                ...
                while (true)
                {
                    ...
                    if (NOT l_U217)
                    {
                        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
                        {
                            ...
                            {
                                sub_2748();
                                if ((sub_3151( ref l_U251 )) || (sub_3243( ref l_U251, 22.00000000 )))
                                {
                                    sub_3420();
                                }
                                sub_3793( ref l_U261 );
                    ...
                    if (l_U217)
                    {
                        ...
                        if ((IS_KEYBOARD_KEY_PRESSED( 31 )) AND (NOT l_U212))
                        {
                            l_U212 = 1;
                            sub_33466();
                        }
                        if ((IS_KEYBOARD_KEY_PRESSED( 30 )) AND (NOT l_U219))
                        {
...
int sub_2748()
{
    if (l_U218)
    {
        if (IS_HINT_RUNNING())
        {
            if (((sub_2783( ref l_U251 )) > 18.00000000) || (sub_2948()))
            {
                HINT_CAM( 0.00000000, 0.00000000, 0.50000000, l_U251, 0, 0, 0 );
                l_U218 = 0;
                return 1;
...
void sub_9384()
{
    ...
    l_U503._fU0 = l_U251;
    l_U503._fU8 = {-1589.37600000, 582.10200000, 24.34240000};
    ...
    l_U503._fU116[1] = {-1591.68800000, 580.35860000, 25.81119000};
    ...
    l_U503._fU92 = {-1596.71000000, 676.28000000, -100.00000000};
    ...
    switch (l_U201)
    {
        ...
        if (sub_12600( l_U251 ))
        {
            if (DOES_BLIP_EXIST( l_U262 ))
            {
                ...
                l_U236 = 1;
                ADD_SCENARIO_BLOCKING_AREA( -1735.51100000, 331.66690000, 100.00000000, -1732.18800000, 375.42120000, -100.00000000 );
                REMOVE_BLIP( l_U262 );
                CLEAR_PRINTS();
        ...
        switch (l_U202)
        {
            ...
            break;
            case 11:
            if ((NOT (sub_17081( l_U460[0] ))) || (l_U421[0] == 1))
            {
                if (NOT (IS_CHAR_INJURED( l_U252[0] )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U252[1] )))
...
int sub_12600(unknown uParam0)
{
    ...
    if ((IS_PLAYER_PRESSING_HORN( sub_1220() )) AND ((sub_2783( ref uParam0 )) < (10.00000000 * 2.00000000)))
    {
        return 1;
    }
    return 0;
...
int sub_14969()
{
    for ( l_U406 = 0; l_U406 <= 1; l_U406++ )
    {
        if ((sub_15011( ref l_U252[l_U406], ref l_U436 )) || (sub_15328( ref l_U252[l_U406], 10.00000000 )))
        {
            return 1;
        }
    }
...
int sub_15030(unknown uParam0, unknown uParam1, unknown uParam2, boolean bParam3)
{
        ...
        for ( I = 0; I <= ((uParam1^) - 1); I++ )
        {
            if (DOES_CHAR_EXIST( (uParam1^)[I] ))
            {
                if (NOT (IS_CHAR_INJURED( (uParam1^)[I] )))
                {
                    ...
                    if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam1^)[I], sub_1914(), 0 )) || (iVar7 < (uParam2^)[I])) || (IS_CHAR_RESPONDING_TO_EVENT( (uParam1^)[I], 9 )))
                    {
                        return 1;
                    }
                }
    ...
    else if (DOES_CHAR_EXIST( (uParam0^) ))
    {
        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
        {
            ...
            if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^), sub_1914(), 0 )) || (iVar7 < (uParam2^)[0])) || (IS_CHAR_RESPONDING_TO_EVENT( (uParam0^), 9 )))
            {
                return 1;
            }
        }
...
int sub_15844(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if (IS_PED_IN_GROUP( (uParam0^) ))
        {
            ...
            if ((IS_CHAR_ON_FOOT( (uParam0^) )) AND (IS_CHAR_ON_FOOT( sub_1914() )))
            {
                return 1;
            }
            if (DOES_VEHICLE_EXIST( (uParam1^) ))
            {
                ...
                {
                    if ((IS_CHAR_SITTING_IN_CAR( (uParam0^), (uParam1^) )) AND (IS_CHAR_SITTING_IN_CAR( sub_1914(), (uParam1^) )))
                    {
                        return 1;
                    }
                }
...
void sub_19677()
{
    ...
    SET_CAM_POS( l_U386, -1725.51900000, 367.95760000, 26.01123000 );
    ...
    SET_CAM_POS( l_U389, -1735.87100000, 360.56890000, 31.52474000 );
    ...
    switch (l_U203)
    {
        ...
        if (NOT l_U249)
        {
            for ( l_U406 = 2; l_U406 <= 3; l_U406++ )
            {
                ...
                {
                    if ((sub_5742( ref l_U409, 5000 )) || (sub_15011( ref l_U252[l_U406], ref l_U436 )))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U252[l_U406] )))
                        {
        ...
        if (sub_5742( ref l_U409, 3000 ))
        {
            if ((sub_2783( ref l_U251 )) < 4.00000000)
            {
                ...
                if (sub_30687( 10, 1 ))
                {
                    ...
                    SET_CAM_ROT( l_U385, -8.97948000, -5.20696600, -176.48680000 );
                    ...
                    SET_CAM_ROT( l_U388, -8.97948000, -5.20696600, -176.48680000 );
                    ...
                    SET_CAM_FOV( l_U390, 39.00002000 );
                    CLEAR_SEQUENCE_TASK( l_U448 );
                    SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U251, 1 );
                    OPEN_SEQUENCE_TASK( ref l_U448 );
                    TASK_LOOK_AT_CHAR( 0, sub_1914(), -2, 0 );
