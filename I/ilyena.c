...
void sub_2431()
{
    switch (l_U103)
    {
        ...
        while ((NOT (HAVE_ANIMS_LOADED( "MISSPASS" ))) || (NOT (HAVE_ANIMS_LOADED( "missilyena" ))))
        {
            WAIT( 0 );
        }
        l_U103 = 1;
...
void sub_3003()
{
    ...
    if ((IS_CHAR_INJURED( l_U119 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U119, sub_2171(), 0 )))
    {
    ...
    if ((sub_3182() < 25) AND (IS_CHAR_ON_FOOT( sub_2171() )))
    {
    ...
    {
        case 0:
        if ((((IS_CHAR_INJURED( l_U119 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U119, sub_2171(), 0 ))) || (IS_CHAR_ON_FIRE( l_U119 ))) || (IS_WANTED_LEVEL_GREATER( sub_960(), 0 )))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U119 )))
        {
            if ((sub_3182() < 18) AND (IS_CHAR_ON_FOOT( sub_2171() )))
            {
                if ((NOT IS_HINT_RUNNING()) AND (NOT l_U186))
                {
...
void sub_7783()
{
    ...
    switch (l_U107)
    {
        ...
        if ((((sub_10467( ref l_U120 )) < 4.50000000) AND (sub_4397( 1, 1 ))) AND (NOT sub_268()))
        {
            if (IS_CHAR_ON_FOOT( sub_2171() ))
            {
        ...
        if (l_U209)
        {
            ...
            if (NOT (IS_CHAR_INJURED( l_U120 )))
            {
                ...
                if (((sub_10894()) AND ((sub_10467( ref l_U120 )) < 5.00000000)) || (IS_BULLET_IN_AREA( l_U201._fU0, l_U201._fU4, l_U201._fU8, 2.00000000, 1 )))
                {
                    SET_CHAR_INVINCIBLE( l_U120, 0 );
                    l_U209 = 0;
                }
        ...
        else
        {
            ...
            PRINTNL();
            if (((sub_10467( ref l_U120 )) > 5.00000000) AND (NOT sub_10894()))
            {
                if (NOT (IS_CHAR_INJURED( l_U120 )))
                {
        ...
        if (NOT (IS_CHAR_INJURED( l_U120 )))
        {
            ...
            if (((sub_10467( ref l_U120 )) > 100) AND (NOT (IS_CHAR_ON_SCREEN( l_U120 ))))
            {
                l_U107 = 14;
            }
        }
        ...
        else if (NOT (IS_CHAR_DEAD( sub_2171() )))
        {
            ...
            if ((NOT (IS_CHAR_INJURED( l_U120 ))) AND (NOT (IS_CHAR_INJURED( sub_2171() ))))
            {
        ...
        if (((TIMERA() >= 2000) AND (sub_16374())) || (TIMERB() > 20000))
        {
            if (NOT (IS_CHAR_INJURED( sub_2171() )))
            {
