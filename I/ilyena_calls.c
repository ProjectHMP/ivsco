...
void sub_946()
{
    ...
    if ((((g_U10978) || (IS_THREAD_ACTIVE( g_U812 ))) || (IS_WANTED_LEVEL_GREATER( sub_955(), 0 ))) || (sub_1090()))
    {
        sub_999();
        return;
    }
...
int sub_1300(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_1531() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1531() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_1863()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
