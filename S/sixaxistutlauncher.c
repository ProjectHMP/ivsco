        ...
        if ((g_U822) AND (NOT g_U8669))
        {
            if ((NOT g_U10978) AND (NOT g_U9893._fU12))
            {
                if (NOT l_U4)
                {
                    ...
                    {
                        if (((sub_158()) AND (NOT g_U10978)) AND (NOT g_U9893._fU12))
                        {
                            g_U10978 = 1;
                            l_U4 = 1;
                            sub_547();
                ...
                else if ((NOT g_U10978) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "sixAxisTutorial" )) == 0))
                {
                    l_U4 = 0;
                    g_U822 = 0;
                    g_U823 = 1;
...
int sub_158()
{
    if ((IS_SCREEN_FADING()) || (IS_SCREEN_FADED_OUT()))
    {
        return 0;
    }
