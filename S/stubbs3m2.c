...
int sub_4673(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3441() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3441() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_5200()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
...
void sub_7713()
{
    ...
    while ((((NOT (HAS_MODEL_LOADED( l_U360 ))) || (NOT (HAS_MODEL_LOADED( l_U361 )))) || (NOT (HAS_MODEL_LOADED( l_U362 )))) || (NOT (HAVE_ANIMS_LOADED( l_U570 ))))
    {
        WAIT( 0 );
    }
    ...
    l_U403[3] = {-375.26270000, 507.15990000, 14.63291000};
    ...
    l_U469[3] = {-3.46331400, 0.00000000, -43.07695000};
    l_U425[4] = {671.43300000, 1654.27500000, 33.65265000};
...
void sub_17897(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3441() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_18065())) AND (iVar3 != 4))
    {
