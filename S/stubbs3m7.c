...
void sub_2060()
{
    ...
    {
        if (((sub_2098( 5, g_U572[I] )) == 1) AND (g_U572[I]._fU20))
        {
...
void sub_4702()
{
    ...
    if (((l_U517 == 0) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_4247(), l_U525._fU0, l_U525._fU4, l_U525._fU8, 120.00000000, 120.00000000, 120.00000000, 0 ))) || ((l_U517 == 0) AND (sub_4883() == 1)))
    {
        sub_5195();
        sub_5486();
        sub_5597();
...
void sub_6065()
{
    ...
    CREATE_CHAR( 26, l_U575, 27.65490000, 981.81350000, 13.66330000, ref l_U545[2], 1 );
...
void sub_7670()
{
    ...
    if (NOT (IS_CHAR_DEAD( l_U544 )))
    {
        ...
        if (((IS_SNIPER_BULLET_IN_AREA( l_U528._fU0 - 10, l_U528._fU4 - 10, l_U528._fU8 - 5, l_U528._fU0 + 10, l_U528._fU4 + 10, l_U528._fU8 + 5 )) || (IS_BULLET_IN_AREA( l_U528._fU0, l_U528._fU4, l_U528._fU8, 15.00000000, 1 ))) || (IS_PROJECTILE_IN_AREA( l_U528._fU0 + 10, l_U528._fU4 + 10, l_U528._fU8 + 10, l_U528._fU0 - 10, l_U528._fU4 - 10, l_U528._fU8 - 10 )))
        {
            l_U519 = 2;
        }
        if ((IS_PLAYER_TARGETTING_CHAR( sub_824(), l_U544 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U501, l_U544, 3.00000000, 3.00000000, 2.00000000, 0 )))
        {
            l_U519 = 2;
        }
        if ((IS_PLAYER_TARGETTING_CHAR( sub_824(), l_U544 )) AND (l_U595 == l_U596))
        {
            l_U519 = 2;
        }
    }
    ...
    if (NOT (IS_CHAR_DEAD( l_U551 )))
    {
        ...
        if ((IS_PLAYER_TARGETTING_CHAR( sub_824(), l_U551 )) AND (l_U595 == l_U596))
        {
            l_U519 = 2;
        }
    }
    ...
    for ( I = 0; I <= 4; I++ )
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U545[I] )))
        {
            if ((IS_PLAYER_TARGETTING_CHAR( sub_824(), l_U545[I] )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_824(), l_U545[I] )))
            {
    ...
    {
        if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U552, l_U501 )) || (IS_CHAR_IN_CAR( l_U501, l_U552 )))
        {
            l_U519 = 2;
        }
    }
    ...
    {
        if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U553[0], l_U501 )) || (IS_CHAR_IN_CAR( l_U501, l_U553[0] )))
        {
            l_U519 = 2;
        }
    }
    ...
    if ((IS_CHAR_IN_ANY_CAR( l_U501 )) AND (l_U521 == 877820577))
    {
        l_U519 = 2;
    }
...
void sub_12115()
{
    if ((IS_CHAR_DEAD( l_U544 )) AND (l_U515 == 0))
    {
        if (sub_12149())
        {
            l_U519 = -1;
...
int sub_13126(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_4247() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_4247() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_13641()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
