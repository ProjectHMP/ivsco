void main()
{
    ...
    l_U479 = {-1312.79800000, 351.17560000, 13.62230000};
...
void sub_3000()
{
    ...
    {
        if (((sub_3038( 5, g_U572[I] )) == 1) AND (g_U572[I]._fU20))
        {
...
int sub_7335(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_4888() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_4888() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_7862()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
...
void sub_10446()
{
    ...
    l_U501[3] = {-1316.78200000, 349.82440000, 13.62230000};
...
void sub_12064()
{
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_4888(), l_U523._fU0, l_U523._fU4, l_U523._fU8, 10.00000000, 10.00000000, 10.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_4888(), l_U526._fU0, l_U526._fU4, l_U526._fU8, 10.00000000, 10.00000000, 10.00000000, 0 )))
    {
        sub_12177();
        sub_12321();
        sub_12465();
...
void sub_19839()
{
    ...
    {
        case 0:
        if (((l_U642 > 10) || (sub_19899() == 1)) || (l_U654))
        {
            GET_GAME_TIMER( ref l_U383 );
            l_U384 = l_U383 - l_U382;
            if ((l_U384 > 5000) || (l_U654 == 1))
            {
                if (sub_20292() == 1)
                {
                    sub_20576();
        ...
        if (((l_U643 > 9) || (sub_23582() == 1)) || (l_U655))
        {
            sub_23834();
        }
        sub_25470();
    ...
    if (DOES_CHAR_EXIST( l_U584 ))
    {
        if (DOES_CHAR_EXIST( l_U582 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U584 )))
            {
                if (NOT (IS_CHAR_INJURED( l_U582 )))
                {
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U584, sub_4888(), 0 )) || (IS_PLAYER_TARGETTING_CHAR( sub_1764(), l_U584 )))
                    {
                        sub_20029( l_U582, l_U584 );
                        l_U654 = 1;
                        return 1;
                    }
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U582, sub_4888(), 0 )) || (IS_PLAYER_TARGETTING_CHAR( sub_1764(), l_U582 )))
                    {
                        sub_20029( l_U582, l_U584 );
                        l_U654 = 1;
                        return 1;
    ...
    if (DOES_CHAR_EXIST( l_U581 ))
    {
        if (DOES_CHAR_EXIST( l_U580 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U581 )))
            {
                if (NOT (IS_CHAR_INJURED( l_U580 )))
                {
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U581, sub_4888(), 0 )) || (IS_PLAYER_TARGETTING_CHAR( sub_1764(), l_U581 )))
                    {
                        sub_20029( l_U580, l_U581 );
                        l_U656 = 1;
                        return 1;
                    }
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U580, sub_4888(), 0 )) || (IS_PLAYER_TARGETTING_CHAR( sub_1764(), l_U580 )))
                    {
                        sub_20029( l_U580, l_U581 );
                        l_U656 = 1;
                        return 1;
        ...
        switch (l_U641)
        {
            ...
            if (IS_VEH_DRIVEABLE( l_U594 ))
            {
                if (NOT (IS_CHAR_INJURED( l_U580 )))
                {
                    ...
                    if ((LOCATE_CAR_2D( l_U594, l_U434._fU0, l_U434._fU4, 12.00000000, 12.00000000, 0 )) || (LOCATE_CAR_2D( l_U594, l_U437._fU0, l_U437._fU4, 12.00000000, 12.00000000, 0 )))
                    {
                        if (fVar2 < 1.00000000)
                        {
    ...
    if (NOT (IS_CHAR_INJURED( uParam0 )))
    {
        if (IS_VEH_DRIVEABLE( iParam1 ))
        {
            if (IS_CHAR_IN_CAR( uParam0, iParam1 ))
            {
                ...
                if ((l_U616 == 7) AND (fVar5 <= 0.10000000))
                {
                    if (iParam2 == l_U581)
                    {
    ...
    if (DOES_CHAR_EXIST( l_U585 ))
    {
        if (DOES_CHAR_EXIST( l_U583 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U585 )))
            {
                if (NOT (IS_CHAR_INJURED( l_U583 )))
                {
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U585, sub_4888(), 0 )) || (IS_PLAYER_TARGETTING_CHAR( sub_1764(), l_U585 )))
                    {
                        sub_20029( l_U583, l_U585 );
                        l_U655 = 1;
                        return 1;
                    }
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U583, sub_4888(), 0 )) || (IS_PLAYER_TARGETTING_CHAR( sub_1764(), l_U583 )))
                    {
                        sub_20029( l_U583, l_U585 );
                        l_U655 = 1;
                        return 1;
    ...
    if (l_U622 == 6)
    {
        if (IS_VEH_DRIVEABLE( l_U594 ))
        {
            if (LOCATE_CHAR_ANY_MEANS_CAR_3D( sub_4888(), l_U594, 15.00000000, 15.00000000, 5.00000000, 0 ))
            {
                if (l_U542 == 0)
                {
                    if ((sub_26744()) || (LOCATE_CHAR_ANY_MEANS_CAR_3D( sub_4888(), l_U594, 8.00000000, 8.00000000, 20.00000000, 0 )))
                    {
                        l_U544 = 1;
                        sub_20576();
                        l_U622 = 8;
...
{
    if ((g_U94._fU0 == 1023) || (g_U94._fU0 == 1024))
    {
        g_U94._fU88 = 1;
        g_U94._fU60 = uParam0;
        return 1;
...
{
    if ((g_U94._fU88) AND (iParam0 == g_U94._fU60))
    {
        return 1;
    }
    return 0;
...
{
    if ((g_U94._fU0 == 1025) AND (iParam0 == g_U94._fU60))
    {
        return 1;
    }
    return 0;
