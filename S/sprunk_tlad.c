...
void sub_216(int iParam0, string sParam1)
{
    ...
    if (NOT (IS_STRING_NULL( sParam1 )))
    {
        ...
        {
            if ((g_U10468 == iParam0) AND (l_U106))
            {
...
int sub_1384(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_496() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_496() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_1480())
                    {
...
void sub_2938(unknown uParam0)
{
    switch (l_U115)
    {
        ...
        if ((l_U116 > 0.98000000) || (NOT (IS_CHAR_PLAYING_ANIM( sub_1018(), l_U135, l_U134 ))))
        {
            ...
            sub_4048( 0, 1 );
            SET_CHAR_HEALTH( sub_1018(), sub_4458() );
            sub_4544();
            l_U115 = 7;
        }
        break;
...
void sub_4048(unknown uParam0, unknown uParam1)
{
    sub_4069( uParam0, uParam1, 0.00000000, "" );
    return;
}

void sub_4069(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
