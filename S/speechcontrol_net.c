...
void sub_317()
{
    ...
    {
        if ((NOT (COMPARE_STRING( ref g_U8499[I], "END" ))) AND (NOT (COMPARE_STRING( ref g_U8499[I], "" ))))
        {
            iVar31 = 1;
            cVar11 = {g_U8499[I]};
            ...
            if (DOES_TEXT_LABEL_EXIST( ref uVar7 ))
            {
                if (iVar32 >= iVar36)
                {
                    ...
                    sub_1047( iVar33, iVar34, iVar35, ref cVar15, ref g_U8499[I] );
                    if (bVar37)
                    {
                        return;
                    }
            ...
            {
                sub_1330( ref uVar3, ref g_U8499[I], iVar31, -1, -1 );
