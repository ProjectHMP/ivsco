void main()
{
    ...
    while (true)
    {
        ...
        if ((NETWORK_HAVE_SUMMONS()) AND (NOT g_U91._fU580))
        {
            if (g_U555 == 9)
            {
                ...
                if (IS_PLAYER_PLAYING( sub_2711() ))
                {
                    switch (g_U555)
                    {
                        ...
                        if (IS_PLAYER_CONTROL_ON( sub_2711() ))
                        {
                            if (sub_2791())
                            {
                                if (((sub_3669( 0 )) == 0) AND (NOT (IS_BUTTON_PRESSED( 0, 4 ))))
                                {
                                    g_U91._fU376 = 0;
                                    g_U91._fU380 = 1;
                                    if ((g_U818) || (g_U822))
                ...
                if (IS_PLAYER_PLAYING( sub_2711() ))
                {
                    switch (g_U555)
                    {
                        ...
                        if (IS_PLAYER_CONTROL_ON( sub_2711() ))
                        {
                            ...
                            {
                                if ((sub_2791()) || (g_U91._fU376))
                                {
                                    sub_7750( 1 );
                                }
                            }
                            else if (((sub_3669( 0 )) == 0) AND (NOT (IS_CONTROL_PRESSED( 0, 23 ))))
                            {
                                if (sub_2791())
                                {
                                    g_U91._fU376 = 0;
                        ...
                        else if (((g_U91._fU48) || (g_U91._fU52)) AND (g_U91._fU376))
                        {
                            sub_7750( 1 );
                        }
                        break;
                    ...
                    switch (l_U4)
                    {
                        ...
                        if (g_U91._fU0 == 1005)
                        {
                            if ((sub_13340( "9485550100" )) || (sub_13442( 21, 1 )))
                            {
...
void sub_8345(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        ...
        {
            sub_8462( uParam1, 11.50000000, -60.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U91._fU8._fU24 );
        }
        else
        {
            sub_8462( uParam1, 5.00000000, -60.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U91._fU8._fU24 );
        }
        break;
        case 2:
        if ((g_U91._fU496) AND (GET_IS_WIDESCREEN()))
        {
            sub_8462( uParam1, 11.50000000, -11.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U91._fU8._fU24 );
        }
        else
        {
            sub_8462( uParam1, 5.00000000, -7.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U91._fU8._fU24 );
        }
        break;
        case 3:
        if ((g_U91._fU496) AND (GET_IS_WIDESCREEN()))
        {
            sub_8462( uParam1, 11.50000000, 4.50000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U91._fU8._fU24 );
        }
        else
        {
            sub_8462( uParam1, 5.00000000, 8.50000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U91._fU8._fU24 );
        }
        break;
        case 4:
        if ((g_U91._fU496) AND (GET_IS_WIDESCREEN()))
        {
            sub_8462( uParam1, 11.50000000, -5.25000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U91._fU8._fU24 );
        }
        else
        {
            sub_8462( uParam1, 5.00000000, -0.75000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U91._fU8._fU24 );
        }
        break;
    }
    return;
...
int sub_12455()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_1266( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_12519( I );
            return 1;
        }
...
int sub_13767(unknown uParam0, unknown uParam1, boolean bParam2)
{
    ...
    if (NOT (COMPARE_STRING( uParam0, "PLACEHOLDER" )))
    {
        ...
        if ((NOT g_U91._fU368) == 1)
        {
            ...
            sub_14931( uVar23, ref g_U91._fU176 );
            g_U91._fU368 = 1;
            return 1;
        }
    }
...
int sub_13875(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    {
        case 0:
        if ((NOT sub_14390()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
    ...
    sub_14931( uParam0, ref g_U91._fU176 );
    sub_16312( ref g_U91._fU160 );
