...
void sub_4072()
{
    ...
    sub_4185( 0, 0, 1232.57200000, -89.69760000, 27.02420000, 270.80440000 );
    sub_4185( 1, 0, 896.84090000, -355.56640000, 16.63910000, 317.92790000 );
    sub_4185( 2, 0, 1232.19200000, 517.28770000, 27.57370000, 176.10820000 );
    sub_4185( 3, 0, 2172.29900000, 449.18780000, 5.08020000, 271.42560000 );
    sub_4185( 4, 1, 991.06670000, 1877.50400000, 22.89280000, 25.88270000 );
    sub_4185( 5, 1, 435.26210000, 1594.44800000, 15.33110000, 9.17450000 );
    sub_4185( 6, 2, 85.57060000, 1189.12600000, 13.75600000, 203.16790000 );
    sub_4185( 7, 2, -416.83880000, 1102.39600000, 10.72210000, 201.71590000 );
    sub_4185( 8, 2, 48.41780000, 679.95230000, 13.66270000, 88.55010000 );
    sub_4185( 9, 2, -416.18250000, 278.27630000, 10.95020000, 200.56330000 );
    sub_4185( 10, 2, 224.55200000, -215.17490000, 9.73680000, 205.17850000 );
    sub_4185( 11, 2, -378.14180000, -263.86910000, 10.04100000, 245.03360000 );
    sub_4185( 12, 3, -924.12320000, 1265.74300000, 23.57260000, 137.19690000 );
    sub_4185( 13, 3, -1716.64400000, 276.68920000, 21.20240000, 250.00490000 );
    sub_4185( 14, 3, -1223.23600000, -233.32100000, 2.03350000, 308.33580000 );
    for ( I = 0; I < 15; I++ )
    {
        if (g_U9999[I]._fU0 == 5)
        {
    ...
    sub_4872( 0, 0, 1190.96500000, 201.09010000, 31.59560000, 148.37250000 );
    sub_4872( 1, 0, 1242.93900000, 497.13550000, 27.41460000, 28.45530000 );
    sub_4872( 2, 1, 975.74330000, 1822.26000000, 19.09530000, 87.84350000 );
    sub_4872( 3, 2, -391.22820000, 1280.00800000, 22.05360000, 225.15350000 );
    sub_4872( 4, 2, 94.86770000, 147.33100000, 13.77200000, 185.87280000 );
    sub_4872( 5, 3, -1306.34600000, 1286.18800000, 20.77930000, 312.24850000 );
    sub_4872( 6, 3, -1512.16900000, 400.12190000, 18.67960000, 315.57750000 );
    for ( I = 0; I < 7; I++ )
    {
...
void sub_4185(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown uVar8;

    g_U9999[uParam0]._fU0 = uParam1;
    g_U9999[uParam0]._fU4 = {uParam2, uParam3, uParam4};
    g_U9999[uParam0]._fU16 = uParam5;
    uVar8 = uParam1;
    ADD_POLICE_RESTART( uParam2, uParam3, uParam4, uParam5, uVar8 );
    return;
}

void sub_4872(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown uVar8;

    g_U10090[uParam0]._fU0 = uParam1;
    g_U10090[uParam0]._fU4 = {uParam2, uParam3, uParam4};
    g_U10090[uParam0]._fU16 = uParam5;
    uVar8 = uParam1;
