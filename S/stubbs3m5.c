void main()
{
    ...
    l_U883 = {-846.56150000, 779.86080000, 5.86030000};
    l_U886 = {-966.75050000, 793.01120000, 3.30170000};
    l_U889 = {-956.27530000, 789.04460000, 3.26710000};
    l_U893 = 319.49970000;
    l_U894 = 123.23700000;
    l_U895 = 321.49500000;
    l_U896 = 1349725314;
    ...
    while (true)
    {
        ...
        switch (l_U523)
        {
            ...
            {
                if (((((LOCATE_CHAR_ANY_MEANS_2D( sub_4185(), -1599.85800000, 707.34960000, 4.00000000, 4.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( sub_4185(), -1637.60300000, 698.15340000, 5.00000000, 5.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_4185(), -1612.12900000, 764.80350000, 7.00000000, 7.00000000, 0 ))) || (sub_14980())) || (sub_15566()))
                {
            ...
            sub_17909();
            sub_18376();
            if ((sub_18590( sub_4185(), l_U1020 )) AND (sub_18657()))
            {
                if (sub_21987())
                {
                    l_U911 = 1;
            ...
            if ((sub_33502()) || (sub_18590( l_U1010, l_U1021 )))
            {
                l_U523 = 13;
            }
            break;
...
void sub_2222()
{
    ...
    {
        if (((sub_2260( 5, g_U572[I] )) == 1) AND (g_U572[I]._fU20))
        {
...
void sub_4589()
{
    ...
    {
        if (((NOT (IS_VEH_DRIVEABLE( l_U1021 ))) || (IS_HELI_PART_BROKEN( l_U1021, 1, 1, 1 ))) || (IS_CAR_IN_WATER( l_U1021 )))
        {
            if (l_U523 != 17)
            {
                l_U904 = 1;
...
int sub_5394(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_4185() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_4185() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_5921()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
...
void sub_10229()
{
    ...
    l_U633[1]._fU0 = {-1634.55700000, 691.29520000, 27.31470000};
    ...
    l_U590[2]._fU0 = {-1608.32500000, 768.07730000, 26.19160000};
    l_U590[2]._fU12 = 344.41990000;
    l_U590[2]._fU16 = 7;
    l_U590[2]._fU20 = 30000;
    l_U590[2]._fU24 = -183203150;
    l_U540[0]._fU0 = {-1606.79000000, 709.52920000, 24.44390000};
    ...
    l_U540[4]._fU0 = {-1610.07500000, 737.69520000, 27.41970000};
...
int sub_14980()
{
    ...
    {
        if (((LOCATE_CHAR_ANY_MEANS_2D( sub_4185(), -1599.85800000, 707.34960000, 10.00000000, 10.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( sub_4185(), -1637.60300000, 698.15340000, 10.00000000, 10.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_4185(), -1612.12900000, 764.80350000, 10.00000000, 10.00000000, 0 )))
        {
            return 1;
        }
    }
...
void sub_18376()
{
    if (l_U912 == 0)
    {
        if (NOT (IS_CHAR_INJURED( l_U1010 )))
        {
            if (NOT (sub_17379( l_U917 )))
            {
                if ((LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_4185(), l_U1010, 8.00000000, 8.00000000, 0 )) || (IS_CHAR_TRYING_TO_ENTER_A_LOCKED_CAR( sub_4185() )))
                {
                    if (NOT (sub_17379( l_U917 )))
                    {
    ...
    if (NOT (IS_CHAR_INJURED( l_U1010 )))
    {
        ...
        switch (l_U1104)
        {
            ...
            if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_4185(), l_U1010, 3.00000000, 3.00000000, 3.00000000, 0 ))
            {
                if (sub_18835( 4, 0 ))
                {
                    if ((NOT (IS_CONTROL_PRESSED( 0, 6 ))) AND (NOT (IS_CONTROL_PRESSED( 0, 87 ))))
                    {
...
int sub_18835(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_986() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_986() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_986() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_18931())
                    {
...
void sub_19601(int iParam0, string sParam1)
{
    ...
    if (NOT (IS_STRING_NULL( sParam1 )))
    {
        ...
        {
            if ((g_U10468 == iParam0) AND (l_U107))
            {
...
int sub_20000()
{
    if ((((((((IS_BUTTON_PRESSED( 0, 17 )) || (IS_BUTTON_PRESSED( 0, 14 ))) || (IS_BUTTON_PRESSED( 0, 15 ))) || (IS_BUTTON_PRESSED( 0, 16 ))) || (sub_20048())) || ((NOT IS_USING_CONTROLLER()) AND (IS_CONTROL_PRESSED( 2, 77 )))) || ((NOT IS_USING_CONTROLLER()) AND (IS_CONTROL_PRESSED( 2, 78 )))) || ((NOT IS_USING_CONTROLLER()) AND (IS_CONTROL_PRESSED( 2, 2 ))))
    {
...
void sub_23081()
{
    ...
    if (IS_VEH_DRIVEABLE( l_U1020 ))
    {
        ...
        {
            sub_23130( l_U1010 );
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_4185(), l_U889._fU0, l_U889._fU4, l_U889._fU8, 2.50000000, 2.50000000, 2.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_4185(), l_U883._fU0, l_U883._fU4, l_U883._fU8, 25.00000000, 25.00000000, 10.00000000, 0 )))
            {
                if (l_U914 == 0)
                {
                    sub_14770( l_U1046 );
            ...
            if ((NOT (sub_23413( l_U1010 ))) AND (IS_CHAR_IN_CAR( sub_4185(), l_U1020 )))
            {
                iVar6 = 1;
                if (l_U1060 != 3)
                {
            ...
            if (((sub_23413( l_U1010 )) AND (IS_CHAR_IN_CAR( sub_4185(), l_U1020 ))) AND (NOT (IS_CHAR_IN_CAR( l_U1010, l_U1020 ))))
            {
            ...
            if (((((l_U1059 == 7) || (l_U1059 == 5)) || (l_U1059 == 6)) || (NOT (IS_CHAR_IN_CAR( sub_4185(), l_U1020 )))) || (NOT (IS_CHAR_IN_CAR( l_U1010, l_U1020 ))))
            {
                l_U908 = 1;
                sub_24065( 1 );
            }
...
void sub_28248(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_4185() )) || (IS_CHAR_ON_ANY_BIKE( sub_4185() )))
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U649[0]._fU28 )))
        {
            if (NOT (IS_CAR_ON_SCREEN( l_U649[0]._fU32 )))
            {
                if (sub_30130( l_U649[0]._fU32 ))
                {
                    ...
                    {
                        SET_CAR_COORDINATES( l_U649[0]._fU32, -941.39030000, 790.05320000, 3.46170000 );
    ...
    if (NOT (IS_CHAR_INJURED( l_U1010 )))
    {
        ...
        switch (l_U1064)
        {
            ...
            if (sub_27836( 1, 1 ))
            {
                ...
                l_U703[1]._fU0 = {-804.30390000, 995.75760000, 35.57016000};
                l_U703[1]._fU12 = {-5.43930800, -0.00000000, -157.69680000};
                l_U703[1]._fU96 = {-799.86900000, 1005.97900000, 35.23057000};
            ...
            if (HAS_CAR_RECORDING_BEEN_LOADED( 1729 ))
            {
                ...
                if ((PRELOAD_STREAM( "BOAT_RADIO" )) || (l_U527 > 3000))
                {
                    DO_SCREEN_FADE_IN( 3000 );
