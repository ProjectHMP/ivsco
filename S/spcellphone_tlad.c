void main()
{
    ...
    while (true)
    {
        ...
        if ((NETWORK_HAVE_SUMMONS()) AND (NOT g_U94._fU580))
        {
            if (g_U558 == 9)
            {
                ...
                if (IS_PLAYER_PLAYING( sub_2737() ))
                {
                    switch (g_U558)
                    {
                        ...
                        if (IS_PLAYER_CONTROL_ON( sub_2737() ))
                        {
                            if (sub_2817())
                            {
                                if (((sub_3695( 0 )) == 0) AND (NOT (IS_BUTTON_PRESSED( 0, 4 ))))
                                {
                                    g_U94._fU376 = 0;
                                    g_U94._fU380 = 1;
                                    if ((g_U821) || (g_U825))
                ...
                if (IS_PLAYER_PLAYING( sub_2737() ))
                {
                    switch (g_U558)
                    {
                        ...
                        if (IS_PLAYER_CONTROL_ON( sub_2737() ))
                        {
                            ...
                            {
                                if ((sub_2817()) || (g_U94._fU376))
                                {
                                    sub_7776( 1 );
                                }
                            }
                            else if (((sub_3695( 0 )) == 0) AND (NOT (IS_CONTROL_PRESSED( 0, 23 ))))
                            {
                                if (sub_2817())
                                {
                                    g_U94._fU376 = 0;
                        ...
                        else if (((g_U94._fU48) || (g_U94._fU52)) AND (g_U94._fU376))
                        {
                            sub_7776( 1 );
                        }
                        break;
                    ...
                    switch (l_U6)
                    {
                        ...
                        if (g_U94._fU0 == 1005)
                        {
                            if ((sub_13366( "9485550100" )) || (sub_13466( 12, 1 )))
                            {
...
int sub_12481()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if (((sub_1282( 1, g_U572[I] )) != 0) AND (g_U572[I]._fU20))
        {
            sub_12545( I );
            return 1;
        }
...
int sub_13899(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    {
        case 0:
        if ((NOT sub_14414()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
