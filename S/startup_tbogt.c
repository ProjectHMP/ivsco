void main()
{
    ...
    g_U9887 = {0, 0, 240};
    g_U9890 = {0, 0, 0};
    g_U9893 = {-0.01000000, -0.04000000, -0.05000000};
    g_U9896 = {0.00000000, -0.04000000, -0.22000000};
    g_U9899 = {-0.01500000, -0.04000000, -0.22000000};
    g_U9902 = {0.01500000, -0.04000000, -0.22000000};
    g_U10418 = {-1721.52400000, 336.34850000, 30.75580000};
    g_U10421 = {0, 0, 0};
    g_U10425 = {-1721.52400000, 336.34850000, 30.75580000};
    g_U10428 = {0, 0, 0};
    g_U10432 = {0, 0, 0};
    g_U10435 = {0, 0, 0};
    g_U10439 = {0, 0, 0};
    ...
    g_U42921 = -1;
    g_U42922 = -1;
    g_U42923 = {-1018.67800000, 1299.36000000, 24.72840000};
    g_U42927 = 0;
    g_U42928 = 0;
    g_U42929 = 0;
    g_U42930 = 0;
    ...
    g_U43659 = 30;
    g_U43660 = 0;
    g_U43661 = {-3.00000000, -3.00000000, 5.00000000};
    g_U43664 = {3.00000000, -3.00000000, -5.00000000};
    g_U43667 = 0;
    g_U43668 = 0;
    g_U43669 = 0;
    g_U43670 = 0;
    ...
    {
        CREATE_PLAYER( 0, -2000.00000000 + (sub_4078( -0.25000000, 0.25000000 )), -2000.00000000 + (sub_4078( -0.25000000, 0.25000000 )), 240.00000000 + (sub_4078( -0.25000000, 0.25000000 )), ref uVar2 );
        sub_4171( GET_PLAYER_ID(), 0 );
    }
    else
    {
        sub_4478();
        sub_4628( 0, -74.28220000, -226.11370000, 13.63970000, 0, 0, g_U10755 );
        sub_5046( uVar2 );
    ...
    START_NEW_SCRIPT( sVar3, 1820 );
    MARK_SCRIPT_AS_NO_LONGER_NEEDED( sVar3 );
    return;
}

void sub_4078(unknown uParam0, unknown Result)
{
    GENERATE_RANDOM_FLOAT_IN_RANGE( uParam0, Result, ref Result );
    return Result;
}

void sub_4171(unknown uParam0, boolean bParam1)
{
    SET_PLAYER_CONTROL_FOR_NETWORK( sub_4182( uParam0 ), bParam1, 0 );
    SET_CHAR_VISIBLE( sub_4220( uParam0 ), bParam1 );
    if (bParam1)
    {
        if (NOT (IS_CHAR_IN_ANY_CAR( sub_4220( uParam0 ) )))
        {
            SET_CHAR_COLLISION( sub_4220( uParam0 ), 1 );
        }
        FREEZE_CHAR_POSITION( sub_4220( uParam0 ), 0 );
        SET_CHAR_NEVER_TARGETTED( sub_4220( uParam0 ), 0 );
        SET_PLAYER_INVINCIBLE( sub_4182( uParam0 ), 0 );
    }
    else
    {
        SET_CHAR_COLLISION( sub_4220( uParam0 ), 0 );
        FREEZE_CHAR_POSITION( sub_4220( uParam0 ), 1 );
        SET_CHAR_NEVER_TARGETTED( sub_4220( uParam0 ), 1 );
        SET_PLAYER_INVINCIBLE( sub_4182( uParam0 ), 1 );
        REMOVE_PTFX_FROM_PED( sub_4220( uParam0 ) );
        if (NOT (IS_CHAR_FATALLY_INJURED( sub_4220( uParam0 ) )))
        {
            CLEAR_CHAR_TASKS_IMMEDIATELY( sub_4220( uParam0 ) );
        }
    }
    return;
}

void sub_4182(unknown uParam0)
{
    return CONVERT_INT_TO_PLAYERINDEX( uParam0 );
}

void sub_4220(unknown uParam0)
{
    unknown Result;
...
void sub_4478()
{
    ...
    for ( I = 0; I < 14; I++ )
    {
        g_U10756[I]._fU4._fU0 = 0.00000000;
        g_U10756[I]._fU4._fU4 = 0.00000000;
        g_U10756[I]._fU4._fU8 = 0.00000000;
        g_U10756[I]._fU16 = g_U10755;
        g_U10756[I]._fU0 = 0;
    }
    return;
}

void sub_4628(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    if (iParam0 > 14)
    {
        sub_4711( "Main_Missions: Store_Contact_Point(): Illegal Contact Point ID" );
    }
    ...
    {
        sub_4711( "Main_Missions: Store_Contact_Point(): Contact Point ID already setup" );
    }
    ...
    sub_4951( ref g_U10756[iParam0]._fU0, 1, uParam4 );
    sub_4951( ref g_U10756[iParam0]._fU0, 2, uParam5 );
    CLEAR_BIT( ref g_U10756[iParam0]._fU0, 3 );
    return;
}

void sub_4711(unknown uParam0)
{
    SCRIPT_ASSERT( uParam0 );
    return;
}

void sub_4951(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (bParam2)
    {
...
void sub_5046(unknown uParam0)
{
    ...
    uVar3 = {g_U10756[0]._fU4};
    fVar6 = 240.75730000;
    g_U21 = 0;
    CREATE_PLAYER( 0, uVar3._fU0, uVar3._fU4, uVar3._fU8, ref uParam0 );
    SET_CHAR_COORDINATES( sub_5101(), uVar3._fU0, uVar3._fU4, uVar3._fU8 );
    SET_CHAR_HEADING( sub_5101(), fVar6 );
...
void sub_5248()
{
    ...
    {
        g_U11209[I]._fU0 = 5;
        g_U11209[I]._fU4 = {0.00000000, 0.00000000, 0.00000000};
        g_U11209[I]._fU16 = 0.00000000;
    }
    sub_5361( 0, 0, 1232.57200000, -89.69760000, 27.02420000, 270.80440000 );
    sub_5361( 1, 0, 896.84090000, -355.56640000, 16.63910000, 317.92790000 );
    sub_5361( 2, 0, 1232.19200000, 517.28770000, 27.57370000, 176.10820000 );
    sub_5361( 3, 0, 2172.29900000, 449.18780000, 5.08020000, 271.42560000 );
    sub_5361( 4, 1, 991.06670000, 1877.50400000, 22.89280000, 25.88270000 );
    sub_5361( 5, 1, 435.26210000, 1594.44800000, 15.33110000, 9.17450000 );
    sub_5361( 6, 2, 85.57060000, 1189.12600000, 13.75600000, 203.16790000 );
    sub_5361( 7, 2, -416.83880000, 1102.39600000, 10.72210000, 201.71590000 );
    sub_5361( 8, 2, 48.41780000, 679.95230000, 13.66270000, 88.55010000 );
    sub_5361( 9, 2, -416.18250000, 278.27630000, 10.95020000, 200.56330000 );
    sub_5361( 10, 2, 224.55200000, -215.17490000, 9.73680000, 205.17850000 );
    sub_5361( 11, 2, -378.14180000, -263.86910000, 10.04100000, 245.03360000 );
    sub_5361( 12, 3, -924.12320000, 1265.74300000, 23.57260000, 137.19690000 );
    sub_5361( 13, 3, -1716.64400000, 276.68920000, 21.20240000, 250.00490000 );
    sub_5361( 14, 3, -1223.23600000, -233.32100000, 2.03350000, 308.33580000 );
    for ( I = 0; I < 15; I++ )
    {
        if (g_U11209[I]._fU0 == 5)
        {
            sub_4711( "startup: Setup_Initial_Restart_Positions: Police Restart not setup" );
        }
    }
    for ( I = 0; I < 7; I++ )
    {
        g_U11300[I]._fU0 = 5;
        g_U11300[I]._fU4 = {0.00000000, 0.00000000, 0.00000000};
        g_U11300[I]._fU16 = 0.00000000;
    }
    sub_6048( 0, 0, 1190.96500000, 201.09010000, 31.59560000, 148.37250000 );
    sub_6048( 1, 0, 1242.93900000, 497.13550000, 27.41460000, 28.45530000 );
    sub_6048( 2, 1, 975.74330000, 1822.26000000, 19.09530000, 87.84350000 );
    sub_6048( 3, 2, -391.22820000, 1280.00800000, 22.05360000, 225.15350000 );
    sub_6048( 4, 2, 94.86770000, 147.33100000, 13.77200000, 185.87280000 );
    sub_6048( 5, 3, -1306.34600000, 1286.18800000, 20.77930000, 312.24850000 );
    sub_6048( 6, 3, -1512.16900000, 400.12190000, 18.67960000, 315.57750000 );
    for ( I = 0; I < 7; I++ )
    {
        if (g_U11300[I]._fU0 == 5)
        {
            sub_4711( "startup: Setup_Initial_Restart_Positions: Hospital Restart not setup" );
        }
    }
    return;
}

void sub_5361(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown uVar8;

    g_U11209[uParam0]._fU0 = uParam1;
    g_U11209[uParam0]._fU4 = {uParam2, uParam3, uParam4};
    g_U11209[uParam0]._fU16 = uParam5;
    uVar8 = uParam1;
    ADD_POLICE_RESTART( uParam2, uParam3, uParam4, uParam5, uVar8 );
    return;
}

void sub_6048(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown uVar8;

    g_U11300[uParam0]._fU0 = uParam1;
    g_U11300[uParam0]._fU4 = {uParam2, uParam3, uParam4};
    g_U11300[uParam0]._fU16 = uParam5;
    uVar8 = uParam1;
...
void sub_6422()
{
    ...
    StrCopy( ref g_U9277[0], "BED", 4 );
    g_U9288[0] = 10950;
    StrCopy( ref g_U9277[1], "LIJ", 4 );
    g_U9288[1] = 10900;
    StrCopy( ref g_U9277[2], "TIT", 4 );
    g_U9288[2] = 9990;
    StrCopy( ref g_U9277[3], "DVA", 4 );
    g_U9288[3] = 7240;
    StrCopy( ref g_U9277[4], "DAV", 4 );
    g_U9288[4] = 7070;
    StrCopy( ref g_U9277[5], "ASS", 4 );
    g_U9288[5] = 5650;
    StrCopy( ref g_U9277[6], "COQ", 4 );
    g_U9288[6] = 5090;
    StrCopy( ref g_U9277[7], "COK", 4 );
    g_U9288[7] = 3420;
    StrCopy( ref g_U9277[8], "COC", 4 );
    g_U9288[8] = 3150;
    StrCopy( ref g_U9277[9], "HOT", 4 );
    g_U9288[9] = 3100;
    return;
}
...
void sub_7670()
{
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "Arnaud1", 100.00000000 );
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "Arnaud2", 100.00000000 );
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "Margot1", 100.00000000 );
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "Margot2", 100.00000000 );
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "Daisy1", 100.00000000 );
    return;
}
