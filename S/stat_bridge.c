...
void sub_794()
{
    if (g_U64626[0] == 0)
    {
        switch (l_U102[0])
        {
            ...
            else if (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_121(), -709.54000000, 1167.26000000, 8.38000000, 33.60000000, 15.66000000, 9.82000000, 0 )))
            {
                l_U102[0] = 0;
            }
            break;
...
void sub_1577()
{
    if (g_U64626[1] == 0)
    {
        switch (l_U102[1])
        {
            ...
            {
                if (LOCATE_CHAR_ANY_MEANS_3D( sub_121(), 748.58400000, 605.18400000, 13, 76.20000000, 1, 13, 0 ))
                {
                    l_U102[1]++;
                }
