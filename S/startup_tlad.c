void main()
{
    ...
    {
        CREATE_PLAYER( 0, -2000.00000000 + (sub_2909( -0.25000000, 0.25000000 )), -2000.00000000 + (sub_2909( -0.25000000, 0.25000000 )), 240.00000000 + (sub_2909( -0.25000000, 0.25000000 )), ref uVar2 );
        sub_3002( GET_PLAYER_ID(), 0 );
    }
    else
    {
        sub_3309();
        sub_3458( 0, -1723.87200000, 365.51490000, 24.44390000, 0, 0, g_U10685 );
        sub_3876( uVar2 );
...
void sub_2909(unknown uParam0, unknown Result)
{
    GENERATE_RANDOM_FLOAT_IN_RANGE( uParam0, Result, ref Result );
    return Result;
}

void sub_3002(unknown uParam0, boolean bParam1)
{
    SET_PLAYER_CONTROL_FOR_NETWORK( sub_3013( uParam0 ), bParam1, 0 );
    SET_CHAR_VISIBLE( sub_3051( uParam0 ), bParam1 );
    if (bParam1)
    {
        if (NOT (IS_CHAR_IN_ANY_CAR( sub_3051( uParam0 ) )))
        {
            SET_CHAR_COLLISION( sub_3051( uParam0 ), 1 );
        }
        FREEZE_CHAR_POSITION( sub_3051( uParam0 ), 0 );
        SET_CHAR_NEVER_TARGETTED( sub_3051( uParam0 ), 0 );
        SET_PLAYER_INVINCIBLE( sub_3013( uParam0 ), 0 );
    }
    else
    {
        SET_CHAR_COLLISION( sub_3051( uParam0 ), 0 );
        FREEZE_CHAR_POSITION( sub_3051( uParam0 ), 1 );
        SET_CHAR_NEVER_TARGETTED( sub_3051( uParam0 ), 1 );
        SET_PLAYER_INVINCIBLE( sub_3013( uParam0 ), 1 );
        REMOVE_PTFX_FROM_PED( sub_3051( uParam0 ) );
        if (NOT (IS_CHAR_FATALLY_INJURED( sub_3051( uParam0 ) )))
        {
            CLEAR_CHAR_TASKS_IMMEDIATELY( sub_3051( uParam0 ) );
        }
    }
    return;
}
...
void sub_3309()
{
    ...
    for ( I = 0; I < 16; I++ )
    {
        g_U10686[I]._fU4._fU0 = 0.00000000;
        g_U10686[I]._fU4._fU4 = 0.00000000;
        g_U10686[I]._fU4._fU8 = 0.00000000;
        g_U10686[I]._fU16 = g_U10685;
        g_U10686[I]._fU0 = 0;
    }
    return;
}

void sub_3458(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    if (iParam0 > 16)
    {
        sub_3541( "Main_Missions: Store_Contact_Point(): Illegal Contact Point ID" );
    }
    ...
    {
        sub_3541( "Main_Missions: Store_Contact_Point(): Contact Point ID already setup" );
    }
    ...
    sub_3781( ref g_U10686[iParam0]._fU0, 1, uParam4 );
    sub_3781( ref g_U10686[iParam0]._fU0, 2, uParam5 );
...
void sub_3781(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (bParam2)
    {
...
void sub_3876(unknown uParam0)
{
    ...
    uVar3 = {g_U10686[0]._fU4};
    fVar6 = 240.75730000;
    g_U21 = 0;
    CREATE_PLAYER( 0, uVar3._fU0, uVar3._fU4, uVar3._fU8, ref uParam0 );
    SET_CHAR_COORDINATES( sub_3931(), uVar3._fU0, uVar3._fU4, uVar3._fU8 );
    SET_CHAR_HEADING( sub_3931(), fVar6 );
...
void sub_4084()
{
    ...
    {
        g_U11236[I]._fU0 = 5;
        g_U11236[I]._fU4 = {0.00000000, 0.00000000, 0.00000000};
        g_U11236[I]._fU16 = 0.00000000;
    }
    sub_4197( 0, 0, 1232.57200000, -89.69760000, 27.02420000, 270.80440000 );
    sub_4197( 1, 0, 896.84090000, -355.56640000, 16.63910000, 317.92790000 );
    sub_4197( 2, 0, 1232.19200000, 517.28770000, 27.57370000, 176.10820000 );
    sub_4197( 3, 0, 2172.29900000, 449.18780000, 5.08020000, 271.42560000 );
    sub_4197( 4, 1, 991.06670000, 1877.50400000, 22.89280000, 25.88270000 );
    sub_4197( 5, 1, 435.26210000, 1594.44800000, 15.33110000, 9.17450000 );
    sub_4197( 6, 2, 85.57060000, 1189.12600000, 13.75600000, 203.16790000 );
    sub_4197( 7, 2, -416.83880000, 1102.39600000, 10.72210000, 201.71590000 );
    sub_4197( 8, 2, 48.41780000, 679.95230000, 13.66270000, 88.55010000 );
    sub_4197( 9, 2, -416.18250000, 278.27630000, 10.95020000, 200.56330000 );
    sub_4197( 10, 2, 224.55200000, -215.17490000, 9.73680000, 205.17850000 );
    sub_4197( 11, 2, -378.14180000, -263.86910000, 10.04100000, 245.03360000 );
    sub_4197( 12, 3, -924.12320000, 1265.74300000, 23.57260000, 137.19690000 );
    sub_4197( 13, 3, -1716.64400000, 276.68920000, 21.20240000, 250.00490000 );
    sub_4197( 14, 3, -1223.23600000, -233.32100000, 2.03350000, 308.33580000 );
    for ( I = 0; I < 15; I++ )
    {
        if (g_U11236[I]._fU0 == 5)
        {
            sub_3541( "startup: Setup_Initial_Restart_Positions: Police Restart not setup" );
        }
    }
    for ( I = 0; I < 7; I++ )
    {
        g_U11327[I]._fU0 = 5;
        g_U11327[I]._fU4 = {0.00000000, 0.00000000, 0.00000000};
        g_U11327[I]._fU16 = 0.00000000;
    }
    sub_4884( 0, 0, 1190.96500000, 201.09010000, 31.59560000, 148.37250000 );
    sub_4884( 1, 0, 1242.93900000, 497.13550000, 27.41460000, 28.45530000 );
    sub_4884( 2, 1, 975.74330000, 1822.26000000, 19.09530000, 87.84350000 );
    sub_4884( 3, 2, -391.22820000, 1280.00800000, 22.05360000, 225.15350000 );
    sub_4884( 4, 2, 94.86770000, 147.33100000, 13.77200000, 185.87280000 );
    sub_4884( 5, 3, -1306.34600000, 1286.18800000, 20.77930000, 312.24850000 );
    sub_4884( 6, 3, -1512.16900000, 400.12190000, 18.67960000, 315.57750000 );
    for ( I = 0; I < 7; I++ )
    {
        if (g_U11327[I]._fU0 == 5)
        {
            sub_3541( "startup: Setup_Initial_Restart_Positions: Hospital Restart not setup" );
        }
    }
    return;
}

void sub_4197(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown uVar8;

    g_U11236[uParam0]._fU0 = uParam1;
    g_U11236[uParam0]._fU4 = {uParam2, uParam3, uParam4};
    g_U11236[uParam0]._fU16 = uParam5;
    uVar8 = uParam1;
    ADD_POLICE_RESTART( uParam2, uParam3, uParam4, uParam5, uVar8 );
    return;
}

void sub_4884(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown uVar8;

    g_U11327[uParam0]._fU0 = uParam1;
    g_U11327[uParam0]._fU4 = {uParam2, uParam3, uParam4};
    g_U11327[uParam0]._fU16 = uParam5;
    uVar8 = uParam1;
    ADD_HOSPITAL_RESTART( uParam2, uParam3, uParam4, uParam5, uVar8 );
    return;
}
...
void sub_5258()
{
    ...
    ALLOCATE_SCRIPT_TO_OBJECT( "air_hockey", 1261730469, 100, 50.00000000, -1 );
    sub_6472();
    ...
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "arm_wrestling", 100.00000000 );
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "hi_lo_cards", 100.00000000 );
    ...
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "ambclubhouse", 150.00000000 );
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "ambgentlemansclub", 150.00000000 );
    ...
    StrCopy( ref g_U9228[0], "BED", 4 );
    ProtectedSet(g_U9239[0], 10950);
    StrCopy( ref g_U9228[1], "LIJ", 4 );
    ProtectedSet(g_U9239[1], 10900);
    StrCopy( ref g_U9228[2], "TIT", 4 );
    ProtectedSet(g_U9239[2], 9990);
    StrCopy( ref g_U9228[3], "DVA", 4 );
    ProtectedSet(g_U9239[3], 7240);
    StrCopy( ref g_U9228[4], "DAV", 4 );
    ProtectedSet(g_U9239[4], 7070);
    StrCopy( ref g_U9228[5], "ASS", 4 );
    ProtectedSet(g_U9239[5], 5650);
    StrCopy( ref g_U9228[6], "COQ", 4 );
    ProtectedSet(g_U9239[6], 5090);
    StrCopy( ref g_U9228[7], "COK", 4 );
    ProtectedSet(g_U9239[7], 3420);
    StrCopy( ref g_U9228[8], "COC", 4 );
    ProtectedSet(g_U9239[8], 3150);
    StrCopy( ref g_U9228[9], "HOT", 4 );
    ProtectedSet(g_U9239[9], 3100);
    return;
}

void sub_6472()
{
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "Brian", 100.00000000 );
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "Dave", 100.00000000 );
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "Malc1", 100.00000000 );
    REGISTER_WORLD_POINT_SCRIPT_BRAIN( "Malc2", 100.00000000 );
    return;
}
...
void sub_8616()
{
    ...
    SET_ZONE_POPULATION_TYPE( "Znhol1", 69 );
    SET_ZONE_POPULATION_TYPE( "Znhol2", 69 );
    SET_ZONE_POPULATION_TYPE( "Znhol3", 45 );
    SET_ZONE_POPULATION_TYPE( "Znhol4", 45 );
...
void sub_12431()
{
    ...
    SET_ZONE_SCUMMINESS( "Znhol3", 4 );
    SET_ZONE_SCUMMINESS( "Znhol4", 4 );
