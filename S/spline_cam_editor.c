void main()
{
    ...
    l_U9 = 0;
    l_U16 = 0;
    sub_58( ref l_U25, 0, 0, 1120403456 );
    while (sub_2322( ref l_U25, 0 ))
    {
        WAIT( 0 );
    }
    sub_16724( ref l_U25 );
...
void sub_58(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    ...
    if (iParam0->_fU12 == 1)
    {
        sub_2267( uParam1, uParam2, uParam3 );
    }
    l_U1 = 0;
    return;
}
...
void sub_936(int iParam0)
{
    ...
    for ( I = 0; I < 16; I++ )
    {
        ...
        {
            sub_1113( ref iParam0->_fU24[I], I );
        }
    }
    return;
}

void sub_1113(int iParam0, unknown uParam1)
{
    char[16] cVar4;
...
void sub_2267(unknown uParam0, unknown uParam1, unknown uParam2)
{
    l_U18 = uParam0;
    l_U4 = 1;
    l_U5 = 0;
...
int sub_2322(int iParam0, unknown uParam1)
{
    int I;
    int J;
        ...
        if (l_U2 == 0)
        {
            ...
            if (l_U5 == 0)
            {
                ...
                for ( I = 0; I < 16; I++ )
                {
                    ...
                    {
                        sub_12784( iParam0, ref iParam0->_fU24[I] );
                ...
                if (l_U4 == 1)
                {
                    sub_13919( iParam0 );
                    DEBUG_OFF();
                    if (sub_15164( iParam0, l_U18, l_U11, l_U19 ))
                    {
                        l_U5 = 1;
                    }
                    else
...
void sub_2416(int iParam0)
{
    ...
    {
        sub_2745( ref vVar3, iParam0->_fU20 );
        uVar9 = {vVar6 + vVar3};
    }
    else if (DOES_OBJECT_EXIST( l_U20 ))
    {
...
void sub_2745(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
    ...
    uVar6 = COS( sub_2758( uParam1._fU0 ) );
    uVar7 = SIN( sub_2758( uParam1._fU0 ) );
    ...
    uVar6 = COS( sub_2758( uParam1._fU4 ) );
    uVar7 = SIN( sub_2758( uParam1._fU4 ) );
    uVar8._fU8 = (iParam0->_fU8 * uVar6) - (iParam0->_fU0 * uVar7);
    uVar8._fU0 = (iParam0->_fU8 * uVar7) + (iParam0->_fU0 * uVar6);
    iParam0->_fU8 = uVar8._fU8;
    iParam0->_fU0 = uVar8._fU0;
    uVar6 = COS( sub_2758( uParam1._fU8 ) );
    uVar7 = SIN( sub_2758( uParam1._fU8 ) );
...
void sub_10159(int iParam0, int iParam1, int iParam2)
{
    int iVar5;
    int I;
    vector vVar7;
...
void sub_11834(int iParam0, int iParam1)
{
    int iVar4;
    ...
    {
        iVar4 = iParam1 - 1;
        sub_11874( ref iParam0->_fU24[iParam1], ref iParam0->_fU24[iVar4] );
    }
    return;
}

void sub_11874(unknown uParam0, unknown uParam1)
{
    unknown uVar4;
    unknown uVar5;
    unknown uVar6;
    ...
    sub_11886( uParam0, ref uVar4 );
    sub_11886( uParam1, uParam0 );
    sub_11886( ref uVar4, uParam1 );
    return;
}

void sub_11886(unknown uParam0, unknown uParam1)
{
    (uParam1^) = {(uParam0^)};
    return;
}

void sub_12173(int iParam0, int iParam1)
{
    int iVar4;
    ...
    {
        iVar4 = iParam1 + 1;
        sub_11874( ref iParam0->_fU24[iVar4], ref iParam0->_fU24[iParam1] );
    }
    return;
}

int sub_12430(int iParam0)
{
    int Result;
    int I;
    ...
    if ((Result > -1) AND (Result < 16))
    {
        if (iParam0->_fU16 == 0)
        {
            sub_1113( ref iParam0->_fU24[Result], Result );
        }
...
int sub_12784(int iParam0, int iParam1)
{
    int Result;

    PRINTSTRING( "ADD_DUPLICATE_CAM_NODE - called \n" );
    Result = -1;
    Result = sub_12430( iParam0 );
    if (NOT (Result == -1))
    {
...
void sub_13074(int iParam0, unknown uParam1)
{
    int iVar4;
    int I;
    unknown uVar6;
    ...
    if (iParam0->_fU24[uParam1]._fU60 == 1)
    {
        ...
        if (NOT (l_U14 == nil))
        {
            ...
            {
                sub_14169( l_U21, ref iParam0->_fU24[uParam1]._fU32, ref uVar6 );
            }
            if (iParam0->_fU24[uParam1]._fU80 == 0)
            {
            ...
            {
                sub_14169( l_U22, ref uVar6, ref iParam0->_fU24[uParam1]._fU44 );
            }
...
void sub_13239(unknown uParam0, unknown uParam1)
{
    if (NOT l_U10)
    {
...
void sub_14169(unknown uParam0, int iParam1, int iParam2)
{
    unknown uVar5;
    unknown uVar6;
    unknown uVar7;
    ...
    uVar17._fU4 = 0.00000000;
    uVar17._fU8 = uVar24 * -1.00000000;
    sub_2745( iParam2, uVar17 );
    return;
}

int sub_15164(int iParam0, unknown uParam1, boolean bParam2, unknown uParam3)
{
    int I;
    int iVar7;
    unknown uVar8;
    ...
    if (iParam0->_fU0 >= 4)
    {
        ...
        for ( I = 0; I < 16; I++ )
        {
            if (iParam0->_fU24[I]._fU88 == 1)
            {
                ...
                {
                    sub_15452( ref iParam0->_fU24[I], 14, bParam2, uParam3 );
                }
                else
                {
...
void sub_15452(int iParam0, unknown uParam1, boolean bParam2, unknown uParam3)
{
    unknown uVar6;
...
void sub_17208(unknown uParam0)
{
    if (NOT l_U10)
    {
