...
void sub_18505()
{
    ...
    {
        iVar3 = sub_18533( 16 );
        if ((sub_18578( 16, iVar3 )) AND (g_U10994[g_U11236[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_18533( 14 );
        if ((sub_18578( 14, iVar3 )) AND (g_U10994[g_U11327[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_19011( I );
        if ((sub_18578( g_U11583[I]._fU12, iVar3 )) AND (g_U10994[g_U11583[I]._fU28]._fU0))
        {
...
void sub_19548()
{
    ...
    for ( I = 0; I < 65; I++ )
    {
        if ((sub_19011( I )) AND (g_U10994[g_U11583[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
int sub_33218(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    if (NOT (iParam1 == nil))
    {
        if ((sub_33290()) || (IS_CHAR_INJURED( iParam1 )))
        {
            l_U505 = 1;
            l_U506 = 0;
...
void sub_44163(unknown uParam0, unknown uParam1)
{
    ...
    if ((NOT sub_44224()) || (NOT sub_35416()))
    {
        return;
    }
    sub_36918();
...
{
    if ((NOT (sub_35343( uParam0 ))) || (NOT (HAS_MODEL_LOADED( sub_44806( uParam0 ) ))))
    {
        sub_35382( uParam0 );
...
void sub_45085(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_45119( vParam0 + (vector( 2.00000000, 0.00000000, 0.00000000)), uParam3, uParam4, iParam6 );
...
void sub_45129(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((((((uParam0^) == (sub_17377( 0 ))) || ((uParam0^) == (sub_17377( 1 )))) || ((uParam0^) == (sub_17377( 6 )))) || ((uParam0^) == (sub_17377( 7 )))) || ((uParam0^) == (sub_17377( 13 )))) || ((uParam0^) == (sub_17377( 16 ))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_17377( 15 ))) || ((uParam0^) == (sub_17377( 17 ))))
        {
            Result = 3;
        }
    }
...
void sub_45845(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_17377( 6 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_17377( 7 ) ))))
        {
            sub_46341( iParam0 );
        }
    }
...
{
    return (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 )) AND (NOT (sub_50206( uParam0, uParam1 )));
}
...
void sub_51734(int iParam0, unknown uParam1, int iParam2, int iParam3)
{
    ...
    if (Result)
    {
        ...
        if (iParam3 != 39)
        {
            if ((iParam3 == 38) AND (IS_CHAR_MODEL( iParam0, sub_17377( 0 ) )))
            {
                if (l_U172)
                {
...
void sub_62683()
{
    ...
    sub_63011( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18770000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
...
int sub_65162(unknown uParam0, unknown uParam1, unknown uParam2)
{
        ...
        for ( I = 0; I < 16; I++ )
        {
            if (l_U514 == -1)
            {
                if (sub_66098( I ))
                {
                    ...
                    if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[I]._fU4._fU0, l_U611[I]._fU4._fU4, fVar8, 2.50000000, 2.50000000, 2.50000000, iVar9 )) AND (NOT (sub_37488( sub_1568() )))) AND (sub_66309( 1, 1 )))
                    {
    ...
    if (l_U502 == 2)
    {
        if ((sub_66818( uParam0 )) || (iVar5 > l_U984))
        {
            l_U514 = l_U985;
            l_U502 = 3;
        }
...
int sub_82336(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    {
        bVar6 = true;
        if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )) AND (NOT (sub_37488( sub_1568() ))))
        {
...
void sub_101718(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U1178 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_1568() )))
        {
            if ((sub_101841( uParam1, 20.00000000 )) || (iVar5 > l_U1208))
            {
                l_U1178++;
            }
            else
...
int sub_105639(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((sub_105711( Result )) AND (NOT (sub_105774( iVar4 ))))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U986[Result]._fU4._fU8;
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U986[Result]._fU4._fU0, l_U986[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_37488( sub_1568() )))) AND (sub_66309( 1, 1 )))
            {
...
int sub_106066(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_106125( Result ))
        {
            ...
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[Result]._fU4._fU0, l_U611[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_37488( sub_1568() )))) AND (sub_66309( 1, 1 )))
            {
                if (IS_CHAR_ON_FOOT( sub_1568() ))
                {
                    if (sub_101841( uParam0, 1092616192 ))
...
int sub_124922(unknown uParam0)
{
    ...
    if ((((sub_125012( uParam0, "Bada_room1" )) || (sub_125012( uParam0, "Bada-Private" ))) || (sub_125012( uParam0, "Bada_room2" ))) || (sub_125012( uParam0, "Bada_room1" )))
    {
        return 1;
    }
    if ((((sub_125012( uParam0, "clammainroom" )) || (sub_125012( uParam0, "clampalbkrm" ))) || (sub_125012( uParam0, "clamfronrm" ))) || (sub_125012( uParam0, "clammainroom" )))
    {
        return 1;
    }
    return 0;
...
void sub_126390(unknown uParam0)
{
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if ((sub_139866( ref l_U465 )) || ((sub_69158( l_U465 )) > 5))
                {
                    bVar5 = true;
                }
            }
...
void sub_126566(unknown uParam0)
{
    ...
    if ((IS_CHAR_DEAD( sub_1568() )) || (sub_126589( uParam0 )))
    {
        return;
    }
    if ((IS_CHAR_ON_ANY_BIKE( sub_1568() )) || (sub_126830( uParam0 )))
    {
        sub_126970( uParam0 );
        return;
    }
...
int sub_128436(unknown uParam0)
{
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( sub_1568() ))) AND (NOT (sub_126589( uParam0 ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_1568() ))
            {
...
int sub_129320(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((NOT g_U18635[uParam0]._fU892._fU28) AND (uParam2))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((sub_129489( uParam0, I )) AND (NOT (sub_129754( uParam0, I ))))
            {
...
void sub_129443()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if (((sub_129489( 1, I )) || (sub_129489( 6, I ))) || (sub_129489( 7, I )))
        {
            sub_129581( 1, I );
            sub_129581( 6, I );
            sub_129581( 7, I );
        ...
        if (((sub_129754( 1, I )) || (sub_129754( 6, I ))) || (sub_129754( 7, I )))
        {
            sub_129846( 1, I );
            sub_129846( 6, I );
            sub_129846( 7, I );
...
int sub_140935(int iParam0)
{
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_45884( iParam0 + 0 )) == 3) AND ((sub_141078( iVar3 )) == sub_141107())))
        {
            if ((((sub_45884( iParam0 + 0 )) != 1) || ((sub_141153( iParam0->_fU0 )) == (sub_17377( 0 )))) || ((sub_141195( sub_1568() )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1568() )))))
            {
                return 0;
            }
            else
...
int sub_141351(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((sub_141195( iParam0->_fU0 )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))))
    {
        return 2;
    }
    else if ((uParam1) || (sub_94683( iParam0, 1 )))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_141907(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if (((sub_141973( (iParam0^) )) AND (NOT l_U154)) AND (NOT l_U155))
            {
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_139350()))
                {
        ...
        {
            if ((((((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_1568(), iParam0->_fU0, l_U145, l_U145, l_U145, 0 ))) || (NOT (IS_CHAR_ON_ANY_BIKE( sub_1568() )))) || (NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )))) || (NOT (sub_69174( l_U147 ))))
            {
                sub_143360( iParam0 );
            }
        }
...
void sub_143523(int iParam0)
{
    ...
    if ((sub_141938( (iParam0^) )) AND (sub_139350()))
    {
    ...
    if (((sub_139350()) || (sub_141938( (iParam0^) ))) || ((iVar4 - l_U165) < 33))
    {
        return;
    }
    if (l_U165 <= 0)
    ...
    if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_144450( uVar12 ))
            {
                ...
                if (((NOT (sub_141938( (iParam0^) ))) AND (((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) AND (fVar21 < 19)) || (fVar21 < 15))) AND (iParam0->_fU0 != l_U167))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((l_U104) AND ((iParam0->_fU36 != 1) || ((sub_52568( 0, 10 )) == 0)))
                    {
                        l_U104 = 0;
                        iVar15 = 17;
                        iVar11 = sub_1568();
                    }
                    else if ((((sub_144687( iParam0 )) AND (iParam0->_fU36 == 2)) AND ((sub_45884( iParam0 + 0 )) == 1)) AND (NOT (IS_BIT_SET( l_U170, 6 ))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_144801( bVar16 );
                        iVar11 = sub_1568();
                    }
                    else if (((IS_CAR_IN_AIR_PROPER( uVar12 )) AND ((ABSF( uVar22 )) < 20.00000000)) AND (sub_144889( 8 )))
                    {
                        uVar13 = sub_51394( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_1568() )) AND (sub_144889( 12 )))
                    {
                        uVar13 = sub_144801( bVar16 );
                        iVar11 = sub_1568();
                        iVar15 = 12;
                    ...
                    else if (((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 )) || (IS_PED_RAGDOLL( iParam0->_fU0 ))) AND (sub_144889( 13 )))
                    {
                        uVar13 = sub_144801( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if (((((sub_45884( iParam0 + 0 )) == 1) AND (NOT (IS_PLAYER_PRESSING_HORN( sub_4209() )))) AND (IS_BIT_SET( l_U170, 7 ))) AND (sub_144889( 20 )))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if ((((IS_WANTED_LEVEL_GREATER( sub_4209(), 0 )) AND (NOT (IS_BIT_SET( l_U170, 0 )))) AND (sub_144889( 24 ))) AND ((sub_45884( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 24;
                        iVar11 = sub_1568();
                    }
                    else if ((((NOT (IS_WANTED_LEVEL_GREATER( sub_4209(), 0 ))) AND (IS_BIT_SET( l_U170, 0 ))) AND (sub_144889( 30 ))) AND ((sub_45884( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_144889( 33 )) AND (NOT (IS_BIT_SET( l_U170, 4 )))) AND ((sub_45884( iParam0 + 0 )) == 1))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_144889( 31 )) AND (NOT (IS_BIT_SET( l_U170, 4 )))) AND ((sub_45884( iParam0 + 0 )) == 1))
                                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((sub_144889( 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_4209(), 0 ))))
                                {
                                ...
                                else if (((sub_144889( 36 )) AND (IS_WANTED_LEVEL_GREATER( sub_4209(), 0 ))) AND (NOT (IS_BIT_SET( l_U170, 1 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((IS_WANTED_LEVEL_GREATER( sub_4209(), 2 )) AND (sub_144889( 23 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if ((sub_144889( 28 )) AND ((sub_45884( iParam0 + 0 )) == 1))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_144889( 3 )) AND (sub_144889( 4 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if (((sub_45884( iParam0 + 0 )) == 1) AND (fVar26 < 5))
                            {
                                if ((sub_144889( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_4209(), 0 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if ((sub_144889( 30 )) AND ((sub_45884( iParam0 + 0 )) == 1))
                                {
                                    iVar15 = 30;
                                }
...
int sub_149362(int iParam0)
{
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            {
                if (((sub_45884( ref iVar4 )) == (sub_45884( iParam0 + 0 ))) || ((iVar4 == sub_1568()) AND ((sub_45884( iParam0 + 0 )) == 1)))
                {
...
int sub_149619(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((((IS_CHAR_IN_CAR( sub_1568(), iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((sub_144513( iParam0->_fU0, sub_1568(), 1 )) < 90.00000000))
        {
...
int sub_150355(unknown uParam0)
{
    ...
    if (IS_PED_IN_GROUP( uParam0 ))
    {
        ...
        if (DOES_GROUP_EXIST( iVar3 ))
        {
            ...
            {
                if (((iVar4 < 1) || (iVar5 < 2)) AND (iVar3 != sub_17798()))
                {
                    REMOVE_GROUP( iVar3 );
                }
                else
            ...
            else if ((iVar5 < 1) AND (iVar3 != sub_17798()))
            {
                REMOVE_GROUP( iVar3 );
            }
        }
...
int sub_150751(int iParam0)
{
    ...
    if ((NOT (sub_94683( iParam0, 2 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        return 0;
    }
...
int sub_151286(int iParam0)
{
    ...
    else if ((((sub_148408( iParam0 )) > 90.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND ((sub_144513( iParam0->_fU0, sub_1568(), 1 )) > 90.00000000))
    {
        ...
        {
            if (((CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 )) || (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 ))) || ((VDIST( sub_141696( sub_1568(), 1 ), uVar4 )) < 30.00000000))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_152058(int iParam0)
{
    ...
    if ((sub_94683( iParam0, 1 )) AND ((sub_148408( iParam0 )) < 30.00000000))
    {
        SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( iParam0->_fU0, 1 );
    ...
    if ((NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))) AND ((((IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 )) || (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 ))) || (DOES_VEHICLE_EXIST( iVar4 ))) || ((sub_144513( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8)))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((sub_50206( iParam0->_fU8, iParam0->_fU4 )) || (iParam0->_fU4 == iVar4))
            {
            ...
            else if ((sub_50206( sub_1568(), iParam0->_fU4 )) AND ((sub_45884( iParam0 + 0 )) == 1))
            {
    ...
    else if (((sub_149657( sub_1568(), iParam0->_fU0, 1 )) AND (iParam0->_fU8 != sub_1568())) AND ((sub_45884( iParam0 + 0 )) == 1))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((NOT (sub_94683( iParam0, 1 ))) || (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
        {
            if ((sub_141513( iParam0 )) != 0)
            {
                ;
    ...
    else if ((sub_94683( iParam0, 1 )) AND (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))))
    {
...
int sub_153811(int iParam0)
{
    ...
    else if ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_144493( iParam0 )) > 30.00000000))
    {
...
int sub_154222(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((VDIST( uVar4, uVar10 )) < 30.00000000)) || ((VDIST( uVar4, uVar7 )) < 30.00000000))
        {
            ...
            else if ((iVar3 == sub_1568()) || ((sub_45884( ref iVar3 )) == (sub_45884( iParam0 + 0 ))))
            {
...
int sub_155048(int iParam0)
{
    ...
    if ((((IS_PED_IN_COMBAT( iParam0->_fU0 )) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 ))) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 ))) AND ((sub_148408( iParam0 )) < 30.00000000))
    {
        return 2;
    }
    return 0;
...
int sub_155197(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_148936( iParam0->_fU4 )) || (sub_94683( iParam0, 4 ))) AND ((sub_144493( iParam0 )) >= l_U125))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 ))) AND ((VDIST( uVar15, sub_141696( sub_1568(), 1 ) )) > fParam2)) AND ((VDIST2( uVar15, vVar6 )) > 9.00000000))
                    {
...
void sub_162251(unknown uParam0)
{
    ...
    if ((((((((IS_CONTROL_PRESSED( 0, 51 )) AND (NOT (IS_CONTROL_PRESSED( 0, 38 )))) AND (NOT (IS_CONTROL_PRESSED( 0, 39 )))) AND (IS_CHAR_ON_ANY_BIKE( sub_1568() ))) AND (NOT sub_164597())) AND (NOT (iVar14 == 4))) AND (iVar8 >= 0)) AND (NOT bVar4))
    {
...
void sub_162486(unknown uParam0)
{
    ...
    {
        if (((sub_162522( uParam0, I )) AND (I != l_U110)) AND (Result < 0))
        {
            Result = I;
        }
    }
...
void sub_165181(unknown uParam0)
{
    ...
    if (HAS_SCRIPT_LOADED( "ability_stats" ))
    {
        if (NOT g_U39103)
        {
            if ((((((NOT sub_164597()) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ability_stats" )) == 0)) AND (NOT sub_167669())) AND (NOT IS_MINIGAME_IN_PROGRESS())) AND (NOT g_U11112)) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))
            {
                if (NOT l_U1220)
                {
...
int sub_167669()
{
    ...
    {
        if ((ARE_WIDESCREEN_BORDERS_ACTIVE()) AND (sub_167703()))
        {
            return 1;
        }
