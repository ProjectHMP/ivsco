void main()
{
    ...
    while (true)
    {
        ...
        if ((DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( 865.70000000, -517.80000000, 16.50000000, 1.00000000, -1452339441 )) AND (NOT l_U2432))
        {
        ...
        switch (l_U2434)
        {
            ...
            else if ((DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( 850.80000000, -517.80000000, 16.50000000, 1.00000000, 257820338 )) AND (NOT l_U2406))
            {
            ...
            {
                if ((sub_32132( 1, 1 )) AND (NOT (sub_32422( sub_3201() ))))
                {
                    sub_32688();
                    l_U2434 = 3;
                }
            ...
            if (((NOT l_U2398) AND (NOT (IS_CHAR_DEAD( l_U2381 )))) AND (NOT (IS_CAR_DEAD( l_U2383 ))))
            {
            ...
            if (NOT l_U2402)
            {
                if (NOT l_U2401)
                {
                    if (NOT (IS_CHAR_INJURED( l_U2381 )))
                    {
                        ...
                        {
                            if ((NOT (IS_VEH_DRIVEABLE( l_U2383 ))) || (sub_76479( l_U2383 )))
                            {
            ...
            if (((NOT (IS_CHAR_DEAD( l_U2381 ))) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U2381 )))) AND (NOT l_U2401))
            {
            ...
            if (((((NOT l_U2401) AND (NOT (IS_CHAR_DEAD( l_U2381 )))) AND (NOT (IS_CAR_DEAD( l_U2383 )))) AND (NOT l_U2399)) AND (TIMERB() > 20000))
            {
                TASK_CAR_DRIVE_WANDER( l_U2381, l_U2383, 20.00000000, 2 );
                l_U2399 = 1;
            }
            if (((NOT l_U2401) AND (NOT (IS_CAR_DEAD( l_U2383 )))) AND (NOT (IS_CHAR_DEAD( l_U2381 ))))
            {
                PRINTNL();
            ...
            if (NOT (IS_CHAR_FATALLY_INJURED( l_U2381 )))
            {
                ...
                else
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( l_U2381 )))
                    {
                        ...
                        {
                            if (((NOT (IS_VEH_DRIVEABLE( l_U2383 ))) || (sub_76479( l_U2383 ))) AND (NOT l_U2402))
                            {
                                TASK_LEAVE_ANY_CAR( l_U2381 );
                                l_U2402 = 1;
                            }
                        ...
                        if ((NOT (HAS_CHAR_GOT_WEAPON( sub_3201(), 57 ))) AND (NOT l_U2402))
                        {
                            TASK_LEAVE_ANY_CAR( l_U2381 );
                            l_U2402 = 1;
                        }
...
void sub_2030()
{
    ...
    {
        if (((sub_2068( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3682()
{
    ...
    sub_17080( 12 );
    FORCE_WEATHER_NOW( 1 );
    SWITCH_PED_PATHS_OFF( 846.83070000, -519.92540000, 0.00000000, 865.75290000, -511.43260000, 100.00000000 );
    ADD_SCENARIO_BLOCKING_AREA( 846.83070000, -519.92540000, 0.00000000, 865.75290000, -511.43260000, 100.00000000 );
...
void sub_18254()
{
    ...
    switch (l_U2434)
    {
        ...
        else
        {
            ...
            SET_CHAR_COORDINATES( sub_3201(), 854.78000000, -516.67960000, 15.27760000 );
...
void sub_22023()
{
    ...
    while ((NOT bVar3) AND (NOT bVar4))
    {
        ...
        if (((iVar7 >= 1000) AND (sub_22101())) AND (IS_SCREEN_FADED_IN()))
        {
        ...
        else
        {
            switch (iVar2)
            {
                ...
                break;
                case 2:
                if ((NOT bVar10) AND (IS_CHAR_PLAYING_ANIM( sub_3201(), "missnet1", "open_doorv2" )))
                {
                    GET_CHAR_ANIM_CURRENT_TIME( sub_3201(), "missnet1", "open_doorv2", ref l_U2428 );
                ...
                if (TIMERA() > 3500)
                {
                    ...
                    SET_CAM_FOV( l_U2391[0], 45 );
                    SET_CAM_POS( l_U2391[1], 856.22000000, -512.65000000, 16.00000000 );
                ...
                if (TIMERA() > 10000)
                {
                    if ((NOT (sub_29888( l_U2414 ))) AND (sub_30051() == 6))
                    {
                        bVar3 = true;
                    }
                }
...
int sub_26063(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3201() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3201() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_26578()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_32688()
{
    ...
    while ((NOT bVar6) AND (NOT bVar7))
    {
        ...
        if (((iVar5 >= 1000) AND (sub_22101())) AND (IS_SCREEN_FADED_IN()))
        {
            DO_SCREEN_FADE_OUT( 500 );
            while (NOT IS_SCREEN_FADED_OUT())
            {
        ...
        else
        {
            switch (iVar2)
            {
                ...
                while ((((((NOT (HAS_MODEL_LOADED( -1984134881 ))) || (NOT (HAS_MODEL_LOADED( 697247370 )))) || (NOT (HAS_MODEL_LOADED( -1180674815 )))) || (NOT (HAS_MODEL_LOADED( 1349725314 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 2949 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 209 ))))
                {
                    WAIT( 0 );
                }
                ...
                if ((((((NOT (sub_33442( uVar13 ))) AND (NOT (IS_THIS_MODEL_A_BOAT( uVar13 )))) AND (NOT (IS_THIS_MODEL_A_PLANE( uVar13 )))) AND (NOT (IS_THIS_MODEL_A_HELI( uVar13 )))) AND (NOT (IS_THIS_MODEL_A_TRAIN( uVar13 )))) AND (NOT (IS_THIS_MODEL_A_BIKE( uVar13 ))))
                {
                    bVar14 = true;
                }
                ...
                break;
                case 3:
                if (((NOT (IS_CHAR_DEAD( l_U2381 ))) AND (NOT (IS_CHAR_DEAD( l_U2380 )))) AND (NOT (IS_CAR_DEAD( l_U2383 ))))
                {
                    if ((TIMERA() > 500) AND (NOT bVar11))
                    {
                ...
                if (NOT (IS_CHAR_DEAD( l_U2380 )))
                {
                    if (IS_CHAR_PLAYING_ANIM( l_U2380, "missnet1", "walk_up_to_car" ))
                    {
                        ...
                        if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (l_U2426 > 0.20000000))
                        {
                            sub_30159( ref l_U2414, 0 );
                ...
                break;
                case 5:
                if ((NOT (IS_CHAR_DEAD( l_U2381 ))) AND (TIMERA() > 4000))
                {
                    UNPOINT_CAM( l_U2389 );
                ...
                break;
                case 7:
                if ((NOT (IS_CHAR_DEAD( l_U2381 ))) AND (TIMERA() > 4500))
                {
                    bVar6 = true;
                }
                break;
...
void sub_38238(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3201() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_38406())) AND (iVar3 != 4))
    {
...
void sub_38977()
{
    ...
    l_U1750[62] = {-437.70210000, 30.73000000, 9.58950000};
    l_U561[62] = -0.03330000;
    l_U677[62] = 0.00700000;
    l_U793[62] = 0.71100000;
    l_U909[62] = 0.70240000;
    l_U1315[62] = 2912;
    ...
    l_U1750[64] = {-457.76030000, 39.55160000, 9.42320000};
    ...
    l_U1750[69] = {-453.13070000, 127.91700000, 9.40840000};
    ...
    l_U1750[72] = {-458.55300000, 149.22720000, 9.71100000};
    ...
    l_U1750[81] = {-438.26740000, 264.30930000, 9.57210000};
    ...
    l_U1750[99] = {-360.46870000, 604.08480000, 14.35890000};
    ...
    l_U1750[110] = {-361.06620000, 807.22830000, 14.26750000};
    ...
    l_U2096[22] = {-365.84170000, 711.29550000, 14.34820000};
...
void sub_57159()
{
    if ((NOT (IS_CHAR_DEAD( l_U2381 ))) AND (NOT l_U2431))
    {
        GET_CHAR_COORDINATES( l_U2381, ref l_U2420._fU0, ref l_U2420._fU4, ref l_U2420._fU8 );
        if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_3201(), l_U2420._fU0, l_U2420._fU4, l_U2420._fU8, 165.00000000, 165.00000000, 165.00000000, 0 ))) AND (NOT (IS_CHAR_ON_SCREEN( l_U2381 ))))
        {
            CLEAR_SMALL_PRINTS();
            sub_57300( 0 );
        }
...
void sub_61253(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U505)
    {
        ...
        if ((l_U1295 == 0) || (IS_SCREEN_FADED_OUT()))
        {
            iVar10 = 1;
        }
...
void sub_63135(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 115; I++ )
        {
            ...
            if (l_U1431[I] == 0)
            {
                if (((l_U1315[I] > 0) AND (l_U1315[I] < 3000)) AND (NOT (l_U1602[I] == 0)))
                {
                    if (NOT l_U493)
                    {
            ...
            if (l_U1431[I] == 2)
            {
                if (HAS_MODEL_LOADED( l_U1602[I] ))
                {
                    if (NOT (DOES_VEHICLE_EXIST( l_U2206[I] )))
                    {
                        ...
                        {
                            bVar17 = false;
                            if ((NOT (sub_62662( l_U1750[I], 5.00000000, 1120403456 ))) AND (NOT (sub_64451( l_U1750[I] ))))
                            {
                                bVar17 = true;
                            }
                            if (l_U519)
                        ...
                        if (14 > l_U1585)
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1315[I] ))
                            {
                                if (fVar14 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1315[I] )))
                                {
                                    ...
                                    if ((NOT (sub_62662( uVar8, 5.00000000, 1120403456 ))) AND (sub_62662( uVar11, 5.00000000, 1120403456 )))
                                    {
                                        sub_63535( I, 1090519040 );
                                    }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2206[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_3083() ))
                                {
                                    if ((((IS_CHAR_TOUCHING_VEHICLE( sub_3201(), l_U2206[I] )) AND (NOT l_U499)) AND (NOT l_U496)) AND (NOT l_U508))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_3201() ))
                                        {
                                            bVar16 = false;
                                    ...
                                    else if ((sub_67308( uParam0, l_U2206[I] )) AND (NOT l_U508))
                                    {
                                        sub_67181( l_U2206[I] );
                                        l_U1431[I]++;
                                    }
        ...
        if (IS_PLAYER_PLAYING( sub_3083() ))
        {
            ...
            for ( I = 0; I < 115; I++ )
            {
                ...
                if (DOES_VEHICLE_EXIST( l_U2206[I] ))
                {
                    if (IS_VEH_DRIVEABLE( l_U2206[I] ))
                    {
                        if ((sub_68763( l_U2206[I], (uParam0^) )) || (sub_68763( l_U2206[I], uVar6 )))
                        {
            ...
            if (l_U1559[I] == 1)
            {
                if (1 > l_U1588)
                {
                    if (HAS_MODEL_LOADED( l_U1718[I] ))
                    {
                        ...
                        {
                            if (((NOT (sub_62662( l_U2096[I], 5.00000000, 1120403456 ))) || (l_U493)) || (l_U519))
                            {
                                if (l_U512)
                                {
...
void sub_70617(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 5; I++ )
        {
            if (((l_U1547[I] > 0) AND (l_U1547[I] < 3000)) AND (NOT (l_U1744[I] == 0)))
            {
                if (l_U1553[I] == 0)
                {
                    if (NOT l_U493)
                ...
                if (l_U1553[I] == 2)
                {
                    if (HAS_MODEL_LOADED( l_U1744[I] ))
                    {
                        if (NOT (DOES_VEHICLE_EXIST( l_U2363[I] )))
                        {
                            ...
                            if (bVar15)
                            {
                                if ((NOT (sub_62662( l_U2172[I], 5.00000000, 1120403456 ))) || (l_U519))
                                {
                            ...
                            if (6 > l_U1587)
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1547[I] ))
                                {
                                    if (fVar13 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1547[I] )))
                                    {
                                        ...
                                        if (((NOT (sub_62662( uVar7, 5.00000000, 1120403456 ))) AND (sub_62662( uVar10, 5.00000000, 1120403456 ))) AND (NOT l_U519))
                                        {
                                            l_U1587++;
                                            l_U1553[I]++;
                                        }
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2363[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_3083() ))
                                    {
                                        if (((IS_CHAR_TOUCHING_VEHICLE( sub_3201(), l_U2363[I] )) AND (NOT l_U499)) AND (NOT l_U496))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_3201() ))
                                            {
                                                bVar15 = false;
...
int sub_74341(unknown uParam0, unknown uParam1)
{
    ...
    if (((l_U1599 == 0) AND (l_U1600 == 0)) AND (l_U1601 == 0))
    {
        l_U496 = 0;
        l_U493 = 0;
        l_U522 = 0;
...
void sub_74781()
{
    ...
    {
        if (((l_U2426 > 112800) AND (l_U2426 < 114000)) AND (NOT l_U2446[0]))
        {
    ...
    {
        if (((l_U2426 > 177500) AND (l_U2426 < 179000)) AND (NOT l_U2446[1]))
        {
    ...
    {
        if (((l_U2426 > 42500) AND (l_U2426 < 44000)) AND (NOT l_U2446[2]))
        {
    ...
    {
        if (((l_U2426 > 63000) AND (l_U2426 < 64200)) AND (NOT l_U2446[3]))
        {
    ...
    {
        if (((l_U2426 > 89000) AND (l_U2426 < 90200)) AND (NOT l_U2446[4]))
        {
    ...
    {
        if (((l_U2426 > 177000) AND (l_U2426 < 179000)) AND (NOT l_U2446[5]))
        {
...
void sub_75338()
{
    switch (l_U2444)
    {
        ...
        {
            CREATE_OBJECT( 1745156571, -94.67980000, -280.98150000, 13.40000000, ref l_U2440[0], 1 );
    ...
    if (((l_U2444 > 2) AND (IS_CHAR_IN_AREA_2D( sub_3201(), -96.00000000, -267.00000000, -87.90000000, -244.40000000, 0 ))) AND (NOT l_U2443))
    {
    ...
    if ((NOT (IS_CHAR_DEAD( l_U2381 ))) AND (NOT (IS_CAR_DEAD( l_U2383 ))))
    {
        if (IS_CHAR_IN_CAR( l_U2381, l_U2383 ))
        {
            if (NOT l_U2409)
            {
                if (l_U2410 < 3)
                {
                    if ((((((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U2383, sub_3201() )) || ((IS_CHAR_PLAYING_ANIM( sub_3201(), "veh@low", "d_locked_ps" )) || (IS_CHAR_PLAYING_ANIM( sub_3201(), "veh@low", "d_locked_ds" )))) || ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3201(), l_U2381, 3.00000000, 3.00000000, 3.00000000, 0 )) AND (l_U2410 == 0))) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_29888( l_U2414 )))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3201(), l_U2381, 10.00000000, 10.00000000, 10.00000000, 0 )))
                    {
