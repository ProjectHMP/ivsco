void main()
{
    ...
    while (bVar2)
    {
        ...
        sub_519();
        bVar2 = false;
        if ((NOT (IS_PLAYER_PLAYING( sub_136() ))) || (g_U10978))
        {
            bVar2 = true;
        }
        if (NOT bVar2)
        {
            bVar3 = false;
            if ((IS_CHAR_IN_AREA_3D( sub_192(), 895.83970000, -508.20070000, 11.99860000, 898.71890000, -501.63750000, 16.15140000, 0 )) AND (IS_CHAR_ON_FOOT( sub_192() )))
            {
                bVar3 = true;
            }
            if (NOT bVar3)
...
int sub_2239()
{
    ...
    if (l_U0 == 2)
    {
        if (TIMERA() > 0)
        {
            SET_CAM_POS( l_U1, 927.91600000, -508.46040000, 14.67776000 );
            SET_CAM_ROT( l_U1, 3.61105500, 0.00000000, 70.63023000 );
            ...
            if (NOT (IS_CHAR_DEAD( sub_192() )))
            {
                ...
                TASK_LOOK_AT_COORD( sub_192(), 927.91600000, -508.46040000, 14.67776000, -2, 0 );
            }
            SETTIMERA( 0 );
            l_U0++;
        }
...
int sub_2680()
{
    ...
    if (l_U0 == 4)
    {
        if ((TIMERA() > 9000) || (NOT (sub_398( l_U10 ))))
        {
            l_U0++;
        }
    }
...
int sub_3198()
{
    ...
    if (l_U0 == 4)
    {
        if ((TIMERA() > 5000) || (NOT (sub_398( l_U10 ))))
        {
            l_U0++;
        }
    }
