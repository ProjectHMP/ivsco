void main()
{
    ...
    while (true)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_388() ))
        {
            ...
            {
                case 0:
                if ((HAS_OBJECT_BEEN_UPROOTED( l_U7 )) || (HAS_OBJECT_BEEN_DAMAGED( l_U7 )))
                {
                    sub_503( "Computer has been uprooted, or damaged" );
                    sub_520();
                }
                if ((g_U951) || ((g_U952) AND (NOT l_U6)))
                {
                    break;
                }
                ...
                else if ((sub_1645( 2, "USE_COMPUTER", 0 )) AND (NOT IS_REPLAY_SAVING()))
                {
                    ...
                    g_U10700 = START_NEW_SCRIPT_WITH_ARGS( "computerMain", ref l_U7, 1, 1024 );
                ...
                iVar15 = 2;
                case 2:
                if (((NOT (IS_BUTTON_PRESSED( 0, 4 ))) AND (IS_USING_CONTROLLER())) || ((NOT IS_USING_CONTROLLER()) AND (IS_CONTROL_PRESSED( 2, 23 ))))
                {
                    if (TIMERA() >= 2000)
                    {
                        iVar15 = 0;
...
int sub_1269(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_388() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_388() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_388() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_1365())
                    {
