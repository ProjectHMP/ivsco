...
void sub_18526()
{
    ...
    {
        iVar3 = sub_18554( 16 );
        if ((sub_18599( 16, iVar3 )) AND (g_U10994[g_U11236[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_18554( 14 );
        if ((sub_18599( 14, iVar3 )) AND (g_U10994[g_U11327[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_19032( I );
        if ((sub_18599( g_U11583[I]._fU12, iVar3 )) AND (g_U10994[g_U11583[I]._fU28]._fU0))
        {
...
void sub_19569()
{
    ...
    for ( I = 0; I < 65; I++ )
    {
        if ((sub_19032( I )) AND (g_U10994[g_U11583[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
void sub_45161(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((((((uParam0^) == (sub_17380( 0 ))) || ((uParam0^) == (sub_17380( 1 )))) || ((uParam0^) == (sub_17380( 6 )))) || ((uParam0^) == (sub_17380( 7 )))) || ((uParam0^) == (sub_17380( 13 )))) || ((uParam0^) == (sub_17380( 16 ))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_17380( 15 ))) || ((uParam0^) == (sub_17380( 17 ))))
        {
            Result = 3;
        }
    }
...
void sub_45877(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_17380( 6 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_17380( 7 ) ))))
        {
            sub_46373( iParam0 );
        }
    }
...
void sub_51766(int iParam0, unknown uParam1, int iParam2, int iParam3)
{
    ...
    if (Result)
    {
        ...
        if (iParam3 != 39)
        {
            if ((iParam3 == 38) AND (IS_CHAR_MODEL( iParam0, sub_17380( 0 ) )))
            {
                if (l_U172)
                {
...
void sub_56059()
{
    ...
    sub_56387( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18770000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
...
int sub_65198(unknown uParam0, unknown uParam1, unknown uParam2)
{
        ...
        for ( I = 0; I < 6; I++ )
        {
            if (l_U514 == -1)
            {
                if (sub_66045( I ))
                {
                    ...
                    if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[I]._fU4._fU0, l_U611[I]._fU4._fU4, fVar8, 2.50000000, 2.50000000, 2.50000000, iVar9 )) AND (NOT (sub_37520( sub_1568() )))) AND (sub_66256( 1, 1 )))
                    {
    ...
    if (l_U502 == 2)
    {
        if ((sub_66765( uParam0 )) || (iVar5 > l_U687))
        {
            l_U514 = l_U688;
            l_U502 = 3;
        }
...
void sub_100792(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U1176 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_1568() )))
        {
            if ((sub_100915( uParam1, 20.00000000 )) || (iVar5 > l_U1206))
            {
                l_U1176++;
            }
            else
...
int sub_104709(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((sub_104781( Result )) AND (NOT (sub_104844( iVar4 ))))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U611[Result]._fU4._fU8;
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[Result]._fU4._fU0, l_U611[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_37520( sub_1568() )))) AND (sub_66256( 1, 1 )))
            {
...
int sub_105136(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_105195( Result ))
        {
            ...
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U757[Result]._fU4._fU0, l_U757[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_37520( sub_1568() )))) AND (sub_66256( 1, 1 )))
            {
                if (IS_CHAR_ON_FOOT( sub_1568() ))
                {
                    if (sub_100915( uParam0, 1092616192 ))
...
int sub_124590(unknown uParam0)
{
    ...
    if ((((sub_124680( uParam0, "Bada_room1" )) || (sub_124680( uParam0, "Bada-Private" ))) || (sub_124680( uParam0, "Bada_room2" ))) || (sub_124680( uParam0, "Bada_room1" )))
    {
        return 1;
    }
    if ((((sub_124680( uParam0, "clammainroom" )) || (sub_124680( uParam0, "clampalbkrm" ))) || (sub_124680( uParam0, "clamfronrm" ))) || (sub_124680( uParam0, "clammainroom" )))
    {
        return 1;
    }
    return 0;
...
void sub_126058(unknown uParam0)
{
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if ((sub_139534( ref l_U465 )) || ((sub_105968( l_U465 )) > 5))
                {
                    bVar5 = true;
                }
            }
...
void sub_126234(unknown uParam0)
{
    ...
    if ((IS_CHAR_DEAD( sub_1568() )) || (sub_126257( uParam0 )))
    {
        return;
    }
    if ((IS_CHAR_ON_ANY_BIKE( sub_1568() )) || (sub_126498( uParam0 )))
    {
        sub_126638( uParam0 );
        return;
    }
...
int sub_128104(unknown uParam0)
{
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( sub_1568() ))) AND (NOT (sub_126257( uParam0 ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_1568() ))
            {
...
int sub_128988(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((NOT g_U18635[uParam0]._fU892._fU28) AND (uParam2))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((sub_129157( uParam0, I )) AND (NOT (sub_129422( uParam0, I ))))
            {
...
void sub_129111()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if (((sub_129157( 1, I )) || (sub_129157( 6, I ))) || (sub_129157( 7, I )))
        {
            sub_129249( 1, I );
            sub_129249( 6, I );
            sub_129249( 7, I );
        ...
        if (((sub_129422( 1, I )) || (sub_129422( 6, I ))) || (sub_129422( 7, I )))
        {
            sub_129514( 1, I );
            sub_129514( 6, I );
            sub_129514( 7, I );
...
int sub_140603(int iParam0)
{
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_45916( iParam0 + 0 )) == 3) AND ((sub_140746( iVar3 )) == sub_140775())))
        {
            if ((((sub_45916( iParam0 + 0 )) != 1) || ((sub_140821( iParam0->_fU0 )) == (sub_17380( 0 )))) || ((sub_140863( sub_1568() )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1568() )))))
            {
                return 0;
            }
            else
...
int sub_141019(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((sub_140863( iParam0->_fU0 )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))))
    {
        return 2;
    }
    else if ((uParam1) || (sub_99450( iParam0, 1 )))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_141575(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if (((sub_141641( (iParam0^) )) AND (NOT l_U154)) AND (NOT l_U155))
            {
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_139018()))
                {
        ...
        {
            if ((((((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_1568(), iParam0->_fU0, l_U145, l_U145, l_U145, 0 ))) || (NOT (IS_CHAR_ON_ANY_BIKE( sub_1568() )))) || (NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )))) || (NOT (sub_71917( l_U147 ))))
            {
                sub_143028( iParam0 );
            }
        }
...
void sub_143191(int iParam0)
{
    ...
    if ((sub_141606( (iParam0^) )) AND (sub_139018()))
    {
    ...
    if (((sub_139018()) || (sub_141606( (iParam0^) ))) || ((iVar4 - l_U165) < 33))
    {
        return;
    }
    if (l_U165 <= 0)
    ...
    if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_144118( uVar12 ))
            {
                ...
                if (((NOT (sub_141606( (iParam0^) ))) AND (((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) AND (fVar21 < 19)) || (fVar21 < 15))) AND (iParam0->_fU0 != l_U167))
                {
                    ...
                    else if ((((sub_144355( iParam0 )) AND (iParam0->_fU36 == 2)) AND ((sub_45916( iParam0 + 0 )) == 1)) AND (NOT (IS_BIT_SET( l_U170, 6 ))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_144469( bVar16 );
                        iVar11 = sub_1568();
                    }
                    else if (((IS_CAR_IN_AIR_PROPER( uVar12 )) AND ((ABSF( uVar22 )) < 20.00000000)) AND (sub_144557( 8 )))
                    {
                        uVar13 = sub_51426( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_1568() )) AND (sub_144557( 12 )))
                    {
                        uVar13 = sub_144469( bVar16 );
                        iVar11 = sub_1568();
                        iVar15 = 12;
                    ...
                    else if (((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 )) || (IS_PED_RAGDOLL( iParam0->_fU0 ))) AND (sub_144557( 13 )))
                    {
                        uVar13 = sub_144469( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if (((((sub_45916( iParam0 + 0 )) == 1) AND (NOT (IS_PLAYER_PRESSING_HORN( sub_4211() )))) AND (IS_BIT_SET( l_U170, 7 ))) AND (sub_144557( 20 )))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if ((((IS_WANTED_LEVEL_GREATER( sub_4211(), 0 )) AND (NOT (IS_BIT_SET( l_U170, 0 )))) AND (sub_144557( 24 ))) AND ((sub_45916( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 24;
                        iVar11 = sub_1568();
                    }
                    else if ((((NOT (IS_WANTED_LEVEL_GREATER( sub_4211(), 0 ))) AND (IS_BIT_SET( l_U170, 0 ))) AND (sub_144557( 30 ))) AND ((sub_45916( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_144557( 33 )) AND (NOT (IS_BIT_SET( l_U170, 4 )))) AND ((sub_45916( iParam0 + 0 )) == 1))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_144557( 31 )) AND (NOT (IS_BIT_SET( l_U170, 4 )))) AND ((sub_45916( iParam0 + 0 )) == 1))
                                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((sub_144557( 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_4211(), 0 ))))
                                {
                                ...
                                else if (((sub_144557( 36 )) AND (IS_WANTED_LEVEL_GREATER( sub_4211(), 0 ))) AND (NOT (IS_BIT_SET( l_U170, 1 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((IS_WANTED_LEVEL_GREATER( sub_4211(), 2 )) AND (sub_144557( 23 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if ((sub_144557( 28 )) AND ((sub_45916( iParam0 + 0 )) == 1))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_144557( 3 )) AND (sub_144557( 4 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if ((sub_144557( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_4211(), 0 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if ((sub_144557( 30 )) AND ((sub_45916( iParam0 + 0 )) == 1))
                                {
                                    iVar15 = 30;
                                }
...
int sub_149287(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((((IS_CHAR_IN_CAR( sub_1568(), iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((sub_144181( iParam0->_fU0, sub_1568(), 1 )) < 90.00000000))
        {
...
int sub_150023(unknown uParam0)
{
    ...
    if (IS_PED_IN_GROUP( uParam0 ))
    {
        ...
        if (DOES_GROUP_EXIST( iVar3 ))
        {
            ...
            {
                if (((iVar4 < 1) || (iVar5 < 2)) AND (iVar3 != sub_17801()))
                {
                    REMOVE_GROUP( iVar3 );
                }
                else
            ...
            else if ((iVar5 < 1) AND (iVar3 != sub_17801()))
            {
                REMOVE_GROUP( iVar3 );
            }
        }
...
int sub_150419(int iParam0)
{
    ...
    if ((NOT (sub_99450( iParam0, 2 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        return 0;
    }
...
int sub_150954(int iParam0)
{
    ...
    else if ((((sub_148076( iParam0 )) > 90.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND ((sub_144181( iParam0->_fU0, sub_1568(), 1 )) > 90.00000000))
    {
        ...
        {
            if (((CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 )) || (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 ))) || ((VDIST( sub_141364( sub_1568(), 1 ), uVar4 )) < 30.00000000))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_151726(int iParam0)
{
    ...
    if ((sub_99450( iParam0, 1 )) AND ((sub_148076( iParam0 )) < 30.00000000))
    {
        SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( iParam0->_fU0, 1 );
    ...
    if ((NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))) AND ((((IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 )) || (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 ))) || (DOES_VEHICLE_EXIST( iVar4 ))) || ((sub_144181( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8)))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
    ...
    else if (((sub_149325( sub_1568(), iParam0->_fU0, 1 )) AND (iParam0->_fU8 != sub_1568())) AND ((sub_45916( iParam0 + 0 )) == 1))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((NOT (sub_99450( iParam0, 1 ))) || (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
        {
            if ((sub_141181( iParam0 )) != 0)
            {
                ;
    ...
    else if ((sub_99450( iParam0, 1 )) AND (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))))
    {
...
int sub_153479(int iParam0)
{
    ...
    else if ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_144161( iParam0 )) > 30.00000000))
    {
...
int sub_154716(int iParam0)
{
    ...
    if ((((IS_PED_IN_COMBAT( iParam0->_fU0 )) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 ))) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 ))) AND ((sub_148076( iParam0 )) < 30.00000000))
    {
        return 2;
    }
    return 0;
...
int sub_154865(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_148604( iParam0->_fU4 )) || (sub_99450( iParam0, 4 ))) AND ((sub_144161( iParam0 )) >= l_U125))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 ))) AND ((VDIST( uVar15, sub_141364( sub_1568(), 1 ) )) > fParam2)) AND ((VDIST2( uVar15, vVar6 )) > 9.00000000))
                    {
...
void sub_161919(unknown uParam0)
{
    ...
    if ((((((((IS_CONTROL_PRESSED( 0, 51 )) AND (NOT (IS_CONTROL_PRESSED( 0, 38 )))) AND (NOT (IS_CONTROL_PRESSED( 0, 39 )))) AND (IS_CHAR_ON_ANY_BIKE( sub_1568() ))) AND (NOT sub_164265())) AND (NOT (iVar14 == 4))) AND (iVar8 >= 0)) AND (NOT bVar4))
    {
...
void sub_162154(unknown uParam0)
{
    ...
    {
        if (((sub_162190( uParam0, I )) AND (I != l_U110)) AND (Result < 0))
        {
            Result = I;
        }
    }
...
void sub_164849(unknown uParam0)
{
    ...
    if (HAS_SCRIPT_LOADED( "ability_stats" ))
    {
        if (NOT g_U39103)
        {
            if ((((((NOT sub_164265()) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ability_stats" )) == 0)) AND (NOT sub_167337())) AND (NOT IS_MINIGAME_IN_PROGRESS())) AND (NOT g_U11112)) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))
            {
                if (NOT l_U1218)
                {
...
int sub_167337()
{
    ...
    {
        if ((ARE_WIDESCREEN_BORDERS_ACTIVE()) AND (sub_167371()))
        {
            return 1;
        }
