...
void sub_3412()
{
    ...
    if (DOES_CAM_EXIST( l_U709 ))
    {
        if (IS_CAM_ACTIVE( l_U709 ))
        {
            ...
            if ((IS_BUTTON_PRESSED( 0, 10 )) AND (NOT l_U728))
            {
                if (NOT l_U705)
                {
                    sub_3547( 10 );
            ...
            if ((IS_BUTTON_PRESSED( 0, 11 )) AND (NOT l_U728))
            {
                if (NOT l_U705)
                {
                    sub_3547( 11 );
            ...
            if ((IS_BUTTON_PRESSED( 0, 9 )) AND (NOT l_U728))
            {
                if (NOT l_U705)
                {
                    sub_3751();
            ...
            if ((IS_BUTTON_PRESSED( 0, 8 )) AND (NOT l_U705))
            {
                if (l_U734)
                {
                    l_U734 = 0;
            ...
            if ((IS_BUTTON_PRESSED( 0, 17 )) AND (NOT l_U728))
            {
                l_U728 = 1;
...
void sub_7393()
{
    if ((l_U744) AND (NOT l_U745))
    {
        sub_7419();
    }
    else if ((NOT l_U744) AND (l_U745))
    {
        l_U745 = 0;
    }
    if ((l_U750) AND (NOT l_U751))
    {
        sub_7658();
    }
    else if ((NOT l_U750) AND (l_U751))
    {
        l_U751 = 0;
    }
    return;
...
void sub_8016()
{
    ...
    else if (((NOT l_U749) AND (NOT l_U743)) AND (l_U753))
    {
        if (IS_PLAYER_PLAYING( sub_8041() ))
        {
            SET_PLAYER_CONTROL( sub_8041(), 1 );
