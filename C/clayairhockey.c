...
int sub_33233(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    if (NOT (iParam1 == nil))
    {
        if ((sub_33305()) || (IS_CHAR_INJURED( iParam1 )))
        {
            l_U505 = 1;
            l_U506 = 0;
...
void sub_44178(unknown uParam0, unknown uParam1)
{
    ...
    if ((NOT sub_44239()) || (NOT sub_35431()))
    {
        return;
    }
    sub_36933();
...
{
    if ((NOT (sub_35358( uParam0 ))) || (NOT (HAS_MODEL_LOADED( sub_44821( uParam0 ) ))))
    {
        sub_35397( uParam0 );
...
void sub_45100(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_45134( vParam0 + (vector( 2.00000000, 0.00000000, 0.00000000)), uParam3, uParam4, iParam6 );
...
{
    return (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 )) AND (NOT (sub_50221( uParam0, uParam1 )));
}
...
void sub_63668()
{
    ...
    sub_63996( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18770000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
...
int sub_66147(unknown uParam0, unknown uParam1, unknown uParam2)
{
        ...
        for ( I = 0; I < 1; I++ )
        {
            if (l_U514 == -1)
            {
                if (sub_66994( I ))
                {
                    ...
                    if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[I]._fU4._fU0, l_U611[I]._fU4._fU4, fVar8, 2.50000000, 2.50000000, 2.50000000, iVar9 )) AND (NOT (sub_37503( sub_1568() )))) AND (sub_67205( 1, 1 )))
                    {
    ...
    if (l_U502 == 2)
    {
        if ((sub_67714( uParam0 )) || (iVar5 > l_U627))
        {
            l_U514 = l_U628;
            l_U502 = 3;
        }
...
int sub_76080(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    {
        bVar6 = true;
        if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )) AND (NOT (sub_37503( sub_1568() ))))
        {
...
void sub_98306(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U1194 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_1568() )))
        {
            if ((sub_98429( uParam1, 20.00000000 )) || (iVar5 > l_U1224))
            {
                l_U1194++;
            }
            else
...
int sub_104051(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((sub_104123( Result )) AND (NOT (sub_104186( iVar4 ))))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U1002[Result]._fU4._fU8;
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U1002[Result]._fU4._fU0, l_U1002[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_37503( sub_1568() )))) AND (sub_67205( 1, 1 )))
            {
...
int sub_104478(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_104537( Result ))
        {
            ...
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U629[Result]._fU4._fU0, l_U629[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_37503( sub_1568() )))) AND (sub_67205( 1, 1 )))
            {
                if (IS_CHAR_ON_FOOT( sub_1568() ))
                {
                    if (sub_98429( uParam0, 1092616192 ))
...
int sub_122625(unknown uParam0)
{
    ...
    if ((((sub_122715( uParam0, "Bada_room1" )) || (sub_122715( uParam0, "Bada-Private" ))) || (sub_122715( uParam0, "Bada_room2" ))) || (sub_122715( uParam0, "Bada_room1" )))
    {
        return 1;
    }
    if ((((sub_122715( uParam0, "clammainroom" )) || (sub_122715( uParam0, "clampalbkrm" ))) || (sub_122715( uParam0, "clamfronrm" ))) || (sub_122715( uParam0, "clammainroom" )))
    {
        return 1;
    }
    return 0;
...
void sub_123951(unknown uParam0)
{
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if ((sub_137427( ref l_U465 )) || ((sub_105310( l_U465 )) > 5))
                {
                    bVar5 = true;
                }
            }
...
void sub_124127(unknown uParam0)
{
    ...
    if ((IS_CHAR_DEAD( sub_1568() )) || (sub_124150( uParam0 )))
    {
        return;
    }
    if ((IS_CHAR_ON_ANY_BIKE( sub_1568() )) || (sub_124391( uParam0 )))
    {
        sub_124531( uParam0 );
        return;
    }
...
int sub_125997(unknown uParam0)
{
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( sub_1568() ))) AND (NOT (sub_124150( uParam0 ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_1568() ))
            {
...
int sub_126881(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((NOT g_U18635[uParam0]._fU892._fU28) AND (uParam2))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((sub_127050( uParam0, I )) AND (NOT (sub_127315( uParam0, I ))))
            {
...
void sub_127004()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if (((sub_127050( 1, I )) || (sub_127050( 6, I ))) || (sub_127050( 7, I )))
        {
            sub_127142( 1, I );
            sub_127142( 6, I );
            sub_127142( 7, I );
        ...
        if (((sub_127315( 1, I )) || (sub_127315( 6, I ))) || (sub_127315( 7, I )))
        {
            sub_127407( 1, I );
            sub_127407( 6, I );
            sub_127407( 7, I );
...
int sub_138496(int iParam0)
{
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_45899( iParam0 + 0 )) == 3) AND ((sub_138639( iVar3 )) == sub_138668())))
        {
            if ((((sub_45899( iParam0 + 0 )) != 1) || ((sub_138714( iParam0->_fU0 )) == (sub_17369( 0 )))) || ((sub_138756( sub_1568() )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1568() )))))
            {
                return 0;
            }
            else
...
int sub_138912(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((sub_138756( iParam0->_fU0 )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))))
    {
        return 2;
    }
    else if ((uParam1) || (sub_88745( iParam0, 1 )))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_139468(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if (((sub_139534( (iParam0^) )) AND (NOT l_U154)) AND (NOT l_U155))
            {
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_136911()))
                {
        ...
        {
            if ((((((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_1568(), iParam0->_fU0, l_U145, l_U145, l_U145, 0 ))) || (NOT (IS_CHAR_ON_ANY_BIKE( sub_1568() )))) || (NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )))) || (NOT (sub_75754( l_U147 ))))
            {
                sub_140921( iParam0 );
            }
        }
...
void sub_141084(int iParam0)
{
    ...
    if ((sub_139499( (iParam0^) )) AND (sub_136911()))
    {
    ...
    if (((sub_136911()) || (sub_139499( (iParam0^) ))) || ((iVar4 - l_U165) < 33))
    {
        return;
    }
    if (l_U165 <= 0)
    ...
    if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_142011( uVar12 ))
            {
                ...
                if (((NOT (sub_139499( (iParam0^) ))) AND (((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) AND (fVar21 < 19)) || (fVar21 < 15))) AND (iParam0->_fU0 != l_U167))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((l_U104) AND ((iParam0->_fU36 != 1) || ((sub_52583( 0, 10 )) == 0)))
                    {
                        l_U104 = 0;
                        iVar15 = 17;
                        iVar11 = sub_1568();
                    }
                    else if ((((sub_142248( iParam0 )) AND (iParam0->_fU36 == 2)) AND ((sub_45899( iParam0 + 0 )) == 1)) AND (NOT (IS_BIT_SET( l_U170, 6 ))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_142362( bVar16 );
                        iVar11 = sub_1568();
                    }
                    else if (((IS_CAR_IN_AIR_PROPER( uVar12 )) AND ((ABSF( uVar22 )) < 20.00000000)) AND (sub_142450( 8 )))
                    {
                        uVar13 = sub_51409( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_1568() )) AND (sub_142450( 12 )))
                    {
                        uVar13 = sub_142362( bVar16 );
                        iVar11 = sub_1568();
                        iVar15 = 12;
                    ...
                    else if (((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 )) || (IS_PED_RAGDOLL( iParam0->_fU0 ))) AND (sub_142450( 13 )))
                    {
                        uVar13 = sub_142362( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if (((((sub_45899( iParam0 + 0 )) == 1) AND (NOT (IS_PLAYER_PRESSING_HORN( sub_4216() )))) AND (IS_BIT_SET( l_U170, 7 ))) AND (sub_142450( 20 )))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if ((((IS_WANTED_LEVEL_GREATER( sub_4216(), 0 )) AND (NOT (IS_BIT_SET( l_U170, 0 )))) AND (sub_142450( 24 ))) AND ((sub_45899( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 24;
                        iVar11 = sub_1568();
                    }
                    else if ((((NOT (IS_WANTED_LEVEL_GREATER( sub_4216(), 0 ))) AND (IS_BIT_SET( l_U170, 0 ))) AND (sub_142450( 30 ))) AND ((sub_45899( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_142450( 33 )) AND (NOT (IS_BIT_SET( l_U170, 4 )))) AND ((sub_45899( iParam0 + 0 )) == 1))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_142450( 31 )) AND (NOT (IS_BIT_SET( l_U170, 4 )))) AND ((sub_45899( iParam0 + 0 )) == 1))
                                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((sub_142450( 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_4216(), 0 ))))
                                {
                                ...
                                else if (((sub_142450( 36 )) AND (IS_WANTED_LEVEL_GREATER( sub_4216(), 0 ))) AND (NOT (IS_BIT_SET( l_U170, 1 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((IS_WANTED_LEVEL_GREATER( sub_4216(), 2 )) AND (sub_142450( 23 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if ((sub_142450( 28 )) AND ((sub_45899( iParam0 + 0 )) == 1))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_142450( 3 )) AND (sub_142450( 4 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if (((sub_45899( iParam0 + 0 )) == 1) AND (fVar26 < 5))
                            {
                                if ((sub_142450( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_4216(), 0 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if ((sub_142450( 30 )) AND ((sub_45899( iParam0 + 0 )) == 1))
                                {
                                    iVar15 = 30;
                                }
...
int sub_146923(int iParam0)
{
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            {
                if (((sub_45899( ref iVar4 )) == (sub_45899( iParam0 + 0 ))) || ((iVar4 == sub_1568()) AND ((sub_45899( iParam0 + 0 )) == 1)))
                {
...
int sub_147180(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((((IS_CHAR_IN_CAR( sub_1568(), iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((sub_142074( iParam0->_fU0, sub_1568(), 1 )) < 90.00000000))
        {
...
int sub_148312(int iParam0)
{
    ...
    if ((NOT (sub_88745( iParam0, 2 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        return 0;
    }
...
int sub_148847(int iParam0)
{
    ...
    else if ((((sub_145969( iParam0 )) > 90.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND ((sub_142074( iParam0->_fU0, sub_1568(), 1 )) > 90.00000000))
    {
        ...
        {
            if (((CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 )) || (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 ))) || ((VDIST( sub_139257( sub_1568(), 1 ), uVar4 )) < 30.00000000))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_149619(int iParam0)
{
    ...
    if ((sub_88745( iParam0, 1 )) AND ((sub_145969( iParam0 )) < 30.00000000))
    {
        SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( iParam0->_fU0, 1 );
    ...
    if ((NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))) AND ((((IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 )) || (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 ))) || (DOES_VEHICLE_EXIST( iVar4 ))) || ((sub_142074( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8)))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((sub_50221( iParam0->_fU8, iParam0->_fU4 )) || (iParam0->_fU4 == iVar4))
            {
            ...
            else if ((sub_50221( sub_1568(), iParam0->_fU4 )) AND ((sub_45899( iParam0 + 0 )) == 1))
            {
    ...
    else if (((sub_147218( sub_1568(), iParam0->_fU0, 1 )) AND (iParam0->_fU8 != sub_1568())) AND ((sub_45899( iParam0 + 0 )) == 1))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((NOT (sub_88745( iParam0, 1 ))) || (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
        {
            if ((sub_139074( iParam0 )) != 0)
            {
                ;
    ...
    else if ((sub_88745( iParam0, 1 )) AND (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))))
    {
...
int sub_151372(int iParam0)
{
    ...
    else if ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_142054( iParam0 )) > 30.00000000))
    {
...
int sub_151783(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((VDIST( uVar4, uVar10 )) < 30.00000000)) || ((VDIST( uVar4, uVar7 )) < 30.00000000))
        {
            ...
            else if ((iVar3 == sub_1568()) || ((sub_45899( ref iVar3 )) == (sub_45899( iParam0 + 0 ))))
            {
...
int sub_152609(int iParam0)
{
    ...
    if ((((IS_PED_IN_COMBAT( iParam0->_fU0 )) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 ))) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 ))) AND ((sub_145969( iParam0 )) < 30.00000000))
    {
        return 2;
    }
    return 0;
...
int sub_152758(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_146497( iParam0->_fU4 )) || (sub_88745( iParam0, 4 ))) AND ((sub_142054( iParam0 )) >= l_U125))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 ))) AND ((VDIST( uVar15, sub_139257( sub_1568(), 1 ) )) > fParam2)) AND ((VDIST2( uVar15, vVar6 )) > 9.00000000))
                    {
...
void sub_159812(unknown uParam0)
{
    ...
    if ((((((((IS_CONTROL_PRESSED( 0, 51 )) AND (NOT (IS_CONTROL_PRESSED( 0, 38 )))) AND (NOT (IS_CONTROL_PRESSED( 0, 39 )))) AND (IS_CHAR_ON_ANY_BIKE( sub_1568() ))) AND (NOT sub_162158())) AND (NOT (iVar14 == 4))) AND (iVar8 >= 0)) AND (NOT bVar4))
    {
...
void sub_160047(unknown uParam0)
{
    ...
    {
        if (((sub_160083( uParam0, I )) AND (I != l_U110)) AND (Result < 0))
        {
            Result = I;
        }
    }
...
void sub_162742(unknown uParam0)
{
    ...
    if (HAS_SCRIPT_LOADED( "ability_stats" ))
    {
        if (NOT g_U39103)
        {
            if ((((((NOT sub_162158()) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ability_stats" )) == 0)) AND (NOT sub_165230())) AND (NOT IS_MINIGAME_IN_PROGRESS())) AND (NOT g_U11112)) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))
            {
                if (NOT l_U1236)
                {
...
int sub_165230()
{
    ...
    {
        if ((ARE_WIDESCREEN_BORDERS_ACTIVE()) AND (sub_165264()))
        {
            return 1;
        }
