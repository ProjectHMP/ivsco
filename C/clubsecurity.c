    ...
    while (true)
    {
        ...
        switch (l_U432)
        {
            ...
            switch (l_U433)
            {
                ...
                if (((((((((GET_CHAR_DRAWABLE_VARIATION( sub_1955(), 1 )) == 2) AND ((GET_CHAR_TEXTURE_VARIATION( sub_1955(), 1 )) == 0)) AND ((GET_CHAR_DRAWABLE_VARIATION( sub_1955(), 2 )) == 1)) AND ((GET_CHAR_TEXTURE_VARIATION( sub_1955(), 2 )) == 0)) AND ((GET_CHAR_DRAWABLE_VARIATION( sub_1955(), 5 )) == 1)) AND ((GET_CHAR_TEXTURE_VARIATION( sub_1955(), 5 )) == 0)) AND ((GET_CHAR_DRAWABLE_VARIATION( sub_1955(), 3 )) == 1)) AND ((GET_CHAR_TEXTURE_VARIATION( sub_1955(), 3 )) == 0))
                {
                    l_U339 = 1;
                }
                ...
                if (IS_PLAYER_PLAYING( sub_903() ))
                {
                    ...
                    SET_CHAR_COORDINATES( sub_1955(), -472.81330000, 147.95070000, 8.85850000 );
            ...
            switch (l_U433)
            {
                ...
                break;
                case 2:
                if (((((LOCATE_CHAR_ON_FOOT_3D( sub_1955(), l_U493._fU0, l_U493._fU4, l_U493._fU8, 1.20000000, 1.20000000, 1.60000000, 1 )) AND (sub_15620( sub_1955(), 1, 0 ))) AND (NOT (IS_PLAYER_CLIMBING( sub_903() )))) AND (NOT sub_16061())) AND (sub_16097()))
                {
                    l_U436++;
                    if (IS_CHAR_DUCKING( sub_1955() ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( g_U29971[g_U30198]._fU12 ))
                        {
                            if (NOT (sub_18980( 0 )))
                            {
                                if (NOT (sub_2167( sub_1955(), "E2_MaisonsecurRoom" )))
                                {
                                    ...
                                    {
                                        if (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_1955(), -469.56240000, 150.01650000, 8.85910000, 2, 2, 2, 0 )))
                                        {
                                            if (NOT l_U273)
                                            {
                                                GET_GAME_TIMER( ref iVar3 );
                                                if (((((iVar3 - l_U415) > 70000) AND ((iVar3 - l_U416) > 70000)) AND ((iVar3 - l_U333) > 70000)) AND ((iVar3 - l_U334) > 70000))
                                                {
                                                    if (NOT l_U410)
                                                    {
                ...
                if ((GET_HOURS_OF_DAY() > 5) AND (GET_HOURS_OF_DAY() < 21))
                {
                    if (NOT l_U411)
                    {
                        sub_22173( 1 );
            ...
            switch (l_U433)
            {
                ...
                if (((((l_U274[0]) AND (l_U274[1])) AND (l_U274[2])) AND (TIMERA() > 12500)) || (l_U434 == 4))
                {
                    CLEAR_HELP();
                    SETTIMERA( 0 );
                    l_U433++;
            ...
            switch (l_U433)
            {
                ...
                if (g_U30198 != -1)
                {
                    if (DOES_CHAR_EXIST( g_U29971[g_U30198]._fU12 ))
                    {
                        ...
                        if (NOT (IS_CHAR_INJURED( g_U29971[g_U30198]._fU12 )))
                        {
                            if ((IS_CHAR_PLAYING_ANIM( g_U29971[g_U30198]._fU12, "MISSCLUB_MGMT", "Joni_idle" )) || (IS_CHAR_PLAYING_ANIM( g_U29971[g_U30198]._fU12, "MISSCLUB_MGMT", "Joni_hi_a" )))
                            {
        ...
        else if ((((IS_CHAR_IN_AREA_3D( sub_1955(), -474.97280000, 143.74440000, 8.86370000, -471.82280000, 150.54440000, 11.86370000, 0 )) AND (IS_CHAR_ON_FOOT( sub_1955() ))) AND (sub_64657( 2, 0 ))) AND (NOT l_U282))
        {
        ...
        if (g_U30198 != -1)
        {
            if (DOES_CHAR_EXIST( g_U29971[g_U30198]._fU12 ))
            {
                if (NOT (IS_CHAR_INJURED( g_U29971[g_U30198]._fU12 )))
                {
                    ...
                    {
                        if ((((sub_65761( sub_1955(), g_U29971[g_U30198]._fU12, 1 )) < 6) AND (IS_CHAR_ON_SCREEN( g_U29971[g_U30198]._fU12 ))) AND (NOT l_U282))
                        {
...
void sub_577()
{
    ...
    l_U496[6] = {-469.36780000, 147.19580000, 8.85910000};
    l_U456[6] = 353.79860000;
    l_U572[6] = "E2_MaisonRoomfront";
    l_U518[6] = {-469.42920000, 150.16590000, 8.85910000};
    l_U464[6] = 178.67620000;
    l_U580[6] = "E2_MaisonRoomfront";
    l_U540[6] = {-471.82910000, 141.03860000, 8.85910000};
...
void sub_1019()
{
    ...
    {
        if (((sub_1057( 5, g_U575[I] )) == 1) AND (g_U575[I]._fU20))
        {
...
void sub_6359()
{
    if (IS_PLAYER_PLAYING( sub_903() ))
    {
        if (NOT l_U279)
        {
            ...
            {
                if ((((NOT g_U30093[1]) AND (NOT (l_U432 == 3))) AND (NOT (l_U432 == 4))) AND (NOT (l_U432 == 5)))
                {
                    if (sub_6419( sub_1955(), 1 ))
                    {
        ...
        {
            SET_CHAR_MAX_MOVE_BLEND_RATIO( sub_1955(), 1.50000000 );
            if ((((NOT (sub_6419( sub_1955(), 1 ))) || (l_U432 == 3)) || (l_U432 == 4)) || (l_U432 == 5))
            {
                SET_CHAR_MAX_MOVE_BLEND_RATIO( sub_1955(), 3.00000000 );
                l_U279 = 0;
            }
...
void sub_9054(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        SET_CAM_POINT_OFFSET( l_U688[0], -0.08040000, 0.49830000, 0.57070000 );
...
vector sub_13638(unknown uParam0)
{
    ...
    {
        case 1:
        return vector( 6.55090000, 156.73000000, -477.53300000);
        break;
        case 2:
        return vector( 6.55070000, 147.04190000, -481.89720000);
        break;
        case 3:
        return vector( 10.61200000, 165.78080000, -480.67240000);
        break;
        case 4:
        return vector( 8.66890000, 159.34640000, -469.48400000);
        break;
        case 5:
        return vector( 6.55290000, 142.40070000, -477.60400000);
        break;
        case 6:
        return vector( 8.85910000, 140.44260000, -468.48100000);
        break;
    }
...
{
    if (((((IS_MESSAGE_BEING_DISPLAYED()) || (((sub_18996()) AND (NOT bParam0)) || ((sub_19050()) AND (bParam0)))) || (sub_19079())) || (IS_SCRIPTED_CONVERSATION_ONGOING())) || (sub_19138()))
    {
        return 1;
    }
    return 0;
...
void sub_23632(unknown uParam0)
{
    ...
    {
        ATTACH_CAM_TO_PED( l_U688[1], uParam0 );
        SET_CAM_ATTACH_OFFSET( l_U688[1], 0.40350000, 0.96570000, 0.65750000 );
        SET_CAM_ATTACH_OFFSET_IS_RELATIVE( l_U688[1], 1 );
    }
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
...
void sub_26135()
{
    ...
    if (l_U434 == 5)
    {
        l_U425 = {-477.76500000, 139.38490000, 10.72685000};
    ...
    if (l_U434 == 2)
    {
        l_U425 = {-488.15500000, 157.56670000, 13.16867000};
    ...
    while (l_U331 == 1)
    {
        ...
        {
            case 0:
            if (((TIMERB() > 2750) AND (TIMERB() < 4000)) || ((TIMERB() > 4750) AND (TIMERB() < 7000)))
            {
                if (TIMERB() > 3750)
                {
                    fVar16 = 0.30000000;
            ...
            if ((TIMERB() > 2250) AND (TIMERB() < 4000))
            {
            ...
            if ((TIMERB() > 4750) AND (TIMERB() < 6500))
            {
                GET_CAM_ROT( uVar10, ref uVar17._fU0, ref uVar17._fU4, ref uVar17._fU8 );
            ...
            if (((TIMERB() > 2250) AND (TIMERB() < 4350)) || ((TIMERB() > 4750) AND (TIMERB() < 6850)))
            {
                if (iVar12 == 0)
                {
                    iVar12 = GET_SOUND_ID();
...
vector sub_32376()
{
    if (l_U434 == 1)
    {
        ...
        {
            return vector( 8.14605400, 156.75360000, -482.11850000);
        }
        ...
        {
            return vector( 8.28513000, 160.61970000, -487.91300000);
        }
    }
    if (l_U434 == 2)
    {
        ...
        {
            return vector( 9.33168400, 151.02020000, -487.84870000);
        }
        if (l_U562._fU0 == l_U518[2]._fU0)
        {
            return vector( 7.60669800, 149.11340000, -487.72450000);
        }
    ...
    if (l_U434 == 3)
    {
        ...
        {
            return vector( 12.00355000, 161.32620000, -487.77610000);
        }
        ...
        {
            return vector( 11.81454000, 166.00640000, -483.70800000);
        }
    }
    if (l_U434 == 4)
    {
        return vector( 10.38461000, 163.10660000, -470.97090000);
    }
    if (l_U434 == 5)
    {
        if (l_U562._fU0 == l_U496[5]._fU0)
        {
            return vector( 8.15687800, 139.50560000, -478.01750000);
        }
    ...
    if (l_U434 == 6)
    {
        ...
        {
            return vector( 10.50855000, 144.90610000, -471.66640000);
        }
        if (l_U562._fU0 == l_U518[6]._fU0)
        {
            return vector( 10.19803000, 139.83140000, -468.87830000);
        }
        if (l_U562._fU0 == l_U540[6]._fU0)
        {
            return vector( 8.72851500, 140.11430000, -475.65860000);
        }
    }
...
vector sub_33182()
{
    if (l_U434 == 1)
    {
        if (l_U562._fU0 == l_U496[1]._fU0)
        {
            return vector( 154.92610000, -0.00000000, -3.09022500);
        }
        if (l_U562._fU0 == l_U518[1]._fU0)
        {
            return vector( 154.92610000, -0.00000000, -3.09022500);
        ...
        if (l_U562._fU0 == l_U540[1]._fU0)
        {
            return vector( -172.14820000, -0.00000000, -2.71883300);
        }
    }
    if (l_U434 == 2)
    {
        if (l_U562._fU0 == l_U496[2]._fU0)
        {
            return vector( -169.09560000, 5.13863600, -43.42024000);
        }
        if (l_U562._fU0 == l_U518[2]._fU0)
        {
            return vector( -128.28010000, -0.00000000, 4.89961900);
        }
        if (l_U562._fU0 == l_U540[2]._fU0)
        {
            return vector( -169.09560000, 5.13863600, -43.42024000);
    ...
    if (l_U434 == 3)
    {
        if (l_U562._fU0 == l_U496[3]._fU0)
        {
            return vector( -32.17744000, -0.00000000, -5.20845600);
        }
        if (l_U562._fU0 == l_U518[3]._fU0)
        {
            return vector( -32.17744000, -0.00000000, -5.20845600);
        ...
        if (l_U562._fU0 == l_U540[3]._fU0)
        {
            return vector( -161.69450000, 0.00000000, -0.42647100);
        }
    }
    if (l_U434 == 4)
    {
        return vector( -104.48080000, 0.00000000, -9.42126600);
    }
    if (l_U434 == 5)
    {
        if (l_U562._fU0 == l_U496[5]._fU0)
        {
            return vector( 67.52788000, -0.00000000, -5.91582800);
        }
        if (l_U562._fU0 == l_U518[5]._fU0)
        {
            return vector( 67.52788000, -0.00000000, -5.91582800);
    ...
    if (l_U434 == 6)
    {
        if (l_U562._fU0 == l_U496[6]._fU0)
        {
            return vector( -26.27252000, -0.00000000, 0.48940600);
        }
        if (l_U562._fU0 == l_U518[6]._fU0)
        {
            return vector( 11.66562000, 0.00000000, -1.41180900);
        }
        if (l_U562._fU0 == l_U540[6]._fU0)
        {
            return vector( -63.98282000, 0.00000000, 18.90565000);
        }
    }
...
vector sub_34005()
{
    if (l_U434 == 1)
    {
        if (l_U562._fU0 == l_U496[1]._fU0)
        {
            return vector( 6.55030000, 155.30140000, -482.73830000);
        }
        if (l_U562._fU0 == l_U518[1]._fU0)
        {
            return vector( 6.55030000, 155.30140000, -482.73830000);
        ...
        if (l_U562._fU0 == l_U540[1]._fU0)
        {
            return vector( 6.55120000, 156.39670000, -487.05620000);
        }
    }
    if (l_U434 == 2)
    {
        if (l_U562._fU0 == l_U496[2]._fU0)
        {
            return vector( 6.55100000, 148.56750000, -486.48510000);
        }
        if (l_U562._fU0 == l_U518[2]._fU0)
        {
            return vector( 6.55090000, 147.77560000, -485.24800000);
        }
        if (l_U562._fU0 == l_U540[2]._fU0)
        {
            return vector( 6.55100000, 148.56750000, -486.48510000);
    ...
    if (l_U434 == 3)
    {
        if (l_U562._fU0 == l_U496[3]._fU0)
        {
            return vector( 10.61840000, 164.45740000, -485.33610000);
        }
        if (l_U562._fU0 == l_U518[3]._fU0)
        {
            return vector( 10.61840000, 164.45740000, -485.33610000);
        ...
        if (l_U562._fU0 == l_U540[3]._fU0)
        {
            return vector( 10.61800000, 164.29760000, -482.28650000);
        }
    }
    if (l_U434 == 4)
    {
        return vector( 8.66910000, 161.46420000, -469.57460000);
    }
    if (l_U434 == 5)
    {
        if (l_U562._fU0 == l_U496[5]._fU0)
        {
            return vector( 6.55280000, 140.90890000, -479.96490000);
        }
        if (l_U562._fU0 == l_U518[5]._fU0)
        {
            return vector( 6.55270000, 141.28730000, -480.22300000);
        }
        if (l_U562._fU0 == l_U540[5]._fU0)
        {
            return vector( 6.55270000, 141.28730000, -480.22300000);
    ...
    if (l_U434 == 6)
    {
        if (l_U562._fU0 == l_U496[6]._fU0)
        {
            return vector( 8.85910000, 147.19580000, -469.36780000);
        }
        if (l_U562._fU0 == l_U518[6]._fU0)
        {
            return vector( 8.85910000, 150.16590000, -469.42920000);
        }
        if (l_U562._fU0 == l_U540[6]._fU0)
        {
            return vector( 8.85910000, 141.03860000, -471.82910000);
        }
    }
    SCRIPT_ASSERT( "GET_CAM_ROT_COORDS - invalid location" );
    return vector( 0.00000000, 0.00000000, 0.00000000);
...
void sub_45728()
{
    ...
    if (l_U441 == 1)
    {
        ...
        fVar6 = -0.36800000;
        fVar7 = 0.89000000;
        vVar8 = {-467.84390000, 153.68200000, 8.86000000};
        fVar14 = 298.00000000;
    }
    if (l_U441 == 2)
    {
        ...
        fVar6 = 0.52700000;
        fVar7 = 0.89000000;
        vVar8 = {-467.34390000, 153.68200000, 8.86000000};
        fVar14 = 268.00000000;
    }
    if (l_U441 == 3)
    {
        ...
        fVar6 = 0.97700000;
        fVar7 = 0.65000000;
        vVar8 = {-467.44390000, 153.68200000, 8.86000000};
        fVar14 = 279.00000000;
    ...
    if (g_U30199 != -1)
    {
        if (DOES_CHAR_EXIST( g_U29971[g_U30199]._fU12 ))
        {
            ...
            {
                SET_CHAR_COORDINATES( g_U29971[g_U30199]._fU12, -467.35710000, 155.00280000, 8.85850000 );
    ...
    if (l_U441 == 1)
    {
        SET_CAM_POS( l_U610, -464.42400000, 151.20690000, 9.10922200 );
        SET_CAM_ROT( l_U610, 21.11524000, 0.00000100, 43.03430000 );
        SET_CAM_FOV( l_U610, 45.00000000 );
        SET_CAM_POS( l_U609, -464.42400000, 151.20690000, 9.10922200 );
    ...
    while (l_U606)
    {
        switch (l_U607)
        {
            ...
            SET_CAM_POS( l_U611, -467.33010000, 156.34840000, 10.90463000 );
            ...
            {
                SET_CHAR_MAX_MOVE_BLEND_RATIO( sub_1955(), 3.00000000 );
                TASK_FOLLOW_NAV_MESH_TO_COORD( sub_1955(), -470.05280000, 154.62270000, 8.85910000, 2, 30000, 1 );
                SETTIMERA( 0 );
                l_U607++;
            }
            break;
            ...
            if (TIMERA() > 700)
            {
                ...
                CLEAR_CHAR_TASKS( sub_1955() );
                SET_CHAR_COORDINATES( sub_1955(), -470.05280000, 154.62270000, 8.85910000 );
...
void sub_51419()
{
    ...
    switch (g_U43693)
    {
        ...
        l_U665 = 25.28154000;
        l_U673 = {-473.08840000, 145.66880000, 8.93980000};
        l_U676 = 141.29890000;
        l_U678 = 9.09000000;
        l_U679 = 12000;
        break;
        ...
        l_U644 = {-473.00100000, 145.72020000, 9.06000000};
        l_U647 = 321.29890000;
        l_U648 = -1.25900000;
        l_U649 = -0.22400000;
        l_U651 = 0.85000000;
        l_U652 = {-473.49800000, 147.87800000, 9.77829600};
        ...
        l_U639 = "Luis_BJ";
        l_U640 = "Joni_BJ";
        l_U644 = {-472.73510000, 147.04680000, 9.06000000};
        l_U647 = 324.01530000;
        l_U648 = -1.31600000;
        l_U649 = -0.20500000;
        l_U651 = 0.85000000;
        l_U652 = {-474.23000000, 145.36540000, 9.88844200};
        l_U655 = {-0.09015800, -0.00000000, -36.88780000};
        l_U658 = 39.00000000;
        l_U659 = {-474.01290000, 145.65450000, 9.88787500};
        l_U662 = {-0.09016100, -0.00000000, -36.88781000};
        l_U665 = 39.00000000;
        ...
        l_U649 = -0.22000000;
        l_U651 = 0.85000000;
        l_U652 = {-471.06400000, 147.54370000, 9.96000700};
        l_U655 = {-0.75325600, -0.00000000, 131.47050000};
        l_U658 = 40.50000000;
        l_U659 = {-471.25430000, 147.64220000, 9.95718900};
        ...
        if (NOT (IS_CHAR_INJURED( g_U29971[g_U30198]._fU12 )))
        {
            if (IS_CHAR_PLAYING_ANIM( g_U29971[g_U30198]._fU12, "MISSCLUB_MGMT", l_U640 ))
            {
                ...
                if (l_U677 > 0.30000000)
                {
                    ...
                    SET_CAM_POS( l_U609, -473.20650000, 147.16470000, 10.42233000 );
                    SET_CAM_ROT( l_U609, 0.29335900, 0.00000000, 159.17700000 );
        ...
        if (NOT (IS_CHAR_INJURED( g_U29971[g_U30198]._fU12 )))
        {
            if (IS_CHAR_PLAYING_ANIM( g_U29971[g_U30198]._fU12, "MISSCLUB_MGMT", l_U640 ))
            {
                ...
                if (l_U677 > 0.60000000)
                {
                    ...
                    SET_CAM_ROT( l_U609, -4.70936800, 0.00000000, -155.34280000 );
                    SET_CAM_FOV( l_U609, 30.90003000 );
                    SET_CAM_FAR_DOF( l_U610, 5 );
                    SET_CAM_FAR_DOF( l_U609, 5 );
                    SET_CAM_ACTIVE( l_U608, 0 );
        ...
        if (NOT (IS_CHAR_INJURED( g_U29971[g_U30198]._fU12 )))
        {
            if (IS_CHAR_PLAYING_ANIM( g_U29971[g_U30198]._fU12, "MISSCLUB_MGMT", l_U640 ))
            {
                ...
                if (l_U677 > 0.80000000)
                {
                    ...
                    SET_CAM_FOV( l_U610, 30.90003000 );
                    SET_CAM_POS( l_U609, -472.08180000, 148.91130000, 10.20441000 );
    ...
    switch (l_U330)
    {
        ...
        if (NOT (IS_CHAR_INJURED( g_U29971[g_U30198]._fU12 )))
        {
            if (IS_CHAR_PLAYING_ANIM( g_U29971[g_U30198]._fU12, "MISSCLUB_MGMT", l_U640 ))
            {
                ...
                if (l_U677 > 0.35000000)
                {
                    SET_CAM_POS( l_U610, -472.62550000, 146.52630000, 10.20687000 );
                    SET_CAM_ROT( l_U610, -15.85176000, 0.00000000, 17.99968000 );
                    SET_CAM_FOV( l_U610, 41.70001000 );
                    SET_CAM_POS( l_U609, -472.62550000, 146.52630000, 10.20687000 );
        ...
        if (NOT (IS_CHAR_INJURED( g_U29971[g_U30198]._fU12 )))
        {
            if (IS_CHAR_PLAYING_ANIM( g_U29971[g_U30198]._fU12, "MISSCLUB_MGMT", l_U640 ))
            {
                ...
                if (l_U677 > 0.38000000)
                {
                    ...
                    SET_CAM_PROPAGATE( l_U608, 1 );
                    SET_CAM_INTERP_STYLE_CORE( l_U608, l_U610, l_U609, 3000, 0 );
                    SET_OBJECT_COORDINATES( l_U286, -474.03180000, 145.41810000, 8.85850000 );
                    SET_OBJECT_HEADING( l_U286, 294.49840000 - 180 );
                    l_U330++;
                }
            }
    ...
    switch (l_U330)
    {
        ...
        if (NOT (IS_CHAR_INJURED( g_U29971[g_U30198]._fU12 )))
        {
            if (IS_CHAR_PLAYING_ANIM( g_U29971[g_U30198]._fU12, "MISSCLUB_MGMT", l_U640 ))
            {
                ...
                {
                    SET_CAM_POS( l_U611, -473.89110000, 144.82030000, 9.83182500 );
        ...
        if (NOT (IS_CHAR_INJURED( g_U29971[g_U30198]._fU12 )))
        {
            if (IS_CHAR_PLAYING_ANIM( g_U29971[g_U30198]._fU12, "MISSCLUB_MGMT", l_U640 ))
            {
                ...
                if (l_U677 > 0.60000000)
                {
                    SET_CAM_POS( l_U610, -473.32290000, 147.61990000, 10.62053000 );
...
int sub_64657(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_903() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((IS_PLAYER_CONTROL_ON( sub_903() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_903() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_64753())
                    {
