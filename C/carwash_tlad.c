void main()
{
    ...
    while (true)
    {
        ...
        if (DOES_OBJECT_EXIST( l_U286 ))
        {
                                    ...
                                    if (sub_10341())
                                    {
                                        if (IS_CAR_STOPPED( l_U101 ))
                                        {
                                            if (sub_10435())
                                            {
                                                ...
                                                if (NOT sub_9803())
                                                {
                                                    ADD_SCORE( sub_5731(), -ProtectedGet(l_U169) );
                                                }
                                ...
                                else if (sub_14868( 1, 1 ))
                                {
                                    if (sub_10341())
                                    {
                                        if (sub_12707())
                                        {
                                            if (sub_9788())
                                            {
                                                if (sub_12981( l_U263, 15.00000000 ))
                                                {
            ...
            {
                sub_10504( "Car Wash Script Killed - Out of Range" );
                PRINTNL();
                sub_1211();
            }
        }
        ...
        {
            sub_10504( "Car Wash Script Killed - Object Doesn't Exist" );
            PRINTNL();
            sub_1211();
        }
    }
...
void sub_6443()
{
    ...
    Result = 1;
    if ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "stubbs2" )) > 0)
    {
        if ((VDIST( l_U102, -499.60610000, 464.02590000, 5.70270000 )) < 50.00000000)
        {
            Result = 0;
        }
    }
...
int sub_9788()
{
    ...
    if (IS_CHAR_IN_ANY_CAR( sub_1900() ))
    {
        ...
        if (((l_U37 == -956048545) || (l_U37 == 1884962369)) || (l_U37 == 1208856469))
        {
            ProtectedSet(l_U169, iVar3);
        }
        else
        {
            ProtectedSet(l_U169, iVar2);
        }
        if (IS_SCORE_GREATER( sub_5731(), ProtectedGet(l_U169) - 1 ))
        {
            return 1;
        }
        else
        ...
        if (LOCATE_CHAR_IN_CAR_3D( sub_1900(), l_U124._fU0, l_U124._fU4, l_U124._fU8, 5.00000000, 5.00000000, 5.00000000, 0 ))
        {
            if (NOT l_U40)
            {
                ...
                if (IS_CHAR_IN_ANY_CAR( sub_1900() ))
                {
                    STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1900(), ref uVar4 );
                    GET_CAR_MODEL( uVar4, ref l_U37 );
                    if ((l_U37 == -956048545) || (l_U37 == 1884962369))
                    {
                        ProtectedSet(l_U169, iVar3);
                    }
                    else
                ...
                if ((NOT IS_MINIGAME_IN_PROGRESS()) AND (NOT sub_9803()))
                {
                    PRINT_HELP_WITH_NUMBER( "CWHLP1", ProtectedGet(l_U169) );
                }
                l_U40 = 1;
            }
...
int sub_10435()
{
    if (l_U26 == 0)
    {
        ...
        SET_USE_HIGHDOF( 1 );
        sub_10504( "BEGIN_CAM_COMMANDS(iCamScope)\n" );
    }
    else
    {
        sub_10504( "iCamScope = 1\n" );
        return 1;
    }
    sub_10504( "CarwWash: Another script has called BEGIN_CAM_COMMANDS without END_CAM_COMMANDS.\n" );
    return 0;
}
...
void sub_10736(unknown uParam0)
{
    if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1900() ))
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1900(), ref l_U101 );
...
void sub_12488(unknown uParam0)
{
    float fVar3;
    ...
    if (DOES_OBJECT_EXIST( uParam0 ))
    {
        if (IS_CHAR_IN_ANY_CAR( sub_1900() ))
        {
            ...
            {
                case 0:
                sub_10504( "handwashStage = (preloadHandwashAssets)\n" );
                ...
                break;
                case 1:
                sub_10504( "handwashStage = (awaitingHandwash)\n" );
                if (sub_12707())
                {
                    if (sub_12981( l_U263, 15.00000000 ))
                    {
                ...
                break;
                case 2:
                sub_10504( "handwashStage = (runHandwashCut)\n" );
                sub_13606();
                if (NOT (IS_CHAR_DEAD( l_U285 )))
                {
                ...
                break;
                case 3:
                sub_10504( "handwashStage = (fadeOutHandwash)\n" );
                if (NOT (IS_CHAR_DEAD( l_U285 )))
                {
                ...
                break;
                case 4:
                sub_10504( "handwashStage = (handwashEnd)\n" );
                if (IS_SCREEN_FADED_OUT())
                {
                    sub_1819( uParam0 );
                }
...
int sub_12981(unknown uParam0, unknown uParam1)
{
    float fVar4;
    float fVar5;
    float fVar6;
...
int sub_14868(boolean bParam0, boolean bParam1)
{
    unknown uVar4;
    int iVar5;
    float fVar6;
...
void sub_15665(unknown uParam0)
{
...
void sub_18617(unknown uParam0)
{
    unknown uVar3;
