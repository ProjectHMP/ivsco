        ...
        if (DOES_OBJECT_EXIST( l_U310[0] ))
        {
            if (IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE( l_U310[0] ))
            {
                ...
                switch (l_U325)
                {
                    ...
                    if (DOES_OBJECT_EXIST( l_U310[0] ))
                    {
                        if ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "BOWL_TRIGGER" )) <= g_U10671)
                        {
                    ...
                    if (sub_1576())
                    {
                        if (NOT sub_1223())
                        {
                            ...
                            {
                                GET_GROUP_SIZE( sub_2142(), ref l_U29, ref l_U30 );
                                if (l_U30 > 0)
                                {
                                    if (DOES_OBJECT_EXIST( l_U310[0] ))
                                    {
                    ...
                    if (sub_9034())
                    {
                        if (NOT (DOES_CHAR_EXIST( l_U292[l_U6] )))
                        {
                            ...
                            SET_ROOM_FOR_CHAR_BY_NAME( l_U292[l_U6], "E1_Bowl_room" );
...
void sub_8266()
{
    ...
    ADD_OBJECT_TO_INTERIOR_ROOM_BY_NAME( l_U310[1], "E1_Bowl_room" );
    ADD_OBJECT_TO_INTERIOR_ROOM_BY_NAME( l_U310[2], "E1_Bowl_room" );
    return;
}
...
void sub_8535()
{
    ...
    ADD_OBJECT_TO_INTERIOR_ROOM_BY_NAME( l_U310[3], "E1_Bowl_room" );
    ...
    ADD_OBJECT_TO_INTERIOR_ROOM_BY_NAME( l_U310[5], "E1_Bowl_room" );
    return;
}
...
void sub_8830()
{
    ...
    ADD_OBJECT_TO_INTERIOR_ROOM_BY_NAME( l_U317, "E1_Bowl_room" );
    return;
}
...
void sub_9773()
{
    ...
    if (NOT (DOES_OBJECT_EXIST( l_U298[0] )))
    {
        ...
        FREEZE_OBJECT_POSITION( l_U298[0], 1 );
        ADD_OBJECT_TO_INTERIOR_ROOM_BY_NAME( l_U298[0], "E1_Bowl_room" );
    }
    return;
}
...
void sub_13779()
{
    ...
    for ( I = 1; I <= 10; I++ )
    {
        if (l_U254[I])
        {
            ...
            ADD_OBJECT_TO_INTERIOR_ROOM_BY_NAME( l_U298[I], "E1_Bowl_room" );
...
void sub_22378(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown Result;
    unknown uVar9;
    unknown uVar10;
...
void sub_26065(int iParam0)
{
    switch (l_U7)
    {
        ...
        else
        {
            ...
            ProtectedSet(l_U26, 10 - iParam0);
        }
        break;
        case 2:
        l_U267 = 1;
        l_U7 = 1;
        if (ProtectedGet(l_U26) == iParam0)
        {
            l_U284 = 1;
            if (sub_10179())
            {
