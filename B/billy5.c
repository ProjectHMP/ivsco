...
void sub_1644()
{
    ...
    {
        if (((sub_1682( 5, g_U572[I] )) == 1) AND (g_U572[I]._fU20))
        {
...
void sub_3536()
{
    ...
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_3452(), 1 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_3452(), 1 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( sub_3452(), 1, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_3452(), 2 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_3452(), 2 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( sub_3452(), 2, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_3452(), 5 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_3452(), 5 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( sub_3452(), 5, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_3452(), 4 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_3452(), 4 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( sub_3452(), 4, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_3452(), 3 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_3452(), 3 )) == 0)))
    {
    ...
    iVar4 = -1;
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_3452(), 0 )) == iVar4)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_3452(), 0 )) == iVar4)))
    {
    ...
    while (((((NOT (HAS_MODEL_LOADED( 807349477 ))) || (NOT (HAS_MODEL_LOADED( sub_3084( 13 ) )))) || (NOT (HAS_MODEL_LOADED( 1613899343 )))) || (NOT (HAS_MODEL_LOADED( 1794146792 )))) || (NOT (HAS_MODEL_LOADED( -1745203402 ))))
    {
        WAIT( 0 );
    }
...
{
    sub_10381();
    if ((NOT l_U584) AND (sub_10942( 1, 1 )))
    {
        if ((IS_CHAR_IN_AREA_3D( sub_3452(), 1186.76700000, 441.96010000, 23.00000000, 1214.04300000, 455.00350000, 27.35000000, 0 )) AND (NOT (IS_CHAR_IN_ANY_HELI( sub_3452() ))))
        {
            REMOVE_BLIP( l_U521 );
...
void sub_12284()
{
    ...
    if (NOT l_U584)
    {
        if (((IS_CHAR_IN_AREA_2D( sub_3452(), 1353, 170, 1394, 192, 0 )) || (IS_CHAR_IN_AREA_3D( sub_3452(), 1383.23000000, 256.97000000, 26, 1360.56000000, 243.12000000, 36, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3452(), l_U607._fU0, l_U607._fU4, l_U607._fU8, 2.00000000, 2.00000000, 2.00000000, 1 )))
        {
...
void sub_12298()
{
    ...
    if (NOT l_U569)
    {
        if ((NOT (IS_CHAR_INJURED( l_U488 ))) AND (NOT (IS_CHAR_INJURED( l_U491 ))))
        {
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3452(), l_U491, 10.30000000, 10.30000000, 2.70000000, 0 )) AND (NOT l_U560))
            {
                if (sub_15614())
                {
                    sub_2701( ref l_U543, 1 );
    ...
    else if (((((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U488, sub_3452(), 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U488, 51 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U488, 4 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U488, 21 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U488, 28 )))
    {
        l_U560 = 1;
    }
    ...
    else if (((((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U491, sub_3452(), 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U491, 51 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U491, 4 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U491, 21 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U491, 28 )))
    {
        l_U560 = 1;
    }
    if (l_U560)
    ...
    if (NOT l_U589)
    {
        if ((TIMERA() > 30000) AND (sub_11066( 1, 1 )))
        {
            l_U589 = 1;
            sub_19243();
    ...
    if (NOT l_U589)
    {
        if ((((g_U39149[3] == 2) AND (l_U394 == 1)) AND (IS_SCREEN_FADED_OUT())) AND (sub_11066( 1, 1 )))
        {
    ...
    if (NOT l_U589)
    {
        if ((((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3452(), l_U488, 6.00000000, 6.00000000, 2.00000000, 0 )) AND (sub_11066( 1, 1 ))) AND (NOT l_U560)) AND (TIMERB() > 1000))
        {
            l_U589 = 1;
            sub_19243();
            sub_15670( "BG05_ROOF", ref l_U543, 7, 1 );
...
void sub_12468()
{
    ...
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( l_U488, 1 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( l_U488, 1 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( l_U488, 1, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( l_U488, 2 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( l_U488, 2 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( l_U488, 2, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( l_U488, 5 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( l_U488, 5 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( l_U488, 5, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( l_U488, 4 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( l_U488, 4 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( l_U488, 4, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( l_U488, 3 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( l_U488, 3 )) == 0)))
    {
    ...
    iVar4 = -1;
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( l_U488, 0 )) == iVar4)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( l_U488, 0 )) == iVar4)))
    {
...
void sub_17181()
{
    switch (l_U394)
    {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U488 ))) AND (NOT (IS_CHAR_INJURED( l_U491 ))))
        {
            if (NOT l_U579)
            {
                if (((NOT (IS_CHAR_INJURED( l_U491 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_17468( l_U543 ))))
                {
                    if (((IS_CHAR_IN_AREA_2D( sub_3452(), 1368.80000000, 195.77000000, 1376.30000000, 199.65000000, 0 )) || (IS_CHAR_IN_AREA_2D( sub_3452(), 1368.98000000, 205.40000000, 1373.47000000, 211.56000000, 0 ))) || (TIMERA() > 10000))
                    {
            ...
            if (NOT l_U592[0])
            {
                if (((LOCATE_CHAR_ANY_MEANS_3D( l_U488, 1365.70500000, 202.77100000, 39.68100000, 1.50000000, 1.50000000, 2.00000000, 0 )) AND (NOT sub_15614())) AND (l_U579 == 1))
                {
            ...
            if (NOT l_U592[1])
            {
                if (((LOCATE_CHAR_ANY_MEANS_3D( l_U488, 1365.62200000, 196.90760000, 39.68530000, 1.50000000, 1.50000000, 2.00000000, 0 )) AND (NOT sub_15614())) AND (l_U579 == 1))
                {
                    sub_15670( "E1B5_RAGE", ref l_U549, 7, 1 );
                    l_U592[1] = 1;
                }
        ...
        if (NOT l_U582)
        {
            if (IS_CHAR_IN_AREA_2D( sub_3452(), 1363.47000000, 220.13000000, 1375.30000000, 228.27000000, 0 ))
            {
                if ((NOT (sub_17468( l_U543 ))) AND (NOT (IS_CHAR_INJURED( l_U491 ))))
                {
        ...
        if ((((((IS_CHAR_IN_AREA_2D( sub_3452(), 1363.39000000, 208.28000000, 1396.76000000, 242.25000000, 0 )) AND (CAM_IS_SPHERE_VISIBLE( l_U520, 1376.70000000, 224.75000000, 46.48000000, 8.00000000 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_3452(), 1384.23000000, 210.50000000, 5.00000000, 5.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_3452(), 1395.96000000, 213.71000000, 5.00000000, 5.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_3452(), 1373.74000000, 239.01000000, 3.00000000, 3.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_3452(), 1367.43000000, 198.77000000, 2.00000000, 2.00000000, 0 )))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U488 )))
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( l_U488, 1377.56000000, 233.04000000, 47.03000000, 2.00000000, 2.00000000, 2.00000000, 0 )) AND (NOT (sub_17468( l_U543 ))))
            {
                if (DOES_CHAR_EXIST( l_U488 ))
                {
                    DELETE_CHAR( ref l_U488 );
...
void sub_19056()
{
    ...
    {
        case 1:
        if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_17468( l_U543 )))) AND (NOT l_U578))
        {
            if ((NOT (IS_CHAR_INJURED( l_U488 ))) AND (NOT (IS_CHAR_INJURED( l_U491 ))))
            {
...
void sub_19243()
{
    ...
    LOAD_ALL_OBJECTS_NOW();
    while ((((((((((NOT (HAS_MODEL_LOADED( -1004762946 ))) || (NOT (HAS_MODEL_LOADED( 1911513875 )))) || (NOT (HAS_MODEL_LOADED( -114291515 )))) || (NOT (HAS_MODEL_LOADED( 1613899343 )))) || (NOT (HAS_MODEL_LOADED( 1794146792 )))) || (NOT (HAS_MODEL_LOADED( l_U395 )))) || (NOT (HAS_MODEL_LOADED( l_U396 )))) || (NOT (HAS_MODEL_LOADED( -825837129 )))) || (NOT (HAS_MODEL_LOADED( -1328445565 )))) || (NOT (HAS_MODEL_LOADED( -1084007777 ))))
    {
        WAIT( 0 );
        GET_CURRENT_COP_MODEL( ref l_U395 );
        GET_CURRENT_POLICE_CAR_MODEL( ref l_U396 );
...
void sub_27384()
{
    ...
    if (l_U589)
    {
        if ((((NOT l_U571) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_17468( l_U543 )))) AND (TIMERA() > 500))
        {
    ...
    if (NOT l_U583)
    {
        ...
        if ((l_U616._fU8 < 28) AND (NOT sub_28895()))
        {
            sub_29094();
            if (NOT l_U590)
            {
    ...
    if (IS_WANTED_LEVEL_GREATER( sub_8571(), 0 ))
    {
        if ((((l_U583) AND (NOT l_U584)) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_17468( l_U543 ))))
        {
            PRINT_NOW( "B5_05", 7500, 0 );
            l_U584 = 1;
        }
...
int sub_28895()
{
    ...
    if (((((iVar2 == (GET_HASH_KEY( "Drugden_Floor03" ))) || (iVar2 == (GET_HASH_KEY( "Drugden_Floor3a" )))) || (iVar2 == (GET_HASH_KEY( "Drugden_Floor3b" )))) || (iVar2 == (GET_HASH_KEY( "drugden_floor1" )))) || (iVar2 == (GET_HASH_KEY( "DRUGDEN_FLOOR02" ))))
    {
        return 1;
    }
    else
