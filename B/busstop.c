        ...
        switch (g_U30190)
        {
            ...
            switch (l_U28)
            {
                ...
                if ((IS_SCREEN_FADED_OUT()) AND (NOT IS_SCREEN_FADING_IN()))
                {
                    ...
                    while ((((NOT (HAS_MODEL_LOADED( g_U30222 ))) || (NOT (HAS_MODEL_LOADED( g_U30224 )))) || (NOT (HAS_MODEL_LOADED( g_U30223 )))) || (NOT (HAS_MODEL_LOADED( g_U30225 ))))
                    {
                        WAIT( 0 );
                    }
                    REQUEST_ANIMS( l_U1 );
                    ...
                    while (NOT ((IS_SCREEN_FADED_OUT()) || (IS_SCREEN_FADING_OUT())))
                    {
                        WAIT( 0 );
                    }
                ...
                if (((IS_KEYBOARD_KEY_JUST_PRESSED( 36 )) || (l_U42 > l_U263)) || (l_U240))
                {
                    if ((l_U250) || ((l_U42 > l_U263) AND (l_U247)))
                    {
                        sub_22338();
                        WAIT( 0 );
                        sub_10340();
            ...
            switch (l_U28)
            {
                ...
                if ((IS_SCREEN_FADED_OUT()) AND (NOT IS_SCREEN_FADING_IN()))
                {
                    ...
                    LOAD_ALL_OBJECTS_NOW();
                    while ((((NOT (HAS_MODEL_LOADED( g_U30220 ))) || (NOT (HAS_MODEL_LOADED( g_U30218 )))) || (NOT (HAS_MODEL_LOADED( g_U30219 )))) || (NOT (HAS_MODEL_LOADED( g_U30221 ))))
                    {
                        WAIT( 0 );
                    }
                    l_U256 = l_U255;
                ...
                if (((IS_KEYBOARD_KEY_JUST_PRESSED( 36 )) || (l_U42 > l_U264)) || (l_U240))
                {
                    if (l_U240)
                    {
                        SAY_AMBIENT_SPEECH( l_U53[8], "DANCING_GAME_LUIS_FAIL", 1, 1, 2 );
                    ...
                    if ((l_U250) || ((l_U42 > l_U264) AND (l_U247)))
                    {
                        sub_22338();
                        WAIT( 0 );
                        sub_10340();
...
void sub_1075()
{
    ...
    switch (g_U30190)
    {
        ...
        sub_1211( (sub_1669( 0.58490000 - l_U302 )) + l_U303, 1 );
        ...
        sub_1211( (sub_1669( 0.69020000 - l_U302 )) + l_U303, 2 );
        ...
        sub_1211( (sub_1669( 0.75490000 - l_U302 )) + l_U303, 4 );
        ...
        sub_1211( (sub_1669( 0.86190000 - l_U302 )) + l_U303, 0 );
...
int sub_8944()
{
    ...
    l_U304 = 0;
    if (((l_U242 < 58) AND (l_U242 > 65478)) AND ((l_U244 < 58) AND (l_U244 > 65478)))
    {
        l_U248 = 1;
    }
    if (l_U248)
    {
        switch (l_U172[l_U237])
        {
            ...
            else if ((((l_U242 > 120) || (l_U242 < 65416)) || (l_U244 > 120)) || (l_U244 < 65416))
            {
                sub_9253();
                return 0;
            }
            ...
            else if (((sub_9716( 0, 17 )) || (sub_9716( 0, 14 ))) || (sub_9716( 0, 15 )))
            {
                sub_9253();
                return 0;
            }
            ...
            else if (((sub_9716( 0, 16 )) || (sub_9716( 0, 14 ))) || (sub_9716( 0, 15 )))
            {
                sub_9253();
                return 0;
            }
            ...
            else if (((sub_9716( 0, 16 )) || (sub_9716( 0, 17 ))) || (sub_9716( 0, 15 )))
            {
                sub_9253();
                return 0;
            }
            ...
            else if (((sub_9716( 0, 16 )) || (sub_9716( 0, 17 ))) || (sub_9716( 0, 14 )))
            {
                sub_9253();
                return 0;
            }
...
void sub_10413()
{
    ...
    switch (iVar2)
    {
        ...
        SET_CAM_ROT( l_U11[0], -30.68880000, 0.00000000, -60.71290000 );
        SET_CAM_FOV( l_U11[0], 45.00000000 );
        SET_CAM_ACTIVE( l_U11[0], 1 );
        CREATE_CAM( 14, ref l_U11[1] );
        SET_CAM_POS( l_U11[1], -431.54500000, 351.74010000, 12.36960000 );
        SET_CAM_ROT( l_U11[1], -16.09530000, 0.00000000, -85.78960000 );
        SET_CAM_FOV( l_U11[1], 45.00000000 );
        SET_CAM_ACTIVE( l_U11[1], 1 );
        CREATE_CAM( 14, ref l_U11[2] );
        ...
        SET_CAM_ROT( l_U11[0], -38.83370000, 0.00000000, -95.86440000 );
        SET_CAM_FOV( l_U11[0], 45.00000000 );
        SET_CAM_ACTIVE( l_U11[0], 1 );
        CREATE_CAM( 14, ref l_U11[1] );
        ...
        SET_CAM_ROT( l_U11[3], -0.33700000, 0.00000000, -92.26050000 );
        SET_CAM_FOV( l_U11[3], 45.00000000 );
        SET_CAM_ACTIVE( l_U11[3], 1 );
        CREATE_CAM( 25, ref l_U10 );
        SET_CAM_SPLINE_DURATION( l_U10, 15000 );
        ...
        SET_CAM_ROT( l_U11[1], -13.95760000, 0.00000000, -81.85880000 );
        ...
        SET_CAM_ROT( l_U11[3], -18.03250000, 0.00000000, -68.95210000 );
...
void sub_18181()
{
    ...
    switch (iVar2)
    {
        ...
        SET_CAM_ROT( l_U11[2], -6.63770000, 0.00000000, 70.55000000 );
        SET_CAM_FOV( l_U11[2], 45.00000000 );
        SET_CAM_ACTIVE( l_U11[2], 1 );
        CREATE_CAM( 14, ref l_U11[3] );
        ...
        SET_CAM_ACTIVE( l_U11[0], 1 );
        CREATE_CAM( 14, ref l_U11[1] );
        SET_CAM_POS( l_U11[1], -482.69500000, 147.79400000, 9.46720000 );
        ...
        SET_CAM_ROT( l_U11[0], 11.14320000, 0.00000000, 86.71200000 );
        SET_CAM_FOV( l_U11[0], 45.00000000 );
        SET_CAM_ACTIVE( l_U11[0], 1 );
        CREATE_CAM( 14, ref l_U11[1] );
...
void sub_25486()
{
    ...
    switch (g_U30190)
    {
        ...
        SET_CAM_ROT( l_U249, -33.00220000, -0.00000000, -97.65203000 );
...
void sub_31275()
{
    switch (l_U30)
    {
        ...
        if (DOES_CAM_EXIST( l_U10 ))
        {
            if ((NOT (IS_SPECIFIC_CAM_INTERPOLATING( l_U10 ))) AND (NOT l_U261))
            {
                switch (g_U30190)
                {
                    case 2:
...
void sub_31995()
{
    ...
    SET_CAM_POS( l_U11[5], -482.95100000, 148.80190000, 9.43940000 );
