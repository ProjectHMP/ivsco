    ...
    while (true)
    {
        ...
        switch (l_U124)
        {
            ...
            if (sub_851( l_U111 ))
            {
                ...
                {
                    if ((sub_3212( "1235550160" )) || (sub_3316( l_U116, 1 )))
                    {
                        l_U124 = 5;
                    }
                }
...
int sub_1661()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if (((sub_1699( 1, g_U572[I] )) != 0) AND (g_U572[I]._fU20))
        {
            sub_1962( I );
            return 1;
        }
...
int sub_4027(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_4272() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_4272() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_4604()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
