void main()
{
    ...
    while (true)
    {
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 37 )) AND (NOT l_U879))
        {
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 44 )) AND (NOT l_U886))
        {
...
void sub_4333()
{
    if (NOT l_U901)
    {
        ...
        switch (l_U821)
        {
            ...
            if (l_U854)
            {
                if ((sub_8858( ref l_U919[0] )) || (sub_8858( ref l_U919[1] )))
                {
                    sub_3696( 0 );
                    CLEAR_PRINTS();
                    if ((NOT (IS_CHAR_INJURED( l_U919[0] ))) AND (NOT (IS_CHAR_INJURED( l_U919[1] ))))
                    {
        ...
        if (IS_VEH_DRIVEABLE( l_U942 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U918 )))
            {
                ...
                if (NOT l_U854)
                {
                    ...
                    if (l_U896)
                    {
                        if (((CHECK_STUCK_TIMER( l_U942, 3, 60000 )) || (CHECK_STUCK_TIMER( l_U942, 2, 30000 ))) || (CHECK_STUCK_TIMER( l_U942, 1, 40000 )))
                        {
                            sub_3696( 0 );
                            CLEAR_PRINTS();
                    ...
                    else if (((CHECK_STUCK_TIMER( l_U942, 3, 60000 )) || (CHECK_STUCK_TIMER( l_U942, 2, 30000 ))) || (CHECK_STUCK_TIMER( l_U942, 1, 40000 )))
                    {
                        sub_3696( 0 );
                        CLEAR_PRINTS();
                        PRINT_NOW( "BER3_FAL5b", 7500, 1 );
                ...
                else if ((((sub_6898( ref l_U919[0] )) > 120) || ((sub_6898( ref l_U919[1] )) > 120)) || ((sub_6898( ref l_U919[2] )) > 120))
                {
                    if (sub_6051( ref l_U942, ref l_U903, ref l_U1065 ))
                    {
                        sub_3696( 0 );
...
int sub_8422()
{
    if (NOT (IS_CAR_DEAD( l_U945 )))
    {
        ...
        {
            if (((sub_6898( ref l_U919[0] )) > 200) AND (NOT (IS_CAR_ON_SCREEN( l_U945 ))))
            {
                sub_3696( 0 );
                CLEAR_PRINTS();
        ...
        {
            if (((sub_6898( ref l_U919[1] )) > 200) AND (NOT (IS_CAR_ON_SCREEN( l_U945 ))))
            {
                sub_3696( 0 );
                CLEAR_PRINTS();
                PRINT_NOW( "BER3_FAL3", 7500, 1 );
        ...
        if (((sub_6898( ref l_U918 )) > 180) AND (NOT (IS_CHAR_ON_SCREEN( l_U918 ))))
        {
            sub_3696( 0 );
            PRINT_NOW( "BER3_LOS2", 7500, 1 );
            sub_4444();
...
void sub_9736()
{
    ...
    l_U1128[2] = {911.14950000, 986.45250000, 6.90120000};
    ...
    l_U1244[7] = {351.32840000, 1066.64700000, 0.64130000};
...
void sub_15236()
{
    ...
    if (NOT l_U888)
    {
        switch (l_U811)
        {
            ...
            if ((IS_KEYBOARD_KEY_PRESSED( 36 )) AND (NOT l_U830[0]))
            {
            ...
            break;
            case 20:
            if ((sub_6166( ref l_U1008, 4000 )) || (l_U1038[0] == 1))
            {
                ...
                {
                    if (((NOT (IS_CHAR_INJURED( l_U919[0] ))) AND (NOT (IS_CHAR_INJURED( l_U919[1] )))) AND (NOT (IS_CHAR_INJURED( l_U919[2] ))))
                    {
                        if (NOT (IS_CAR_DEAD( l_U945 )))
                        {
                            if (NOT (IS_CAR_DEAD( l_U942 )))
...
void sub_15503()
{
    ...
    {
        case 0:
        if ((IS_CHAR_SITTING_IN_CAR( sub_4129(), l_U942 )) AND (NOT (CHECK_STUCK_TIMER( l_U942, 0, 250 ))))
        {
            if (IS_SCREEN_FADED_IN())
            {
        ...
        else
        {
            ...
            if (NOT l_U914)
            {
                if ((NOT (IS_CHAR_SITTING_IN_CAR( sub_4129(), l_U942 ))) AND (NOT (CHECK_STUCK_TIMER( l_U942, 0, 0 ))))
                {
        ...
        switch (g_U65005)
        {
            ...
            if ((IS_CHAR_SITTING_IN_CAR( sub_4129(), l_U942 )) AND (NOT (CHECK_STUCK_TIMER( l_U942, 0, 250 ))))
            {
                l_U914 = 0;
                l_U913 = 0;
                if ((sub_6166( ref l_U1008, 3000 )) AND (l_U916))
                {
                    if (sub_4817( "BC3_BANT1V1", ref l_U1573[0], 8, 1 ))
                    {
                        sub_15799();
        ...
        break;
        case 7:
        if (((sub_6898( ref l_U918 )) < 4.00000000) AND (IS_CHAR_IN_CAR( sub_4129(), l_U942 )))
        {
            if (l_U858)
            {
        ...
        break;
        case 9:
        if ((IS_CHAR_IN_CAR( sub_4129(), l_U942 )) AND (NOT (CHECK_STUCK_TIMER( l_U942, 0, 250 ))))
        {
            if (l_U858)
            {
    ...
    if (NOT l_U859)
    {
        for ( l_U992 = 0; l_U992 <= 2; l_U992++ )
        {
            if (LOCATE_CHAR_IN_CAR_3D( sub_4129(), l_U1297[l_U992]._fU0, l_U1297[l_U992]._fU4, l_U1297[l_U992]._fU8, 1.70000000, 1.70000000, 1.70000000, 0 ))
            {
                if (NOT (IS_CHAR_INJURED( l_U918 )))
                {
                    if ((IS_CHAR_IN_CAR( l_U918, l_U942 )) AND (IS_CHAR_IN_CAR( sub_4129(), l_U942 )))
                    {
    ...
    if (NOT l_U861)
    {
        if ((sub_22432()) AND (IS_CHAR_IN_CAR( sub_4129(), l_U942 )))
        {
            l_U819 = 14;
            l_U861 = 1;
        }
...
{
    if ((IS_CHAR_SITTING_IN_CAR( sub_4129(), (uParam0^) )) AND (NOT (CHECK_STUCK_TIMER( (uParam0^), 0, 250 ))))
    {
        (uParam5^) = 0;
        if ((uParam4^))
        {
    ...
    else
    {
        ...
        if (NOT (uParam5^))
        {
            if ((NOT (IS_CHAR_SITTING_IN_CAR( sub_4129(), (uParam0^) ))) AND (NOT (CHECK_STUCK_TIMER( (uParam0^), 0, 0 ))))
            {
...
void sub_32732(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_4129() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_32900())) AND (iVar3 != 4))
    {
...
void sub_33410()
{
    ...
    switch (l_U815)
    {
        ...
        if (l_U850)
        {
            if (NOT (IS_CAR_DEAD( l_U945 )))
            {
                if ((l_U1481 < 2.00000000) AND (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U945 )))
                {
                    l_U1481 += 0.00625000;
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 36 )) AND (NOT l_U830[1]))
        {
            l_U830[1] = 1;
            sub_41704();
        }
        ...
        for ( l_U992 = 0; l_U992 <= 2; l_U992++ )
        {
            if (NOT (IS_CHAR_INJURED( l_U919[l_U992] )))
            {
                ...
                if (((l_U1000[0] == 1) AND (l_U1000[1] == 1)) AND (l_U1000[2] == 1))
                {
                    l_U810 = 3;
                    break;
                }
                if (l_U1004[l_U992] == 0)
                {
                    if ((sub_44430( ref l_U919[l_U992], ref l_U1066[l_U992] )) || (sub_44550( ref l_U919[l_U992], 15.00000000 )))
                    {
                ...
                if (((l_U1004[0] == 1) AND (l_U1004[1] == 1)) AND (l_U1004[2] == 1))
                {
                    l_U810 = 3;
                    break;
                }
            ...
            if (((l_U1049[0] == 1) AND (l_U1049[1] == 1)) AND (l_U1049[2] == 1))
            {
                l_U810 = 4;
                break;
            }
    ...
    if ((IS_KEYBOARD_KEY_PRESSED( 21 )) AND (NOT l_U851))
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U945 )))
        {
            if (NOT (IS_CAR_DEAD( l_U942 )))
            {
                if ((NOT (IS_CHAR_INJURED( l_U919[0] ))) AND (NOT (IS_CHAR_INJURED( l_U919[1] ))))
                {
                    ...
                    SET_CAR_HEADING( l_U942, 64.30640000 );
                    if (IS_PED_ATTACHED_TO_ANY_CAR( l_U919[1] ))
                    {
                        DETACH_PED( l_U919[1], 1 );
...
int sub_44430(unknown uParam0, unknown uParam1)
{
    ...
    if (DOES_CHAR_EXIST( (uParam0^) ))
    {
        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
        {
            ...
            if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^), sub_4129(), 0 )) || (iVar4 < (uParam1^))) || (IS_CHAR_RESPONDING_TO_EVENT( (uParam0^), 9 )))
            {
                return 1;
            }
        }
...
void sub_45424()
{
    ...
    if (sub_45457( ref l_U919, ref l_U985 ))
    {
        ...
        if (IS_VEH_DRIVEABLE( l_U945 ))
        {
            ...
            if ((NOT (CAM_IS_SPHERE_VISIBLE( l_U1559, l_U1073._fU0, l_U1073._fU4, l_U1073._fU8, 5.00000000 ))) AND (NOT (CAM_IS_SPHERE_VISIBLE( l_U1559, l_U1076._fU0, l_U1076._fU4, l_U1076._fU8, 5.00000000 ))))
            {
                l_U912 = 1;
                sub_45791();
            }
...
void sub_46526()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U918 )))
    {
        if (IS_VEH_DRIVEABLE( l_U942 ))
        {
            ...
            {
                case 0:
                if ((LOCATE_CHAR_ON_FOOT_3D( sub_4129(), 845.27470000, 937.25520000, 2.08880000, 10.00000000, 10.00000000, 10.00000000, 0 )) || ((sub_6898( ref l_U918 )) < 10.00000000))
                {
                    l_U901 = 1;
                    if (l_U912)
                    {
                ...
                if (NOT (sub_16047( l_U1573[0] )))
                {
                    ...
                    if (sub_24170( 1 ))
                    {
                        ...
                        LOAD_SCENE( 835.64250000, 931.51950000, 4.55115100 );
                        if (NOT (IS_CHAR_INJURED( l_U918 )))
                        {
                            if (IS_VEH_DRIVEABLE( l_U942 ))
                            {
                ...
                if (NOT (IS_CHAR_INJURED( l_U918 )))
                {
                    if (IS_VEH_DRIVEABLE( l_U942 ))
                    {
                        if ((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U942 ))) || (sub_6166( ref l_U1008, 4250 )))
                        {
                            DO_SCREEN_FADE_OUT( 500 );
                            l_U817 = 4;
                        }
                ...
                if (sub_6166( ref l_U1008, 3000 ))
                {
                    if ((l_U891) AND (NOT (sub_16047( l_U1573[0] ))))
                    {
                        if (NOT (IS_CAR_DEAD( l_U942 )))
                        {
                            if (NOT (IS_CHAR_INJURED( l_U918 )))
                ...
                if (IS_SCREEN_FADED_OUT())
                {
                    if (NOT (IS_CHAR_INJURED( l_U918 )))
                    {
                        if (IS_VEH_DRIVEABLE( l_U942 ))
                        {
                            ...
                            SET_CAR_COORDINATES( l_U942, 827.29270000, 942.69050000, -0.20000000 );
...
void sub_46999()
{
    if (NOT (IS_CHAR_INJURED( l_U918 )))
    {
        ...
        {
            WARP_CHAR_FROM_CAR_TO_COORD( l_U918, 827.29270000, 942.69050000, 3.00000000 );
        }
        ATTACH_PED_TO_CAR( l_U918, l_U942, 0, 0.20000000, -3.70000000, 0.95000000, 0.00000000, 360.00000000, 1, 1 );
        SET_CHAR_HEADING( l_U918, 264.66840000 );
        TASK_LOOK_AT_CHAR( l_U918, sub_4129(), -2, 0 );
...
void sub_47188()
{
    ...
    SET_CAM_FOV( l_U1515, 31.20004000 );
    ...
    SET_CAM_ROT( l_U1517, -9.75485000, 0.00000000, 66.20978000 );
    SET_CAM_FOV( l_U1517, 30.00004000 );
    SET_CAM_POS( l_U1518, 843.62980000, 935.13560000, 2.60566900 );
    SET_CAM_ROT( l_U1518, -9.75485000, 0.00000000, 66.20978000 );
        ...
        if (IS_VEH_DRIVEABLE( l_U942 ))
        {
            switch (l_U818)
            {
                    ...
                    if (sub_24170( 1 ))
                    {
                        ...
                        if (NOT (IS_CHAR_INJURED( l_U918 )))
                        {
                            if (NOT (IS_CAR_DEAD( l_U942 )))
                            {
                                ...
                                SET_CAM_ROT( l_U1516, -7.90666800, -0.00000000, 24.43114000 );
                                SET_CAM_FOV( l_U1516, 28.20004000 );
                                SET_CAM_POS( l_U1517, 516.15000000, -529.26310000, 1.73415000 );
                                SET_CAM_ROT( l_U1517, -7.35422800, 0.00000000, 26.80431000 );
                                SET_CAM_FOV( l_U1517, 32.40003000 );
                                SET_CAM_POS( l_U1518, 500.63670000, -505.64500000, 2.13919600 );
                ...
                if (NOT (IS_CHAR_INJURED( l_U918 )))
                {
                    if (NOT (IS_CAR_DEAD( l_U942 )))
                    {
                        if ((NOT (IS_CHAR_ON_SCREEN( l_U918 ))) AND (NOT (IS_CAR_ON_SCREEN( l_U942 ))))
                        {
                            if (NOT (IS_CAR_DEAD( l_U942 )))
                            {
                                SET_CAM_ACTIVE( l_U1524, 0 );
...
void sub_65830()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U918 )))
    {
        switch (l_U822)
        {
            ...
            break;
            case 7:
            if (((sub_6166( ref l_U1008, 3000 )) || (NOT (IS_CHAR_ON_SCREEN( l_U918 )))) || (l_U1038[3] == 1))
            {
                DO_SCREEN_FADE_OUT( 500 );
                while (NOT IS_SCREEN_FADED_OUT())
                {
