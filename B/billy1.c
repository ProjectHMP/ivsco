...
void sub_2084()
{
    ...
    {
        if (((sub_2122( 5, g_U572[I] )) == 1) AND (g_U572[I]._fU20))
        {
...
void sub_5152()
{
    ...
    if ((NOT (IS_CHAR_DEAD( sub_3854() ))) AND (g_U39149[0] < 1))
    {
    ...
    l_U1104[0] = {-481.56090000, 1774.75500000, 8.61653500};
    l_U1104[1] = {-482.51700000, 1770.66600000, 8.62929600};
    l_U1104[2] = {-479.19540000, 1772.00300000, 8.64084200};
    l_U1104[3] = {-484.83780000, 1772.66500000, 8.65998500};
...
void sub_6953()
{
    if (((((NOT (l_U703 == 0)) AND (NOT (l_U703 == 2))) AND (NOT (l_U703 == 4))) AND (NOT (l_U703 == 8))) AND (NOT ((l_U703 == 5) AND (g_U39149[0] == 3))))
    {
        for ( l_U1148 = 0; l_U1148 < l_U708; l_U1148++ )
        {
...
void sub_8416(int iParam0, boolean bParam1)
{
    ...
    if ((DOES_CHAR_EXIST( iParam0->_fU0 )) AND (iParam0->_fU0 != sub_3854()))
    {
...
void sub_11175()
{
    ...
    while (((((((((((NOT (HAS_MODEL_LOADED( sub_4752( 0 ) ))) || (NOT (HAS_MODEL_LOADED( sub_4752( 1 ) )))) || (NOT (HAS_MODEL_LOADED( sub_4752( 13 ) )))) || (NOT (HAS_MODEL_LOADED( sub_4752( 16 ) )))) || (NOT (HAS_MODEL_LOADED( sub_4752( 6 ) )))) || (NOT (HAS_MODEL_LOADED( sub_4752( 7 ) )))) || (NOT (HAS_MODEL_LOADED( -408052231 )))) || (NOT (HAS_MODEL_LOADED( -570033273 )))) || (NOT (HAS_MODEL_LOADED( sub_11355() )))) || (NOT (HAVE_ANIMS_LOADED( "MISSBIKE_GESTCHOP" )))) || (NOT (HAVE_ANIMS_LOADED( "MISSBILLY_1" ))))
    {
        REQUEST_MODEL( sub_4752( 0 ) );
        REQUEST_MODEL( sub_4752( 1 ) );
        REQUEST_MODEL( sub_4752( 13 ) );
...
void sub_13883(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((((((uParam0^) == (sub_4752( 0 ))) || ((uParam0^) == (sub_4752( 1 )))) || ((uParam0^) == (sub_4752( 6 )))) || ((uParam0^) == (sub_4752( 7 )))) || ((uParam0^) == (sub_4752( 13 )))) || ((uParam0^) == (sub_4752( 16 ))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_4752( 15 ))) || ((uParam0^) == (sub_4752( 17 ))))
        {
            Result = 3;
        }
    }
...
void sub_14599(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_4752( 6 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_4752( 7 ) ))))
        {
            sub_15095( iParam0 );
        }
    }
...
void sub_15421(unknown uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
    ...
    if (NOT (IS_CHAR_DEAD( (uParam0^) )))
    {
        ...
        if (((uParam0^) == sub_3854()) AND (g_U15728[19]))
        {
...
{
    if ((NOT (sub_13785( uParam0 ))) || (NOT (HAS_MODEL_LOADED( sub_16610( uParam0 ) ))))
    {
        sub_13824( uParam0 );
...
void sub_16889(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_13873( vParam0 + (vector( 2.00000000, 0.00000000, 0.00000000)), uParam3, uParam4, iParam6 );
...
void sub_18718(int iParam0, int iParam1)
{
    ...
    if ((iParam0->_fU8 == sub_3854()) AND (iParam1 != sub_3854()))
    {
...
{
    return (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 )) AND (NOT (sub_18838( uParam0, uParam1 )));
}
...
void sub_21265()
{
    ...
    sub_24134();
    if ((IS_CHAR_SITTING_IN_CAR( sub_3854(), l_U875 )) AND (IS_CHAR_IN_CAR( l_U708[0]._fU0, l_U875 )))
    {
        if (NOT l_U1059)
        {
            if (IS_EPISODIC_DISC_BUILD())
            {
                if (l_U1047)
                {
                    ...
                    else if (((TIMERA() > 21500) AND (TIMERA() < 25500)) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ENTERC" ))))
                    {
                        PRINT_HELP( "ENTERC" );
                    }
                    else if ((TIMERA() > 17500) AND (TIMERA() < 21500))
                    {
                    ...
                    else if ((TIMERA() > 13500) AND (TIMERA() < 17500))
                    {
                    ...
                    else if ((TIMERA() > 9500) AND (TIMERA() < 13500))
                    {
            ...
            else if ((l_U1047) AND (TIMERA() >= 9500))
            {
                PRINT_HELP( "B1_SCHELP" );
                l_U1059 = 1;
            }
        ...
        if (sub_52751())
        {
            ...
            else if ((sub_53185( l_U933 )) AND (l_U1076 == 0))
            {
                switch (l_U1156)
                {
                    case 0:
    ...
    sub_61798();
    sub_61948();
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3854(), l_U1098._fU0, l_U1098._fU4, l_U1098._fU8, 40, 40, 40, 0 )) AND (l_U1080 == 0))
    {
        sub_28478( "BG01_BACK", ref l_U939, 7, 1 );
        l_U1080 = 1;
    }
    if ((IS_GROUP_MEMBER( l_U708[0]._fU0, sub_5876() )) AND (NOT l_U948))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3854(), l_U1098._fU0, l_U1098._fU4, l_U1098._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (sub_62625( 1, 1 )))
        {
            if (DOES_BLIP_EXIST( l_U898 ))
            {
                REMOVE_BLIP( l_U898 );
...
void sub_21278(unknown uParam0)
{
    ...
    if ((((((((IS_CONTROL_PRESSED( 0, 51 )) AND (NOT (IS_CONTROL_PRESSED( 0, 38 )))) AND (NOT (IS_CONTROL_PRESSED( 0, 39 )))) AND (IS_CHAR_ON_ANY_BIKE( sub_3854() ))) AND (NOT sub_23614())) AND (NOT (iVar14 == 4))) AND (iVar8 >= 0)) AND (NOT bVar4))
    {
...
void sub_21505(unknown uParam0)
{
    ...
    {
        if (((sub_21539( uParam0, I )) AND (I != l_U20)) AND (Result < 0))
        {
            Result = I;
        }
    }
...
int sub_21539(unknown uParam0, int iParam1)
{
    ...
    if (((NOT (IS_CHAR_INJURED( (uParam0^)[iParam1]._fU0 ))) AND (IS_VEH_DRIVEABLE( (uParam0^)[iParam1]._fU4 ))) AND (NOT (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_3854() ))))
    {
        if (((NOT (IS_CHAR_IN_CAR( sub_3854(), (uParam0^)[iParam1]._fU4 ))) AND (IS_CHAR_IN_CAR( (uParam0^)[iParam1]._fU0, (uParam0^)[iParam1]._fU4 ))) AND (IS_CHAR_ON_ANY_BIKE( (uParam0^)[iParam1]._fU0 )))
        {
...
void sub_24134()
{
    if ((NOT l_U946) AND (NOT (IS_CAR_DEAD( l_U875 ))))
    {
        if ((NOT (IS_CAR_STOPPED( l_U875 ))) || (NOT (IS_CHAR_STOPPED( sub_3854() ))))
        {
            l_U946 = 1;
        }
    }
    else if ((NOT (l_U703 == 1)) AND (NOT (IS_CAR_DEAD( l_U875 ))))
    {
        if (IS_CHAR_IN_CAR( sub_3854(), l_U875 ))
        {
            ...
            if ((l_U1018) || (NOT (l_U703 == 3)))
            {
                sub_47581( ref l_U708, -2, 0 );
            }
        }
        else if ((NOT l_U1023) AND (NOT (IS_CAR_DEAD( l_U875 ))))
        {
        ...
        for ( l_U1148 = 0; l_U1148 < l_U708; l_U1148++ )
        {
            if (NOT (l_U1148 == 0))
            {
                if (NOT (IS_CHAR_INJURED( l_U708[l_U1148]._fU0 )))
                {
                    ...
                    {
                        if ((IS_CHAR_IN_ANGLED_AREA_2D( l_U708[l_U1148]._fU0, -1763.32000000, 385.27000000, -1751.43000000, 405.89000000, 65425, 0 )) AND (IS_CHAR_IN_ANY_CAR( l_U708[l_U1148]._fU0 )))
                        {
...
int sub_24770(int iParam0)
{
    ...
    if ((NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))) || (IS_CHAR_SITTING_IN_ANY_CAR( sub_3854() )))
    {
        return 0;
    }
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_14638( iParam0 + 0 )) == 3) AND ((sub_24913( iVar3 )) == sub_11355())))
        {
            if ((((sub_14638( iParam0 + 0 )) != 1) || ((sub_24971( iParam0->_fU0 )) == (sub_4752( 0 )))) || ((sub_25013( sub_3854() )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_3854() )))))
            {
                return 0;
            }
            else
    ...
    if (Result)
    {
        ...
        if (DOES_CHAR_EXIST( iParam2 ))
        {
            ...
            if (iParam0 != sub_3854())
            {
                ...
                if ((iVar8 == 1) AND (iParam2 != sub_3854()))
                {
        ...
        if (iParam3 != 39)
        {
            if ((iParam3 == 38) AND (IS_CHAR_MODEL( iParam0, sub_4752( 0 ) )))
            {
                if (l_U180)
                {
...
int sub_27613(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((sub_25013( iParam0->_fU0 )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))))
    {
        return 2;
    }
    else if ((uParam1) || (sub_20058( iParam0, 1 )))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_28168(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if (((sub_28234( (iParam0^) )) AND (NOT l_U162)) AND (NOT l_U163))
            {
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_28286()))
                {
                    if ((IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )) AND (IS_CHAR_ON_ANY_BIKE( sub_3854() )))
                    {
        ...
        {
            if ((((((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3854(), iParam0->_fU0, l_U153, l_U153, l_U153, 0 ))) || (NOT (IS_CHAR_ON_ANY_BIKE( sub_3854() )))) || (NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3854() )))) || (NOT (sub_30267( l_U155 ))))
            {
                sub_3795( iParam0 );
            }
        }
...
void sub_30823(int iParam0)
{
    ...
    if ((sub_28199( (iParam0^) )) AND (sub_28286()))
    {
        if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
        {
            if (((IS_CHAR_SITTING_IN_CAR( iParam0->_fU0, iParam0->_fU4 )) AND (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 ))) AND (IS_CHAR_ON_ANY_BIKE( sub_3854() )))
            {
                ...
                {
                    if ((l_U175 != iParam0->_fU0) || (l_U176 != sub_3854()))
                    {
    ...
    if (((sub_28286()) || (sub_28199( (iParam0^) ))) || ((iVar4 - l_U173) < 33))
    {
        return;
    }
    if (l_U173 <= 0)
    ...
    if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_31750( uVar12 ))
            {
                ...
                if (((NOT (sub_28199( (iParam0^) ))) AND (((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) AND (fVar21 < 19)) || (fVar21 < 15))) AND (iParam0->_fU0 != l_U175))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((l_U14) AND ((iParam0->_fU36 != 1) || ((sub_25765( 0, 10 )) == 0)))
                    {
                        l_U14 = 0;
                        iVar15 = 17;
                        iVar11 = sub_3854();
                    }
                    else if ((((sub_31946( iParam0 )) AND (iParam0->_fU36 == 2)) AND ((sub_14638( iParam0 + 0 )) == 1)) AND (NOT (IS_BIT_SET( l_U178, 6 ))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_32060( bVar16 );
                        iVar11 = sub_3854();
                    }
                    else if (((IS_CAR_IN_AIR_PROPER( uVar12 )) AND ((ABSF( uVar22 )) < 20.00000000)) AND (sub_32148( 8 )))
                    {
                        uVar13 = sub_32402( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_3854() )) AND (sub_32148( 12 )))
                    {
                        uVar13 = sub_32060( bVar16 );
                        iVar11 = sub_3854();
                        iVar15 = 12;
                    ...
                    else if (((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 )) || (IS_PED_RAGDOLL( iParam0->_fU0 ))) AND (sub_32148( 13 )))
                    {
                        uVar13 = sub_32060( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if (((((sub_14638( iParam0 + 0 )) == 1) AND (NOT (IS_PLAYER_PRESSING_HORN( sub_5225() )))) AND (IS_BIT_SET( l_U178, 7 ))) AND (sub_32148( 20 )))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if ((((IS_WANTED_LEVEL_GREATER( sub_5225(), 0 )) AND (NOT (IS_BIT_SET( l_U178, 0 )))) AND (sub_32148( 24 ))) AND ((sub_14638( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 24;
                        iVar11 = sub_3854();
                    }
                    else if ((((NOT (IS_WANTED_LEVEL_GREATER( sub_5225(), 0 ))) AND (IS_BIT_SET( l_U178, 0 ))) AND (sub_32148( 30 ))) AND ((sub_14638( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_32148( 33 )) AND (NOT (IS_BIT_SET( l_U178, 4 )))) AND ((sub_14638( iParam0 + 0 )) == 1))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_3854() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_32148( 31 )) AND (NOT (IS_BIT_SET( l_U178, 4 )))) AND ((sub_14638( iParam0 + 0 )) == 1))
                                    {
                            ...
                            else if ((IS_CHAR_ON_FOOT( sub_3854() )) AND (NOT (IS_PED_RAGDOLL( sub_3854() ))))
                            {
                                CLEAR_BIT( ref l_U178, 3 );
                                CLEAR_BIT( ref l_U178, 4 );
                            };;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((sub_32148( 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_5225(), 0 ))))
                                {
                                ...
                                else if (((sub_32148( 36 )) AND (IS_WANTED_LEVEL_GREATER( sub_5225(), 0 ))) AND (NOT (IS_BIT_SET( l_U178, 1 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((IS_WANTED_LEVEL_GREATER( sub_5225(), 2 )) AND (sub_32148( 23 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            if ((IS_WANTED_LEVEL_GREATER( sub_5225(), 0 )) AND (NOT (IS_BIT_SET( l_U178, 2 ))))
                            {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if ((sub_32148( 28 )) AND ((sub_14638( iParam0 + 0 )) == 1))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_32148( 3 )) AND (sub_32148( 4 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if (((sub_14638( iParam0 + 0 )) == 1) AND (fVar26 < 5))
                            {
                                if ((sub_32148( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_5225(), 0 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if ((sub_32148( 30 )) AND ((sub_14638( iParam0 + 0 )) == 1))
                                {
                                    iVar15 = 30;
                                }
    ...
    if ((IS_PLAYER_PRESSING_HORN( sub_5225() )) AND (NOT (IS_BIT_SET( l_U178, 7 ))))
    {
...
int sub_36950(int iParam0)
{
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            {
                if (((sub_14638( ref iVar4 )) == (sub_14638( iParam0 + 0 ))) || ((iVar4 == sub_3854()) AND ((sub_14638( iParam0 + 0 )) == 1)))
                {
...
int sub_37207(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((iVar3 == sub_3854()) || ((iVar3 == iParam0->_fU8) AND (NOT (IS_CHAR_INJURED( iVar3 )))))
        {
        ...
        if ((((IS_CHAR_IN_CAR( sub_3854(), iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((sub_22315( iParam0->_fU0, sub_3854(), 1 )) < 90.00000000))
        {
...
int sub_37943(unknown uParam0)
{
    ...
    if (IS_PED_IN_GROUP( uParam0 ))
    {
        ...
        if (DOES_GROUP_EXIST( iVar3 ))
        {
            ...
            {
                if (((iVar4 < 1) || (iVar5 < 2)) AND (iVar3 != sub_5876()))
                {
                    REMOVE_GROUP( iVar3 );
                }
                else
            ...
            else if ((iVar5 < 1) AND (iVar3 != sub_5876()))
            {
                REMOVE_GROUP( iVar3 );
            }
        }
...
int sub_38339(int iParam0)
{
    ...
    if ((NOT (sub_20058( iParam0, 2 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        return 0;
    }
...
int sub_38874(int iParam0)
{
    ...
    else if ((((sub_35996( iParam0 )) > 90.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND ((sub_22315( iParam0->_fU0, sub_3854(), 1 )) > 90.00000000))
    {
        ...
        {
            if (((CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 )) || (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 ))) || ((VDIST( sub_21681( sub_3854(), 1 ), uVar4 )) < 30.00000000))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_39489(int iParam0)
{
    ...
    if (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
    {
        if (NOT (IS_PED_IN_COMBAT( iParam0->_fU0 )))
        {
            ...
            if ((iVar3 == 7) AND (NOT (IS_CHAR_FACING_CHAR( iParam0->_fU0, sub_3854(), 45.00000000 ))))
            {
...
int sub_39646(int iParam0)
{
    ...
    if (DOES_VEHICLE_EXIST( iVar4 ))
    {
        if (sub_18814( iParam0->_fU0, iVar4 ))
        {
            ...
            bVar6 = false;
            if ((NOT (IS_CHAR_IN_CAR( sub_3854(), iVar4 ))) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_3854() ))))
            {
    ...
    if ((sub_20058( iParam0, 1 )) AND ((sub_35996( iParam0 )) < 30.00000000))
    {
    ...
    if (iParam0->_fU8 == sub_3854())
    {
        if ((IS_CHAR_ON_FOOT( iParam0->_fU0 )) AND (IS_CHAR_ON_FOOT( sub_3854() )))
        {
    ...
    if ((NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))) AND ((((IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 )) || (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 ))) || (DOES_VEHICLE_EXIST( iVar4 ))) || ((sub_22315( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8)))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((sub_18838( iParam0->_fU8, iParam0->_fU4 )) || (iParam0->_fU4 == iVar4))
            {
            ...
            else if ((sub_18838( sub_3854(), iParam0->_fU4 )) AND ((sub_14638( iParam0 + 0 )) == 1))
            {
    ...
    else if (((sub_37245( sub_3854(), iParam0->_fU0, 1 )) AND (iParam0->_fU8 != sub_3854())) AND ((sub_14638( iParam0 + 0 )) == 1))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((NOT (sub_20058( iParam0, 1 ))) || (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
        {
            if ((sub_27775( iParam0 )) != 0)
            {
                ;
    ...
    else if ((sub_20058( iParam0, 1 )) AND (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))))
    {
...
int sub_41399(int iParam0)
{
    ...
    else if ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_31793( iParam0 )) > 30.00000000))
    {
...
int sub_41810(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((VDIST( uVar4, uVar10 )) < 30.00000000)) || ((VDIST( uVar4, uVar7 )) < 30.00000000))
        {
            ...
            else if ((iVar3 == sub_3854()) || ((sub_14638( ref iVar3 )) == (sub_14638( iParam0 + 0 ))))
            {
...
int sub_42636(int iParam0)
{
    ...
    if ((((IS_PED_IN_COMBAT( iParam0->_fU0 )) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 ))) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 ))) AND ((sub_35996( iParam0 )) < 30.00000000))
    {
        return 2;
    }
    return 0;
...
int sub_42785(int iParam0)
{
    ...
    else if ((iParam0->_fU8 == sub_3854()) AND (IS_CHAR_GETTING_IN_TO_A_CAR( sub_3854() )))
    {
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_36524( iParam0->_fU4 )) || (sub_20058( iParam0, 4 ))) AND ((sub_31793( iParam0 )) >= l_U133))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 ))) AND ((VDIST( uVar15, sub_21681( sub_3854(), 1 ) )) > fParam2)) AND ((VDIST2( uVar15, vVar6 )) > 9.00000000))
                    {
...
void sub_47581(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    {
        iVar31[I] = -1;
        uVar52[I] = sub_48180( uParam0, ref uVar21[I], ref iVar6, (bVar17) || (NOT bParam2) );
        if (uVar52[I] >= 0)
        {
    ...
    if (uVar52[0] == uVar52[1])
    {
        ...
        J = (J + 1) mod 2;
        uVar52[J] = sub_48180( uParam0, ref uVar21[J], ref iVar6, (bVar17) || (NOT bParam2) );
        if (uVar52[J] >= 0)
        {
...
void sub_50502(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        else if ((iParam0->_fU36 == 4) AND ((VDIST( iParam0->_fU16, sub_21681( iParam0->_fU0, 1 ) )) < 12.00000000))
        {
            return;
        }
...
{
    if ((NOT (IS_CHAR_INJURED( uParam0 ))) AND (NOT (IS_CHAR_INJURED( sub_3854() ))))
    {
...
int sub_52751()
{
    if ((((((NOT (sub_30267( l_U939 ))) AND (NOT (sub_30267( l_U933 )))) AND (NOT sub_52785())) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT l_U948)) AND (NOT l_U1052))
    {
        return 1;
    }
    return 0;
    ...
    if ((IS_CHAR_SITTING_IN_CAR( sub_3854(), l_U875 )) AND (IS_CHAR_IN_CAR( l_U708[0]._fU0, l_U875 )))
    {
        if (sub_30267( l_U933 ))
        {
            if (l_U1042)
            {
                ...
                if ((((IS_SCRIPTED_SPEECH_PLAYING( l_U708[0]._fU0 )) AND ((sub_53719( l_U933 )) != 7)) AND ((sub_53719( l_U933 )) != 10)) AND ((sub_53719( l_U933 )) != 17))
                {
                    if (l_U1087 == 0)
                    {
            ...
            else if (l_U1039)
            {
                ...
                if (((((IS_SCRIPTED_SPEECH_PLAYING( l_U708[0]._fU0 )) AND ((sub_53719( l_U933 )) != 18)) AND ((sub_53719( l_U933 )) != 25)) AND ((sub_53719( l_U933 )) != 28)) AND ((sub_53719( l_U933 )) != 21))
                {
                    if (l_U1087 == 0)
                    {
                        GENERATE_RANDOM_INT_IN_RANGE( 1, 101, ref iVar2 );
            ...
            else if (l_U1035)
            {
                ...
                if (((IS_SCRIPTED_SPEECH_PLAYING( l_U708[0]._fU0 )) AND ((sub_53719( l_U933 )) != 5)) AND ((sub_53719( l_U933 )) != 9))
                {
                    if (l_U1087 == 0)
                    {
                        GENERATE_RANDOM_INT_IN_RANGE( 1, 101, ref iVar2 );
        ...
        if ((sub_52751()) AND (NOT (sub_53185( l_U933 ))))
        {
        ...
        if (((NOT IS_MESSAGE_BEING_DISPLAYED()) || (sub_30267( l_U933 ))) AND (NOT (sub_30267( l_U939 ))))
        {
            if (NOT l_U1046)
            {
                ...
                if (l_U1073)
                {
                    ...
                    if (((l_U1075 == 1) AND (NOT (sub_30267( l_U933 )))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U708[0]._fU0, -497.92620000, 1747.81500000, 7.52390000, 50, 50, 50, 0 ))))
                    {
            ...
            if (((l_U1153 < l_U1154) AND (l_U1074 == 0)) AND (NOT (sub_30267( l_U933 ))))
            {
                if (sub_30267( l_U933 ))
                {
            ...
            if ((l_U1074 == 1) AND (NOT (sub_30267( l_U933 ))))
            {
...
void sub_58857()
{
    if (NOT l_U1052)
    {
        if (IS_VEH_DRIVEABLE( l_U875 ))
        {
            if (NOT l_U948)
            {
                if (NOT (IS_CHAR_SITTING_IN_CAR( sub_3854(), l_U875 )))
                {
                    ...
                    if (NOT sub_58993())
                    {
                        ...
                        if (((NOT l_U950) AND (NOT (IS_CHAR_INJURED( l_U708[0]._fU0 )))) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                        {
                ...
                else if (l_U703 == 7)
                {
                    if (NOT l_U954)
                    {
                        if (((((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3854(), l_U708[0]._fU0, 200, 200, 200, 0 ))) AND (NOT (sub_30267( l_U939 )))) AND (NOT (sub_30267( l_U933 )))) AND (NOT sub_52785())) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                        {
            ...
            if (IS_CHAR_SITTING_IN_CAR( sub_3854(), l_U875 ))
            {
                if ((IS_GROUP_MEMBER( l_U708[0]._fU0, sub_5876() )) || (l_U703 == 7))
                {
                    sub_60172();
                }
                if (DOES_BLIP_EXIST( l_U902 ))
...
void sub_60172()
{
    switch (l_U703)
    {
        ...
        break;
        case 7:
        if (((((sub_30267( l_U939 )) AND (NOT l_U1053)) AND (NOT l_U1051)) AND (IS_CHAR_SITTING_IN_CAR( sub_3854(), l_U875 ))) AND (NOT l_U1054))
        {
            l_U1053 = 1;
        }
        else
...
void sub_60744()
{
    if (NOT (IS_GROUP_MEMBER( l_U708[0]._fU0, sub_5876() )))
    {
        ...
        {
            if ((NOT (IS_CHAR_IN_ANY_CAR( sub_3854() ))) || (IS_CHAR_IN_CAR( sub_3854(), l_U875 )))
            {
                GET_CAR_CHAR_IS_USING( sub_3854(), ref l_U880 );
                if ((l_U880 == nil) || (l_U880 == l_U875))
                {
    ...
    else if ((IS_CHAR_IN_ANY_CAR( sub_3854() )) || (IS_CHAR_GETTING_IN_TO_A_CAR( sub_3854() )))
    {
        GET_CAR_CHAR_IS_USING( sub_3854(), ref l_U880 );
        if (l_U880 != l_U875)
        {
...
void sub_61948()
{
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3854(), 63808, 354, 24.40000000, 7, 7, 7, 0 )) AND (l_U1067[2] == 0))
    {
        GET_RANDOM_CHAR_IN_AREA_OFFSET_NO_SAVE( 63808, 354, 24.40000000, 6, 3, 4, ref iVar2 );
        if (((iVar2 != nil) AND (NOT (IS_CHAR_INJURED( iVar2 )))) AND (NOT (IS_CHAR_INJURED( sub_3854() ))))
        {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3854(), 63814, 357, 24.40000000, 7, 7, 7, 0 )) AND (l_U1067[1] == 0))
    {
        GET_RANDOM_CHAR_IN_AREA_OFFSET_NO_SAVE( 63814, 357, 24.40000000, 6, 3, 4, ref iVar3 );
        if (((iVar3 != nil) AND (NOT (IS_CHAR_INJURED( iVar3 )))) AND (NOT (IS_CHAR_INJURED( sub_3854() ))))
        {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3854(), 63820, 360, 24.40000000, 7, 7, 7, 0 )) AND (l_U1067[0] == 0))
    {
        GET_RANDOM_CHAR_IN_AREA_OFFSET_NO_SAVE( 63820, 360, 24.40000000, 6, 3, 4, ref iVar4 );
        if (((iVar4 != nil) AND (NOT (IS_CHAR_INJURED( iVar4 )))) AND (NOT (IS_CHAR_INJURED( sub_3854() ))))
        {
...
void sub_62826()
{
    switch (l_U704)
    {
        ...
        CREATE_OBJECT( -1165777728, 879.16000000, 1526.75000000, 16.00000000, ref l_U886[1], 1 );
...
void sub_64273()
{
    ...
    if ((((IS_CHAR_SITTING_IN_CAR( sub_3854(), l_U875 )) AND (IS_CHAR_IN_CAR( l_U708[0]._fU0, l_U875 ))) AND (sub_52751())) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
        if (NOT l_U1081)
        {
            if ((IS_SCREEN_FADED_IN()) AND (NOT (sub_30267( l_U939 ))))
            {
        ...
        else if ((NOT l_U1037) AND (l_U1081))
        {
            if ((IS_SCREEN_FADED_IN()) AND (NOT (sub_30267( l_U939 ))))
            {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3854(), l_U1089._fU0, l_U1089._fU4, l_U1089._fU8, 150, 150, 100, 0 )) AND (l_U1079 == 0))
    {
    ...
    if ((IS_GROUP_MEMBER( l_U708[0]._fU0, sub_5876() )) AND (NOT l_U948))
    {
        if (((LOCATE_CHAR_ANY_MEANS_3D( sub_3854(), l_U1089._fU0, l_U1089._fU4, l_U1089._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3854(), 928.75000000, 1563.16000000, 18.26000000, 2.50000000, 2.50000000, 2.50000000, 0 ))) AND (sub_62625( 1, 1 )))
        {
            if (DOES_BLIP_EXIST( l_U899 ))
            {
                REMOVE_BLIP( l_U899 );
...
void sub_66403()
{
    ...
    LOAD_ALL_OBJECTS_NOW();
    while ((((NOT (HAS_MODEL_LOADED( -2107556865 ))) || (NOT (HAS_MODEL_LOADED( 226415164 )))) || (NOT (HAS_MODEL_LOADED( -1745203402 )))) || (NOT (HAS_MODEL_LOADED( -109692574 ))))
    {
        WAIT( 0 );
    }
    for ( l_U1148 = 0; l_U1148 < l_U866; l_U1148++ )
    {
        ...
        if ((((l_U1148 == 1) || (l_U1148 == 3)) || (l_U1148 == 4)) || (l_U1148 == 6))
        {
        ...
        if ((((l_U1148 == 1) || (l_U1148 == 3)) || (l_U1148 == 5)) || (l_U1148 == 7))
        {
    ...
    CREATE_CAR( -1745203402, -477.43000000, 1763.20000000, 8.35000000, ref l_U877[0], 1 );
    SET_CAR_HEADING( l_U877[0], 8 );
    CREATE_CAR( -1745203402, -480.86000000, 1756.95000000, 8.35000000, ref l_U877[1], 1 );
    ...
    if (((((NOT (DOES_OBJECT_EXIST( l_U886[0] ))) AND (NOT (DOES_OBJECT_EXIST( l_U886[1] )))) AND (NOT (DOES_OBJECT_EXIST( l_U886[2] )))) AND (NOT (DOES_OBJECT_EXIST( l_U886[3] )))) AND (NOT (DOES_OBJECT_EXIST( l_U886[4] ))))
    {
        REQUEST_MODEL( -1165777728 );
        while (NOT (HAS_MODEL_LOADED( -1165777728 )))
        {
    ...
    CREATE_OBJECT( 2142893183, -503.91810000, 1743.21900000, 7.51680000, ref l_U892[3], 1 );
...
void sub_68350()
{
    while (NOT (sub_68383( ref l_U876, -475.24000000, 1751.47000000, 8.60000000, 178 )))
    {
        WAIT( 0 );
    }
...
void sub_69042()
{
    if (g_U39149[0] == 3)
    {
        if (NOT l_U1066)
        {
            ...
            if (((IS_VEH_DRIVEABLE( l_U876 )) AND (IS_VEH_DRIVEABLE( l_U875 ))) AND (NOT (IS_CHAR_INJURED( l_U708[0]._fU0 ))))
            {
    ...
    sub_21278( ref l_U708 );
    sub_24134();
    if ((((IS_CHAR_SITTING_IN_CAR( sub_3854(), l_U875 )) AND (IS_CHAR_IN_CAR( l_U708[0]._fU0, l_U875 ))) AND (sub_52751())) AND (NOT l_U955))
    {
        if (NOT l_U1041)
        {
            if (IS_SCREEN_FADED_IN())
    ...
    if (((((IS_CHAR_IN_AREA_2D( sub_3854(), -492.70000000, 1703.51000000, -481.33000000, 1723.15000000, 0 )) AND (IS_GROUP_MEMBER( l_U708[0]._fU0, sub_5876() ))) AND (NOT l_U948)) || (((LOCATE_CHAR_ANY_MEANS_2D( sub_3854(), -486.68630000, 1718.17200000, 9, 12, 0 )) AND (IS_GROUP_MEMBER( l_U708[0]._fU0, sub_5876() ))) AND (NOT l_U948))) || (l_U955 == 1))
    {
        sub_70423();
        if (DOES_BLIP_EXIST( l_U900 ))
        {
...
void sub_70010()
{
    if ((((IS_CHAR_IN_ANGLED_AREA_2D( sub_3854(), -505.63000000, 1706.23000000, -463.34000000, 1737.07000000, 50, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3854(), -522.95000000, 1776.54000000, 9.11000000, 1.00000000, 1.00000000, 1.00000000, 0 ))) || (IS_CHAR_IN_ANGLED_AREA_2D( sub_3854(), -465.11000000, 1737.87000000, -465.68000000, 1742.15000000, 4.00000000, 0 ))) || (IS_CHAR_IN_ANGLED_AREA_2D( sub_3854(), -461.76000000, 1781.38000000, -466.35000000, 1789.66000000, 4.00000000, 0 )))
    {
        l_U1082 = 1;
    }
    for ( l_U1148 = 0; l_U1148 < l_U708; l_U1148++ )
...
void sub_72552()
{
    ...
    sub_69862();
    if ((((NOT (sub_30267( l_U939 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (IS_SCREEN_FADED_IN())) AND (l_U1085 == 0))
    {
        PRINTSTRING( "\n\n        -------->    PLAY E1B1_GETIN     <------- \n\n\n" );
    ...
    if (iVar2 > 0)
    {
        ...
        if (NOT l_U956)
        {
            if (((IS_CHAR_GETTING_IN_TO_A_CAR( sub_3854() )) || (NOT (IS_CHAR_IN_AREA_2D( sub_3854(), 64993, 1673, 65084, 1820, 0 )))) || (NOT (IS_GROUP_MEMBER( l_U708[0]._fU0, sub_5876() ))))
            {
                REMOVE_CHAR_FROM_GROUP( l_U708[0]._fU0 );
        ...
        if (NOT l_U1017)
        {
            if (NOT l_U1050)
            {
                if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_30267( l_U939 )))) || (TIMERA() >= 2500))
                {
            ...
            else if ((NOT l_U1043) AND ((l_U955) || (l_U956)))
            {
                if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_30267( l_U939 )))) AND (IS_SCREEN_FADED_IN()))
                {
        ...
        if (IS_EPISODIC_DISC_BUILD())
        {
            if ((TIMERC() > 12000) AND (TIMERC() < 13000))
            {
                CLEAR_HELP();
            }
            else if ((TIMERC() > 8000) AND (TIMERC() < 12000))
            {
            ...
            else if ((TIMERC() > 4000) AND (TIMERC() < 8000))
            {
            ...
            else if ((TIMERC() > 0) AND (TIMERC() < 4000))
            {
        ...
        if (((l_U1043) AND (NOT l_U1017)) AND (l_U955))
        {
            if (sub_52751())
            {
                if (l_U1186 >= l_U1187)
        ...
        for ( l_U1148 = 0; l_U1148 < l_U708; l_U1148++ )
        {
            if (NOT l_U957[l_U1148])
            {
                if (NOT (IS_CHAR_INJURED( l_U708[l_U1148]._fU0 )))
                {
                    ...
                    else if (((IS_CHAR_IN_AREA_2D( l_U708[l_U1148]._fU0, 65031, 1706, 65075, 1798, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( l_U708[l_U1148]._fU0, -486.68630000, 1718.17200000, 9, 12, 0 ))) || (l_U956))
                    {
                        REMOVE_CHAR_FROM_GROUP( l_U708[l_U1148]._fU0 );
                        if (NOT (IS_CAR_DEAD( l_U875 )))
                        {
                            GET_CAR_SPEED( l_U875, ref l_U1198 );
                            if ((IS_CHAR_SITTING_IN_CAR( l_U708[0]._fU0, l_U875 )) AND (l_U1198 < 4.00000000))
                            {
                                l_U697 = 1;
                            }
                            else if ((IS_CHAR_SITTING_IN_ANY_CAR( l_U708[0]._fU0 )) AND (NOT (IS_CHAR_SITTING_IN_CAR( l_U708[0]._fU0, l_U875 ))))
                            {
                                l_U697 = 1;
                            }
                        }
                    }
                    if ((((IS_CHAR_IN_AREA_2D( l_U708[l_U1148]._fU0, 65031, 1706, 65075, 1798, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( l_U708[l_U1148]._fU0, -486.68630000, 1718.17200000, 9, 12, 0 ))) || (l_U956)) || (l_U697))
                    {
                        REMOVE_CHAR_FROM_GROUP( l_U708[l_U1148]._fU0 );
...
void sub_77761()
{
    ...
    for ( l_U1148 = 0; l_U1148 < l_U708; l_U1148++ )
    {
        if (NOT (IS_CHAR_INJURED( l_U708[l_U1148]._fU0 )))
        {
            ...
            if (l_U964[l_U1148])
            {
                if (l_U1148 == 0)
                {
                    if (NOT l_U1016)
                    {
                        ...
                        sub_24328( ref l_U708[l_U1148], 0 );
                        if (((sub_22315( l_U708[l_U1148]._fU0, sub_3854(), 1 )) < 50) AND (IS_CHAR_IN_CAR( sub_3854(), l_U875 )))
                        {
                            sub_78935();
                        }
                        else
                    ...
                    if (NOT l_U1015)
                    {
                        if (IS_CHAR_IN_CAR( l_U708[0]._fU0, l_U876 ))
                        {
                            if (l_U1013)
                            {
                                if (((IS_CHAR_IN_AREA_2D( l_U708[0]._fU0, -877.09000000, 1149.88000000, -668.51000000, 1178.28000000, 0 )) || (IS_CHAR_IN_AREA_2D( l_U708[0]._fU0, -1286.12000000, 565.27000000, -1178.50000000, 766.54000000, 0 ))) || (IS_CHAR_IN_AREA_2D( l_U708[0]._fU0, -1661.51000000, 363.30000000, -1575.81000000, 504.08000000, 0 )))
                                {
            ...
            else if (IS_CHAR_IN_ANY_CAR( l_U708[l_U1148]._fU0 ))
            {
                ...
                {
                    if ((IS_CHAR_IN_CAR( l_U708[l_U1148]._fU0, l_U876 )) || (NOT (l_U1148 == 0)))
                    {
                        SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U708[l_U1148]._fU0, 0 );
                        l_U999[l_U1148] = 1;
                    }
                }
                if ((l_U1062) || (l_U1148 == 0))
                {
                    if (l_U978[l_U1148])
                    {
                        if ((LOCATE_CHAR_IN_CAR_3D( l_U708[l_U1148]._fU0, -485.77000000, 1716.31000000, 9, 6, 6, 6, 0 )) || ((l_U1148 == 0) AND (NOT (IS_CHAR_IN_ANGLED_AREA_2D( l_U708[l_U1148]._fU0, -528.63000000, 1688.23000000, -463.34000000, 1737.07000000, 50, 0 )))))
                        {
                            if (l_U1148 == 0)
                            {
                                if (l_U1013)
                    ...
                    else if ((IS_CHAR_IN_ANGLED_AREA_2D( l_U708[l_U1148]._fU0, -528.63000000, 1688.23000000, -463.34000000, 1737.07000000, 50, 0 )) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U708[l_U1148]._fU0, "MISSBILLY_1", "get_on_bike" ))))
                    {
                        GENERATE_RANDOM_FLOAT_IN_RANGE( 12, 26, ref uVar2 );
                        if (((l_U1013) AND (LOCATE_CAR_3D( l_U876, -485.77000000, 1716.31000000, 9, uVar2, uVar2, uVar2, 0 ))) || (l_U1148 == 0))
                        {
                            if (IS_VEH_DRIVEABLE( l_U708[l_U1148]._fU4 ))
                            {
                                CLEAR_SEQUENCE_TASK( l_U930 );
            ...
            {
                if (((l_U708[l_U1148]._fU4 == l_U876) AND (l_U1148 != 0)) || (IS_CHAR_IN_ANGLED_AREA_2D( l_U708[0]._fU0, -528.63000000, 1688.23000000, -463.34000000, 1737.07000000, 50, 0 )))
                {
                    if ((l_U1062) AND (NOT (IS_CHAR_IN_ANGLED_AREA_2D( l_U708[0]._fU0, -528.63000000, 1688.23000000, -463.34000000, 1737.07000000, 50, 0 ))))
                    {
                        sub_78587( ref l_U708 );
                        sub_24328( ref l_U708[l_U1148], 0 );
                    }
    ...
    if ((((((l_U964[0]) AND (l_U964[1])) AND (l_U964[2])) AND (l_U964[3])) AND (l_U964[4])) AND (l_U964[5]))
    {
        sub_47581( ref l_U708, 0, 0 );
    }
    if (((NOT l_U1045) AND (l_U1051)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
        if (sub_52751())
        {
            if (IS_CHAR_IN_CAR( sub_3854(), l_U875 ))
            {
                ...
                if (((LOCATE_CHAR_IN_CAR_3D( sub_3854(), l_U1194, l_U1195, l_U1196, 10, 10, 10, 0 )) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U708[0]._fU0, -497.92620000, 1747.81500000, 7.52390000, 50, 50, 50, 0 )))) AND ((l_U1160 - l_U1161) > 15000))
                {
    ...
    if (((NOT l_U1062) AND (NOT (IS_CHAR_INJURED( l_U708[0]._fU0 )))) AND (NOT (IS_CAR_DEAD( l_U876 ))))
    {
        if (NOT l_U1061)
        {
            if (((LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U708[0]._fU0, l_U876, 3.00000000, 3.00000000, 3.00000000, 0 )) || (l_U1192 >= 20.00000000)) AND (NOT (IS_PED_RAGDOLL( l_U708[0]._fU0 ))))
            {
                SET_PLAYER_CONTROL( sub_5225(), 0 );
                sub_77602();
                ...
                for ( l_U1148 = 0; l_U1148 < l_U708; l_U1148++ )
                {
                    if (NOT (l_U1148 == 0))
                    {
                        ...
                        if (IS_VEH_DRIVEABLE( l_U708[l_U1148]._fU4 ))
                        {
                            if ((iVar8) || (NOT (LOCATE_CAR_2D( l_U708[l_U1148]._fU4, 65039, 1743, 80, 80, 0 ))))
                            {
                ...
                if (((((LOCATE_CAR_3D( l_U875, -482.89990000, 1719.55300000, 7.39570000, 2, 2, 2, 0 )) || (LOCATE_CAR_3D( l_U875, -477.83520000, 1721.38000000, 7.47890000, 2, 2, 2, 0 ))) || (LOCATE_CAR_3D( l_U875, -472.82860000, 1720.92100000, 7.53530000, 2, 2, 2, 0 ))) || (LOCATE_CAR_3D( l_U875, -481.80390000, 1711.72500000, 7.45210000, 2, 2, 2, 0 ))) || (LOCATE_CAR_3D( l_U875, -476.41740000, 1715.91400000, 7.47930000, 2, 2, 2, 0 )))
                {
                    SET_CAR_HEADING( l_U875, 121.74370000 );
                    SET_CAR_COORDINATES( l_U875, -481.10000000, 1709.25000000, 7.30980000 );
                }
                if ((NOT (IS_CAR_DEAD( l_U708[1]._fU4 ))) AND (NOT (IS_CHAR_DEAD( l_U708[1]._fU0 ))))
                {
                ...
                if ((NOT (IS_CAR_DEAD( l_U708[2]._fU4 ))) AND (NOT (IS_CHAR_DEAD( l_U708[2]._fU0 ))))
                {
                ...
                if ((NOT (IS_CAR_DEAD( l_U708[3]._fU4 ))) AND (NOT (IS_CHAR_DEAD( l_U708[3]._fU0 ))))
                {
                    SET_CAR_HEADING( l_U708[3]._fU4, 98.70190000 );
                ...
                if ((NOT (IS_CAR_DEAD( l_U708[4]._fU4 ))) AND (NOT (IS_CHAR_DEAD( l_U708[4]._fU0 ))))
                {
                    SET_CAR_HEADING( l_U708[4]._fU4, 110.53320000 );
                    SET_CAR_COORDINATES( l_U708[4]._fU4, -481.80390000, 1711.72500000, 7.45210000 );
                ...
                if ((NOT (IS_CAR_DEAD( l_U708[5]._fU4 ))) AND (NOT (IS_CHAR_DEAD( l_U708[5]._fU0 ))))
                {
                ...
                if ((NOT (sub_30267( l_U939 ))) AND (l_U1088 == 0))
                {
        ...
        if (NOT l_U1064)
        {
            ...
            {
                if ((IS_CHAR_SITTING_IN_CAR( l_U708[0]._fU0, l_U876 )) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U708[0]._fU0, "MISSBILLY_1", "get_on_bike" ))))
                {
        ...
        if ((l_U1188 >= 2.00000000) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U708[0]._fU0, "MISSBILLY_1", "get_on_bike" ))))
        {
            BEGIN_CAM_COMMANDS( ref l_U1155 );
    ...
    if ((NOT l_U1054) AND (NOT (IS_CAR_DEAD( l_U875 ))))
    {
        if (NOT (IS_CHAR_SITTING_IN_CAR( sub_3854(), l_U875 )))
        {
            l_U1054 = 1;
    ...
    if (((l_U1083 == 0) AND (l_U1062 == 1)) AND (l_U698 == 1))
    {
        if ((NOT (IS_CAR_DEAD( l_U876 ))) AND (NOT (IS_CHAR_INJURED( l_U708[0]._fU0 ))))
        {
            if (((((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_30267( l_U933 )))) AND (NOT (sub_30267( l_U939 )))) AND (NOT (IS_CAR_DEAD( l_U875 )))) AND (IS_CHAR_SITTING_IN_CAR( l_U708[0]._fU0, l_U876 )))
            {
                SET_WANTED_MULTIPLIER( 0.30000000 );
                if (IS_CHAR_IN_CAR( sub_3854(), l_U875 ))
                {
    ...
    if ((l_U1083 == 1) AND (l_U1086 == 0))
    {
        if ((NOT (IS_CAR_DEAD( l_U876 ))) AND (NOT (IS_CHAR_INJURED( l_U708[0]._fU0 ))))
        {
            if ((((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_30267( l_U933 )))) AND (NOT (sub_30267( l_U939 )))) AND (IS_CHAR_SITTING_IN_CAR( l_U708[0]._fU0, l_U876 )))
            {
    ...
    if (l_U1071 == 0)
    {
        if (NOT (IS_CHAR_INJURED( l_U708[0]._fU0 )))
        {
            ...
            {
                if ((IS_CHAR_IN_CAR( l_U708[0]._fU0, l_U876 )) AND (l_U964[0] == 1))
                {
    ...
    if (NOT (IS_CAR_DEAD( l_U875 )))
    {
        if ((IS_CHAR_SITTING_IN_CAR( sub_3854(), l_U875 )) AND (NOT (IS_CHAR_IN_AREA_2D( sub_3854(), 65031, 1706, 65075, 1798, 0 ))))
        {
            if (NOT l_U1056)
            {
                if (NOT l_U1060)
            ...
            else if ((TIMERA() >= 9500) AND (l_U1072 == 0))
            {
                sub_87000( 0 );
                l_U1072 = 1;
            }
            ...
            else if ((NOT l_U1055) AND (TIMERA() >= 18000))
            {
                GET_FOLLOW_VEHICLE_CAM_SUBMODE( ref iVar10 );
                if (((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_52785())) AND (iVar10 != 5))
                {
        ...
        if ((l_U1016) AND (NOT (IS_CHAR_INJURED( l_U708[0]._fU0 ))))
        {
            if ((IS_CHAR_STOPPED( l_U708[0]._fU0 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3854(), l_U708[0]._fU0, 10, 10, 10, 0 )))
            {
                if (sub_62625( 1, 1 ))
                {
                    if (DOES_BLIP_EXIST( l_U901 ))
    ...
    if ((l_U1062) AND (NOT (IS_CHAR_INJURED( l_U708[0]._fU0 ))))
    {
        if (NOT (IS_CHAR_INJURED( l_U708[0]._fU0 )))
        {
...
void sub_77916(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3854() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_23614())) AND (iVar3 != 4))
    {
...
int sub_88882(int iParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((l_U137) AND (NOT l_U138))
    {
        if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 )))
        {
            ...
            {
                if ((NOT (HAS_MODEL_LOADED( l_U211 ))) || (NOT (HAS_MODEL_LOADED( l_U212 ))))
                {
            ...
            else if (NOT (IS_CAR_DEAD( uVar42 )))
            {
                ...
                if (l_U136 == 3)
                {
                    if (l_U140 > 400.00000000)
                    {
                        ...
                        {
                            l_U140 = 999999.90000000;
                        }
                        l_U136 = 0;
                    }
                }
                sub_92698();
                return (IS_CHAR_IN_ANY_CAR( sub_3854() )) AND ((VDIST( l_U213, sub_21681( sub_3854(), 1 ) )) < 5.00000000);
            }
            else
            {
                sub_4258();
...
void sub_93790()
{
    ...
    if ((sub_93799()) AND (IS_SCREEN_FADED_IN()))
    {
        l_U519 = 23;
        while (IS_SCREEN_FADING_IN())
        {
    ...
    switch (l_U519)
    {
        ...
        l_U540[9] = {0.00000000, -0.58960000, 0.39300000};
        ...
        break;
        case 4:
        if ((TIMERA() > 5500) AND (l_U692 == 0))
        {
            l_U692 = 1;
        }
        if ((TIMERA() > 8500) AND (l_U691 == 0))
        {
            SET_CAM_POS( l_U502, -1721.95800000, 353.25740000, 29.11952000 );
            SET_CAM_ROT( l_U502, -21.10899000, -0.00000000, -155.13270000 );
            SET_CAM_FOV( l_U502, 53.99998000 );
            SET_CAM_POS( l_U504, -1721.95800000, 353.25740000, 29.11952000 );
            ...
            SET_CAM_POS( l_U504, -1724.65100000, 345.31080000, 26.70392000 );
            SET_CAM_ROT( l_U504, 0.45506800, -0.00000000, -74.96770000 );
        ...
        SET_CAM_POS( l_U504, -1715.19300000, 347.31300000, 31.94800000 );
        SET_CAM_ROT( l_U504, 0.87332300, 0.00000000, -36.23764000 );
        ...
        SET_CAM_FOV( l_U504, 45.00000000 );
        SET_CAM_POS( l_U502, -1721.63500000, 332.45660000, 32.12140000 );
        ...
        LOAD_ALL_OBJECTS_NOW();
        while ((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 1760 ))) || (NOT (HAS_MODEL_LOADED( 301427732 ))))
        {
            WAIT( 0 );
        }
        SET_CAM_POS( l_U502, -1721.74000000, 335.82250000, 25.64100000 );
        ...
        break;
        case 14:
        if ((((TIMERA() > 1000) AND (IS_SCREEN_FADED_IN())) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())) AND (l_U696 == 0))
        {
            PRINT_HELP( "ACT_06E" );
            l_U696 = 1;
        }
        ...
        LOAD_ALL_OBJECTS_NOW();
        while (((((NOT (HAS_MODEL_LOADED( 729783779 ))) || (NOT (HAS_MODEL_LOADED( -967822724 )))) || (NOT (sub_13785( 6 )))) || (NOT (HAVE_ANIMS_LOADED( "PLAYIDLES_STD" )))) || (NOT sub_100255()))
        {
            WAIT( 0 );
        }
        ...
        LOAD_ALL_OBJECTS_NOW();
        while (((NOT (HAS_MODEL_LOADED( -570033273 ))) || (NOT (HAS_MODEL_LOADED( -408052231 )))) || (NOT (sub_13785( 7 ))))
        {
            WAIT( 0 );
        }
        ...
        LOAD_ALL_OBJECTS_NOW();
        while ((NOT (HAS_MODEL_LOADED( l_U702 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 1761 ))))
        {
            WAIT( 0 );
        }
        ...
        break;
        case 16:
        if ((((TIMERA() > 1000) AND (TIMERA() < 5000)) AND (l_U686 == 0)) AND (l_U701 == 0))
        {
            l_U686 = START_PTFX_ON_VEH( "E1_burnout_smoke", l_U875, l_U688, l_U362, 1065353216 );
            l_U701 = 1;
        }
        if ((l_U686 > 0) AND (l_U700 == 0))
        {
            UPDATE_PTFX_OFFSETS( l_U686, l_U688, l_U362 );
        }
        if ((((TIMERA() > 6000) AND (l_U686 > 0)) AND (l_U701 == 1)) AND (l_U700 == 0))
        {
            STOP_PTFX( l_U686 );
            l_U700 = 1;
        }
        if ((TIMERA() > 10000) AND (l_U695 == 0))
        {
            PRINT_HELP( "ACT_06D" );
            ...
            SET_CAM_POS( l_U504, -1696.42300000, 362.44090000, 25.92986000 );
        ...
        if (NOT (IS_CAR_DEAD( l_U677 )))
        {
            ...
            {
                if (((FIND_TIME_POSITION_IN_RECORDING( l_U677 )) > 8720) AND (l_U694 == 0))
                {
        ...
        SET_CAM_ROT( l_U502, 5.71697600, 0.00000000, -85.77579000 );
        ...
        break;
        case 20:
        if ((TIMERA() > 5000) AND (l_U693 == 0))
        {
            if ((NOT (IS_CHAR_INJURED( l_U679 ))) AND (NOT (IS_CAR_DEAD( l_U674 ))))
            {
        ...
        if (NOT (IS_CHAR_DEAD( sub_3854() )))
        {
            ...
            SET_CHAR_HEADING( sub_3854(), 82.40160000 );
        }
        CLEAR_PRINTS();
        SET_GAME_CAM_HEADING( 0.00000000 );
        if (NOT (IS_CAR_DEAD( l_U875 )))
