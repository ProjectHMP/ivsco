...
int sub_5933(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_525() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_525() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_3472())
                    {
...
int sub_11470(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;
    unknown uVar6;
    unknown uVar7;
...
void sub_12730()
{
    ...
    sub_12774( 3, 1 );
    SET_CHAR_HEALTH( sub_653(), sub_13184() );
    ADD_SCORE( sub_525(), -5 );
    sub_13283();
    return;
}

void sub_12774(unknown uParam0, unknown uParam1)
{
    sub_12795( uParam0, uParam1, 0.00000000, "" );
    return;
}

void sub_12795(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
