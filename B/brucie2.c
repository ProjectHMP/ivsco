void main()
{
    ...
    {
        WAIT( 0 );
        if ((IS_CHAR_DEAD( sub_3308() )) || (IS_CHAR_FATALLY_INJURED( sub_3308() )))
        {
            l_U575 = 6;
        }
        sub_3664();
...
void sub_2079()
{
    ...
    {
        if (((sub_2117( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3664()
{
    if (DOES_VEHICLE_EXIST( l_U688 ))
    {
        if (IS_VEH_DRIVEABLE( l_U688 ))
        {
            ...
            if (((CHECK_STUCK_TIMER( l_U688, 3, 60000 )) || (CHECK_STUCK_TIMER( l_U688, 2, 30000 ))) || (CHECK_STUCK_TIMER( l_U688, 1, 40000 )))
            {
...
void sub_5534()
{
    ...
    l_U784 = 360.00000000;
    l_U720 = {870.74940000, -121.52140000, 8.40000000};
    l_U745 = {1119.35100000, 712.10510000, 34.91060000};
    l_U801 = 1.50000000;
    l_U748[2] = {1115.88000000, 702.87300000, 35.21640000};
    l_U802[2] = 1.66500000;
...
void sub_7259()
{
    ...
    switch (l_U576)
    {
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 36 )) AND (NOT (l_U867[0] == 1)))
        {
            l_U867[0] = 1;
        ...
        if ((sub_7312( ref l_U870, 2000 )) AND (NOT l_U594))
        {
        ...
        if (l_U633)
        {
            if ((IS_VEH_DRIVEABLE( l_U689[0] )) AND (IS_VEH_DRIVEABLE( l_U689[1] )))
            {
                if (l_U658[0])
                {
...
void sub_8385()
{
    ...
    SET_CAR_HEADING( l_U689[1], 90.32870000 );
...
void sub_16621()
{
    ...
    if ((IS_KEYBOARD_KEY_PRESSED( 36 )) AND (NOT (l_U867[1] == 1)))
    {
        if (NOT (IS_CAR_DEAD( l_U688 )))
        {
            if (NOT (IS_CHAR_DEAD( sub_3308() )))
...
int sub_17718(unknown uParam0, int iParam1)
{
    ...
    if (DOES_VEHICLE_EXIST( (uParam0^) ))
    {
        if (IS_VEH_DRIVEABLE( (uParam0^) ))
        {
            ...
            if (((((GET_PETROL_TANK_HEALTH( (uParam0^) )) < iParam1) || ((GET_ENGINE_HEALTH( (uParam0^) )) < iParam1)) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( (uParam0^), sub_3308() ))) || (iVar4 < iParam1))
            {
                return 1;
            }
        }
                ...
                if (NOT (IS_CHAR_INJURED( l_U676[l_U839] )))
                {
                    if (IS_CHAR_INJURED( l_U680[l_U839] ))
                    {
                        if (IS_VEH_DRIVEABLE( l_U689[l_U839] ))
                        {
                            if (IS_CHAR_SITTING_IN_CAR( l_U676[l_U839], l_U689[l_U839] ))
                            {
                                if (((sub_4750( ref l_U689[l_U839] )) < 10.00000000) || (sub_7312( ref l_U876, 15000 )))
                                {
            ...
            for ( l_U839 = 0; l_U839 <= 2; l_U839++ )
            {
                if (NOT (IS_CHAR_INJURED( l_U676[l_U839] )))
                {
                    if (IS_VEH_DRIVEABLE( l_U689[l_U839] ))
                    {
                        if (IS_CHAR_SITTING_IN_CAR( l_U676[l_U839], l_U689[l_U839] ))
                        {
                            if ((l_U802[l_U839] > 145) || (l_U802[l_U839] < 283))
                            {
...
void sub_24303()
{
    if (DOES_OBJECT_EXIST( g_U9167 ))
    {
        if (IS_CHAR_SITTING_IN_CAR( sub_3308(), l_U688 ))
        {
            if ((LOCATE_CHAR_IN_CAR_3D( sub_3308(), l_U773._fU0, l_U773._fU4, l_U773._fU8, 8.00000000, 8.00000000, 3.00000000, 0 )) || (LOCATE_CHAR_IN_CAR_3D( sub_3308(), 874.04070000, -111.15070000, 5.00040000, 9.60000000, 14.60000000, 4.00000000, 0 )))
            {
...
int sub_25163(unknown uParam0)
{
    ...
    if (((iVar3 > 700) || ((GET_PETROL_TANK_HEALTH( (uParam0^) )) > 700)) || ((GET_ENGINE_HEALTH( (uParam0^) )) > 700))
    {
        return 1;
    }
    return 0;
...
void sub_25931()
{
    switch (l_U580)
    {
        ...
        if (sub_26017( 1 ))
        {
            ...
            LOAD_ALL_OBJECTS_NOW();
            CLEAR_AREA( 870.37820000, -121.81840000, 5.00001000, 50.00000000, 1 );
            ...
            if (NOT (IS_CAR_DEAD( l_U688 )))
            {
                ...
                SET_CAM_ROT( l_U834, 14.68352000, -0.00000000, -158.71550000 );
                ...
                SET_CAM_POS( l_U832, 855.89380000, -114.79610000, 9.13849700 );
