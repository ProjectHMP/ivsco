    ...
    while (l_U1317)
    {
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U194)
            {
                ...
                else if ((LOCATE_CHAR_ON_FOOT_3D( sub_598(), l_U1340._fU0, l_U1340._fU4, l_U1340._fU8, 1.60000000, 1.60000000, 2.00000000, 0 )) || ((LOCATE_CHAR_ON_FOOT_3D( sub_598(), l_U1384._fU0 + l_U1343._fU0, l_U1384._fU4 + l_U1343._fU4, l_U1384._fU8 + l_U1343._fU8, l_U1346._fU0, l_U1346._fU4, l_U1346._fU8, 0 )) AND (sub_11617( sub_598(), l_U1330 ))))
                {
                    if (sub_11674( l_U1330, l_U1384 ))
                    {
                        if (NOT sub_11912())
                        {
                            if ((g_U15728[6]) || (g_U8913))
                            {
                                l_U194 = 5;
                            }
                            else
                ...
                if (sub_11674( l_U1330, l_U1384 ))
                {
                    if (sub_11970())
                    {
                        ...
                        {
                            if ((LOCATE_CHAR_ON_FOOT_3D( sub_598(), l_U278[l_U1379]._fU8._fU0, l_U278[l_U1379]._fU8._fU4, l_U278[l_U1379]._fU8._fU8, l_U278[l_U1379]._fU32._fU0, l_U278[l_U1379]._fU32._fU4, l_U278[l_U1379]._fU32._fU8, 0 )) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "SHOP_H_EXIT" ))))
                            {
                    ...
                    if (NOT l_U1417)
                    {
                        if ((((((IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT (IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( ref g_U8923, ProtectedGet(l_U1322) )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "SHOP_CS_01" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "SHOP_CS_02" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "SHOP_CS_05" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "SHOP_H_EXIT" ))))
                        {
                            for ( I = 0; I < 31; I++ )
                            {
                                if (NOT (IS_STRING_NULL( l_U278[I]._fU4 )))
...
void sub_392()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_598() )))
    {
        ...
        if ((IS_PLAYER_PLAYING( sub_665() )) AND (l_U1318))
        {
    ...
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        if (uParam1._fU0 != uVar21._fU0)
        {
            ...
            else
            {
                ...
                if (((GET_CHAR_DRAWABLE_VARIATION( sub_598(), 8 )) != 1) || ((GET_CHAR_TEXTURE_VARIATION( sub_598(), 8 )) != 0))
                {
...
void sub_2439()
{
    ...
    if (iVar3 > 0)
    {
        for ( I = 0; I < iVar3; I++ )
        {
            ...
            if ((NOT (IS_CHAR_INJURED( uVar5 ))) AND (IS_PLAYER_PLAYING( sub_665() )))
            {
...
void sub_2865()
{
    ...
    sub_2943( 2, 3.70000000, -5.20000000, 1.40000000, 1.25000000, 0.50000000, 1.50000000, 3.90000000, -5.20000000, 1.40000000, 889.30960000, -437.99200000, 14.86010000, 360.00000000 );
    ...
    sub_2943( 12, -6.10000000, 5.40000000, 1.40000000, 0.75000000, 0.40000000, 1.50000000, -6.30000000, 5.80000000, 1.40000000, 879.62430000, -447.51200000, 14.86010000, 287.64000000 );
    sub_2943( 13, -5.25000000, 5.40000000, 1.40000000, 0.75000000, 0.45000000, 1.50000000, -6.30000000, 5.80000000, 1.40000000, 879.62430000, -446.51200000, 14.86010000, 270.00000000 );
    sub_2943( 14, -4.40000000, 5.40000000, 1.40000000, 0.75000000, 0.40000000, 1.50000000, -4.80000000, 5.80000000, 1.40000000, 879.62430000, -445.61200000, 14.86010000, 270.00000000 );
    sub_2943( 15, -3.20000000, 5.30000000, 1.40000000, 0.75000000, 0.80000000, 1.50000000, -3.30000000, 5.80000000, 1.40000000, 879.62430000, -444.63640000, 14.86010000, 270.00000000 );
    sub_2943( 16, -1.80000000, 5.30000000, 1.40000000, 0.75000000, 0.60000000, 1.50000000, 1.40000000, 5.80000000, 1.40000000, 879.62430000, -443.12100000, 14.86010000, 270.00000000 );
    sub_2943( 17, -0.60000000, 5.30000000, 1.40000000, 0.75000000, 0.60000000, 1.50000000, 1.40000000, 5.80000000, 1.40000000, 879.62430000, -441.82100000, 14.86010000, 206.28000000 );
    sub_2943( 18, 0.60000000, 5.30000000, 1.40000000, 0.75000000, 0.60000000, 1.50000000, 2.90000000, 5.80000000, 1.40000000, 879.62430000, -440.49660000, 14.86010000, 300.00000000 );
    ...
    sub_2943( 28, -3.60000000, 3.10000000, 1.40000000, 1.30000000, 1.30000000, 1.50000000, -3.60000000, 3.00000000, 1.40000000, 880.33730000, -444.14280000, 14.86020000, 199.80000000 );
...
void sub_5322()
{
    ...
    sub_5370( 14, 880.94430000, -446.11930000, 16.20920000, -1.29170000, -0.00000000, 72.99700000, 45.00000000 );
    ...
    sub_5370( 19, 887.69180000, -443.60670000, 15.66380000, -0.00400000, 0.00000000, 72.43540000, 45.00000000 );
    ...
    sub_5370( 23, 882.37380000, -441.00780000, 15.84000000, -2.04930000, -0.00000000, -69.20680000, 45.00000000 );
...
int sub_11970()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U1325 )))
    {
        ...
        if ((sub_11617( sub_598(), l_U1330 )) AND (LOCATE_CHAR_ON_FOOT_3D( sub_598(), l_U1384._fU0 + vVar2.x, l_U1384._fU4 + vVar2.y, l_U1384._fU8 + vVar2.z, vVar5.x + 2.50000000, vVar5.y + 2.50000000, vVar5.z + 2.50000000, 0 )))
        {
            if (sub_11617( l_U1325, l_U1330 ))
            {
                if ((IS_CHAR_IN_ANY_CAR( sub_598() )) || (IS_WANTED_LEVEL_GREATER( sub_665(), 0 )))
                {
                    if (NOT l_U1401)
                    {
                ...
                if ((IS_CHAR_SHOOTING( sub_598() )) || (l_U1400))
                {
                ...
                else
                {
                    ...
                    else if ((sub_14641( l_U1325, 34 )) || (iVar8 > (l_U1376 + 2500)))
                    {
                        CLEAR_CHAR_TASKS( l_U1325 );
                        TASK_TURN_CHAR_TO_FACE_CHAR( l_U1325, sub_598() );
                        GET_GAME_TIMER( ref l_U1377 );
                    }
                    if ((IS_PLAYER_TARGETTING_CHAR( sub_665(), l_U1325 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_665(), l_U1325 )))
                    {
                        if (NOT l_U1403)
                        {
                ...
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1325, sub_598(), 0 )) AND (NOT l_U1404))
                {
...
int sub_16050()
{
    ...
    switch (l_U195)
    {
        ...
        else
        {
            ...
            {
                if ((LOCATE_CAR_3D( uVar3, l_U1340._fU0, l_U1340._fU4, l_U1340._fU8, 7.50000000, 7.50000000, 7.50000000, 0 )) || (sub_16499( uVar3, l_U1330 )))
                {
            ...
            SET_CAM_POS( l_U1395[0], 890.22440000, -438.83040000, 16.89151000 );
            SET_CAM_ROT( l_U1395[0], -9.57918500, 0.00000000, 112.57860000 );
...
int sub_16096(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if (((sub_16113()) AND (IS_SCREEN_FADED_IN())) AND (iParam1 > 0))
        {
            return 1;
        }
        else
...
int sub_20074(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, int iParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24)
{
    ...
    if ((sub_20100( 2, 0 )) AND (NOT (uParam11^)))
    {
...
void sub_28671(unknown uParam0)
{
    ...
    if (iVar4 > 0)
    {
        for ( I = 0; I < iVar4; I++ )
        {
            ...
            if ((NOT (IS_CHAR_INJURED( uVar10 ))) AND (IS_PLAYER_PLAYING( sub_665() )))
            {
...
int sub_31444(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, int iParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25, unknown uParam26, unknown uParam27, unknown uParam28)
{
    ...
    if ((sub_20100( 2, 0 )) AND (NOT (uParam11^)))
    {
        if (((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( sub_31584( uParam7, 0, 0 ) ))) AND (NOT (IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( sub_31584( uParam7, 1, 0 ), iParam8 )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( sub_31584( uParam7, 1, 1 ) ))))
        {
            if (sub_20481( 2, "BLANK", 0 ))
            {
                sub_831( 2, "BLANK" );
...
int sub_33618(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, int iParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18)
{
    ...
    if ((sub_20100( 2, 0 )) AND (NOT l_U1319))
    {
...
void sub_34075(int iParam0)
{
    ...
    else
    {
        ...
        if (((GET_CHAR_DRAWABLE_VARIATION( sub_598(), 8 )) != 0) || ((GET_CHAR_TEXTURE_VARIATION( sub_598(), 8 )) != 0))
        {
...
int sub_37998(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25, unknown uParam26, unknown uParam27, unknown uParam28, unknown uParam29, unknown uParam30, unknown uParam31, unknown uParam32, int iParam33, unknown uParam34, unknown uParam35, unknown uParam36, unknown uParam37, unknown uParam38, unknown uParam39, unknown uParam40, unknown uParam41, unknown uParam42, unknown uParam43, unknown uParam44, unknown uParam45)
{
    ...
    if ((sub_14641( sub_598(), 80 )) AND (sub_14641( sub_598(), 88 )))
    {
        if (TIMERA() > iParam33)
        {
            TASK_PLAY_ANIM( sub_598(), "examine shirt", "clothing", 4.00000000, 0, 0, 0, 0, -1 );
    ...
    if (sub_38279())
    {
        if ((NOT (IS_SCORE_GREATER( sub_665(), iVar48 - 1 ))) AND (NOT sub_38359()))
        {
            CLEAR_PRINTS();
...
int sub_38488(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6, boolean bParam7)
{
    ...
    (uParam6^) = 0;
    REGISTER_STRING_FOR_FRONTEND_STAT( 668, sub_38861() );
    CLEAR_PRINTS();
...
int sub_45941(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7)
{
    ...
    else if ((sub_41819( "BLANK" )) AND (NOT l_U1320))
    {
        return sub_51789( sVar12, uParam0, ref uParam1 );
    }
