...
void sub_1782()
{
    ...
    {
        if (((sub_1820( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3047()
{
    ...
    l_U1866[1]._fU80 = 1;
    l_U1866[1]._fU52 = 0;
    l_U1866[2]._fU8 = {-1532.49400000, 141.65030000, 23.18240000};
...
void sub_7230()
{
    ...
    if (l_U649[l_U645] == 0)
    {
        ...
        if (DOES_VEHICLE_EXIST( l_U2623 ))
        {
            if ((NOT (IS_CHAR_DEAD( l_U728 ))) AND (NOT (IS_CAR_DEAD( l_U2623 ))))
            {
...
void sub_12411()
{
    if ((l_U649[l_U645] == 0) AND (NOT (IS_CHAR_DEAD( l_U728 ))))
    {
        if ((((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1577.15700000, 145.22100000, 14.08800000, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U728, -1577.15700000, 145.22100000, 14.08800000, 2.50000000, 2.50000000, 2.50000000, 1 ))) AND (sub_12544( 1, 1 ))) AND (NOT (IS_CHAR_IN_ANY_HELI( l_U628 ))))
        {
            if (l_U649[l_U645] == 0)
            {
    ...
    if (NOT (IS_CHAR_DEAD( l_U728 )))
    {
        ...
        if ((((l_U687 == 0) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (sub_13575( l_U628, l_U728 ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( l_U728 )))
        {
            if (NOT (IS_CHAR_DEAD( l_U728 )))
            {
                if (NOT (IS_GROUP_MEMBER( l_U728, l_U627 )))
        ...
        else if ((sub_13575( l_U628, l_U728 )) AND (IS_CHAR_SITTING_IN_ANY_CAR( l_U628 )))
        {
            switch (g_U64968)
            {
                case 1:
    ...
    sub_14726();
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1536.78200000, 156.83720000, 9.97990000, 150.00000000, 150.00000000, 150.00000000, 0 )) AND (l_U563[5] == 0))
    {
        MARK_MODEL_AS_NO_LONGER_NEEDED( 886934177 );
    ...
    if (NOT (IS_CHAR_DEAD( l_U728 )))
    {
        if (l_U649[l_U645] == 1)
        {
            ...
            if (((l_U563[1] == 0) AND (l_U563[0] == 1)) AND (NOT (sub_12139( l_U639 ))))
            {
                SET_CAM_POS( l_U626, -1538.43900000, 168.06550000, 19.51312000 );
                SET_CAM_ROT( l_U626, -39.08018000, -0.00000000, 143.01100000 );
            ...
            if (((l_U563[2] == 0) AND (l_U563[1] == 1)) AND (NOT (sub_12139( l_U639 ))))
            {
            ...
            if (((l_U563[3] == 0) AND (l_U563[2] == 1)) AND (NOT (sub_12139( l_U639 ))))
            {
                DO_SCREEN_FADE_OUT( 500 );
                while (IS_SCREEN_FADING_OUT())
                {
                ...
                sub_13247( ref l_U626, 1 );
                sub_13247( ref l_U624, 0 );
                SET_CAM_POS( l_U626, -1587.38300000, 140.67490000, 13.61639000 );
                ...
                if (NOT (IS_CHAR_DEAD( l_U728 )))
                {
                    if ((IS_CHAR_IN_ANY_CAR( l_U728 )) || (IS_CHAR_ON_ANY_BIKE( l_U728 )))
                    {
                    ...
                    else
                    {
                        ...
                        TASK_GO_STRAIGHT_TO_COORD( 0, -1601.42700000, 30.63110000, 8.95250000, 2, 45000 );
            ...
            if ((((l_U563[4] == 0) AND (l_U563[3] == 1)) AND (NOT (sub_12139( l_U639 )))) || ((sub_18469()) AND (IS_SCREEN_FADED_IN())))
            {
                if (l_U563[3] == 0)
                {
                    DO_SCREEN_FADE_OUT( 500 );
                ...
                if ((NOT (IS_CHAR_DEAD( l_U728 ))) AND (l_U563[3] == 0))
                {
                    GET_CAR_CHAR_IS_USING( l_U728, ref l_U2628 );
                    ...
                    if (((IS_CHAR_IN_ANY_CAR( l_U728 )) || (IS_CHAR_ON_ANY_BIKE( l_U728 ))) || (IS_CAR_DEAD( l_U2628 )))
                    {
                        if (NOT (IS_CAR_DEAD( l_U2628 )))
                        {
                            if (IS_CHAR_ON_ANY_BIKE( l_U728 ))
...
void sub_14726()
{
    if (DOES_CHAR_EXIST( l_U728 ))
    {
        if (NOT (IS_CHAR_DEAD( l_U728 )))
        {
            if (((sub_14781( l_U628, l_U728, 1 )) > 30.00000000) || (((IS_CHAR_IN_ANY_CAR( l_U628 )) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U728 )))) AND ((sub_14781( l_U628, l_U728, 1 )) > 10.00000000)))
            {
            ...
            {
                if ((NOT (IS_GROUP_MEMBER( l_U728, l_U627 ))) AND (l_U680 == 1))
                {
                    SET_GROUP_MEMBER( l_U627, l_U728 );
                }
                CHANGE_BLIP_DISPLAY( l_U2632, 0 );
        ...
        if ((IS_CHAR_IN_WATER( l_U728 )) AND (IS_CHAR_INJURED( l_U728 )))
        {
            CHANGE_BLIP_DISPLAY( l_U2632, 0 );
            PRINT_NOW( "B4FAIL1", 7500, 1 );
            sub_15452( 19, l_U728, 19 );
...
void sub_19484()
{
    ...
    if (l_U649[l_U645] == 0)
    {
        ...
        while (((NOT (HAS_MODEL_LOADED( -1180674815 ))) || (NOT (HAS_MODEL_LOADED( 1976502708 )))) || (NOT (HAS_MODEL_LOADED( 1543404628 ))))
        {
            WAIT( 0 );
        }
        sub_19887( ref l_U732, 3, 60 );
        if ((NOT (IS_CHAR_DEAD( l_U732[2]._fU0 ))) AND (NOT (IS_CHAR_DEAD( l_U732[1]._fU0 ))))
        {
    ...
    sub_21533();
    if (((sub_14781( l_U628, l_U728, 1 )) > 100.00000000) AND (DOES_CHAR_EXIST( l_U728 )))
    {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1542.85100000, 153.89600000, 10.50930000, 1.00000000, 1.00000000, 1.50000000, 0 )) AND (l_U669 == 0))
    {
        REMOVE_BLIP( l_U2630 );
        l_U669 = 1;
    }
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1537.02300000, 150.25190000, 10.50370000, 4.50000000, 4.50000000, 1.00000000, 0 )) AND (l_U668 == 0))
    {
    ...
    if (l_U563[0] == 0)
    {
        if ((((((l_U668) || (l_U669)) || (IS_CHAR_SHOOTING( l_U628 ))) || (IS_PROJECTILE_IN_AREA( -1549.64500000, 138.85950000, 4.95960000, -1533.85700000, 153.95090000, 21.31790000 ))) || (IS_EXPLOSION_IN_AREA( -1, -1549.64500000, 138.85950000, 4.95960000, -1533.85700000, 153.95090000, 21.31790000 ))) || (LOCATE_CHAR_IN_CAR_3D( l_U628, -1541.98400000, 147.79680000, 6.88120000, 8.00000000, 9.00000000, 4.00000000, 0 )))
        {
    ...
    if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1540.79700000, 148.22170000, 36.26900000, 4.80000000, 4.00000000, 1.50000000, 0 )) AND (l_U670 == 0)) AND (l_U563[1] == 0))
    {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1548.47000000, 142.92530000, 15.73390000, 1.50000000, 7.00000000, 2.00000000, 0 )) AND (l_U563[11] == 0))
    {
        l_U563[11] = 1;
    }
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1545.24000000, 138.83490000, 6.87140000, 1.00000000, 1.00000000, 1.00000000, 0 ))
    {
        if ((l_U563[8] == 1) AND (l_U563[9] == 0))
        {
    ...
    if (l_U563[1] == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1531.73600000, 145.22810000, 16.41890000, 2.00000000, 7.00000000, 2.00000000, 0 )) || (l_U691 == 1))
        {
            if (NOT (IS_CHAR_DEAD( l_U729 )))
            {
    ...
    if (((l_U563[1] == 1) AND (NOT (sub_12139( l_U639 )))) AND (l_U672 == 0))
    {
        PRINT_NOW( "B4GT_02", 7500, 1 );
        l_U672 = 1;
    }
    if (((TIMERA() > 1000) AND (l_U563[7] == 0)) AND (l_U563[1] == 1))
    {
        if (NOT (IS_CHAR_DEAD( l_U729 )))
        {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1538.37200000, 141.47240000, 23.29560000, 1.00000000, 1.00000000, 1.00000000, 0 )) AND (l_U679 == 0))
    {
    ...
    if ((l_U563[6] == 0) AND (l_U563[7] == 1))
    {
        if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1539.80500000, 146.26430000, 22.92540000, 5.00000000, 8.50000000, 1.00000000, 0 )) || (((sub_14781( l_U628, l_U729, 1 )) < 10.00000000) AND (TIMERA() > 5000))) || (sub_24061( l_U729, 5.00000000, -1529.07100000, 143.28130000, 23.18250000, 0, 0 )))
        {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1548.27300000, 148.31740000, 20.18370000, 2.00000000, 2.00000000, 1.00000000, 0 )) AND (l_U563[12] == 0))
    {
        sub_19887( ref l_U1866, 8, 50 );
        l_U563[12] = 1;
    }
...
void sub_19887(unknown uParam0, int iParam1, int iParam2)
{
    ...
    for ( I = 0; I <= (iParam1 - 1); I++ )
    {
        if ((VMAG( (uParam0^)[I]._fU8 )) > 0.00000000)
        {
            ...
            if (((uParam0^)[I]._fU52 == 4) || ((uParam0^)[I]._fU52 == 5))
            {
            ...
            if (((uParam0^)[I]._fU68 == 0) AND ((uParam0^)[I]._fU72 == 0))
            {
                ;
            }
...
void sub_23882(unknown uParam0, int iParam1)
{
    ...
    for ( I = 0; I <= (iParam1 - 1); I++ )
    {
        ...
        {
            if (((((uParam0^)[I]._fU52 == 0) || ((uParam0^)[I]._fU52 == 3)) || ((uParam0^)[I]._fU52 == 4)) || ((uParam0^)[I]._fU52 == 5))
            {
                if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 )))
                {
                    if ((IS_CHAR_FACING_CHAR( l_U628, (uParam0^)[I]._fU0, 30.00000000 )) || (sub_24061( (uParam0^)[I]._fU0, 4.50000000, (uParam0^)[I]._fU8, 0, 0 )))
                    {
                        ...
                        if ((((uParam0^)[I]._fU52 == 3) || ((uParam0^)[I]._fU52 == 4)) || ((uParam0^)[I]._fU52 == 5))
                        {
        ...
        if (((uParam0^)[I]._fU52 == 4) AND (DOES_CHAR_EXIST( (uParam0^)[I]._fU0 )))
        {
            if (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^)[I]._fU0, l_U628, 0 ))
            {
                if (((uParam0^)[I]._fU84 == 0) AND (DOES_CHAR_EXIST( (uParam0^)[I]._fU0 )))
                {
                    if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 )))
                    {
        ...
        if (((uParam0^)[I]._fU52 == 5) AND (DOES_CHAR_EXIST( (uParam0^)[I]._fU0 )))
        {
            if (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^)[I]._fU0, l_U628, 0 ))
            {
                if (((uParam0^)[I]._fU84 == 0) AND (DOES_CHAR_EXIST( (uParam0^)[I]._fU0 )))
        ...
        if (((uParam0^)[I]._fU52 == 3) AND (DOES_CHAR_EXIST( (uParam0^)[I]._fU0 )))
        {
            if ((uParam0^)[I]._fU84 == 0)
            {
                if (NOT (IS_CHAR_DEAD( (uParam0^)[I]._fU0 )))
                {
                    ...
                    if (iVar9 < 350)
                    {
                        ...
                        if ((NOT (IS_CHAR_DEAD( (uParam0^)[I]._fU0 ))) AND (IS_PED_RAGDOLL( (uParam0^)[I]._fU0 )))
                        {
            ...
            else if (((sub_26410( (uParam0^)[I]._fU0, (uParam0^)[I]._fU92 )) < 1.65000000) AND ((uParam0^)[I]._fU88 == 0))
            {
                if ((NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 ))) AND (IS_PED_RAGDOLL( (uParam0^)[I]._fU0 )))
                {
...
void sub_28581()
{
    ...
    if (((l_U688 - l_U689) > 8000) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
...
void sub_28964()
{
    ...
    sub_21533();
    if ((l_U563[1] == 0) AND (NOT (IS_CHAR_DEAD( l_U729 ))))
    {
    ...
    if (((l_U563[1] == 1) AND ((sub_29493( l_U729, uVar2 )) > 2)) AND (l_U678 == 0))
    {
...
void sub_29861()
{
    ...
    if (((TIMERB() > 5000) AND ((sub_26620( l_U628 )) < 20.00000000)) AND (l_U671 == 1))
    {
        l_U671 = 0;
    }
    if ((l_U563[0] == 0) AND (l_U692 == 0))
    {
    ...
    if (l_U563[0] == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1506.34500000, 165.35660000, 20.12590000, 6.20000000, 1.00000000, 5.00000000, 0 )) || (sub_24061( l_U729, 5.00000000, -1508.46900000, 186.77140000, 20.67020000, 0, 1 )))
        {
    ...
    if (l_U563[1] == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1508.48000000, 180.95710000, 19.41980000, 2.00000000, 1.00000000, 1.00000000, 0 )) || (sub_24061( l_U729, 5.00000000, -1523.19000000, 191.64140000, 20.09200000, 0, 0 )))
        {
    ...
    if (l_U563[2] == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1517.58300000, 193.31630000, 20.50800000, 7.50000000, 7.00000000, 1.50000000, 0 )) || (sub_24061( l_U729, 5.00000000, -1523.76100000, 178.19000000, 19.66010000, 0, 0 )))
        {
    ...
    if (l_U563[3] == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1518.98000000, 174.50000000, 31.57920000, 7.00000000, 3.00000000, 1.00000000, 0 )) || (sub_24061( l_U729, 5.00000000, -1523.92000000, 155.63280000, 30.75460000, 0, 0 )))
        {
            sub_27894( l_U729, -1537.52500000, 143.22980000, 34.57530000, 1, 1 );
            l_U563[3] = 1;
        }
    }
    if (((sub_14781( l_U2244[6]._fU0, l_U628, 1 )) < 25.00000000) AND (l_U563[4] == 0))
    {
...
void sub_30918()
{
    ...
    if (l_U649[l_U645] == 0)
    {
        ...
        while (((((NOT (HAS_MODEL_LOADED( -1660661558 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 218 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 378 )))) || (NOT (HAS_MODEL_LOADED( -1180674815 )))) || (NOT (HAVE_ANIMS_LOADED( "missbell4" ))))
        {
            PRINTSTRING( "waiting" );
            WAIT( 0 );
        }
    ...
    PRINTNL();
    WAIT( 0 );
    if (((TIMERA() > 2000) AND (l_U674 == 0)) AND (NOT (IS_CAR_DEAD( l_U2622 ))))
    {
        OPEN_SEQUENCE_TASK( ref uVar3 );
        TASK_TOGGLE_DUCK( 0, 1 );
    ...
    if ((fVar2 > 10000) AND (l_U675 == 0))
    {
        if ((NOT (IS_CAR_DEAD( l_U2622 ))) AND (NOT (IS_CHAR_DEAD( l_U729 ))))
        {
            ...
            if ((((sub_32630( l_U628 )) == 4) || ((sub_32630( l_U628 )) == 5)) || ((sub_32630( l_U628 )) == 18))
            {
    ...
    if ((((sub_26410( l_U730, -1523.68900000, 147.15090000, 44.38027000 )) < 10.00000000) AND (l_U676 == 0)) AND (l_U563[0] == 1))
    {
    ...
    if (((TIMERA() > 1750) AND (l_U563[0] == 1)) AND (l_U563[1] == 0))
    {
        ...
        SET_CAM_FOV( l_U623, 16.40002000 );
        uVar8 = {sub_23051( l_U628 )};
    ...
    if ((((TIMERA() > 1750) AND (l_U563[0] == 1)) AND (l_U563[1] == 1)) AND (l_U563[2] == 0))
    {
        UNATTACH_CAM( l_U626 );
        UNPOINT_CAM( l_U626 );
        if (NOT (IS_CAR_DEAD( l_U2622 )))
    ...
    PRINTFLOAT( fVar11 );
    PRINTNL();
    if ((l_U563[3] == 0) AND (l_U563[2] == 1))
    {
        if ((fVar11 >= 0.80000000) || (TIMERA() > 3000))
        {
            l_U563[3] = 1;
        }
    }
    if ((NOT (IS_CAR_DEAD( l_U2622 ))) AND (l_U563[2] == 1))
    {
        GET_CAR_HEALTH( l_U2622, ref uVar12 );
    }
    if ((l_U563[3] == 1) AND (l_U563[4] == 0))
    {
    ...
    if ((((l_U563[4] == 1) AND (TIMERA() > 1000)) AND (NOT (sub_12139( l_U639 )))) || (sub_35630()))
    {
        ...
        if (l_U563[4] == 0)
        {
            ...
            if (((NOT (IS_CAR_DEAD( l_U2622 ))) AND (NOT (IS_CHAR_DEAD( l_U729 )))) AND (NOT (IS_CHAR_DEAD( l_U730 ))))
            {
                FREEZE_CAR_POSITION( l_U2622, 0 );
                if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2622 ))
                {
...
void sub_36632()
{
    ...
    {
        FREEZE_CAR_POSITION( l_U2622, 0 );
        if (((TIMERA() > 3000) AND (NOT (IS_CHAR_DEAD( l_U730 )))) AND (l_U682 == 0))
        {
    ...
    if ((l_U682 == 1) AND ((sub_26410( l_U730, -1546.98500000, 133.51820000, 54.34010000 )) > 40.00000000))
    {
        if (NOT (IS_CHAR_DEAD( l_U730 )))
        {
    ...
    if (((iVar2 < 500) || (IS_EXPLOSION_IN_SPHERE( -1, uVar3._fU0, uVar3._fU4, uVar3._fU8, 10.00000000 ))) || (l_U673 == 1))
    {
        if (NOT (IS_CAR_DEAD( l_U2622 )))
        {
...
void sub_38326()
{
    ...
    if (l_U649[l_U645] == 0)
    {
        ...
        SET_CAM_ROT( l_U626, 46.72220000, 0.00000000, 82.99577000 );
    ...
    {
        SET_CAM_POS( l_U621, -1546.98500000, 133.51820000, 54.34010000 );
        SET_CAM_ROT( l_U621, 0.72659400, -19.59370000, -38.95797000 );
        SET_CAM_FOV( l_U621, 45.00000000 );
    ...
    if ((TIMERA() > 6500) AND (l_U563[1] == 0))
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U2622 )))
        {
            SET_CAR_COORDINATES( l_U2622, -1542.05300000, 148.08770000, 37.79708000 );
            ...
            {
                SET_CHAR_COORDINATES( l_U729, -1541.83300000, 147.79440000, 29.25367000 );
    ...
    if (((TIMERA() > 8000) AND (l_U563[1] == 1)) AND (l_U667 == 0))
    {
        EXPLODE_CAR( l_U2622, 1, 0 );
        STOP_SOUND( l_U677 );
        l_U667 = 1;
