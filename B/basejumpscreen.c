...
int sub_860()
{
    if (((((IS_PLAYER_PLAYING( sub_869() )) AND (NOT IS_MINIGAME_IN_PROGRESS())) AND (NOT IS_PAUSE_MENU_ACTIVE())) AND (NOT sub_925())) AND (NOT sub_1034()))
    {
        return 1;
    }
    return 0;
...
int sub_925()
{
    if (l_U299 == 1)
    {
        ...
        if ((l_U303 > 1000) AND (g_U12379 == 1))
        {
            return 1;
        }
    }
    if ((g_U12379 == 1) AND (l_U299 == 0))
    {
        return 1;
    }
    return 0;
