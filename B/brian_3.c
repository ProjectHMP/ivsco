            ...
            if (NOT (IS_WANTED_LEVEL_GREATER( sub_1338(), 0 )))
            {
                ...
                while (true)
                {
                    ...
                    if (NOT l_U221)
                    {
                        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
                        {
                            ...
                            if (NOT (IS_WANTED_LEVEL_GREATER( sub_1338(), 0 )))
                            {
                                sub_2807( ref l_U268 );
                                sub_2960();
                                if ((sub_3288( ref l_U263 )) || (sub_3380( ref l_U263, 22.00000000 )))
                                {
                                    sub_3557();
                                }
                                switch (l_U197)
                    ...
                    if (l_U221)
                    {
                        ...
                        if ((IS_KEYBOARD_KEY_PRESSED( 31 )) AND (NOT l_U223))
                        {
                            l_U223 = 1;
                            sub_33495();
                        }
...
int sub_2960()
{
    if (l_U230)
    {
        if (IS_HINT_RUNNING())
        {
            if (((sub_2995( ref l_U263 )) > 18.00000000) || (sub_3160()))
            {
                HINT_CAM( 0.00000000, 0.00000000, 0.50000000, l_U263, 0, 0, 0 );
                l_U230 = 0;
                return 1;
    ...
    if (NOT l_U262)
    {
        ...
        if (l_U259)
        {
            ...
            if (l_U431 < 9900)
            {
                ...
                else if ((IS_PED_RAGDOLL( l_U263 )) || (l_U254))
                {
...
void sub_11594()
{
    ...
    if ((l_U202 == 1) || (l_U202 == 3))
    {
        sub_12331();
    }
    if ((IS_KEYBOARD_KEY_PRESSED( 36 )) AND (NOT l_U204))
    {
    ...
    switch (l_U202)
    {
        ...
        if (NOT l_U210)
        {
            if ((NOT (IS_CHAR_INJURED( l_U263 ))) AND (NOT (IS_CHAR_INJURED( l_U264[0] ))))
            {
        ...
        break;
        case 12:
        if ((sub_5680( ref l_U401, 2000 )) || (l_U406[0] == 1))
        {
            if (NOT (IS_CHAR_INJURED( l_U263 )))
            {
                if (NOT (IS_CHAR_INJURED( l_U264[0] )))
        ...
        if (((sub_26315( ref l_U264[0], ref l_U264, ref l_U432, 1 )) || (sub_3380( ref l_U264[0], 10.00000000 ))) || (sub_3380( ref l_U264[1], 10.00000000 )))
        {
            for ( l_U402 = 0; l_U402 <= 1; l_U402++ )
            {
                if (NOT (IS_CHAR_INJURED( l_U264[l_U402] )))
        ...
        if (((l_U403[0] == 1) AND (l_U403[1] == 1)) AND (NOT l_U241))
        {
            if (NOT l_U251)
            {
        ...
        if (((sub_2995( ref l_U264[0] )) > 100) || ((sub_2995( ref l_U264[1] )) > 100))
        {
            SET_CHAR_HEALTH( l_U263, 13 );
            CLEAR_PRINTS();
...
void sub_12331()
{
    for ( l_U402 = 0; l_U402 <= (l_U410 - 1); l_U402++ )
    {
        if (DOES_CHAR_EXIST( l_U264[l_U402] ))
        {
            if (NOT (IS_CHAR_INJURED( l_U264[l_U402] )))
            {
                if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U264[l_U402], sub_2032(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_1338(), l_U264[l_U402] )) AND (HAS_CHAR_SPOTTED_CHAR( l_U264[l_U402], sub_2032() )))) || (IS_CHAR_RESPONDING_TO_EVENT( l_U264[l_U402], 9 )))
                {
                    CLEAR_PRINTS();
                    sub_2127( 0 );
                    GET_GAME_TIMER( ref l_U508._fU220 );
...
int sub_13617(unknown uParam0)
{
    ...
    if ((IS_PLAYER_PRESSING_HORN( sub_1338() )) AND ((sub_2995( ref uParam0 )) < (10.00000000 * 2.00000000)))
    {
        return 1;
    }
    return 0;
...
int sub_16154(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if (IS_PED_IN_GROUP( (uParam0^) ))
        {
            ...
            if ((IS_CHAR_ON_FOOT( (uParam0^) )) AND (IS_CHAR_ON_FOOT( sub_2032() )))
            {
                return 1;
            }
            if (DOES_VEHICLE_EXIST( (uParam1^) ))
            {
                ...
                {
                    if ((IS_CHAR_SITTING_IN_CAR( (uParam0^), (uParam1^) )) AND (IS_CHAR_SITTING_IN_CAR( sub_2032(), (uParam1^) )))
                    {
                        return 1;
                    }
                }
...
void sub_20451()
{
    ...
    SET_CAM_POS( l_U388, 930.89360000, -52.01659000, 25.84923000 );
    SET_CAM_ROT( l_U388, 7.86561800, -0.00000000, 96.73840000 );
    SET_CAM_FOV( l_U388, 36.80003000 );
    SET_CAM_POS( l_U389, 930.89360000, -52.01659000, 25.84923000 );
    SET_CAM_ROT( l_U389, 7.86561800, -0.00000000, 96.73840000 );
    SET_CAM_FOV( l_U389, 34.80003000 );
    SET_CAM_POS( l_U390, 926.56880000, -54.46138000, 26.81310000 );
    SET_CAM_ROT( l_U390, -0.57695700, -0.00000000, 69.85062000 );
...
int sub_26315(unknown uParam0, unknown uParam1, unknown uParam2, boolean bParam3)
{
        ...
        for ( I = 0; I <= ((uParam1^) - 1); I++ )
        {
            if (DOES_CHAR_EXIST( (uParam1^)[I] ))
            {
                if (NOT (IS_CHAR_INJURED( (uParam1^)[I] )))
                {
                    ...
                    if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam1^)[I], sub_2032(), 0 )) || (iVar7 < (uParam2^)[I])) || (IS_CHAR_RESPONDING_TO_EVENT( (uParam1^)[I], 9 )))
                    {
                        return 1;
                    }
                }
    ...
    else if (DOES_CHAR_EXIST( (uParam0^) ))
    {
        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
        {
            ...
            if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^), sub_2032(), 0 )) || (iVar7 < (uParam2^)[0])) || (IS_CHAR_RESPONDING_TO_EVENT( (uParam0^), 9 )))
            {
                return 1;
            }
        }
...
void sub_29152()
{
    ...
    switch (l_U203)
    {
            ...
            if (NOT (IS_CHAR_INJURED( l_U263 )))
            {
                ...
                if (NOT (sub_17535( l_U453[7] )))
                {
                    ...
                    if (NOT (IS_CAR_DEAD( l_U268 )))
                    {
                        ...
                        if ((l_U385 > 270) || (l_U385 < 90))
                        {
                            l_U357 = {981.36630000, -467.42000000, 15.15200000};
                        }
                        else
                        {
                            l_U357 = {981.54160000, -495.73200000, 14.70740000};
                        }
                        CLEAR_SEQUENCE_TASK( l_U444 );
                        OPEN_SEQUENCE_TASK( ref l_U444 );
        ...
        {
            GET_SCRIPT_TASK_STATUS( l_U263, 29, ref l_U450 );
            if ((NOT (IS_CHAR_ON_SCREEN( l_U263 ))) || (l_U450 == 7))
            {
                l_U203 = 11;
            }
        }
...
void sub_29511()
{
    ...
    if (l_U244)
    {
        ...
        CREATE_CAM( 14, ref l_U387 );
        CREATE_CAM( 3, ref l_U393 );
        SET_CAM_POS( l_U391, 980.21250000, -468.69020000, 16.29309000 );
        SET_CAM_ROT( l_U391, 1.47307100, 0.00000000, -153.41620000 );
        SET_CAM_FOV( l_U391, 33.60004000 );
        SET_CAM_POS( l_U392, 980.21250000, -468.69020000, 16.29309000 );
