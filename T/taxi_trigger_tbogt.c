void main()
{
    ...
    while (true)
    {
        if (NOT sub_139())
        {
            ...
            if ((NOT g_U2674) AND (NOT IS_NETWORK_GAME_RUNNING()))
            {
                if (NOT (g_U2668 == nil))
                {
                ...
                switch (l_U19)
                {
                    ...
                    if (l_U22 == 1)
                    {
                        ...
                        if (IS_PLAYER_PLAYING( sub_148() ))
                        {
                            if ((NOT l_U7) AND (IS_CONTROL_PRESSED( 2, 23 )))
                            {
                                ...
                                {
                                    if ((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_148() )) || (g_U9200))
                                    {
                                        if (((sub_2001()) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_770() )))) AND (NOT (IS_CHAR_IN_ANY_CAR( sub_770() ))))
                                        {
                                            l_U28 = sub_2135();
                        ...
                        if (l_U13)
                        {
                            if (TIMERA() > 1000)
                            {
                                ...
                                if (l_U25 == 7)
                                {
                                    ...
                                    if (l_U25 == 7)
                                    {
                                        if (((NOT (IS_CHAR_PLAYING_ANIM( sub_770(), "TAXI_HAIL", "HAIL_TAXI" ))) AND (NOT (IS_CHAR_PLAYING_ANIM( sub_770(), "TAXI_HAIL", "FUCK_U" )))) AND (NOT (IS_CHAR_PLAYING_ANIM( sub_770(), "TAXI_HAIL", "FORGET_IT" ))))
                                        {
                                            if (NOT g_U9200)
                                            {
                        ...
                        if (IS_PLAYER_PLAYING( sub_148() ))
                        {
                            ...
                            {
                                if (((sub_7825()) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TX_H02" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TX_H07" )))
                                {
                                    bVar13 = false;
                                    if (((IS_CONTROL_PRESSED( 2, 3 )) AND (TIMERB() > 275)) AND (NOT (sub_7887( sub_770() ))))
                                    {
                                        bVar13 = true;
                                    }
                                    ...
                                    {
                                        sub_1258();
                                        if ((l_U28 == g_U9605) || (l_U28 == g_U2687))
                                        {
                    ...
                    if (IS_PLAYER_PLAYING( sub_148() ))
                    {
                        ...
                        else if ((NOT (IS_CHAR_PLAYING_ANIM( sub_770(), "TAXI_HAIL", "HAIL_TAXI" ))) AND (TIMERA() > 3000))
                        {
                            CLEAR_CHAR_TASKS( sub_770() );
                    ...
                    if (l_U22 == 1)
                    {
                        ...
                        if (((sub_10846()) AND (NOT bVar13)) AND (NOT sub_10967()))
                        {
                            if (NOT (IS_CHAR_INJURED( g_U2682 )))
                            {
                                GET_SCRIPT_TASK_STATUS( g_U2682, 48, ref l_U25 );
...
void sub_943()
{
    ...
    if (g_U2676)
    {
        if (NOT sub_962())
        {
            if ((DOES_CHAR_EXIST( g_U2682 )) AND (DOES_VEHICLE_EXIST( g_U2686 )))
            {
                if (NOT (IS_CHAR_INJURED( g_U2682 )))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( g_U2686 ))
                    {
                        if (IS_CHAR_SITTING_IN_CAR( g_U2682, g_U2686 ))
                        {
                            ...
                            if (((NOT (IS_CAR_PASSENGER_SEAT_FREE( g_U2686, 0 ))) || (NOT (IS_CAR_PASSENGER_SEAT_FREE( g_U2686, 1 )))) || (NOT (IS_CAR_PASSENGER_SEAT_FREE( g_U2686, 2 ))))
                            {
                                TASK_PAUSE( 0, 2000 );
                            }
        ...
        if (IS_VEH_DRIVEABLE( (uParam0^) ))
        {
            if (sub_2694( (uParam0^) ))
            {
                if (IS_VEH_DRIVEABLE( (uParam0^) ))
                {
                    ...
                    if ((NOT (IS_CHAR_DEAD( l_U23 ))) AND (sub_2820( l_U23 )))
                    {
                        if (NOT sub_3175())
                        {
                            return 1;
...
int sub_3175()
{
    if (IS_PLAYER_PLAYING( sub_148() ))
    {
        ...
        if (IS_CHAR_IN_AREA_3D( sub_770(), 598.60000000, 1466.25000000, 9.84960000, 654.35000000, 1487.70000000, 14.24960000, 0 ))
        {
            return 1;
        }
    }
...
int sub_4130(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_148() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_148() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_4226())
                    {
...
int sub_5393(unknown uParam0, boolean bParam1)
{
    ...
    if (DOES_VEHICLE_EXIST( (uParam0^) ))
    {
        if (IS_VEH_DRIVEABLE( (uParam0^) ))
        {
            if (sub_2694( (uParam0^) ))
            {
                if ((sub_5448( (uParam0^) )) || (NOT bParam1))
                {
                    GET_DRIVER_OF_CAR( (uParam0^), ref l_U23 );
                    if ((NOT (IS_CHAR_DEAD( l_U23 ))) AND (sub_2820( l_U23 )))
                    {
                        if ((NOT (sub_3678( (uParam0^) ))) || (NOT bParam1))
                        {
                            GET_CAR_DOOR_LOCK_STATUS( (uParam0^), ref iVar4 );
                            if ((iVar4 == 3) || (iVar4 == 2))
                            {
                                if ((NOT ((uParam0^) == g_U9605)) AND (NOT ((uParam0^) == g_U2687)))
                                {
                                    return 0;
                                }
                            }
...
{
    if ((NOT ((uParam0^) == g_U2686)) AND (NOT (g_U2686 == nil)))
    {
        sub_943();
    }
...
int sub_8237(unknown uParam0)
{
    ...
    if (DOES_VEHICLE_EXIST( uParam0 ))
    {
        if (NOT (IS_CAR_DEAD( uParam0 )))
        {
            ...
            {
                if ((NOT (IS_CHAR_INJURED( iVar3 ))) AND (sub_2820( iVar3 )))
                {
