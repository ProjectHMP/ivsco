void main()
{
    ...
    while (NOT l_U507)
    {
        if (NOT sub_4113())
        {
            sub_5185( "TerryStrip: Perform_Mission_Loop() returned FALSE unexpectedly" );
        }
        sub_166570();
        WAIT( 0 );
    }
    ...
    {
        PRINTSTRING( "******************** TERRY STRIP CLUB DEATHARREST\n" );
        PRINTNL();
        sub_12783();
    }
    WAIT( 0 );
    ...
    PRINTSTRING( "quitting TERRY STRIP CLUB without PASS or FAIL\n" );
    sub_12783();
    sub_30720( "TERRY STRIP CLUB: should never reach ENDSCRIPT" );
    return;
}
...
int sub_4113()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_1568() )))
    {
        sub_138384( ref g_U38857 );
        sub_158385( ref g_U38857 );
    }
    if (l_U1376)
    {
        sub_160494( ref g_U38857 );
    }
...
void sub_4147()
{
    PRINTSTRING( "******************** TERRY STRIP CLUB PASSED\n" );
    PRINTNL();
...
void sub_12783()
{
    sub_12802( l_U549, l_U1375 );
    sub_15131( l_U482 );
    sub_17073( 0 );
    sub_17982();
    sub_20287();
    sub_20610( 6, 21, l_U507 );
    sub_20774();
    sub_20894();
    if (l_U1377)
    {
...
void sub_12802(boolean bParam0, unknown uParam1)
{
    ...
    uVar33 = sub_10530( l_U1235 );
    for ( I = 0; I < l_U1196; I++ )
    {
        sub_12287( uVar33, l_U1189[I]._fU0 );
    }
    if (l_U1211)
    {
...
void sub_22388()
{
    ...
    PRINTSTRING( ".................... TERRY STRIP CLUB FAILED" );
    iVar2 = 0;
    switch (l_U506)
    {
        case 0:
...
{
    sub_30759( "ERROR: TERRY STRIP CLUB: ", uParam0 );
    return;
}
...
void sub_30926(boolean bParam0)
{
    switch (l_U506)
    {
        case 0:
...
void sub_31302()
{
    ...
    for ( I = 0; I < 3; I++ )
    {
        if (g_U38847[I]._fU0)
        {
            ...
            sub_32806( ref g_U38857[I], 1 );
        }
    }
    return;
}

void sub_32806(int iParam0, unknown uParam1)
{
    if (DOES_BLIP_EXIST( iParam0->_fU100 ))
    {
        REMOVE_BLIP( iParam0->_fU100 );
...
int sub_33250(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    if (NOT (iParam1 == nil))
    {
        if ((sub_33322()) || (IS_CHAR_INJURED( iParam1 )))
        {
            l_U505 = 1;
            l_U506 = 0;
...
{
    CREATE_CHAR( sub_35565( uParam0 ), sub_17371( uParam0 ), uParam2, uParam3, uParam4, uParam1, 1 );
...
void sub_44195(unknown uParam0, unknown uParam1)
{
    ...
    if ((NOT sub_44256()) || (NOT sub_35448()))
    {
        return;
    }
    sub_36950();
...
{
    if ((NOT (sub_35375( uParam0 ))) || (NOT (HAS_MODEL_LOADED( sub_44838( uParam0 ) ))))
    {
        sub_35414( uParam0 );
        REQUEST_MODEL( sub_44838( uParam0 ) );
        return 0;
    }
    sub_45117( uParam1, uParam4, sub_17371( uParam0 ), sub_44838( uParam0 ), iParam5, 1 );
...
void sub_45117(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_45151( vParam0 + (vector( 2.00000000, 0.00000000, 0.00000000)), uParam3, uParam4, iParam6 );
...
{
    return (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 )) AND (NOT (sub_50238( uParam0, uParam1 )));
}
...
void sub_55254()
{
    ...
    l_U507 = 1;
    sub_56059();
    sub_57033( "Terry Friend Activity: Strip CLub" );
...
void sub_56059()
{
    ...
    for ( I = 0; I < 65; I++ )
    {
        if (g_U11583[I]._fU12 == 20)
        {
            if (l_U634 >= 2)
            {
                sub_5185( "InfoStripClub: Initialise_StripClub_Destinations: Increase MAX_STRIP_CLUB_DESTINATIONS" );
            }
    ...
    sub_56396( iVar3[21], 1213.31000000, 1717.37500000, 18.01600000, 0.00000000, 1226.37100000, 1700.91000000, 30.70050000, -41.66920000, 0.00000000, 94.95740000 );
    sub_56396( iVar3[63], -1596.04900000, 19.57230000, 11.44500000, 89.03420000, -1605.50400000, 32.53180000, 15.81510000, -13.81120000, 0.00000000, -126.06430000 );
    for ( I = 0; I < l_U634; I++ )
    {
        if (NOT l_U635[I])
        {
            sub_5185( "InfoStripClub: Initialise_StripClub_Destinations: There is missing additional data - are there new STRIP CLUB Map Blips?" );
        }
    }
    return;
}

void sub_56396(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    if (iParam0 < 0)
    {
        sub_5185( "InfoStripClub: Store_Additional_StripClub_Info: ID less than 0" );
    }
    if (iParam0 >= l_U634)
    {
        sub_5185( "InfoStripClub: Store_Additional_StripClub_Info: ID out of range" );
    }
    if (l_U635[iParam0])
    {
        sub_5185( "InfoStripClub: Store_Additional_StripClub_Info: Duplicate additional data" );
    }
...
void sub_57033(unknown uParam0)
{
    return;
}

void sub_57149(unknown uParam0)
{
    g_U2767 = uParam0;
    return;
}
...
void sub_57173()
{
    ...
    if (g_U15728[22])
    {
        ...
        sub_57305( ref uVar2, ref uVar4, ref uVar3, ref uVar5 );
        sub_59601();
    }
    return;
}

void sub_57305(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        g_U11081[0] = (uParam0^);
...
void sub_57631(unknown uParam0)
{
    int iVar3;
    ...
    if (NOT (IS_CHAR_INJURED( g_U11081[uParam0] )))
    {
        ...
        GIVE_WEAPON_TO_CHAR( g_U11081[uParam0], sub_57770( g_U11147[uParam0], uParam0 ), 30000, 0 );
        GIVE_WEAPON_TO_CHAR( g_U11081[uParam0], sub_58424( g_U11147[uParam0], uParam0 ), 30000, 0 );
        SET_CURRENT_CHAR_WEAPON( g_U11081[uParam0], sub_58424( g_U11147[uParam0], uParam0 ), 0 );
...
int sub_57770(float fParam0, unknown uParam1)
{
    switch (uParam1)
    {
        default:
...
int sub_58424(float fParam0, unknown uParam1)
{
    switch (uParam1)
    {
        default:
...
void sub_58809(unknown uParam0)
{
    int I;

    for ( I = 0; I < 2; I++ )
    {
        sub_58841( g_U11081[I], uParam0 );
    }
    return;
}

void sub_58841(int iParam0, boolean bParam1)
{
    int I;
    int iVar5;
    ...
    if (DOES_CHAR_EXIST( iParam0 ))
    {
        if (NOT (IS_CHAR_INJURED( iParam0 )))
        {
            ...
            if (bParam1)
            {
                sub_59087( ref g_U11028[iVar5], ref g_U11081[iVar5], ref g_U11087[iVar5] );
            }
            else if (IS_PLAYER_PLAYING( sub_4218() ))
            {
                ...
                if (g_U11090)
                {
                    sub_59456( ref g_U11028[iVar5], 4 );
                }
            }
...
void sub_59087(int iParam0, unknown uParam1, unknown uParam2)
{
    ...
    {
        REMOVE_CHAR_FROM_GROUP( iParam0->_fU0 );
        if (IS_VEH_DRIVEABLE( sub_59152( iParam0 ) ))
        {
...
void sub_59456(int iParam0, int iParam1)
{
...
void sub_59569(unknown uParam0)
{
    g_U11100 = uParam0;
    return;
}
...
void sub_59665(unknown uParam0)
{
    int iVar3;

    iVar3 = sub_59676( uParam0 );
    if (iVar3 == 6)
    {
        return;
    }
...
void sub_59894(unknown uParam0, unknown uParam1)
{
    sub_59905( uParam0 );
    sub_60038( uParam1 );
    return;
...
int sub_59934(int iParam0)
{
    if (iParam0 < 9)
    {
        return 1;
    }
    if (sub_59958( iParam0 ))
    {
        return 1;
    }
    return 0;
...
int sub_59958(unknown uParam0)
{
    return 0;
}

void sub_60038(int iParam0)
{
...
void sub_60120(unknown uParam0)
{
    int I;
    ...
    sub_60189( uParam0, 6, 1 );
    sub_60189( uParam0, 7, 1 );
    sub_60189( uParam0, 10, 1 );
    sub_60189( uParam0, 11, 1 );
    sub_60189( uParam0, 12, 1 );
    sub_60189( uParam0, 16, 1 );
    sub_60189( uParam0, 18, 1 );
    sub_60189( uParam0, 20, 1 );
    sub_60189( uParam0, 21, 1 );
    sub_60189( uParam0, 9, 0 );
    sub_60596();
    sub_63846();
    sub_64993();
    sub_65826( 3 );
    l_U1180 = 0;
    l_U1235 = sub_22819( uParam0 );
    sub_65877( l_U1178 );
    l_U1185 = 0;
    if (NOT l_U1203)
    {
...
void sub_60189(unknown uParam0, int iParam1, unknown uParam2)
{
    int iVar5;

    if (NOT g_U15862[uParam0]._fU8[0]._fU0[iParam1])
    {
        if (NOT (sub_60230( uParam0, iParam1 )))
        {
            return;
        }
    }
    iVar5 = sub_60285( iParam1 );
    if (iVar5 == 12)
    {
    ...
    sub_60475( iVar5, uParam2 );
    return;
}

int sub_60230(unknown uParam0, int iParam1)
{
    if (iParam1 == 16)
    {
        return 1;
...
void sub_60596()
{
    ...
    sub_60930( iVar3[0], 1186.03200000, 381.45840000, 25.89440000, 273.88000000, 1175.87300000, 392.51750000, 29.59400000, -13.69880000, 0.00000000, -147.50740000, 1112014848 );
    sub_60930( iVar3[1], 1643.65800000, 245.58400000, 25.50000000, 243.86450000, 1670.37300000, 252.74060000, 27.71511000, 0.69950600, 0.00000000, 130.74310000, 1112014848 );
    sub_60930( iVar3[2], 882.92200000, -473.00300000, 16.30900000, 270.12920000, 876.81410000, -460.09550000, 15.35026000, 11.67727000, -0.00000000, -161.68270000, 1112014848 );
    sub_60930( iVar3[18], 443.42000000, 1526.31400000, 17.50700000, 268.88550000, 423.45340000, 1529.01700000, 34.79707000, -36.57798000, -11.22095000, -114.45570000, 1112014848 );
    sub_60930( iVar3[19], 1096.24500000, 1599.80300000, 18.02700000, 316.12340000, 1108.09200000, 1625.32100000, 21.56322000, -1.15058200, -0.00000000, 174.86560000, 1112014848 );
    sub_60930( iVar3[23], -146.61000000, 72.23300000, 16.02500000, 191.93320000, -172.63120000, 61.32870000, 55.90245000, -51.17967000, -0.00000000, -102.22700000, 1112014848 );
    sub_60930( iVar3[24], -619.91990000, 161.67230000, 6.02700000, 91.38610000, -645.24320000, 125.56240000, 22.66623000, -32.12400000, -0.00000000, -56.49996000, 1112014848 );
    sub_60930( iVar3[25], -174.31000000, 272.46700000, 15.98500000, 90.06450000, -206.20180000, 261.43610000, 35.89857000, -34.11337000, -0.00000000, -46.99197000, 1112014848 );
    sub_60930( iVar3[26], -433.07940000, 1178.45900000, 14.39740000, 91.17450000, -423.18860000, 1174.36700000, 24.29361000, -39.14743000, 6.24956800, 45.26580000, 1112014848 );
    sub_60930( iVar3[27], -136.81900000, -276.97200000, 14.53500000, 179.94550000, -123.23390000, -275.37620000, 12.44489000, 3.61987600, -0.00000000, 92.21399000, 1112014848 );
    sub_60930( iVar3[28], -394.37900000, 250.15800000, 15.55600000, 91.12110000, -410.06970000, 251.82990000, 20.99272000, -11.35220000, 0.00000000, -107.25360000, 1112014848 );
    sub_60930( iVar3[29], 118.72730000, 636.46600000, 16.10430000, 181.62540000, 126.37460000, 628.77320000, 20.18756000, -20.45377000, 0.00000000, 51.15732000, 1112014848 );
    sub_60930( iVar3[30], 33.67200000, 974.29800000, 15.96700000, 0.00000000, 37.68074000, 1005.61400000, 22.87771000, -23.27425000, 0.00000100, 145.58120000, 1112014848 );
    sub_60930( iVar3[51], -1002.54900000, 1604.37000000, 25.21300000, 214.78020000, -992.73790000, 1583.80300000, 36.61912000, -19.68591000, 0.00000100, 26.11061000, 1112014848 );
    sub_60930( iVar3[52], -1250.08700000, 1070.77300000, 21.16600000, 2.24760000, -1258.48500000, 1055.73500000, 25.37512000, -4.82664000, 0.00000000, -37.46955000, 1112014848 );
    sub_60930( iVar3[53], -1155.57900000, 1389.54100000, 25.63000000, 89.35540000, -1173.21800000, 1372.00600000, 22.45787000, 10.71952000, -0.00000000, -29.54759000, 45.00000000 );
    for ( I = 0; I < l_U978; I++ )
    {
        if (NOT l_U979[I])
        {
    ...
    sub_62499( iVar3[0], 1190.88800000, 377.97630000, 22.99430000, 1192.66900000, 380.07240000, 22.80760000, 1199.55100000, 378.34750000, 22.14610000 );
    sub_62499( iVar3[1], 1647.85500000, 237.53700000, 23.59960000, 1650.38400000, 239.51570000, 23.67850000, 1656.71000000, 235.95590000, 24.03360000 );
    sub_62499( iVar3[2], 881.32170000, -478.59920000, 14.02390000, 880.96580000, -476.32940000, 14.03240000, 872.43070000, -476.56120000, 13.75210000 );
    sub_62499( iVar3[18], 440.97420000, 1520.30900000, 15.37440000, 442.17310000, 1522.82200000, 15.23160000, 430.21190000, 1522.47900000, 15.65150000 );
    sub_62499( iVar3[19], 1099.11500000, 1596.27700000, 15.71580000, 1096.33900000, 1596.88800000, 15.71540000, 1089.31000000, 1588.39100000, 15.71540000 );
    sub_62499( iVar3[23], -139.76190000, 72.06730000, 13.75790000, -142.36840000, 73.33570000, 13.75790000, -143.59300000, 83.87050000, 13.75790000 );
    sub_62499( iVar3[24], -618.24940000, 149.04600000, 3.81270000, -619.85540000, 150.61060000, 3.81270000, -628.95990000, 149.64940000, 3.81270000 );
    sub_62499( iVar3[25], -174.20310000, 276.77800000, 13.81320000, -176.70890000, 274.19620000, 13.81320000, -186.13620000, 276.34440000, 13.81860000 );
    sub_62499( iVar3[26], -429.96930000, 1183.50600000, 12.05390000, -427.68120000, 1181.30100000, 12.16880000, -414.22730000, 1183.68000000, 12.81370000 );
    sub_62499( iVar3[27], -140.75110000, -278.08280000, 12.41860000, -139.00030000, -281.15140000, 12.82390000, -140.91290000, -291.95790000, 13.76250000 );
    sub_62499( iVar3[28], -393.03260000, 245.99450000, 13.39040000, -391.13880000, 248.59180000, 13.49290000, -381.94700000, 246.83300000, 13.75370000 );
    sub_62499( iVar3[29], 114.91250000, 640.95900000, 13.71340000, 116.64570000, 639.25250000, 13.71330000, 113.40200000, 629.90410000, 13.66730000 );
    sub_62499( iVar3[30], 29.85950000, 980.51480000, 13.66350000, 32.71410000, 982.65520000, 13.66330000, 30.02770000, 994.23700000, 13.68900000 );
    sub_62499( iVar3[51], -1006.38000000, 1609.67400000, 23.01270000, -1003.73300000, 1607.31800000, 23.01270000, -993.22520000, 1610.06000000, 22.96360000 );
    sub_62499( iVar3[52], -1244.90300000, 1070.48900000, 18.74650000, -1246.81000000, 1067.58300000, 18.70840000, -1245.11300000, 1055.32400000, 18.77390000 );
    sub_62499( iVar3[53], -1157.79600000, 1397.05500000, 23.41630000, -1160.04400000, 1392.25500000, 23.19830000, -1173.15100000, 1393.90200000, 21.29680000 );
    for ( I = 0; I < l_U978; I++ )
    {
        if (NOT l_U996[I])
        {
...
void sub_60930(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11)
{
    if (iParam0 < 0)
    {
...
void sub_62499(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9)
{
    if (iParam0 < 0)
    {
...
void sub_63846()
{
    ...
    sub_64174( iVar3[3], 920.89200000, -489.48600000, 16.62500000, 359.20360000, 912.35260000, -480.41450000, 19.36200000, -7.81876100, -0.00000000, -137.45620000 );
    sub_64174( iVar3[4], 1157.61500000, 736.30880000, 36.89920000, 264.94570000, 1190.61600000, 721.34830000, 46.09572000, -12.26530000, 0.00000000, 54.47784000 );
    sub_64174( iVar3[31], 118.11700000, 565.07100000, 15.97500000, 181.45510000, 128.69340000, 539.74560000, 20.18760000, -3.03840000, 0.00000000, 43.11860000 );
    sub_64174( iVar3[32], -477.32300000, 1414.07100000, 16.73800000, 270.89310000, -466.49520000, 1426.17700000, 14.79384000, 16.12449000, -0.00000000, 130.86440000 );
    sub_64174( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18770000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
    sub_64174( iVar3[55], -994.40110000, 917.45700000, 15.12010000, 60.82650000, -1013.51600000, 891.85650000, 26.70177000, -7.98437500, -0.00000000, -53.09180000 );
    for ( I = 0; I < l_U1081; I++ )
    {
        if (NOT l_U1082[I])
        {
...
void sub_64174(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    if (iParam0 < 0)
    {
...
void sub_64993()
{
    ...
    sub_65320( iVar3[44], -352.57100000, 182.69200000, 16.05700000, 0.43160000, -365.76050000, 178.55880000, 17.75000000, 1.22540000, -0.00000000, -86.48420000, 0 );
    for ( I = 0; I < l_U1103; I++ )
    {
        if (NOT l_U1104[I])
        {
...
void sub_65320(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11)
{
    if (iParam0 < 0)
    {
...
void sub_65826(unknown uParam0)
{
    g_U26739._fU32 = uParam0;
    return;
}

void sub_65877(unknown uParam0)
{
    int I;
...
int sub_65919(unknown uParam0, unknown uParam1)
{
    switch (uParam1)
    {
...
void sub_66295()
{
    ...
    iVar2 = 6;
    iVar3 = 1;
    if (NOT (sub_66325( iVar2, l_U482, iVar3 )))
    {
        l_U1197 = 1;
        sub_68795();
        return;
...
int sub_66325(unknown uParam0, unknown uParam1, unknown uParam2)
{
    int iVar5;
    int I;
    int iVar7;
        ...
        for ( I = 0; I < 2; I++ )
        {
            if (l_U514 == -1)
            {
                if (sub_67172( I ))
                {
                    ...
                    if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U611[I]._fU4._fU0, l_U611[I]._fU4._fU4, fVar8, 2.50000000, 2.50000000, 2.50000000, iVar9 )) AND (NOT (sub_37520( sub_1568() )))) AND (sub_67383( 1, 1 )))
                    {
    ...
    if (l_U502 == 2)
    {
        if ((sub_67892( uParam0 )) || (iVar5 > l_U639))
        {
            l_U514 = l_U640;
            l_U502 = 3;
        }
...
void sub_66488(unknown uParam0)
{
    switch (uParam0)
    {
        case 1:
...
void sub_66785(unknown uParam0, unknown uParam1)
{
    if (NOT l_U390)
    {
        sub_17187( uParam1 );
...
void sub_66902()
{
    ...
    sub_66785( l_U491, ref l_U492 );
    return;
}

int sub_67172(unknown uParam0)
{
    unknown uVar3;
...
int sub_67383(unknown uParam0, boolean bParam1)
{
    unknown uVar4;
    float fVar5;
    unknown uVar6;
...
int sub_67507(boolean bParam0, boolean bParam1)
{
    unknown uVar4;
    int iVar5;
    float fVar6;
...
int sub_67892(unknown uParam0)
{
    switch (uParam0)
    {
        case 1: return sub_67934();
        case 6: return sub_68308();
        case 7: return sub_68338();
    }
...
void sub_68308()
{
    return sub_67948( l_U482 );
}

void sub_68338()
{
    return sub_67948( l_U491 );
}
...
void sub_69710()
{
    ...
    iVar2 = 0;
    sub_69728( ref l_U465, iVar2 );
    g_U18635[l_U416]._fU892._fU44 = -1;
    return;
}

void sub_69728(int iParam0, unknown uParam1)
{
    PRINTSTRING( "\n KILL SPEECH CALLED***************************************" );
    if (IS_SCRIPTED_CONVERSATION_ONGOING())
    {
...
void sub_69988()
{
    ...
    {
        sub_30720( "TerryStripClub: Play Arrival Speech: Chosen Destination out of range" );
    }
    uVar2 = l_U611[l_U514]._fU0;
    uVar3 = g_U11583[uVar2]._fU16;
    iVar4 = 0;
    sub_69728( ref l_U405, iVar4 );
    sub_3299( "E1FCT3A" );
    sub_3420( 0, sub_1568(), "JOHNNY", 0 );
    ...
    switch (uVar3)
    {
        case 28:
        case 29:
        sub_70226( l_U416, ref l_U405 );
        break;
        default:
        sub_30720( "TerryStripClub: Play Arrival Speech: Unknown Map Blip Subgroup" );
        break;
    }
    return;
}

void sub_70226(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_70249( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
        case 1:
        sub_40039( "E1FCJ3_AST", uParam1, 8, 1 );
        PRINTSTRING( "***** JIM - ARRIVE: STRIP CLUB\n" );
        return;
        case 6:
        sub_40039( "E1FCT3_ST", uParam1, 8, 1 );
        PRINTSTRING( "***** TERRY - ARRIVE: STRIP CLUB\n" );
        return;
        case 7:
        sub_40039( "E1FCC3_AST", uParam1, 8, 1 );
...
void sub_70249(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_71126()
{
    if (sub_21052( 0 ))
    {
        sub_59087( ref g_U38857[0], ref g_U38857[0]._fU0, ref g_U38857[0]._fU4 );
    }
    if (sub_21052( 1 ))
    {
        sub_59087( ref g_U38857[1], ref g_U38857[1]._fU0, ref g_U38857[1]._fU4 );
    }
    if (sub_21052( 2 ))
    {
        sub_59087( ref g_U38857[2], ref g_U38857[2]._fU0, ref g_U38857[2]._fU4 );
    }
    return;
}
...
void sub_71331()
{
    ...
    if (l_U502 == 99)
    {
        sub_74975( 6, 21 );
        l_U1179 = 1;
        sub_75104( 21, l_U1179, g_U26739._fU32 );
        g_U10502 = 1;
        l_U501 = 5;
        l_U502 = 0;
    }
...
void sub_71453()
{
    ...
    switch (l_U1375)
    {
        ...
        l_U515 = 1;
        l_U464 = 1;
        sub_71647( "PASS LEVEL: GOOD (Friend stayed behind)" );
        break;
        case 0:
        l_U515 = 1;
        sub_71647( "PASS LEVEL: GOOD" );
        break;
        case 3:
        l_U515 = 3;
        sub_71647( "PASS LEVEL: MINIMAL" );
        break;
        case 1:
        l_U515 = 4;
        sub_71647( "PASS LEVEL: NONE (Thrown out for fighting?)" );
        break;
        case 4:
        l_U505 = 1;
        l_U506 = 1;
    ...
    sub_71882( "Calculate_Pass_Level: Unknown minigame result" );
    return;
}
...
void sub_71647(unknown uParam0)
{
    return;
}

void sub_71882(unknown uParam0)
{
    sub_71932( "WARNING: TERRY STRIP CLUB (KEITHM): ", uParam0 );
    return;
}

void sub_71932(unknown uParam0, unknown uParam1)
{
...
void sub_72069(unknown uParam0, unknown uParam1)
{
    unknown uVar4;

    uVar4 = sub_72080( uParam0 );
    g_U27961._fU0[uVar4]._fU0[uParam1]++;
    g_U27961._fU0[uVar4]._fU92++;
    sub_72280( uParam1 );
    sub_73170( uParam0, uParam1 );
    return;
}

int sub_72080(unknown uParam0)
{
    switch (uParam0)
    {
        case 1: return 0;
...
void sub_72424(unknown uParam0, unknown uParam1)
{
    char[64] cVar4;
...
void sub_73170(unknown uParam0, int iParam1)
{
    unknown uVar4;
    int iVar5;
    int iVar6;
...
void sub_73679()
{
    ...
    if ((l_U514 < 0) || (l_U514 >= 2))
    {
        sub_30720( "TerryStrip: Play Leaving Speech: Chosen Destination out of range" );
    }
    uVar2 = l_U611[l_U514]._fU0;
    uVar3 = g_U11583[uVar2]._fU16;
    sub_3299( "E1FCT3A" );
    sub_3420( 0, sub_1568(), "JOHNNY", 0 );
    sub_3420( l_U415, l_U482, ref l_U411, 0 );
    sub_73879( l_U1375, l_U416, ref l_U405 );
    return;
}

void sub_73879(int iParam0, unknown uParam1, unknown uParam2)
{
    if (iParam0 == 1)
    {
        return;
    ...
    if (iParam0 == 3)
    {
        sub_73913( uParam1, uParam2 );
    }
    else
    {
        sub_74553( uParam1, uParam2 );
    }
    return;
}

void sub_73913(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_73936( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_73936(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_74553(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_73936( uParam0, uParam1 );
...
void sub_74975(unknown uParam0, unknown uParam1)
{
    int iVar4;
...
void sub_75104(int iParam0, boolean bParam1, unknown uParam2)
{
    int iVar5;
...
int sub_75255(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
...
void sub_75552()
{
    ...
    iVar2 = 6;
    if (sub_75581( iVar2, l_U482, "E1FCT3A" ))
    {
        return;
    }
    l_U1197 = 1;
...
int sub_75581(unknown uParam0, unknown uParam1, unknown uParam2)
{
    int iVar5;
    boolean bVar6;
    boolean bVar7;
    ...
    {
        bVar6 = true;
        if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )) AND (NOT (sub_37520( sub_1568() ))))
        {
            ...
            for ( I = 0; I < 3; I++ )
            {
                if (l_U580[I]._fU8)
                {
                    switch (iVar37)
                    {
                        ...
                        break;
                        case 2:
                        sub_82582( fVar32, fVar33, ref vVar34 );
        ...
        for ( I = 0; I < 3; I++ )
        {
            if (NOT (l_U580[I]._fU0 == nil))
            {
                if (l_U580[I]._fU4 == nil)
                {
                    iVar39 = sub_44634( l_U580[I]._fU12 );
                    vVar34 = {l_U580[I]._fU16};
                    if (NOT (sub_84763( ref l_U580[I]._fU4, sub_44838( iVar39 ), vVar34, l_U605, iVar39 )))
                    {
...
void sub_81921(unknown uParam0, int iParam1)
{
    unknown uVar4;
    unknown uVar5;
    unknown uVar6;
...
int sub_82028(float fParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    float fVar6;
    float fVar7;
    float fVar8;
...
void sub_82582(unknown uParam0, unknown uParam1, int iParam2)
{
    unknown uVar5;
    unknown uVar6;
    unknown uVar7;
...
int sub_84763(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
...
void sub_85900(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_85923( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_85923(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_88244(int iParam0, int iParam1)
{
    if (sub_88257( iParam0, iParam1 ))
    {
...
boolean sub_88257(int iParam0, unknown uParam1)
{
...
void sub_88724()
{
    ...
    iVar2 = sub_88757( 6, l_U482, ref l_U405 );
    if (NOT (iVar2 == 22))
    {
        sub_104735( iVar2 );
        l_U1186 = sub_104950( iVar2 );
        sub_105104( 6, iVar2, "E1FCT3A", l_U415, l_U482, ref l_U411, ref l_U405 );
    }
    iVar2 = sub_109342();
    if (NOT (iVar2 == 22))
    {
        l_U464 = sub_109388( iVar2 );
        sub_109619( 6, iVar2, "E1FCT3A", l_U415, l_U482, ref l_U411, ref l_U405 );
        sub_122272( iVar2, ref l_U557, ref l_U560, ref l_U563 );
        l_U556 = l_U1186;
        sub_75104( iVar2, l_U1179, g_U26739._fU32 );
    }
    iVar3 = sub_122395();
    if (iVar3 == 12)
    {
    ...
    {
        iVar2 = sub_122452( iVar3 );
    }
    if (sub_122713( iVar2, l_U482 ))
    {
        sub_123669( 6, "E1FCT3A", l_U415, l_U482, ref l_U411, ref l_U405 );
    }
    if (l_U1200)
    {
        l_U389 = 0;
...
int sub_88757(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;
    int Result;
    ...
    if (l_U1210)
    {
        uVar5 = sub_88778( uParam0 );
        sub_88885( uParam0, uParam1, uVar5 );
    }
    if (l_U1198)
    {
        sub_94505( uParam0, uParam1, uParam2 );
        return 22;
    }
    Result = 22;
    Result = 6;
    if (sub_103268( Result, uParam0, uParam1, uParam2 ))
    {
        return Result;
    }
    Result = 7;
    ...
    Result = 11;
    if (sub_103487( Result, uParam0, uParam1, uParam2 ))
    {
        return Result;
    }
    Result = 12;
...
void sub_88885(unknown uParam0, unknown uParam1, unknown uParam2)
{
    int I;

    if (NOT l_U1111)
    {
        sub_88909( uParam0, uParam2 );
        g_U10502 = 0;
        l_U1177 = 0;
        return;
    }
...
void sub_88909(unknown uParam0, unknown uParam1)
{
    int I;
    int iVar5;
    int iVar6;
    ...
    sub_88922( ref l_U1112 );
    I = 0;
    for ( I = 0; I < 3; I++ )
    {
        sub_88922( ref l_U1127[I] );
    }
    iVar5 = 0;
    GET_GAME_TIMER( ref iVar5 );
    l_U1112._fU8 = 0;
    ...
    sub_15315( uParam1 );
    sub_89288( uParam1 );
    sub_89727( ref l_U1112 );
    for ( I = 0; I < 3; I++ )
    {
        if (g_U38847[I]._fU0)
        {
            sub_89727( ref l_U1127[I] );
        }
    }
    l_U1111 = 1;
    g_U10499 = 1;
...
void sub_89288(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 1:
        l_U1173 = sub_89470( 0.05000000, 0.02000000 );
        break;
        case 2:
        l_U1173 = sub_89470( 0.07000000, 0.03000000 );
        break;
        case 3:
        l_U1173 = sub_89470( 0.09000000, 0.04000000 );
        break;
        case 4:
        l_U1173 = sub_89470( 0.10000000, 0.05000000 );
        break;
        case 5:
        l_U1173 = sub_89470( 0.13000000, 0.06000000 );
        break;
    }
    return;
}

void sub_89470(unknown uParam0, unknown uParam1)
{
    float Result;
    float fVar5;
...
void sub_90054(unknown uParam0)
{
    ...
    sub_90134( uParam0, ref uVar3 );
    return;
}

void sub_90134(int iParam0, unknown uParam1)
{
    if (iParam0 == -1)
    {
        l_U1112 = {(uParam1^)};
...
void sub_90374(unknown uParam0)
{
    unknown uVar3;
    unknown uVar4;
    unknown uVar5;
...
void sub_92027(unknown uParam0)
{
    unknown uVar3;
    unknown uVar4;
    unknown uVar5;
...
void sub_92165(unknown uParam0)
{
    int iVar3;
    unknown uVar4;
    boolean bVar5;
...
void sub_92328(unknown uParam0)
{
    int iVar3;
    unknown uVar4;
    unknown uVar5;
...
void sub_93113(unknown uParam0)
{
    unknown uVar3;
    unknown uVar4;
    unknown uVar5;
...
void sub_94505(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (l_U1205)
    {
        case 0:
        ...
        break;
        case 2:
        sub_97818( uParam0, uParam1, uParam2 );
        break;
        case 3:
        sub_99318( uParam0, uParam1, uParam2 );
        break;
        case 4:
        sub_101709( uParam0 );
        break;
...
void sub_94748(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    int iVar6;
    int iVar7;
    int iVar8;
    ...
    if (sub_21052( 0 ))
    {
        ...
        if ((NOT (iVar8 == nil)) AND (IS_VEH_DRIVEABLE( iVar8 )))
        {
            ...
            PRINTINT( iVar6 );
            PRINTNL();
            iVar7 = sub_95003( iVar6, iVar8, uParam0, uParam3 );
            if (NOT (iVar7 == iVar6))
            {
                if (iVar7 < 0)
                {
...
int sub_95003(int Result, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    vector vVar8;
    float fVar11;
    boolean bVar12;
    ...
    while (bVar12)
    {
        ...
        PRINTINT( Result );
        PRINTNL();
        if (sub_95141( Result, uParam2, ref vVar8 ))
        {
            ...
            if (sub_82028( fVar11, vVar8 ))
            {
                CLEAR_AREA( vVar8.x, vVar8.y, vVar8.z, 1.00000000, 0 );
                SET_CAR_HEADING( uParam1, sub_95686( uParam5 ) );
...
int sub_95141(unknown uParam0, vector vParam1, unknown uParam4)
{
    vector vVar7;
...
void sub_95686(unknown uParam0)
{
    float fVar3;
    float fVar4;
    float Result;
...
void sub_97473()
{
    ...
    l_U1182 = sub_97482();
    sub_97557( l_U1199, l_U1182 );
    uVar2 = sub_10530( l_U1235 );
    sub_72069( uVar2, l_U1199 );
    l_U1198 = 0;
    l_U1181 = l_U1199;
    l_U1199 = 22;
    if (l_U1179)
...
void sub_97557(unknown uParam0, unknown uParam1)
{
    if (l_U1196 == 3)
    {
...
void sub_97818(unknown uParam0, unknown uParam1, unknown uParam2)
{
    int iVar5;
    int iVar6;
    ...
    if (l_U1206 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_1568() )))
        {
            if ((sub_97941( uParam1, 20.00000000 )) || (iVar5 > l_U1236))
            {
                l_U1206++;
            }
            else
...
int sub_97941(unknown uParam0, unknown uParam1)
{
    unknown uVar4;
    unknown uVar5;
    unknown uVar6;
...
void sub_98464(unknown uParam0)
{
    int iVar3;
    boolean bVar4;
    unknown uVar5;
...
void sub_99318(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;
    unknown uVar6;
    unknown uVar7;
    ...
    if (l_U1206 == 4)
    {
        ...
        if (NOT l_U1186)
        {
            ...
            uVar14 = {sub_99891( uVar6, uVar9 )};
            SET_CHAR_COORDINATES( sub_1568(), uVar14._fU0, uVar14._fU4, uVar14._fU8 );
            sub_100110( uVar6, uVar9, uParam0 );
            uVar17 = sub_101090( uVar9, uVar6 );
            SET_CHAR_HEADING( uParam1, uVar17 );
            uVar17 = sub_101090( uVar9, uVar14 );
            SET_CHAR_HEADING( sub_1568(), uVar17 );
            SET_GAME_CAM_HEADING( 0.00000000 );
            sub_94748( uVar9, uVar12 );
            SET_CURRENT_CHAR_WEAPON( sub_1568(), 0, 0 );
        }
        SETTIMERA( 0 );
        l_U1206++;
...
void sub_99891(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown Result;
    unknown uVar9;
    unknown uVar10;
...
void sub_100110(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6)
{
    int iVar9;
    int I;
    boolean bVar11;
    ...
    for ( I = 0; I < 3; I++ )
    {
        ...
        if (sub_21052( I ))
        {
            if (NOT (IS_CHAR_INJURED( g_U38857[I]._fU0 )))
            {
                ...
                if (bVar11)
                {
                    uVar12 = {sub_99891( uParam0, uParam3 )};
                    uVar15 = {sub_100313( uVar12, uParam0, iVar9 )};
                    if (IS_CHAR_IN_ANY_CAR( g_U38857[I]._fU0 ))
                    {
...
void sub_100313(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    int iVar9;
    int iVar10;
    float fVar11;
...
void sub_101090(vector vParam0, vector vParam3)
{
    unknown uVar8;
    unknown uVar9;
    unknown uVar10;
...
void sub_101709(unknown uParam0)
{
    unknown uVar3;

    l_U1182 = sub_101725( l_U1199, uParam0 );
    sub_97557( l_U1199, l_U1182 );
    uVar3 = sub_10530( l_U1235 );
    sub_72069( uVar3, l_U1199 );
    switch (l_U1199)
    {
        case 11:
        sub_102588( uVar3 );
...
int sub_101725(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 11: return sub_101766( uParam1, l_U1188 );
        case 12: return sub_102102( uParam1, l_U1188 );
    }
    SCRIPT_ASSERT( "Return_Alternative_NonMinigame_Result_For_Activity: unknown activity" );
    return 8;
}

int sub_101766(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
        case 6:
        case 7: return sub_101810( uParam1 );
    }
    SCRIPT_ASSERT( "Return_Alternative_Drinking_Result_For_Friend: unknown friend" );
    return 8;
}

int sub_101810(unknown uParam0)
{
    unknown uVar3;
    unknown uVar4;
...
int sub_102102(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
        case 6:
        case 7: return sub_102146( uParam1 );
    }
    SCRIPT_ASSERT( "Return_Alternative_Eating_Result_For_Friend: unknown friend" );
    return 8;
}

int sub_102146(unknown uParam0)
{
    unknown uVar3;
    unknown uVar4;
...
void sub_102588(unknown uParam0)
{
    unknown uVar3;
    float fVar4;
    float fVar5;
    ...
    uVar3 = sub_102599( uParam0 );
    fVar4 = 50;
    fVar5 = fVar4 * uVar3;
    uVar6 = sub_102695( fVar5 );
    sub_102845( uVar6 );
    return;
}

float sub_102599(unknown uParam0)
{
    switch (uParam0)
    {
...
void sub_102695(unknown uParam0)
{
    int iVar3;
    int Result;
    int iVar5;
...
void sub_102800(unknown uParam0)
{
    ADD_SCORE( sub_4218(), uParam0 );
    return;
}

void sub_102845(unknown uParam0)
{
...
void sub_102917(unknown uParam0)
{
    unknown uVar3;
    float fVar4;
    float fVar5;
...
void sub_102959(unknown uParam0)
{
...
int sub_103268(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    int iVar6;

    iVar6 = sub_60285( uParam0 );
    if (iVar6 == 12)
    {
        return 0;
    }
    if (NOT (sub_103301( iVar6 )))
    {
        return 0;
    }
    l_U1205 = 0;
    ...
    l_U1198 = 1;
    l_U1199 = uParam0;
    sub_94505( uParam1, uParam2, uParam3 );
    return 1;
}

int sub_103301(int iParam0)
{
    boolean bVar3;
...
int sub_103487(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    int iVar6;
    ...
    {
        case 11:
        iVar6 = sub_103563( uParam2 );
        break;
        case 12:
        iVar6 = sub_103990( uParam2 );
        break;
...
int sub_103563(unknown uParam0)
{
    int Result;
    int iVar4;
    int iVar5;
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((sub_103635( Result )) AND (NOT (sub_103698( iVar4 ))))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U1014[Result]._fU4._fU8;
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U1014[Result]._fU4._fU0, l_U1014[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_37520( sub_1568() )))) AND (sub_67383( 1, 1 )))
            {
                if (IS_CHAR_ON_FOOT( sub_1568() ))
                {
                    if (sub_97941( uParam0, 1092616192 ))
                    {
                        return Result;
                    }
                }
...
int sub_103635(unknown uParam0)
{
    unknown uVar3;
...
int sub_103698(unknown uParam0)
{
    unknown uVar3;
...
int sub_103990(unknown uParam0)
{
    int Result;
    int iVar4;
    int iVar5;
    ...
    {
        if (sub_104049( Result ))
        {
            iVar4 = l_U641[Result]._fU0;
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U641[Result]._fU4._fU8;
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1568(), l_U641[Result]._fU4._fU0, l_U641[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_37520( sub_1568() )))) AND (sub_67383( 1, 1 )))
            {
                if (IS_CHAR_ON_FOOT( sub_1568() ))
                {
                    if (sub_97941( uParam0, 1092616192 ))
...
int sub_104049(unknown uParam0)
{
    unknown uVar3;
...
void sub_104792()
{
    ...
    uVar2 = sub_104822( l_U465 );
    g_U18635[l_U416]._fU892._fU44 = uVar2;
    return;
}

void sub_104822(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    int Result;

    Result = -1;
    if (sub_75255( uParam0 ))
    {
...
boolean sub_104950(unknown uParam0)
{
    unknown uVar3;
    int iVar4;
...
void sub_105104(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    int iVar9;
    ...
    iVar9 = 0;
    sub_69728( uParam6, iVar9 );
    sub_3299( uParam2 );
    sub_3420( 0, sub_1568(), "JOHNNY", 0 );
    sub_3420( uParam3, uParam4, uParam5, 0 );
    sub_105202( iParam1, uParam0, uParam6 );
    return;
}

void sub_105202(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (uParam0)
    {
        case 6:
        sub_105304( uParam1, uParam2 );
        l_U1180 = 1;
        return;
        case 7: return;
        case 10:
        sub_105963( uParam1, uParam2 );
        l_U1180 = 1;
        return;
        case 11:
        sub_106588( uParam1, uParam2 );
        l_U1180 = 1;
        return;
        case 12:
        sub_106910( uParam1, uParam2 );
        l_U1180 = 1;
        return;
        case 16: return;
        case 18:
        sub_107524( uParam1, uParam2 );
        l_U1180 = 1;
        return;
        case 20:
        if (g_U10999 == 2)
        {
            sub_108154( uParam1, uParam2 );
        }
        l_U1180 = 1;
        return;
        case 21:
        sub_108778( uParam1, uParam2 );
        l_U1180 = 1;
        return;
        case 9:
        sub_109138( uParam1, uParam2 );
        l_U1180 = 1;
        return;
    }
...
void sub_105304(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_105327( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_105327(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_105963(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_105986( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_105986(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_106588(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_106933(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_107547(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_108177(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_109138(unknown uParam0, unknown uParam1)
{
...
int sub_109388(unknown uParam0)
{
    l_U1187 = 0;
    switch (uParam0)
    {
...
void sub_109619(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    int iVar9;
    ...
    if ((NOT l_U1186) AND (NOT l_U1187))
    {
        ...
        sub_3420( 0, sub_1568(), "JOHNNY", 0 );
        sub_3420( uParam3, uParam4, uParam5, 0 );
        sub_109711( uParam1, l_U1182, uParam0, uParam6 );
    }
    l_U1182 = 8;
    return;
}

void sub_109711(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    switch (uParam0)
    {
        case 6:
        sub_109815( uParam1, uParam2, uParam3 );
        return;
        case 7:
        sub_111633( uParam1, uParam2, uParam3 );
        return;
        case 10:
        sub_113643( uParam1, uParam2, uParam3 );
        return;
        case 11:
        sub_115373( uParam2, uParam3, l_U1188 );
        return;
        case 12:
        sub_116387( uParam2, uParam3, l_U1188 );
        return;
        case 16:
        sub_117547( uParam1, uParam2, uParam3 );
        return;
        case 18:
        sub_119024( uParam1, uParam2, uParam3 );
        return;
        case 20:
        if (g_U10999 == 2)
        {
            sub_120747( uParam1, uParam2, uParam3 );
        }
        else
        {
            sub_121676( uParam1, uParam2, uParam3 );
        }
        return;
        case 21:
        sub_73879( uParam1, uParam2, uParam3 );
        return;
        case 9:
        sub_121820( uParam1, uParam2, uParam3 );
        return;
    }
...
void sub_109815(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (uParam0)
    {
        case 0:
        sub_109869( uParam1, uParam2 );
        break;
        case 2:
        sub_110514( uParam1, uParam2 );
        break;
        case 1:
        sub_110844( uParam1, uParam2 );
        break;
        case 3:
        sub_111195( uParam1, uParam2 );
        break;
...
void sub_109869(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_109892( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_109892(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_110514(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_109892( uParam0, uParam1 );
...
void sub_110844(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_109892( uParam0, uParam1 );
...
void sub_111195(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_109892( uParam0, uParam1 );
...
void sub_111633(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (uParam0)
    {
        case 0:
        sub_111687( uParam1, uParam2 );
        break;
        case 1:
        sub_112350( uParam1, uParam2 );
        break;
        case 2:
        sub_112710( uParam1, uParam2 );
        break;
        case 3:
        sub_113127( uParam1, uParam2 );
        break;
...
void sub_111687(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_111710( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_111710(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_112350(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_111710( uParam0, uParam1 );
...
void sub_112710(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_111710( uParam0, uParam1 );
...
void sub_113127(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_111710( uParam0, uParam1 );
...
void sub_113643(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (uParam0)
    {
        case 0:
        sub_113697( uParam1, uParam2 );
        break;
        case 2:
        sub_114309( uParam1, uParam2 );
        break;
        case 1:
        sub_114621( uParam1, uParam2 );
        break;
        case 3:
        sub_114954( uParam1, uParam2 );
        break;
...
void sub_113697(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_113720( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_114309(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_113720( uParam0, uParam1 );
...
void sub_114621(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_113720( uParam0, uParam1 );
...
void sub_114954(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_113720( uParam0, uParam1 );
...
void sub_115373(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (uParam0)
    {
        case 1:
        case 6:
        case 7:
        sub_115421( uParam0, uParam1, uParam2 );
        return;
    }
...
void sub_115421(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    {
        case 10:
        sub_115517( uParam0, uParam1 );
        break;
        case 8:
        case 12:
        sub_115716( uParam0, uParam1 );
        break;
        case 11:
        case 9:
        case 13:
        sub_115914( uParam0, uParam1 );
        break;
        default:
...
void sub_115517(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_115716(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_115914(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_116387(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (uParam0)
    {
        case 1:
        case 6:
        case 7:
        sub_116435( uParam0, uParam1, uParam2 );
        return;
    }
...
void sub_116435(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    switch (uVar6)
    {
        case 18:
        case 19:
        sub_116531( uParam0, uParam1 );
        break;
        case 17:
        case 16:
        sub_116996( uParam0, uParam1 );
        break;
        case 15:
        case 20:
        sub_117179( uParam0, uParam1 );
        break;
        default:
...
void sub_116531(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_116554( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_116996(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_116554( uParam0, uParam1 );
...
void sub_117179(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_116554( uParam0, uParam1 );
...
void sub_117547(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (uParam0)
    {
        case 0:
        sub_117593( uParam1, uParam2 );
        break;
        case 1:
        sub_118235( uParam1, uParam2 );
        break;
        case 3:
        sub_118586( uParam1, uParam2 );
        break;
...
void sub_117593(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_117616( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_117616(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_118235(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_117616( uParam0, uParam1 );
...
void sub_118586(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_117616( uParam0, uParam1 );
...
void sub_119024(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (uParam0)
    {
        case 0:
        sub_119078( uParam1, uParam2 );
        break;
        case 2:
        sub_119684( uParam1, uParam2 );
        break;
        case 1:
        sub_119993( uParam1, uParam2 );
        break;
        case 3:
        sub_120323( uParam1, uParam2 );
        break;
...
void sub_119078(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_119101( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_119101(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_119684(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_119101( uParam0, uParam1 );
...
void sub_119993(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_119101( uParam0, uParam1 );
...
void sub_120323(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_119101( uParam0, uParam1 );
...
void sub_120747(int iParam0, unknown uParam1, unknown uParam2)
{
    if (iParam0 == 3)
    {
        sub_120769( uParam1, uParam2 );
    }
    else
    {
        sub_121375( uParam1, uParam2 );
    }
    return;
}

void sub_120769(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_120792( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_120792(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_121375(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_120792( uParam0, uParam1 );
...
void sub_121676(int iParam0, unknown uParam1, unknown uParam2)
{
    if (iParam0 == 3)
    {
        sub_121698( uParam1, uParam2 );
    }
    else
    {
        sub_121748( uParam1, uParam2 );
    }
    return;
}

void sub_121698(unknown uParam0, unknown uParam1)
{
    sub_40039( "PLACEHOLDER", uParam1, 7, 1 );
    return;
}

void sub_121748(unknown uParam0, unknown uParam1)
{
    sub_40039( "PLACEHOLDER", uParam1, 7, 1 );
    return;
}

void sub_121820(unknown uParam0, unknown uParam1, unknown uParam2)
{
    switch (uParam0)
    {
        case 0:
        sub_121874( uParam1, uParam2 );
        break;
        case 2:
        sub_121924( uParam1, uParam2 );
        break;
        case 1:
        sub_121974( uParam1, uParam2 );
        break;
        case 3:
        sub_122024( uParam1, uParam2 );
        break;
...
void sub_121874(unknown uParam0, unknown uParam1)
{
    sub_40039( "PLACEHOLDER", uParam1, 7, 1 );
    return;
}

void sub_121924(unknown uParam0, unknown uParam1)
{
    sub_40039( "PLACEHOLDER", uParam1, 7, 1 );
    return;
}

void sub_121974(unknown uParam0, unknown uParam1)
{
    sub_40039( "PLACEHOLDER", uParam1, 7, 1 );
    return;
}

void sub_122024(unknown uParam0, unknown uParam1)
{
    sub_40039( "PLACEHOLDER", uParam1, 7, 1 );
    return;
}

void sub_122272(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    if (iParam0 == 12)
    {
...
int sub_122452(unknown uParam0)
{
    switch (uParam0)
    {
        case 0: return 6;
...
int sub_122713(int iParam0, unknown uParam1)
{
    if (NOT (iParam0 == 22))
    {
        l_U1184 = iParam0;
    ...
    switch (l_U1184)
    {
        case 6: return sub_122873( uParam1 );
        case 10: return sub_123064( uParam1 );
        case 18: return sub_123123( uParam1 );
        case 20: return 0;
        case 21: return sub_123167( uParam1 );
        case 9: return sub_123524( uParam1 );
        case 7:
        case 16: return 0;
    }
...
int sub_122873(unknown uParam0)
{
    if (sub_122885( uParam0, 8 ))
    {
        return 1;
    }
    if (sub_122885( uParam0, 39 ))
    {
        return 1;
    }
    return 0;
...
void sub_122885(unknown uParam0, unknown uParam1)
{
    unknown uVar4;
    unknown uVar5;
    unknown uVar6;
    ...
    return sub_122914( uParam0, uVar4 );
}

void sub_122914(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    if (IS_CHAR_DEAD( sub_1568() ))
    {
        return 0;
    ...
    return sub_97941( uParam0, 1092616192 );
}

int sub_123064(unknown uParam0)
{
    if (sub_122885( uParam0, 11 ))
    {
        return 1;
    }
    if (sub_122885( uParam0, 43 ))
    {
        return 1;
    }
    return 0;
...
int sub_123123(unknown uParam0)
{
    if (sub_122885( uParam0, 10 ))
    {
        return 1;
    }
    return 0;
...
int sub_123167(unknown uParam0)
{
    int iVar3;
    ...
    if ((((sub_123257( uParam0, "Bada_room1" )) || (sub_123257( uParam0, "Bada-Private" ))) || (sub_123257( uParam0, "Bada_room2" ))) || (sub_123257( uParam0, "Bada_room1" )))
    {
        return 1;
    }
    if ((((sub_123257( uParam0, "clammainroom" )) || (sub_123257( uParam0, "clampalbkrm" ))) || (sub_123257( uParam0, "clamfronrm" ))) || (sub_123257( uParam0, "clammainroom" )))
    {
        return 1;
    }
    return 0;
...
int sub_123257(unknown uParam0, unknown uParam1)
{
    int iVar4;
    int iVar5;
...
void sub_123669(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    int iVar8;

    iVar8 = 0;
    sub_69728( uParam5, iVar8 );
    sub_3299( uParam1 );
    sub_3420( 0, sub_1568(), "JOHNNY", 0 );
    sub_3420( uParam2, uParam3, uParam4, 0 );
    sub_123736( uParam0, uParam5 );
    l_U1183 = l_U1184;
    return;
}

void sub_123736(unknown uParam0, unknown uParam1)
{
    if (g_U10499)
    {
        sub_123759( uParam0, uParam1 );
        return;
    }
    switch (uParam0)
    {
...
void sub_123759(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
...
void sub_124510(unknown uParam0, int iParam1, unknown uParam2)
{
    int iVar5;
    unknown uVar6;
    unknown uVar7;
...
void sub_124633(unknown uParam0)
{
    int iVar3;
    boolean bVar4;
    boolean bVar5;
    ...
    if (NOT (l_U521._fU20 == 0))
    {
        ...
        if (iVar3 > l_U521._fU20)
        {
            ...
            if (NOT l_U521._fU8)
            {
                sub_127229( l_U416 );
                sub_3420( 0, sub_1568(), l_U579, 0 );
                if (NOT (sub_127563( l_U416, ref l_U465, l_U521._fU16 )))
                {
                    bVar4 = true;
                }
            }
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if ((sub_138109( ref l_U465 )) || ((sub_104822( l_U465 )) > 5))
                {
                    bVar5 = true;
                }
            }
...
void sub_124798(unknown uParam0)
{
    sub_124809( uParam0 );
    sub_125495( uParam0 );
    sub_125910( uParam0 );
...
void sub_124809(unknown uParam0)
{
    unknown uVar3;
    unknown uVar4;
    unknown uVar5;
    ...
    if ((IS_CHAR_DEAD( sub_1568() )) || (sub_124832( uParam0 )))
    {
        return;
    }
    if ((IS_CHAR_ON_ANY_BIKE( sub_1568() )) || (sub_125073( uParam0 )))
    {
        sub_125213( uParam0 );
        return;
    }
...
int sub_124832(unknown uParam0)
{
    int I;
    ...
    for ( I = 0; I < 3; I++ )
    {
        if (sub_21052( I ))
        {
            if (IS_CHAR_INJURED( sub_124888( I ) ))
            {
                return 1;
            }
        }
...
int sub_125073(unknown uParam0)
{
    int I;
    ...
    for ( I = 0; I < 3; I++ )
    {
        if (sub_21052( I ))
        {
            if (NOT (IS_CHAR_INJURED( sub_124888( I ) )))
            {
                if (IS_CHAR_ON_ANY_BIKE( sub_124888( I ) ))
                {
                    return 1;
                }
            }
...
void sub_125213(unknown uParam0)
{
    unknown uVar3;
    unknown uVar4;
    unknown uVar5;
...
void sub_125495(unknown uParam0)
{
    boolean bVar3;
    int iVar4;
    int iVar5;

    if ((IS_CHAR_DEAD( sub_1568() )) || (sub_125518( uParam0 )))
    {
        return;
    }
    bVar3 = false;
...
int sub_125518(unknown uParam0)
{
    int I;
...
void sub_125910(unknown uParam0)
{
    boolean bVar3;
    ...
    if (sub_125992( uParam0 ))
    {
        bVar3 = true;
    }
    if (sub_126107( uParam0 ))
    {
        bVar3 = true;
    }
    if (l_U521._fU44)
...
int sub_125992(unknown uParam0)
{
    int I;
    ...
    for ( I = 0; I < 3; I++ )
    {
        if (sub_21052( I ))
        {
            if (IS_CHAR_SHOOTING( sub_124888( I ) ))
            {
                return 1;
            }
        }
...
int sub_126107(unknown uParam0)
{
    int I;
    ...
    for ( I = 0; I < 3; I++ )
    {
        if (sub_21052( I ))
        {
            if (IS_CHAR_IN_MELEE_COMBAT( sub_124888( I ) ))
            {
                return 1;
            }
        }
...
void sub_126311(unknown uParam0)
{
    int I;
    unknown uVar4;
...
int sub_126538(unknown uParam0)
{
    unknown uVar3;

    if ((sub_126547()) || (l_U521._fU24))
    {
        return 0;
    }
    if ((l_U501 == 0) || (l_U501 == 1))
...
int sub_126679(unknown uParam0)
{
    if ((sub_126547()) || (l_U521._fU24))
    {
        return 0;
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( sub_1568() ))) AND (NOT (sub_124832( uParam0 ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_1568() ))
            {
                if (sub_126769( uParam0 ))
                {
                    return 1;
                }
            }
...
int sub_126769(unknown uParam0)
{
    int I;
    ...
    for ( I = 0; I < 3; I++ )
    {
        if (sub_21052( I ))
        {
            ...
            if (NOT (IS_CHAR_ON_ANY_BIKE( sub_124888( I ) )))
            {
                return 0;
            }
        }
...
void sub_127229(unknown uParam0)
{
    switch (uParam0)
    {
        case 1:
...
int sub_127563(unknown uParam0, unknown uParam1, unknown uParam2)
{
    int iVar5;
    int iVar6;
    int I;
    ...
    if ((NOT g_U18635[uParam0]._fU892._fU28) AND (uParam2))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((sub_127732( uParam0, I )) AND (NOT (sub_127997( uParam0, I ))))
            {
                sub_127913( uParam0, I );
            }
        }
    }
    sub_129209( uParam0 );
    ...
    {
        case 1:
        sub_130921( uParam1, iVar10 );
        return 1;
        case 6:
        sub_132191( uParam1, iVar10 );
        return 1;
        case 7:
        sub_132607( uParam1, iVar10 );
        return 1;
    }
...
void sub_127686()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if (((sub_127732( 1, I )) || (sub_127732( 6, I ))) || (sub_127732( 7, I )))
        {
            sub_127824( 1, I );
            sub_127824( 6, I );
            sub_127824( 7, I );
        ...
        if (((sub_127997( 1, I )) || (sub_127997( 6, I ))) || (sub_127997( 7, I )))
        {
            sub_128089( 1, I );
            sub_128089( 6, I );
            sub_128089( 7, I );
...
void sub_127732(unknown uParam0, int iParam1)
{
    int iVar4;
    int iVar5;
...
void sub_127824(unknown uParam0, int iParam1)
{
    int iVar4;
    int iVar5;
...
void sub_127997(unknown uParam0, int iParam1)
{
    int iVar4;
    int iVar5;
...
void sub_128089(unknown uParam0, int iParam1)
{
    int iVar4;
    int iVar5;
...
void sub_128178(unknown uParam0, int iParam1)
{
    int iVar4;
    int iVar5;
...
void sub_129209(unknown uParam0)
{
    return;
}

int sub_129466(unknown uParam0)
{
    boolean bVar3;
    boolean bVar4;
    boolean bVar5;
...
int sub_129849(unknown uParam0)
{
...
void sub_130921(unknown uParam0, boolean bParam1)
{
    int iVar4;
    int iVar5;
    int iVar6;
...
void sub_132047(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    return sub_132072( uParam0, ref l_U6._fU0, uParam1, uParam2, uParam3, uParam4, uParam5 );
}

void sub_132072(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    char[16] cVar9;
    char[12] cVar13;
    unknown uVar16;
...
void sub_132191(unknown uParam0, boolean bParam1)
{
    int iVar4;
    int iVar5;
    int iVar6;
...
void sub_132607(unknown uParam0, boolean bParam1)
{
    int iVar4;
    int iVar5;
    int iVar6;
...
void sub_133149(unknown uParam0)
{
    switch (uParam0)
    {
        case 1:
...
void sub_133476(unknown uParam0, unknown uParam1)
{
    int iVar4;
    int iVar5;
    int iVar6;
    ...
    switch (uParam0)
    {
        ...
        return;
        case 6:
        sub_136414( uParam1, iVar11 );
        return;
        case 7:
        sub_136853( uParam1, iVar11 );
        return;
    }
...
int sub_134427(unknown uParam0)
{
    boolean bVar3;
    boolean bVar4;
    boolean bVar5;
...
void sub_136414(unknown uParam0, boolean bParam1)
{
    int iVar4;
    int iVar5;
    int iVar6;
...
void sub_136853(unknown uParam0, boolean bParam1)
{
    int iVar4;
    int iVar5;
    int iVar6;
...
int sub_137447(unknown uParam0)
{
    int iVar3;
    int iVar4;

    if ((sub_125518( uParam0 )) || (IS_CHAR_DEAD( sub_1568() )))
    {
        return l_U521._fU24;
    }
    if (l_U521._fU24)
        ...
        if (NOT sub_126547())
        {
            ...
            if ((NOT (l_U521._fU28 == 0)) AND (iVar3 > l_U521._fU28))
            {
                ...
                if (l_U521._fU8)
                {
                    sub_133149( l_U416 );
                    sub_3420( 0, sub_1568(), l_U579, 0 );
                    sub_137712( l_U416, ref l_U465 );
                }
                else
                {
                    sub_127229( l_U416 );
                    sub_3420( 0, sub_1568(), l_U579, 0 );
                    sub_137848( l_U416, ref l_U465 );
                }
                l_U521._fU24 = 0;
                return 0;
            }
...
void sub_137712(unknown uParam0, unknown uParam1)
{
    int iVar4;
    ...
    switch (uParam0)
    {
        ...
        break;
        case 6:
        sub_136414( uParam1, iVar4 );
        break;
        case 7:
        sub_136853( uParam1, iVar4 );
        break;
    }
    return;
}

void sub_137848(unknown uParam0, unknown uParam1)
{
    int iVar4;
    ...
    {
        case 1:
        sub_130921( uParam1, iVar4 );
        break;
        case 6:
        sub_132191( uParam1, iVar4 );
        break;
        case 7:
        sub_132607( uParam1, iVar4 );
        break;
    }
    return;
}

int sub_138109(int iParam0)
{
    if (IS_SCRIPTED_CONVERSATION_ONGOING())
    {
        if (iParam0->_fU4 == g_U8945)
...
void sub_138384(unknown uParam0)
{
    int iVar3;
    int I;
    ...
    for ( I = 0; I < (uParam0^); I++ )
    {
        sub_157537( ref (uParam0^)[I] );
    }
    return;
}

void sub_138423(unknown uParam0)
{
    int[5] iVar3;
    int I;
    unknown uVar10;
...
void sub_138736(int iParam0, boolean bParam1)
{
    unknown uVar4;
    int iVar5;
    ...
    if (iParam0->_fU36 != 0)
    {
        ...
        if (sub_88257( iParam0, 1 ))
        {
            sub_146263( iParam0 + 0, 0 );
        }
        else
        {
            sub_146263( iParam0 + 0, 1 );
        }
        if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
        {
    ...
    {
        case 2:
        iVar5 = sub_146554( iParam0 );
        if (iVar5 == 1)
        {
            if (sub_88257( iParam0, 32 ))
            {
                sub_50699( iParam0, 3 );
            }
            else if (sub_88257( iParam0, 64 ))
            {
                if (sub_88257( iParam0, 1 ))
                {
                    sub_50699( iParam0, 5 );
        ...
        else if ((sub_147605( iParam0 )) != 0)
        {
            ;
        }
        else if ((sub_147862( iParam0 )) != 0)
        {
            ;
        }
        else if ((sub_148994( iParam0 )) != 0)
        {
            ;
        }
        else if ((sub_149108( iParam0 )) != 0)
        {
            ;
        }
        else if ((sub_149229( iParam0 )) != 0)
        {
            ;
        }
        else if ((sub_149529( iParam0 )) != 0)
        {
            ;
        };;;;;;;;
        break;
        case 3:
        if ((sub_149885( iParam0 )) != 0)
        {
            ;
        }
        else if ((sub_147605( iParam0 )) != 0)
        ...
        {
            if ((sub_139756( iParam0 )) != 0)
            {
                ;
            }
            else if ((sub_150144( iParam0 )) != 0)
            {
                ;
            }
        }
        else if ((sub_150301( iParam0 )) != 0)
        {
            ;
        }
        break;
        ...
        break;
        case 5:
        if ((sub_146651( iParam0 )) > 30.00000000)
        {
            sub_157452( iParam0 );
        }
        else if ((sub_150144( iParam0 )) != 0)
        ...
        else if ((sub_139594( iParam0, 1, 0 )) != 0)
        {
            ;
        };;;
        break;
...
void sub_138783(unknown uParam0)
{
    int iVar3;

    iVar3 = sub_138794( uParam0 );
    if (iVar3 == -1)
    {
        return;
    }
...
int sub_139178(int iParam0)
{
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_45916( iParam0 + 0 )) == 3) AND ((sub_139321( iVar3 )) == sub_139350())))
        {
            if ((((sub_45916( iParam0 + 0 )) != 1) || ((sub_139396( iParam0->_fU0 )) == (sub_17371( 0 )))) || ((sub_139438( sub_1568() )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1568() )))))
            {
                return 0;
            }
            else
        ...
        return sub_139594( iParam0, 1, 1 );
    }
    return 0;
}

void sub_139321(unknown uParam0)
{
    unknown Result;
...
void sub_139396(unknown uParam0)
{
    unknown Result;
...
boolean sub_139438(unknown uParam0)
{
    return (IS_CHAR_IN_ANY_CAR( uParam0 )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( uParam0 )));
}

int sub_139594(int iParam0, unknown uParam1, boolean bParam2)
{
    unknown uVar5;
    float fVar6;
    int iVar7;
    ...
    else if ((sub_139438( iParam0->_fU0 )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))))
    {
        return 2;
    }
    else if ((uParam1) || (sub_88257( iParam0, 1 )))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
int sub_139756(int iParam0)
{
    unknown uVar3;
    int iVar4;

    uVar3 = sub_59152( iParam0 );
    if (IS_VEH_DRIVEABLE( uVar3 ))
    {
...
void sub_139939(unknown uParam0, boolean bParam1)
{
    unknown Result;
    unknown uVar5;
    unknown uVar6;
...
void sub_140150(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        if (NOT (sub_140181( (iParam0^) )))
        {
            if (((sub_140216( (iParam0^) )) AND (NOT l_U154)) AND (NOT l_U155))
            {
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_137593()))
                {
        ...
        {
            if ((((((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_1568(), iParam0->_fU0, l_U145, l_U145, l_U145, 0 ))) || (NOT (IS_CHAR_ON_ANY_BIKE( sub_1568() )))) || (NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() )))) || (NOT (sub_75255( l_U147 ))))
            {
                sub_141603( iParam0 );
            }
        }
    }
    else if (sub_140181( (iParam0^) ))
    {
        sub_69728( ref l_U147, 0 );
        sub_141603( iParam0 );
    }
    return;
}

void sub_140181(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25)
{
    return uParam0._fU44._fU4;
}

void sub_140216(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25)
{
...
void sub_141302(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25)
{
...
void sub_141603(int iParam0)
{
    sub_69728( ref l_U147, 1 );
...
void sub_141766(int iParam0)
{
    ...
    if ((sub_140181( (iParam0^) )) AND (sub_137593()))
    {
        if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
        {
            if (((IS_CHAR_SITTING_IN_CAR( iParam0->_fU0, iParam0->_fU4 )) AND (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 ))) AND (IS_CHAR_ON_ANY_BIKE( sub_1568() )))
            {
                ...
                if (IS_SCRIPTED_SPEECH_PLAYING( iParam0->_fU0 ))
                {
                    ...
                    {
                        sub_51766( iParam0->_fU0, sub_142040( uVar8._fU0 < 0.00000000, sub_51979( iParam0->_fU4 ) ), sub_1568(), 39 );
    ...
    if (((sub_137593()) || (sub_140181( (iParam0^) ))) || ((iVar4 - l_U165) < 33))
    {
        return;
    }
    if (l_U165 <= 0)
    ...
    if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        ...
        {
            if (sub_142693( uVar12 ))
            {
                fVar21 = sub_142736( iParam0 );
                if (((NOT (sub_140181( (iParam0^) ))) AND (((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) AND (fVar21 < 19)) || (fVar21 < 15))) AND (iParam0->_fU0 != l_U167))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((l_U104) AND ((iParam0->_fU36 != 1) || ((sub_52600( 0, 10 )) == 0)))
                    {
                        l_U104 = 0;
                        iVar15 = 17;
                        iVar11 = sub_1568();
                    }
                    else if ((((sub_142930( iParam0 )) AND (iParam0->_fU36 == 2)) AND ((sub_45916( iParam0 + 0 )) == 1)) AND (NOT (IS_BIT_SET( l_U170, 6 ))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_143044( bVar16 );
                        iVar11 = sub_1568();
                    }
                    else if (((IS_CAR_IN_AIR_PROPER( uVar12 )) AND ((ABSF( uVar22 )) < 20.00000000)) AND (sub_143132( 8 )))
                    {
                        uVar13 = sub_51426( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_1568() )) AND (sub_143132( 12 )))
                    {
                        uVar13 = sub_143044( bVar16 );
                        iVar11 = sub_1568();
                        iVar15 = 12;
                    ...
                    else if (((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 )) || (IS_PED_RAGDOLL( iParam0->_fU0 ))) AND (sub_143132( 13 )))
                    {
                        uVar13 = sub_143044( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if (((((sub_45916( iParam0 + 0 )) == 1) AND (NOT (IS_PLAYER_PRESSING_HORN( sub_4218() )))) AND (IS_BIT_SET( l_U170, 7 ))) AND (sub_143132( 20 )))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if ((((IS_WANTED_LEVEL_GREATER( sub_4218(), 0 )) AND (NOT (IS_BIT_SET( l_U170, 0 )))) AND (sub_143132( 24 ))) AND ((sub_45916( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 24;
                        iVar11 = sub_1568();
                    }
                    else if ((((NOT (IS_WANTED_LEVEL_GREATER( sub_4218(), 0 ))) AND (IS_BIT_SET( l_U170, 0 ))) AND (sub_143132( 30 ))) AND ((sub_45916( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        uVar5 = {sub_139939( sub_1568(), 1 )};
                        uVar23 = nil;
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_143132( 33 )) AND (NOT (IS_BIT_SET( l_U170, 4 )))) AND ((sub_45916( iParam0 + 0 )) == 1))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1568() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_143132( 31 )) AND (NOT (IS_BIT_SET( l_U170, 4 )))) AND ((sub_45916( iParam0 + 0 )) == 1))
                                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((sub_143132( 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_4218(), 0 ))))
                                {
                                ...
                                else if (((sub_143132( 36 )) AND (IS_WANTED_LEVEL_GREATER( sub_4218(), 0 ))) AND (NOT (IS_BIT_SET( l_U170, 1 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((IS_WANTED_LEVEL_GREATER( sub_4218(), 2 )) AND (sub_143132( 23 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            uVar23 = sub_144946( uVar5, 25.00000000, 4 );
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if ((sub_143132( 28 )) AND ((sub_45916( iParam0 + 0 )) == 1))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_143132( 3 )) AND (sub_143132( 4 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if (((sub_45916( iParam0 + 0 )) == 1) AND (fVar26 < 5))
                            {
                                if ((sub_143132( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_4218(), 0 )))
                                {
                                    iVar15 = 23;
                                }
                                else if (sub_143132( 21 ))
                                {
                                    iVar15 = 21;
                                }
                            }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if ((sub_143132( 30 )) AND ((sub_45916( iParam0 + 0 )) == 1))
                                {
                                    iVar15 = 30;
                                }
                                else if (sub_143132( 20 ))
                                {
                                    iVar15 = 20;
                                }
                            }
...
void sub_142040(boolean bParam0, int iParam1)
{
    string Result;
...
void sub_142693(unknown uParam0)
{
    unknown uVar3;
...
void sub_142736(int iParam0)
{
    return sub_142756( iParam0->_fU0, sub_1568(), 1 );
}

void sub_142756(unknown uParam0, unknown uParam1, unknown uParam2)
{
    return VDIST( sub_139939( uParam0, uParam2 ), sub_139939( uParam1, uParam2 ) );
}

void sub_142930(int iParam0)
{
    unknown uVar3;
    unknown uVar4;
    unknown uVar5;
...
void sub_143044(boolean bParam0)
{
    string Result;
...
boolean sub_143132(int iParam0)
{
    int iVar3;
    int iVar4;
...
void sub_144946(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    unknown Result;
    int[22] iVar8;
    int I;
...
void sub_145547(boolean bParam0)
{
    unknown uVar3;
    string Result;
...
void sub_146263(unknown uParam0, unknown uParam1)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
...
int sub_146554(int iParam0)
{
    ...
    else if ((sub_59152( iParam0 )) != iParam0->_fU4)
    {
        if (sub_142693( iParam0->_fU4 ))
        {
            SET_CAR_TRACTION( iParam0->_fU4, 1.00000000 );
        }
        return 0;
    }
    else if ((sub_146651( iParam0 )) < l_U175)
    {
        return 1;
    };;;
    if (sub_142693( iParam0->_fU4 ))
    ...
    {
        fVar4 = (sub_146651( iParam0 )) / 3.00000000;
    ...
    if (sub_147179( iParam0->_fU4 ))
    {
        uVar6 = {sub_147329( iParam0->_fU4, 1 )};
...
void sub_146651(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        switch (iParam0->_fU36)
        {
            ...
            if (NOT (IS_CHAR_INJURED( iParam0->_fU8 )))
            {
                return sub_142756( iParam0->_fU0, iParam0->_fU8, 1 );
            }
            break;
            default:
        }
    }
    return VDIST( sub_139939( iParam0->_fU0, 1 ), iParam0->_fU16 );
}

int sub_147179(unknown uParam0)
{
...
void sub_147329(unknown uParam0, boolean bParam1)
{
    unknown Result;
    unknown uVar5;
    unknown uVar6;
...
int sub_147605(int iParam0)
{
    unknown uVar3;
    int iVar4;

    if (NOT (sub_88257( iParam0, 2 )))
    {
        return 0;
    }
    uVar3 = sub_59152( iParam0 );
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            {
                if (((sub_45916( ref iVar4 )) == (sub_45916( iParam0 + 0 ))) || ((iVar4 == sub_1568()) AND ((sub_45916( iParam0 + 0 )) == 1)))
                {
...
int sub_147862(int iParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( iParam0->_fU8 )))
    {
        if (sub_147900( iParam0->_fU8, iParam0->_fU0, 0 ))
        {
            return 2;
        }
    }
    ...
    {
        if (sub_139438( iParam0->_fU0 ))
        {
            return 2;
        }
        if ((sub_59152( iParam0 )) == iParam0->_fU4)
        {
            if (sub_142693( iParam0->_fU4 ))
            {
        ...
        if (NOT (sub_142693( iParam0->_fU4 )))
        {
            iParam0->_fU4 = nil;
            return 0;
        }
        ...
        if ((((IS_CHAR_IN_CAR( sub_1568(), iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((sub_142756( iParam0->_fU0, sub_1568(), 1 )) < 90.00000000))
        {
...
void sub_147900(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown[2] uVar5;
    ...
    uVar5[0] = uParam0;
    uVar5[1] = uParam1;
    return sub_147930( ref uVar5, uParam2 );
}

int sub_147930(unknown uParam0, unknown uParam1)
{
    int I;
    unknown[2] uVar5;

    array(ref uVar5, 2);
    if (NOT (sub_147955( (uParam0^)[0], ref uVar5[0], uParam1 )))
    {
        return 0;
    }
    for ( I = 1; I <= ((uParam0^) - 1); I++ )
    {
        if (sub_147955( (uParam0^)[I], ref uVar5[1], uParam1 ))
        {
            if (uVar5[0] != uVar5[1])
            {
                return 0;
...
int sub_147955(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (bParam2)
    {
...
int sub_148584(int iParam0)
{
    if (sub_148598( iParam0->_fU0 ))
    {
        ;
    }
    return 1;
...
int sub_148598(unknown uParam0)
{
    int iVar3;
    int iVar4;
    int iVar5;
...
int sub_148994(int iParam0)
{
    unknown uVar3;

    if ((NOT (sub_88257( iParam0, 2 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        return 0;
    }
    uVar3 = sub_144946( sub_139939( iParam0->_fU0, 1 ), 30.00000000, 190 );
    if (IS_VEH_DRIVEABLE( uVar3 ))
    {
        iParam0->_fU4 = uVar3;
        return 1;
...
int sub_149108(int iParam0)
{
    ...
    uVar3 = GET_CLOSEST_CAR( sub_139939( iParam0->_fU0, 1 ), 30.00000000, 0, 190 );
    if (IS_VEH_DRIVEABLE( uVar3 ))
    {
        iParam0->_fU4 = uVar3;
        return 1;
...
int sub_149529(int iParam0)
{
    ...
    if ((sub_146651( iParam0 )) < 12.00000000)
    {
        return 1;
    }
    else if ((((sub_146651( iParam0 )) > 90.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND ((sub_142756( iParam0->_fU0, sub_1568(), 1 )) > 90.00000000))
    {
        ...
        {
            if (((CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 )) || (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 ))) || ((VDIST( sub_139939( sub_1568(), 1 ), uVar4 )) < 30.00000000))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_150301(int iParam0)
{
    ...
    if (DOES_VEHICLE_EXIST( iVar4 ))
    {
        if (sub_50214( iParam0->_fU0, iVar4 ))
        {
            ...
            {
                if (sub_147900( sub_1568(), iParam0->_fU0, 0 ))
                {
                    return 2;
                }
            }
            ...
            if (bVar6)
            {
                return sub_139594( iParam0, 1, 0 );
            }
        }
    }
    if ((sub_88257( iParam0, 1 )) AND ((sub_146651( iParam0 )) < 30.00000000))
    {
        SET_CHAR_WILL_LEAVE_CAR_IN_COMBAT( iParam0->_fU0, 1 );
    ...
    if ((NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))) AND ((((IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 )) || (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 ))) || (DOES_VEHICLE_EXIST( iVar4 ))) || ((sub_142756( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8)))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((sub_50238( iParam0->_fU8, iParam0->_fU4 )) || (iParam0->_fU4 == iVar4))
            {
                if ((sub_150987( iParam0 )) != 0)
                {
                    ;
                }
                else if ((sub_147605( iParam0 )) != 0)
                ...
                else if ((sub_152054( iParam0 )) != 0)
                {
                    ;
                }
                else if ((sub_152465( iParam0 )) != 0)
                {
                    ;
                }
                else if ((sub_149229( iParam0 )) != 0)
            ...
            else if ((sub_50238( sub_1568(), iParam0->_fU4 )) AND ((sub_45916( iParam0 + 0 )) == 1))
            {
                if ((sub_147605( iParam0 )) != 0)
                {
                    ;
                }
                else if ((sub_148994( iParam0 )) != 0)
            ...
            else if ((sub_153291( iParam0 )) != 0)
            {
                ;
            }
            else if ((sub_153440( iParam0 )) != 0)
            {
                ;
            }
            else if ((sub_147862( iParam0 )) != 0)
    ...
    else if (((sub_147900( sub_1568(), iParam0->_fU0, 1 )) AND (iParam0->_fU8 != sub_1568())) AND ((sub_45916( iParam0 + 0 )) == 1))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((NOT (sub_88257( iParam0, 1 ))) || (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
        {
            if ((sub_139756( iParam0 )) != 0)
            {
                ;
    ...
    else if ((sub_88257( iParam0, 1 )) AND (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))))
    {
        if ((sub_153291( iParam0 )) != 0)
        {
            ;
        }
        else if ((sub_151326( iParam0 )) != 0)
        ...
        else if ((sub_139594( iParam0, 0, 0 )) != 0)
        {
            ;
        }
        else if ((sub_139756( iParam0 )) != 0)
        {
            ;
        };;;;;
    }
...
int sub_150987(int iParam0)
{
    ...
    uVar5 = {sub_147329( uVar3, 1 )};
    uVar8 = {sub_139939( iParam0->_fU0, 1 )};
    uVar11 = {sub_139939( sub_1568(), 1 )};
    if (IS_PED_IN_GROUP( iParam0->_fU0 ))
    {
        if ((sub_146651( iParam0 )) > 30.00000000)
        {
    ...
    else if ((sub_146651( iParam0 )) < 12.00000000)
    {
        iVar14 = sub_151326( iParam0 );
        if (iVar14 != 0)
        {
            return 2;
        }
...
int sub_151116(unknown uParam0)
{
    int Result;
    int iVar4;
...
int sub_151326(int iParam0)
{
    ...
    {
        if (NOT (sub_147900( iParam0->_fU0, iParam0->_fU8, 1 )))
        {
            return 0;
        }
    }
    else if ((sub_142756( iParam0->_fU0, iParam0->_fU8, 1 )) > 12.00000000)
    {
        return 0;
    }
...
int sub_152054(int iParam0)
{
    ...
    else if ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_142736( iParam0 )) > 30.00000000))
    {
...
int sub_152465(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        uVar4 = {sub_139939( sub_1568(), 1 )};
        uVar7 = {sub_139939( iParam0->_fU0, 1 )};
        uVar10 = {sub_147329( iParam0->_fU4, 1 )};
        if ((((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((VDIST( uVar4, uVar10 )) < 30.00000000)) || ((VDIST( uVar4, uVar7 )) < 30.00000000))
        {
            ...
            else if ((iVar3 == sub_1568()) || ((sub_45916( ref iVar3 )) == (sub_45916( iParam0 + 0 ))))
            {
                iVar14 = sub_151116( iParam0->_fU4 );
                if (iVar14 < 0)
                {
                    return 0;
                }
...
int sub_153291(int iParam0)
{
    ...
    if ((((IS_PED_IN_COMBAT( iParam0->_fU0 )) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 ))) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 ))) AND ((sub_146651( iParam0 )) < 30.00000000))
    {
        return 2;
    }
    return 0;
...
int sub_153440(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_147179( iParam0->_fU4 )) || (sub_88257( iParam0, 4 ))) AND ((sub_142736( iParam0 )) >= l_U125))
        {
            bVar9 = sub_154640( iParam0, l_U125, l_U126, fVar5 + 4.00000000 );
            if (bVar9)
            {
                if (sub_88257( iParam0, 128 ))
                {
    ...
    else
    {
        ...
        fVar7 = fVar6;
        sub_156084( ref fVar7, 5.00000000, 50.00000000 );
        SET_DRIVE_TASK_CRUISE_SPEED( iParam0->_fU0, fVar7 );;
    }
    return 2;
}

void sub_153958(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
    ...
    uVar9 = iParam0->_fU88;
    sub_59456( iParam0, 64 );
    Result = sub_146554( iParam0 );
    iParam0->_fU16 = {uVar6};
    iParam0->_fU88 = uVar9;
    return Result;
}
...
int sub_154640(int iParam0, unknown uParam1, float fParam2, unknown uParam3)
{
    vector vVar6;
    vector vVar9;
    vector vVar12;
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 ))) AND ((VDIST( uVar15, sub_139939( sub_1568(), 1 ) )) > fParam2)) AND ((VDIST2( uVar15, vVar6 )) > 9.00000000))
                    {
...
int sub_156084(unknown uParam0, float fParam1, float fParam2)
{
    float fVar5;
...
void sub_157452(unknown uParam0)
{
    sub_50699( uParam0, 2 );
    return;
}

void sub_157537(int iParam0)
{
    if (PLAYER_IS_INTERACTING_WITH_GARAGE())
    {
        if (NOT (sub_88257( iParam0, 256 )))
        {
            if (DOES_CHAR_EXIST( iParam0->_fU0 ))
            {
                if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
                {
                    ...
                    {
                        if (NOT (sub_147900( sub_1568(), iParam0->_fU0, 1 )))
                        {
            ...
            sub_59456( iParam0, 256 );
        }
    }
    else if (sub_88257( iParam0, 256 ))
    {
        if (DOES_CHAR_EXIST( iParam0->_fU0 ))
        {
...
int sub_158088(unknown uParam0, int iParam1)
{
    int Result;
...
void sub_158385(unknown uParam0)
{
    int I;
    int iVar4;
    int J;
...
void sub_160494(unknown uParam0)
{
    int I;
    boolean bVar4;
    boolean bVar5;
    ...
    if (l_U110 >= 0)
    {
        ...
        {
            iVar9 = sub_160729( uParam0 );
        }
        else if (iVar12 <= 65456)
        {
            iVar9 = sub_161248( uParam0 );
        };;;
    }
    if (IS_CHAR_IN_ANY_CAR( sub_1568() ))
    {
        for ( I = 0; I < (uParam0^); I++ )
        {
            if (sub_160765( uParam0, I ))
            {
                if (iVar9 < 0)
                {
                    fVar11 = sub_142756( (uParam0^)[I]._fU0, sub_1568(), 1 );
                    if (fVar11 > fVar10)
                    {
                        fVar10 = fVar11;
                        iVar8 = I;
    ...
    if ((((((((IS_CONTROL_PRESSED( 0, 51 )) AND (NOT (IS_CONTROL_PRESSED( 0, 38 )))) AND (NOT (IS_CONTROL_PRESSED( 0, 39 )))) AND (IS_CHAR_ON_ANY_BIKE( sub_1568() ))) AND (NOT sub_162840())) AND (NOT (iVar14 == 4))) AND (iVar8 >= 0)) AND (NOT bVar4))
    {
        sub_162903( uParam0, iVar8 );
    }
    else
    {
        sub_21622();
...
void sub_160729(unknown uParam0)
{
    int I;
    int Result;
    ...
    {
        if (((sub_160765( uParam0, I )) AND (I != l_U110)) AND (Result < 0))
        {
            Result = I;
        }
    }
...
int sub_160765(unknown uParam0, int iParam1)
{
    unknown uVar4;
    unknown uVar5;
    unknown uVar6;
    ...
    if (((NOT (IS_CHAR_INJURED( (uParam0^)[iParam1]._fU0 ))) AND (IS_VEH_DRIVEABLE( (uParam0^)[iParam1]._fU4 ))) AND (NOT (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_1568() ))))
    {
        ...
        {
            uVar4 = {sub_139939( (uParam0^)[iParam1]._fU0, 1 )};
            uVar7 = {sub_139939( sub_1568(), 1 )};
...
void sub_161248(unknown uParam0)
{
    int I;
    int Result;
...
void sub_161561(int iParam0)
{
    ...
    vVar3 = {sub_139939( sub_1568(), 1 )};
    vVar6 = {sub_139939( iParam0->_fU0, 1 )};
    ...
    SET_CAM_FOV( l_U109, sub_162093( l_U113 - fVar19 ) );
...
void sub_162903(unknown uParam0, unknown uParam1)
{
    int iVar4;
    int iVar5;
    int iVar6;
    ...
    if (NOT (DOES_CAM_EXIST( l_U109 )))
    {
        ...
        else
        {
            ...
            l_U112 = sub_142756( (uParam0^)[l_U110]._fU0, sub_1568(), 1 );
            l_U113 = l_U112;
            l_U114 = 0.00000000;
...
void sub_163424(unknown uParam0)
{
    unknown uVar3;
    int iVar4;
    boolean bVar5;
    ...
    if (bVar5)
    {
        ...
        if (NOT sub_164234())
        {
            ...
            if (bVar7)
            {
                ...
                sub_164311( 0.08000000 * (TO_FLOAT( sub_165618( 2, FLOOR( fVar6 ) ) )) );
                bVar7 = false;
            }
            if (bVar8)
            {
    ...
    if (HAS_SCRIPT_LOADED( "ability_stats" ))
    {
        if (NOT g_U39103)
        {
            if ((((((NOT sub_162840()) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ability_stats" )) == 0)) AND (NOT sub_165912())) AND (NOT IS_MINIGAME_IN_PROGRESS())) AND (NOT g_U11112)) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))
            {
                if (NOT l_U1248)
                {
...
void sub_164311(unknown uParam0)
{
    int I;

    for ( I = 0; I < 2; I++ )
    {
        sub_164337( I, uParam0, 0 );
    }
    g_U11101 = 1;
    return;
}

void sub_164337(int iParam0, unknown uParam1, unknown uParam2)
{
    float fVar5;
    unknown uVar6;
    float fVar7;
...
void sub_165253(boolean bParam0, unknown uParam1)
{
...
int sub_165618(int Result, int iParam1)
{
    int I;
    int iVar5;
...
int sub_165912()
{
    ...
    {
        if ((ARE_WIDESCREEN_BORDERS_ACTIVE()) AND (sub_165946()))
        {
            return 1;
        }
