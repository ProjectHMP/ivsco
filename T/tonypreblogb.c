void main()
{
    ...
    while (bVar2)
    {
        ...
        bVar7 = true;
        if ((g_U12379) AND (NOT ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony4b" )) > 0)))
        {
            bVar7 = false;
        }
        if (bVar7)
...
int sub_156()
{
    if ((((IS_BIT_SET( g_U10938._fU0, 4 )) AND (IS_BIT_SET( g_U10938._fU0, 6 ))) AND (g_U10938._fU4 == 0)) AND (g_U10938._fU8 == 6))
    {
...
int sub_1178(unknown uParam0)
{
    ...
    if ((g_U15904[uParam0]._fU12) AND (sub_1219()))
    {
        return 1;
    }
    return 0;
