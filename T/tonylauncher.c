void main()
{
    ...
    while (bVar2)
    {
        ...
        if (bVar2)
        {
            ...
            {
                if ((LOCATE_CHAR_ANY_MEANS_3D( sub_294(), g_U10756[l_U20]._fU4._fU0, g_U10756[l_U20]._fU4._fU4, g_U10756[l_U20]._fU4._fU8, 50.00000000, 50.00000000, 50.00000000, 0 )) || (TIMERB() < 20000))
                {
                    bVar2 = true;
                }
            }
...
void sub_473()
{
    ...
    else if ((g_U15811[12]) AND (l_U20 == 3))
    {
        iVar6 = 1;
    }
    if ((NOT bVar5) || (iVar6))
...
int sub_3270()
{
    if (l_U19)
    {
        if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "DAY_TRY" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AT_CLUB" )))
        {
            return 1;
        }
    }
    else if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "NIGHT_TRY" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AT_LOFT" )))
    {
        return 1;
    }
    return 0;
