...
int sub_1912(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_753() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((IS_PLAYER_CONTROL_ON( sub_753() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_753() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_2008())
                    {
...
int sub_2104(boolean bParam0, unknown uParam1)
{
    if (bParam0)
    {
        g_U95._fU104 = 1;
...
int sub_2202(unknown uParam0, string sParam1, unknown uParam2)
{
    string sVar5;
    string sVar6;
...
int sub_3688(unknown uParam0, unknown uParam1, unknown uParam2)
{
...
int sub_5054()
{
    if (((((IS_BUTTON_PRESSED( 0, 17 )) || (IS_BUTTON_PRESSED( 0, 14 ))) || (IS_BUTTON_PRESSED( 0, 15 ))) || (IS_BUTTON_PRESSED( 0, 16 ))) || (sub_5102()))
    {
        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_1148() );
        SET_PLAYER_CONTROL( sub_753(), 1 );
        return 1;
...
void sub_5780()
{
    ...
    uVar5 = l_U20;
    uVar6 = l_U21;
    if ((IS_SNIPER_INVERTED()) AND (IS_USING_CONTROLLER()))
    {
        l_U65 = 0;
        l_U18 = uVar3;
        l_U19 = uVar4;
    ...
    if ((l_U19 < 65436) AND (l_U19 >= 65408))
    {
        if (l_U28)
        {
            if (DOES_CAM_EXIST( l_U101 ))
    ...
    if ((l_U18 < 65436) AND (l_U18 >= 65408))
    {
        if (DOES_CAM_EXIST( l_U101 ))
        {
            GET_CAM_ROT( l_U101, ref l_U41, ref l_U42, ref l_U43 );
