void main()
{
    ...
    l_U3690 = {-681.76210000, -0.62300000, 3.70750000};
    l_U3693 = {-702.64780000, -13.68750000, 3.80540000};
    ...
    while (true)
    {
        ...
        if ((l_U4221 != 0) AND (l_U4221 != 10))
        {
            sub_29196( 0 );
        }
        if (((((l_U4221 == 4) || (l_U4221 == 5)) || (l_U4221 == 6)) || (l_U4221 == 7)) || (l_U4221 == 9))
        {
            ...
            if ((iVar4 - l_U3889) > 8000)
            {
                ...
                SET_VISIBILITY_OF_CLOSEST_OBJECT_OF_TYPE( -826.71500000, 5.88290000, 5.19150000, 10.00000000, -1022619662, 0 );
                SET_USES_COLLISION_OF_CLOSEST_OBJECT_OF_TYPE( -821.19300000, -34.21250000, 5.19150000, 10.00000000, -1022619662, 0 );
                SET_USES_COLLISION_OF_CLOSEST_OBJECT_OF_TYPE( -826.71500000, 5.88290000, 5.19150000, 10.00000000, -1022619662, 0 );
        ...
        if (DOES_VEHICLE_EXIST( l_U4052 ))
        {
            if (NOT l_U3824)
            {
                if (((((NOT (IS_VEH_DRIVEABLE( l_U4052 ))) || (CHECK_STUCK_TIMER( l_U4052, 0, 5000 ))) || (CHECK_STUCK_TIMER( l_U4052, 3, 60000 ))) || (CHECK_STUCK_TIMER( l_U4052, 2, 30000 ))) || (CHECK_STUCK_TIMER( l_U4052, 1, 40000 )))
                {
                    CLEAR_PRINTS();
                    CLEAR_HELP();
                    sub_7282();
...
void sub_5569()
{
    ...
    {
        if (((sub_5607( 5, g_U575[I] )) == 1) AND (g_U575[I]._fU20))
        {
...
void sub_14706()
{
    ...
    switch (g_U43104[2])
    {
        ...
        sub_15006( 6 );
        sub_15006( 0 );
        while ((((((((((NOT (HAS_MODEL_LOADED( 675415136 ))) || (NOT (HAS_MODEL_LOADED( 64730935 )))) || (NOT (HAVE_ANIMS_LOADED( "MISSTONY03" )))) || (NOT (HAS_MODEL_LOADED( 996477618 )))) || (NOT (HAS_MODEL_LOADED( 576867354 )))) || (NOT (HAS_MODEL_LOADED( 657888018 )))) || (NOT (HAS_MODEL_LOADED( 1147287684 )))) || (NOT (sub_15578( 6 )))) || (NOT (sub_15578( 0 )))) || (NOT (HAVE_ANIMS_LOADED( "FACIALS@M_LO" ))))
        {
            WAIT( 0 );
        }
        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_6646() );
        ...
        {
            iVar2 = I / 4;
            if ((DOES_VEHICLE_EXIST( l_U4057[iVar2] )) AND (IS_VEH_DRIVEABLE( l_U4057[iVar2] )))
            {
                iVar3 = I mod 4;
                if (iVar3 == 0)
                {
        ...
        while (((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 760 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 761 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 762 ))))
        {
            WAIT( 0 );
        }
        sub_19743( 1, 1 );
        ...
        while ((((((((((((((NOT (HAS_MODEL_LOADED( 675415136 ))) || (NOT (HAS_MODEL_LOADED( 64730935 )))) || (NOT (HAVE_ANIMS_LOADED( "MISSTONY03" )))) || (NOT (HAS_MODEL_LOADED( 996477618 )))) || (NOT (HAS_MODEL_LOADED( 576867354 )))) || (NOT (HAS_MODEL_LOADED( 657888018 )))) || (NOT (HAS_MODEL_LOADED( 1147287684 )))) || (NOT (sub_15578( 6 )))) || (NOT (sub_15578( 0 )))) || (NOT (HAVE_ANIMS_LOADED( "FACIALS@M_LO" )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 750 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( l_U4535[0]._fU0 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( l_U4535[1]._fU0 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( l_U4535[2]._fU0 ))))
        {
            WAIT( 0 );
        }
        CREATE_CAR( 1147287684, l_U3784._fU0, l_U3784._fU4, l_U3784._fU8, ref l_U4052, 1 );
        ...
        TURN_OFF_VEHICLE_EXTRA( l_U4057[2], 1, 1 );
        LOCK_CAR_DOORS( l_U4057[2], 3 );
        if ((g_U42931[2]) AND (iVar8 < 2))
        {
            iVar8++;
            ADD_EXPLOSION( l_U3741[0]._fU0, l_U3741[0]._fU4, l_U3741[0]._fU8, 0, 0.50000000, 0, 1, 0.00000000 );
        }
        WAIT( 1500 );
        sub_27183( ref l_U4264[0]._fU0, 64730935, -633.08720000, -37.07460000, 3.81250000, 72.37400000, 23, 200, 0, 12 );
...
void sub_39321()
{
    ...
    if (((NOT (IS_CHAR_INJURED( l_U3984 ))) AND (NOT (IS_CHAR_INJURED( sub_6646() )))) AND (IS_VEH_DRIVEABLE( l_U4051 )))
    {
        ...
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_6741(), 0 )))
        {
            ...
            {
                if ((sub_54868( sub_6646(), l_U3984 )) || (NOT l_U3809[7]))
                {
                    l_U4202 = 1;
                    BLOCK_CHAR_AMBIENT_ANIMS( sub_6646(), 1 );
                    BLOCK_CHAR_AMBIENT_ANIMS( l_U3984, 1 );
                    if (((NOT (sub_45643( 0 ))) AND (NOT (sub_55034( l_U4204 )))) AND (NOT (sub_11432( l_U4204 ))))
                    {
                        if (NOT l_U3832)
                        {
                            if (g_U43133)
                            ...
                            g_U42928++;
                            if (((NOT g_U43133) AND (g_U42928 > 2)) || ((g_U43133) AND (g_U42928 > 102)))
                            {
                                SAY_AMBIENT_SPEECH( l_U3984, "LISTEN_TO_RADIO", 1, 0, 0 );
                            }
                            l_U3832 = 1;
                        }
                        if ((g_U42928 == 1) || ((g_U43133) AND (g_U42928 == 101)))
                        {
                            if (g_U15811[16])
                            {
                                iVar3 = 0;
                        ...
                        else if ((g_U42928 == 2) || ((g_U43133) AND (g_U42928 == 102)))
                        {
                            iVar3 = 2;
                        }
                        else
        ...
        if (sub_40941( l_U3146[0], l_U3146[1], l_U3146[2], uParam12, uParam13, uParam14, uParam15, l_U3140, uParam17, uParam10, 0, 0 ))
        {
            if (IS_SCREEN_FADED_IN())
            {
                if (IS_CHAR_IN_CAR( sub_6646(), uParam10 ))
                {
                    ...
                    sub_41489( uParam16 );
                    sub_41489( uParam20 );
                    if ((uParam18) AND (IS_WANTED_LEVEL_GREATER( sub_6741(), 0 )))
                    {
                        if ((DOES_BLIP_EXIST( l_U3137 )) || (DOES_BLIP_EXIST( l_U3132 )))
                        {
                        ...
                        if (((NOT (sub_45643( 0 ))) AND (NOT sub_47049())) AND (NOT l_U3106))
                        {
                ...
                else if (((uParam18) AND (IS_WANTED_LEVEL_GREATER( sub_6741(), 0 ))) AND (NOT l_U3121))
                {
                    sub_41489( uParam16 );
                    sub_41489( uParam20 );
                    if ((DOES_BLIP_EXIST( l_U3137 )) || (DOES_BLIP_EXIST( l_U3132 )))
...
void sub_39529()
{
    ...
    for ( I = 0; I < l_U3146; I++ )
    {
        if (DOES_CHAR_EXIST( l_U3146[I] ))
        {
            if (NOT (IS_CHAR_INJURED( l_U3146[I] )))
            {
                if (((IS_CHAR_SITTING_IN_ANY_CAR( l_U3146[I] )) AND (sub_39622( l_U3146[I] ))) AND (sub_39689()))
                {
    ...
    if (IS_PLAYER_PLAYING( sub_6741() ))
    {
        if (NOT (IS_CHAR_INJURED( sub_6646() )))
        {
            if (((IS_CHAR_SITTING_IN_ANY_CAR( sub_6646() )) AND (sub_39622( sub_6646() ))) AND (sub_39689()))
            {
                BLOCK_CHAR_AMBIENT_ANIMS( sub_6646(), 1 );
            }
        }
...
int sub_40941(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, int iParam9, unknown uParam10, unknown uParam11)
{
    ...
    if (((NOT sub_41112()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_6646() ))) AND (NOT (DOES_VEHICLE_EXIST( iParam9 ))))
    {
            ...
            if (NOT (IS_CHAR_INJURED( l_U3146[I] )))
            {
                ...
                if (IS_CHAR_SITTING_IN_ANY_CAR( sub_6646() ))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( iVar26 ))
                    {
                        ...
                        {
                            if ((NOT sub_41112()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_6646() )))
                            {
                ...
                if (((NOT (IS_GROUP_MEMBER( l_U3146[I], sub_41599() ))) AND (NOT (sub_42544( l_U3146[I], iParam9 )))) AND (NOT (sub_42640( l_U3146[I], iParam9 ))))
                {
                ...
                {
                    if (((sub_43595( l_U3146[I] )) || (sub_42544( l_U3146[I], iParam9 ))) || (uParam11))
                    {
                ...
                else if (IS_VEH_DRIVEABLE( iParam9 ))
                {
                    ...
                    {
                        if ((LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U3146[I], iParam9, 20.00000000, 20.00000000, 5.00000000, 0 )) AND (NOT l_U3123))
                        {
                            if (IS_CHAR_SITTING_IN_ANY_CAR( l_U3146[I] ))
                            {
    ...
    if (NOT (sub_45643( 0 )))
    {
        if (iVar15 > 0)
        {
            for ( I = 0; I < 3; I++ )
            {
                if (iVar20[I])
                {
                    if (NOT (IS_CHAR_INJURED( l_U3146[I] )))
                    {
                        if ((sub_41801( l_U3146[I] )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U3146[I], sub_6646(), 40.00000000, 40.00000000, 40.00000000, 0 )))
                        {
                            iVar15--;
                            iVar20[I] = 0;
                        }
        ...
        if (((iVar17 - l_U3143) > 1500) || (iVar16 == 1))
        {
            if (iVar15 > 0)
            {
                if (l_U3144 < iVar15)
                {
                    ...
                    {
                        if ((NOT l_U3112) AND (NOT (l_U3144 == iVar15)))
                        {
                            sub_41369( uParam6, 0 );
                            l_U3112 = 1;
                            l_U3144 = iVar15;
                    ...
                    else
                    {
                        for ( I = 0; I < 3; I++ )
                        {
                            if (iVar20[I])
                            {
                                if ((NOT l_U3113[I]) AND (NOT (l_U3144 == iVar15)))
                                {
        ...
        if (IS_VEH_DRIVEABLE( iVar3 ))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                ...
                if (IS_VEH_DRIVEABLE( iVar4 ))
                {
                    if (iVar3 == iVar4)
                    {
                        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_6646(), uParam0, 20.00000000, 20.00000000, 20.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( uParam0, iVar4, 20.00000000, 20.00000000, 20.00000000, 0 )))
                        {
                            return 1;
                        }
                    }
...
{
    if (((((IS_MESSAGE_BEING_DISPLAYED()) || (((sub_39689()) AND (NOT bParam0)) || ((sub_45668()) AND (bParam0)))) || (sub_45697())) || (IS_SCRIPTED_CONVERSATION_ONGOING())) || (sub_45756()))
    {
        return 1;
    }
    return 0;
...
int sub_47448()
{
    ...
    if (IS_CHAR_SITTING_IN_ANY_CAR( sub_6646() ))
    {
        if ((IS_CHAR_ON_ANY_BIKE( sub_6646() )) || (IS_CHAR_IN_ANY_HELI( sub_6646() )))
        {
            iVar2 = 0;
        }
    }
    if (l_U3124)
    {
        ...
        {
            if ((sub_47538( 1, iVar2 )) || (l_U3118))
            {
                return 1;
            }
        }
    }
    else if ((sub_47538( 1, iVar2 )) || (l_U3118))
    {
        return 1;
    }
    return 0;
...
void sub_52014(boolean bParam0, unknown uParam1)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_6646() ))) AND ((IS_SCREEN_FADED_OUT()) || (bParam0)))
    {
...
void sub_57721()
{
    ...
    switch (l_U4222)
    {
        ...
        if (NOT l_U3791)
        {
            if (TIMERB() > 1000)
            {
                if (l_U3793)
                {
                    ...
                    {
                        if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_55034( l_U4204 ))))
                        {
                            if ((NOT l_U4119[70]) AND (NOT l_U4119[71]))
                            {
                                if (IS_BIT_SET( g_U10938._fU0, 7 ))
                                {
        ...
        {
            if ((NOT l_U4119[9]) AND (l_U4119[8]))
            {
...
void sub_57978()
{
    ...
    sub_15006( 6 );
    sub_15006( 0 );
    while (((((((((((((NOT (HAS_MODEL_LOADED( 1147287684 ))) || (NOT (HAS_MODEL_LOADED( 819995114 )))) || (NOT (HAS_MODEL_LOADED( 1277520569 )))) || (NOT (HAS_MODEL_LOADED( 64730935 )))) || (NOT (HAS_MODEL_LOADED( 657888018 )))) || (NOT (HAS_MODEL_LOADED( 996477618 )))) || (NOT (HAS_MODEL_LOADED( 576867354 )))) || (NOT (HAS_MODEL_LOADED( -411494208 )))) || (NOT (HAVE_ANIMS_LOADED( "FACIALS@M_LO" )))) || (NOT (HAVE_ANIMS_LOADED( "MINI_GOLF" )))) || (NOT (HAVE_ANIMS_LOADED( "MISSTONY03" )))) || (NOT (sub_15578( 6 )))) || (NOT (sub_15578( 0 ))))
    {
        WAIT( 0 );
    }
    if (# -NULL-0xc27c84())
    ...
    sub_21059( 6 );
    sub_13813( 2, l_U3983, "ROCCO", 0 );
    if ((NOT (IS_CHAR_INJURED( l_U3983 ))) AND (NOT (IS_CHAR_INJURED( l_U3985 ))))
    {
    ...
    if ((DOES_VEHICLE_EXIST( l_U4051 )) AND (IS_VEH_DRIVEABLE( l_U4051 )))
    {
        DELETE_CAR( ref l_U4051 );
    }
...
void sub_61139()
{
    ...
    if (((IS_VEH_DRIVEABLE( l_U4052 )) AND (NOT (IS_CHAR_INJURED( l_U3985 )))) AND (NOT (IS_CHAR_INJURED( l_U3983 ))))
    {
...
void sub_62859()
{
    ...
    else if (l_U4228 == 0)
    {
        ...
        if (((iVar7 > 110) AND (l_U3883 == 0)) || (((IS_CONTROL_JUST_PRESSED( 2, 1 )) || (IS_CONTROL_JUST_PRESSED( 2, 137 ))) AND (l_U3883 == 1)))
        {
            if (l_U3805)
            {
                l_U3936 = 0.00000000;
    ...
    {
        if (((iVar7 < -10) AND (l_U3883 == 0)) || ((((IS_CONTROL_JUST_PRESSED( 0, 1 )) || (IS_CONTROL_JUST_PRESSED( 0, 137 ))) AND (l_U3883 == 1)) AND (l_U3884 == -1)))
        {
            CLEAR_HELP();
            CLEAR_PRINTS();
            if (l_U3805)
        ...
        if ((((iVar7 < 110) AND (l_U3857 < 110)) AND (l_U3883 == 0)) || (((l_U3936 == 0.00000000) AND (l_U3884 == -1)) AND (l_U3883 == 1)))
        {
            l_U4228 = 3;
        }
    };;;
    if (((l_U3805) AND (l_U4222 != 2)) AND (NOT IS_SCREEN_FADING()))
    {
        sub_68650();
    }
    l_U3857 = iVar7;
...
void sub_64302()
{
    ...
    switch (l_U4234)
    {
        ...
        if (iVar3 > 0)
        {
            ...
            if (((ABSF( fVar8 - l_U3953 )) > 0.00500000) || ((ABSI( iVar3 - l_U3885 )) > 10))
            {
...
void sub_65297()
{
    ...
    if (l_U3851 != -1)
    {
        if ((NOT l_U3796) AND (NOT l_U3797))
        {
...
void sub_65732(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((uParam0._fU8 - uVar15) > 0.20000000)
    {
        ...
        else if ((uParam0._fU4 > 5.90000000) || (uParam0._fU4 < -32.50000000))
        {
            Result = 4;
        }
        else if ((uParam0._fU4 > l_U3924) || (uParam0._fU4 < l_U3923))
        {
            Result = 5;
        };;;;
    }
...
void sub_72619()
{
    ...
    if ((sub_56753()) AND (l_U3796))
    {
        l_U4223 = 3;
    }
    sub_62924();
    if (((l_U4223 != 2) AND (l_U4223 != 3)) AND (l_U4223 != 4))
    {
        sub_65297();
    }
    switch (l_U4223)
    {
        ...
        if (NOT l_U3796)
        {
            if (DOES_OBJECT_EXIST( l_U3988 ))
            {
                if (NOT (HAS_OBJECT_COLLIDED_WITH_ANYTHING( l_U3988 )))
                {
                    if ((TIMERA() > 2500) AND (NOT l_U3795))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U3985 )))
                        {
                            GET_CHAR_COORDINATES( l_U3985, ref uVar3._fU0, ref uVar3._fU4, ref uVar3._fU8 );
                        ...
                        if (NOT sub_73000())
                        {
                            if (((sub_54615( uVar3, l_U3964, 1, 1 )) < 3.00000000) || ((l_U3852 >= 2) AND ((sub_54615( uVar3, l_U3964, 1, 1 )) < 5.00000000)))
                            {
                                GET_OBJECT_VELOCITY( l_U3988, ref l_U3955._fU0, ref l_U3955._fU4, ref l_U3955._fU8 );
        ...
        if (((l_U3796) AND (TIMERB() > 3000)) || (TIMERA() > 10000))
        {
            l_U4223 = 4;
        }
        break;
        ...
        if (NOT l_U3796)
        {
            if (DOES_OBJECT_EXIST( l_U3988 ))
            {
                ...
                {
                    if (((l_U3955._fU0 == 0.00000000) AND (l_U3955._fU4 == 0.00000000)) AND (l_U3955._fU8 == 0.00000000))
                    {
        ...
        {
            if (((HAS_CHAR_ANIM_FINISHED( l_U3985, "FACIALS@M_LO", "Pain_A" )) || (HAS_CHAR_ANIM_FINISHED( l_U3985, "FACIALS@M_LO", "Pain_B" ))) || (HAS_CHAR_ANIM_FINISHED( l_U3985, "FACIALS@M_LO", "Pain_C" )))
            {
                TASK_PLAY_ANIM_FACIAL( l_U3985, "Mood_Scared", "FACIALS@M_LO", 4.00000000, 1, 0, -1 );
            }
        }
        if (l_U3796)
        {
            ...
            else if (l_U3852 == 3)
            {
                ...
                vVar33 = {-718.32010000, -10.94672000, 5.17598300};
        ...
        if (((((l_U3852 < 3) AND (l_U4119[iVar29])) || ((l_U3852 >= 3) AND (l_U4119[iVar27]))) AND (NOT sub_39689())) AND ((l_U3796) AND (TIMERB() > 5000)))
        {
            l_U4223 = 4;
        }
        break;
        ...
        SWITCH_STREAMING( 1 );
        if ((IS_VEH_DRIVEABLE( l_U4052 )) AND (l_U3793))
        {
        ...
        if (l_U3852 < 3)
        {
            ...
            l_U4228 = 0;
            SETTIMERB( 0 );
            if ((NOT (DOES_BLIP_EXIST( l_U3977 ))) AND (NOT (IS_CHAR_INJURED( l_U3985 ))))
            {
                ADD_BLIP_FOR_CHAR( l_U3985, ref l_U3977 );
                sub_21292( l_U3977 );
            }
...
void sub_78604(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U32)
    {
        ...
        if ((l_U1211 == 0) || (IS_SCREEN_FADED_OUT()))
        {
            iVar10 = 1;
        }
        if ((iVar10) AND (NOT l_U54))
        {
            if (NOT l_U20)
            {
...
void sub_80776(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 150; I++ )
        {
            ...
            if (l_U1382[I] == 0)
            {
                if (((l_U1231[I] > 0) AND (l_U1231[I] < 3000)) AND (NOT (l_U1653[I] == 0)))
                {
                    if (NOT l_U20)
                    {
            ...
            if (l_U1382[I] == 2)
            {
                if (HAS_MODEL_LOADED( l_U1653[I] ))
                {
                    if (NOT (DOES_VEHICLE_EXIST( l_U2577[I] )))
                    {
                        ...
                        {
                            bVar17 = false;
                            if ((NOT (sub_80307( l_U1881[I], 5.00000000, 1120403456 ))) AND (NOT (sub_82108( l_U1881[I] ))))
                            {
                                bVar17 = true;
                            }
                            if (l_U46)
                        ...
                        if (8 > l_U1636)
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1231[I] ))
                            {
                                if (fVar14 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1231[I] )))
                                {
                                    ...
                                    if ((NOT (sub_80307( uVar8, 5.00000000, 1120403456 ))) AND (sub_80307( uVar11, 5.00000000, 1120403456 )))
                                    {
                                        sub_81174( I, 1090519040 );
                                    }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2577[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_6741() ))
                                {
                                    if ((((IS_CHAR_TOUCHING_VEHICLE( sub_6646(), l_U2577[I] )) AND (NOT l_U26)) AND (NOT l_U23)) AND (NOT l_U35))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_6646() ))
                                        {
                                            bVar16 = false;
                                    ...
                                    else if ((sub_84648( uParam0, l_U2577[I] )) AND (NOT l_U35))
                                    {
                                        sub_84521( l_U2577[I] );
                                        l_U1382[I]++;
                                    }
        ...
        if (IS_PLAYER_PLAYING( sub_6741() ))
        {
            ...
            for ( I = 0; I < 150; I++ )
            {
                ...
                if (DOES_VEHICLE_EXIST( l_U2577[I] ))
                {
                    if (IS_VEH_DRIVEABLE( l_U2577[I] ))
                    {
                        if ((sub_86098( l_U2577[I], (uParam0^) )) || (sub_86098( l_U2577[I], uVar6 )))
                        {
            ...
            if (l_U1585[I] == 1)
            {
                if (6 > l_U1639)
                {
                    if (HAS_MODEL_LOADED( l_U1804[I] ))
                    {
                        ...
                        {
                            if (((NOT (sub_80307( l_U2332[I], 5.00000000, 1120403456 ))) || (l_U20)) || (l_U46))
                            {
                                if (l_U39)
                                {
...
void sub_87952(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 25; I++ )
        {
            if (((l_U1533[I] > 0) AND (l_U1533[I] < 3000)) AND (NOT (l_U1855[I] == 0)))
            {
                if (l_U1559[I] == 0)
                {
                    if (NOT l_U20)
                ...
                if (l_U1559[I] == 2)
                {
                    if (HAS_MODEL_LOADED( l_U1855[I] ))
                    {
                        if (NOT (DOES_VEHICLE_EXIST( l_U2788[I] )))
                        {
                            ...
                            if (bVar15)
                            {
                                if ((NOT (sub_80307( l_U2483[I], 5.00000000, 1120403456 ))) || (l_U46))
                                {
                            ...
                            if (4 > l_U1638)
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1533[I] ))
                                {
                                    if (fVar13 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1533[I] )))
                                    {
                                        ...
                                        if (((NOT (sub_80307( uVar7, 5.00000000, 1120403456 ))) AND (sub_80307( uVar10, 5.00000000, 1120403456 ))) AND (NOT l_U46))
                                        {
                                            l_U1638++;
                                            l_U1559[I]++;
                                        }
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2788[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_6741() ))
                                    {
                                        if ((((IS_CHAR_TOUCHING_VEHICLE( sub_6646(), l_U2788[I] )) AND (NOT l_U26)) AND (NOT l_U23)) AND (NOT l_U56))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_6646() ))
                                            {
                                                bVar15 = false;
...
int sub_91693(unknown uParam0, unknown uParam1)
{
    ...
    sub_87004( (uParam0^) );
    if (((l_U1650 == 0) AND (l_U1651 == 0)) AND (l_U1652 == 0))
    {
        l_U23 = 0;
        l_U20 = 0;
        l_U49 = 0;
...
void sub_92160()
{
    ...
    switch (l_U4224)
    {
        ...
        REQUEST_MODEL( 996477618 );
        REQUEST_MODEL( 576867354 );
        while ((NOT (HAS_MODEL_LOADED( 996477618 ))) || (NOT (HAS_MODEL_LOADED( 576867354 ))))
        {
            WAIT( 0 );
        }
        ...
        REQUEST_MODEL( 675415136 );
        REQUEST_MODEL( 64730935 );
        while ((NOT (HAS_MODEL_LOADED( 675415136 ))) || (NOT (HAS_MODEL_LOADED( 64730935 ))))
        {
            WAIT( 0 );
        }
        CREATE_CAR( 675415136, l_U3738._fU0, l_U3738._fU4, l_U3738._fU8, ref l_U4057[0], 1 );
        ...
        for ( I = 0; I < l_U4365; I++ )
        {
            ...
            if ((DOES_VEHICLE_EXIST( l_U4057[iVar2] )) AND (IS_VEH_DRIVEABLE( l_U4057[iVar2] )))
            {
                ...
                SET_CHAR_WILL_USE_CARS_IN_COMBAT( l_U4365[I]._fU0, 0 );
                if ((I == 1) AND (NOT (IS_CHAR_INJURED( l_U3983 ))))
                {
                    TASK_DRIVE_BY( l_U4365[I]._fU0, l_U3983, 0, 0.00000000, 0.00000000, 0.00000000, 100.00000000, 8, 0, 50 );
                }
            }
        ...
        while (((((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 760 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 761 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 762 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 745 )))) || (NOT (HAS_MODEL_LOADED( 240192349 ))))
        {
            WAIT( 0 );
        }
        sub_19743( 1, 1 );
        ...
        {
            case 0:
            if ((l_U4119[21]) AND (NOT l_U4119[19]))
            {
                if (NOT (sub_55034( l_U4204 )))
                {
            ...
            if ((l_U4119[19]) AND (NOT (sub_55034( l_U4204 ))))
            {
                CLEAR_PRINTS();
                if ((NOT (IS_CHAR_INJURED( l_U4365[1]._fU0 ))) AND (IS_VEH_DRIVEABLE( l_U4057[0] )))
                {
            ...
            if (TIMERB() > 7400)
            {
                if ((NOT (IS_CHAR_INJURED( l_U4365[1]._fU0 ))) AND (NOT (IS_CHAR_INJURED( l_U3983 ))))
                {
            ...
            if (TIMERB() > 9250)
            {
                ...
                for ( I = 0; I < l_U4365; I++ )
                {
                    if ((I mod 4) != 0)
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U4365[I]._fU0 ))) AND (NOT (IS_CHAR_INJURED( l_U3983 ))))
                        {
                            TASK_DRIVE_BY( l_U4365[I]._fU0, l_U3983, 0, 0.00000000, 0.00000000, 0.00000000, 100.00000000, 8, 0, 50 );
                        }
                    }
                ...
                UNPOINT_CAM( l_U4066 );
                SET_CAM_POS( l_U4066, -705.57140000, -8.58081000, 4.59641600 );
            ...
            if (TIMERB() > 11250)
            {
                ...
                SET_CAM_POS( l_U4068, -702.21470000, -50.72452000, 5.52150100 );
            ...
            else if (TIMERB() > 16000)
            {
                ...
                SET_CAM_ROT( l_U4066, 2.52098700, 0.00000000, 88.57806000 );
                SET_CAM_FOV( l_U4066, 16.20007000 );
                SET_CAM_POS( l_U4068, -671.07320000, -16.16854000, 4.52989500 );
                SET_CAM_ROT( l_U4068, 2.52098700, 0.00000000, 88.57806000 );
...
void sub_102065()
{
    ...
    if (l_U3809[8])
    {
        ...
        if (NOT l_U3850)
        {
            if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())) AND (IS_CHAR_SHOOTING( sub_6646() )))
            {
    ...
    if ((((IS_VEH_DRIVEABLE( l_U4052 )) AND (IS_VEH_DRIVEABLE( l_U4053 ))) AND (NOT (IS_CHAR_INJURED( l_U3983 )))) AND (NOT (IS_CHAR_INJURED( l_U3984 ))))
    {
        switch (l_U4226)
        {
            case 3:
            if ((NOT l_U3809[8]) AND (l_U4119[26]))
            {
                if ((NOT (sub_45643( 0 ))) AND (NOT (sub_55034( l_U4204 ))))
                {
            ...
            if (((uVar11._fU8 < 7.00000000) AND (uVar11._fU0 < (l_U3940 + 3.00000000))) AND (NOT (IS_CHAR_IN_AIR( sub_6646() ))))
            {
                CLEAR_PRINTS();
                sub_7282();
                sub_11417( 1 );
            ...
            else if (NOT l_U3809[4])
            {
                if (l_U4119[27])
                {
                    ...
                    else if ((NOT (sub_45643( 0 ))) AND (NOT (sub_55034( l_U4204 ))))
                    {
            ...
            if (NOT l_U4235[0]._fU8)
            {
                if (IS_CHAR_IN_ANY_CAR( sub_6646() ))
                {
                    ...
                    {
                        sub_27183( ref l_U4235[0]._fU0, 64730935, -633.08720000, -37.07460000, 3.81250000, 72.37400000, 23, 200, 0, 12 );
            ...
            if (IS_VEH_DRIVEABLE( l_U4053 ))
            {
                if (IS_CHAR_IN_CAR( sub_6646(), l_U4053 ))
                {
                    if (IS_CHAR_IN_CAR( l_U3984, l_U4053 ))
                    {
                        ...
                        {
                            if ((HAS_MODEL_LOADED( 64730935 )) AND (HAS_CAR_RECORDING_BEEN_LOADED( 750 )))
                            {
                    ...
                    if (((((NOT l_U3809[5]) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( l_U3984 )))) AND (l_U4119[31])) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_55034( l_U4204 ))))
                    {
                        CLEAR_PRINTS();
                ...
                else if ((NOT l_U3809[1]) AND (l_U4119[31]))
                {
                    if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_55034( l_U4204 ))))
                    {
    ...
    sub_110622( uVar11 );
    if ((l_U4226 == 3) || (l_U4226 == 4))
    {
        if (((((NOT (sub_45643( 0 ))) AND (sub_111064())) AND (NOT l_U3825)) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U3983 )))) AND (sub_112620( uVar11 )))
        {
        ...
        if ((((NOT (sub_45643( 0 ))) AND (sub_111064())) AND (NOT l_U3825)) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( sub_6646() ))))
        {
            if (((iVar6 - l_U3881) > 7000) AND (sub_113463()))
            {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U3985 ))) AND (NOT l_U3823))
    {
        if ((sub_54530( sub_6646(), l_U3985, 1, 0 )) < 2500.00000000)
        {
            if (((NOT (sub_45643( 0 ))) AND (sub_111064())) AND (NOT l_U3825))
            {
    ...
    if (l_U4226 != 2)
    {
        for ( I = 0; I < l_U4365; I++ )
        {
            ...
            if (l_U4365[I]._fU8)
            {
                if ((NOT (IS_CHAR_INJURED( l_U4365[I]._fU0 ))) AND (l_U4365[I]._fU20 == 0))
                {
                    if (IS_VEH_DRIVEABLE( l_U4057[iVar5] ))
                    {
                        if (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U4057[iVar5] )))
                        {
                            if (l_U3865[iVar5] != 0)
                            {
                                ...
                                {
                                    if ((IS_CHAR_SITTING_IN_CAR( l_U4365[I]._fU0, l_U4057[iVar5] )) AND (NOT (IS_CHAR_INJURED( l_U3983 ))))
                                    {
    ...
    for ( I = 0; I < l_U4057; I++ )
    {
        if (NOT l_U3835[I])
        {
            if (IS_VEH_DRIVEABLE( l_U4057[I] ))
            {
                ...
                if ((iVar3 == 0) AND (IS_CHAR_INJURED( uVar4 )))
                {
                    iVar6 = 0;
...
void sub_110622(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((NOT (IS_CHAR_INJURED( l_U3984 ))) AND (IS_VEH_DRIVEABLE( l_U4053 )))
    {
        ...
        switch (l_U4229)
        {
            ...
            if ((((((sub_111064()) AND (NOT (sub_55034( l_U4204 )))) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND ((iVar9 - l_U3870) > 8000)) || ((((NOT (sub_55034( l_U4204 ))) AND (NOT l_U3840)) AND (uParam0._fU0 > -635.70000000)) AND (uParam0._fU8 > 12.00000000))) AND (NOT l_U3825))
            {
                GET_GAME_TIMER( ref l_U3870 );
                ...
                if (((NOT l_U3840) AND (uParam0._fU0 > -635.70000000)) AND (uParam0._fU8 > 12.00000000))
                {
                    CLEAR_PRINTS();
            ...
            if ((uParam0._fU0 > (l_U3940 + 1.00000000)) AND (uParam0._fU8 < 11.60000000))
            {
                CLEAR_CHAR_TASKS_IMMEDIATELY( l_U3984 );
                if (NOT (IS_PED_IN_GROUP( l_U3984 )))
                {
            ...
            else if (((uVar11._fU8 - uParam0._fU8) < 2.00000000) AND (uParam0._fU8 > 5.50000000))
            {
                ...
                else if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_55034( l_U4204 )))) AND (sub_111064()))
                {
            ...
            break;
            case 3:
            if ((((NOT (sub_45643( 0 ))) AND (sub_111064())) AND (NOT l_U3825)) AND (sub_112620( uParam0 )))
            {
            ...
            if (iVar14 != 1)
            {
                if ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( l_U3984 ))) AND (NOT (IS_CHAR_IN_CAR( l_U3984, l_U4053 ))))
                {
                    TASK_ENTER_CAR_AS_PASSENGER( l_U3984, l_U4053, -2, 0 );
                }
            }
...
int sub_111064()
{
    if (((((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_55034( l_U4204 )))) AND (NOT (sub_11432( l_U4204 )))) AND (l_U4119[l_U4118]))
    {
        return 1;
    }
    return 0;
...
{
    if ((((uParam0._fU0 > -632.00000000) || (uParam0._fU0 < -832.00000000)) || (uParam0._fU4 < -41.00000000)) || (uParam0._fU4 > 13.00000000))
    {
        return 0;
    }
    return 1;
...
int sub_113463()
{
    ...
    for ( I = 0; I < l_U4365; I++ )
    {
        if (NOT (IS_CHAR_INJURED( l_U4365[I]._fU0 )))
        {
            if (((IS_PLAYER_TARGETTING_CHAR( sub_6741(), l_U4365[I]._fU0 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_6741(), l_U4365[I]._fU0 ))) AND (IS_CHAR_SHOOTING( sub_6646() )))
            {
                return 1;
            }
        }
...
void sub_114708()
{
    ...
    if ((NOT (IS_VEH_DRIVEABLE( l_U4053 ))) || (NOT (sub_117915( l_U4053 ))))
    {
        if (NOT l_U3824)
        {
            CLEAR_PRINTS();
    ...
    sub_118119();
    if (((IS_VEH_DRIVEABLE( l_U4052 )) AND (NOT (IS_CHAR_INJURED( l_U3983 )))) AND (NOT (IS_CHAR_INJURED( l_U3984 ))))
    {
        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U4052 ))
        {
            if (NOT (IS_CHAR_IN_CAR( l_U3983, l_U4052 )))
            ...
            if (NOT l_U3798)
            {
                if ((fVar7 > 5000) AND (NOT (sub_122700( ref l_U4365 ))))
                {
                    I = 0;
                    iVar3 = 0;
                    iVar4 = 0;
                    ...
                    for ( I = 0; I < l_U4365; I++ )
                    {
                        ...
                        if ((iVar3 != 0) AND (NOT l_U4535[iVar3]._fU4))
                        {
            ...
            {
                GET_CHAR_COORDINATES( sub_6646(), ref uVar8._fU0, ref uVar8._fU4, ref uVar8._fU8 );
                if ((fVar7 > 7000) AND (uVar8._fU0 < -725.00000000))
                {
                    sub_123311();
                    l_U3842 = 1;
                }
                        ...
                        if (I != 0)
                        {
                            if (NOT l_U4535[I]._fU4)
                            {
                                if (fVar7 > l_U4535[I]._fU8)
                                {
                                    ...
                                    {
                                        if ((HAS_CAR_RECORDING_BEEN_LOADED( l_U4535[I]._fU0 )) AND (HAS_MODEL_LOADED( 64730935 )))
                                        {
                                            bVar14 = false;
                                            if (I == 0)
                                            {
                                                if ((l_U4535[2]._fU4) AND ((iVar5 - l_U4535[2]._fU12) > 2000))
                                                {
                                                    bVar14 = true;
                                                }
                                            }
                                            ...
                                            {
                                                if ((l_U4535[1]._fU4) AND ((iVar5 - l_U4535[1]._fU12) > 2000))
                                                {
                                                    bVar14 = true;
                                                }
                                            }
                            ...
                            {
                                if ((IS_CHAR_IN_CAR( sub_6646(), l_U4053 )) AND (IS_CHAR_IN_CAR( l_U3984, l_U4053 )))
                                {
                                    if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_55034( l_U4204 )))) AND (NOT l_U3825))
                                    {
                                        if (NOT l_U4119[37])
                                        {
        ...
        if (fVar20 < 625.00000000)
        {
            ...
            if ((IS_VEH_DRIVEABLE( l_U4053 )) AND (IS_VEH_DRIVEABLE( l_U4052 )))
            {
                if (IS_CHAR_IN_CAR( sub_6646(), l_U4053 ))
                {
                    if (IS_CHAR_IN_CAR( l_U3984, l_U4053 ))
                    {
                        if ((((NOT l_U3809[10]) AND (NOT (sub_55034( l_U4204 )))) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (l_U4119[33]))
                        {
                            PRINT_NOW( "T3_FOLLOW", 7500, 0 );
                            l_U3809[10] = 1;
                            l_U3825 = 1;
                        ...
                        if (NOT (DOES_BLIP_EXIST( l_U3981 )))
                        {
                            ...
                            if (((sub_54615( uVar21, -397.00920000, -458.35370000, 3.76980000, 1, 1 )) < 5.00000000) AND (((l_U3723._fU0 == 0.00000000) AND ((sub_54530( l_U3983, sub_6646(), 1, 0 )) < 1600.00000000)) || (l_U3723._fU0 != 0.00000000)))
                            {
                                sub_7282();
                                CLEAR_PRINTS();
                        ...
                        if ((NOT (DOES_BLIP_EXIST( l_U3979 ))) AND (NOT (DOES_BLIP_EXIST( l_U3981 ))))
                        {
                            sub_7282();
                            CLEAR_PRINTS();
                            ADD_BLIP_FOR_CHAR( l_U3983, ref l_U3979 );
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U4052 ))
                        {
                            if ((l_U4535[1]._fU20) AND (NOT l_U4535[1]._fU28))
                            {
                                if (l_U4535[1]._fU4)
                                {
                                    if ((NOT l_U4119[35]) || (NOT l_U4119[36]))
                                    {
                                ...
                                if (NOT l_U4119[36])
                                {
                                    if ((l_U4535[2]._fU20) AND (NOT l_U4535[2]._fU4))
                                    {
                                        l_U4119[36] = 1;
                                        l_U4535[1]._fU28 = 1;
                                    }
                            ...
                            if ((l_U4535[2]._fU20) AND (NOT l_U4535[2]._fU28))
                            {
                                if (l_U4535[2]._fU4)
                                {
                                    if ((NOT l_U4119[35]) || (NOT l_U4119[36]))
                                ...
                                if (NOT l_U4119[36])
                                {
                                    if ((l_U4535[1]._fU20) AND (NOT l_U4535[1]._fU4))
                                    {
                                        l_U4119[36] = 1;
                                        l_U4535[2]._fU28 = 1;
                                    }
                            ...
                            if (((l_U4535[1]._fU28) AND (l_U4535[2]._fU28)) || ((l_U4535[1]._fU24) AND (l_U4535[2]._fU24)))
                            {
                                if (NOT l_U4119[38])
                                {
                                    if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_55034( l_U4204 ))))
                                    {
                                        if (((sub_54615( uVar8, -396.34050000, -457.96970000, 3.77010000, 1, 0 )) < 6000.00000000) AND (NOT l_U3825))
                                        {
                            ...
                            if (((NOT (sub_45643( 0 ))) AND (sub_111064())) AND (NOT l_U3825))
                            {
                                ...
                                else if (NOT l_U4119[38])
                                {
                                    if ((iVar5 - l_U3879) > 10000)
                                    {
                                        ...
                                        while ((l_U4214[l_U3871]) AND (iVar27 < 50))
                                        {
                                            GENERATE_RANDOM_INT_IN_RANGE( 0, 4, ref l_U3871 );
                                            iVar27++;
                                        }
                        ...
                        {
                            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_6646(), l_U3723._fU0, l_U3723._fU4, l_U3723._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (IS_CHAR_SITTING_IN_CAR( sub_6646(), l_U4053 )))
                            {
                                sub_7282();
                                CLEAR_PRINTS();
                                SET_PLAYER_CONTROL( sub_6741(), 0 );
                    ...
                    else if (NOT (DOES_BLIP_EXIST( l_U3978 )))
                    {
                        ...
                        SET_BLIP_AS_FRIENDLY( l_U3978, 1 );
                        sub_21292( l_U3978 );
                        if ((NOT l_U3809[5]) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( l_U3984 ))))
                        {
                            CLEAR_PRINTS();
                            PRINT_NOW( "T3_WAIT", 7500, 0 );
                            l_U3809[5] = 1;
        ...
        else if (NOT (DOES_BLIP_EXIST( l_U3978 )))
        {
            ...
            SET_BLIP_AS_FRIENDLY( l_U3978, 1 );
            sub_21292( l_U3978 );
            if ((NOT l_U3809[6]) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( l_U3984 ))))
            {
                CLEAR_PRINTS();
    ...
    for ( I = 0; I < l_U4365; I++ )
    {
        if (NOT (IS_CHAR_INJURED( l_U4365[I]._fU0 )))
        {
            if ((NOT (IS_PED_IN_COMBAT( l_U4365[I]._fU0 ))) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U4365[I]._fU0 ))))
            {
                TASK_COMBAT( l_U4365[I]._fU0, sub_6646() );
            }
        }
    ...
    for ( I = 0; I < l_U4450; I++ )
    {
        if (NOT (IS_CHAR_INJURED( l_U4450[I]._fU0 )))
        {
            if ((NOT (IS_PED_IN_COMBAT( l_U4450[I]._fU0 ))) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U4450[I]._fU0 ))))
            {
...
int sub_117915(unknown uParam0)
{
    if (DOES_VEHICLE_EXIST( uParam0 ))
    {
        if (((((IS_VEH_DRIVEABLE( uParam0 )) AND (NOT (CHECK_STUCK_TIMER( uParam0, 0, 5000 )))) AND (NOT (CHECK_STUCK_TIMER( uParam0, 3, 60000 )))) AND (NOT (CHECK_STUCK_TIMER( uParam0, 2, 30000 )))) AND (NOT (CHECK_STUCK_TIMER( uParam0, 1, 40000 ))))
        {
            return 1;
        }
    }
        ...
        if (IS_CHAR_IN_CAR( l_U3984, l_U4053 ))
        {
            ...
            for ( I = 0; I < l_U4365; I++ )
            {
                if (NOT (IS_CHAR_INJURED( l_U4365[I]._fU0 )))
                {
                    ...
                    {
                        if ((fVar4 == 0.00000000) || (fVar7 < fVar4))
                        {
                            uVar3 = l_U4365[I]._fU0;
                            fVar4 = fVar7;
                        }
...
void sub_121726(unknown uParam0)
{
    ...
    if ((l_U3033) AND (IS_HINT_RUNNING()))
    {
        iVar4 = 0;
        GET_GAME_TIMER( ref iVar4 );
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_6646() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_121894())) AND (iVar3 != 4))
    {
    ...
    {
        if ((NOT l_U3032) AND (NOT l_U3033))
        {
            if (l_U3035)
            {
                PRINTNL();
...
void sub_123311()
{
    ...
    if (((iVar3[0]) AND (iVar3[1])) AND (NOT iVar3[2]))
    {
        uVar2 = l_U4057[0];
        l_U4057[0] = l_U4057[2];
        l_U4057[2] = uVar2;
    ...
    else if (((iVar3[0]) AND (NOT iVar3[1])) AND (NOT iVar3[2]))
    {
        uVar2 = l_U4057[0];
        l_U4057[0] = l_U4057[1];
        l_U4057[1] = uVar2;
    ...
    else if (((iVar3[0]) AND (NOT iVar3[1])) AND (iVar3[2]))
    {
        uVar2 = l_U4057[0];
        l_U4057[0] = l_U4057[1];
        l_U4057[1] = uVar2;
    ...
    else if (((NOT iVar3[0]) AND (NOT iVar3[1])) AND (iVar3[2]))
    {
        uVar2 = l_U4057[2];
        l_U4057[2] = l_U4057[1];
        l_U4057[1] = uVar2;
...
void sub_126252(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( l_U4057[uParam0] ))
    {
        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U4057[uParam0] ))
        {
            ...
            if ((NOT l_U3803) AND (sub_126476( ref l_U4057[uParam0] )))
            {
        ...
        if (((l_U4535[uParam0]._fU16) AND (NOT l_U4535[uParam0]._fU20)) AND (NOT l_U4535[uParam0]._fU24))
        {
            if ((NOT (HAS_CAR_RECORDING_BEEN_LOADED( l_U4535[1]._fU0 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( l_U4535[2]._fU0 ))))
            {
                REQUEST_CAR_RECORDING( l_U4535[1]._fU0 );
                REQUEST_CAR_RECORDING( l_U4535[2]._fU0 );
            }
    ...
    bVar12 = false;
    if ((l_U4535[uParam0]._fU20) || (l_U4535[uParam0]._fU16))
    {
        if (IS_VEH_DRIVEABLE( l_U4057[uParam0] ))
        {
...
int sub_126476(unknown uParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( (uParam0^) ))
    {
        ...
        if ((((ABSF( uVar14 - uVar9 )) < 15.00000000) AND ((sub_54615( vVar3, vVar6, 1, 1 )) < 20.00000000)) AND (fVar10 > 2.00000000))
        {
            return 1;
        }
    }
...
void sub_131784()
{
    ...
    switch (l_U4230)
    {
        ...
        if ((IS_VEH_DRIVEABLE( l_U4053 )) AND (IS_VEH_DRIVEABLE( l_U4052 )))
        {
            if (((IS_CHAR_IN_CAR( sub_6646(), l_U4053 )) AND (NOT (IS_CHAR_INJURED( l_U3984 )))) AND (NOT (IS_CHAR_INJURED( l_U3983 ))))
            {
        ...
        SET_CAM_ROT( l_U4067, -0.86495100, 0.00000000, 155.09410000 );
        SET_CAM_FOV( l_U4067, 21.60006000 );
        CREATE_CAM( 14, ref l_U4068 );
        SET_CAM_POS( l_U4068, -395.17740000, -455.83860000, 5.12211300 );
        SET_CAM_ROT( l_U4068, -0.86495100, 0.00000000, 155.09410000 );
        ...
        BLOCK_CHAR_AMBIENT_ANIMS( sub_6646(), 1 );
        if (((((NOT l_U3823) AND (NOT sub_45668())) AND (TIMERB() > 21000)) || ((l_U3823) AND (TIMERB() > 21000))) || (sub_56753()))
        {
            sub_11417( 1 );
            if (NOT IS_SCREEN_FADED_OUT())
            {
    ...
    if (NOT (IS_CHAR_INJURED( l_U3984 )))
    {
        ...
        if (fVar2 < 25.00000000)
        {
            ...
            if (NOT (IS_WANTED_LEVEL_GREATER( sub_6741(), 0 )))
            {
                ...
                if ((sub_54868( sub_6646(), l_U3984 )) || (NOT l_U3809[9]))
                {
                    l_U4202 = 1;
                    BLOCK_CHAR_AMBIENT_ANIMS( sub_6646(), 1 );
                    BLOCK_CHAR_AMBIENT_ANIMS( l_U3984, 1 );
                    if (NOT l_U3809[9])
                    {
                        if (l_U4119[45])
                        {
                            if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_55034( l_U4204 ))))
                            {
                    ...
                    else if ((((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_55034( l_U4204 )))) AND (NOT (sub_11432( l_U4204 ))))
                    {
                        if (NOT l_U3833)
                        {
                            if (g_U43133)
                            ...
                            g_U42929++;
                            if (((NOT g_U43133) AND (g_U42929 > 2)) || ((g_U43133) AND (g_U42929 > 102)))
                            {
                                SAY_AMBIENT_SPEECH( l_U3984, "LISTEN_TO_RADIO", 1, 0, 0 );
                            }
                            l_U3833 = 1;
                        }
                        if ((g_U42929 == 1) || ((g_U43133) AND (g_U42929 == 101)))
                        {
                            iVar3 = 0;
                        }
                        else if ((g_U42929 == 2) || ((g_U43133) AND (g_U42929 == 102)))
                        {
                            iVar3 = 1;
                        }
                        else
...
void sub_139372()
{
    ...
    {
        case 0:
        if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())) AND (sub_47538( 1, 1 )))
        {
            SET_PLAYER_CONTROL( sub_6741(), 0 );
            SET_CAR_DENSITY_MULTIPLIER( 0.00000000 );
            SET_PED_DENSITY_MULTIPLIER( 0.00000000 );
            ...
            if (NOT (IS_CHAR_INJURED( l_U3984 )))
            {
                ...
                if (IS_CHAR_IN_ANY_CAR( l_U3984 ))
                {
                    WARP_CHAR_FROM_CAR_TO_COORD( l_U3984, -87.92940000, -226.74310000, 12.97200000 );
                }
                else
                {
                    SET_CHAR_COORDINATES( l_U3984, -87.92940000, -226.74310000, 12.97200000 );
                }
                ...
                SET_CAM_ROT( l_U4067, -0.74339100, 0.00000000, -57.75100000 );
                SET_CAM_FOV( l_U4067, 23.10006000 );
                CREATE_CAM( 14, ref l_U4068 );
                SET_CAM_POS( l_U4068, -90.85885000, -229.12810000, 14.38606000 );
                SET_CAM_ROT( l_U4068, -0.74339100, -0.00000000, -49.04203000 );
        ...
        switch (l_U3877)
        {
            ...
            if (l_U3878 == 0)
            {
                ...
                {
                    vVar7 = {-87.22920000, -227.11520000, 12.91660000};
            ...
            if (((NOT g_U15811[16]) AND (TIMERB() > 7000)) || ((g_U15811[16]) AND (TIMERB() > 8000)))
            {
            ...
            break;
            case 1:
            if ((((l_U3878 == 1) AND (TIMERB() > 10000)) || (l_U3878 == 2)) AND (NOT sub_39689()))
            {
                if (NOT (IS_CHAR_INJURED( l_U3984 )))
                {
                    if (l_U3878 == 1)
                    ...
                    else if (l_U3878 == 2)
                    {
                        ...
                        {
                            sub_56223( l_U4069, 0 );
                            SET_CAM_POS( l_U4067, -73.73804000, -225.80680000, 14.10855000 );
                            SET_CAM_ROT( l_U4067, 2.57976600, 0.00000000, 89.13313000 );
                            SET_CAM_FOV( l_U4067, 23.10006000 );
                            SET_CAM_POS( l_U4068, -73.73804000, -225.80680000, 14.10855000 );
...
int sub_150115(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_6646() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_6646() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_150630()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U95._fU60 = uParam0;
...
void sub_154296()
{
    ...
    {
        case 0:
        if ((((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (sub_47538( 1, 1 ))) AND (IS_PLAYER_CONTROL_ON( sub_6741() ))) AND (NOT IS_SCREEN_FADING()))
        {
            SET_PLAYER_CONTROL( sub_6741(), 0 );
            if (NOT IS_SCREEN_FADED_OUT())
            {
        ...
        case 1:
        BLOCK_CHAR_AMBIENT_ANIMS( sub_6646(), 1 );
        if ((TIMERB() > 7000) AND (NOT sub_45668()))
        {
            if (NOT (IS_CHAR_INJURED( l_U3984 )))
            {
                ...
                if (iVar8 != 1)
                {
                    TASK_FOLLOW_NAV_MESH_TO_COORD( l_U3984, -68.52760000, -224.11480000, 13.72620000, 2, -2, 0.50000000 );
                    sub_56223( l_U4069, 0 );
...
void sub_159944()
{
    ...
    if ((((l_U4118 != 0) AND (NOT l_U4119[l_U4118])) AND (l_U4202)) AND (iVar2))
    {
        if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_55034( l_U4204 ))))
        {
            sub_160533( l_U4212 );
