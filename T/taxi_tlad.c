void main()
{
    ...
    while (sub_3124())
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U197 )))
        {
            if ((NOT sub_3622()) || (sub_2254( l_U201 )))
            {
                if (NOT (l_U192 == -1))
                {
                    switch (l_U192)
                    {
                        ...
                        if (NOT sub_7674())
                        {
                            if ((NOT IS_RADIO_RETUNING()) AND (l_U190 > 4000.00000000))
                            {
        ...
        switch (l_U173)
        {
            ...
            if (IS_CAR_MODEL( l_U342, 1884962369 ))
            {
                ...
                l_U330 = {-0.51100000, -0.81700000, 0.60200000};
                l_U163 = -12.00000000;
                l_U164 = 36.00000000;
                l_U165 = -130.00000000;
                l_U166 = 130.00000000;
            ...
            for ( I = 0; I < 3; I++ )
            {
                if (NOT (IS_CAR_DEAD( l_U342 )))
                {
                    if (NOT (IS_CAR_PASSENGER_SEAT_FREE( l_U342, I )))
                    {
                        ...
                        {
                            if ((NOT (IS_GROUP_MEMBER( l_U198, sub_1362() ))) AND (NOT (l_U198 == sub_1588())))
                            {
            ...
            SETTIMERA( 0 );
            while ((sub_12162()) AND (TIMERA() < 5000))
            {
                WAIT( 0 );
            }
            l_U153[0] = 0.27000000;
            ...
            switch (l_U174)
            {
                ...
                if (NOT (IS_CHAR_INJURED( l_U197 )))
                {
                    ...
                    {
                        case 0:
                        if (((IS_CHAR_PLAYING_ANIM( l_U197, "amb@taxi", "taxi_driver_chat_in" )) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U197, "amb@taxi", "taxi_driver_chat" )))) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U197, "amb@taxi", "taxi_driver_chat_out" ))))
                        {
                        ...
                        break;
                        case 1:
                        if (((IS_CHAR_PLAYING_ANIM( l_U197, "amb@taxi", "taxi_driver_chat" )) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U197, "amb@taxi", "taxi_driver_chat_in" )))) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U197, "amb@taxi", "taxi_driver_chat_out" ))))
                        {
                ...
                if (NOT l_U102)
                {
                    if (((IS_CONTROL_PRESSED( 2, 77 )) AND (NOT l_U106)) AND (NOT sub_30123()))
                    {
                        if (l_U182 > 0)
                        {
                            l_U102 = 1;
                ...
                if (NOT l_U102)
                {
                    if ((IS_CONTROL_PRESSED( 2, 43 )) AND (NOT sub_30123()))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U197 )))
                        {
                            CLEAR_CHAR_SECONDARY_TASK( l_U197 );
            ...
            if (NOT (IS_CHAR_INJURED( l_U197 )))
            {
                ...
                if (NOT (IS_CAR_DEAD( l_U342 )))
                {
                    ...
                    if (((CHECK_STUCK_TIMER( l_U342, 0, 3000 )) || (IS_CAR_ON_FIRE( l_U342 ))) || (NOT (IS_VEH_DRIVEABLE( l_U342 ))))
                    {
                        l_U177 = 3;
                        sub_10874( 3 );
                    }
            ...
            if (NOT (IS_PED_DOING_DRIVEBY( sub_1588() )))
            {
                if (NOT l_U102)
                {
                    if (NOT l_U107)
                    {
                        if ((sub_41790()) AND (NOT sub_30123()))
                        {
                            if ((sub_31323( 0 )) || (sub_31404( 0 )))
                            {
                                SET_CAMERA_CONTROLS_DISABLED_WITH_PLAYER_CONTROLS( 1 );
                ...
                if (NOT l_U102)
                {
                    if ((IS_CONTROL_JUST_PRESSED( 2, 77 )) AND (NOT sub_30123()))
                    {
                ...
                if (NOT g_U2775)
                {
                    if (NOT l_U102)
                    {
                        if ((IS_BUTTON_PRESSED( 0, 14 )) || ((IS_CONTROL_PRESSED( 2, 2 )) AND (NOT sub_30123())))
                        {
                            if (NOT (IS_CHAR_INJURED( l_U197 )))
                            {
                                if (IS_VEH_DRIVEABLE( l_U342 ))
            ...
            if (IS_SCREEN_FADED_OUT())
            {
                ...
                while (NOT l_U136)
                {
                    ...
                    if (NOT (IS_CAR_DEAD( l_U342 )))
                    {
                        if ((SET_CAR_ON_GROUND_PROPERLY( l_U342 )) || (TIMERA() > 2000))
                        {
                            if (TIMERA() > 2000)
                            {
                                SET_CAR_COORDINATES( l_U342, l_U312._fU0, l_U312._fU4, l_U312._fU8 );
            ...
            switch (l_U174)
            {
                ...
                sub_588();
                SETTIMERA( 0 );
                if ((NOT l_U113) || (l_U114))
                {
                    if (NOT (IS_CHAR_INJURED( l_U197 )))
                    {
                        if (NOT (IS_CAR_DEAD( l_U342 )))
                        {
                            if (((NOT (CHECK_STUCK_TIMER( l_U342, 0, 3000 ))) AND (NOT (IS_CAR_ON_FIRE( l_U342 )))) AND (IS_VEH_DRIVEABLE( l_U342 )))
                            {
                                CLEAR_CHAR_TASKS( l_U197 );
                ...
                if (l_U113)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U197 ))) AND (IS_PLAYER_PLAYING( sub_1532() )))
                    {
                        SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U197, 1 );
                        CLEAR_CHAR_TASKS( l_U197 );
                        OPEN_SEQUENCE_TASK( ref l_U200 );
                ...
                if (IS_SCREEN_FADED_IN())
                {
                    if (NOT (IS_CHAR_INJURED( l_U197 )))
                    {
                        ...
                        {
                            case 0:
                            if ((l_U159 > 75.00000000) AND (NOT g_U2770))
                            {
                                l_U192 = 5;
                            }
                            else
                ...
                if (NOT (IS_CAR_DEAD( l_U342 )))
                {
                    ...
                    if ((CHECK_STUCK_TIMER( l_U342, 0, 3000 )) || (IS_CAR_ON_FIRE( l_U342 )))
                    {
                        bVar11 = true;
                    }
                    if ((bVar11) AND (NOT l_U113))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U197 )))
                        {
                            if (IS_VEH_DRIVEABLE( l_U342 ))
    ...
    if ((NOT g_U2774) AND (NOT l_U113))
    {
        ...
        while (bVar11)
        {
            if (NOT (IS_CAR_DEAD( l_U342 )))
            {
                if (IS_PLAYER_PLAYING( sub_1532() ))
                {
                    if ((((NOT (IS_CHAR_IN_CAR( sub_1588(), l_U342 ))) AND (NOT (sub_48294( sub_1588() )))) AND (NOT (sub_48673( l_U342 )))) AND (NOT (sub_48840( l_U342 ))))
                    {
                        bVar11 = false;
                    }
                }
    ...
    if (l_U113)
    {
        ...
        while (bVar11)
        {
            ...
            if (NOT (IS_CAR_DEAD( l_U342 )))
            {
                if (NOT (IS_CHAR_INJURED( l_U197 )))
                {
                    if ((IS_CHAR_IN_CAR( l_U197, l_U342 )) || (sub_48294( l_U197 )))
                    {
                        bVar11 = true;
                    }
                }
    ...
    if (((l_U115) AND (NOT g_U2770)) AND (NOT l_U113))
    {
...
void sub_571()
{
    ...
    if (NOT g_U2774)
    {
        if ((IS_SCREEN_FADED_OUT()) AND (l_U141))
        {
            DO_SCREEN_FADE_IN( 1000 );
        }
    }
...
void sub_1667()
{
    if ((((DOES_CAM_EXIST( l_U145 )) || (DOES_CAM_EXIST( l_U147 ))) || (DOES_CAM_EXIST( l_U346 ))) || (DOES_CAM_EXIST( l_U147 )))
    {
                ...
                if (sub_12844( iVar8 ))
                {
                    ...
                    if (sub_13423( uVar4 ))
                    {
                        if (NOT (sub_13683( ref iVar8, uParam0 )))
                        {
                            ...
                            {
                                bVar7 = false;
                                if ((((((GET_BLIP_INFO_ID_TYPE( iVar8 )) == 4) || ((GET_BLIP_INFO_ID_TYPE( iVar8 )) == 5)) || ((GET_BLIP_INFO_ID_TYPE( iVar8 )) == 6)) || ((GET_BLIP_INFO_ID_TYPE( iVar8 )) == 3)) || (sub_14531( iVar8 )))
                                {
                                    bVar7 = true;
                                }
...
void sub_16456()
{
    ...
    while (DOES_BLIP_EXIST( uVar3 ))
    {
        if (sub_12773( uVar3 ))
        {
            if (sub_12844( uVar3 ))
            {
                if (((((GET_BLIP_INFO_ID_TYPE( uVar3 )) == 4) || ((GET_BLIP_INFO_ID_TYPE( uVar3 )) == 6)) || ((GET_BLIP_INFO_ID_TYPE( uVar3 )) == 3)) || (sub_14531( uVar3 )))
                {
                    Result++;
                }
            }
...
void sub_17334()
{
    ...
    if ((DOES_OBJECT_EXIST( l_U196 )) AND (NOT (l_U176 == -1)))
    {
        fVar10 = 1.26400000;
        fVar11 = 0.60400000;
        fVar12 = 0.60400000;
                ...
                if (DOES_BLIP_EXIST( l_U298._fU0 ))
                {
                    ...
                    if (l_U125)
                    {
                        ...
                        if (fVar2 < l_U148)
                        {
                            ...
                            SET_TEXT_BACKGROUND( 0 );
                            SET_TEXT_PROPORTIONAL( 1 );
                            if ((l_U298._fU4 == l_U298._fU8) || ((sub_23044( l_U298._fU4, l_U298._fU8 )) > 37))
                            {
                        ...
                        if (fVar2 < l_U148)
                        {
                            ...
                            if ((NOT (COMPARE_STRING( uVar8, "FULSTP" ))) AND (NOT ((sub_24195( uVar9, uVar8 )) > 37)))
                            {
            ...
            if (DOES_BLIP_EXIST( l_U301._fU0 ))
            {
                ...
                if (l_U125)
                {
                    ...
                    if (fVar2 < l_U148)
                    {
                        ...
                        SET_TEXT_BACKGROUND( 0 );
                        SET_TEXT_PROPORTIONAL( 1 );
                        if ((l_U301._fU4 == l_U301._fU8) || ((sub_23044( l_U301._fU4, l_U301._fU8 )) > 37))
                        {
                ...
                if (DOES_BLIP_EXIST( l_U304._fU0 ))
                {
                    ...
                    if (l_U125)
                    {
                        ...
                        if (fVar2 < l_U148)
                        {
                            ...
                            SET_TEXT_BACKGROUND( 0 );
                            SET_TEXT_PROPORTIONAL( 1 );
                            if ((l_U304._fU4 == l_U304._fU8) || ((sub_23044( l_U304._fU4, l_U304._fU8 )) > 37))
                            {
...
void sub_30327(unknown uParam0)
{
    ...
    if ((NOT (IS_CAR_DEAD( l_U342 ))) AND (IS_PLAYER_PLAYING( sub_1532() )))
    {
        if (DOES_GROUP_EXIST( sub_1362() ))
        {
            ...
            if (iVar3 > 0)
            {
                ...
                if (NOT (IS_CHAR_INJURED( l_U198 )))
                {
                    if (NOT (IS_CHAR_IN_CAR( l_U198, l_U342 )))
                    {
                        ...
                        {
                            if ((NOT (sub_30513( l_U198, l_U342 ))) || (IS_SCREEN_FADED_OUT()))
                            {
                                if (((NOT (IS_CHAR_ON_SCREEN( l_U198 ))) || (uParam0)) || (IS_SCREEN_FADED_OUT()))
                                {
                                    if (IS_CAR_PASSENGER_SEAT_FREE( l_U342, 1 ))
                                    {
                                        WARP_CHAR_INTO_CAR_AS_PASSENGER( l_U198, l_U342, 1 );
...
void sub_31313()
{
    ...
    if (NOT l_U105)
    {
        if (NOT l_U102)
        {
            if ((sub_31323( 0 )) AND (NOT sub_30123()))
            {
                l_U104 = 1;
                l_U102 = 1;
            }
        }
        else if ((sub_31323( 0 )) AND (NOT sub_30123()))
        {
            if (l_U178 > 1000)
            {
                l_U104 = 1;
    ...
    if (NOT l_U104)
    {
        if (NOT l_U102)
        {
            if ((sub_31404( 0 )) AND (NOT sub_30123()))
            {
                l_U105 = 1;
                l_U102 = 1;
            }
        }
        else if ((sub_31404( 0 )) AND (NOT sub_30123()))
        {
            if (l_U178 > 1000)
            {
                l_U105 = 1;
...
int sub_32727(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    if ((sub_32555( uParam0, -1015.45000000, 1839.62700000, -100.00000000, -912.00000000, 1911.17700000, 100.00000000 )) || (sub_32555( uParam0, -961.97500000, 1613.37500000, -100.00000000, -801.82500000, 1852.27500000, 100.00000000 )))
    {
...
void sub_36062()
{
    ...
    if (IS_PLAYER_PLAYING( sub_1532() ))
    {
        if (((NOT (IS_CONTROL_PRESSED( 2, 51 ))) || (l_U117)) || (sub_30123()))
        {
            if (NOT l_U107)
            {
                if (l_U118)
        ...
        else if (NOT l_U107)
        {
            if (NOT l_U102)
            {
                if (NOT (IS_CAR_DEAD( l_U342 )))
                {
                    if ((((IS_CHAR_SITTING_IN_CAR( sub_1588(), l_U342 )) AND (NOT (IS_PED_DOING_DRIVEBY( sub_1588() )))) AND (NOT (IS_BUTTON_PRESSED( 0, 5 )))) AND (NOT sub_30123()))
                    {
                        GET_FOLLOW_VEHICLE_CAM_SUBMODE( ref iVar2 );
                        if (iVar2 == 4)
                        {
...
void sub_38102()
{
    if (NOT l_U108)
    {
        if ((((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TX_H13" )))) AND (NOT sub_30123())) AND (IS_SCREEN_FADED_IN()))
        {
            if (l_U116)
            {
                if (NOT g_U2775)
...
void sub_42864()
{
    if ((DOES_CAM_EXIST( l_U346 )) || (DOES_CAM_EXIST( l_U147 )))
    {
        if (DOES_CAM_EXIST( l_U147 ))
        {
            DESTROY_CAM( l_U147 );
