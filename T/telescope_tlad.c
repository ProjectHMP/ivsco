...
int sub_1900(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_753() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_753() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_1996())
                    {
...
int sub_5042()
{
    if (((((IS_BUTTON_PRESSED( 0, 17 )) || (IS_BUTTON_PRESSED( 0, 14 ))) || (IS_BUTTON_PRESSED( 0, 15 ))) || (IS_BUTTON_PRESSED( 0, 16 ))) || (sub_5090()))
    {
        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_1148() );
        SET_PLAYER_CONTROL( sub_753(), 1 );
        return 1;
