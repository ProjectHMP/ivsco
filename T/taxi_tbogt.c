void main()
{
    ...
    while (sub_3124())
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U198 )))
        {
            if ((NOT sub_3622()) || (sub_2254( l_U202 )))
            {
                if (NOT (l_U193 == -1))
                {
                    switch (l_U193)
                    {
                        ...
                        if (NOT sub_9627())
                        {
                            if ((NOT IS_RADIO_RETUNING()) AND (l_U191 > 4000.00000000))
                            {
        ...
        switch (l_U174)
        {
            ...
            if (IS_CAR_MODEL( l_U343, 1884962369 ))
            {
                ...
                l_U331 = {-0.51100000, -0.81700000, 0.60200000};
                l_U164 = -12.00000000;
                l_U165 = 36.00000000;
                l_U166 = -130.00000000;
                l_U167 = 130.00000000;
            ...
            for ( I = 0; I < 3; I++ )
            {
                if (NOT (IS_CAR_DEAD( l_U343 )))
                {
                    if (NOT (IS_CAR_PASSENGER_SEAT_FREE( l_U343, I )))
                    {
                        ...
                        {
                            if ((NOT (IS_GROUP_MEMBER( l_U199, sub_1362() ))) AND (NOT (l_U199 == sub_1588())))
                            {
            ...
            SETTIMERA( 0 );
            while ((sub_14115()) AND (TIMERA() < 5000))
            {
                WAIT( 0 );
            }
            l_U154[0] = 0.27000000;
            ...
            switch (l_U175)
            {
                ...
                if (NOT (IS_CHAR_INJURED( l_U198 )))
                {
                    ...
                    {
                        case 0:
                        if (((IS_CHAR_PLAYING_ANIM( l_U198, "amb@taxi", "taxi_driver_chat_in" )) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U198, "amb@taxi", "taxi_driver_chat" )))) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U198, "amb@taxi", "taxi_driver_chat_out" ))))
                        {
                        ...
                        break;
                        case 1:
                        if (((IS_CHAR_PLAYING_ANIM( l_U198, "amb@taxi", "taxi_driver_chat" )) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U198, "amb@taxi", "taxi_driver_chat_in" )))) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U198, "amb@taxi", "taxi_driver_chat_out" ))))
                        {
                ...
                if (NOT l_U103)
                {
                    if (((IS_CONTROL_PRESSED( 2, 77 )) AND (NOT l_U107)) AND (NOT sub_32559()))
                    {
                        if (l_U183 > 0)
                        {
                            l_U103 = 1;
                ...
                if (NOT l_U103)
                {
                    if ((IS_CONTROL_PRESSED( 2, 43 )) AND (NOT sub_32559()))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U198 )))
                        {
                            CLEAR_CHAR_SECONDARY_TASK( l_U198 );
            ...
            if (NOT (IS_CHAR_INJURED( l_U198 )))
            {
                ...
                if (NOT (IS_CAR_DEAD( l_U343 )))
                {
                    ...
                    if (((CHECK_STUCK_TIMER( l_U343, 0, 3000 )) || (IS_CAR_ON_FIRE( l_U343 ))) || (NOT (IS_VEH_DRIVEABLE( l_U343 ))))
                    {
                        l_U178 = 3;
                        sub_12827( 3 );
                    }
            ...
            if (NOT (IS_PED_DOING_DRIVEBY( sub_1588() )))
            {
                if (NOT l_U103)
                {
                    if (NOT l_U108)
                    {
                        if ((sub_44535()) AND (NOT sub_32559()))
                        {
                            if ((sub_33759( 0 )) || (sub_33840( 0 )))
                            {
                                SET_CAMERA_CONTROLS_DISABLED_WITH_PLAYER_CONTROLS( 1 );
                ...
                if (NOT l_U103)
                {
                    if ((IS_CONTROL_JUST_PRESSED( 2, 77 )) AND (NOT sub_32559()))
                    {
                ...
                if (NOT g_U2678)
                {
                    if (NOT l_U103)
                    {
                        if ((IS_BUTTON_PRESSED( 0, 14 )) || ((IS_CONTROL_PRESSED( 2, 2 )) AND (NOT sub_32559())))
                        {
                            if (NOT (IS_CHAR_INJURED( l_U198 )))
                            {
                                if (IS_VEH_DRIVEABLE( l_U343 ))
            ...
            if (IS_SCREEN_FADED_OUT())
            {
                ...
                while (NOT l_U137)
                {
                    ...
                    if (NOT (IS_CAR_DEAD( l_U343 )))
                    {
                        if ((SET_CAR_ON_GROUND_PROPERLY( l_U343 )) || (TIMERA() > 2000))
                        {
                            if (TIMERA() > 2000)
                            {
                                SET_CAR_COORDINATES( l_U343, l_U313._fU0, l_U313._fU4, l_U313._fU8 );
                ...
                if (g_U42891)
                {
                    ...
                    while (NOT bVar11)
                    {
                        if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1588(), 81.12530000, -338.25000000, 11.15940000, 50.00000000, 50.00000000, 50.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_1588(), -1334.70000000, 317.90000000, 14.49000000, 50.00000000, 50.00000000, 50.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( sub_1588(), 1066.50300000, 87.56122000, 34.13000000, 50.00000000, 50.00000000, 50.00000000, 0 )))
                        {
                            if (TIMERA() < 4000)
                            {
            ...
            switch (l_U175)
            {
                ...
                sub_588();
                SETTIMERA( 0 );
                if ((NOT l_U114) || (l_U115))
                {
                    if (NOT (IS_CHAR_INJURED( l_U198 )))
                    {
                        if (NOT (IS_CAR_DEAD( l_U343 )))
                        {
                            if (((NOT (CHECK_STUCK_TIMER( l_U343, 0, 3000 ))) AND (NOT (IS_CAR_ON_FIRE( l_U343 )))) AND (IS_VEH_DRIVEABLE( l_U343 )))
                            {
                                CLEAR_CHAR_TASKS( l_U198 );
                ...
                if (l_U114)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U198 ))) AND (IS_PLAYER_PLAYING( sub_1532() )))
                    {
                        SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U198, 1 );
                        CLEAR_CHAR_TASKS( l_U198 );
                        OPEN_SEQUENCE_TASK( ref l_U201 );
                ...
                if (IS_SCREEN_FADED_IN())
                {
                    if (NOT (IS_CHAR_INJURED( l_U198 )))
                    {
                        ...
                        {
                            case 0:
                            if ((l_U160 > 75.00000000) AND (NOT g_U2673))
                            {
                                l_U193 = 5;
                            }
                            else
                ...
                if (NOT (IS_CAR_DEAD( l_U343 )))
                {
                    ...
                    if ((CHECK_STUCK_TIMER( l_U343, 0, 3000 )) || (IS_CAR_ON_FIRE( l_U343 )))
                    {
                        bVar11 = true;
                    }
                    if ((bVar11) AND (NOT l_U114))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U198 )))
                        {
                            if (IS_VEH_DRIVEABLE( l_U343 ))
    ...
    if ((NOT g_U2677) AND (NOT l_U114))
    {
        ...
        while (bVar11)
        {
            if (NOT (IS_CAR_DEAD( l_U343 )))
            {
                if (IS_PLAYER_PLAYING( sub_1532() ))
                {
                    if ((((NOT (IS_CHAR_IN_CAR( sub_1588(), l_U343 ))) AND (NOT (sub_53015( sub_1588() )))) AND (NOT (sub_53394( l_U343 )))) AND (NOT (sub_53561( l_U343 ))))
                    {
                        bVar11 = false;
                    }
                }
    ...
    if (l_U114)
    {
        ...
        while (bVar11)
        {
            ...
            if (NOT (IS_CAR_DEAD( l_U343 )))
            {
                if (NOT (IS_CHAR_INJURED( l_U198 )))
                {
                    if ((IS_CHAR_IN_CAR( l_U198, l_U343 )) || (sub_53015( l_U198 )))
                    {
                        bVar11 = true;
                    }
                }
    ...
    if (((l_U116) AND (NOT g_U2673)) AND (NOT l_U114))
    {
...
void sub_571()
{
    ...
    if (NOT g_U2677)
    {
        if ((IS_SCREEN_FADED_OUT()) AND (l_U142))
        {
            DO_SCREEN_FADE_IN( 1000 );
        }
    }
...
void sub_1667()
{
    if ((((DOES_CAM_EXIST( l_U146 )) || (DOES_CAM_EXIST( l_U148 ))) || (DOES_CAM_EXIST( l_U348 ))) || (DOES_CAM_EXIST( l_U148 )))
    {
                ...
                if (sub_14797( iVar8 ))
                {
                    ...
                    if (sub_15376( uVar4 ))
                    {
                        if (NOT (sub_15636( ref iVar8, uParam0 )))
                        {
                            ...
                            {
                                bVar7 = false;
                                if ((((((GET_BLIP_INFO_ID_TYPE( iVar8 )) == 4) || ((GET_BLIP_INFO_ID_TYPE( iVar8 )) == 5)) || ((GET_BLIP_INFO_ID_TYPE( iVar8 )) == 6)) || ((GET_BLIP_INFO_ID_TYPE( iVar8 )) == 3)) || (sub_16524( iVar8 )))
                                {
                                    bVar7 = true;
                                }
...
void sub_18503()
{
    ...
    while (DOES_BLIP_EXIST( uVar3 ))
    {
        if (sub_14726( uVar3 ))
        {
            if (sub_14797( uVar3 ))
            {
                if (((((GET_BLIP_INFO_ID_TYPE( uVar3 )) == 4) || ((GET_BLIP_INFO_ID_TYPE( uVar3 )) == 6)) || ((GET_BLIP_INFO_ID_TYPE( uVar3 )) == 3)) || (sub_16524( uVar3 )))
                {
                    Result++;
                }
            }
...
void sub_19381()
{
    ...
    if ((DOES_OBJECT_EXIST( l_U197 )) AND (NOT (l_U177 == -1)))
    {
        fVar9 = 1.26400000;
        fVar10 = 3.93000000;
        fVar11 = 0.60400000;
                ...
                if (DOES_BLIP_EXIST( l_U299._fU0 ))
                {
                    ...
                    if (l_U126)
                    {
                        ...
                        if (fVar2 < l_U149)
                        {
                            ...
                            SET_TEXT_BACKGROUND( 0 );
                            SET_TEXT_PROPORTIONAL( 1 );
                            if ((l_U299._fU4 == l_U299._fU8) || ((sub_25470( l_U299._fU4, l_U299._fU8 )) > 37))
                            {
                        ...
                        if (fVar2 < l_U149)
                        {
                            ...
                            if ((NOT (COMPARE_STRING( uVar8, "FULSTP" ))) AND (NOT ((sub_26623( l_U347, uVar8 )) > 37)))
                            {
            ...
            if (DOES_BLIP_EXIST( l_U302._fU0 ))
            {
                ...
                if (l_U126)
                {
                    ...
                    if (fVar2 < l_U149)
                    {
                        ...
                        SET_TEXT_BACKGROUND( 0 );
                        SET_TEXT_PROPORTIONAL( 1 );
                        if ((l_U302._fU4 == l_U302._fU8) || ((sub_25470( l_U302._fU4, l_U302._fU8 )) > 37))
                        {
                ...
                if (DOES_BLIP_EXIST( l_U305._fU0 ))
                {
                    ...
                    if (l_U126)
                    {
                        ...
                        if (fVar2 < l_U149)
                        {
                            ...
                            SET_TEXT_BACKGROUND( 0 );
                            SET_TEXT_PROPORTIONAL( 1 );
                            if ((l_U305._fU4 == l_U305._fU8) || ((sub_25470( l_U305._fU4, l_U305._fU8 )) > 37))
                            {
...
void sub_32763(unknown uParam0)
{
    ...
    if ((NOT (IS_CAR_DEAD( l_U343 ))) AND (IS_PLAYER_PLAYING( sub_1532() )))
    {
        if (DOES_GROUP_EXIST( sub_1362() ))
        {
            ...
            if (iVar3 > 0)
            {
                ...
                if (NOT (IS_CHAR_INJURED( l_U199 )))
                {
                    if (NOT (IS_CHAR_IN_CAR( l_U199, l_U343 )))
                    {
                        ...
                        {
                            if ((NOT (sub_32949( l_U199, l_U343 ))) || (IS_SCREEN_FADED_OUT()))
                            {
                                if (((NOT (IS_CHAR_ON_SCREEN( l_U199 ))) || (uParam0)) || (IS_SCREEN_FADED_OUT()))
                                {
                                    if (IS_CAR_PASSENGER_SEAT_FREE( l_U343, 1 ))
                                    {
                                        WARP_CHAR_INTO_CAR_AS_PASSENGER( l_U199, l_U343, 1 );
...
void sub_33749()
{
    ...
    if (NOT l_U106)
    {
        if (NOT l_U103)
        {
            if ((sub_33759( 0 )) AND (NOT sub_32559()))
            {
                l_U105 = 1;
                l_U103 = 1;
            }
        }
        else if ((sub_33759( 0 )) AND (NOT sub_32559()))
        {
            if (l_U179 > 1000)
            {
                l_U105 = 1;
    ...
    if (NOT l_U105)
    {
        if (NOT l_U103)
        {
            if ((sub_33840( 0 )) AND (NOT sub_32559()))
            {
                l_U106 = 1;
                l_U103 = 1;
            }
        }
        else if ((sub_33840( 0 )) AND (NOT sub_32559()))
        {
            if (l_U179 > 1000)
            {
                l_U106 = 1;
...
int sub_35163(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    if ((sub_34991( uParam0, -1015.45000000, 1839.62700000, -100.00000000, -912.00000000, 1911.17700000, 100.00000000 )) || (sub_34991( uParam0, -961.97500000, 1613.37500000, -100.00000000, -801.82500000, 1852.27500000, 100.00000000 )))
    {
    ...
    {
        (uParam3^) = {-459.08250000, 358.33610000, 9.82770000};
        (uParam4^) = 180;
        return 1;
    }
...
void sub_38807()
{
    ...
    if (IS_PLAYER_PLAYING( sub_1532() ))
    {
        if (((NOT (IS_CONTROL_PRESSED( 2, 51 ))) || (l_U118)) || (sub_32559()))
        {
            if (NOT l_U108)
            {
                if (l_U119)
        ...
        else if (NOT l_U108)
        {
            if (NOT l_U103)
            {
                if (NOT (IS_CAR_DEAD( l_U343 )))
                {
                    if ((((IS_CHAR_SITTING_IN_CAR( sub_1588(), l_U343 )) AND (NOT (IS_PED_DOING_DRIVEBY( sub_1588() )))) AND (NOT (IS_BUTTON_PRESSED( 0, 5 )))) AND (NOT sub_32559()))
                    {
                        GET_FOLLOW_VEHICLE_CAM_SUBMODE( ref iVar2 );
                        if (iVar2 == 4)
                        {
...
void sub_40847()
{
    if (NOT l_U109)
    {
        if ((((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TX_H13" )))) AND (NOT sub_32559())) AND (IS_SCREEN_FADED_IN()))
        {
            if (l_U117)
            {
                if (NOT g_U2678)
...
void sub_45609()
{
    if ((DOES_CAM_EXIST( l_U348 )) || (DOES_CAM_EXIST( l_U148 )))
    {
        if (DOES_CAM_EXIST( l_U148 ))
        {
            DESTROY_CAM( l_U148 );
...
void sub_48580(boolean bParam0, unknown uParam1)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_1588() ))) AND ((IS_SCREEN_FADED_OUT()) || (bParam0)))
    {
