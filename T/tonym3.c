    ...
    while (true)
    {
        ...
        switch (l_U269)
        {
            ...
            switch (l_U332)
            {
                ...
                case 1:
                sub_3675();
                if (((((HAS_MODEL_LOADED( -604558634 )) AND (HAS_MODEL_LOADED( 1964095658 ))) AND (HAS_MODEL_LOADED( -297585214 ))) AND (HAS_MODEL_LOADED( sub_4820( 0 ) ))) AND (HAVE_ANIMS_LOADED( "misstonym3" )))
                {
                    l_U332++;
                }
                break;
                ...
                break;
                case 4:
                if ((NOT (sub_9250( l_U374 ))) || (sub_9413()))
                {
                    if (g_U30199 != -1)
                    {
                        if (DOES_CHAR_EXIST( g_U29971[g_U30199]._fU12 ))
            ...
            if (DOES_CHAR_EXIST( l_U291 ))
            {
                ...
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_4089(), -483.89640000, 143.81140000, 6.60000000, 0.40000000, 0.40000000, 4, 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U291, sub_4089(), 0 )))
                    {
            ...
            if (DOES_CHAR_EXIST( l_U283 ))
            {
                ...
                {
                    if (((sub_11617( sub_4089(), l_U283, 1 )) < 3) AND (TIMERA() > 3500))
                    {
...
void sub_1609()
{
    ...
    {
        if (((sub_1647( 5, g_U575[I] )) == 1) AND (g_U575[I]._fU20))
        {
...
void sub_12021()
{
    ...
    if ((sub_12325( sub_4089(), 1, 1 )) || (sub_12325( sub_4089(), 2, 1 )))
    {
...
{
    if (((((IS_MESSAGE_BEING_DISPLAYED()) || (((sub_14553()) AND (NOT bParam0)) || ((sub_14607()) AND (bParam0)))) || (sub_14636())) || (IS_SCRIPTED_CONVERSATION_ONGOING())) || (sub_14695()))
    {
        return 1;
    }
    return 0;
    ...
    if (sub_20375( l_U243[0], l_U243[1], l_U243[2], uParam11, uParam12, uParam13, uParam14, l_U237, uParam16, 0, 0, 0 ))
    {
        ...
        if (IS_SCREEN_FADED_IN())
        {
            if (sub_26090())
            {
                ...
                sub_20923( uParam15 );
                sub_20923( uParam19 );
                if ((uParam17) AND (IS_WANTED_LEVEL_GREATER( sub_738(), 0 )))
                {
                    ...
                    if (((NOT (sub_14537( 0 ))) AND (NOT sub_26252())) AND (NOT l_U203))
                    {
...
void sub_19027()
{
    ...
    for ( I = 0; I < l_U243; I++ )
    {
        if (DOES_CHAR_EXIST( l_U243[I] ))
        {
            ...
            {
                if (((IS_CHAR_SITTING_IN_ANY_CAR( l_U243[I] )) AND (sub_19120( l_U243[I] ))) AND (sub_14553()))
                {
    ...
    if (IS_PLAYER_PLAYING( sub_738() ))
    {
        ...
        {
            if (((IS_CHAR_SITTING_IN_ANY_CAR( sub_4089() )) AND (sub_19120( sub_4089() ))) AND (sub_14553()))
            {
...
int sub_20375(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, int iParam9, unknown uParam10, unknown uParam11)
{
    ...
    if (((NOT sub_20546()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_4089() ))) AND (NOT (DOES_VEHICLE_EXIST( iParam9 ))))
    {
            ...
            if (NOT (IS_CHAR_INJURED( l_U243[I] )))
            {
                ...
                if (IS_CHAR_SITTING_IN_ANY_CAR( sub_4089() ))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( iVar26 ))
                    {
                        ...
                        {
                            if ((NOT sub_20546()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_4089() )))
                            {
                ...
                if (((NOT (IS_GROUP_MEMBER( l_U243[I], sub_14116() ))) AND (NOT (sub_21942( l_U243[I], iParam9 )))) AND (NOT (sub_22038( l_U243[I], iParam9 ))))
                {
                ...
                {
                    if (((sub_22993( l_U243[I] )) || (sub_21942( l_U243[I], iParam9 ))) || (uParam11))
                    {
        ...
        if (iVar15 > 0)
        {
            for ( I = 0; I < 3; I++ )
            {
                if (iVar20[I])
                {
                    if (NOT (IS_CHAR_INJURED( l_U243[I] )))
                    {
                        if ((sub_21199( l_U243[I] )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U243[I], sub_4089(), 40.00000000, 40.00000000, 40.00000000, 0 )))
                        {
                            iVar15--;
                            iVar20[I] = 0;
                        }
        ...
        if (IS_VEH_DRIVEABLE( iVar3 ))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                ...
                if (IS_VEH_DRIVEABLE( iVar4 ))
                {
                    if (iVar3 == iVar4)
                    {
                        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_4089(), uParam0, 20.00000000, 20.00000000, 20.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( uParam0, iVar4, 20.00000000, 20.00000000, 20.00000000, 0 )))
                        {
                            return 1;
                        }
                    }
...
int sub_26794()
{
    ...
    if (IS_CHAR_SITTING_IN_ANY_CAR( sub_4089() ))
    {
        if ((IS_CHAR_ON_ANY_BIKE( sub_4089() )) || (IS_CHAR_IN_ANY_HELI( sub_4089() )))
        {
            iVar2 = 0;
        }
    }
    if (l_U221)
    {
        ...
        {
            if ((sub_26884( 1, iVar2 )) || (l_U215))
            {
                return 1;
            }
        }
    }
    else if ((sub_26884( 1, iVar2 )) || (l_U215))
    {
        return 1;
    }
    return 0;
...
void sub_30152(boolean bParam0, unknown uParam1)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_4089() ))) AND ((IS_SCREEN_FADED_OUT()) || (bParam0)))
    {
...
void sub_31798()
{
    ...
    SET_WIDESCREEN_BORDERS( 1 );
    ACTIVATE_SCRIPTED_CAMS( 1, 1 );
    SET_CAM_POS( l_U335, -281.87600000, 340.62450000, 15.40814000 );
    SET_CAM_ROT( l_U335, -2.23855200, 0.00000000, -26.49821000 );
    ...
    while (l_U339 == 1)
    {
        switch (l_U340)
        {
            ...
            break;
            case 1:
            SET_CAM_POS( l_U336, -287.45790000, 359.30720000, 17.15479000 );
            SET_CAM_ROT( l_U336, -8.62523800, -0.00000000, -136.50620000 );
            SET_CAM_FOV( l_U336, 45.00000000 );
            SET_CAM_POS( l_U337, -287.09050000, 358.91990000, 17.07380000 );
            SET_CAM_ROT( l_U337, -8.62523800, -0.00000000, -136.50620000 );
