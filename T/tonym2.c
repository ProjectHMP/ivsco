void main()
{
    ...
    l_U330 = {-468.55550000, 140.33990000, 8.85910000};
    l_U333 = 129.90300000;
    l_U334 = 104.42500000;
    l_U335 = 184.52100000;
    l_U336 = 90.00000000;
    ...
    while (true)
    {
        ...
        switch (l_U269)
        {
            ...
            switch (l_U317)
            {
                ...
                case 2:
                sub_3413();
                if ((((HAS_MODEL_LOADED( 1878085135 )) AND (HAS_MODEL_LOADED( 1781540370 ))) AND (HAS_MODEL_LOADED( sub_4568( 0 ) ))) AND (HAVE_ANIMS_LOADED( "misstonym2" )))
                {
                    l_U317++;
                }
                break;
                ...
                break;
                case 5:
                if ((NOT (sub_7922( l_U365 ))) || (sub_8085()))
                {
                    if (g_U30199 != -1)
                    {
                        if (DOES_CHAR_EXIST( g_U29971[g_U30199]._fU12 ))
            ...
            SET_CAM_POS( l_U341, 745.92290000, 1531.00700000, 25.07866000 );
            SET_CAM_ROT( l_U341, 12.51185000, -0.00000000, 30.29911000 );
            SET_CAM_FOV( l_U341, 22.20006000 );
            SET_CAM_POS( l_U342, 745.92290000, 1531.00700000, 25.07866000 );
            ...
            while (l_U344 == 1)
            {
                switch (l_U345)
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( l_U292 )))
                    {
                        ...
                        SET_CHAR_COORDINATES( l_U292, 733.12850000 - 1.50000000, 1555.35600000, 21.15760000 );
                        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_3827() );
                        if (IS_CHAR_IN_ANY_CAR( sub_3827() ))
                        {
                            WARP_CHAR_FROM_CAR_TO_COORD( sub_3827(), 733.12850000, 1555.35600000, 21.15760000 );
                        }
                        else
                        {
                            SET_CHAR_COORDINATES( sub_3827(), 733.12850000, 1555.35600000, 21.15760000 );
                        }
                    ...
                    SET_CAM_POS( l_U342, 731.54750000, 1549.34700000, 27.71120000 );
            ...
            if (TIMERA() < 150000)
            {
                if (NOT (IS_WANTED_LEVEL_GREATER( sub_800(), 0 )))
                {
                    if (IS_CHAR_IN_ANY_CAR( sub_3827() ))
                    {
                        if (NOT l_U362)
                        {
                            if ((LOCATE_CHAR_IN_CAR_3D( sub_3827(), l_U271._fU0, l_U271._fU4, l_U271._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (sub_27514()))
                            {
            ...
            if (NOT (IS_WANTED_LEVEL_GREATER( sub_800(), 0 )))
            {
                if ((NOT (DOES_BLIP_EXIST( l_U274 ))) AND (NOT l_U362))
                {
...
void sub_1671()
{
    ...
    {
        if (((sub_1709( 5, g_U575[I] )) == 1) AND (g_U575[I]._fU20))
        {
...
void sub_9920()
{
    ...
    if ((sub_10381( sub_3827(), 1, 1 )) || (sub_10381( sub_3827(), 2, 1 )))
    {
...
{
    if (((((IS_MESSAGE_BEING_DISPLAYED()) || (((sub_11379()) AND (NOT bParam0)) || ((sub_11433()) AND (bParam0)))) || (sub_11462())) || (IS_SCRIPTED_CONVERSATION_ONGOING())) || (sub_11521()))
    {
        return 1;
    }
    return 0;
...
int sub_12436(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if (IS_SCREEN_FADED_IN())
    {
        if ((uParam9) AND (IS_WANTED_LEVEL_GREATER( sub_800(), 0 )))
        {
            ...
            if ((NOT (sub_11363( 0 ))) AND (NOT l_U203))
            {
...
int sub_13944()
{
    ...
    {
        if ((IS_CHAR_ON_ANY_BIKE( sub_3827() )) || (IS_CHAR_IN_ANY_HELI( sub_3827() )))
        {
            iVar2 = 0;
        }
    }
    if (l_U221)
    {
        ...
        {
            if ((sub_14099( 1, iVar2 )) || (l_U215))
            {
                return 1;
            }
        }
    }
    else if ((sub_14099( 1, iVar2 )) || (l_U215))
    {
        return 1;
    }
    return 0;
...
void sub_17126(boolean bParam0, unknown uParam1)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_3827() ))) AND ((IS_SCREEN_FADED_OUT()) || (bParam0)))
    {
...
int sub_23611(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3827() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3827() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_24126()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U95._fU60 = uParam0;
