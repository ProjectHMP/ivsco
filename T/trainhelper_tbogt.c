...
void sub_93()
{
    ...
    Result = 1;
    if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "tony5" )) >= 1) || ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "yusuf4" )) >= 1))
    {
        Result = 0;
    }
    return Result;
...
void sub_8797()
{
    if (NOT (IS_CHAR_DEAD( sub_266() )))
    {
        if ((IS_CHAR_IN_MODEL( sub_266(), 800869680 )) AND (sub_603()))
        {
            if (sub_757())
            {
                sub_639( ref l_U11, 0 );
