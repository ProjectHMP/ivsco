...
void sub_7521()
{
    ...
    {
        if (((sub_7559( 5, g_U575[I] )) == 1) AND (g_U575[I]._fU20))
        {
...
void sub_9268()
{
    ...
    switch (l_U220)
    {
        ...
        switch (g_U43104[0])
        {
            ...
            while (((((((NOT (HAS_MODEL_LOADED( sub_9627( 0 ) ))) || (NOT (sub_10357( 0 )))) || (NOT (HAVE_ANIMS_LOADED( "misstony01" )))) || (NOT (HAS_MODEL_LOADED( -1446884113 )))) || (NOT (HAS_MODEL_LOADED( 1662473323 )))) || (NOT (HAS_SCRIPT_LOADED( "ambNightclubHC" )))) || (NOT (HAS_SCRIPT_LOADED( "ambNightclubHC2" ))))
            {
                WAIT( 0 );
            }
            ...
            sub_9801( 0 );
            REQUEST_ANIMS( "misstony01" );
            while (((NOT (HAS_MODEL_LOADED( sub_9627( 0 ) ))) || (NOT (sub_10357( 0 )))) || (NOT (HAVE_ANIMS_LOADED( "misstony01" ))))
            {
...
void sub_15063(boolean bParam0, unknown uParam1)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_917() ))) AND ((IS_SCREEN_FADED_OUT()) || (bParam0)))
    {
...
int sub_18812()
{
    if (((NOT (sub_18827( l_U967 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT sub_19011()))
    {
        return 1;
    }
    return 0;
        ...
        if (sub_21660( l_U210[0], l_U210[1], l_U210[2], uParam12, uParam13, uParam14, uParam15, l_U204, uParam17, uParam10, 0, 0 ))
        {
            if (IS_SCREEN_FADED_IN())
            {
                if (IS_CHAR_IN_CAR( sub_917(), uParam10 ))
                {
                    ...
                    sub_22208( uParam16 );
                    sub_22208( uParam20 );
                    if ((uParam18) AND (IS_WANTED_LEVEL_GREATER( sub_4777(), 0 )))
                    {
                        ...
                        if (((NOT (sub_26362( 0 ))) AND (NOT sub_27722())) AND (NOT l_U170))
                        {
                ...
                else if (((uParam18) AND (IS_WANTED_LEVEL_GREATER( sub_4777(), 0 ))) AND (NOT l_U185))
                {
                    sub_22208( uParam16 );
                    sub_22208( uParam20 );
                    if ((DOES_BLIP_EXIST( l_U201 )) || (DOES_BLIP_EXIST( l_U196 )))
...
void sub_20250()
{
    ...
    for ( I = 0; I < l_U210; I++ )
    {
        if (DOES_CHAR_EXIST( l_U210[I] ))
        {
            if (NOT (IS_CHAR_INJURED( l_U210[I] )))
            {
                if (((IS_CHAR_SITTING_IN_ANY_CAR( l_U210[I] )) AND (sub_20343( l_U210[I] ))) AND (sub_20408()))
                {
    ...
    if (IS_PLAYER_PLAYING( sub_4777() ))
    {
        ...
        {
            if (((IS_CHAR_SITTING_IN_ANY_CAR( sub_917() )) AND (sub_20343( sub_917() ))) AND (sub_20408()))
            {
...
int sub_21660(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, int iParam9, unknown uParam10, unknown uParam11)
{
    ...
    if (((NOT sub_21831()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_917() ))) AND (NOT (DOES_VEHICLE_EXIST( iParam9 ))))
    {
            ...
            if (NOT (IS_CHAR_INJURED( l_U210[I] )))
            {
                ...
                if (IS_CHAR_SITTING_IN_ANY_CAR( sub_917() ))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( iVar26 ))
                    {
                        ...
                        {
                            if ((NOT sub_21831()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_917() )))
                            {
                ...
                if (((NOT (IS_GROUP_MEMBER( l_U210[I], sub_22318() ))) AND (NOT (sub_23263( l_U210[I], iParam9 )))) AND (NOT (sub_23359( l_U210[I], iParam9 ))))
                {
                ...
                {
                    if (((sub_24314( l_U210[I] )) || (sub_23263( l_U210[I], iParam9 ))) || (uParam11))
                    {
                        if (DOES_BLIP_EXIST( l_U197[I] ))
                        {
                            REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U197[I] );
        ...
        if (iVar15 > 0)
        {
            for ( I = 0; I < 3; I++ )
            {
                if (iVar20[I])
                {
                    if (NOT (IS_CHAR_INJURED( l_U210[I] )))
                    {
                        if ((sub_22520( l_U210[I] )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U210[I], sub_917(), 40.00000000, 40.00000000, 40.00000000, 0 )))
                        {
                            iVar15--;
                            iVar20[I] = 0;
                        }
        ...
        if (IS_VEH_DRIVEABLE( iVar3 ))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                ...
                if (IS_VEH_DRIVEABLE( iVar4 ))
                {
                    if (iVar3 == iVar4)
                    {
                        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_917(), uParam0, 20.00000000, 20.00000000, 20.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( uParam0, iVar4, 20.00000000, 20.00000000, 20.00000000, 0 )))
                        {
                            return 1;
                        }
                    }
...
{
    if (((((IS_MESSAGE_BEING_DISPLAYED()) || (((sub_20408()) AND (NOT bParam0)) || ((sub_26387()) AND (bParam0)))) || (sub_26416())) || (IS_SCRIPTED_CONVERSATION_ONGOING())) || (sub_19011()))
    {
        return 1;
    }
    return 0;
...
int sub_28121()
{
    ...
    if (IS_CHAR_SITTING_IN_ANY_CAR( sub_917() ))
    {
        if ((IS_CHAR_ON_ANY_BIKE( sub_917() )) || (IS_CHAR_IN_ANY_HELI( sub_917() )))
        {
            iVar2 = 0;
        }
    }
    if (l_U188)
    {
        ...
        {
            if ((sub_28211( 1, iVar2 )) || (l_U182))
            {
                return 1;
            }
        }
    }
    else if ((sub_28211( 1, iVar2 )) || (l_U182))
    {
        return 1;
    }
    return 0;
...
void sub_34579()
{
    ...
    else if (((l_U1017 > 0) AND (NOT l_U1021)) AND (IS_SCREEN_FADED_IN()))
    {
        if (sub_34647())
        {
            CLEAR_PRINTS();
    ...
    switch (l_U1017)
    {
        ...
        if (sub_18668( l_U958 ))
        {
            ...
            if ((fVar4 >= 270.00000000) || (fVar4 <= 90.00000000))
            {
        ...
        if (NOT l_U1019)
        {
            ...
            SET_CAM_POS( l_U877[4], -451.82240000, 366.78890000 + 1.20210000, 12.29029000 );
            ...
            SET_CAM_POS( l_U877[7], -452.02690000, 357.51140000, 11.55228000 );
            ...
            SET_CAM_POS( l_U877[13], -451.47800000, 356.98650000 + 1.20210000, 11.66443000 );
            ...
            SET_CAM_ROT( l_U877[15], 8.94761800, -0.00000000, 135.97580000 );
            ...
            SET_CAM_ROT( l_U877[16], 8.94761800, 0.00000000, 145.25140000 );
        ...
        else
        {
            ...
            SET_CAM_ACTIVE( l_U877[0], 1 );
            SET_CAM_PROPAGATE( l_U877[0], 1 );
            SET_CAM_POS( l_U877[1], -452.45540000, 351.80630000 + 1.47070000, 12.69933000 - 0.18970000 );
            ...
            SET_CAM_ROT( l_U877[10], -0.21971400, -0.00000000, 58.81625000 );
            SET_CAM_FOV( l_U877[10], 37.80002000 );
        ...
        if (sub_18668( l_U958 ))
        {
            ...
            {
                SET_CAR_COORDINATES( l_U958, -449.09360000, 359.64210000, 9.92660000 );
        ...
        if ((sub_19106( "E2T1_TROY", ref l_U967, 6, 1 )) || (TIMERA() > 15000))
        {
            if (NOT (IS_CHAR_INJURED( l_U870 )))
            {
                if (NOT l_U1019)
        ...
        if (NOT l_U1018)
        {
            if (((sub_18827( l_U967 )) AND (TIMERA() > 500)) || (TIMERA() > 1500))
            {
                if (NOT (IS_CHAR_INJURED( l_U870 )))
                {
                    if (NOT (IS_CHAR_INJURED( g_U30210 )))
        ...
        break;
        case 3:
        if ((NOT (IS_CHAR_INJURED( g_U30210 ))) || (TIMERA() > 10000))
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( g_U30210, -447.66690000, 356.51920000, 10.73690000, 1.60000000, 4.00000000, 2.00000000, 0 )) || (TIMERA() > 10000))
            {
                if (NOT l_U1019)
                {
        ...
        if ((sub_19106( "E2T1_TROY2", ref l_U967, 6, 1 )) || (TIMERA() > 15000))
        {
            if (NOT (IS_CHAR_INJURED( g_U30210 )))
            {
        ...
        case 5:
        iVar3 = sub_40880( l_U967 );
        if (((sub_40880( l_U967 )) > 0) || (TIMERA() > 10000))
        {
            SETTIMERA( 0 );
            l_U1017 = 6;
        }
        ...
        case 6:
        iVar3 = sub_40880( l_U967 );
        if (((sub_40880( l_U967 )) > 2) || (TIMERA() > 10000))
        {
            SETTIMERA( 0 );
            l_U1017 = 7;
        }
        ...
        case 7:
        iVar3 = sub_40880( l_U967 );
        if (((sub_40880( l_U967 )) > 4) || (TIMERA() > 10000))
        {
            SETTIMERA( 0 );
            l_U1017 = 8;
        }
        ...
        break;
        case 9:
        if (((NOT (sub_18827( l_U967 ))) || (TIMERA() > 20000)) || (l_U1021))
        {
            sub_42258();
...
void sub_43916()
{
    switch (l_U220)
    {
        ...
        break;
        case 1:
        sub_18621( -459.44330000, 161.08140000, 8.80710000, 176.15230000 );
        if (sub_18668( l_U958 ))
        {
...
void sub_45337()
{
    ...
    else if (((l_U1025 > 0) AND (NOT l_U1029)) AND (IS_SCREEN_FADED_IN()))
    {
        if (sub_34647())
        {
            CLEAR_PRINTS();
    ...
    switch (l_U1025)
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U958 )))
        {
            ...
            if ((fVar2 > 270.00000000) || (fVar2 < 90.00000000))
            {
                l_U1030 = 1;
            }
        }
        ...
        if (NOT l_U1030)
        {
            ...
            SET_CAM_ROT( l_U877[21], 5.91264700, -0.00000000, 59.44118000 );
            ...
            SET_CAM_ROT( l_U877[22], 5.91264600, -0.00000000, 76.97369000 );
        ...
        else
        {
            ...
            SET_CAM_FOV( l_U877[18], 23.40005000 );
            ...
            SET_CAM_FOV( l_U877[19], 23.40005000 );
            ...
            SET_CAM_ACTIVE( l_U877[24], 0 );
            SET_CAM_PROPAGATE( l_U877[24], 0 );
            SET_CAM_POS( l_U877[25], -461.70960000, 153.47980000, 9.99398500 );
            SET_CAM_ROT( l_U877[25], 5.15262600, 0.00000000, 90.51498000 );
            SET_CAM_FOV( l_U877[25], 45.00000000 );
            SET_CAM_ACTIVE( l_U877[25], 0 );
            SET_CAM_PROPAGATE( l_U877[25], 0 );
            ...
            if (NOT (IS_CAR_DEAD( l_U958 )))
            {
                SET_CAR_COORDINATES( l_U958, -460.57580000, 152.45880000, 8.74830000 );
        ...
        if (TIMERA() > (l_U1031 + 3000))
        {
            ...
            CLEAR_AREA( -455.78880000, 153.87300000, 9.91250000, 3.00000000, 1 );
            SET_CURRENT_CHAR_WEAPON( sub_917(), 0, 0 );
            SETTIMERA( 0 );
            l_U1025 = 2;
        }
        ...
        if (NOT (IS_CHAR_INJURED( l_U870 )))
        {
            if (((TIMERA() > 5000) || ((LOCATE_CHAR_ON_FOOT_3D( sub_917(), -461.76560000, 151.37690000, 9.86360000, 1.00000000, 9.00000000, 2.00000000, 0 )) AND (NOT l_U1030))) || ((LOCATE_CHAR_ON_FOOT_3D( l_U870, -461.76560000, 151.37690000, 9.86360000, 1.00000000, 9.00000000, 2.00000000, 0 )) AND (l_U1030)))
            {
                if (NOT (sub_18827( l_U967 )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U870 )))
        ...
        if ((IS_KEYBOARD_KEY_JUST_PRESSED( 2 )) || (IS_SCREEN_FADED_OUT()))
        {
            sub_42258();
...
void sub_51240()
{
    ...
    else if (((l_U1033 > 0) AND (NOT l_U1036)) AND (IS_SCREEN_FADED_IN()))
    {
        if (sub_34647())
        {
            CLEAR_PRINTS();
    ...
    switch (l_U1033)
    {
        ...
        while ((NOT (sub_12796( 1, 0 ))) || (NOT (HAS_MODEL_LOADED( 661511415 ))))
        {
            WAIT( 0 );
        ...
        SET_CAM_POS( l_U877[36], -484.09660000, 148.42950000, 7.93662800 );
        ...
        if ((TIMERA() > 3950) || (LOCATE_CHAR_ANY_MEANS_3D( sub_917(), -474.34720000, 155.24610000, 9.50120000, 1.00000000, 1.00000000, 2.00000000, 0 )))
        {
...
void sub_58020()
{
    switch (l_U220)
    {
        ...
        if ((LOCATE_CHAR_ANY_MEANS_3D( sub_917(), -466.20900000, 153.40200000, 10.41900000, 1.60000000, 1.60000000, 1.60000000, 0 )) AND (sub_28211( 1, 1 )))
        {
            sub_17969( 7, 1 );
        }
        break;
        ...
        else if (NOT l_U1043)
        {
            ...
            {
                if ((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "MENUPHONE" ))) || (sub_62456() == 1011))
                {
                    PRINT_HELP( "NAVPHONE" );
                    l_U1043 = 1;
                    GET_GAME_TIMER( ref l_U1046 );
        ...
        if (l_U1049)
        {
            if ((sub_62853( -469.32400000, 153.27400000, 10.41900000, 1.60000000, 1.60000000, 1.60000000, 1, "T1_M05", 0, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_917(), -466.20900000, 153.40200000, 10.41900000, 1.60000000, 1.60000000, 1.60000000, 0 )))
            {
                sub_17969( 7, 1 );
                l_U1053 = 0;
                CLEAR_HELP();
...
int sub_58270()
{
    if (g_U43705)
    {
        ...
        {
            if ((NOT g_U9200) AND (NOT g_U9199))
            {
                return 1;
            }
        }
    }
    else if ((NOT g_U9200) AND (NOT g_U9199))
    {
        return 1;
    }
    return 0;
...
int sub_58563(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_917() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_917() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_59078()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U95._fU60 = uParam0;
...
int sub_62853(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9)
{
    ...
    if (IS_SCREEN_FADED_IN())
    {
        if ((uParam8) AND (IS_WANTED_LEVEL_GREATER( sub_4777(), 0 )))
        {
            if (DOES_BLIP_EXIST( l_U201 ))
            {
                REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U201 );
            ...
            if ((NOT (sub_26362( 0 ))) AND (NOT l_U170))
            {
                sub_22088( uParam9, 0 );
                l_U214 = uParam9;
                l_U170 = 1;
        ...
        if ((LOCATE_CHAR_ON_FOOT_3D( sub_917(), uParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6 )) AND (sub_28121()))
        {
            sub_22208( uParam7 );
            sub_22208( uParam9 );
            sub_17998();
...
void sub_63424()
{
    ...
    {
        case 0:
        if ((sub_63461()) || (sub_32842( l_U1048, 30000 )))
        {
            PRINT_HELP( "PANSWER" );
            GET_GAME_TIMER( ref l_U1048 );
            l_U1047++;
...
void sub_63737()
{
    switch (l_U220)
    {
        ...
        if ((NOT g_U30093[2]) AND (NOT g_U30093[1]))
        {
            g_U2792 = 1;
            if (DOES_VEHICLE_EXIST( l_U958 ))
            {
...
void sub_71801()
{
    ...
    switch (l_U220)
    {
        ...
        REQUEST_MODEL( -1446884113 );
        REQUEST_MODEL( sub_9627( 0 ) );
        while ((((NOT (sub_10357( 7 ))) || (NOT (sub_10357( 3 )))) || (NOT (HAS_MODEL_LOADED( -1446884113 )))) || (NOT (HAS_MODEL_LOADED( sub_9627( 0 ) ))))
        {
            WAIT( 0 );
        }
                ...
                else if (NOT (IS_CHAR_INJURED( l_U872 )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U871 )))
                    {
                        ...
                        else if (NOT (IS_CAR_DEAD( l_U958 )))
                        {
                            ...
                            {
                                if ((sub_24362( sub_917(), l_U871 )) AND (sub_24362( sub_917(), l_U872 )))
                                {
                                    if (l_U1064)
                                    {
                                        l_U1064 = 0;
...
void sub_74191()
{
    ...
    else if (((l_U1069 > 0) AND (NOT l_U1074)) AND (IS_SCREEN_FADED_IN()))
    {
        if (sub_34647())
        {
            CLEAR_PRINTS();
    ...
    switch (l_U1069)
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U958 )))
        {
            ...
            if ((fVar10 >= (329.65580000 - 90.00000000)) || (fVar10 <= ((329.65580000 + 90.00000000) - 360.00000000)))
            {
        ...
        if (NOT l_U1068)
        {
            SET_CAM_POS( l_U877[45], -178.23370000, 1512.50300000, 18.44722000 );
            ...
            SET_CAM_POS( l_U877[46], -177.44800000, 1512.60800000, 18.44722000 );
            SET_CAM_ROT( l_U877[46], -0.03221100, -0.00000000, 179.79300000 );
        ...
        else
        {
            ...
            SET_CAM_ACTIVE( l_U877[48], 0 );
            SET_CAM_PROPAGATE( l_U877[48], 0 );
            SET_CAM_POS( l_U877[49], -174.61590000, 1506.69600000, 19.19396000 );
        ...
        if (NOT l_U1068)
        {
            ...
            SET_CAM_ROT( l_U877[51], -8.21919300, 0.00000000, 179.22550000 );
            ...
            SET_CAM_POS( l_U877[52], -172.58260000, 1527.78500000, 21.46128000 );
            SET_CAM_ROT( l_U877[52], -8.21919300, -0.00000000, 166.87330000 );
        ...
        else
        {
            ...
            SET_CAM_FOV( l_U877[51], 23.40005000 );
            SET_CAM_FAR_DOF( l_U877[51], 40.00000000 );
            SET_CAM_ACTIVE( l_U877[51], 0 );
            SET_CAM_PROPAGATE( l_U877[51], 0 );
            SET_CAM_POS( l_U877[52], -191.31790000, 1496.01700000, 20.76767000 );
            SET_CAM_ROT( l_U877[52], -4.54889200, -0.00000000, -47.49001000 );
            SET_CAM_FOV( l_U877[52], 23.40005000 );
            SET_CAM_FAR_DOF( l_U877[52], 40.00000000 );
            SET_CAM_ACTIVE( l_U877[52], 0 );
            SET_CAM_PROPAGATE( l_U877[52], 0 );
        }
        ...
        break;
        case 1:
        if ((TIMERA() > 2000) AND (NOT (sub_18827( l_U967 ))))
        {
            sub_32671( 0 );
            SETTIMERA( 0 );
        ...
        break;
        case 2:
        if ((NOT (sub_18827( l_U967 ))) || (TIMERA() > 2000))
        {
            if (NOT l_U1068)
            {
        ...
        break;
        case 3:
        if (((NOT l_U1068) AND (TIMERA() > 2000)) || ((l_U1068) AND (TIMERA() > 3500)))
        {
            TASK_CLEAR_LOOK_AT( sub_917() );
            if (NOT (IS_CHAR_INJURED( l_U872 )))
            {
            ...
            if (NOT (IS_CHAR_INJURED( l_U871 )))
            {
                ...
                if (NOT l_U1068)
                {
                    TASK_LOOK_AT_COORD( sub_917(), -181.15930000, 1514.01400000, 18.80326000, 9999999, 4 );
                }
                else
                {
        ...
        break;
        case 4:
        if ((TIMERA() > 10000) || (NOT (sub_18827( l_U967 ))))
        {
            if (NOT (IS_CHAR_DEAD( l_U871 )))
            {
                CLEAR_CHAR_TASKS_IMMEDIATELY( l_U871 );
        ...
        break;
        case 5:
        if ((((IS_KEYBOARD_KEY_JUST_PRESSED( 2 )) || ((NOT l_U1068) AND (TIMERA() > 8500))) || ((l_U1068) AND (TIMERA() > 4000))) || (l_U1074))
        {
            if ((NOT (sub_18827( l_U967 ))) || (l_U1074))
            {
...
vector sub_81423()
{
    if (g_U43133)
    {
        return vector( 17.34300000, 1380.55100000, -449.63300000);
    }
    return vector( 16.88100000, 1389.24700000, -449.25000000);
}
...
int sub_81529(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9)
{
    ...
    if (IS_SCREEN_FADED_IN())
    {
        ...
        if ((LOCATE_CHAR_ANY_MEANS_3D( sub_917(), uParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6 )) AND (sub_28121()))
        {
            sub_22208( uParam7 );
            sub_22208( uParam9 );
            sub_17998();
...
void sub_81941()
{
    ...
    else if (((l_U1077 > 0) AND (NOT l_U1080)) AND (IS_SCREEN_FADED_IN()))
    {
        if (sub_34647())
        {
            if (((NOT IS_SCREEN_FADING_OUT()) AND (NOT IS_SCREEN_FADED_OUT())) AND (NOT IS_SCREEN_FADING_IN()))
            {
                CLEAR_PRINTS();
                DO_SCREEN_FADE_OUT( 500 );
                while (NOT IS_SCREEN_FADED_OUT())
    ...
    switch (l_U1077)
    {
        ...
        SET_CAM_POS( l_U877[57], -431.79320000, 1397.02000000, 17.08578000 );
        ...
        SET_CAM_POS( l_U877[58], -434.59090000, 1397.02000000, 17.08578000 );
        ...
        SET_CAM_ROT( l_U877[60], -25.97610000, -0.00000000, -58.57413000 );
        ...
        SET_CAM_ROT( l_U877[61], -25.97610000, -0.00000000, -58.57413000 );
        ...
        SET_CAM_ROT( l_U877[63], -13.52092000, -0.00000000, -64.00137000 );
        ...
        SET_CAM_ROT( l_U877[64], -13.52092000, -0.00000000, -64.00137000 );
        ...
        break;
        case 1:
        if ((TIMERA() > 20000) || (LOCATE_CHAR_ANY_MEANS_3D( sub_917(), -443.40700000, 1389.45600000, 15.47640000, 1.00000000, 3.00000000, 2.00000000, 0 )))
        {
            DO_SCREEN_FADE_OUT( 500 );
            while (NOT IS_SCREEN_FADED_OUT())
            {
        ...
        break;
        case 6:
        if (((IS_KEYBOARD_KEY_JUST_PRESSED( 2 )) || (TIMERA() > 7000)) || (l_U1080))
        {
...
void sub_94749()
{
    switch (l_U988)
    {
        case 0:
        l_U957 = 0;
        if ((COMPARE_STRING( l_U955, "ALSEC" )) AND ((g_U30145[2]) || (g_U30145[1])))
        {
            if (l_U990)
            {
...
void sub_96177()
{
    ...
    switch (l_U991)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U992 )))
        {
            ...
            if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U992, sub_917(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_4777(), l_U992 )) AND (iVar2 != 0))) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_4777(), l_U992 )) AND (iVar2 != 0)))
            {
