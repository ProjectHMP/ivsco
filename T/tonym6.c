void main()
{
    ...
    l_U370 = {-468.55550000, 140.33990000, 8.85910000};
    l_U373 = 129.90300000;
    l_U374 = 104.42500000;
    l_U375 = 184.52100000;
    l_U376 = 90.00000000;
    ...
    while (true)
    {
        ...
        switch (l_U269)
        {
            ...
            switch (l_U402)
            {
                ...
                case 1:
                sub_3475();
                if ((((((((((HAS_MODEL_LOADED( 1448755353 )) AND (HAS_MODEL_LOADED( -836732954 ))) AND (HAS_MODEL_LOADED( 2046537925 ))) AND (HAS_MODEL_LOADED( -183203150 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 1903 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 1904 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 1905 ))) AND (HAS_MODEL_LOADED( sub_4676( 0 ) ))) AND (HAVE_ANIMS_LOADED( "misstonym7" ))) AND (HAVE_ANIMS_LOADED( "missnightclub" )))
                {
                    l_U402++;
                }
                break;
                ...
                break;
                case 4:
                if ((NOT (sub_8136( l_U426 ))) || (sub_8299()))
                {
                    if (g_U30199 != -1)
                    {
                        if (DOES_CHAR_EXIST( g_U29971[g_U30199]._fU12 ))
            ...
            if ((DOES_CHAR_EXIST( l_U296 )) AND (NOT (IS_CHAR_DEAD( l_U296 ))))
            {
            ...
            if (NOT (IS_WANTED_LEVEL_GREATER( sub_947(), 0 )))
            {
                ...
                if (((LOCATE_CHAR_ANY_MEANS_3D( sub_3889(), -466.73030000, 1011.89500000, 8.76500000, 7, 7, 5, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3889(), -578.81230000, 1011.17800000, 8.74770000, 7, 7, 5, 0 ))) || (fVar8 < 17))
                {
                    if (sub_15438( l_U296, sub_3889(), 1 ))
                    {
                        if (NOT l_U340)
            ...
            SET_CAM_FOV( l_U407, 23.40005000 );
            ...
            while (l_U409 == 1)
            {
                switch (l_U410)
                {
                    ...
                    if (TIMERA() > 6000)
                    {
                        ...
                        SET_CAM_POS( l_U407, -509.60640000, 1019.75100000, 10.69092000 );
                    ...
                    SET_CAM_ROT( l_U407, 0.12116700, -0.00000000, -95.58495000 );
                    ...
                    CLEAR_AREA( -519.42390000, 1009.49700000, 8.74690000, 5, 1 );
                    if (NOT (IS_CHAR_DEAD( l_U283[0] )))
                    {
                        SET_CHAR_COORDINATES( l_U283[0], -517.61250000, 1014.58400000, 8.74680000 );
                        SET_CHAR_HEADING( l_U283[0], 172.14190000 );
                    }
                    if (NOT (IS_CHAR_DEAD( l_U283[1] )))
                    {
                        SET_CHAR_COORDINATES( l_U283[1], -518.96180000, 1014.93000000, 8.74680000 );
            ...
            {
                if (((sub_14552( sub_3889(), l_U378[0], 1 )) > 150) || (IS_CHAR_INJURED( l_U378[0] )))
                {
...
void sub_1818()
{
    ...
    {
        if (((sub_1856( 5, g_U575[I] )) == 1) AND (g_U575[I]._fU20))
        {
...
void sub_12376()
{
    ...
    if ((sub_12680( sub_3889(), 1, 1 )) || (sub_12680( sub_3889(), 2, 1 )))
    {
...
{
    if (((((IS_MESSAGE_BEING_DISPLAYED()) || (((sub_13678()) AND (NOT bParam0)) || ((sub_13732()) AND (bParam0)))) || (sub_13761())) || (IS_SCRIPTED_CONVERSATION_ONGOING())) || (sub_13820()))
    {
        return 1;
    }
    return 0;
    ...
    if (sub_18996( l_U243[0], l_U243[1], l_U243[2], uParam11, uParam12, uParam13, uParam14, l_U237, uParam16, 0, 0, 0 ))
    {
        ...
        if (IS_SCREEN_FADED_IN())
        {
            if (sub_24711())
            {
                ...
                sub_19544( uParam15 );
                sub_19544( uParam19 );
                if ((uParam17) AND (IS_WANTED_LEVEL_GREATER( sub_947(), 0 )))
                {
                    ...
                    if (((NOT (sub_13662( 0 ))) AND (NOT sub_24873())) AND (NOT l_U203))
                    {
...
void sub_17648()
{
    ...
    for ( I = 0; I < l_U243; I++ )
    {
        if (DOES_CHAR_EXIST( l_U243[I] ))
        {
            ...
            {
                if (((IS_CHAR_SITTING_IN_ANY_CAR( l_U243[I] )) AND (sub_17741( l_U243[I] ))) AND (sub_13678()))
                {
    ...
    if (IS_PLAYER_PLAYING( sub_947() ))
    {
        ...
        {
            if (((IS_CHAR_SITTING_IN_ANY_CAR( sub_3889() )) AND (sub_17741( sub_3889() ))) AND (sub_13678()))
            {
...
int sub_18996(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, int iParam9, unknown uParam10, unknown uParam11)
{
    ...
    if (((NOT sub_19167()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_3889() ))) AND (NOT (DOES_VEHICLE_EXIST( iParam9 ))))
    {
            ...
            if (NOT (IS_CHAR_INJURED( l_U243[I] )))
            {
                ...
                if (IS_CHAR_SITTING_IN_ANY_CAR( sub_3889() ))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( iVar26 ))
                    {
                        ...
                        {
                            if ((NOT sub_19167()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_3889() )))
                            {
                ...
                if (((NOT (IS_GROUP_MEMBER( l_U243[I], sub_14824() ))) AND (NOT (sub_20563( l_U243[I], iParam9 )))) AND (NOT (sub_20659( l_U243[I], iParam9 ))))
                {
                ...
                {
                    if (((sub_21614( l_U243[I] )) || (sub_20563( l_U243[I], iParam9 ))) || (uParam11))
                    {
        ...
        if (iVar15 > 0)
        {
            for ( I = 0; I < 3; I++ )
            {
                if (iVar20[I])
                {
                    if (NOT (IS_CHAR_INJURED( l_U243[I] )))
                    {
                        if ((sub_19820( l_U243[I] )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U243[I], sub_3889(), 40.00000000, 40.00000000, 40.00000000, 0 )))
                        {
                            iVar15--;
                            iVar20[I] = 0;
                        }
        ...
        if (IS_VEH_DRIVEABLE( iVar3 ))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                ...
                if (IS_VEH_DRIVEABLE( iVar4 ))
                {
                    if (iVar3 == iVar4)
                    {
                        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3889(), uParam0, 20.00000000, 20.00000000, 20.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( uParam0, iVar4, 20.00000000, 20.00000000, 20.00000000, 0 )))
                        {
                            return 1;
                        }
                    }
...
int sub_25415()
{
    ...
    if (IS_CHAR_SITTING_IN_ANY_CAR( sub_3889() ))
    {
        if ((IS_CHAR_ON_ANY_BIKE( sub_3889() )) || (IS_CHAR_IN_ANY_HELI( sub_3889() )))
        {
            iVar2 = 0;
        }
    }
    if (l_U221)
    {
        ...
        {
            if ((sub_25505( 1, iVar2 )) || (l_U215))
            {
                return 1;
            }
        }
    }
    else if ((sub_25505( 1, iVar2 )) || (l_U215))
    {
        return 1;
    }
    return 0;
...
void sub_28773(boolean bParam0, unknown uParam1)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_3889() ))) AND ((IS_SCREEN_FADED_OUT()) || (bParam0)))
    {
...
int sub_37322(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17)
{
    ...
    if (sub_18996( l_U243[0], l_U243[1], l_U243[2], uParam11, uParam12, uParam13, uParam14, l_U237, uParam15, 0, 0, 0 ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((uParam16) AND (IS_WANTED_LEVEL_GREATER( sub_947(), 0 )))
            {
                if (DOES_BLIP_EXIST( l_U234 ))
                {
                    REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U234 );
            ...
            if (LOCATE_CHAR_ANY_MEANS_3D( sub_3889(), uParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6 ))
            {
                ...
                for ( I = 0; I < 3; I++ )
                {
                    if (DOES_CHAR_EXIST( l_U243[I] ))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U243[I] )))
                        {
                            if ((NOT (IS_GROUP_MEMBER( l_U243[I], sub_14824() ))) || (NOT (sub_21614( l_U243[I] ))))
                            {
                                iVar20 = 0;
                            }
                        }
...
void sub_41668()
{
    ...
    SET_CAM_ROT( l_U405, -1.04603800, 0.00000000, -36.51357000 );
