void main()
{
    ...
    l_U373 = {-468.55550000, 140.33990000, 8.85910000};
    l_U376 = 129.90300000;
    l_U377 = 104.42500000;
    l_U378 = 184.52100000;
    l_U379 = 90.00000000;
    ...
    while (true)
    {
        ...
        switch (l_U269)
        {
            ...
            switch (l_U389)
            {
                ...
                case 1:
                sub_3695();
                if ((((((((HAS_MODEL_LOADED( -339587598 )) AND (HAS_MODEL_LOADED( 1730047377 ))) AND (HAS_MODEL_LOADED( -1961627517 ))) AND (HAS_MODEL_LOADED( 1269098716 ))) AND (HAS_MODEL_LOADED( 1969438324 ))) AND (HAS_MODEL_LOADED( 1473654742 ))) AND (HAS_MODEL_LOADED( sub_4901( 0 ) ))) AND (HAVE_ANIMS_LOADED( "misstonym8" )))
                {
                    l_U389++;
                }
                break;
                ...
                break;
                case 4:
                if ((NOT (sub_8308( l_U400 ))) || (sub_8471()))
                {
                    if (g_U30199 != -1)
                    {
                        if (DOES_CHAR_EXIST( g_U29971[g_U30199]._fU12 ))
...
void sub_1722()
{
    ...
    {
        if (((sub_1760( 5, g_U575[I] )) == 1) AND (g_U575[I]._fU20))
        {
...
void sub_10827()
{
    ...
    if ((sub_11288( sub_4109(), 1, 1 )) || (sub_11288( sub_4109(), 2, 1 )))
    {
...
{
    if (((((IS_MESSAGE_BEING_DISPLAYED()) || (((sub_12286()) AND (NOT bParam0)) || ((sub_12340()) AND (bParam0)))) || (sub_12369())) || (IS_SCRIPTED_CONVERSATION_ONGOING())) || (sub_12428()))
    {
        return 1;
    }
    return 0;
...
void sub_13207()
{
    ...
    CREATE_CHAR( 4, 1969438324, -471.08120000, 1633.62600000, 17.93130000, ref l_U395[1], 1 );
            ...
            if (IS_CHAR_IN_CAR( sub_4109(), l_U275 ))
            {
                if (NOT (IS_CHAR_DEAD( l_U290 )))
                {
                    if (IS_CHAR_IN_CAR( l_U290, l_U275 ))
                    {
                        GET_CAR_COORDINATES( l_U275, ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
                        GET_GROUND_Z_FOR_3D_COORD( uVar2._fU0, uVar2._fU4, uVar2._fU8, ref uVar5 );
                        if (((uVar2._fU8 - uVar5) > 30) AND ((uVar2._fU8 - uVar5) < 60))
                        {
                            if (NOT l_U303)
                            {
                                sub_8656( ref l_U400, 1 );
        ...
        if (sub_20409( l_U243[0], l_U243[1], l_U243[2], uParam12, uParam13, uParam14, uParam15, l_U237, uParam17, uParam10, 0, 0 ))
        {
            if (IS_SCREEN_FADED_IN())
            {
                if (IS_CHAR_IN_CAR( sub_4109(), uParam10 ))
                {
                    ...
                    sub_20957( uParam16 );
                    sub_20957( uParam20 );
                    if ((uParam18) AND (IS_WANTED_LEVEL_GREATER( sub_851(), 0 )))
                    {
                        ...
                        if (((NOT (sub_12270( 0 ))) AND (NOT sub_26339())) AND (NOT l_U203))
                        {
                ...
                else if (((uParam18) AND (IS_WANTED_LEVEL_GREATER( sub_851(), 0 ))) AND (NOT l_U218))
                {
                    sub_20957( uParam16 );
                    sub_20957( uParam20 );
                    if ((DOES_BLIP_EXIST( l_U234 )) || (DOES_BLIP_EXIST( l_U229 )))
...
void sub_19044()
{
    ...
    for ( I = 0; I < l_U243; I++ )
    {
        if (DOES_CHAR_EXIST( l_U243[I] ))
        {
            if (NOT (IS_CHAR_INJURED( l_U243[I] )))
            {
                if (((IS_CHAR_SITTING_IN_ANY_CAR( l_U243[I] )) AND (sub_19137( l_U243[I] ))) AND (sub_12286()))
                {
    ...
    if (IS_PLAYER_PLAYING( sub_851() ))
    {
        ...
        {
            if (((IS_CHAR_SITTING_IN_ANY_CAR( sub_4109() )) AND (sub_19137( sub_4109() ))) AND (sub_12286()))
            {
...
int sub_20409(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, int iParam9, unknown uParam10, unknown uParam11)
{
    ...
    if (((NOT sub_20580()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_4109() ))) AND (NOT (DOES_VEHICLE_EXIST( iParam9 ))))
    {
            ...
            if (NOT (IS_CHAR_INJURED( l_U243[I] )))
            {
                ...
                if (IS_CHAR_SITTING_IN_ANY_CAR( sub_4109() ))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( iVar26 ))
                    {
                        ...
                        {
                            if ((NOT sub_20580()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_4109() )))
                            {
                ...
                if (((NOT (IS_GROUP_MEMBER( l_U243[I], sub_21067() ))) AND (NOT (sub_22012( l_U243[I], iParam9 )))) AND (NOT (sub_22108( l_U243[I], iParam9 ))))
                {
                ...
                {
                    if (((sub_23063( l_U243[I] )) || (sub_22012( l_U243[I], iParam9 ))) || (uParam11))
                    {
                        if (DOES_BLIP_EXIST( l_U230[I] ))
                        {
                            REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U230[I] );
        ...
        if (iVar15 > 0)
        {
            for ( I = 0; I < 3; I++ )
            {
                if (iVar20[I])
                {
                    if (NOT (IS_CHAR_INJURED( l_U243[I] )))
                    {
                        if ((sub_21269( l_U243[I] )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U243[I], sub_4109(), 40.00000000, 40.00000000, 40.00000000, 0 )))
                        {
                            iVar15--;
                            iVar20[I] = 0;
                        }
        ...
        if (IS_VEH_DRIVEABLE( iVar3 ))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                ...
                if (IS_VEH_DRIVEABLE( iVar4 ))
                {
                    if (iVar3 == iVar4)
                    {
                        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_4109(), uParam0, 20.00000000, 20.00000000, 20.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( uParam0, iVar4, 20.00000000, 20.00000000, 20.00000000, 0 )))
                        {
                            return 1;
                        }
                    }
...
int sub_26738()
{
    ...
    if (IS_CHAR_SITTING_IN_ANY_CAR( sub_4109() ))
    {
        if ((IS_CHAR_ON_ANY_BIKE( sub_4109() )) || (IS_CHAR_IN_ANY_HELI( sub_4109() )))
        {
            iVar2 = 0;
        }
    }
    if (l_U221)
    {
        ...
        {
            if ((sub_26828( 1, iVar2 )) || (l_U215))
            {
                return 1;
            }
        }
    }
    else if ((sub_26828( 1, iVar2 )) || (l_U215))
    {
        return 1;
    }
    return 0;
...
void sub_30867(boolean bParam0, unknown uParam1)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_4109() ))) AND ((IS_SCREEN_FADED_OUT()) || (bParam0)))
    {
...
void sub_32526()
{
    ...
    if (NOT (IS_CAR_DEAD( l_U275 )))
    {
        ...
        SET_CAR_COORDINATES( l_U275, -456.87830000, 155.73680000, 8.88660000 );
    ...
    else
    {
        ...
        SET_CAM_ROT( l_U384, 1.14287100, -0.00000000, 40.30761000 );
        SET_CAM_FOV( l_U384, 45.00000000 );
    ...
    while (l_U387 == 1)
    {
        switch (l_U388)
        {
            ...
            if (TIMERA() > 10000)
            {
                SET_CAM_POS( l_U383, -449.23900000, 163.41490000, 18.80471000 );
