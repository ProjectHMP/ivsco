            ...
            if (NOT (IS_CHAR_INJURED( g_U30205 )))
            {
                switch (l_U114)
                {
                    ...
                    switch (l_U115)
                    {
                        ...
                        if ((IS_PLAYER_PLAYING( sub_375() )) AND (NOT (IS_CHAR_INJURED( g_U30205 ))))
                        {
                            switch (g_U30191)
                            {
                                case 0:
                                ...
                                SET_CHAR_COORDINATES( g_U30205, -473.99100000, 155.28680000, 8.67680000 );
                        ...
                        if ((l_U103 == 5) AND (IS_SCREEN_FADED_IN()))
                        {
                            if (NOT l_U117)
                            {
                    ...
                    switch (l_U115)
                    {
                        ...
                        switch (g_U30191)
                        {
                            ...
                            if ((IS_PLAYER_PLAYING( sub_375() )) AND (NOT (IS_CHAR_INJURED( g_U30205 ))))
                            {
                                ...
                                SET_CAM_POS( l_U108[2], -472.40230000, 157.35550000, 9.83390000 );
                    ...
                    switch (l_U115)
                    {
                        ...
                        STOP_STREAM();
                        sub_214( 0 );
                        SET_CHAR_COORDINATES( sub_442(), -473.78270000, 160.42720000, 8.66820000 );
                        SET_CHAR_HEADING( sub_442(), 230.40660000 );
                        SET_ROOM_FOR_CHAR_BY_NAME( sub_442(), "E2_MaisonRoomt2" );
                        TASK_LOOK_AT_CHAR( sub_442(), g_U30205, 7000, 0 );
                        CLEAR_CHAR_TASKS_IMMEDIATELY( g_U30205 );
                        SET_CHAR_COORDINATES_NO_OFFSET( g_U30205, -473.09740000, 159.34580000, 9.66900000 );
...
int sub_1261(unknown uParam0)
{
    ...
    if ((GET_STREAM_PLAYTIME() == -1) || (GET_STREAM_PLAYTIME() == 0))
    {
