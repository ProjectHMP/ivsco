void main()
{
    ...
    while (true)
    {
        WAIT( 0 );
        sub_544();
        if (IS_PLAYER_PLAYING( sub_1227() ))
        {
            sub_713();
            if (NOT (IS_WANTED_LEVEL_GREATER( sub_1227(), 0 )))
            {
                if (NOT l_U57)
                {
                    sub_2843();
            ...
            if (DOES_OBJECT_EXIST( l_U22 ))
            {
                ...
                SET_OBJECT_DYNAMIC( l_U22, 0 );
                if ((IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) AND (NOT (sub_3031( l_U22 ))))
                {
                    ...
                    switch (l_U2)
                    {
                        ...
                        if (sub_4672())
                        {
                            if (DOES_OBJECT_EXIST( l_U24 ))
                            {
                                ...
                                else if (NOT sub_3118())
                                {
                                    ...
                                    if (IS_VEH_DRIVEABLE( l_U25 ))
                                    {
                                        sub_5333( "IF IS_VEH_DRIVEABLE(boothCar)\n" );
                                        if (sub_5363( l_U25, l_U33, 15.00000000 ))
                                        {
                                            if ((IS_CHAR_IN_CAR( sub_722(), l_U25 )) AND (NOT (IS_CHAR_IN_ANY_HELI( sub_722() ))))
                                            {
                                                if (NOT (IS_WANTED_LEVEL_GREATER( sub_1227(), 0 )))
                                                {
                                                    if (sub_996())
                                                    ...
                                                    {
                                                        l_U54 = 1;
                                                        sub_5333( "IF NOT isPlayerAbleToDriveCar()\n" );
                                                        l_U38 = 1;
                                                        l_U2 = 3;
                                                    }
                                                }
                                        ...
                                        {
                                            sub_5333( "IF NOT isCarHeadingAcceptable(boothCar, fArmH, 15.0)\n" );
                                        }
                                    }
                                }
                            }
                        ...
                        switch (l_U3)
                        {
                            ...
                            if (l_U38)
                            {
                                sub_5333( "armStage = armOpen & IF bAmbientPedUse\n" );
                                if (IS_VEH_DRIVEABLE( l_U25 ))
                                {
                                    if (DOES_OBJECT_EXIST( l_U24 ))
                                    {
...
void sub_441()
{
    ...
    vVar2 = {551.97590000, 763.48410000, 20.11330000};
...
void sub_713()
{
    if (NOT (IS_CHAR_DEAD( sub_722() )))
    {
        if (DOES_OBJECT_EXIST( l_U24 ))
        {
            if (NOT (sub_796( sub_722() )))
            {
                if ((HAS_CLOSEST_OBJECT_OF_TYPE_BEEN_DAMAGED_BY_CHAR( l_U19._fU0, l_U19._fU4, l_U19._fU8, 3.00000000, -1295524692, sub_722() )) || (l_U42))
                {
                    CLEAR_CHAR_TASKS( sub_722() );
                    ALTER_WANTED_LEVEL_NO_DROP( sub_1227(), 1 );
                    APPLY_WANTED_LEVEL_CHANGE_NOW( sub_1227() );
                    if (NOT (IS_CHAR_INJURED( l_U27 )))
                    {
                        SAY_AMBIENT_SPEECH( l_U27, "TOLL_COME_BACK", 1, 0, 0 );
                    }
...
int sub_3611()
{
    ...
    REQUEST_MODEL( sub_3667() );
    if (((((HAS_MODEL_LOADED( -1295524692 )) AND (HAS_MODEL_LOADED( -1174154857 ))) AND (HAVE_ANIMS_LOADED( "AMB@TOLLBOOTH" ))) AND (REQUEST_AMBIENT_AUDIO_BANK( "SCRIPT_AMBIENT\TOLLBOOTH" ))) AND (HAS_MODEL_LOADED( sub_3667() )))
    {
        return 1;
    }
    return 0;
...
void sub_4239(unknown uParam0)
{
    if (DOES_OBJECT_EXIST( uParam0 ))
    {
        ...
        CREATE_CHAR( 6, sub_3667(), l_U4._fU0, l_U4._fU4, l_U4._fU8, ref l_U27, 1 );
                ...
                if (NOT (IS_CHAR_IN_ANY_HELI( sub_722() )))
                {
                    if (sub_996())
                    {
                        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1227(), 0 )))
                        {
                            if (NOT (sub_796( sub_722() )))
                            {
                                if (IS_SCORE_GREATER( sub_1227(), 4 ))
                                {
                                    l_U58 = 0;
                                }
                            }
...
int sub_5363(unknown uParam0, unknown uParam1, unknown uParam2)
{
    float fVar5;
    float fVar6;
    float fVar7;
...
void sub_5704(unknown uParam0, unknown uParam1)
{
    if (DOES_TEXT_LABEL_EXIST( uParam0 ))
    {
...
int sub_5913(int iParam0)
{
    ...
    STORE_SCORE( sub_1227(), ref iVar3 );
    if (iVar3 >= iParam0)
    {
        ADD_SCORE( sub_1227(), -iParam0 );
        return 1;
        break;
    }
    return 0;
...
void sub_6045(int iParam0, unknown uParam1)
{
    string sVar4;
    ...
    if (NOT (IS_CHAR_INJURED( iParam0 )))
    {
        if (IS_VEH_DRIVEABLE( uParam1 ))
        {
            if (sub_6085( iParam0 ))
            {
                ...
                else if (sub_6522( uParam1 ))
                {
                    sVar4 = "toss_money_dirt";
                }
                else if (sub_6590( uParam1 ))
                {
                    sVar4 = "toss_money_freeway";
                }
                else if (sub_6661( uParam1 ))
                {
                    sVar4 = "toss_money_scooter";
                }
                else if (sub_6732( uParam1 ))
                {
...
int sub_6191(unknown uParam0)
{
    if ((sub_6202( uParam0 )) == 1)
    {
        return 1;
    }
    return 0;
...
int sub_6522(unknown uParam0)
{
    if ((sub_6202( uParam0 )) == 4)
    {
        return 1;
    }
    return 0;
...
int sub_6590(unknown uParam0)
{
    if ((sub_6202( uParam0 )) == 0)
    {
        return 1;
    }
    return 0;
...
int sub_6732(unknown uParam0)
{
    if ((sub_6202( uParam0 )) == 2)
    {
        return 1;
    }
    return 0;
