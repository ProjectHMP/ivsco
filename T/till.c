void main()
{
    ...
    while (l_U5)
    {
        ...
        {
            if ((IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE( l_U19 )) AND (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_337() )))
            {
                switch (l_U18)
                {
                    case 0:
                    ...
                    if (NOT l_U6)
                    {
                        if (IS_PLAYER_PLAYING( sub_337() ))
                        {
                            ...
                            if ((LOCATE_CHAR_ON_FOOT_3D( sub_716(), l_U11._fU0, l_U11._fU4, l_U11._fU8, 1.00000000, 1.00000000, 1.00000000, 0 )) AND (sub_799( l_U17, 0 )))
                            {
...
int sub_799(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_337() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_337() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_337() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_895())
                    {
