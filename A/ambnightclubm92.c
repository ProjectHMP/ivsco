void main()
{
    ...
    while (true)
    {
        ...
        {
            if ((((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ClubSecurity" )) == 0) AND (NOT g_U30153)) AND (NOT g_U12379))
            {
                bVar2 = true;
                if (g_U30093[1])
                {
                ...
                if (g_U15811[31])
                {
                    if (NOT bVar2)
                    {
                        if ((IS_CHAR_IN_AREA_3D( sub_3822(), -474.97280000, 143.74440000, 8.86370000, -471.82280000, 150.54440000, 11.86370000, 0 )) AND (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_985() )))
                        {
...
void sub_7335()
{
    ...
    l_U139[79]._fU4 = 1;
    l_U139[79]._fU56 = 22;
    l_U139[79]._fU28 = {-470.36750000, 159.35130000, 8.66890000};
    l_U139[79]._fU40 = 90.00000000;
    l_U139[80]._fU0 = 1;
    l_U139[80]._fU52 = 2;
    l_U139[80]._fU4 = 2;
    l_U139[80]._fU56 = 11;
    l_U139[80]._fU28 = {-472.47180000, 164.79710000, 8.66890000};
...
void sub_18114()
{
        ...
        else if (NOT g_U15811[35])
        {
            if ((NOT g_U12379) AND (NOT g_U30153))
            {
                if (NOT (l_U1660 == 2))
                {
                    ...
                    {
                        if (((NOT (sub_18479( sub_3822(), l_U1660, 1094713344 ))) || ((l_U1632) AND (NOT (sub_4107( sub_3822(), l_U1660, 0 ))))) || (g_U30110[l_U1660]))
                        {
    ...
    {
        GET_TIME_OF_DAY( ref iVar7, ref uVar8 );
        if (NOT ((g_U30181) AND (l_U1660 == 0)))
        {
            if (NOT g_U15811[35])
            {
                if (((((g_U12379) || (IS_THREAD_ACTIVE( g_U30226[l_U1660] ))) || ((iVar7 >= 21) || (iVar7 < 6))) || (g_U30153)) || (sub_4107( sub_3822(), l_U1660, 0 )))
                {
    ...
    if (((sub_19182( sub_3822(), l_U1660 )) AND (IS_PLAYER_PLAYING( sub_985() ))) AND (NOT ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "rocco1" )) > 0)))
    {
        sub_20162();
        if (g_U30154[l_U1660])
        {
        ...
        switch (l_U1659)
        {
            ...
            {
                if ((sub_28713( sub_3822(), l_U1660 )) AND (NOT g_U30093[l_U1660]))
                {
            ...
            break;
            case 1:
            if ((NOT (sub_4107( sub_3822(), l_U1660, 0 ))) || (NOT (sub_28713( sub_3822(), l_U1660 ))))
            {
                sub_2042();
                l_U1659 = 0;
            }
        ...
        if ((NOT g_U30149[l_U1660]) || (sub_29498()))
        {
            if ((NOT g_U30120[l_U1660]) || (sub_29498()))
            {
                if (g_U30128[l_U1660])
                {
                ...
                if (g_U30114[l_U1660])
                {
                    ...
                    if ((IS_SCREEN_FADED_OUT()) || (sub_4107( sub_3822(), l_U1660, 0 )))
                    {
                ...
                if (g_U30109)
                {
                    for ( I = 0; I < l_U1385; I++ )
                    {
                        if ((l_U1385[I]._fU4 == 10) || (l_U1385[I]._fU4 == 12))
                        {
                            l_U1385[I]._fU16 = 0;
                        }
                    }
        ...
        else if ((IS_THREAD_ACTIVE( g_U30226[l_U1660] )) || (l_U1625))
        {
            sub_74127();
            if (g_U30110[l_U1660])
            {
...
int sub_19182(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_PLAYER_PLAYING( sub_985() ))
    {
        ...
        {
            if (((sub_19456( sub_3822() )) == 5) || ((sub_19456( sub_3822() )) == 3))
            {
                bVar4 = true;
            }
        }
...
void sub_25013()
{
    ...
    if (IS_PLAYER_PLAYING( sub_985() ))
    {
        if ((NOT g_U30153) AND (NOT g_U30179))
        {
            if (NOT l_U1615)
            {
                if ((NOT g_U30093[l_U1660]) AND (NOT l_U1617))
                {
            ...
            else if ((NOT (sub_4135( sub_3822(), l_U1660 ))) || (g_U30093[l_U1660]))
            {
                SET_CHAR_MAX_MOVE_BLEND_RATIO( sub_3822(), 3.00000000 );
                l_U1615 = 0;
            }
...
void sub_25442()
{
    ...
    if (IS_PLAYER_PLAYING( sub_985() ))
    {
        if ((NOT g_U30153) AND (NOT g_U30179))
        {
            if (NOT l_U1617)
            {
                if ((NOT g_U30093[l_U1660]) AND (NOT g_U30153))
                {
                    if (sub_4135( sub_3822(), l_U1660 ))
                    {
            ...
            else
            {
                ...
                if (((((NOT (sub_4135( sub_3822(), l_U1660 ))) || (g_U30093[l_U1660])) || (g_U30153)) || (NOT bVar3)) || (sub_25742( sub_3822() )))
                {
...
void sub_26308()
{
    ...
    if (NOT g_U30167)
    {
        if (((HAS_CUTSCENE_FINISHED()) AND (IS_PLAYER_CONTROL_ON( sub_985() ))) || (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0) AND (l_U1660 == 0)))
        {
            if (IS_PLAYER_PLAYING( sub_985() ))
            {
                if (g_U30153)
                ...
                else if ((((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0) AND (l_U1660 == 0)) || (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "E2EndCredits" )) > 0) AND (l_U1660 == 0)))
                {
                    if ((IS_WANTED_LEVEL_GREATER( sub_985(), 0 )) AND (NOT (sub_4107( sub_3822(), l_U1660, 0 ))))
                    {
                        sub_26587( l_U1660, 2 );
                    }
                    else
                ...
                else if (((IS_WANTED_LEVEL_GREATER( sub_985(), 0 )) || (g_U30093[l_U1660])) || (g_U30149[l_U1660]))
                {
                    sub_26587( l_U1660, 2 );
                }
                else if (l_U1660 == 0)
            ...
            if (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( vVar3.x, vVar3.y, vVar3.z, 1.50000000, iVar2 ))
            {
                switch (g_U30192[l_U1660])
                {
                    ...
                    if ((IS_SCREEN_FADED_OUT()) || (NOT (sub_27042( vVar3, 2.00000000 ))))
                    {
                        fVar8 = -1.00000000;
                    }
    ...
    if (NOT l_U1614)
    {
        if (IS_PLAYER_PLAYING( sub_985() ))
        {
            if (g_U30149[l_U1660])
            {
                ...
                {
                    if (((NOT sub_27935()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())) AND (NOT g_U12379))
                    {
                        switch (l_U1660)
                        {
                            case 0:
...
int sub_27935()
{
    if (((IS_MESSAGE_BEING_DISPLAYED()) || (sub_27951())) || (sub_28002()))
    {
        return 1;
    }
    return 0;
...
void sub_32928()
{
    if (NOT l_U1613)
    {
        if (IS_PLAYER_PLAYING( sub_985() ))
        {
            if ((g_U30093[l_U1660]) AND (NOT (g_U30192[l_U1660] == 1)))
            {
                if (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3822() )))
                {
                    if ((NOT sub_27935()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))
                    {
                        switch (l_U1660)
                        {
                            case 0:
...
void sub_34269()
{
    ...
    if ((IS_PLAYER_PLAYING( sub_985() )) AND (NOT g_U30093[l_U1660]))
    {
        if (((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3822() ))) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_985(), 0 )))) AND (NOT g_U43025))
        {
            if (NOT l_U1609)
            {
                if (NOT l_U1596)
...
int sub_34399(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( uParam0 )))
    {
        ...
        if (((sub_34541( uVar12, uVar15 )) > 0.00000000) AND ((VMAG2( uVar12 )) > 0.50000000))
        {
            return 1;
        }
    }
...
void sub_35286()
{
    ...
    if (NOT g_U30101)
    {
        if (NOT l_U1597)
        {
            ...
            {
                if ((IS_CHAR_SHOOTING( sub_3822() )) || (sub_35354()))
                {
                    g_U30093[l_U1660] = 1;
    ...
    if (NOT g_U30093[l_U1660])
    {
        if (IS_PLAYER_PLAYING( sub_985() ))
        {
            if ((sub_18479( sub_3822(), l_U1660, 1094713344 )) || ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0))
            {
        ...
        if ((uParam0^)[I]._fU0)
        {
            if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU24 )))
            {
                if (NOT g_U30153)
                {
                    if (NOT sub_34851())
                    {
                        if ((IS_PLAYER_TARGETTING_CHAR( sub_985(), (uParam0^)[I]._fU24 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_985(), (uParam0^)[I]._fU24 )))
                        {
                            g_U30093[l_U1660] = 1;
                    ...
                    {
                        if ((l_U1660 == 0) || (((uParam0^)[I]._fU4 == 8) || ((uParam0^)[I]._fU4 == 9)))
                        {
...
void sub_37007()
{
    ...
    if (sub_4107( sub_3822(), l_U1660, 0 ))
    {
        if (sub_37040())
        {
            if (((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "dancing" )) == 0) AND (NOT l_U1604))
            {
                if (NOT g_U30093[l_U1660])
                {
                ...
                if ((((bVar7) || (g_U30105)) AND (sub_38526( 2, 0 ))) AND (iVar8))
                {
                    l_U1724 = "DANC_H01";
                    if (((NOT l_U1598) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) || (g_U30105))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U1709 )))
                        {
                            if (l_U1689 > 30000)
                        ...
                        if ((sub_39010( 2, l_U1724, 0 )) || (g_U30105))
                        {
                            g_U30206 = l_U1709;
                            g_U30190 = l_U1660;
                            l_U1633 = 0;
...
int sub_38526(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_985() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_985() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_985() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_38622())
                    {
...
void sub_42341(int iParam0)
{
    if (iParam0->_fU0)
    {
            ...
            else if (NOT l_U1597)
            {
                if (iParam0->_fU20 > 0)
                {
                    switch (iParam0->_fU4)
                    {
                        ...
                        case 10:
                        case 12:
                        if (((sub_4107( sub_3822(), l_U1660, 1 )) || (sub_28713( sub_3822(), l_U1660 ))) AND ((NOT g_U30103) || (sub_29498())))
                        {
                            iParam0->_fU8 = 1;
                        }
                        break;
                        case 14:
                        if ((NOT l_U1636) AND (NOT g_U30180))
                        {
                            if ((NOT g_U30102) AND (NOT l_U1619))
                            {
        ...
        if (iParam0->_fU8 == 1)
        {
            if ((NOT l_U1597) AND (sub_42962( iParam0 )))
            {
                switch (iParam0->_fU4)
                {
                    case 1:
                    ...
                    {
                        if (((sub_43117( iParam0 )) AND (sub_28713( sub_3822(), l_U1660 ))) AND ((NOT g_U30103) || (sub_29498())))
                        {
                            sub_43936( iParam0 );
                        }
                    }
                    ...
                    if (sub_43117( iParam0 ))
                    {
                        if ((sub_51474( sub_3822(), l_U1660 )) || (sub_42789( (iParam0^) )))
                        {
                            if ((NOT g_U30102) || (sub_42789( (iParam0^) )))
                            {
                                sub_43936( iParam0 );
                            }
                        }
                    ...
                    break;
                    case 6:
                    if ((sub_51474( sub_3822(), l_U1660 )) || (sub_4135( sub_3822(), l_U1660 )))
                    {
                        if (sub_43117( iParam0 ))
                        {
                            sub_43936( iParam0 );
                    ...
                    if (sub_4107( sub_3822(), l_U1660, 1 ))
                    {
                        if (((sub_43117( iParam0 )) AND (sub_28713( sub_3822(), l_U1660 ))) AND (NOT g_U30103))
                        {
                            sub_43936( iParam0 );
                        }
                    }
        ...
        if (iParam0->_fU8 == 2)
        {
            ...
            else
            {
                switch (iParam0->_fU4)
                {
                    ...
                    case 10:
                    case 12:
                    if ((sub_28713( sub_3822(), l_U1660 )) AND ((NOT g_U30103) || (sub_29498())))
                    {
                        sub_52092( iParam0 );
                    }
                    else
                    ...
                    break;
                    case 4:
                    if ((sub_28713( sub_3822(), l_U1660 )) AND (NOT g_U30103))
                    {
                        sub_52092( iParam0 );
                    }
                    else
                    ...
                    else if ((sub_51474( sub_3822(), l_U1660 )) AND (NOT g_U30102))
                    {
                        sub_52092( iParam0 );
                    }
                    else
    ...
    else if (NOT g_U30097[l_U1660])
    {
        if (NOT (iParam0->_fU4 == 0))
        {
            ...
            else if ((((NOT (sub_4107( sub_3822(), l_U1660, 0 ))) AND (NOT (iParam0->_fU4 == 2))) AND (NOT (iParam0->_fU4 == 13))) AND (NOT (iParam0->_fU4 == 9)))
            {
                iParam0->_fU0 = 1;
            }
...
{
    if (((((g_U30162[l_U1660]) || (iParam0->_fU4 == 2)) || (iParam0->_fU4 == 13)) || (iParam0->_fU4 == 6)) || (iParam0->_fU4 == 7))
    {
...
void sub_43936(int iParam0)
{
    ...
    if (iParam0->_fU0)
    {
        if ((sub_43957( iParam0 )) || (l_U1624))
        {
            if (((sub_44028( iParam0 )) || (g_U30114[l_U1660])) || (l_U1624))
            {
                if ((NOT (sub_44859( iParam0->_fU28, g_U30251, g_U30254 ))) || (l_U1624))
                {
                    if ((sub_44959( iParam0 )) || (l_U1624))
                    {
                        if (HAS_MODEL_LOADED( iParam0->_fU48 ))
                        {
                            if (NOT (DOES_CHAR_EXIST( iParam0->_fU24 )))
                            {
                                if (((NOT g_U30093[l_U1660]) || (sub_4107( sub_3822(), l_U1660, 0 ))) || (l_U1624))
                                {
...
int sub_44028(int iParam0)
{
    ...
    if (((NOT IS_SCREEN_FADED_OUT()) AND (NOT g_U30114[l_U1660])) AND (IS_PLAYER_CONTROL_ON( sub_985() )))
    {
        ...
        if ((iParam0->_fU16 == -1) AND (iParam0->_fU20 > 0))
        {
            ...
            {
                GET_GAME_VIEWPORT_ID( ref uVar4 );
                if ((CAM_IS_SPHERE_VISIBLE( uVar4, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 2.00000000 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3822(), ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 5.00000000, 5.00000000, 5.00000000, 0 )))
                {
                    return 0;
                }
            }
        ...
        {
            GET_GAME_VIEWPORT_ID( ref uVar4 );
            if ((CAM_IS_SPHERE_VISIBLE( uVar4, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 1.50000000 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_3822(), ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 7.00000000, 7.00000000, 5.00000000, 0 )))
            {
                return 0;
            }
        }
...
int sub_45104(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 15:
        if ((l_U1660 == 0) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Tony6" )) > 0))
        {
            return 1;
        }
        else
...
string sub_46694(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((sub_44859( uParam0, -471.45100000, 139.90120000, 5.00000000, -468.07600000, 156.20120000, 11.86410000 )) || (sub_44859( uParam0, -473.07430000, 139.93400000, 5.00000000, -467.99930000, 142.23400000, 11.86410000 )))
    {
    ...
    if ((sub_44859( uParam0, -398.37480000, 417.79220000, 4.00000000, -377.19980000, 431.96720000, 12.05160000 )) || (sub_44859( uParam0, -397.59980000, 431.71720000, 4.00000000, -383.42480000, 441.21720000, 12.05160000 )))
    {
        return "gaydanceflr";
    }
    ...
    if (DOES_CHAR_EXIST( iParam0->_fU24 ))
    {
        if (NOT (IS_CHAR_INJURED( iParam0->_fU24 )))
        {
            if (NOT (sub_2552( iParam0->_fU24 )))
            {
                ...
                if (NOT (iParam0->_fU12 == 99))
                {
                    if ((sub_3221( iParam0->_fU56 )) || (sub_50008( iParam0->_fU56 )))
                    {
                        BLOCK_CHAR_AMBIENT_ANIMS( iParam0->_fU24, 1 );
                    }
                }
                if (NOT l_U1597)
                {
                    if (sub_54207( iParam0 ))
                    {
                        ...
                        else if (iParam0->_fU12 == 99)
                        {
                            ...
                            if ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU24 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3822(), iParam0->_fU24, 15.00000000, 15.00000000, 5.00000000, 0 ))))
                            {
                                if (l_U1599)
                                {
                        ...
                        switch (iParam0->_fU4)
                        {
                            ...
                            if (NOT g_U30118)
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    if (NOT g_U30093[l_U1660])
                                    {
                                        ...
                                        if (NOT sub_34851())
                                        {
                                            if ((iParam0->_fU24 == l_U1703) || (iParam0->_fU24 == l_U1704))
                                            {
                                                CLEAR_CHAR_TASKS( iParam0->_fU24 );
                                                iParam0->_fU20 = 0;
                                                iParam0->_fU12 = 1;
                                    ...
                                    else if ((iParam0->_fU24 == l_U1703) || (iParam0->_fU24 == l_U1704))
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 91, ref l_U1725 );
                                        if (l_U1725 == 7)
                                        {
                                    ...
                                    break;
                                    case 2:
                                    if ((NOT sub_34851()) AND (sub_4107( sub_3822(), l_U1660, 0 )))
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 29, ref l_U1725 );
                                        if (l_U1725 == 7)
                                        {
                            ...
                            else
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    {
                                        GET_SCRIPT_TASK_STATUS( iParam0->_fU24, 29, ref l_U1725 );
                                        if ((l_U1725 == 7) || (iParam0->_fU20 > 30000))
                                        {
                                            if (NOT (iParam0->_fU16 == -1))
                                            {
                            ...
                            break;
                            default:
                            if ((sub_57830( iParam0 )) || (NOT (LOCATE_CHAR_ANY_MEANS_3D( iParam0->_fU24, ref iParam0->_fU28->_fU0, ref iParam0->_fU28->_fU4, ref iParam0->_fU28->_fU8, 5.00000000, 5.00000000, 5.00000000, 0 ))))
                            {
                                iParam0->_fU12 = 99;
                            }
                            else
                            {
                                switch (iParam0->_fU12)
                                {
                                    ...
                                    else if ((NOT (sub_25914( uVar13 ))) AND (NOT (sub_25914( uVar14 ))))
                                    {
                                    ...
                                    if (sub_25914( sVar15 ))
                                    {
                                        ...
                                        if (l_U1725 == 7)
                                        {
                                            ...
                                            if ((NOT (sub_25914( uVar13 ))) AND (NOT (sub_25914( uVar14 ))))
                                            {
                                                if (NOT (IS_CHAR_PLAYING_ANIM( iParam0->_fU24, uVar14, uVar13 )))
                                                {
...
int sub_57830(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU24 )))
    {
        if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( iParam0->_fU24, sub_3822(), 0 )) || (IS_PED_RAGDOLL( iParam0->_fU24 )))
        {
            return 1;
        }
    }
...
void sub_57976(int iParam0)
{
    ...
    for ( I = 0; I < l_U1534; I++ )
    {
        if ((NOT (I == iParam0->_fU16)) AND (NOT (l_U1534[I]._fU20 == iParam0->_fU24)))
        {
...
int sub_58299(unknown uParam0)
{
    ...
    {
        if ((sub_25914( l_U1476[l_U1534[uParam0]._fU24]._fU0 )) || (sub_25914( sub_52221( l_U1534[uParam0]._fU24 ) )))
        {
            return 1;
        }
    }
...
int sub_60433(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14)
{
    if (NOT (IS_CHAR_INJURED( uParam0._fU24 )))
    {
        if (NOT (sub_4107( uParam0._fU24, l_U1660, 0 )))
        {
            ...
            {
                if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3822(), uParam0._fU24, 60.00000000, 60.00000000, 60.00000000, 0 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_985(), uParam0._fU24 )))
                {
                    return 1;
                }
            }
                        ...
                        if (iParam0->_fU20 > 10000)
                        {
                            switch (iParam0->_fU4)
                            {
                                ...
                                if (l_U1621)
                                {
                                    ...
                                    {
                                        if ((NOT (IS_AMBIENT_SPEECH_PLAYING( l_U1708 ))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( iParam0->_fU24 ))))
                                        {
                                ...
                                if (DOES_CHAR_EXIST( l_U1706 ))
                                {
                                    ...
                                    {
                                        if ((IS_AMBIENT_SPEECH_PLAYING( l_U1706 )) || (l_U1706 == iParam0->_fU24))
                                        {
                                            bVar3 = false;
                                        }
                                    }
                                ...
                                if (NOT bVar4)
                                {
                                    if (bVar3)
                                    {
                                        if (NOT l_U1622)
                                        {
                                            if (((l_U1685 > 6000) AND (iParam0->_fU20 > 20000)) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3822(), iParam0->_fU24, 2.00000000, 2.00000000, 2.00000000, 0 )))
                                            {
                                                GENERATE_RANDOM_INT_IN_RANGE( 0, 5, ref iVar5 );
                                                if (iVar5 < 2)
                                                {
                                                    if ((sub_66355( iParam0->_fU24 )) || (l_U1660 == 0))
                                                    {
                                                ...
                                                else if ((sub_67198( iParam0->_fU24 )) AND (l_U1690 > 20000))
                                                {
                                                    l_U1706 = iParam0->_fU24;
                                ...
                                else if ((l_U1685 > 5000) AND (iParam0->_fU20 > 5000))
                                {
                                ...
                                if (DOES_CHAR_EXIST( l_U1707 ))
                                {
                                    ...
                                    {
                                        if ((IS_AMBIENT_SPEECH_PLAYING( l_U1707 )) || (l_U1707 == iParam0->_fU24))
                                        {
                                            bVar3 = false;
                                        }
                                    }
...
void sub_78197()
{
    ...
    if ((l_U1597) || (g_U30178))
    {
        if ((NOT (l_U1699 == -1)) AND (NOT l_U1630))
        {
    ...
    if (NOT (g_U30197 == -1))
    {
        ...
        else if (((NOT (sub_18479( sub_3822(), g_U30197, l_U1653 ))) || (g_U30177)) || ((g_U30149[l_U1660]) AND (NOT g_U30154[l_U1660])))
        {
            if (l_U1626)
            {
                if (g_U30177)
    ...
    switch (l_U1692)
    {
        ...
        if (fVar2 < l_U1652)
        {
            if (g_U30197 == -1)
            {
                if ((((sub_18479( sub_3822(), l_U1660, l_U1653 )) AND (NOT g_U30177)) AND (NOT ((g_U30149[l_U1660]) AND (NOT g_U30154[l_U1660])))) || (g_U30154[l_U1660]))
                {
...
void sub_82001(int iParam0)
{
    ...
    if ((g_U10597) || (IS_PLAYER_CONTROL_ON( sub_985() )))
    {
...
int sub_82052(unknown uParam0)
{
    ...
    {
        case 1:
        if ((IS_CHAR_IN_AREA_3D( sub_3822(), -474.97280000, 143.74440000, 8.86370000, -471.82280000, 150.54440000, 11.86370000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_3822(), -468.32000000, 156.33000000, 11.46000000, -476.07000000, 166.44000000, 8.74000000, 0 )))
        {
            return 1;
        }
        break;
