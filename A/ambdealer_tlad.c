...
int sub_425()
{
    if (DOES_CHAR_EXIST( l_U105 ))
    {
        ...
        {
            if (NOT (IS_CHAR_IN_ANY_CAR( l_U105 )))
            {
                return 1;
            }
        }
...
void sub_608()
{
    if ((NOT (l_U101 == 2)) AND (NOT (l_U101 == 3)))
    {
...
int sub_715()
{
    ...
    iVar2 = nil;
    if (NOT (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_728() )))
    {
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_782(), 0 )))
        {
...
void sub_1338()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U106 )))
    {
        switch (l_U102)
        {
            ...
            if (((iVar5 < 75) AND (NOT (IS_PED_HOLDING_AN_OBJECT( l_U106 )))) AND (NOT l_U104))
            {
                l_U102 = 2;
            }
            else
