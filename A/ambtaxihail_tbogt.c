...
void sub_1412()
{
    switch (l_U6)
    {
        ...
        break;
        case 2:
        if ((HAVE_ANIMS_LOADED( "AMB@TAXI_HAIL_M" )) AND (HAVE_ANIMS_LOADED( "AMB@TAXI_HAIL_F" )))
        {
            if (IS_VEH_DRIVEABLE( l_U27 ))
            {
                if (NOT (IS_CHAR_INJURED( l_U26 )))
...
int sub_1576(unknown uParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        ...
        fVar4 = l_U15 - 90;
        fVar5 = l_U15 + 89;
        if ((fVar5 > 360) || (fVar4 < 0))
        {
            if (fVar5 > 360)
            {
                fVar5 -= 360;
                if ((((fVar3 < fVar5) AND (fVar3 > 0)) || ((fVar3 > l_U15) AND (fVar3 < 360))) || ((fVar3 < l_U15) AND (fVar3 > fVar4)))
                {
                    l_U23 = 1;
                }
                else
            ...
            {
                fVar4 += 360;
                if ((((fVar3 > fVar4) AND (fVar3 < 360)) || ((fVar3 > 0) AND (fVar3 < l_U15))) || ((fVar3 < fVar5) AND (fVar3 > l_U15)))
                {
                    l_U23 = 1;
                }
                else
        ...
        else if ((fVar3 > fVar4) AND (fVar3 < fVar5))
        {
            l_U23 = 1;
        }
        else
        ...
        if (l_U23)
        {
            if (IS_VEH_DRIVEABLE( uParam0 ))
            {
                if ((((IS_CAR_PASSENGER_SEAT_FREE( uParam0, 1 )) AND (IS_CAR_PASSENGER_SEAT_FREE( uParam0, 2 ))) AND (IS_CAR_PASSENGER_SEAT_FREE( uParam0, 0 ))) AND (LOCATE_CAR_2D( uParam0, l_U8._fU0, l_U8._fU4, 40.00000000, 40.00000000, 0 )))
                {
                    return 1;
                }
                else
...
void sub_3257(int iParam0)
{
    ...
    if ((IS_CHAR_GETTING_IN_TO_A_CAR( sub_236() )) || (IS_CHAR_IN_ANY_CAR( sub_236() )))
    {
