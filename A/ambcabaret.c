void main()
{
    ...
    l_U28 = {966.37210000, -277.24790000, 17.37360000};
    ...
    while (l_U163)
    {
        ...
        if (g_U10978)
        {
            if ((NOT (sub_1554( 5 ))) AND (NOT l_U100))
            {
                l_U13 = 0;
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U9)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_2133() )))
                {
                    ...
                    {
                        if (((NOT sub_3646()) AND (g_U9347)) AND (sub_1554( 5 )))
                        {
                        ...
                        if ((NOT l_U78) AND (NOT (IS_CHAR_IN_AREA_3D( sub_2133(), 946.48000000, -284.36000000, 16.99000000, 968.44000000, -261.10000000, 23.76000000, 0 ))))
                        {
                            sub_2962();
                        }
                        l_U9 = 1;
                ...
                if (l_U75)
                {
                    if ((((g_U9347) AND (NOT sub_3646())) AND (sub_1554( 5 ))) AND (l_U13))
                    {
                        l_U100 = sub_3741( ref l_U95 );
                        if (l_U100)
                        {
                ...
                if (((((((((g_U9347) AND (NOT sub_6702())) AND (NOT sub_6483())) AND (NOT sub_3646())) AND (l_U13)) AND (NOT g_U9893._fU12)) AND (NOT g_U10980)) AND (NOT sub_6808())) AND ((sub_6860()) || (l_U100)))
                {
                    if (NOT l_U12)
                    {
...
void sub_2723()
{
    switch (l_U8)
    {
        ...
        if (NOT (IS_CHAR_INJURED( sub_2133() )))
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_2133(), 957.74120000, -291.33820000, 18.68050000, 5.00000000, 5.00000000, 5.00000000, 0 )) || (sub_2825( sub_2133() )))
            {
                sub_2962();
                l_U82 = -1788328884;
                l_U83 = -2139064254;
        ...
        break;
        case 1:
        while ((NOT (HAS_MODEL_LOADED( l_U82 ))) || (NOT (HAS_MODEL_LOADED( l_U83 ))))
        {
            WAIT( 0 );
        }
        CREATE_OBJECT( l_U84, l_U101._fU0, l_U101._fU4, l_U101._fU8, ref l_U92, 1 );
...
int sub_2825(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        if (((((iVar3 == (GET_HASH_KEY( l_U69 ))) || (iVar3 == (GET_HASH_KEY( l_U70 )))) || (iVar3 == (GET_HASH_KEY( l_U71 )))) || (iVar3 == (GET_HASH_KEY( l_U72 )))) || (iVar3 == (GET_HASH_KEY( l_U73 ))))
        {
            return 1;
        }
    }
...
void sub_3825()
{
    if ((IS_CHAR_INJURED( l_U81 )) AND (NOT (l_U98 == 0)))
    {
