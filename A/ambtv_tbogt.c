void main()
{
    ...
    while (true)
    {
        ...
        if (DOES_OBJECT_EXIST( l_U98 ))
        {
            if ((IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE( l_U98 )) AND (NOT (HAS_OBJECT_BEEN_DAMAGED( l_U98 ))))
            {
                if (IS_PLAYER_PLAYING( sub_581() ))
                {
                    switch (l_U7)
                    {
                        ...
                        else
                        {
                            ...
                            if (((((LOCATE_CHAR_ON_FOOT_3D( sub_667(), l_U77._fU0, l_U77._fU4, l_U77._fU8, 1.00000000, 1.00000000, 1.00000000, 0 )) AND (sub_3054( 4, 0 ))) AND (IS_OBJECT_STATIC( l_U98 ))) AND (NOT g_U12379)) AND (IS_OBJECT_UPRIGHT( l_U98, 1 )))
                            {
                        ...
                        if (NOT g_U10735)
                        {
                            ...
                            else if ((NOT (IS_CHAR_INJURED( sub_667() ))) AND (IS_CHAR_PLAYING_ANIM( sub_667(), "missambtv", "sit_loop" )))
                            {
                        ...
                        if ((HAS_OBJECT_BEEN_DAMAGED( l_U98 )) || (g_U10738 == 1))
                        {
                            if (NOT l_U85)
                            {
                                if (g_U10737)
                        ...
                        if (NOT g_U10735)
                        {
                            ...
                            if (NOT g_U10527)
                            {
                                ...
                                if (USING_STANDARD_CONTROLS())
                                {
                                    if (((((((IS_CONTROL_JUST_PRESSED( 2, 82 )) || (IS_CONTROL_JUST_PRESSED( 2, 79 ))) || (IS_CONTROL_JUST_PRESSED( 2, 80 ))) || (sub_8167())) || (sub_8223())) || (IS_CONTROL_JUST_PRESSED( 2, 66 ))) || (IS_CONTROL_JUST_PRESSED( 2, 67 )))
                                    {
                                ...
                                else if (((((((IS_CONTROL_JUST_PRESSED( 2, 84 )) || (IS_CONTROL_JUST_PRESSED( 2, 79 ))) || (IS_CONTROL_JUST_PRESSED( 2, 80 ))) || (sub_8167())) || (sub_8223())) || (IS_CONTROL_JUST_PRESSED( 2, 66 ))) || (IS_CONTROL_JUST_PRESSED( 2, 67 )))
                                {
...
int sub_3054(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_581() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_581() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_581() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_3150())
                    {
