        ...
        switch (l_U3)
        {
            ...
            else if (sub_238())
            {
                if (NOT (IS_CHAR_INJURED( sub_2249() )))
                {
                    ...
                    {
                        if ((sub_2845( l_U7 )) AND (g_U10518 == 0))
                        {
                            sub_2442();
                            if (sub_2525( l_U5, l_U7 ))
                            {
        ...
        switch (l_U4)
        {
            ...
            else if (sub_238())
            {
                if (NOT (IS_CHAR_INJURED( sub_2249() )))
                {
                    ...
                    {
                        if ((sub_2845( l_U10 )) AND (g_U10519 == 0))
                        {
                            sub_3536();
                            if (sub_2525( l_U6, l_U10 ))
                            {
...
int sub_2668()
{
    if (NOT sub_238())
    {
        if ((NOT g_U10500) AND (NOT g_U10518))
        {
            return 1;
        }
    }
...
int sub_3689()
{
    if (NOT sub_238())
    {
        if ((NOT g_U10501) AND (NOT g_U10519))
        {
            return 1;
        }
    }
