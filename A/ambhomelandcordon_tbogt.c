...
int sub_354()
{
    ...
    if ((((HAS_MODEL_LOADED( l_U4 )) AND (HAS_MODEL_LOADED( sub_395() ))) AND (HAS_MODEL_LOADED( sub_448() ))) AND (HAS_MODEL_LOADED( l_U124 )))
    {
        return 1;
    }
    else
...
void sub_564()
{
    if (l_U117 > -1)
    {
        switch (l_U117)
        {
            ...
            l_U31[3] = 0.00000000;
            l_U12[4] = {8.16830000, -556.96750000, 13.59220000};
            l_U31[4] = 15.00000000;
