void main()
{
    ...
    l_U135 = {1202.73300000, 1713.70300000, 15.66150000};
    l_U138 = {-1575.97400000, 19.67334000, 9.01100000};
    l_U141 = {-1555.46800000, 9.48290000, 9.01100000};
...
void sub_867()
{
    ...
    if (((((VDIST( l_U117, l_U147[0] )) < 2.00000000) || ((VDIST( l_U117, l_U147[1] )) < 2.00000000)) || ((VDIST( l_U117, l_U147[2] )) < 2.00000000)) || ((VDIST( l_U117, l_U147[3] )) < 2.00000000))
    {
        l_U126 = 897868981;
        l_U176 = 3;
        sub_922();
        sub_1553();
        if (((VDIST( l_U117, l_U147[2] )) < 2.00000000) || ((VDIST( l_U117, l_U147[3] )) < 2.00000000))
        {
            l_U210 = 1;
        }
    }
    ...
    if ((((VDIST( l_U117, l_U163[0] )) < 2.00000000) || ((VDIST( l_U117, l_U163[1] )) < 2.00000000)) || ((VDIST( l_U117, l_U163[2] )) < 2.00000000))
    {
        l_U126 = 676448572;
        l_U176 = 4;
        sub_922();
                ...
                if (NOT g_U10504)
                {
                    if (NOT l_U209)
                    {
                        if (NOT l_U207)
                        {
                            ...
                            {
                                if (((IS_CHAR_ARMED( sub_673(), 7 )) || (IS_CHAR_ON_ANY_BIKE( sub_673() ))) || (IS_WANTED_LEVEL_GREATER( sub_2882(), 0 )))
                                {
                    ...
                    if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U125, sub_673(), 20.00000000, 20.00000000, 20.00000000, 0 ))
                    {
                        ...
                        if ((IS_CHAR_SHOOTING( sub_673() )) AND (g_U12379 == 0))
                        {
                            g_U10504 = 1;
                        }
...
int sub_5039()
{
    ...
    if (l_U176 > 0)
    {
        if (NOT (IS_CHAR_DEAD( sub_673() )))
        {
            ...
            if ((((iVar2 == (GET_HASH_KEY( l_U197 ))) || (iVar2 == (GET_HASH_KEY( l_U198 )))) || (iVar2 == (GET_HASH_KEY( l_U199 )))) || (iVar2 == (GET_HASH_KEY( l_U200 ))))
            {
                return 1;
            }
        }
...
int sub_6044()
{
    ...
    if (l_U176 > 0)
    {
        ...
        {
            GET_KEY_FOR_CHAR_IN_ROOM( sub_673(), ref iVar2 );
            if ((iVar2 == (GET_HASH_KEY( l_U197 ))) || (iVar2 == (GET_HASH_KEY( l_U200 ))))
            {
                return 1;
            }
        }
