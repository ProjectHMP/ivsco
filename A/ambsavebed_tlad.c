        ...
        if (IS_PLAYER_PLAYING( sub_414() ))
        {
            if (NOT (IS_CHAR_DEAD( sub_457() )))
            {
                if (sub_511())
                {
                    ...
                    else if ((NOT (l_U279 == 4)) AND (NOT (IS_BIT_SET( g_U10959._fU0, 4 ))))
                    {
                        if (l_U10._fU132)
                        {
                            if ((g_U11005[l_U10._fU0]._fU0) AND (NOT sub_947()))
                            {
                                if (sub_7209())
                                {
                                    sub_7260();
...
void sub_723()
{
    if ((NOT (HAVE_ANIMS_LOADED( l_U300 ))) AND (NOT (HAS_MODEL_LOADED( -809347846 ))))
    {
        REQUEST_ANIMS( l_U300 );
        REQUEST_MODEL( -809347846 );
    }
...
void sub_812()
{
    if (IS_PLAYER_PLAYING( sub_414() ))
    {
        if (g_U11005[l_U10._fU0]._fU0)
        {
            ...
            {
                if (((((NOT g_U12303) AND (IS_SCREEN_FADED_IN())) AND (NOT IS_MEMORY_CARD_IN_USE())) AND (NOT sub_947())) AND (NOT sub_983()))
                {
