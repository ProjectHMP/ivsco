void main()
{
    ...
    l_U136 = {1026.54700000, -322.49570000, 19.21690000};
    ...
    if (l_U115 < 5.00000000)
    {
        l_U127 = {-608.10930000, -791.44680000, 4.84410000};
        l_U113 = 350.00000000;
        l_U114 = 170.00000000;
        l_U102 = -1870989171;
        l_U118 = 4;
...
void sub_3000()
{
    if (NOT (IS_CHAR_DEAD( sub_2107() )))
    {
        ...
        {
            if (((NOT (IS_PLAYER_TARGETTING_CHAR( sub_3278(), l_U101 ))) AND (NOT (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3278(), l_U101 )))) AND (NOT (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U101, sub_2107(), 0 ))))
            {
...
void sub_5315()
{
    if (NOT (IS_CHAR_DEAD( sub_2107() )))
    {
        ...
        {
            if ((NOT (IS_PLAYER_TARGETTING_CHAR( sub_3278(), l_U101 ))) AND (NOT (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3278(), l_U101 ))))
            {
