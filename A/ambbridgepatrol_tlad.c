                                    ...
                                    if (NOT (IS_CAR_DEAD( l_U6 )))
                                    {
                                        if (NOT (IS_CHAR_IN_CAR( l_U5, l_U6 )))
                                        {
                                            if (NOT (IS_CHAR_INJURED( sub_164() )))
                                            {
                                                ...
                                                {
                                                    if (IS_PLAYER_PLAYING( sub_3942() ))
                                                    {
                                                        ALTER_WANTED_LEVEL_NO_DROP( sub_3942(), 1 );
                                                    }
                                                }
                                            }
                                        }
                                    ...
                                    else if (l_U4 == 7)
                                    {
                                        if (NOT (IS_CHAR_IN_CAR( l_U5, l_U6 )))
                                        {
                                            if (NOT (IS_CHAR_INJURED( sub_164() )))
                                            {
                                                if (LOCATE_CHAR_ON_FOOT_CHAR_3D( sub_164(), l_U5, 1.50000000, 1.50000000, 1.50000000, 0 ))
                                                {
                                                    if (NOT (IS_PLAYER_PLAYING( sub_3942() )))
                                                    {
                                                        ALTER_WANTED_LEVEL_NO_DROP( sub_3942(), 1 );
                                                    }
                                                }
                            ...
                            if (CAN_CREATE_RANDOM_CHAR( 0, 0 ))
                            {
                                ...
                                if (NOT (IS_CHAR_INJURED( l_U5 )))
                                {
                                    ...
                                    if (HAVE_ANIMS_LOADED( "AMB@BRIDGECOPS" ))
                                    {
                                        ...
                                        SAY_AMBIENT_SPEECH( l_U5, sub_2525(), 0, 0, 0 );
                                    }
                                    else
                                    {
                    ...
                    if (IS_THIS_MODEL_A_CAR( uVar6 ))
                    {
                        if (NOT (sub_1382( uVar6 )))
                        {
                            if (CAN_CREATE_RANDOM_CHAR( 0, 0 ))
                            {
                                ...
                                GET_OFFSET_FROM_CAR_IN_WORLD_COORDS( l_U7, 0.00000000, -sub_3044( uVar6 ), 0.00000000, ref uVar3._fU0, ref uVar3._fU4, ref uVar3._fU8 );
                                if (NOT (IS_CHAR_INJURED( l_U5 )))
                                {
                                    if (IS_CHAR_IN_ANY_CAR( l_U5 ))
                                    {
...
void sub_2536(unknown uParam0, unknown Result)
{
...
void sub_3933()
{
    ...
    if (IS_PLAYER_PLAYING( sub_3942() ))
    {
        ...
        if (IS_WANTED_LEVEL_GREATER( sub_3942(), 0 ))
        {
            sub_4705();
        }
    }
