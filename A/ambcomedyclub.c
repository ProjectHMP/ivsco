void main()
{
    ...
    while (true)
    {
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            ...
            if (((g_U9212) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "michelle1" )) == 0)) AND ((l_U6) || (sub_987())))
            {
                if ((LOCATE_CHAR_ANY_MEANS_3D( sub_1306(), l_U152._fU0, l_U152._fU4, l_U152._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (l_U13))
                {
                    if (NOT (IS_WANTED_LEVEL_GREATER( sub_1400(), 0 )))
                    {
                        GET_GAME_TIMER( ref l_U20 );
                        if ((((((NOT l_U5) AND (sub_1460( 1, 1 ))) AND (NOT g_U10980)) AND (NOT sub_1753())) AND (NOT g_U9893._fU12)) AND (NOT (g_U26757 > l_U20)))
                        {
                            if (l_U6)
                            {
                                sub_1838();
                                if ((NOT (IS_CHAR_INJURED( l_U23 ))) AND (NOT (IS_CHAR_ON_FIRE( l_U23 ))))
                                {
...
void sub_1838()
{
    if ((IS_CHAR_INJURED( l_U23 )) AND (NOT (l_U4 == 0)))
    {
...
void sub_6886(unknown uParam0)
{
    ...
    {
        if (NOT (((l_U158._fU0 == 0.00000000) AND (l_U158._fU4 == 0.00000000)) AND (l_U158._fU8 == 0.80000000)))
        {
        ...
        switch (l_U42[uParam0])
        {
            ...
            break;
            case 1:
            if ((NOT l_U12) AND (l_U22 >= l_U33[uParam0]))
            {
                sub_7263( uParam0 );
            }
            break;
...
void sub_10459()
{
    if (NOT (IS_CHAR_INJURED( sub_1306() )))
    {
        if (IS_CHAR_SITTING_IDLE( sub_1306() ))
        {
            ...
            else if (NOT (((l_U158._fU0 == 0.00000000) AND (l_U158._fU4 == 0.00000000)) AND (l_U158._fU8 == 0.80000000)))
            {
...
void sub_11240()
{
    if (NOT ((l_U60[l_U16 + 1]._fU4) == -1))
    {
        ...
        else if ((NOT l_U12) AND (NOT (l_U16 == -1)))
        {
...
void sub_11517()
{
    ...
    if ((IS_VEH_DRIVEABLE( uVar2 )) AND (l_U9))
    {
