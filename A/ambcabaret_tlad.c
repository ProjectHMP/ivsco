void main()
{
    ...
    while (l_U165)
    {
        ...
        if (g_U12303)
        {
            if ((NOT (sub_1477( 8 ))) AND (NOT l_U102))
            {
                l_U15 = 0;
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U11)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_2001() )))
                {
                    ...
                    {
                        if (((NOT sub_3514()) AND (g_U10648)) AND (sub_1477( 8 )))
                        {
                        ...
                        if ((NOT l_U80) AND (NOT (IS_CHAR_IN_AREA_3D( sub_2001(), 946.48000000, -284.36000000, 16.99000000, 968.44000000, -261.10000000, 23.76000000, 0 ))))
                        {
                            sub_2830();
                        }
                        l_U11 = 1;
                ...
                if (l_U77)
                {
                    if ((((g_U10648) AND (NOT sub_3514())) AND (sub_1477( 8 ))) AND (l_U15))
                    {
                        l_U102 = sub_3609( ref l_U97 );
                        if (l_U102)
                        {
                ...
                if (((((((((g_U10648) AND (NOT sub_6552())) AND (NOT sub_6333())) AND (NOT sub_3514())) AND (l_U15)) AND (NOT (IS_BIT_SET( g_U10959._fU0, 4 )))) AND (NOT g_U12305)) AND (NOT sub_6666())) AND ((sub_6718()) || (l_U102)))
                {
                    if (NOT l_U14)
                    {
...
void sub_2591()
{
    switch (l_U10)
    {
        ...
        if (NOT (IS_CHAR_INJURED( sub_2001() )))
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_2001(), 957.74120000, -291.33820000, 18.68050000, 5.00000000, 5.00000000, 5.00000000, 0 )) || (sub_2693( sub_2001() )))
            {
                sub_2830();
                l_U84 = -1788328884;
                l_U85 = -2139064254;
