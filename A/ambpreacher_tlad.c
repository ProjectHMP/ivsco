...
void sub_3371()
{
    if (NOT (l_U105 == 4))
    {
        if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U115, sub_3398(), 0 )) || (IS_PED_IN_COMBAT( l_U115 )))
        {
            TASK_SMART_FLEE_CHAR_PREFERRING_PAVEMENTS( l_U115, sub_3398(), 300, -1 );
            l_U105 = 4;
        }
    }
    switch (l_U105)
