...
void sub_677()
{
    ...
    if (IS_PLAYER_PLAYING( sub_585() ))
    {
        if (IS_CHAR_IN_ANGLED_AREA_3D( sub_722(), l_U43[l_U4]._fU0, l_U43[l_U4]._fU4, l_U43[l_U4]._fU8, l_U74[l_U4]._fU0, l_U74[l_U4]._fU4, l_U74[l_U4]._fU8, l_U105[l_U4], 0 ))
        {
            l_U5 = 0;
            bVar2 = true;
        }
        ...
        if (bVar2)
        {
            ...
            else
            {
                ...
                if ((iVar3 - l_U3) >= l_U1)
                {
                    if (IS_CHAR_IN_ANY_HELI( sub_722() ))
                    {
