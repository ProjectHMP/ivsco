...
void sub_963()
{
    ...
    if (iVar3 > 0)
    {
        for ( I = 0; I < iVar3; I++ )
        {
            ...
            if ((NOT (IS_CHAR_INJURED( uVar5 ))) AND (IS_PLAYER_PLAYING( sub_578() )))
            {
...
void sub_1231()
{
    ...
    for ( I = 0; I < 1; I++ )
    {
        if ((l_U211) AND (NOT (IS_STRING_NULL( l_U223[I] ))))
        {
            sub_1303( "iClear: " );
            sub_1322( I );
            sub_1303( ", " );
...
{
    if (((IS_PLAYER_CONTROL_ON( sub_578() )) AND (sub_3814( l_U205 ))) AND (sub_3885()))
    {
        if ((((sub_3911( 1, 1 )) AND (NOT sub_4196())) AND (NOT sub_4294())) AND (NOT sub_4330()))
        {
        ...
        else if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( uParam1 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "BED_TRI" )))
        {
            CLEAR_HELP();
        }
        sub_633( 2, uParam0 );;
...
int sub_4513(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_578() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_578() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_578() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_4330())
                    {
...
void sub_5745(unknown uParam0)
{
    ...
    for ( J = 0; J < 1; J++ )
    {
        ...
        SET_CAM_POS( l_U221[J], -432.99450000, 1395.48900000, 16.66256000 );
...
void sub_7136(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, string sParam4)
{
    switch (uParam0)
    {
        ...
        {
            case 0:
            (uParam2^) = {-435.98010000, 1392.87500000, 15.46250000};
            (uParam3^) = 87.69610000;
            break;
            case 1:
...
void sub_7568()
{
    ...
    if (IS_CAM_PROPAGATING( l_U221[l_U206] ))
    {
        ...
        if (NOT l_U212)
        {
            if ((((NOT (IS_BUTTON_PRESSED( 0, 10 ))) AND (NOT (IS_BUTTON_PRESSED( 0, 11 )))) AND (NOT (IS_BUTTON_PRESSED( 0, 8 )))) AND (NOT (IS_BUTTON_PRESSED( 0, 9 ))))
            {
                l_U212 = 1;
            }
        }
        ...
        if (sub_7621( l_U206 ))
        {
            if (((IS_BUTTON_PRESSED( 0, 10 )) || (IS_GAME_KEYBOARD_NAV_LEFT_PRESSED( 0 ))) || (sub_11697( 10 )))
            {
                if (IS_SCREEN_FADED_IN())
                {
            ...
            else if (((IS_BUTTON_PRESSED( 0, 11 )) || (IS_GAME_KEYBOARD_NAV_RIGHT_PRESSED( 0 ))) || (sub_11697( 11 )))
            {
                if (IS_SCREEN_FADED_IN())
                {
...
void sub_9669(unknown uParam0)
{
    ...
    if (((GET_CHAR_DRAWABLE_VARIATION( sub_156(), 8 )) != 0) || ((GET_CHAR_TEXTURE_VARIATION( sub_156(), 8 )) != 0))
    {
...
void sub_10623()
{
    ...
    if ((l_U233 > (l_U234 + iVar2)) AND ((l_U234 + iVar2) > 0))
    {
...
void sub_12617()
{
    ...
    iVar3 = iVar2 - 1;
    bVar4 = false;
    while ((iVar3 >= sub_12792()) AND (NOT bVar4))
    {
        iVar2 = iVar3;
