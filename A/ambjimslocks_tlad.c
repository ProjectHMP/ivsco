    ...
    switch (l_U118)
    {
        ...
        if (l_U123 == 0)
        {
            if (sub_3816())
            {
                ...
                if ((((DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( l_U102[0]._fU0, l_U102[0]._fU4, l_U102[0]._fU8, 1.50000000, -431164822 )) AND (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( l_U102[1]._fU0, l_U102[1]._fU4, l_U102[1]._fU8, 1.50000000, 866127123 ))) AND (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( l_U102[2]._fU0, l_U102[2]._fU4, l_U102[2]._fU8, 1.50000000, -431164822 ))) AND (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( l_U102[3]._fU0, l_U102[3]._fU4, l_U102[3]._fU8, 1.50000000, 866127123 )))
                {
...
{
    if (((((((((sub_7005( uParam0, "Museum2_back" )) || (sub_7005( uParam0, "Museum2_Hall" ))) || (sub_7005( uParam0, "Museum2_jugs" ))) || (sub_7005( uParam0, "Museum2_display1" ))) || (sub_7005( uParam0, "Museum2_display2" ))) || (sub_7005( uParam0, "Museum2_entrance" ))) || (sub_7005( uParam0, "Museum2_exit" ))) || (sub_7005( uParam0, "Museum2_store" ))) || (sub_7005( uParam0, "Museum2_loading" )))
    {
        return 1;
    }
    return 0;
