void main()
{
    ...
    if (ALLOW_ONE_TIME_ONLY_COMMANDS_TO_RUN())
    {
        ...
        ADD_WIDGET_SLIDER( "Bomb Location", ref g_U11227, -1, 16, 1 );
        ADD_WIDGET_TOGGLE( "Recreate at preset location", ref l_U62 );
        ADD_WIDGET_FLOAT_SLIDER( "x", ref l_U58._fU0._fU0, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "y", ref l_U58._fU0._fU4, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "z", ref l_U58._fU0._fU8, -999999.90000000, 999999.90000000, 0.00100000 );
    ...
    while (IS_PLAYER_PLAYING( sub_632() ))
    {
        ...
        if ((l_U64) || (IS_KEYBOARD_KEY_JUST_PRESSED( 36 )))
        {
            SET_CHAR_COORDINATES( sub_1399(), l_U58._fU0._fU0, l_U58._fU0._fU4, l_U58._fU0._fU8 );
        ...
        switch (l_U74)
        {
            ...
            switch (l_U75)
            {
                ...
                if (DOES_OBJECT_EXIST( l_U77 ))
                {
                    ...
                    if (sub_4225())
                    {
                        if (LOCATE_CHAR_ON_FOOT_3D( sub_1399(), l_U58._fU0._fU0, l_U58._fU0._fU4, l_U58._fU0._fU8, 0.70000000, 0.70000000, 2.00000000, 0 ))
                        {
                            bVar3 = true;
                        }
                    }
                    ...
                    {
                        SHAKE_PAD( 0, 120, 100 );
                        ATTACH_OBJECT_TO_PED( l_U77, sub_1399(), 1202, l_U78, l_U81, 0 );
                        PRINT_HELP( "PK_H04" );
            ...
            switch (l_U75)
            {
                ...
                {
                    if (NOT (IS_CHAR_IN_ANY_CAR( sub_1399() )))
                    {
                        if (sub_4747( 2, 0 ))
                        {
                            bVar3 = true;
                ...
                if ((bVar3) AND (sub_4747( 2, 0 )))
                {
                    if (sub_5040( 2, "PK_H05", 0 ))
                    {
                        REQUEST_MODEL( 410856034 );
                        TASK_SWAP_WEAPON( sub_1399(), 0 );
                        TASK_PLAY_ANIM( sub_1399(), "putdown_low", "pickup_object", 4.00000000, 0, 1, 1, 0, -1 );
                        SETTIMERA( 0 );
                        l_U75++;
                    }
                }
                ...
                break;
                case 1:
                if (NOT (IS_CHAR_PLAYING_ANIM( sub_1399(), "pickup_object", "putdown_low" )))
                {
                    sub_352( 2, "PK_H05" );
                ...
                {
                    GET_CHAR_ANIM_CURRENT_TIME( sub_1399(), "pickup_object", "putdown_low", ref fVar2 );
                    if (fVar2 < 0.50000000)
                    {
                        if (DOES_OBJECT_EXIST( l_U77 ))
                        {
                            ...
                            ATTACH_OBJECT_TO_PED( l_U77, sub_1399(), 1232, l_U84, l_U87, 0 );
                        }
                    }
            ...
            if (NOT sub_6120())
            {
                ...
                if (l_U65)
                {
                    ...
                    for ( I = 0; I < 16; I++ )
                    {
                        ...
                        fVar2 *= TO_FLOAT( I );
                        vVar7 = {sub_6521( vVar7, 0.00000000, 0.00000000, fVar2 )};
...
void sub_898(int iParam0)
{
    ...
    if ((g_U11227 < 0) || (g_U11227 >= 16))
    {
        g_U11227 = 0;
    }
    return l_U1[g_U11227];
}
...
int sub_1348()
{
    ...
    if (IS_PLAYER_PLAYING( sub_632() ))
    {
        GET_CHAR_COORDINATES( sub_1399(), ref vVar20.x, ref vVar20.y, ref vVar20.z );
...
int sub_4236(boolean bParam0, unknown uParam1)
{
    if (bParam0)
    {
        g_U94._fU104 = 1;
...
int sub_4747(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_632() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((IS_PLAYER_CONTROL_ON( sub_632() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_632() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_4843())
                    {
                        if ((GET_OBJECT_PED_IS_HOLDING( sub_1399() )) == nil)
                        {
                            if (g_U10468 <= iParam0)
                            {
                                if (g_U10469 == 0)
...
int sub_5040(unknown uParam0, string sParam1, unknown uParam2)
{
    string sVar5;
    string sVar6;
...
int sub_6120()
{
    ...
    {
        if ((ARE_WIDESCREEN_BORDERS_ACTIVE()) AND (sub_6154()))
        {
            return 1;
        }
...
void sub_6521(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    unknown uVar8;
    unknown uVar9;
    unknown Result;
