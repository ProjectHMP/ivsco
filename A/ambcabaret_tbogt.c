void main()
{
    ...
    l_U30 = {966.37210000, -277.24790000, 17.37360000};
    ...
    while (l_U165)
    {
        ...
        if (g_U12379)
        {
            if ((NOT (sub_1612( 12 ))) AND (NOT l_U102))
            {
                l_U15 = 0;
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U11)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_2064() )))
                {
                    ...
                    {
                        if (((NOT sub_3577()) AND (g_U10718)) AND (sub_1612( 12 )))
                        {
                        ...
                        if ((NOT l_U80) AND (NOT (IS_CHAR_IN_AREA_3D( sub_2064(), 946.48000000, -284.36000000, 16.99000000, 968.44000000, -261.10000000, 23.76000000, 0 ))))
                        {
                            sub_2893();
                        }
                        l_U11 = 1;
                ...
                if (l_U77)
                {
                    if ((((g_U10718) AND (NOT sub_3577())) AND (sub_1612( 12 ))) AND (l_U15))
                    {
                        l_U102 = sub_3673( ref l_U97, 0 );
                        if (l_U102)
                        {
                ...
                if (((((((((g_U10718) AND (NOT sub_6670())) AND (NOT sub_6452())) AND (NOT sub_3577())) AND (l_U15)) AND (NOT (IS_BIT_SET( g_U10938._fU0, 4 )))) AND (NOT g_U12381)) AND (NOT sub_6784())) AND ((sub_6836()) || (l_U102)))
                {
                    if (NOT l_U14)
                    {
...
void sub_2654()
{
    switch (l_U10)
    {
        ...
        if (NOT (IS_CHAR_INJURED( sub_2064() )))
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_2064(), 957.74120000, -291.33820000, 18.68050000, 5.00000000, 5.00000000, 5.00000000, 0 )) || (sub_2756( sub_2064() )))
            {
                sub_2893();
                l_U84 = -1788328884;
                l_U85 = -2139064254;
        ...
        break;
        case 1:
        while ((NOT (HAS_MODEL_LOADED( l_U84 ))) || (NOT (HAS_MODEL_LOADED( l_U85 ))))
        {
            WAIT( 0 );
        }
        CREATE_OBJECT( l_U86, l_U103._fU0, l_U103._fU4, l_U103._fU8, ref l_U94, 1 );
...
int sub_2756(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        if (((((iVar3 == (GET_HASH_KEY( l_U71 ))) || (iVar3 == (GET_HASH_KEY( l_U72 )))) || (iVar3 == (GET_HASH_KEY( l_U73 )))) || (iVar3 == (GET_HASH_KEY( l_U74 )))) || (iVar3 == (GET_HASH_KEY( l_U75 ))))
        {
            return 1;
        }
    }
...
void sub_3774()
{
    if ((IS_CHAR_INJURED( l_U83 )) AND (NOT (l_U100 == 0)))
    {
