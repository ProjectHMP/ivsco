                ...
                if (NOT g_U10441)
                {
                    if (NOT l_U180)
                    {
                        if (NOT l_U178)
                        {
                            ...
                            {
                                if (((IS_CHAR_ARMED( sub_448(), 7 )) || (IS_CHAR_ON_ANY_BIKE( sub_448() ))) || (IS_WANTED_LEVEL_GREATER( sub_1877(), 0 )))
                                {
                    ...
                    if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U125, sub_448(), 20.00000000, 20.00000000, 20.00000000, 0 ))
                    {
                        ...
                        if ((IS_CHAR_SHOOTING( sub_448() )) AND (g_U12303 == 0))
                        {
                            g_U10441 = 1;
                        }
...
int sub_4034()
{
    ...
    if (l_U147 > 0)
    {
        if (NOT (IS_CHAR_DEAD( sub_448() )))
        {
            ...
            if ((((iVar2 == (GET_HASH_KEY( l_U168 ))) || (iVar2 == (GET_HASH_KEY( l_U169 )))) || (iVar2 == (GET_HASH_KEY( l_U170 )))) || (iVar2 == (GET_HASH_KEY( l_U171 ))))
            {
                return 1;
            }
        }
...
int sub_5039()
{
    ...
    if (l_U147 > 0)
    {
        ...
        {
            GET_KEY_FOR_CHAR_IN_ROOM( sub_448(), ref iVar2 );
            if ((iVar2 == (GET_HASH_KEY( l_U168 ))) || (iVar2 == (GET_HASH_KEY( l_U171 ))))
            {
                return 1;
            }
        }
