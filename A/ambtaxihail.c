...
int sub_1560(unknown uParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        ...
        if ((fVar5 > 360) || (fVar4 < 0))
        {
            ...
            {
                fVar5 -= 360;
                if ((((fVar3 < fVar5) AND (fVar3 > 0)) || ((fVar3 > l_U13) AND (fVar3 < 360))) || ((fVar3 < l_U13) AND (fVar3 > fVar4)))
                {
                    l_U21 = 1;
                }
                else
            ...
            {
                fVar4 += 360;
                if ((((fVar3 > fVar4) AND (fVar3 < 360)) || ((fVar3 > 0) AND (fVar3 < l_U13))) || ((fVar3 < fVar5) AND (fVar3 > l_U13)))
                {
                    l_U21 = 1;
                }
                else
        ...
        if (l_U21)
        {
            if (IS_VEH_DRIVEABLE( uParam0 ))
            {
                if ((((IS_CAR_PASSENGER_SEAT_FREE( uParam0, 1 )) AND (IS_CAR_PASSENGER_SEAT_FREE( uParam0, 2 ))) AND (IS_CAR_PASSENGER_SEAT_FREE( uParam0, 0 ))) AND (LOCATE_CAR_2D( uParam0, l_U6._fU0, l_U6._fU4, 40.00000000, 40.00000000, 0 )))
                {
                    return 1;
                }
                else
...
void sub_3241(int iParam0)
{
    ...
    if ((IS_CHAR_GETTING_IN_TO_A_CAR( sub_220() )) || (IS_CHAR_IN_ANY_CAR( sub_220() )))
    {
