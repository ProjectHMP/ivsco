                ...
                if (l_U16)
                {
                    if (IS_PLAYER_PLAYING( sub_1060() ))
                    {
                        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1060(), 0 )))
                        {
                            ...
                            {
                                if ((IS_CLOSEST_OBJECT_OF_TYPE_SMASHED_OR_DAMAGED( l_U18._fU0, l_U18._fU4, l_U18._fU8, 5.00000000, -869586478, 1, 1 )) || (IS_CLOSEST_OBJECT_OF_TYPE_SMASHED_OR_DAMAGED( l_U18._fU0, l_U18._fU4, l_U18._fU8, 5.00000000, -1046467484, 1, 1 )))
                                {
