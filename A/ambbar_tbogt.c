...
void sub_654(unknown uParam0)
{
    if (NOT (IS_CHAR_INJURED( uParam0 )))
    {
        ...
        else if (NOT (IS_CHAR_INJURED( sub_749() )))
        {
            if (IS_CHAR_SHOOTING( sub_749() ))
            {
                l_U14 = 1;
            }
        }
...
void sub_859(unknown uParam0, unknown Result)
{
