...
int sub_338()
{
    ...
    if ((((HAS_MODEL_LOADED( l_U2 )) AND (HAS_MODEL_LOADED( sub_379() ))) AND (HAS_MODEL_LOADED( sub_432() ))) AND (HAS_MODEL_LOADED( l_U122 )))
    {
        return 1;
    }
    else
...
void sub_548()
{
    if (l_U115 > -1)
    {
        switch (l_U115)
        {
            ...
            l_U29[3] = 0.00000000;
            l_U10[4] = {8.16830000, -556.96750000, 13.59220000};
            l_U29[4] = 15.00000000;
