        ...
        if (IS_PLAYER_PLAYING( sub_180() ))
        {
            if (NOT (IS_CHAR_DEAD( sub_223() )))
            {
                if (sub_277())
                {
                    ...
                    else if ((NOT (l_U69 == 4)) AND (NOT (IS_BIT_SET( g_U10938._fU0, 4 ))))
                    {
                        if (l_U10._fU132)
                        {
                            if ((g_U10984[l_U10._fU0]._fU0) AND (NOT sub_713()))
                            {
                                if (sub_6624())
                                {
                                    sub_6675();
...
void sub_489()
{
    if ((NOT (HAVE_ANIMS_LOADED( l_U90 ))) AND (NOT (HAS_MODEL_LOADED( -809347846 ))))
    {
        REQUEST_ANIMS( l_U90 );
        REQUEST_MODEL( -809347846 );
    }
...
void sub_578()
{
    if (IS_PLAYER_PLAYING( sub_180() ))
    {
        if (g_U10984[l_U10._fU0]._fU0)
        {
            ...
            {
                if (((((NOT g_U12379) AND (IS_SCREEN_FADED_IN())) AND (NOT IS_MEMORY_CARD_IN_USE())) AND (NOT sub_713())) AND (NOT sub_749()))
                {
...
void sub_1974()
{
    ...
    if (IS_PLAYER_PLAYING( sub_180() ))
    {
        ...
        {
            if ((LOCATE_CAR_3D( uVar2, l_U10._fU36._fU0, l_U10._fU36._fU4, l_U10._fU36._fU8, 5.00000000, 5.00000000, 1.50000000, 0 )) || (LOCATE_CAR_3D( uVar2, l_U10._fU72._fU0, l_U10._fU72._fU4, l_U10._fU72._fU8, 5.00000000, 5.00000000, 1.50000000, 0 )))
            {
...
void sub_6125(unknown uParam0)
{
    ...
    switch (uVar3)
    {
        ...
        l_U10._fU84 = {-429.57360000, 1394.87100000, 18.02439000};
