...
void sub_1189()
{
    ...
    if ((NOT (HAVE_ANIMS_LOADED( l_U165 ))) || (NOT (HAS_MODEL_LOADED( l_U164 ))))
    {
...
int sub_1721()
{
    if (IS_PED_HOLDING_AN_OBJECT( l_U117 ))
    {
        ...
        {
            if (((IS_CHAR_PLAYING_ANIM( l_U117, "amb@busker", "sax_loop_a" )) || (IS_CHAR_PLAYING_ANIM( l_U117, "amb@busker", "sax_loop_b" ))) || (IS_CHAR_PLAYING_ANIM( l_U117, "amb@default", "busker_default" )))
            {
...
int sub_2505(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_561() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_561() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_561() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_2601())
                    {
