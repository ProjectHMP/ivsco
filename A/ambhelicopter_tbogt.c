...
{
    if (((sub_332( uParam0, 1, 0 )) || (sub_332( uParam0, 2, 0 ))) || (sub_332( uParam0, 0, 0 )))
    {
        return 1;
    }
    return 0;
...
void sub_1603()
{
    switch (l_U2)
    {
        ...
        break;
        case 4:
        l_U3._fU0[0] = {-631.91000000, -359.33000000, 6.23000000};
        ...
        if ((sub_1776( l_U3._fU0[0], l_U3._fU0[1] )) == 0)
        {
            ...
            l_U3._fU56 = {-822.46000000, 1814.62000000, 80.00000000};
        }
        else
        {
            l_U3._fU28 = {-736.53000000, 1749.14000000, 80.00000000};
