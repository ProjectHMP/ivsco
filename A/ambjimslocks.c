...
void sub_1833()
{
    ...
    switch (l_U104)
    {
        ...
        else
        {
            ...
            sub_2539( "\n" );
            if ((NOT sub_2870()) AND (NOT sub_2920()))
            {
                l_U88[0] = {l_U10};
                if (g_U64690)
                {
        ...
        if (l_U109 == 0)
        {
            if (sub_3750())
            {
                ...
                if ((((DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( l_U88[0]._fU0, l_U88[0]._fU4, l_U88[0]._fU8, 1.50000000, -431164822 )) AND (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( l_U88[1]._fU0, l_U88[1]._fU4, l_U88[1]._fU8, 1.50000000, 866127123 ))) AND (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( l_U88[2]._fU0, l_U88[2]._fU4, l_U88[2]._fU8, 1.50000000, -431164822 ))) AND (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( l_U88[3]._fU0, l_U88[3]._fU4, l_U88[3]._fU8, 1.50000000, 866127123 )))
                {
