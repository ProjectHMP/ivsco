...
{
    g_U9152[uParam0]._fU4 = uParam1;
    g_U9152[uParam0]._fU8 = 0;
    return;
}
...
void sub_2370(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    sub_2450( "\n PED NUMBER ", uParam0 );
    sub_2490( " ADDED WITH VOICE ", uParam2 );
    return;
}

void sub_2450(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_2490(unknown uParam0, unknown uParam1)
{
    return;
}
                                ...
                                if (NOT (IS_CHAR_DEAD( l_U156 )))
                                {
                                    ...
                                    if (l_U242 == 0)
                                    {
                                        ...
                                        if (DOES_CHAR_EXIST( l_U156 ))
                                        {
                                            ...
                                            sub_9113( "BO1_POSYES2", ref l_U419, 1, 1 );
                                        }
                                    }
                                    if (l_U242 == 1)
                                    {
...
void sub_9113(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    return sub_9134( uParam0, ref l_U2._fU0, uParam1, uParam2, uParam3 );
}

void sub_9134(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    char[16] cVar7;
    char[12] cVar11;
    unknown uVar14;
    ...
    return sub_9188( ref cVar11, uParam2, uParam3, 0, 0, 0, 0, ref cVar7, uParam4 );
}

int sub_9188(unknown uParam0, int iParam1, unknown uParam2, boolean bParam3, boolean bParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8)
{
    int I;
    int iVar12;
...
void sub_9287(unknown uParam0)
{
    return;
}

void sub_9898(int iParam0, int iParam1)
{
    int I;
                    ...
                    if ((NOT (IS_CHAR_DEAD( l_U156 ))) AND (NOT (IS_CHAR_INJURED( l_U156 ))))
                    {
                        if ((NOT (IS_CHAR_DEAD( l_U157 ))) AND (NOT (IS_CHAR_INJURED( l_U157 ))))
                        {
                            if (LOCATE_CHAR_ANY_MEANS_3D( sub_753(), 957.90000000, -288.65000000, 19.88000000, 3.50000000, 3.50000000, 3.50000000, 0 ))
                            {
                                if (g_U12303 == 1)
                                {
                                    sub_9113( "BO1_AGGNO2", ref l_U419, 5, 1 );
                                }
                                else
                                {
                                    sub_9113( "BO1_AGGNO2", ref l_U419, 6, 1 );
                                }
                                l_U399 = 1;
            ...
            if (IS_PLAYER_PLAYING( sub_927() ))
            {
                if (NOT l_U400)
                {
                    if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_753(), l_U157, 2.00000000, 2.00000000, 2.00000000, 0 ))
                    {
                        if (g_U12303 == 1)
                        {
                            sub_9113( "BO1_NEGYES2", ref l_U419, 5, 1 );
                        }
                        else
                        {
                            sub_9113( "BO1_NEGYES2", ref l_U419, 6, 1 );
                        }
                        l_U400 = 1;
                    }
                }
    ...
    else if (NOT (IS_CHAR_DEAD( l_U157 )))
    {
        if (IS_PLAYER_PLAYING( sub_927() ))
        {
            if (NOT l_U400)
            {
                if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_753(), l_U157, 2.00000000, 2.00000000, 2.00000000, 0 ))
                {
                    sub_9113( "BO1_POSYES2", ref l_U419, 6, 1 );
                    l_U400 = 1;
                }
            }
        }
