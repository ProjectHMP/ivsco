...
void sub_340(int iParam0, string sParam1)
{
    string sVar4;
    ...
    if (NOT (IS_STRING_NULL( sParam1 )))
    {
        if (COMPARE_STRING( sParam1, ref g_U10470 ))
        {
            ...
            if (l_U4)
            {
                ALLOW_PLAYER_TO_CARRY_NON_MISSION_OBJECTS( sub_610(), 1 );
                l_U4 = 0;
            }
            if (l_U2)
            {
...
int sub_1074()
{
    ...
    if (DOES_CHAR_EXIST( l_U113 ))
    {
        if (NOT (IS_CHAR_INJURED( l_U113 )))
        {
            ...
            {
                if (NOT (IS_CHAR_IN_ANY_CAR( sub_1136() )))
                {
                    if (NOT g_U12303)
                    {
                        if (IS_PLAYER_CONTROL_ON( sub_610() ))
                        {
                            GET_INTERIOR_FROM_CHAR( sub_1136(), ref iVar2 );
                            if (NOT (iVar2 == nil))
                            {
                                if (NOT l_U110)
                                {
...
void sub_1431()
{
    ...
    {
        case 0:
        if ((IS_SCORE_GREATER( sub_610(), 9 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_610(), 0 ))))
        {
            l_U105 = 1;
        }
        else
        ...
        if (NOT g_U9223)
        {
            if ((LOCATE_CHAR_ON_FOOT_CHAR_3D( l_U113, sub_1136(), 10.00000000, 10.00000000, 2.00000000, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_610(), 0 ))))
            {
                sub_1735();
            }
        }
        ...
        if (LOCATE_CHAR_ON_FOOT_CHAR_3D( l_U113, sub_1136(), 15.00000000, 15.00000000, 2.00000000, 0 ))
        {
        ...
        break;
        case 4:
        if (LOCATE_CHAR_ON_FOOT_CHAR_3D( l_U113, sub_1136(), 5.00000000, 5.00000000, 2.00000000, 0 ))
        {
            sub_2477();
        }
        else
        ...
        break;
        case 5:
        GET_SCRIPT_TASK_STATUS( sub_1136(), 102, ref l_U137 );
        if (l_U137 == 7)
        {
            sub_4520();
        }
...
void sub_1453()
{
    if ((IS_PED_IN_COMBAT( l_U113 )) || (IS_PED_IN_COMBAT( sub_1136() )))
    {
        sub_340( 2, ref l_U142 );
        l_U105 = 9;
    }
...
void sub_1735()
{
    ...
    TASK_GO_TO_CHAR( 0, sub_1136(), -1, 2.00000000 );
...
void sub_2477()
{
    ...
    if (sub_2501( 2, 0 ))
    {
        if (sub_2790( 2, ref l_U142, 0 ))
        {
            sub_340( 2, ref l_U142 );
            SAY_AMBIENT_SPEECH( l_U113, "THANKS", 0, 0, 0 );
            if (HAVE_ANIMS_LOADED( l_U141 ))
            {
                TASK_PLAY_ANIM_SECONDARY_UPPER_BODY( sub_1136(), "throw_right", l_U141, 12.00000000, 0, 0, 0, 0, -1 );
            }
            l_U105 = 5;
        }
        else
            ...
            else
            {
                ...
                if (l_U137 == 1)
                {
                    ...
                    if (l_U138 > 1)
                    {
                        ...
                        GET_CHAR_COORDINATES( sub_1136(), ref l_U124._fU0, ref l_U124._fU4, ref l_U124._fU8 );
...
int sub_2501(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_610() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((IS_PLAYER_CONTROL_ON( sub_610() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_610() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_2597())
                    {
                        if ((GET_OBJECT_PED_IS_HOLDING( sub_1136() )) == nil)
                        {
                            if (g_U10468 <= iParam0)
                            {
                                if (g_U10469 == 0)
...
int sub_2693(boolean bParam0, unknown uParam1)
{
    if (bParam0)
    {
        g_U94._fU104 = 1;
...
int sub_2790(unknown uParam0, string sParam1, unknown uParam2)
{
    string sVar5;
    string sVar6;
    ...
    if (sub_2501( uParam0, uParam2 ))
    {
        if (((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) || (IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( sParam1, sVar5 ))) || (IS_CONTROL_PRESSED( 2, 23 )))
        {
            if (NOT l_U4)
            {
                ALLOW_PLAYER_TO_CARRY_NON_MISSION_OBJECTS( sub_610(), 0 );
                l_U4 = 1;
            }
            g_U10468 = uParam0;
            l_U5 = 1;
...
void sub_4520()
{
    ...
    if (NOT (IS_CHAR_PLAYING_ANIM( sub_1136(), l_U141, "throw_right" )))
    {
        if (DOES_OBJECT_EXIST( l_U140 ))
        {
            if (IS_OBJECT_ATTACHED( l_U140 ))
        ...
        if (IS_SCORE_GREATER( sub_610(), 9 ))
        {
            ADD_SCORE( sub_610(), -10 );
            l_U108 = 1;
        }
        sub_340( 2, ref l_U142 );
        l_U105 = 6;
    ...
    {
        GET_CHAR_COORDINATES( sub_1136(), ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
        CREATE_OBJECT( l_U117, uVar2._fU0, uVar2._fU4, uVar2._fU8, ref l_U140, 1 );
        ATTACH_OBJECT_TO_PED( l_U140, sub_1136(), 1232, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 0 );
        l_U109 = 1;
    }
    else
    {
        GET_CHAR_ANIM_CURRENT_TIME( sub_1136(), l_U141, "throw_right", ref fVar5 );
        if (fVar5 >= 0.59000000)
        {
            if (DOES_OBJECT_EXIST( l_U140 ))
            {
...
void sub_5509(unknown uParam0, unknown uParam1)
{
    sub_5530( uParam0, uParam1, 0.00000000, "" );
    return;
}

void sub_5530(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
...
void sub_5914()
{
    ...
    ProtectedSet(g_U9255, ProtectedGet(g_U9255) + 1);
    if (ProtectedGet(g_U9255) >= 3)
    {
        switch (g_U9256)
        {
            case 0:
        ...
        CREATE_TEMPORARY_RADAR_BLIPS_FOR_PICKUPS_IN_AREA( l_U146, 200.00000000, g_U9256 );
        l_U111 = 1;
        GET_GAME_TIMER( ref l_U132 );
        ProtectedSet(g_U9255, ProtectedGet(g_U9255) - 3);
    }
    iVar3 = 0;
    iVar4 = 0;
    GET_CURRENT_CHAR_WEAPON( sub_1136(), ref iVar2 );
    if (((iVar2 == 4) || (iVar2 == 5)) || (iVar2 == 18))
    {
        ADD_AMMO_TO_CHAR( sub_1136(), iVar2, 1 );
    }
    else
    {
        GET_MAX_AMMO_IN_CLIP( sub_1136(), iVar2, ref iVar3 );
        if (GET_AMMO_IN_CLIP( sub_1136(), iVar2, ref iVar4 ))
        {
            if (iVar4 < iVar3)
            {
                SET_AMMO_IN_CLIP( sub_1136(), iVar2, iVar3 );
            }
        }
    }
    return;
