...
void sub_908()
{
    ...
    if (iVar3 > 0)
    {
        for ( I = 0; I < iVar3; I++ )
        {
            ...
            if ((NOT (IS_CHAR_INJURED( uVar5 ))) AND (IS_PLAYER_PLAYING( sub_523() )))
            {
...
void sub_1176()
{
    ...
    for ( I = 0; I < 6; I++ )
    {
        if ((l_U89) AND (NOT (IS_STRING_NULL( l_U112[I] ))))
        {
            sub_1248( "iClear: " );
            sub_1267( I );
            sub_1248( ", " );
...
{
    if (((IS_PLAYER_CONTROL_ON( sub_523() )) AND (sub_5874( l_U86 ))) AND (sub_5945()))
    {
        if (sub_5971( 1, 1 ))
        {
...
int sub_6403(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_523() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_523() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_523() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_6499())
                    {
...
void sub_9529()
{
    ...
    if (IS_CAM_PROPAGATING( l_U104[l_U87] ))
    {
        ...
        if (sub_9582( l_U87 ))
        {
            if (((IS_BUTTON_PRESSED( 0, 10 )) || (IS_GAME_KEYBOARD_NAV_LEFT_PRESSED( 0 ))) || (sub_15140( 10 )))
            {
                if (IS_SCREEN_FADED_IN())
                {
            ...
            else if (((IS_BUTTON_PRESSED( 0, 11 )) || (IS_GAME_KEYBOARD_NAV_RIGHT_PRESSED( 0 ))) || (sub_15140( 11 )))
            {
                if (IS_SCREEN_FADED_IN())
                {
        ...
        if (((IS_BUTTON_PRESSED( 0, 8 )) || (IS_GAME_KEYBOARD_NAV_UP_PRESSED( 0 ))) || (sub_15140( 8 )))
        {
            sub_2704( ref uVar22 );
        ...
        else if (((IS_BUTTON_PRESSED( 0, 9 )) || (IS_GAME_KEYBOARD_NAV_DOWN_PRESSED( 0 ))) || (sub_15140( 9 )))
        {
            sub_2704( ref uVar23 );
...
void sub_12904(int iParam0)
{
    ...
    if (iParam0 == 3)
    {
        sub_12904( -1 );
        sub_12929( -1 );
        if (((GET_CHAR_DRAWABLE_VARIATION( sub_138(), 8 )) != 1) || ((GET_CHAR_TEXTURE_VARIATION( sub_138(), 8 )) != 0))
        {
    ...
    else
    {
        ...
        if (((GET_CHAR_DRAWABLE_VARIATION( sub_138(), 8 )) != 0) || ((GET_CHAR_TEXTURE_VARIATION( sub_138(), 8 )) != 0))
        {
...
void sub_13733()
{
    ...
    if ((l_U147 > (l_U148 + iVar2)) AND ((l_U148 + iVar2) > 0))
    {
...
void sub_17057(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        while ((iVar3 >= 0) AND (NOT bVar6))
        {
            ...
            sub_1267( iVar3 );
            sub_1308();
            if ((sub_17244( iVar5 )) AND (NOT (sub_10075( iVar5 ))))
            {
                sub_12592( iVar5 );
                bVar6 = true;
            }
        ...
        {
            iVar15 = iVar13;
            if ((sub_17244( iVar15 )) AND (NOT (sub_10075( iVar15 ))))
            {
                sub_17561( 5, l_U155 );
                l_U90 = 0;
    ...
    switch ((uParam0^))
    {
        ...
        for ( I = iVar3 + 1; I <= (45 - 2); I++ )
        {
            if (NOT bVar5)
            {
                ...
                sub_1267( I );
                sub_1308();
                if ((sub_17244( iVar3 )) AND (NOT (sub_10075( iVar3 ))))
                {
                    sub_12592( iVar3 );
                    bVar5 = true;
                }
        ...
        if (NOT bVar13)
        {
            ...
            for ( J = 0; J <= 20; J++ )
            {
                ...
                {
                    iVar14 = J;
                    if ((sub_17244( iVar14 )) AND (NOT (sub_10075( iVar14 ))))
                    {
                        sub_17561( 5, l_U155 );
                        l_U90 = 0;
                        while (NOT (sub_17806( l_U155 )))
