void main()
{
    ...
    l_U138 = {1026.54700000, -322.49570000, 19.21690000};
    ...
    if (l_U117 < 5.00000000)
    {
        l_U129 = {-608.10930000, -791.44680000, 4.84410000};
        l_U115 = 350.00000000;
        l_U116 = 170.00000000;
        l_U104 = -1870989171;
        l_U120 = 4;
...
void sub_2929()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_2046() )))
    {
        ...
        {
            if ((NOT (IS_PLAYER_TARGETTING_CHAR( sub_3118(), l_U103 ))) AND (NOT (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3118(), l_U103 ))))
            {
            ...
            {
                GET_CURRENT_CHAR_WEAPON( sub_2046(), ref iVar2 );
                if (iVar2 != 0)
                {
                    GET_SCRIPT_TASK_STATUS( l_U103, 7, ref l_U132 );
                    if (l_U132 == 7)
