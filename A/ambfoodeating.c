...
void sub_1719(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    else if ((sub_1731( uParam0 )) == 1)
    {
        ...
        sub_2000( ref l_U179, -65.76537000, 24.98617000, 18.17422000, -16.32347000, 0.00000000, 175.45670000, -65.84908000, 23.93270000, 21.78266000, -16.32347000, 0.00000000, 175.45670000, 45, 8000 );
    }
    ...
    else if ((sub_1731( uParam0 )) == 3)
    {
        ...
        sub_2000( ref l_U179, -307.85300000, 23.18573000, 14.18429000, -6.89211800, 0.00000000, -122.95030000, -307.27470000, 22.81084000, 19.88647000, -6.89211800, 0.00000000, -122.95030000, 45, 8000 );
    }
    else if ((sub_1731( uParam0 )) == 4)
    {
        l_U178 = 0;
        sub_1859( l_U281[4], 87.66080000, -429.86580000, 1182.30000000, 12.06720000, 177.44440000, 1, ref l_U179 );
        sub_2000( ref l_U179, -416.20750000, 1176.64700000, 19.58881000, -27.61243000, 0.00000100, 66.49268000, -416.31450000, 1176.69300000, 19.57940000, -19.41356000, -0.00000000, 66.49268000, 37, 8000 );
    }
    ...
    else if ((sub_1731( uParam0 )) == 7)
    {
        ...
        sub_2000( ref l_U179, -387.22150000, 249.53150000, 21.16422000, -21.45799000, 0.00000000, 104.21760000, -375.83940000, 251.58840000, 24.08780000, -18.42793000, -0.00000100, 127.13010000, 37, 8000 );
    }
    else if ((sub_1731( uParam0 )) == 8)
    {
        l_U178 = 0;
        sub_1859( l_U281[8], 80.27900000, -617.83120000, 148.35490000, 3.80000000, 19.25670000, 1, ref l_U179 );
        sub_2000( ref l_U179, -627.95300000, 165.94190000, 5.46856600, -3.37064700, 0.00000000, -157.06770000, -627.86210000, 165.72680000, 9.43430800, -3.37064700, 0.00000000, -157.06770000, 37, 8000 );
    }
    ...
    else if ((sub_1731( uParam0 )) == 11)
    {
        ...
        sub_2000( ref l_U179, -1252.48000000, 1066.83300000, 19.14869000, 5.11244800, -0.00000000, -44.57520000, -1252.59200000, 1066.71900000, 20.93413000, 5.11244800, -0.00000000, -44.57520000, 36, 8000 );
    }
    ...
    else if ((sub_1731( uParam0 )) == 14)
    {
        ...
        sub_2000( ref l_U179, 1177.11500000, 380.85000000, 25.74579000, -10.08404000, 0.00000000, -107.92820000, 1177.53600000, 380.71370000, 28.23441000, -10.08404000, 0.00000100, -122.44760000, 31, 8000 );
    }
    ...
    else if ((sub_1731( uParam0 )) == 16)
    {
        ...
        sub_2000( ref l_U179, 862.62840000, -473.41850000, 14.69269000, 9.01804300, 0.00000000, -125.63280000, 869.53990000, -473.41850000, 14.69269000, 9.01804300, 0.00000000, -125.63280000, 36, 8000 );
    }
    else if ((sub_1731( uParam0 )) == 17)
    {
        l_U178 = 3;
        sub_1859( l_U281[17], 358.90560000, 28.41270000, 980.65630000, 13.66320000, 270, 1, ref l_U179 );
        sub_2000( ref l_U179, 33.52589000, 989.83890000, 14.46687000, 2.00838800, -0.00000000, 168.49980000, 33.56033000, 989.96430000, 18.20295000, 2.00838800, 0.00000000, 150.89210000, 36, 8000 );
    }
    ...
    else if ((sub_4666( uParam0 )) == 1)
    {
        ...
        sub_2000( ref l_U228, -243.83310000, 33.42586000, 16.66905000, -7.93912000, 0.00000000, -91.20097000, -242.64880000, 39.25813000, 15.99256000, -3.35495600, 0.00000000, -26.32488000, 45, 8000 );
    }
    ...
    else if ((sub_4666( uParam0 )) == 3)
    {
        ...
        sub_2000( ref l_U228, 119.51050000, 549.48020000, 17.40519000, -13.43865000, -0.00000000, 22.74287000, 119.32600000, 549.92030000, 19.40197000, -13.43865000, -0.00000000, 22.74287000, 39, 8000 );
    }
    ...
    else if ((sub_4666( uParam0 )) == 5)
    {
        ...
        sub_2000( ref l_U228, -976.47870000, 911.18230000, 14.82901000, -5.66369300, -0.00000100, 50.16215000, -977.81340000, 912.29600000, 32.35391000, -5.66369300, -0.00000100, 50.16215000, 36, 8000 );
    }
    ...
    else if ((sub_4666( uParam0 )) == 7)
    {
        ...
        sub_2000( ref l_U228, 922.01870000, -508.43680000, 17.34037000, -3.62778100, 0.00000000, -44.61792000, 921.98680000, -499.65600000, 17.34037000, 8.42851100, 0.00000000, -44.61792000, 36, 8000 );
    };;;;;;;;;;;;;;;;;;;;;;;;;;
    return;
}
...
void sub_13512(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25, unknown uParam26, unknown uParam27, unknown uParam28, unknown uParam29, unknown uParam30, unknown uParam31, unknown uParam32, unknown uParam33, unknown uParam34, unknown uParam35, unknown uParam36, unknown uParam37, unknown uParam38, unknown uParam39, unknown uParam40, unknown uParam41, unknown uParam42, unknown uParam43, unknown uParam44, unknown uParam45, unknown uParam46, unknown uParam47, unknown uParam48)
{
    ...
    for ( I = 0; I < 2; I++ )
    {
        if ((NOT (IS_CHAR_INJURED( l_U367[I] ))) AND (NOT (IS_CHAR_INJURED( sub_393() ))))
        {
