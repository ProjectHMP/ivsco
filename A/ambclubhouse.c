        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U167)
            {
                ...
                if (g_U10460)
                {
                    ...
                    while ((NOT (HAS_MODEL_LOADED( l_U160 ))) || (NOT (HAVE_ANIMS_LOADED( "AMB@BAR" ))))
                    {
                        WAIT( 0 );
                    }
                }
                ...
                if (l_U134 == 0)
                {
                    ...
                    {
                        if ((HAS_MODEL_LOADED( -2034268874 )) AND (NOT (CAM_IS_SPHERE_VISIBLE( l_U162, -1717.27000000, 345.23000000, 25.35000000, 2.00000000 ))))
                        {
                            sub_1440();
                            l_U134 = 1;
                        }
