...
void sub_1156()
{
    ...
    if (IS_PLAYER_PLAYING( sub_961() ))
    {
        ...
        {
            if (LOCATE_CHAR_ANY_MEANS_3D( sub_1217(), l_U38[l_U5]._fU0, l_U38[l_U5]._fU4, l_U38[l_U5]._fU8, l_U69[l_U5]._fU0, l_U69[l_U5]._fU4, l_U69[l_U5]._fU8, 0 ))
            {
                bVar2 = true;
            }
        }
        if (bVar2)
        {
            if (NOT l_U108)
            {
                if (IS_CHAR_IN_ANY_CAR( sub_1217() ))
                {
                    l_U109 = 1;
                }
            }
            else if (NOT (IS_CHAR_IN_ANY_CAR( sub_1217() )))
            {
                l_U108 = 0;
            }
        }
        else if (IS_CHAR_IN_ANY_CAR( sub_1217() ))
        {
            l_U108 = 1;
        }
        if (l_U33)
