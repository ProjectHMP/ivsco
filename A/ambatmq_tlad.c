...
void sub_170()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U39 )))
    {
        if (((((((((IS_CHAR_RESPONDING_TO_EVENT( l_U39, 31 )) || (IS_CHAR_RESPONDING_TO_EVENT( l_U39, 9 ))) || (IS_CHAR_RESPONDING_TO_EVENT( l_U39, 75 ))) || (IS_CHAR_RESPONDING_TO_EVENT( l_U39, 43 ))) || (IS_CHAR_RESPONDING_TO_EVENT( l_U39, 50 ))) || (IS_CHAR_RESPONDING_TO_EVENT( l_U39, 65 ))) || (IS_CHAR_RESPONDING_TO_EVENT( l_U39, 59 ))) || (IS_CHAR_RESPONDING_TO_EVENT( l_U39, 51 ))) || (IS_CHAR_RESPONDING_TO_EVENT( l_U39, 61 )))
        {
