void main()
{
    ...
    END_WIDGET_GROUP();
    g_U11226 = 0;
    while ((IS_PLAYER_PLAYING( sub_1317() )) AND (NOT g_U11226))
    {
        switch (l_U106)
        {
            case 0:
            ...
            if ((((HAS_MODEL_LOADED( l_U112 )) AND (HAS_MODEL_LOADED( sub_171( 7 ) ))) AND (HAS_MODEL_LOADED( l_U113 ))) AND (HAS_MODEL_LOADED( g_U11224 )))
            {
                sub_1526( 1 );
            }
            break;
            ...
            if (NOT sub_4088())
            {
                ...
                {
                    if ((IS_VEH_DRIVEABLE( l_U126[0] )) AND (IS_VEH_DRIVEABLE( l_U126[1] )))
                    {
                    ...
                    if (NOT (IS_CHAR_INJURED( l_U109[0] )))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U109[1] )))
                        {
                            if (IS_VEH_DRIVEABLE( l_U126[1] ))
                            {
                                ...
                                {
                                    if ((IS_CHAR_SITTING_IN_CAR( l_U109[1], l_U126[1] )) AND (NOT (IS_CHAR_SITTING_IN_CAR( l_U109[0], l_U126[1] ))))
                                    {
                                        GET_SCRIPT_TASK_STATUS( l_U109[0], 29, ref l_U130 );
                                        if (l_U130 == 7)
                                        {
                                    ...
                                    if ((IS_CHAR_SITTING_IN_CAR( l_U109[0], l_U126[1] )) AND (IS_CHAR_SITTING_IN_CAR( l_U109[1], l_U126[1] )))
                                    {
            ...
            if (NOT sub_6022())
            {
                if (TIMERA() < 60000)
                {
                    if (IS_VEH_DRIVEABLE( l_U126[0] ))
                    {
                        ...
                        {
                            if ((IS_CHAR_IN_CAR( sub_1648(), l_U126[0] )) AND (TIMERA() > 7000))
                            {
        ...
        if (NOT sub_6022())
        {
            if (NOT (l_U106 == 5))
            {
                if ((((DOES_CHAR_EXIST( l_U109[0] )) AND (DOES_CHAR_EXIST( l_U109[1] ))) AND (DOES_VEHICLE_EXIST( l_U126[0] ))) AND (DOES_VEHICLE_EXIST( l_U126[1] )))
                {
                    if ((((IS_CHAR_INJURED( l_U109[0] )) || (IS_CHAR_INJURED( l_U109[1] ))) || (NOT (IS_VEH_DRIVEABLE( l_U126[0] )))) || (NOT (IS_VEH_DRIVEABLE( l_U126[1] ))))
                    {
                        PRINTSTRING( "ABILITY VEHICLE SCRIPT CLEANUP 8 \n" );
                        sub_149();
                    }
...
void sub_2995(unknown uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
    ...
    if (NOT (IS_CHAR_DEAD( (uParam0^) )))
    {
        ...
        if (((uParam0^) == sub_1648()) AND (g_U15728[19]))
        {
            ...
            if (IS_PLAYER_PLAYING( sub_1317() ))
            {
                ...
                if (bVar2)
                {
                    ...
                    else
                    {
                        ...
                        {
                            GET_CHAR_COORDINATES( sub_1648(), ref uVar5._fU0, ref uVar5._fU4, ref uVar5._fU8 );
                            if ((LOCATE_CAR_3D( l_U126[0], l_U123._fU0, l_U123._fU4, l_U123._fU8, 15.00000000, 15.00000000, 4.00000000, 0 )) || (LOCATE_CAR_3D( l_U126[0], uVar5._fU0, uVar5._fU4, uVar5._fU8, 15.00000000, 15.00000000, 2.00000000, 0 )))
                            {
                                CLEAR_CHAR_TASKS( l_U109[0] );
                                return 1;
                            }
...
int sub_6022()
{
    ...
    {
        if ((ARE_WIDESCREEN_BORDERS_ACTIVE()) AND (sub_6056()))
        {
            return 1;
        }
...
int sub_7995()
{
    if (((sub_8004()) || (IS_MESSAGE_BEING_DISPLAYED())) || (IS_HELP_MESSAGE_BEING_DISPLAYED()))
    {
        return 1;
    }
    return 0;
