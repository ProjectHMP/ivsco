...
void sub_1014(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22)
{
    ...
    l_U168 = VDIST( l_U153, 3.35950000, -747.91000000, 5.93000000 );
    if (l_U168 < 5.00000000)
    {
        l_U167 = 1;
    }
    if ((sub_511()) AND (l_U167 == 1))
    {
        CREATE_OBJECT_NO_OFFSET( 1289046123, l_U153._fU0, l_U153._fU4, l_U153._fU8, ref g_U10448, 1 );
        SET_OBJECT_HEADING( g_U10448, l_U159 );
        SET_OBJECT_PROOFS( g_U10448, 1, 1, 1, 1, 1 );
        l_U160 = g_U10448;
    }
    else
    {
...
void sub_1526(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    ...
    if (DOES_OBJECT_EXIST( uParam0 ))
    {
        ...
        else
        {
                        ...
                        if (sub_5564( uParam4 ))
                        {
                            if (NOT (IS_CHAR_DEAD( sub_1654() )))
                            {
                                if (NOT l_U61)
                                {
                                    ...
                                    sub_6008( uParam1, uParam0, uParam5 );
                                    l_U126 = 0;
                                }
                            }
                        }
            ...
            if ((l_U61) || (l_U13))
            {
                ...
                sub_6723( ref uParam0, uParam2, uParam3, uParam4 );
                if (NOT l_U13)
                {
                    sub_8485();
                    sub_6485( uParam1, uParam5 );
    ...
    if (NOT (IS_CHAR_DEAD( sub_1654() )))
    {
        if ((((IS_CHAR_PLAYING_ANIM( sub_1654(), uParam4, "GET_IN_LIFT_BOTTOM" )) || (IS_CHAR_PLAYING_ANIM( sub_1654(), uParam4, "OPERATE_LIFT_SWITCH" ))) || (IS_CHAR_PLAYING_ANIM( sub_1654(), uParam4, "operate_lift_intro" ))) || (IS_CHAR_PLAYING_ANIM( sub_1654(), uParam4, "GET_IN_LIFT_TOP" )))
        {
            l_U149 = 1;
        }
        else
...
int sub_4046(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_828() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_828() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_828() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_4142())
                    {
...
void sub_5564(unknown uParam0)
{
    ...
    if (l_U14)
    {
        if (l_U126)
        {
            if (NOT (IS_CHAR_DEAD( sub_1654() )))
            {
                if ((IS_CHAR_PLAYING_ANIM( sub_1654(), uParam0, "GET_IN_LIFT_BOTTOM" )) || (IS_CHAR_PLAYING_ANIM( sub_1654(), uParam0, "GET_IN_LIFT_TOP" )))
                {
                    l_U151 = 1;
                }
            }
...
void sub_6008(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (NOT l_U6)
    {
        if (bParam2)
...
void sub_6485(unknown uParam0, boolean bParam1)
{
    if (NOT (IS_CHAR_DEAD( sub_1654() )))
    {
        if (bParam1)
...
void sub_6723(unknown uParam0, float fParam1, float fParam2, unknown uParam3)
{
    int iVar6;
    int iVar7;
    unknown uVar8;
