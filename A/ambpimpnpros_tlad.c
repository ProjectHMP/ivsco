...
void sub_1639()
{
    if ((((IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( ref l_U216, ProtectedGet(l_U179[0]) )) || (IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( ref l_U216, ProtectedGet(l_U179[1]) ))) || (IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( ref l_U216, ProtectedGet(l_U179[2]) ))) || (IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( ref l_U216, ProtectedGet(l_U179[3]) )))
    {
        CLEAR_HELP();
    }
    return;
...
void sub_2062()
{
    ...
    if ((NOT (HAVE_ANIMS_LOADED( l_U146 ))) || (NOT (HAVE_ANIMS_LOADED( l_U149 ))))
    {
        REQUEST_ANIMS( l_U146 );
        REQUEST_ANIMS( l_U149 );
    }
...
void sub_3180()
{
    ...
    if (NOT (IS_CHAR_DEAD( l_U118 )))
    {
        if (NOT g_U9223)
        {
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U118, sub_1092(), 10.00000000, 10.00000000, 10.00000000, 0 )) AND (IS_SCORE_GREATER( sub_754(), ProtectedGet(l_U179[0]) - 1 )))
            {
            ...
            if (NOT (l_U122 == nil))
            {
                if (IS_VEH_DRIVEABLE( l_U122 ))
                {
                    ...
                    if (fVar3 <= 2.00000000)
                    {
                        ...
                        {
                            if ((IS_SCORE_GREATER( sub_754(), ProtectedGet(l_U179[0]) - 1 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_754(), 0 ))))
                            {
...
void sub_4816()
{
    ...
    switch (l_U105)
    {
        ...
        break;
        case 5:
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U118, sub_1092(), 5.00000000, 5.00000000, 5.00000000, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_754(), 0 ))))
        {
            ...
            if (l_U144 == 1)
            {
                ...
                if (l_U145 > 0)
                {
                    if ((IS_CHAR_IN_ANY_CAR( sub_1092() )) AND (IS_CHAR_IN_ANY_CAR( l_U118 )))
                    {
                        if (l_U116)
                        {
                            if (IS_PLAYER_PLAYING( sub_754() ))
                        ...
                        if (IS_VEH_DRIVEABLE( l_U122 ))
                        {
                            if ((IS_CHAR_IN_CAR( l_U118, l_U122 )) AND (IS_CHAR_IN_CAR( sub_1092(), l_U122 )))
                            {
    ...
    if (l_U144 == 7)
    {
        if (IS_CHAR_IN_ANY_CAR( sub_1092() ))
        {
            ...
            if (IS_VEH_DRIVEABLE( l_U122 ))
            {
                ...
                {
                    GET_CAR_SPEED( l_U122, ref fVar2 );
                    if ((fVar2 <= 2.00000000) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_754(), 0 ))))
                    {
                        GET_CAR_MODEL( l_U122, ref l_U124 );
                        GET_MODEL_DIMENSIONS( l_U124, ref vVar12, ref vVar9 );
                        vVar6 = {vVar9 - vVar12};
                    ...
                    else if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U118, sub_1092(), 15.00000000, 15.00000000, 5.00000000, 0 ))) || (IS_WANTED_LEVEL_GREATER( sub_754(), 0 )))
                    {
                        CLEAR_CHAR_TASKS( l_U118 );
                        SET_PED_WITH_BRAIN_CAN_BE_CONVERTED_TO_DUMMY_PED( l_U118, 1 );
                        l_U105 = 11;
...
void sub_7062()
{
    ...
    if (IS_CHAR_IN_ANY_CAR( sub_1092() ))
    {
        ...
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U118, sub_1092(), 15.00000000, 15.00000000, 5.00000000, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_754(), 0 ))))
        {
            if (sub_7172( 4, 0 ))
            {
                if (NOT l_U116)
...
int sub_7172(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_754() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_754() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_754() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_7268())
                    {
...
void sub_9652()
{
    ...
    if (NOT l_U117)
    {
        if ((NOT (IS_AMBIENT_SPEECH_PLAYING( sub_1092() ))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U118 ))))
        {
    ...
    if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_1092() )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_754(), 0 ))))
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1092(), ref l_U122 );
        if (IS_VEH_DRIVEABLE( l_U122 ))
        {
            ...
            {
                GET_CAR_SPEED( l_U122, ref fVar2 );
                if ((fVar2 <= 2.00000000) AND (IS_PLAYER_CONTROL_ON( sub_754() )))
                {
                    if (NOT l_U109)
                    {
                        if (sub_10037())
                    ...
                    else
                    {
                        ...
                        if (l_U135 >= iVar3)
                        {
                            if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_7268()))
                            {
                                l_U177 = 0;
                                l_U178 = 1;
...
void sub_10987()
{
    ...
    if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_1092() )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_754(), 0 ))))
    {
        ...
        if (IS_VEH_DRIVEABLE( l_U122 ))
        {
            ...
            {
                GET_CAR_SPEED( l_U122, ref fVar2 );
                if ((((fVar2 <= 2.00000000) AND (IS_PLAYER_CONTROL_ON( sub_754() ))) AND (NOT sub_7268())) || (l_U177))
                {
                    if (((IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( ref l_U216, ProtectedGet(l_U179[l_U147]) )) || (# -NULL-0xc27e8e())) || (l_U177))
                    {
                        if (NOT l_U177)
                        {
...
void sub_14270()
{
    ...
    if ((IS_CHAR_SITTING_IN_ANY_CAR( l_U118 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_754(), 0 ))))
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( l_U118, ref l_U122 );
        if (IS_VEH_DRIVEABLE( l_U122 ))
        {
            GET_CAR_SPEED( l_U122, ref fVar9 );
            if ((fVar9 <= 2.00000000) AND (IS_PLAYER_CONTROL_ON( sub_754() )))
            {
                sub_11967();
                GET_GAME_TIMER( ref l_U134 );
                if (NOT l_U176)
                    ...
                    if (NOT (IS_COP_VEHICLE_IN_AREA_3D_NO_SAVE( uVar3._fU0, uVar3._fU4, uVar3._fU8, uVar6._fU0, uVar6._fU4, uVar6._fU8 )))
                    {
                        ...
                        if (NOT l_U176)
                        {
                            if (NOT (l_U147 == 3))
                            {
                                if (HAVE_ANIMS_LOADED( l_U149 ))
                                {
                                    if ((IS_CHAR_PLAYING_ANIM( l_U118, l_U149, l_U150[l_U147] )) AND (IS_CHAR_PLAYING_ANIM( sub_1092(), l_U149, l_U162[l_U147] )))
                                    {
                                        if ((HAS_CHAR_ANIM_FINISHED( l_U118, l_U149, l_U150[l_U147] )) AND (HAS_CHAR_ANIM_FINISHED( sub_1092(), l_U149, l_U162[l_U147] )))
                                        {
    ...
    switch (l_U105)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U119 )))
        {
            ...
            if (l_U144 == 7)
            {
                GET_GAME_TIMER( ref l_U134 );
                l_U135 = l_U134 - l_U132;
                if ((l_U135 >= 10000) || (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U118, l_U119, 12.00000000, 12.00000000, 5.00000000, 0 ))))
                {
                    sub_18355();
                }
            }
...
void sub_19765()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U119 )))
    {
        if (IS_VEH_DRIVEABLE( l_U121 ))
        {
            ...
            {
                GET_CAR_SPEED( l_U121, ref fVar2 );
                if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U119, l_U118, 15.00000000, 15.00000000, 5.00000000, 0 )) AND (fVar2 <= 1.00000000))
                {
                    GET_GAME_TIMER( ref l_U134 );
                    l_U135 = l_U134 - l_U132;
                    if (l_U135 >= l_U137)
