        ...
        while (l_U4)
        {
            ...
            if ((IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) AND (sub_504()))
            {
                switch (l_U0)
                {
                    ...
                    case 2:
                    l_U11 = 0;
                    if (IS_PLAYER_PLAYING( sub_1779() ))
                    {
                        if (NOT (IS_CAR_DEAD( l_U23 )))
                        {
                            if (IS_CHAR_IN_CAR( sub_1838(), l_U23 ))
                            {
                                l_U11 = 1;
                            }
                            else
                            ...
                            if (NOT l_U11)
                            {
                                GET_CAR_CHAR_IS_USING( sub_1838(), ref iVar3 );
                                if (iVar3 == l_U23)
                                {
                                    l_U11 = 1;
                                }
                        ...
                        {
                            if (IS_CHAR_IN_CAR( sub_1838(), l_U24 ))
                            {
                                l_U11 = 1;
                            }
                        }
...
void sub_2351()
{
    ...
    if ((NOT g_U10978) AND (sub_2366()))
    {
        switch (l_U1)
        {
            ...
            iVar10 = iVar9 - l_U42;
            if ((iVar10 >= l_U43) AND (sub_2366()))
            {
                if (NOT l_U7)
                {
                    l_U7 = 1;
                }
                else if (sub_2583( ref uVar2, ref uVar8 ))
                {
                    sub_866();
            ...
            if (NOT (IS_CHAR_INJURED( l_U19 )))
            {
                if (IS_VEH_DRIVEABLE( l_U24 ))
                {
                    ...
                    if (l_U22 == 7)
                    {
                        ...
                        {
                            if (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_1838(), 811.23960000, -257.15500000, 15.33780000, 5.00000000, 5.00000000, 5.00000000, 0 )))
                            {
                                OPEN_SEQUENCE_TASK( ref l_U21 );
    ...
    else if (l_U5)
    {
        ...
        if (IS_VEH_DRIVEABLE( l_U24 ))
        {
            if (NOT (IS_CHAR_IN_CAR( sub_1838(), l_U24 )))
            {
...
int sub_2366()
{
    ...
    GET_INTERIOR_FROM_CHAR( sub_1838(), ref iVar2 );
    if (NOT (iVar2 == nil))
    {
        return 0;
    }
    if (LOCATE_CHAR_ANY_MEANS_3D( sub_1838(), 822.90000000, -273.71600000, 16.70000000, 6.30000000, 8.47500000, 2.50000000, 0 ))
    {
        return 0;
    }
    return 1;
...
int sub_2583(unknown uParam0, unknown uParam1)
{
    vector[3] vVar4;
    unknown uVar8;
    unknown uVar9;
    ...
    if (NOT (IS_CHAR_DEAD( sub_1838() )))
    {
        GET_CHAR_COORDINATES( sub_1838(), ref uVar18._fU0, ref uVar18._fU4, ref uVar18._fU8 );
    }
    for ( I = 0; I < iVar24; I++ )
    {
