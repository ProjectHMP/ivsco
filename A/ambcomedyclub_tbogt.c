                ...
                if (l_U18)
                {
                    ...
                    if (NOT (IS_WANTED_LEVEL_GREATER( sub_826(), 0 )))
                    {
                        ...
                        if (LOCATE_CHAR_ANY_MEANS_3D( sub_879(), l_U159._fU0, l_U159._fU4, l_U159._fU8, 2.50000000, 2.50000000, 2.50000000, 1 ))
                        {
                            ...
                            if ((((((NOT l_U7) AND (sub_1899( 1, 1 ))) AND (NOT g_U12381)) AND (NOT sub_2192())) AND (NOT (IS_BIT_SET( g_U10938._fU0, 4 )))) AND (NOT (g_U22959 > l_U25)))
                            {
...
int sub_3081(unknown uParam0, unknown uParam1)
{
    switch (uParam1)
    {
        ...
        break;
        case 1:
        if ((sub_3125( uParam0 )) || (sub_3178( uParam0 )))
        {
            return 0;
        }
        else
...
void sub_8215()
{
    if (NOT (IS_CHAR_INJURED( sub_879() )))
    {
        ...
        {
            if ((((NOT (COMPARE_STRING( l_U15, "E2_CM01" ))) AND (NOT (COMPARE_STRING( l_U15, "E2_CM02" )))) AND (NOT (COMPARE_STRING( l_U15, "E2_CM03" )))) AND (NOT (COMPARE_STRING( l_U15, "E2_CM04" ))))
            {
