void main()
{
    ...
    while (IS_PLAYER_PLAYING( sub_1094() ))
    {
        switch (l_U108)
        {
            ...
            if ((((HAS_MODEL_LOADED( sub_139( 7 ) )) AND (HAS_MODEL_LOADED( 52357603 ))) AND (HAS_MODEL_LOADED( g_U11196 ))) AND (HAS_MODEL_LOADED( -789894171 )))
            {
                sub_1296( 1 );
            }
            sub_1350( "E2FHAU", 6 );
            ...
            if (bVar2)
            {
                ...
                if ((IS_VEH_DRIVEABLE( l_U125[1] )) AND (NOT (IS_CHAR_INJURED( l_U110[1] ))))
                {
            ...
            if (NOT sub_3980())
            {
                ...
                {
                    if ((IS_VEH_DRIVEABLE( l_U125[0] )) AND (IS_VEH_DRIVEABLE( l_U125[1] )))
                    {
                ...
                if (NOT (IS_CHAR_INJURED( l_U110[0] )))
                {
                    if (IS_VEH_DRIVEABLE( l_U125[0] ))
                    {
                        if (NOT (IS_CHAR_SITTING_IN_CAR( l_U110[0], l_U125[0] )))
                        {
                            ...
                            if ((NOT (DOES_BLIP_EXIST( l_U103 ))) AND (NOT g_U12379))
                            {
                                if (IS_VEH_DRIVEABLE( l_U125[0] ))
                                {
                            ...
                            if (NOT l_U102)
                            {
                                if ((NOT (IS_CHAR_INJURED( sub_1571() ))) AND (NOT (IS_CHAR_INJURED( l_U110[0] ))))
                                {
                        ...
                        else if ((NOT (IS_CHAR_INJURED( l_U110[0] ))) AND (IS_VEH_DRIVEABLE( l_U125[0] )))
                        {
                            GET_SCRIPT_TASK_STATUS( l_U110[0], 49, ref l_U129 );
                            if ((l_U129 == 7) AND (IS_CHAR_SITTING_IN_CAR( l_U110[0], l_U125[0] )))
                            {
            ...
            else if (NOT (IS_CHAR_INJURED( l_U110[0] )))
            {
                if (NOT (IS_CHAR_INJURED( l_U110[1] )))
                {
                    if (IS_VEH_DRIVEABLE( l_U125[1] ))
                    {
                        if ((IS_CHAR_SITTING_IN_CAR( l_U110[1], l_U125[1] )) AND (NOT (IS_CHAR_SITTING_IN_CAR( l_U110[0], l_U125[1] ))))
                        {
                            GET_SCRIPT_TASK_STATUS( l_U110[0], 29, ref l_U129 );
                            if (l_U129 == 7)
                            {
                    ...
                    if (IS_VEH_DRIVEABLE( l_U125[1] ))
                    {
                        if ((IS_CHAR_SITTING_IN_CAR( l_U110[0], l_U125[1] )) AND (IS_CHAR_SITTING_IN_CAR( l_U110[1], l_U125[1] )))
                        {
            ...
            if (NOT g_U12379)
            {
                if (IS_VEH_DRIVEABLE( l_U125[0] ))
                {
                    ...
                    {
                        if ((IS_CHAR_IN_CAR( sub_1571(), l_U125[0] )) AND (TIMERA() > 7000))
                        {
        ...
        if ((NOT (l_U108 == 5)) AND (NOT (l_U108 < 2)))
        {
            if ((((IS_CHAR_INJURED( l_U110[0] )) || (IS_CHAR_INJURED( l_U110[1] ))) || (NOT (IS_VEH_DRIVEABLE( l_U125[0] )))) || (NOT (IS_VEH_DRIVEABLE( l_U125[1] ))))
            {
        ...
        if (l_U108 >= 3)
        {
            if ((NOT (IS_CHAR_INJURED( sub_1571() ))) AND (IS_VEH_DRIVEABLE( l_U125[0] )))
            {
            ...
            if (IS_PLAYER_PLAYING( sub_1094() ))
            {
                ...
                if (IS_CHAR_IN_ANY_CAR( sub_1571() ))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( uVar3 ))
                    {
                        ...
                        if (((NOT (IS_THIS_MODEL_A_BOAT( uVar4 ))) AND (NOT (IS_THIS_MODEL_A_PLANE( uVar4 )))) AND (NOT (IS_THIS_MODEL_A_HELI( uVar4 ))))
                        {
                ...
                if (bVar2)
                {
                    ...
                    else
                    {
                        ...
                        {
                            GET_CHAR_COORDINATES( sub_1571(), ref uVar5._fU0, ref uVar5._fU4, ref uVar5._fU8 );
                            if ((LOCATE_CAR_3D( l_U125[0], l_U122._fU0, l_U122._fU4, l_U122._fU8, 15.00000000, 15.00000000, 4.00000000, 0 )) || (LOCATE_CAR_3D( l_U125[0], uVar5._fU0, uVar5._fU4, uVar5._fU8, 15.00000000, 15.00000000, 2.00000000, 0 )))
                            {
