...
int sub_702(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_947() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_947() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_1279()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_15262()
{
    ...
    {
        if (((sub_15300( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_17690()
{
    ...
    if ((((((g_U10978) || (IS_THREAD_ACTIVE( g_U812 ))) || (IS_WANTED_LEVEL_GREATER( sub_868(), 0 ))) || (sub_17825())) || (sub_17876())) || (sub_18074( 0 )))
    {
        sub_17730();
        return;
    }
    if ((NOT (sub_18437( l_U481, 30000 ))) || (sub_501( l_U481 )))
    {
        sub_17730();
        return;
    }
