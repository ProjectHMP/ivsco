...
void sub_3640()
{
    if ((IS_CHAR_INJURED( l_U215 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U215, sub_2023(), 0 )))
    {
    ...
    if ((sub_3841() < 25) AND (IS_CHAR_ON_FOOT( sub_2023() )))
    {
    ...
    {
        case 0:
        if ((((IS_CHAR_INJURED( l_U215 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U215, sub_2023(), 0 ))) || (IS_CHAR_ON_FIRE( l_U215 ))) || (IS_WANTED_LEVEL_GREATER( sub_1043(), 0 )))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U215 )))
        {
            if ((sub_3841() < 18) AND (IS_CHAR_ON_FOOT( sub_2023() )))
            {
                if ((NOT IS_HINT_RUNNING()) AND (NOT l_U270))
                {
...
void sub_9383()
{
                ...
                if (DOES_BLIP_EXIST( l_U218 ))
                {
                    if (sub_3841() < 12.00000000)
                    {
                        ...
                        if (NOT (IS_CHAR_INJURED( l_U215 )))
                        {
                            ...
                            l_U211 = 1;
                            if ((NOT (IS_CHAR_INJURED( sub_2023() ))) AND (NOT (IS_CHAR_IN_ANY_CAR( sub_2023() ))))
                            {
                                if (NOT l_U286)
                                {
    ...
    switch (l_U200)
    {
        ...
        if ((DOES_VEHICLE_EXIST( l_U216 )) AND (NOT (IS_VEH_DRIVEABLE( l_U216 ))))
        {
        ...
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1043(), 0 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U215 )))
            {
                ...
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_2023(), -1266.54700000, 821.05270000, 18.56210000 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (sub_6064( 1, 1 )))
                    {
                        if (sub_10140( l_U243 ))
                        {
                            sub_1122( ref l_U243, 0 );
                        ...
                        if (IS_CHAR_IN_ANY_CAR( sub_2023() ))
                        {
                            if (NOT (IS_CAR_UPSIDEDOWN( l_U216 )))
                            {
                                ...
                                else if ((IS_VEH_DRIVEABLE( l_U216 )) AND (NOT (IS_CHAR_INJURED( l_U215 ))))
                                {
                                    GET_CAR_MODEL( l_U216, ref l_U236 );
                                ...
                                if ((IS_THIS_MODEL_A_HELI( l_U236 )) || (IS_THIS_MODEL_A_BIKE( l_U236 )))
                                {
                                    DO_SCREEN_FADE_IN( 250 );
                                    while (NOT IS_SCREEN_FADED_IN())
                                    {
                        ...
                        else if (DOES_BLIP_EXIST( l_U219 ))
                        {
                            ...
                            if (((NOT l_U205) AND (NOT (IS_CHAR_INJURED( l_U215 )))) AND (NOT (IS_CHAR_INJURED( sub_2023() ))))
                            {
                                GET_PED_BONE_POSITION( sub_2023(), 0, 0.00000000, 0.00000000, 0.00000000, ref l_U280 );
                                GET_PED_BONE_POSITION( sub_2023(), 1205, 0.00000000, 0.00000000, 0.00000000, ref l_U277 );
                                GET_OFFSET_FROM_CHAR_IN_WORLD_COORDS( sub_2023(), 2.03490000, 1.69320000, 0.71580000, ref l_U283._fU0, ref l_U283._fU4, ref l_U283._fU8 );
        ...
        break;
        case 9:
        if ((((LOCATE_CHAR_ANY_MEANS_3D( l_U215, -1280.64700000, 833.76680000, 19.56620000, 2.50000000, 2.50000000, 2.50000000, 0 )) || (l_U214 == 1)) || (NOT (IS_CHAR_ON_SCREEN( l_U215 )))) || (TIMERB() > 5000))
        {
            if (IS_VEH_DRIVEABLE( l_U216 ))
            {
                if (IS_THIS_MODEL_A_HELI( l_U236 ))
