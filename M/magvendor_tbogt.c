...
void sub_2406(unknown uParam0)
{
    ...
    {
        COPY_SHARED_COMBAT_DECISION_MAKER( 65560, ref g_U9592 );
        ...
        if (NOT (IS_CHAR_INJURED( l_U99 )))
        {
            ...
            SET_COMBAT_DECISION_MAKER( l_U99, g_U9592 );
...
int sub_6719(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_665() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_665() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_5634())
                    {
...
int sub_13455(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;
    unknown uVar6;
    unknown uVar7;
...
void sub_15277()
{
    ...
    sub_15728();
    SET_CHAR_HEALTH( sub_3620(), sub_15803() );
    return;
}

void sub_15301(unknown uParam0, unknown uParam1)
{
    sub_15322( uParam0, uParam1, 0.00000000, "" );
    return;
}

void sub_15322(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
