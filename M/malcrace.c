void main()
{
    ...
    sub_11511();
    while (((NOT sub_11612()) || (NOT sub_15390())) || (NOT sub_15549()))
    {
        WAIT( 0 );
    }
    ...
    while (true)
    {
        ...
        switch (l_U263)
        {
            ...
            if ((l_U631) || (l_U624))
            {
                if ((NOT (IS_CHAR_INJURED( l_U269[l_U267]._fU0 ))) AND (IS_VEH_DRIVEABLE( l_U269[l_U267]._fU8 )))
                {
                    l_U211 = 5.00000000;
            ...
            if (sub_47620( ref l_U269[l_U268], 0 ))
            {
                ...
                if (NOT (IS_CHAR_INJURED( l_U269[l_U267]._fU0 )))
                {
                    ...
                    {
                        if ((NOT (IS_AMBIENT_SPEECH_PLAYING( l_U269[l_U268]._fU0 ))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U269[l_U267]._fU0 ))))
                        {
                            if (l_U684 > l_U685)
                            {
                                if (NOT l_U683)
            ...
            {
                sub_1474();
                if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "bkCombatHlp1" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "bkCombatHlp12" )))
                {
                    CLEAR_HELP();
                }
            }
...
void sub_5030(int iParam0)
{
    ...
    switch (iParam0->_fU364)
    {
        ...
        sub_5223( iParam0, 1158.89100000, 1756.09600000, 9.92040000 );
        ...
        sub_5223( iParam0, 1225.12500000, -220.57560000, 24.15610000 );
        ...
        sub_5223( iParam0, 5.23470000, 1525.70300000, 10.88830000 );
        ...
        sub_5223( iParam0, -1002.94300000, 1976.83000000, 0.89080000 );
        ...
        sub_5223( iParam0, -801.30430000, 1244.55500000, 16.34630000 );
        ...
        sub_5223( iParam0, -1518.21900000, -205.86770000, 6.97700000 );
        ...
        sub_5223( iParam0, -1316.59800000, -72.18230000, 8.30870000 );
...
void sub_10871(unknown uParam0)
{
    ...
    (uParam0^)[l_U267]._fU36 = {-326.62960000, 1605.18700000, 19.27820000};
...
int sub_11621()
{
    ...
    if ((HAS_MODEL_LOADED( sub_11631( 15 ) )) AND (HAS_MODEL_LOADED( sub_11097( 15 ) )))
    {
        return 1;
    }
    return 0;
...
void sub_12086(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_12120( vParam0 + (vector( 2.00000000, 0.00000000, 0.00000000)), uParam3, uParam4, iParam6 );
...
void sub_12130(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((((((uParam0^) == (sub_11631( 0 ))) || ((uParam0^) == (sub_11631( 1 )))) || ((uParam0^) == (sub_11631( 6 )))) || ((uParam0^) == (sub_11631( 7 )))) || ((uParam0^) == (sub_11631( 13 )))) || ((uParam0^) == (sub_11631( 16 ))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_11631( 15 ))) || ((uParam0^) == (sub_11631( 17 ))))
        {
            Result = 3;
        }
    }
...
void sub_12846(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_11631( 6 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_11631( 7 ) ))))
        {
            sub_13342( iParam0 );
        }
    }
...
int sub_15390()
{
    ...
    if ((((HAVE_ANIMS_LOADED( "MISSBIKE_COMBAT" )) AND (HAS_MODEL_LOADED( 377107 ))) AND (HAS_MODEL_LOADED( 800724201 ))) AND (REQUEST_MISSION_AUDIO_BANK( "EP1_SFX\BIKER_MELEE" )))
    {
        return 1;
    }
    return 0;
...
int sub_15549()
{
    ...
    if (l_U599[1] != l_U599[0])
    {
        ...
        if ((l_U599[2] != l_U599[0]) AND (l_U599[2] != l_U599[1]))
        {
            if (l_U599[3] == 0)
            {
                l_U599[3] = sub_15574( 0 );
            }
            if (((l_U599[3] != l_U599[0]) AND (l_U599[3] != l_U599[1])) AND (l_U599[3] != l_U599[2]))
            {
                for ( I = 0; I < 4; I++ )
                {
...
int sub_18144()
{
    ...
    if ((((((((HAS_MODEL_LOADED( l_U599[0] )) AND (HAS_MODEL_LOADED( l_U599[1] ))) AND (HAS_MODEL_LOADED( l_U599[2] ))) AND (HAS_MODEL_LOADED( l_U599[3] ))) AND (sub_18262( ref l_U604[0] ))) AND (sub_18262( ref l_U604[1] ))) AND (sub_18262( ref l_U604[2] ))) AND (sub_18262( ref l_U604[3] )))
    {
        return 1;
    }
    return 0;
...
int sub_19299(int iParam0)
{
    ...
    if ((NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))) || (IS_CHAR_SITTING_IN_ANY_CAR( sub_1331() )))
    {
        return 0;
    }
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_12885( iParam0 + 0 )) == 3) AND ((sub_19442( iVar3 )) == sub_11454())))
        {
            if ((((sub_12885( iParam0 + 0 )) != 1) || ((sub_19500( iParam0->_fU0 )) == (sub_11631( 0 )))) || ((sub_19542( sub_1331() )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1331() )))))
            {
                return 0;
            }
            else
    ...
    if (Result)
    {
        ...
        if (DOES_CHAR_EXIST( iParam2 ))
        {
            ...
            if (iParam0 != sub_1331())
            {
                ...
                if ((iVar8 == 1) AND (iParam2 != sub_1331()))
                {
        ...
        if (iParam3 != 39)
        {
            if ((iParam3 == 38) AND (IS_CHAR_MODEL( iParam0, sub_11631( 0 ) )))
            {
                if (l_U208)
                {
...
int sub_22317(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((sub_19542( iParam0->_fU0 )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))))
    {
        return 2;
    }
    else if ((uParam1) || (sub_22395( iParam0, 1 )))
    {
        uVar5 = nil;
...
void sub_22983(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if (((sub_23049( (iParam0^) )) AND (NOT l_U190)) AND (NOT l_U191))
            {
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_23101()))
                {
                    if ((IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )) AND (IS_CHAR_ON_ANY_BIKE( sub_1331() )))
                    {
        ...
        {
            if ((((((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_1331(), iParam0->_fU0, l_U181, l_U181, l_U181, 0 ))) || (NOT (IS_CHAR_ON_ANY_BIKE( sub_1331() )))) || (NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1331() )))) || (NOT (sub_25070( l_U183 ))))
            {
                sub_25561( iParam0 );
            }
        }
...
void sub_25843(int iParam0)
{
    ...
    if ((sub_23014( (iParam0^) )) AND (sub_23101()))
    {
        if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
        {
            if (((IS_CHAR_SITTING_IN_CAR( iParam0->_fU0, iParam0->_fU4 )) AND (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 ))) AND (IS_CHAR_ON_ANY_BIKE( sub_1331() )))
            {
                ...
                {
                    if ((l_U203 != iParam0->_fU0) || (l_U204 != sub_1331()))
                    {
    ...
    if (((sub_23101()) || (sub_23014( (iParam0^) ))) || ((iVar4 - l_U201) < 33))
    {
        return;
    }
    if (l_U201 <= 0)
    ...
    if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_26770( uVar12 ))
            {
                ...
                if (((NOT (sub_23014( (iParam0^) ))) AND (((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) AND (fVar21 < 19)) || (fVar21 < 15))) AND (iParam0->_fU0 != l_U203))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((l_U42) AND ((iParam0->_fU36 != 1) || ((sub_15965( 0, 10 )) == 0)))
                    {
                        l_U42 = 0;
                        iVar15 = 17;
                        iVar11 = sub_1331();
                    }
                    else if ((((sub_27007( iParam0 )) AND (iParam0->_fU36 == 2)) AND ((sub_12885( iParam0 + 0 )) == 1)) AND (NOT (IS_BIT_SET( l_U206, 6 ))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_27121( bVar16 );
                        iVar11 = sub_1331();
                    }
                    else if (((IS_CAR_IN_AIR_PROPER( uVar12 )) AND ((ABSF( uVar22 )) < 20.00000000)) AND (sub_27209( 8 )))
                    {
                        uVar13 = sub_27463( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_1331() )) AND (sub_27209( 12 )))
                    {
                        uVar13 = sub_27121( bVar16 );
                        iVar11 = sub_1331();
                        iVar15 = 12;
                    ...
                    else if (((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 )) || (IS_PED_RAGDOLL( iParam0->_fU0 ))) AND (sub_27209( 13 )))
                    {
                        uVar13 = sub_27121( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if (((((sub_12885( iParam0 + 0 )) == 1) AND (NOT (IS_PLAYER_PRESSING_HORN( sub_1662() )))) AND (IS_BIT_SET( l_U206, 7 ))) AND (sub_27209( 20 )))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if ((((IS_WANTED_LEVEL_GREATER( sub_1662(), 0 )) AND (NOT (IS_BIT_SET( l_U206, 0 )))) AND (sub_27209( 24 ))) AND ((sub_12885( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 24;
                        iVar11 = sub_1331();
                    }
                    else if ((((NOT (IS_WANTED_LEVEL_GREATER( sub_1662(), 0 ))) AND (IS_BIT_SET( l_U206, 0 ))) AND (sub_27209( 30 ))) AND ((sub_12885( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_27209( 33 )) AND (NOT (IS_BIT_SET( l_U206, 4 )))) AND ((sub_12885( iParam0 + 0 )) == 1))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1331() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_27209( 31 )) AND (NOT (IS_BIT_SET( l_U206, 4 )))) AND ((sub_12885( iParam0 + 0 )) == 1))
                                    {
                            ...
                            else if ((IS_CHAR_ON_FOOT( sub_1331() )) AND (NOT (IS_PED_RAGDOLL( sub_1331() ))))
                            {
                                CLEAR_BIT( ref l_U206, 3 );
                                CLEAR_BIT( ref l_U206, 4 );
                            };;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((sub_27209( 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_1662(), 0 ))))
                                {
                                ...
                                else if (((sub_27209( 36 )) AND (IS_WANTED_LEVEL_GREATER( sub_1662(), 0 ))) AND (NOT (IS_BIT_SET( l_U206, 1 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((IS_WANTED_LEVEL_GREATER( sub_1662(), 2 )) AND (sub_27209( 23 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            if ((IS_WANTED_LEVEL_GREATER( sub_1662(), 0 )) AND (NOT (IS_BIT_SET( l_U206, 2 ))))
                            {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if ((sub_27209( 28 )) AND ((sub_12885( iParam0 + 0 )) == 1))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_27209( 3 )) AND (sub_27209( 4 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if (((sub_12885( iParam0 + 0 )) == 1) AND (fVar26 < 5))
                            {
                                if ((sub_27209( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_1662(), 0 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if ((sub_27209( 30 )) AND ((sub_12885( iParam0 + 0 )) == 1))
                                {
                                    iVar15 = 30;
                                }
    ...
    if ((IS_PLAYER_PRESSING_HORN( sub_1662() )) AND (NOT (IS_BIT_SET( l_U206, 7 ))))
    {
...
int sub_32032(int iParam0)
{
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            {
                if (((sub_12885( ref iVar4 )) == (sub_12885( iParam0 + 0 ))) || ((iVar4 == sub_1331()) AND ((sub_12885( iParam0 + 0 )) == 1)))
                {
...
void sub_32257(int iParam0, int iParam1)
{
    ...
    if ((iParam0->_fU8 == sub_1331()) AND (iParam1 != sub_1331()))
    {
...
{
    return (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 )) AND (NOT (sub_32377( uParam0, uParam1 )));
}
...
int sub_33271(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((iVar3 == sub_1331()) || ((iVar3 == iParam0->_fU8) AND (NOT (IS_CHAR_INJURED( iVar3 )))))
        {
        ...
        if ((((IS_CHAR_IN_CAR( sub_1331(), iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((sub_26833( iParam0->_fU0, sub_1331(), 1 )) < 90.00000000))
        {
...
int sub_34007(unknown uParam0)
{
    ...
    if (IS_PED_IN_GROUP( uParam0 ))
    {
        ...
        if (DOES_GROUP_EXIST( iVar3 ))
        {
            ...
            {
                if (((iVar4 < 1) || (iVar5 < 2)) AND (iVar3 != sub_34093()))
                {
                    REMOVE_GROUP( iVar3 );
                }
                else
            ...
            else if ((iVar5 < 1) AND (iVar3 != sub_34093()))
            {
                REMOVE_GROUP( iVar3 );
            }
        }
...
int sub_34439(int iParam0)
{
    ...
    if ((NOT (sub_22395( iParam0, 2 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        return 0;
    }
...
int sub_34974(int iParam0)
{
    ...
    else if ((((sub_31057( iParam0 )) > 90.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND ((sub_26833( iParam0->_fU0, sub_1331(), 1 )) > 90.00000000))
    {
        ...
        {
            if (((CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 )) || (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 ))) || ((VDIST( sub_22772( sub_1331(), 1 ), uVar4 )) < 30.00000000))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_35589(int iParam0)
{
    ...
    if (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
    {
        if (NOT (IS_PED_IN_COMBAT( iParam0->_fU0 )))
        {
            ...
            if ((iVar3 == 7) AND (NOT (IS_CHAR_FACING_CHAR( iParam0->_fU0, sub_1331(), 45.00000000 ))))
            {
...
int sub_35746(int iParam0)
{
    ...
    if (DOES_VEHICLE_EXIST( iVar4 ))
    {
        if (sub_32353( iParam0->_fU0, iVar4 ))
        {
            ...
            bVar6 = false;
            if ((NOT (IS_CHAR_IN_CAR( sub_1331(), iVar4 ))) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1331() ))))
            {
    ...
    if ((sub_22395( iParam0, 1 )) AND ((sub_31057( iParam0 )) < 30.00000000))
    {
    ...
    if (iParam0->_fU8 == sub_1331())
    {
        if ((IS_CHAR_ON_FOOT( iParam0->_fU0 )) AND (IS_CHAR_ON_FOOT( sub_1331() )))
        {
    ...
    if ((NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))) AND ((((IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 )) || (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 ))) || (DOES_VEHICLE_EXIST( iVar4 ))) || ((sub_26833( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8)))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((sub_32377( iParam0->_fU8, iParam0->_fU4 )) || (iParam0->_fU4 == iVar4))
            {
            ...
            else if ((sub_32377( sub_1331(), iParam0->_fU4 )) AND ((sub_12885( iParam0 + 0 )) == 1))
            {
    ...
    else if (((sub_33309( sub_1331(), iParam0->_fU0, 1 )) AND (iParam0->_fU8 != sub_1331())) AND ((sub_12885( iParam0 + 0 )) == 1))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((NOT (sub_22395( iParam0, 1 ))) || (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
        {
            if ((sub_22503( iParam0 )) != 0)
            {
                ;
    ...
    else if ((sub_22395( iParam0, 1 )) AND (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))))
    {
...
int sub_37499(int iParam0)
{
    ...
    else if ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_26813( iParam0 )) > 30.00000000))
    {
...
int sub_37910(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((VDIST( uVar4, uVar10 )) < 30.00000000)) || ((VDIST( uVar4, uVar7 )) < 30.00000000))
        {
            ...
            else if ((iVar3 == sub_1331()) || ((sub_12885( ref iVar3 )) == (sub_12885( iParam0 + 0 ))))
            {
...
int sub_38736(int iParam0)
{
    ...
    if ((((IS_PED_IN_COMBAT( iParam0->_fU0 )) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 ))) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 ))) AND ((sub_31057( iParam0 )) < 30.00000000))
    {
        return 2;
    }
    return 0;
...
int sub_38885(int iParam0)
{
    ...
    else if ((iParam0->_fU8 == sub_1331()) AND (IS_CHAR_GETTING_IN_TO_A_CAR( sub_1331() )))
    {
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_31585( iParam0->_fU4 )) || (sub_22395( iParam0, 4 ))) AND ((sub_26813( iParam0 )) >= l_U161))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 ))) AND ((VDIST( uVar15, sub_22772( sub_1331(), 1 ) )) > fParam2)) AND ((VDIST2( uVar15, vVar6 )) > 9.00000000))
                    {
...
void sub_44100(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        else if ((iParam0->_fU36 == 4) AND ((VDIST( iParam0->_fU16, sub_22772( iParam0->_fU0, 1 ) )) < 12.00000000))
        {
            return;
        }
...
void sub_46138(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_1331() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_46306())) AND (iVar3 != 4))
    {
...
void sub_50305()
{
    switch (l_U265)
    {
        ...
        if (IS_CHAR_IN_ANY_CAR( l_U269[l_U268]._fU0 ))
        {
            ...
            {
                if ((IS_CAR_MODEL( l_U269[l_U268]._fU8, -114291515 )) || (IS_CAR_MODEL( l_U269[l_U268]._fU8, -891462355 )))
                {
                    l_U641 = {-1.21200000, -0.36300000, 0.60000000};
                }
                else if ((IS_CAR_MODEL( l_U269[l_U268]._fU8, -1670998136 )) || (IS_CAR_MODEL( l_U269[l_U268]._fU8, -1759858085 )))
                {
                    l_U641 = {-1.21200000, -0.30300000, 0.46000000};
                }
                else if ((IS_CAR_MODEL( l_U269[l_U268]._fU8, 1265391242 )) || (IS_CAR_MODEL( l_U269[l_U268]._fU8, -255678177 )))
                {
                    l_U641 = {-1.21200000, -0.38300000, 0.46000000};
                }
                else if ((IS_CAR_MODEL( l_U269[l_U268]._fU8, 1203311498 )) || (IS_CAR_MODEL( l_U269[l_U268]._fU8, -909201658 )))
                {
...
int sub_56227(int iParam0)
{
    if (iParam0 != 0)
    {
        ...
        {
            if ((NOT IS_CAM_INTERPOLATING()) || (sub_53942()))
            {
                if (DOES_CAM_EXIST( l_U41 ))
                {
...
void sub_65029(int iParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (sub_65242( sub_1331(), (iParam0->_fU0 == 9) || (iParam0->_fU0 == 4) ))
    {
        if (HAS_CHAR_GOT_WEAPON( sub_1331(), 1 ))
        {
...
void sub_65752(unknown uParam0, int iParam1, unknown uParam2, boolean bParam3)
{
    ...
    if (sub_65242( uParam0, (iParam1 == 9) || (iParam1 == 4) ))
    {
...
void sub_81522()
{
    ...
    l_U647[0] = {-254.80690000, 1474.76100000, 20.18526000};
