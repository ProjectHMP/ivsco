...
void sub_1148()
{
    ...
    if ((NOT (IS_CHAR_INJURED( l_U216._fU0 ))) AND (NOT (IS_CHAR_INJURED( sub_1179() ))))
    {
...
int sub_1405()
{
    ...
    if ((((HAS_MODEL_LOADED( sub_1448( l_U243 ) )) AND (HAS_MODEL_LOADED( sub_1778( l_U243 ) ))) AND (HAS_MODEL_LOADED( -114291515 ))) AND (HAVE_ANIMS_LOADED( "AMB@SERVICE_IDLES_B" )))
    {
        return 1;
    }
    return 0;
...
void sub_2154(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_2188( vParam0 + (vector( 2.00000000, 0.00000000, 0.00000000)), uParam3, uParam4, iParam6 );
...
void sub_2198(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((((((uParam0^) == (sub_1448( 0 ))) || ((uParam0^) == (sub_1448( 1 )))) || ((uParam0^) == (sub_1448( 6 )))) || ((uParam0^) == (sub_1448( 7 )))) || ((uParam0^) == (sub_1448( 13 )))) || ((uParam0^) == (sub_1448( 16 ))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_1448( 15 ))) || ((uParam0^) == (sub_1448( 17 ))))
        {
            Result = 3;
        }
    }
...
void sub_2914(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_1448( 6 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_1448( 7 ) ))))
        {
            sub_3410( iParam0 );
        }
    }
