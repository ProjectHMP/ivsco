            ...
            switch (l_U199)
            {
                ...
                if (sub_11073())
                {
                    ...
                    if (sub_20665( l_U982, l_U1014 ))
                    {
                        ...
                        {
                            if ((LOCATE_CHAR_ON_FOOT_3D( sub_490(), l_U200[l_U1013]._fU8._fU0, l_U200[l_U1013]._fU8._fU4, l_U200[l_U1013]._fU8._fU8, l_U200[l_U1013]._fU32._fU0, l_U200[l_U1013]._fU32._fU4, l_U200[l_U1013]._fU32._fU8, 0 )) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U1000 ))))
                            {
                    ...
                    if ((NOT l_U940) AND (sub_10984( sub_490(), l_U982 )))
                    {
...
void sub_340()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_490() )))
    {
        ...
        if ((IS_PLAYER_PLAYING( sub_557() )) AND (l_U936))
        {
    ...
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        if (uParam1._fU0 != uVar21._fU0)
        {
            ...
            else
            {
                ...
                if (((GET_CHAR_DRAWABLE_VARIATION( sub_490(), 8 )) != 1) || ((GET_CHAR_TEXTURE_VARIATION( sub_490(), 8 )) != 0))
                {
...
void sub_2331()
{
    ...
    if (iVar3 > 0)
    {
        for ( I = 0; I < iVar3; I++ )
        {
            ...
            if ((NOT (IS_CHAR_INJURED( uVar5 ))) AND (IS_PLAYER_PLAYING( sub_557() )))
            {
...
void sub_2765()
{
    ...
    sub_2845( 7, 0.75000000, -3.23750000, 1.00000000, 0.75000000, 0.90000000, 1.50000000, 0.70500000, -3.53750000, 1.00000000, -279.64120000, 1361.63600000, 24.63220000, 64.44000000 );
...
void sub_4571()
{
    ...
    sub_4619( 9, -280.23910000, 1362.92600000, 26.04679000, -8.36518100, 0.00000000, -147.67890000, 45.00000000 );
    sub_4619( 10, -275.93820000, 1357.43500000, 25.91911000, -0.82381000, 0.00000000, 28.35691000, 45.00000000 );
    ...
    sub_4619( 16, -283.15810000, 1364.41900000, 25.97610000, -8.27773600, 0.00000000, 73.07284000, 45.00000000 );
    sub_4619( 17, -276.43640000, 1363.28000000, 26.03255000, -4.05362700, -0.00000000, 43.66415000, 45.00000000 );
    sub_4619( 18, -277.11800000, 1363.28800000, 26.11416000, -4.28817800, -0.00000000, -33.59678000, 45.00000000 );
    sub_4619( 19, -285.30680000, 1355.36500000, 24.91185000, -1.01929100, 0.00000000, -78.60535000, 45.00000000 );
...
int sub_11073()
{
    if (NOT (IS_CHAR_INJURED( l_U945._fU0 )))
    {
        if (sub_10984( sub_490(), l_U982 ))
        {
            if (sub_10984( l_U945._fU0, l_U982 ))
            {
                if ((IS_CHAR_IN_ANY_CAR( sub_490() )) || (IS_WANTED_LEVEL_GREATER( sub_557(), 0 )))
                {
                    if (NOT l_U1018)
                    {
                ...
                if (((IS_CHAR_SHOOTING( sub_490() )) || (g_U9207)) || (l_U939))
                {
                    if (sub_10984( sub_490(), l_U982 ))
                    {
                ...
                else if ((IS_PLAYER_TARGETTING_CHAR( sub_557(), l_U945._fU0 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_557(), l_U945._fU0 )))
                {
                    if (NOT l_U1020)
                    {
                ...
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U945._fU0, sub_490(), 0 )) AND (NOT l_U1021))
                {
...
int sub_21496(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, int iParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24)
{
    ...
    if ((sub_21522( 2, 0 )) AND (NOT (uParam11^)))
    {
...
int sub_21522(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_557() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_557() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_557() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_21618())
                    {
...
void sub_28302(unknown uParam0)
{
    ...
    if (iVar4 > 0)
    {
        for ( I = 0; I < iVar4; I++ )
        {
            ...
            if ((NOT (IS_CHAR_INJURED( uVar10 ))) AND (IS_PLAYER_PLAYING( sub_557() )))
            {
...
int sub_30939(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, int iParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25, unknown uParam26, unknown uParam27, unknown uParam28)
{
    ...
    if ((sub_21522( 2, 0 )) AND (NOT (uParam11^)))
    {
        if (((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( sub_31081( uParam7, 0, 0 ) ))) AND (NOT (IS_THIS_HELP_MESSAGE_WITH_NUMBER_BEING_DISPLAYED( sub_31081( uParam7, 1, 0 ), iParam8 )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( sub_31081( uParam7, 1, 1 ) ))))
        {
            if (sub_21903( 2, "BLANK", 0 ))
            {
                sub_723( 2, "BLANK" );
...
int sub_33550(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25, unknown uParam26, unknown uParam27, unknown uParam28, unknown uParam29, unknown uParam30, unknown uParam31, unknown uParam32, int iParam33, unknown uParam34, unknown uParam35, unknown uParam36, unknown uParam37, unknown uParam38, unknown uParam39, unknown uParam40, unknown uParam41, unknown uParam42, unknown uParam43, unknown uParam44, unknown uParam45)
{
    ...
    if ((sub_13651( sub_490(), 80 )) AND (sub_13651( sub_490(), 88 )))
    {
        if (TIMERA() > iParam33)
        {
            TASK_PLAY_ANIM( sub_490(), "examine shirt", "clothing", 4.00000000, 0, 0, 0, 0, -1 );
    ...
    if (sub_33831())
    {
        if ((NOT (IS_SCORE_GREATER( sub_557(), iVar48 - 1 ))) AND (NOT sub_33911()))
        {
            CLEAR_PRINTS();
