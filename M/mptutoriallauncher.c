        ...
        if ((g_U825) AND (NOT g_U9228))
        {
            if ((NOT g_U10978) AND (NOT g_U9893._fU12))
            {
                if (NOT l_U7)
                {
                    ...
                    {
                        if (((sub_177()) AND (NOT g_U10978)) AND (NOT g_U9893._fU12))
                        {
                            sub_469();
                            g_U10978 = 1;
                            l_U7 = 1;
                ...
                else if ((NOT g_U10978) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "MultiTutorial" )) == 0))
                {
                    l_U7 = 0;
                    g_U825 = 0;
                    g_U814 = 0;
