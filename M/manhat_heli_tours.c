...
void sub_224()
{
    ...
    l_U217[1] = {366.79550000, -731.30100000, 4.15270000};
    ...
    l_U261[1] = {333.54860000, -697.44450000, 3.69190000};
    ...
    l_U279[2] = {378.68210000, -721.63070000, 4.69190000};
    l_U279[3] = {385.66610000, -726.54300000, 4.69190000};
...
int sub_1405()
{
    if (IS_PLAYER_PLAYING( sub_1240() ))
    {
        if (g_U9932[2]._fU0)
        {
            if ((IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE()) || (l_U103 == 5))
            {
                if (sub_1466())
                {
                    if (NOT g_U10978)
...
void sub_1658()
{
    ...
    {
        iVar3 = sub_1686( 13 );
        if ((sub_1731( 13, iVar3 )) AND (g_U9932[g_U9999[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_1686( 11 );
        if ((sub_1731( 11, iVar3 )) AND (g_U9932[g_U10090[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_2212( I );
        if ((sub_1731( g_U10324[I]._fU12, iVar3 )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
...
void sub_2749()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((sub_2212( I )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
                        ...
                        if (IS_CHAR_SITTING_IN_CAR( l_U167[l_U330], l_U208[l_U330] ))
                        {
                            switch (l_U105[l_U330])
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U334[l_U330] ))
                                {
                                    ...
                                    if ((l_U206 == 7) || (sub_5695( l_U208[l_U330], l_U330 )))
                                    {
                                        if ((LOCATE_CAR_3D( l_U208[l_U330], uVar10._fU0, uVar10._fU4, uVar10._fU8, 15.00000000, 15.00000000, 15.00000000, 0 )) || (sub_5695( l_U208[l_U330], l_U330 )))
                                        {
                                ...
                                break;
                                case 4:
                                if ((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U208[l_U330] ))) || (LOCATE_CAR_3D( l_U208[l_U330], l_U217[l_U330]._fU0, l_U217[l_U330]._fU4, l_U217[l_U330]._fU8, 5.00000000, 5.00000000, 5.00000000, 0 )))
                                {
                                    if (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U208[l_U330] )))
                                    {
                                        l_U105[l_U330] = 5;
    ...
    for ( J = 0; J < 5; J++ )
    {
        if (NOT (IS_CHAR_INJURED( l_U198[J] )))
        {
            if (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U198[J], l_U239[J]._fU0, l_U239[J]._fU4, l_U239[J]._fU8, 2.00000000, 2.00000000, 2.00000000, 0 )))
            {
                ...
                if ((l_U206 == 7) AND (NOT (IS_PED_IN_COMBAT( l_U198[J] ))))
                {
                    CLEAR_CHAR_TASKS( l_U198[J] );
                    OPEN_SEQUENCE_TASK( ref l_U205 );
...
void sub_11577()
{
    if ((((NOT (HAS_MODEL_LOADED( l_U164 ))) || (NOT (HAS_MODEL_LOADED( l_U165 )))) || (NOT (HAS_MODEL_LOADED( l_U166 )))) || (NOT (HAVE_ANIMS_LOADED( l_U423 ))))
    {
        REQUEST_MODEL( l_U164 );
        REQUEST_MODEL( l_U165 );
        REQUEST_MODEL( l_U166 );
...
void sub_12907()
{
    ...
    for ( l_U330 = 0; l_U330 < 5; l_U330++ )
    {
        if ((IS_VEH_DRIVEABLE( l_U208[l_U330] )) AND (NOT l_U124[l_U330]))
        {
            if (NOT (IS_CHAR_INJURED( l_U167[l_U330] )))
            {
                if (IS_CHAR_SITTING_IN_CAR( l_U167[l_U330], l_U208[l_U330] ))
                    ...
                    if (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U208[l_U330] )))
                    {
                        if (IS_CAR_PASSENGER_SEAT_FREE( l_U208[l_U330], 0 ))
                        {
                            if (NOT l_U118[l_U330])
                            {
                                if (NOT (IS_CHAR_DEAD( sub_1283() )))
                                {
                                    if ((LOCATE_CHAR_ON_FOOT_CAR_3D( sub_1283(), l_U208[l_U330], 3.50000000, 3.50000000, 2.00000000, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_1240(), 0 ))))
                                    {
                                        if ((IS_SCORE_GREATER( sub_1240(), ProtectedGet(l_U102) - 1 )) AND (sub_13201()))
                                        {
...
void sub_19527()
{
    ...
    if (IS_VEH_DRIVEABLE( l_U207 ))
    {
        if ((NOT (IS_CHAR_INJURED( l_U204 ))) AND (IS_CHAR_SITTING_IN_CAR( sub_1283(), l_U207 )))
        {
            SET_PLAYER_CAN_DO_DRIVE_BY( sub_1240(), 0 );
            if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U207 ))
            {
                ...
                if (l_U312)
                {
                    ...
                    else if (l_U114)
                    {
                        if (NOT l_U116)
                        {
                            if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) || (l_U117))
                            {
                                CLEAR_HELP();
                                ADD_NEXT_MESSAGE_TO_PREVIOUS_BRIEFS( 0 );
                                PRINT_HELP( "HETR_03" );
                ...
                if (l_U353 < l_U367)
                {
                    ...
                    else if ((l_U353 > l_U368) AND ((l_U353 - 1) <= l_U369))
                    {
                        if (NOT l_U163)
                        {
                            if (NOT (sub_20329( l_U430 )))
...
void sub_25867()
{
    if (IS_VEH_DRIVEABLE( l_U207 ))
    {
        switch (l_U104)
        {
            ...
            if (((((g_U8697) AND (g_U8698)) AND (g_U8699)) AND (g_U8700)) AND (g_U8701))
            {
