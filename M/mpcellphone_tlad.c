void main()
{
    ...
    while (true)
    {
        ...
        if (NOT g_U94._fU580)
        {
            if (IS_PLAYER_PLAYING( sub_602() ))
            {
                switch (g_U558)
                {
                    ...
                    {
                        if ((sub_689()) || (g_U94._fU376))
                        {
                            while (NOT (sub_1235( 5 )))
                            {
                                WAIT( 0 );
                            }
                        }
                    ...
                    else if (g_U94._fU632 == 1)
                    {
                        if (sub_689())
                        {
                            while (NOT (sub_1235( 4 )))
                            {
                                WAIT( 0 );
                            }
                        }
                    }
                    else if ((sub_4608( 0 )) == 0)
                    {
                        if (NETWORK_IS_RENDEZVOUS())
                        {
                            if (IS_SCREEN_FADED_IN())
                            {
                                while (NOT (sub_1235( 7 )))
                                {
                                    WAIT( 0 );
                                }
                            }
                        }
                        else if ((sub_689()) AND (NOT CODE_WANTS_MOBILE_PHONE_REMOVED_FOR_WEAPON_SWITCHING()))
                        {
                            g_U94._fU376 = 0;
                            g_U94._fU380 = 1;
                            while (NOT (sub_1235( 4 )))
        ...
        if (NOT (# -NULL-0xc27c84()))
        {
            if (IS_PLAYER_PLAYING( sub_602() ))
            {
                if (IS_PLAYER_SCRIPT_CONTROL_ON( sub_602() ))
                {
...
int sub_689()
{
    if (NOT (IS_PLAYER_PLAYING( sub_602() )))
    {
    ...
    if (NOT (IS_PLAYER_CONTROL_ON( sub_602() )))
    {
...
void sub_1247(unknown uParam0, unknown uParam1)
{
    switch (uParam1)
    {
        case 0:
...
void sub_1621()
{
    ...
    if (g_U484._fU160 == 0)
    {
        ...
        if ((NOT g_U484._fU164) AND (NOT IS_NETWORK_SESSION()))
        {
...
void sub_1713(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_1848(unknown uParam0, unknown uParam1)
{
    switch (uParam0)
    {
        case 1:
        ...
        {
            sub_1965( uParam1, 11.50000000, -60.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U94._fU8._fU24 );
        }
        else
        {
            sub_1965( uParam1, 5.00000000, -60.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U94._fU8._fU24 );
        }
        break;
        case 2:
        if ((g_U94._fU496) AND (GET_IS_WIDESCREEN()))
        {
            sub_1965( uParam1, 11.50000000, -11.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U94._fU8._fU24 );
        }
        else
        {
            sub_1965( uParam1, 5.00000000, -7.00000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U94._fU8._fU24 );
        }
        break;
        case 3:
        if ((g_U94._fU496) AND (GET_IS_WIDESCREEN()))
        {
            sub_1965( uParam1, 11.50000000, 4.50000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U94._fU8._fU24 );
        }
        else
        {
            sub_1965( uParam1, 5.00000000, 8.50000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U94._fU8._fU24 );
        }
        break;
        case 4:
        if ((g_U94._fU496) AND (GET_IS_WIDESCREEN()))
        {
            sub_1965( uParam1, 11.50000000, -5.25000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U94._fU8._fU24 );
        }
        else
        {
            sub_1965( uParam1, 5.00000000, -0.75000000, -50.00000000, -92.00000000, -10.50000000, 0.00000000, g_U94._fU8._fU24 );
        }
        break;
    }
    return;
...
void sub_1965(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7)
{
...
void sub_5175(unknown uParam0, unknown uParam1)
{
    unknown uVar4;
...
void sub_9392(unknown uParam0, unknown uParam1)
{
