...
int sub_2479()
{
    ...
    if ((HAS_MODEL_LOADED( 1798610950 )) AND (HAVE_ANIMS_LOADED( "move_f@margot" )))
    {
        return 1;
    }
    return 0;
...
{
    if (((((IS_MESSAGE_BEING_DISPLAYED()) || (((sub_4389()) AND (NOT bParam0)) || ((sub_4443()) AND (bParam0)))) || (sub_4472())) || (IS_SCRIPTED_CONVERSATION_ONGOING())) || (sub_4531()))
    {
        return 1;
    }
    return 0;
...
void sub_5684()
{
    ...
    switch (l_U156)
    {
        ...
        vVar3[1] = {-315.36610000, 1611.21800000, 20.27950000};
        for ( I = 0; I < 2; I++ )
        {
...
void sub_8340(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    if ((IS_VEH_DRIVEABLE( (uParam4^) )) AND (NOT (IS_CHAR_INJURED( sub_3203() ))))
    {
...
void sub_9548(boolean bParam0, unknown uParam1)
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_3203() ))) AND ((IS_SCREEN_FADED_OUT()) || (bParam0)))
    {
...
void sub_11534()
{
    ...
    REQUEST_MODEL( 1798610950 );
    REQUEST_ANIMS( "move_f@margot" );
    while ((NOT (HAS_MODEL_LOADED( 1798610950 ))) || (NOT (HAVE_ANIMS_LOADED( "move_f@margot" ))))
    {
        WAIT( 0 );
    }
...
int sub_12176()
{
    if (sub_12185())
    {
        if ((DOES_CHAR_EXIST( l_U160 )) AND (DOES_VEHICLE_EXIST( l_U164 )))
        {
            return 1;
        }
...
int sub_12185()
{
    ...
    if ((((HAS_MODEL_LOADED( -1193778389 )) AND (HAS_MODEL_LOADED( -268530289 ))) AND (HAS_MODEL_LOADED( 1376298265 ))) AND (HAVE_ANIMS_LOADED( "missMargot" )))
    {
        return 1;
    }
    return 0;
...
void sub_12847()
{
    ...
    {
        if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3203() ))) AND (l_U255))
        {
            switch (l_U218)
            {
                case 0:
...
void sub_13345()
{
    ...
    if (((sub_13691( sub_3203(), l_U159 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_2262(), 0 )))) AND (NOT (sub_4373( 0 ))))
    {
        if (l_U231)
        {
            if (l_U232)
...
int sub_18285(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17)
{
    ...
    if (sub_19681( l_U141[0], l_U141[1], l_U141[2], uParam11, uParam12, uParam13, uParam14, l_U135, uParam15, 0, 0, 0 ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((uParam16) AND (IS_WANTED_LEVEL_GREATER( sub_2262(), 0 )))
            {
                ...
                if (((NOT (sub_4373( 0 ))) AND (NOT sub_25364())) AND (NOT l_U101))
                {
            ...
            if (LOCATE_CHAR_ANY_MEANS_3D( sub_3203(), uParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6 ))
            {
                ...
                for ( I = 0; I < 3; I++ )
                {
                    if (DOES_CHAR_EXIST( l_U141[I] ))
                    {
                        ...
                        {
                            if ((NOT (IS_GROUP_MEMBER( l_U141[I], sub_20339() ))) || (NOT (sub_22335( l_U141[I] ))))
                            {
                                iVar20 = 0;
                            }
                        }
...
void sub_18333()
{
    ...
    for ( I = 0; I < l_U141; I++ )
    {
        if (DOES_CHAR_EXIST( l_U141[I] ))
        {
            if (NOT (IS_CHAR_INJURED( l_U141[I] )))
            {
                if (((IS_CHAR_SITTING_IN_ANY_CAR( l_U141[I] )) AND (sub_18426( l_U141[I] ))) AND (sub_4389()))
                {
    ...
    if (IS_PLAYER_PLAYING( sub_2262() ))
    {
        if (NOT (IS_CHAR_INJURED( sub_3203() )))
        {
            if (((IS_CHAR_SITTING_IN_ANY_CAR( sub_3203() )) AND (sub_18426( sub_3203() ))) AND (sub_4389()))
            {
...
int sub_19681(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, int iParam9, unknown uParam10, unknown uParam11)
{
    ...
    if (((NOT sub_19852()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_3203() ))) AND (NOT (DOES_VEHICLE_EXIST( iParam9 ))))
    {
            ...
            if (NOT (IS_CHAR_INJURED( l_U141[I] )))
            {
                ...
                if (IS_CHAR_SITTING_IN_ANY_CAR( sub_3203() ))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( iVar26 ))
                    {
                        ...
                        {
                            if ((NOT sub_19852()) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_3203() )))
                            {
                ...
                if (((NOT (IS_GROUP_MEMBER( l_U141[I], sub_20339() ))) AND (NOT (sub_21284( l_U141[I], iParam9 )))) AND (NOT (sub_21380( l_U141[I], iParam9 ))))
                {
                ...
                {
                    if (((sub_22335( l_U141[I] )) || (sub_21284( l_U141[I], iParam9 ))) || (uParam11))
                    {
        ...
        if (iVar15 > 0)
        {
            for ( I = 0; I < 3; I++ )
            {
                if (iVar20[I])
                {
                    if (NOT (IS_CHAR_INJURED( l_U141[I] )))
                    {
                        if ((sub_20541( l_U141[I] )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U141[I], sub_3203(), 40.00000000, 40.00000000, 40.00000000, 0 )))
                        {
                            iVar15--;
                            iVar20[I] = 0;
                        }
        ...
        if (IS_VEH_DRIVEABLE( iVar3 ))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                ...
                if (IS_VEH_DRIVEABLE( iVar4 ))
                {
                    if (iVar3 == iVar4)
                    {
                        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3203(), uParam0, 20.00000000, 20.00000000, 20.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CAR_3D( uParam0, iVar4, 20.00000000, 20.00000000, 20.00000000, 0 )))
                        {
                            return 1;
                        }
                    }
...
int sub_25917()
{
    ...
    if (IS_CHAR_SITTING_IN_ANY_CAR( sub_3203() ))
    {
        if ((IS_CHAR_ON_ANY_BIKE( sub_3203() )) || (IS_CHAR_IN_ANY_HELI( sub_3203() )))
        {
            iVar2 = 0;
        }
    }
    if (l_U119)
    {
        ...
        {
            if ((sub_5770( 1, iVar2 )) || (l_U113))
            {
                return 1;
            }
        }
    }
    else if ((sub_5770( 1, iVar2 )) || (l_U113))
    {
        return 1;
    }
    return 0;
...
void sub_29657()
{
    ...
    switch (l_U216)
    {
        ...
        SET_CAM_FOV( l_U265, 42.00002000 );
        SET_CAM_FAR_DOF( l_U264, 20.00000000 );
        SET_CAM_FAR_DOF( l_U265, 20.00000000 );
        SET_CAM_POS( l_U267, 91.38478000, 137.71420000, 17.05853000 );
        SET_CAM_ROT( l_U267, -26.95385000, -0.00000000, -33.97602000 );
            ...
            if ((sub_32105( l_U219 )) > 1)
            {
                ...
                if (DOES_CHAR_EXIST( l_U159 ))
                {
                    if (NOT (IS_CHAR_INJURED( l_U159 )))
                    {
                        if (NOT (IS_CHAR_IN_ANY_CAR( l_U159 )))
                        {
                            if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_3203() )) AND (NOT (IS_CHAR_ON_ANY_BIKE( sub_3203() ))))
                            {
                                l_U253 = 1;
                ...
                if (IS_CHAR_IN_ANY_CAR( sub_3203() ))
                {
                    if (fVar3 <= 180)
                    {
                        if (TIMERA() >= 3000)
                        {
                            ...
                            SET_CAM_POS( l_U262, 97.55289000, 147.47540000, 14.04654000 );
        ...
        if ((DOES_CHAR_EXIST( l_U160 )) AND (NOT (IS_CHAR_INJURED( l_U160 ))))
        {
            if (IS_SCREEN_FADED_IN())
            {
        ...
        {
            if ((IS_SCREEN_FADED_IN()) AND (NOT IS_SCREEN_FADING_OUT()))
            {
                DO_SCREEN_FADE_OUT( 500 );
            }
        }
