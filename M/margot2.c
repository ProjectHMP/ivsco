...
int sub_2341()
{
    ...
    if ((HAS_MODEL_LOADED( 1798610950 )) AND (HAVE_ANIMS_LOADED( "missMARGOT2" )))
    {
        return 1;
    }
    return 0;
...
int sub_7163()
{
    ...
    if ((((((HAS_MODEL_LOADED( 1530937394 )) AND (HAS_MODEL_LOADED( 809067472 ))) AND (HAS_MODEL_LOADED( 677687516 ))) AND (HAS_MODEL_LOADED( -1984134881 ))) AND (HAS_MODEL_LOADED( 1207402441 ))) AND (HAS_MODEL_LOADED( -1356924456 )))
    {
        return 1;
    }
    return 0;
...
void sub_7968()
{
    ...
    {
        case 0:
        if ((DOES_CHAR_EXIST( l_U176[1] )) AND (NOT (IS_CHAR_INJURED( l_U176[1] ))))
        {
        ...
        if ((DOES_CHAR_EXIST( l_U176[2] )) AND (NOT (IS_CHAR_INJURED( l_U176[2] ))))
        {
        ...
        if ((DOES_CHAR_EXIST( l_U176[3] )) AND (NOT (IS_CHAR_INJURED( l_U176[3] ))))
        {
        ...
        if ((DOES_CHAR_EXIST( l_U176[4] )) AND (NOT (IS_CHAR_INJURED( l_U176[4] ))))
        {
        ...
        if ((DOES_CHAR_EXIST( l_U176[5] )) AND (NOT (IS_CHAR_INJURED( l_U176[5] ))))
        {
        ...
        if ((DOES_CHAR_EXIST( l_U176[6] )) AND (NOT (IS_CHAR_INJURED( l_U176[6] ))))
        {
...
void sub_11827()
{
    if (l_U265)
    {
        switch (l_U261)
        {
            ...
            break;
            case 1:
            if ((DOES_CHAR_EXIST( l_U176[7] )) AND (NOT (IS_CHAR_INJURED( l_U176[7] ))))
            {
            ...
            if ((DOES_CHAR_EXIST( l_U176[8] )) AND (NOT (IS_CHAR_INJURED( l_U176[8] ))))
            {
...
void sub_12581()
{
    if (l_U266)
    {
        switch (l_U262)
        {
            ...
            break;
            case 1:
            if ((DOES_CHAR_EXIST( l_U176[9] )) AND (NOT (IS_CHAR_INJURED( l_U176[9] ))))
            {
            ...
            if ((DOES_CHAR_EXIST( l_U176[10] )) AND (NOT (IS_CHAR_INJURED( l_U176[10] ))))
            {
...
void sub_13335()
{
    if (l_U267)
    {
        switch (l_U263)
        {
            ...
            break;
            case 1:
            if ((DOES_CHAR_EXIST( l_U176[11] )) AND (NOT (IS_CHAR_INJURED( l_U176[11] ))))
            {
            ...
            if ((DOES_CHAR_EXIST( l_U176[12] )) AND (NOT (IS_CHAR_INJURED( l_U176[12] ))))
            {
            ...
            if ((DOES_CHAR_EXIST( l_U176[13] )) AND (NOT (IS_CHAR_INJURED( l_U176[13] ))))
            {
...
void sub_14415()
{
    if (l_U268)
    {
        switch (l_U264)
        {
            ...
            break;
            case 1:
            if ((DOES_CHAR_EXIST( l_U176[14] )) AND (NOT (IS_CHAR_INJURED( l_U176[14] ))))
            {
            ...
            if ((DOES_CHAR_EXIST( l_U176[15] )) AND (NOT (IS_CHAR_INJURED( l_U176[15] ))))
            {
...
void sub_16578()
{
    ...
    if ((uVar2._fU8 <= 11.00000000) || (uVar2._fU8 >= 22.00000000))
    {
        if (NOT l_U280)
        {
...
void sub_16713()
{
    ...
    if ((l_U305 == 0) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_2186(), 0 ))))
    {
        sub_17133();
    }
    return;
