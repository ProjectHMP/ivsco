void main()
{
    ...
    l_U508 = 0;
    l_U509 = 0;
    l_U535 = {711.43290000, 1503.35300000, 14.03730000};
    l_U543 = 35;
    l_U544 = 20;
    l_U546 = 0;
    l_U547 = 0;
    ...
    while (l_U488)
    {
        ...
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_4042(), 714.86300000, 1508.26800000, 19.61490000, 100.00000000, 100.00000000, 50.00000000, 0 ))
        {
            if (NOT l_U508)
            {
...
void sub_1596()
{
    ...
    {
        if (((sub_1634( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
    ...
    else
    {
        ...
        for ( l_U545 = 0; l_U545 < l_U546; l_U545++ )
        {
            if (NOT (IS_CHAR_DEAD( l_U510[l_U545] )))
            {
                if (NOT l_U493)
                {
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U510[l_U545], sub_4042(), 0 )) || (IS_CHAR_RESPONDING_TO_EVENT( l_U510[l_U545], 15 )))
                    {
                        l_U493 = 1;
                    }
        ...
        if (NOT l_U493)
        {
            ...
            {
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U515, sub_4042(), 0 )) || (IS_CHAR_RESPONDING_TO_EVENT( l_U515, 15 )))
                {
                    l_U493 = 1;
                }
            ...
            {
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U516, sub_4042(), 0 )) || (IS_CHAR_RESPONDING_TO_EVENT( l_U516, 15 )))
                {
                    l_U493 = 1;
                }
            ...
            {
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U517, sub_4042(), 0 )) || (IS_CHAR_RESPONDING_TO_EVENT( l_U517, 15 )))
                {
                    l_U493 = 1;
                }
        ...
        else if (NOT l_U492)
        {
            if (IS_CHAR_SITTING_IN_ANY_CAR( sub_4042() ))
            {
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_10665()))
                {
                    if (sub_10416() > 1)
                    {
...
void sub_5152()
{
    ...
    CLEAR_AREA_OF_COPS( 711.43290000, 1503.35300000, 14.03730000, 20.00000000 );
...
void sub_12837()
{
    ...
    for ( l_U545 = 0; l_U545 < l_U546; l_U545++ )
    {
        if ((IS_CHAR_DEAD( l_U510[l_U545] )) || (IS_CHAR_INJURED( l_U510[l_U545] )))
        {
            REMOVE_BLIP( l_U523[l_U545] );
            iVar2++;
        }
    ...
    if ((IS_CHAR_INJURED( l_U515 )) || (IS_CHAR_DEAD( l_U515 )))
    {
        REMOVE_BLIP( l_U523[l_U565] );
        iVar2++;
    }
    ...
    if ((IS_CHAR_INJURED( l_U516 )) || (IS_CHAR_DEAD( l_U516 )))
    {
        REMOVE_BLIP( l_U523[l_U566] );
        iVar2++;
    }
    ...
    if ((IS_CHAR_INJURED( l_U517 )) || (IS_CHAR_DEAD( l_U517 )))
    {
        REMOVE_BLIP( l_U523[l_U567] );
        iVar2++;
    }
    ...
    if (l_U504)
    {
        if (((IS_CHAR_INJURED( l_U515 )) AND (IS_CHAR_INJURED( l_U516 ))) AND (IS_CHAR_INJURED( l_U517 )))
        {
            SET_CREATE_RANDOM_COPS( 1 );
            l_U504 = 0;
        }
...
void sub_15332()
{
            ...
            if (IS_CHAR_IN_CAR( l_U510[l_U564], l_U519 ))
            {
                for ( l_U545 = 0; l_U545 < l_U546; l_U545++ )
                {
                    if (NOT (IS_CHAR_INJURED( l_U510[l_U545] )))
                    {
                        ...
                        {
                            if ((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U519 ))) || (NOT l_U499))
                            {
                                OPEN_SEQUENCE_TASK( ref l_U538 );
                                ...
                                TASK_CAR_DRIVE_TO_COORD( 0, l_U519, 897.36600000, 1759.60400000, 15.80410000, l_U542, 0, 0, 2, -1, -1 );
            ...
            if (NOT (IS_CHAR_INJURED( l_U510[l_U564] )))
            {
                if (IS_CHAR_IN_CAR( l_U510[l_U564], l_U519 ))
                {
                    ...
                    if (NOT l_U490)
                    {
                        ...
                        if (((((l_U563 == 0) || (CHECK_STUCK_TIMER( l_U519, 1, 40000 ))) || (CHECK_STUCK_TIMER( l_U519, 0, 5000 ))) || (CHECK_STUCK_TIMER( l_U519, 2, 30000 ))) || (sub_17917()))
                        {
                            if (NOT (IS_CHAR_INJURED( l_U510[l_U564] )))
                            {
    ...
    if (l_U485 == 8)
    {
        ...
        for ( l_U545 = 0; l_U545 < l_U546; l_U545++ )
        {
            if ((NOT (IS_CHAR_DEAD( l_U510[l_U545] ))) AND (NOT (IS_CHAR_INJURED( l_U510[l_U545] ))))
            {
                CLEAR_CHAR_TASKS( l_U510[l_U545] );
...
void sub_16377(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_4042() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_16545())) AND (iVar3 != 4))
    {
