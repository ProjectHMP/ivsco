void main()
{
    ...
    for ( I = 0; I <= 34; I++ )
    {
        iVar3 = GET_BITS_IN_RANGE( g_U955[I / 5], (I mod 5) * 6, ((I mod 5) * 6) + 5 );
        if (iVar3 != 63)
        {
            iVar5[iVar3 + 12] = I + 12;
    ...
    for ( I = 0; I <= 5; I++ )
    {
        if ((iVar64 - I) >= 0)
        {
            ...
            while (bVar68)
            {
                ...
                {
                    sub_1023( ref uVar57[I], ref cVar53, -1 );
    ...
    if (iVar65 != -1)
    {
        sub_1343( ref uVar67, "BLOG_NEXT_POSTS", "BACK" );
        if (iVar66 != -1)
        {
    ...
    if (iVar66 != -1)
    {
        sub_1023( ref uVar67, "BLOG_PREV_POSTS", 2 );
    }
    sub_1559( ref l_U0._fU0, 1, 0 );
    while (NOT g_U857._fU16)
    {
        ...
        switch (g_U851._fU12)
        {
            ...
            if (iVar66 != -1)
            {
                sub_1956( ref g_U831, "liberatedwoman.blogsnobs.org", iVar66, -1, -1 );
                g_U830 = 1;
            }
            break;
            default:
...
void sub_1023(unknown uParam0, unknown uParam1, int iParam2)
{
    char[16] cVar5;
...
void sub_1343(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ADD_TO_HTML_SCRIPT_OBJECT( (uParam0^), "<a href="" );
...
void sub_1559(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_1570( uParam1 );
    if (bParam2)
    {
...
void sub_1956(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
