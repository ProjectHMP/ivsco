void main()
{
    ...
    sub_117();
    sub_339();
    sub_1773( ref l_U19._fU0, 1, 0 );
    while (NOT g_U857._fU16)
    {
        WAIT( 0 );
        if (sub_2096( ref l_U18 ))
        {
            sub_339();
            sub_1773( ref l_U19._fU0, 1, 1 );
        }
        switch (g_U851._fU12)
        {
            case 1:
...
void sub_1773(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_1784( uParam1 );
    if (bParam2)
    {
