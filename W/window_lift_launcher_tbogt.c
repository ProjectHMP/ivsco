...
void sub_1994(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_2122() )))
    {
        if ((((IS_CHAR_PLAYING_ANIM( sub_2122(), uParam4, "GET_IN_LIFT_BOTTOM" )) || (IS_CHAR_PLAYING_ANIM( sub_2122(), uParam4, "OPERATE_LIFT_SWITCH" ))) || (IS_CHAR_PLAYING_ANIM( sub_2122(), uParam4, "operate_lift_intro" ))) || (IS_CHAR_PLAYING_ANIM( sub_2122(), uParam4, "GET_IN_LIFT_TOP" )))
        {
            l_U149 = 1;
        }
        else
...
int sub_4865(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_2398() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_2398() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_2398() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_4961())
                    {
...
void sub_6463(unknown uParam0)
{
    ...
    if (l_U14)
    {
        if (l_U126)
        {
            if (NOT (IS_CHAR_DEAD( sub_2122() )))
            {
                if ((IS_CHAR_PLAYING_ANIM( sub_2122(), uParam0, "GET_IN_LIFT_BOTTOM" )) || (IS_CHAR_PLAYING_ANIM( sub_2122(), uParam0, "GET_IN_LIFT_TOP" )))
                {
                    l_U151 = 1;
                }
            }
