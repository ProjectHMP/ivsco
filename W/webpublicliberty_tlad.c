void main()
{
    ...
    sub_1052( 1 );
    sub_4593( ref l_U79._fU0, 1, 0 );
    while (NOT g_U860._fU16)
    {
        WAIT( 0 );
        if (sub_4918( ref l_U77 ))
        {
            sub_1052( 0 );
            sub_4593( ref l_U79._fU0, 1, 1 );
        }
        if (g_U854._fU12 != -1)
        {
            sub_5047( ref g_U834, "www.publiclibertyonline.com", g_U854._fU12, -1, -1 );
            g_U833 = 1;
        }
    }
    g_U860._fU16 = 0;
...
void sub_1052(unknown uParam0)
{
    ...
    sub_1447( ref l_U68, ref l_U72, "HEAD", l_U3, -1 );
    sub_1531( ref l_U55, ref l_U68, -1 );
    sub_1447( ref l_U68, ref l_U72, "SECH", l_U3, -1 );
    sub_1531( ref l_U56, ref l_U68, -1 );
    sub_1447( ref l_U68, ref l_U72, "REP", l_U3, -1 );
    sub_1531( ref l_U57, ref l_U68, -1 );
    ...
    while (DOES_TEXT_LABEL_EXIST( ref l_U68 ))
    {
        if (l_U76)
        {
            sub_1900( ref l_U58[l_U65], ref l_U68 );
        }
        else
        {
            sub_1531( ref l_U58[l_U65], ref l_U68, -1 );
        }
    ...
    sub_2139( ref l_U67, "advert_medium_0", 3, 0 );
    if (NOT (sub_2962( 2, ref l_U66, l_U2, 6, 1 )))
    {
        sub_2139( ref l_U66, "quick_link_table", 3, 1 );
    }
    return;
}

void sub_1447(unknown uParam0, unknown uParam1, unknown uParam2, int iParam3, int iParam4)
{
...
void sub_1531(unknown uParam0, unknown uParam1, int iParam2)
{
    char[16] cVar5;
...
void sub_1900(unknown uParam0, unknown uParam1)
{
...
void sub_2139(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    char[16] cVar6;
    unknown uVar10;
...
int sub_2962(unknown uParam0, unknown uParam1, int iParam2, int iParam3, unknown uParam4)
{
    int I;
    int iVar8;
    int iVar9;
    ...
    {
        case 0:
        sub_3105( uParam1, "titAlso.jpg", -1, 88, 28 );
    ...
    for ( I = 48; I >= 1; I += -1 )
    {
        if (uVar11[I] != -1)
        {
            if ((bVar10) || (uVar11[I] == iVar9))
            {
                if (bVar10)
                {
                    sub_3507( uParam0, uParam1, uVar11[I], -1, ref iVar8, uParam4, iParam3 );
                    sub_4399( "\n adding other stories" );
                }
                else
                {
                    sub_3507( uParam0, uParam1, uVar11[I], iParam2 / 100, ref iVar8, uParam4, iParam3 );
...
void sub_3042(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_3105(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4)
{
    char[16] cVar7;
...
void sub_3507(unknown uParam0, unknown uParam1, int iParam2, int iParam3, unknown uParam4, unknown uParam5, int iParam6)
{
    int I;
    int iVar10;
    char[12] cVar11;
    ...
    if ((iParam3 != 0) AND ((uParam4^) < iParam6))
    {
        for ( I = 0; I <= iVar10; I++ )
        {
            sub_1447( ref uVar20, ref cVar11[I], "LINK", iParam2, -1 );
            if (DOES_TEXT_LABEL_EXIST( ref uVar20 ))
            {
                sub_3895( uParam0, uParam1, uParam5 );
                sub_1531( uParam1, ref uVar20, iParam2 );
                ADD_TO_HTML_SCRIPT_OBJECT( (uParam1^), "<br/><br/>" );
                (uParam4^)++;
                I = iVar10 + 1;
            }
    ...
    if ((iParam3 != 1) AND ((uParam4^) < iParam6))
    {
        for ( I = 0; I <= iVar10; I++ )
        {
            sub_1447( ref uVar20, ref cVar11[I], "S1LINK", iParam2, -1 );
            if (DOES_TEXT_LABEL_EXIST( ref uVar20 ))
            {
                sub_3895( uParam0, uParam1, uParam5 );
                sub_1531( uParam1, ref uVar20, iParam2 + 100 );
                ADD_TO_HTML_SCRIPT_OBJECT( (uParam1^), "<br/><br/>" );
                (uParam4^)++;
                I = iVar10 + 1;
            }
    ...
    if ((iParam3 != 2) AND ((uParam4^) < iParam6))
    {
        for ( I = 0; I <= iVar10; I++ )
        {
            sub_1447( ref uVar20, ref cVar11[I], "S2LINK", iParam2, -1 );
            if (DOES_TEXT_LABEL_EXIST( ref uVar20 ))
            {
                sub_3895( uParam0, uParam1, uParam5 );
                sub_1531( uParam1, ref uVar20, iParam2 + 200 );
                ADD_TO_HTML_SCRIPT_OBJECT( (uParam1^), "<br/><br/>" );
                (uParam4^)++;
                I = iVar10 + 1;
            }
...
void sub_3895(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (bParam2)
    {
        switch (uParam0)
        {
            case 0:
            sub_3105( uParam1, "arrowBlack.jpg", -1, 16, 16 );
            break;
            case 2:
            sub_3105( uParam1, "arrow.jpg", -1, 16, 16 );
            break;
        }
    }
    return;
...
void sub_4399(unknown uParam0)
{
    return;
}

void sub_4593(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_4604( uParam1 );
    if (bParam2)
    {
...
void sub_5047(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
