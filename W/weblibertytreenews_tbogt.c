void main()
{
    ...
    sub_347( 1 );
    sub_7161( ref l_U52._fU0, 1, 0 );
    while (NOT g_U864._fU16)
    {
        WAIT( 0 );
        if (sub_7486( ref l_U50 ))
        {
            sub_347( 0 );
            sub_7161( ref l_U52._fU0, 1, 1 );
        }
        if (g_U858._fU12 != -1)
        {
            sub_7623( ref g_U838, "www.libertytreeonline.com/news.html", g_U858._fU12, -1, -1 );
            g_U837 = 1;
        }
    }
    if (l_U48)
...
void sub_347(boolean bParam0)
{
        ...
        if (bParam0)
        {
            if (l_U51)
            {
                switch (l_U4)
                {
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_789" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_789" );
                    }
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_282930" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_282930" );
                    }
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_2021" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_2021" );
                    }
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_222324" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_222324" );
                    }
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_252627" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_252627" );
                    }
                    StrCopy( ref l_U28, "webNews_252627", 64 );
                    break;
                    case 30:
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_2930" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_2930" );
                    }
                    StrCopy( ref l_U28, "webNews_2930", 64 );
                    break;
                    case 31:
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_3132" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_3132" );
                    }
                    StrCopy( ref l_U28, "webNews_3132", 64 );
                    break;
                    case 33:
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_3334" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_3334" );
                    }
                    StrCopy( ref l_U28, "webNews_3334", 64 );
                    break;
                    case 39:
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_383940" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_383940" );
                    }
                    StrCopy( ref l_U28, "webNews_383940", 64 );
                    break;
                    case 42:
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_4142" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_4142" );
                    }
                    StrCopy( ref l_U28, "webNews_4142", 64 );
                    break;
                    case 47:
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_4647" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_4647" );
                    }
                    StrCopy( ref l_U28, "webNews_4647", 64 );
                    break;
                    case 48:
                    if (# -NULL-0xc27c84())
                    {
                        l_U5 = LOAD_TXD( "e2:/xbox360/textures/webNews_4849" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U5 = LOAD_TXD( "e2:/pc/textures/webNews_4849" );
                    }
                    StrCopy( ref l_U28, "webNews_4849", 64 );
                    break;
                }
            ...
            else
            {
                ...
                sub_6125( ref l_U44, "storyPhoto", l_U3, -1, -1 );
                l_U5 = LOAD_TXD( ref l_U28 );
            }
            PRINTSTRING( ref l_U44 );
            PRINTSTRING( ref l_U28 );
            PRINTNL();
            l_U6 = GET_TEXTURE( l_U5, ref l_U44 );
        }
        sub_6288( ref l_U10, ref l_U28, ref l_U44, 340, 176, -1 );
        ADD_TO_HTML_SCRIPT_OBJECT( l_U10, "<br/><br/>" );
    }
    ...
    ConcatString(ref l_U24, l_U4, 16);
    sub_3107( ref l_U11, ref l_U24, -1 );
    ...
    while (DOES_TEXT_LABEL_EXIST( ref l_U24 ))
    {
        if (l_U49)
        {
            sub_6949( ref l_U13[l_U12], ref l_U24 );
        }
        else
        {
            sub_3107( ref l_U13[l_U12], ref l_U24, -1 );
        }
    ...
    for ( I = 48; I >= 1; I += -1 )
    {
        if (uVar11[I] != -1)
        {
            if ((bVar10) || (uVar11[I] == iVar9))
            {
                if (bVar10)
                {
                    sub_2535( uParam0, uParam1, uVar11[I], -1, ref iVar8, uParam4, iParam3 );
                    sub_3651( "\n adding other stories" );
                }
                else
                {
                    sub_2535( uParam0, uParam1, uVar11[I], iParam2 / 100, ref iVar8, uParam4, iParam3 );
...
void sub_2535(unknown uParam0, unknown uParam1, int iParam2, int iParam3, unknown uParam4, unknown uParam5, int iParam6)
{
    int I;
    int iVar10;
    char[12] cVar11;
    ...
    if ((iParam3 != 0) AND ((uParam4^) < iParam6))
    {
        for ( I = 0; I <= iVar10; I++ )
        {
            sub_2898( ref uVar20, ref cVar11[I], "LINK", iParam2, -1 );
            if (DOES_TEXT_LABEL_EXIST( ref uVar20 ))
            {
                sub_2993( uParam0, uParam1, uParam5 );
                sub_3107( uParam1, ref uVar20, iParam2 );
                ADD_TO_HTML_SCRIPT_OBJECT( (uParam1^), "<br/><br/>" );
                (uParam4^)++;
                I = iVar10 + 1;
            }
    ...
    if ((iParam3 != 1) AND ((uParam4^) < iParam6))
    {
        for ( I = 0; I <= iVar10; I++ )
        {
            sub_2898( ref uVar20, ref cVar11[I], "S1LINK", iParam2, -1 );
            if (DOES_TEXT_LABEL_EXIST( ref uVar20 ))
            {
                sub_2993( uParam0, uParam1, uParam5 );
                sub_3107( uParam1, ref uVar20, iParam2 + 100 );
                ADD_TO_HTML_SCRIPT_OBJECT( (uParam1^), "<br/><br/>" );
                (uParam4^)++;
                I = iVar10 + 1;
            }
    ...
    if ((iParam3 != 2) AND ((uParam4^) < iParam6))
    {
        for ( I = 0; I <= iVar10; I++ )
        {
            sub_2898( ref uVar20, ref cVar11[I], "S2LINK", iParam2, -1 );
            if (DOES_TEXT_LABEL_EXIST( ref uVar20 ))
            {
                sub_2993( uParam0, uParam1, uParam5 );
                sub_3107( uParam1, ref uVar20, iParam2 + 200 );
                ADD_TO_HTML_SCRIPT_OBJECT( (uParam1^), "<br/><br/>" );
                (uParam4^)++;
                I = iVar10 + 1;
            }
...
void sub_2898(unknown uParam0, unknown uParam1, unknown uParam2, int iParam3, int iParam4)
{
...
void sub_2993(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (bParam2)
    {
        switch (uParam0)
...
void sub_3107(unknown uParam0, unknown uParam1, int iParam2)
{
    char[16] cVar5;
...
void sub_6125(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4)
{
    StrCopy( (uParam0^), uParam1, 16 );
    if (iParam2 != -1)
    {
...
void sub_6288(unknown uParam0, unknown uParam1, unknown uParam2, int iParam3, int iParam4, int iParam5)
{
    char[16] cVar8;
...
void sub_6949(unknown uParam0, unknown uParam1)
{
    if (NOT IS_JAPANESE_VERSION())
    {
...
void sub_7161(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_7172( uParam1 );
    if (bParam2)
    {
...
void sub_7623(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
