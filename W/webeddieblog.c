void main()
{
    ...
    {
        l_U1 = GET_BITS_IN_RANGE( g_U953, l_U0 * 3, (l_U0 * 3) + 2 );
        if (l_U1 != 7)
        {
    ...
    while (NOT g_U857._fU16)
    {
        ...
        switch (g_U851._fU12)
        {
            ...
            if (l_U31 != -1)
            {
                sub_1784( ref g_U831, "eddielowfilthslayer.blogsnobs.org", l_U31, -1, -1 );
                g_U830 = 1;
            }
            break;
            default:
...
void sub_276()
{
    ...
    for ( l_U0 = 0; l_U0 <= 5; l_U0++ )
    {
        if ((l_U29 - l_U0) >= 0)
        {
            ...
            while (bVar2)
            {
                ...
                {
                    sub_856( ref l_U22[l_U0], ref l_U18, -1 );
    ...
    if (l_U30 != -1)
    {
        sub_1164( ref l_U32, "BLOG_NEXT_POSTS", "BACK" );
        if (l_U31 != -1)
        {
    ...
    if (l_U31 != -1)
    {
        sub_856( ref l_U32, "BLOG_PREV_POSTS", 2 );
    }
    return;
}
...
void sub_856(unknown uParam0, unknown uParam1, int iParam2)
{
    char[16] cVar5;
...
void sub_1164(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ADD_TO_HTML_SCRIPT_OBJECT( (uParam0^), "<a href="" );
...
void sub_1386(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_1397( uParam1 );
    if (bParam2)
    {
...
void sub_1784(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
