void main()
{
    ...
    sub_234();
    sub_2809( ref l_U18._fU0, 1, 0 );
    while (NOT g_U857._fU16)
    {
        WAIT( 0 );
        if (sub_3132( ref l_U16 ))
        {
            sub_234();
            sub_2809( ref l_U18._fU0, 1, 1 );
        }
    }
    g_U857._fU16 = 0;
    return;
...
void sub_234()
{
    ...
    if (l_U5 < 100)
    {
        l_U14 = GET_BITS_IN_RANGE( g_U1502[l_U5 / 16], (l_U5 mod 16) * 2, ((l_U5 mod 16) * 2) + 1 );
        if (l_U14 != 0)
        {
...
void sub_2809(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_2820( uParam1 );
    if (bParam2)
    {
