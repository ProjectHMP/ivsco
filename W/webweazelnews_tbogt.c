void main()
{
    ...
    sub_1040( 1 );
    sub_6393( ref l_U103._fU0, 1, 0 );
    while (NOT g_U864._fU16)
    {
        WAIT( 0 );
        if (sub_6718( ref l_U101 ))
        {
            sub_1040( 0 );
            sub_6393( ref l_U103._fU0, 1, 1 );
        }
        if (g_U858._fU12 != -1)
        {
            sub_6848( ref g_U838, "www.weazelnews.com/news.html", g_U858._fU12, -1, -1 );
            g_U837 = 1;
        }
    }
    if (l_U99)
...
void sub_1040(boolean bParam0)
{
    ...
    if (NOT (sub_1454( 1, ref l_U58, l_U2, 5, 1 )))
    {
    ...
    ConcatString(ref l_U75, l_U3, 16);
    sub_2571( ref l_U59, ref l_U75, -1 );
    l_U75 = {l_U71};
    ConcatString(ref l_U75, "SECH_", 16);
    ConcatString(ref l_U75, l_U3, 16);
    sub_2571( ref l_U60, ref l_U75, -1 );
    if (l_U99)
    {
        if (bParam0)
        {
            if (l_U102)
            {
                switch (l_U3)
                {
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_789" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_789" );
                    }
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_282930" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_282930" );
                    }
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_2021" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_2021" );
                    }
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_222324" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_222324" );
                    }
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_252627" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_252627" );
                    }
                    StrCopy( ref l_U79, "webNews_252627", 64 );
                    break;
                    case 30:
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_131415" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_131415" );
                    }
                    ...
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_3132" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_3132" );
                    }
                    StrCopy( ref l_U79, "webNews_3132", 64 );
                    break;
                    case 33:
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_3334" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_3334" );
                    }
                    StrCopy( ref l_U79, "webNews_3334", 64 );
                    break;
                    case 39:
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_383940" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_383940" );
                    }
                    StrCopy( ref l_U79, "webNews_383940", 64 );
                    break;
                    case 42:
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_4142" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_4142" );
                    }
                    StrCopy( ref l_U79, "webNews_4142", 64 );
                    break;
                    case 47:
                    if (# -NULL-0xc27c84())
                    {
                        l_U55 = LOAD_TXD( "e2:/xbox360/textures/webNews_4647" );
                    }
                    else if (# -NULL-0xc27bfa())
                    {
                        l_U55 = LOAD_TXD( "e2:/pc/textures/webNews_4647" );
                    }
                    StrCopy( ref l_U79, "webNews_4647", 64 );
                    break;
                    case 48:
                    if (# -NULL-0xc27c84())
                    {
            ...
            else
            {
                ...
                sub_5531( ref l_U95, "storyPhoto", l_U3, -1, -1 );
                l_U55 = LOAD_TXD( ref l_U79 );
            }
            l_U56 = GET_TEXTURE( l_U55, ref l_U95 );
        }
        sub_5679( ref l_U62, ref l_U79, ref l_U95, 330, 176, -1 );
    }
    l_U75 = {l_U71};
    ConcatString(ref l_U75, "REP_", 16);
    ConcatString(ref l_U75, l_U3, 16);
    sub_2571( ref l_U61, ref l_U75, -1 );
    l_U54 = 1;
    ...
    while (DOES_TEXT_LABEL_EXIST( ref l_U75 ))
    {
        if (l_U100)
        {
            sub_6151( ref l_U63[l_U70], ref l_U75 );
        }
        else
        {
            sub_2571( ref l_U63[l_U70], ref l_U75, -1 );
        }
...
int sub_1454(unknown uParam0, unknown uParam1, int iParam2, int iParam3, unknown uParam4)
{
    int I;
    int iVar8;
    int iVar9;
    ...
    {
        case 0:
        sub_1597( uParam1, "titAlso.jpg", -1, 88, 28 );
    ...
    for ( I = 48; I >= 1; I += -1 )
    {
        if (uVar11[I] != -1)
        {
            if ((bVar10) || (uVar11[I] == iVar9))
            {
                if (bVar10)
                {
                    sub_1999( uParam0, uParam1, uVar11[I], -1, ref iVar8, uParam4, iParam3 );
                    sub_3115( "\n adding other stories" );
                }
                else
                {
                    sub_1999( uParam0, uParam1, uVar11[I], iParam2 / 100, ref iVar8, uParam4, iParam3 );
...
void sub_1534(unknown uParam0, unknown uParam1)
{
    return;
}

void sub_1597(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4)
{
    char[16] cVar7;
...
void sub_1999(unknown uParam0, unknown uParam1, int iParam2, int iParam3, unknown uParam4, unknown uParam5, int iParam6)
{
    int I;
    int iVar10;
    char[12] cVar11;
    ...
    if ((iParam3 != 0) AND ((uParam4^) < iParam6))
    {
        for ( I = 0; I <= iVar10; I++ )
        {
            sub_2362( ref uVar20, ref cVar11[I], "LINK", iParam2, -1 );
            if (DOES_TEXT_LABEL_EXIST( ref uVar20 ))
            {
                sub_2457( uParam0, uParam1, uParam5 );
                sub_2571( uParam1, ref uVar20, iParam2 );
                ADD_TO_HTML_SCRIPT_OBJECT( (uParam1^), "<br/><br/>" );
                (uParam4^)++;
                I = iVar10 + 1;
            }
    ...
    if ((iParam3 != 1) AND ((uParam4^) < iParam6))
    {
        for ( I = 0; I <= iVar10; I++ )
        {
            sub_2362( ref uVar20, ref cVar11[I], "S1LINK", iParam2, -1 );
            if (DOES_TEXT_LABEL_EXIST( ref uVar20 ))
            {
                sub_2457( uParam0, uParam1, uParam5 );
                sub_2571( uParam1, ref uVar20, iParam2 + 100 );
                ADD_TO_HTML_SCRIPT_OBJECT( (uParam1^), "<br/><br/>" );
                (uParam4^)++;
                I = iVar10 + 1;
            }
    ...
    if ((iParam3 != 2) AND ((uParam4^) < iParam6))
    {
        for ( I = 0; I <= iVar10; I++ )
        {
            sub_2362( ref uVar20, ref cVar11[I], "S2LINK", iParam2, -1 );
            if (DOES_TEXT_LABEL_EXIST( ref uVar20 ))
            {
                sub_2457( uParam0, uParam1, uParam5 );
                sub_2571( uParam1, ref uVar20, iParam2 + 200 );
                ADD_TO_HTML_SCRIPT_OBJECT( (uParam1^), "<br/><br/>" );
                (uParam4^)++;
                I = iVar10 + 1;
            }
...
void sub_2362(unknown uParam0, unknown uParam1, unknown uParam2, int iParam3, int iParam4)
{
...
void sub_2457(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (bParam2)
    {
        switch (uParam0)
        {
            case 0:
            sub_1597( uParam1, "arrowBlack.jpg", -1, 16, 16 );
            break;
            case 2:
            sub_1597( uParam1, "arrow.jpg", -1, 16, 16 );
            break;
        }
    }
    return;
...
void sub_2571(unknown uParam0, unknown uParam1, int iParam2)
{
    char[16] cVar5;
...
void sub_3115(unknown uParam0)
{
    return;
}

void sub_5531(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4)
{
    StrCopy( (uParam0^), uParam1, 16 );
    if (iParam2 != -1)
    {
...
void sub_5679(unknown uParam0, unknown uParam1, unknown uParam2, int iParam3, int iParam4, int iParam5)
{
    char[16] cVar8;
...
void sub_6151(unknown uParam0, unknown uParam1)
{
...
void sub_6393(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_6404( uParam1 );
    if (bParam2)
    {
...
void sub_6848(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
