void main()
{
    ...
    StrCopy( ref l_U4, "EMAILE", 8 );
    ConcatString(ref l_U4, GET_CURRENT_EPISODE(), 8);
    LOAD_ADDITIONAL_TEXT( ref l_U4, 1 );
    ALLOW_THIS_SCRIPT_TO_BE_PAUSED( 0 );
    StrCopy( ref l_U2, "E", 8 );
    ConcatString(ref l_U2, GET_CURRENT_EPISODE(), 8);
    StrCopy( ref l_U4, "EML", 8 );
    ConcatString(ref l_U4, GET_CURRENT_EPISODE(), 8);
    l_U9 = -1;
    if (g_U860._fU40 == -1)
    {
    ...
    g_U860._fU12 = 0;
    sub_397( 0 );
    sub_8665( ref l_U54._fU0, 1, 0 );
    while (NOT g_U860._fU16)
    {
        WAIT( 0 );
        if (sub_8988( ref l_U25 ))
        {
            l_U9 = -1;
            l_U24 = 0;
            g_U860._fU8 = 0;
        ...
        switch (l_U24)
        {
            ...
            case 2:
            if ((g_U860._fU312) AND (g_U860._fU8))
            {
                iVar2 = 40;
            }
            break;
        ...
        switch (iVar2)
        {
            ...
            if (g_U860._fU40 == -1)
            {
                sub_9400( ref g_U971[l_U9] );
                l_U15 = sub_483( 0, g_U971[l_U9] );
            }
            else
            {
                sub_9400( ref g_U1372[l_U9] );
                l_U15 = sub_483( 0, g_U1372[l_U9] );
            }
            ...
            if (g_U860._fU40 == -1)
            {
                if ((sub_483( 3, g_U971[l_U9] )) != 16383)
                {
                    l_U10 = 3;
                }
                else if ((sub_483( 2, g_U971[l_U9] )) != 16383)
                {
                    l_U10 = 2;
                }
                l_U11 = 0;
                if ((sub_483( 6, g_U971[l_U9] )) != 65535)
                {
                    sub_10130( sub_483( 6, g_U971[l_U9] ) );
                    l_U11 = 1;
                }
            }
            else if ((sub_483( 3, g_U1372[l_U9] )) != 16383)
            {
                l_U10 = 3;
            }
            else if ((sub_483( 2, g_U1372[l_U9] )) != 16383)
            {
                l_U10 = 2;
            }
            l_U11 = 0;
            if ((sub_483( 6, g_U1372[l_U9] )) != 65535)
            {
                sub_10130( sub_483( 6, g_U1372[l_U9] ) );
                l_U11 = 1;
            }
            if (g_U860._fU40 == -1)
            {
                uVar3 = sub_483( 1, g_U971[l_U9] );
                sub_2384( ref l_U18, ref l_U2, "R", l_U15, uVar3 );
                if (NOT g_U971[l_U9]._fU20)
                {
                    sub_2052( ref uVar4, ref uVar8, l_U15, uVar3, 0 );
                ...
                if (g_U971[l_U9]._fU36)
                {
                    if ((NOT g_U971[l_U9]._fU24) || (g_U971[l_U9]._fU28))
                    {
                        g_U971[l_U9]._fU36 = 0;
                    }
                    else
                    {
                        switch (sub_483( 4, g_U971[l_U9] ))
                        {
                            case 2:
                            case 4:
                            case 5:
            ...
            if (iVar2 == 30)
            {
                sub_10982( ref g_U971[l_U9], 1 );
            }
            else
            {
                sub_10982( ref g_U971[l_U9], 0 );
            }
            if (iVar2 == 30)
            {
...
void sub_397(boolean bParam0)
{
    ...
    if (l_U9 != -1)
    {
        if (g_U860._fU40 == -1)
        {
            sub_1687( g_U971[l_U9] );
        }
        else
        {
            sub_1687( g_U1372[l_U9] );
        }
    }
    else if (g_U860._fU40 == -1)
    {
        sub_1687( g_U971[0] );
    }
    else
...
void sub_413()
{
    ...
    if (g_U971[39]._fU0[0] != -1)
    {
        ...
        sub_1198( ref l_U26[10], ref cVar2, -1 );
    }
    else
    {
...
int sub_483(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    switch (uParam0)
    {
        case 0:
...
void sub_1198(unknown uParam0, unknown uParam1, int iParam2)
{
    char[16] cVar5;
...
void sub_1687(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9)
{
    char[16] cVar12;
    unknown uVar16;
    unknown uVar17;
    ...
    switch (l_U24)
    {
        ...
        if (l_U9 != -1)
        {
            switch (l_U24)
            {
                ...
                iVar32 = sub_483( 12, g_U971[l_U9] );
                iVar33 = sub_483( 14, g_U971[l_U9] );
                sub_2052( ref cVar12, ref uVar16, l_U15, sub_483( 8, uParam0 ), -1 );
                sub_2151( ref l_U26[7], ref cVar12 );
                ADD_TO_HTML_SCRIPT_OBJECT( l_U26[7], "<br/><br/>" );
                if (iVar32 == 1)
                {
                    string(ref cVar12, sub_483( 11, g_U971[l_U9] ), 16);
                ...
                {
                    sub_2384( ref cVar12, ref l_U2, "EMAIL_DAY", sub_483( 13, g_U971[l_U9] ), -1 );
                    sub_1198( ref l_U26[7], ref cVar12, -1 );
                    ADD_TO_HTML_SCRIPT_OBJECT( l_U26[7], "." );
                    ADD_TO_HTML_SCRIPT_OBJECT( l_U26[7], "&nbsp;" );
                }
                sub_2384( ref cVar12, ref l_U2, "M", l_U15, sub_483( 1, uParam0 ) );
                sub_2151( ref l_U26[7], ref cVar12 );
                if (iVar32 == 2)
                {
                    ADD_TO_HTML_SCRIPT_OBJECT( l_U26[7], "&nbsp;" );
                ...
                {
                    sub_2052( ref cVar12, "EMAIL_DAY", sub_483( 13, g_U971[l_U9] ), -1, -1 );
                    sub_1198( ref l_U26[7], ref cVar12, -1 );
                    ADD_TO_HTML_SCRIPT_OBJECT( l_U26[7], "." );
                }
                if (l_U10 > 1)
                {
                    ...
                    sub_2384( ref cVar12, ref l_U2, "M", l_U15, sub_483( 2, uParam0 ) );
                    sub_2151( ref l_U26[8], ref cVar12 );
                    if (iVar32 == 3)
                    {
                        ADD_TO_HTML_SCRIPT_OBJECT( l_U26[8], "&nbsp;" );
                        string(ref cVar12, sub_483( 11, g_U971[l_U9] ), 16);
                    ...
                    {
                        sub_2052( ref cVar12, "EMAIL_DAY", sub_483( 13, g_U971[l_U9] ), -1, -1 );
                        sub_1198( ref l_U26[8], ref cVar12, -1 );
                        ADD_TO_HTML_SCRIPT_OBJECT( l_U26[8], "." );
                    }
                    if (l_U10 > 2)
                    {
                        ADD_TO_HTML_SCRIPT_OBJECT( l_U26[9], "&nbsp;" );
                        sub_2384( ref cVar12, ref l_U2, "M", l_U15, sub_483( 3, g_U971[l_U9] ) );
                        sub_2151( ref l_U26[9], ref cVar12 );
                        if (iVar32 == 4)
                        {
                            ADD_TO_HTML_SCRIPT_OBJECT( l_U26[9], "&nbsp;" );
                            string(ref cVar12, sub_483( 11, g_U971[l_U9] ), 16);
                        ...
                        {
                            sub_2052( ref cVar12, "EMAIL_DAY", sub_483( 13, g_U971[l_U9] ), -1, -1 );
                            sub_1198( ref l_U26[9], ref cVar12, -1 );
                            ADD_TO_HTML_SCRIPT_OBJECT( l_U26[9], "." );
                        }
                    }
                }
                ADD_TO_HTML_SCRIPT_OBJECT( l_U26[9], "<br/><br/>" );
                sub_2052( ref cVar12, ref uVar20, l_U15, sub_483( 9, g_U971[l_U9] ), -1 );
                sub_2151( ref l_U26[9], ref cVar12 );
                ADD_TO_HTML_SCRIPT_OBJECT( l_U26[9], "<br /><br />" );
                sub_2384( ref cVar12, ref l_U2, "_SIGNOFF", l_U15, -1 );
                sub_1198( ref l_U26[9], ref cVar12, -1 );
                break;
                case 2:
                ...
                sub_3541( ref l_U26[7], ref l_U45, ref l_U50, 320, 200, -1 );
        ...
        l_U22++;
        if (((l_U22 > l_U23) || (g_U860._fU312)) || (g_U860._fU320))
        {
            l_U22 = l_U23;
            l_U16 = 1;
        }
        ...
        if (l_U16)
        {
            ...
            if (l_U17)
            {
                sub_4488( ref l_U26[7], "posIcon.jpg", -1, 16, 16 );
            }
            else
            {
                sub_4488( ref l_U26[7], "negIcon.jpg", -1, 16, 16 );
            }
            sub_1198( ref l_U26[7], "EMAILMSG_SENT", -1 );
            g_U860._fU8 = 0;
            g_U860._fU12 = 0;
            g_U854._fU20 = 0;
        }
...
void sub_2052(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4)
{
...
void sub_2151(unknown uParam0, unknown uParam1)
{
...
void sub_2384(unknown uParam0, unknown uParam1, unknown uParam2, int iParam3, int iParam4)
{
    StrCopy( (uParam0^), uParam1, 16 );
...
void sub_3541(unknown uParam0, unknown uParam1, unknown uParam2, int iParam3, int iParam4, int iParam5)
{
    char[16] cVar8;
...
void sub_4488(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4)
{
    char[16] cVar7;
...
void sub_4927()
{
    ...
    if (l_U9 != -1)
    {
        ...
        {
            sub_1198( ref l_U26[11], "EMAIL_VIEW", -1 );
            if (l_U24 == 0)
            {
                sub_3541( ref l_U26[12], ref l_U45, ref l_U50, 70, 40, 41 );
            }
            else
            {
                sub_4488( ref l_U26[12], "but_email.jpg", 40, 70, 40 );
            }
        }
        if (l_U24 != 1)
        {
            if (g_U860._fU40 == -1)
            {
                if ((g_U971[l_U9]._fU36) AND (NOT g_U971[l_U9]._fU28))
                {
                    sub_1198( ref l_U26[13], "EMAIL_REPLY", -1 );
                    sub_4488( ref l_U26[14], "but_reply_pos.jpg", 30, 70, 40 );
                    sub_4488( ref l_U26[15], "but_reply_neg.jpg", 31, 70, 40 );
                }
                else if (g_U971[l_U9]._fU16)
                {
                    sub_1198( ref l_U26[13], "EMAIL_DELETE", -1 );
                    sub_4488( ref l_U26[14], "but_delete.jpg", 21, 70, 40 );
                }
            }
        }
    }
...
void sub_5455()
{
    ...
    if (l_U9 != -1)
    {
        ...
        sub_2384( ref uVar2, ref l_U2, "_ADDRESS", l_U15, -1 );
        sub_1198( ref l_U26[6], ref uVar2, -1 );
        ...
        if (g_U860._fU40 == -1)
        {
            sub_2384( ref uVar2, ref l_U2, "S", l_U15, sub_483( 1, g_U971[l_U9] ) );
        }
        else
        {
            sub_2384( ref uVar2, ref l_U2, "S", l_U15, sub_483( 1, g_U1372[l_U9] ) );
        }
        sub_1198( ref l_U26[6], ref uVar2, -1 );
        ADD_TO_HTML_SCRIPT_OBJECT( l_U26[6], "</span></th>" );
        ADD_TO_HTML_SCRIPT_OBJECT( l_U26[6], "</tr>" );
...
void sub_6234()
{
    ...
    for ( I = 0; I <= (l_U6 - 1); I++ )
    {
        if (((l_U12 - I) >= 0) AND (l_U13 != 0))
        {
            if (g_U860._fU40 == -1)
            {
                sub_6472( g_U971[l_U12 - I], I );
            }
            else
            {
                sub_6472( g_U1372[l_U12 - I], I );
            }
        }
    }
    return;
...
void sub_6472(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, int iParam10)
{
    unknown uVar13;
    unknown uVar14;
    unknown uVar15;
    ...
    if ((sub_483( 6, uParam0 )) != 65535)
    {
        sub_4488( ref l_U26[iParam10], "attachedIcon.jpg", -1, 12, 20 );
    }
    ...
    sub_2384( ref uVar14, ref l_U2, "_NAME", uVar13, -1 );
    if (l_U9 == (l_U12 - iParam10))
    {
        sub_1198( ref l_U26[iParam10], ref uVar14, -1 );
    }
    else
    {
        sub_1198( ref l_U26[iParam10], ref uVar14, iParam10 );
    }
    ...
    ADD_TO_HTML_SCRIPT_OBJECT( l_U26[iParam10], "<span class="read_text">" );
    sub_2384( ref uVar14, ref l_U2, "S", uVar13, sub_483( 1, uParam0 ) );
    sub_1198( ref l_U26[iParam10], ref uVar14, -1 );
    ADD_TO_HTML_SCRIPT_OBJECT( l_U26[iParam10], "</span></th>" );
    if (iParam10 == 0)
    {
        ...
        else
        {
            ...
            sub_4488( ref l_U26[iParam10], "but_up.jpg", 10, 16, 16 );
            ADD_TO_HTML_SCRIPT_OBJECT( l_U26[iParam10], "</th>" );
        }
    }
    else if (iParam10 == (l_U6 - 1))
    {
        ...
        {
            ADD_TO_HTML_SCRIPT_OBJECT( l_U26[iParam10], "<th width="30" align="center" valign="middle" bgcolor="#999999">" );
            sub_4488( ref l_U26[iParam10], "but_down.jpg", 11, 16, 16 );
            ADD_TO_HTML_SCRIPT_OBJECT( l_U26[iParam10], "</th>" );
        }
    }
    else
...
void sub_8565(int iParam0, unknown uParam1)
{
...
void sub_8665(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_8676( uParam1 );
    if (bParam2)
    {
...
void sub_9400(unknown uParam0)
{
    switch (sub_483( 4, (uParam0^) ))
    {
        case 0:
        case 1:
        sub_9454( 3, 4, uParam0 );
        break;
        case 2:
        sub_9454( 4, 4, uParam0 );
        break;
    }
    return;
}

void sub_9454(unknown uParam0, unknown uParam1, int iParam2)
{
    switch (uParam1)
    {
        case 0:
...
void sub_10982(int iParam0, unknown uParam1)
{
    switch (sub_483( 4, (iParam0^) ))
    {
        case 3:
        case 4:
        sub_9454( 5, 4, iParam0 );
        iParam0->_fU28 = 1;
