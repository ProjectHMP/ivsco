void main()
{
    ...
    ADD_TO_HTML_SCRIPT_OBJECT( uVar18, ref g_U860._fU76 );
    if (g_U860._fU40 == -1)
    {
    ...
    {
        default:
        StrCopy( ref cVar25, "LCT", 16 );
        ConcatString(ref cVar25, GET_CURRENT_EPISODE(), 16);
        cVar29 = {cVar25};
        ConcatString(ref cVar29, "_HEAD", 16);
        ConcatString(ref cVar25, "_LINK_", 16);
        ConcatString(ref cVar25, g_U1454, 16);
        if (DOES_TEXT_LABEL_EXIST( ref cVar25 ))
        {
            StrCopy( ref cVar25, "LBTR", 16 );
            ConcatString(ref cVar25, GET_CURRENT_EPISODE(), 16);
            ConcatString(ref cVar25, g_U1454, 16);
            break;
        }
        ...
        ConcatString(ref cVar25, g_U1454, 16);
        StrCopy( ref cVar29, "LCT_HEAD", 16 );
        break;
    }
    LOAD_ADDITIONAL_TEXT( ref cVar25, 1 );
    sub_2241( ref cVar25, ref cVar29, g_U1454, -1, -1 );
    sub_2375( ref uVar24, ref cVar25, "www.libertytreeonline.com/news.html" );
    array(ref uVar33, 3);
    uVar33[0] = CREATE_HTML_SCRIPT_OBJECT( "tvAdvert_0" );
    uVar33[1] = CREATE_HTML_SCRIPT_OBJECT( "tvAdvert_1" );
    uVar33[2] = CREATE_HTML_SCRIPT_OBJECT( "tvAdvert_2" );
    uVar37 = LOAD_TXD( "webTVadverts" );
    array(ref uVar38, 3);
    array(ref cVar42, 3);
    switch (GET_CURRENT_DAY_OF_WEEK())
    {
        case 0:
        StrCopy( ref cVar42[0], "tvadvert_9", 16 );
        StrCopy( ref cVar42[1], "tvadvert_5", 16 );
        StrCopy( ref cVar42[2], "tvadvert_2", 16 );
        break;
        case 1:
        StrCopy( ref cVar42[0], "tvadvert_8", 16 );
        StrCopy( ref cVar42[1], "tvadvert_0", 16 );
        StrCopy( ref cVar42[2], "tvadvert_3", 16 );
        break;
        case 2:
        StrCopy( ref cVar42[0], "tvadvert_7", 16 );
        StrCopy( ref cVar42[1], "tvadvert_2", 16 );
        StrCopy( ref cVar42[2], "tvadvert_1", 16 );
        break;
        case 3:
        StrCopy( ref cVar42[0], "tvadvert_9", 16 );
        StrCopy( ref cVar42[1], "tvadvert_0", 16 );
        ...
        case 4:
        StrCopy( ref cVar42[0], "tvadvert_7", 16 );
        StrCopy( ref cVar42[1], "tvadvert_1", 16 );
        StrCopy( ref cVar42[2], "tvadvert_3", 16 );
        break;
        case 5:
        StrCopy( ref cVar42[0], "tvadvert_8", 16 );
        StrCopy( ref cVar42[1], "tvadvert_2", 16 );
        StrCopy( ref cVar42[2], "tvadvert_4", 16 );
        break;
        case 6:
        StrCopy( ref cVar42[0], "tvadvert_8", 16 );
        StrCopy( ref cVar42[1], "tvadvert_6", 16 );
        StrCopy( ref cVar42[2], "tvadvert_1", 16 );
        break;
    }
    uVar38[0] = GET_TEXTURE( uVar37, ref cVar42[0] );
    uVar38[1] = GET_TEXTURE( uVar37, ref cVar42[1] );
    uVar38[2] = GET_TEXTURE( uVar37, ref cVar42[2] );
    sub_3328( ref uVar33[0], "webTVadverts", ref cVar42[0], 128, 105, -1 );
    sub_3328( ref uVar33[1], "webTVadverts", ref cVar42[1], 128, 105, -1 );
    sub_3328( ref uVar33[2], "webTVadverts", ref cVar42[2], 128, 105, -1 );
    sub_3688( ref l_U6._fU0, 1, 0 );
    ...
    REMOVE_TXD( uVar3 );
    RELEASE_TEXTURE( uVar38[0] );
    RELEASE_TEXTURE( uVar38[1] );
    RELEASE_TEXTURE( uVar38[2] );
    REMOVE_TXD( uVar37 );
    g_U860._fU16 = 0;
    return;
}
...
void sub_2241(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4)
{
...
void sub_2375(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ADD_TO_HTML_SCRIPT_OBJECT( (uParam0^), "<a href="" );
...
void sub_3328(unknown uParam0, unknown uParam1, unknown uParam2, int iParam3, int iParam4, int iParam5)
{
    char[16] cVar8;
...
void sub_3688(unknown uParam0, unknown uParam1, boolean bParam2)
{
    sub_3699( uParam1 );
    if (bParam2)
    {
