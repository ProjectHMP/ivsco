...
void sub_178()
{
    ...
    for ( I = 0; I <= 4; I++ )
    {
        ...
        sub_226( ref uVar7, "EYE_SEARCH3", l_U6[l_U88], -1, -1 );
        sub_226( ref uVar3, "EYE_SEARCH1", l_U6[l_U88], -1, -1 );
        sub_412( ref l_U0[I], ref uVar3, GET_STRING_FROM_TEXT_FILE( ref uVar7 ) );
        ADD_TO_HTML_SCRIPT_OBJECT( l_U0[I], "<br/>" );
        sub_226( ref uVar3, "EYE_SEARCH2", l_U6[l_U88], -1, -1 );
