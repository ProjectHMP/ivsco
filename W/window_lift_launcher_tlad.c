void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U152)
        {
            ...
            if (l_U153 == 1)
            {
                sub_1973( l_U154[1], ref l_U161, l_U162, l_U163, "misslift", 1 );
...
void sub_1973(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    vector vVar8;
    unknown uVar11;
    ...
    if (DOES_OBJECT_EXIST( uParam0 ))
    {
        if (l_U141)
        {
            sub_2056( uParam4, uParam1, uParam5, uParam0 );
        }
        else
        {
            sub_3078( uParam0, uParam1, uParam2, uParam3, uParam4, uParam5 );
            sub_4133( uParam0, uParam3, uParam2 );
            if (NOT (IS_PLAYER_TARGETTING_ANYTHING( sub_2377() )))
            {
                sub_4432( uParam0 );
            }
            ...
            if (NOT (IS_CHAR_DEAD( sub_2101() )))
            {
                if (l_U14)
                {
                    if (NOT (IS_PED_ATTACHED_TO_OBJECT( sub_2101(), uParam0 )))
                    {
                        if (sub_6362( uParam4 ))
                        {
                            if (NOT (IS_CHAR_DEAD( sub_2101() )))
                            {
                                if (NOT l_U61)
                                {
                                    FREEZE_CHAR_POSITION( sub_2101(), 0 );
                                    CLEAR_CHAR_TASKS( sub_2101() );
                                    GET_OBJECT_HEADING( uParam0, ref uVar11 );
                                    l_U61 = 1;
                                    SET_CHAR_HEADING( sub_2101(), uVar11 );
                                    ATTACH_PED_TO_OBJECT( sub_2101(), uParam0, 0, vVar8, 0.00000000, 0.00000000, 0, 0 );
                                    TASK_PLAY_ANIM( sub_2101(), "OPERATE_LIFT_INTRO", uParam4, 8.00000000, 0, 0, 0, 1, -1 );
                                    sub_6806( uParam1, uParam0, uParam5 );
                                    l_U126 = 0;
                                }
                            }
                        }
                    ...
                    {
                        TASK_LOOK_AT_COORD( sub_2101(), 0.00000000, 0.00000000, 0.00000000, 1, 32 );
                    }
                }
            }
            if ((l_U61) || (l_U13))
            {
                ...
                sub_7521( ref uParam0, uParam2, uParam3, uParam4 );
                if (NOT l_U13)
                {
                    sub_9283();
                    sub_7283( uParam1, uParam5 );
        ...
        if ((l_U62) || (l_U150))
        {
            if ((IS_CONTROL_PRESSED( 0, 23 )) || (l_U150))
            {
                if ((l_U63) || (l_U150))
                {
                    if ((l_U61) || (l_U150))
    ...
    if (NOT (IS_CHAR_DEAD( sub_2101() )))
    {
        if ((((IS_CHAR_PLAYING_ANIM( sub_2101(), uParam4, "GET_IN_LIFT_BOTTOM" )) || (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam4, "OPERATE_LIFT_SWITCH" ))) || (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam4, "operate_lift_intro" ))) || (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam4, "GET_IN_LIFT_TOP" )))
        {
            l_U149 = 1;
        }
        else
...
void sub_2056(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    float fVar6;
    ...
    switch (l_U148)
    {
        ...
        if (NOT (IS_CHAR_DEAD( sub_2101() )))
        {
            TASK_PLAY_ANIM( sub_2101(), "operate_lift_outro", uParam0, 8.00000000, 0, 0, 0, 0, -1 );
            SETTIMERA( 0 );
            l_U148 = 1;
        }
        break;
        ...
        if (NOT (IS_CHAR_DEAD( sub_2101() )))
        {
            if (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam0, "operate_lift_outro" ))
            {
                GET_CHAR_ANIM_CURRENT_TIME( sub_2101(), uParam0, "operate_lift_outro", ref fVar6 );
                if (fVar6 > 0.50000000)
                {
                    l_U148 = 2;
                }
        ...
        if (NOT (IS_CHAR_DEAD( sub_2101() )))
        {
            SET_USE_LEG_IK( sub_2377(), 0 );
            DETACH_PED( sub_2101(), 0 );
            SETTIMERA( 0 );
            sub_2437();
            CLEAR_PRINTS();
            l_U93 = 0.00000000;
...
void sub_2672(int iParam0, string sParam1)
{
    string sVar4;
    ...
    if (NOT (IS_STRING_NULL( sParam1 )))
    {
        if (COMPARE_STRING( sParam1, ref g_U10470 ))
        {
            ...
            if (l_U4)
            {
                ALLOW_PLAYER_TO_CARRY_NON_MISSION_OBJECTS( sub_2377(), 1 );
                l_U4 = 0;
            }
            if (l_U2)
            {
...
void sub_3078(unknown uParam0, unknown uParam1, float fParam2, float fParam3, unknown uParam4, unknown uParam5)
{
    if (DOES_OBJECT_EXIST( uParam0 ))
    {
    ...
    switch (l_U119)
    {
        ...
        sub_3325( uParam0, uParam1, 0, uParam4, uParam5 );
        break;
        case 1:
        ...
        sub_3325( uParam0, uParam1, 1, uParam4, uParam5 );
        break;
        case 2: break;
    }
    return;
...
void sub_3325(unknown uParam0, unknown uParam1, int iParam2, unknown uParam3, unknown uParam4)
{
    if (l_U136)
    {
        if (NOT l_U61)
        {
            if (NOT l_U126)
            {
                ...
                SET_CHAR_COORDINATES( sub_2101(), l_U104._fU0, l_U104._fU4, l_U104._fU8 );
                SET_CHAR_HEADING( sub_2101(), l_U53 );
                sub_3480( uParam1, uParam0, uParam4 );
                CLEAR_CHAR_TASKS( sub_2101() );
                WAIT( 0 );
                ...
                if (iParam2 == 0)
                {
                    FREEZE_CHAR_POSITION( sub_2101(), 1 );
                    TASK_PLAY_ANIM_WITH_ADVANCED_FLAGS( sub_2101(), "GET_IN_LIFT_BOTTOM", uParam3, 8.00000000, 0, 0, 0, 0, 0, 0, 1, -1 );
                }
                else
                {
                    TASK_PLAY_ANIM_WITH_ADVANCED_FLAGS( sub_2101(), "GET_IN_LIFT_TOP", uParam3, 8.00000000, 0, 1, 1, 1, 0, 0, 0, -1 );
                }
                SETTIMERB( 0 );
            }
        }
...
void sub_3480(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (bParam2)
    {
        if (NOT l_U9)
...
void sub_4133(unknown uParam0, float fParam1, unknown uParam2)
{
    unknown uVar5;
    unknown uVar6;
    unknown uVar7;
    ...
    if (NOT l_U14)
    {
        if (NOT (IS_CHAR_DEAD( sub_2101() )))
        {
            if (NOT (IS_CHAR_IN_ANGLED_AREA_3D( sub_2101(), uVar9._fU0, uVar9._fU4, uVar9._fU8, uVar12._fU0, uVar12._fU4, uVar12._fU8, 3.00000000, 0 )))
            {
                GET_OBJECT_COORDINATES( uParam0, ref l_U120._fU0, ref l_U120._fU4, ref l_U120._fU8 );
                GET_CHAR_COORDINATES( sub_2101(), ref uVar6._fU0, ref uVar6._fU4, ref uVar6._fU8 );
...
void sub_4432(unknown uParam0)
{
    ...
    if (NOT l_U13)
    {
        if (NOT l_U14)
        {
            if (NOT (IS_CHAR_DEAD( sub_2101() )))
            {
                if (IS_CHAR_IN_ANGLED_AREA_3D( sub_2101(), l_U101._fU0, l_U101._fU4, l_U101._fU8, l_U104._fU0, l_U104._fU4, l_U104._fU8, 1.00000000, 0 ))
                {
                    if ((l_U83) || (l_U84))
                    {
                        if (TIMERA() > 2000)
                    ...
                    else if (NOT (IS_CHAR_IN_ANGLED_AREA_3D( sub_2101(), l_U130._fU0, l_U130._fU4, l_U130._fU8, l_U133._fU0, l_U133._fU4, l_U133._fU8, 1.00000000, 0 )))
                    {
                        sub_2672( 2, "WClift_01" );
                    }
                }
                else if (NOT (IS_CHAR_DEAD( sub_2101() )))
                {
                    if (NOT (IS_CHAR_IN_ANGLED_AREA_3D( sub_2101(), l_U130._fU0, l_U130._fU4, l_U130._fU8, l_U133._fU0, l_U133._fU4, l_U133._fU8, 1.00000000, 0 )))
                    {
                        l_U140 = 0;
                    }
                }
        ...
        if (NOT l_U14)
        {
            if (NOT (IS_CHAR_DEAD( sub_2101() )))
            {
                if (IS_CHAR_IN_ANGLED_AREA_3D( sub_2101(), l_U130._fU0, l_U130._fU4, l_U130._fU8, l_U133._fU0, l_U133._fU4, l_U133._fU8, 1.00000000, 0 ))
                {
                    if (TIMERA() > 2000)
                    {
                        if (NOT l_U136)
...
int sub_4844(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_2377() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((IS_PLAYER_CONTROL_ON( sub_2377() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_2377() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_4940())
                    {
                        if ((GET_OBJECT_PED_IS_HOLDING( sub_2101() )) == nil)
                        {
                            if (g_U10468 <= iParam0)
                            {
                                if (g_U10469 == 0)
...
int sub_5036(boolean bParam0, unknown uParam1)
{
    if (bParam0)
    {
        g_U94._fU104 = 1;
...
int sub_5147(unknown uParam0, string sParam1, unknown uParam2)
{
    string sVar5;
    string sVar6;
    ...
    if (sub_4844( uParam0, uParam2 ))
    {
        if (((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) || (IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( sParam1, sVar5 ))) || (IS_CONTROL_PRESSED( 2, 23 )))
        {
            if (NOT l_U4)
            {
                ALLOW_PLAYER_TO_CARRY_NON_MISSION_OBJECTS( sub_2377(), 0 );
                l_U4 = 1;
            }
            g_U10468 = uParam0;
            l_U5 = 1;
...
void sub_6362(unknown uParam0)
{
    ...
    if (l_U14)
    {
        if (l_U126)
        {
            if (NOT (IS_CHAR_DEAD( sub_2101() )))
            {
                if ((IS_CHAR_PLAYING_ANIM( sub_2101(), uParam0, "GET_IN_LIFT_BOTTOM" )) || (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam0, "GET_IN_LIFT_TOP" )))
                {
                    l_U151 = 1;
                }
            }
            if (l_U151)
            {
                if (NOT (IS_CHAR_DEAD( sub_2101() )))
                {
                    if (NOT (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam0, "GET_IN_LIFT_BOTTOM" )))
                    {
                        if (NOT (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam0, "GET_IN_LIFT_TOP" )))
                        {
                            l_U151 = 0;
                            Result = 1;
                        }
...
void sub_6806(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (NOT l_U6)
    {
        if (bParam2)
        {
            ...
            if (NOT (IS_CHAR_DEAD( sub_2101() )))
            {
                POINT_CAM_AT_PED( l_U7, sub_2101() );
            }
        ...
        else
        {
            ...
            if (NOT (IS_CHAR_DEAD( sub_2101() )))
            {
                POINT_CAM_AT_PED( (uParam0^), sub_2101() );
            }
            GET_GAME_VIEWPORT_ID( ref l_U15 );
            CLEAR_ROOM_FOR_VIEWPORT( l_U15 );
            SET_CAM_ACTIVE( (uParam0^), 1 );
...
void sub_7283(unknown uParam0, boolean bParam1)
{
    if (NOT (IS_CHAR_DEAD( sub_2101() )))
    {
        if (bParam1)
...
void sub_7521(unknown uParam0, float fParam1, float fParam2, unknown uParam3)
{
    int iVar6;
    int iVar7;
    unknown uVar8;
    ...
    if (((iVar7 > 10) AND (iVar7 < 129)) || (l_U13))
    {
    ...
    switch (l_U76)
    {
        ...
        break;
        case 4:
        if ((sub_8447( uParam3 )) || (l_U13))
        {
            GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( (uParam0^), 1.00000000, 0.50000000, -1.00000000, ref l_U95._fU0, ref l_U95._fU4, ref l_U95._fU8 );
            GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( (uParam0^), -1.00000000, 0.50000000, -3.00000000, ref l_U98._fU0, ref l_U98._fU4, ref l_U98._fU8 );
            if (NOT (IS_CHAR_DEAD( sub_2101() )))
            {
                if (NOT (IS_CHAR_IN_ANGLED_AREA_3D( sub_2101(), l_U95._fU0, l_U95._fU4, l_U95._fU8, l_U98._fU0, l_U98._fU4, l_U98._fU8, 1.00000000, 0 )))
                {
...
int sub_8447(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_2101() )))
    {
        if (l_U91)
        {
            if (IS_CHAR_PLAYING_ANIM( sub_2101(), uParam0, "OPERATE_LIFT_SWITCH" ))
            {
                GET_CHAR_ANIM_CURRENT_TIME( sub_2101(), uParam0, "OPERATE_LIFT_SWITCH", ref fVar3 );
                if (fVar3 > 0.50000000)
                {
                    return 1;
                }
            ...
            {
                TASK_PLAY_ANIM( sub_2101(), "OPERATE_LIFT_SWITCH", uParam0, 8.00000000, 0, 0, 0, 1, -1 );
            }
        }
        else if (NOT l_U13)
        {
...
void sub_9770()
{
    ...
    if (l_U153 == 1)
    {
        GET_CHAR_COORDINATES( sub_2101(), ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
