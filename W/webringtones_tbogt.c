void main()
{
    ...
    l_U15 = 0;
    if (GET_CURRENT_DAY_OF_WEEK() != g_U1441._fU64)
    {
        sub_86();
    }
    sub_676();
    ...
    while (NOT g_U864._fU16)
    {
        ...
        switch (g_U858._fU12)
        {
            ...
            iVar2 = g_U1441._fU4[g_U858._fU12];
            break;
            case 4:
            case 5:
            case 6:
            case 7:
            sub_2394( ref g_U838, "www.vipluxuryringtones.com/purchase.html", 0, g_U1441._fU4[g_U858._fU12 - 4], -1 );
            g_U837 = 1;
            break;
            case 8:
            case 9:
            ...
            case 11:
            STOP_PREVIEW_RINGTONE();
            iVar2 = g_U1441._fU24[g_U858._fU12 - 8];
            break;
            case 12:
            case 13:
            case 14:
            case 15:
            sub_2394( ref g_U838, "www.vipluxuryringtones.com/purchase.html", 1, g_U1441._fU24[g_U858._fU12 - 12], -1 );
            g_U837 = 1;
            break;
            case 16:
            case 17:
            case 18:
            case 19:
            sub_2394( ref g_U838, "www.vipluxuryringtones.com/purchase.html", 2, g_U1441._fU44[g_U858._fU12 - 16], -1 );
            g_U837 = 1;
            break;
            default:
...
void sub_86()
{
    ...
    g_U1441._fU4[1] = 38;
    g_U1441._fU4[2] = 39;
    GENERATE_RANDOM_INT_IN_RANGE( 16, 27, ref g_U1441._fU4[3] );
    for ( I = 3; I >= 1; I += -1 )
    {
        GENERATE_RANDOM_INT_IN_RANGE( 0, I + 1, ref uVar15 );
        uVar16 = g_U1441._fU4[I];
        g_U1441._fU4[I] = g_U1441._fU4[uVar15];
        g_U1441._fU4[uVar15] = uVar16;
    }
    for ( I = 0; I <= 7; I++ )
    {
        iVar3[I] = I + 27;
    ...
    for ( I = 0; I <= (g_U1441._fU24 - 1); I++ )
    {
        g_U1441._fU24[I] = iVar3[I];
    }
    for ( I = 0; I <= 10; I++ )
    {
        iVar3[I] = I + 1;
    ...
    for ( I = 0; I <= (g_U1441._fU44 - 1); I++ )
    {
        g_U1441._fU44[I] = iVar3[I];
        sub_457( "\n the theme values are ", I, g_U1441._fU44[I] );
    }
    g_U1441._fU64 = GET_CURRENT_DAY_OF_WEEK();
    return;
}
...
void sub_676()
{
    ...
    for ( I = 0; I <= 3; I++ )
    {
        ...
        sub_709( ref uVar3, "CP_RINGTONE", g_U1441._fU4[I], -1, -1 );
    ...
    for ( I = 0; I <= 3; I++ )
    {
        ...
        sub_709( ref uVar3, "CP_RINGTONE", g_U1441._fU24[I], -1, -1 );
    ...
    for ( I = 0; I <= 3; I++ )
    {
        ...
        sub_709( ref uVar3, "webTheme", g_U1441._fU44[I], -1, -1 );
