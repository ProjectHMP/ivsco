...
void sub_1866()
{
    ...
    {
        if (((sub_1904( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_4718()
{
    ...
    {
        if ((LOCATE_CHAR_ON_FOOT_3D( l_U655, -421.84950000, 1483.59600000, 18.49900000 + 1.60000000, 1.60000000, 1.60000000, 1.60000000, 1 )) AND (sub_5046( 1, 1 )))
        {
            l_U539 = 1;
            l_U538 = 1;
        }
        GET_KEY_FOR_CHAR_IN_ROOM( l_U655, ref l_U516 );
        if (((l_U516 == -1180793541) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U655 )))) AND (sub_5046( 1, 1 )))
        {
            l_U539 = 1;
            l_U538 = 1;
        }
        if ((LOCATE_CHAR_ON_FOOT_3D( l_U655, -126.06160000, 1501.11500000, 22.77990000, 1.00000000, 1.00000000, 1.00000000, 1 )) AND (sub_5046( 1, 1 )))
        {
            l_U539 = 0;
            l_U538 = 1;
        }
        if ((LOCATE_CHAR_ON_FOOT_3D( l_U655, -126.06160000, 1501.11500000, 22.77990000, 50.00000000, 50.00000000, 50.00000000, 0 )) AND (l_U553 == 0))
        {
...
void sub_12152()
{
    ...
    if ((l_U540 == 0) AND (NOT (IS_CHAR_DEAD( l_U575 ))))
    {
        GET_KEY_FOR_CHAR_IN_ROOM( sub_4151(), ref l_U516 );
        if (((((LOCATE_CHAR_ANY_MEANS_3D( sub_4151(), -429.01860000, 1455.54900000, 39.04730000, 2.00000000, 2.00000000, 2.00000000, 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U575, l_U655, 0 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U575, 4 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U575, 18 ))) || (l_U516 == 0))
        {
            ...
            if (NOT (IS_CHAR_INJURED( l_U575 )))
            {
                ...
                TASK_GO_STRAIGHT_TO_COORD( 0, -434.83290000, 1446.23800000, 38.10290000, 3, 15000 );
                CLOSE_SEQUENCE_TASK( l_U618 );
            ...
            if (NOT (IS_CHAR_INJURED( l_U575 )))
            {
                if ((NOT (IS_PED_RAGDOLL( l_U575 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U655, l_U575, 4.00000000, 4.00000000, 4.00000000, 0 ))))
                {
                    sub_12665();
                }
            }
    ...
    if (l_U542 == 0)
    {
        if (NOT (IS_CHAR_INJURED( l_U575 )))
        {
            ...
            {
                if ((NOT (sub_15518( l_U664 ))) AND (NOT (IS_CHAR_FATALLY_INJURED( l_U575 ))))
                {
    ...
    if ((NOT (IS_CHAR_DEAD( l_U575 ))) AND (l_U558 == 0))
    {
    ...
    else if ((NOT (IS_CHAR_INJURED( l_U575 ))) AND (NOT (DOES_BLIP_EXIST( l_U582 ))))
    {
        ADD_BLIP_FOR_CHAR( l_U575, ref l_U582 );
    }
    iVar4 = 0;;
    if (((IS_CHAR_INJURED( l_U603[1] )) || (IS_CHAR_DEAD( l_U575 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U655, -474.08590000, 1373.50100000, 16.19750000, 11, 9, 5, 0 )))
    {
        if ((NOT (IS_CHAR_INJURED( l_U603[0] ))) AND (NOT (IS_CAR_DEAD( l_U602 ))))
        {
    ...
    if ((l_U556 == 0) AND (NOT (IS_CHAR_DEAD( l_U575 ))))
    {
    ...
    if ((l_U559 == 0) AND (NOT (IS_CHAR_INJURED( l_U575 ))))
    {
    ...
    if (((l_U543 == 0) AND (NOT (IS_CHAR_INJURED( l_U575 )))) AND (l_U559 == 1))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U575, -474.08590000, 1373.50100000, 16.19750000, 1.50000000, 1.50000000, 1.50000000, 0 )) AND (l_U556 == 0))
        {
            UNLOCK_RAGDOLL( l_U575, 1 );
            l_U556 = 1;
        }
        if (IS_CHAR_PLAYING_ANIM( l_U575, "misspxdf", "shoulder_door_loop" ))
        {
            ...
            if (((((LOCATE_CHAR_ANY_MEANS_3D( l_U575, -474.08590000, 1373.50100000, 16.19750000, 1.50000000, 1.50000000, 1.50000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U655, l_U575, 8.00000000, 8.00000000, 5.00000000, 0 ))) AND (IS_CHAR_ON_SCREEN( l_U575 ))) AND (NOT (IS_PED_RAGDOLL( l_U575 )))) AND (l_U519 > 0.95000000))
            {
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U575, 1 );
                ...
                if ((NOT (IS_CHAR_DEAD( l_U603[0] ))) AND (NOT (IS_CAR_DEAD( l_U602 ))))
                {
                    if (IS_CHAR_IN_CAR( l_U603[0], l_U602 ))
                    {
                        TASK_CAR_DRIVE_WANDER( l_U603[0], l_U602, 15.00000000, 2 );
                ...
                while (l_U562 == 0)
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( l_U575 )))
                    {
                        if (IS_CHAR_PLAYING_ANIM( l_U575, "misspxdf", "out_of_ammo" ))
                        {
                            ...
                            if ((l_U519 > 0.45000000) AND (l_U563 == 0))
                            {
    ...
    if (((l_U543 == 1) AND (l_U544 == 0)) AND (NOT (IS_CHAR_DEAD( l_U575 ))))
    {
        PRINTSTRING( "\n ----> MAINTAIN PLEADING 1 <---- \n\n" );
        if (NOT (IS_CHAR_PLAYING_ANIM( l_U575, "misspxdf", "out_of_ammo" )))
        {
    ...
    sub_22987();
    sub_23078();
    if ((l_U544 == 0) AND (l_U541 == 1))
    {
        sub_23537();
        sub_23673();
    }
    sub_23933();
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U655, -435.63250000, 1439.02600000, 35.89360000, 8.00000000, 8.00000000, 8.00000000, 0 )) AND (l_U560 == 0))
    {
...
void sub_12665()
{
    ...
    SET_CAM_POS( l_U615, -442.29430000, 1431.33000000, 39.32573000 );
            ...
            if (NOT (IS_CHAR_INJURED( (uParam0^) )))
            {
                if (NOT (IS_CHAR_INJURED( sub_4151() )))
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
                    {
                        ...
                        {
                            if ((sub_19571( (uParam3^) )) AND (iVar7 > l_U485))
                            {
                    ...
                    if (NOT l_U489)
                    {
                        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
                        {
                            if (IS_CHAR_PLAYING_ANIM( (uParam0^), uParam2, uParam1 ))
                            {
                                ...
                                {
                                    case 0:
                                    if ((NOT (IS_CHAR_INJURED( sub_4151() ))) AND (NOT (IS_CHAR_INJURED( (uParam0^) ))))
                                    {
...
int sub_20548(unknown uParam0)
{
    ...
    if (DOES_CHAR_EXIST( uParam0 ))
    {
        if (NOT (IS_CHAR_INJURED( sub_4151() )))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                if ((GET_CHAR_MELEE_ACTION_FLAG0( uParam0 )) || (((NOT IS_USING_CONTROLLER()) AND (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_4359(), uParam0 ))) AND (IS_CONTROL_JUST_PRESSED( 0, 4 ))))
                {
                    if ((NOT (IS_CHAR_INJURED( sub_4151() ))) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
                    {
                        SET_CHAR_READY_TO_BE_EXECUTED( uParam0, 0 );
...
void sub_20854()
{
    if (((NOT (IS_CHAR_DEAD( l_U575 ))) AND (l_U598 == 0)) AND (l_U543 == 0))
    {
        GET_CHAR_COORDINATES( l_U655, ref l_U530._fU0, ref l_U530._fU4, ref l_U530._fU8 );
        if ((l_U561 == 0) AND (l_U530._fU4 < 1425))
        {
        ...
        if (NOT (IS_CHAR_DEAD( l_U575 )))
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( l_U575, -456.00000000, 1394.00000000, 14.47000000, 17.00000000, 17.00000000, 17.00000000, 0 )) AND (l_U600 == 0))
            {
                PRINTSTRING( "\n ----> GOONCAR - PX POS OKAY <---- \n\n" );
                l_U600 = 1;
            }
        }
        if ((l_U530._fU8 < 16.50000000) AND (l_U601 == 0))
        {
            PRINTSTRING( "\n ----> GOONCAR - PLYR POS OKAY <---- \n\n" );
            l_U601 = 1;
        }
        if ((l_U601 == 1) AND (l_U600 == 1))
        {
            PRINTSTRING( "\n ----> Create Goon Car <---- \n\n" );
            if (l_U561 == 0)
            {
            ...
            if ((NOT (IS_CHAR_INJURED( l_U575 ))) AND (NOT (sub_15518( l_U664 ))))
            {
...
void sub_22142()
{
    if ((l_U599 == 0) AND (l_U598 == 1))
    {
        if (NOT (IS_CAR_DEAD( l_U602 )))
        {
            GET_CAR_HEALTH( l_U602, ref l_U606 );
            if ((l_U606 < 600) AND (NOT (IS_CHAR_IN_CAR( l_U655, l_U602 ))))
            {
...
{
    GET_CHAR_COORDINATES( l_U655, ref l_U530._fU0, ref l_U530._fU4, ref l_U530._fU8 );
    if ((LOCATE_CHAR_ON_FOOT_3D( l_U655, -421.84950000, 1483.59600000, 18.49900000 + 1.60000000, 1.60000000, 1.60000000, 1.60000000, 1 )) AND (l_U530._fU8 < 20.00000000))
    {
        DO_SCREEN_FADE_OUT( 1000 );
        while (NOT IS_SCREEN_FADED_OUT())
        {
...
void sub_23537()
{
    ...
    {
        if (((TIMERB() > ((l_U515 * 2) + 4000)) AND (NOT (sub_15518( l_U664 )))) AND (l_U542 == 1))
        {
            sub_13587( "PXDF_CHASE", ref l_U664, 6, 1 );
...
void sub_23673()
{
    if (NOT (IS_CHAR_FATALLY_INJURED( l_U575 )))
    {
        if ((((TIMERB() > l_U515) || (l_U564 == 1)) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U655, l_U575, 6.00000000, 6.00000000, 1.00000000, 0 ))) AND (NOT (sub_15518( l_U664 ))))
        {
            if (l_U543 == 0)
            {
                sub_13587( "PXDF_ATTCK", ref l_U664, 6, 1 );
...
void sub_23933()
{
    if (NOT (IS_CHAR_INJURED( l_U576[0] )))
    {
        ...
        if (((TIMERB() > l_U515) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U655, l_U576[0], 7.50000000, 7.50000000, 7.50000000, 0 ))) AND (NOT (sub_15518( l_U664 ))))
        {
...
int sub_24371(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    switch (l_U671)
    {
        ...
        SET_CAM_ROT( l_U675[3], 12.43447000, 0.00000000, -52.93311000 );
        ...
        if ((l_U617 == 1) AND (NOT (sub_15518( l_U664 ))))
        {
            l_U617 = 2;
        ...
        if (((l_U673 - l_U672) > 9500) AND (l_U670 == 1))
        {
            l_U670 = 2;
...
void sub_26499()
{
    ...
    fVar45[1] = 43;
    vVar13[2] = {-127.77820000, 1502.74000000, 23.44228000};
    ...
    SETTIMERB( 0 );
    SETTIMERA( 0 );
    while ((NOT bVar57) AND (NOT sub_28606()))
    {
        if (iVar4 == 0)
        {
            I = 1;
        ...
        if ((iVar4 == 1) AND (NOT (sub_15518( l_U664 ))))
        {
            iVar4 = 2;
            SET_CAM_PROPAGATE( l_U611, 0 );
        ...
        if ((iVar4 == 2) AND (NOT (sub_15518( l_U664 ))))
        {
            iVar4 = 3;
        ...
        if ((iVar4 == 3) AND (NOT (sub_15518( l_U664 ))))
        {
            iVar4 = 4;
        ...
        if ((I == 1) AND (IS_CHAR_PLAYING_ANIM( sub_4151(), "misspxdf", "plyr_shldropen" )))
        {
            I = 2;
            SETTIMERB( 0 );
        }
        if ((I == 2) AND (TIMERB() > 4750))
        {
            I = 3;
        ...
        if (((I == 3) AND (NOT (IS_CHAR_PLAYING_ANIM( sub_4151(), "misspxdf", "plyr_shldropen" )))) AND (NOT (sub_15518( l_U664 ))))
        {
            INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
            bVar57 = true;
        }
        if ((sub_29515( sub_4151(), 29 )) AND (NOT (sub_15518( l_U664 ))))
        {
            INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
            bVar57 = true;
        }
...
void sub_29907()
{
    ...
    sub_30004();
    if ((l_U551 == 0) AND (NOT (IS_CHAR_INJURED( l_U574 ))))
    {
    ...
    if (NOT (IS_CHAR_INJURED( l_U574 )))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U574, -131.90640000, 1490.59400000, 21.77730000, 0.80000000 + 0.70000000, 0.80000000 + 0.70000000, 1.50000000, 0 )) AND (l_U557 == 0))
        {
            if (sub_20548( l_U574 ))
            {
                if (sub_15518( l_U664 ))
...
void sub_30004()
{
    ...
    {
        if (((TIMERB() > l_U515) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U655, l_U574, 4.00000000, 4.00000000, 2.00000000, 0 ))) AND (NOT (sub_15518( l_U664 ))))
        {
...
void sub_38548()
{
    ...
    if (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_4151() ))
    {
        ...
        if ((NOT (IS_CHAR_IN_MODEL( sub_4151(), 837858166 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_4151(), -488123221 ))))
        {
...
int sub_40542(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    switch (l_U671)
    {
        ...
        SET_CAM_PROPAGATE( l_U675[0], 1 );
        CREATE_CAM( 14, ref l_U675[1] );
        SET_CAM_POS( l_U675[1], -134.69050000, 1492.68900000, 23.15047000 );
        ...
        if (((l_U673 - l_U672) > 12500) AND (l_U670 == 1))
        {
            l_U670 = 2;
        }
        if (((l_U673 - l_U672) > 17000) AND (l_U670 == 2))
        {
            l_U670 = 3;
        ...
        if (((l_U673 - l_U672) > 18500) AND (l_U670 == 3))
        {
            l_U670 = 4;
            SET_CAM_ACTIVE( l_U675[3], 1 );
            SET_CAM_PROPAGATE( l_U675[3], 1 );
