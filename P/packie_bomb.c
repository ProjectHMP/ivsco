void main()
{
    ...
    if (ALLOW_ONE_TIME_ONLY_COMMANDS_TO_RUN())
    {
        ...
        ADD_WIDGET_FLOAT_SLIDER( "x", ref l_U56._fU0._fU0, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "y", ref l_U56._fU0._fU4, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "z", ref l_U56._fU0._fU8, -999999.90000000, 999999.90000000, 0.00100000 );
        ...
        ADD_WIDGET_FLOAT_SLIDER( "vAttachOffset.x", ref l_U69._fU0, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vAttachOffset.y", ref l_U69._fU4, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vAttachOffset.z", ref l_U69._fU8, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vAttachRotation.x", ref l_U72._fU0, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vAttachRotation.y", ref l_U72._fU4, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vAttachRotation.z", ref l_U72._fU8, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vCarAttachOffset.x", ref l_U75._fU0, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vCarAttachOffset.y", ref l_U75._fU4, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vCarAttachOffset.z", ref l_U75._fU8, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vCarAttachRotation.x", ref l_U78._fU0, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vCarAttachRotation.y", ref l_U78._fU4, -999999.90000000, 999999.90000000, 0.00100000 );
        ADD_WIDGET_FLOAT_SLIDER( "vCarAttachRotation.z", ref l_U78._fU8, -999999.90000000, 999999.90000000, 0.00100000 );
    ...
    while (IS_PLAYER_PLAYING( sub_559() ))
    {
        ...
        if ((l_U62) || (IS_KEYBOARD_KEY_JUST_PRESSED( 36 )))
        {
        ...
        switch (l_U65)
        {
            ...
            switch (l_U66)
            {
                ...
                {
                    if ((NOT GET_TASK_PLACE_CAR_BOMB_UNSUCCESSFUL()) AND (l_U63))
                    {
                        if (NOT (IS_CAR_DEAD( l_U84 )))
                        {
            ...
            break;
            case 5:
            if ((NOT sub_13581()) AND (IS_PLAYER_CONTROL_ON( sub_559() )))
            {
                bVar3 = false;
                if (DOES_OBJECT_EXIST( l_U68 ))
                {
...
int sub_5237(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_559() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_559() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_559() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_5333())
                    {
...
int sub_13581()
{
    ...
    {
        if ((ARE_WIDESCREEN_BORDERS_ACTIVE()) AND (sub_13615()))
        {
            return 1;
        }
...
int sub_13965(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_1398() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_1398() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_14492()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
