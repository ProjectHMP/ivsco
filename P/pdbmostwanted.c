...
void sub_45()
{
    ...
    while (((NOT (HAS_MODEL_LOADED( sub_1388( l_U170 ) ))) || (NOT (HAS_MODEL_LOADED( uVar5 )))) || (NOT (HAS_MODEL_LOADED( -196312163 ))))
    {
        WAIT( 0 );
    }
    ...
    switch (uVar13)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U169 )))
        {
            ...
            for ( I = 0; I <= 1; I++ )
            {
                ...
                if ((NOT (IS_CAR_DEAD( l_U180 ))) AND (NOT (IS_CHAR_DEAD( l_U176[I] ))))
                {
...
void sub_4575()
{
    if ((g_U8083 < 100) AND (g_U8083 < g_U2272))
    {
...
void sub_4635()
{
    ...
    for ( I = 0; I <= (sub_4700() - 1); I++ )
    {
        if ((((g_U2273[I]._fU196 < 2000) AND (NOT g_U2273[I]._fU208)) AND (sub_5800( uVar8, I ))) AND (NOT (g_U2273[I]._fU216 == 1)))
        {
...
int sub_6123(int iParam0)
{
    ...
    {
        if (((g_U2273[Result]._fU196 == iParam0) AND (NOT g_U2273[Result]._fU212)) AND (sub_5800( uVar7, Result )))
        {
...
void sub_7557()
{
    if (NOT l_U215)
    {
        if ((NOT (IS_CHAR_DEAD( l_U169 ))) AND (NOT (IS_CHAR_DEAD( l_U176[0] ))))
        {
...
void sub_7834(boolean bParam0)
{
    ...
    if ((NOT (IS_CHAR_DEAD( l_U169 ))) AND (NOT (IS_CAR_DEAD( l_U180 ))))
    {
        if (NOT l_U216)
        {
    ...
    if (l_U216)
    {
        if (((NOT (IS_CHAR_DEAD( l_U169 ))) AND (NOT (IS_CAR_DEAD( l_U180 )))) AND (IS_PLAYER_PLAYING( sub_644() )))
        {
...
void sub_8971()
{
    if (NOT l_U216)
    {
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U169, sub_687(), 0 )) || (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U169, sub_687() )))
            {
                CLEAR_CHAR_TASKS_IMMEDIATELY( l_U169 );
