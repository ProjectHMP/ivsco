...
void sub_2034()
{
    ...
    {
        if (((sub_2072( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3531()
{
    ...
    CREATE_PICKUP_ROTATE( 1069950328, 22, 200, 64.44000000, -885.97000000, 13.31000000, 90.00000000, 0.20000000, 64, ref l_U910[1] );
...
void sub_10535()
{
    ...
    if ((NOT (IS_CHAR_DEAD( l_U4470 ))) AND (l_U563[4] == 0))
    {
    ...
    if ((NOT (IS_CHAR_DEAD( l_U4470 ))) AND (l_U563[0] == 0))
    {
        if ((IS_CHAR_SITTING_IN_ANY_CAR( l_U4470 )) AND (l_U563[5] == 0))
        {
            ...
            {
                if ((IS_CHAR_SITTING_IN_CAR( l_U628, uVar2 )) || (sub_13631( l_U628 )))
                {
                    switch (g_U64962)
                    {
                        case 0:
                ...
                if (l_U563[11] == 0)
                {
                    if ((NOT (IS_CHAR_DEAD( l_U4470 ))) AND (l_U829 == 1))
                    {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U628, -3.58370000, -750.60470000, 150.00000000, 150.00000000, 0 )) AND (l_U563[8] == 0))
    {
        ADD_SCENARIO_BLOCKING_AREA( 38.18220000, -1012.34300000, -16.57720000, 153.18220000, -768.34310000, 24.57720000 );
        SET_PED_NON_CREATION_AREA( 38.18220000, -1012.34300000, -16.57720000, 153.18220000, -768.34310000, 24.57720000 );
        ...
        while (((NOT sub_15299()) || (NOT sub_15401())) || (NOT sub_15543()))
        {
            WAIT( 0 );
        }
        CREATE_CHAR( 26, 64730935, 36.25710000, -843.88650000, 7.94430000, ref l_U4472[0], 1 );
    ...
    if ((l_U563[11] == 0) AND (LOCATE_CHAR_ANY_MEANS_2D( l_U628, -3.58370000, -750.60470000, 50.50000000, 50.50000000, 0 )))
    {
    ...
    if (l_U563[5] == 0)
    {
        if ((((LOCATE_CHAR_ANY_MEANS_2D( l_U628, -3.58370000, -750.60470000, 10.50000000, 10.50000000, 0 )) AND (l_U563[4] == 0)) AND ((sub_17128( l_U628 )) < 3.00000000)) AND (NOT (sub_17197( l_U788 ))))
        {
            sub_10802( "PX3_HEDSET", ref l_U788, 8, 1 );
            if ((NOT (IS_CHAR_DEAD( l_U4470 ))) AND (NOT (IS_CAR_DEAD( l_U897 ))))
            {
    ...
    if ((((l_U563[4] == 1) AND (l_U563[5] == 0)) AND (NOT (sub_17197( l_U788 )))) AND (l_U563[10] == 0))
    {
    ...
    if (((l_U563[4] == 1) AND (l_U563[5] == 0)) AND (NOT (IS_CAR_DEAD( l_U897 ))))
    {
        if (((iVar5 == l_U897) AND (IS_CHAR_GETTING_IN_TO_A_CAR( l_U628 ))) || (IS_CHAR_SITTING_IN_CAR( l_U628, l_U897 )))
        {
    ...
    if ((l_U563[5] == 0) AND (l_U563[8] == 1))
    {
        if ((IS_CAR_DEAD( l_U897 )) || (IS_CAR_IN_WATER( l_U897 )))
        {
            l_U794 = 1;
            l_U796 = 1;
            l_U797 = 0;
    ...
    if ((l_U563[0] == 0) AND (l_U563[5] == 1))
    {
        ...
        if ((NOT (IS_CHAR_DEAD( l_U4470 ))) AND (NOT (IS_CAR_DEAD( l_U897 ))))
        {
            if ((NOT (IS_CHAR_IN_CAR( l_U4470, l_U897 ))) || ((NOT (IS_CHAR_GETTING_IN_TO_A_CAR( l_U4470 ))) AND ((sub_19486( l_U4470, -3.53210000, -753.63420000, 3.94110000 )) < (sub_19573( l_U4470, l_U897 )))))
            {
    ...
    if (NOT (IS_CAR_DEAD( l_U897 )))
    {
        if ((((l_U563[0] == 1) AND (l_U563[1] == 0)) AND (IS_CHAR_SITTING_IN_CAR( l_U628, l_U897 ))) AND (NOT (sub_17197( l_U788 ))))
        {
            ...
            if ((DOES_VEHICLE_EXIST( l_U902 )) AND (NOT (IS_CAR_DEAD( l_U902 ))))
            {
            ...
            while ((sub_17197( l_U788 )) AND (l_U830 == 0))
            {
                if (((((sub_20831()) AND (TIMERA() > 1000)) AND (IS_SCREEN_FADED_IN())) AND (IS_CHAR_SITTING_IN_ANY_CAR( l_U628 ))) AND (l_U563[0] == 1))
                {
                    l_U830 = 1;
                }
                WAIT( 0 );
    ...
    if (((l_U563[1] == 1) AND (l_U563[2] == 0)) AND ((NOT (sub_17197( l_U788 ))) AND (TIMERA() > 4000)))
    {
        if (NOT (DOES_CAM_EXIST( l_U621 )))
        {
            CREATE_CAM( 14, ref l_U621 );
        }
        SET_CAM_POS( l_U621, 68.66615000, -836.08120000, 50.00032000 );
        ...
        SET_CAM_POS( l_U623, 68.66615000, -836.08120000, 50.00032000 );
    ...
    if ((((sub_21435( l_U788 )) == 3) AND (l_U852 == 0)) AND (l_U563[2] == 1))
    {
        SET_CAM_POS( l_U621, 12.49182000, -824.68400000, 50.25798000 );
        SET_CAM_ROT( l_U621, 10.32926000, -0.00000000, 91.43771000 );
        SET_CAM_FOV( l_U621, 45.00000000 );
        SET_CAM_POS( l_U623, 12.49182000, -821.50910000, 50.25798000 );
    ...
    if (((l_U563[2] == 1) AND (l_U563[3] == 0)) AND ((sub_21435( l_U788 )) == 4))
    {
        WAIT( 500 );
        if (NOT (DOES_CAM_EXIST( l_U621 )))
        {
        ...
        SET_CAM_POS( l_U621, -4.25927700, -750.82390000, 5.40373900 );
        ...
        SET_CAM_POS( l_U623, -4.25927700, -750.82390000, 5.40373900 );
    ...
    if (((l_U563[7] == 0) AND (l_U563[3] == 1)) AND ((sub_21435( l_U788 )) == 5))
    {
        if (NOT (IS_CHAR_DEAD( l_U4470 )))
        {
        ...
        TASK_GO_STRAIGHT_TO_COORD( 0, 3.21000000, -747.26650000, 5.89510000, 3, 5000 );
        ...
        TASK_TURN_CHAR_TO_FACE_COORD( l_U628, 3.21000000, -747.26650000, 5.89510000 );
        SETTIMERA( 0 );
        l_U563[7] = 1;
    }
    if (((l_U563[5] == 1) AND (l_U563[7] == 1)) AND ((NOT (sub_17197( l_U788 ))) AND (TIMERA() > 3000)))
    {
        if (NOT (IS_CAR_DEAD( l_U897 )))
        {
            FREEZE_CAR_POSITION( l_U897, 0 );
        ...
        {
            REMOVE_CHAR_FROM_GROUP( l_U4470 );
            if ((IS_CHAR_IN_ANY_CAR( l_U4470 )) || (IS_CHAR_GETTING_IN_TO_A_CAR( l_U4470 )))
            {
    ...
    if (NOT (IS_CHAR_DEAD( l_U4470 )))
    {
        if (((((IS_CHAR_SITTING_IN_ANY_CAR( l_U4470 )) AND (sub_20831())) AND (TIMERA() > 1000)) AND (IS_SCREEN_FADED_IN())) AND (l_U563[5] == 1))
        {
            DO_SCREEN_FADE_OUT( 500 );
            while (IS_SCREEN_FADING_OUT())
            {
...
int sub_11896()
{
    if (NOT (IS_CHAR_DEAD( l_U4470 )))
    {
        if (((sub_11934( l_U628, l_U4470, 1 )) > 30.00000000) || (((IS_CHAR_IN_ANY_CAR( l_U628 )) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U4470 )))) AND ((sub_11934( l_U628, l_U4470, 1 )) > 10.00000000)))
        {
            if (l_U850 == 0)
            {
        ...
        else if (((sub_11934( l_U628, l_U4470, 1 )) < 12.00000000) AND (l_U850 == 1))
        {
...
void sub_24027()
{
    ...
    if (l_U798[l_U794] == 0)
    {
        ...
        while (((NOT (HAS_MODEL_LOADED( -302362397 ))) || (NOT (HAS_MODEL_LOADED( -1616890832 )))) || (NOT (REQUEST_MISSION_AUDIO_BANK( "SCRIPT_MISSION\PX2_DECONSTRUCTION" ))))
        {
            WAIT( 0 );
        }
        for ( I = 0; I <= 2; I++ )
    ...
    {
        if (((IS_CHAR_TOUCHING_OBJECT( l_U628, g_U9165 )) AND (l_U856 == 0)) AND (l_U563[6] == 0))
        {
            sub_4019( 1, l_U4470, "PLAYBOY", 0 );
            switch (g_U64963)
            {
    ...
    if (DOES_OBJECT_EXIST( g_U9165 ))
    {
        ...
        if ((((l_U563[6] == 1) AND ((l_U890 - l_U891) > 25000)) AND (IS_PED_ATTACHED_TO_OBJECT( l_U628, g_U9165 ))) AND (l_U892 == 0))
        {
    ...
    if (NOT (IS_CHAR_DEAD( l_U4470 )))
    {
        if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 13.08250000, -752.57060000, 112.11110000, 9.00000000, 4.00000000, 1.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U4470, 13.08250000, -752.57060000, 112.11110000, 9.00000000, 4.00000000, 1.00000000, 0 ))) AND (l_U563[7] == 0))
        {
    ...
    if ((NOT l_U563[5]) AND (DOES_OBJECT_EXIST( g_U9165 )))
    {
        if (((((sub_32194( g_U9165 )) < 112.10000000) AND ((sub_32194( g_U9165 )) > 111.00000000)) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 18.96420000, -738.17310000, 112.11410000, 10.00000000, 19.00000000, 2.00000000, 0 ))) AND (NOT (IS_PED_ATTACHED_TO_OBJECT( l_U628, g_U9165 ))))
        {
        ...
        {
            if ((NOT (IS_CHAR_INJURED( l_U4470 ))) AND (l_U862 == 0))
            {
    ...
    if ((((l_U907 - l_U908) > 3000) AND (l_U563[5] == 0)) AND (l_U862 == 1))
    {
    ...
    if (((l_U945[0] == 1) AND (l_U945[1] == 1)) AND (l_U945[2] == 1))
    {
        if (l_U563[3] == 0)
        {
            l_U848 = 1;
            ...
            REMOVE_BLIP( l_U4480 );
            ADD_BLIP_FOR_COORD( 8.98570000, -872.93640000, 8.72380000, ref l_U4477 );
    ...
    if (l_U563[3] == 1)
    {
        if ((NOT (sub_17197( l_U788 ))) AND (l_U855 == 0))
        {
    ...
    if (((NOT (sub_17197( l_U788 ))) AND (l_U855 == 1)) AND (l_U873 == 0))
    {
        PRINT_NOW( "PBX3_01", 7500, 1 );
        l_U873 = 1;
    }
    if (((((((LOCATE_CHAR_ANY_MEANS_2D( l_U628, 73.98610000, -844.10900000, 45.00000000, 45.00000000, 0 )) AND ((sub_27584( l_U628 )) > 2.50000000)) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 8.98570000, -872.93640000, 8.72380000, 35.00000000, 35.00000000, 10.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -26.33140000, -825.12350000, 5.41920000, 25.00000000, 20.00000000, 2.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -23.53180000, -938.90480000, 4.98920000, 32.00000000, 33.00000000, 7.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 54.27140000, -835.12180000, 4.81460000, 31.00000000, 10.00000000, 30.00000000, 0 ))) || ((IS_CHAR_IN_ANY_HELI( l_U628 )) AND ((sub_27584( l_U628 )) > 30.00000000)))
    {
        if (((l_U945[0] == 0) || (l_U945[1] == 0)) || (l_U945[2] == 0))
        {
            if (l_U563[4] == 0)
            {
    ...
    sub_13223();
    if ((((sub_11934( l_U628, l_U4470, 0 )) > 30.00000000) || (NOT (DOES_OBJECT_EXIST( g_U9165 )))) AND (l_U856 == 0))
    {
        if ((NOT (IS_CHAR_IN_AIR( l_U4470 ))) AND (NOT (IS_OBJECT_ON_SCREEN( g_U9165 ))))
        {
            DETACH_PED( l_U4470, 1 );
    ...
    if (l_U563[8] == 0)
    {
        if ((((IS_CHAR_SHOOTING( l_U628 )) || (IS_CHAR_INJURED( l_U950[0]._fU0 ))) || (IS_CHAR_INJURED( l_U950[1]._fU0 ))) || (IS_CHAR_INJURED( l_U950[2]._fU0 )))
        {
            for ( I = 0; I <= 2; I++ )
            {
                if (NOT (IS_CHAR_DEAD( l_U950[I]._fU0 )))
    ...
    if (((((((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 73.98610000, -844.10900000, 4.69450000, 8.00000000, 8.00000000, 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 8.98570000, -872.93640000, 8.72380000, 35.00000000, 35.00000000, 10.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -26.33140000, -825.12350000, 5.41920000, 14.00000000, 8.00000000, 2.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_2D( l_U628, -75.12000000, -880.93580000, 16.00000000, 66.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 54.27140000, -835.12180000, 4.81460000, 31.00000000, 10.00000000, 30.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -23.53180000, -938.90480000, 4.98920000, 32.00000000, 33.00000000, 7.00000000, 0 ))) || (l_U831 == 1))
    {
        REMOVE_BLIP( l_U4480 );
...
void sub_24628()
{
    if (NOT (IS_CHAR_DEAD( l_U4470 )))
    {
        if (DOES_OBJECT_EXIST( g_U9165 ))
        {
            ...
            if ((IS_PED_ATTACHED_TO_OBJECT( l_U4470, g_U9165 )) AND (IS_PED_ATTACHED_TO_OBJECT( l_U628, g_U9165 )))
            {
...
void sub_25034(int iParam0)
{
    ...
    if (l_U934[0] == 0)
    {
        ...
        {
            case 0:
            SET_CAM_POS( l_U626, 81.79142000, -831.06130000, 46.93155000 );
    ...
    if (((TIMERA() > 1600) AND (l_U934[1] == 0)) AND (l_U934[0] == 1))
    {
        if (NOT (IS_CHAR_DEAD( l_U950[iParam0]._fU0 )))
        {
    ...
    if (((l_U934[3] == 0) AND (l_U934[1] == 1)) AND (l_U934[4] == 0))
    {
        if (uVar3._fU8 < 16.00000000)
        {
            ...
            switch (iParam0)
            {
                ...
                SET_CAM_POS( l_U626, 11.77537000, -841.15160000, 4.08423000 );
    ...
    if (((l_U904 == 0) AND (l_U934[5] == 0)) AND (l_U934[4] == 1))
    {
        ...
        if (DOES_VEHICLE_EXIST( l_U899 ))
        {
            if (DOES_CHAR_EXIST( l_U950[1]._fU0 ))
            {
                if (NOT (IS_CAR_DEAD( l_U899 )))
                {
                    ...
                    if (((HAS_CHAR_BEEN_DAMAGED_BY_CAR( l_U950[iParam0]._fU0, l_U899 )) || (iVar9)) AND (l_U904 == 0))
                    {
                        STOP_SOUND( l_U886[1] );
                        SET_VEH_ALARM( l_U899, 1 );
    ...
    if (iParam0 == 0)
    {
        if (((((sub_27584( l_U950[0]._fU0 )) <= 4.80000000) || (IS_CHAR_FATALLY_INJURED( l_U950[0]._fU0 ))) AND (l_U934[6] == 0)) AND (l_U934[5] == 1))
        {
    ...
    if ((((TIMERA() > 7000) || ((l_U934[1] == 0) AND (TIMERA() > 3500))) || (sub_20831())) || (l_U934[3] == 1))
    {
        UNPOINT_CAM( l_U626 );
        sub_19738( ref l_U626, 0 );
        sub_19795( 0 );
...
void sub_28419(unknown uParam0, int iParam1, int iParam2)
{
    ...
    for ( I = 0; I <= (iParam1 - 1); I++ )
    {
        if (((uParam0^)[I]._fU84 == 1) AND (NOT (IS_CHAR_DEAD( (uParam0^)[I]._fU0 ))))
        {
            ...
            if ((((((sub_19486( l_U628, (uParam0^)[I]._fU4 )) < 20.00000000) AND ((sub_28598( l_U628, (uParam0^)[I]._fU0 )) < 1.50000000)) || (IS_BULLET_IN_AREA( (uParam0^)[I]._fU4._fU0, (uParam0^)[I]._fU4._fU4, (uParam0^)[I]._fU4._fU8, 15.00000000, 1 ))) || (IS_SNIPER_BULLET_IN_AREA( (uParam0^)[I]._fU4._fU0 + 5.00000000, (uParam0^)[I]._fU4._fU4 + 5.00000000, (uParam0^)[I]._fU4._fU8 + 5.00000000, (uParam0^)[I]._fU4._fU0 - 5.00000000, (uParam0^)[I]._fU4._fU4 - 5.00000000, (uParam0^)[I]._fU4._fU8 - 5.00000000 ))) || (iParam2 == 1))
            {
                FREEZE_CHAR_POSITION( (uParam0^)[I]._fU0, 0 );
                SET_CHAR_NEVER_TARGETTED( (uParam0^)[I]._fU0, 0 );
                SET_CHAR_WILL_USE_COVER( (uParam0^)[I]._fU0, 1 );
                if ((NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 ))) AND ((uParam0^)[I]._fU76 == 0))
                {
                    ...
                    if ((NOT (DOES_BLIP_EXIST( (uParam0^)[I]._fU80 ))) AND (l_U949))
                    {
            ...
            if ((((sub_11934( l_U628, (uParam0^)[I]._fU0, 1 )) > 35.00000000) AND ((uParam0^)[I]._fU76 == 1)) AND ((uParam0^)[I]._fU88 == 0))
            {
            ...
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^)[I]._fU0, l_U628, 0 )) AND ((uParam0^)[I]._fU72 == 0))
            {
            ...
            if ((uParam0^)[I]._fU72 == 1)
            {
                switch ((uParam0^)[I]._fU148)
                {
                    ...
                    break;
                    case 4:
                    if (((iVar8 - (uParam0^)[I]._fU68) > 0) AND ((uParam0^)[I]._fU32[0] == 0))
                    {
                        if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 )))
                        {
                    ...
                    if ((((iVar8 - (uParam0^)[I]._fU68) > 400) AND ((uParam0^)[I]._fU32[1] == 0)) AND ((uParam0^)[I]._fU32[0] == 1))
                    {
                        if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 )))
                        {
                            if (IS_PED_RAGDOLL( (uParam0^)[I]._fU0 ))
                    ...
                    if ((((iVar8 - (uParam0^)[I]._fU68) > 500) AND ((uParam0^)[I]._fU32[1] == 0)) AND ((uParam0^)[I]._fU32[1] == 1))
                    {
                        if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 )))
                        {
                            if (IS_PED_RAGDOLL( (uParam0^)[I]._fU0 ))
                    ...
                    if (((iVar8 - (uParam0^)[I]._fU68) > 50) AND ((uParam0^)[I]._fU32[1] == 0))
                    {
                        if (NOT (IS_CHAR_DEAD( (uParam0^)[I]._fU0 )))
                        {
                            if (IS_PED_RAGDOLL( (uParam0^)[I]._fU0 ))
                    ...
                    if (((uParam0^)[I]._fU112._fU8 < -0.50000000) AND ((uParam0^)[I]._fU32[2] == 0))
                    {
...
void sub_33443()
{
    if ((l_U818._fU8 < 112.10000000) AND ((sub_11934( l_U628, l_U4470, 1 )) > 7.50000000))
    {
        GET_OBJECT_COORDINATES( g_U9165, ref l_U818._fU0, ref l_U818._fU4, ref l_U818._fU8 );
        l_U818._fU8 += l_U821;
        SET_OBJECT_COORDINATES( g_U9165, l_U818._fU0, l_U818._fU4, l_U818._fU8 );
    ...
    if (l_U4491 == 0)
    {
        ...
        else
        {
            ...
            if ((l_U4498 - l_U4495) > 7500)
            {
                ...
                else if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "PBX3GR2" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "PBX3GR1" )))
                {
                    CLEAR_HELP();
                }
            }
        ...
        GET_GAME_TIMER( ref l_U4498 );
        if (((l_U4493 == 1) AND (l_U4494 == 0)) AND ((l_U4498 - l_U4496) > 7500))
        {
            if (USING_STANDARD_CONTROLS())
            {
        ...
        GET_GAME_TIMER( ref l_U4498 );
        if ((l_U4494 == 1) AND ((l_U4498 - l_U4497) > 7500))
        {
            if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "PBX3GR2" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "PBX3GR1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "PBX3GR3" )))
            {
                CLEAR_HELP();
            }
            l_U4491 = 1;
...
void sub_37058()
{
    ...
    if (l_U871 == 0)
    {
        ...
        if (l_U826 == 0)
        {
            if ((LOCATE_CHAR_ON_FOOT_3D( l_U628, 70.35390000, -894.57230000, 14.13660000, 9.00000000, 4.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 81.65860000, -904.40060000, 14.21510000, 3.00000000, 5.00000000, 2.00000000, 0 )))
            {
                if (l_U861 == 0)
                {
                    SETTIMERA( 0 );
    ...
    if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (l_U859 == 0))
    {
        sub_4019( 1, 0, "PLAYBOY", 0 );
        sub_10802( "PX3_CSITE", ref l_U788, 8, 1 );
        l_U859 = 1;
    }
    if ((((NOT (sub_17197( l_U788 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (l_U860 == 0)) AND (l_U859 == 1))
    {
    ...
    if ((NOT (IS_CHAR_DEAD( l_U4118[0]._fU0 ))) AND (l_U4118[0]._fU76 == 0))
    {
        if ((((sub_11934( l_U628, l_U4118[0]._fU0, 1 )) < 45.00000000) || (IS_BULLET_IN_AREA( l_U4118[0]._fU4._fU0, l_U4118[0]._fU4._fU4, l_U4118[0]._fU4._fU8, 15.00000000, 1 ))) || (sub_39017( l_U4118[0]._fU0, 6.00000000 )))
        {
    ...
    {
        if ((IS_CHAR_INJURED( l_U4118[0]._fU0 )) AND (l_U4118[1]._fU76 == 0))
        {
    ...
    if (((l_U4118[1]._fU76 == 1) AND (NOT (sub_17197( l_U788 )))) AND (l_U905 == 0))
    {
    ...
    {
        if (((IS_CHAR_INJURED( l_U4118[1]._fU0 )) AND (l_U4118[2]._fU76 == 0)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
        {
    ...
    if (((l_U4118[2]._fU76 == 1) AND (NOT (sub_17197( l_U788 )))) AND (l_U906 == 0))
    {
        PRINT_NOW( "PBX3_11", 7500, 1 );
        GET_GAME_TIMER( ref l_U858 );
        l_U906 = 1;
    }
    if (((((l_U4118[2]._fU76 == 1) AND (NOT (IS_CHAR_SHOOTING( l_U628 )))) AND (NOT (sub_17197( l_U788 )))) AND (l_U872 == 0)) AND (l_U906 == 1))
    {
    ...
    {
        if ((IS_CHAR_INJURED( l_U4118[2]._fU0 )) AND (l_U4118[3]._fU76 == 0))
        {
    ...
    if ((l_U4118[3]._fU76 == 1) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 145.71840000, -967.33310000, 21.57940000, 3.00000000, 5.00000000, 1.40000000, 0 ))))
    {
        if ((((IS_CHAR_INJURED( l_U4118[2]._fU0 )) AND (IS_CHAR_INJURED( l_U4118[1]._fU0 ))) AND (IS_CHAR_INJURED( l_U4118[0]._fU0 ))) || (IS_CHAR_IN_ANGLED_AREA_2D( l_U628, 114.89540000, -948.86060000, 112.62810000, -931.87990000, 2.00000000, 0 )))
        {
            l_U794++;
        }
    }
...
void sub_40338()
{
    ...
    if ((IS_EXPLOSION_IN_AREA( -1, 38.18220000, -1012.34300000, -16.57720000, 153.18220000, -768.34310000, 24.57720000 )) AND ((l_U816 - l_U817) > 15000))
    {
...
void sub_40496(unknown uParam0)
{
    ...
    if ((l_U857 - l_U858) > 8000)
    {
        ...
        uVar6 = sub_16378( 0, 9 );
        if (((DOES_CHAR_EXIST( (uParam0^)[uVar6]._fU0 )) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_17197( l_U788 ))))
        {
...
void sub_41026()
{
    ...
    if (l_U798[l_U794] == 0)
    {
        ...
        while (((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 1445 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 1992 )))) || (NOT (HAS_MODEL_LOADED( -1660661558 ))))
        {
            WAIT( 0 );
        }
    ...
    if (((NOT (sub_17197( l_U788 ))) AND (l_U854 == 0)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
    ...
    sub_13223();
    if (((sub_19486( l_U628, 150.67440000, -924.13690000, 8.23180000 )) < 40.00000000) AND (l_U563[1] == 0))
    {
    ...
    if ((l_U563[1] == 1) AND (NOT (sub_41933( l_U4118[3]._fU0, 29 ))))
    {
        if (NOT (IS_CHAR_INJURED( l_U4118[3]._fU0 )))
        {
    ...
    {
        if (((sub_11934( l_U628, l_U4118[3]._fU0, 1 )) > 280.00000000) AND (NOT (IS_CHAR_ON_SCREEN( l_U4118[3]._fU0 ))))
        {
    ...
    if (((((NOT (IS_CHAR_DEAD( l_U3766[1]._fU0 ))) AND (NOT (IS_CAR_DEAD( l_U898 )))) AND (l_U563[0] == 1)) AND (l_U563[2] == 0)) AND (l_U824 > 23000.00000000))
    {
        if (((((NOT (IS_CHAR_IN_ANY_HELI( l_U3766[1]._fU0 ))) AND (TIMERB() > 3000)) AND (LOCATE_CHAR_ANY_MEANS_2D( l_U628, 153.52650000, -957.09230000, 40.00000000, 40.00000000, 0 ))) AND ((sub_19573( l_U628, l_U898 )) < 40.00000000)) || ((TIMERB() > 30000) AND (l_U563[0] == 1)))
        {
    ...
    if (l_U563[9] == 0)
    {
        if (((sub_43303( l_U898 )) < 900) || (IS_CHAR_INJURED( l_U3766[0]._fU0 )))
        {
            if (NOT (IS_CAR_DEAD( l_U898 )))
            {
                if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U898 ))
    ...
    if (TIMERB() > 3000)
    {
        if (l_U563[10] == 0)
        {
            if ((NOT (sub_17197( l_U788 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
            {
    ...
    if ((TIMERA() > (sub_43719( 6000, 9000 ))) AND (l_U885 < 3))
    {
        sub_43769( l_U885 );
        l_U885++;
        SETTIMERA( 0 );
