...
void sub_61()
{
    ...
    if (sub_786())
    {
        uVar2 = {g_U2832[l_U172]._fU60[0]._fU16._fU0, g_U2832[l_U172]._fU60[0]._fU16._fU4, g_U2832[l_U172]._fU60[0]._fU16._fU8};
        PRINT_STRING_IN_STRING_NOW( "MW_GOD_01", ref g_U2832[l_U172]._fU60[0]._fU0, 5000, 1 );
        l_U221 = 0;
    }
    else if (sub_956())
    {
        uVar2 = {g_U2832[l_U172]._fU32._fU16._fU0, g_U2832[l_U172]._fU32._fU16._fU4, g_U2832[l_U172]._fU32._fU16._fU8};
        PRINT_STRING_IN_STRING_NOW( "MW_GOD_01", ref g_U2832[l_U172]._fU32._fU0, 5000, 1 );
        l_U221 = 1;
    }
...
void sub_4591()
{
    if ((g_U8642 < 100) AND (g_U8642 < g_U2831))
    {
        g_U2832[g_U8642]._fU180 = 1;
        g_U8642 = -1;
        sub_4651();
    }
    else
...
void sub_4651()
{
    ...
    for ( I = 0; I <= (sub_4716() - 1); I++ )
    {
        ...
        {
            g_U2832[I]._fU148 = {sub_4801( g_U2832[I]._fU196 )};
        }
    }
    for ( I = 0; I <= (sub_4716() - 1); I++ )
    {
        if ((((g_U2832[I]._fU196 < 2000) AND (NOT g_U2832[I]._fU208)) AND (sub_5816( uVar8, I ))) AND (NOT (g_U2832[I]._fU216 == 1)))
        {
...
int sub_6139(int iParam0)
{
    ...
    {
        if (((g_U2832[Result]._fU196 == iParam0) AND (NOT g_U2832[Result]._fU212)) AND (sub_5816( uVar7, Result )))
        {
...
int sub_6654(unknown uParam0)
{
    ...
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_703(), g_U8637._fU4._fU0, g_U8637._fU4._fU4, g_U8637._fU4._fU8, 50.00000000, 50.00000000, 15.00000000, 0 ))
        {
...
int sub_7065(unknown uParam0)
{
    if (DOES_BLIP_EXIST( g_U8633._fU0 ))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_703(), g_U8633._fU4._fU0, g_U8633._fU4._fU4, g_U8633._fU4._fU8, 50.00000000, 50.00000000, 15.00000000, 0 ))
        {
