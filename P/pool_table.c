    ...
    while (DOES_OBJECT_EXIST( l_U36 ))
    {
        ...
        switch (l_U14)
        {
            ...
            switch (l_U15)
            {
                ...
                if (NOT bVar2)
                {
                    if (NOT l_U10)
                    {
                        if (IS_PLAYER_PLAYING( sub_1451() ))
                        {
                            ...
                            {
                                if ((LOCATE_CHAR_ON_FOOT_3D( sub_1590(), uVar3._fU0, uVar3._fU4, uVar3._fU8, 2.00000000, 2.00000000, 2.00000000, 0 )) AND (LOCATE_CHAR_ON_FOOT_3D( l_U31, uVar3._fU0, uVar3._fU4, uVar3._fU8, 3.00000000, 3.00000000, 2.00000000, 0 )))
                                {
                                    l_U9 = 0;
                                    bVar2 = true;
                                }
                ...
                if (IS_PLAYER_PLAYING( sub_1451() ))
                {
                    if (((IS_WANTED_LEVEL_GREATER( sub_1451(), 0 )) AND (NOT (DOES_SCRIPT_EXIST( "michelle1" )))) AND (NOT ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "michelle1" )) > 0)))
                    {
                        bVar2 = false;
                    }
                }
                ...
                if ((bVar2) AND (sub_4383( 2, 0 )))
                {
                    ...
                    if (sub_6007( 2, l_U32, 0 ))
                    {
                        ...
                        if ((NOT (IS_CHAR_INJURED( sub_1590() ))) AND (NOT l_U9))
                        {
                ...
                {
                    bVar2 = false;
                    if ((NOT (IS_CHAR_INJURED( l_U31 ))) AND (NOT l_U9))
                    {
                        switch (l_U18)
                        {
                            case 0:
...
int sub_3096(unknown uParam0)
{
    ...
    {
        if (((((IS_CHAR_MODEL( uParam0, sub_3123( 0 ) )) || (IS_CHAR_MODEL( uParam0, sub_3123( 3 ) ))) || (IS_CHAR_MODEL( uParam0, sub_3123( 13 ) ))) || (IS_CHAR_MODEL( uParam0, sub_3123( 8 ) ))) || (IS_CHAR_MODEL( uParam0, sub_3123( 7 ) )))
        {
            return 1;
        }
        if (((((IS_CHAR_MODEL( uParam0, sub_3123( 2 ) )) || (IS_CHAR_MODEL( uParam0, sub_3123( 10 ) ))) || (IS_CHAR_MODEL( uParam0, sub_3123( 28 ) ))) || (IS_CHAR_MODEL( uParam0, sub_3123( 29 ) ))) || (IS_CHAR_MODEL( uParam0, sub_3123( 30 ) )))
        {
            return 1;
        }
    }
...
int sub_4383(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_1451() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_1451() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_1451() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_4479())
                    {
