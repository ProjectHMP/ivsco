            ...
            if (DOES_OBJECT_EXIST( l_U9 ))
            {
                if (NOT sub_522())
                {
                    if (IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE( l_U9 ))
                    {
                        ...
                        if (((l_U13 == l_U12) AND (IS_CHAR_IN_ANGLED_AREA_3D( sub_694(), uVar6._fU0, uVar6._fU4, uVar6._fU8, uVar3._fU0, uVar3._fU4, uVar3._fU8, l_U21, 0 ))) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_380(), 0 ))))
                        {
                            if ((NOT g_U10978) AND (sub_916()))
                            {
                                if (NOT l_U11)
                                {
                                    if (sub_979( 2, 0 ))
...
int sub_979(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_380() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_380() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_380() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_1075())
                    {
