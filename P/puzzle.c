void main()
{
    ...
    l_U1357 = {-65.48000000, -0.00000000, 0.42200000};
    l_U1360 = 70.00000000;
...
void sub_5836()
{
    ...
    LOAD_ALL_OBJECTS_NOW();
    while ((((((NOT (HAS_MODEL_LOADED( l_U783[0] ))) || (NOT (HAS_MODEL_LOADED( l_U783[1] )))) || (NOT (HAS_MODEL_LOADED( l_U783[2] )))) || (NOT (HAS_MODEL_LOADED( l_U783[3] )))) || (NOT (HAS_MODEL_LOADED( l_U783[4] )))) || (NOT (HAS_MODEL_LOADED( l_U783[5] ))))
    {
        WAIT( 0 );
    }
    ...
    LOAD_ALL_OBJECTS_NOW();
    while ((((((NOT (HAS_MODEL_LOADED( l_U790[0] ))) || (NOT (HAS_MODEL_LOADED( l_U790[1] )))) || (NOT (HAS_MODEL_LOADED( l_U790[2] )))) || (NOT (HAS_MODEL_LOADED( l_U790[3] )))) || (NOT (HAS_MODEL_LOADED( l_U790[4] )))) || (NOT (HAS_MODEL_LOADED( l_U790[5] ))))
    {
        WAIT( 0 );
    }
    ...
    LOAD_ALL_OBJECTS_NOW();
    while ((((((((((NOT (HAS_MODEL_LOADED( l_U943[0] ))) || (NOT (HAS_MODEL_LOADED( l_U943[1] )))) || (NOT (HAS_MODEL_LOADED( l_U943[2] )))) || (NOT (HAS_MODEL_LOADED( l_U943[3] )))) || (NOT (HAS_MODEL_LOADED( l_U943[4] )))) || (NOT (HAS_MODEL_LOADED( l_U943[5] )))) || (NOT (HAS_MODEL_LOADED( l_U943[6] )))) || (NOT (HAS_MODEL_LOADED( l_U943[7] )))) || (NOT (HAS_MODEL_LOADED( l_U943[8] )))) || (NOT (HAS_MODEL_LOADED( l_U943[9] ))))
    {
        WAIT( 0 );
    }
    sub_9568( "puzzle" );
...
void sub_11340(boolean bParam0)
{
    ...
    fVar16 = 0.47300000;
    l_U146 = GET_CURRENT_LANGUAGE();
    if ((l_U146 == 0) || (l_U146 == 1))
    {
        fVar15 = 0.37200000;
        fVar16 = 0.47300000;
    }
    else if ((((l_U146 == 2) || (l_U146 == 4)) || (l_U146 == 3)) || (l_U146 == 5))
    {
        fVar15 = 0.31200000;
        fVar16 = 0.43200000;
    }
...
void sub_12390()
{
    ...
    l_U685[1] = {2.02300000, 1.94950000, 3850.77400000};
...
void sub_19787()
{
    ...
    if ((NOT l_U620._fU16) AND (NOT l_U620._fU20))
    {
        l_U150 = 0;
    }
    else if (NOT l_U166)
...
void sub_19956()
{
    ...
    if (l_U620._fU16)
    {
        if (l_U620._fU20)
        {
            if ((l_U620._fU64 == 0) || (l_U620._fU64 == 1))
            {
    ...
    if (l_U620._fU20)
    {
        if (l_U620._fU16)
        {
            if ((l_U620._fU68 == 0) || (l_U620._fU68 == 1))
            {
...
void sub_24106()
{
    ...
    if ((l_U620._fU20) AND (l_U620._fU16))
    {
        if (NOT l_U153)
        {
...
void sub_25058()
{
    ...
    if ((((iVar3 <= l_U754) AND (iVar3 >= l_U755)) AND (iVar4 <= l_U752)) AND (iVar4 >= l_U753))
    {
    ...
    if ((((iVar5 <= l_U754) AND (iVar5 >= l_U755)) AND (iVar6 <= l_U752)) AND (iVar6 >= l_U753))
    {
...
void sub_26234()
{
    ...
    for ( l_U750 = 0; l_U750 < 9; l_U750++ )
    {
        for ( l_U751 = 0; l_U751 < 6; l_U751++ )
        {
            ...
            if (iVar2 < 6)
            {
                if (((l_U751 + 1) <= l_U754) AND ((l_U750 + 1) <= l_U752))
                {
                    if ((((l_U181[l_U751 + 1][l_U750]._fU24) == l_U7) AND ((l_U181[l_U751][l_U750 + 1]._fU24) == l_U7)) AND ((l_U181[l_U751 + 1][l_U750 + 1]._fU24) == l_U7))
                    {
                        bVar4 = true;
                    }
                }
...
void sub_33269()
{
    ...
    if ((((l_U158) || (l_U159)) || (l_U160)) || (l_U161))
    {
        if (l_U160)
        {
...
void sub_46575()
{
    ...
    if (l_U150)
    {
        ...
        if (l_U766 >= iVar3)
        {
            ...
            else if ((NOT (l_U620._fU12 == 0)) AND (NOT (l_U620._fU4 == 0)))
            {
                sub_19956();
                GET_GAME_TIMER( ref l_U767 );
            }
            else if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_36366()))
            {
                if (DOES_OBJECT_EXIST( l_U620._fU24 ))
                {
                    DELETE_OBJECT( ref l_U620._fU24 );
...
void sub_48370()
{
    ...
    else
    {
        ...
        if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())) AND (NOT sub_36366()))
        {
            l_U167 = 0;
            l_U5 = 4;
            GET_GAME_TIMER( ref l_U767 );
