...
void sub_1736()
{
    ...
    if (IS_PLAYER_PLAYING( sub_498() ))
    {
        if (IS_CHAR_IN_ANY_CAR( sub_441() ))
        {
            ...
            {
                CLEAR_AREA( 1401.93300000, 609.87430000, 31.48700000, 3.00000000, 0 );
                SET_CAR_HEADING( uVar2, 180.66530000 );
                SET_CAR_COORDINATES( uVar2, 1401.93300000, 609.87430000, 31.48700000 );
            }
        }
...
void sub_2230()
{
    ...
    {
        iVar3 = sub_2258( 13 );
        if ((sub_2303( 13, iVar3 )) AND (g_U9932[g_U9999[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_2258( 11 );
        if ((sub_2303( 11, iVar3 )) AND (g_U9932[g_U10090[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_2782( I );
        if ((sub_2303( g_U10324[I]._fU12, iVar3 )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
...
void sub_3319()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((sub_2782( I )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
void sub_14688()
{
    ...
    {
        if (((sub_14726( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
