                                ...
                                if (NOT l_U13)
                                {
                                    if (sub_995( 2, 0 ))
                                    {
                                        if (sub_1282( 2, ref l_U24, 0 ))
                                        {
                                            ...
                                            CLEAR_AREA( uVar6._fU0, uVar6._fU4, uVar6._fU8, 3.00000000, 1 );
...
int sub_995(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_396() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_396() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_1091())
                    {
