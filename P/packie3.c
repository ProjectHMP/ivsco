...
void sub_1656()
{
    ...
    {
        if (((sub_1694( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_2976(int iParam0)
{
    ...
    if (iParam0 == 3)
    {
        sub_2976( -1 );
        sub_3001( -1 );
        if (((GET_CHAR_DRAWABLE_VARIATION( sub_3123(), 8 )) != 1) || ((GET_CHAR_TEXTURE_VARIATION( sub_3123(), 8 )) != 0))
        {
    ...
    else
    {
        ...
        if (((GET_CHAR_DRAWABLE_VARIATION( sub_3123(), 8 )) != 0) || ((GET_CHAR_TEXTURE_VARIATION( sub_3123(), 8 )) != 0))
        {
...
void sub_3599()
{
    ...
    l_U1908[19]._fU4 = {555.27840000, 783.24070000, 20.66090000};
...
void sub_7359()
{
    ...
    if ((NOT (sub_8970( l_U818 ))) AND (l_U563[0] == 0))
    {
    ...
    if (sub_9205())
    {
        ...
        if (l_U736 <= 1)
        {
            ...
            l_U795 = 0;
            if (((TIMERA() > 15000) AND ((sub_12510( l_U628, l_U1531, 1 )) < 12.00000000)) AND (IS_CHAR_SITTING_IN_ANY_CAR( l_U628 )))
            {
        ...
        else if (((NOT (sub_8970( l_U818 ))) AND ((sub_12510( l_U628, l_U1530, 1 )) > 10.00000000)) AND (l_U795 == 0))
        {
...
void sub_8453(boolean bParam0)
{
    ...
    if (bParam0)
    {
        ...
        PRINTNL();
        if ((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT (IS_GROUP_MEMBER( l_U1530, l_U627 ))))
        {
            CLEAR_CHAR_TASKS( l_U1530 );
            SET_GROUP_MEMBER( l_U627, l_U1530 );
            CHANGE_BLIP_DISPLAY( l_U1571, 0 );
        }
        if ((NOT (IS_CHAR_DEAD( l_U1531 ))) AND (NOT (IS_GROUP_MEMBER( l_U1531, l_U627 ))))
        {
        ...
        {
            if ((NOT (IS_CHAR_DEAD( l_U1532 ))) AND (NOT (IS_GROUP_MEMBER( l_U1532, l_U627 ))))
            {
...
void sub_9701()
{
    ...
    {
        iVar3 = sub_9729( 13 );
        if ((sub_9774( 13, iVar3 )) AND (g_U9932[g_U9999[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_9729( 11 );
        if ((sub_9774( 11, iVar3 )) AND (g_U9932[g_U10090[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_10253( I );
        if ((sub_9774( g_U10324[I]._fU12, iVar3 )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
...
void sub_10790()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((sub_10253( I )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
void sub_11620()
{
    ...
    if (((l_U775 - l_U734) > 9000) AND (NOT (sub_8970( l_U818 ))))
    {
    ...
    if ((l_U775 - l_U776) > 6000)
    {
        ...
        l_U732++;
        if (((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT (IS_CHAR_DEAD( l_U1531 )))) AND (NOT (IS_CHAR_DEAD( l_U1532 ))))
        {
            switch (l_U780)
            {
                case 0:
...
void sub_12463(int iParam0)
{
    ...
    if (iParam0 == 0)
    {
        ...
        if ((l_U740 < 3) || (l_U740 == 17))
        {
            if (((bVar5) AND (bVar6)) AND (bVar4))
            {
                if (l_U784 != l_U783)
                {
            ...
            else if ((((bVar5) AND (bVar4)) || ((bVar4) AND (bVar5))) || ((bVar4) AND (bVar6)))
            {
                if ((bVar5) AND (bVar4))
                {
                    if (l_U783 != l_U784)
        ...
        if (DOES_CHAR_EXIST( l_U1532 ))
        {
            if ((((((NOT (IS_WANTED_LEVEL_GREATER( l_U629, 0 ))) AND (sub_9205())) AND (l_U728 == 0)) AND (IS_GROUP_MEMBER( l_U1530, l_U627 ))) AND (IS_GROUP_MEMBER( l_U1532, l_U627 ))) AND (IS_GROUP_MEMBER( l_U1531, l_U627 )))
            {
                if ((((sub_14015( l_U628, l_U1530 )) AND (sub_14015( l_U628, l_U1532 ))) AND (sub_14015( l_U628, l_U1531 ))) AND (l_U774 == 0))
                {
                    l_U783 = -1;
        ...
        if (((DOES_BLIP_EXIST( l_U1576 )) AND (IS_GROUP_MEMBER( l_U1530, l_U627 ))) AND (IS_GROUP_MEMBER( l_U1531, l_U627 )))
        {
            l_U783 = -1;
    ...
    if ((IS_CHAR_INJURED( l_U1530 )) || ((IS_CHAR_IN_WATER( l_U1530 )) AND (IS_CHAR_INJURED( l_U1530 ))))
    {
        sub_14368();
        sub_14472();
        sub_14605();
        ...
        WAIT( 7500 );
        if ((l_U740 >= 4) AND (l_U740 <= 10))
        {
            sub_14814();
        }
        if ((l_U740 >= 11) AND (l_U740 <= 16))
        {
            sub_16569();
        }
        if (l_U740 > 16)
    ...
    if ((IS_CHAR_INJURED( l_U1531 )) || ((IS_CHAR_IN_WATER( l_U1531 )) AND (IS_CHAR_INJURED( l_U1531 ))))
    {
        sub_14368();
        sub_14472();
        sub_14605();
    ...
    if (l_U740 < 3)
    {
        if ((IS_CHAR_INJURED( l_U1532 )) || ((IS_CHAR_IN_WATER( l_U1532 )) AND (IS_CHAR_INJURED( l_U1532 ))))
        {
            sub_14368();
            sub_14472();
...
void sub_16569()
{
    ...
    while (l_U833 == 0)
    {
        if ((sub_14835()) AND (IS_SCREEN_FADED_IN()))
        {
            SETTIMERA( 6001 );
            l_U836 = 1;
            DO_SCREEN_FADE_OUT( 500 );
    ...
    if (NOT g_U813)
    {
        if (IS_PLAYER_PLAYING( sub_3891() ))
        {
            if ((GET_CHAR_TEXTURE_VARIATION( l_U628, 8 )) == 1)
            {
                ...
                SETTIMERB( 0 );
                while (((sub_19166( l_U628, "missbankjob", "remove_balaclave_b" )) < 0.50000000) AND (TIMERB() < 10000))
                {
                    WAIT( 0 );
                }
...
void sub_24292()
{
    ...
    sub_28113();
    if (((NOT (IS_CHAR_DEAD( l_U1532 ))) || (NOT (IS_CHAR_DEAD( l_U1531 )))) || (NOT (IS_CHAR_DEAD( l_U1530 ))))
    {
...
void sub_32094()
{
    ...
    if ((IS_CHAR_GETTING_IN_TO_A_CAR( l_U628 )) || ((IS_CHAR_IN_ANY_CAR( l_U628 )) AND (NOT (sub_8970( l_U818 )))))
    {
        GET_CAR_CHAR_IS_USING( l_U628, ref l_U737 );
        GET_MAXIMUM_NUMBER_OF_PASSENGERS( l_U737, ref l_U736 );
        if (l_U736 <= 1)
        ...
        else
        {
            ...
            PRINTNL();
            if (((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT (IS_CHAR_DEAD( l_U1532 )))) AND (NOT (IS_CHAR_DEAD( l_U1532 ))))
            {
                if ((((IS_CHAR_IN_ANY_CAR( l_U1530 )) AND (IS_CHAR_IN_ANY_CAR( l_U1532 ))) AND (IS_CHAR_IN_ANY_CAR( l_U1531 ))) AND (l_U774 == 1))
                {
                    CHANGE_BLIP_DISPLAY( l_U1570, 4 );
    ...
    {
        if (((IS_CHAR_IN_ANY_CAR( l_U628 )) AND (l_U563[1] == 0)) AND (NOT (IS_CHAR_IN_CAR( l_U628, l_U840 ))))
        {
    ...
    if (sub_9205())
    {
        if (l_U768 == 1)
        {
            if (((((l_U728 == 0) AND (sub_14015( l_U628, l_U1530 ))) AND (sub_14015( l_U628, l_U1532 ))) AND (sub_14015( l_U628, l_U1531 ))) AND (l_U774 == 0))
            {
                CHANGE_BLIP_DISPLAY( l_U1570, 4 );
            }
            sub_9677( 36, 0 );
    ...
    if ((NOT IS_MESSAGE_BEING_DISPLAYED()) || (l_U738 == 1))
    {
        PRINTSTRING( "no message being displayed or banter already triggered\n" );
        if ((sub_33827( 1 )) AND (IS_CHAR_SITTING_IN_ANY_CAR( l_U628 )))
        {
            PRINTSTRING( "Everyone i n car\n" );
            if (((l_U563[2] == 0) AND (l_U563[3] == 1)) AND (NOT (sub_8970( l_U818 ))))
            {
            ...
            else if (((IS_CHAR_IN_ANY_CAR( l_U628 )) AND (NOT sub_34350())) AND (sub_9205()))
            {
                switch (g_U64965)
                {
                    case 1:
    ...
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U628, l_U1567._fU0, l_U1567._fU4, 150.00000000, 150.00000000, 0 )) AND (l_U563[0] == 0))
    {
        sub_35053( 1778551148 );
        sub_35053( 772345340 );
        sub_35129( "missbankjob" );
        while ((NOT sub_35219()) || (NOT sub_35321()))
        {
            WAIT( 0 );
        }
        OPEN_SEQUENCE_TASK( ref l_U3074 );
        TASK_TURN_CHAR_TO_FACE_COORD( 0, -28.91745000, -466.30830000, 16.21759000 );
    ...
    if (((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT (IS_CHAR_DEAD( l_U1531 )))) AND (NOT (IS_CHAR_DEAD( l_U1532 ))))
    {
        if (((IS_GROUP_MEMBER( l_U1530, l_U627 )) AND (IS_GROUP_MEMBER( l_U1531, l_U627 ))) AND (IS_GROUP_MEMBER( l_U1532, l_U627 )))
        {
            if (((((LOCATE_CHAR_ANY_MEANS_3D( l_U628, l_U1567._fU0, l_U1567._fU4, l_U1567._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U1530, l_U1567._fU0, l_U1567._fU4, l_U1567._fU8, 2.50000000, 2.50000000, 2.50000000, 0 ))) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U1531, l_U1567._fU0, l_U1567._fU4, l_U1567._fU8, 2.50000000, 2.50000000, 2.50000000, 0 ))) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U1532, l_U1567._fU0, l_U1567._fU4, l_U1567._fU8, 2.50000000, 2.50000000, 2.50000000, 0 ))) AND (sub_9361( 1, 1 )))
            {
...
{
    if ((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT (IS_CHAR_DEAD( l_U1531 ))))
    {
        if ((IS_CHAR_IN_ANY_CAR( l_U1530 )) AND (IS_CHAR_IN_ANY_CAR( l_U1531 )))
        {
            if (bParam0)
            {
                if (NOT (IS_CHAR_DEAD( l_U1532 )))
...
int sub_34350()
{
    ...
    if ((((sub_34516( l_U818 )) AND (l_U791 == 1)) AND (sub_9205())) AND (l_U774 == 0))
    {
        CHANGE_BLIP_DISPLAY( l_U1570, 4 );
...
void sub_36478()
{
    if (l_U744[l_U740] == 0)
    {
        ...
        SET_CAM_ROT( l_U623, -60.96675000, 0.00000000, -157.59930000 );
    ...
    if ((NOT (sub_8970( l_U818 ))) AND (l_U744[l_U740] == 1))
    {
        DO_SCREEN_FADE_OUT( 500 );
        while (IS_SCREEN_FADING_OUT())
        {
        ...
        l_U3079 = START_PTFX( "smoke_vault_lingers", -14.04100000, -473.99450000, 8.15076000, 0.00000000, 0.00000000, 0.00000000, 1.00000000 );
        sub_28113();
        sub_37774();
        sub_38425();
        l_U837 = GET_SOUND_ID();
        ...
        l_U894[2] = START_SCRIPT_FIRE( -9.41520000, -476.24000000, 7.90740000, 1, 1 );
...
void sub_37774()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( 1530937394 ))) || (NOT (HAS_MODEL_LOADED( 453889158 ))))
    {
        WAIT( 0 );
    }
    REQUEST_ANIMS( "missbankjob" );
...
void sub_38425()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( -492470690 ))) || (NOT (HAS_MODEL_LOADED( 690281432 ))))
    {
        WAIT( 0 );
    }
    REQUEST_ANIMS( "missbankjob" );
...
void sub_40525()
{
    ...
    if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (TIMERA() > 4000)) AND (l_U563[0] == 0))
    {
    ...
    sub_12463( 1 );
    sub_42079();
    if (((sub_42642( l_U841 )) < 1000) || (IS_EXPLOSION_IN_AREA( -1, -21.74370000, -477.80290000, 5.90740000, -16.66000000, -470.40000000, 11.10720000 )))
    {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, -18.90560000, -475.58400000, 8.90720000, 2.50000000, 2.50000000, 2.50000000, 0 )) AND (l_U563[0] == 0))
    {
    ...
    if (((l_U832 - l_U831) > (3 + l_U785)) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U856[3], l_U628, 0 )))
    {
        WAIT( 0 );
        while (sub_8970( l_U818 ))
        {
    ...
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -19.10560000, -475.58400000, 8.90720000, 1.00000000, 1.00000000, 1.50000000, 0 ))
    {
        ...
        SET_CAM_ROT( l_U621, 1.98398400, 0.00000000, -89.31667000 );
        SET_CAM_FOV( l_U621, 34.20003000 );
        SET_CAM_POS( l_U623, -17.58806000, -474.02310000, 9.72444100 );
        SET_CAM_ROT( l_U623, 1.98398400, 0.00000000, -89.31667000 );
        ...
        ADD_SCENARIO_BLOCKING_AREA( 70.52930000, -581.56960000, -14.75790000, -68.50960000, -320.72070000, 28.76190000 );
...
void sub_41164()
{
    ...
    for ( I = 0; I <= 7; I++ )
    {
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U865[I], l_U628, 0 )) AND (l_U874[I] == 0))
            {
            ...
            if (NOT (IS_CHAR_DEAD( l_U865[I] )))
            {
                ...
                if ((IS_CHAR_TOUCHING_CHAR( l_U628, l_U865[I] )) || (IS_PED_RAGDOLL( l_U865[I] )))
                {
        ...
        if (DOES_CHAR_EXIST( l_U856[I] ))
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U856[I], l_U628, 0 )) AND (l_U883[I] == 0))
            {
                sub_7469( "PM3_CIVS", "PM3AUD", ref l_U818, 6, 1 );
                l_U883[I] = 1;
            }
            if (NOT (IS_CHAR_DEAD( l_U856[I] )))
            {
                ...
                if ((IS_CHAR_TOUCHING_CHAR( l_U628, l_U856[I] )) || (IS_PED_RAGDOLL( l_U856[I] )))
                {
...
void sub_46032()
{
    ...
    while ((((((((((NOT (HAS_MODEL_LOADED( -183203150 ))) || (NOT (HAS_MODEL_LOADED( 837858166 )))) || (NOT (HAS_MODEL_LOADED( -1900572838 )))) || (NOT (HAS_MODEL_LOADED( -1004762946 )))) || (NOT (HAS_MODEL_LOADED( 897930585 )))) || (NOT (HAS_MODEL_LOADED( 2046537925 )))) || (NOT (HAS_MODEL_LOADED( -1627000575 )))) || (NOT (HAS_MODEL_LOADED( -1218270655 )))) || (NOT (HAVE_ANIMS_LOADED( "missbankjob" )))) || (NOT (HAVE_ANIMS_LOADED( "move_m@cs_swat" ))))
    {
        WAIT( 0 );
    }
    while (NOT sub_46527())
...
void sub_48240()
{
    ...
    if ((l_U563[0] == 0) AND (l_U563[1] == 1))
    {
        sub_7469( "PM3_CASH", "PM3AUD", ref l_U818, 8, 1 );
        sub_8453( 1 );
        l_U563[0] = 1;
    }
    if (((l_U563[1] == 1) AND (l_U563[0] == 1)) AND (NOT (sub_8970( l_U818 ))))
    {
        l_U740++;
    }
...
void sub_48963()
{
    ...
    if (l_U744[l_U740] == 0)
    {
        ...
        SET_CAM_ROT( l_U621, 12.84060000, 0.00000000, -99.11971000 );
    ...
    if ((TIMERA() > 5000) AND (l_U563[0] == 0))
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U1556[9] )))
        {
            ...
            POINT_CAM_AT_COORD( l_U626, -41.83500000, -464.65470000, 14.89168000 );
        ...
        if ((DOES_CHAR_EXIST( l_U845[1] )) AND (NOT (IS_CHAR_DEAD( l_U845[1] ))))
        {
        ...
        if ((DOES_CHAR_EXIST( l_U845[2] )) AND (NOT (IS_CHAR_DEAD( l_U845[2] ))))
        {
        ...
        if ((DOES_CHAR_EXIST( l_U845[3] )) AND (NOT (IS_CHAR_DEAD( l_U845[3] ))))
        {
        ...
        if ((DOES_CHAR_EXIST( l_U845[4] )) AND (NOT (IS_CHAR_DEAD( l_U845[4] ))))
        {
    ...
    if (((TIMERA() > 4400) AND (l_U563[1] == 0)) AND (l_U563[0] == 1))
    {
        UNATTACH_CAM( l_U626 );
        SET_CAM_POS( l_U626, -41.83500000, -464.65470000, 14.89168000 );
        ...
        if ((NOT (IS_CHAR_DEAD( l_U1533[0] ))) AND (NOT (IS_CAR_DEAD( l_U1556[0] ))))
        {
            OPEN_SEQUENCE_TASK( ref uVar3 );
    ...
    if (((TIMERA() > 1350) AND (l_U563[2] == 0)) AND (l_U563[1] == 1))
    {
    ...
    if (((TIMERA() > 2000) AND (l_U563[3] == 0)) AND (l_U563[2] == 1))
    {
        if ((NOT (IS_CHAR_DEAD( l_U1533[3] ))) AND (NOT (IS_CAR_DEAD( l_U1556[3] ))))
        {
    ...
    if (((TIMERA() > 3000) AND (l_U563[4] == 0)) AND (l_U563[3] == 1))
    {
        ...
        SET_CAM_ROT( l_U626, 16.70920000, -0.00000000, -38.88187000 );
        SET_CAM_FOV( l_U626, 45.00000000 );
        SET_CAM_NEAR_DOF( l_U626, 2.00000000 );
        SET_CAM_FAR_DOF( l_U626, 15.00000000 );
    ...
    if (((TIMERA() > 1500) AND (l_U563[5] == 0)) AND (l_U563[4] == 1))
    {
        sub_53971( 0 );
        UNATTACH_CAM( l_U626 );
        SET_CAM_FOV( l_U626, 55.00000000 );
        ...
        SET_CAM_POS( l_U621, -80.62740000, -482.48500000, 15.00247000 );
        ...
        SET_CAM_ROT( l_U623, -1.06982100, 0.00000000, -69.34595000 );
    ...
    if (l_U563[5] == 1)
    {
        if (NOT (IS_CHAR_DEAD( l_U1544[1] )))
        {
            if ((IS_CHAR_PLAYING_ANIM( l_U1544[1], "move_m@cs_swat", "run" )) AND (l_U772 == 0))
            {
        ...
        if (NOT (IS_CHAR_DEAD( l_U1544[2] )))
        {
            if ((IS_CHAR_PLAYING_ANIM( l_U1544[2], "move_m@cs_swat", "run" )) AND (l_U773 == 0))
            {
    ...
    if (((TIMERA() > 3000) AND (l_U563[6] == 0)) AND (l_U563[5] == 1))
    {
        if (((NOT (IS_CHAR_DEAD( l_U1544[0] ))) AND (NOT (IS_CHAR_DEAD( l_U1544[1] )))) AND (NOT (IS_CHAR_DEAD( l_U1544[2] ))))
        {
        ...
        SET_CAM_FOV( l_U621, 54.59998000 );
        ...
        SET_CAM_FOV( l_U623, 54.59998000 );
    ...
    if (((TIMERA() > 3000) AND (l_U563[7] == 0)) AND (l_U563[6] == 1))
    {
        CLEAR_AREA_OF_CHARS( l_U1567._fU0, l_U1567._fU4, l_U1567._fU8, 150.00000000 );
    ...
    if (((TIMERA() > 7800) AND (l_U563[8] == 0)) AND (l_U563[7] == 1))
    {
        for ( I = 0; I <= 9; I++ )
        {
    ...
    if ((((NOT (sub_8970( l_U818 ))) AND (l_U563[9] == 0)) AND (l_U563[8] == 1)) || (((sub_14835()) AND (TIMERA() > 1000)) AND (IS_SCREEN_FADED_IN())))
    {
        DO_SCREEN_FADE_OUT( 500 );
        while (IS_SCREEN_FADING_OUT())
        {
...
void sub_52323(int iParam0)
{
    ...
    for ( I = 0; I <= 45; I++ )
    {
        if ((l_U3071) AND (l_U1585[I]._fU24))
        {
            iVar4 = 1;
        }
        if ((LOCATE_CHAR_ANY_MEANS_2D( l_U628, l_U1585[I]._fU4._fU0, l_U1585[I]._fU4._fU4, 100.00000000, 100.00000000, 0 )) AND (iVar4 == 0))
        {
            if (((NOT (DOES_OBJECT_EXIST( l_U1585[I]._fU0 ))) AND ((VMAG2( l_U1585[I]._fU4 )) > 0.00000000)) AND (iParam0 == 0))
            {
...
void sub_53971(int iParam0)
{
    ...
    if (l_U3070 == 0)
    {
        if ((IS_CHAR_SHOOTING( l_U628 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -44.92760000, -465.00090000, 14.80390000, 15.40000000, 15.00000000, 4.00000000, 0 )))
        {
            PRINTNL();
            PRINTNL();
            PRINTNL();
    ...
    for ( J = 0; J <= 42; J++ )
    {
        if (LOCATE_CHAR_ANY_MEANS_2D( l_U628, l_U1908[J]._fU4._fU0, l_U1908[J]._fU4._fU4, 70.00000000 + l_U727, 70.00000000 + l_U727, 0 ))
        {
            ...
            if (((((NOT (DOES_VEHICLE_EXIST( l_U1908[J]._fU0 ))) AND ((VMAG2( l_U1908[J]._fU4 )) > 0.00000000)) AND (iParam0 == 0)) AND (l_U1908[J]._fU20 == 0)) AND (l_U1908[J]._fU24 == 0))
            {
                if (((l_U740 == 17) AND (IS_WANTED_LEVEL_GREATER( l_U629, 0 ))) AND (NOT (IS_WANTED_LEVEL_GREATER( l_U629, 2 ))))
                {
                ...
                if ((NOT (DOES_CHAR_EXIST( l_U1908[J]._fU28[0]._fU0 ))) AND (NOT l_U1908[J]._fU96))
                {
                ...
                if (((NOT (DOES_CHAR_EXIST( l_U1908[J]._fU28[1]._fU0 ))) AND (NOT l_U1908[J]._fU96)) AND (l_U1908[J]._fU100 == 0))
                {
                    GET_OFFSET_FROM_CAR_IN_WORLD_COORDS( l_U1908[J]._fU0, 1.25000000, 2.25000000, -1.00000000, ref uVar6._fU0, ref uVar6._fU4, ref uVar6._fU8 );
                    GET_OFFSET_FROM_CAR_IN_WORLD_COORDS( l_U1908[J]._fU0, -1.25000000, 2.25000000, -1.00000000, ref uVar9._fU0, ref uVar9._fU4, ref uVar9._fU8 );
                    if ((sub_55354( l_U628, uVar6 )) > (sub_55354( l_U628, uVar9 )))
...
void sub_62662()
{
    ...
    if (l_U769 == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_2D( l_U628, -49.75580000, -459.18690000, 20.50000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( l_U628, 0.90720000, -493.48900000, 1.00000000, 13.50000000, 0 )))
        {
    ...
    {
        if (((sub_63578( l_U1908[16]._fU0 )) < 850) AND (l_U563[6] == 0))
        {
    ...
    {
        if (((sub_63578( l_U1908[15]._fU0 )) < 600) AND (l_U563[7] == 0))
        {
            EXPLODE_CAR( l_U1908[15]._fU0, 1, 0 );
            l_U563[7] = 1;
        }
    }
    if (((l_U563[0] == 0) AND (l_U3070)) AND (NOT (sub_8970( l_U818 ))))
    {
        sub_8453( 0 );
    ...
    if (((l_U563[0] == 1) AND (NOT (sub_8970( l_U818 )))) AND (l_U892 == 0))
    {
        PRINT_NOW( "BJFLLOW", 7500, 1 );
        l_U892 = 1;
    }
    if (((((sub_64296( l_U1530, l_U898 )) >= 1) AND (l_U563[1] == 0)) AND (l_U892 == 1)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
        if (NOT (IS_CHAR_DEAD( l_U1530 )))
        {
    ...
    if (((sub_64296( l_U1531, l_U904 )) >= 1) AND (l_U563[1] == 0))
    {
        if (NOT (IS_CHAR_DEAD( l_U1531 )))
        {
    ...
    if (((l_U3070) AND (l_U563[1] == 0)) AND (TIMERA() > 20000))
    {
        ...
        sub_63039( 8.85850000, -443.24650000, 13.75020000, ref l_U928[7], 0, 1, 0 );
        sub_42971();
        sub_7469( "PM3_CUT", "PM3AUD", ref l_U818, 8, 1 );
        while (l_U926 < 30)
        {
            GET_CLOSEST_CHAR( -51.27290000, -456.80240000, 13.79430000, 24.00000000, 1, 1, ref iVar3 );
            if (((NOT (IS_CHAR_DEAD( iVar3 ))) AND (iVar3 != l_U1530)) AND (iVar3 != l_U1531))
            {
    ...
    sub_41164();
    if (((NOT (sub_8970( l_U818 ))) AND (l_U563[1] == 1)) AND (l_U563[4] == 0))
    {
        PRINT_NOW( "BJFLLOW", 7500, 1 );
    ...
    if (NOT (IS_CHAR_DEAD( l_U1530 )))
    {
        if (((l_U563[1] == 1) AND ((LOCATE_CHAR_ANY_MEANS_3D( l_U1530, -14.97680000, -445.41980000, 13.76180000, 2.00000000, 2.00000000, 2.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -15.97680000, -445.41980000, 13.76180000, 2.00000000, 4.00000000, 2.00000000, 0 )))) AND (l_U928[0]._fU20 == 0))
        {
            if ((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT (IS_CHAR_INJURED( l_U928[0]._fU0 ))))
            {
    ...
    if (((l_U928[0]._fU20 == 1) AND (NOT (sub_8970( l_U818 )))) AND (l_U563[5] == 0))
    {
    ...
    if (l_U563[3] == 0)
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -1.16130000, -447.46730000, 14.76290000, 1.00000000, 4.00000000, 5.00000000, 1 ))
        {
            ...
            SET_CAR_HEADING( l_U1001, 94.18980000 );
    ...
    if (NOT (IS_CHAR_DEAD( l_U1531 )))
    {
        if (((l_U563[1] == 1) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U1531, -27.61410000, -446.13970000, 13.75645000, 2.00000000, 2.00000000, 2.00000000, 0 ))) AND (l_U928[1]._fU20 == 0))
        {
            if ((NOT (IS_CHAR_DEAD( l_U1531 ))) AND (NOT (IS_CHAR_INJURED( l_U928[1]._fU0 ))))
            {
    ...
    {
        if ((IS_CHAR_INJURED( l_U928[4]._fU0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -9.36540000, -448.41190000, 14.76350000, 1.00000000, 3.00000000, 3.00000000, 0 )))
        {
            if (l_U928[5]._fU20 == 0)
            {
    ...
    {
        if (((IS_CHAR_INJURED( l_U928[7]._fU0 )) || (IS_CHAR_INJURED( l_U928[6]._fU0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 3.09400000, -447.44200000, 14.76050000, 1.00000000, 4.00000000, 3.00000000, 0 )))
        {
            if (l_U928[3]._fU20 == 0)
            {
    ...
    if (l_U928[0]._fU20 == 1)
    {
        if ((((((((IS_CHAR_INJURED( l_U928[0]._fU0 )) AND (IS_CHAR_INJURED( l_U928[1]._fU0 ))) AND (IS_CHAR_INJURED( l_U928[2]._fU0 ))) AND (IS_CHAR_INJURED( l_U928[3]._fU0 ))) AND (IS_CHAR_INJURED( l_U928[4]._fU0 ))) AND (IS_CHAR_INJURED( l_U928[5]._fU0 ))) AND (IS_CHAR_INJURED( l_U928[6]._fU0 ))) AND (IS_CHAR_INJURED( l_U928[7]._fU0 )))
        {
            for ( I = 0; I <= 8; I++ )
            {
...
void sub_66738()
{
    ...
    if (l_U778 < l_U779)
    {
        ...
        if ((((l_U3081 - l_U3080) > 5000) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_8970( l_U818 ))))
        {
            if (l_U778 < 100)
            {
...
void sub_67321(float fParam0, int iParam1)
{
    if (NOT (IS_CHAR_DEAD( l_U1530 )))
    {
        if (((sub_12510( l_U628, l_U1530, 1 )) > fParam0) AND ((sub_12510( l_U628, l_U1531, 1 )) > fParam0))
        {
    ...
    if (((l_U729 == 1) AND (NOT (IS_CHAR_DEAD( l_U1530 )))) AND (NOT (IS_CHAR_DEAD( l_U1531 ))))
    {
        GET_GAME_TIMER( ref l_U730 );
        if ((((l_U730 - l_U731) > iParam1) AND (NOT (IS_CHAR_ON_SCREEN( l_U1530 )))) AND (NOT (IS_CHAR_ON_SCREEN( l_U1531 ))))
        {
...
void sub_67620()
{
    ...
    if ((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
        if (((IS_CHAR_SHOOTING( l_U1530 )) AND (NOT (sub_8970( l_U818 )))) AND ((l_U802 - l_U803) > 4500))
        {
        ...
        if ((sub_11675( 0, 10 )) > 5)
        {
            ...
            if ((IS_BULLET_IN_AREA( uVar2._fU0, uVar2._fU4, uVar2._fU8, 5.00000000, 0 )) AND ((l_U802 - l_U803) > 7500))
            {
                sub_7469( "PM3_FIRE", "PM3AUD", ref l_U818, 6, 1 );
                GET_GAME_TIMER( ref l_U803 );
            }
        }
        else if ((((NOT (sub_8970( l_U818 ))) AND (IS_CHAR_SHOOTING( l_U628 ))) AND (NOT (IS_CHAR_SHOOTING( l_U1530 )))) AND ((l_U802 - l_U803) > 4500))
        {
...
void sub_69233()
{
    ...
    if ((NOT (sub_8970( l_U818 ))) AND (l_U563[5] == 0))
    {
        PRINT_NOW( "BJFLLOW", 7500, 1 );
        l_U563[5] = 1;
    }
    if (((sub_63578( l_U1001 )) < 800) AND (l_U563[0] == 0))
    {
        EXPLODE_CAR( l_U1001, 1, 0 );
        l_U563[0] = 1;
    }
    if (((((sub_64296( l_U1530, l_U900 )) > 0) || ((sub_64296( l_U1531, l_U906 )) > 0)) || (LOCATE_CHAR_ANY_MEANS_3D( l_U1530, 8.31320000, -454.03700000, 13.74980000, 2.00000000, 2.00000000, 2.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U1531, 8.31320000, -454.03700000, 13.74980000, 2.00000000, 2.00000000, 2.00000000, 0 )))
    {
        if (l_U817 == 0)
        {
            CHANGE_BLIP_DISPLAY( l_U1571, 2 );
    ...
    if (((((l_U563[2] == 1) AND (IS_CHAR_INJURED( l_U1002[0]._fU0 ))) AND (IS_CHAR_INJURED( l_U1002[1]._fU0 ))) AND (IS_CHAR_INJURED( l_U1002[2]._fU0 ))) AND (l_U563[4] == 0))
    {
        for ( I = 0; I <= 8; I++ )
        {
...
void sub_70821()
{
    ...
    if ((NOT (sub_8970( l_U818 ))) AND (l_U563[11] == 0))
    {
        PRINT_NOW( "BJFLLOW", 7500, 1 );
        l_U563[11] = 1;
    }
    ...
    {
        if (((sub_63578( l_U1908[42]._fU0 )) < 300) AND (l_U563[0] == 0))
        {
            EXPLODE_CAR( l_U1908[42]._fU0, 1, 0 );
            l_U563[0] = 1;
        }
    }
    if ((l_U563[4] == 1) AND (l_U563[5] == 0))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -0.88520000, -395.75170000, 14.75890000, 108.00000000, 3.50000000, 6.00000000, 0 ))
        {
            while (((((((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 797 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 798 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 1989 )))) || (NOT (HAS_MODEL_LOADED( -1900572838 )))) || (NOT (HAS_MODEL_LOADED( -1004762946 )))) || (NOT (HAS_MODEL_LOADED( 148777611 )))) || (NOT (HAS_MODEL_LOADED( -1627000575 ))))
            {
                WAIT( 0 );
            }
    ...
    if (NOT (IS_CAR_DEAD( l_U1077 )))
    {
        ...
        {
            if (((sub_63578( l_U1077 )) < 900) AND (l_U563[10] == 0))
            {
        ...
        else if ((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1077 ))) AND (l_U563[10] == 0))
        {
            OPEN_SEQUENCE_TASK( ref l_U910 );
            TASK_LEAVE_CAR_DONT_CLOSE_DOOR( 0, l_U1077 );
    ...
    if (((l_U563[9] == 1) AND (TIMERB() > 7500)) AND (l_U563[12] == 0))
    {
        PRINT_NOW( "BJFLLO2", 7500, 1 );
        l_U563[12] = 1;
    }
    for ( I = 0; I <= 7; I++ )
    {
        ...
        else
        {
            ...
            if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U628, -0.84180000, -357.92340000, 14.76190000, 14.00000000, 48.00000000, 1.00000000, 0 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 17.30190000, -351.13230000, 14.63650000, 14.00000000, 18.00000000, 1.00000000, 0 ))))
            {
                REMOVE_BLIP( l_U1078[I]._fU24 );
    ...
    if ((((((((((l_U563[5] == 1) AND (l_U563[7] == 0)) AND (IS_CHAR_INJURED( l_U1078[0]._fU0 ))) AND (IS_CHAR_INJURED( l_U1078[1]._fU0 ))) AND (IS_CHAR_INJURED( l_U1078[2]._fU0 ))) AND (IS_CHAR_INJURED( l_U1078[3]._fU0 ))) AND (IS_CHAR_INJURED( l_U1078[4]._fU0 ))) AND (IS_CHAR_INJURED( l_U1078[5]._fU0 ))) AND (IS_CHAR_INJURED( l_U1078[6]._fU0 ))) AND (IS_CHAR_INJURED( l_U1078[7]._fU0 )))
    {
...
void sub_75608()
{
    ...
    if ((TIMERB() > 7500) AND (l_U563[0] == 0))
    {
        PRINT_NOW( "BJFLLOW", 7500, 1 );
        l_U563[0] = 1;
    }
    if (((TIMERA() > 1000) AND (l_U1240 < 3)) AND (l_U1175[l_U1240]._fU20 == 0))
    {
    ...
    if ((((((((IS_CHAR_INJURED( l_U1175[0]._fU0 )) AND (IS_CHAR_INJURED( l_U1175[1]._fU0 ))) AND (IS_CHAR_INJURED( l_U1175[2]._fU0 ))) AND (IS_CHAR_INJURED( l_U1175[3]._fU0 ))) AND (IS_CHAR_INJURED( l_U1175[4]._fU0 ))) AND (IS_CHAR_INJURED( l_U1175[5]._fU0 ))) AND (l_U563[7] == 1)) AND (l_U563[8] == 0))
    {
...
void sub_77293()
{
    ...
    if (l_U744[l_U740] == 0)
    {
        ...
        ADD_SCENARIO_BLOCKING_AREA( 66.86000000, -319.15000000, -6.95000000, 137.60000000, -222.31000000, 8.15000000 );
        SET_PED_NON_CREATION_AREA( 66.86000000, -319.15000000, -6.95000000, 137.60000000, -222.31000000, 8.15000000 );
        ...
        while ((((NOT (HAS_MODEL_LOADED( 837858166 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 799 )))) || (NOT (HAS_MODEL_LOADED( -1004762946 )))) || (NOT (HAS_MODEL_LOADED( -183203150 ))))
        {
            WAIT( 0 );
        }
        SET_CHAR_COORDINATES( l_U628, 81.73940000, -347.23170000, 13.75790000 );
        ...
        if (NOT (IS_CHAR_DEAD( l_U1531 )))
        {
            ...
            CLEAR_CHAR_TASKS( l_U1531 );
            SET_CHAR_COORDINATES( l_U1531, 86.84670000, -346.62510000, 12.72980000 );
    ...
    if ((TIMERA() > 6450) AND (l_U563[7] == 0))
    {
        sub_7469( "PM3_CHOP", "PM3BAUD", ref l_U818, 8, 1 );
        l_U563[7] = 1;
    }
    if (((sub_79480( l_U818 )) == 1) AND (l_U563[4] == 0))
    {
        sub_79570( ref l_U818 );
    }
    if ((TIMERA() > 7000) AND (l_U563[1] == 0))
    {
        UNATTACH_CAM( l_U626 );
        UNPOINT_CAM( l_U626 );
    ...
    if ((TIMERA() > 10000) AND (l_U563[2] == 0))
    {
        OPEN_SEQUENCE_TASK( ref uVar3 );
        ...
        SET_CAM_FOV( l_U621, 45.00000000 );
        SET_CAM_POS( l_U623, 86.13814000, -320.24700000, 39.22800000 );
    ...
    if ((TIMERA() > 14000) AND (l_U563[3] == 0))
    {
        ...
        SET_CAM_FOV( l_U621, 34.20004000 );
        SET_CAM_POS( l_U623, 94.39677000, -323.22190000, 13.79601000 );
        SET_CAM_ROT( l_U623, 10.35337000, -0.00000000, -72.55891000 );
        SET_CAM_FOV( l_U623, 34.20004000 );
        SET_CAM_INTERP_STYLE_CORE( l_U624, l_U621, l_U623, 5000, 0 );
        sub_15887( ref l_U624, 1 );
        sub_15887( ref l_U626, 0 );
        l_U563[3] = 1;
    }
    if (((l_U563[3] == 1) AND (l_U563[4] == 0)) AND (TIMERB() > 5))
    {
        if (NOT (IS_CHAR_DEAD( l_U1531 )))
        {
    ...
    if ((TIMERA() > 17000) AND (l_U563[4] == 0))
    {
    ...
    if ((TIMERA() > 18500) AND (l_U563[5] == 0))
    {
        SET_CAM_POS( l_U626, 114.64150000, -321.45280000, 14.95370000 );
        SET_CAM_ROT( l_U626, 26.11318000, -8.24516100, 91.34303000 );
        SET_CAM_FOV( l_U626, 43.50000000 );
        l_U563[5] = 1;
    }
    if ((TIMERA() > 19700) AND (l_U563[6] == 0))
    {
    ...
    if (((TIMERA() > 24000) AND (NOT (sub_8970( l_U818 )))) || (l_U777 == 1))
    {
        sub_15122( ref l_U818, 0 );
        if (NOT (IS_CAR_DEAD( l_U1257 )))
        {
...
void sub_82712()
{
    ...
    sub_67620();
    if ((NOT (IS_CAR_DEAD( l_U1257 ))) AND (l_U563[8] == 0))
    {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 98.11440000, -317.97960000, 11.75530000, 2.00000000, 2.00000000, 1.00000000, 0 )) AND (l_U563[3] == 0))
    {
        MARK_MODEL_AS_NO_LONGER_NEEDED( 837858166 );
        MARK_CAR_AS_NO_LONGER_NEEDED( ref l_U1257 );
        MARK_CHAR_AS_NO_LONGER_NEEDED( ref l_U1260._fU0 );
    ...
    if ((((l_U563[1] == 0) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 98.11440000, -317.97960000, 11.75530000, 2.00000000, 2.00000000, 1.00000000, 0 ))) AND (NOT (IS_CHAR_DEAD( l_U1530 )))) AND (NOT (IS_CHAR_DEAD( l_U1531 ))))
    {
    ...
    if ((l_U563[2] == 0) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 98.44790000, -302.63570000, 11.75530000, 2.00000000, 2.50000000, 1.00000000, 0 )))
    {
    ...
    if (((NOT (sub_8970( l_U818 ))) AND (l_U563[6] == 0)) AND (l_U563[2] == 1))
    {
    ...
    if (((IS_CHAR_INJURED( l_U1268[3]._fU0 )) AND (l_U563[4] == 0)) AND (l_U563[2] == 1))
    {
        if (NOT (IS_CHAR_DEAD( l_U1530 )))
        {
            CLEAR_CHAR_TASKS( l_U1530 );
    ...
    if (((IS_CHAR_INJURED( l_U1268[2]._fU0 )) AND (l_U563[5] == 0)) AND (l_U563[2] == 1))
    {
        if (NOT (IS_CHAR_DEAD( l_U1531 )))
        {
            REMOVE_CHAR_DEFENSIVE_AREA( l_U1531 );
    ...
    if ((((((l_U563[2] == 1) AND (IS_CHAR_INJURED( l_U1268[0]._fU0 ))) AND (IS_CHAR_INJURED( l_U1268[1]._fU0 ))) AND (IS_CHAR_INJURED( l_U1268[2]._fU0 ))) AND (IS_CHAR_INJURED( l_U1268[3]._fU0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 110.55270000, -267.68170000, 1.28650000, 2.50000000, 4.50000000, 1.00000000, 0 )))
    {
        for ( I = 0; I <= 7; I++ )
        {
            if (DOES_BLIP_EXIST( l_U1268[I]._fU24 ))
...
void sub_86362()
{
    ...
    sub_66738();
    sub_67321( 50.00000000, 10000 );
    if (((((((l_U744[l_U740] == 1) AND (IS_CHAR_INJURED( l_U1333[0]._fU0 ))) AND (IS_CHAR_INJURED( l_U1333[1]._fU0 ))) AND (IS_CHAR_INJURED( l_U1333[2]._fU0 ))) AND (IS_CHAR_INJURED( l_U1333[3]._fU0 ))) AND (IS_CHAR_INJURED( l_U1333[4]._fU0 ))) AND (IS_CHAR_INJURED( l_U1333[5]._fU0 )))
    {
        l_U740++;
    }
    return;
...
void sub_87659()
{
    ...
    if ((((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 111.30520000, -252.55780000, -3.29140000, 6.00000000, 5.00000000, 3.00000000, 0 )) AND (l_U563[0] == 0)) AND (HAS_MODEL_LOADED( 800869680 ))) AND (HAS_MODEL_LOADED( 1159759556 )))
    {
    ...
    if ((((IS_CHAR_INJURED( l_U1398[0]._fU0 )) || (IS_CHAR_INJURED( l_U1398[1]._fU0 ))) AND (l_U563[0] == 1)) AND (l_U563[1] == 0))
    {
    ...
    if (((l_U563[1] == 1) AND (TIMERA() > 4000)) AND (l_U563[2] == 0))
    {
        PRINTSTRING( "Creating Train" );
        PRINTNL();
    ...
    if (l_U563[2] == 1)
    {
        ...
        {
            if (LOCATE_CAR_2D( l_U1463[0], 97.71320000, -258.06380000, 3.00000000, 3.00000000, 0 ))
            {
...
void sub_90116()
{
    ...
    if (l_U744[l_U740] == 0)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U1530 )))
        {
            ...
            TASK_TURN_CHAR_TO_FACE_CHAR( 0, l_U628 );
            TASK_AIM_GUN_AT_COORD( 0, 97.91000000, -235.15000000, -4.01000000, -2 );
        ...
        if (NOT (IS_CHAR_DEAD( l_U1531 )))
        {
            ...
            TASK_GO_STRAIGHT_TO_COORD( 0, 97.69340000, -210.09200000, -5.47930000, 3, 20000 );
            TASK_TURN_CHAR_TO_FACE_CHAR( 0, l_U628 );
    ...
    if ((NOT (sub_8970( l_U818 ))) AND (l_U563[9] == 0))
    {
        PRINT_NOW( "BJFLLOW", 7500, 1 );
        l_U563[9] = 1;
    }
    if ((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT (IS_CHAR_DEAD( l_U1531 ))))
    {
        if ((((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 100.89610000, -214.15070000, -4.47440000, 5.00000000, 4.00000000, 3.00000000, 0 )) || ((sub_90860( l_U628 )) > -214.15070000)) AND ((LOCATE_CHAR_ANY_MEANS_3D( l_U1530, 100.89610000, -214.15070000, -4.47440000, 5.00000000, 4.00000000, 3.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U1531, 100.89610000, -214.15070000, -4.47440000, 5.00000000, 4.00000000, 3.00000000, 0 )))) AND (l_U563[0] == 0))
        {
            l_U563[0] = 1;
        }
    }
    ...
    if (((((TIMERA() > 8000) AND (l_U563[2] == 0)) AND (l_U563[0] == 1)) AND (l_U563[1] == 1)) AND (((sub_12510( l_U628, l_U1531, 1 )) < 15.00000000) || ((sub_12510( l_U628, l_U1530, 1 )) < 15.00000000)))
    {
        if ((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT (IS_CHAR_DEAD( l_U1472[2]._fU0 ))))
        {
            REMOVE_CHAR_DEFENSIVE_AREA( l_U1530 );
        ...
        WAIT( 1000 );
        if ((NOT (IS_CHAR_DEAD( l_U1531 ))) AND (NOT (IS_CHAR_DEAD( l_U1472[5]._fU0 ))))
        {
            REMOVE_CHAR_DEFENSIVE_AREA( l_U1531 );
    ...
    if (((sub_55354( l_U1530, 55.27710000, -121.50290000, -5.41730000 )) < 68.00000000) AND (l_U563[4] == 0))
    {
        CLEAR_AREA_OF_CHARS( 14.50020000, -98.68350000, -3.90330000, 100.00000000 );
    ...
    if (((TIMERB() > 2900) AND (l_U563[8] == 0)) AND (l_U563[4] == 1))
    {
        if ((sub_12510( l_U628, l_U1530, 1 )) < 30.00000000)
        {
    ...
    if (((((l_U563[2] == 1) AND (NOT (sub_8970( l_U818 )))) AND (l_U563[7] == 0)) AND (l_U563[8] == 1)) AND (TIMERB() > 2000))
    {
        if ((sub_12510( l_U628, l_U1530, 1 )) < 30.00000000)
        {
    ...
    if ((((sub_55354( l_U628, 23.85660000, -97.93270000, -1.74710000 )) < 30.00000000) AND (l_U563[3] == 0)) AND (NOT (sub_8970( l_U818 ))))
    {
    ...
    if (((l_U563[3] == 1) AND (NOT (sub_8970( l_U818 )))) AND (l_U563[10] == 0))
    {
...
void sub_93849()
{
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 30.96140000, -87.26930000, 10.25290000, 1.00000000, 1.00000000, 1.00000000, 0 )) AND (l_U563[1] == 0))
    {
    ...
    sub_12463( 0 );
    sub_66738();
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 35.79160000, -94.36490000, 10.24800000, 1.60000000, 1.60000000, 1.60000000, 1 )) || ((sub_94637( l_U628 )) > 9.24800000))
    {
        sub_48992( 0 );
        MARK_MODEL_AS_NO_LONGER_NEEDED( 800869680 );
        MARK_MODEL_AS_NO_LONGER_NEEDED( 1159759556 );
...
void sub_95027()
{
    ...
    if (((sub_94637( l_U1530 )) > 13.00000000) AND (l_U767 == 0))
    {
        sub_7469( "PM3_PCOPS", "PM3BAUD", ref l_U818, 8, 1 );
        l_U767 = 1;
    }
    if (((l_U563[9] == 0) AND (l_U767 == 1)) AND (NOT (sub_8970( l_U818 ))))
    {
    ...
    if ((NOT (IS_CHAR_DEAD( l_U1530 ))) AND (NOT (IS_CHAR_DEAD( l_U1531 ))))
    {
        if ((((IS_CHAR_IN_ANY_CAR( l_U1530 )) AND (IS_CHAR_IN_ANY_CAR( l_U1531 ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( l_U628 ))) AND (l_U563[2] == 0))
        {
            MARK_MODEL_AS_NO_LONGER_NEEDED( 2046537925 );
    ...
    if (((l_U563[2] == 1) AND (NOT (IS_CHAR_DEAD( l_U1530 )))) AND (NOT (IS_CHAR_DEAD( l_U1531 ))))
    {
        if (((IS_CHAR_IN_ANY_CAR( l_U1530 )) AND (IS_CHAR_IN_ANY_CAR( l_U1531 ))) AND (IS_CHAR_SITTING_IN_ANY_CAR( l_U628 )))
        {
            if (sub_34516( l_U818 ))
            {
                switch (g_U64966)
    ...
    if (((l_U563[8] == 0) AND (l_U563[2] == 1)) AND (NOT (sub_8970( l_U818 ))))
    {
    ...
    if ((HAS_MODEL_LOADED( -183203150 )) AND (HAS_MODEL_LOADED( 2046537925 )))
    {
        if (IS_WANTED_LEVEL_GREATER( l_U629, 0 ))
        {
            sub_52323( 0 );
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 214.67880000, -408.15100000, 16.35970000, 3.00000000, 11.50000000, 4.00000000, 0 )) AND ((NOT l_U563[0]) == 0))
    {
        l_U563[0] = 1;
    }
    if (NOT (IS_WANTED_LEVEL_GREATER( l_U629, 0 )))
    {
        ...
        if (l_U793)
        {
            if (((sub_19166( l_U1531, "missbankjob", "remove_balaclave_a" )) > 0.50000000) AND (l_U799 == 0))
            {
                SET_CHAR_COMPONENT_VARIATION( l_U1531, 3, 0, 0 );
                l_U799 = 1;
            }
        ...
        if (l_U794)
        {
            if (((sub_19166( l_U1530, "missbankjob", "remove_balaclave_b" )) > 0.50000000) AND (l_U798 == 0))
            {
                SET_CHAR_COMPONENT_VARIATION( l_U1530, 3, 0, 0 );
                l_U798 = 1;
            }
        ...
        if (l_U792)
        {
            if (((sub_19166( l_U628, "missbankjob", "remove_balaclave_b" )) > 0.50000000) AND (l_U797 == 0))
            {
    ...
    if ((IS_GROUP_MEMBER( l_U1530, l_U627 )) AND (IS_GROUP_MEMBER( l_U1531, l_U627 )))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1401.60600000, 618.81800000, 34.90700000, 2.50000000, 2.50000000, 2.50000000, 1 ))
        {
            ...
            else if (sub_9361( 1, 1 ))
            {
                ...
                SET_CAM_FOV( l_U626, 43.40002000 );
                DO_SCREEN_FADE_IN( 500 );
                while (IS_SCREEN_FADING_IN())
                {
                    WAIT( 0 );
                ...
                while (((sub_79480( l_U818 )) < 2) AND (l_U790 == 0))
                {
                    if (NOT (IS_CHAR_DEAD( l_U1530 )))
                    {
                        BLOCK_CHAR_AMBIENT_ANIMS( l_U1530, 1 );
                ...
                while ((TIMERA() < 9000) AND (l_U790 == 0))
                {
                    if (sub_14835())
                    {
                        l_U790 = 1;
