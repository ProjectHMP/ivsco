void main()
{
    ...
    if (SECUROM_SPOT_CHECK4())
    {
        ...
        {
            if ((((IS_MOBILE_PHONE_CALL_ONGOING()) || (g_U555 == 1)) || (IS_CHAR_SHOOTING( sub_1712() ))) || (g_U33837))
            {
                sub_2737();
                sub_2438( 1 );
                sub_2555();
        ...
        sub_6091();
        sub_18756();
        ADD_WIDGET_TOGGLE( "force shut comp down", ref g_U8219 );
...
int sub_3007()
{
    ...
    g_U2245[9] = GET_TEXTURE( g_U2244, "enterBut1" );
    g_U2245[10] = GET_TEXTURE( g_U2244, "keyBut1" );
    ...
    sub_3104( "policeComputer", "keyBut1" );
    ...
    sub_3104( "PDBMostWantedNJ", "M_M_GJam_Hi_01_b" );
    sub_3104( "PDBMostWantedNJ", "M_Y_ChopShop_02" );
    sub_3104( "PDBMostWantedNJ", "M_Y_dEALER_B" );
    sub_3104( "PDBMostWantedNJ", "M_Y_DOWNTOWN_03" );
    ...
    sub_3104( "PDBMostWantedmh", "m_y_gbik_lo_02" );
    sub_3104( "PDBMostWantedmh", "m_y_gru2_lo_01" );
    sub_3104( "PDBMostWantedmh", "m_y_grus_lo_01" );
    sub_3104( "PDBMostWantedmh", "m_y_dealer" );
    ...
    sub_3104( "PDBMostWantedeast", "m_y_Drug_01" );
    sub_3104( "PDBMostWantedeast", "M_Y_GAFR_HI_02" );
    sub_3104( "PDBMostWantedEAST", "M_Y_GAFR_LO_02" );
    sub_3104( "PDBMostWantedEAST", "M_Y_GALB_LO_01" );
    sub_3104( "PDBMostWantedEAST", "M_Y_GBIK_HI_02" );
    sub_3104( "PDBMostWantedEAST", "M_Y_GLAT_HI_02_B" );
    sub_3104( "PDBMostWantedEAST", "M_Y_GRUS_LO_01" );
    return 1;
    return 0;
}
...
int sub_6202(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;
    unknown uVar6;
    ...
    if (NOT g_U8086)
    {
        ...
        if ((IS_CONTROL_PRESSED( 2, 77 )) AND (NOT l_U496))
        {
            switch (l_U490)
            {
                ...
                if (((((NOT GET_MISSION_FLAG()) AND (NOT (sub_6202( uVar3 )))) AND (NOT g_U10978)) AND (sub_27338())) AND (g_U15654[20]))
                {
                ...
                break;
                case 2:
                if ((((NOT GET_MISSION_FLAG()) AND (NOT g_U10978)) AND (sub_27338())) AND (g_U15654[20]))
                {
                    PLAY_SOUND_FRONTEND( -1, "POLICE_COMPUTER_FORWARDS" );
                    l_U489 = 3;
                    l_U490 = 0;
                ...
                if (NOT g_U8218)
                {
                    if ((((VDIST( g_U8212, uVar3 )) > 150.00000000) || (g_U8215 != iVar6)) || (g_U8216 != iVar7))
                    {
                        g_U8212 = {uVar3};
                        g_U8215 = iVar6;
                        g_U8216 = iVar7;
...
void sub_21429(int iParam0)
{
    ...
    for ( I = 0; I <= 3; I++ )
    {
        if (iParam0 == I)
        {
            sub_23454( sVar4[I], l_U287, l_U286 + (I * 0.08000000), 1, 1065353216 );
            if (NOT IS_JAPANESE_VERSION())
            {
                DRAW_SPRITE( g_U2245[1], l_U288, 0.42500000 + (I * 0.08000000), l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
            }
            else
            {
                DRAW_SPRITE( g_U2245[1], l_U288, 0.41600000 + (I * 0.08000000), l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
            }
        }
        else
        {
            sub_23454( sVar4[I], l_U287, l_U286 + (I * 0.08000000), 0, 1065353216 );
        }
    }
    sub_23921( "", "PC_UB_MMA", "PC_QUIT", "PC_UB_MMDP", 0, 0, 0 );
    sub_25165( "PCS_H1", l_U287, l_U285, 3 );
    sub_25390( 0 );
    return;
}
...
void sub_21527()
{
    ...
    DRAW_SPRITE( g_U2245[0], l_U138, l_U139, l_U140, l_U141, 0.00000000, 255, 255, 255, 255 );
    DRAW_SPRITE( g_U2245[6], l_U130, l_U131, l_U132 * 0.70000000, l_U133 * 0.70000000, 0.00000000, 255, 255, 255, 255 );
    DRAW_SPRITE( g_U2245[7], l_U134, l_U135, l_U136 * 0.70000000, l_U137 * 0.70000000, 0.00000000, 255, 255, 255, 255 );
    DISABLE_PAUSE_MENU( 1 );
    return;
}
...
{
    sub_23178( 1.00000000, 1.00000000, 1.00000000, 1.00000000, l_U48 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
    SET_TEXT_COLOUR( 243, 193, 34, 255 );
    DISPLAY_TEXT( 0.18500000, l_U56, uParam0 );
    return;
}

void sub_23178(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    if (NOT IS_JAPANESE_VERSION())
    {
...
void sub_23454(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, float fParam4)
{
    float fVar7;
    float fVar8;
    ...
    sub_23178( fVar7, fVar8, fVar7, fVar8, l_U48 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
...
void sub_23921(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, boolean bParam6)
{
    float fVar9;
    float fVar10;
    float fVar11;
    ...
    sub_23930();
    DRAW_RECT( l_U58, l_U59, l_U60, 0.02500000, 255, 0, 0, 255 );
    DRAW_RECT( l_U61, l_U62, l_U60, 0.02500000, 255, 0, 0, 255 );
    DRAW_RECT( l_U63, l_U64, l_U60, 0.02500000, 255, 0, 0, 255 );
    sub_24085();
    if (NOT bParam6)
    {
        DISPLAY_TEXT( l_U11, l_U2, uParam3 );
    }
    PRINTSTRING( "\n ***** iCurrScreen ****** CO. " );
    PRINTINT( uParam4 );
    ...
    {
        case 0:
        fVar9 = l_U68 - (GET_STRING_WIDTH( uParam2 ));
        fVar10 = fVar9 - (l_U67 * (GET_STRING_WIDTH( uParam1 )));
        fVar11 = fVar10 - (l_U67 * (GET_STRING_WIDTH( uParam0 )));
        sub_24085();
        DISPLAY_TEXT( fVar10, l_U2, uParam1 );
        sub_24085();
        DISPLAY_TEXT( fVar9, l_U2, uParam2 );
        break;
        case 1:
        fVar9 = l_U68 - (GET_STRING_WIDTH( uParam2 ));
        fVar10 = fVar9 - (l_U67 * (GET_STRING_WIDTH( uParam1 )));
        ...
        fVar10 = (fVar9 + l_U68) - (l_U67 * (GET_STRING_WIDTH( uParam1 )));
        fVar11 = (fVar10 + l_U68) - (l_U67 * (GET_STRING_WIDTH( uParam0 )));
        sub_24085();
        DISPLAY_TEXT( fVar10, l_U2, uParam1 );
        sub_24085();
        DISPLAY_TEXT( fVar9, l_U2, uParam2 );
        ...
        {
            sub_24085();
            DISPLAY_TEXT( fVar11, l_U2, uParam0 );
        }
        break;
        case 4:
        fVar9 = l_U68 - (GET_STRING_WIDTH( uParam2 ));
        ...
        l_U68 = 0.86000000;
        fVar9 = l_U68 - (GET_STRING_WIDTH( uParam2 ));
        fVar10 = (fVar9 - (l_U67 * (GET_STRING_WIDTH( uParam1 )))) - 0.02000000;
        fVar11 = (fVar10 - (l_U67 * (GET_STRING_WIDTH( uParam0 )))) - 0.02000000;
        sub_24085();
        if (NOT bParam5)
        {
            DISPLAY_TEXT( fVar10, l_U2, uParam1 );
...
void sub_24085()
{
    sub_23178( l_U66, l_U66, l_U66, l_U66, 1.00000000 );
...
void sub_25165(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    sub_23178( 0.50000000, 0.50000000, 0.50000000, 0.50000000, l_U48 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
...
void sub_25390(unknown uParam0)
{
    int iVar3;
    ...
    if ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "Brucie1" )) > 0)
    {
        if (g_U64945)
        {
            switch (uParam0)
            {
                ...
                {
                    l_U55 = 0;
                    if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TTKHLP_B_H5" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TTKHLP_B_H6" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TTKHLP_B_H7" )))
                    {
                        CLEAR_HELP();
                    }
                    if (((iVar3 - l_U52) < 12500) AND ((iVar3 - l_U52) > 5000))
                    {
                        if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TTKHLP_B_H2" )))
                        {
                            PRINT_HELP_FOREVER( "TTKHLP_B_H2" );
                        }
                    }
                    else if (((iVar3 - l_U52) < 20000) AND ((iVar3 - l_U52) > 12500))
                    {
                        if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TTKHLP_B_H3" )))
                        {
                            PRINT_HELP_FOREVER( "TTKHLP_B_H3" );
                        }
                    }
                    else if ((iVar3 - l_U52) > 20000)
                    {
                        if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TTKHLP_B_H4" )))
                        {
                            PRINT_HELP_FOREVER( "TTKHLP_B_H4" );
                        }
                    };;;
                }
                break;
                ...
                if (NOT g_U64946)
                {
                    if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TTKHLP_B_H5" )))
                    {
                        PRINT_HELP_FOREVER( "TTKHLP_B_H5" );
                    }
                }
                break;
                case 3:
                if (NOT g_U64946)
                {
                    ...
                    {
                        PRINT_HELP_FOREVER( "TTKHLP_B_H6" );
                    }
                }
                break;
                case 5:
                if (sub_26000( "PD_LYLE", "PD_RIVAS" ))
                {
                    if (NOT g_U64946)
                    {
                        if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TTKHLP_B_H7" )))
                        {
                            PRINT_HELP_FOREVER( "TTKHLP_B_H7" );
                            PRINT_NOW( "TTK_SEARCH2", 7500, 1 );
                        }
                    }
                    else if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TTKHLP_B_H8" )))
                    {
                        PRINT_HELP_FOREVER( "TTKHLP_B_H8" );
                    }
                }
                break;
                default:
    ...
    else if ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "cia2" )) > 0)
    {
        if (g_U64947)
        {
            switch (uParam0)
            {
                ...
                if (NOT g_U64948)
                {
                    if ((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "CIA2_E_H1" ))) AND ((iVar3 - l_U52) > 5000))
                    {
                        PRINT_HELP_FOREVER( "CIA2_E_H1" );
                    }
                }
                break;
                case 2:
                if (NOT g_U64948)
                {
                    if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "CIA2_E_H2" )))
                    {
                        PRINT_HELP_FOREVER( "CIA2_E_H2" );
                    }
                }
                break;
                case 6:
                ...
                if (sub_26000( "PD_ADAM", "PD_DIMAYEV" ))
                {
                    if (NOT g_U64948)
                    {
                        if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "CIA2_E_H4" )))
                        {
                            PRINT_HELP_FOREVER( "CIA2_E_H4" );
                        }
                    }
                    else if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "CIA2_B_H8" )))
                    {
                        CLEAR_HELP();
                    }
                }
    ...
    else if ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "DERRICK1" )) > 0)
    {
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1820(), 0 )))
        {
            ...
            {
                case 2:
                if (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TF_BYDSH_04" )))
                {
                    if (NOT l_U69)
                    {
                        PRINT_HELP( "TF_BYDSH_04" );
                        l_U69 = 1;
                    }
                }
                break;
...
void sub_27482()
{
    ...
    sub_21527();
    DISABLE_PAUSE_MENU( 1 );
    sub_27540( "PC_REQFAIL", l_U161, l_U162, 2, 1 );
    if (NOT IS_JAPANESE_VERSION())
    {
        sub_27540( "PC_FBIFAIL2", l_U161, l_U142, 2, 1 );
    }
    else
    {
        sub_27540( "PC_FBIFAIL2", l_U161, l_U142 + 0.03000000, 2, 1 );
    }
    return;
}

void sub_27540(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, boolean bParam4)
{
    unknown uVar7;
    float fVar8;

    sub_23178( 0.60000000, 0.80000000, 0.60000000, 0.80000000, l_U48 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
    switch (uParam3)
    {
...
void sub_28608()
{
    ...
    sub_28638( l_U495, ref l_U498, ref l_U677, ref l_U682, ref l_U692 );
    GET_POSITION_OF_ANALOGUE_STICKS( 0, ref l_U661, ref l_U662, ref l_U663, ref l_U663 );
    if ((l_U661 == 0) AND (l_U662 == 0))
    {
        GET_KEYBOARD_MOVE_INPUT( ref l_U661, ref l_U662 );
...
void sub_28638(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    char[16] cVar7;
    unknown uVar11;
    unknown uVar12;
    ...
    sub_23144( "PC_CC_TT0" );
    sub_28850( "PC_CC_OP1", l_U287, 0.38000000, 2, 1 );
    sub_25165( "PCS_H2", l_U287, l_U285, 3 );
    if (iParam0 != 0)
    {
        sub_29107( ref cVar7[0], (uParam4^)[0], l_U287, 0.46000000, 0 );
    }
    else
    {
        DRAW_SPRITE( g_U2245[1], l_U288, 0.50000000, l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
        sub_29107( ref cVar7[0], (uParam4^)[0], l_U287, 0.46000000, 1 );
    }
    if (iParam0 != 1)
    {
        sub_29107( ref cVar7[1], (uParam4^)[1], l_U287, 0.54000000, 0 );
    }
    else
    {
        sub_29107( ref cVar7[1], (uParam4^)[1], l_U287, 0.54000000, 1 );
        DRAW_SPRITE( g_U2245[1], l_U288, 0.58000000, l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
    }
    if (iParam0 != 2)
    {
        sub_29107( ref cVar7[2], (uParam4^)[2], l_U287, 0.62000000, 0 );
    }
    else
    {
        DRAW_SPRITE( g_U2245[1], l_U288, 0.66000000, l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
        sub_29107( ref cVar7[2], (uParam4^)[2], l_U287, 0.62000000, 1 );
    }
    sub_25390( 1 );
    sub_23921( "", "PC_UB_MMA", "PC_UB_MWB", "PC_UB_MWDP", 1, 0, 0 );
    return;
}

void sub_28850(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    sub_23178( 0.60000000, 0.80000000, 0.60000000, 0.80000000, l_U48 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
...
void sub_29107(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    sub_23178( 0.60000000, 0.60000000, 0.40000000, 0.60000000, l_U48 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
...
void sub_30791()
{
    ...
    switch (l_U493)
    {
        ...
        if ((NOT sub_32861()) AND (sub_32939( l_U495 )))
        {
            uVar3 = sub_33203( l_U495, 1 );
        }
        else
        {
            sub_33996();
        ...
        break;
        case 2:
        if ((NOT sub_34937()) AND (NOT sub_37318()))
        {
            sub_40259( ref l_U503 );
            sub_40348( ref l_U503, sub_40321(), l_U462 );
        }
        else
        {
            l_U495 = 0;
            switch (l_U492)
            {
                case 0:
                sub_40348( ref l_U503, sub_40321(), l_U462 );
                sub_44128( ref uVar5, ref uVar13 );
                l_U656 = sub_44369( ref uVar5, ref uVar13, ref l_U665 );
                l_U493 = 3;
                PLAY_SOUND_FRONTEND( -1, "POLICE_COMPUTER_FORWARDS" );
                break;
                default:
        ...
        if (NOT (l_U492 == 1))
        {
            if (l_U656 == 1)
            {
                sub_32123();
                g_U8082 = l_U665[0];
                sub_48288( l_U665[0], l_U715 );
                sub_50452( l_U665[0], 0 );
                if (NOT l_U676)
                {
            ...
            else if (l_U656 > 1)
            {
                ...
                g_U8082 = l_U495;
                sub_48288( l_U665[l_U495], l_U715 );
                sub_50452( l_U665[l_U495], 0 );;
                if ((sub_26966()) AND (NOT l_U496))
                {
                    PLAY_SOUND_FRONTEND( -1, "POLICE_COMPUTER_BACK" );
                    sub_53636();
...
void sub_30908(int iParam0)
{
    GET_SCRIPT_RENDERTARGET_RENDER_ID( ref l_U129 );
    sub_21527();
    sub_23144( "PC_SSL_TT0" );
    if (iParam0 == 0)
    {
        sub_23454( "PC_SSL_OP1", l_U287, l_U286, 1, 1065353216 );
        sub_23454( "PC_SSL_OP2", l_U287, l_U286 + 0.08000000, 0, 1065353216 );
        if (NOT IS_JAPANESE_VERSION())
        {
            DRAW_SPRITE( g_U2245[1], l_U288, 0.42500000, l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
        }
        else
        {
            DRAW_SPRITE( g_U2245[1], l_U288, 0.41600000, l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
        }
    }
    if (iParam0 == 1)
    {
        sub_23454( "PC_SSL_OP1", l_U287, l_U286, 0, 1065353216 );
        sub_23454( "PC_SSL_OP2", l_U287, l_U286 + 0.08000000, 1, 1065353216 );
        if (NOT IS_JAPANESE_VERSION())
        {
            DRAW_SPRITE( g_U2245[1], l_U288, 0.50500000, l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
        }
        else
        {
            DRAW_SPRITE( g_U2245[1], l_U288, 0.49700000, l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
        }
    }
    if (NOT sub_31361())
    {
        sub_25165( "PCS_H3", l_U287, l_U285, 3 );
    }
    else
    {
        sub_25165( "PCS_H3", l_U287, l_U285 + 0.02000000, 3 );
    }
    sub_23921( "", "PC_UB_MMA", "PC_UB_MWB", "PC_UB_MMDP", 2, 0, 0 );
    sub_25390( 2 );
    return;
}
...
void sub_32244()
{
    ...
    DISABLE_PAUSE_MENU( 1 );
    sub_21527();
    sub_27540( "PC_BT_UP", l_U161, l_U162, 2, 1 );
    return;
}
...
void sub_32321()
{
    if (IS_PLAYER_PLAYING( sub_1820() ))
    {
        if ((NOT (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_1712() ))) || (g_U8219))
        {
            sub_32371();
            g_U8219 = 0;
        }
...
void sub_32759()
{
    ...
    sub_21527();
    DISABLE_PAUSE_MENU( 1 );
    sub_27540( "PC_BT_CO", l_U161, l_U162, 2, 1 );
    return;
}
...
int sub_32939(unknown uParam0)
{
    if (NOT (sub_32962( uParam0, ref l_U101, ref l_U109, ref l_U117 )))
    {
        return 0;
    }
    return 1;
...
int sub_32962(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    int I;
    int iVar7;
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (g_U569[I]._fU0[2] != -1)
        {
            if (g_U569[I]._fU0[2] >= 100000)
            {
                if (iVar7 == iParam0)
                {
                    (uParam3^) = g_U569[I]._fU0[2];
                    sub_33072( uParam1, uParam2, (uParam3^) );
                    return 1;
                }
                else
                {
...
void sub_33072(unknown uParam0, unknown uParam1, int iParam2)
{
...
int sub_33203(unknown uParam0, boolean bParam1)
{
    int Result;

    GET_SCRIPT_RENDERTARGET_RENDER_ID( ref l_U129 );
    sub_21527();
    sub_33248( 0.49800000, 0.48200000, l_U157, l_U158 );
    sub_2280( l_U99 );
    if (sub_32962( uParam0, ref l_U101, ref l_U109, ref l_U117 ))
    {
        ...
        if (HAS_STREAMED_TXD_LOADED( ref l_U101 ))
        {
            ...
            DRAW_SPRITE( g_U2245[13], 0.49800000, 0.48200000, l_U157, l_U158, 0.00000000, 255, 255, 255, 255 );
            DRAW_SPRITE( g_U2245[12], 0.49800000, 0.48200000, l_U157, l_U158, 0.00000000, 255, 255, 255, 255 );
            if (l_U99 != nil)
            {
...
void sub_33248(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
...
void sub_33996()
{
    GET_SCRIPT_RENDERTARGET_RENDER_ID( ref l_U129 );
    sub_21527();
    sub_27540( "PC_PHOTOFAIL", l_U161, l_U162, 2, 1 );
    sub_23921( "", "", "PC_UB_MWB", "", 1, 0, 0 );
    return;
}

int sub_34208(unknown uParam0)
{
    int iVar3;
...
int sub_34689(int iParam0)
{
    int Result;

    for ( Result = 0; Result <= 99; Result++ )
    {
        if (g_U2273[Result]._fU184 == iParam0)
        {
            if (NOT g_U2273[Result]._fU208)
            {
                return Result;
            }
        }
    ...
    if ((IS_CONTROL_PRESSED( 2, 77 )) AND (NOT l_U307))
    {
        ...
        if (NOT (l_U475 == 27))
        {
            if (l_U462 < 19)
            {
                l_U471 = 0;
                l_U472 = 0;
                StrCopy( ref l_U309[l_U462], sub_37327(), 32 );
                l_U462++;
            }
            l_U307 = 1;
            l_U308 = 1;
...
void sub_40259(unknown uParam0)
{
    int I;
...
void sub_40348(unknown uParam0, unknown uParam1, int iParam2)
{
    int I;
    unknown uVar6;
    float fVar7;
    ...
    if (l_U272)
    {
        for ( I = 0; I <= 18; I++ )
        {
            DRAW_SPRITE( g_U2245[10], l_U264 + (l_U271 * I), l_U266, l_U268, l_U269, 0.00000000, 255, 255, 255, 255 );
        }
    }
    if (iParam2 == 0)
    {
    ...
    for ( I = 0; I <= 9; I++ )
    {
        ...
        sub_42024( l_U177, l_U178, sVar43[I] );
        if (COMPARE_STRING( uParam1, sVar32[I] ))
        {
            DRAW_SPRITE( g_U2245[10], fVar54, l_U73, l_U71, l_U72, 0.00000000, 255, 255, 255, 255 );
        }
        else
        {
            DRAW_SPRITE( g_U2245[2], fVar54, l_U73, l_U71, l_U72, 0.00000000, 243, 193, 24, 255 );
        }
    }
    array(ref sVar58, 9);
    array(ref sVar68, 9);
    ...
    for ( I = 0; I <= 8; I++ )
    {
        ...
        sub_42024( l_U179, l_U180, sVar68[I] );
        if (COMPARE_STRING( uParam1, sVar58[I] ))
        {
            DRAW_SPRITE( g_U2245[10], fVar55, l_U73 + 0.10000000, l_U71, l_U72, 0.00000000, 255, 255, 255, 255 );
        }
        else
        {
            DRAW_SPRITE( g_U2245[2], fVar55, l_U73 + 0.10000000, l_U71, l_U72, 0.00000000, 243, 193, 24, 255 );
        }
    }
    array(ref sVar78, 7);
    array(ref sVar86, 7);
    ...
    for ( I = 0; I <= 6; I++ )
    {
        ...
        sub_42024( l_U181, l_U182, sVar86[I] );
        if (COMPARE_STRING( uParam1, sVar78[I] ))
        {
            DRAW_SPRITE( g_U2245[10], fVar56, l_U73 + 0.20000000, l_U71, l_U72, 0.00000000, 255, 255, 255, 255 );
        }
        else
        {
            DRAW_SPRITE( g_U2245[2], fVar56, l_U73 + 0.20000000, l_U71, l_U72, 0.00000000, 243, 193, 24, 255 );
        }
    }
    fVar56 += 0.12000000;
    if (COMPARE_STRING( uParam1, "ENTER" ))
    {
        DRAW_SPRITE( g_U2245[9], fVar56, l_U73 + 0.20000000, l_U71 * l_U146, l_U72, 0.00000000, 255, 255, 255, 255 );
    }
    else
    {
        DRAW_SPRITE( g_U2245[4], fVar56, l_U73 + 0.20000000, l_U71 * l_U146, l_U72, 0.00000000, 243, 193, 24, 255 );
    }
    if (COMPARE_STRING( uParam1, "_" ))
    {
        DRAW_SPRITE( g_U2245[11], l_U143, l_U73 + 0.30000000, l_U71 * l_U144, l_U72, 0.00000000, 255, 255, 255, 255 );
    }
    else
    {
        DRAW_SPRITE( g_U2245[3], l_U143, l_U73 + 0.30000000, l_U71 * l_U144, l_U72, 0.00000000, 243, 193, 24, 255 );
    }
    if (COMPARE_STRING( uParam1, "DEL" ))
    {
        DRAW_SPRITE( g_U2245[9], l_U145, l_U73 + 0.30000000, l_U71 * l_U146, l_U72, 0.00000000, 255, 255, 255, 255 );
    }
    else
    {
        DRAW_SPRITE( g_U2245[4], l_U145, l_U73 + 0.30000000, l_U71 * l_U146, l_U72, 0.00000000, 243, 193, 24, 255 );
    }
    SET_TEXT_SCALE( 0.60000000 * 0.75000000, 0.60000000 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
    sub_43742( "KYB_ENTER", fVar56, l_U182 );
    SET_TEXT_SCALE( 0.60000000 * 0.75000000, 0.60000000 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
    sub_43742( "KEY_SPACE", l_U143, l_U183 );
    SET_TEXT_SCALE( 0.60000000 * 0.75000000, 0.60000000 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
    sub_43742( "KYB_DEL", l_U145, l_U183 );
    sub_25390( 3 );
    l_U49._fU0 = l_U163._fU0;
    if (IS_USING_CONTROLLER())
    {
        sub_23921( "PC_UB_MMX", "PC_UB_MMA", "PC_UB_KEB", "PC_UB_KEDP", 3, 0, 0 );
    }
    else
    {
        sub_23921( "", "PC_UB_MMA", "PC_UB_KEB", "PC_UB_KEDP", 3, 0, 0 );
    }
    return;
}
...
void sub_40592()
{
    SET_TEXT_FONT( 0 );
    SET_TEXT_COLOUR( 255, 255, 255, 255 );
    sub_23178( 0.45500000, 0.45500000, 0.60000000, 0.60000000, 1.00000000 );
    SET_TEXT_PROPORTIONAL( 1 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
    return;
}

void sub_42024(unknown uParam0, unknown uParam1, unknown uParam2)
{
    SET_TEXT_SCALE( 0.60000000 * 0.75000000, 0.60000000 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
...
void sub_43742(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;
    float fVar6;
...
void sub_44128(unknown uParam0, unknown uParam1)
{
    int iVar4;
    int I;
...
void sub_44369(unknown uParam0, unknown uParam1, unknown uParam2)
{
    int I;
    int Result;
    ...
    if ((DOES_TEXT_LABEL_EXIST( uParam0 )) || (DOES_TEXT_LABEL_EXIST( uParam1 )))
    {
        for ( I = 0; I <= 99; I++ )
        {
            ...
            if (COMPARE_STRING( ref g_U2273[I]._fU0, "PD_" ))
            {
                ;
            }
            if (((COMPARE_STRING( ref g_U2273[I]._fU16, uParam0 )) || (COMPARE_STRING( ref g_U2273[I]._fU0, uParam1 ))) || (COMPARE_STRING( ref g_U2273[I]._fU0, uParam0 )))
            {
                if (NOT g_U2273[I]._fU208)
                {
                    (uParam2^)[Result] = I;
...
void sub_44868()
{
    ...
    sub_44975( l_U128 );
    sub_23178( 0.60000000, 0.80000000, 0.60000000, 0.80000000, l_U48 );
    sub_43742( "PC_NRSRCH", 0.49800000, l_U76 );
    return;
}
...
void sub_44975(int iParam0)
{
    ...
    if (l_U98 != nil)
    {
        uVar3 = {sub_45251( g_U2273[iParam0]._fU184 )};
        l_U99 = GET_TEXTURE( l_U98, ref uVar3 );
        DRAW_SPRITE( g_U2245[13], 0.49800000, l_U74, l_U157, l_U158, 0.00000000, 255, 255, 255, 255 );
        DRAW_SPRITE( g_U2245[12], 0.49800000, l_U74 + (sub_47379( iParam0 )), l_U157, l_U158, 0.00000000, 255, 255, 255, 255 );
        if (GET_IS_WIDESCREEN())
        {
        ...
        sub_33248( 0.49800000, l_U74, l_U157, l_U158 );
        sub_47763( ref g_U2273[iParam0]._fU16, ref g_U2273[iParam0]._fU0, 0.49800000, l_U75, l_U163 );
    }
    return;
}

void sub_45251(unknown uParam0)
{
    char[32] Result;
...
float sub_47379(unknown uParam0)
{
    if (g_U2273[uParam0]._fU224 < 10)
    {
        return g_U2273[uParam0]._fU224 * 0.00300000;
    }
    else
    {
        return g_U2273[uParam0]._fU224 * -0.00300000;
...
void sub_47763(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    unknown uVar9;
    float fVar10;

    fVar10 = 0.26200000;
    sub_23178( 0.26200000, 0.40000000, 0.26240000, 0.40000000, 1.00000000 );
    if (GET_CURRENT_LANGUAGE() == 6)
    {
        sub_23178( 0.23580000, 0.36000000, 0.23610000, 0.36000000, 1.00000000 );
    }
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
...
void sub_48288(int iParam0, unknown uParam1)
{
    unknown uVar4;
    unknown uVar5;
    unknown uVar6;
    ...
    uVar5 = {sub_45251( g_U2273[iParam0]._fU184 )};
    l_U99 = GET_TEXTURE( l_U98, ref uVar5 );
    DRAW_SPRITE( g_U2245[13], l_U155, l_U156, l_U157, l_U158, 0.00000000, 255, 255, 255, 255 );
    DRAW_SPRITE( g_U2245[12], l_U155, l_U156 + (sub_47379( iParam0 )), l_U157, l_U158, 0.00000000, 255, 255, 255, 255 );
    ...
    sub_33248( l_U155, l_U156, l_U157, l_U158 );
    l_U119 = 1;
    (array(ref array(ref array(ref array(ref array(ref array(ref uVar13, 5)->_fU4, 5)->_fU24, 5)->_fU24, 5)->_fU24, 5)->_fU24, 5)) + 24;
    array(ref uVar13, 5);
    fVar45 = 0.00000000;
    sub_23454( "PC_CSW_TT0", l_U287, 0.28000000 + fVar45, 2, 1065353216 );
    sub_49008( ref g_U2273[iParam0]._fU16, ref g_U2273[iParam0]._fU0, l_U287, 0.36000000 + fVar45, 0 );
    sub_23454( "PC_CSW_TT1", l_U287, 0.42000000 + fVar45, 2, 1065353216 );
    if ((VMAG( g_U2273[iParam0]._fU60[0]._fU16 )) == 0)
    {
        if (GET_CURRENT_LANGUAGE() == 5)
        {
            sub_23454( ref g_U2273[iParam0]._fU32._fU0, l_U287, 0.48000000 + fVar45, 1, 0.70000000 );
        }
        else
        {
            sub_23454( ref g_U2273[iParam0]._fU32._fU0, l_U287, 0.48000000 + fVar45, 1, 1065353216 );
        }
    }
    else if (GET_CURRENT_LANGUAGE() == 5)
    {
        sub_23454( ref g_U2273[iParam0]._fU60[0]._fU0, l_U287, 0.48000000 + fVar45, 1, 0.70000000 );
    }
    else
    {
        sub_23454( ref g_U2273[iParam0]._fU60[0]._fU0, l_U287, 0.48000000 + fVar45, 1, 1065353216 );
    }
    if (NOT (COMPARE_STRING( ref g_U2273[iParam0]._fU148, "NULL" )))
    {
        sub_23454( "PC_CSW_TT3", l_U287, 0.56000000 + fVar45, 2, 1065353216 );
        sub_49598( ref g_U2273[iParam0]._fU148, l_U287, 0.62000000 + fVar45, 0, l_U287, 0.54000000 );
    }
    if (g_U2273[iParam0]._fU180)
    {
        SET_TEXT_WRAP( 0.10000000, 1.00000000 );
        SET_TEXT_COLOUR( 255, 0, 0, 255 );
        SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
        sub_23178( 0.60000000, 0.60000000, 0.60000000, 0.60000000, l_U48 );
        sub_43742( "PC_UB_DEAD", l_U155, l_U205 );
    }
    if (g_U2273[iParam0]._fU188)
    {
        SET_TEXT_WRAP( 0.10000000, 1.00000000 );
        SET_TEXT_COLOUR( 255, 0, 0, 255 );
        SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
        sub_23178( 0.60000000, 0.60000000, 0.60000000, 0.60000000, l_U48 );
        sub_43742( "PC_JAIL", l_U155, l_U205 );
    }
    if (g_U2273[iParam0]._fU192)
    {
        sub_23178( 0.60000000, 0.60000000, 0.60000000, 0.60000000, l_U48 );
        SET_TEXT_WRAP( 0.10000000, 1.00000000 );
        SET_TEXT_COLOUR( 255, 0, 0, 255 );
        SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
        sub_43742( "PC_MISSING", l_U155, l_U205 );
    }
    sub_47763( ref g_U2273[iParam0]._fU16, ref g_U2273[iParam0]._fU0, l_U155, l_U160, l_U163 );
    if (((VMAG( g_U2273[iParam0]._fU32._fU16 )) > 0.00000000) || ((VMAG( g_U2273[iParam0]._fU60[0]._fU16 )) > 0.00000000))
    {
        if (iParam0 != g_U8083)
        {
            sub_23921( "", "PC_LCA", "PC_UB_KEB", "PC_UB_MMDP", 5, 0, 1 );
        }
        else
        {
            sub_23921( "", "PC_LCA", "PC_UB_KEB", "PC_UB_MMDP", 5, 1, 1 );
        }
    }
    else
    {
...
void sub_49008(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    sub_23178( 0.60000000, 0.80000000, 0.60000000, 0.80000000, l_U48 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
...
void sub_49598(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    sub_23178( 0.60000000, 0.80000000, 0.60000000, 0.80000000, l_U48 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
...
void sub_50452(int iParam0, boolean bParam1)
{
    unknown uVar4;

    if ((VMAG( g_U2273[iParam0]._fU32._fU16 )) == 0.00000000)
    {
        l_U715 = 1;
    }
    else if ((VMAG( g_U2273[iParam0]._fU60[0]._fU16 )) == 0.00000000)
    {
        l_U715 = 0;
    }
    if ((IS_CONTROL_PRESSED( 2, 77 )) AND (NOT l_U496))
    {
        if ((iParam0 != g_U8083) AND (NOT g_U2273[iParam0]._fU208))
        {
            if ((l_U715 == 0) AND ((VMAG( g_U2273[iParam0]._fU32._fU16 )) > 1.00000000))
            {
                if (NOT (sub_50674( ref g_U2273[iParam0]._fU16, ref g_U2273[iParam0]._fU0 )))
                {
                    ...
                    else if (IS_THREAD_ACTIVE( l_U658 ))
                    {
                        if ((VMAG( g_U2273[iParam0]._fU32._fU16 )) > 0.00000000)
                        {
                            if (g_U8083 != iParam0)
                            {
                                ...
                                if ((NOT sub_51134()) AND (NOT sub_51166()))
                                {
                                    DISPLAY_RADAR( 0 );
                                }
                                sub_50910( iParam0 );
            ...
            else if (NOT (sub_50674( ref g_U2273[iParam0]._fU16, ref g_U2273[iParam0]._fU0 )))
            {
                if (NOT (IS_THREAD_ACTIVE( l_U659 )))
                {
                    if ((VMAG( g_U2273[iParam0]._fU60[0]._fU16 )) > 0.00000000)
                    {
                        PLAY_SOUND_FRONTEND( -1, "POLICE_COMPUTER_FORWARDS" );
                        sub_51443( iParam0 );
                    }
        ...
        if (NOT (sub_50674( ref g_U2273[iParam0]._fU16, ref g_U2273[iParam0]._fU0 )))
        {
            if (sub_51810( iParam0 ))
            {
                if ((NOT g_U10978) AND (sub_27338()))
                {
                    sub_1662();
                    CLEAR_HELP();
                    REQUEST_SCRIPT( "mostWanted" );
...
int sub_50674(unknown uParam0, unknown uParam1)
{
    int iVar4;

    iVar4 = sub_50687( uParam0, uParam1 );
    if (iVar4 != -1)
    {
        return g_U2273[iVar4]._fU180;
    }
    return 0;
}

int sub_50687(unknown uParam0, unknown uParam1)
{
    int Result;
...
void sub_50910(unknown uParam0)
{
    REQUEST_SCRIPT( "pdbHomeMgr" );
...
void sub_51443(unknown uParam0)
{
    REQUEST_SCRIPT( "pdbHangoutMgr" );
...
void sub_51810(unknown uParam0)
{
    return g_U2273[uParam0]._fU228;
}

void sub_52333(unknown uParam0, unknown uParam1)
{
    int I;
    unknown uVar5;
    float fVar6;
    ...
    GET_SCRIPT_RENDERTARGET_RENDER_ID( ref l_U129 );
    sub_21527();
    sub_23454( "PC_MRS_TT0", l_U287, 0.28000000 + fVar6, 2, 1065353216 );
    for ( I = 0; I <= 4; I++ )
    {
        if ((uParam0^)[I] > -1)
        {
            sub_52474( ref g_U2273[(uParam0^)[I]]._fU0, l_U287, 0.35000000 + (0.06000000 * I), 0 );
            sub_52474( ref g_U2273[(uParam0^)[I]]._fU16, 0.50000000, 0.35000000 + (0.06000000 * I), 0 );
        }
    }
    switch (uParam1)
    {
        case 0:
        DRAW_SPRITE( g_U2245[1], l_U288, 0.39400000 + (fVar7 * uParam1), l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
        break;
        case 1:
        DRAW_SPRITE( g_U2245[1], l_U288, 0.39400000 + (fVar7 * uParam1), l_U150, l_U151, 0.00000000, 255, 255, 255, 255 );
        break;
    ...
    sub_23921( "", "PC_UB_MWA", "PC_UB_MWB", "PC_UB_MWDP", 4, 0, 0 );
    return;
}

void sub_52474(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    sub_23178( 0.40000000, 0.60000000, 0.40000000, 0.80000000, l_U48 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
    switch (uParam3)
    {
...
void sub_53787()
{
    GET_SCRIPT_RENDERTARGET_RENDER_ID( ref l_U129 );
    sub_21527();
    sub_27540( "PC_SR_FAIL", l_U161, l_U162, 2, 1 );
    return;
}
...
void sub_54325()
{
    ...
    switch (l_U494)
    {
        ...
        if (NOT g_U8086)
        {
            ...
            else if (NOT g_U2273[uVar2]._fU180)
            {
                l_U489 = 5;
            }
            else
...
void sub_54657(unknown uParam0)
{
    float fVar3;
    int I;
    int iVar5;
    ...
    GET_SCRIPT_RENDERTARGET_RENDER_ID( ref l_U129 );
    sub_21527();
    sub_56415( "PC_MW_TT0", 0.32900000, 0.24000000 );
    sub_56415( "PC_MW_TT1", 0.67100000, 0.24000000 );
    ...
    for ( I = 0; I <= 9; I++ )
    {
        ...
        if (iVar5 > -1)
        {
            sub_57441( iVar5, I, uParam0 );
            l_U49._fU0 = l_U163._fU0;
            fVar3 += GET_STRING_WIDTH( ref g_U2273[iVar5]._fU16 );
            fVar3 += GET_STRING_WIDTH( "KYB_M" );
            fVar3 += GET_STRING_WIDTH( ref g_U2273[iVar5]._fU0 );
            sub_57751( ref g_U2273[iVar5]._fU16, ref g_U2273[iVar5]._fU0, 0.32900000, (0.29500000 + l_U199._fU4) + (I * l_U199._fU8), iVar5, I, uParam0, l_U163, fVar3 );
            sub_57441( iVar5, I, uParam0 );
            uVar8 = GET_STRING_WIDTH( ref g_U2273[iVar5]._fU148 );
            fVar9 = uVar8 / 2;
            fVar3 = 0.00000000;
            DISPLAY_TEXT( 0.67100000 - fVar9, (0.29500000 + l_U202._fU4) + (I * l_U202._fU8), ref g_U2273[iVar5]._fU148 );
        }
        else
        {
...
void sub_54681()
{
    ...
    for ( I = 0; I <= (sub_44917() - 1); I++ )
    {
        ...
        {
            g_U2273[I]._fU148 = {sub_54814( g_U2273[I]._fU196 )};
        }
    }
    for ( I = 0; I <= (sub_44917() - 1); I++ )
    {
        if ((((g_U2273[I]._fU196 < 2000) AND (NOT g_U2273[I]._fU208)) AND (sub_55829( uVar8, I ))) AND (NOT (g_U2273[I]._fU216 == 1)))
        {
...
void sub_54814(unknown uParam0)
{
    unknown Result;
    unknown uVar4;
    unknown uVar5;
    ...
    Result = {sub_54825( uParam0 )};
    return Result;
}

void sub_54825(unknown uParam0)
{
    char[32] Result;
...
int sub_55829(int iParam0, unknown uParam1)
{
    if ((iParam0 == 0) || (iParam0 == 1))
    {
        if ((g_U2273[uParam1]._fU220 == 0) || (g_U2273[uParam1]._fU220 == 1))
        {
            return 1;
        }
    }
...
int sub_56152(int iParam0)
{
    ...
    {
        if (((g_U2273[Result]._fU196 == iParam0) AND (NOT g_U2273[Result]._fU212)) AND (sub_55829( uVar7, Result )))
        {
...
void sub_56415(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;
    float fVar6;
    ...
    if (GET_CURRENT_LANGUAGE() == 5)
    {
        sub_23178( 0.40000000, 0.60000000, 0.60000000, 0.70000000, l_U48 );
    }
    else
    {
        sub_23178( 0.60000000, 0.80000000, 1.00000000, 1.00000000, l_U48 );
    }
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
    SET_TEXT_WRAP( 0.10000000, 0.90000000 );
    SET_TEXT_COLOUR( 243, 193, 34, 255 );
...
void sub_57441(unknown uParam0, int iParam1, int iParam2)
{
    sub_23178( 0.40000000, 0.40000000, 0.40000000, 0.40000000, 1.00000000 );
    SET_TEXT_WRAP( 0.00000000, 1.00000000 );
    SET_TEXT_DROPSHADOW( 0, 0, 0, 0, 255 );
    if (NOT g_U2273[uParam0]._fU180)
    {
        if (iParam1 == iParam2)
        {
...
void sub_57751(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    unknown uVar13;
    float fVar14;

    sub_57441( uParam4, uParam5, uParam6 );
    fVar14 = uParam10 / 2;
    DISPLAY_TEXT_WITH_TWO_STRINGS( uParam2 - fVar14, uParam3, "PC_PD_NAMES", uParam0, uParam1 );
    return;
}

void sub_58213(int iParam0, unknown uParam1)
{
    unknown uVar4;
    unknown uVar5;
    unknown uVar6;
    ...
    if (NOT l_U119)
    {
        ...
        l_U99 = GET_TEXTURE( l_U98, ref uVar5 );
        DRAW_SPRITE( g_U2245[13], l_U155, l_U156, l_U157, l_U158, 0.00000000, 255, 255, 255, 255 );
        DRAW_SPRITE( g_U2245[12], l_U155, l_U156, l_U157, l_U158, 0.00000000, 255, 255, 255, 255 );
        DRAW_SPRITE( l_U99, l_U155, l_U156, l_U157, l_U158, 0.00000000, 255, 255, 255, 255 );
        sub_33248( l_U155, l_U156, l_U157, l_U158 );
        l_U119 = 1;
    }
    fVar14 = 0.00000000;
    sub_23454( "PC_CSW_TT0", l_U287, 0.28000000 + fVar14, 2, 1065353216 );
    sub_49008( ref g_U2273[iParam0]._fU16, ref g_U2273[iParam0]._fU0, l_U287, 0.36000000 + fVar14, 0 );
    sub_23454( "PC_CSW_TT1", l_U287, 0.42000000 + fVar14, 2, 1065353216 );
    if ((VMAG( g_U2273[iParam0]._fU60[0]._fU16 )) == 0)
    {
        if (GET_CURRENT_LANGUAGE() == 5)
        {
            sub_23454( ref g_U2273[iParam0]._fU32._fU0, l_U287, 0.48000000 + fVar14, 0, 0.70000000 );
        }
        else if (IS_JAPANESE_VERSION())
        {
            SET_TEXT_SCALE( 0.50000000, 0.50000000 );
            sub_23454( ref g_U2273[iParam0]._fU32._fU0, l_U287, 0.47000000 + fVar14, 0, 1065353216 );
        }
        else
        {
            sub_23454( ref g_U2273[iParam0]._fU32._fU0, l_U287, 0.48000000 + fVar14, 0, 1065353216 );
        }
    }
    else if (GET_CURRENT_LANGUAGE() == 5)
    {
        sub_23454( ref g_U2273[iParam0]._fU60[0]._fU0, l_U287, 0.48000000 + fVar14, 0, 0.70000000 );
    }
    else if (IS_JAPANESE_VERSION())
    {
        SET_TEXT_SCALE( 0.50000000, 0.50000000 );
        sub_23454( ref g_U2273[iParam0]._fU60[0]._fU0, l_U287, 0.47000000 + fVar14, 0, 1065353216 );
    }
    else
    {
        sub_23454( ref g_U2273[iParam0]._fU60[0]._fU0, l_U287, 0.48000000 + fVar14, 0, 1065353216 );
    };;;
    if (NOT (COMPARE_STRING( ref g_U2273[iParam0]._fU148, "NULL" )))
    {
        sub_23454( "PC_CSW_TT3", l_U287, 0.56000000 + fVar14, 2, 1065353216 );
        sub_49598( ref g_U2273[iParam0]._fU148, l_U287, 0.62000000 + fVar14, 0, l_U287, 0.54000000 );
    }
    if (g_U2273[iParam0]._fU180)
    {
        sub_23178( 0.60000000, 0.60000000, 0.60000000, 0.60000000, l_U48 );
    ...
    if (((VMAG( g_U2273[iParam0]._fU32._fU16 )) > 0.00000000) || ((VMAG( g_U2273[iParam0]._fU60[0]._fU16 )) > 0.00000000))
    {
        if (iParam0 != g_U8083)
        {
            sub_23921( "", "PC_LCA", "PC_UB_KEB", "PC_UB_MWDP", 5, 0, 1 );
        }
        else
        {
            sub_23921( "", "PC_LCA", "PC_UB_KEB", "PC_UB_MWDP", 5, 1, 1 );
        }
    }
    else
    {
...
void sub_60481()
{
    GET_SCRIPT_RENDERTARGET_RENDER_ID( ref l_U129 );
    sub_21527();
    sub_27540( "PC_FBIFAIL1", l_U161, l_U162, 2, 1 );
    sub_23921( "", "", "PC_UB_MWB", "", 1, 0, 0 );
    return;
}
