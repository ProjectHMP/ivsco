...
void sub_791()
{
    ...
    CREATE_PICKUP_ROTATE( 833537224, 2, 0, -0.71000000, 566.87000000, 205.16000000, -90.00000000, 0.00000000, 0.00000000, ref l_U6[17] );
...
int sub_3730(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_3739() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_3739() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_3739() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_3852())
                    {
...
void sub_6107()
{
    if (NOT (IS_CHAR_INJURED( sub_196() )))
    {
        if (((((g_U2692[0]._fU56) AND ((g_U2692[0]._fU4 == 3) || (g_U2692[0]._fU4 == 5))) || (IS_CHAR_IN_ANY_HELI( sub_196() ))) AND (NOT ARE_WIDESCREEN_BORDERS_ACTIVE())) AND (IS_HUD_PREFERENCE_SWITCHED_ON()))
        {
