...
void sub_591()
{
    ...
    if (NOT l_U12)
    {
        for ( I = 0; I <= 1; I++ )
        {
            ...
            if ((NOT (IS_CHAR_DEAD( l_U3[I] ))) AND (IS_VEH_DRIVEABLE( l_U0[I] )))
            {
...
void sub_806()
{
    ...
    for ( I = 0; I <= 1; I++ )
    {
        if (NOT g_U8646[I])
        {
            ...
            {
                if ((NOT (IS_CHAR_DEAD( l_U3[I] ))) AND (NOT (IS_CHAR_DEAD( l_U6[I] ))))
                {
                    if (LOCATE_CHAR_IN_CAR_3D( l_U3[I], l_U9._fU0, l_U9._fU4, l_U9._fU8, l_U13[I], l_U13[I], 4.00000000, 0 ))
                    {
                        ...
                        {
                            REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U16[I] );
                        }
                        g_U8646[I] = 1;
                    }
                }
...
void sub_1081()
{
    ...
    for ( I = 0; I <= 1; I++ )
    {
        if ((IS_PLAYER_PLAYING( sub_24() )) AND (NOT (IS_CHAR_DEAD( l_U3[I] ))))
        {
        ...
        if ((IS_PLAYER_PLAYING( sub_24() )) AND (NOT (IS_CHAR_DEAD( l_U6[I] ))))
        {
...
void sub_1387()
{
    if (g_U8646[0])
    {
        sub_1427( l_U3[0], l_U0[0], ref l_U20[0], 1 );
        sub_1427( l_U6[0], l_U0[0], ref l_U20[1], 0 );
    }
    if (g_U8646[1])
    {
        sub_1427( l_U3[1], l_U0[1], ref l_U20[2], 1 );
        sub_1427( l_U6[1], l_U0[1], ref l_U20[3], 0 );
    }
    return;
}

void sub_1427(unknown uParam0, unknown uParam1, unknown uParam2, boolean bParam3)
{
    int iVar6;
    unknown uVar7;
    unknown uVar8;
