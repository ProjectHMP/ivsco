...
void sub_14275()
{
    ...
    {
        if (((sub_14313( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_22321()
{
    ...
    {
        iVar3 = sub_22349( 13 );
        if ((sub_22394( 13, iVar3 )) AND (g_U9932[g_U9999[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_22349( 11 );
        if ((sub_22394( 11, iVar3 )) AND (g_U9932[g_U10090[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_22827( I );
        if ((sub_22394( g_U10324[I]._fU12, iVar3 )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
...
void sub_23364()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((sub_22827( I )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
int sub_31741()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_14313( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_14599( I );
            return 1;
        }
...
int sub_39147()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((fVar3 < 0.01000000) AND (sub_39222( 1, 1 )))
    {
        if (NOT l_U113)
        {
...
int sub_39585()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if (((IS_CHAR_IN_ANY_CAR( sub_1592() )) AND (sub_39222( 1, 1 ))) AND (IS_PLAYER_PRESSING_HORN( sub_3642() )))
    {
        if (l_U113)
        {
            return 0;
...
void sub_46201()
{
    ...
    sub_46529( iVar3[30], -437.20600000, 463.31500000, 11.30600000, 273.22870000, -451.98680000, 469.22640000, 14.42270000, -12.98044000, 0.00000000, -130.48930000 );
        ...
        for ( I = 0; I < 5; I++ )
        {
            if (l_U337 == -1)
            {
                if (sub_52273( I ))
                {
                    ...
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_1592(), l_U401[I]._fU4._fU0, l_U401[I]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar7 )) AND (NOT (sub_38124( sub_1592() ))))
                    {
...
int sub_70161(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (l_U325 == 12)
    {
        ...
        if ((sub_80141( iParam1, l_U359 )) || (TIMERA() > 7000))
        {
            l_U325++;
        }
    }
...
int sub_86036(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 5; Result++ )
    {
        ...
        if ((sub_86108( Result )) AND (NOT (sub_86171( iVar4 ))))
        {
            iVar5 = g_U10324[iVar4]._fU28 == g_U9937;
            fVar6 = l_U401[Result]._fU4._fU8;
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_1592(), l_U401[Result]._fU4._fU0, l_U401[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_38124( sub_1592() ))))
            {
...
int sub_86522(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_86581( Result ))
        {
            ...
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_1592(), l_U489[Result]._fU4._fU0, l_U489[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_38124( sub_1592() ))))
            {
                if (sub_86379( uParam0 ))
                {
                    return Result;
...
int sub_98565(unknown uParam0)
{
    ...
    if ((((sub_98655( uParam0, "Bada_room1" )) || (sub_98655( uParam0, "Bada-Private" ))) || (sub_98655( uParam0, "Bada_room2" ))) || (sub_98655( uParam0, "Bada_room1" )))
    {
        return 1;
    }
    if ((((sub_98655( uParam0, "clammainroom" )) || (sub_98655( uParam0, "clampalbkrm" ))) || (sub_98655( uParam0, "clamfronrm" ))) || (sub_98655( uParam0, "clammainroom" )))
    {
        return 1;
    }
    return 0;
...
void sub_99599(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if ((sub_99655( ref l_U147 )) || ((sub_87294( l_U147 )) > 5))
                {
                    bVar5 = true;
                }
            }
...
void sub_100260()
{
    ...
    if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_1592() )) AND (NOT (sub_38124( sub_1592() ))))
    {
        sub_3209( "MF10AUD" );
        sub_3328( 0, sub_1592(), "NIKO", 0 );
