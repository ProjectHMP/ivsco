void main()
{
    ...
    {
        WAIT( 0 );
        if ((NOT g_U2692[l_U21]._fU56) || (IS_CHAR_INJURED( g_U2692[l_U21]._fU0 )))
        {
            sub_257();
        }
        if (NOT (IS_CHAR_INJURED( g_U2692[l_U21]._fU0 )))
        {
            if ((g_U2692[l_U21]._fU4 != 0) AND (g_U2692[l_U21]._fU4 != 1))
            {
        ...
        if (((sub_665()) AND (g_U2692[l_U21]._fU56)) AND (NOT g_U2692[l_U21]._fU68))
        {
            ...
            if (NOT (IS_CHAR_INJURED( g_U2692[l_U21]._fU0 )))
            {
                ...
                switch (g_U2692[l_U21]._fU4)
                {
                    ...
                    break;
                    case 1:
                    if ((NOT (IS_CHAR_IN_ANY_CAR( g_U2692[l_U21]._fU0 ))) AND (l_U37 == 0))
                    {
                    ...
                    break;
                    case 5:
                    if ((NOT (IS_CHAR_INJURED( g_U2692[l_U21]._fU0 ))) AND (NOT (IS_CHAR_INJURED( sub_2126() ))))
                    {
                        if (g_U2692[l_U21]._fU8 == 2)
                        {
                            GET_CHAR_COORDINATES( sub_2126(), ref g_U2692[l_U21]._fU12._fU0, ref g_U2692[l_U21]._fU12._fU4, ref g_U2692[l_U21]._fU12._fU8 );
                    ...
                    else if ((((NOT (IS_CHAR_PLAYING_ANIM( g_U2692[l_U21]._fU0, "PARACHUTE", "Land" ))) AND (NOT (IS_CHAR_PLAYING_ANIM( g_U2692[l_U21]._fU0, "PARACHUTE", "Land_Safe" )))) AND (NOT (IS_CHAR_PLAYING_ANIM( g_U2692[l_U21]._fU0, "PARACHUTE", "Land_Fast" )))) AND (NOT (IS_PED_RAGDOLL( g_U2692[l_U21]._fU0 ))))
                    {
                        sub_257();
                    }
                    break;
...
void sub_2213()
{
    ...
    if ((NOT (IS_CHAR_INJURED( g_U2692[l_U21]._fU0 ))) AND (g_U2692[l_U21]._fU12._fU0 != 0.00000000))
    {
        fVar2 = 0.00000000;
        ...
        if (uVar6._fU8 < -1.00000000)
        {
            if (NOT g_U2692[l_U21]._fU64)
            {
                ...
                if ((fVar9 < 0.20000000) || (fVar13 < 100.00000000))
                {
        ...
        if ((fVar2 < 10.00000000) AND (uVar6._fU8 > -5.00000000))
        {
...
void sub_3620(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((NOT (IS_CHAR_INJURED( g_U2692[l_U21]._fU0 ))) AND (g_U2692[l_U21]._fU4 == 3))
    {
...
void sub_5140()
{
    ...
    if ((NOT (IS_CHAR_INJURED( g_U2692[l_U21]._fU0 ))) AND (g_U2692[l_U21]._fU12._fU0 != 0.00000000))
    {
        ...
        GET_CHAR_VELOCITY( g_U2692[l_U21]._fU0, ref uVar6._fU0, ref uVar6._fU4, ref uVar6._fU8 );
        GET_CHAR_HEIGHT_ABOVE_GROUND( g_U2692[l_U21]._fU0, ref fVar2 );
        if ((IS_CHAR_IN_WATER( g_U2692[l_U21]._fU0 )) || (uVar3._fU8 < 0.00000000))
        {
            if (DOES_OBJECT_EXIST( l_U20 ))
            {
        ...
        else if (l_U27)
        {
            ...
            else
            {
                ...
                if (((iVar20 - l_U24) > 2000) || (uVar6._fU8 < -1.00000000))
                {
                    l_U27 = 0;
                }
            }
        }
        if ((fVar2 < 1.20000000) || (((uVar6._fU8 > -1.00000000) AND ((ABSF( uVar6._fU8 - l_U29 )) > 3.00000000)) AND (NOT l_U27)))
        {
            if (DOES_OBJECT_EXIST( l_U20 ))
            {
                DETACH_OBJECT( l_U20, 1 );
