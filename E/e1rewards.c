...
int sub_469()
{
    ...
    uVar2 = sub_499( -1731.25000000, 337.08360000, 24.44400000, 26.48870000 );
    uVar3 = sub_759( -1743.99000000, 328.27220000, 24.44400000, 58.73580000 );
    uVar4 = sub_1019( -1735.50400000, 333.68910000, 24.44400000, 323.18800000 );
    if (((uVar2) AND (uVar3)) AND (uVar4))
    {
        return 1;
    }
    return 0;
...
int sub_1412()
{
    ...
    uVar3 = sub_759( -1952.68300000, -81.35660000, 5.66350000, 226.19880000 );
