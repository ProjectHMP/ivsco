void main()
{
    ...
    l_U241 = {-1013.01500000, 681.12100000, 2.81050000};
...
void sub_3196()
{
    switch (l_U196)
    {
        ...
        while (((NOT (HAS_MODEL_LOADED( l_U260 ))) || (NOT (HAVE_ANIMS_LOADED( "misseddie1" )))) || (NOT (HAVE_ANIMS_LOADED( "move_m@eddie" ))))
        {
            WAIT( 0 );
        }
        l_U196 = 1;
...
void sub_3888()
{
    if ((IS_CHAR_INJURED( l_U220 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U220, sub_1561(), 0 )))
    {
        if (IS_HINT_RUNNING())
        {
            HINT_CAM( -1.00000000, -1.00000000, -1.00000000, l_U220, 0, 0, 0 );
    ...
    if ((sub_4054() < 25) AND (IS_CHAR_ON_FOOT( sub_1561() )))
    {
    ...
    {
        case 0:
        if ((((IS_CHAR_INJURED( l_U220 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U220, sub_1561(), 0 ))) || (IS_CHAR_ON_FIRE( l_U220 ))) || (IS_WANTED_LEVEL_GREATER( sub_1255(), 0 )))
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U220 )))
        {
            if ((sub_4054() < 18) AND (IS_CHAR_ON_FOOT( sub_1561() )))
            {
                if ((NOT IS_HINT_RUNNING()) AND (NOT l_U297))
                {
...
void sub_8689()
{
    if ((IS_CHAR_INJURED( l_U220 )) || (IS_CHAR_DEAD( l_U220 )))
    {
    ...
    else if ((NOT (IS_CHAR_SWIMMING( l_U220 ))) AND (DOES_OBJECT_EXIST( l_U295[0] )))
    {
            ...
            if (NOT (IS_GROUP_MEMBER( l_U220, sub_6187() )))
            {
                ...
                if (DOES_BLIP_EXIST( l_U223 ))
                {
                    if (sub_4054() < 12.00000000)
                    {
                        ...
                        if (NOT (IS_CHAR_INJURED( l_U220 )))
                        {
                            if ((NOT (IS_CHAR_INJURED( sub_1561() ))) AND (NOT (IS_CHAR_IN_ANY_CAR( sub_1561() ))))
                            {
                                if (NOT l_U312)
                                {
    ...
    switch (l_U200)
    {
        ...
        if ((DOES_VEHICLE_EXIST( l_U221 )) AND (NOT (IS_VEH_DRIVEABLE( l_U221 ))))
        {
        ...
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_1255(), 0 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U220 )))
            {
                ...
                {
                    if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1561(), l_U241._fU0, l_U241._fU4, l_U241._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U220, l_U241._fU0, l_U241._fU4, l_U241._fU8 + 2.50000000, 10.00000000, 10.00000000, 10.00000000, 0 ))) AND (sub_5195( 1, 1 )))
                    {
                        SET_PLAYER_CONTROL( sub_1255(), 0 );
                            ...
                            if (IS_VEH_DRIVEABLE( l_U221 ))
                            {
                                ...
                                if (NOT (IS_CAR_UPSIDEDOWN( l_U221 )))
                                {
                                    ...
                                    if (NOT l_U204)
                                    {
                                        ...
                                        SET_CAM_POS( l_U303, -975.08000000, 645.71000000, 0.10000000 );
        ...
        if (NOT l_U218)
        {
            ...
            else if ((NOT (IS_CHAR_INJURED( l_U220 ))) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U220 ))))
            {
                DELETE_OBJECT( ref l_U295[0] );
                ...
                if (l_U311 > 0.71200000)
                {
                    if (NOT l_U314)
                    {
                        if (DOES_OBJECT_EXIST( l_U295[0] ))
                        {
                            ...
                            l_U321 = {sub_19216( l_U318, -985.41000000, 653.80000000, 3.93000000 )};
        ...
        if (NOT (IS_CHAR_INJURED( l_U220 )))
        {
            if (IS_GROUP_MEMBER( l_U220, sub_6187() ))
            {
                if (((LOCATE_CHAR_ANY_MEANS_3D( sub_1561(), l_U238._fU0, l_U238._fU4, l_U238._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U220, l_U238._fU0, l_U238._fU4, l_U238._fU8 + 2.50000000, 10.00000000, 10.00000000, 10.00000000, 0 ))) AND (sub_5195( 1, 1 )))
                {
                    SET_PLAYER_CONTROL( sub_1255(), 0 );
                    if (IS_CHAR_IN_ANY_CAR( sub_1561() ))
                    {
                        if ((IS_VEH_DRIVEABLE( l_U221 )) AND (NOT (IS_CAR_UPSIDEDOWN( l_U221 ))))
                        {
                            if (DOES_BLIP_EXIST( l_U224 ))
                            {
                                sub_1334( ref l_U269, 0 );
                                ...
                                if (NOT l_U204)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        SET_CAM_ROT( l_U302, 3.71000000, -0.00000000, -81.62000000 );
                                ...
                                if ((IS_VEH_DRIVEABLE( l_U221 )) AND (NOT (IS_CHAR_INJURED( l_U220 ))))
                                {
        ...
        else if (((sub_23659( l_U281 )) == 0) AND (NOT l_U315))
        {
            if (NOT (IS_CHAR_INJURED( sub_1561() )))
            {
                if (NOT (IS_CHAR_INJURED( l_U220 )))
        ...
        if ((((LOCATE_CHAR_ANY_MEANS_3D( l_U220, l_U247._fU0, l_U247._fU4, l_U247._fU8 + 1.00000000, 1.00000000, 1.00000000, 1.00000000, 0 )) || (l_U217 == 1)) || (NOT (IS_CHAR_ON_SCREEN( l_U220 )))) || (TIMERB() > 9000))
        {
            if (DOES_CHAR_EXIST( l_U220 ))
            {
                DELETE_CHAR( ref l_U220 );
...
int sub_15088(unknown uParam0)
{
    ...
    if ((fVar3 < 2.50000000) || (IS_CHAR_STOPPED( uParam0 )))
    {
        return 1;
    }
    return 0;
...
int sub_15673(unknown uParam0)
{
    ...
    {
        if ((((((((((((((IS_CAR_MODEL( uParam0, 1911513875 )) || (IS_CAR_MODEL( uParam0, 2053223216 ))) || (IS_CAR_MODEL( uParam0, 850991848 ))) || (IS_CAR_MODEL( uParam0, -713569950 ))) || (IS_CAR_MODEL( uParam0, 1938952078 ))) || (IS_CAR_MODEL( uParam0, 1353720154 ))) || (IS_CAR_MODEL( uParam0, 904750859 ))) || (IS_CAR_MODEL( uParam0, 569305213 ))) || (IS_CAR_MODEL( uParam0, -2137348917 ))) || (IS_CAR_MODEL( uParam0, -1900572838 ))) || (IS_CAR_MODEL( uParam0, -845979911 ))) || (IS_CAR_MODEL( uParam0, 1747439474 ))) || (IS_CAR_MODEL( uParam0, 1917016601 ))) || (IS_CAR_MODEL( uParam0, -1099960214 )))
        {
            return 1;
        }
    }
...
void sub_17578()
{
    if (((TIMERA() >= 2000) AND (sub_17598())) AND (IS_SCREEN_FADED_IN()))
    {
        DO_SCREEN_FADE_OUT( 250 );
        while (NOT IS_SCREEN_FADED_OUT())
        {
        ...
        if ((NOT (IS_CHAR_INJURED( sub_1561() ))) AND (NOT (IS_CHAR_INJURED( l_U220 ))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_1561() ))
            {
