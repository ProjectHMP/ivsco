...
void sub_1631()
{
    if (DOES_BLIP_EXIST( l_U6 ))
    {
        if ((((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "hi_lo_cards" )) < 1) || (NOT g_U26737._fU4)) || (NOT g_U10460))
        {
            sub_479();
            return;
        }
...
void sub_1753()
{
    if (DOES_BLIP_EXIST( l_U7 ))
    {
        if ((((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "arm_wrestling" )) < 1) || (NOT g_U26737._fU4)) || (NOT g_U10460))
        {
            sub_530();
        }
        return;
...
void sub_1844()
{
    if (DOES_BLIP_EXIST( l_U8 ))
    {
        if ((((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "pool_table" )) < 1) || (NOT g_U26737._fU4)) || (NOT g_U10460))
        {
            sub_581();
        }
        return;
