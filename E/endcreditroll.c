...
void sub_1053(unknown uParam0)
{
    ...
    {
        case 0:
        if ((l_U576 >= 1.50000000) || (IS_SCREEN_FADED_OUT()))
        {
            sub_1178();
            l_U484[iVar3] = 1;
        }
...
void sub_1384(unknown uParam0)
{
    ...
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -600.66850000, 100.91250000, 184.07600000 );
    SET_CAM_ROT( l_U597[iVar3], -13.84863000, 0.00000000, 110.12560000 );
    SET_CAM_FOV( l_U597[iVar3], 50 );
    iVar3++;
    ...
    FORCE_WEATHER_NOW( 0 );
    l_U593 = {-600.66850000, 100.91250000, 184.07600000};
    for ( I = 0; I <= (iVar3 - 1); I++ )
    {
...
void sub_1891(unknown uParam0)
{
    ...
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -44.36544000, -403.81140000, 16.31100000 );
    SET_CAM_ROT( l_U597[iVar3], 10.96661000, -0.00000000, 91.27537000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -111.73510000, -402.86090000, 16.31100000 );
    SET_CAM_ROT( l_U597[iVar3], 9.78717300, 0.00000000, 107.05020000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 25, ref l_U596 );
    SET_CAM_SPLINE_DURATION( l_U596, l_U517[uParam0] );
...
void sub_3332(unknown uParam0)
{
    ...
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], 947.85860000, -401.56690000, 49.00399000 );
    SET_CAM_ROT( l_U597[iVar3], 0.00807600, -0.00000000, 88.62653000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], 802.17970000, -401.56690000, 49.00399000 );
    SET_CAM_ROT( l_U597[iVar3], 0.00807600, -0.00000000, 88.62653000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
...
void sub_4104(unknown uParam0)
{
    ...
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -641.75880000, -799.90480000, 39.87172000 );
    SET_CAM_ROT( l_U597[iVar3], -24.75624000, -0.00000000, -34.75497000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -636.08860000, -791.73250000, 61.44152000 );
    SET_CAM_ROT( l_U597[iVar3], -24.75624000, -0.00000000, -34.75497000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -628.67580000, -781.04930000, 84.63930000 );
    SET_CAM_ROT( l_U597[iVar3], -24.75624000, -0.00000000, -34.75497000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -612.32930000, -757.48970000, 95.82294000 );
...
void sub_4782(unknown uParam0)
{
    ...
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -54.80154000, 1642.39600000, 40.50032000 );
...
void sub_5239(unknown uParam0)
{
    ...
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], 1645.10000000, 638.96890000, 33.36374000 );
    SET_CAM_ROT( l_U597[iVar3], 2.83559500, -0.00000000, -53.01928000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
...
void sub_9047(unknown uParam0)
{
    ...
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -221.81500000, 51.09295000, 21.34130000 );
    SET_CAM_ROT( l_U597[iVar3], -2.45084500, 0.00000000, -77.69350000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -218.20360000, 51.88079000, 107.70200000 );
    SET_CAM_ROT( l_U597[iVar3], -2.45084500, 0.00000000, -77.69350000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 25, ref l_U596 );
...
void sub_9959(unknown uParam0)
{
    ...
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], 952.25380000, 880.01480000, 27.61006000 );
...
void sub_10638(unknown uParam0)
{
    ...
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], 781.08250000, 60.64069000, 10.68758000 );
    SET_CAM_ROT( l_U597[iVar3], -6.52894500, 0.00000000, -146.06070000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], 818.10530000, -56.64117000, 10.68758000 );
    SET_CAM_ROT( l_U597[iVar3], -6.52894500, 0.00000000, -146.06070000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 25, ref l_U596 );
...
void sub_12305(unknown uParam0)
{
    ...
    SET_CAM_ROT( l_U597[iVar3], -1.02262700, -0.00000000, -87.46703000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
...
void sub_13539(unknown uParam0)
{
    ...
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], 926.25850000, 797.46700000, 20.30934000 );
    SET_CAM_ROT( l_U597[iVar3], -1.74071000, -0.00000000, 119.04690000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    ...
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], 926.25850000, 746.95090000, 20.30934000 );
    SET_CAM_ROT( l_U597[iVar3], -1.74071000, -0.00000000, 119.04690000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
...
void sub_14523(unknown uParam0)
{
    ...
    SET_CAM_ROT( l_U597[iVar3], -31.01060000, 0.00000000, -100.27180000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], 741.98110000, 1705.25200000, 69.39276000 );
    SET_CAM_ROT( l_U597[iVar3], -31.01060000, 0.00000000, -100.27180000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 25, ref l_U596 );
...
void sub_15461(unknown uParam0)
{
    ...
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -1341.91500000, 1929.13700000, 24.63358000 );
    SET_CAM_ROT( l_U597[iVar3], -17.47498000, -0.00000000, -131.17520000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
    SET_CAM_POS( l_U597[iVar3], -1207.24200000, 1929.13700000, 24.63358000 );
    SET_CAM_ROT( l_U597[iVar3], -17.47498000, -0.00000000, -131.17520000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 25, ref l_U596 );
...
void sub_16375(unknown uParam0)
{
    ...
    SET_CAM_ROT( l_U597[iVar3], -70.18999000, 0.00000000, -130.68670000 );
    SET_CAM_FOV( l_U597[iVar3], 45 );
    iVar3++;
    CREATE_CAM( 14, ref l_U597[iVar3] );
...
void sub_18169()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_265() )))
    {
        if (NOT (IS_CHAR_IN_ANY_CAR( sub_265() )))
        {
            ...
            SET_CHAR_COORDINATES( sub_265(), -639.60390000, -688.59700000, 6.05100000 );
        }
        else
        {
            SET_CHAR_COLLISION( sub_265(), 1 );
            SET_CHAR_VISIBLE( sub_265(), 1 );
            WARP_CHAR_FROM_CAR_TO_COORD( sub_265(), -639.60390000, -688.59700000, 6.05100000 );
        }
        FREEZE_CHAR_POSITION( sub_265(), 1 );
    }
    ...
    WAIT( 4000 );
    LOAD_SCENE( -639.60390000, -688.59700000, 5.90510000 );
...
void sub_29655()
{
    ...
    {
        if (((sub_29693( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
