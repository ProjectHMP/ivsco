...
void sub_12353()
{
    ...
    if (iVar2 < 1200000)
    {
        ...
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_0" );
        }
    }
    else if ((iVar2 >= 1200000) AND (iVar2 < 3600000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_1" );
        }
    }
    else if ((iVar2 >= 3600000) AND (iVar2 < 10800000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_2" );
        }
    }
    else if ((iVar2 >= 10800000) AND (iVar2 < 18000000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_3" );
        }
    }
    else if ((iVar2 >= 18000000) AND (iVar2 < 25200000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_4" );
        }
    }
    else if ((iVar2 >= 25200000) AND (iVar2 < 36000000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_5" );
        }
    }
    else if ((iVar2 >= 36000000) AND (iVar2 < 46800000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_6" );
        }
    }
    else if ((iVar2 >= 46800000) AND (iVar2 < 61200000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_7" );
        }
    }
    else if ((iVar2 >= 61200000) AND (iVar2 < 75600000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_8" );
        }
    }
    else if ((iVar2 >= 75600000) AND (iVar2 < 86400000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_9" );
        }
    }
    else if ((iVar2 >= 86400000) AND (iVar2 < 108000000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_10" );
        }
    }
    else if ((iVar2 >= 108000000) AND (iVar2 < 122400000))
    {
        if (CAN_THE_STAT_HAVE_STRING( 649 ))
        {
            REGISTER_STRING_FOR_FRONTEND_STAT( 649, "E2Addict_11" );
        }
    }
...
void sub_13193()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_13202() )))
    {
        if ((((IS_CHAR_IN_ANY_CAR( sub_13202() )) AND (NOT (IS_CHAR_ON_ANY_BIKE( sub_13202() )))) AND (NOT (IS_CHAR_IN_ANY_BOAT( sub_13202() )))) AND (NOT (IS_CHAR_IN_ANY_HELI( sub_13202() ))))
        {
            GET_CAR_CHAR_IS_USING( sub_13202(), ref uVar2 );
            sub_13330( uVar2 );
            sub_21859( uVar2 );
            sub_24844( uVar2 );
        }
        else if (IS_CHAR_ON_ANY_BIKE( sub_13202() ))
        {
            GET_CAR_CHAR_IS_USING( sub_13202(), ref uVar2 );
            sub_13330( uVar2 );
            sub_26038( uVar2 );
        }
        else if (IS_CHAR_IN_ANY_BOAT( sub_13202() ))
        {
            GET_CAR_CHAR_IS_USING( sub_13202(), ref uVar2 );
            sub_13330( uVar2 );
            sub_26489( uVar2 );
        }
        else if (IS_CHAR_IN_ANY_HELI( sub_13202() ))
        {
            GET_CAR_CHAR_IS_USING( sub_13202(), ref uVar2 );
            sub_13330( uVar2 );
            sub_26918( uVar2 );
...
void sub_13330(unknown uParam0)
{
    unknown uVar3;
...
void sub_13365(int iParam0)
{
    ...
    else if (iParam0 == -283209848)
    {
        l_U103[2]++;
        l_U142[115] += 5000;
    }
    else if (iParam0 == -891462355)
    {
        l_U103[6]++;
        l_U271[17] += 5000;
    }
    else if (iParam0 == -304802106)
    {
        l_U103[8]++;
        l_U142[116] += 5000;
    }
    else if (iParam0 == -1696146015)
    {
        l_U103[7]++;
        l_U142[117] += 5000;
    }
    ...
    else if (iParam0 == 1147287684)
    {
        l_U103[3]++;
        l_U142[118] += 5000;
    }
    else if (iParam0 == -591610296)
    {
        l_U103[7]++;
        l_U142[119] += 5000;
    }
    else if (iParam0 == 55628203)
    {
        l_U103[6]++;
        l_U271[18] += 5000;
    }
    ...
    else if (iParam0 == 1044954915)
    {
        l_U103[2]++;
        l_U303[6] += 5000;
    }
    else if (iParam0 == 944930284)
    {
        l_U103[5]++;
        l_U292[9] += 5000;
    }
    else if (iParam0 == 1123216662)
    {
        l_U103[8]++;
        l_U142[125] += 5000;
    }
    else if (iParam0 == 1638119866)
    {
        l_U103[7]++;
        l_U142[126] += 5000;
    }
...
void sub_21859(unknown uParam0)
{
    int I;
    unknown uVar4;
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        ...
        if (IS_THIS_MODEL_A_CAR( uVar4 ))
        {
            for ( I = 0; I <= (128 - 1); I++ )
            {
                if (l_U142[I] > l_U142[l_U134])
                {
                    l_U134 = I;
                    l_U138 = I;
                }
            }
            uVar4 = sub_21979( l_U138 );
            if (l_U138 != 0)
            {
...
void sub_24844(unknown uParam0)
{
    int iVar3;
    unknown uVar4;
    int I;
...
void sub_26038(unknown uParam0)
{
    int I;
    unknown uVar4;
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        ...
        if (IS_THIS_MODEL_A_BIKE( uVar4 ))
        {
            for ( I = 0; I <= (20 - 1); I++ )
            {
                if (l_U271[I] > l_U271[l_U135])
                {
                    l_U135 = I;
                    l_U139 = I;
                }
            }
            uVar4 = sub_26156( l_U139 );
            if (l_U139 != 0)
            {
...
void sub_26489(unknown uParam0)
{
    int I;
    unknown uVar4;
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        ...
        if (IS_THIS_MODEL_A_BOAT( uVar4 ))
        {
            for ( I = 0; I <= (10 - 1); I++ )
            {
                if (l_U292[I] > l_U292[l_U136])
                {
                    l_U136 = I;
                    l_U140 = I;
                }
            }
            uVar4 = sub_26607( l_U140 );
            if (l_U140 != 0)
            {
...
void sub_26918(unknown uParam0)
{
    int I;
    unknown uVar4;
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        ...
        if (IS_THIS_MODEL_A_HELI( uVar4 ))
        {
            for ( I = 0; I <= (8 - 1); I++ )
            {
                if (l_U303[I] > l_U303[l_U137])
                {
                    l_U137 = I;
                    l_U141 = I;
                }
            }
            uVar4 = sub_27036( l_U141 );
            if (l_U141 != 0)
            {
