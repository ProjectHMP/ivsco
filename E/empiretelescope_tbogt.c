    ...
    while (true)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_429() ))
        {
            switch (l_U6)
            {
                ...
                if (g_U10935 != 1)
                {
                    if (IS_CHAR_ON_FOOT( sub_749() ))
                    {
                        DRAW_COLOURED_CYLINDER( l_U27._fU0, l_U27._fU4, l_U27._fU8 - 3.50000000, 1.60000000, 1.60000000, 0, 132, 202, 255 );
                        if (LOCATE_CHAR_ANY_MEANS_3D( sub_749(), l_U27._fU0, l_U27._fU4, l_U27._fU8 - 3.50000000, 1.60000000, 1.60000000, 1.60000000, 0 ))
                        {
                            if (sub_906( 2, 0 ))
                            {
                                if (sub_1194( 2, l_U25, 0 ))
                                {
                                    sub_159( 2, "empire_up" );
                                    l_U6 = 1;
                                }
...
int sub_906(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_429() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((IS_PLAYER_CONTROL_ON( sub_429() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_429() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_1002())
                    {
                        if ((GET_OBJECT_PED_IS_HOLDING( sub_749() )) == nil)
                        {
                            if (g_U10534 <= iParam0)
                            {
                                if (g_U10535 == 0)
...
int sub_1098(boolean bParam0, unknown uParam1)
{
    if (bParam0)
    {
        g_U95._fU104 = 1;
...
int sub_1194(unknown uParam0, string sParam1, unknown uParam2)
{
    string sVar5;
    string sVar6;
...
void sub_1899()
{
    ...
    switch (l_U7)
    {
        ...
        if (IS_SCREEN_FADED_OUT())
        {
            SET_CHAR_COORDINATES_DONT_WARP_GANG( sub_749(), l_U32._fU0, l_U32._fU4, l_U32._fU8 );
            SET_CHAR_HEADING( sub_749(), l_U35 );
            if (g_U11058)
            {
                if (NOT (IS_CHAR_INJURED( g_U10996[0]._fU0 )))
                {
                    CLEAR_CHAR_TASKS_IMMEDIATELY( g_U10996[0]._fU0 );
                    GET_OFFSET_FROM_CHAR_IN_WORLD_COORDS( sub_749(), -0.30000000, -1.50000000, -1.00000000, ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
                    SET_CHAR_COORDINATES( g_U10996[0]._fU0, uVar2._fU0, uVar2._fU4, uVar2._fU8 );
                    SET_CHAR_HEADING( g_U10996[0]._fU0, l_U35 );
                }
                if (NOT (IS_CHAR_INJURED( g_U10996[1]._fU0 )))
                {
                    CLEAR_CHAR_TASKS_IMMEDIATELY( g_U10996[1]._fU0 );
                    GET_OFFSET_FROM_CHAR_IN_WORLD_COORDS( sub_749(), 0.30000000, -2.30000000, -1.00000000, ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
                    SET_CHAR_COORDINATES( g_U10996[1]._fU0, uVar2._fU0, uVar2._fU4, uVar2._fU8 );
                    SET_CHAR_HEADING( g_U10996[1]._fU0, l_U35 );
                }
            }
            sub_159( 2, "empire_up" );
            GET_GAME_TIMER( ref l_U13 );
            SET_CAM_BEHIND_PED( sub_749() );
