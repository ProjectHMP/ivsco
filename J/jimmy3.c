void main()
{
    ...
    l_U591 = 59.43250000;
    l_U592 = -1193778389;
    l_U594 = {-1339.39500000, 1275.83300000, 22.37020000};
    l_U597 = 216.49380000;
    l_U598 = -1193778389;
    l_U600 = {-1337.70200000, 1276.19800000, 23.37010000};
    l_U603 = 134.18920000;
    l_U604 = 219393781;
    ...
    while (true)
    {
        ...
        switch (l_U570)
        {
            ...
            else if (sub_14167( sub_4352() ))
            {
                ...
                {
                    if ((l_U695) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_4352(), l_U649, 5.00000000, 5.00000000, 5.00000000, 0 )))
                    {
                        sub_21495();
                    }
                }
...
void sub_1995()
{
    ...
    {
        if (((sub_2033( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
int sub_6572()
{
    if (((IS_SITTING_OBJECT_NEAR( l_U594, 976040367 )) AND (IS_SITTING_OBJECT_NEAR( l_U588, 976040367 ))) AND (IS_SITTING_OBJECT_NEAR( l_U643, 798444530 )))
    {
        if (((NOT (IS_CHAR_DEAD( l_U593 ))) AND (NOT (IS_CHAR_DEAD( l_U587 )))) AND (NOT (IS_CHAR_DEAD( l_U642 ))))
        {
...
int sub_11946()
{
    if ((NOT (IS_CHAR_DEAD( l_U656 ))) || (NOT l_U674))
    {
        if (NOT (IS_CHAR_INJURED( l_U656 )))
        {
            if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U656, sub_4352(), 0 )) || (l_U572 == 4)) || (IS_CHAR_ON_FIRE( l_U656 )))
            {
...
int sub_12090()
{
    if (NOT (IS_CHAR_DEAD( l_U656 )))
    {
        if ((((((((((((((HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 7 )) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 9 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 10 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 11 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 12 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 13 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 14 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 15 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 16 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 17 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 20 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 5 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_WEAPON( l_U656, 4 ))) || (IS_CHAR_ON_FIRE( l_U656 )))
        {
            return 1;
        }
    }
...
int sub_14167(unknown uParam0)
{
    ...
    if ((((((((((iVar3 == (GET_HASH_KEY( "GTAMloRoom01" ))) || (iVar3 == (GET_HASH_KEY( "GTA_MloRoom02" )))) || (iVar3 == (GET_HASH_KEY( "GTAMloRoom02" )))) || (iVar3 == (GET_HASH_KEY( "GTAMloRoom03" )))) || (iVar3 == (GET_HASH_KEY( "GTA_MloRoom03" )))) || (iVar3 == (GET_HASH_KEY( "GTA_MloRoom04" )))) || (iVar3 == (GET_HASH_KEY( "GTAMloRoom04" )))) || (iVar3 == (GET_HASH_KEY( "GTAMloRoom05" )))) || (iVar3 == (GET_HASH_KEY( "GTA_MloRoom06" )))) || (iVar3 == (GET_HASH_KEY( "GTA_MloRoom011" ))))
    {
        if (l_U675 == 0)
        {
            if (l_U680 == 0)
...
int sub_15334(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_3074() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_3074() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_3074() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_15430())
                    {
...
void sub_18369()
{
    ...
    else if (LOCATE_CHAR_ON_FOOT_3D( sub_4352(), vVar2.x, vVar2.y, vVar2.z, 6.00000000, 6.00000000, 3.00000000, 0 ))
    {
        ...
        else if ((IS_CHAR_ARMED( sub_4352(), 7 )) || (IS_CHAR_IN_MELEE_COMBAT( sub_4352() )))
        {
            l_U675 = 1;
        }
    }
...
void sub_20325()
{
    ...
    if (NOT l_U686)
    {
        ...
        {
            if ((NOT (IS_CHAR_INJURED( l_U593 ))) AND (NOT (IS_CHAR_INJURED( l_U599 ))))
            {
                if (NOT l_U695)
                {
                ...
                else if ((NOT (sub_11647( l_U724 ))) || (l_U675))
                {
                    sub_2911( ref l_U724, 1 );
                    l_U686 = 1;
                }
...
void sub_22416()
{
    if (NOT l_U690)
    {
        if (NOT (IS_CHAR_INJURED( l_U593 )))
        {
            ...
            else if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_4352(), l_U593, 2.50000000, 2.50000000, 2.50000000, 0 ))) || (NOT (sub_11647( l_U724 ))))
            {
                l_U690 = 1;
            }
        }
    ...
    if (l_U705 == 0)
    {
        if (IS_CHAR_IN_ANY_CAR( sub_4352() ))
        {
            if (LOCATE_CHAR_ANY_MEANS_3D( sub_4352(), l_U583._fU0, l_U583._fU4, l_U583._fU8, 10.00000000, 10.00000000, 10.00000000, 0 ))
            {
                ...
                if (((((((iVar2 == (GET_HASH_KEY( "GTAMloRoom01" ))) || (iVar2 == (GET_HASH_KEY( "GTA_MloRoom02" )))) || (iVar2 == (GET_HASH_KEY( "GTA_MloRoom03" )))) || (iVar2 == (GET_HASH_KEY( "GTA_MloRoom04" )))) || (iVar2 == (GET_HASH_KEY( "GTAMloRoom04" )))) || (iVar2 == (GET_HASH_KEY( "GTAMloRoom05" )))) || (iVar2 == (GET_HASH_KEY( "GTA_MloRoom011" ))))
                {
                    if (IS_PLAYER_PLAYING( sub_3074() ))
                    {
                        ALTER_WANTED_LEVEL_NO_DROP( sub_3074(), 2 );
