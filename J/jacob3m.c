void main()
{
    ...
    switch (l_U893)
    {
        ...
        l_U663 = 105.52380000;
        l_U664 = 105.52380000;
        l_U744[0] = {1023.12200000, -78.32584000, 28.18781000};
        ...
        l_U644[2] = {1038.33300000, -65.29710000, 32.73540000};
        ...
        l_U779 = {-16.26956000, 0.00000000, 26.28905000};
        ...
        l_U666 = {848.24000000, 575.54000000, 9.19060000};
        l_U663 = 52;
        l_U776 = {860.85410000, 594.81830000, 12.35424000};
        ...
        l_U798[0] = {8.63925000, -0.00000000, -45.26994000};
        ...
        l_U740 = 270.01960000;
        l_U741 = {1600.82800000, 629.10440000, 28.78370000};
        l_U638 = {1610.07100000, 632.45300000, 30.35300000};
        l_U666 = {1610.17200000, 632.46330000, 28.75290000};
        l_U663 = 18.27860000;
        l_U664 = 206.20270000;
        l_U744[0] = {1614.52800000, 624.78300000, 43.71951000};
        ...
        l_U814[3] = {1606.88500000, 629.50770000, 28.72010000};
        ...
        l_U736 = 75.68870000;
        l_U737 = {1574.53100000, 895.74710000, 15.12100000};
        l_U740 = 90.92020000;
        l_U638 = {1572.36000000, 871.57000000, 16.60500000};
        l_U782[0] = {1579.45800000, 877.35670000, 16.04572000};
        l_U798[0] = {0.88612000, -0.00000000, 116.67650000};
        l_U782[1] = {1577.38500000, 877.06590000, 16.08032000};
        l_U798[1] = {0.19765200, 0.00000000, 143.32450000};
        l_U782[2] = {1574.72700000, 952.07920000, 15.47733000};
        l_U798[2] = {15.00752000, -0.00000100, -137.39810000};
        l_U782[3] = {1574.72700000, 952.07920000, 15.47733000};
        l_U798[3] = {15.00752000, -0.00000000, -143.81530000};
        l_U782[4] = {1570.03100000, 899.52850000, 15.19492000};
    ...
    while (true)
    {
        ...
        else if (l_U888)
        {
            ...
            if (l_U860)
            {
                if (((((IS_CHAR_INJURED( l_U713 )) AND (IS_CHAR_INJURED( l_U714 ))) AND (IS_CHAR_INJURED( l_U708[0] ))) AND (IS_CHAR_INJURED( l_U708[1] ))) AND (IS_CHAR_INJURED( l_U708[2] )))
                {
                    sub_17635();
                }
            }
            else if ((((IS_CHAR_INJURED( l_U708[0] )) AND (IS_CHAR_INJURED( l_U708[1] ))) AND (IS_CHAR_INJURED( l_U708[2] ))) AND (IS_CHAR_INJURED( l_U708[3] )))
            {
                sub_17635();
            }
        }
...
void sub_2239()
{
    ...
    {
        if (((sub_2277( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
int sub_11921(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_12152() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_12152() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_12484()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_30024()
{
    ...
    switch (l_U939)
    {
        ...
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_411(), 0 )))
        {
            ...
            if (IS_VEH_DRIVEABLE( l_U706 ))
            {
                if (((((((LOCATE_CAR_3D( l_U706, l_U638._fU0, l_U638._fU4, l_U638._fU8, 4.00000000, 4.00000000, l_U905, 0 )) || (LOCATE_CAR_3D( l_U706, l_U744[0]._fU0, l_U744[0]._fU4, l_U744[0]._fU8, 4.00000000, 4.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U744[1]._fU0, l_U744[1]._fU4, l_U744[1]._fU8, 4.00000000, 4.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U814[0]._fU0, l_U814[0]._fU4, l_U814[0]._fU8, 5.00000000, 5.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U814[1]._fU0, l_U814[1]._fU4, l_U814[1]._fU8, 5.00000000, 5.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U814[2]._fU0, l_U814[2]._fU4, l_U814[2]._fU8, 5.00000000, 5.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U814[3]._fU0, l_U814[3]._fU4, l_U814[3]._fU8, 5.00000000, 5.00000000, l_U905, 0 )))
                {
                    l_U870 = 1;
                }
                else
        ...
        if (NOT l_U864)
        {
            ...
            if (l_U860)
            {
                ...
                if (NOT (IS_CHAR_INJURED( l_U713 )))
                {
                    if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_12152(), l_U713, 150, 150, 0 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_12152(), l_U638._fU0, l_U638._fU4, l_U638._fU8, 100, 100, 100, 0 ))))
                    {
                        if (sub_32997( 1, 1 ))
                        {
                ...
                if (NOT (IS_CHAR_INJURED( l_U714 )))
                {
                    if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_12152(), l_U714, 150, 150, 0 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_12152(), l_U638._fU0, l_U638._fU4, l_U638._fU8, 100, 100, 100, 0 ))))
                    {
                        if (sub_32997( 1, 1 ))
                        {
                            PRINT_NOW( "PRCDRG_01", 7500, 1 );
                ...
                {
                    if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_12152(), l_U708[0], 150, 150, 0 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_12152(), l_U638._fU0, l_U638._fU4, l_U638._fU8, 100, 100, 100, 0 ))))
                    {
                        if (sub_32997( 1, 1 ))
                        {
                            PRINT_NOW( "PRCDRG_01", 7500, 1 );
                ...
                {
                    if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_12152(), l_U708[1], 150, 150, 0 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_12152(), l_U638._fU0, l_U638._fU4, l_U638._fU8, 100, 100, 100, 0 ))))
                    {
                        if (sub_32997( 1, 1 ))
                        {
                            PRINT_NOW( "PRCDRG_01", 7500, 1 );
                ...
                {
                    if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_12152(), l_U708[2], 150, 150, 0 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_12152(), l_U638._fU0, l_U638._fU4, l_U638._fU8, 100, 100, 100, 0 ))))
                    {
                        if (sub_32997( 1, 1 ))
                        {
                            PRINT_NOW( "PRCDRG_01", 7500, 1 );
            ...
            {
                if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_12152(), l_U708[3], 150, 150, 0 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_12152(), l_U638._fU0, l_U638._fU4, l_U638._fU8, 100, 100, 100, 0 ))))
                {
                    if (sub_32997( 1, 1 ))
                    {
                        PRINT_NOW( "PRCDRG_01", 7500, 1 );
        ...
        else if (NOT (IS_WANTED_LEVEL_GREATER( sub_411(), 0 )))
        {
            ...
            if (IS_CHAR_IN_ANY_CAR( sub_12152() ))
            {
                ...
                if (IS_VEH_DRIVEABLE( l_U706 ))
                {
                    if ((((((LOCATE_CAR_3D( l_U706, l_U669._fU0, l_U669._fU4, l_U669._fU8, 4.00000000, 4.00000000, l_U905, 0 )) || (LOCATE_CAR_3D( l_U706, l_U782[0]._fU0, l_U782[0]._fU4, l_U782[0]._fU8, 4.00000000, 4.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U782[1]._fU0, l_U782[1]._fU4, l_U782[1]._fU8, 4.00000000, 4.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U782[2]._fU0, l_U782[2]._fU4, l_U782[2]._fU8, 4.00000000, 4.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U782[3]._fU0, l_U782[3]._fU4, l_U782[3]._fU8, 4.00000000, 4.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U782[4]._fU0, l_U782[4]._fU4, l_U782[4]._fU8, 4.00000000, 4.00000000, l_U905, 0 )))
                    {
                        l_U870 = 1;
                    }
                    else
        ...
        if (l_U880)
        {
            if ((sub_33454()) AND (IS_SCREEN_FADED_IN()))
            {
        ...
        switch (l_U857)
        {
            ...
            if (IS_VEH_DRIVEABLE( l_U706 ))
            {
                if (((((LOCATE_CAR_3D( l_U706, l_U638._fU0, l_U638._fU4, l_U638._fU8, 4.00000000, 4.00000000, l_U905, 0 )) || (LOCATE_CAR_3D( l_U706, l_U782[1]._fU0, l_U782[1]._fU4, l_U782[1]._fU8, 4.00000000, 4.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U782[2]._fU0, l_U782[2]._fU4, l_U782[2]._fU8, 4.00000000, 4.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U782[3]._fU0, l_U782[3]._fU4, l_U782[3]._fU8, 5.00000000, 5.00000000, l_U905, 0 ))) || (LOCATE_CAR_3D( l_U706, l_U782[4]._fU0, l_U782[4]._fU4, l_U782[4]._fU8, 5.00000000, 5.00000000, l_U905, 0 )))
                {
                    l_U870 = 1;
                }
                for ( l_U854 = 0; l_U854 <= l_U852; l_U854++ )
            ...
            if (TIMERA() >= 2000)
            {
                if ((NOT (IS_CHAR_INJURED( l_U713 ))) AND (NOT (IS_CHAR_INJURED( l_U714 ))))
                {
                    SET_CHAR_RELATIONSHIP( l_U713, 5, 0 );
        ...
        if (NOT l_U875)
        {
            if (((IS_VEH_DRIVEABLE( l_U707 )) AND (NOT (IS_CHAR_INJURED( l_U713 )))) AND (NOT (IS_CHAR_INJURED( l_U714 ))))
            {
...
void sub_46689()
{
    switch (l_U940)
    {
        ...
        if (l_U846 < 120000)
        {
            ...
            else if ((l_U846 > 30000) AND (l_U846 <= 60000))
            {
                l_U847 = 30;
            }
            else if ((l_U846 > 60000) AND (l_U846 <= 90000))
            {
                l_U847 = 45;
            }
            else if ((l_U846 > 90000) AND (l_U846 <= 120000))
            {
                l_U848++;
                l_U847 = 0;
            };;;;
        }
        if ((l_U848 == 24) AND (l_U847 < 10))
        {
            PRINT_WITH_NUMBER( ref l_U676[4], l_U847, 7500, 1 );
        }
        else if ((l_U848 == 24) AND (l_U847 >= 10))
        {
            PRINT_WITH_NUMBER( ref l_U676[5], l_U847, 7500, 1 );
        }
        else if ((l_U848 >= 10) AND (l_U847 >= 10))
        {
            ...
            if (l_U866)
            {
                if (NOT (IS_CHAR_INJURED( l_U716 )))
                {
                    if (NOT (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U716, sub_12152(), 0 )))
                    {
                        if (NOT l_U878)
                        {
                            if ((IS_CHAR_ON_SCREEN( l_U716 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_12152(), l_U716, 20, 20, 0 )))
                            {
                                l_U878 = 1;
                            }
                        }
        ...
        else if (l_U866)
        {
            if (NOT (IS_CHAR_DEAD( l_U716 )))
            {
                if (NOT (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U716, sub_12152(), 0 )))
                {
                    ...
                    else if ((NOT (IS_CHAR_ON_SCREEN( l_U716 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_12152(), l_U716, 20, 20, 0 ))))
                    {
                        PRINT_NOW( "PRCDRG_22", 7500, 1 );
                        REMOVE_BLIP( l_U718 );
                        REMOVE_BLIP( l_U719 );
