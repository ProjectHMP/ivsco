...
void sub_1607()
{
    ...
    {
        if (((sub_1645( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_2509()
{
    ...
    SWITCH_ROADS_BACK_TO_ORIGINAL( -48.84150000, 1092.95500000, 0.00000000, -40.25890000, 1158.40000000, 100.00000000 );
    ...
    SWITCH_ROADS_BACK_TO_ORIGINAL( 160.61230000, 1002.84700000, 0.00000000, 165.27580000, 1008.29700000, 100.00000000 );
...
void sub_4384()
{
    ...
    l_U606[1] = {-55.26660000, 1238.47400000, 20.23150000};
    ...
    SWITCH_ROADS_OFF( -48.84150000, 1092.95500000, 0.00000000, -40.25890000, 1158.40000000, 100.00000000 );
...
void sub_7199()
{
    ...
    if (NOT (DOES_VEHICLE_EXIST( l_U824 )))
    {
        ...
        else if ((((sub_8038( 14 )) AND (HAS_MODEL_LOADED( l_U789 ))) AND (HAS_MODEL_LOADED( l_U790 ))) AND (HAS_MODEL_LOADED( l_U791 )))
        {
    ...
    else if (NOT (IS_CAR_DEAD( l_U824 )))
    {
        ...
        if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U824, sub_4746() )) || (iVar2 < 1000))
        {
            sub_11686( 1 );
        }
    }
    if (NOT (IS_CAR_DEAD( l_U825[1] )))
    {
        ...
        if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U825[1], sub_4746() )) || (iVar2 < 1000))
        {
            sub_11686( 1 );
        }
    }
...
void sub_13120()
{
    ...
    else if ((l_U1138 > 0) AND (NOT l_U1140))
    {
        if (sub_13140())
        {
            ...
            if (l_U1140)
            {
                ...
                if (NOT l_U861[0])
                {
                    ...
                    if (NOT (IS_CAR_DEAD( l_U824 )))
                    {
                        if (NOT (IS_CHAR_DEAD( l_U828[4] )))
                        {
                            SET_CAR_COORDINATES( l_U824, -26.40310000, 1277.40100000, 19.86270000 );
...
int sub_15670(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_4746() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_4746() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_16197()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
int sub_21141()
{
    if (((sub_21160( l_U794, l_U824 )) AND (sub_21160( l_U828[5], l_U824 ))) AND (sub_21160( l_U828[4], l_U824 )))
    {
        return 1;
    }
...
int sub_21358()
{
    if ((sub_21160( l_U828[6], l_U825[1] )) AND (sub_21160( l_U828[7], l_U825[1] )))
    {
        return 1;
    }
...
void sub_24280()
{
    ...
    switch (l_U873)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U828[4] )))
        {
            if (NOT (IS_CAR_DEAD( l_U824 )))
            {
                ...
                {
                    if ((LOCATE_CHAR_IN_CAR_3D( l_U828[4], 93.34800000, 1160.55500000, 14.28960000, 10.00000000, 10.00000000, 2.00000000, l_U889 )) || (NOT l_U1046))
                    {
                        if (NOT l_U1121)
                        {
                            if (NOT l_U861[4])
        ...
        if ((sub_25876( l_U828[4], 1, 0 )) || (l_U1125))
        {
            if (NOT l_U861[5])
            {
                if (NOT (IS_CHAR_DEAD( l_U828[5] )))
        ...
        if (((l_U861[9]) AND (l_U861[8])) AND (l_U861[5]))
        {
            l_U861[9] = 0;
            l_U861[8] = 0;
            l_U861[2] = 0;
        ...
        if (NOT sub_27671())
        {
            if (NOT sub_27770())
            {
                ...
                if (NOT (IS_CHAR_DEAD( l_U828[5] )))
                {
                    if (NOT l_U861[5])
                    {
                        if ((sub_25876( l_U828[5], 1, 0 )) || ((l_U1115 - l_U1114) > 60000))
                        {
                            if (NOT (IS_CAR_DEAD( l_U824 )))
                            {
                                OPEN_SEQUENCE_TASK( ref l_U850[5] );
        ...
        if (NOT (IS_CHAR_DEAD( l_U828[4] )))
        {
            if (NOT (IS_CAR_DEAD( l_U824 )))
            {
                ...
                l_U606[9] = {535.85280000, 757.19010000, 20.44910000};
                l_U746 = 10;
                l_U1045 = 0;
                l_U1046 = 1;
                l_U873 = 5;
        ...
        if (l_U788)
        {
            ...
            l_U606[4] = {852.54080000, 615.01810000, 38.10350000};
    ...
    if (l_U873 > 0)
    {
        if (NOT l_U1118)
        {
            if (((((((((sub_27770()) || (sub_27671())) || (sub_32612())) || (sub_32728())) || (sub_32963())) || (sub_33178())) || (sub_33254())) || (sub_33721())) || (sub_33926()))
            {
                if (sub_34102())
                {
                ...
                if (NOT (IS_CAR_DEAD( l_U824 )))
                {
                    if (IS_CHAR_IN_CAR( l_U828[4], l_U824 ))
                    {
                        if (LOCATE_CHAR_IN_CAR_3D( l_U828[4], l_U606[l_U1045]._fU0, l_U606[l_U1045]._fU4, l_U606[l_U1045]._fU8, 10.00000000, 10.00000000, 10.00000000, 0 ))
                        {
                            ...
                            if ((l_U606[l_U1045]._fU0 == -40.07720000) || (l_U606[l_U1045]._fU0 == -55.26660000))
                            {
                                iVar4 = 2;
                            }
                            else
...
int sub_27770()
{
    ...
    if (((NOT (IS_CAR_DEAD( l_U825[1] ))) AND (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U825[1], sub_4746() ))) || (IS_CAR_DEAD( l_U825[1] )))
    {
        l_U1038 = 1;
        return 1;
    }
    else if (((NOT (IS_CAR_DEAD( l_U824 ))) AND (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U824, sub_4746() ))) || (IS_CAR_DEAD( l_U824 )))
    {
        l_U1038 = 1;
        return 1;
    }
                ...
                if (LOCATE_CHAR_IN_CAR_3D( l_U794, 108.44630000, 1139.23700000, 14.55310000, 16.00000000, 15.00000000, 2.00000000, 0 ))
                {
                    ...
                    else
                    {
                        ...
                        if ((l_U1039 - l_U1040) > 200)
                        {
                            ...
                            while ((NOT (HAS_MODEL_LOADED( 1938952078 ))) || (NOT (HAS_MODEL_LOADED( -610224615 ))))
                            {
                                WAIT( 0 );
                            }
...
int sub_33721()
{
    ...
    if (NOT (IS_CHAR_DEAD( l_U794 )))
    {
        if ((((iVar2 == 18) AND (IS_CHAR_SHOOTING( sub_4746() ))) AND (IS_CHAR_ON_SCREEN( l_U794 ))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_4746(), l_U794, 300.00000000, 300.00000000, 300.00000000, 0 )))
        {
            return 1;
        }
        else if (iVar2 != 18)
...
void sub_34395(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_4746() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_34563())) AND (iVar3 != 4))
    {
    ...
    switch (l_U1054)
    {
        ...
        if (l_U756)
        {
            if (LOCATE_CHAR_ANY_MEANS_3D( sub_4746(), 540.57000000, 755.04800000, 20.11370000, 150.00000000, 150.00000000, 3.00000000, 0 ))
            {
                ...
                else if (((((HAS_MODEL_LOADED( -1295524692 )) AND (HAS_MODEL_LOADED( -1174154857 ))) AND (HAS_MODEL_LOADED( l_U793 ))) AND (HAVE_ANIMS_LOADED( "AMB@TOLLBOOTH" ))) AND (REQUEST_AMBIENT_AUDIO_BANK( "SCRIPT_AMBIENT\TOLLBOOTH" )))
                {
                    sub_35367();
                    sub_8191( 7 );
                    l_U1054 = 1;
...
int sub_39024()
{
    if (NOT (IS_CHAR_INJURED( l_U828[6] )))
    {
        if (((IS_CHAR_INJURED( l_U828[7] )) AND (IS_CHAR_INJURED( l_U828[9] ))) AND (IS_CHAR_INJURED( l_U828[8] )))
        {
            return 1;
        }
        if (NOT (IS_VEH_DRIVEABLE( l_U825[1] )))
        ...
        else if (((IS_CHAR_INJURED( l_U828[7] )) AND (NOT (sub_21160( l_U828[9], l_U825[1] )))) AND (NOT (sub_21160( l_U828[8], l_U825[1] ))))
        {
            return 1;
        }
    }
...
int sub_40115(unknown uParam0, boolean bParam1)
{
    ...
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if ((NOT (IS_CHAR_IN_ANY_CAR( (uParam0^) ))) || (bParam1))
        {
            OPEN_SEQUENCE_TASK( ref uVar4 );
            if (bParam1)
            {
...
int sub_42628()
{
    ...
    if (NOT l_U1093)
    {
        if (NOT (IS_CAR_DEAD( l_U824 )))
        {
            if ((((CHECK_STUCK_TIMER( l_U824, 0, 5000 )) || (CHECK_STUCK_TIMER( l_U824, 3, 20000 ))) || (CHECK_STUCK_TIMER( l_U824, 1, 40000 ))) || (NOT (IS_VEH_DRIVEABLE( l_U824 ))))
            {
                if (DOES_CAR_HAVE_STUCK_CAR_CHECK( l_U824 ))
                {
                    REMOVE_STUCK_CAR_CHECK( l_U824 );
    ...
    switch (l_U1086)
    {
        ...
        if (sub_47368( 1, 1 ))
        {
            if (sub_6824())
            {
                ...
                SET_USE_HIGHDOF( 1 );
                if ((LOCATE_CHAR_ANY_MEANS_3D( sub_4746(), 985.23510000, 519.81650000, 21.92920000, 10.00000000, 12.00000000, 3.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_4746(), 985.47170000, 529.37580000, 22.21170000, 10.00000000, 12.00000000, 3.00000000, 0 )))
                {
                    if (IS_CHAR_IN_ANY_CAR( sub_4746() ))
                    {
                ...
                SET_CAM_POS( l_U798[0], 977.06130000, 514.15890000, 26.86534000 );
                ...
                SET_CAM_POS( l_U798[1], 977.06130000, 514.15890000, 26.86534000 );
        ...
        if ((sub_25876( l_U828[4], 1, 0 )) || ((l_U1088 - l_U1087) > 10000))
        {
            CLOSE_GARAGE( "QW2MG2" );
            l_U1086 = 3;
        }
        ...
        if (NOT (IS_CAR_DEAD( l_U825[0] )))
        {
            if (IS_CHAR_IN_CAR( l_U828[0], l_U825[0] ))
            {
                if (LOCATE_CHAR_IN_CAR_3D( l_U828[0], 123.56550000, 1037.23800000, 14.76090000, 11.00000000, 1.00000000, 2.00000000, 0 ))
                {
                    ...
                    SWITCH_ROADS_OFF( 160.61230000, 1002.84700000, 0.00000000, 165.27580000, 1008.29700000, 100.00000000 );
                }
            }
        }
    }
...
void sub_68748()
{
    ...
    {
        STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_4746(), ref uVar2 );
        if ((NOT (IS_CHAR_IN_MODEL( sub_4746(), 837858166 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_4746(), -488123221 ))))
        {
