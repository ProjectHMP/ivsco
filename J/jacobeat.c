...
void sub_14346()
{
    ...
    {
        if (((sub_14384( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_22418()
{
    ...
    {
        iVar3 = sub_22446( 13 );
        if ((sub_22491( 13, iVar3 )) AND (g_U9932[g_U9999[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_22446( 11 );
        if ((sub_22491( 11, iVar3 )) AND (g_U9932[g_U10090[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_22924( I );
        if ((sub_22491( g_U10324[I]._fU12, iVar3 )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
...
void sub_23461()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((sub_22924( I )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
int sub_31829()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_14384( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_14670( I );
            return 1;
        }
...
int sub_39231()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((fVar3 < 0.01000000) AND (sub_39306( 1, 1 )))
    {
        if (NOT l_U113)
        {
...
int sub_39669()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if (((IS_CHAR_IN_ANY_CAR( sub_1574() )) AND (sub_39306( 1, 1 ))) AND (IS_PLAYER_PRESSING_HORN( sub_3714() )))
    {
        if (l_U113)
        {
            return 0;
...
void sub_50225()
{
    ...
    sub_50553( iVar3[30], -437.20600000, 463.31500000, 11.30600000, 273.22870000, -451.98680000, 469.22640000, 14.42270000, -12.98044000, 0.00000000, -130.48930000 );
                ...
                switch (l_U223)
                {
                    ...
                    if (sub_61960( uParam0 ))
                    {
                        ...
                        if (DOES_OBJECT_EXIST( l_U232 ))
                        {
                            if (HAVE_ANIMS_LOADED( l_U235 ))
                            {
                                if ((((((((NOT (IS_PED_RAGDOLL( uParam0 ))) AND (NOT (IS_CHAR_DUCKING( uParam0 )))) AND (NOT (IS_CHAR_PLAYING_ANIM( uParam0, l_U235, l_U236 )))) AND (NOT (IS_CHAR_GESTURING( uParam0 )))) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( uParam0 )))) AND (NOT (sub_63663( uParam0 )))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( uParam0 )))) AND (NOT (IS_SCRIPTED_SPEECH_PLAYING( uParam0 ))))
                                {
                            ...
                            else if ((sub_52107( uParam0 )) || (sub_64169( uParam0 )))
                            {
...
void sub_51868(unknown uParam0)
{
    ...
    if ((NOT (IS_CHAR_INJURED( uParam0 ))) AND (IS_PLAYER_PLAYING( sub_3714() )))
    {
        switch (l_U225)
        {
            case 0:
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    ...
                    if ((((NOT (sub_51992( l_U227[0] ))) AND (NOT (sub_51992( l_U227[1] )))) AND (NOT (sub_51992( l_U227[2] )))) AND (NOT (sub_51992( l_U227[3] ))))
                    {
                        l_U225 = 0;
                        l_U218 = 0.00000000;
                    }
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    if (l_U218 > 1000.00000000)
                    {
                        ...
                        else if ((((NOT (sub_51992( l_U227[0] ))) AND (NOT (sub_51992( l_U227[1] )))) AND (NOT (sub_51992( l_U227[2] )))) AND (NOT (sub_51992( l_U227[3] ))))
                        {
                            l_U225 = 1;
                        }
                    }
...
int sub_52475(unknown uParam0)
{
    if (DOES_VEHICLE_EXIST( uParam0 ))
    {
        if (NOT (IS_CAR_DEAD( uParam0 )))
        {
            ...
            {
                if ((((NOT (sub_52530( uParam0, 0 ))) AND (NOT (sub_52530( uParam0, 1 )))) AND (NOT (sub_52530( uParam0, 2 )))) AND (NOT (sub_52530( uParam0, 3 ))))
                {
                    return 1;
                }
            }
        ...
        for ( I = 0; I < 16; I++ )
        {
            if (l_U337 == -1)
            {
                if (sub_65524( I ))
                {
                    ...
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_1574(), l_U401[I]._fU4._fU0, l_U401[I]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar7 )) AND (NOT (sub_38208( sub_1574() ))))
                    {
...
int sub_78606(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (l_U325 == 12)
    {
        ...
        if ((sub_88586( iParam1, l_U359 )) || (TIMERA() > 7000))
        {
            l_U325++;
        }
    }
...
void sub_89925(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    sub_92933( uParam2 );
    sub_93073();
    if ((NOT (IS_CHAR_DEAD( sub_1574() ))) AND (l_U840._fU8))
    {
        SET_CURRENT_CHAR_WEAPON( sub_1574(), 0, 0 );
    }
...
int sub_99091(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 5; Result++ )
    {
        ...
        if ((sub_99163( Result )) AND (NOT (sub_99226( iVar4 ))))
        {
            iVar5 = g_U10324[iVar4]._fU28 == g_U9937;
            fVar6 = l_U774[Result]._fU4._fU8;
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_1574(), l_U774[Result]._fU4._fU0, l_U774[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_38208( sub_1574() ))))
            {
...
int sub_99577(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_99636( Result ))
        {
            ...
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_1574(), l_U401[Result]._fU4._fU0, l_U401[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_38208( sub_1574() ))))
            {
                if (sub_99434( uParam0 ))
                {
                    return Result;
...
int sub_112077(unknown uParam0)
{
    ...
    if ((((sub_112167( uParam0, "Bada_room1" )) || (sub_112167( uParam0, "Bada-Private" ))) || (sub_112167( uParam0, "Bada_room2" ))) || (sub_112167( uParam0, "Bada_room1" )))
    {
        return 1;
    }
    if ((((sub_112167( uParam0, "clammainroom" )) || (sub_112167( uParam0, "clampalbkrm" ))) || (sub_112167( uParam0, "clamfronrm" ))) || (sub_112167( uParam0, "clammainroom" )))
    {
        return 1;
    }
    return 0;
...
void sub_113111(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if ((sub_113167( ref l_U147 )) || ((sub_67139( l_U147 )) > 5))
                {
                    bVar5 = true;
                }
            }
...
void sub_113772()
{
    ...
    if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_1574() )) AND (NOT (sub_38208( sub_1574() ))))
    {
        sub_3293( "MF10AUD" );
        sub_3412( 0, sub_1574(), "NIKO", 0 );
