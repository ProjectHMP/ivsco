...
void sub_8628()
{
    ...
    {
        if (((sub_8666( 5, g_U572[I] )) == 1) AND (g_U572[I]._fU20))
        {
...
int sub_24189()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if (((sub_8666( 1, g_U572[I] )) != 0) AND (g_U572[I]._fU20))
        {
            sub_8952( I );
            return 1;
        }
...
int sub_26362(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    if (NOT (iParam1 == nil))
    {
        if ((sub_26434()) || (IS_CHAR_INJURED( iParam1 )))
        {
            l_U505 = 1;
            l_U506 = 0;
...
void sub_37307(unknown uParam0, unknown uParam1)
{
    ...
    if ((NOT sub_37368()) || (NOT sub_28560()))
    {
        return;
    }
    sub_30062();
...
{
    if ((NOT (sub_28487( uParam0 ))) || (NOT (HAS_MODEL_LOADED( sub_38070( uParam0 ) ))))
    {
        sub_28526( uParam0 );
...
void sub_38349(vector vParam0, unknown uParam3, unknown uParam4, unknown uParam5, int iParam6, boolean bParam7)
{
    ...
    sub_38383( vParam0 + (vector( 2.00000000, 0.00000000, 0.00000000)), uParam3, uParam4, iParam6 );
...
void sub_38393(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((((((uParam0^) == (sub_16105( 0 ))) || ((uParam0^) == (sub_16105( 1 )))) || ((uParam0^) == (sub_16105( 6 )))) || ((uParam0^) == (sub_16105( 7 )))) || ((uParam0^) == (sub_16105( 13 )))) || ((uParam0^) == (sub_16105( 16 ))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_16105( 15 ))) || ((uParam0^) == (sub_16105( 17 ))))
        {
            Result = 3;
        }
    }
...
void sub_39109(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_16105( 6 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_16105( 7 ) ))))
        {
            sub_39605( iParam0 );
        }
    }
...
{
    return (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 )) AND (NOT (sub_43997( uParam0, uParam1 )));
}
...
void sub_45525(int iParam0, unknown uParam1, int iParam2, int iParam3)
{
    ...
    if (Result)
    {
        ...
        if (iParam3 != 39)
        {
            if ((iParam3 == 38) AND (IS_CHAR_MODEL( iParam0, sub_16105( 0 ) )))
            {
                if (l_U172)
                {
...
void sub_53744()
{
    ...
    sub_54072( iVar3[54], -1378.11200000, 510.59840000, 13.97960000, 95.79300000, -1382.08400000, 528.18770000, 16.99844000, -11.86755000, -0.00000000, -132.35800000 );
...
void sub_56275()
{
    ...
    TASK_FOLLOW_NAV_MESH_AND_SLIDE_TO_COORD( l_U473, -1721.47500000, 337.99800000, 25.34170000, 2, -2, 1.00000000, 89.09280000 );
    if (NOT g_U39169)
    {
...
void sub_56908()
{
    ...
    if (l_U502 == 1)
    {
        ...
        if ((sub_57711()) AND (sub_57794( l_U473 )))
        {
            l_U502++;
        }
    }
...
void sub_69955(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U1178 == 1)
    {
        if (NOT (IS_CHAR_ON_FOOT( sub_2582() )))
        {
            if ((sub_70078( uParam1, 20.00000000 )) || (iVar5 > l_U1208))
            {
                l_U1178++;
            }
            else
...
int sub_75700(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 6; Result++ )
    {
        ...
        if ((sub_75772( Result )) AND (NOT (sub_75835( iVar4 ))))
        {
            iVar5 = g_U11583[iVar4]._fU28 == g_U10999;
            fVar6 = l_U986[Result]._fU4._fU8;
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_2582(), l_U986[Result]._fU4._fU0, l_U986[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_30632( sub_2582() )))) AND (sub_76038( 1, 1 )))
            {
...
int sub_76549(unknown uParam0)
{
    ...
    for ( Result = 0; Result < 16; Result++ )
    {
        if (sub_76608( Result ))
        {
            ...
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_2582(), l_U613[Result]._fU4._fU0, l_U613[Result]._fU4._fU4, fVar6, 2.50000000, 2.50000000, 2.50000000, iVar5 )) AND (NOT (sub_30632( sub_2582() )))) AND (sub_76038( 1, 1 )))
            {
                if (IS_CHAR_ON_FOOT( sub_2582() ))
                {
                    if (sub_70078( uParam0, 1092616192 ))
...
int sub_97000(unknown uParam0)
{
    ...
    if ((((sub_97090( uParam0, "Bada_room1" )) || (sub_97090( uParam0, "Bada-Private" ))) || (sub_97090( uParam0, "Bada_room2" ))) || (sub_97090( uParam0, "Bada_room1" )))
    {
        return 1;
    }
    if ((((sub_97090( uParam0, "clammainroom" )) || (sub_97090( uParam0, "clampalbkrm" ))) || (sub_97090( uParam0, "clamfronrm" ))) || (sub_97090( uParam0, "clammainroom" )))
    {
        return 1;
    }
    return 0;
...
void sub_98326(unknown uParam0)
{
    ...
    if (l_U521._fU12)
    {
        if (g_U18635[l_U416]._fU892._fU40 >= 0)
        {
            ...
            if (NOT l_U521._fU24)
            {
                if ((sub_111916( ref l_U465 )) || ((sub_77381( l_U465 )) > 5))
                {
                    bVar5 = true;
                }
            }
...
void sub_98502(unknown uParam0)
{
    ...
    if ((IS_CHAR_DEAD( sub_2582() )) || (sub_98525( uParam0 )))
    {
        return;
    }
    if ((IS_CHAR_ON_ANY_BIKE( sub_2582() )) || (sub_98766( uParam0 )))
    {
        sub_98906( uParam0 );
        return;
    }
...
int sub_100486(unknown uParam0)
{
    ...
    if (NOT l_U521._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( sub_2582() ))) AND (NOT (sub_98525( uParam0 ))))
        {
            if (IS_CHAR_ON_ANY_BIKE( sub_2582() ))
            {
...
int sub_101370(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if ((NOT g_U18635[uParam0]._fU892._fU28) AND (uParam2))
    {
        ...
        for ( I = 0; I < iVar6; I++ )
        {
            if ((sub_101539( uParam0, I )) AND (NOT (sub_101804( uParam0, I ))))
            {
...
void sub_101493()
{
    ...
    for ( I = 0; I < iVar2; I++ )
    {
        if (((sub_101539( 1, I )) || (sub_101539( 6, I ))) || (sub_101539( 7, I )))
        {
            sub_101631( 1, I );
            sub_101631( 6, I );
            sub_101631( 7, I );
        ...
        if (((sub_101804( 1, I )) || (sub_101804( 6, I ))) || (sub_101804( 7, I )))
        {
            sub_101896( 1, I );
            sub_101896( 6, I );
            sub_101896( 7, I );
