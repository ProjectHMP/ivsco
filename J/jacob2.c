void main()
{
    ...
    while (true)
    {
        ...
        else if (IS_CHAR_INJURED( l_U481 ))
        {
            if (l_U753)
            {
                if ((IS_CHAR_INJURED( l_U482[0] )) AND (IS_CHAR_INJURED( l_U482[1] )))
                {
                    sub_38746();
                    sub_20277();
                }
        ...
        if (NOT (IS_CHAR_DEAD( l_U481 )))
        {
            if ((LOCATE_CHAR_ANY_MEANS_2D( l_U481, 535.97900000, 1540.07700000, 4.50000000, 4.50000000, 0 )) AND (NOT l_U750))
            {
                CLEAR_AREA_OF_CARS( 535.97900000, 1540.07700000, 20.00000000, 20.00000000 );
                l_U750 = 1;
            }
        }
        if (((((NOT l_U745) AND (l_U757)) AND (l_U765)) AND (l_U739)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
        {
        ...
        if (l_U759)
        {
            if (NOT (IS_CHAR_DEAD( l_U481 )))
            {
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U481, sub_2543(), 0 )) AND (NOT l_U777))
                {
            ...
            {
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U482[0], sub_2543(), 0 )) AND (NOT l_U776))
                {
            ...
            {
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U482[1], sub_2543(), 0 )) AND (NOT l_U776))
                {
        ...
        if (NOT (IS_CHAR_DEAD( l_U481 )))
        {
            if ((IS_PED_IN_COMBAT( l_U481 )) AND (NOT l_U740))
            {
                if (NOT (IS_CHAR_DEAD( l_U482[0] )))
                {
        ...
        if ((l_U730) AND (NOT l_U729))
        {
            if ((NOT (sub_40001( l_U733 ))) AND (NOT sub_45252()))
            {
...
void sub_1498()
{
    ...
    {
        if (((sub_1536( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_2452(unknown uParam0)
{
    ...
    {
        if ((DOES_CHAR_EXIST( l_U497[0] )) AND (DOES_CHAR_EXIST( l_U497[1] )))
        {
            if (LOCATE_CHAR_ON_FOOT_3D( sub_2543(), 565.31880000, 1400.81600000, 15.00000000, 3.00000000, 3.00000000, 1.00000000, 0 ))
            {
                if (((NOT l_U763) AND (NOT (IS_CHAR_DEAD( l_U497[1] )))) AND (NOT (IS_CHAR_DEAD( l_U497[0] ))))
                {
            ...
            else if (((l_U763) AND (NOT (IS_CHAR_DEAD( l_U497[1] )))) AND (NOT (IS_CHAR_DEAD( l_U497[0] ))))
            {
                l_U763 = 0;
            }
        }
        ...
        if (DOES_CHAR_EXIST( l_U496 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U496 )))
            {
                ...
                else
                {
                    ...
                    else if (((l_U762) || (NOT l_U826)) AND (LOCATE_CHAR_ON_FOOT_3D( l_U496, 571.73050000, 1401.41900000, 19.60450000, 0.30000000, 0.30000000, 1.00000000, 0 )))
                    {
                        TASK_PLAY_ANIM( l_U496, "piss_loop", "missjacob2", 4.00000000, 1, 0, 0, 0, -1 );
                        if (NOT l_U826)
                        {
...
void sub_6358(unknown uParam0)
{
    ...
    else if (COMPARE_STRING( uParam0, "FEEDBACK" ))
    {
        if (DOES_CHAR_EXIST( l_U495 ))
        {
            ...
            {
                if ((NOT l_U761) AND (NOT (IS_CHAR_DEAD( l_U495 ))))
                {
                    OPEN_SEQUENCE_TASK( ref l_U799 );
            ...
            else if ((l_U761) AND (NOT (IS_CHAR_DEAD( l_U495 ))))
            {
                l_U761 = 0;
            }
        }
...
void sub_7068(unknown uParam0)
{
    ...
    else if (COMPARE_STRING( uParam0, "CREATE" ))
    {
        if (l_U823 < 2)
        {
            if ((CAN_CREATE_RANDOM_CHAR( 1, 0 )) AND (HAS_MODEL_LOADED( 1872110126 )))
            {
    ...
    {
        if ((DOES_CHAR_EXIST( l_U489[0] )) AND (DOES_CHAR_EXIST( l_U489[1] )))
        {
            if (LOCATE_CHAR_ON_FOOT_3D( sub_2543(), 559.00280000, 1401.61000000, 27.10450000, 6.00000000, 6.00000000, 1.00000000, 0 ))
            {
                if (((NOT l_U764) AND (NOT (IS_CHAR_DEAD( l_U489[1] )))) AND (NOT (IS_CHAR_DEAD( l_U489[0] ))))
                {
                    OPEN_SEQUENCE_TASK( ref l_U799 );
                    TASK_PLAY_ANIM( 0, "IDLE_look_L", "missjacob2", 4.00000000, 0, 0, 0, 0, -1 );
            ...
            else if (((l_U764) AND (NOT (IS_CHAR_DEAD( l_U489[1] )))) AND (NOT (IS_CHAR_DEAD( l_U489[0] ))))
            {
                l_U764 = 0;
            }
        }
...
void sub_8199(unknown uParam0)
{
    ...
    else if (COMPARE_STRING( uParam0, "FEEDBACK" ))
    {
        if (NOT (IS_CHAR_DEAD( l_U481 )))
        {
            if ((l_U755) || (LOCATE_CHAR_ANY_MEANS_3D( l_U481, 568.20000000, 1404.05000000, 15.00000000, 1.00000000, 1.00000000, 1.50000000, 0 )))
            {
                if (NOT l_U774)
                {
                    l_U755 = 1;
                    if (l_U780 == 2)
                    {
                        switch (l_U781)
                        {
                            ...
                            break;
                            case 1:
                            if ((NOT (IS_CHAR_INJURED( l_U492 ))) AND (NOT (IS_CHAR_DEAD( l_U481 ))))
                            {
                                CLEAR_CHAR_TASKS( l_U481 );
...
void sub_9299()
{
    if ((l_U583 < 13) AND (l_U583 > l_U717))
    {
        if (NOT (((l_U717 == 2) || (l_U717 == 6)) || (l_U717 == 10)))
        {
...
void sub_11116(unknown uParam0)
{
    ...
    else if (COMPARE_STRING( uParam0, "CREATE" ))
    {
        if (l_U834 < 2)
        {
            if (((HAS_MODEL_LOADED( -1080673049 )) AND (HAS_MODEL_LOADED( -1220737489 ))) AND (HAS_MODEL_LOADED( -1425428163 )))
            {
...
void sub_12403(unknown uParam0)
{
    ...
    else if (COMPARE_STRING( uParam0, "CREATE" ))
    {
        if (l_U772)
        {
            ...
            while ((NOT (HAS_MODEL_LOADED( -713569950 ))) || (NOT (CAN_CREATE_RANDOM_CHAR( 0, 0 ))))
            {
                WAIT( 0 );
            }
        ...
        if (l_U723)
        {
            if (l_U771)
            {
                ...
                switch (l_U722)
                {
                    case 0:
                    sub_11976( "DELETE" );
                    while (((NOT (CAN_CREATE_RANDOM_CHAR( 0, 0 ))) || (NOT (HAS_MODEL_LOADED( -1962071130 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 201 ))))
                    {
                        WAIT( 0 );
                    }
                    sub_13596( 545.09140000, 1450.16900000, 9.93269300, 30.00000000 );
                    TASK_CHAR_SLIDE_TO_COORD( l_U481, 545.40000000, 1464.20000000, 9.36910000, 180, 100 );
                    l_U722++;
                    break;
                    case 1:
                    ...
                    break;
                    case 3:
                    if ((NOT (IS_CHAR_DEAD( l_U481 ))) AND (IS_CHAR_PLAYING_ANIM( l_U481, "missjacob2", "vault_bonnet_Stop" )))
                    {
                        GET_CHAR_ANIM_CURRENT_TIME( l_U481, "missjacob2", "vault_bonnet_Stop", ref fVar3 );
                    }
                    if ((NOT (IS_CHAR_PLAYING_ANIM( l_U481, "missjacob2", "vault_bonnet_Stop" ))) || ((IS_CHAR_PLAYING_ANIM( l_U481, "missjacob2", "vault_bonnet_Stop" )) AND (fVar3 > 0.70000000)))
                    {
...
void sub_15052(unknown uParam0)
{
    ...
    else if (COMPARE_STRING( uParam0, "FEEDBACK" ))
    {
        if (l_U773)
        {
            if (l_U746)
            {
                if ((NOT (IS_CHAR_DEAD( l_U481 ))) AND (IS_CHAR_PLAYING_ANIM( l_U481, "missjacob2", "crates" )))
                {
                    GET_CHAR_ANIM_CURRENT_TIME( l_U481, "missjacob2", "crates", ref fVar34 );
                }
                if ((fVar34 > 0.45000000) AND (NOT l_U747))
                {
                    vVar35 = {-0.40000000, 1.00000000, 0.30000000};
                    vVar38 = {0.00000000, 0.00000000, 0.00000000};
                    for ( l_U798 = 0; l_U798 <= 9; l_U798++ )
                    {
                        if ((l_U798 > 1) AND ((l_U798 mod 2) == 0))
                        {
                            vVar35.x *= 1.20000000;
                            vVar35.y *= 1.20000000;
                            vVar35.z *= 1.20000000;
...
void sub_17211()
{
    ...
    l_U603[1][1] = {543.51240000, 1582.10000000, 100.00000000};
    ...
    l_U603[5][0] = {521.32180000, 1484.16700000, 0.00000000};
    ...
    l_U603[7][0] = {526.77440000, 1464.65900000, 0.00000000};
    ...
    l_U603[12][0] = {556.05160000, 1383.63500000, 0.00000000};
...
void sub_32712()
{
    ...
    if (NOT l_U743)
    {
        if ((IS_KEYBOARD_KEY_JUST_PRESSED( 36 )) AND (NOT l_U766))
        {
    ...
    else if (l_U583 < 6)
    {
        ...
        LOAD_SCENE( 542.61000000, 1488.62000000, 9.70000000 );
        if (NOT (IS_CHAR_DEAD( l_U481 )))
        {
            SET_CHAR_COORDINATES( l_U481, 542.61000000, 1488.62000000, 9.70000000 );
            SET_CHAR_HEADING( l_U481, 180.00000000 );
            l_U583 = 6;
            sub_9145( l_U481, l_U519[l_U583] );
        }
...
void sub_34688()
{
    ...
    while ((NOT bVar2) AND (NOT bVar3))
    {
        ...
        if (((iVar8 >= 1000) AND (sub_34774())) AND (IS_SCREEN_FADED_IN()))
        {
            if (NOT (IS_CHAR_DEAD( l_U481 )))
            {
                CLEAR_CHAR_TASKS_IMMEDIATELY( l_U481 );
        ...
        switch (iVar4)
        {
            ...
            while (((NOT (HAS_MODEL_LOADED( -1222963415 ))) || (NOT (HAS_MODEL_LOADED( 1448755353 )))) || (NOT (HAVE_ANIMS_LOADED( "missjacob2" ))))
            {
                WAIT( 0 );
            }
            if (IS_CHAR_IN_ANY_CAR( sub_2543() ))
            ...
            SET_CAM_FOV( l_U512[1], 37.10003000 );
            ...
            if (TIMERA() > 5500)
            {
                if ((NOT (IS_CHAR_DEAD( l_U481 ))) AND (NOT (IS_CHAR_DEAD( l_U485 ))))
                {
            ...
            {
                if ((LOCATE_CHAR_ON_FOOT_3D( l_U481, 478.60000000, 1564.45000000, 15.22110000, 0.80000000, 0.80000000, 2.00000000, 0 )) AND (NOT bVar9))
                {
...
void sub_39559()
{
    if (NOT (IS_CHAR_DEAD( l_U481 )))
    {
        ...
        {
            if ((IS_CHAR_IN_AREA_2D( sub_2543(), 475.64380000, 1596.43100000, 593.22430000, 1623.19300000, 0 )) || (IS_CHAR_IN_AREA_2D( sub_2543(), 480.48260000, 1545.36900000, 575.14320000, 1482.50400000, 0 )))
            {
                sub_39015( 2 );
            }
        }
        ...
        {
            if (((IS_CHAR_IN_AREA_2D( sub_2543(), 482.00960000, 1440.66300000, 599.88620000, 1469.50300000, 0 )) || (IS_CHAR_IN_AREA_2D( sub_2543(), 480.40600000, 1466.99400000, 507.46340000, 1523.91000000, 0 ))) || (IS_CHAR_IN_AREA_2D( sub_2543(), 573.02590000, 1440.22400000, 598.37510000, 1521.55800000, 0 )))
            {
                sub_39015( 2 );
            }
        }
        ...
        {
            if ((IS_CHAR_IN_AREA_2D( sub_2543(), 519.67490000, 1400.23300000, 524.53530000, 1441.03000000, 0 )) || (IS_CHAR_IN_AREA_2D( sub_2543(), 571.80790000, 1373.40400000, 598.56360000, 1439.17700000, 0 )))
            {
                sub_39015( 2 );
            }
        };;;
...
void sub_39986()
{
    if (NOT (sub_40001( l_U733 )))
    {
        if (l_U739)
        {
            ...
            if (((l_U749) AND (IS_CHAR_IN_AREA_3D( sub_2543(), 522.90000000, 1494.20000000, 12.50000000, 526.70000000, 1504.10000000, 14.80000000, 0 ))) AND (NOT l_U804[1]))
            {
                sub_4944( "LJ2_BOX", ref l_U733, 4, 1 );
                l_U804[1] = 1;
            }
            if ((((l_U780 > 2) AND (l_U583 < 17)) AND (IS_CHAR_IN_AREA_3D( sub_2543(), 556.00000000, 1400.40000000, 10.60000000, 572.80000000, 1405.50000000, 15.00000000, 0 ))) AND (NOT l_U804[2]))
            {
                sub_4944( "LJ2_PUSH", ref l_U733, 4, 1 );
                l_U804[2] = 1;
            }
            if ((l_U758) AND (NOT l_U804[3]))
            {
    ...
    if (NOT (IS_CHAR_DEAD( l_U481 )))
    {
        ...
        if (l_U739)
        {
            if (l_U583 < 12)
            {
                if (NOT l_U723)
                {
                    if (((sub_44575( sub_2543(), l_U481 )) < 20.00000000) || (l_U767))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U481 )))
                        {
                    ...
                    else if (((sub_44575( sub_2543(), l_U481 )) < 30.00000000) || (l_U583 == 4))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U481 )))
                        {
                    ...
                    else if ((NOT (IS_CHAR_INJURED( l_U481 ))) AND (NOT (HAS_CHAR_SPOTTED_CHAR( sub_2543(), l_U481 ))))
                    {
            ...
            else
            {
                ...
                else if ((fVar8 < 2.50000000) || (IS_CHAR_ON_SCREEN( l_U481 )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U481 )))
                    {
                        MODIFY_CHAR_MOVE_STATE( l_U481, 3 );
...
void sub_42794()
{
    ...
    if ((NOT (IS_CHAR_DEAD( l_U481 ))) AND (l_U583 < 20))
    {
        GET_CHAR_COORDINATES( l_U481, ref l_U791._fU0, ref l_U791._fU4, ref l_U791._fU8 );
        ...
        if ((NOT l_U739) AND (NOT l_U727))
        {
            if ((IS_CHAR_INJURED( l_U481 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U481, sub_2543(), 0 )))
            {
                if (NOT l_U728)
                {
                    if (NOT (IS_CHAR_DEAD( l_U481 )))
            ...
            else if (((l_U583 == 0) AND (IS_CHAR_IN_ANY_CAR( sub_2543() ))) AND (l_U778))
            {
                sub_38628( "FP_10", 7500 );
                sub_4944( "LJ2_CHASED", ref l_U733, 4, 1 );
                sub_43215();
            ...
            else if ((IS_PLAYER_TARGETTING_CHAR( sub_16700(), l_U481 )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U481, sub_2543() )))
            {
                sub_38628( "FP_10", 7500 );
                sub_4944( "LJ2_SHOOTD", ref l_U733, 4, 1 );
                sub_43215();
            ...
            else if ((((fVar2 < l_U731) AND (l_U583 < 14)) || (((fVar3 < 1.00000000) AND (l_U583 > 13)) AND (l_U583 < 19))) AND (HAS_CHAR_SPOTTED_CHAR( l_U481, sub_2543() )))
            {
                sub_38628( "FP_10", 7500 );
        ...
        else if ((IS_CHAR_INJURED( l_U481 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U481, sub_2543(), 0 )))
        {
            if (NOT l_U728)
            {
                if (NOT (IS_CHAR_DEAD( l_U481 )))
...
void sub_45315()
{
    switch (l_U835)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U481 )))
        {
            ...
            {
                if (((NOT l_U739) AND (NOT l_U727)) AND (sub_45577( 0 )))
                {
                    GET_CHAR_COORDINATES( sub_2543(), ref l_U791._fU0, ref l_U791._fU4, ref l_U791._fU8 );
                    ...
                    if ((l_U797 < 20.00000000) AND (HAS_CHAR_SPOTTED_CHAR( l_U481, sub_2543() )))
                    {
        ...
        case 2:
        GET_GAME_TIMER( ref l_U798 );
        if ((sub_51087() == 0) AND (l_U798 > (l_U839 + 6000)))
        {
            if (sub_51171())
            {
                sub_4944( "LJ2_2CLOSE", ref l_U733, 4, 1 );
        ...
        else if ((sub_51087() == 4) || (sub_51087() == 3))
        {
            sub_4944( "LJ2_2CLOSE", ref l_U733, 4, 1 );
            sub_43215();
            l_U730 = 1;
...
int sub_47125(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_2543() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_2543() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_47640()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_52207()
{
    ...
    if ((l_U583 == 19) || (l_U583 == 20))
    {
        sub_10110( "CREATE" );
    }
    if (((NOT (IS_CHAR_INJURED( l_U481 ))) AND (NOT (IS_CHAR_INJURED( l_U482[0] )))) AND (NOT (IS_CHAR_INJURED( l_U482[1] ))))
    {
        if ((NOT l_U816) AND (NOT l_U759))
        {
    ...
    if (l_U583 == 20)
    {
        ...
        else if ((NOT l_U775) AND (NOT l_U759))
        {
            sub_53049();
            l_U775 = 1;
        }
        if (l_U775)
        {
            if (NOT l_U759)
            {
                if ((IS_CHAR_IN_AREA_3D( sub_2543(), 562.10000000, 1388.89000000, 29.50000000, 571.95000000, 1395.87000000, 33.00000000, 0 )) || (HAS_CHAR_SPOTTED_CHAR( l_U481, sub_2543() )))
                {
    ...
    else if ((((DOES_CHAR_EXIST( l_U482[0] )) AND (NOT (IS_CHAR_DEAD( l_U482[0] )))) AND (DOES_CHAR_EXIST( l_U482[1] ))) AND (NOT (IS_CHAR_DEAD( l_U482[1] ))))
    {
        if ((NOT (DOES_BLIP_EXIST( l_U507[0] ))) AND (NOT (DOES_BLIP_EXIST( l_U507[1] ))))
        {
            if ((HAS_CHAR_SPOTTED_CHAR( sub_2543(), l_U482[0] )) || ((HAS_CHAR_SPOTTED_CHAR( sub_2543(), l_U482[1] )) AND (NOT l_U759)))
            {
                if (NOT (DOES_BLIP_EXIST( l_U507[0] )))
                {
                    ADD_BLIP_FOR_CHAR( l_U482[0], ref l_U507[0] );
    ...
    if (IS_CHAR_IN_AREA_3D( sub_2543(), 558.10000000, 1389.10000000, 30.00000000, 561.70000000, 1401.30000000, 32.80000000, 0 ))
    {
        ...
        else if (l_U583 == 20)
        {
            if (NOT l_U759)
            {
                if ((NOT (IS_CHAR_DEAD( l_U482[0] ))) AND (NOT (IS_CHAR_DEAD( l_U482[1] ))))
                {
                    if ((NOT (DOES_BLIP_EXIST( l_U507[0] ))) AND (NOT (DOES_BLIP_EXIST( l_U507[1] ))))
                    {
                        if (NOT l_U775)
    ...
    if (DOES_OBJECT_EXIST( l_U814 ))
    {
        ...
        if ((l_U811 < 999.00000000) || (IS_EXPLOSION_IN_AREA( -1, 558.50000000, 1389.50000000, 30.00000000, 562.50000000, 1393.00000000, 33.00000000 )))
        {
            if (NOT (IS_CHAR_DEAD( l_U481 )))
            {
                UNLOCK_RAGDOLL( l_U481, 1 );
            ...
            l_U758 = 1;
            if ((DOES_CHAR_EXIST( l_U482[0] )) AND (NOT (IS_CHAR_DEAD( l_U482[0] ))))
            {
                if (NOT (DOES_BLIP_EXIST( l_U507[0] )))
                {
                    ADD_BLIP_FOR_CHAR( l_U482[0], ref l_U507[0] );
            ...
            if ((DOES_CHAR_EXIST( l_U482[1] )) AND (NOT (IS_CHAR_DEAD( l_U482[1] ))))
            {
                if (NOT (DOES_BLIP_EXIST( l_U507[1] )))
                {
                    ADD_BLIP_FOR_CHAR( l_U482[1], ref l_U507[1] );
            ...
            if ((DOES_CHAR_EXIST( l_U481 )) AND (NOT (IS_CHAR_DEAD( l_U481 ))))
            {
    ...
    if ((((NOT l_U813) AND (l_U812)) AND (DOES_BLIP_EXIST( l_U815 ))) AND (IS_CHAR_IN_AREA_3D( sub_2543(), 558.10000000, 1392.10000000, 30.00000000, 561.70000000, 1396.30000000, 32.00000000, 0 )))
    {
...
void sub_55255()
{
    if ((NOT (IS_CHAR_DEAD( l_U481 ))) AND (l_U739))
    {
        GET_CHAR_COORDINATES( l_U481, ref l_U791._fU0, ref l_U791._fU4, ref l_U791._fU8 );
