void main()
{
    ...
    if (sub_123( iVar14 ))
    {
        sub_374( iVar14, 1, 10, -1, -1, -1 );
        l_U483 = 1;
    }
    else if (sub_1161( iVar14, 10 ))
    {
    ...
    while (true)
    {
        ...
        switch (l_U482)
        {
            ...
            if (sub_1445( iVar14 ))
            {
                if (NOT (IS_CHAR_INJURED( sub_2246() )))
                {
                    if (((((LOCATE_CHAR_ON_FOOT_2D( sub_2246(), 1459.66600000, 27.70450000, 150.00000000, 150.00000000, 0 )) || (LOCATE_CHAR_IN_CAR_2D( sub_2246(), 1459.66600000, 27.70450000, 150.00000000, 150.00000000, 0 ))) || (sub_2367())) || (sub_2421( 0 ))) || (NOT sub_2477()))
                    {
                        GENERATE_RANDOM_INT_IN_RANGE( 0, 2, ref l_U484 );
                        if (sub_2367())
                        {
                            sub_2553();
                            l_U482 = 3;
                        ...
                        {
                            iVar6 = 0;
                            sub_7094( ref l_U485, "LJp3_NSETUP", ref iVar6 );
                            sub_7094( ref l_U485, "LJp3_SORRY", ref iVar6 );
                            sub_7235( ref l_U485, ref iVar6 );
                            sub_7279();
                            l_U482 = 3;
                        };;;
                    }
                    ...
                    {
                        uVar15 = sub_7682( iVar14 );
                        uVar16 = sub_7787( iVar14, 1, uVar15 );
                        iVar6 = 0;
                        sub_7094( ref l_U485, "LJp3_NSETUP", ref iVar6 );
                        if (l_U483)
                        {
                            sub_7094( ref l_U485, "LJp3_RESP", ref iVar6 );
                        }
                        else if (sub_7901( 3 ))
                        {
                            sub_7094( ref l_U485, "LJp3_PACKG", ref iVar6 );
                        }
                        else
                        {
                            sub_7094( ref l_U485, "LJp3_PACKB", ref iVar6 );
                        }
                        StrCopy( ref cVar2, "LJp3_DROP", 16 );
                        ConcatString(ref cVar2, uVar16, 16);
                        sub_7094( ref l_U485, ref cVar2, ref iVar6 );
                        l_U482 = 4;
                        l_U567 = 1;
                    }
                }
            ...
            if (l_U567)
            {
                REQUEST_SCRIPT( "jacob3m" );
                while (NOT (HAS_SCRIPT_LOADED( "jacob3m" )))
                {
                    WAIT( 0 );
                    REQUEST_SCRIPT( "jacob3m" );
                }
                sub_11170( iVar14 );
                START_NEW_SCRIPT( "jacob3m", 8192 );
                MARK_SCRIPT_AS_NO_LONGER_NEEDED( "jacob3m" );
                l_U567 = 0;
                l_U482 = 2;
            }
            break;
...
void sub_374(unknown uParam0, unknown uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
    int I;
    int J;
    unknown uVar10;
...
int sub_1161(unknown uParam0, int iParam1)
{
    int I;
...
void sub_1250(unknown uParam0, unknown uParam1)
{
    return;
}
...
{
    l_U566 = 1;
    if (sub_2595( ref g_U10981[3]._fU92, ref g_U10981[3]._fU76, 0 ))
    {
        while (l_U566)
        {
            WAIT( 0 );
...
int sub_2595(unknown uParam0, unknown uParam1, boolean bParam2)
{
    char[12] cVar5;
    unknown uVar8;
    unknown uVar9;
    ...
    if (NOT (COMPARE_STRING( uParam0, "PLACEHOLDER" )))
    {
        if (bParam2)
        {
            return sub_2703( uVar23, ref cVar5, uParam1, 0, ref uVar14, ref uVar14, "", 0, bParam2, 1, 1, 0, 0, 0 );
        }
        if ((NOT g_U91._fU368) == 1)
        {
            StrCopy( ref g_U91._fU224[0], uParam1, 16 );
            StrCopy( ref g_U91._fU224[1], uParam0, 16 );
            sub_4628( uVar23, ref g_U91._fU176 );
            g_U91._fU368 = 1;
            return 1;
        }
    }
...
int sub_2703(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    int I;
    ...
    if (NOT (IS_PLAYER_PLAYING( sub_2881() )))
    {
        sub_2773( "\n player is not playing" );
        return 0;
    }
    if ((IS_CHAR_IN_ANY_CAR( sub_2246() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_2246() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_3256()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
    ...
    sub_4628( uParam0, ref g_U91._fU176 );
    sub_6009( ref g_U91._fU160 );
...
int sub_3313()
{
    ...
    if (NOT (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_2881() )))
    {
        if (NOT (IS_CHAR_IN_ANY_CAR( sub_2246() )))
        {
            GET_SCRIPT_TASK_STATUS( sub_2246(), 53, ref uVar3 );
            switch (uVar3)
            {
                case 7:
                case 2:
                ...
                break;
                default:
                if (NOT (IS_CHAR_IN_WATER( sub_2246() )))
                {
                    bVar2 = true;
                }
                else
    ...
    if (NOT (IS_PLAYER_SCRIPT_CONTROL_ON( sub_2881() )))
    {
...
void sub_4628(int iParam0, unknown uParam1)
{
    switch (iParam0)
    {
        case 0:
...
void sub_6009(unknown uParam0)
{
    StrCopy( (uParam0^), "NIKO", 16 );
    return;
}

void sub_6249(unknown uParam0, unknown uParam1)
{
    return;
}
...
void sub_7094(unknown uParam0, unknown uParam1, unknown uParam2)
{
    if ((uParam2^) < (uParam0^))
    {
...
void sub_7235(unknown uParam0, unknown uParam1)
{
    if ((uParam1^) < (uParam0^))
    {
...
{
    l_U566 = 1;
    if (sub_7309( ref l_U485, "LJP3AUD", 1 ))
    {
        while (l_U566)
        {
            WAIT( 0 );
...
int sub_7309(unknown uParam0, unknown uParam1, boolean bParam2)
{
    unknown[2] uVar5;
    unknown uVar8;
    unknown uVar9;
    ...
    if (bParam2)
    {
        return sub_2703( uVar14, uParam0, uParam1, 0, ref uVar5, ref uVar5, "", 0, bParam2, 1, 1, 0, 0, 0 );
    }
    if (NOT g_U91._fU368)
    {
        StrCopy( ref g_U91._fU224[0], uParam1, 16 );
        g_U91._fU224[1] = {(uParam0^)[0]};
        sub_4628( uVar14, ref g_U91._fU176 );
        g_U91._fU368 = 1;
        return 1;
    }
    return 0;
...
void sub_7787(unknown uParam0, unknown uParam1, unknown uParam2)
{
...
void sub_8154(unknown uParam0)
{
    ...
    if (NOT g_U13391[uParam0]._fU160._fU80)
    {
        ...
        PRINTINT( uParam0 );
        PRINTNL();
        sub_8306( "Flow_Start_Proc_Subpart: Proc Mission not loaded" );
    }
    sub_8441();
    ...
    sub_9239( uParam0 );
    uVar3 = sub_10712( uParam0, g_U13391[uParam0]._fU160._fU76 );
    sub_10900( uVar3 );
    sub_11021();
    return;
}

void sub_8306(unknown uParam0)
{
...
int sub_8640(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6)
{
    switch (uParam0)
    {
        case 0:
...
void sub_9239(unknown uParam0)
{
    ...
    uVar7 = {sub_9275( ref uVar3, uParam0 )};
    sub_10540( uVar7 );
    return;
}

void sub_9275(unknown uParam0, unknown uParam1)
{
    char[16] Result;
...
void sub_10540(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
...
int sub_10712(int iParam0, int iParam1)
{
    unknown uVar4;
    int iVar5;
    int Result;
    ...
    {
        sub_10786( "Main_Missions: Find_Trigger(): Illegal Strand ID" );
    }
...
void sub_10786(unknown uParam0)
{
    SCRIPT_ASSERT( uParam0 );
    return;
}

void sub_10900(unknown uParam0)
{
    g_U9925 = g_U26758[uParam0]._fU8;
    if (g_U9925 >= 50000)
    {
        g_U9925 = sub_10946( g_U9925 );
    }
    return;
}

void sub_10946(int Result)
{
    if (Result == 50094)
    {
        if (g_U15654[12])
...
void sub_11170(unknown uParam0)
{
    g_U91._fU68 = uParam0;
    return;
}
...
void sub_11287()
{
    ...
    iVar2 = 3;
    iVar3 = 3;
    sub_11317( iVar2, iVar3, "Friend_4" );
    return;
}

void sub_11317(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;

    sub_11332( uParam0, uParam1, uParam2 );
...
void sub_11332(unknown uParam0, unknown uParam1, unknown uParam2)
{
    char[64] cVar5;
    int iVar21;
    int iVar22;
    ...
    iVar22 = -1;
    iVar23 = -1;
    if (sub_12496( uParam0, ref iVar21, ref iVar22, ref iVar23 ))
    {
        sub_12631( iVar21, uParam1, iVar22, iVar23 );
    }
    return;
}

void sub_11476(unknown uParam0)
{
...
void sub_11761(unknown uParam0)
{
    int iVar3;
    int iVar4;
...
void sub_11936(unknown uParam0, int iParam1)
{
...
void sub_12118(boolean bParam0)
{
    float fVar3;
    float fVar4;
    float fVar5;
...
int sub_12496(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    switch (uParam0)
    {
        case 0:
...
void sub_12631(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    int iVar6;

    iVar6 = 7;
    sub_12653( uParam0, uParam1, uParam2, uParam3, iVar6 );
    return;
}

void sub_12653(int iParam0, unknown uParam1, unknown uParam2, int iParam3, unknown uParam4)
{
    int iVar7;
    int iVar8;
...
void sub_12765(unknown uParam0, unknown uParam1)
{
    ...
    ref uVar4._fU0;
    ref uVar4;
    uVar11 = sub_12788( uParam0 );
    sub_13279( uVar11, uParam1, 16383, 16383, ref uVar4 );
    sub_13623( ref uVar4, 1 );
    sub_13651( ref uVar4, 0 );
    sub_13679( ref uVar4, 2 );
    sub_13709( ref uVar4 );
    return;
}

int sub_12788(unknown uParam0)
{
    switch (uParam0)
    {
        case 0: return 0;
    ...
    sub_10786( "Flow_public: Return_Text_Message_From_Contact(): Contact Text Message ID not set up yet" );
    return 99;
}

void sub_13279(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, int iParam4)
{
    iParam4->_fU24 = -1;
    sub_13301( uParam0, 0, iParam4 + 0 );
    sub_13301( uParam1, 1, iParam4 + 0 );
    sub_13301( uParam2, 2, iParam4 + 0 );
    sub_13301( uParam3, 3, iParam4 + 0 );
    sub_13301( 0, 4, iParam4 + 0 );
    sub_13301( 1, 5, iParam4 + 0 );
    sub_13301( -1, 6, iParam4 + 0 );
    ref iParam4->_fU0->_fU20 = 1;
    return;
}

void sub_13301(unknown uParam0, unknown uParam1, int iParam2)
{
    switch (uParam1)
    {
        case 0:
...
void sub_13623(int iParam0, unknown uParam1)
{
    ref iParam0->_fU0->_fU20 = uParam1;
    return;
}

void sub_13651(int iParam0, unknown uParam1)
{
    ref iParam0->_fU0->_fU16 = uParam1;
    return;
}

void sub_13679(int iParam0, unknown uParam1)
{
    sub_13301( uParam1, 5, iParam0 + 0 );
    return;
}

int sub_13709(int iParam0)
{
    int I;
    int iVar4;
    char[16] cVar5;
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (g_U569[I]._fU0[0] == -1)
        {
            ...
            {
                ConcatString(ref cVar5, sub_8640( 0, iParam0->_fU0 ), 16);
...
int sub_13779()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_8640( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_8891( I );
            return 1;
        }
...
int sub_13906(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
    int Result;
    ...
    for ( Result = 0; Result <= (g_U569 - 1); Result++ )
    {
        ...
        {
            if (sub_13971( uParam0, g_U569[Result] ))
            {
                return Result;
            }
        }
...
int sub_13971(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11)
{
    int iVar14;
    int iVar15;
    ...
    {
        iVar14 = sub_8640( 0, uParam0 );
        if (iVar14 == (sub_8640( 0, uParam6 )))
        {
            iVar15 = sub_8640( 3, uParam0 );
            if (iVar15 == (sub_8640( 3, uParam6 )))
            {
                return 1;
            }
        }
...
void sub_14699(unknown uParam0, int iParam1)
{
