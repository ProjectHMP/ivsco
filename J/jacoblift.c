...
void sub_13498()
{
    ...
    {
        if (((sub_13536( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_23015()
{
    ...
    if (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_2514() ))
    {
        ...
        if ((NOT (IS_CHAR_IN_MODEL( sub_2514(), 837858166 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_2514(), -488123221 ))))
        {
...
int sub_25769()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_13536( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_13822( I );
            return 1;
        }
                ...
                switch (l_U223)
                {
                    ...
                    if (sub_38327( uParam0 ))
                    {
                        ...
                        if (DOES_OBJECT_EXIST( l_U232 ))
                        {
                            if (HAVE_ANIMS_LOADED( l_U235 ))
                            {
                                if ((((((((NOT (IS_PED_RAGDOLL( uParam0 ))) AND (NOT (IS_CHAR_DUCKING( uParam0 )))) AND (NOT (IS_CHAR_PLAYING_ANIM( uParam0, l_U235, l_U236 )))) AND (NOT (IS_CHAR_GESTURING( uParam0 )))) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( uParam0 )))) AND (NOT (sub_40284( uParam0 )))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( uParam0 )))) AND (NOT (IS_SCRIPTED_SPEECH_PLAYING( uParam0 ))))
                                {
                            ...
                            else if ((sub_28474( uParam0 )) || (sub_40790( uParam0 )))
                            {
...
void sub_28235(unknown uParam0)
{
    ...
    if ((NOT (IS_CHAR_INJURED( uParam0 ))) AND (IS_PLAYER_PLAYING( sub_2866() )))
    {
        switch (l_U225)
        {
            case 0:
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    ...
                    if ((((NOT (sub_28359( l_U227[0] ))) AND (NOT (sub_28359( l_U227[1] )))) AND (NOT (sub_28359( l_U227[2] )))) AND (NOT (sub_28359( l_U227[3] ))))
                    {
                        l_U225 = 0;
                        l_U218 = 0.00000000;
                    }
            ...
            if (DOES_VEHICLE_EXIST( l_U266 ))
            {
                if (NOT (IS_CAR_DEAD( l_U266 )))
                {
                    if (l_U218 > 1000.00000000)
                    {
                        ...
                        else if ((((NOT (sub_28359( l_U227[0] ))) AND (NOT (sub_28359( l_U227[1] )))) AND (NOT (sub_28359( l_U227[2] )))) AND (NOT (sub_28359( l_U227[3] ))))
                        {
                            l_U225 = 1;
                        }
                    }
...
int sub_28842(unknown uParam0)
{
    if (DOES_VEHICLE_EXIST( uParam0 ))
    {
        if (NOT (IS_CAR_DEAD( uParam0 )))
        {
            ...
            {
                if ((((NOT (sub_28897( uParam0, 0 ))) AND (NOT (sub_28897( uParam0, 1 )))) AND (NOT (sub_28897( uParam0, 2 )))) AND (NOT (sub_28897( uParam0, 3 ))))
                {
                    return 1;
                }
            }
...
int sub_46441()
{
    ...
    fVar3 = 0.00000000;
    GET_CAR_SPEED( uVar2, ref fVar3 );
    if ((fVar3 < 0.01000000) AND (sub_46516( 1, 1 )))
    {
        if (NOT l_U113)
        {
...
int sub_46879()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    bVar3 = false;
    if (((IS_CHAR_IN_ANY_CAR( sub_2514() )) AND (sub_46516( 1, 1 ))) AND (IS_PLAYER_PRESSING_HORN( sub_2866() )))
    {
        if (l_U113)
        {
            return 0;
...
int sub_47483(unknown uParam0, unknown uParam1)
{
    ...
    iVar11 = 0;
    if ((IS_CHAR_IN_ANY_CAR( sub_2514() )) AND (NOT l_U119))
    {
...
int sub_55846(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, boolean bParam5, unknown uParam6)
{
    ...
    if (bVar10)
    {
        ...
        {
            if ((NOT (IS_CHAR_DEAD( sub_2514() ))) AND (NOT (IS_CHAR_DEAD( iParam1 ))))
            {
    ...
    if (l_U325 == 7)
    {
        ...
        else if ((IS_CHAR_DEAD( sub_2514() )) || (IS_CHAR_DEAD( iParam1 )))
        {
            l_U325++;
        }
        else
    ...
    if (l_U325 == 12)
    {
        ...
        if ((sub_67411( iParam1, l_U359 )) || (TIMERA() > 7000))
        {
            l_U325++;
        }
    }
...
void sub_70314(unknown uParam0)
{
    ...
    if (l_U344._fU12)
    {
        if (g_U22274[l_U158]._fU688._fU24 >= 0)
        {
            ...
            if (NOT l_U344._fU24)
            {
                if ((sub_70370( ref l_U147 )) || ((sub_71100( l_U147 )) > 5))
                {
                    bVar5 = true;
                }
            }
...
void sub_70975()
{
    ...
    if ((IS_CHAR_SITTING_IN_ANY_CAR( sub_2514() )) AND (NOT (sub_38943( sub_2514() ))))
    {
        sub_2408( "MF10AUD" );
        sub_2563( 0, sub_2514(), "NIKO", 0 );
...
int sub_72212(unknown uParam0)
{
    ...
    if ((sub_72221()) || (l_U344._fU24))
    {
        return 0;
    }
    if (NOT l_U344._fU8)
    {
        if ((NOT (IS_CHAR_DEAD( sub_2514() ))) AND (NOT (IS_CHAR_DEAD( uParam0 ))))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_2514() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_2514(), ref uVar3 );
