...
void sub_1119()
{
    ...
    l_U380[2] = {-1254.01500000, -289.49990000, 1.92380000};
...
void sub_1487()
{
    ...
    if ((((g_U12303 == 0) AND (NOT (IS_CHAR_DEAD( sub_1543() )))) AND (iVar2 == 0)) AND (iVar3 == 0))
    {
        if (l_U348 == 0)
        {
...
void sub_4446()
{
    if (g_U15728[18] == 0)
    {
        if ((g_U39219 == 50) AND (g_U15728[53] == 1))
        {
            if (l_U357 == 0)
            {
        ...
        if ((g_U39219 >= 40) AND (g_U15728[54] == 1))
        {
            if (l_U356 == 0)
            {
        ...
        if ((g_U39219 >= 30) AND (g_U15728[48] == 1))
        {
            if (l_U355 == 0)
            {
        ...
        if ((g_U39219 >= 20) AND (g_U15728[41] == 1))
        {
            if (l_U354 == 0)
            {
            ...
            if (NOT (IS_CHAR_DEAD( sub_1543() )))
            {
                if (NOT (IS_THREAD_ACTIVE( g_U815 )))
                {
                    if ((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (NOT g_U39103))
                    {
                        ...
                        {
                            if ((g_U39226 == 0) AND (g_U39123 == 1))
                            {
                                PRINT_HELP( "GW_HELP_02" );
                                g_U39226 = 1;
                            }
                            if ((l_U357 == 1) || (l_U368 == 1))
                            {
                                if (g_U39227[4] == 0)
                                {
...
void sub_8617()
{
    ...
    sub_4141();
    SETTIMERA( 0 );
    while ((sub_9884( l_U322 )) AND (TIMERA() < 7000))
    {
        WAIT( 0 );
    }
...
int sub_10515(int iParam0, unknown uParam1, unknown uParam2, boolean bParam3)
{
    ...
    if ((((IS_PLAYER_PLAYING( sub_2001() )) AND (NOT IS_MINIGAME_IN_PROGRESS())) AND (NOT sub_10545())) AND (NOT g_U38758))
    {
