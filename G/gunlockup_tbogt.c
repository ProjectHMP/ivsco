    ...
    while (l_U184)
    {
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U370)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_982() )))
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_982(), -1333.07600000, 308.10840000, 13.62120000, 5.00000000, 5.00000000, 5.00000000, 0 )) || (sub_4137()))
                    {
                        if ((IS_WANTED_LEVEL_GREATER( sub_740(), 0 )) || (g_U43667))
                        {
                            SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( 807349477, l_U197._fU0, l_U197._fU4, l_U197._fU8, 1, 0.00000000 );
                            PRINT_HELP( "GLOCK_WL" );
                            if ((DOES_CHAR_EXIST( l_U121 )) AND (NOT (IS_CHAR_INJURED( l_U121 ))))
                            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_982() )))
                {
                    if ((IS_CHAR_IN_AREA_2D( sub_982(), 1049, 79, 1058, 96, 0 )) || (sub_4137()))
                    {
                        if ((IS_WANTED_LEVEL_GREATER( sub_740(), 0 )) || (g_U43667))
                        {
                            SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( 807349477, l_U197._fU0, l_U197._fU4, l_U197._fU8, 1, 0.00000000 );
                ...
                case 4:
                l_U191 = 0;
                if (((IS_WANTED_LEVEL_GREATER( sub_740(), 0 )) || (g_U43667)) AND (NOT sub_4137()))
                {
                ...
                if (sub_4137())
                {
                    ...
                    if ((NOT l_U466) AND (NOT g_U10704))
                    {
                        if ((DOES_CHAR_EXIST( l_U121 )) AND (NOT (IS_CHAR_INJURED( l_U121 ))))
                        {
                ...
                else if ((((NOT sub_4137()) AND (l_U466)) AND (NOT l_U467)) AND (NOT g_U10704))
                {
                    if ((DOES_CHAR_EXIST( l_U121 )) AND (NOT (IS_CHAR_INJURED( l_U121 ))))
                    {
                ...
                if (sub_4137())
                {
                    ...
                    if ((NOT l_U466) AND (NOT g_U10705))
                    {
                        if ((DOES_CHAR_EXIST( l_U121 )) AND (NOT (IS_CHAR_INJURED( l_U121 ))))
                        {
                            sub_4432( "GS1_GREET2", ref l_U358, 1, 0 );
                ...
                else if ((((NOT sub_4137()) AND (l_U466)) AND (NOT l_U467)) AND (NOT g_U10705))
                {
                    if ((DOES_CHAR_EXIST( l_U121 )) AND (NOT (IS_CHAR_INJURED( l_U121 ))))
                    {
                        sub_4432( "GS1_BYE2", ref l_U358, 1, 0 );
                ...
                {
                    if ((((IS_PLAYER_TARGETTING_CHAR( sub_740(), l_U121 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_740(), l_U121 ))) || (IS_CHAR_SHOOTING_IN_AREA( sub_982(), l_U194._fU0 - 9.39310000, l_U194._fU4 - 1.66650000, l_U194._fU0 + 3.09560000, l_U194._fU4 + 6.77950000, 0 ))) || (IS_PED_RAGDOLL( l_U121 )))
                    {
                        if (NOT l_U471)
                        {
                            ...
                            if ((IS_CHAR_ARMED( sub_982(), 6 )) || (IS_PED_RAGDOLL( l_U121 )))
                            {
                    ...
                    if ((NOT (IS_PLAYER_TARGETTING_CHAR( sub_740(), l_U121 ))) AND (NOT (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_740(), l_U121 ))))
                    {
                        if (l_U471)
                        {
                            if (NOT (IS_CHAR_INJURED( l_U121 )))
                ...
                else if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U121, sub_982(), 0 )) || (IS_WANTED_LEVEL_GREATER( sub_740(), 0 ))) || (g_U43667))
                {
...
void sub_1156()
{
    if (IS_PLAYER_PLAYING( sub_740() ))
    {
        ...
        {
            if ((HAS_CHAR_GOT_WEAPON( sub_982(), l_U214[l_U208]._fU0 )) AND (NOT l_U142[l_U208]))
            {
...
int sub_4137()
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_982() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_982(), l_U194._fU0, l_U194._fU4, l_U194._fU8, 15.00000000, 15.00000000, 15.00000000, 0 )))
    {
        GET_KEY_FOR_CHAR_IN_ROOM( sub_982(), ref iVar2 );
        if ((iVar2 == (GET_HASH_KEY( l_U206 ))) || (iVar2 == (GET_HASH_KEY( "Room_gunlobby" ))))
        {
            return 1;
        }
        else
...
void sub_5446()
{
    ...
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U126[0], -0.35000000, -1.40000000, 0.84000000, ref l_U385[2]._fU0, ref l_U385[2]._fU4, ref l_U385[2]._fU8 );
    ...
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U126[0], -5.00000000, 3.90000000, 0.84000000, ref l_U385[6]._fU0, ref l_U385[6]._fU4, ref l_U385[6]._fU8 );
...
void sub_9576()
{
    switch (l_U371)
    {
        ...
        if (((((((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U458 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GUN_FAIL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FAIL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_BUY" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FULL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FULL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FAIL" )))
        {
            if (TIMERB() > 1500)
            {
                CLEAR_HELP();
        ...
        {
            if ((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_740() )) AND (NOT sub_10075()))
            {
                if (l_U163[l_U207])
                {
                    if (NOT l_U142[l_U207])
                    {
                        if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U454 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U444 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
                        {
                            CLEAR_HELP();
                        }
                    ...
                    else if ((NOT (l_U207 == 11)) AND (NOT (l_U207 == 12)))
                    {
                        if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U450 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U444 )))
                        {
                            CLEAR_HELP();
                        }
                    }
                    if (sub_10209( sub_982() ))
                    {
                        if ((((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U458 ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_BUY" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FULL" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FAIL" ))))
                        {
                            if (NOT (l_U207 == 0))
                            {
                                if (NOT l_U449)
        ...
        {
            if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U450 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U454 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
            {
                CLEAR_HELP();
            }
            if (sub_10209( sub_982() ))
            {
                if (((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_BUY" ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FULL" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FAIL" ))))
                {
                    ...
                    else if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_A1" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U444 )))
                    {
                        CLEAR_HELP();
                    }
                }
        ...
        else
        {
            ...
            if ((((((((((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_H11" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_H1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_WH1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_FAUST" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_A1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_B1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U450 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U454 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U444 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
            {
                CLEAR_HELP();
            }
        }
        ...
        if (NOT (IS_WANTED_LEVEL_GREATER( sub_740(), 0 )))
        {
            ...
            if (((((((IS_CHAR_PLAYING_ANIM( sub_982(), "missgunlockup", "pistol_loop" )) || (IS_CHAR_PLAYING_ANIM( sub_982(), "missgunlockup", "rifle_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_982(), "missgunlockup", "shotgun_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_982(), "missgunlockup", "over_shoulder" ))) || (IS_CHAR_PLAYING_ANIM( sub_982(), "missgunlockup", "grenade_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_982(), "missgunlockup", "uzi_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_982(), "missgunlockup", "rpg_loop" )))
            {
        ...
        if (l_U6)
        {
            if (sub_17435( sub_17214( l_U214[l_U207]._fU0 ) ))
            {
                ...
                SETTIMERB( 0 );
                if ((NOT (IS_CHAR_INJURED( l_U121 ))) AND (NOT (IS_CHAR_INJURED( sub_982() ))))
                {
                    OPEN_SEQUENCE_TASK( ref l_U357 );
                    TASK_TURN_CHAR_TO_FACE_CHAR( 0, sub_982() );
                    TASK_LOOK_AT_CHAR( 0, sub_982(), -2, 1 );
        ...
        break;
        case 10:
        if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U458 )) || ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GUN_FAIL" )) AND (TIMERB() > 3000)))
        {
            CLEAR_HELP();
        }
...
int sub_10271(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_740() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_740() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_740() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_10075())
                    {
...
void sub_24864()
{
    while (((NOT (sub_24908( l_U372[1]._fU0, l_U372[1]._fU4, l_U372[1]._fU8, 2.00000000 ))) || (sub_24908( l_U372[2]._fU0, l_U372[2]._fU4, l_U372[2]._fU8, 2.00000000 ))) || (sub_24908( l_U372[3]._fU0, l_U372[3]._fU4, l_U372[3]._fU8, 2.00000000 )))
    {
        WAIT( 0 );
    }
    if (NOT l_U187)
