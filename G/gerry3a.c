            ...
            switch (l_U497)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_3899() )))
                {
                    switch (l_U498)
                    {
                        ...
                        break;
                        case 6:
                        if ((sub_11481( "www.autoeroticar.com/carProfiles.html" )) AND (sub_11744() > 23))
                        {
                ...
                if ((((sub_11387() == 0) AND (l_U503)) AND (NOT l_U504)) AND (NOT l_U501))
                {
                    CLEAR_HELP();
...
void sub_1305()
{
    ...
    {
        if (((sub_1343( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_2356()
{
    ...
    {
        iVar3 = sub_2384( 13 );
        if ((sub_2429( 13, iVar3 )) AND (g_U9932[g_U9999[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_2384( 11 );
        if ((sub_2429( 11, iVar3 )) AND (g_U9932[g_U10090[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_2908( I );
        if ((sub_2429( g_U10324[I]._fU12, iVar3 )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
...
void sub_3445()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((sub_2908( I )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
int sub_7077(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3899() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3899() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_7604()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
