        ...
        switch (l_U34)
        {
            ...
            if (sub_244())
            {
                ...
                else if (l_U23 == 1)
                {
                    ...
                    else if ((IS_CONTROL_JUST_PRESSED( 2, 115 )) || (IS_BUTTON_JUST_PRESSED( 0, 16 )))
                    {
                        sub_1235( 1 );
                        sub_1474();
                    }
                    else if ((IS_CONTROL_JUST_PRESSED( 2, 116 )) || (IS_BUTTON_JUST_PRESSED( 0, 17 )))
                    {
                        sub_1235( 0 );
                        sub_1474();
                    };;;
            ...
            {
                g_U2674 = 0;
                if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GOLFPRESSLB" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GOLFBUDDIES" )))
                {
                    CLEAR_HELP();
                    l_U23 = 0;
                }
