void main()
{
    ...
    l_U593 = {94.62000000, 30.00000000, 60.00000000};
    l_U853 = 0;
    l_U854 = 0;
    SET_MISSION_FLAG( 1 );
    ...
    l_U684[3] = {-1413.29600000, 601.21780000, 19.55010000};
    ...
    l_U596[3] = {-1436.49700000, 589.52810000, 31.82833000};
    ...
    while (true)
    {
        ...
        if (l_U514)
        {
            if (IS_VEH_DRIVEABLE( l_U761[3] ))
            {
                ...
                if ((NOT (LOCATE_CHAR_ANY_MEANS_CAR_2D( sub_5316(), l_U761[3], 200, 200, 0 ))) AND (NOT (IS_CAR_ON_SCREEN( l_U761[3] ))))
                {
                    if (sub_5619( 1, 1 ))
                    {
        ...
        switch (l_U853)
        {
            ...
            break;
            case 1:
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_5316(), -1411.96600000, 562.10110000, 19.06230000, 200, 200, 200, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_5316(), -1419.70400000, 601.17860000, 19.55340000, 200, 200, 200, 0 )))
            {
                CLEAR_AREA( -1341.94800000, 586.45340000, 11.37050000, 20, 0 );
                l_U853 = 2;
            }
            break;
            case 2:
            ...
            while ((NOT (HAVE_ANIMS_LOADED( "missgambetti3" ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 866 ))))
            {
                WAIT( 0 );
            }
            sub_7081( 1976502708 );
            ...
            TASK_PLAY_ANIM_SECONDARY_UPPER_BODY( 0, "Push_Trolley", "missgambetti3", 1.00000000, 0, 0, 0, 1, -1 );
            TASK_FOLLOW_NAV_MESH_TO_COORD( 0, -1413.29600000, 601.21780000, 19.55010000, 2, -2, 1.50000000 );
            ...
            if ((NOT (IS_CHAR_INJURED( l_U729[12] ))) AND (NOT (IS_CHAR_INJURED( l_U729[13] ))))
            {
                TASK_CHAT_WITH_CHAR( l_U729[12], l_U729[13], 1, 1 );
                TASK_CHAT_WITH_CHAR( l_U729[13], l_U729[12], 0, 1 );
            }
            if ((NOT (IS_CHAR_INJURED( l_U729[7] ))) AND (NOT (IS_CHAR_INJURED( l_U729[8] ))))
            {
                TASK_CHAT_WITH_CHAR( l_U729[7], l_U729[8], 1, 1 );
                TASK_CHAT_WITH_CHAR( l_U729[8], l_U729[7], 0, 1 );
            }
            if ((NOT (IS_CHAR_INJURED( l_U729[15] ))) AND (NOT (IS_CHAR_INJURED( l_U729[6] ))))
            {
            ...
            if ((IS_BULLET_IN_AREA( -1426.01400000, 562.70660000, 19.93000000, 30, 1 )) || (IS_SNIPER_BULLET_IN_AREA( -1426.01400000 - 15, 562.70660000 - 15, 19.93000000 - 15, -1426.01400000 + 15, 562.70660000 + 15, 19.93000000 + 15 )))
            {
                l_U512 = 1;
            }
            if (l_U512)
            ...
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_5316(), -1411.96600000, 562.10110000, 19.06230000, 35, 35, 70, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_5316(), -1419.70400000, 601.17860000, 19.55340000, 43, 43, 70, 0 )))
            {
                if (NOT (sub_13057( sub_5316() )))
                {
                    ...
                    if (((IS_CHAR_SITTING_IN_ANY_CAR( sub_5316() )) || (IS_CHAR_IN_ANY_HELI( sub_5316() ))) || (IS_CHAR_IN_ANY_PLANE( sub_5316() )))
                    {
                        GET_CAR_CHAR_IS_USING( sub_5316(), ref l_U812 );
                        if (DOES_VEHICLE_EXIST( l_U812 ))
                        {
            ...
            if (l_U488)
            {
                if ((sub_13867()) AND (IS_SCREEN_FADED_IN()))
                {
                    DO_SCREEN_FADE_OUT( 500 );
                    while (IS_SCREEN_FADING_OUT())
                    {
            ...
            {
                case 0:
                CLEAR_AREA( -1341.94800000, 586.45340000, 11.37050000, 150, 1 );
                if (l_U513)
                {
                    GET_CAR_CHAR_IS_USING( sub_5316(), ref l_U812 );
                    if (DOES_VEHICLE_EXIST( l_U812 ))
                ...
                if (TIMERA() >= 3000)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U729[1] ))) AND (NOT (IS_CHAR_INJURED( l_U752 ))))
                    {
                ...
                if (TIMERA() >= 9000)
                {
                    if (NOT (IS_CHAR_INJURED( l_U729[14] )))
                    {
                        ...
                        SET_CAM_ROT( l_U813, 0.11857900, -0.00000000, 112.70770000 );
            ...
            if (NOT l_U512)
            {
                if (NOT (IS_CHAR_INJURED( l_U729[14] )))
                {
                    if (((IS_CHAR_TOUCHING_CHAR( sub_5316(), l_U729[14] )) || (IS_BULLET_IN_AREA( -1412.75600000, 621.94560000, 34.99690000, 5, 1 ))) || (IS_SNIPER_BULLET_IN_AREA( -1412.75600000 - 2.50000000, 621.94560000 - 2.50000000, 34.99690000 - 2.50000000, -1412.75600000 + 2.50000000, 621.94560000 + 2.50000000, 34.99690000 + 2.50000000 )))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[14] )))
                        {
                ...
                for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                {
                    if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
                    {
                        if ((LOCATE_CHAR_ANY_MEANS_3D( sub_5316(), l_U596[l_U580]._fU0, l_U596[l_U580]._fU4, l_U596[l_U580]._fU8, 5.00000000, 5.00000000, 2.50000000, 0 )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U729[l_U580], sub_5316() )))
                        {
                            l_U512 = 1;
                        }
                ...
                for ( l_U580 = 1; l_U580 <= 4; l_U580++ )
                {
                    ...
                    {
                        if ((LOCATE_CHAR_ANY_MEANS_3D( sub_5316(), l_U684[l_U580]._fU0, l_U684[l_U580]._fU4, l_U684[l_U580]._fU8, 5.00000000, 5.00000000, 2.50000000, 0 )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U746[l_U580], sub_5316() )))
                        {
                            l_U512 = 1;
                        }
                ...
                if ((((((((((((((((((((((((((((((((((((((((LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1412.64900000, 557.98060000, 5.00000000, 5.00000000, 0 )) || (IS_SNIPER_BULLET_IN_AREA( -1412.64900000 - 5, 557.98060000 - 5, 19.93000000 - 5, -1412.64900000 + 5, 557.98060000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1412.64900000, 557.98060000, 19.93000000, 5, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1425.29100000, 598.50780000, 4.00000000, 4.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1425.29100000 - 5, 598.50780000 - 5, 19.93000000 - 5, -1425.29100000 + 5, 598.50780000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1425.29100000, 598.50780000, 19.93000000, 5, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1422.62600000, 602.55130000, 4.00000000, 4.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1422.62600000 - 5, 602.55130000 - 5, 19.93000000 - 5, -1422.62600000 + 5, 602.55130000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1422.62600000, 602.55130000, 19.93000000, 5, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1419.93600000, 606.70840000, 4.00000000, 4.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1419.93600000 - 5, 606.70840000 - 5, 19.93000000 - 5, -1419.93600000 + 5, 606.70840000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1419.93600000, 606.70840000, 19.93000000, 5, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1414.99900000, 608.52010000, 4.00000000, 4.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1414.99900000 - 5, 608.52010000 - 5, 19.93000000 - 5, -1414.99900000 + 5, 608.52010000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1414.99900000, 608.52010000, 19.93000000, 5, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1412.14200000, 613.85990000, 4.00000000, 4.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1412.14200000 - 5, 613.85990000 - 5, 19.93000000 - 5, -1412.14200000 + 5, 613.85990000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1412.14200000, 613.85990000, 19.93000000, 5, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1409.20300000, 620.18020000, 2.00000000, 2.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1409.20300000 - 5, 620.18020000 - 5, 19.93000000 - 5, -1409.20300000 + 5, 620.18020000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1409.20300000, 620.18020000, 19.93000000, 5, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1435.06400000, 562.79660000, 15.00000000, 15.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1435.06400000 - 15, 562.79660000 - 15, 19.93000000 - 15, -1435.06400000 + 15, 562.79660000 + 15, 19.93000000 + 15 ))) || (IS_BULLET_IN_AREA( -1435.06400000, 562.79660000, 19.93000000, 15, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1436.36500000, 584.92010000, 10.00000000, 10.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1436.36500000 - 10, 584.92010000 - 10, 19.93000000 - 10, -1436.36500000 + 10, 584.92010000 + 10, 19.93000000 + 10 ))) || (IS_BULLET_IN_AREA( -1436.36500000, 584.92010000, 19.93000000, 10, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1429.54600000, 591.19350000, 5.00000000, 5.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1429.54600000 - 5, 591.19350000 - 5, 19.93000000 - 5, -1429.54600000 + 5, 591.19350000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1429.54600000, 591.19350000, 19.93000000, 5, 1 ))) || (LOCATE_CHAR_ANY_MEANS_2D( sub_5316(), -1419.23300000, 601.28660000, 5.00000000, 5.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( -1419.23300000 - 5, 601.28660000 - 5, 19.93000000 - 5, -1419.23300000 + 5, 601.28660000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1429.54600000, 601.28660000, 19.93000000, 5, 1 ))) || (LOCATE_CHAR_IN_CAR_2D( sub_5316(), -1393.76400000, 547.78980000, 5.00000000, 5.00000000, 0 ))) || (IS_PROJECTILE_IN_AREA( -1393.76400000 - 10, 547.78980000 - 10, 10.00000000 - 10, -1393.76400000 + 10, 547.78980000 + 10, 10.00000000 + 10 ))) || (IS_SNIPER_BULLET_IN_AREA( -1393.76400000 - 5, 547.78980000 - 5, 19.93000000 - 5, -1393.76400000 + 5, 547.78980000 + 5, 19.93000000 + 5 ))) || (IS_BULLET_IN_AREA( -1393.76400000, 547.78980000, 19.93000000, 5, 1 ))) || (IS_BULLET_IN_AREA( -1426.01400000, 562.70660000, 19.93000000, 30, 1 ))) || (IS_SNIPER_BULLET_IN_AREA( -1426.01400000 - 15, 562.70660000 - 15, 19.93000000 - 15, -1426.01400000 + 15, 562.70660000 + 15, 19.93000000 + 15 ))) || (IS_CHAR_IN_ANY_HELI( sub_5316() )))
                {
                    l_U512 = 1;
                }
            }
            ...
            if ((NOT l_U542[1]) AND (TIMERA() >= 91320))
            {
                if (NOT (IS_CHAR_INJURED( l_U746[2] )))
                {
            ...
            if ((NOT l_U542[2]) AND (TIMERA() >= 153420))
            {
                if (NOT (IS_CHAR_INJURED( l_U746[3] )))
                {
            ...
            if ((NOT l_U542[3]) AND (TIMERA() >= 326000))
            {
                if (NOT (IS_CHAR_INJURED( l_U746[4] )))
                {
            ...
            else if (NOT l_U529[2])
            {
                if (NOT (IS_CHAR_INJURED( l_U729[0] )))
                {
                    ...
                    if ((l_U596[0]._fU8 < 21) || (TIMERA() >= 60000))
                    {
            ...
            else if (NOT l_U529[3])
            {
                if (NOT (IS_CHAR_INJURED( l_U729[4] )))
                {
                    ...
                    if ((l_U596[4]._fU8 < 21) || (TIMERA() >= 60000))
                    {
            ...
            if (NOT l_U494[0])
            {
                if (((((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U761[0], sub_5316() )) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U761[1], sub_5316() ))) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U761[2], sub_5316() ))) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U761[3], sub_5316() ))) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U761[4], sub_5316() )))
                {
            ...
            {
                if ((NOT (sub_27943( l_U847 ))) AND (TIMERB() > 15400))
                {
                    for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
            ...
            if (NOT l_U494[2])
            {
                if ((NOT (sub_27943( l_U847 ))) AND (TIMERB() > 16400))
                {
                    for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
            ...
            if (NOT l_U494[3])
            {
                if ((NOT (sub_27943( l_U847 ))) AND (TIMERB() > 13700))
                {
                    for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
            ...
            if (NOT l_U494[4])
            {
                if ((NOT (sub_27943( l_U847 ))) AND (TIMERB() > 14800))
                {
                    for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
            ...
            if (NOT l_U494[5])
            {
                if ((NOT (sub_27943( l_U847 ))) AND (TIMERB() > 10000))
                {
                    for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
            ...
            if (NOT l_U494[6])
            {
                if ((NOT (sub_27943( l_U847 ))) AND (TIMERB() > 8450))
                {
                    for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
            ...
            if (NOT l_U494[7])
            {
                if ((NOT (sub_27943( l_U847 ))) AND (TIMERB() > 6400))
                {
                    for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
            ...
            if (NOT l_U494[8])
            {
                if ((NOT (sub_27943( l_U847 ))) AND (TIMERB() > 5100))
                {
                    for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
            ...
            if (NOT l_U494[9])
            {
                if ((NOT (sub_27943( l_U847 ))) AND (TIMERB() > 5900))
                {
                    for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
                    {
                        if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
                ...
                if (NOT (l_U578 > 4))
                {
                    ...
                    else if (NOT l_U517)
                    {
                        if (IS_VEH_DRIVEABLE( l_U761[3] ))
                        {
                            ...
                            {
                                GET_DRIVER_OF_CAR( l_U761[3], ref l_U753 );
                                if ((IS_CHAR_INJURED( l_U753 )) || (IS_CHAR_SITTING_IN_CAR( sub_5316(), l_U761[3] )))
                                {
...
void sub_1374()
{
    ...
    {
        if (((sub_1412( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_13357()
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_5316() )) || (IS_CHAR_ON_ANY_BIKE( sub_5316() )))
    {
...
void sub_25818()
{
    ...
    else
    {
        ...
        if (((((l_U519[0]) AND (l_U519[1])) AND (l_U519[2])) AND (l_U519[3])) AND (l_U519[4]))
        {
            for ( l_U580 = 0; l_U580 <= 15; l_U580++ )
            {
                if (NOT (IS_CHAR_INJURED( l_U729[l_U580] )))
