void main()
{
    ...
    if ((DOES_SCRIPT_EXIST( "faustin2" )) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "faustin2" )) > 0))
    {
        l_U197 = 1;
    }
    if (NOT l_U197)
    ...
    while (l_U189)
    {
        ...
        else if (l_U197)
        {
            ...
            if ((DOES_CHAR_EXIST( l_U126 )) AND (NOT (IS_CHAR_INJURED( l_U126 ))))
            {
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U381)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_983() )))
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_983(), -1333.07600000, 308.10840000, 13.62120000, 5.00000000, 5.00000000, 5.00000000, 0 )) || (sub_7604()))
                    {
                ...
                if (NOT (IS_CHAR_INJURED( sub_983() )))
                {
                    if ((IS_CHAR_IN_AREA_2D( sub_983(), 1049, 79, 1058, 96, 0 )) || (sub_7604()))
                    {
                        if (IS_WANTED_LEVEL_GREATER( sub_731(), 0 ))
                        {
                            SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( 807349477, l_U202._fU0, l_U202._fU4, l_U202._fU8, 1, 0.00000000 );
                ...
                case 4:
                l_U196 = 0;
                if ((IS_WANTED_LEVEL_GREATER( sub_731(), 0 )) AND (NOT sub_7604()))
                {
                ...
                else if ((((NOT sub_7604()) AND (l_U482)) AND (NOT l_U483)) AND (NOT g_U9333))
                {
                    if ((DOES_CHAR_EXIST( l_U126 )) AND (NOT (IS_CHAR_INJURED( l_U126 ))))
                    {
                ...
                else if (((((NOT sub_7604()) AND (l_U482)) AND (NOT l_U483)) AND (NOT g_U9334)) AND (NOT l_U443))
                {
                    if ((DOES_CHAR_EXIST( l_U126 )) AND (NOT (IS_CHAR_INJURED( l_U126 ))))
                    {
                        sub_7891( "GS1_BYE2", ref l_U363, 1, 0 );
                ...
                {
                    if ((((IS_PLAYER_TARGETTING_CHAR( sub_731(), l_U126 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_731(), l_U126 ))) || (IS_CHAR_SHOOTING_IN_AREA( sub_983(), l_U199._fU0 - 9.39310000, l_U199._fU4 - 1.66650000, l_U199._fU0 + 3.09560000, l_U199._fU4 + 6.77950000, 0 ))) || (IS_PED_RAGDOLL( l_U126 )))
                    {
                        if (NOT l_U487)
                        {
                            ...
                            if ((IS_CHAR_ARMED( sub_983(), 6 )) || (IS_PED_RAGDOLL( l_U126 )))
                            {
                    ...
                    if ((NOT (IS_PLAYER_TARGETTING_CHAR( sub_731(), l_U126 ))) AND (NOT (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_731(), l_U126 ))))
                    {
                        if (l_U487)
                        {
                            if (NOT (IS_CHAR_INJURED( l_U126 )))
                ...
                else if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U126, sub_983(), 0 )) || (IS_WANTED_LEVEL_GREATER( sub_731(), 0 )))
                {
                ...
                if (g_U9334 == 1)
                {
                    if (LOCATE_CHAR_ANY_MEANS_3D( sub_983(), l_U397[12]._fU0, l_U397[12]._fU4, l_U397[12]._fU8, 3.50000000, 3.50000000, 3.50000000, 0 ))
                    {
                        ...
                        if ((l_U214 - g_U9332) > 300000)
                        {
                            ...
                            else if ((DOES_CHAR_EXIST( l_U126 )) AND (NOT (IS_CHAR_INJURED( l_U126 ))))
                            {
                                sub_7891( "GS1_GREET2", ref l_U363, 1, 0 );
                            }
                            g_U9334 = 0;
                ...
                {
                    if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U126, sub_983(), 0 )) || (IS_WANTED_LEVEL_GREATER( sub_731(), 0 )))
                    {
                        CLEAR_CHAR_TASKS( sub_983() );
                        SET_RELATIONSHIP( 5, 28, 0 );
                        if (NOT (IS_CHAR_INJURED( l_U126 )))
...
void sub_1158()
{
    if (IS_PLAYER_PLAYING( sub_731() ))
    {
        ...
        {
            if ((HAS_CHAR_GOT_WEAPON( sub_983(), l_U219[l_U213]._fU0 )) AND (NOT l_U147[l_U213]))
            {
...
void sub_3517()
{
    ...
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U131[0], -0.35000000, -1.40000000, 0.84000000, ref l_U397[2]._fU0, ref l_U397[2]._fU4, ref l_U397[2]._fU8 );
    ...
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U131[0], -5.00000000, 3.90000000, 0.84000000, ref l_U397[6]._fU0, ref l_U397[6]._fU4, ref l_U397[6]._fU8 );
...
int sub_7604()
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_983() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_983(), l_U199._fU0, l_U199._fU4, l_U199._fU8, 15.00000000, 15.00000000, 15.00000000, 0 )))
    {
        GET_KEY_FOR_CHAR_IN_ROOM( sub_983(), ref iVar2 );
        if ((iVar2 == (GET_HASH_KEY( l_U211 ))) || (iVar2 == (GET_HASH_KEY( "Room_gunlobby" ))))
        {
            return 1;
        }
        else
...
int sub_10382()
{
    ...
    switch (l_U382)
    {
        ...
        if (NOT (IS_CHAR_INJURED( sub_983() )))
        {
            if (TIMERA() > 5000)
            {
                if ((LOCATE_CHAR_ANY_MEANS_3D( sub_983(), 1062.70300000, 88.55340000, 33.23720000 + 0.25000000, 0.50000000, 0.50000000, 1.00000000, 1 )) || (sub_11367( sub_983() )))
                {
                    SETTIMERA( 0 );
                    l_U123 = 0;
                    l_U382 = 2;
...
void sub_11995()
{
    switch (l_U383)
    {
        ...
        if (((((((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U469 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GUN_FAIL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FAIL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_BUY" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FULL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FULL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FAIL" )))
        {
            if (TIMERB() > 1500)
            {
                CLEAR_HELP();
        ...
        {
            if ((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_731() )) AND (NOT sub_12489()))
            {
                if (l_U168[l_U212])
                {
                    if (NOT l_U147[l_U212])
                    {
                        if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U465 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U455 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
                        {
                            CLEAR_HELP();
                        }
                    ...
                    else if ((NOT (l_U212 == 11)) AND (NOT (l_U212 == 12)))
                    {
                        if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U461 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U455 )))
                        {
                            CLEAR_HELP();
                        }
                    }
                    if (sub_11367( sub_983() ))
                    {
                        if ((((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U469 ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_BUY" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FULL" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FAIL" ))))
                        {
                            if (NOT (l_U212 == 0))
                            {
                                if (NOT l_U460)
        ...
        {
            if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U461 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U465 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
            {
                CLEAR_HELP();
            }
            if (sub_11367( sub_983() ))
            {
                if (((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_BUY" ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FULL" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FAIL" ))))
                {
                    ...
                    else if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_A1" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U455 )))
                    {
                        CLEAR_HELP();
                    }
                }
        ...
        else
        {
            ...
            if ((((((((((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_H11" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_H1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_WH1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_FAUST" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_A1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_B1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U461 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U465 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U455 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
            {
                CLEAR_HELP();
            }
        }
        ...
        if (((((((IS_CHAR_PLAYING_ANIM( sub_983(), "missgunlockup", "pistol_loop" )) || (IS_CHAR_PLAYING_ANIM( sub_983(), "missgunlockup", "rifle_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_983(), "missgunlockup", "shotgun_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_983(), "missgunlockup", "over_shoulder" ))) || (IS_CHAR_PLAYING_ANIM( sub_983(), "missgunlockup", "grenade_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_983(), "missgunlockup", "uzi_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_983(), "missgunlockup", "rpg_loop" )))
        {
        ...
        if (l_U4)
        {
            if (sub_20242( sub_19963( l_U219[l_U212]._fU0 ) ))
            {
                ...
                SETTIMERB( 0 );
                if ((NOT (IS_CHAR_INJURED( l_U126 ))) AND (NOT (IS_CHAR_INJURED( sub_983() ))))
                {
                    OPEN_SEQUENCE_TASK( ref l_U362 );
                    TASK_TURN_CHAR_TO_FACE_CHAR( 0, sub_983() );
                    TASK_LOOK_AT_CHAR( 0, sub_983(), -2, 1 );
        ...
        break;
        case 10:
        if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U469 )) || ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GUN_FAIL" )) AND (TIMERB() > 3000)))
        {
            CLEAR_HELP();
        }
...
int sub_12635(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_731() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_731() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_731() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_12489())
                    {
...
void sub_28338()
{
    while (((NOT (sub_28382( l_U384[1]._fU0, l_U384[1]._fU4, l_U384[1]._fU8, 2.00000000 ))) || (sub_28382( l_U384[2]._fU0, l_U384[2]._fU4, l_U384[2]._fU8, 2.00000000 ))) || (sub_28382( l_U384[3]._fU0, l_U384[3]._fU4, l_U384[3]._fU8, 2.00000000 )))
    {
        WAIT( 0 );
    }
    if (NOT l_U191)
