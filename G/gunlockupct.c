    ...
    while (l_U182)
    {
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U356)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_950() )))
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_950(), 67.55050000, -342.48320000, 12.96240000, 5.00000000, 5.00000000, 10.00000000, 0 )) || (sub_6652()))
                    {
                ...
                break;
                case 2:
                if ((IS_WANTED_LEVEL_GREATER( sub_708(), 0 )) AND (NOT sub_6652()))
                {
                ...
                if ((LOCATE_CHAR_ANY_MEANS_3D( sub_950(), l_U371[12]._fU0 - 0.80000000, l_U371[12]._fU4 - 0.50000000, l_U371[12]._fU8 + (1.60000000 / 2), 1.60000000 + 0.10000000, 1.60000000 + 0.10000000, 1.60000000 + 0.20000000, 0 )) || (sub_6652()))
                {
                    sub_8423();
                    if (NOT g_U9338)
                    {
                    ...
                    if ((NOT l_U450) AND (NOT g_U9335))
                    {
                        if ((DOES_CHAR_EXIST( l_U120 )) AND (NOT (IS_CHAR_INJURED( l_U120 ))))
                        {
                ...
                {
                    if ((((IS_PLAYER_TARGETTING_CHAR( sub_708(), l_U120 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_708(), l_U120 ))) || (IS_CHAR_SHOOTING_IN_AREA( sub_950(), l_U189._fU0 - 9.39310000, l_U189._fU4 - 1.66650000, l_U189._fU0 + 3.09560000, l_U189._fU4 + 6.77950000, 0 ))) || (IS_PED_RAGDOLL( l_U120 )))
                    {
                        if (NOT l_U454)
                        {
                            ...
                            if ((IS_CHAR_ARMED( sub_950(), 6 )) || (IS_PED_RAGDOLL( l_U120 )))
                            {
                    ...
                    if ((NOT (IS_PLAYER_TARGETTING_CHAR( sub_708(), l_U120 ))) AND (NOT (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_708(), l_U120 ))))
                    {
                        if (l_U454)
                        {
                ...
                else if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U120, sub_950(), 0 )) || (IS_WANTED_LEVEL_GREATER( sub_708(), 0 )))
                {
...
void sub_1226()
{
    if (IS_PLAYER_PLAYING( sub_708() ))
    {
        ...
        {
            if ((HAS_CHAR_GOT_WEAPON( sub_950(), l_U200[l_U194]._fU0 )) AND (NOT l_U140[l_U194]))
            {
...
void sub_2622()
{
    ...
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U125[0], 0.90000000, -1.30000000, 0.84000000, ref l_U371[3]._fU0, ref l_U371[3]._fU4, ref l_U371[3]._fU8 );
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U125[0], -4.00000000, 6.20000000, 0.84000000, ref l_U371[4]._fU0, ref l_U371[4]._fU4, ref l_U371[4]._fU8 );
    ...
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U125[0], -5.00000000, 3.70000000, 0.84000000, ref l_U371[6]._fU0, ref l_U371[6]._fU4, ref l_U371[6]._fU8 );
...
int sub_6652()
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_950() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_950(), l_U189._fU0, l_U189._fU4, l_U189._fU8, 15.00000000, 15.00000000, 15.00000000, 0 )))
    {
...
void sub_8796()
{
    switch (l_U357)
    {
        ...
        if (((((((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U443 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GUN_FAIL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FAIL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_BUY" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FULL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FULL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FAIL" )))
        {
            if (TIMERB() > 1500)
            {
                CLEAR_HELP();
        ...
        {
            if ((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_708() )) AND (NOT sub_9290()))
            {
                if (l_U161[l_U193])
                {
                    if (NOT l_U140[l_U193])
                    {
                        if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U439 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U429 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
                        {
                            CLEAR_HELP();
                        }
                        if (sub_9424( sub_950() ))
                    ...
                    else if ((NOT (l_U193 == 11)) AND (NOT (l_U193 == 12)))
                    {
                        if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U435 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U429 )))
                        {
                            CLEAR_HELP();
                        }
                    }
                    if (sub_9424( sub_950() ))
                    {
                        if ((((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U443 ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_BUY" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FULL" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FAIL" ))))
                        {
                            if (NOT (l_U193 == 0))
                            {
                                if (NOT l_U434)
        ...
        {
            if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U435 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U439 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
            {
                CLEAR_HELP();
            }
            if (sub_9424( sub_950() ))
            {
                if (((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_BUY" ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FULL" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FAIL" ))))
                {
                    ...
                    else if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_A1" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U429 )))
                    {
                        CLEAR_HELP();
                    }
                }
        ...
        if (((((((IS_CHAR_PLAYING_ANIM( sub_950(), "missgunlockup", "pistol_loop" )) || (IS_CHAR_PLAYING_ANIM( sub_950(), "missgunlockup", "rifle_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_950(), "missgunlockup", "shotgun_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_950(), "missgunlockup", "over_shoulder" ))) || (IS_CHAR_PLAYING_ANIM( sub_950(), "missgunlockup", "grenade_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_950(), "missgunlockup", "uzi_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_950(), "missgunlockup", "rpg_loop" )))
        {
        ...
        if (l_U4)
        {
            if (sub_17266( sub_17045( l_U200[l_U193]._fU0 ) ))
            {
                ...
                SETTIMERB( 0 );
                if ((NOT (IS_CHAR_INJURED( l_U120 ))) AND (NOT (IS_CHAR_INJURED( sub_950() ))))
                {
                    OPEN_SEQUENCE_TASK( ref l_U343 );
                    TASK_TURN_CHAR_TO_FACE_CHAR( 0, sub_950() );
                    TASK_LOOK_AT_CHAR( 0, sub_950(), -2, 1 );
        ...
        break;
        case 10:
        if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U443 )) || ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GUN_FAIL" )) AND (TIMERB() > 3000)))
        {
            CLEAR_HELP();
        }
...
int sub_9486(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_708() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_708() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_708() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_9290())
                    {
...
void sub_23566()
{
    while (((NOT (sub_23610( l_U358[1]._fU0, l_U358[1]._fU4, l_U358[1]._fU8, 2.00000000 ))) || (sub_23610( l_U358[2]._fU0, l_U358[2]._fU4, l_U358[2]._fU8, 2.00000000 ))) || (sub_23610( l_U358[3]._fU0, l_U358[3]._fU4, l_U358[3]._fU8, 2.00000000 )))
    {
        WAIT( 0 );
    }
    if (NOT l_U184)
