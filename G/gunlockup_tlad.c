    ...
    while (l_U184)
    {
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U368)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_952() )))
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_952(), -1333.07600000, 308.10840000, 13.62120000, 5.00000000, 5.00000000, 5.00000000, 0 )) || (sub_6980()))
                    {
                        if ((IS_WANTED_LEVEL_GREATER( sub_710(), 0 )) || (g_U39234))
                        {
                            SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( 807349477, l_U195._fU0, l_U195._fU4, l_U195._fU8, 1, 0.00000000 );
                ...
                if (NOT (IS_CHAR_INJURED( sub_952() )))
                {
                    if ((IS_CHAR_IN_AREA_2D( sub_952(), 1049, 79, 1058, 96, 0 )) || (sub_6980()))
                    {
                        if ((IS_WANTED_LEVEL_GREATER( sub_710(), 0 )) || (g_U39234))
                        {
                            SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( 807349477, l_U195._fU0, l_U195._fU4, l_U195._fU8, 1, 0.00000000 );
                ...
                case 4:
                l_U190 = 0;
                if (((IS_WANTED_LEVEL_GREATER( sub_710(), 0 )) || (g_U39234)) AND (NOT sub_6980()))
                {
                ...
                if (sub_6980())
                {
                    ...
                    if ((NOT l_U464) AND (NOT g_U10634))
                    {
                        if ((DOES_CHAR_EXIST( l_U121 )) AND (NOT (IS_CHAR_INJURED( l_U121 ))))
                        {
                ...
                else if ((((NOT sub_6980()) AND (l_U464)) AND (NOT l_U465)) AND (NOT g_U10634))
                {
                    if ((DOES_CHAR_EXIST( l_U121 )) AND (NOT (IS_CHAR_INJURED( l_U121 ))))
                    {
                ...
                if (sub_6980())
                {
                    ...
                    if ((NOT l_U464) AND (NOT g_U10635))
                    {
                        if ((DOES_CHAR_EXIST( l_U121 )) AND (NOT (IS_CHAR_INJURED( l_U121 ))))
                        {
                            sub_7301( "GS1_GREET2", ref l_U356, 1, 0 );
                ...
                else if ((((NOT sub_6980()) AND (l_U464)) AND (NOT l_U465)) AND (NOT g_U10635))
                {
                    if ((DOES_CHAR_EXIST( l_U121 )) AND (NOT (IS_CHAR_INJURED( l_U121 ))))
                    {
                        sub_7301( "GS1_BYE2", ref l_U356, 1, 0 );
                ...
                {
                    if ((((IS_PLAYER_TARGETTING_CHAR( sub_710(), l_U121 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_710(), l_U121 ))) || (IS_CHAR_SHOOTING_IN_AREA( sub_952(), l_U192._fU0 - 9.39310000, l_U192._fU4 - 1.66650000, l_U192._fU0 + 3.09560000, l_U192._fU4 + 6.77950000, 0 ))) || (IS_PED_RAGDOLL( l_U121 )))
                    {
                        if (NOT l_U469)
                        {
                            ...
                            if ((IS_CHAR_ARMED( sub_952(), 6 )) || (IS_PED_RAGDOLL( l_U121 )))
                            {
                    ...
                    if ((NOT (IS_PLAYER_TARGETTING_CHAR( sub_710(), l_U121 ))) AND (NOT (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_710(), l_U121 ))))
                    {
                        if (l_U469)
                        {
                            if (NOT (IS_CHAR_INJURED( l_U121 )))
                ...
                else if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U121, sub_952(), 0 )) || (IS_WANTED_LEVEL_GREATER( sub_710(), 0 ))) || (g_U39234))
                {
...
void sub_1127()
{
    if (IS_PLAYER_PLAYING( sub_710() ))
    {
        ...
        {
            if ((HAS_CHAR_GOT_WEAPON( sub_952(), l_U212[l_U206]._fU0 )) AND (NOT l_U142[l_U206]))
            {
...
void sub_3050()
{
    ...
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U126[0], -0.35000000, -1.40000000, 0.84000000, ref l_U383[2]._fU0, ref l_U383[2]._fU4, ref l_U383[2]._fU8 );
    ...
    GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS( l_U126[0], -5.00000000, 3.90000000, 0.84000000, ref l_U383[6]._fU0, ref l_U383[6]._fU4, ref l_U383[6]._fU8 );
...
int sub_6980()
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_952() ))) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_952(), l_U192._fU0, l_U192._fU4, l_U192._fU8, 15.00000000, 15.00000000, 15.00000000, 0 )))
    {
        GET_KEY_FOR_CHAR_IN_ROOM( sub_952(), ref iVar2 );
        if ((iVar2 == (GET_HASH_KEY( l_U204 ))) || (iVar2 == (GET_HASH_KEY( "Room_gunlobby" ))))
        {
            return 1;
        }
        else
...
void sub_9556()
{
    switch (l_U369)
    {
        ...
        if (((((((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U456 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GUN_FAIL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FAIL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_BUY" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FULL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FULL" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FAIL" )))
        {
            if (TIMERB() > 1500)
            {
                CLEAR_HELP();
        ...
        {
            if ((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_710() )) AND (NOT sub_10050()))
            {
                if (l_U163[l_U205])
                {
                    if (NOT l_U142[l_U205])
                    {
                        if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U452 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U442 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
                        {
                            CLEAR_HELP();
                        }
                    ...
                    else if ((NOT (l_U205 == 11)) AND (NOT (l_U205 == 12)))
                    {
                        if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U448 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U442 )))
                        {
                            CLEAR_HELP();
                        }
                    }
                    if (sub_10184( sub_952() ))
                    {
                        if ((((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U456 ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_BUY" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FULL" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "AMMO_FAIL" ))))
                        {
                            if (NOT (l_U205 == 0))
                            {
                                if (NOT l_U447)
        ...
        {
            if (((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U448 )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U452 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
            {
                CLEAR_HELP();
            }
            if (sub_10184( sub_952() ))
            {
                if (((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_BUY" ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FULL" )))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ARM_FAIL" ))))
                {
                    ...
                    else if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_A1" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U442 )))
                    {
                        CLEAR_HELP();
                    }
                }
        ...
        else
        {
            ...
            if ((((((((((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_H11" )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_H1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_WH1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_FAUST" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_A1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GLOCK_B1" ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U448 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U452 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U442 ))) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GL_SOON" )))
            {
                CLEAR_HELP();
            }
        }
        ...
        if (((((((IS_CHAR_PLAYING_ANIM( sub_952(), "missgunlockup", "pistol_loop" )) || (IS_CHAR_PLAYING_ANIM( sub_952(), "missgunlockup", "rifle_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_952(), "missgunlockup", "shotgun_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_952(), "missgunlockup", "over_shoulder" ))) || (IS_CHAR_PLAYING_ANIM( sub_952(), "missgunlockup", "grenade_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_952(), "missgunlockup", "uzi_loop" ))) || (IS_CHAR_PLAYING_ANIM( sub_952(), "missgunlockup", "rpg_loop" )))
        {
        ...
        if (l_U6)
        {
            if (sub_17368( sub_17147( l_U212[l_U205]._fU0 ) ))
            {
                ...
                SETTIMERB( 0 );
                if ((NOT (IS_CHAR_INJURED( l_U121 ))) AND (NOT (IS_CHAR_INJURED( sub_952() ))))
                {
                    OPEN_SEQUENCE_TASK( ref l_U355 );
                    TASK_TURN_CHAR_TO_FACE_CHAR( 0, sub_952() );
                    TASK_LOOK_AT_CHAR( 0, sub_952(), -2, 1 );
        ...
        break;
        case 10:
        if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( ref l_U456 )) || ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "GUN_FAIL" )) AND (TIMERB() > 3000)))
        {
            CLEAR_HELP();
        }
...
int sub_10246(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_710() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_710() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_710() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_10050())
                    {
...
void sub_24419()
{
    while (((NOT (sub_24463( l_U370[1]._fU0, l_U370[1]._fU4, l_U370[1]._fU8, 2.00000000 ))) || (sub_24463( l_U370[2]._fU0, l_U370[2]._fU4, l_U370[2]._fU8, 2.00000000 ))) || (sub_24463( l_U370[3]._fU0, l_U370[3]._fU4, l_U370[3]._fU8, 2.00000000 )))
    {
        WAIT( 0 );
    }
    if (NOT l_U186)
