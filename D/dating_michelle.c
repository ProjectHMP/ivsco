        ...
        if (NOT g_U33838)
        {
            ...
            switch (l_U594)
            {
                ...
                switch (sub_22538())
                {
                    ...
                    else if ((sub_22538() == 5) || (sub_22538() == 8))
                    {
...
void sub_248(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15, unknown uParam16, unknown uParam17, unknown uParam18, unknown uParam19, unknown uParam20, unknown uParam21, unknown uParam22, unknown uParam23, unknown uParam24, unknown uParam25, unknown uParam26, unknown uParam27, unknown uParam28, unknown uParam29, unknown uParam30, unknown uParam31, unknown uParam32, unknown uParam33, unknown uParam34, unknown uParam35, unknown uParam36, unknown uParam37, unknown uParam38, unknown uParam39, unknown uParam40, unknown uParam41, unknown uParam42, unknown uParam43, unknown uParam44, unknown uParam45, unknown uParam46, unknown uParam47, unknown uParam48, unknown uParam49, unknown uParam50, unknown uParam51, unknown uParam52, unknown uParam53, unknown uParam54, unknown uParam55, unknown uParam56, unknown uParam57, unknown uParam58, unknown uParam59, unknown uParam60, unknown uParam61, unknown uParam62, unknown uParam63)
{
    ...
    l_U598 = {930.07010000, 177.57920000, 34.42450000};
...
int sub_5133(unknown uParam0)
{
    ...
    if (g_U33837)
    {
        if ((sub_5293( sub_5178( uParam0 ), 1 )) || (g_U15946[sub_5178( uParam0 )]._fU4))
        {
            switch (uParam0)
            {
                case 0:
...
int sub_8321(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_8566() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_8566() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_8898()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
int sub_19084()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_19122( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_19385( I );
            return 1;
        }
...
int sub_20763(unknown uParam0, boolean bParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if ((NOT (IS_CHAR_DEAD( sub_8566() ))) AND (IS_PLAYER_PLAYING( sub_8487() )))
    {
        if (GET_MISSION_FLAG())
        {
            if ((uParam2^) <= iVar13)
...
int sub_23150(unknown uParam0, int iParam1, unknown uParam2, int iParam3)
{
    if (iParam3 != 1)
    {
        ...
        {
            if (((sub_23190( iParam1 )) > 90) || ((sub_23190( iParam1 )) < 65476))
            {
    ...
    else
    {
        ...
        if ((iParam1->_fU0 >= 0) AND (iParam1->_fU4 >= 0))
        {
            if (((sub_23671( iParam1 )) > 180) || ((sub_23671( iParam1 )) < 65356))
            {
    ...
    if (NOT (sub_23150( iParam0, iParam5, (uParam1^), iParam7 )))
    {
        if (NOT ((g_U10978) || (GET_MISSION_FLAG())))
        {
            if (IS_PLAYER_PLAYING( sub_8487() ))
            {
                ...
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_8566(), uParam2._fU0, uParam2._fU4, uParam2._fU8, 8.00000000, 8.00000000, 8.00000000, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_8487(), 0 ))))
                    {
                        g_U33841 = 0;
                    }
                }
...
int sub_25235(unknown uParam0)
{
    ...
    if (sub_5293( sub_5178( uParam0 ), 1 ))
    {
        ...
        if ((g_U15946[sub_5178( uParam0 )]._fU8[1]._fU0[0]) || (g_U15946[sub_5178( uParam0 )]._fU8[1]._fU0[1]))
        {
        ...
        if (NOT (IS_CAR_DEAD( uVar21 )))
        {
            switch (l_U592)
            {
                ...
                else
                {
                    ...
                    if ((NOT (IS_CAR_DEAD( uVar21 ))) AND (IS_PLAYER_PLAYING( sub_8487() )))
                    {
...
int sub_28481(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if (((sub_28498()) AND (IS_SCREEN_FADED_IN())) AND (iParam1 > 0))
        {
            return 1;
        }
        else
...
int sub_39334(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if (IS_PLAYER_PLAYING( sub_8487() ))
    {
        switch (l_U592)
        {
            ...
            if (NOT (IS_CHAR_DEAD( (uParam3^) )))
            {
                if ((NOT (IS_SPECIFIC_CAM_INTERPOLATING( l_U573[2] ))) || ((sub_40606( (uParam3^), 17 )) AND (sub_40606( sub_8566(), 17 ))))
                {
                    INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
                    l_U592 = 5;
                }
...
void sub_41458(int iParam0, int iParam1, unknown uParam2)
{
    if (iParam0 == 2)
    {
        if (((NOT (sub_41480( iParam0, uParam2 ))) || (iParam1 == 27)) || (iParam1 == 26))
        {
            sub_41557( iParam1 );
        }
    }
            ...
            switch ((uParam2^))
            {
                ...
                if (NOT IS_MESSAGE_BEING_DISPLAYED())
                {
                    ...
                    else
                    {
                        ...
                        if ((IS_CHAR_IN_ANY_CAR( sub_8566() )) AND (NOT (IS_CHAR_ON_ANY_BIKE( sub_8566() ))))
                        {
                        ...
                        WAIT( 0 );
                        if ((IS_PLAYER_PLAYING( sub_8487() )) AND (NOT (IS_CHAR_DEAD( (uParam0^) ))))
                        {
                            bVar59 = false;
                            if ((IS_CHAR_IN_ANY_CAR( sub_8566() )) AND (NOT (IS_CHAR_ON_ANY_BIKE( sub_8566() ))))
                            {
                ...
                else if (sub_68587( iParam1, uParam12, uParam2 ))
                {
                    if (sub_68238())
                    {
                        if (sub_43936( 25, ref l_U581, (uParam8^), iParam1, 83, 0 ))
                        {
                            ...
                            TASK_PERFORM_SEQUENCE( (uParam0^), uVar54 );
                            CLEAR_SEQUENCE_TASK( uVar54 );
                            if ((IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( "GET_NUM", sub_4573( iParam1, 1 ) )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TRY_LUCK" )))
                            {
                                CLEAR_HELP();
                            }
                ...
                break;
                case 5:
                if ((NOT (sub_74288( l_U581 ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) ))))
                {
                    if ((uParam8^) <= 1)
                    {
                        if (NOT l_U572)
                        {
                            ...
                            else if ((IS_CHAR_PLAYING_ANIM( sub_8566(), "amb@dating", "pass_text" )) || (IS_CHAR_PLAYING_ANIM( sub_8566(), "Cellphone", "cellphone_text" )))
                            {
                ...
                if (((IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] )) AND ((IS_CHAR_ON_SCREEN( sub_8566() )) || (IS_CHAR_ON_SCREEN( (uParam0^) )))) AND (NOT ((LOCATE_CHAR_ON_FOOT_3D( sub_8566(), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( (uParam0^), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )))))
                {
                ...
                break;
                case 8:
                if (((IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] )) AND (NOT IS_SCRIPTED_CONVERSATION_ONGOING())) AND (NOT ((sub_28498()) AND (IS_SCREEN_FADED_IN()))))
                {
...
int sub_80899(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15)
{
    ...
    switch ((uParam15^))
    {
        ...
        if ((iVar81 <= ((uParam12^) + (sub_3531( 20.00000000 )))) AND (NOT ((IS_KEYBOARD_KEY_PRESSED( 11 )) AND ((IS_KEYBOARD_KEY_PRESSED( 29 )) || (IS_KEYBOARD_KEY_PRESSED( 157 ))))))
        {
            sub_5376( "  * WAIT_FOR_" );
        ...
        {
            if (((LOCATE_CHAR_ANY_MEANS_2D( sub_8566(), g_U10090[uParam13]._fU4._fU0, g_U10090[uParam13]._fU4._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( sub_8566(), g_U33981[iParam1]._fU0, g_U33981[iParam1]._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 ))) || (DOES_CHAR_EXIST( (uParam0^) )))
            {
            ...
            else if (NOT IS_MESSAGE_BEING_DISPLAYED())
            {
                ...
                else
                {
                    ...
                    if (IS_PLAYER_PLAYING( sub_8487() ))
                    {
                        ...
                        {
                            WAIT( 1500 );
                            if ((NOT (IS_CHAR_INJURED( (uParam0^) ))) AND (IS_PLAYER_PLAYING( sub_8487() )))
                            {
