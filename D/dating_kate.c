        ...
        if (NOT g_U33838)
        {
            ...
            switch (l_U594)
            {
                ...
                if (NOT sub_2547())
                {
                    if (g_U15654[37])
                    {
                        if ((NOT GET_MISSION_FLAG()) AND (NOT g_U10978))
                        {
                ...
                if (NOT sub_2547())
                {
                    if (NOT ((g_U15654[52]) AND ((g_U34005[1] > 14) || (sub_13415( 1 )))))
                    {
                        if (g_U15654[37])
                        {
                            if (NOT (sub_13415( 1 )))
                            {
                                if (NOT (sub_13517( 1 )))
                                {
                                    ...
                                    if (NOT l_U691)
                                    {
                                        if ((l_U730 >= 3) AND (ProtectedGet(g_U34042[1]) >= 65.00000000))
                                        {
...
int sub_2547()
{
    if ((g_U15654[52]) AND (NOT g_U15654[37]))
    {
        PRINTNL();
        PRINTSTRING( "  ###################\n" );
...
int sub_2758(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    switch (uParam0)
    {
        ...
        if (sub_7606( uParam1 ))
        {
            if (((g_U10978) || (GET_MISSION_FLAG())) || (sub_7704()))
            {
                return 0;
            }
...
int sub_3261(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3506() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3506() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_3838()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
int sub_9807()
{
    if ((((g_U9387[23]._fU24) || (g_U9387[25]._fU24)) || (g_U9387[27]._fU24)) || (sub_9848()))
    {
        return 1;
        break;
    }
...
void sub_10398()
{
    ...
    if (l_U738 < 0)
    {
        if (((sub_10423( ref l_U722 )) == 6) || ((sub_10423( ref l_U722 )) != 0))
        {
...
int sub_12290()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_10525( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_12354( I );
            return 1;
        }
...
int sub_13517(unknown uParam0)
{
    ...
    if (g_U33837)
    {
        if ((sub_2810( sub_13562( uParam0 ), 1 )) || (g_U15946[sub_13562( uParam0 )]._fU4))
        {
            switch (uParam0)
            {
                case 0:
...
int sub_21269(unknown uParam0, boolean bParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if ((NOT (IS_CHAR_DEAD( sub_3506() ))) AND (IS_PLAYER_PLAYING( sub_3427() )))
    {
        if (GET_MISSION_FLAG())
        {
            if ((uParam2^) <= iVar13)
...
int sub_23713(unknown uParam0, int iParam1, unknown uParam2, int iParam3)
{
    if (iParam3 != 1)
    {
        ...
        {
            if (((sub_23753( iParam1 )) > 90) || ((sub_23753( iParam1 )) < 65476))
            {
    ...
    else
    {
        ...
        if ((iParam1->_fU0 >= 0) AND (iParam1->_fU4 >= 0))
        {
            if (((sub_24234( iParam1 )) > 180) || ((sub_24234( iParam1 )) < 65356))
            {
    ...
    if (NOT (sub_23713( iParam0, iParam5, (uParam1^), iParam7 )))
    {
        if (NOT ((g_U10978) || (GET_MISSION_FLAG())))
        {
            if (IS_PLAYER_PLAYING( sub_3427() ))
            {
                ...
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3506(), uParam2._fU0, uParam2._fU4, uParam2._fU8, 8.00000000, 8.00000000, 8.00000000, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_3427(), 0 ))))
                    {
                        g_U33841 = 0;
                    }
                }
...
int sub_25829(unknown uParam0)
{
    ...
    if (sub_2810( sub_13562( uParam0 ), 1 ))
    {
        ...
        if ((g_U15946[sub_13562( uParam0 )]._fU8[1]._fU0[0]) || (g_U15946[sub_13562( uParam0 )]._fU8[1]._fU0[1]))
        {
        ...
        if (NOT (IS_CAR_DEAD( uVar21 )))
        {
            switch (l_U592)
            {
                ...
                else
                {
                    ...
                    if ((NOT (IS_CAR_DEAD( uVar21 ))) AND (IS_PLAYER_PLAYING( sub_3427() )))
                    {
...
int sub_29063(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if (((sub_29080()) AND (IS_SCREEN_FADED_IN())) AND (iParam1 > 0))
        {
            return 1;
        }
        else
...
int sub_39725(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if (IS_PLAYER_PLAYING( sub_3427() ))
    {
        switch (l_U592)
        {
            ...
            if (NOT (IS_CHAR_DEAD( (uParam3^) )))
            {
                if ((NOT (IS_SPECIFIC_CAM_INTERPOLATING( l_U573[2] ))) || ((sub_40997( (uParam3^), 17 )) AND (sub_40997( sub_3506(), 17 ))))
                {
                    INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
                    l_U592 = 5;
                }
...
void sub_44106(int iParam0, int iParam1, unknown uParam2)
{
    if (iParam0 == 2)
    {
        if (((NOT (sub_44128( iParam0, uParam2 ))) || (iParam1 == 27)) || (iParam1 == 26))
        {
            sub_44205( iParam1 );
        }
    }
            ...
            switch ((uParam2^))
            {
                ...
                if (NOT IS_MESSAGE_BEING_DISPLAYED())
                {
                    ...
                    else
                    {
                        ...
                        if ((IS_CHAR_IN_ANY_CAR( sub_3506() )) AND (NOT (IS_CHAR_ON_ANY_BIKE( sub_3506() ))))
                        {
                        ...
                        WAIT( 0 );
                        if ((IS_PLAYER_PLAYING( sub_3427() )) AND (NOT (IS_CHAR_DEAD( (uParam0^) ))))
                        {
                            bVar59 = false;
                            if ((IS_CHAR_IN_ANY_CAR( sub_3506() )) AND (NOT (IS_CHAR_ON_ANY_BIKE( sub_3506() ))))
                            {
                ...
                else if (sub_70797( iParam1, uParam12, uParam2 ))
                {
                    if (sub_70448())
                    {
                        if (sub_54130( 25, ref l_U581, (uParam8^), iParam1, 83, 0 ))
                        {
                            ...
                            TASK_PERFORM_SEQUENCE( (uParam0^), uVar54 );
                            CLEAR_SEQUENCE_TASK( uVar54 );
                            if ((IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( "GET_NUM", sub_19708( iParam1, 1 ) )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TRY_LUCK" )))
                            {
                                CLEAR_HELP();
                            }
                ...
                break;
                case 5:
                if ((NOT (sub_76498( l_U581 ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) ))))
                {
                    if ((uParam8^) <= 1)
                    {
                        if (NOT l_U572)
                        {
                            ...
                            else if ((IS_CHAR_PLAYING_ANIM( sub_3506(), "amb@dating", "pass_text" )) || (IS_CHAR_PLAYING_ANIM( sub_3506(), "Cellphone", "cellphone_text" )))
                            {
                ...
                if (((IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] )) AND ((IS_CHAR_ON_SCREEN( sub_3506() )) || (IS_CHAR_ON_SCREEN( (uParam0^) )))) AND (NOT ((LOCATE_CHAR_ON_FOOT_3D( sub_3506(), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( (uParam0^), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )))))
                {
                ...
                break;
                case 8:
                if (((IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] )) AND (NOT IS_SCRIPTED_CONVERSATION_ONGOING())) AND (NOT ((sub_29080()) AND (IS_SCREEN_FADED_IN()))))
                {
...
int sub_83189(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15)
{
    ...
    switch ((uParam15^))
    {
        ...
        if ((iVar81 <= ((uParam12^) + (sub_1404( 20.00000000 )))) AND (NOT ((IS_KEYBOARD_KEY_PRESSED( 11 )) AND ((IS_KEYBOARD_KEY_PRESSED( 29 )) || (IS_KEYBOARD_KEY_PRESSED( 157 ))))))
        {
            sub_2893( "  * WAIT_FOR_" );
        ...
        {
            if (((LOCATE_CHAR_ANY_MEANS_2D( sub_3506(), g_U10090[uParam13]._fU4._fU0, g_U10090[uParam13]._fU4._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( sub_3506(), g_U33981[iParam1]._fU0, g_U33981[iParam1]._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 ))) || (DOES_CHAR_EXIST( (uParam0^) )))
            {
            ...
            else if (NOT IS_MESSAGE_BEING_DISPLAYED())
            {
                ...
                else
                {
                    ...
                    if (IS_PLAYER_PLAYING( sub_3427() ))
                    {
                        ...
                        {
                            WAIT( 1500 );
                            if ((NOT (IS_CHAR_INJURED( (uParam0^) ))) AND (IS_PLAYER_PLAYING( sub_3427() )))
                            {
