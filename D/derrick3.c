...
void sub_2272()
{
    ...
    {
        if (((sub_2310( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_7687()
{
    ...
    {
        if ((sub_7788( l_U805 )) || (NOT (IS_VEH_DRIVEABLE( l_U805 ))))
        {
            PRINT_NOW( "DM_FAIL_05", 7000, 1 );
            l_U490 = -1;
            l_U523 = 1;
...
int sub_8119(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3432() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3432() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_8646()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_18230()
{
    ...
    SETTIMERA( 0 );
    SETTIMERB( 0 );
    while ((NOT bVar57) AND (NOT ((sub_22054()) AND (TIMERA() > 1000))))
    {
        ...
        if (((I == 8) AND (TIMERB() > 20000)) AND (NOT (sub_26102( l_U848 ))))
        {
            bVar57 = true;
        }
        WAIT( 0 );
...
void sub_31248()
{
    ...
    if (((l_U498 == 0) AND (TIMERA() > 4000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U498 = 1;
        if (NOT (IS_CHAR_INJURED( l_U736[0] )))
        {
    ...
    if (((l_U498 == 1) AND (TIMERA() > 4000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U498 = 2;
        if (NOT (IS_CHAR_INJURED( l_U736[0] )))
        {
    ...
    if (((l_U498 == 2) AND (TIMERA() > 8000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U498 = 3;
        if (NOT (IS_CHAR_INJURED( l_U736[0] )))
        {
    ...
    if (((l_U498 == 3) AND (TIMERA() > 12000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U498 = 4;
    }
    ...
    if (((l_U498 == 5) AND (TIMERA() > 16000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U498 = 6;
        if (NOT (IS_CHAR_INJURED( l_U736[0] )))
        {
...
void sub_31339()
{
    ...
    SETTIMERB( 0 );
    SETTIMERA( 0 );
    while ((NOT bVar107) AND (NOT ((sub_22054()) AND (TIMERA() > 1000))))
    {
        ...
        if (((iVar4 == 3) AND (TIMERB() > 10000)) AND (NOT (sub_26102( l_U848 ))))
        {
            iVar4 = 4;
        }
        if ((J == -3) AND (TIMERB() > 0))
    ...
    if ((sub_22054()) AND (IS_SCREEN_FADED_IN()))
    {
        if (NOT IS_SCREEN_FADED_OUT())
        {
            DO_SCREEN_FADE_OUT( 750 );
...
void sub_46645()
{
    ...
    if (((l_U499 == 1) AND (TIMERA() > 7000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U499 = 2;
        if (NOT (IS_CHAR_INJURED( l_U745[0] )))
        {
    ...
    if (((l_U499 == 2) AND (TIMERA() > 12000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U499 = 3;
        sub_22213( "DM3_HFIRE", ref l_U848, 6, 1 );
    }
    if (((l_U499 == 3) AND (TIMERA() > 18000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U499 = 4;
        TRIGGER_POLICE_REPORT( "SCRIPTED_REPORTS_DM3" );
    }
    if (((l_U499 == 4) AND (TIMERA() > 24000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U499 = 5;
        sub_22213( "DM3_GUYS", ref l_U848, 6, 1 );
    }
    if (((l_U499 == 5) AND (TIMERA() > 30000)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U499 = 6;
        if (NOT (IS_CHAR_INJURED( l_U745[0] )))
        {
    ...
    if (((l_U499 == 6) AND (TIMERA() > 37500)) AND (NOT (sub_26102( l_U848 ))))
    {
        l_U499 = 7;
        sub_22213( "DM3_GUYS", ref l_U848, 6, 1 );
    }
...
void sub_50010()
{
    ...
    {
        if ((sub_7788( l_U813 )) || (NOT (IS_VEH_DRIVEABLE( l_U813 ))))
        {
            sub_26302( ref l_U848, 0 );
            if (l_U548 == 1)
            {
...
void sub_50454()
{
    ...
    if (sub_50150( 1, 0 ))
    {
        ...
        SETTIMERA( 0 );
        while (((sub_26102( l_U848 )) AND (iVar3 == 0)) AND (TIMERA() < 1000))
        {
            if (sub_22054())
            {
                iVar3 = 1;
        ...
        while (((sub_26102( l_U848 )) AND (iVar3 == 0)) AND (TIMERA() < 5000))
        {
            if (sub_22054())
            {
                iVar3 = 1;
    ...
    if (l_U563 == 0)
    {
        if (NOT (IS_CAR_DEAD( l_U813 )))
        {
            if (NOT (IS_CHAR_IN_CAR( l_U837, l_U813 )))
            {
                ...
                SET_PED_IS_BLIND_RAGING( l_U837, 0 );
                while ((sub_26102( l_U848 )) AND (TIMERA() < 7000))
                {
                    WAIT( 0 );
                }
...
void sub_58773()
{
    if ((l_U565 == 0) AND (TIMERA() > 7000))
    {
        if ((NOT (IS_CAR_DEAD( l_U813 ))) AND (NOT (IS_CHAR_DEAD( l_U730 ))))
        {
            ...
            {
                if ((l_U567 == 0) AND (NOT (sub_26102( l_U848 ))))
                {
                    if (g_U64978 == 0)
                    {
    ...
    if ((l_U565 == 1) AND (TIMERA() > 7000))
    {
        if ((NOT (IS_CAR_DEAD( l_U813 ))) AND (NOT (IS_CHAR_DEAD( l_U730 ))))
        {
            if ((IS_CHAR_SITTING_IN_CAR( l_U837, l_U813 )) AND (IS_CHAR_SITTING_IN_CAR( l_U730, l_U813 )))
            {
                if ((l_U566 == 0) AND (NOT (sub_26102( l_U848 ))))
                {
                    if (g_U64979 == 0)
                    {
...
void sub_61947()
{
    ...
    if ((((NOT (IS_CHAR_DEAD( l_U731 ))) AND (l_U599 == 0)) AND (NOT (sub_26102( l_U848 )))) AND (TIMERB() > l_U493))
    {
    ...
    if ((((NOT (IS_CHAR_DEAD( l_U730 ))) AND (l_U574 == 1)) AND (NOT (sub_26102( l_U848 )))) AND (TIMERA() > 2000))
    {
...
void sub_62030()
{
    ...
    SETTIMERB( 0 );
    SETTIMERA( 0 );
    while ((NOT bVar74) AND (NOT ((sub_22054()) AND (TIMERA() > 1000))))
    {
        if (I == 0)
        {
            I = 1;
        ...
        if (I == 3)
        {
            fVar57[0] += 0.05000000;
            SET_CAM_FOV( uVar49[0], fVar57[0] );
            if ((TIMERA() > 2750) AND (NOT (sub_26102( l_U848 ))))
            {
                I = 4;
                if ((iVar75 > 18) AND (iVar75 < 21))
                {
        ...
        if (I == 5)
        {
            if ((TIMERA() > 3000) AND (NOT (sub_26102( l_U848 ))))
            {
                I = 6;
                if ((iVar75 > 18) AND (iVar75 < 21))
                {
        ...
        if (I == 7)
        {
            ...
            if (((TIMERA() > 3000) AND (NOT (sub_26102( l_U848 )))) AND (NOT (IS_CHAR_DEAD( l_U731 ))))
            {
        ...
        if (I == 9)
        {
            if ((TIMERA() > 1500) AND (NOT (sub_26102( l_U848 ))))
            {
                I = 10;
        ...
        if (I == 10)
        {
            if ((TIMERA() > 2000) AND (NOT (sub_26102( l_U848 ))))
            {
                I = 11;
        ...
        if ((I == 11) AND (NOT (sub_26102( l_U848 ))))
        {
            if (TIMERA() > 500)
            {
                bVar74 = true;
...
void sub_71073()
{
    ...
    while ((NOT bVar57) AND (NOT ((sub_22054()) AND (TIMERA() > 1000))))
    {
        ...
        if (I == 6)
        {
            if ((TIMERA() > 500) AND (NOT (sub_26102( l_U848 ))))
            {
                if (NOT (IS_CHAR_INJURED( l_U730 )))
                {
                    CLEAR_CHAR_TASKS( l_U730 );
...
void sub_77144()
{
    ...
    {
        if ((sub_7788( l_U481 )) || (NOT (IS_VEH_DRIVEABLE( l_U481 ))))
        {
            sub_26302( ref l_U848, 0 );
            if (l_U548 == 1)
            {
...
void sub_77966()
{
    ...
    while ((NOT bVar57) AND (NOT ((sub_22054()) AND (TIMERA() > 1000))))
    {
        ...
        if (I == 1)
        {
            if ((TIMERA() > 4000) AND (NOT (sub_26102( l_U848 ))))
            {
                I = 2;
        ...
        if (I == 2)
        {
            if ((TIMERA() > 5000) AND (NOT (sub_26102( l_U848 ))))
            {
                I = 3;
                SET_CAM_PROPAGATE( l_U639, 0 );
                SET_CAM_ACTIVE( uVar43[3], 1 );
        ...
        if (I == 5)
        {
            if ((TIMERA() > 2500) AND (NOT (sub_26102( l_U848 ))))
            {
                I = 6;
                INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
                bVar57 = true;
...
void sub_84102()
{
    ...
    if ((((l_U599 == 1) AND (NOT (sub_26102( l_U848 )))) AND (TIMERA() > 2000)) AND (l_U523 == 0))
    {
        CLEAR_WANTED_LEVEL( l_U838 );
        sub_73906( 16, "DM3_CALLP", "DM3AUD", 0 );
        l_U490 = -1;
...
void sub_84185()
{
    ...
    while ((NOT bVar74) AND (NOT ((sub_22054()) AND (TIMERA() > 1000))))
    {
        ...
        if (I == 7)
        {
            ...
            if (((TIMERA() > 0) AND (NOT (sub_26102( l_U848 )))) AND (NOT (IS_CHAR_DEAD( l_U731 ))))
            {
