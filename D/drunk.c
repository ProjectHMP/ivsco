...
int sub_3147()
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( l_U0._fU4 )) || (IS_CHAR_GETTING_IN_TO_A_CAR( l_U0._fU4 )))
    {
        return 0;
    }
...
void sub_5740()
{
    ...
    if ((bVar3) || (IS_CHAR_SITTING_IN_ANY_CAR( l_U0._fU4 )))
    {
        if (NOT l_U8)
        {
...
int sub_9278()
{
    ...
    bVar10 = false;
    bVar11 = false;
    if (((IS_CAR_MODEL( iVar5, -956048545 )) || (IS_CAR_MODEL( iVar5, 1884962369 ))) || (IS_CAR_MODEL( iVar5, 1208856469 )))
    {
        fVar8 = 4.00000000;
        fVar7 = 0.00000000;
        bVar11 = true;
