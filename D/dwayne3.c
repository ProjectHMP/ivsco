void main()
{
    ...
    l_U579[7] = {1152.11800000, 1673.10400000, 15.79190000};
    ...
    while (true)
    {
        ...
        if (l_U575)
        {
            if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (IS_CHAR_SHOOTING( sub_3680() ))) AND (sub_3734( sub_3680() )))
            {
        ...
        if (NOT l_U576)
        {
            if (NOT l_U571[0])
            {
                ...
                {
                    if ((IS_CHAR_IN_ANY_CAR( l_U512[0] )) || (IS_CHAR_GETTING_IN_TO_A_CAR( l_U512[0] )))
                    {
                        if ((NOT (IS_CHAR_IN_ANY_CAR( sub_3680() ))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3680(), l_U512[0], 10.00000000, 10.00000000, 10.00000000, 0 )))
                        {
            ...
            if (NOT l_U571[1])
            {
                ...
                {
                    if ((IS_CHAR_IN_ANY_CAR( l_U512[1] )) || (IS_CHAR_GETTING_IN_TO_A_CAR( l_U512[1] )))
                    {
                        if ((NOT (IS_CHAR_IN_ANY_CAR( sub_3680() ))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3680(), l_U512[1], 10.00000000, 10.00000000, 10.00000000, 0 )))
                        {
            ...
            if (NOT l_U571[2])
            {
                ...
                {
                    if ((IS_CHAR_IN_ANY_CAR( l_U512[2] )) || (IS_CHAR_GETTING_IN_TO_A_CAR( l_U512[2] )))
                    {
                        if ((NOT (IS_CHAR_IN_ANY_CAR( sub_3680() ))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3680(), l_U512[2], 10.00000000, 10.00000000, 10.00000000, 0 )))
                        {
        ...
        if (l_U529)
        {
            ...
            if (((IS_CHAR_INJURED( l_U512[0] )) AND (IS_CHAR_INJURED( l_U512[1] ))) AND (IS_CHAR_INJURED( l_U512[2] )))
            {
                SETTIMERB( 0 );
        ...
        switch (l_U675)
        {
            ...
            while ((((((NOT (HAVE_ANIMS_LOADED( "missdwayne3" ))) || (NOT (HAS_MODEL_LOADED( 1168388225 )))) || (NOT (HAS_MODEL_LOADED( -1746774780 )))) || (NOT (HAS_MODEL_LOADED( 492147228 )))) || (NOT (HAS_MODEL_LOADED( -1926041127 )))) || (NOT (HAS_MODEL_LOADED( 1113677074 ))))
            {
                WAIT( 0 );
            }
            ...
            if (NOT g_U64769)
            {
                if ((NOT (IS_WANTED_LEVEL_GREATER( sub_2401(), 0 ))) AND (NOT (sub_25514( sub_3680() ))))
                {
            ...
            if (sub_3734( sub_3680() ))
            {
                ...
                else if (NOT l_U546)
                {
                    if (TIMERA() >= 7500)
                    {
                        if ((NOT (sub_33124( l_U669 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                        {
                ...
                if (NOT l_U537)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U512[2] ))) AND (NOT (IS_CHAR_INJURED( l_U522 ))))
                    {
                ...
                if (NOT l_U542)
                {
                    if ((LOCATE_CHAR_ANY_MEANS_2D( sub_3680(), 1148.27200000, 1674.10900000, 2.50000000, 2.50000000, 0 )) AND (NOT (IS_CHAR_INJURED( l_U501[6] ))))
                    {
                ...
                if (NOT l_U539[0])
                {
                    if (LOCATE_CHAR_ANY_MEANS_2D( sub_3680(), 1189.10900000, 1692.10500000, 2.50000000, 2.50000000, 0 ))
                    {
                        ...
                        if ((NOT (IS_CHAR_INJURED( l_U501[5] ))) AND (NOT (IS_CHAR_INJURED( l_U501[3] ))))
                        {
                        ...
                        if (LOCATE_CHAR_ANY_MEANS_3D( sub_3680(), 1198.46500000, 1696.40000000, 17.72180000, 1.30000000, 1.30000000, 1.00000000, 0 ))
                        {
                            ...
                            if (NOT (l_U644 == 3))
                            {
                                if (NOT (l_U644 == 1))
                                {
                                    if (NOT (l_U644 == 0))
                                    {
                                        if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2401(), l_U512[0] )) || (IS_PLAYER_TARGETTING_CHAR( sub_2401(), l_U512[0] )))
                                        {
                                            SAY_AMBIENT_SPEECH( l_U512[0], "GENERIC_FUCK_OFF", 1, 1, 0 );
                                            TASK_COMBAT( l_U512[0], sub_3680() );
                                            l_U532[2] = 1;
            ...
            {
                if (((NOT (DOES_BLIP_EXIST( l_U517[0] ))) AND (NOT (DOES_BLIP_EXIST( l_U517[1] )))) AND (NOT (DOES_BLIP_EXIST( l_U517[2] ))))
                {
...
void sub_1337()
{
    ...
    {
        if (((sub_1375( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
int sub_3734(unknown uParam0)
{
    ...
    if ((((iVar3 == (GET_HASH_KEY( "clampalbkrm" ))) || (iVar3 == (GET_HASH_KEY( "clamchangeroom" )))) || (iVar3 == (GET_HASH_KEY( "clammainroom" )))) || (iVar3 == (GET_HASH_KEY( "clamfronrm" ))))
    {
        return 1;
    }
    return 0;
    ...
    if (sub_3734( sub_3680() ))
    {
        ...
        for ( l_U641 = 1; l_U641 <= 2; l_U641++ )
        {
            ...
            if (NOT (IS_CHAR_INJURED( l_U512[l_U641] )))
            {
                ...
                {
                    if (((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2401(), l_U512[l_U641] )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U512[l_U641], sub_3680() ))) || ((IS_PLAYER_TARGETTING_CHAR( sub_2401(), l_U512[l_U641] )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U512[l_U641], sub_3680() ))))
                    {
                        if (NOT (l_U644 == 0))
                        {
                            l_U552 = 1;
        ...
        for ( l_U641 = 1; l_U641 <= 9; l_U641++ )
        {
            ...
            if (NOT (IS_CHAR_INJURED( l_U501[l_U641] )))
            {
                ...
                {
                    if (((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2401(), l_U501[l_U641] )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U501[l_U641], sub_3680() ))) || ((IS_PLAYER_TARGETTING_CHAR( sub_2401(), l_U501[l_U641] )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U501[l_U641], sub_3680() ))))
                    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U501[6] )))
        {
            if (NOT (l_U644 == 0))
            {
                if ((LOCATE_CHAR_ANY_MEANS_2D( sub_3680(), 1148.27200000, 1674.10900000, 2.50000000, 2.50000000, 0 )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U501[6], sub_3680() )))
                {
                    PRINTNL();
                    PRINTNL();
                    PRINTNL();
        ...
        if (((IS_CHAR_SHOOTING( sub_3680() )) || (IS_CHAR_ON_ANY_BIKE( sub_3680() ))) || (l_U552))
        {
            sub_2607( 0 );
...
int sub_25919(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3680() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3680() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_26434()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_36107()
{
    ...
    {
        case 0:
        if ((((TIMERA() >= 25000) || (NOT l_U531)) || (NOT l_U539[0])) || (NOT l_U542))
        {
            if (NOT (IS_CHAR_ON_ANY_BIKE( sub_3680() )))
            {
                if (sub_3734( sub_3680() ))
                {
                    ...
                    if ((HAS_MODEL_LOADED( 675415136 )) AND (HAS_MODEL_LOADED( 108773431 )))
                    {
                        ...
                        if ((sub_33382( sub_3680() )) || (LOCATE_CHAR_ANY_MEANS_2D( sub_3680(), 1163.52400000, 1677.46900000, 15.00000000, 15.00000000, 0 )))
                        {
        ...
        if (IS_VEH_DRIVEABLE( l_U526 ))
        {
            if ((NOT (IS_CHAR_INJURED( l_U512[2] ))) AND (NOT l_U548[2]))
            {
            ...
            else if ((NOT (IS_CHAR_INJURED( l_U512[0] ))) AND (NOT l_U548[0]))
            {
                CLEAR_CHAR_TASKS( l_U512[0] );
                SET_NEXT_DESIRED_MOVE_STATE( 4 );
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U512[0], 1 );
            ...
            else if ((NOT (IS_CHAR_INJURED( l_U512[1] ))) AND (NOT l_U548[1]))
            {
                CLEAR_CHAR_TASKS( l_U512[1] );
                SET_NEXT_DESIRED_MOVE_STATE( 4 );
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U512[1], 1 );
        ...
        if ((((l_U548[0]) AND (l_U548[1])) AND (l_U548[2])) AND (NOT (sub_3734( sub_3680() ))))
        {
            PRINTNL();
            PRINTNL();
            PRINTSTRING( "ALL IN" );
        ...
        if (IS_VEH_DRIVEABLE( l_U526 ))
        {
            if (((HAS_CAR_RECORDING_BEEN_LOADED( 877 )) AND (HAS_CAR_RECORDING_BEEN_LOADED( 878 ))) AND (NOT (IS_CHAR_IN_CAR( sub_3680(), l_U526 ))))
            {
                if (l_U559)
                {
                    GET_DRIVER_OF_CAR( l_U526, ref l_U516 );
        ...
        if (NOT (IS_CHAR_INJURED( l_U512[0] )))
        {
            if (NOT l_U553[0])
            {
                if (((((NOT (IS_VEH_DRIVEABLE( l_U526 ))) || (IS_CHAR_INJURED( l_U516 ))) || (NOT (IS_CHAR_IN_ANY_CAR( l_U512[0] )))) || (l_U516 == nil)) || (sub_43705()))
                {
            ...
            if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3680(), l_U512[0], 300.00000000, 300.00000000, 300.00000000, 0 ))) AND (NOT (IS_CHAR_ON_SCREEN( l_U512[0] ))))
            {
                if (sub_43989( 1, 1 ))
                {
                    PRINT_NOW( "GM2_INSTR4", 7500, 1 );
        ...
        if (NOT (IS_CHAR_INJURED( l_U512[1] )))
        {
            if (NOT l_U553[1])
            {
                if (((((NOT (IS_VEH_DRIVEABLE( l_U526 ))) || (IS_CHAR_INJURED( l_U516 ))) || (NOT (IS_CHAR_IN_ANY_CAR( l_U512[1] )))) || (l_U516 == nil)) || (sub_43705()))
                {
            ...
            if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3680(), l_U512[1], 300.00000000, 300.00000000, 300.00000000, 0 ))) AND (NOT (IS_CHAR_ON_SCREEN( l_U512[1] ))))
            {
                if (sub_43989( 1, 1 ))
                {
                    PRINT_NOW( "GM2_INSTR4", 7500, 1 );
        ...
        if (NOT (IS_CHAR_INJURED( l_U512[2] )))
        {
            if (NOT l_U553[2])
            {
                if (((((NOT (IS_VEH_DRIVEABLE( l_U526 ))) || (IS_CHAR_INJURED( l_U516 ))) || (NOT (IS_CHAR_IN_ANY_CAR( l_U512[2] )))) || (l_U516 == nil)) || (sub_43705()))
                {
            ...
            if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3680(), l_U512[2], 300.00000000, 300.00000000, 300.00000000, 0 ))) AND (NOT (IS_CHAR_ON_SCREEN( l_U512[2] ))))
            {
                if (sub_43989( 1, 1 ))
                {
                    PRINT_NOW( "GM2_INSTR4", 7500, 1 );
...
void sub_37581()
{
    if (NOT l_U560)
    {
        ...
        if ((NOT (IS_VEH_DRIVEABLE( l_U526 ))) || (l_U567))
        {
            if (IS_VEH_DRIVEABLE( l_U526 ))
            {
                if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U526 ))
...
void sub_40860(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3680() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_41028())) AND (iVar3 != 4))
    {
...
int sub_43705()
{
    if (IS_VEH_DRIVEABLE( l_U526 ))
    {
        if ((((CHECK_STUCK_TIMER( l_U526, 3, 60000 )) || (CHECK_STUCK_TIMER( l_U526, 2, 30000 ))) || (CHECK_STUCK_TIMER( l_U526, 1, 40000 ))) || (CHECK_STUCK_TIMER( l_U526, 0, 5000 )))
        {
            return 1;
        }
    }
