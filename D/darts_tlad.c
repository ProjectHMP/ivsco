...
void sub_206()
{
    ...
    if (l_U409)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_443() ))
        {
            ...
            if (l_U407)
            {
                if ((DOES_CHAR_EXIST( l_U262 )) AND (NOT (IS_CHAR_DEAD( l_U262 ))))
                {
                    if ((NOT (IS_CHAR_DEAD( sub_215() ))) AND (NOT (IS_CHAR_DEAD( l_U262 ))))
                    {
...
void sub_2654()
{
    if (NOT l_U432)
    {
        if ((NOT (IS_CONTROL_PRESSED( 2, 77 ))) AND (IS_CONTROL_PRESSED( 2, 78 )))
        {
            l_U432 = 1;
        }
        else
    ...
    if (l_U0 != 2)
    {
        if (l_U430)
        {
            ...
            if ((sub_2765()) AND ((l_U432) || (# -NULL-0xc27bfa())))
            {
                l_U393 = 0;
                l_U430 = 0;
                l_U431 = 0;
...
void sub_3012()
{
    ...
    if ((l_U260 > 359) || (l_U260 < 1))
    {
        sub_3380( 1151.53200000, 731.44900000, 34.91700000, 84, l_U300._fU0, l_U300._fU4, l_U300._fU8, 5, -1, 0 );
    }
    else
    {
    ...
    while ((((NOT (HAS_MODEL_LOADED( 127575244 ))) || (NOT (HAS_MODEL_LOADED( l_U261 )))) || (NOT (HAS_MODEL_LOADED( 2063078697 )))) || (NOT (HAS_MODEL_LOADED( -172899370 ))))
    {
        WAIT( 0 );
    }
        ...
        if (DOES_GROUP_EXIST( sub_841() ))
        {
            ...
            if (l_U297 > 0)
            {
                for ( l_U296 = 0; l_U296 < l_U297; l_U296++ )
                {
                    ...
                    if ((((NOT (IS_CHAR_INJURED( iVar2 ))) AND (NOT (l_U262 == iVar2))) AND (l_U370 < 2)) AND (sub_4626( iVar2 )))
                    {
                        l_U371[l_U370] = iVar2;
    ...
    for ( l_U296 = 0; l_U296 < 3; l_U296++ )
    {
        ...
        if (NOT (iVar2 == nil))
        {
            ...
            {
                if (((((NOT (l_U262 == iVar2)) AND (NOT (l_U371[0] == iVar2))) AND (NOT (l_U371[1] == iVar2))) AND (l_U370 < 2)) AND (sub_4626( iVar2 )))
                {
                    l_U371[l_U370] = iVar2;
...
int sub_4626(unknown uParam0)
{
    ...
    {
        if (((IS_CHAR_MODEL( uParam0, sub_4653( 1 ) )) || (IS_CHAR_MODEL( uParam0, sub_4653( 6 ) ))) || (IS_CHAR_MODEL( uParam0, sub_4653( 7 ) )))
        {
            return 1;
        }
    }
...
void sub_8140()
{
    ...
    while ((NOT bVar2) AND (NOT bVar3))
    {
        ...
        if (((iVar7 >= 1000) AND (IS_CONTROL_JUST_PRESSED( 2, 77 ))) AND (IS_SCREEN_FADED_IN()))
        {
            bVar3 = true;
        }
        else
...
void sub_16011()
{
    ...
    if (l_U331 == 1)
    {
        if (((IS_CONTROL_PRESSED( 2, 77 )) AND (l_U432)) || ((NOT IS_USING_CONTROLLER()) AND (IS_CONTROL_JUST_PRESSED( 2, 4 ))))
        {
            l_U1 = 3;
        }
    }
...
void sub_16173()
{
    ...
    else if (((IS_USING_CONTROLLER()) AND (NOT (IS_CONTROL_JUST_PRESSED( 2, 77 )))) || ((NOT IS_USING_CONTROLLER()) AND (NOT (IS_CONTROL_JUST_PRESSED( 2, 4 )))))
    {
        l_U432 = 1;
        l_U393 = 1;
        if (NOT l_U256)
        {
            ...
            if (((iVar2 - l_U255) > 12000) AND ((iVar2 - l_U255) < 15000))
            {
                sub_16935();
            }
        }
...
void sub_17659()
{
    if (((NOT l_U394) AND (NOT l_U395[0])) AND (l_U328[l_U331] < 80))
    {
        PRINT_HELP_FOREVER( "HELP_DOUBLE" );
        l_U395[0] = 1;
        l_U394 = 1;
    }
    if (((NOT l_U394) AND (l_U395[4])) AND (NOT l_U395[5]))
    {
        if (NOT l_U408)
        {
    ...
    if (((NOT l_U394) AND (l_U395[3])) AND (NOT l_U395[4]))
    {
        PRINT_HELP_FOREVER( "HELP_SPEED" );
        l_U395[4] = 1;
    }
    if (((NOT l_U394) AND (l_U395[2])) AND (NOT l_U395[3]))
    {
        PRINT_HELP_FOREVER( "HELP_STEADY" );
        l_U395[3] = 1;
    }
    if ((NOT l_U394) AND (NOT l_U395[2]))
    {
        if (# -NULL-0xc238b5( 5 ))
        {
...
void sub_18109()
{
    if ((IS_BUTTON_PRESSED( 0, 6 )) || ((NOT IS_USING_CONTROLLER()) AND (IS_CONTROL_PRESSED( 2, 1 ))))
    {
        l_U383 = 0.30000000;
    }
    else
    ...
    if ((IS_BUTTON_PRESSED( 0, 7 )) || ((NOT IS_USING_CONTROLLER()) AND (IS_CONTROL_PRESSED( 2, 2 ))))
    {
        if (l_U385)
        {
            if (TIMERA() > 1000)
...
void sub_24403()
{
    ...
    else if ((fVar2 > 0.12800000) AND (fVar2 < 0.14200000))
    {
        if (NOT l_U368)
        {
            PLAY_SOUND_FROM_OBJECT( l_U358, "DARTS_HIT_TRIPLE", l_U2[l_U331][l_U332]._fU0 );
    ...
    else if ((fVar2 > 0.21100000) AND (fVar2 < 0.22500000))
    {
        if (NOT l_U368)
        {
    ...
    if ((l_U2[l_U331][l_U332]._fU92 == 50) AND (l_U331 == 0))
    {
...
void sub_24557()
{
    ...
    {
        if ((((l_U2[l_U331][l_U332]._fU32._fU0 > (l_U2[l_U331][l_U296]._fU32._fU0 - 0.00800000)) AND (l_U2[l_U331][l_U332]._fU32._fU0 < (l_U2[l_U331][l_U296]._fU32._fU0 + 0.00800000))) AND (l_U2[l_U331][l_U332]._fU32._fU8 > (l_U2[l_U331][l_U296]._fU32._fU8 - 0.00800000))) AND (l_U2[l_U331][l_U332]._fU32._fU8 < (l_U2[l_U331][l_U296]._fU32._fU8 + 0.00800000)))
        {
            l_U368 = 1;
        }
    }
...
void sub_27914()
{
    ...
    if (((l_U333 == 2) || (l_U2[l_U331][l_U332]._fU92 == 50)) AND (l_U328[l_U331] == 0))
    {
        sub_28095();
    }
    else if (((l_U328[l_U331] == 1) || (l_U328[l_U331] < 0)) || ((l_U328[l_U331] == 0) AND (l_U333 != 2)))
    {
        if ((l_U328[l_U331] == 0) AND (l_U333 != 2))
        {
    ...
    if (NOT l_U369)
    {
        if (l_U331 == 0)
        {
            if (l_U332 < 2)
            {
                if ((((l_U328[l_U331] < 41) AND (l_U328[l_U331] > 0)) AND ((l_U328[l_U331] mod 2) == 0)) || (l_U328[l_U331] == 50))
                {
                    sub_36384();
                    l_U369 = 1;
                }
    ...
    {
        SETTIMERA( 0 );
        while ((TIMERA() < 600) AND (NOT (l_U1 == 3)))
        {
            WAIT( 0 );
            sub_16011();
        }
...
void sub_32588()
{
    ...
    l_U432 = 0;
    WAIT( 0 );
    while ((IS_MESSAGE_BEING_DISPLAYED()) AND (NOT bVar2))
    {
        WAIT( 0 );
        if (NOT (IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE( l_U257 )))
        {
...
void sub_38598()
{
    ...
    if (l_U247)
    {
        ...
        else
        {
            ...
            else if ((fVar5 > 0.12800000) AND (fVar5 < 0.14200000))
            {
                l_U333 = 3;
            }
            else if ((fVar5 > 0.21100000) AND (fVar5 < 0.22600000))
            {
                l_U333 = 2;
            }
            else
...
void sub_40385()
{
    if ((NOT (IS_SPECIFIC_CAM_INTERPOLATING( l_U294 ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ANOTHER_GAME" ))))
    {
