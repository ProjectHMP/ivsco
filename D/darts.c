...
void sub_2368()
{
    ...
    if (l_U0 != 2)
    {
        if (l_U419)
        {
            ...
            if ((sub_2479()) AND ((l_U421) || (# -NULL-0xc27bfa())))
            {
                l_U382 = 0;
                l_U419 = 0;
                l_U420 = 0;
...
void sub_2726()
{
    ...
    {
        sub_3090( 1151.53200000, 731.44900000, 34.91700000, 84, l_U300._fU0, l_U300._fU4, l_U300._fU8, 5, -1, 0 );
    }
    else
    {
    ...
    while ((((NOT (HAS_MODEL_LOADED( 937660317 ))) || (NOT (HAS_MODEL_LOADED( l_U261 )))) || (NOT (HAS_MODEL_LOADED( 2063078697 )))) || (NOT (HAS_MODEL_LOADED( -172899370 ))))
    {
        WAIT( 0 );
    }
...
void sub_14806()
{
    ...
    if (l_U331 == 1)
    {
        if (((IS_CONTROL_PRESSED( 2, 77 )) AND (l_U421)) || ((NOT IS_USING_CONTROLLER()) AND (IS_CONTROL_JUST_PRESSED( 2, 4 ))))
        {
            l_U1 = 3;
        }
    }
...
void sub_16454()
{
    if (((NOT l_U383) AND (NOT l_U384[0])) AND (l_U328[l_U331] < 80))
    {
        PRINT_HELP_FOREVER( "HELP_DOUBLE" );
        l_U384[0] = 1;
        l_U383 = 1;
    }
    if (((NOT l_U383) AND (l_U384[4])) AND (NOT l_U384[5]))
    {
        if (NOT l_U397)
        {
    ...
    if (((NOT l_U383) AND (l_U384[3])) AND (NOT l_U384[4]))
    {
        PRINT_HELP_FOREVER( "HELP_SPEED" );
        l_U384[4] = 1;
    }
    if (((NOT l_U383) AND (l_U384[2])) AND (NOT l_U384[3]))
    {
        PRINT_HELP_FOREVER( "HELP_STEADY" );
        l_U384[3] = 1;
    }
    if ((NOT l_U383) AND (NOT l_U384[2]))
    {
        if (# -NULL-0xc238b5( 5 ))
        {
