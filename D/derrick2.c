void main()
{
    ...
    while (true)
    {
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 30 )) AND (NOT l_U1747))
        {
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 37 )) AND (NOT l_U1771))
        {
            if (IS_VEH_DRIVEABLE( l_U1630._fU148._fU0 ))
            {
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 44 )) AND (NOT l_U1812))
        {
...
void sub_2766()
{
    ...
    {
        if (((sub_2804( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3668()
{
    ...
    sub_4295( 0 );
    SET_CAR_GENERATORS_ACTIVE_IN_AREA( -788.72000000, 866.61680000, 10.00000000, -777.25190000, 832.35600000, -10.00000000, 1 );
    sub_6852();
...
void sub_7245()
{
    if (NOT l_U1769)
    {
        ...
        else if (l_U1824[1] == 1)
        {
            if (IS_VEH_DRIVEABLE( l_U1312._fU0 ))
            {
                if (((sub_8693( ref l_U1162._fU0 )) > 200) AND (NOT (IS_CAR_ON_SCREEN( l_U1312._fU0 ))))
                {
                    if (l_U1751[0])
                    {
                        EXPLODE_CAR( l_U1312._fU0, 1, 0 );
...
int sub_9329()
{
    if (DOES_VEHICLE_EXIST( l_U1296._fU0 ))
    {
        if (IS_VEH_DRIVEABLE( l_U1296._fU0 ))
        {
            ...
            if (((CHECK_STUCK_TIMER( l_U1296._fU0, 3, 60000 )) || (CHECK_STUCK_TIMER( l_U1296._fU0, 2, 30000 ))) || (CHECK_STUCK_TIMER( l_U1296._fU0, 1, 40000 )))
            {
                sub_3755( 0 );
                CLEAR_PRINTS();
...
void sub_12123()
{
    if (sub_12133( 1 ))
    {
        ...
        SET_CAR_GENERATORS_ACTIVE_IN_AREA( -788.72000000, 866.61680000, 10.00000000, -777.25190000, 832.35600000, -10.00000000, 0 );
        l_U1137 = 3;
    }
    return;
}
...
void sub_15622()
{
    ...
    {
        case 0:
        CLEAR_AREA( -784.29520000, 873.75900000, -1.22770000, 200.00000000, 1 );
        ...
        SET_CAM_POS( l_U1967, -790.58620000, 905.32200000, 5.02953300 );
        ...
        SET_CAM_POS( l_U1969, -790.58620000, 905.32200000, 5.02953300 );
        ...
        if (IS_SCREEN_FADED_OUT())
        {
            ...
            LOAD_ALL_OBJECTS_NOW();
            if ((IS_VEH_DRIVEABLE( l_U1296._fU0 )) AND (NOT (IS_CHAR_INJURED( l_U1150._fU0 ))))
            {
                ANCHOR_BOAT( l_U1296._fU0, 0 );
        ...
        else
        {
            ...
            if ((NOT (IS_CHAR_INJURED( l_U1150._fU0 ))) AND (NOT (IS_CAR_DEAD( l_U1296._fU0 ))))
            {
...
void sub_22709()
{
    ...
    if ((IS_KEYBOARD_KEY_PRESSED( 36 )) AND (NOT l_U1727[1]))
    {
...
void sub_22718()
{
    ...
    {
        case 0:
        if ((IS_CHAR_SITTING_IN_CAR( sub_4997(), l_U1296._fU0 )) AND (NOT (CHECK_STUCK_TIMER( l_U1296._fU0, 0, 250 ))))
        {
        ...
        else
        {
            ...
            if (NOT l_U1780)
            {
                if ((NOT (IS_CHAR_SITTING_IN_CAR( sub_4997(), l_U1296._fU0 ))) AND (NOT (CHECK_STUCK_TIMER( l_U1296._fU0, 0, 0 ))))
                {
        ...
        break;
        case 11:
        if (((IS_CHAR_SITTING_IN_CAR( sub_4997(), l_U1296._fU0 )) || ((sub_8693( ref l_U1162._fU0 )) < 5.00000000)) AND (NOT (CHECK_STUCK_TIMER( l_U1296._fU0, 0, 250 ))))
        {
...
{
    if ((IS_CHAR_SITTING_IN_CAR( sub_4997(), (uParam0^) )) AND (NOT (CHECK_STUCK_TIMER( (uParam0^), 0, 250 ))))
    {
        (uParam5^) = 0;
        if ((uParam4^))
        {
    ...
    else
    {
        ...
        if (NOT (uParam5^))
        {
            if ((NOT (IS_CHAR_SITTING_IN_CAR( sub_4997(), (uParam0^) ))) AND (NOT (CHECK_STUCK_TIMER( (uParam0^), 0, 0 ))))
            {
...
void sub_32472()
{
    ...
    if ((((IS_VEH_DRIVEABLE( l_U1312._fU0 )) AND (IS_VEH_DRIVEABLE( l_U1296._fU0 ))) AND (NOT (IS_CHAR_DEAD( l_U1150._fU0 )))) AND (NOT (IS_CHAR_DEAD( l_U1162._fU0 ))))
    {
        switch (l_U1139)
        {
            case 1:
...
void sub_35936()
{
    l_U1024[0] = {-423.82250000, 1866.75600000, 0.04160000};
    l_U708[0] = 0.01730000;
    l_U720[0] = 0.00620000;
    l_U732[0] = -0.19140000;
    l_U744[0] = 0.98130000;
...
void sub_36736(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_4997() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_36904())) AND (iVar3 != 4))
    {
        ...
        if (IS_VEH_DRIVEABLE( l_U1312._fU0 ))
        {
            ...
            switch (l_U1141)
            {
                ...
                if (sub_37538( 4 ))
                {
                    ...
                    if (NOT l_U1804)
                    {
                        if ((IS_CAR_IN_WATER( l_U1630._fU148._fU0 )) || (sub_9790( ref l_U1829, 5000 )))
                        {
                            EXPLODE_CAR( l_U1630._fU148._fU0, 1, 0 );
                            l_U1804 = 1;
                        }
                    }
                    if ((sub_9790( ref l_U1829, 7500 )) AND (NOT (sub_20711( l_U2027[0] ))))
                    {
                        sub_65179( 1 );
                        l_U1137 = 7;
                    }
...
int sub_37538(unknown uParam0)
{
    ...
    for ( I = 0; I <= 3; I++ )
    {
        if (DOES_VEHICLE_EXIST( l_U1109[I] ))
        {
            if ((NOT (IS_VEH_DRIVEABLE( l_U1109[I] ))) || (IS_CHAR_INJURED( l_U1199[I]._fU0._fU0 )))
            {
                if (l_U1777)
                {
    ...
    for ( I = 0; I <= 0; I++ )
    {
        ...
        {
            if ((NOT (IS_VEH_DRIVEABLE( l_U1360[I]._fU0._fU0 ))) || (IS_CHAR_INJURED( l_U1360[I]._fU64._fU0 )))
            {
...
void sub_39471()
{
    ...
    else
    {
        ...
        if ((l_U1162._fU44 == 7) || (LOCATE_CHAR_ANY_MEANS_3D( l_U1162._fU0, 645.73030000, 1162.66700000, 0.00000000, 5.00000000, 5.00000000, 5.00000000, 0 )))
        {
...
int sub_39990(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( uParam0 )))
    {
        ...
        if ((uVar3._fU0 >= l_U196._fU0._fU4) AND (uVar3._fU0 <= l_U196._fU0._fU8))
        {
            if ((uVar3._fU4 >= l_U196._fU16._fU4) AND (uVar3._fU4 <= l_U196._fU16._fU8))
            {
...
void sub_40656()
{
    ...
    if (NOT l_U1774)
    {
        switch (l_U1148)
        {
            ...
            if (NOT (IS_CHAR_SITTING_IN_CAR( sub_4997(), l_U1296._fU0 )))
            {
                if (((IS_CONTROL_PRESSED( 2, 6 )) || (IS_CONTROL_PRESSED( 2, 87 ))) AND ((IS_BUTTON_PRESSED( 0, 2 )) || (iVar2 != 0)))
                {
                    CLEAR_HELP();
            ...
            if (NOT (IS_CHAR_SITTING_IN_CAR( sub_4997(), l_U1296._fU0 )))
            {
                if (((IS_CONTROL_PRESSED( 2, 6 )) || (IS_CONTROL_PRESSED( 2, 87 ))) AND (IS_CONTROL_PRESSED( 2, 4 )))
                {
                    CLEAR_HELP();
                    l_U1774 = 1;
                }
...
void sub_44845(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U596)
    {
        ...
        if ((l_U834 == 0) || (IS_SCREEN_FADED_OUT()))
        {
            iVar10 = 1;
        }
...
void sub_46727(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 10; I++ )
        {
            ...
            if (l_U865[I] == 0)
            {
                if (((l_U854[I] > 0) AND (l_U854[I] < 3000)) AND (NOT (l_U928[I] == 0)))
                {
                    if (NOT l_U584)
                    {
            ...
            if (l_U865[I] == 2)
            {
                if (HAS_MODEL_LOADED( l_U928[I] ))
                {
                    if (NOT (DOES_VEHICLE_EXIST( l_U1076[I] )))
                    {
                        ...
                        {
                            bVar17 = false;
                            if ((NOT (sub_46254( l_U962[I], 5.00000000, 1120403456 ))) AND (NOT (sub_48035( l_U962[I] ))))
                            {
                                bVar17 = true;
                            }
                            if (l_U610)
                        ...
                        if (10 > l_U911)
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U854[I] ))
                            {
                                if (fVar14 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U854[I] )))
                                {
                                    ...
                                    if ((NOT (sub_46254( uVar8, 5.00000000, 1120403456 ))) AND (sub_46254( uVar11, 5.00000000, 1120403456 )))
                                    {
                                        sub_47125( I, 1090519040 );
                                    }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1076[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_3698() ))
                                {
                                    if ((((IS_CHAR_TOUCHING_VEHICLE( sub_4997(), l_U1076[I] )) AND (NOT l_U590)) AND (NOT l_U587)) AND (NOT l_U599))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_4997() ))
                                        {
                                            bVar16 = false;
                                    ...
                                    else if ((sub_50892( uParam0, l_U1076[I] )) AND (NOT l_U599))
                                    {
                                        sub_50765( l_U1076[I] );
                                        l_U865[I]++;
                                    }
        ...
        if (IS_PLAYER_PLAYING( sub_3698() ))
        {
            ...
            for ( I = 0; I < 10; I++ )
            {
                ...
                if (DOES_VEHICLE_EXIST( l_U1076[I] ))
                {
                    if (IS_VEH_DRIVEABLE( l_U1076[I] ))
                    {
                        if ((sub_52345( l_U1076[I], (uParam0^) )) || (sub_52345( l_U1076[I], uVar6 )))
                        {
            ...
            if (l_U900[I] == 1)
            {
                if (6 > l_U914)
                {
                    if (HAS_MODEL_LOADED( l_U939[I] ))
                    {
                        ...
                        {
                            if (((NOT (sub_46254( l_U993[I], 5.00000000, 1120403456 ))) || (l_U584)) || (l_U610))
                            {
                                if (l_U603)
                                {
...
void sub_54191(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 11; I++ )
        {
            if (((l_U876[I] > 0) AND (l_U876[I] < 3000)) AND (NOT (l_U950[I] == 0)))
            {
                if (l_U888[I] == 0)
                {
                    if (NOT l_U584)
                ...
                if (l_U888[I] == 2)
                {
                    if (HAS_MODEL_LOADED( l_U950[I] ))
                    {
                        if (NOT (DOES_VEHICLE_EXIST( l_U1109[I] )))
                        {
                            ...
                            if (bVar15)
                            {
                                if ((NOT (sub_46254( l_U1024[I], 5.00000000, 1120403456 ))) || (l_U610))
                                {
                            ...
                            if (11 > l_U913)
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U876[I] ))
                                {
                                    if (fVar13 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U876[I] )))
                                    {
                                        ...
                                        if (((NOT (sub_46254( uVar7, 5.00000000, 1120403456 ))) AND (sub_46254( uVar10, 5.00000000, 1120403456 ))) AND (NOT l_U610))
                                        {
                                            l_U913++;
                                            l_U888[I]++;
                                        }
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1109[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_3698() ))
                                    {
                                        if (((IS_CHAR_TOUCHING_VEHICLE( sub_4997(), l_U1109[I] )) AND (NOT l_U590)) AND (NOT l_U587))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_4997() ))
                                            {
                                                bVar15 = false;
...
int sub_57915(unknown uParam0, unknown uParam1)
{
    ...
    if (((l_U925 == 0) AND (l_U926 == 0)) AND (l_U927 == 0))
    {
        l_U587 = 0;
        l_U584 = 0;
        l_U613 = 0;
...
void sub_62318()
{
    switch (l_U1854)
    {
        ...
        l_U1908[1] = {610.64510000, 1186.77700000, 20.00000000};
        break;
        case 15:
        case 16:
        case 20:
...
void sub_66121()
{
    if (NOT l_U1762)
    {
        if (((sub_60645( ref l_U1312._fU0 )) > 60) AND ((sub_60645( ref l_U1312._fU0 )) < 65))
        {
            l_U1846 = 25;
            l_U1847 = 25;
        }
        else if (((sub_60645( ref l_U1312._fU0 )) > 65) AND ((sub_60645( ref l_U1312._fU0 )) < 70))
        {
            l_U1846 = 40;
            l_U1847 = 40;
        }
        else if (((sub_60645( ref l_U1312._fU0 )) > 70) AND ((sub_60645( ref l_U1312._fU0 )) < 75))
        {
            l_U1846 = 55;
            l_U1847 = 55;
        }
        else if (((sub_60645( ref l_U1312._fU0 )) > 75) AND ((sub_60645( ref l_U1312._fU0 )) < 80))
        {
            l_U1846 = 65;
            l_U1847 = 65;
        }
        else if (((sub_60645( ref l_U1312._fU0 )) > 80) AND ((sub_60645( ref l_U1312._fU0 )) < 85))
        {
            l_U1846 = 75;
            l_U1847 = 75;
        }
        else if (((sub_60645( ref l_U1312._fU0 )) > 85) AND ((sub_60645( ref l_U1312._fU0 )) < 90))
        {
            l_U1846 = 85;
            l_U1847 = 85;
        }
...
float sub_68063(unknown uParam0, unknown uParam1)
{
    ...
    Result = 0.00000000;
    if ((NOT (IS_CAR_DEAD( (uParam0^) ))) AND (NOT (IS_CAR_DEAD( (uParam1^) ))))
    {
        GET_CAR_COORDINATES( (uParam0^), ref vVar4.x, ref vVar4.y, ref vVar4.z );
        GET_CAR_COORDINATES( (uParam1^), ref vVar7.x, ref vVar7.y, ref vVar7.z );
...
void sub_68396()
{
    ...
    switch (l_U1146)
    {
        ...
        if (sub_12133( 1 ))
        {
            ...
            if (((NOT (IS_CHAR_DEAD( l_U1150._fU0 ))) AND (NOT (IS_CAR_DEAD( l_U1312._fU0 )))) AND (NOT (IS_CAR_DEAD( l_U1296._fU0 ))))
            {
                ANCHOR_BOAT( l_U1312._fU0, 0 );
                if (IS_PED_ATTACHED_TO_ANY_CAR( l_U1162._fU0 ))
                {
                ...
                CREATE_CAM( 14, ref l_U1967 );
                SET_CAM_POS( l_U1967, 1014.27400000, 1577.05700000, 5.70122400 );
                ...
                SET_CAM_FOV( l_U1970, 39.00002000 );
                ...
                SET_CAM_FOV( l_U1971, 39.30001000 );
                CREATE_CAM( 14, ref l_U1972 );
                SET_CAM_POS( l_U1972, 1014.27400000, 1577.05700000, 5.70122400 );
                ...
                SET_CAM_POS( l_U1974, 1022.75300000, 1572.71300000, 4.56189000 );
        ...
        if (IS_SCREEN_FADED_OUT())
        {
            if (sub_9790( ref l_U1829, 1500 ))
            {
                ...
                if ((((NOT (IS_CHAR_DEAD( l_U1162._fU0 ))) AND (NOT (IS_CHAR_DEAD( l_U1150._fU0 )))) AND (NOT (IS_CHAR_DEAD( l_U1174[0]._fU0 )))) AND (NOT (IS_CHAR_DEAD( l_U1174[1]._fU0 ))))
                {
                    CLEAR_CHAR_TASKS( sub_4997() );
        ...
        if (IS_SCREEN_FADED_OUT())
        {
            ...
            if (IS_CHAR_IN_ANY_BOAT( sub_4997() ))
            {
                WARP_CHAR_FROM_CAR_TO_COORD( sub_4997(), 1117.46400000, 1527.93500000, 15.57810000 );
            }
            else
            {
                SET_CHAR_COORDINATES( sub_4997(), 1117.46400000, 1527.93500000, 15.57810000 );
            }
...
void sub_85785()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U1150._fU0 )))
    {
        switch (l_U1149)
        {
            ...
            break;
            case 3:
            if ((sub_9790( ref l_U1829, 3000 )) || (l_U1824[3] >= 1))
            {
                if (NOT IS_SCREEN_FADED_OUT())
                {
                    if (NOT IS_SCREEN_FADING_OUT())
