...
int sub_970()
{
    if (((((IS_PLAYER_PLAYING( sub_979() )) AND (NOT IS_MINIGAME_IN_PROGRESS())) AND (NOT IS_PAUSE_MENU_ACTIVE())) AND (NOT sub_1035())) AND (NOT sub_1144()))
    {
        return 1;
    }
    return 0;
...
int sub_1035()
{
    if (l_U300 == 1)
    {
        ...
        if ((l_U304 > 1000) AND (g_U12379 == 1))
        {
            return 1;
        }
    }
    if ((g_U12379 == 1) AND (l_U300 == 0))
    {
        return 1;
    }
    return 0;
