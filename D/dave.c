                ...
                while (true)
                {
                    ...
                    if (NOT l_U572)
                    {
                        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
                        {
                            ...
                            {
                                sub_2463( ref l_U255 );
                                if ((sub_2549( ref l_U539, 0 )) || (sub_2659( ref l_U539, 22.00000000, 0 )))
                                {
                                    sub_3034();
                                }
                                switch (l_U563)
...
void sub_3084()
{
    switch (l_U564)
    {
        ...
        if (NOT l_U571)
        {
            if ((((HAS_MODEL_LOADED( l_U544 )) AND (HAVE_ANIMS_LOADED( "MISSDAVE" ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 1899 ))) AND (HAVE_ANIMS_LOADED( "Gestures@Niko" )))
            {
...
void sub_11550()
{
    if ((((sub_11569( ref l_U551, 50.00000000, 0 )) || ((sub_11792( sub_2270(), ref l_U608 )) < 50.00000000)) || (sub_2549( ref l_U546, 0 ))) || (sub_11934( ref l_U551, 1000 )))
    {
        ...
        TASK_CAR_DRIVE_TO_COORD_NOT_AGAINST_TRAFFIC( 0, l_U551, -501.36790000, 146.36370000, 7.38680000, 20.00000000, 0, l_U556, 2, 40.00000000, -1 );
    ...
    if ((IS_KEYBOARD_KEY_PRESSED( 36 )) AND (NOT l_U574[0]))
    {
...
int sub_11934(unknown uParam0, int iParam1)
{
    ...
    if (DOES_VEHICLE_EXIST( (uParam0^) ))
    {
        if (IS_VEH_DRIVEABLE( (uParam0^) ))
        {
            ...
            if (((((GET_PETROL_TANK_HEALTH( (uParam0^) )) < iParam1) || ((GET_ENGINE_HEALTH( (uParam0^) )) < iParam1)) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( (uParam0^), sub_2270() ))) || (iVar4 < iParam1))
            {
                return 1;
            }
        }
...
void sub_14585(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_2270() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_805())) AND (iVar3 != 4))
    {
...
void sub_15234()
{
    ...
    {
        if (((((l_U560 < 400.00000000) || (l_U559 < 400.00000000)) || (l_U558 < 400.00000000)) || (sub_15556( sub_2270(), ref l_U551 ))) || (sub_15616( ref l_U551 )))
        {
            ...
            sub_15843();
            sub_15894();
            if ((sub_13924( ref l_U590, 2500 )) || (sub_15556( sub_2270(), ref l_U551 )))
            {
                sub_16030();
                return;
            }
    ...
    {
        if (((l_U560 < 400.00000000) || (l_U559 < 400.00000000)) || (l_U558 < 400.00000000))
        {
            if (IS_CHAR_SITTING_IN_CAR( l_U546, l_U551 ))
            {
                CLEAR_CHAR_TASKS( l_U546 );
    ...
    if (NOT l_U583)
    {
        ...
        {
            case 0:
            if ((sub_11934( ref l_U551, 1000 )) || (sub_16931( ref l_U546, ref l_U549, 0 )))
            {
                l_U569 = 5;
            }
...
int sub_16931(unknown uParam0, unknown uParam1, boolean bParam2)
{
    ...
    if (DOES_CHAR_EXIST( (uParam0^) ))
    {
        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
        {
            ...
            if (bParam2)
            {
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^), sub_2270(), 1 )) || (iVar5 < (uParam1^)))
                {
                    return 1;
                }
            }
            else if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^), sub_2270(), 0 )) || (iVar5 < (uParam1^)))
            {
                return 1;
            }
        }
