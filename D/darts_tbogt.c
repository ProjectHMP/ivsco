...
void sub_218()
{
    ...
    if (l_U410)
    {
        ...
        if (IS_PLAYER_PLAYING( sub_227() ))
        {
            ...
            if (l_U408)
            {
                if ((DOES_CHAR_EXIST( l_U264 )) AND (NOT (IS_CHAR_DEAD( l_U264 ))))
                {
                    if ((NOT (IS_CHAR_DEAD( sub_270() ))) AND (NOT (IS_CHAR_DEAD( l_U264 ))))
                    {
...
void sub_2787()
{
    ...
    if (l_U2 != 2)
    {
        if (l_U431)
        {
            ...
            if ((sub_2898()) AND ((l_U433) || (# -NULL-0xc27bfa())))
            {
                l_U394 = 0;
                l_U431 = 0;
                l_U432 = 0;
...
void sub_3145()
{
    ...
    if ((l_U262 > 359) || (l_U262 < 1))
    {
        sub_3609( 1151.53200000, 731.44900000, 34.91700000, 84, l_U302._fU0, l_U302._fU4, l_U302._fU8, 5, -1, 0 );
    }
    else
    {
    ...
    while (((NOT (HAS_MODEL_LOADED( l_U263 ))) || (NOT (HAS_MODEL_LOADED( 2063078697 )))) || (NOT (HAS_MODEL_LOADED( -172899370 ))))
    {
        WAIT( 0 );
    }
        ...
        if (DOES_GROUP_EXIST( sub_838() ))
        {
            ...
            if (l_U299 > 0)
            {
                for ( l_U298 = 0; l_U298 < l_U299; l_U298++ )
                {
                    ...
                    if ((((NOT (IS_CHAR_INJURED( iVar2 ))) AND (NOT (l_U264 == iVar2))) AND (l_U372 < 2)) AND (sub_4779( iVar2 )))
                    {
                        l_U373[l_U372] = iVar2;
    ...
    for ( l_U298 = 0; l_U298 < 3; l_U298++ )
    {
        ...
        if (NOT (iVar2 == nil))
        {
            ...
            {
                if (((((NOT (l_U264 == iVar2)) AND (NOT (l_U373[0] == iVar2))) AND (NOT (l_U373[1] == iVar2))) AND (l_U372 < 2)) AND (sub_4779( iVar2 )))
                {
                    l_U373[l_U372] = iVar2;
...
int sub_4779(unknown uParam0)
{
    ...
    {
        if (((IS_CHAR_MODEL( uParam0, sub_4806( 7 ) )) || (IS_CHAR_MODEL( uParam0, sub_4806( 1 ) ))) || (IS_CHAR_MODEL( uParam0, sub_4806( 3 ) )))
        {
            return 1;
        }
    }
...
void sub_16495()
{
    ...
    if (l_U333 == 1)
    {
        if (((IS_CONTROL_PRESSED( 2, 77 )) AND (l_U433)) || ((NOT IS_USING_CONTROLLER()) AND (IS_CONTROL_JUST_PRESSED( 2, 4 ))))
        {
            l_U3 = 3;
        }
    }
...
void sub_16657()
{
    ...
    else if (((IS_USING_CONTROLLER()) AND (NOT (IS_CONTROL_JUST_PRESSED( 2, 77 )))) || ((NOT IS_USING_CONTROLLER()) AND (NOT (IS_CONTROL_JUST_PRESSED( 2, 4 )))))
    {
        ...
        if (NOT l_U258)
        {
            ...
            if (((iVar2 - l_U257) > 12000) AND ((iVar2 - l_U257) < 15000))
            {
                sub_17419();
            }
        }
...
void sub_18143()
{
    if (((NOT l_U395) AND (NOT l_U396[0])) AND (l_U330[l_U333] < 80))
    {
        PRINT_HELP_FOREVER( "HELP_DOUBLE" );
        l_U396[0] = 1;
        l_U395 = 1;
    }
    if (((NOT l_U395) AND (l_U396[4])) AND (NOT l_U396[5]))
    {
        if (NOT l_U409)
        {
    ...
    if (((NOT l_U395) AND (l_U396[3])) AND (NOT l_U396[4]))
    {
        PRINT_HELP_FOREVER( "HELP_SPEED" );
        l_U396[4] = 1;
    }
    if (((NOT l_U395) AND (l_U396[2])) AND (NOT l_U396[3]))
    {
        PRINT_HELP_FOREVER( "HELP_STEADY" );
        l_U396[3] = 1;
    }
    if ((NOT l_U395) AND (NOT l_U396[2]))
    {
        if (# -NULL-0xc238b5( 5 ))
        {
...
void sub_24887()
{
    ...
    if ((l_U4[l_U333][l_U334]._fU92 == 50) AND (l_U333 == 0))
    {
...
void sub_25041()
{
    ...
    {
        if ((((l_U4[l_U333][l_U334]._fU32._fU0 > (l_U4[l_U333][l_U298]._fU32._fU0 - 0.00800000)) AND (l_U4[l_U333][l_U334]._fU32._fU0 < (l_U4[l_U333][l_U298]._fU32._fU0 + 0.00800000))) AND (l_U4[l_U333][l_U334]._fU32._fU8 > (l_U4[l_U333][l_U298]._fU32._fU8 - 0.00800000))) AND (l_U4[l_U333][l_U334]._fU32._fU8 < (l_U4[l_U333][l_U298]._fU32._fU8 + 0.00800000)))
        {
            l_U370 = 1;
        }
    }
...
void sub_28398()
{
    ...
    if (((l_U335 == 2) || (l_U4[l_U333][l_U334]._fU92 == 50)) AND (l_U330[l_U333] == 0))
    {
        sub_28579();
    }
    else if (((l_U330[l_U333] == 1) || (l_U330[l_U333] < 0)) || ((l_U330[l_U333] == 0) AND (l_U335 != 2)))
    {
        if ((l_U330[l_U333] == 0) AND (l_U335 != 2))
        {
    ...
    if (NOT l_U371)
    {
        if (l_U333 == 0)
        {
            if (l_U334 < 2)
            {
                if ((((l_U330[l_U333] < 41) AND (l_U330[l_U333] > 0)) AND ((l_U330[l_U333] mod 2) == 0)) || (l_U330[l_U333] == 50))
                {
                    sub_36766();
                    l_U371 = 1;
                }
    ...
    {
        SETTIMERA( 0 );
        while ((TIMERA() < 600) AND (NOT (l_U3 == 3)))
        {
            WAIT( 0 );
            sub_16495();
        }
...
void sub_40767()
{
    if ((NOT (IS_SPECIFIC_CAM_INTERPOLATING( l_U296 ))) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ANOTHER_GAME" ))))
    {
