void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U736)
        {
            ...
            while (((((((NOT (HAS_MODEL_LOADED( 1203311498 ))) || (NOT (HAS_MODEL_LOADED( -881358690 )))) || (NOT (HAS_MODEL_LOADED( 88667657 )))) || (NOT (HAVE_ANIMS_LOADED( "missdwayne1" )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 874 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 875 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 881 ))))
            {
                WAIT( 0 );
            }
            ...
            if (l_U705)
            {
                if ((sub_5237()) AND (IS_SCREEN_FADED_IN()))
                {
                    l_U737 = 15;
                    ...
                    if (((NOT (IS_CHAR_INJURED( l_U661 ))) AND (NOT (IS_CHAR_INJURED( l_U662 )))) AND (IS_VEH_DRIVEABLE( l_U664 )))
                    {
            ...
            switch (l_U737)
            {
                ...
                if (LOCATE_CHAR_ANY_MEANS_3D( sub_3071(), l_U677._fU0, l_U677._fU4, l_U677._fU8, 2.50000000, 2.50000000, 2.50000000, 1 ))
                {
                    if (sub_6426( 1, 1 ))
                    {
                        ...
                        LOAD_ALL_OBJECTS_NOW();
                        while ((((NOT (HAS_MODEL_LOADED( 584879743 ))) || (NOT (HAS_MODEL_LOADED( -1685021548 )))) || (NOT (HAS_MODEL_LOADED( -685276541 )))) || (NOT (HAVE_ANIMS_LOADED( "gestures@niko" ))))
                        {
                            WAIT( 0 );
                        }
                ...
                if (TIMERA() > 1000)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U662 ))) AND (NOT (IS_CHAR_INJURED( l_U661 ))))
                    {
                ...
                if (TIMERA() > 4500)
                {
                    if ((((HAS_MODEL_LOADED( -685276541 )) AND (HAS_MODEL_LOADED( -1685021548 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 874 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 875 )))
                    {
                ...
                break;
                case 4:
                if ((TIMERA() > 5500) AND (NOT (IS_CHAR_INJURED( l_U662 ))))
                {
                ...
                if (TIMERA() > 2000)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U662 ))) AND (IS_VEH_DRIVEABLE( l_U664 )))
                    {
            ...
            if (sub_15172( sub_3071() ))
            {
                ...
                if (l_U722)
                {
                    ...
                    {
                        if ((DOES_CHAR_EXIST( l_U662 )) AND (DOES_VEHICLE_EXIST( l_U664 )))
                        {
            ...
            else if (NOT (IS_CHAR_FATALLY_INJURED( l_U661 )))
            {
                if (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_3071(), l_U661, 20.00000000, 20.00000000, 0 )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U662 )))
                    {
                        if ((NOT (IS_CHAR_ON_SCREEN( l_U661 ))) || (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_3071(), l_U662, 30.00000000, 30.00000000, 0 )))
                        {
            ...
            if (NOT l_U709)
            {
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_10838( l_U729 ))))
                {
            ...
            if (NOT l_U712)
            {
                ...
                {
                    if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U662, sub_3071(), 0 )) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U662 )))) || (NOT (IS_VEH_DRIVEABLE( l_U664 ))))
                    {
            ...
            if (NOT (IS_WANTED_LEVEL_GREATER( sub_3928(), 0 )))
            {
                ...
                if (NOT (IS_CHAR_INJURED( l_U663 )))
                {
                    ...
                    if ((LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_3071(), l_U663, 10, 10, 0 )) AND (NOT (iVar3 == nil)))
                    {
                        if (IS_CHAR_IN_ANY_CAR( sub_3071() ))
                        {
                            sub_6733();
...
void sub_1480()
{
    ...
    {
        if (((sub_1518( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_6733()
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3071() )) || (IS_CHAR_ON_ANY_BIKE( sub_3071() )))
    {
...
void sub_13015()
{
    ...
    if (NOT l_U721)
    {
        ...
        else if ((NOT (IS_CHAR_INJURED( l_U662 ))) AND (IS_VEH_DRIVEABLE( l_U664 )))
        {
            bVar2 = false;
            ...
            if ((NOT (sub_10838( l_U729 ))) AND (TIMERB() >= 55000))
            {
                bVar2 = true;
            }
            if (bVar2)
            {
                ...
                if (iVar3 == 0)
                {
                    ...
                    TASK_CAR_DRIVE_TO_COORD( 0, l_U664, 227.36480000, -263.81660000, 8.05160000, 30, 1, 584879743, 2, 10.00000000, -1 );
                    TASK_CAR_DRIVE_TO_COORD( 0, l_U664, 125.87000000, 850.43680000, 13.72280000, 30, 1, 584879743, 2, 10.00000000, -1 );
...
void sub_13864()
{
    if (NOT (IS_CHAR_FATALLY_INJURED( l_U662 )))
    {
        if (sub_13891())
        {
            if ((NOT (IS_CAR_ON_SCREEN( l_U664 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CAR_2D( sub_3071(), l_U664, 30.00000000, 30.00000000, 0 ))))
            {
...
int sub_13891()
{
    if (IS_VEH_DRIVEABLE( l_U664 ))
    {
        if ((((CHECK_STUCK_TIMER( l_U664, 3, 60000 )) || (CHECK_STUCK_TIMER( l_U664, 2, 30000 ))) || (CHECK_STUCK_TIMER( l_U664, 1, 40000 ))) || (CHECK_STUCK_TIMER( l_U664, 0, 5000 )))
        {
            return 1;
        }
    }
...
void sub_14249(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3071() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_14417())) AND (iVar3 != 4))
    {
...
void sub_14935()
{
    if (NOT l_U718)
    {
        if (NOT (IS_CHAR_FATALLY_INJURED( l_U662 )))
        {
            if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_3071(), l_U662, 250.00000000, 250.00000000, 0 ))) AND (NOT (IS_CHAR_ON_SCREEN( l_U662 ))))
            {
    ...
    if (NOT (IS_CHAR_FATALLY_INJURED( l_U662 )))
    {
        if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_3071(), l_U662, 300.00000000, 300.00000000, 0 ))) AND (NOT (IS_CHAR_ON_SCREEN( l_U662 ))))
        {
            CLEAR_PRINTS();
            PRINT_NOW( "D1_11", 7500, 1 );
            l_U658 = 1;
            ...
            if (NOT (IS_CHAR_INJURED( (uParam0^) )))
            {
                if (NOT (IS_CHAR_INJURED( sub_3071() )))
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
                    {
                        ...
                        {
                            if ((sub_17306( (uParam3^) )) AND (iVar7 > l_U642))
                            {
                    ...
                    if (NOT l_U646)
                    {
                        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
                        {
                            if (IS_CHAR_PLAYING_ANIM( (uParam0^), uParam2, uParam1 ))
                            {
                                ...
                                {
                                    case 0:
                                    if ((NOT (IS_CHAR_INJURED( sub_3071() ))) AND (NOT (IS_CHAR_INJURED( (uParam0^) ))))
                                    {
...
int sub_18123(unknown uParam0)
{
    ...
    if (DOES_CHAR_EXIST( uParam0 ))
    {
        if (NOT (IS_CHAR_INJURED( sub_3071() )))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                if ((GET_CHAR_MELEE_ACTION_FLAG0( uParam0 )) || (((NOT IS_USING_CONTROLLER()) AND (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3928(), uParam0 ))) AND (IS_CONTROL_JUST_PRESSED( 0, 4 ))))
                {
                    if ((NOT (IS_CHAR_INJURED( sub_3071() ))) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
                    {
                        SET_CHAR_READY_TO_BE_EXECUTED( uParam0, 0 );
...
int sub_18735(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    if (((l_U741) AND (NOT l_U717)) AND (NOT (IS_CHAR_INJURED( uParam4 ))))
    {
        if (IS_CHAR_PLAYING_ANIM( uParam4, "missdwayne1", "victim" ))
        {
            GET_CHAR_ANIM_CURRENT_TIME( uParam4, "missdwayne1", "victim", ref fVar7 );
...
int sub_21791(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3071() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3071() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_22306()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
