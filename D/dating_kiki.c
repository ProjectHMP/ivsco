        ...
        if (NOT g_U33838)
        {
            ...
            switch (l_U594)
            {
                ...
                else
                {
                    ...
                    sub_2838();
                    if ((l_U717 > (l_U817 + l_U824)) || (IS_KEYBOARD_KEY_PRESSED( 11 )))
                    {
                ...
                switch (sub_15825())
                {
                    ...
                    else if ((sub_15825() == 5) || (sub_15825() == 8))
                    {
...
int sub_7535(unknown uParam0)
{
    ...
    if (g_U33837)
    {
        if ((sub_7586( sub_6086( uParam0 ), 1 )) || (g_U15946[sub_6086( uParam0 )]._fU4))
        {
            switch (uParam0)
            {
                case 0:
...
int sub_10602(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_10847() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_10847() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_11179()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
    ...
    if (IS_PLAYER_PLAYING( sub_10768() ))
    {
        if (g_U15946[sub_6086( 3 )]._fU4)
        {
            ...
            else if (g_U15946[sub_6086( 3 )]._fU8[1]._fU0[1])
            {
                ...
                bVar2 = ((IS_WANTED_LEVEL_GREATER( sub_10768(), 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_10768(), 3 )))) AND (sub_23231());
                bVar3 = NOT l_U724;
...
int sub_21965()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_22003( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_22266( I );
            return 1;
        }
...
int sub_23315(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, int iParam5, unknown uParam6)
{
    ...
    if ((uParam4^) < 3)
    {
        ...
        PRINTNL();
        if ((iVar10 < ((uParam1^) + (sub_1348( 20.00000000 )))) AND ((uParam4^) > 0))
        {
            iParam5 = 0;
        }
    }
...
int sub_25380(unknown uParam0, boolean bParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if ((NOT (IS_CHAR_DEAD( sub_10847() ))) AND (IS_PLAYER_PLAYING( sub_10768() )))
    {
        if (GET_MISSION_FLAG())
        {
            if ((uParam2^) <= iVar13)
...
int sub_33072(unknown uParam0, int iParam1, unknown uParam2, int iParam3)
{
    if (iParam3 != 1)
    {
        ...
        {
            if (((sub_33112( iParam1 )) > 90) || ((sub_33112( iParam1 )) < 65476))
            {
    ...
    else
    {
        ...
        if ((iParam1->_fU0 >= 0) AND (iParam1->_fU4 >= 0))
        {
            if (((sub_33593( iParam1 )) > 180) || ((sub_33593( iParam1 )) < 65356))
            {
    ...
    if (NOT (sub_33072( iParam0, iParam5, (uParam1^), iParam7 )))
    {
        if (NOT ((g_U10978) || (GET_MISSION_FLAG())))
        {
            if (IS_PLAYER_PLAYING( sub_10768() ))
            {
                ...
                {
                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_10847(), uParam2._fU0, uParam2._fU4, uParam2._fU8, 8.00000000, 8.00000000, 8.00000000, 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_10768(), 0 ))))
                    {
                        g_U33841 = 0;
                    }
                }
...
int sub_35085(unknown uParam0)
{
    ...
    if (sub_7586( sub_6086( uParam0 ), 1 ))
    {
        ...
        if ((g_U15946[sub_6086( uParam0 )]._fU8[1]._fU0[0]) || (g_U15946[sub_6086( uParam0 )]._fU8[1]._fU0[1]))
        {
        ...
        if (NOT (IS_CAR_DEAD( uVar21 )))
        {
            switch (l_U592)
            {
                ...
                else
                {
                    ...
                    if ((NOT (IS_CAR_DEAD( uVar21 ))) AND (IS_PLAYER_PLAYING( sub_10768() )))
                    {
...
int sub_37752(unknown uParam0, int iParam1)
{
    if ((uParam0^))
    {
        if (((sub_37769()) AND (IS_SCREEN_FADED_IN())) AND (iParam1 > 0))
        {
            return 1;
        }
        else
...
int sub_48277(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10)
{
    ...
    if (IS_PLAYER_PLAYING( sub_10768() ))
    {
        switch (l_U592)
        {
            ...
            if (NOT (IS_CHAR_DEAD( (uParam3^) )))
            {
                if ((NOT (IS_SPECIFIC_CAM_INTERPOLATING( l_U573[2] ))) || ((sub_49549( (uParam3^), 17 )) AND (sub_49549( sub_10847(), 17 ))))
                {
                    INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
                    l_U592 = 5;
                }
...
void sub_52843(int iParam0, int iParam1, unknown uParam2)
{
    if (iParam0 == 2)
    {
        if (((NOT (sub_52865( iParam0, uParam2 ))) || (iParam1 == 27)) || (iParam1 == 26))
        {
            sub_52942( iParam1 );
        }
    }
            ...
            switch ((uParam2^))
            {
                ...
                if (NOT IS_MESSAGE_BEING_DISPLAYED())
                {
                    ...
                    else
                    {
                        ...
                        if ((IS_CHAR_IN_ANY_CAR( sub_10847() )) AND (NOT (IS_CHAR_ON_ANY_BIKE( sub_10847() ))))
                        {
                        ...
                        WAIT( 0 );
                        if ((IS_PLAYER_PLAYING( sub_10768() )) AND (NOT (IS_CHAR_DEAD( (uParam0^) ))))
                        {
                            bVar59 = false;
                            if ((IS_CHAR_IN_ANY_CAR( sub_10847() )) AND (NOT (IS_CHAR_ON_ANY_BIKE( sub_10847() ))))
                            {
                ...
                else if (sub_79719( iParam1, uParam12, uParam2 ))
                {
                    if (sub_79370())
                    {
                        if (sub_63052( 25, ref l_U581, (uParam8^), iParam1, 83, 0 ))
                        {
                            ...
                            TASK_PERFORM_SEQUENCE( (uParam0^), uVar54 );
                            CLEAR_SEQUENCE_TASK( uVar54 );
                            if ((IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( "GET_NUM", sub_18796( iParam1, 1 ) )) || (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "TRY_LUCK" )))
                            {
                                CLEAR_HELP();
                            }
                ...
                break;
                case 5:
                if ((NOT (sub_85354( l_U581 ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) ))))
                {
                    if ((uParam8^) <= 1)
                    {
                        if (NOT l_U572)
                        {
                            ...
                            else if ((IS_CHAR_PLAYING_ANIM( sub_10847(), "amb@dating", "pass_text" )) || (IS_CHAR_PLAYING_ANIM( sub_10847(), "Cellphone", "cellphone_text" )))
                            {
                ...
                if (((IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] )) AND ((IS_CHAR_ON_SCREEN( sub_10847() )) || (IS_CHAR_ON_SCREEN( (uParam0^) )))) AND (NOT ((LOCATE_CHAR_ON_FOOT_3D( sub_10847(), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( (uParam0^), uParam9._fU0, uParam9._fU4, uParam9._fU8 + 1.00000000, vVar85.x, vVar85.y, vVar85.z, 0 )))))
                {
                ...
                break;
                case 8:
                if (((IS_SPECIFIC_CAM_INTERPOLATING( l_U573[6] )) AND (NOT IS_SCRIPTED_CONVERSATION_ONGOING())) AND (NOT ((sub_37769()) AND (IS_SCREEN_FADED_IN()))))
                {
...
int sub_92398(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8, unknown uParam9, unknown uParam10, unknown uParam11, unknown uParam12, unknown uParam13, unknown uParam14, unknown uParam15)
{
    ...
    switch ((uParam15^))
    {
        ...
        if ((iVar81 <= ((uParam12^) + (sub_1348( 20.00000000 )))) AND (NOT ((IS_KEYBOARD_KEY_PRESSED( 11 )) AND ((IS_KEYBOARD_KEY_PRESSED( 29 )) || (IS_KEYBOARD_KEY_PRESSED( 157 ))))))
        {
            sub_2583( "  * WAIT_FOR_" );
        ...
        {
            if (((LOCATE_CHAR_ANY_MEANS_2D( sub_10847(), g_U10090[uParam13]._fU4._fU0, g_U10090[uParam13]._fU4._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( sub_10847(), g_U33981[iParam1]._fU0, g_U33981[iParam1]._fU4, 50.00000000 * 1.50000000, 50.00000000 * 1.50000000, 0 ))) || (DOES_CHAR_EXIST( (uParam0^) )))
            {
            ...
            else if (NOT IS_MESSAGE_BEING_DISPLAYED())
            {
                ...
                else
                {
                    ...
                    if (IS_PLAYER_PLAYING( sub_10768() ))
                    {
                        ...
                        {
                            WAIT( 1500 );
                            if ((NOT (IS_CHAR_INJURED( (uParam0^) ))) AND (IS_PLAYER_PLAYING( sub_10768() )))
                            {
...
int sub_103559(int iParam0, unknown uParam1, unknown uParam2, boolean bParam3, unknown uParam4)
{
    ...
    if ((uParam1^) < 0)
    {
        if (((NOT bParam3) AND (NOT ((g_U10978) || (GET_MISSION_FLAG())))) AND (NOT sub_20656()))
        {
            GET_GAME_TIMER( uParam1 );
    ...
    {
        if (((bParam3) || ((g_U10978) || (GET_MISSION_FLAG()))) || (sub_20656()))
        {
            (uParam1^) = -1;
            return 0;
        }
