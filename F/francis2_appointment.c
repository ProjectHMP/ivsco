...
void sub_1257()
{
    ...
    {
        iVar3 = sub_1285( 13 );
        if ((sub_1330( 13, iVar3 )) AND (g_U9932[g_U9999[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_1285( 11 );
        if ((sub_1330( 11, iVar3 )) AND (g_U9932[g_U10090[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_1809( I );
        if ((sub_1330( g_U10324[I]._fU12, iVar3 )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
...
void sub_2346()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((sub_1809( I )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
void sub_14229()
{
    ...
    {
        if (((sub_14267( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_18039()
{
    ...
    if (l_U531 == 3)
    {
        if (sub_17617( l_U526 ))
        {
            if (((((((((g_U10978) || (IS_THREAD_ACTIVE( g_U812 ))) || (IS_WANTED_LEVEL_GREATER( sub_3622(), 0 ))) || (sub_20081())) || (g_U33837)) || (sub_20286())) || (sub_20322( 0 ))) || (sub_20664())) || ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ambInternetCafe" )) > 0))
            {
                l_U531 = 1;
            }
...
int sub_19274()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_14267( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_14553( I );
            return 1;
        }
...
void sub_20818(unknown uParam0, unknown uParam1, boolean bParam2, boolean bParam3, boolean bParam4, boolean bParam5, unknown uParam6, unknown uParam7)
{
    ...
    while (true)
    {
        ...
        if ((sub_21404( (uParam6^), (uParam7^) )) AND (iVar14))
        {
            return;
        }
...
int sub_21708(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_899() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_899() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_22235()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_26523()
{
    ...
    if (l_U531 == 2)
    {
        if (sub_17617( l_U526 ))
        {
            ...
            if ((((((((g_U10978) || (IS_THREAD_ACTIVE( g_U812 ))) || (IS_WANTED_LEVEL_GREATER( sub_3622(), 0 ))) || (sub_20081())) || (g_U33837)) || (sub_20286())) || (sub_20664())) || ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "ambInternetCafe" )) > 0))
            {
                l_U531 = 1;
            }
...
void sub_27502()
{
    ...
    if (NOT g_U10978)
    {
        if (LOCATE_CHAR_ON_FOOT_3D( sub_899(), l_U522._fU0, l_U522._fU4, l_U522._fU8, 1.00000000, 1.00000000, 2.00000000, 1 ))
        {
            ...
            else if (((NOT sub_27681()) AND (NOT sub_27772())) AND (l_U500 == 0))
            {
                PRINT_HELP_FOREVER( "FM_CLOTHES_03" );
                l_U500 = 1;
                SETTIMERA( 0 );
            }
            else if ((NOT sub_27681()) AND (l_U500 == 0))
            {
                PRINT_HELP_FOREVER( "FM_CLOTHES_01" );
                l_U500 = 1;
                SETTIMERA( 0 );
            }
            else if ((NOT sub_27772()) AND (l_U500 == 0))
            {
                PRINT_HELP_FOREVER( "FM_CLOTHES_02" );
                l_U500 = 1;
                SETTIMERA( 0 );
            }
            else if ((NOT sub_27860()) AND (l_U500 == 0))
            {
                PRINT_HELP_FOREVER( "FM_CLOTHES_04" );
                l_U500 = 1;
                SETTIMERA( 0 );
            }
            else if ((NOT sub_28012()) AND (l_U500 == 0))
            {
...
int sub_28012()
{
    if (((((((((((((HAS_CHAR_GOT_WEAPON( sub_899(), 7 )) || (HAS_CHAR_GOT_WEAPON( sub_899(), 9 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 10 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 11 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 12 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 13 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 14 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 15 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 16 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 17 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 18 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 5 ))) || (HAS_CHAR_GOT_WEAPON( sub_899(), 4 )))
    {
        return 1;
    }
    return 0;
...
void sub_29277()
{
    ...
    if (l_U531 == 1)
    {
        if (sub_17617( l_U526 ))
        {
            ...
            if ((((((((g_U10978) || (NOT bVar2)) || (NOT bVar3)) || (IS_THREAD_ACTIVE( g_U812 ))) || (sub_20081())) || (g_U33837)) || (sub_20286())) || (sub_20664()))
            {
                l_U531 = 0;
                l_U530 = 4;
                return;
...
void sub_29817()
{
    ...
    if (l_U531 == 1)
    {
        if (((NOT g_U10978) AND (iVar2 > l_U538)) AND (NOT (LOCATE_CHAR_ANY_MEANS_2D( sub_899(), l_U522._fU0, l_U522._fU4, 140.00000000, 140.00000000, 0 ))))
        {
            l_U531++;
        }
    }
    ...
    if (l_U531 == 5)
    {
        if ((iVar2 > l_U538) || ((sub_30518( ref l_U539 )) == 3))
        {
...
int sub_30651(int iParam0, int iParam1)
{
    ...
    while (true)
    {
        if ((iVar6 == iVar4) AND (iVar7 == iVar5))
        {
            return Result;
        }
        if ((iVar6 == iParam0) AND (iVar7 == iParam1))
        {
            return Result;
        }
        sub_30707( ref iVar6, ref iVar7 );
