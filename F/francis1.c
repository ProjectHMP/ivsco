void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U609)
        {
            ...
            {
                if ((((HAS_MODEL_LOADED( -1292254815 )) AND (HAS_MODEL_LOADED( 243672348 ))) AND (HAS_MODEL_LOADED( 1352017873 ))) AND (HAS_MODEL_LOADED( 809067472 )))
                {
                    if (sub_21911( 1, 1 ))
                    {
                        sub_22201();
            ...
            if (NOT (IS_CHAR_INJURED( l_U498 )))
            {
                ...
                if (l_U582)
                {
                    if (((sub_31457( ref l_U622 )) == 3) AND (NOT l_U583))
                    {
                        sub_3605( l_U586 );
                        sub_31601( l_U586 );
                ...
                if ((NOT ((sub_31713( l_U586, 1 )) || (sub_32028( "8435550124" )))) AND (l_U590))
                {
                    if (sub_28222() == 6)
                    {
                        SETTIMERA( 99999 );
                ...
                if (((sub_31713( l_U586, 1 )) || (sub_32028( "8435550124" ))) || (l_U590))
                {
                    if (NOT l_U590)
                    {
                        if (NOT l_U587)
                ...
                {
                    sub_33064();
                    if ((((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U498, sub_3174(), 0 )) || (IS_CHAR_RESPONDING_TO_EVENT( l_U498, 49 ))) || (IS_PED_FLEEING( l_U498 ))) || (sub_36627()))
                    {
                        l_U534 = 1;
                        l_U535 = 1;
                        sub_33115();
            ...
            if (NOT (IS_CHAR_INJURED( l_U498 )))
            {
                ...
                else if ((sub_28222() == 6) || (sub_28222() == 2))
                {
                    if (NOT l_U587)
                    {
                        STOP_SOUND( l_U589 );
                ...
                else if ((NOT l_U617) AND (sub_38091()))
                {
                    PRINT_HELP( "HELP_PHONE" );
                    l_U617 = 1;
                }
                if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U498, sub_3174(), 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3174(), l_U498, 2.50000000, 2.50000000, 3.00000000, 0 )))
                {
                    sub_22567();
                    TASK_USE_MOBILE_PHONE( l_U498, 0 );
                    l_U534 = 1;
            ...
            if (NOT (IS_CHAR_INJURED( l_U498 )))
            {
                ...
                if (l_U610 == 0)
                {
                    ...
                    if (l_U610 != 1)
                    {
                        if (NOT l_U534)
                        {
                            if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U498, sub_3174(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_3131(), l_U498 )) AND (HAS_CHAR_SPOTTED_CHAR_IN_FRONT( l_U498, sub_3174() )))) || (sub_36627()))
                            {
                                sub_2709( ref l_U601, 0 );
                    ...
                    if (l_U610 != 2)
                    {
                        if ((IS_CAR_DEAD( l_U499[l_U533] )) || (IS_VEH_DRIVEABLE( l_U499[l_U533] )))
                        {
                ...
                else if (l_U610 == 1)
                {
                    ...
                    if (((((NOT (IS_VEH_DRIVEABLE( l_U499[l_U533] ))) || (IS_VEH_STUCK( l_U499[l_U533], 60000, 1, 0, 0 ))) || (IS_VEH_STUCK( l_U499[l_U533], 5000, 0, 1, 0 ))) AND (IS_CHAR_IN_ANY_CAR( l_U498 ))) || (NOT (IS_CHAR_IN_CAR( l_U498, l_U499[l_U533] ))))
                    {
                        OPEN_SEQUENCE_TASK( ref l_U594 );
...
void sub_1369()
{
    ...
    {
        if (((sub_1407( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3267()
{
    ...
    l_U639[4] = {194.85330000, 1098.61800000, 8.13970700};
...
void sub_22201()
{
    ...
    while ((NOT bVar2) AND (NOT bVar3))
    {
        ...
        if (((iVar7 >= 1000) AND (sub_22268())) AND (IS_SCREEN_FADED_IN()))
        {
        ...
        else
        {
            switch (iVar4)
            {
                ...
                break;
                case 1:
                if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3174(), 179.40000000, 1089.80000000, 14.70000000, 1.00000000, 1.00000000, 1.00000000, 0 )) || (TIMERA() > 8000))
                {
                ...
                if (l_U599 > 0)
                {
                    ...
                    SET_CAM_ROT( uVar9[1], -0.83925100, 0.00000000, 87.92899000 );
...
int sub_23789(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    {
        case 0:
        if ((NOT sub_24304()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_28637()
{
    ...
    else
    {
        ...
        while ((NOT (DOES_SCENARIO_EXIST_IN_AREA( l_U537[l_U588], 0.50000000, 1 ))) AND (l_U599 < 100))
        {
            WAIT( 0 );
            GENERATE_RANDOM_INT_IN_RANGE( 0, 4, ref l_U588 );
            l_U599++;
...
void sub_29021()
{
    ...
    while (((NOT (HAS_MODEL_LOADED( 1534326199 ))) || (NOT (HAS_MODEL_LOADED( -449022887 )))) || (NOT (HAS_MODEL_LOADED( -193114041 ))))
    {
        WAIT( 0 );
    }
    l_U599 = 0;
...
void sub_30013()
{
    ...
    if (l_U599 > l_U677)
    {
        ...
        if ((l_U670[l_U673] != nil) AND (NOT (IS_CHAR_INJURED( l_U670[l_U673] ))))
        {
...
int sub_30848()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_1407( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_1693( I );
            return 1;
        }
...
void sub_33064()
{
    if (TIMERA() > l_U614)
    {
        ...
        else
        {
            ...
            if ((NOT (l_U599 == l_U588)) AND (DOES_SCENARIO_EXIST_IN_AREA( l_U537[l_U599], 0.50000000, 1 )))
            {
                CLEAR_CHAR_TASKS( l_U498 );
...
void sub_33115()
{
    ...
    if (l_U534)
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U499[l_U533] )))
        {
            if ((((NOT (IS_CHAR_IN_CAR( sub_3174(), l_U499[l_U533] ))) AND (IS_CAR_UPRIGHT( l_U499[l_U533] ))) AND (NOT (IS_CAR_ON_FIRE( l_U499[l_U533] )))) AND (IS_CAR_IN_AREA_3D( l_U499[l_U533], l_U503[l_U533]._fU0 - 2.00000000, l_U503[l_U533]._fU4 - 2.00000000, l_U503[l_U533]._fU8 - 2.00000000, l_U503[l_U533]._fU0 + 2.00000000, l_U503[l_U533]._fU4 + 2.00000000, l_U503[l_U533]._fU8 + 2.00000000, 0 )))
            {
...
int sub_36627()
{
    ...
    if (NOT (IS_CHAR_DEAD( l_U498 )))
    {
        ...
        if (GET_CLOSEST_CHAR( l_U596._fU0, l_U596._fU4, l_U596._fU8, 15, 1, 0, ref uVar2 ))
        {
            ...
            {
                if ((IS_PED_FLEEING( uVar2 )) || (IS_PED_IN_COMBAT( uVar2 )))
                {
                    return 1;
                }
            }
...
void sub_38454()
{
    if ((NOT (DOES_BLIP_EXIST( l_U495 ))) AND (NOT (IS_CHAR_INJURED( l_U498 ))))
    {
        if ((IS_CHAR_ON_SCREEN( l_U498 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3174(), l_U498, 2.50000000, 2.50000000, 2.50000000, 0 )))
        {
            ADD_BLIP_FOR_CHAR( l_U498, ref l_U495 );
            SET_BLIP_AS_FRIENDLY( l_U495, 0 );
            SET_CHAR_AS_ENEMY( l_U498, 1 );
...
void sub_38633()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U498 )))
    {
        if (l_U534)
        {
            ...
            {
                if ((NOT l_U616) AND (DOES_BLIP_EXIST( l_U495 )))
                {
        ...
        else if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_2D( sub_3174(), l_U498, 80.00000000, 80.00000000, 0 ))) AND (NOT (IS_CHAR_ON_SCREEN( l_U498 ))))
        {
            sub_38892( 0 );
        }
    }
...
void sub_40196(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3174() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_40364())) AND (iVar3 != 4))
    {
    ...
    while ((NOT bVar2) AND (NOT bVar3))
    {
        ...
        else
        {
            switch (iVar4)
            {
                ...
                while (((((NOT (HAVE_ANIMS_LOADED( "missfrancis1" ))) || (NOT (sub_43149( 11 )))) || (NOT (HAS_MODEL_LOADED( 837858166 )))) || (NOT (HAS_MODEL_LOADED( -1004762946 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 239 ))))
                {
                    WAIT( 0 );
                }
                CLEAR_SMALL_PRINTS();
