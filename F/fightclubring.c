void main()
{
    ...
    l_U1 = 274.00000000;
    l_U105 = 0;
    l_U115 = {-385.75950000, 1492.44800000, 9.71040000};
    l_U151 = {-388.25960000, 1492.73400000, 9.71030000};
    ...
    l_U323 = {-394.05000000, 1483.98000000, 9.70000000};
    ...
    l_U982 = {-384.35000000, 1480.52000000, 9.71030000};
    l_U986 = 0;
    l_U987 = 0;
    l_U988 = 0;
    l_U989 = 0;
...
void sub_5830()
{
    if ((HAS_CHAR_GOT_WEAPON( sub_1354(), 41 )) || (sub_5859( sub_1354() )))
    {
        g_U2799 = 1;
        g_U43644 = 1;
    }
...
int sub_8662()
{
    ...
    if ((((((((((HAS_MODEL_LOADED( l_U344 )) AND (HAS_MODEL_LOADED( l_U345 ))) AND (HAS_MODEL_LOADED( l_U346 ))) AND (HAS_MODEL_LOADED( l_U347 ))) AND (HAS_MODEL_LOADED( l_U348 ))) AND (HAS_MODEL_LOADED( l_U349 ))) AND (HAVE_ANIMS_LOADED( l_U351 ))) AND (HAVE_ANIMS_LOADED( l_U352 ))) AND (HAVE_ANIMS_LOADED( l_U343 ))) AND (REQUEST_AMBIENT_AUDIO_BANK( "EP2_SFX\FIGHT_CLUB_ROAR" )))
    {
        l_U469 = 1;
        return 1;
    }
...
void sub_9423(int iParam0, unknown uParam1)
{
    ...
    l_U118[0] = {-379.89000000, 1493.01000000, 9.71030000};
    l_U118[1] = {-379.89000000, 1493.01000000, 9.71030000};
    l_U118[2] = {-379.89000000, 1493.01000000, 9.71030000};
    l_U118[3] = {-379.89000000, 1493.01000000, 9.71030000};
    if (iParam0 == 1)
    {
    ...
    l_U144[0] = {-387.44270000, 1492.48800000, 9.71030000};
    l_U336[0] = 275.76360000;
    l_U144[1] = {-384.14840000, 1493.22100000, 9.71030000};
...
void sub_10197(int iParam0)
{
    ...
    sub_2330( 1 );
    l_U154[0] = {-380.00000000, 1498.14000000, 9.71030000};
    l_U154[1] = {-381.76000000, 1498.64000000, 9.71030000};
    l_U154[2] = {-392.38000000, 1495.73800000, 9.71030000};
    l_U154[3] = {-381.62640000, 1498.05300000, 9.71030000};
    l_U154[4] = {-379.81110000, 1488.55300000, 9.71030000};
    l_U154[5] = {-384.04000000, 1499.59000000, 9.71030000};
    l_U154[6] = {-386.37890000, 1500.22400000, 9.71030000};
    l_U154[7] = {-387.11810000, 1500.60000000, 9.71030000};
    l_U154[8] = {-390.25000000, 1502.32000000, 9.71030000};
    l_U154[9] = {-391.13000000, 1499.44000000, 9.71030000};
    l_U154[10] = {-391.37000000, 1498.54000000, 9.71030000};
    l_U154[11] = {-392.00000000, 1496.78000000, 9.71030000};
    l_U154[12] = {-391.90960000, 1496.53000000, 9.71040000};
    l_U154[13] = {-393.26000000, 1494.50000000, 9.71030000};
    l_U154[14] = {-394.55000000, 1492.99000000, 9.71030000};
    l_U154[15] = {-394.33110000, 1490.60600000, 9.71030000};
    l_U154[16] = {-393.49410000, 1488.65600000, 9.71030000};
    l_U154[17] = {-392.22440000, 1488.12600000, 9.71030000};
    l_U154[18] = {-394.05000000, 1486.99000000, 9.71000000};
    l_U154[19] = {-385.96000000, 1484.27000000, 9.71030000};
    l_U154[20] = {-379.49000000, 1489.48000000, 9.71030000};
    l_U154[21] = {-386.29990000, 1485.05600000, 9.71030000};
    l_U154[22] = {-385.24310000, 1484.54400000, 9.71030000};
    l_U154[23] = {-384.16400000, 1483.99100000, 9.71030000};
    l_U154[24] = {-382.86990000, 1483.95700000, 9.71040000};
    l_U154[25] = {-382.01660000, 1484.82600000, 9.71030000};
    l_U154[26] = {-381.15000000, 1486.68000000, 9.71030000};
    l_U154[27] = {-380.53000000, 1487.97000000, 9.71030000};
    l_U154[28] = {-379.36000000, 1490.32000000, 9.71040000};
    l_U154[29] = {-375.13000000, 1493.28000000, 9.71030000};
    l_U154[30] = {-377.73000000, 1494.45000000, 9.71030000};
    l_U154[31] = {-378.49000000, 1497.50000000, 9.71030000};
    l_U154[32] = {-379.19740000, 1498.27000000, 9.71030000};
    l_U154[33] = {-381.02660000, 1498.74500000, 9.71030000};
    l_U154[34] = {-382.18640000, 1499.61400000, 9.71030000};
    l_U154[35] = {-383.46080000, 1500.35600000, 9.71030000};
    l_U154[36] = {-384.02050000, 1500.68100000, 9.71030000};
    l_U154[37] = {-385.08850000, 1501.30200000, 9.71030000};
    l_U154[38] = {-387.08870000, 1502.50100000, 9.71030000};
    l_U154[39] = {-388.55750000, 1502.80100000, 9.71030000};
    l_U154[39] = {-390.10220000, 1501.98500000, 9.71030000};
    l_U154[39] = {-391.04730000, 1500.44000000, 9.71030000};
    l_U154[40] = {-392.27450000, 1497.82900000, 9.71030000};
    l_U154[41] = {-393.32890000, 1495.65800000, 9.71040000};
    l_U154[42] = {-394.24090000, 1493.72600000, 9.71040000};
    l_U154[43] = {-395.09110000, 1491.84700000, 9.71030000};
    l_U154[44] = {-395.47950000, 1489.60100000, 9.71030000};
    l_U154[45] = {-387.90790000, 1484.64600000, 9.71030000};
    l_U154[47] = {-383.15580000, 1480.85600000, 9.71030000};
    l_U154[48] = {-381.78020000, 1483.17100000, 9.71030000};
    l_U154[49] = {-380.67900000, 1485.18100000, 9.71030000};
    l_U154[50] = {-379.03640000, 1486.38300000, 9.71030000};
    l_U154[51] = {-378.15320000, 1488.69800000, 9.71030000};
    l_U154[52] = {-376.83120000, 1489.68600000, 9.71030000};
...
void sub_12065(unknown uParam0, boolean bParam1, int iParam2)
{
    ...
    if ((NOT (IS_CHAR_INJURED( l_U477[uParam0] ))) AND (NOT (IS_CHAR_INJURED( sub_1354() ))))
    {
        switch (uVar6)
        {
            case 0:
        ...
        switch (l_U1133)
        {
            ...
            switch (l_U964)
            {
                ...
                if (IS_SCREEN_FADED_OUT())
                {
                    ...
                    l_U1021._fU12 = {16.66006000, -0.00000000, 96.67165000};
...
int sub_25317()
{
    if (((((IS_BUTTON_PRESSED( 0, 17 )) || (IS_BUTTON_PRESSED( 0, 14 ))) || (IS_BUTTON_PRESSED( 0, 15 ))) || (IS_BUTTON_PRESSED( 0, 16 ))) || (sub_25365()))
    {
        SET_PLAYER_CONTROL( sub_1261(), 1 );
        return 1;
    }
...
int sub_25702()
{
    if (HAVE_ANIMS_LOADED( "melee_counters" ))
    {
        if (NOT (IS_CHAR_INJURED( sub_1354() )))
        {
            if (((((((((IS_CHAR_PLAYING_ANIM( sub_1354(), "melee_counters", "counter_right" )) || (IS_CHAR_PLAYING_ANIM( sub_1354(), "melee_counters", "counter_right_2" ))) || (IS_CHAR_PLAYING_ANIM( sub_1354(), "melee_counters", "counter_right_3" ))) || (IS_CHAR_PLAYING_ANIM( sub_1354(), "melee_counters", "counter_left" ))) || (IS_CHAR_PLAYING_ANIM( sub_1354(), "melee_counters", "counter_left_2" ))) || (IS_CHAR_PLAYING_ANIM( sub_1354(), "melee_counters", "counter_left_3" ))) || (IS_CHAR_PLAYING_ANIM( sub_1354(), "melee_counters", "counter_back" ))) || (IS_CHAR_PLAYING_ANIM( sub_1354(), "melee_counters", "counter_back_2" ))) || (IS_CHAR_PLAYING_ANIM( sub_1354(), "melee_counters", "counter_back_3" )))
            {
                return 1;
            }
        }
...
void sub_33134(int iParam0, unknown uParam1, int iParam2)
{
    ...
    if (iParam2 == 0)
    {
        ...
        switch (l_U652)
        {
            ...
            for ( I = 0; I <= 52; I++ )
            {
                if ((l_U105 > 2) || (sub_33206( uParam1 )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U477[I] )))
                    {
                        GET_SCRIPT_TASK_STATUS( l_U477[I], 29, ref iVar6 );
                        if ((iVar6 == 7) AND (NOT (IS_PED_RAGDOLL( l_U477[I] ))))
                        {
                            if (iParam0 == 1)
                            {
                                sub_12065( I, 1, 1 );
...
void sub_41741()
{
    ...
    switch (l_U1137)
    {
        ...
        if (IS_SCREEN_FADED_OUT())
        {
            ...
            l_U1377._fU96 = {-388.62810000, 1500.65500000, 12.78610000};
        ...
        if (((IS_USING_CONTROLLER()) AND (sub_8300())) || (IS_CONTROL_JUST_PRESSED( 2, 132 )))
        {
            l_U1014 = 0;
        ...
        else if (((IS_USING_CONTROLLER()) AND (sub_8090())) || (IS_CONTROL_JUST_PRESSED( 2, 133 )))
        {
            l_U1014 = 1;
            PRINT_HELP_FOREVER( "QuitBet" );
            DISPLAY_CASH( 1 );
...
void sub_45474()
{
    ...
    if (l_U993 > 0)
    {
        if ((iVar3 > 60) AND (iVar3 <= 128))
        {
            GET_GAME_TIMER( ref l_U1372 );
            l_U1373 = l_U1372 - l_U1371;
            if (((l_U1373 > iVar6) || (iVar3 > iVar7)) || (NOT l_U1364))
            {
                l_U993 -= 50;
                if (iVar3 < 127)
                {
    ...
    if (l_U993 < iVar8)
    {
        if ((iVar3 < 65476) AND (iVar3 >= 65408))
        {
            GET_GAME_TIMER( ref l_U1366 );
            l_U1367 = l_U1366 - l_U1365;
            if (((l_U1367 > iVar6) || (iVar3 < -iVar7)) || (NOT l_U1364))
            {
                l_U993 += 50;
                if (iVar3 > 65409)
                {
...
void sub_46630()
{
    ...
    if ((l_U963 != 8) AND (l_U963 != 9))
    {
        switch (l_U1134)
        {
            ...
            if ((IS_CHAR_INJURED( l_U532[1] )) || (sub_50044( l_U532[1] )))
            {
                l_U971 = 1;
                if (NOT (IS_CHAR_INJURED( l_U532[0] )))
                {
            ...
            else if ((IS_CHAR_INJURED( l_U532[0] )) || (sub_50044( l_U532[0] )))
            {
                if (NOT (IS_CHAR_INJURED( l_U532[1] )))
                {
                    GENERATE_RANDOM_INT_IN_RANGE( 0, 50, ref iVar2 );
            ...
            if ((IS_CHAR_INJURED( l_U532[0] )) AND (IS_CHAR_INJURED( l_U532[1] )))
            {
                l_U971 = 3;
                ADD_SCORE( sub_1261(), l_U993 );
                l_U966 = 2;
            ...
            switch (l_U966)
            {
                ...
                if (IS_SCREEN_FADED_OUT())
                {
                    ...
                    l_U1021._fU96 = {-388.59880000, 1500.44900000, 11.81991000};
...
void sub_48458(unknown uParam0)
{
    ...
    switch (l_U967)
    {
        ...
        l_U1296._fU120 = 37;
        l_U1330._fU0 = {-391.59050000, 1494.96600000, 12};
...
void sub_55537(unknown uParam0)
{
    ...
    if (((GET_CHAR_DRAWABLE_VARIATION( sub_1354(), 8 )) != 0) || ((GET_CHAR_TEXTURE_VARIATION( sub_1354(), 8 )) != 0))
    {
