void main()
{
    ...
    while ((((((((NOT (HAS_MODEL_LOADED( 1708842493 ))) || (NOT (HAS_MODEL_LOADED( 467469635 )))) || (NOT (HAS_MODEL_LOADED( -1143910864 )))) || (NOT (HAS_MODEL_LOADED( -301223260 )))) || (NOT (HAS_MODEL_LOADED( 1343144208 )))) || (NOT (HAS_MODEL_LOADED( -1490216169 )))) || (NOT (HAS_MODEL_LOADED( -196312163 )))) || (NOT (HAS_MODEL_LOADED( 1069950328 ))))
    {
        WAIT( 0 );
    }
    ...
    while (true)
    {
        switch (l_U667)
        {
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (LOCATE_CHAR_ANY_MEANS_3D( sub_493(), -70.31460000, 1322.82300000, 19.99820000, 150.00000000, 150.00000000, 50.00000000, 0 ))
                {
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U752[2] ))) AND (NOT (IS_CHAR_INJURED( l_U752[0] ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar32 );
                        TASK_TURN_CHAR_TO_FACE_CHAR( 0, l_U752[0] );
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U724[2] ))) AND (NOT (IS_CHAR_INJURED( l_U724[0] ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar32 );
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U724[1] ))) AND (NOT (IS_CHAR_INJURED( l_U724[4] ))))
                    {
                    ...
                    CREATE_OBJECT( -1490216169, -127.79690000, 1325.65600000, 29.50000000, ref l_U775, 1 );
                    SET_OBJECT_HEADING( l_U775, 97.38200000 );
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U730[0] ))) AND (NOT (IS_CHAR_INJURED( l_U730[1] ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar33 );
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U730[2] ))) AND (NOT (IS_CHAR_INJURED( l_U730[3] ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar33 );
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if ((LOCATE_CHAR_ON_FOOT_3D( sub_493(), vVar28.x, vVar28.y, vVar28.z, 1.60000000, 1.60000000, 1.00000000, 1 )) AND (sub_8540( 1, 1 )))
                {
                    if (NOT (IS_CHAR_INJURED( sub_493() )))
                    {
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U735[2] ))) AND (NOT (IS_CHAR_INJURED( l_U756 ))))
                    {
            ...
            for ( I = 0; I <= 4; I++ )
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    if (DOES_CHAR_EXIST( l_U724[I] ))
                    {
                        ...
                        {
                            if ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U724[I] )) AND (sub_10753( sub_493() )))
                            {
                                l_U788 = 1;
                                sub_10166();
                            }
            ...
            for ( I = 0; I <= 3; I++ )
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    if (DOES_CHAR_EXIST( l_U730[I] ))
                    {
                        ...
                        {
                            if ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U730[I] )) AND (sub_10753( sub_493() )))
                            {
                                l_U788 = 1;
                                sub_10166();
                            }
            ...
            for ( I = 0; I <= 2; I++ )
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    if (DOES_CHAR_EXIST( l_U752[I] ))
                    {
                        ...
                        {
                            if ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U752[I] )) AND (sub_10753( sub_493() )))
                            {
                                l_U788 = 1;
                                sub_10166();
                            }
            ...
            break;
            case 3:
            vVar38 = {-121.38890000, 1326.43200000, 20.42280000};
            ...
            switch (l_U670)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    SET_CHAR_COORDINATES( sub_493(), -65.45660000, 1279.16700000, 19.40000000 );
                ...
                if (iVar41 != nil)
                {
                    if (IS_VEH_DRIVEABLE( iVar41 ))
                    {
                        ...
                        {
                            SET_CAR_COORDINATES( iVar41, -81.66250000, 1258.37500000, 19.30940000 );
                ...
                CLEAR_AREA( -62.23277000, 1322.96200000, 19.72272000, 10.00000000, 1 );
                CLEAR_AREA( -113.97880000, 1324.02500000, 20.12729000, 10.00000000, 1 );
                CLEAR_AREA( -64.84361000, 1280.56000000, 20.88410000, 10.00000000, 1 );
                CLEAR_AREA( -64.84361000, 1280.56000000, 20.88410000, 10.00000000, 1 );
                CREATE_CAM( 14, ref l_U772 );
                sub_12284( ref l_U672, 1 );
                SET_CAM_POS( l_U772, -64.18133000, 1278.69800000, 20.76800000 );
                ...
                if (NOT (sub_3829( l_U890 )))
                {
                    ...
                    SET_CAM_POS( l_U773, -86.81735000, 1284.81900000, 24.99819000 );
                ...
                if (NOT (sub_3829( l_U890 )))
                {
                    sub_13680( ref l_U772, ref l_U773, ref l_U774 );
                    CREATE_CAM( 14, ref l_U772 );
                    SET_CAM_POS( l_U772, -98.54346000, 1299.34500000, 26.34979000 );
            ...
            if (((sub_15595()) AND (NOT (l_U670 == 0))) AND (NOT (l_U670 == 1)))
            {
                sub_11503( 1000 );
                sub_13680( ref l_U772, ref l_U773, ref l_U774 );
                sub_15253( ref l_U672, 1, 1, 1 );
            ...
            for ( I = 0; I <= 4; I++ )
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U724[I] )))
                    {
                        if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U724[I], sub_493(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U724[I] )) AND (sub_10753( sub_493() )))) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U724[I] )) AND (IS_CHAR_IN_AREA_3D( sub_493(), -142.07700000, 1261.49800000, 18.71912000, -23.16429000, 1344.24000000, 48.62354000, 0 ))))
                        {
                            l_U666 = 4;
                        }
                    }
            ...
            for ( I = 0; I <= 3; I++ )
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U730[I] )))
                    {
                        if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U730[I], sub_493(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U730[I] )) AND (sub_10753( sub_493() )))) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U730[I] )) AND (IS_CHAR_IN_AREA_3D( sub_493(), -142.07700000, 1261.49800000, 18.71912000, -23.16429000, 1344.24000000, 48.62354000, 0 ))))
                        {
                            l_U666 = 2;
                        }
                    }
            ...
            for ( I = 0; I <= 2; I++ )
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U752[I] )))
                    {
                        if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U752[I], sub_493(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U752[I] )) AND (sub_10753( sub_493() )))) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U752[I] )) AND (IS_CHAR_IN_AREA_3D( sub_493(), -142.07700000, 1261.49800000, 18.71912000, -23.16429000, 1344.24000000, 48.62354000, 0 ))))
                        {
                            l_U666 = 1;
                        }
                    }
            ...
            for ( I = 0; I <= 2; I++ )
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    ...
                    {
                        if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U735[I], sub_493(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U735[I] )) AND (sub_10753( sub_493() )))) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U735[I] )) AND (IS_CHAR_IN_AREA_3D( sub_493(), -142.07700000, 1261.49800000, 18.71912000, -23.16429000, 1344.24000000, 48.62354000, 0 ))))
                        {
                            l_U666 = 1;
                        }
                    }
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (NOT (IS_CHAR_INJURED( l_U756 )))
                {
                    if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U756, sub_493(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U756 )) AND (sub_10753( sub_493() )))) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U756 )) AND (IS_CHAR_IN_AREA_3D( sub_493(), -142.07700000, 1261.49800000, 18.71912000, -23.16429000, 1344.24000000, 48.62354000, 0 ))))
                    {
                        l_U666 = 1;
                    }
                }
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (NOT (IS_CHAR_INJURED( l_U757[0] )))
                {
                    if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U757[0], sub_493(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U757[0] )) AND (sub_10753( sub_493() )))) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U757[0] )) AND (IS_CHAR_IN_AREA_3D( sub_493(), -142.07700000, 1261.49800000, 18.71912000, -23.16429000, 1344.24000000, 48.62354000, 0 ))))
                    {
                        l_U666 = 4;
                    }
                }
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (NOT (IS_CHAR_INJURED( l_U757[1] )))
                {
                    if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U757[1], sub_493(), 0 )) || ((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U757[1] )) AND (sub_10753( sub_493() )))) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U757[1] )) AND (IS_CHAR_IN_AREA_3D( sub_493(), -142.07700000, 1261.49800000, 18.71912000, -23.16429000, 1344.24000000, 48.62354000, 0 ))))
                    {
                        l_U666 = 2;
                    }
                }
            }
            if (((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT l_U791)) AND (NOT l_U799))
            {
                if (LOCATE_CHAR_ANY_MEANS_3D( sub_493(), -62.74660000, 1308.80200000, 18.99830000, 7.00000000, 7.00000000, 4.00000000, 0 ))
                {
                    if ((NOT (IS_CHAR_INJURED( l_U724[2] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                    {
            ...
            if (((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT l_U797)) AND (NOT l_U799))
            {
                if (LOCATE_CHAR_ANY_MEANS_3D( sub_493(), -114.33800000, 1305.34000000, 20.43630000, 7.00000000, 7.00000000, 4.00000000, 0 ))
                {
                    if ((NOT (IS_CHAR_INJURED( l_U730[2] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar42 );
                        TASK_LOOK_AT_CHAR( 0, sub_493(), 15000, 0 );
                        TASK_TURN_CHAR_TO_FACE_CHAR( 0, sub_493() );
            ...
            if ((NOT l_U793) AND (NOT l_U799))
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    if (LOCATE_CHAR_ANY_MEANS_3D( sub_493(), -90.78610000, 1286.25400000, 20.23600000, 9.00000000, 8.00000000, 2.00000000, 0 ))
                    {
                        if (((NOT (IS_CHAR_INJURED( l_U752[0] ))) AND (NOT (IS_CHAR_INJURED( sub_493() )))) AND (NOT (IS_CHAR_INJURED( l_U752[1] ))))
                        {
                        ...
                        if (((NOT (IS_CHAR_INJURED( l_U752[1] ))) AND (NOT (IS_CHAR_INJURED( l_U752[0] )))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
                            OPEN_SEQUENCE_TASK( ref uVar43 );
                        ...
                        if (((NOT (IS_CHAR_INJURED( l_U752[2] ))) AND (NOT (IS_CHAR_INJURED( sub_493() )))) AND (NOT (IS_CHAR_INJURED( l_U752[0] ))))
                        {
                            OPEN_SEQUENCE_TASK( ref uVar43 );
            ...
            if (NOT l_U799)
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    if (IS_CHAR_IN_AREA_3D( sub_493(), -62.77290000, 1320.30700000, 22.72439000, -53.61643000, 1327.45900000, 19.48010000, 0 ))
                    {
                        ...
                        {
                            if ((NOT (IS_CHAR_INJURED( l_U724[4] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                            {
            ...
            if (NOT l_U799)
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    if (IS_CHAR_IN_AREA_3D( sub_493(), -123.89690000, 1327.46500000, 20.05850000, -113.95820000, 1320.62200000, 22.37178000, 0 ))
                    {
                        ...
                        {
                            if ((NOT (IS_CHAR_INJURED( l_U730[0] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                            {
                                OPEN_SEQUENCE_TASK( ref uVar45 );
                                TASK_LOOK_AT_CHAR( 0, sub_493(), 15000, 0 );
                                TASK_TURN_CHAR_TO_FACE_CHAR( 0, sub_493() );
                            ...
                            if ((NOT (IS_CHAR_INJURED( l_U730[1] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                            {
                                OPEN_SEQUENCE_TASK( ref uVar45 );
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if ((IS_CHAR_IN_AREA_3D( sub_493(), -46.81655000, 1327.29400000, 24.97706000, -58.24519000, 1330.45800000, 28.67368000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_493(), -46.90738000, 1326.94500000, 33.13568000, -54.80001000, 1325.12200000, 28.64790000, 0 )))
                {
                    if ((NOT l_U799) AND (NOT (IS_CHAR_INJURED( l_U757[0] ))))
                    {
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if ((IS_CHAR_IN_AREA_3D( sub_493(), -126.68380000, 1327.16900000, 25.07790000, -120.31750000, 1330.18300000, 28.60634000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_493(), -129.34870000, 1325.08900000, 33.24553000, -121.58400000, 1326.90700000, 28.52102000, 0 )))
                {
                    if ((NOT l_U799) AND (NOT (IS_CHAR_INJURED( l_U757[1] ))))
                    {
                        GET_CURRENT_CHAR_WEAPON( sub_493(), ref iVar44 );
                        if (iVar44 != 0)
                        {
            ...
            switch (l_U666)
            {
                ...
                if (NOT l_U799)
                {
                    ...
                    if (l_U666 == 5)
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U724[3] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
                    ...
                    else if ((NOT (IS_CHAR_INJURED( l_U724[2] ))) AND (NOT l_U823))
                    {
                    ...
                    if (l_U666 != 6)
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U757[0] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
                ...
                if (NOT l_U810)
                {
                    ...
                    for ( I = 0; I <= 2; I++ )
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U735[I] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U752[0] ))) AND (NOT l_U823))
                    {
                ...
                if (NOT l_U799)
                {
                    for ( I = 0; I <= 2; I++ )
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U752[I] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
                            MARK_CHAR_AS_NO_LONGER_NEEDED( ref l_U752[I] );
                        }
                    }
                    ...
                    if (l_U666 == 2)
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U730[2] ))) AND (NOT l_U823))
                        {
                    ...
                    if (l_U666 != 7)
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U757[1] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if ((((l_U791) AND (NOT l_U824)) AND (NOT (sub_3829( l_U836 )))) AND (NOT (sub_3829( l_U854 ))))
                {
                    sub_12685( "FM3_INSULT", ref l_U854, 6, 1 );
                    l_U824 = 1;
                }
                if ((((l_U797) AND (NOT l_U825)) AND (NOT (sub_3829( l_U866 )))) AND (NOT (sub_3829( l_U854 ))))
                {
                    sub_12685( "FM3_INSULT", ref l_U854, 6, 1 );
                    l_U825 = 1;
                }
                if ((((l_U793) AND (NOT l_U826)) AND (NOT (sub_3829( l_U848 )))) AND (NOT (sub_3829( l_U854 ))))
                {
                    sub_12685( "FM3_INSULT", ref l_U854, 6, 1 );
                    l_U826 = 1;
                }
                if ((((l_U792) AND (NOT l_U827)) AND (NOT (sub_3829( l_U860 )))) AND (NOT (sub_3829( l_U854 ))))
                {
                    sub_12685( "FM3_INSULT", ref l_U854, 6, 1 );
                    l_U827 = 1;
                }
                if ((((l_U798) AND (NOT l_U828)) AND (NOT (sub_3829( l_U866 )))) AND (NOT (sub_3829( l_U854 ))))
                {
                    sub_12685( "FM3_INSULT", ref l_U854, 6, 1 );
                    l_U828 = 1;
                }
            ...
            if (NOT (IS_CHAR_DEAD( sub_493() )))
            {
                if (IS_CHAR_IN_AREA_3D( sub_493(), -125.98530000, 1329.90500000, 25.21061000, -117.11700000, 1323.74600000, 28.79936000, 0 ))
                {
                    if (NOT l_U800[1])
                    {
                        ...
                        if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U739[0] ))))
                        {
                        ...
                        if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U739[1] ))))
                        {
                            OPEN_SEQUENCE_TASK( ref uVar52 );
                        ...
                        if ((NOT (IS_CHAR_INJURED( l_U735[2] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
            ...
            if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U756 ))))
            {
                ...
                if ((((IS_CHAR_IN_AREA_3D( sub_493(), -54.58748000, 1325.24000000, 28.66099000, -55.44971000, 1326.96200000, 25.45172000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_493(), -54.37531000, 1326.99800000, 25.71247000, -52.20605000, 1325.00800000, 29.86010000, 0 ))) || (IS_CHAR_IN_AREA_3D( sub_493(), -50.56822000, 1329.81900000, 28.94166000, -51.49436000, 1324.98000000, 25.03206000, 0 ))) || (((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U756 )) AND (IS_CHAR_IN_AREA_3D( sub_493(), -47.39503000, 1325.28300000, 32.98812000, -75.04807000, 1329.26700000, 25.15790000, 0 ))) AND (iVar55 == 7)))
                {
                    if (NOT (IS_CHAR_INJURED( l_U756 )))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar51 );
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (IS_CHAR_IN_AREA_3D( sub_493(), -56.86050000, 1323.43100000, 33.32898000, -46.89256000, 1329.73400000, 28.36998000, 0 ))
                {
                    l_U667 = 9;
                }
            }
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (IS_CHAR_IN_AREA_3D( sub_493(), -46.69192000, 1323.19400000, 32.90833000, -137.26430000, 1328.60300000, 36.34783000, 0 ))
                {
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (((LOCATE_CHAR_ANY_MEANS_3D( sub_493(), -66.98811000, 1315.51900000, 36.05404000, 9.63460700, 13.51910000, 2.50000000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_493(), -129.56020000, 1323.36700000, 37.49396000, -119.19100000, 1327.20800000, 33.80841000, 0 ))) || ((IS_CHAR_INJURED( l_U747[0] )) AND (IS_CHAR_INJURED( l_U747[1] ))))
                {
                    if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U747[2] ))))
                    {
                    ...
                    if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U747[3] ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar60 );
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if ((IS_CHAR_IN_AREA_3D( sub_493(), -57.82572000, 1315.82400000, 38.27037000, -36.60788000, 1329.08300000, 48.86989000, 0 )) AND (NOT (IS_CHAR_INJURED( l_U756 ))))
                {
                    l_U668 = 0;
                    l_U667 = 13;
                }
            ...
            if (NOT (IS_CHAR_INJURED( l_U756 )))
            {
                if ((IS_CHAR_IN_AREA_3D( l_U756, -40.24597000, 1326.65600000, 38.23461000, -56.13174000, 1319.16600000, 42.21711000, 0 )) AND (NOT l_U829))
                {
            ...
            sub_24579();
            sub_25244();
            if (((NOT (IS_CHAR_INJURED( l_U747[0] ))) AND (NOT (IS_CHAR_INJURED( sub_493() )))) AND (NOT l_U822))
            {
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (NOT (IS_CHAR_IN_AREA_3D( sub_493(), -57.05005000, 1327.54900000, 48.02913000, -39.80846000, 1305.57700000, 37.93025000, 0 )))
                {
                    l_U667 = 15;
                    l_U669 = 0;
            ...
            sub_24579();
            if (((NOT (sub_3829( l_U872 ))) AND (NOT (sub_34214( l_U872 )))) AND (NOT l_U815))
            {
                SETTIMERA( 0 );
                l_U815 = 1;
            }
            if (DOES_BLIP_EXIST( l_U678 ))
            {
                if (sub_35820( ref l_U678, ref l_U675 ))
                {
                    if (TIMERA() < 7500)
                    {
                        if ((NOT (sub_3829( l_U872 ))) AND (NOT (sub_34214( l_U872 ))))
                        {
                            if (l_U816 == 0)
                            {
            ...
            break;
            case 16:
            if (sub_36094( -46.08730000, 1317.31800000, 37.84900000, 12.68700000, l_U756 ))
            {
                sub_12685( "FM3_KILL", ref l_U872, 8, 1 );
                l_U667 = 33;
            }
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                ...
                if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT l_U796))
                {
                    if (IS_CHAR_IN_AREA_3D( sub_493(), -75.67063000, 1322.62200000, 24.80642000, -70.12444000, 1313.43700000, 28.24960000, 0 ))
                    {
                        for ( I = 2; I <= 2; I++ )
                        {
                            if ((NOT (IS_CHAR_INJURED( l_U735[I] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        ...
                        if ((NOT (IS_CHAR_INJURED( l_U735[0] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
                            ...
                            SET_CHAR_COORDINATES( l_U735[0], -77.51150000, 1300.39100000, 25.02380000 );
                        ...
                        if ((NOT (IS_CHAR_INJURED( l_U735[1] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
                            ...
                            SET_CHAR_COORDINATES( l_U735[1], -79.87640000, 1301.49700000, 25.02380000 );
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (IS_CHAR_IN_AREA_3D( sub_493(), -97.75005000, 1303.10300000, 24.94559000, -108.64300000, 1297.53900000, 28.74458000, 0 ))
                {
                    for ( I = 0; I <= 2; I++ )
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U739[I] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                        {
                    ...
                    if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U739[2] ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar52 );
                        TASK_FOLLOW_NAV_MESH_TO_COORD( 0, -116.40310000, 1328.17200000, 26.01870000, 4, -2, 0.20000000 );
            ...
            {
                GET_SCRIPT_TASK_STATUS( l_U756, 29, ref iVar55 );
                if ((IS_CHAR_IN_AREA_3D( sub_493(), -122.82540000, 1327.17800000, 29.32675000, -120.08000000, 1325.16300000, 25.53412000, 0 )) || ((((IS_CHAR_IN_AREA_3D( sub_493(), -124.45100000, 1330.06800000, 24.86286000, -119.35520000, 1324.82800000, 29.15260000, 0 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U756 ))) AND (IS_CHAR_IN_AREA_3D( sub_493(), -129.32370000, 1329.74000000, 33.38172000, -100.99320000, 1321.20800000, 25.27960000, 0 ))) AND (iVar55 == 7)))
                {
                    vVar3 = {5.00000000, 0.00000000, 2.00000000};
                    vVar6 = {0.00000000, 0.00000000, 0.00000000};
            ...
            if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U756 ))))
            {
                if (IS_CHAR_IN_AREA_3D( sub_493(), -119.56530000, 1323.48600000, 32.91307000, -129.35360000, 1329.76700000, 28.08811000, 0 ))
                {
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U743[1] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                    {
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U743[2] ))) AND (NOT (IS_CHAR_INJURED( sub_493() ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar69 );
                        TASK_SET_CHAR_DECISION_MAKER( 0, l_U715 );
                ...
                if (((IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U756 )) AND (sub_10753( sub_493() ))) || ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U756 )) AND (sub_10753( sub_493() ))))
                {
                    if (NOT l_U817)
                    {
            ...
            if (NOT l_U813)
            {
                if ((((IS_CHAR_INJURED( l_U743[1] )) AND (IS_CHAR_INJURED( l_U743[2] ))) AND (NOT (IS_CHAR_INJURED( sub_493() )))) AND (NOT (IS_CHAR_INJURED( l_U743[0] ))))
                {
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                ...
                {
                    if (((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U756 )))) AND (NOT l_U817))
                    {
                    ...
                    if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U747[0] ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar71 );
                        TASK_COMBAT( 0, sub_493() );
                        CLOSE_SEQUENCE_TASK( uVar71 );
                    ...
                    if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U747[1] ))))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar71 );
                        TASK_COMBAT( 0, sub_493() );
                        CLOSE_SEQUENCE_TASK( uVar71 );
                    ...
                    sub_5440( ref l_U747[2], -93.91010000, 1301.25800000, 34.68630000, 270.78080000, l_U717, l_U720, 1 );
            ...
            if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U756 ))))
            {
                if ((((((IS_CHAR_INJURED( l_U747[0] )) AND (IS_CHAR_INJURED( l_U747[1] ))) || (LOCATE_CHAR_ANY_MEANS_3D( sub_493(), -109.72260000, 1319.18700000, 35.51525000, 9.08000000, 1.00000000, 2.00000000, 0 ))) || (IS_CHAR_IN_AREA_3D( sub_493(), -133.31260000, 1331.15100000, 33.81746000, -136.82430000, 1327.91100000, 38.34174000, 0 ))) || (IS_PLAYER_TARGETTING_CHAR( sub_547(), l_U756 ))) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), l_U756 )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U756 )))
                    {
                        OPEN_SEQUENCE_TASK( ref uVar71 );
            ...
            if ((IS_CHAR_IN_AREA_3D( sub_493(), -137.60830000, 1328.89600000, 48.48069000, -118.40550000, 1316.10100000, 37.68614000, 0 )) AND (NOT (IS_CHAR_INJURED( l_U756 ))))
            {
                l_U668 = 0;
                l_U667 = 24;
            }
            if (NOT (IS_CHAR_INJURED( l_U756 )))
            {
                if ((IS_CHAR_IN_AREA_3D( l_U756, -136.23980000, 1327.08100000, 38.01790000, -119.45070000, 1317.17800000, 41.53566000, 0 )) AND (NOT l_U829))
                {
                    UNLOCK_RAGDOLL( l_U756, 1 );
                    l_U829 = 1;
                }
            ...
            switch (l_U668)
            {
                ...
                sub_12284( ref l_U672, 1 );
                CREATE_CAM( 14, ref l_U772 );
                SET_CAM_POS( l_U772, -126.38370000, 1315.94400000, 39.54937000 );
            ...
            if (NOT (IS_CHAR_INJURED( l_U756 )))
            {
                ...
                GET_GAME_TIMER( ref l_U674 );
                if ((l_U674 > l_U676) AND (sub_15595()))
                {
                    sub_11503( 1000 );
                    sub_13680( ref l_U772, ref l_U773, ref l_U774 );
                    sub_15253( ref l_U672, 1, 1, 1 );
            ...
            if (NOT (IS_CHAR_INJURED( l_U756 )))
            {
                switch (l_U669)
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( sub_493() )))
                    {
                        ...
                        TASK_FOLLOW_NAV_MESH_TO_COORD( 0, -47.52230000, 1306.22000000, 38.84770000, 2, -2, 0.10000000 );
                    ...
                    sub_12284( ref l_U672, 1 );
                    CREATE_CAM( 14, ref l_U772 );
                    SET_CAM_POS( l_U772, -47.10014000, 1321.64400000, 38.31750000 );
            ...
            break;
            case 33:
            if (((NOT (sub_3829( l_U872 ))) AND (g_U15654[43])) AND (NOT l_U821))
            {
            ...
            if (((NOT (sub_3829( l_U872 ))) AND (NOT g_U15654[43])) AND (NOT l_U821))
            {
                ALTER_WANTED_LEVEL( sub_547(), 2 );
                APPLY_WANTED_LEVEL_CHANGE_NOW( sub_547() );
                SET_WANTED_MULTIPLIER( 1.00000000 );
            ...
            if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (l_U821))
            {
            ...
            if (NOT l_U809)
            {
                if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (IS_CHAR_IN_AREA_3D( sub_493(), -16.60471000, 1383.39100000, 11.77348000, -179.14020000, 1239.74100000, 48.59429000, 0 )))
                {
                    ...
                    REQUEST_MODEL( 1708842493 );
                    while (((NOT (HAS_MODEL_LOADED( uVar74 ))) || (NOT (HAS_MODEL_LOADED( uVar75 )))) || (NOT (HAS_MODEL_LOADED( 1708842493 ))))
                    {
                        WAIT( 0 );
                    }
            ...
            break;
            case 35:
            if (((NOT (IS_CHAR_INJURED( sub_493() ))) AND (IS_VEH_DRIVEABLE( l_U777 ))) AND (NOT (IS_CHAR_INJURED( l_U756 ))))
            {
                if (IS_CHAR_IN_CAR( l_U756, l_U777 ))
                {
                    GET_CHAR_COORDINATES( l_U756, ref uVar81._fU0, ref uVar81._fU4, ref uVar81._fU8 );
                    if ((IS_CAR_ON_SCREEN( l_U777 )) AND (LOCATE_CHAR_ANY_MEANS_3D( sub_493(), uVar81._fU0, uVar81._fU4, uVar81._fU8, 20.00000000, 20.00000000, 4.00000000, 0 )))
                    {
                        SET_ROUTE( l_U678, 0 );
        ...
        if (IS_KEYBOARD_KEY_PRESSED( 36 ))
        {
            ...
            switch (l_U667)
            {
                ...
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    SET_CHAR_COORDINATES( sub_493(), -64.02670000, 1270.96100000, 19.39010000 );
                    SET_CHAR_HEADING( sub_493(), 0.00000000 );
                    SET_CAM_BEHIND_PED( sub_493() );
                }
                break;
...
void sub_2334()
{
    ...
    {
        if (((sub_2372( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_27261()
{
    ...
    if (NOT l_U787)
    {
        if ((IS_CHAR_DEAD( l_U757[1] )) AND (DOES_CHAR_EXIST( l_U757[1] )))
        {
        ...
        if ((IS_CHAR_DEAD( l_U757[0] )) AND (DOES_CHAR_EXIST( l_U757[0] )))
        {
...
void sub_29645()
{
    if ((NOT (IS_CHAR_INJURED( l_U756 ))) AND (NOT l_U812))
    {
            ...
            if (NOT (IS_CHAR_INJURED( (uParam0^) )))
            {
                if (NOT (IS_CHAR_INJURED( sub_493() )))
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
                    {
                        ...
                        {
                            if ((sub_34214( (uParam3^) )) AND (iVar7 > l_U647))
                            {
                    ...
                    if (NOT l_U651)
                    {
                        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
                        {
                            if (IS_CHAR_PLAYING_ANIM( (uParam0^), uParam2, uParam1 ))
                            {
                                ...
                                {
                                    case 0:
                                    if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( (uParam0^) ))))
                                    {
                                        ...
                                        if (iVar22 > 360)
                                        {
                                            if ((iVar21 < (iVar22 - 360)) || (iVar21 >= iVar23))
                                            {
                                                l_U652 = 1;
                                            }
                                            else
                                        ...
                                        else if ((iVar21 <= iVar22) AND (iVar21 > iVar23))
                                        {
                                            l_U652 = 1;
                                        }
                                        else
...
int sub_35462(unknown uParam0)
{
    ...
    if (DOES_CHAR_EXIST( uParam0 ))
    {
        if (NOT (IS_CHAR_INJURED( sub_493() )))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                if ((GET_CHAR_MELEE_ACTION_FLAG0( uParam0 )) || (((NOT IS_USING_CONTROLLER()) AND (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_547(), uParam0 ))) AND (IS_CONTROL_JUST_PRESSED( 0, 4 ))))
                {
                    if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
                    {
                        SET_CHAR_READY_TO_BE_EXECUTED( uParam0, 0 );
...
int sub_36094(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    if (((l_U908) AND (NOT l_U909)) AND (NOT (IS_CHAR_INJURED( uParam4 ))))
    {
...
void sub_53383()
{
    ...
    if (NOT (IS_CHAR_INJURED( sub_493() )))
    {
        switch (l_U667)
        {
            ...
            if ((NOT (IS_CHAR_INJURED( sub_493() ))) AND (NOT (IS_CHAR_INJURED( l_U756 ))))
            {
                if (((IS_CHAR_IN_AREA_3D( sub_493(), -104.72730000, 1329.53500000, 29.38552000, -120.03560000, 1324.87900000, 33.44109000, 0 )) AND (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U756, sub_493(), 0 ))) AND (IS_CHAR_SHOOTING( sub_493() )))
                {
                    sub_53707( 0 );
                }
            }
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (IS_CHAR_IN_AREA_3D( sub_493(), -118.83280000, 1329.60900000, 29.47890000, -123.59060000, 1323.64600000, 33.69999000, 0 ))
                {
                    sub_53707( 0 );
                }
            }
            break;
            case 19:
            if ((IS_CHAR_IN_AREA_3D( sub_493(), -105.69020000, 1321.53800000, 29.29646000, -100.85510000, 1311.67300000, 32.84549000, 0 )) || (IS_CHAR_IN_AREA_3D( sub_493(), -129.37470000, 1327.20600000, 33.75061000, -119.19040000, 1323.53600000, 37.49474000, 0 )))
            {
                sub_53707( 1 );
            }
            break;
            ...
            if (NOT (IS_CHAR_INJURED( sub_493() )))
            {
                if (IS_CHAR_IN_AREA_3D( sub_493(), -57.18403000, 1327.20800000, 37.36558000, -47.35752000, 1323.53300000, 31.50466000, 0 ))
                {
                    ...
                    sub_5440( ref l_U747[2], -93.91010000, 1301.25800000, 34.68630000, 270.78080000, l_U715, l_U720, 1 );
...
void sub_53707(boolean bParam0)
{
    ...
    REQUEST_MODEL( -301223260 );
    REQUEST_MODEL( 1708842493 );
    while (((NOT (HAS_MODEL_LOADED( 1304597482 ))) || (NOT (HAS_MODEL_LOADED( -301223260 )))) || (NOT (HAS_MODEL_LOADED( 1708842493 ))))
    {
        WAIT( 0 );
    }
    LOAD_ALL_OBJECTS_NOW();
    if (bParam0)
    {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U756 ))) AND (IS_VEH_DRIVEABLE( l_U777 )))
        {
    ...
    {
        CLEAR_AREA( -30.40030000, 1307.37000000, 20.00270000, 5.00000000, 1 );
        CREATE_CAR( 1304597482, -30.40030000, 1307.37000000, 20.00270000, ref l_U777, 1 );
        ...
        if ((NOT (IS_CHAR_INJURED( l_U756 ))) AND (IS_VEH_DRIVEABLE( l_U777 )))
        {
            ...
            TASK_FOLLOW_NAV_MESH_TO_COORD( 0, -67.54270000, 1324.75500000, 20.43650000, 3, -2, 0.20000000 );
...
void sub_56263()
{
    if (((l_U671 == 0) AND (l_U667 != 1)) AND (l_U667 != 2))
    {
        if (NOT (IS_CHAR_INJURED( sub_493() )))
        {
            if (NOT l_U814)
