...
void sub_1520()
{
    ...
    {
        if (((sub_1558( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_2910()
{
    ...
    l_U2702 = 0;
    while (((((NOT (sub_3694( 3 ))) || (NOT (HAS_MODEL_LOADED( 467469635 )))) || (NOT (HAS_MODEL_LOADED( -196312163 )))) || (NOT (HAS_MODEL_LOADED( uVar2 )))) || (NOT (HAVE_ANIMS_LOADED( "missfaustin8" ))))
    {
        WAIT( 0 );
        if (NOT (sub_3694( 25 )))
        {
    ...
    l_U2422 = {734.10520000, -71.63000000, 4.81900000};
    ...
    WAIT( 6000 );
    sub_4490( "F7_CALLJ" );
    ADD_SCENARIO_BLOCKING_AREA( 699.00000000, -90.00000000, 0.00000000, 806.32480000, 0.85870000, 100.00000000 );
    SET_PED_NON_CREATION_AREA( 699.00000000, -90.00000000, 0.00000000, 806.32480000, 0.85870000, 100.00000000 );
...
int sub_4623(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_2759() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_2759() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_5150()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
    ...
    switch (l_U2875)
    {
        ...
        if (DOES_CHAR_EXIST( l_U2421 ))
        {
            if (NOT (IS_CHAR_DEAD( l_U2421 )))
            {
                if (NOT l_U2429)
                {
                    if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_2759(), l_U2421, 10.00000000, 10.00000000, 7.00000000, 0 )) AND (sub_18255( sub_2759() )))
                    {
                        if (IS_CHAR_ON_SCREEN( l_U2421 ))
                        {
                            if (NOT (IS_WANTED_LEVEL_GREATER( sub_4388(), 0 )))
                            {
                                ...
                                {
                                    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_2759(), 731.91470000, -67.22950000, 5.82370000, 7.00000000, 8.00000000, 3.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_2759(), 731.91470000, -75.22950000, 5.82490000, 4.00000000, 3.00000000, 3.00000000, 0 )))
                                    {
                                        if (l_U2711)
                                        {
                                            l_U2617[47] = 0;
                    ...
                    {
                        if ((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 721.17860000, -73.18290000, 5.82350000, 12.00000000, 10.00000000, 3.00000000, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 712.54360000, -54.57320000, 5.92100000, 12.00000000, 10.00000000, 3.00000000, 0 )))
                        {
            ...
            if (l_U2429)
            {
                if (((sub_20093( l_U2421, 1, 0 )) || (IS_PED_RAGDOLL( l_U2421 ))) || (NOT l_U2711))
                {
                    if ((NOT (sub_20506( l_U2876 ))) || (NOT l_U2711))
                    {
                        if ((NOT (sub_20687( l_U2876 ))) || (NOT l_U2711))
                        {
                            if (NOT l_U2692)
                            {
                                if (NOT (IS_CHAR_DEAD( l_U2421 )))
                                {
                                    if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_2759(), l_U2421, 10.00000000, 10.00000000, 3.00000000, 0 )) AND (sub_18255( sub_2759() )))
                                    {
                                        if (sub_20801( 1, 1 ))
                                        {
                            ...
                            else if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_2759(), l_U2421, 10.00000000, 10.00000000, 3.00000000, 0 )) AND (sub_18255( sub_2759() )))
                            {
                                if (sub_21413())
                                {
                                    if (DOES_BLIP_EXIST( l_U2420 ))
        ...
        while (((((((((NOT (HAS_MODEL_LOADED( l_U2315 ))) || (NOT (HAS_MODEL_LOADED( l_U2316 )))) || (NOT (HAS_MODEL_LOADED( uVar8 )))) || (NOT (HAS_MODEL_LOADED( -1758615024 )))) || (NOT (sub_3694( 25 )))) || (NOT (sub_3694( 24 )))) || (NOT (HAS_MODEL_LOADED( -268530289 )))) || (NOT (HAS_MODEL_LOADED( -366960778 )))) || (NOT (HAVE_ANIMS_LOADED( "missfaustin8" ))))
        {
        ...
        if (NOT l_U2705)
        {
            ...
            if ((IS_PED_IN_COVER( sub_2759() )) || ((l_U2888 - l_U2887) > 30000))
            {
                ...
                while ((IS_SCREEN_FADING_IN()) AND ((l_U2890 - l_U2889) < 4000))
                {
                    WAIT( 0 );
                    GET_GAME_TIMER( ref l_U2890 );
                    SET_GAME_CAM_HEADING( 45.00000000 );
...
void sub_9335(unknown uParam0)
{
    switch (uParam0)
    {
        ...
        case 4: break;
        case 5:
        l_U2431[5] = sub_14213( l_U2316, 23, 765.59940000, -61.69250000, 5.85370000, 70.55740000, 12 );
        ...
        l_U491[6]._fU36 = {763.22580000, -66.60790000, 5.84150000};
        l_U491[6]._fU20 = 1;
        ...
        {
            l_U2431[10] = sub_14213( l_U2316, 23, 761.65390000, -61.12990000, 4.83970000, 90.00000000, 7 );
        }
        else
        {
        ...
        {
            l_U2431[20] = sub_14213( l_U2316, 23, 766.72240000, -38.86870000, 8.96880000, 99.00000000, 7 );
            l_U491[20]._fU0 = l_U2431[20];
            l_U491[20]._fU36 = {754.76790000, -45.77350000, 8.96880000};
            l_U491[20]._fU48 = 16;
            l_U491[20]._fU28 = 1;
        ...
        break;
        case 9:
        l_U2431[13] = sub_14213( l_U2315, 23, 800.75260000, -50.41200000, 5.90640000, 115.89770000, 12 );
        ...
        l_U2431[21] = sub_14213( l_U2315, 23, 750.53250000, -69.57870000, 8.96880000, 276.75850000, 12 );
        l_U491[21]._fU0 = l_U2431[21];
        l_U491[21]._fU36 = {766.94740000, -62.01560000, 8.96880000};
        l_U491[21]._fU48 = 49;
        l_U491[21]._fU28 = 1;
...
int sub_21686()
{
    ...
    if (IS_CHAR_ARMED( sub_2759(), 4 ))
    {
        ...
        if (iVar3 != 0)
        {
            if ((((((((iVar3 == 7) || (iVar3 == 9)) || (iVar3 == 10)) || (iVar3 == 11)) || (iVar3 == 12)) || (iVar3 == 13)) || (iVar3 == 14)) || (iVar3 == 15))
            {
...
int sub_25993()
{
    ...
    switch (l_U2846)
    {
        ...
        if (NOT l_U2849)
        {
            ...
            SET_CAM_ROT( l_U2827[4], 18.37989000, -0.00000000, 60.34171000 );
        ...
        if (NOT (IS_CHAR_DEAD( l_U2326 )))
        {
            if (NOT (IS_CHAR_DEAD( l_U2329 )))
            {
                if (((LOCATE_CHAR_ANY_MEANS_3D( l_U2329, 802.00820000, -41.50910000, 5.82420000, 2.00000000, 5.00000000, 2.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2326, 802.00820000, -41.50910000, 5.82420000, 2.00000000, 5.00000000, 2.00000000, 0 ))) || ((l_U2816 - l_U2815) > 4500))
                {
                    SET_CAM_ACTIVE( l_U2827[4], 0 );
                    SET_CAM_PROPAGATE( l_U2827[4], 0 );
...
void sub_28709()
{
    ...
    switch (l_U2872)
    {
        ...
        l_U1613[0] = {l_U491[22]};
        if ((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 742.12020000, -58.02580000, 5.81860000, 1.00000000, 18.00000000, 2.00000000, 0 )) || (sub_28968( ref l_U1613, 1, 1, 0 )))
        {
        ...
        l_U1613[2] = {l_U491[6]};
        l_U1613[3] = {l_U491[7]};
        if (((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 748.22530000, -46.02680000, 5.81860000, 1.00000000, 4.00000000, 1.00000000, l_U2706 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 749.82620000, -56.62440000, 5.81860000, 1.00000000, 7.00000000, 1.00000000, l_U2706 ))) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 751.34040000, -67.77180000, 5.82400000, 1.00000000, 7.00000000, 1.00000000, l_U2706 )))
        {
        ...
        if ((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 756.95720000, -43.76970000, 5.83500000, 1.00000000, 3.50000000, 1.00000000, l_U2706 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 758.65220000, -57.28010000, 5.83150000, 1.00000000, 9.50000000, 1.00000000, l_U2706 )))
        {
            sub_9335( 7 );
            l_U2872 = 4;
        }
        ...
        {
            if ((IS_CHAR_INJURED( l_U2431[14] )) || (IS_CHAR_INJURED( l_U2431[8] )))
            {
                l_U491[17]._fU4 = 1;
        ...
        if (((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 771.82310000, -43.69250000, 5.87620000, 1.00000000, 5.00000000, 1.00000000, l_U2706 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 773.09880000, -50.68310000, 5.86090000, 1.00000000, 3.00000000, 1.00000000, l_U2706 ))) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 773.30920000, -60.17840000, 5.85570000, 1.00000000, 6.00000000, 1.00000000, l_U2706 )))
        {
            sub_15021( ref l_U491[21] );
            l_U491[21]._fU36 = {781.36690000, -60.80030000, 8.96880000};
            l_U491[21]._fU48 = 50;
            l_U491[21]._fU4 = 1;
            l_U2872 = 5;
        }
        ...
        if (l_U2848)
        {
            ...
            if (((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 771.82310000, -43.69250000, 5.87620000, 1.00000000, 5.00000000, 1.00000000, l_U2706 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 771.30320000, -51.28040000, 5.85570000, 1.00000000, 3.00000000, 1.00000000, l_U2706 ))) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 773.30920000, -60.17840000, 5.85570000, 1.00000000, 6.00000000, 1.00000000, l_U2706 )))
            {
                l_U2872 = 5;
            }
        }
...
void sub_31304()
{
    ...
    GET_GAME_TIMER( ref iVar2 );
    if (((NOT (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 748.22530000, -46.02680000, 5.81860000, 1.00000000, 4.00000000, 1.00000000, l_U2706 ))) AND (NOT (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 749.82620000, -56.62440000, 5.81860000, 1.00000000, 7.00000000, 1.00000000, l_U2706 )))) AND (NOT (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 751.34040000, -67.77180000, 5.82400000, 1.00000000, 7.00000000, 1.00000000, l_U2706 ))))
    {
        if (l_U491[10]._fU4)
        {
    ...
    if ((NOT (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 756.95720000, -43.76970000, 5.83500000, 1.00000000, 3.50000000, 1.00000000, l_U2706 ))) AND (NOT (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 758.65220000, -57.28010000, 5.83150000, 1.00000000, 9.50000000, 1.00000000, l_U2706 ))))
    {
        if (l_U491[13]._fU4)
        {
    ...
    for ( I = 0; I <= 34; I++ )
    {
        if (l_U491[I]._fU4)
        {
            if (NOT (IS_CHAR_DEAD( l_U491[I]._fU0 )))
            {
                ...
                else if ((NOT l_U491[I]._fU16) || (l_U491[I]._fU12))
                {
...
void sub_32648(unknown uParam0, unknown uParam1)
{
    switch (uParam1)
    {
        ...
        break;
        case 8:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 772.36130000, -51.31160000, 6.85570000, 773.81020000, -50.92330000, 3.85570000, 5.50000000 );
        break;
        case 9:
        ...
        break;
        case 18:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 747.60470000, -66.00020000, 11.16420000, 748.07650000, -67.94370000, 8.66420000, 8.00000000 );
        break;
        case 19:
        ...
        break;
        case 22:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 744.71140000, -66.04510000, 6.81860000, 741.71420000, -66.17590000, 3.81860000, 2.50000000 );
        break;
        case 23:
        ...
        break;
        case 27:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 775.48160000, -58.17080000, 6.85570000, 779.43790000, -57.58040000, 3.85573000, 4.00000000 );
        break;
        case 28:
        ...
        break;
        case 29:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 797.47910000, -51.27700000, 6.89700000, 800.41880000, -50.67890000, 3.39700000, 1.50000000 );
        break;
        case 30:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 746.88380000, -50.39350000, 6.81870000, 749.73690000, -49.46640000, 3.81870000, 1.50000000 );
        break;
        case 31:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 755.46890000, -47.72830000, 6.83420000, 758.42960000, -47.24430000, 3.83420000, 2.50000000 );
        break;
        case 32:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 764.13840000, -45.41950000, 6.85580000, 767.09280000, -44.89850000, 3.85580000, 2.50000000 );
        break;
        case 33:
        ...
        break;
        case 37:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 780.36600000, -47.98500000, 6.88080000, 784.17020000, -46.74900000, 3.88080000, 10.00000000 );
        break;
        case 38:
        ...
        break;
        case 43:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 773.34420000, -60.33490000, 7.36070000, 773.99130000, -62.74970000, 4.36070000, 4.50000000 );
        break;
        case 41:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 767.71030000, -63.92110000, 7.35570000, 775.93950000, -61.79290000, 3.85570000, 3.50000000 );
        break;
        case 44:
        ...
        break;
        case 48:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 804.79160000, -42.30620000, 7.51280000, 825.62640000, -36.99980000, 4.51280000, 39.50000000 );
        break;
        case 49:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 766.21560000, -61.39210000, 11.46880000, 767.06240000, -64.78810000, 8.46880000, 7.00000000 );
        break;
        case 50:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( (uParam0^), 780.66450000, -59.72440000, 11.46890000, 782.00070000, -64.54260000, 8.46890000, 3.00000000 );
        break;
        case 51:
        ...
        if (NOT (IS_CHAR_INJURED( l_U491[I]._fU0 )))
        {
            if (NOT l_U491[I]._fU32)
            {
                if (l_U491[I]._fU28)
                {
                    ...
                    if ((iVar3 < 200) AND (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U491[I]._fU0, sub_2759(), 1 )))
                    {
...
void sub_36821()
{
    ...
    if (NOT l_U2710)
    {
        if (NOT l_U2709)
        {
            if ((NOT l_U2755) AND (NOT l_U2749))
            {
                for ( I = 0; I <= 34; I++ )
                {
                    if (DOES_BLIP_EXIST( l_U2467[I] ))
                    {
                        if (((IS_CHAR_FATALLY_INJURED( l_U2431[I] )) || (l_U490 > 12)) || (l_U2699))
                        {
                            REMOVE_BLIP( l_U2467[I] );
                        }
                    }
                    else if (((NOT (IS_CHAR_FATALLY_INJURED( l_U2431[I] ))) AND (l_U490 <= 12)) AND (NOT l_U2699))
                    {
        ...
        else if ((NOT l_U2755) AND (NOT l_U2749))
        {
            for ( I = 0; I <= 34; I++ )
            {
                if (DOES_BLIP_EXIST( l_U2467[I] ))
                {
                    if ((IS_CHAR_FATALLY_INJURED( l_U2431[I] )) || (l_U2699))
                    {
                        REMOVE_BLIP( l_U2467[I] );
                    }
                }
                else if (((NOT (IS_CHAR_FATALLY_INJURED( l_U2431[I] ))) AND (NOT (DOES_BLIP_EXIST( l_U2426 )))) AND (NOT l_U2699))
                {
                    ADD_BLIP_FOR_CHAR( l_U2431[I], ref l_U2467[I] );
                    if (NOT l_U2844)
                    {
    ...
    else if ((NOT l_U2755) AND (NOT l_U2749))
    {
        for ( I = 0; I <= 34; I++ )
        {
            if (DOES_BLIP_EXIST( l_U2467[I] ))
            {
                if (((IS_CHAR_FATALLY_INJURED( l_U2431[I] )) || (DOES_BLIP_EXIST( l_U2426 ))) || (l_U2699))
                {
                    REMOVE_BLIP( l_U2467[I] );
                }
            }
            else if ((((NOT (IS_CHAR_FATALLY_INJURED( l_U2431[I] ))) AND (NOT (DOES_BLIP_EXIST( l_U2426 )))) AND (NOT (DOES_BLIP_EXIST( l_U2427 )))) AND (NOT l_U2699))
            {
                ADD_BLIP_FOR_CHAR( l_U2431[I], ref l_U2467[I] );
                CHANGE_BLIP_DISPLAY( l_U2467[I], 2 );
            }
...
void sub_37528()
{
    ...
    if (NOT l_U2505)
    {
        if (((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 779.53590000, -48.52240000, 5.87480000, 1.00000000, 16.00000000, 1.00000000, l_U2706 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 773.48620000, -49.98610000, 5.86420000, 1.00000000, 16.00000000, 1.00000000, l_U2706 ))) || (l_U2416))
        {
            if (sub_28113())
            {
                if (sub_25993())
    ...
    switch (l_U490)
    {
        ...
        if ((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 742.12020000, -58.02580000, 5.81860000, 1.00000000, 18.00000000, 2.00000000, l_U2706 )) || (l_U2504))
        {
            l_U2858 = 1;
            sub_15021( ref l_U1192 );
        ...
        l_U1613[2] = {l_U491[10]};
        l_U1613[3] = {l_U491[20]};
        if ((((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 748.22530000, -46.02680000, 5.81860000, 1.00000000, 4.00000000, 1.00000000, l_U2706 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 749.82620000, -56.62440000, 5.81860000, 1.00000000, 7.00000000, 1.00000000, l_U2706 ))) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 751.34040000, -67.77180000, 5.82400000, 1.00000000, 7.00000000, 1.00000000, l_U2706 ))) || (sub_28968( ref l_U1613, 4, 4, 1 )))
        {
        ...
        l_U1613[2] = {l_U491[9]};
        l_U1613[3] = {l_U491[21]};
        if (((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 756.95720000, -43.76970000, 5.83500000, 1.00000000, 3.50000000, 1.00000000, l_U2706 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 758.65220000, -57.28010000, 5.83150000, 1.00000000, 9.50000000, 1.00000000, l_U2706 ))) || (sub_28968( ref l_U1613, 4, 4, 1 )))
        {
            if (sub_28968( ref l_U1613, 4, 4, 1 ))
            {
                sub_29487();
        ...
        l_U1613[4] = {l_U491[14]};
        l_U1613[5] = {l_U491[15]};
        if ((((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 771.82310000, -43.69250000, 5.87620000, 1.00000000, 5.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 773.09880000, -50.68310000, 5.86090000, 1.00000000, 3.00000000, 1.00000000, 0 ))) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 773.30920000, -60.17840000, 5.85570000, 1.00000000, 6.00000000, 1.00000000, 0 ))) || (sub_28968( ref l_U1613, 6, 6, 1 )))
        {
            if (sub_28113())
            {
                if (sub_25993())
        ...
        case 7: break;
        case 6:
        if ((l_U2701) AND (NOT (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 779.53590000, -48.52240000, 5.87480000, 1.00000000, 16.00000000, 1.00000000, l_U2706 ))))
        {
            if (NOT IS_MESSAGE_BEING_DISPLAYED())
            {
                if (NOT (sub_20506( l_U2357 )))
                {
                    if (NOT l_U2598)
                    {
                        ...
                        if ((l_U2694) || ((l_U2695) AND ((l_U2698 - l_U2697) > 20000)))
                        {
        ...
        case 9:
        l_U1613[0] = {l_U491[16]};
        if ((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 779.53590000, -48.52240000, 5.87480000, 1.00000000, 16.00000000, 1.00000000, l_U2706 )) || (sub_28968( ref l_U1613, 1, 1, 1 )))
        {
                ...
                if (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())
                {
                    if (NOT IS_MESSAGE_BEING_DISPLAYED())
                    {
                        if (NOT (sub_20506( l_U2375 )))
                        {
                            ...
                            {
                                if ((NOT l_U2412) AND (NOT (IS_CHAR_IN_ANY_CAR( sub_2759() ))))
                                {
        ...
        if (NOT l_U2862)
        {
            if ((IS_CHAR_GETTING_IN_TO_A_CAR( sub_2759() )) || (IS_CHAR_IN_ANY_CAR( sub_2759() )))
            {
                if (NOT (IS_CHAR_DEAD( l_U2421 )))
                {
                    UNLOCK_RAGDOLL( l_U2421, 0 );
    ...
    if (l_U2707)
    {
        if ((NOT l_U2700) || ((l_U2700) AND (l_U2701)))
        {
            if (NOT (IS_CHAR_INJURED( l_U2421 )))
            {
                if (NOT (DOES_BLIP_EXIST( l_U2427 )))
    ...
    else if (NOT l_U2863)
    {
        ...
        if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_2759(), 809.10910000, -39.34070000, 6.02610000, 27.00000000, 34.00000000, 1.00000000, 0 ))) || ((l_U2868 - l_U2867) > 50000))
        {
            SET_WANTED_MULTIPLIER( 1.00000000 );
            l_U2863 = 1;
        }
    }
    if ((l_U490 <= 10) AND (l_U490 >= 2))
    {
        sub_61349();
    }
    return;
...
void sub_45373()
{
    ...
    else if ((((l_U2839 > 0) || (l_U2429)) AND (NOT l_U2841)) AND (IS_SCREEN_FADED_IN()))
    {
        if (sub_45393())
        {
            CLEAR_PRINTS();
    ...
    switch (l_U2839)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U2421 )))
        {
            if (NOT l_U2429)
            {
                ...
                SET_CAM_POS( l_U2827[1], 1489.75600000, 46.30952000, 27.84155000 );
        ...
        case 1:
        GET_GAME_TIMER( ref l_U2816 );
        if (((sub_20093( l_U2421, 1, 0 )) || ((l_U2816 - l_U2815) > 6000)) || (l_U2841))
        {
...
void sub_61349()
{
    ...
    if (NOT (IS_GROUP_MEMBER( l_U2421, sub_37806() )))
    {
        if (NOT (IS_CHAR_DEAD( l_U2421 )))
        {
            if (l_U1192._fU4)
            {
                if ((NOT l_U1192._fU8) AND (NOT l_U1192._fU12))
                {
                ...
                {
                    if ((NOT l_U1192._fU16) || (l_U1192._fU12))
                    {
                        if ((sub_20093( l_U1192._fU0, 1, 0 )) || (l_U1192._fU12))
                        {
...
void sub_62410()
{
    switch (l_U2826)
    {
        ...
        if (l_U490 > 1)
        {
            if (((l_U2819) AND (NOT (sub_20506( l_U2820 )))) || (l_U2504))
            {
                if (NOT IS_HELP_MESSAGE_BEING_DISPLAYED())
                {
                    PRINT_HELP( "FA8_04" );
...
void sub_63603()
{
    ...
    switch (l_U489)
    {
        ...
        else if (((((HAS_MODEL_LOADED( 2046537925 )) AND (HAS_MODEL_LOADED( -183203150 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 470 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 471 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 474 )))
        {
        ...
        if (NOT l_U2691)
        {
            ...
            else if ((sub_20093( l_U2533[4], 1, 0 )) AND (sub_20093( l_U2533[5], 1, 0 )))
            {
                l_U1212[3]._fU4 = 1;
                l_U1212[4]._fU4 = 1;
                l_U1212[6]._fU4 = 1;
        ...
        {
            GET_GAME_TIMER( ref l_U2816 );
            if (((LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 754.48740000, -46.91460000, 5.82380000, 1.00000000, 6.00000000, 1.00000000, l_U2706 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_2759(), 756.10520000, -63.59430000, 5.81860000, 1.00000000, 6.00000000, 1.00000000, l_U2706 ))) || (l_U491[18]._fU4))
            {
        ...
        if (((l_U2527[0]) AND (l_U2527[1])) AND (l_U2601))
        {
            if (sub_65438())
            {
                l_U489 = 8;
    ...
    for ( I = 0; I <= 19; I++ )
    {
        if (l_U1212[I]._fU4)
        {
            if (NOT (IS_CHAR_DEAD( l_U1212[I]._fU0 )))
            {
                ...
                else if ((NOT l_U1212[I]._fU16) || (l_U1212[I]._fU12))
                {
                    if ((sub_20093( l_U1212[I]._fU0, 1, 0 )) || (l_U1212[I]._fU12))
                    {
