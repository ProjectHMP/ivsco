void main()
{
    ...
    while (true)
    {
        ...
        if (l_U894)
        {
            ...
            {
                if (((sub_5702( ref l_U609 )) > 200) AND (NOT (IS_CHAR_ON_SCREEN( l_U609 ))))
                {
                    CLEAR_PRINTS();
        ...
        if ((IS_KEYBOARD_KEY_PRESSED( 21 )) AND (NOT l_U901))
        {
        ...
        if (l_U916)
        {
            ...
            TASK_FOLLOW_NAV_MESH_TO_COORD( 0, -138.29670000, 1378.42200000, 31.79690000, 2, -2, 0.40000000 );
            TASK_CHAR_SLIDE_TO_COORD( 0, l_U726, 1378.42200000, 31.79690000, l_U725, 1061158912 );
...
void sub_2145()
{
    ...
    {
        if (((sub_2183( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3585()
{
    ...
    {
        iVar3 = sub_3613( 13 );
        if ((sub_3658( 13, iVar3 )) AND (g_U9932[g_U9999[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_3613( 11 );
        if ((sub_3658( 11, iVar3 )) AND (g_U9932[g_U10090[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_4137( I );
        if ((sub_3658( g_U10324[I]._fU12, iVar3 )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
...
void sub_4674()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((sub_4137( I )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
int sub_9332()
{
    if ((HAS_CHAR_GOT_WEAPON( sub_3461(), 16 )) || (HAS_CHAR_GOT_WEAPON( sub_3461(), 17 )))
    {
        return 1;
    }
    return 0;
...
void sub_9477()
{
    switch (l_U600)
    {
        ...
        switch (l_U601)
        {
            ...
            if ((IS_KEYBOARD_KEY_PRESSED( 36 )) AND (NOT (l_U682[0] == 1)))
            {
            ...
            if ((IS_KEYBOARD_KEY_PRESSED( 36 )) AND (NOT l_U876))
            {
        ...
        if (NOT l_U864)
        {
            ...
            SET_CAM_ROT( l_U644[4], 10.20727000, -0.00000000, 63.78502000 );
        ...
        if ((l_U864) AND (TIMERB() > 8500))
        {
            if (NOT l_U865)
            {
                ...
                SET_CAM_ROT( l_U652, 10.20727000, -0.00000000, 63.78502000 );
                SET_CAM_POS( l_U653, -135.61200000, 1378.91300000, 32.84066000 );
                SET_CAM_ROT( l_U653, 5.17315800, -0.00000000, -160.57460000 );
        ...
        if ((l_U865) AND (NOT l_U866))
        {
            if (NOT IS_CAM_INTERPOLATING())
            {
                ...
                SET_CAM_ROT( l_U655, 6.03156800, -0.00000000, -74.59895000 );
        ...
        if ((l_U866) AND (NOT l_U899))
        {
            if (TIMERB() > 6000)
            {
                ...
                SET_CAM_POS( l_U652, -140.95000000, 1378.88100000, 34.03773000 );
...
void sub_11505()
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3461() )) || (IS_CHAR_ON_ANY_BIKE( sub_3461() )))
    {
...
int sub_12174(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3461() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3461() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_12701()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_19256()
{
    ...
    switch (l_U607)
    {
        ...
        if (sub_20042( 1 ))
        {
            ...
            CREATE_CAM( 3, ref l_U654 );
            SET_CAM_POS( l_U652, -164.64220000, 1379.52900000, 42.47095000 );
            ...
            SET_CAM_ROT( l_U656, 11.20563000, -0.00000000, 72.62022000 );
            ...
            SET_CAM_FOV( l_U657, 39.30001000 );
        ...
        break;
        case 5:
        if ((NOT IS_CAM_INTERPOLATING()) AND ((GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT( "AmbTV" )) > 0))
        {
            SET_CAM_ACTIVE( l_U654, 0 );
            SET_CAM_PROPAGATE( l_U654, 0 );
            SET_CAM_ACTIVE( l_U655, 0 );
        ...
        break;
        case 6:
        if ((sub_19375( ref l_U692, 3250 )) || (l_U879))
        {
...
void sub_25185()
{
    ...
    if ((l_U701 > 2) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3461(), -139.79350000, 1378.56800000, 32.51210000, 2.00000000, 1.30000000, 1.80000000, 0 )))
    {
        if (NOT l_U845)
        {
            TASK_FLUSH_ROUTE();
...
{
    if ((IS_SNIPER_BULLET_IN_AREA( -134.70000000, 1384.00000000, 35.47000000, -139.44630000, 1377.01600000, 31.80000000 )) || (IS_BULLET_IN_BOX( -134.70000000, 1384.00000000, 35.47000000, -139.44630000, 1377.01600000, 31.80000000, 1 )))
    {
        if (bParam0)
        {
            l_U603 = 11;
...
int sub_27919()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_2183( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_2469( I );
            return 1;
        }
...
void sub_29652()
{
    ...
    l_U701++;
    OPEN_SEQUENCE_TASK( ref l_U619 );
    TASK_FOLLOW_NAV_MESH_TO_COORD( 0, -138.19670000, 1378.42200000, 31.79690000, 2, -2, 0.40000000 );
    TASK_CHAR_SLIDE_TO_COORD( 0, -138.19670000, 1378.42200000, 31.79690000, 93.00000000, 1061158912 );
    TASK_PLAY_ANIM_WITH_ADVANCED_FLAGS( 0, "Spooked_2nd_Half", "missfrancis4", 8.00000000, 0, 1, 1, 1, 0, 1, 0, -1 );
    CLOSE_SEQUENCE_TASK( l_U619 );
    TASK_PERFORM_SEQUENCE( l_U609, l_U619 );
    CLEAR_SEQUENCE_TASK( l_U619 );
    ...
    switch (l_U596)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U609 )))
        {
            if (NOT (IS_CAR_DEAD( l_U610 )))
            {
                ...
                if ((NOT (IS_CHAR_IN_CAR( l_U609, l_U610 ))) || ((l_U712 < 0.50000000) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3461(), l_U609, 10.00000000, 10.00000000, 10.00000000, 0 ))))
                {
                    CLEAR_CHAR_TASKS( l_U609 );
                    OPEN_SEQUENCE_TASK( ref l_U620 );
                    TASK_SMART_FLEE_CHAR( 0, sub_3461(), 50.00000000, 5000 );
...
void sub_37009(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3461() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_25224())) AND (iVar3 != 4))
    {
