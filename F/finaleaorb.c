void main()
{
    ...
    l_U484 = {754.95810000, -214.45890000, 4.81880000};
    l_U490 = 0;
    l_U491 = 0;
    l_U489 = 0;
    while (true)
    {
        ...
        if ((IS_PLAYER_PLAYING( sub_418() )) AND (NOT (IS_CHAR_DEAD( sub_456() ))))
        {
            switch (l_U491)
            {
                case 0:
...
void sub_193()
{
    ...
    if ((NOT (DOES_BLIP_EXIST( l_U487 ))) AND (NOT (DOES_BLIP_EXIST( l_U488 ))))
    {
        l_U489 = 0;
        return;
    }
...
int sub_747(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_456() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_456() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_1274()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_5301()
{
    ...
    if (l_U490 == 1)
    {
        if (((sub_5706()) AND (NOT sub_5845())) AND (NOT sub_5897()))
        {
            g_U15654[12] = 1;
            l_U490 = 99;
        }
        if (((IS_CHAR_IN_AREA_3D( sub_456(), 682.06890000, -243.41550000, 0.00000000, 782.33720000, -153.58430000, 32.40240000, 0 )) AND (NOT sub_5845())) AND (NOT sub_5897()))
        {
            g_U15654[12] = 0;
            l_U490 = 99;
        }
        if (((IS_CHAR_IN_AREA_3D( sub_456(), 682.06890000, -295.79970000, 0.00000000, 749.06460000, -234.07570000, 32.40240000, 0 )) AND (NOT sub_5845())) AND (NOT sub_5897()))
        {
            g_U15654[12] = 0;
            l_U490 = 99;
        }
        if (((IS_CHAR_IN_AREA_3D( sub_456(), 645.37670000, -357.94360000, 0.00000000, 725.22410000, -234.07570000, 32.40240000, 0 )) AND (NOT sub_5845())) AND (NOT sub_5897()))
        {
            g_U15654[12] = 0;
            l_U490 = 99;
        }
...
void sub_18286()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_6411( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
            if ((sub_6411( 1, g_U569[I] )) != 0)
            {
                sub_6662( I );
...
int sub_21278()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_6411( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_6662( I );
            return 1;
        }
