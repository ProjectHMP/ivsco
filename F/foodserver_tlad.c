    ...
    while (true)
    {
        ...
        if (IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
        {
            switch (l_U105)
            {
                ...
                case 2:
                sub_4426();
                if ((NOT (IS_CHAR_INJURED( l_U115 ))) AND (NOT (IS_CHAR_INJURED( sub_2856() ))))
                {
                    if (l_U166)
                    {
                        if (IS_CHAR_ARMED( sub_2856(), 7 ))
                        {
                            l_U166 = 0;
                        }
                        else
                    ...
                    else if (NOT (IS_CHAR_ARMED( sub_2856(), 7 )))
                    {
                        l_U166 = 1;
                    }
                    else
...
int sub_1280()
{
    ...
    else
    {
        ...
        if (((HAS_MODEL_LOADED( l_U116 )) AND (HAS_MODEL_LOADED( l_U117 ))) AND (HAVE_ANIMS_LOADED( "amb@FFOOD_SERVER" )))
        {
            ...
            {
                sub_2926( 0, sub_2856(), "JOHNNY", 0 );
            }
            sub_2926( 1, l_U115, l_U152, 0 );
...
void sub_1381(unknown uParam0, unknown Result)
{
...
void sub_2926(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    sub_3006( "\n PED NUMBER ", uParam0 );
    sub_3046( " ADDED WITH VOICE ", uParam2 );
    return;
}

void sub_3006(unknown uParam0, unknown uParam1)
{
    return;
}
...
int sub_3212()
{
    ...
    vVar2 = {l_U107 + vVar2};
    vVar5 = {l_U107 + vVar5};
    if (IS_PLAYER_PLAYING( sub_3286() ))
    {
        if (NOT (IS_CHAR_INJURED( l_U115 )))
        {
            if ((sub_3347()) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3286(), l_U115 )))
            {
                sub_3459( l_U135, l_U134 );
                return 1;
            }
        }
        else
        ...
        if (NOT sub_3995())
        {
            if (IS_WANTED_LEVEL_GREATER( sub_3286(), 0 ))
            {
                sub_3459( l_U135, l_U134 );
                return 1;
            }
            if ((IS_CHAR_SHOOTING( sub_2856() )) || (IS_ANY_CHAR_SHOOTING_IN_AREA( vVar2, vVar5, 0 )))
            {
                sub_3459( l_U135, l_U134 );
                return 1;
            }
            if (IS_CHAR_IN_MELEE_COMBAT( sub_2856() ))
            {
                l_U166 = 1;
                if (NOT (IS_CHAR_INJURED( l_U115 )))
                {
            ...
            if (NOT (IS_CHAR_INJURED( l_U115 )))
            {
                if (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U115, sub_2856(), 0 ))
                {
                    sub_3459( l_U135, l_U134 );
                    return 1;
                }
...
int sub_3347()
{
    if (IS_PLAYER_PLAYING( sub_3286() ))
    {
        if (IS_CHAR_ARMED( sub_2856(), 7 ))
        {
            if (IS_PLAYER_TARGETTING_CHAR( sub_3286(), l_U115 ))
            {
                return 1;
            }
        }
...
void sub_3459(int iParam0, string sParam1)
{
    string sVar4;
    ...
    if (NOT (IS_STRING_NULL( sParam1 )))
    {
        if (COMPARE_STRING( sParam1, ref g_U10470 ))
        {
            ...
            if (l_U102)
            {
                ALLOW_PLAYER_TO_CARRY_NON_MISSION_OBJECTS( sub_3286(), 1 );
                l_U102 = 0;
            }
            if (l_U100)
            {
...
int sub_3818()
{
    if (LOCATE_CHAR_IN_CAR_3D( sub_2856(), l_U123._fU0, l_U123._fU4, l_U123._fU8, 1.50000000, 1.50000000, 2.00000000, 0 ))
    {
...
int sub_3995()
{
    ...
    {
        GET_INTERIOR_FROM_CHAR( sub_2856(), ref iVar2 );
    }
    if (iVar2 == nil)
    {
        return 1;
...
void sub_4391()
{
    ...
    if (IS_PLAYER_PLAYING( sub_3286() ))
    {
        if (sub_4417())
        {
            if (NOT l_U162)
            {
                if (sub_5067( l_U148, ref l_U154, l_U160, 1 ))
                {
                    if (NOT (IS_CHAR_INJURED( l_U115 )))
                    {
                        TASK_LOOK_AT_CHAR( l_U115, sub_2856(), -2, 1 );
                    }
                    l_U162 = 1;
                }
            }
            if (IS_SCORE_GREATER( sub_3286(), l_U130 - 1 ))
            {
                if (TIMERA() > 2000)
                {
                    if (sub_6121( l_U135, 0 ))
                    {
                        if (sub_6415( l_U135, l_U134, 0 ))
                        {
                            sub_3459( l_U135, l_U134 );
                            if (NOT (IS_CHAR_INJURED( l_U115 )))
                            {
                                if (NOT (sub_7077( l_U154 )))
                                {
                                    if (sub_5067( l_U150, ref l_U154, l_U160, 1 ))
                                    {
                                        ;
                                    }
                                }
                                SET_PLAYER_CONTROL( sub_3286(), 0 );
                                SET_MINIGAME_IN_PROGRESS( 1 );
                                REMOVE_PLAYER_HELMET( sub_3286(), 1 );
                                sub_7304();
                                OPEN_SEQUENCE_TASK( ref l_U120 );
                                TASK_CHAR_SLIDE_TO_COORD( 0, l_U123._fU0, l_U123._fU4, l_U123._fU8, sub_7403(), 5.00000000 );
                                TASK_TURN_CHAR_TO_FACE_CHAR( 0, l_U115 );
                                CLOSE_SEQUENCE_TASK( l_U120 );
                                TASK_PERFORM_SEQUENCE( sub_2856(), l_U120 );
                                ...
                                else if (sub_9094( l_U130 ))
                                {
                                    iVar2 = sub_1381( 0, 4 );
                                    if (iVar2 == 0)
                                    {
                                        SET_PLAYER_MOOD_NORMAL( sub_3286() );
                                    }
                                    SET_CHAR_HEALTH( sub_2856(), sub_9199() );
                                    INCREMENT_INT_STAT_NO_MESSAGE( 97, l_U130 );
                                    INCREMENT_INT_STAT_NO_MESSAGE( 306, 1 );
                                    INCREMENT_INT_STAT_NO_MESSAGE( 308, 1 );
                                    sub_9328( l_U129, 1 );
                                    RESET_VISIBLE_PED_DAMAGE( sub_2856() );
                                    TASK_START_SCENARIO_IN_PLACE( l_U115, "Scenario_Standing", -1082130432 );
                                    sub_9782();
                                    if (l_U165)
                                    {
        ...
        else if (NOT (IS_CHAR_DEAD( sub_2856() )))
        {
            if (NOT (LOCATE_CHAR_ON_FOOT_3D( sub_2856(), l_U123._fU0, l_U123._fU4, l_U123._fU8, 3.00000000, 3.00000000, 2.00000000, 0 )))
            {
                if (l_U162)
                {
                    if (NOT (sub_7077( l_U154 )))
                    {
                        if (sub_5067( l_U149, ref l_U154, l_U160, 1 ))
                        {
                            ;
                        }
                    }
...
int sub_4417()
{
    if (sub_4426())
    {
        if (NOT (IS_CHAR_DEAD( sub_2856() )))
        {
            if (LOCATE_CHAR_ON_FOOT_3D( sub_2856(), l_U123._fU0, l_U123._fU4, l_U123._fU8, 0.50000000, 0.50000000, 2.00000000, 0 ))
            {
                GET_CHAR_COORDINATES( sub_2856(), ref l_U111._fU0, ref l_U111._fU4, ref l_U111._fU8 );
                l_U111 = {l_U107 - l_U111};
                GET_HEADING_FROM_VECTOR_2D( l_U111._fU0, l_U111._fU4, ref l_U114 );
                if (sub_4831( l_U114, 60.00000000 ))
                {
                    return 1;
                }
            }
...
int sub_4831(unknown uParam0, unknown uParam1)
{
    float fVar4;
    float fVar5;
    float fVar6;
    ...
    if (NOT (IS_CHAR_DEAD( sub_2856() )))
    {
        GET_CHAR_HEADING( sub_2856(), ref fVar4 );
...
void sub_5067(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    return sub_5088( uParam0, ref l_U2._fU0, uParam1, uParam2, uParam3 );
}
...
void sub_5088(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    return sub_5142( ref cVar11, uParam2, uParam3, 0, 0, 0, 0, ref cVar7, uParam4 );
}

int sub_5142(unknown uParam0, int iParam1, unknown uParam2, boolean bParam3, boolean bParam4, unknown uParam5, unknown uParam6, unknown uParam7, unknown uParam8)
{
    int I;
    int iVar12;
...
void sub_5241(unknown uParam0)
{
    return;
}

void sub_5852(int iParam0, int iParam1)
{
    int I;
...
int sub_6121(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_3286() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            if ((IS_PLAYER_CONTROL_ON( sub_3286() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_3286() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_6217())
                    {
                        if ((GET_OBJECT_PED_IS_HOLDING( sub_2856() )) == nil)
                        {
                            if (g_U10468 <= iParam0)
                            {
                                if (g_U10469 == 0)
...
int sub_6313(boolean bParam0, unknown uParam1)
{
    if (bParam0)
    {
        g_U94._fU104 = 1;
...
int sub_6415(unknown uParam0, string sParam1, unknown uParam2)
{
    string sVar5;
    string sVar6;
    ...
    if (sub_6121( uParam0, uParam2 ))
    {
        if (((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) || (IS_THIS_HELP_MESSAGE_WITH_STRING_BEING_DISPLAYED( sParam1, sVar5 ))) || (IS_CONTROL_PRESSED( 2, 23 )))
        {
            if (NOT l_U102)
            {
                ALLOW_PLAYER_TO_CARRY_NON_MISSION_OBJECTS( sub_3286(), 0 );
                l_U102 = 1;
            }
            g_U10468 = uParam0;
            l_U103 = 1;
...
int sub_7077(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5)
{
...
void sub_7304()
{
    if (NOT (IS_CHAR_DEAD( sub_2856() )))
    {
        GET_CURRENT_CHAR_WEAPON( sub_2856(), ref l_U172 );
        SET_CURRENT_CHAR_WEAPON( sub_2856(), 0, 1 );
    }
    return;
}
...
int sub_7555()
{
    ...
    if ((NOT (IS_CHAR_INJURED( sub_2856() ))) AND (NOT (IS_CHAR_INJURED( l_U115 ))))
    {
        switch (l_U106)
        {
            case 0:
            if (l_U164)
            {
                ...
                if (l_U119 == 7)
                {
                    TASK_PLAY_ANIM( sub_2856(), "BUY_BURGER_PLYR", "amb@FFOOD_SERVER", 8.00000000, 0, 0, 0, 0, -2 );
            ...
            {
                GET_SCRIPT_TASK_STATUS( sub_2856(), 29, ref l_U119 );
                if (l_U119 == 7)
                {
                    TASK_TURN_CHAR_TO_FACE_CHAR( l_U115, sub_2856() );
                    l_U164 = 1;
                }
                else if (IS_PLAYER_PLAYING( sub_3286() ))
                {
                    if ((TIMERB() > 5000) || (IS_PLAYER_CLIMBING( sub_3286() )))
                    {
                        ;
                    }
                }
            ...
            if (IS_CHAR_PLAYING_ANIM( sub_2856(), "amb@FFOOD_SERVER", "BUY_BURGER_PLYR" ))
            {
                GET_CHAR_ANIM_CURRENT_TIME( sub_2856(), "amb@FFOOD_SERVER", "BUY_BURGER_PLYR", ref fVar3 );
            }
            GET_SCRIPT_TASK_STATUS( l_U115, 80, ref l_U119 );
            if (l_U119 == 7)
            {
                SET_PLAYER_CONTROL( sub_3286(), 1 );
            ...
            if (l_U163 == 0)
            {
                ...
                else if (NOT l_U173)
                {
                    if (NOT (sub_7077( l_U154 )))
                    {
                        SAY_AMBIENT_SPEECH( sub_2856(), "ORDER_FOOD", 0, 0, 0 );
                        l_U173 = 1;
                    }
                }
                if (fVar2 > 0.58000000)
                {
                    if (DOES_OBJECT_EXIST( l_U118 ))
                    {
                        if (IS_OBJECT_ATTACHED( l_U118 ))
                        {
                            if (NOT (sub_7077( l_U154 )))
                            {
                                if (sub_5067( l_U151, ref l_U154, l_U160, 1 ))
                                {
                                    ;
                                }
                            }
            ...
            else if (fVar3 > 0.58000000)
            {
                if (DOES_OBJECT_EXIST( l_U118 ))
                {
                    if (NOT (IS_OBJECT_ATTACHED( l_U118 )))
                    {
                        ATTACH_OBJECT_TO_PED( l_U118, sub_2856(), 1232, 0.06000000, 0.12000000, -0.11000000, 1.49000000, -0.31000000, -0.72000000, 0 );
                    }
                    if (l_U173)
                    {
                        if (NOT (sub_7077( l_U154 )))
                        {
                            SAY_AMBIENT_SPEECH( sub_2856(), "THANKS", 0, 0, 0 );
                            l_U173 = 0;
                        }
                    }
                }
            ...
            if (fVar3 == 1.00000000)
            {
                TASK_PLAY_ANIM_SECONDARY_UPPER_BODY( sub_2856(), "EAT_BURGER_PLYR", "amb@FFOOD_SERVER", 8.00000000, 0, 0, 0, 0, -2 );
                SET_PLAYER_CONTROL( sub_3286(), 1 );
                SET_MINIGAME_IN_PROGRESS( 0 );
                l_U163 = 0;
                l_U106 = 2;
            ...
            break;
            case 2:
            if (IS_CHAR_PLAYING_ANIM( sub_2856(), "amb@FFOOD_SERVER", "EAT_BURGER_PLYR" ))
            {
                GET_CHAR_ANIM_CURRENT_TIME( sub_2856(), "amb@FFOOD_SERVER", "EAT_BURGER_PLYR", ref fVar3 );
            }
            if ((fVar3 > 0.90000000) || (NOT (IS_CHAR_PLAYING_ANIM( sub_2856(), "amb@FFOOD_SERVER", "EAT_BURGER_PLYR" ))))
            {
                if (DOES_OBJECT_EXIST( l_U118 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U118 ))
...
int sub_9094(int iParam0)
{
    int iVar3;

    STORE_SCORE( sub_3286(), ref iVar3 );
    if (iVar3 >= iParam0)
    {
        ADD_SCORE( sub_3286(), -iParam0 );
        return 1;
        break;
    }
    return 0;
...
void sub_9199()
{
    ...
    if (NOT (IS_CHAR_DEAD( sub_2856() )))
    {
        GET_CHAR_HEALTH( sub_2856(), ref Result );
        if (Result <= 100)
        {
            Result += 100;
        }
...
void sub_9328(unknown uParam0, unknown uParam1)
{
    sub_9349( uParam0, uParam1, 0.00000000, "" );
    return;
}

void sub_9349(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
...
void sub_9782()
{
    if (NOT (IS_CHAR_DEAD( sub_2856() )))
    {
        SET_CURRENT_CHAR_WEAPON( sub_2856(), l_U172, 0 );
    }
    return;
}
