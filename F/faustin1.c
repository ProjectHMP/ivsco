...
void sub_1752()
{
    ...
    {
        if (((sub_1790( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_2654()
{
    ...
    SWITCH_ROADS_BACK_TO_ORIGINAL( 1356.12500000, -869.40160000, -7.33800000, 1332.86300000, -767.89320000, 18.34270000 );
...
void sub_3226()
{
    ...
    {
        if ((((((IS_CHAR_IN_MODEL( sub_3235(), 2046537925 )) || (IS_CHAR_IN_MODEL( sub_3235(), -1627000575 ))) || (IS_CHAR_IN_MODEL( sub_3235(), 148777611 ))) || (IS_CHAR_IN_MODEL( sub_3235(), -350085182 ))) || (IS_CHAR_IN_MODEL( sub_3235(), -1900572838 ))) || ((IS_CHAR_IN_MODEL( sub_3235(), 1127131465 )) AND (NOT l_U924)))
        {
...
void sub_5168()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( -46564867 ))) || (NOT (HAS_MODEL_LOADED( -810318068 ))))
    {
        WAIT( 0 );
    }
    ...
    l_U627[1] = {759.18710000, -467.35070000, 5.92750000};
...
void sub_7529()
{
    ...
    while ((NOT (HAS_MODEL_LOADED( 2046537925 ))) || (NOT (HAS_MODEL_LOADED( -183203150 ))))
    {
        WAIT( 0 );
    }
    ...
    TASK_FOLLOW_NAV_MESH_TO_COORD( 0, 1288.48300000, -761.20620000, 8.21170000, 3, -2, 0.50000000 );
    ...
    switch (l_U841)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U490[l_U486] )))
        {
            if (IS_VEH_DRIVEABLE( uParam0 ))
            {
                ...
                if ((l_U513 == 7) || (IS_CAR_STOPPED( uParam0 )))
                {
                    SETTIMERA( 0 );
        ...
        if (IS_SCREEN_FADED_OUT())
        {
            ...
            if (IS_VEH_DRIVEABLE( uParam0 ))
            {
                ...
                SET_CAM_ATTACH_OFFSET( l_U516, 0.78000000, 3.60000000, 0.63000000 );
        ...
        if (NOT l_U896)
        {
            if (l_U812)
            {
                if ((NOT (IS_CHAR_INJURED( l_U494 ))) AND (IS_VEH_DRIVEABLE( uParam0 )))
                {
        ...
        if ((fVar5 < 2.70000000) AND (IS_VEH_DRIVEABLE( uParam0 )))
        {
            l_U841 = 16;
            SETTIMERA( 0 );
            if (NOT (IS_CHAR_INJURED( l_U490[l_U486] )))
        ...
        if (NOT l_U856)
        {
            if (TIMERA() > 100)
            {
                ...
                SET_CAM_FOV( l_U515, 65.80000000 );
        ...
        case 18:
        CLEAR_AREA_OF_CARS( l_U657, l_U658, l_U659, 200 );
        if ((NOT (IS_CHAR_INJURED( l_U490[l_U486] ))) || (sub_6305( 5000, l_U900 )))
        {
            if ((NOT (IS_CHAR_PLAYING_ANIM( l_U490[l_U486], "MISSFAUSTIN1", "VAN_OPEN_DOORS" ))) || (sub_6305( 5000, l_U900 )))
            {
                if ((NOT sub_16383()) || (sub_6305( 5000, l_U900 )))
                {
        ...
        break;
        case 11:
        if ((IS_CHAR_INJURED( l_U494 )) AND (IS_CHAR_INJURED( l_U490[l_U486] )))
        {
            l_U841 = 21;
            l_U683 = 1;
        }
...
void sub_18720()
{
    ...
    if (NOT l_U814)
    {
        switch (sub_22675())
        {
            ...
            if (l_U921)
            {
                if ((sub_22799( 0 )) || (NOT CAN_PHONE_BE_SEEN_ON_SCREEN()))
                {
                    if (sub_23074())
                    {
                        if (l_U923)
...
int sub_18860(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3235() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3235() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_19375()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
    ...
    for ( I = 0; I <= 2; I++ )
    {
        if (DOES_VEHICLE_EXIST( l_U497[I] ))
        {
            if (IS_VEH_DRIVEABLE( l_U497[I] ))
            {
                ...
                {
                    if ((l_U917[I] < 900) || (IS_CHAR_SHOOTING( sub_3235() )))
                    {
                        if (NOT l_U691[I])
                        {
...
void sub_24964(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        if (IS_CHAR_PLAYING_ANIM( uParam0, "MISSFAUSTIN1", "VAN_OPEN_DOORS" ))
        {
            ...
            if ((fVar3 > 0.16000000) AND (fVar3 < 0.99000000))
            {
                l_U673[l_U486] = 1;
                l_U681 = 1;
            }
            if ((fVar3 > 0.65000000) AND (fVar3 < 0.99000000))
            {
                l_U677[l_U486] = 1;
                l_U681 = 1;
            }
...
void sub_25177()
{
    if (l_U681)
    {
        ...
        if ((l_U905 == 1.00000000) AND (l_U903 == 1.00000000))
        {
            l_U681 = 0;
            l_U904 = 0.05500000;
            l_U906 = 0.08000000;
...
void sub_27522(unknown uParam0)
{
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        if (NOT (DOES_CHAR_EXIST( l_U494 )))
        {
            ...
            while ((NOT (HAS_MODEL_LOADED( -746428590 ))) || (NOT (HAS_MODEL_LOADED( -111611196 ))))
            {
                WAIT( 0 );
            }
            if (IS_VEH_DRIVEABLE( uParam0 ))
...
void sub_27896(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3235() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_28064())) AND (iVar3 != 4))
    {
...
void sub_30106()
{
    ...
    switch (l_U819)
    {
        ...
        if (TIMERA() > 500)
        {
            if (NOT l_U830)
            {
                SET_CAM_POS( l_U826, 909.68370000, 561.70330000, 22.70485000 );
            ...
            if (NOT (LOCATE_CHAR_ON_FOOT_3D( sub_3235(), 917.57840000, 569.35920000, 22.27770000, 4.00000000, 8.00000000, 2.00000000, 0 )))
            {
                l_U819 = 8;
                CLOSE_GARAGE( "QW2MG1" );
                SETTIMERA( 0 );
...
void sub_30115()
{
    ...
    Result = 0;
    if (((sub_6305( 1500, l_U820 )) AND (sub_30140())) AND (IS_SCREEN_FADED_IN()))
    {
        if (l_U821)
        {
            Result = 1;
...
void sub_45201(unknown uParam0)
{
    ...
    Result = 0;
    if ((((CHECK_STUCK_TIMER( uParam0, 3, 60000 )) || (CHECK_STUCK_TIMER( uParam0, 0, 5000 ))) || (CHECK_STUCK_TIMER( uParam0, 1, 40000 ))) || (CHECK_STUCK_TIMER( uParam0, 2, 30000 )))
    {
        Result = 1;
    }
    return Result;
