void main()
{
    ...
    l_U1020 = {84.92000000, 373.34300000, 39.08900000};
    l_U1045 = 0;
    l_U1046 = 0;
    l_U1052 = 16;
    l_U1053 = 0;
            ...
            switch (l_U880)
            {
                ...
                if (l_U971)
                {
                    if (NOT l_U970)
                    {
                        ...
                        if ((sub_33858( 1000, l_U1263 )) || (NOT (IS_CONTROL_PRESSED( 0, 6 ))))
                        {
                ...
                if (l_U970)
                {
                    if (NOT l_U971)
                    {
                        ...
                        if ((sub_33858( 5000, l_U1263 )) || (NOT (IS_CONTROL_PRESSED( 0, 6 ))))
                        {
                            if (NOT (IS_CHAR_IN_AIR( sub_5707() )))
                            {
                                if (IS_PLAYER_PLAYING( sub_6521() ))
...
void sub_3227()
{
    ...
    {
        if (((sub_3265( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_4164()
{
    ...
    {
        iVar3 = sub_4192( 13 );
        if ((sub_4237( 13, iVar3 )) AND (g_U9932[g_U9999[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_4192( 11 );
        if ((sub_4237( 11, iVar3 )) AND (g_U9932[g_U10090[I]._fU0]._fU0))
        {
    ...
    {
        iVar3 = sub_4716( I );
        if ((sub_4237( g_U10324[I]._fU12, iVar3 )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
...
void sub_5253()
{
    ...
    for ( I = 0; I < 59; I++ )
    {
        if ((sub_4716( I )) AND (g_U9932[g_U10324[I]._fU28]._fU0))
        {
            iVar4++;
        }
    }
...
void sub_9274()
{
    sub_9284( 11 );
    sub_9284( 16 );
    while ((NOT (sub_9994( 11 ))) || (NOT (sub_9994( 16 ))))
    {
        WAIT( 0 );
    }
...
void sub_19320()
{
    ...
    if (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_5707() ))
    {
        ...
        if ((NOT (IS_CHAR_IN_MODEL( sub_5707(), 837858166 ))) AND (NOT (IS_CHAR_IN_MODEL( sub_5707(), -488123221 ))))
        {
...
void sub_32888()
{
    ...
    if ((NOT l_U971) AND (NOT l_U970))
    {
        if ((DOES_CHAR_EXIST( l_U893[1] )) AND (DOES_CHAR_EXIST( l_U893[0] )))
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U893[1], sub_5707(), 0 )) AND (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U893[0], sub_5707(), 0 )))
            {
            ...
            if (NOT l_U1199)
            {
                if (NOT (IS_CHAR_INJURED( l_U893[0] )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U893[1] )))
                    {
                        ...
                        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U893[0], l_U1201._fU0, l_U1201._fU4, l_U1201._fU8, l_U1204._fU0, l_U1204._fU4, l_U1204._fU8, 0 )) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U893[1], l_U1201._fU0, l_U1201._fU4, l_U1201._fU8, l_U1204._fU0, l_U1204._fU4, l_U1204._fU8, 0 )))
                        {
                            l_U1199 = 1;
                            l_U1200 = 1;
...
int sub_36989()
{
    if ((HAS_CHAR_GOT_WEAPON( sub_5707(), 16 )) || (HAS_CHAR_GOT_WEAPON( sub_5707(), 17 )))
    {
        if (NOT sub_37030())
        {
            l_U973 = 1;
...
void sub_39837()
{
    ...
    vVar23 = {2.86119000, -0.00000000, 53.97218000};
    ...
    switch (l_U1073)
    {
        ...
        if (IS_SCREEN_FADED_OUT())
        {
            EXTINGUISH_FIRE_AT_POINT( 74.13000000, 315.60000000, 13.85000000, 25.00000000 );
            if (NOT l_U884)
            {
                if (l_U995 == 0)
                {
            ...
            sub_40570();
            LOAD_SCENE( 74.13000000, 315.60000000, 13.85000000 );
        ...
        if (NOT (IS_CHAR_INJURED( l_U893[1] )))
        {
            if (NOT (IS_CHAR_INJURED( l_U893[0] )))
            {
                if ((IS_CHAR_PLAYING_ANIM( l_U893[0], "missfrancis5", "CHATTING_ON_BENCH_B" )) AND (IS_CHAR_PLAYING_ANIM( l_U893[1], "missfrancis5", "CHATTING_ON_BENCH_A" )))
                {
                    l_U1073 = 7;
                }
            }
...
void sub_40147()
{
    ...
    Result = 0;
    if (((sub_33858( 1500, l_U1071 )) AND (sub_40172())) AND (IS_SCREEN_FADED_IN()))
    {
        if (l_U1072)
        {
            Result = 1;
...
void sub_40570()
{
    ...
    fVar2 = 243.92300000;
    vVar3 = {74.13000000, 315.60000000, 13.21000000};
    fVar6 = 13.75300000;
    GET_CHAR_COORDINATES( sub_5707(), ref uVar7._fU0, ref uVar7._fU4, ref uVar7._fU8 );
...
int sub_49191(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_5707() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_5707() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_49706()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_54352()
{
    switch (l_U1001)
    {
        ...
        break;
        case 1:
        if ((sub_33858( 25000, l_U1002 )) || (l_U1005))
        {
...
void sub_54712()
{
    ...
    switch (l_U1127)
    {
        ...
        switch (sub_53417())
        {
            ...
            else if ((sub_53492( 0 )) || (NOT CAN_PHONE_BE_SEEN_ON_SCREEN()))
            {
                if (sub_55072())
                {
                    l_U1128 = 0;
...
int sub_55648()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_3265( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_3551( I );
            return 1;
        }
...
void sub_60178()
{
    ...
    vVar12 = {-1.01097600, -0.00000000, 77.77480000};
    ...
    switch (l_U1088)
    {
        ...
        if (l_U970)
        {
            if (TIMERA() > 3500)
            {
                ...
                SET_CAM_ROT( l_U974[12], -11.34857000, -0.00000000, 53.95515000 );
                SET_CAM_FOV( l_U974[12], 24.00005000 );
...
void sub_63299()
{
    ...
    switch (l_U1235)
    {
        ...
        while ((NOT (HAS_MODEL_LOADED( 1171614426 ))) || (NOT (HAS_MODEL_LOADED( -1175077216 ))))
        {
            WAIT( 0 );
        }
...
void sub_63358(unknown uParam0, unknown uParam1)
{
    ...
    l_U1218[1] = {40.30000000, 293, 78.80000000};
    ...
    switch (l_U1217)
    {
        ...
        if ((l_U1231 > 0) AND (l_U1231 < 25))
        {
            l_U1233 = 0;
        }
        if ((l_U1231 > 25) AND (l_U1231 < 50))
        {
            l_U1233 = 1;
        }
        if ((l_U1231 > 50) AND (l_U1231 < 75))
        {
            l_U1233 = 2;
        }
        if ((l_U1231 > 75) AND (l_U1231 < 100))
        {
            l_U1233 = 3;
        }
        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
