...
int sub_3258()
{
    ...
    if (IS_PLAYER_PLAYING( sub_3332() ))
    {
        ...
        {
            if ((sub_3393()) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3332(), l_U115 )))
            {
        ...
        if (NOT sub_4041())
        {
            ...
            if ((IS_CHAR_SHOOTING( sub_2902() )) || (IS_ANY_CHAR_SHOOTING_IN_AREA( vVar2, vVar5, 0 )))
            {
                sub_3505( l_U135, l_U134 );
                return 1;
            }
...
int sub_6167(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_3332() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_3332() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_3332() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_6263())
                    {
    ...
    if ((NOT (IS_CHAR_INJURED( sub_2902() ))) AND (NOT (IS_CHAR_INJURED( l_U115 ))))
    {
        switch (l_U106)
        {
            ...
            else
            {
                ...
                {
                    if ((TIMERB() > 5000) || (IS_PLAYER_CLIMBING( sub_3332() )))
                    {
                        ;
                    }
                }
            ...
            if ((fVar3 > 0.90000000) || (NOT (IS_CHAR_PLAYING_ANIM( sub_2902(), "amb@FFOOD_SERVER", "EAT_BURGER_PLYR" ))))
            {
                if (DOES_OBJECT_EXIST( l_U118 ))
                {
                    if (IS_OBJECT_ATTACHED( l_U118 ))
