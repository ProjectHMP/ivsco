void main()
{
    ...
    l_U630 = {898.85940000, -615.14150000, 16.02040000};
    ...
    while (((NOT (sub_5130( 4 ))) || (NOT (HAS_MODEL_LOADED( -2088164056 )))) || (NOT (HAS_MODEL_LOADED( 1976502708 ))))
    {
        WAIT( 0 );
    }
...
void sub_1943()
{
    ...
    {
        if (((sub_1981( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_5622()
{
    ...
    switch (l_U532)
    {
        ...
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3289(), l_U603._fU0, l_U603._fU4, l_U603._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (sub_5917( 1, 1 )))
            {
                SETTIMERA( 0 );
                l_U532++;
            }
        ...
        if (LOCATE_CHAR_ANY_MEANS_3D( sub_3289(), l_U603._fU0, l_U603._fU4, l_U603._fU8, 2.50000000, 2.50000000, 2.50000000, 1 ))
        {
            if (sub_5917( 1, 1 ))
            {
                ...
                SWITCH_ROADS_OFF( 930.97600000, -307.38420000, 15.11990000, 957.37850000, -300.52210000, 25.56260000 );
                ...
                while ((((((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 520 ))) || (NOT (HAS_MODEL_LOADED( l_U693[0] )))) || (NOT (HAS_MODEL_LOADED( l_U693[1] )))) || (NOT (HAS_MODEL_LOADED( -322343873 )))) || (NOT (HAS_MODEL_LOADED( 617421203 )))) || (NOT (HAS_MODEL_LOADED( -202313765 ))))
                {
                    WAIT( 0 );
                }
        ...
        if (TIMERA() > 2500)
        {
            ...
            SWITCH_ROADS_ON( 930.97600000, -307.38420000, 15.11990000, 957.37850000, -300.52210000, 25.56260000 );
            SET_ALL_CARS_CAN_BE_DAMAGED( 1 );
            if (NOT (IS_CAR_DEAD( l_U672 )))
            {
...
void sub_11896()
{
    switch (l_U532)
    {
        ...
        CREATE_CHAR( 26, 1976502708, 949.92350000, -271.38970000, 17.12360000, ref l_U660[3], 1 );
        ...
        if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3289(), 957.35900000, -284.16780000, 19.88210000, 4.50000000, 2.50000000, 2.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3289(), 961.60900000, -259.02330000, 18.77400000, 2.00000000, 3.00000000, 2.50000000, 0 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U659 )))
            {
...
int sub_13980()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_1981( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_2267( I );
            return 1;
        }
...
int sub_17296()
{
    ...
    if ((((l_U642 == 56) || (l_U642 == 0)) || (l_U642 == 3)) || (l_U642 == 1))
    {
        return 0;
        break;
    }
...
void sub_17728()
{
    if (NOT (IS_CHAR_INJURED( l_U659 )))
    {
        ...
        if (NOT (sub_19389( l_U681 )))
        {
            if (TIMERB() > 3500)
            {
                if (((IS_PLAYER_TARGETTING_CHAR( sub_2874(), l_U659 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2874(), l_U659 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U659, sub_3289(), 0 )))
                {
                    OPEN_SEQUENCE_TASK( ref l_U675 );
                    TASK_DUCK( 0, l_U546 );
        ...
        else if (((IS_PLAYER_TARGETTING_CHAR( sub_2874(), l_U659 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2874(), l_U659 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U659, sub_3289(), 0 )))
        {
            OPEN_SEQUENCE_TASK( ref l_U675 );
            TASK_DUCK( 0, l_U546 );
            CLOSE_SEQUENCE_TASK( l_U675 );
        ...
        if ((((((l_U534 > 3) || (NOT (IS_CHAR_HEALTH_GREATER( l_U659, 250 )))) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U659, sub_3289(), 6.00000000, 6.00000000, 3.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3289(), 957.35900000, -284.16780000, 19.88210000, 2.00000000, 1.00000000, 2.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3289(), 961.60900000, -259.02330000, 18.77400000, 2.00000000, 1.00000000, 2.00000000, 0 ))) || (IS_EXPLOSION_IN_AREA( -1, 945.78000000, -272.17000000, 23.63000000, 951.29000000, -261.37000000, 16.27000000 )))
        {
            ...
            SET_CAM_FOV( l_U650, 54.59998000 );
            SET_CAM_ACTIVE( l_U650, 1 );
            SET_CAM_PROPAGATE( l_U650, 1 );
            ACTIVATE_SCRIPTED_CAMS( 1, 1 );
            if (NOT (IS_CHAR_INJURED( l_U659 )))
            {
                ...
                TASK_FOLLOW_NAV_MESH_TO_COORD( 0, 978.43260000, -284.70180000, 30.12800000, 3, 15000, 1.50000000 );
            ...
            while (NOT l_U567)
            {
                ...
                if (TIMERA() > 1400)
                {
                    if ((sub_19389( l_U681 )) || (TIMERA() > 4000))
                    {
                        l_U567 = 1;
                    }
                }
...
void sub_23771()
{
    if (NOT l_U559)
    {
        ...
        if (NOT l_U568)
        {
            if ((NOT (IS_CHAR_INJURED( l_U660[8] ))) AND (NOT (IS_CHAR_INJURED( l_U660[9] ))))
            {
                if (((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3289(), l_U660[8], 8.00000000, 12.00000000, 3.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3289(), l_U660[9], 8.00000000, 12.00000000, 3.00000000, 0 ))) || (TIMERA() > 7000))
                {
        ...
        if (NOT (IS_CHAR_INJURED( l_U659 )))
        {
            ...
            {
                if (((TIMERA() > 6000) || (IS_PLAYER_TARGETTING_CHAR( sub_2874(), l_U659 ))) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2874(), l_U659 )))
                {
            ...
            if (NOT l_U573)
            {
                if ((IS_CHAR_IN_AREA_3D( sub_3289(), 969.22620000, -269.17780000, 19.74050000, 979.36030000, -290.19450000, 40.10190000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3289(), l_U659, 15.00000000, 15.00000000, 15.00000000, 0 )))
                {
            ...
            if ((NOT (IS_CHAR_HEALTH_GREATER( l_U659, 200 ))) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3289(), l_U659, 7.00000000, 7.00000000, 4.50000000, 0 )))
            {
    ...
    else if (NOT (IS_CHAR_INJURED( l_U659 )))
    {
        if (NOT l_U574)
        {
            if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3289(), l_U659, 5.50000000, 5.50000000, 3.00000000, 0 )) || (NOT (IS_CHAR_HEALTH_GREATER( l_U659, 140 ))))
            {
                sub_27615();
                l_U574 = 1;
                SETTIMERB( 0 );
            ...
            if (NOT l_U581)
            {
                if ((LOCATE_CHAR_ANY_MEANS_3D( l_U659, l_U621._fU0, l_U621._fU4, l_U621._fU8, 1.50000000, 1.50000000, 2.00000000, 0 )) || (TIMERB() > 3000))
                {
                    SET_CHAR_PROOFS( l_U659, 0, 0, 0, 0, 0 );
                    l_U581 = 1;
                }
        ...
        if (NOT l_U565)
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( l_U659, l_U621._fU0, l_U621._fU4, l_U621._fU8, 2.00000000, 2.00000000, 3.00000000, 0 )) AND (l_U579 == 1))
            {
                SET_CHAR_PROOFS( l_U659, 0, 0, 0, 0, 0 );
    ...
    if (NOT (IS_CHAR_INJURED( l_U659 )))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U659, l_U600._fU0, l_U600._fU4, l_U600._fU8, 1.20000000, 1.20000000, 3.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3289(), l_U659, 6.50000000, 6.50000000, 3.50000000, 0 )))
        {
...
void sub_25780()
{
    if (NOT l_U570)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3289(), 967.32330000, -258.66200000, 20.30140000, 3.00000000, 3.00000000, 2.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3289(), 957.35900000, -284.16780000, 19.88210000, 3.00000000, 3.00000000, 2.00000000, 0 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U660[5] )))
            {
            ...
            if (NOT (IS_CHAR_INJURED( (uParam0^) )))
            {
                if (NOT (IS_CHAR_INJURED( sub_3289() )))
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
                    {
                        ...
                        {
                            if ((sub_30221( (uParam3^) )) AND (iVar7 > l_U481))
                            {
                    ...
                    if (NOT l_U485)
                    {
                        if (NOT (IS_CHAR_INJURED( (uParam0^) )))
                        {
                            if (IS_CHAR_PLAYING_ANIM( (uParam0^), uParam2, uParam1 ))
                            {
                                ...
                                {
                                    case 0:
                                    if ((NOT (IS_CHAR_INJURED( sub_3289() ))) AND (NOT (IS_CHAR_INJURED( (uParam0^) ))))
                                    {
...
int sub_31094(unknown uParam0)
{
    ...
    if (DOES_CHAR_EXIST( uParam0 ))
    {
        if (NOT (IS_CHAR_INJURED( sub_3289() )))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                if ((GET_CHAR_MELEE_ACTION_FLAG0( uParam0 )) || (((NOT IS_USING_CONTROLLER()) AND (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_2874(), uParam0 ))) AND (IS_CONTROL_JUST_PRESSED( 0, 4 ))))
                {
                    if ((NOT (IS_CHAR_INJURED( sub_3289() ))) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
                    {
                        SET_CHAR_READY_TO_BE_EXECUTED( uParam0, 0 );
...
int sub_31359()
{
    ...
    switch (l_U531)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U659 )))
        {
            if (IS_CHAR_PLAYING_ANIM( l_U659, "missfaustin6", "victim" ))
            {
                ...
                if (fVar5 >= 0.95000000)
                {
                    ...
                    SET_CAM_ROT( l_U651, -79.89085000, -0.00000000, 167.67840000 );
                    l_U531 = 5;
                }
            }
        }
        ...
        if (TIMERA() > 3000)
        {
            ...
            SET_CAM_POS( l_U650, 957.40670000, -303.16840000, 23.61271000 );
