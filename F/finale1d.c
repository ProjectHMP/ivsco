...
void sub_10782()
{
    ...
    {
        if (((sub_10820( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_13314()
{
    ...
    l_U484._fU40 = {605.21360000, 1409.99700000, 18.30088000};
    l_U484._fU52 = {-14.95635000, 0.00000000, 59.50907000};
    l_U484._fU64 = {605.21360000, 1409.99700000, 18.30088000};
...
void sub_13933()
{
    ...
    else
    {
        l_U524 = "upset_get_out_bed_l";
        l_U525 = "upset_in_bed_idle";
        if ((ProtectedGet(g_U34042[1]) >= 65.00000000) AND (g_U34005[1] >= 4))
        {
            l_U526 = "FIN1C_POOR";
        }
        else
    ...
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_13658(), 1 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_13658(), 1 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( sub_13658(), 1, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_13658(), 2 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_13658(), 2 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( sub_13658(), 2, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_13658(), 5 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_13658(), 5 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( sub_13658(), 5, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_13658(), 4 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_13658(), 4 )) == 0)))
    {
        SET_CHAR_COMPONENT_VARIATION( sub_13658(), 4, 0, 0 );
    }
    if ((NOT ((GET_CHAR_DRAWABLE_VARIATION( sub_13658(), 3 )) == 0)) || (NOT ((GET_CHAR_TEXTURE_VARIATION( sub_13658(), 3 )) == 0)))
    {
...
void sub_17136()
{
    ...
    if (IS_PLAYER_PLAYING( sub_2031() ))
    {
        if (sub_17168( l_U512 ))
        {
            ...
            while (NOT bVar2)
            {
                if ((NOT (sub_17168( l_U512 ))) AND (NOT (IS_CHAR_GESTURING( sub_13658() ))))
                {
                    bVar2 = true;
                }
                WAIT( 0 );
