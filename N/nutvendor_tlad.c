...
{
    if ((HAS_MODEL_LOADED( 1432278665 )) AND (HAS_MODEL_LOADED( l_U89 )))
    {
...
void sub_2559(unknown uParam0)
{
    ...
    {
        if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U91, sub_619(), 0 )) || (IS_PLAYER_TARGETTING_CHAR( sub_491(), l_U91 ))) || (sub_3441( l_U21 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U90 )))
            {
                CLEAR_CHAR_TASKS( l_U90 );
        ...
        if (IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_491() ))
        {
            ...
            if (l_U94 == nil)
            {
                if (HAVE_ANIMS_LOADED( "amb@nutcart" ))
                {
                    if (NOT (IS_CHAR_INJURED( l_U90 )))
                    {
                        if ((l_U13 != 1) AND (NOT (IS_CHAR_IN_ANY_CAR( sub_619() ))))
                        {
...
int sub_5250(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_491() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_491() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_491() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U10499)))
                {
                    if (NOT sub_4056())
                    {
...
int sub_10414()
{
    if (((((IS_BUTTON_PRESSED( 0, 17 )) || (IS_BUTTON_PRESSED( 0, 14 ))) || (IS_BUTTON_PRESSED( 0, 15 ))) || (IS_BUTTON_PRESSED( 0, 16 ))) || (sub_10462()))
    {
        CLEAR_CHAR_TASKS_IMMEDIATELY( sub_619() );
        SET_PLAYER_CONTROL( sub_491(), 1 );
        return 1;
...
int sub_10742(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;
    unknown uVar6;
    unknown uVar7;
...
void sub_11867()
{
    ADD_SCORE( sub_491(), -5 );
    sub_11889();
    SET_CHAR_HEALTH( sub_619(), sub_12006() );
    sub_12094( 2, 1 );
...
void sub_12094(unknown uParam0, unknown uParam1)
{
    sub_12115( uParam0, uParam1, 0.00000000, "" );
    return;
}

void sub_12115(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
