void main()
{
    ...
    while (true)
    {
        ...
        if (l_U704)
        {
            if ((IS_CHAR_INJURED( l_U647 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U647, sub_3600(), 0 )))
            {
                REMOVE_BLIP( l_U642 );
                REMOVE_BLIP( l_U643 );
        ...
        switch (l_U824)
        {
            ...
            while (((((((((NOT (HAS_MODEL_LOADED( -432593815 ))) || (NOT (HAS_MODEL_LOADED( 189853472 )))) || (NOT (HAS_MODEL_LOADED( -907477130 )))) || (NOT (HAS_MODEL_LOADED( -344943009 )))) || (NOT (HAS_MODEL_LOADED( 1349725314 )))) || (NOT (HAS_MODEL_LOADED( 1958308232 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 880 )))) || (NOT (HAVE_ANIMS_LOADED( "missvlad2" )))) || (NOT (HAVE_ANIMS_LOADED( "gestures@niko" ))))
            {
                WAIT( 0 );
            ...
            {
                if (((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U648, sub_3600() )) || (NOT (IS_VEH_WINDOW_INTACT( l_U648, 0 )))) || (NOT (IS_VEH_WINDOW_INTACT( l_U648, 1 ))))
                {
                    l_U704 = 0;
                    l_U786 = 3;
                    sub_3755();
            ...
            if (LOCATE_CHAR_ANY_MEANS_2D( sub_3600(), 1012.68100000, -325.19100000, 50.00000000, 50.00000000, 0 ))
            {
                ...
                if ((NOT (IS_CHAR_INJURED( l_U644[0] ))) AND (NOT (IS_CHAR_INJURED( l_U644[1] ))))
                {
            ...
            break;
            case 3:
            if ((((IS_BULLET_IN_AREA( 1011.15600000, -324.52100000, 21.96700000, 2.80000000, 1 )) || (IS_SNIPER_BULLET_IN_AREA( 1011.15600000 - 1.50000000, -324.52100000 - 1.50000000, 21.96700000 - 1.50000000, 1011.15600000 + 1.50000000, -324.52110000 + 1.50000000, 21.96710000 + 1.50000000 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U644[0], sub_3600(), 0 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U644[1], sub_3600(), 0 )))
            {
            ...
            l_U737 = 0;
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3600(), 1012.68100000, -325.19100000, 20.83000000, 1.60000000, 1.60000000, 1.60000000, 0 )) AND (IS_CHAR_ON_ANY_BIKE( sub_3600() )))
            {
                l_U737 = 1;
            }
            ...
            if ((LOCATE_CHAR_ON_FOOT_3D( sub_3600(), 1012.68100000, -325.19100000, 20.83000000, 1.60000000, 1.60000000, 1.60000000, 1 )) || (l_U737))
            {
                if ((sub_10982( 1, 1 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3600(), 1014.94000000, -324.94000000, 20.83000000, 1.10000000, 1.10000000, 1.10000000, 0 )))
                {
            ...
            if ((LOCATE_CHAR_ANY_MEANS_2D( sub_3600(), 1020.77800000, -323.26260000, 3.50000000, 3.50000000, 0 )) || (TIMERA() >= 7000))
            {
                SETTIMERA( 0 );
            ...
            if (NOT l_U716)
            {
                ...
                {
                    GET_OBJECT_COORDINATES( l_U656, ref l_U754._fU0, ref l_U754._fU4, ref l_U754._fU8 );
                    if ((LOCATE_CHAR_ANY_MEANS_OBJECT_3D( sub_3600(), l_U656, 1.60000000, 1.60000000, 1.60000000, 0 )) || (TIMERB() > 500))
                    {
            ...
            if (NOT l_U720)
            {
                if (TIMERB() > 600)
                {
                    ...
                    SET_CAM_POS( l_U799, 1018.80500000, -325.59250000, 21.19296000 );
            ...
            if (NOT l_U728)
            {
                if ((IS_VEH_DRIVEABLE( l_U648 )) AND (NOT (IS_CHAR_INJURED( l_U647 ))))
                {
                    if (NOT (# -NULL-0xbfc08d( l_U648 )))
                    {
                        ...
                        {
                            OPEN_SEQUENCE_TASK( ref l_U698 );
                            TASK_CAR_DRIVE_TO_COORD( 0, l_U648, 1490.42700000, 100.02430000, 22.84160000, 22, 1, -907477130, 3, 10.00000000, -1 );
            ...
            if (IS_VEH_DRIVEABLE( l_U648 ))
            {
                ...
                if (sub_19308())
                {
                    if ((NOT (IS_CAR_ON_SCREEN( l_U648 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CAR_2D( sub_3600(), l_U648, 5.00000000, 5.00000000, 0 ))))
                    {
            ...
            if ((NOT (IS_CHAR_INJURED( l_U647 ))) AND (IS_VEH_DRIVEABLE( l_U648 )))
            {
                if (NOT l_U712)
                {
                    if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3600(), l_U647, 30.00000000, 30.00000000, 30.00000000, 0 ))
                    {
                        if (l_U703)
                        {
                            if ((IS_CHAR_IN_ANY_CAR( sub_3600() )) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                            {
                                if (sub_19735())
                                {
                                    PRINT_HELP( "VL2_3" );
                                    ...
                                    {
                                        OPEN_SEQUENCE_TASK( ref l_U698 );
                                        TASK_CAR_DRIVE_TO_COORD( 0, l_U648, 1490.42700000, 100.02430000, 22.84160000, 25, 1, -907477130, 3, 10.00000000, -1 );
                                        TASK_COMBAT( 0, sub_3600() );
                                        CLOSE_SEQUENCE_TASK( l_U698 );
                                        TASK_PERFORM_SEQUENCE( l_U647, l_U698 );
                                        CLEAR_SEQUENCE_TASK( l_U698 );
                ...
                if (sub_20193( sub_3600() ))
                {
                    ...
                    if (l_U735)
                    {
                        ...
                        {
                            l_U704 = 0;
                            if ((DOES_CHAR_EXIST( l_U647 )) AND (DOES_VEHICLE_EXIST( l_U648 )))
                            {
                                DELETE_CAR( ref l_U648 );
                ...
                if (NOT l_U703)
                {
                    if (IS_VEH_DRIVEABLE( l_U648 ))
                    {
                        if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3600(), l_U647, 300.00000000, 300.00000000, 300.00000000, 0 ))) AND (NOT (IS_CAR_ON_SCREEN( l_U648 ))))
                        {
                            if (sub_10982( 1, 1 ))
                            {
                                l_U704 = 0;
                ...
                {
                    if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3600(), l_U647, 250.00000000, 250.00000000, 250.00000000, 0 ))) AND (NOT (IS_CAR_ON_SCREEN( l_U648 ))))
                    {
                        if (sub_10982( 1, 1 ))
                        {
                            if (NOT (IS_CHAR_DEAD( l_U647 )))
            ...
            if (IS_VEH_DRIVEABLE( l_U648 ))
            {
                ...
                if ((IS_VEH_DRIVEABLE( l_U653 )) || (l_U653 == l_U648))
                {
                    if ((IS_CAR_TOUCHING_CAR( l_U653, l_U648 )) || (l_U653 == l_U648))
                    {
                        if (NOT l_U702)
                        {
                            if (NOT (IS_CHAR_INJURED( l_U647 )))
                        ...
                        if (NOT l_U730[0])
                        {
                            if ((l_U739 > 2) AND (NOT (sub_21121( l_U817 ))))
                            {
                        ...
                        if (NOT l_U730[1])
                        {
                            if ((l_U739 > 5) AND (NOT (sub_21121( l_U817 ))))
                            {
                        ...
                        if (NOT l_U730[2])
                        {
                            if ((l_U739 > 8) AND (NOT (sub_21121( l_U817 ))))
                            {
                        ...
                        if (NOT l_U727)
                        {
                            if ((l_U739 > 6) || (IS_PED_DOING_DRIVEBY( sub_3600() )))
                            {
                                if (l_U823 == 0)
                                {
                                    OPEN_SEQUENCE_TASK( ref l_U698 );
                                    TASK_CAR_DRIVE_TO_COORD( 0, l_U648, 1490.42700000, 100.02430000, 22.84160000, 30, 1, -907477130, 3, 10.00000000, -1 );
                                    TASK_COMBAT( 0, sub_3600() );
                                    CLOSE_SEQUENCE_TASK( l_U698 );
                                    TASK_PERFORM_SEQUENCE( l_U647, l_U698 );
                                    CLEAR_SEQUENCE_TASK( l_U698 );
            ...
            if ((((((((l_U795 > 35) || (l_U739 > 10)) || (l_U653 == l_U648)) || (IS_CAR_ON_FIRE( l_U648 ))) || (l_U738 < 310)) || ((GET_ENGINE_HEALTH( l_U648 )) < 310)) || ((GET_PETROL_TANK_HEALTH( l_U648 )) < 310)) || (CHECK_STUCK_TIMER( l_U648, 0, 5000 )))
            {
                if (IS_VEH_DRIVEABLE( l_U648 ))
                {
                    if (NOT (CHECK_STUCK_TIMER( l_U648, 0, 5000 )))
                    {
                        if (((l_U738 < 310) || ((GET_ENGINE_HEALTH( l_U648 )) < 310)) || ((GET_PETROL_TANK_HEALTH( l_U648 )) < 310))
                        {
                ...
                if ((IS_VEH_DRIVEABLE( l_U648 )) AND (IS_VEH_DRIVEABLE( l_U653 )))
                {
                    if ((IS_CAR_TOUCHING_CAR( l_U653, l_U648 )) || (LOCATE_CHAR_ANY_MEANS_CAR_2D( sub_3600(), l_U648, 30, 30, 0 )))
                    {
                        if (l_U795 > 35)
                        {
                            l_U715 = 1;
            ...
            if ((sub_4909()) AND (IS_SCREEN_FADED_IN()))
            {
                DO_SCREEN_FADE_OUT( 500 );
                while (IS_SCREEN_FADING_OUT())
                {
            ...
            if (NOT l_U710)
            {
                if ((NOT (sub_21121( l_U817 ))) AND (TIMERA() > 4000))
                {
                    if (NOT (IS_CHAR_INJURED( l_U647 )))
                    {
                        if (IS_VEH_DRIVEABLE( l_U648 ))
...
void sub_1497()
{
    ...
    {
        if (((sub_1535( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_18577(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3600() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_18745())) AND (iVar3 != 4))
    {
...
int sub_19308()
{
    if (IS_VEH_DRIVEABLE( l_U648 ))
    {
        if ((((CHECK_STUCK_TIMER( l_U648, 3, 60000 )) || (CHECK_STUCK_TIMER( l_U648, 2, 30000 ))) || (CHECK_STUCK_TIMER( l_U648, 1, 40000 ))) || (CHECK_STUCK_TIMER( l_U648, 0, 5000 )))
        {
            return 1;
        }
    }
...
int sub_19735()
{
    ...
    if (((iVar2 != 4) AND (iVar2 != 5)) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_3600() )))
    {
        return 1;
    }
    return 0;
