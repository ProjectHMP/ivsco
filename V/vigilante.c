void main()
{
    ...
    while (true)
    {
        ...
        if ((sub_2007( sub_228() )) AND (IS_SCREEN_FADED_OUT()))
        {
        ...
        switch (l_U131._fU0)
        {
            ...
            else if ((l_U131._fU4 > 50) AND (l_U131._fU4 < 100))
            {
                sub_16543( l_U131._fU16, l_U131._fU12 );
            }
            else
            ...
            switch (l_U118)
            {
                ...
                switch (l_U95)
                {
                    ...
                    if (NOT (IS_CHAR_INJURED( l_U13 )))
                    {
                        ...
                        if (l_U115)
                        {
                            if ((((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_228(), l_U13, 30.00000000, 30.00000000, 12.50000000, 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U13, sub_228(), 0 ))) || (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_4285(), l_U13 ))) || (IS_PLAYER_TARGETTING_CHAR( sub_4285(), l_U13 )))
                            {
                    ...
                    if (NOT (IS_CHAR_INJURED( l_U13 )))
                    {
                        ...
                        if (l_U115)
                        {
                            if ((HAS_CHAR_SPOTTED_CHAR( l_U13, sub_228() )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U13, sub_228(), 0 )))
                            {
                                CLEAR_CHAR_TASKS_IMMEDIATELY( l_U13 );
                                l_U118 = 2;
                            }
...
int sub_2483()
{
    ...
    else if ((ProtectedGet(g_U8195) >= 10) AND (ProtectedGet(g_U8195) < 20))
    {
        return 2;
    }
...
int sub_3425()
{
    ...
    if ((ProtectedGet(g_U8195) >= 5) AND (ProtectedGet(g_U8195) < 10))
    {
        return 300;
    }
    if ((ProtectedGet(g_U8195) >= 10) AND (ProtectedGet(g_U8195) < 20))
    {
        return 350;
    }
    return 450;
...
void sub_4225()
{
    ...
    if (l_U119 != 2)
    {
        if ((NOT (IS_CHAR_INJURED( l_U13 ))) AND (IS_PLAYER_PLAYING( sub_4285() )))
        {
    ...
    else if ((NOT (IS_CHAR_INJURED( l_U14[0] ))) AND (IS_PLAYER_PLAYING( sub_4285() )))
    {
...
int sub_4657()
{
    ...
    if ((ProtectedGet(g_U8195) >= 10) AND (ProtectedGet(g_U8195) < 15))
    {
        return 2;
    }
    if ((ProtectedGet(g_U8195) >= 15) AND (ProtectedGet(g_U8195) < 20))
    {
        return 3;
    }
    return 4;
...
void sub_5236()
{
    if (l_U120 != 0)
    {
        if ((l_U48 > l_U47) AND (NOT sub_5268()))
        {
            if (l_U96)
            {
                sub_5407( l_U103 );
...
int sub_5268()
{
    if ((NOT (IS_CHAR_DEAD( sub_228() ))) AND (NOT (IS_CHAR_FATALLY_INJURED( l_U13 ))))
    {
...
void sub_5407(int iParam0)
{
    ...
    else
    {
        ...
        if (l_U124)
        {
            ...
            else if ((l_U122 < (l_U123 + 700)) AND (l_U122 > (l_U123 + 500)))
            {
                SET_MULTIPLAYER_HUD_TIME( " " );
                return;
            }
...
void sub_10574(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    if (NOT (IS_CHAR_FATALLY_INJURED( sub_228() )))
    {
        switch (l_U120)
        {
            ...
            if ((NOT (IS_CHAR_FATALLY_INJURED( l_U13 ))) AND (IS_VEH_DRIVEABLE( l_U23 )))
            {
                SET_CHAR_AS_MISSION_CHAR( l_U13 );
                SET_CHAR_HEALTH( l_U13, sub_3425() );
                GIVE_DELAYED_WEAPON_TO_CHAR( l_U13, sub_3525(), 100, 1 );
            ...
            if (((IS_CHAR_FATALLY_INJURED( l_U13 )) AND (IS_CHAR_FATALLY_INJURED( l_U14[0] ))) AND (IS_CHAR_FATALLY_INJURED( l_U14[1] )))
            {
            ...
            else if (NOT (IS_CHAR_FATALLY_INJURED( l_U13 )))
            {
                switch (l_U117)
                {
                    ...
                    if (IS_VEH_DRIVEABLE( l_U23 ))
                    {
                        ...
                        if (((l_U49 > 350) AND (NOT (CHECK_STUCK_TIMER( l_U23, 3, 10000 )))) AND (NOT (CHECK_STUCK_TIMER( l_U23, 0, 10000 ))))
                        {
                            ...
                            else
                            {
                                ...
                                if (((VDIST( l_U40, l_U37 )) > 20.00000000) AND ((VDIST( l_U40, l_U37 )) < 40.00000000))
                                {
                                    if ((l_U51 < 20.00000000) || (l_U51 > 40.00000000))
                                    {
                                        if (IS_CHAR_SITTING_IN_ANY_CAR( l_U13 ))
                                        {
                    ...
                    break;
                    case 4:
                    if ((NOT (IS_CHAR_INJURED( l_U13 ))) AND (NOT (IS_CHAR_FATALLY_INJURED( sub_228() ))))
                    {
                        if (IS_CHAR_SITTING_IN_ANY_CAR( l_U13 ))
                        {
                            TASK_LEAVE_ANY_CAR( l_U13 );
                    ...
                    if ((NOT (IS_CHAR_INJURED( l_U14[0] ))) AND (NOT (IS_CHAR_FATALLY_INJURED( sub_228() ))))
                    {
                        if (IS_CHAR_SITTING_IN_ANY_CAR( l_U13 ))
                        {
                            TASK_LEAVE_ANY_CAR( l_U14[0] );
...
void sub_13968(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    if (NOT (IS_CHAR_FATALLY_INJURED( sub_228() )))
    {
        switch (l_U120)
        {
            ...
            if ((IS_CHAR_FATALLY_INJURED( l_U13 )) AND (IS_CHAR_FATALLY_INJURED( l_U14[0] )))
            {
                if (NOT (sub_6996( l_U13 )))
                {
                    sub_11916();
...
void sub_17558()
{
    if (l_U120 != 0)
    {
        if ((l_U48 > l_U47) AND (NOT (sub_17595( 1112014848 ))))
        {
            if (l_U96)
            {
                sub_5407( l_U103 );
