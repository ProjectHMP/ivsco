void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U133._fU0)
        {
            ...
            if (l_U133._fU4 < 30)
            {
                sub_10663( l_U133._fU16, l_U133._fU12 );
            }
            ...
            {
                sub_14048( l_U133._fU16, l_U133._fU12 );
            }
            break;
            case 2:
            if (l_U133._fU4 < 50)
            {
                sub_16615( l_U133._fU16, l_U133._fU12 );
            }
...
int sub_2499()
{
    ...
    else if ((g_U8754 >= 10) AND (g_U8754 < 20))
    {
        return 2;
    }
    else if (g_U8754 >= 20)
...
int sub_3441()
{
    ...
    if ((g_U8754 >= 5) AND (g_U8754 < 10))
    {
        return 300;
    }
    if ((g_U8754 >= 10) AND (g_U8754 < 20))
    {
        return 350;
    }
    return 450;
...
int sub_4673()
{
    ...
    if ((g_U8754 >= 10) AND (g_U8754 < 15))
    {
        return 2;
    }
    if ((g_U8754 >= 15) AND (g_U8754 < 20))
    {
        return 3;
    }
    return 4;
    ...
    switch (l_U121)
    {
        ...
        if (NOT l_U104)
        {
            if (NOT (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_244() )))
            {
                ...
                {
                    REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U29[0] );
                }
            }
        ...
        if (NOT l_U104)
        {
            if (NOT (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_244() )))
            {
                for ( I = 0; I <= 7; I++ )
                {
                    ...
                    {
                        REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U29[I] );
                    }
                }
            }
            else if (NOT (DOES_BLIP_EXIST( l_U29[0] )))
...
void sub_9459(unknown uParam0)
{
    ...
    iVar3 = 0;
    if (NOT g_U43082[uParam0]._fU0)
    {
        iVar3 = g_U43082[uParam0]._fU8;
        if (iVar3 > 0)
        {
            sub_9528( 6, iVar3 );
            g_U43082[uParam0]._fU0 = 1;
            return;
        }
    }
    return;
...
void sub_9528(unknown uParam0, int iParam1)
{
...
void sub_10256(unknown uParam0)
{
    ...
    sub_10307( ref g_U10751._fU0, 2, uParam0 );
...
void sub_10307(unknown uParam0, unknown uParam1, boolean bParam2)
{
    if (bParam2)
    {
...
void sub_10663(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
    ...
    if (NOT (IS_CHAR_FATALLY_INJURED( sub_244() )))
    {
        switch (l_U122)
        {
            ...
            SET_CAR_HEALTH( l_U25, sub_11170() );
            ...
            SET_PETROL_TANK_HEALTH( l_U25, TO_FLOAT( sub_11170() ) );
            SET_ENGINE_HEALTH( l_U25, TO_FLOAT( sub_11170() ) );
            ...
            else if (NOT (IS_CHAR_FATALLY_INJURED( l_U15 )))
            {
                            ...
                            if (l_U52 == 7)
                            {
                                ...
                                if (NOT (IS_CHAR_FATALLY_INJURED( l_U16[0] )))
                                {
                                    if (IS_CHAR_SITTING_IN_ANY_CAR( l_U16[0] ))
                                    {
                                        ...
                                        TASK_DRIVE_BY( l_U16[0], sub_244(), 0, 0.00000000, 0.00000000, 0.00000000, 1000.00000000, 8, 1, sub_12446() );
                                    }
                                }
                                if (NOT (IS_CHAR_FATALLY_INJURED( l_U16[1] )))
                                {
                                    if (IS_CHAR_SITTING_IN_ANY_CAR( l_U16[1] ))
                                    {
                                        ...
                                        TASK_DRIVE_BY( l_U16[1], sub_244(), 0, 0.00000000, 0.00000000, 0.00000000, 1000.00000000, 8, 1, sub_12446() );
                                    }
                                }
                            }
                            else
                ...
                {
                    REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U29[1] );
                }
                if (IS_CHAR_FATALLY_INJURED( l_U16[1] ))
                {
                    REMOVE_BLIP_AND_CLEAR_INDEX( ref l_U29[2] );
                }
                if (sub_7009( l_U15 ))
                {
                    l_U122 = 3;
...
void sub_14048(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
...
void sub_16615(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
...
int sub_16691(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    int iVar6;
    unknown uVar7;
    unknown uVar8;
    ...
    GENERATE_RANDOM_INT_IN_RANGE( 4, sub_16701() + 1, ref iVar6 );
    l_U106 = iVar6;
    uVar11 = sub_2689();
    ...
    SET_GROUP_FORMATION( uVar10, sub_16957() );
...
void sub_17630()
{
    if (l_U122 != 0)
    {
        if ((l_U50 > l_U49) AND (NOT (sub_17667( 1112014848 ))))
        {
            if (l_U98)
            {
                sub_5423( l_U105 );
...
int sub_18423()
{
    ...
    if (NOT l_U98)
    {
        if (l_U121 != 1)
        {
            if (l_U104)
            {
                if ((VDIST( sub_17676(), uVar2 )) > 100.00000000)
                {
                    return 1;
                }
            }
            else if ((VDIST( sub_17676(), uVar2 )) > 50.00000000)
            {
                return 1;
            }
        }
