...
void sub_2119()
{
    ...
    {
        if (((sub_2157( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3302()
{
    ...
    l_U2156 = sub_3597();
    l_U2157 = sub_3643();
    if (NOT (IS_CHAR_DEAD( l_U2156 )))
    {
        GET_PLAYER_GROUP( l_U2157, ref l_U2155 );
    }
    sub_3727( 0, l_U2156, "NIKO", 0 );
    ...
    if (NOT (IS_CHAR_DEAD( l_U2156 )))
    {
        SET_PLAYER_CONTROL( l_U2157, 1 );
        SET_CHAR_COORDINATES( l_U2156, l_U2501._fU0, l_U2501._fU4, l_U2501._fU8 );
        SET_CHAR_HEADING( l_U2156, 96.13350000 );
...
void sub_4651()
{
    ...
    if (l_U2180[l_U2176] == 0)
    {
        if (g_U9893._fU24)
        {
            ...
            ADD_SCENARIO_BLOCKING_AREA( 930.55990000, -498.18430000, 19.48470000, 940.55990000, -487.18430000, 9.48470000 );
            SET_PED_NON_CREATION_AREA( 930.55990000, -498.18430000, 19.48470000, 940.55990000, -487.18430000, 9.48470000 );
            ...
            CLEAR_CHAR_TASKS( l_U2156 );
            SET_CHAR_COORDINATES( l_U2156, 925.73300000, -489.96130000, 14.33450000 );
        ...
        sub_5459( "missvlad4" );
        SET_CHAR_COORDINATES( l_U2156, 925.73300000, -489.96130000, 14.33450000 );
        SET_CHAR_HEADING( l_U2156, 90.00000000 );
        LOAD_ALL_OBJECTS_NOW();
        while (((NOT sub_5601()) || (NOT sub_5703())) || (NOT sub_5790()))
        {
            WAIT( 0 );
        }
        SUPPRESS_CAR_MODEL( -227741703 );
        ...
        TASK_JUMP( 0, 1 );
        TASK_LOOK_AT_CHAR( 0, l_U2156, 3000, 0 );
...
void sub_4821()
{
    ...
    if (((DOES_VEHICLE_EXIST( l_U2162 )) AND (NOT (IS_CAR_DEAD( l_U2162 )))) AND (l_U2162 != nil))
    {
        ...
        {
            if ((l_U2163 != l_U2162) AND (l_U2163 != nil))
            {
...
void sub_6797()
{
    ...
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 820.19050000, -264.48110000, 165.00000000, 165.50000000, 0 )) AND (l_U2091[0] == 0))
    {
        ...
        CREATE_CAR( -227741703, 815.70730000, -274.84000000, 13.00380000, ref l_U2482, 1 );
        SET_CAR_HEADING( l_U2482, 271.68200000 );
        SET_CAR_ON_GROUND_PROPERLY( l_U2482 );
        SET_CAR_PROOFS( l_U2482, 0, 1, 1, 1, 1 );
        SET_CAR_ENGINE_ON( l_U2482, 1, 1 );
        CHANGE_CAR_COLOUR( l_U2482, 0, 89 );
        CREATE_CHAR_INSIDE_CAR( l_U2482, 26, 1166762483, ref l_U2250 );
        SET_CHAR_AS_ENEMY( l_U2250, 1 );
        SET_CHAR_GET_OUT_UPSIDE_DOWN_CAR( l_U2250, 0 );
        SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U2250, 1 );
        SET_CHAR_NAME_DEBUG( l_U2250, "Ivan" );
        SET_CHAR_RELATIONSHIP_GROUP( l_U2250, 24 );
        SET_CHAR_SUFFERS_CRITICAL_HITS( l_U2250, 0 );
        sub_3727( 1, l_U2250, "IVAN", 0 );
        SET_DONT_ACTIVATE_RAGDOLL_FROM_PLAYER_IMPACT( l_U2250, 1 );
        SET_WANTED_MULTIPLIER( 0.10000000 );
        ALLOW_TARGET_WHEN_INJURED( l_U2250, 1 );
        SET_CHAR_HEALTH( l_U2250, 375 );
        SET_CHAR_MAX_HEALTH( l_U2250, 375 );
        l_U2091[0] = 1;
    }
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 836.96340000, -403.96730000, 40.00000000, 180.50000000, 0 )) AND (l_U2091[3] == 0))
    {
    ...
    if (LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 836.96340000, -403.96730000, 40.00000000, 180.50000000, 0 ))
    {
        FORCE_AIR_DRAG_MULT_FOR_PLAYERS_CAR( l_U2157, 2.50000000 );
    }
    if (IS_CHAR_IN_ANY_CAR( l_U2156 ))
    {
        if (l_U2091[2] == 0)
        {
        ...
        GET_CAR_CHAR_IS_USING( l_U2156, ref l_U2234 );
    ...
    sub_7813();
    if ((l_U2091[0] == 1) AND (NOT (IS_CAR_DEAD( l_U2482 ))))
    {
        if ((((LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 834.11170000, -340.11840000, 11.00000000, 20.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 817.44650000, -294.02660000, 15.49630000, 2.50000000, 2.40000000, 1.50000000, 0 ))) || ((sub_8216( l_U2156, l_U2250, 1 )) < 8.00000000)) || (HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U2482, l_U2156 )))
        {
            l_U2221 = 0;
            REMOVE_BLIP( l_U2484 );
            if ((NOT (IS_CHAR_DEAD( l_U2250 ))) AND (NOT (IS_CAR_DEAD( l_U2482 ))))
            {
                ADD_BLIP_FOR_CHAR( l_U2250, ref l_U2485 );
                SET_BLIP_AS_FRIENDLY( l_U2485, 0 );
            }
            SET_CAR_DENSITY_MULTIPLIER( 0.00000000 );
            sub_8475();
            WAIT( 0 );
            if (NOT (IS_CAR_DEAD( l_U2482 )))
            {
                MARK_CAR_AS_NO_LONGER_NEEDED( ref l_U2235 );
                ENABLE_CHASE_AUDIO( 1 );
                START_PLAYBACK_RECORDED_CAR( l_U2482, 708 );
            }
            l_U1129 = 900.00000000;
            l_U2176++;
            sub_17418();
        }
        if (l_U2091[0] == 1)
        {
            if (((((((LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 820.64890000, -245.94270000, 3.00000000, 11.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 811.08870000, -258.63010000, 3.50000000, 3.50000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 850.26240000, -244.51680000, 15.79550000, 4.00000000, 12.00000000, 3.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 871.51570000, -287.71920000, 17.05500000, 23.00000000, 31.00000000, 20.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 814.99680000, -244.41490000, 15.18060000, 3.50000000, 12.00000000, 6.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 823.32060000, -274.76620000, 15.34690000, 1.50000000, 3.00000000, 3.00000000, 0 ))) || ((sub_17753( l_U2156, 814.03540000, -269.81020000, 15.34270000 )) < 8.00000000))
            {
                l_U2221 = 1;
                REMOVE_BLIP( l_U2484 );
                if ((NOT (IS_CHAR_DEAD( l_U2250 ))) AND (NOT (IS_CAR_DEAD( l_U2482 ))))
                ...
                {
                    MARK_CAR_AS_NO_LONGER_NEEDED( ref l_U2235 );
                    START_PLAYBACK_RECORDED_CAR( l_U2482, 709 );
                }
                l_U2176++;
                sub_17418();
            }
...
void sub_7813()
{
    ...
    if (DOES_VEHICLE_EXIST( l_U2482 ))
    {
        if (NOT (IS_CAR_DEAD( l_U2482 )))
        {
            GET_CAR_HEALTH( l_U2482, ref iVar2 );
            uVar3 = GET_ENGINE_HEALTH( l_U2482 );
            PRINTSTRING( "ivans car health: " );
            PRINTINT( sub_7917( l_U2482 ) );
            PRINTNL();
            ...
            if (iVar2 < 400)
            {
                SET_CAR_HEALTH( l_U2482, 400 );
                SET_ENGINE_HEALTH( l_U2482, 400.00000000 );
                SET_CAR_PROOFS( l_U2482, 1, 1, 1, 1, 1 );
            }
        }
    }
    return;
...
void sub_8475()
{
    ...
    l_U1367[20] = -67282078;
    l_U1699[16] = {1244.49400000, -215.48940000, 24.21080000};
...
void sub_8486(boolean bParam0, unknown uParam1)
{
    unknown uVar4;
    unknown uVar5;
    unknown uVar6;
    ...
    l_U1129 = 0.00000000;
    l_U513 = 0;
    if (IS_PLAYER_PLAYING( sub_3643() ))
    {
        GET_CHAR_COORDINATES( sub_3597(), ref uVar4._fU0, ref uVar4._fU4, ref uVar4._fU8 );
        l_U1851._fU0 = uVar4._fU0 - 100.00000000;
        l_U1851._fU4 = uVar4._fU4 - 100.00000000;
        l_U1851._fU8 = uVar4._fU8 - 100.00000000;
        l_U1854._fU0 = uVar4._fU0 + 100.00000000;
        l_U1854._fU4 = uVar4._fU4 + 100.00000000;
        l_U1854._fU8 = uVar4._fU8 + 100.00000000;
        SWITCH_ROADS_OFF( l_U1851._fU0, l_U1851._fU4, l_U1851._fU8, l_U1854._fU0, l_U1854._fU4, l_U1854._fU8 );
        if (bParam0)
        {
    ...
    if (IS_PLAYER_PLAYING( sub_3643() ))
    {
        DONT_DISPATCH_COPS_FOR_PLAYER( sub_3643(), 1 );
...
void sub_17933()
{
    ...
    l_U1488[13] = {1144.43200000, -330.92440000, 17.67250000};
...
void sub_21735()
{
    if (l_U2180[l_U2176] == 0)
    {
        STOP_PED_SPEAKING( l_U2156, 0 );
        PRINT_NOW( "VLA4A_02", 7500, 1 );
        sub_17418();
        SET_CHAR_WILL_FLY_THROUGH_WINDSCREEN( l_U2156, 0 );
        GET_GAME_TIMER( ref l_U2242 );
        SETTIMERA( 0 );
        l_U2180[l_U2176] = 1;
    }
    if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (TIMERA() > 7500)) AND (l_U2091[1] == 0))
    {
        sub_21901( "V4_DEPOT", ref l_U2170, 8, 1 );
        l_U2091[1] = 1;
    }
    if (((NOT (sub_22883( l_U2170 ))) AND (l_U2091[1] == 1)) AND (l_U2210 == 0))
    {
    ...
    if ((IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "BRKCTRL" )) AND (l_U2210 == 1))
    {
    ...
    if (NOT (IS_CAR_DEAD( l_U2482 )))
    {
        if (IS_CHAR_IN_CAR( l_U2156, l_U2482 ))
        {
            MARK_CAR_AS_NO_LONGER_NEEDED( ref l_U2482 );
        }
    }
    GET_GAME_TIMER( ref l_U2243 );
    if ((((l_U2243 - l_U2242) > 22000) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_22883( l_U2170 ))))
    {
        if ((sub_23278( 0, 10 )) > 5)
        {
    ...
    if (NOT (IS_CAR_DEAD( l_U2482 )))
    {
        if (l_U2199 < 310.00000000)
        {
            if (l_U2221 == 0)
            {
                sub_23474( l_U2482, l_U2156, ref l_U2227, 27.00000000, 20.00000000, 40.00000000, 0.65000000, 1.60000000, 1065353216 );
            }
            else
            {
                sub_24509( l_U2482, l_U2156, ref l_U2227, 27.00000000, 27.00000000, 40.00000000, 0.65000000, 1.60000000, 1065353216 );
            }
            if ((l_U2221 == 0) AND ((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 43849.22000000))
            {
                sub_24509( l_U2482, l_U2156, ref l_U2227, 38.00000000, 34.00000000, 55.00000000, 1.20000000, 1.80000000, 1065353216 );
            }
            if ((l_U2221 == 0) AND ((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 46849.22000000))
            {
                sub_24509( l_U2482, l_U2156, ref l_U2227, 38.00000000, 34.00000000, 55.00000000, 1.35000000, 1.80000000, 1065353216 );
            }
        }
        if (((l_U2221 == 0) AND ((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 68166.00000000)) || ((l_U2221 == 1) AND ((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 28207.79000000)))
        {
            ...
            sub_23474( l_U2482, l_U2156, ref l_U2227, 50.00000000, 40.00000000, 50.00000000, l_U2233, 1.75000000, 1065353216 );
        }
        if ((sub_17753( l_U2156, 814.03540000, -269.81020000, 15.34270000 )) < 30.00000000)
        {
            sub_23474( l_U2482, l_U2156, ref l_U2227, 33.00000000, 27.00000000, 40.00000000, 1.45000000, 2.00000000, 1065353216 );
        }
        if (IS_CHAR_ON_FOOT( l_U2156 ))
        {
            l_U2227 = 1.00000000;
        }
        sub_27639( l_U2482, l_U2227 );
        sub_42893( ref l_U2250 );
        if (((sub_8216( l_U2250, l_U2156, 1 )) > l_U2199) AND (NOT (IS_CAR_ON_SCREEN( l_U2482 ))))
        {
            REMOVE_BLIP( l_U2485 );
            DELETE_CHAR( ref l_U2250 );
            DELETE_CAR( ref l_U2482 );
    ...
    PRINTFLOAT( l_U2227 );
    PRINTNL();
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 1175.97000000, -378.41300000, 90.00000000, 90.00000000, 0 )) AND ((NOT l_U2091[0]) == 0))
    {
        sub_44664();
    ...
    if (DOES_VEHICLE_EXIST( l_U2482 ))
    {
        if (NOT (IS_CAR_DEAD( l_U2482 )))
        {
            if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2482 ))
            {
                if ((((l_U2221 == 0) AND ((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 79066.00000000)) || ((l_U2221 == 1) AND ((FIND_TIME_POSITION_IN_RECORDING( l_U2482 )) >= 44207.79000000))) || (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2482 ))))
                {
                    ENABLE_CHASE_AUDIO( 0 );
                    STOP_PLAYBACK_RECORDED_CAR( l_U2482 );
                    sub_45143( 0 );
                    ADD_SCENARIO_BLOCKING_AREA( 1153.80000000, -390.31980000, 19.61120000, 1190.00000000, -346.00000000, 50.00000000 );
                    SET_PED_NON_CREATION_AREA( 1153.80000000, -390.31980000, 19.61120000, 1190.00000000, -346.00000000, 50.00000000 );
                    SWITCH_PED_PATHS_OFF( 1153.80000000, -390.31980000, 19.61120000, 1190.00000000, -346.00000000, 40.00000000 );
                    sub_3086();
                    SET_CAR_PROOFS( l_U2482, 0, 0, 0, 0, 0 );
                    SET_CHAR_WILL_FLY_THROUGH_WINDSCREEN( l_U2156, 1 );
                    l_U2176++;
                }
            }
        }
...
{
    return sub_21924( uParam0, ref l_U181._fU0, uParam1, uParam2, uParam3 );
}
                    ...
                    if (NOT (IS_CAR_DEAD( uVar22 )))
                    {
                        ...
                        if ((IS_THIS_MODEL_A_CAR( uVar23 )) || (IS_THIS_MODEL_A_BIKE( uVar23 )))
                        {
                            if (IS_VEH_DRIVEABLE( uVar22 ))
                            {
                                ...
                                FORCE_AIR_DRAG_MULT_FOR_PLAYERS_CAR( sub_3643(), l_U1138 );
                            }
                        }
                    }
                }
...
void sub_27639(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U503)
    {
        if (l_U502)
        {
            ...
            if (IS_PLAYER_PLAYING( sub_3643() ))
            {
                GET_CHAR_COORDINATES( sub_3597(), ref uVar6._fU0, ref uVar6._fU4, ref uVar6._fU8 );
    ...
    if (NOT l_U493)
    {
        ...
        if (IS_VEH_DRIVEABLE( uParam0 ))
        {
            if (IS_PLAYBACK_GOING_ON_FOR_CAR( uParam0 ))
            {
                ...
                l_U1129 = FIND_TIME_POSITION_IN_RECORDING( uParam0 );
                l_U1359 = GET_CURRENT_PLAYBACK_NUMBER_FOR_CAR( uParam0 );
        ...
        if ((l_U1129 == 0) || (IS_SCREEN_FADED_OUT()))
        {
            iVar10 = 1;
        }
        ...
        if (l_U495)
        {
            if (IS_PLAYER_PLAYING( sub_3643() ))
            {
                if (IS_CHAR_IN_ANY_CAR( sub_3597() ))
                {
                    STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_3597(), ref l_U2000 );
                    GET_CAR_COORDINATES( l_U2000, ref l_U1845._fU0, ref l_U1845._fU4, ref l_U1845._fU8 );
        ...
        if (l_U494)
        {
            ...
            {
                SET_CAR_COORDINATES( l_U2001, l_U1845._fU0, l_U1845._fU4, l_U1845._fU8 );
...
void sub_28329(unknown uParam0, unknown uParam1)
{
    ...
    l_U1860 = {vVar9};
    SWITCH_ROADS_OFF( l_U1851._fU0, l_U1851._fU4, l_U1851._fU8, l_U1854._fU0, l_U1854._fU4, l_U1854._fU8 );
    SWITCH_ROADS_OFF( l_U1857._fU0, l_U1857._fU4, l_U1857._fU8, l_U1860._fU0, l_U1860._fU4, l_U1860._fU8 );
    return;
}

void sub_28378()
{
    SWITCH_ROADS_BACK_TO_ORIGINAL( l_U1857._fU0, l_U1857._fU4, l_U1857._fU8, l_U1860._fU0, l_U1860._fU4, l_U1860._fU8 );
    SWITCH_ROADS_BACK_TO_ORIGINAL( l_U1851._fU0, l_U1851._fU4, l_U1851._fU8, l_U1854._fU0, l_U1854._fU4, l_U1854._fU8 );
    return;
}
...
void sub_28934(unknown uParam0, unknown uParam1)
{
    ...
    if (NOT l_U503)
    {
        if (NOT (IS_CAR_DEAD( uParam0 )))
        {
            ...
            {
                GET_CAR_COORDINATES( uParam0, ref vVar4.x, ref vVar4.y, ref vVar4.z );
                GET_CHAR_COORDINATES( sub_3597(), ref vVar7.x, ref vVar7.y, ref vVar7.z );
                uVar10 = {vVar4 - vVar7};
        ...
        if (NOT l_U503)
        {
            if (NOT l_U481)
            {
                ...
                if (CAM_IS_SPHERE_VISIBLE( uVar7, vParam0.x, vParam0.y, vParam0.z, uParam3 ))
                {
                    if (IS_PLAYER_PLAYING( sub_3643() ))
                    {
                        GET_CHAR_COORDINATES( sub_3597(), ref vVar8.x, ref vVar8.y, ref vVar8.z );
...
void sub_29792(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 70; I++ )
        {
            ...
            if (l_U1220[I] == 0)
            {
                if (((l_U1149[I] > 0) AND (l_U1149[I] < 3000)) AND (NOT (l_U1367[I] == 0)))
                {
                    if (NOT l_U481)
                    {
                        if (l_U1129 > (l_U826[I] - (7000.00000000 * uParam1)))
                        {
                            l_U1366++;
                            l_U1220[I]++;
                        }
            ...
            if (l_U1220[I] == 2)
            {
                if (HAS_MODEL_LOADED( l_U1367[I] ))
                {
                    if (NOT (DOES_VEHICLE_EXIST( l_U1863[I] )))
                    {
                        ...
                        {
                            bVar17 = false;
                            if ((NOT (sub_29319( l_U1488[I], 5.00000000, 1120403456 ))) AND (NOT (sub_31306( l_U1488[I] ))))
                            {
                                bVar17 = true;
                            }
                            if (l_U507)
                            ...
                            if (bVar17)
                            {
                                ...
                                CREATE_CAR( l_U1367[I], l_U1488[I]._fU0, l_U1488[I]._fU4, l_U1488[I]._fU8, ref l_U1863[I], 1 );
                    ...
                    if (l_U1129 > l_U826[I])
                    {
                        if (8 > l_U1350)
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1149[I] ))
                            {
                                ...
                                {
                                    GET_CAR_COORDINATES( l_U1863[I], ref uVar8._fU0, ref uVar8._fU4, ref uVar8._fU8 );
                                    GET_POSITION_OF_CAR_RECORDING_AT_TIME( l_U1149[I], fVar14, ref uVar11 );
                                    if ((NOT (sub_29319( uVar8, 5.00000000, 1120403456 ))) AND (sub_29319( uVar11, 5.00000000, 1120403456 )))
                                    {
                                        sub_30192( I, 1090519040 );
                                    }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1863[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_3643() ))
                                {
                                    if ((((IS_CHAR_TOUCHING_VEHICLE( sub_3597(), l_U1863[I] )) AND (NOT l_U487)) AND (NOT l_U484)) AND (NOT l_U496))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_3597() ))
                                        {
                                            bVar16 = false;
                                            STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_3597(), ref uVar7 );
                                    ...
                                    else if ((sub_34163( uParam0, l_U1863[I] )) AND (NOT l_U496))
                                    {
                                        sub_34036( l_U1863[I] );
                                        l_U1220[I]++;
                                    }
            ...
            if (l_U1220[I] == 5)
            {
                if (IS_VEH_DRIVEABLE( l_U1863[I] ))
                {
                    ...
                    else
                    {
                        ...
                        if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1149[I] ))
                        {
                            if (l_U1129 > (l_U826[I] + (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1149[I] ))))
                            {
                                STOP_PLAYBACK_RECORDED_CAR( l_U1863[I] );
                            }
                        }
...
void sub_35712(unknown uParam0)
{
    ...
    if (l_U2006 > 4000.00000000)
    {
        if (IS_PLAYER_PLAYING( sub_3643() ))
        {
            if (IS_CHAR_IN_ANY_CAR( sub_3597() ))
            {
                STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_3597(), ref uVar6 );
            }
            for ( I = 0; I < 70; I++ )
            {
                if (I < iVar4)
                ...
                if (DOES_VEHICLE_EXIST( l_U1863[I] ))
                {
                    if (IS_VEH_DRIVEABLE( l_U1863[I] ))
                    {
                        if ((sub_35881( l_U1863[I], (uParam0^) )) || (sub_35881( l_U1863[I], uVar6 )))
                        {
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 40; I++ )
        {
            ...
            if (l_U1309[I] == 0)
            {
                if (NOT (l_U1438[I] == 0))
                {
                    if (LOCATE_CAR_2D( uParam0, l_U1699[I]._fU0, l_U1699[I]._fU4, l_U1126, l_U1126, 0 ))
                    {
                        l_U1364++;
                        l_U1309[I]++;
                    }
            ...
            if (l_U1309[I] == 1)
            {
                if (6 > l_U1353)
                {
                    if (HAS_MODEL_LOADED( l_U1438[I] ))
                    {
                        ...
                        {
                            if (((NOT (sub_29319( l_U1699[I], 5.00000000, 1120403456 ))) || (l_U481)) || (l_U507))
                            {
                                if (l_U500)
                                {
                                    sub_29289( l_U1699[I], l_U1134 );
                                }
                                CREATE_CAR( l_U1438[I], l_U1699[I]._fU0, l_U1699[I]._fU4, l_U1699[I]._fU8, ref l_U1943[I], 1 );
...
void sub_37941(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 8; I++ )
        {
            if (((l_U1291[I] > 0) AND (l_U1291[I] < 3000)) AND (NOT (l_U1479[I] == 0)))
            {
                if (l_U1300[I] == 0)
                {
                    if (NOT l_U481)
                    {
                        if (l_U1129 > (l_U937[I] - (7000.00000000 * uParam1)))
                        {
                            l_U1300[I]++;
                            l_U1365++;
                        }
                ...
                if (l_U1300[I] == 2)
                {
                    if (HAS_MODEL_LOADED( l_U1479[I] ))
                    {
                        if (NOT (DOES_VEHICLE_EXIST( l_U1984[I] )))
                        {
                            ...
                            if (bVar15)
                            {
                                if ((NOT (sub_29319( l_U1820[I], 5.00000000, 1120403456 ))) || (l_U507))
                                {
                                    CREATE_CAR( l_U1479[I], l_U1820[I]._fU0, l_U1820[I]._fU4, l_U1820[I]._fU8, ref l_U1984[I], 1 );
                                    if (l_U1479[I] == sub_30920())
                                    {
                        ...
                        if (l_U1129 > l_U937[I])
                        {
                            if (4 > l_U1352)
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1291[I] ))
                                {
                                    ...
                                    {
                                        GET_CAR_COORDINATES( l_U1984[I], ref uVar7._fU0, ref uVar7._fU4, ref uVar7._fU8 );
                                        GET_POSITION_OF_CAR_RECORDING_AT_TIME( l_U1291[I], fVar13, ref uVar10 );
                                        if (((NOT (sub_29319( uVar7, 5.00000000, 1120403456 ))) AND (sub_29319( uVar10, 5.00000000, 1120403456 ))) AND (NOT l_U507))
                                        {
                                            l_U1352++;
                                            l_U1300[I]++;
                                        }
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1984[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_3643() ))
                                    {
                                        if (((IS_CHAR_TOUCHING_VEHICLE( sub_3597(), l_U1984[I] )) AND (NOT l_U487)) AND (NOT l_U484))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_3597() ))
                                            {
                                                bVar15 = false;
                ...
                if (l_U1300[I] == 5)
                {
                    if (IS_VEH_DRIVEABLE( l_U1984[I] ))
                    {
                        ...
                        else
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1291[I] ))
                            {
                                if (l_U1129 > (l_U937[I] + (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1291[I] ))))
                                {
                                    STOP_PLAYBACK_RECORDED_CAR( l_U1984[I] );
                                }
                            }
...
int sub_41873(unknown uParam0, unknown uParam1)
{
    if (NOT l_U510)
    {
        ...
        if (IS_VEH_DRIVEABLE( (uParam0^) ))
        {
            ...
            if (NOT (l_U1359 == -1))
            {
                while (NOT (sub_32419( uParam0, l_U1359, uParam1, 1, 0, 0 )))
                {
                    WAIT( 0 );
                }
                if (NOT l_U492)
...
void sub_42893(unknown uParam0)
{
    ...
    if ((l_U2167) AND (IS_HINT_RUNNING()))
    {
        iVar4 = 0;
        GET_GAME_TIMER( ref iVar4 );
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3597() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_43061())) AND (iVar3 != 4))
    {
    ...
    {
        if ((NOT l_U2166) AND (NOT l_U2167))
        {
            if (l_U2169)
            {
                PRINTNL();
...
void sub_44274()
{
    ...
    SAY_AMBIENT_SPEECH( l_U2156, "MISSION_FAIL_RAGE", 0, 0, 0 );
    sub_44462();
    l_U2148 = 0;
    sub_3021();
    return;
...
void sub_45143(boolean bParam0)
{
    ...
    if (IS_PLAYER_PLAYING( sub_3643() ))
    {
        FORCE_AIR_DRAG_MULT_FOR_PLAYERS_CAR( sub_3643(), 1.00000000 );
        DONT_DISPATCH_COPS_FOR_PLAYER( sub_3643(), 0 );
...
void sub_45543()
{
    ...
    if (l_U2180[l_U2176] == 0)
    {
        ...
        if ((NOT (IS_CHAR_DEAD( l_U2250 ))) AND (NOT (IS_CAR_DEAD( l_U2482 ))))
        {
            if ((LOCATE_CHAR_ANY_MEANS_CAR_2D( l_U2156, l_U2482, 35.00000000, 35.00000000, 0 )) AND (IS_CAR_ON_SCREEN( l_U2482 )))
            {
                OPEN_SEQUENCE_TASK( ref uVar2 );
                TASK_LEAVE_ANY_CAR( 0 );
                TASK_FOLLOW_NAV_MESH_TO_COORD( 0, 1174.04800000, -378.45940000, 26.23970000, 3, 20000, 0.50000000 );
                TASK_TURN_CHAR_TO_FACE_CHAR( 0, l_U2156 );
                TASK_PLAY_ANIM( 0, "look_about", "missVlad4", 8.00000000, 1, 0, 0, 0, -1 );
                CLOSE_SEQUENCE_TASK( uVar2 );
                TASK_PERFORM_SEQUENCE( l_U2250, uVar2 );
                CLEAR_SEQUENCE_TASK( uVar2 );
            }
            else
            {
                WARP_CHAR_FROM_CAR_TO_COORD( l_U2250, 1174.04800000, -379.45940000, 26.23970000 );
                TASK_PLAY_ANIM( l_U2250, "look_about", "missVlad4", 8.00000000, 1, 0, 0, 0, -1 );
            }
        }
        if (NOT (IS_CAR_DEAD( l_U2482 )))
        {
            SET_CAR_PROOFS( l_U2482, 0, 0, 0, 0, 0 );
            if ((sub_7917( l_U2482 )) < 500)
            {
                SET_CAR_HEALTH( l_U2482, 500 );
            }
        }
        sub_17418();
    ...
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U2156, 1175.13900000, -379.40640000, 48.00000000, 48.00000000, 0 )) AND (l_U2204 == 0))
    {
    ...
    GET_GAME_TIMER( ref l_U2243 );
    if ((((((((l_U2243 - l_U2242) > 22000) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_22883( l_U2170 )))) AND (l_U2204 == 1)) AND ((sub_46763( l_U2156 )) > 0.50000000)) AND (IS_CHAR_ON_FOOT( l_U2156 ))) AND (l_U2214 == 1))
    {
        sub_21901( "V4_ONFOOT", ref l_U2170, 8, 1 );
        GET_GAME_TIMER( ref l_U2242 );
    }
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if ((((((LOCATE_CHAR_ON_FOOT_2D( l_U2156, 1175.13900000, -379.40640000, 15.00000000, 15.00000000, 0 )) || (IS_PLAYER_TARGETTING_CHAR( l_U2157, l_U2250 ))) || (IS_PLAYER_FREE_AIMING_AT_CHAR( l_U2157, l_U2250 ))) || (IS_PLAYER_FREE_AIMING_AT_CHAR( l_U2157, l_U2250 ))) || (IS_BULLET_IN_AREA( 1174.04800000, -379.45940000, 26.23970000, 5.00000000, 1 ))) || (IS_CHAR_IN_ANY_HELI( l_U2156 )))
        {
            if (l_U2214 == 0)
            {
                if (NOT (IS_CHAR_INJURED( l_U2250 )))
                {
                    PRINT_HELP_FOREVER( "VLA4H_01" );
                    SETTIMERB( 0 );
                    l_U2091[8] = 1;
                    HINT_CAM( 0.00000000, 0.00000000, 0.00000000, l_U2250, 0, 0, 3000 );
                    TASK_PERFORM_SEQUENCE( l_U2250, l_U2492 );
        ...
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1174.04800000, -379.45940000, 26.23970000, 1.50000000, 1.50000000, 1.50000000, 0 )) AND (IS_CHAR_PLAYING_ANIM( l_U2250, "missVlad4", "look_about" )))
            {
                sub_47305( l_U2250, l_U2156 );
            }
        }
    }
    if (((TIMERB() > 4000) AND (l_U2091[9] == 0)) AND (l_U2091[8] == 1))
    {
        PRINT_HELP_FOREVER( "VLA4H_02" );
        SETTIMERB( 0 );
        l_U2091[9] = 1;
    }
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1176.71700000, -366.90080000, 27.18590000, 1.00000000, 1.00000000, 1.00000000, 0 )) AND (l_U2091[13] == 0))
    {
        PRINT_HELP_FOREVER( "VLA4H_05" );
        SETTIMERB( 0 );
        l_U2091[13] = 1;
    }
    if ((((TIMERB() > 8500) AND (l_U2091[10] == 0)) AND ((l_U2091[9] == 1) || (l_U2091[13] == 1))) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1175.68700000, -379.40220000, 21.52380000, 2.00000000, 2.00000000, 2.00000000, 0 ))))
    {
        CLEAR_HELP();
        if ((l_U2091[9] == 1) AND (l_U2091[14] == 1))
        {
            l_U2091[10] = 1;
        }
    }
    if (((((TIMERA() > 5000) AND (l_U2091[2] == 0)) AND (l_U2091[0] == 1)) AND ((sub_8216( l_U2156, l_U2250, 1 )) < 20.00000000)) AND (NOT (sub_22883( l_U2170 ))))
    {
        sub_21901( "V4_FIND", ref l_U2170, 8, 1 );
        l_U2091[2] = 1;
    }
    if (((((TIMERA() > 15000) AND (l_U2091[3] == 0)) AND (l_U2091[0] == 1)) AND ((sub_8216( l_U2156, l_U2250, 1 )) < 20.00000000)) AND (NOT (sub_22883( l_U2170 ))))
    {
        sub_21901( "V4_CHASE", ref l_U2170, 8, 1 );
        l_U2091[3] = 1;
    }
    if (((((sub_47981( l_U2156 )) > 25.00000000) AND (IS_CHAR_ON_FOOT( l_U2156 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1175.76700000, -379.40220000, 24.91630000, 1.00000000, 1.00000000, 1.00000000, 0 ))) AND (l_U2091[0] == 0))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
            TASK_PERFORM_SEQUENCE( l_U2250, l_U2493 );
        }
        SETTIMERA( 0 );
        l_U2091[0] = 1;
    }
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1173.11000000, -365.15580000, 33.02390000, 1.00000000, 10.00000000, 1.00000000, 0 ))
        {
            if (NOT (IS_CHAR_INJURED( l_U2250 )))
            {
                if ((NOT (IS_CHAR_ON_SCREEN( l_U2250 ))) AND (NOT (IS_CHAR_IN_ANY_HELI( l_U2156 ))))
                {
                    SET_CHAR_COORDINATES( l_U2250, 1165.25700000, -368.97960000, 34.74900000 );
                    SET_CHAR_HEADING( l_U2250, 0.00000000 );
                }
            }
        }
    }
    if (((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1172.69400000, -375.99700000, 27.26980000, 2.50000000, 2.50000000, 1.00000000, 0 )) || (((sub_47981( l_U2156 )) > 27.00000000) AND ((IS_CHAR_ON_FOOT( l_U2156 )) || (IS_CHAR_IN_ANY_HELI( l_U2156 ))))) AND (l_U2091[4] == 0))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
            TASK_PERFORM_SEQUENCE( l_U2250, l_U2494 );
        }
        l_U2091[4] = 1;
    }
    if (((((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1169.59100000, -366.86830000, 32.96820000, 10.50000000, 11.00000000, 1.00000000, 0 )) || ((sub_47981( l_U2156 )) > 33.50000000)) || (IS_CHAR_IN_ANY_HELI( l_U2156 ))) AND (l_U2091[5] == 0)) AND (l_U2091[1] == 0))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
            CLEAR_CHAR_TASKS( l_U2250 );
            TASK_PERFORM_SEQUENCE( l_U2250, l_U2495 );
        }
        if (IS_CHAR_IN_ANY_HELI( l_U2156 ))
        {
            ...
            TASK_PERFORM_SEQUENCE( l_U2250, l_U2496 );
        }
        l_U2091[5] = 1;
    }
    if (l_U2091[6] == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1168.76400000, -365.23640000, 39.02080000, 13.00000000, 5.50000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1163.18800000, -366.07840000, 39.02080000, 11.50000000, 5.50000000, 1.00000000, 0 )))
        {
            if ((NOT (IS_CHAR_INJURED( l_U2250 ))) AND (l_U2091[1] == 0))
            {
                if (NOT (IS_CHAR_IN_ANY_HELI( l_U2156 )))
                {
                    SET_CHAR_COORDINATES( l_U2250, 1166.92500000, -379.04320000, 39.46630000 );
                    SET_CHAR_HEADING( l_U2250, 87.18530000 );
                }
                CLEAR_CHAR_TASKS_IMMEDIATELY( l_U2250 );
                SET_CHAR_PROOFS( l_U2250, 0, 0, 0, 0, 0 );
                OPEN_SEQUENCE_TASK( ref l_U2496 );
                ...
                CLOSE_SEQUENCE_TASK( l_U2496 );
                TASK_PERFORM_SEQUENCE( l_U2250, l_U2496 );
                STOP_PED_SPEAKING( l_U2250, 1 );
            }
            l_U2091[6] = 1;
        }
    }
    sub_49155();
    uVar3 = {sub_49296( l_U2250 )};
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if ((((LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1166.93800000, -379.03900000, 42.05800000, 1.00000000, 1.00000000, 4.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1172.75000000, -378.48780000, 27.24020000, 3.00000000, 3.50000000, 1.50000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1176.71700000, -366.82090000, 29.89490000, 1.00000000, 1.00000000, 2.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1165.43000000, -367.36410000, 35.95900000, 1.00000000, 4.00000000, 4.00000000, 0 )))
        {
            SET_CHAR_PROOFS( l_U2250, 1, 0, 0, 0, 0 );
            if (IS_BULLET_IN_AREA( uVar3._fU0, uVar3._fU4, uVar3._fU8, 1.00000000, 1 ))
            {
                iVar6 = sub_49643( l_U2250 );
                iVar6 -= 3;
                if (iVar6 >= 0)
                {
                    SET_CHAR_HEALTH( l_U2250, iVar6 );
                }
            }
        }
        else
    ...
    if (l_U2091[0] == 1)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1165.01000000, -390.35730000, 45.56450000, 1.50000000, 14.00000000, 5.50000000, 0 )) || (IS_BULLET_IN_AREA( 1164.80300000, -390.96860000, 45.56450000, 3.00000000, 1 )))
        {
            if (l_U2091[1] == 0)
            {
                if (NOT (IS_CHAR_INJURED( l_U2250 )))
                {
                    UNLOCK_RAGDOLL( l_U2250, 0 );
                    GET_GAME_TIMER( ref l_U2223 );
                    l_U2222 = 1;
                    STOP_PED_SPEAKING( l_U2250, 1 );
                    TASK_PERFORM_SEQUENCE( l_U2250, l_U2497 );
                    SETTIMERB( 0 );
                }
                l_U2091[1] = 1;
            }
    ...
    if ((sub_8216( l_U2250, l_U2156, 1 )) > 180.00000000)
    {
        if (NOT (IS_CHAR_DEAD( l_U2250 )))
        {
            if (NOT (IS_CHAR_ON_SCREEN( l_U2250 )))
            {
                REMOVE_BLIP( l_U2485 );
                DELETE_CHAR( ref l_U2250 );
                PRINT_NOW( "VLALOST", 7500, 1 );
    ...
    if (DOES_CHAR_EXIST( l_U2250 ))
    {
        if (IS_CHAR_DEAD( l_U2250 ))
        {
    ...
    if (((((sub_8216( l_U2251[0], l_U2156, 1 )) < 5.00000000) AND (NOT (IS_CHAR_DEAD( l_U2251[0] )))) AND (NOT (IS_CHAR_DEAD( l_U2251[1] )))) AND (l_U2091[11] == 0))
    {
        TASK_LOOK_AT_CHAR( l_U2251[0], l_U2156, 10000, 0 );
        TASK_LOOK_AT_CHAR( l_U2251[1], l_U2156, 10000, 0 );
        OPEN_SEQUENCE_TASK( ref uVar7 );
        TASK_LOOK_AT_CHAR( 0, l_U2156, 10000, 0 );
        TASK_TURN_CHAR_TO_FACE_CHAR( 0, l_U2156 );
    ...
    if (NOT (IS_CHAR_INJURED( l_U2250 )))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1165.15700000, -400.36430000, 45.56460000, 3.50000000, 3.50000000, 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1166.85800000, -377.36910000, 40.47110000, 1.00000000, 1.00000000, 1.00000000, 0 )))
        {
            SET_GAME_CAM_HEADING( 0.00000000 );
            CLEAR_CHAR_TASKS_IMMEDIATELY( l_U2156 );
            STOP_PED_SPEAKING( l_U2250, 1 );
            GET_GAME_TIMER( ref l_U2223 );
            l_U2222 = 1;
            CLEAR_CHAR_TASKS_IMMEDIATELY( l_U2250 );
            SET_CHAR_COORDINATES_NO_OFFSET( l_U2250, 1165.08000000, -394.98420000, 45.56970000 );
            SET_CHAR_HEADING( l_U2250, 180.00000000 );
            TASK_PERFORM_SEQUENCE( l_U2250, l_U2497 );
            UNLOCK_RAGDOLL( l_U2250, 0 );
            SET_CHAR_PROOFS( l_U2250, 0, 0, 0, 0, 0 );
            l_U2176++;
...
void sub_49155()
{
    ...
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        GET_CHAR_COORDINATES( l_U2156, ref uVar3._fU0, ref uVar3._fU4, ref uVar3._fU8 );
        GET_CHAR_COORDINATES( l_U2250, ref uVar6._fU0, ref uVar6._fU4, ref uVar6._fU8 );
        fVar2 = VDIST( uVar3, uVar6 );
        if (fVar2 > 15.00000000)
        {
            MODIFY_CHAR_MOVE_STATE( l_U2250, 3 );
        }
        else
        {
            MODIFY_CHAR_MOVE_STATE( l_U2250, 4 );
        }
    }
    return;
}
...
void sub_54130(int iParam0, boolean bParam1, boolean bParam2, boolean bParam3, unknown uParam4)
{
    ...
    {
        SET_PLAYER_MOOD_NORMAL( sub_3643() );
    }
    sub_2119();
    bVar27 = true;
...
void sub_66132()
{
    if (l_U2180[l_U2176] == 0)
    {
        ...
        sub_66170();
        SET_GAME_CAM_HEADING( 0.00000000 );
        SET_CAM_POS( l_U2149, 1167.47300000, -397.13210000, 46.00491000 );
        ...
        if (NOT (IS_CHAR_DEAD( l_U2250 )))
        {
            POINT_CAM_AT_PED( l_U2154, l_U2250 );
        }
        ADD_COVER_POINT( 1165.12000000, -461.01090000, 31.96240000, 0, 0.00000000, 2, 1, ref l_U2074[0] );
        if (NOT (IS_CHAR_DEAD( l_U2250 )))
        {
            SET_COMBAT_DECISION_MAKER( l_U2250, l_U2490 );
        }
        l_U2180[l_U2176] = 1;
    }
    if ((sub_66744()) AND (l_U2180[l_U2176] == 1))
    {
        l_U2249 = 1;
    }
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1168.31500000, -431.89710000, 35.46350000, 4.00000000, 1.00000000, 2.00000000, 0 ))
    {
        if (l_U2207 == 0)
        {
    ...
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if ((l_U2091[1] == 0) || (IS_CHAR_IN_AIR( l_U2250 )))
        {
            CANCEL_CURRENTLY_PLAYING_AMBIENT_SPEECH( l_U2250 );
        }
    }
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1169.59600000, -409.25850000, 40.53150000, 10.00000000, 8.00000000, 2.00000000, 0 )) || (l_U2249 == 1))
        {
            if (l_U2091[1] == 0)
            {
                if (l_U2249 == 0)
                ...
                if (NOT (IS_CHAR_INJURED( l_U2250 )))
                {
                    UNLOCK_RAGDOLL( l_U2250, 1 );
                    CLEAR_CHAR_TASKS_IMMEDIATELY( l_U2250 );
                    SET_CHAR_COORDINATES( l_U2250, 1167.88900000, -432.41540000, 35.46350000 );
                    SET_CHAR_HEADING( l_U2250, 180.00000000 );
                    STOP_PED_SPEAKING( l_U2250, 1 );
                }
                l_U2091[1] = 1;
    ...
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1165.11100000, -405.90770000, 44.66900000, 5.00000000, 4.30000000, 2.00000000, 0 ))
    {
        l_U2230 = 1;
        if (l_U2148 == 0)
        {
        ...
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
            TASK_PERFORM_SEQUENCE( l_U2250, l_U2499 );
            l_U2091[3] = 1;
        }
        STOP_PED_SPEAKING( l_U2250, 1 );
        ...
        POINT_CAM_AT_PED( l_U2154, l_U2156 );
        sub_66463( ref l_U2154, 1 );
        ACTIVATE_SCRIPTED_CAMS( 1, 1 );
    }
    else if ((l_U2230 == 1) AND (NOT (IS_CHAR_IN_AIR( l_U2156 ))))
    {
        UNPOINT_CAM( l_U2154 );
    ...
    if (NOT (IS_CHAR_INJURED( l_U2250 )))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1167.61500000, -434.40880000, 37.27490000, 7.00000000, 1.00000000, 1.00000000, 0 )) AND (l_U2211 == 0))
        {
            UNLOCK_RAGDOLL( l_U2250, 0 );
            l_U2211 = 1;
        }
        if ((((l_U2211 == 1) AND (l_U2212 == 0)) AND (NOT (IS_CHAR_IN_AIR( l_U2250 )))) AND ((sub_47981( l_U2250 )) < 33.20000000))
        {
            UNLOCK_RAGDOLL( l_U2250, 1 );
            l_U2212 = 1;
        }
    }
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1168.61700000, -422.00020000, 39.95830000, 9.00000000, 1.00000000, 5.00000000, 0 ))
    {
        l_U2231 = 1;
        if (l_U2148 == 0)
        {
        ...
        SET_CAM_ROT( l_U2154, -87.40494000, 0.00000000, 179.15570000 );
        SET_CAM_FOV( l_U2154, 40.00000000 );
        POINT_CAM_AT_PED( l_U2154, l_U2156 );
        sub_66463( ref l_U2154, 1 );
        ACTIVATE_SCRIPTED_CAMS( 1, 1 );
    }
    else if ((l_U2231 == 1) AND (NOT (IS_CHAR_IN_AIR( l_U2156 ))))
    {
        UNPOINT_CAM( l_U2154 );
        SET_CAM_FOV( l_U2154, 55.00000000 );
        sub_66463( ref l_U2154, 0 );
    ...
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1167.78900000, -446.69920000, 35.04320000, 9.00000000, 1.00000000, 5.00000000, 0 ))
    {
        l_U2232 = 1;
        if (l_U2148 == 0)
        {
        ...
        SET_CAM_POS( l_U2154, 1176.76500000, -446.33440000, 21.18246000 );
    ...
    else if ((l_U2232 == 1) AND (NOT (IS_CHAR_IN_AIR( l_U2156 ))))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
            CLEAR_CHAR_TASKS( l_U2250 );
            SET_CHAR_COORDINATES( l_U2250, 1164.66800000, -473.29370000, 33.53040000 );
            SET_CHAR_HEADING( l_U2250, 180.00000000 );
            UNLOCK_RAGDOLL( l_U2250, 1 );
            TASK_PERFORM_SEQUENCE( l_U2250, l_U2500 );
    ...
    if (((sub_47981( l_U2156 )) < 20.00000000) AND (NOT (IS_CHAR_IN_AIR( l_U2156 ))))
    {
        sub_66463( ref l_U2154, 0 );
        SET_CAM_FOV( l_U2154, 55.00000000 );
        ACTIVATE_SCRIPTED_CAMS( 0, 0 );
    ...
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1167.71500000, -433.85750000, 16.44330000, 12.00000000, 2.30000000, 17.00000000, 0 ))
        {
            SET_CHAR_COORDINATES( l_U2250, 1167.59000000, -435.93220000, 34.45880000 );
            SET_CHAR_HEADING( l_U2250, 229.73870000 );
        }
    }
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1169.48400000, -421.92650000, 24.79960000, 10.00000000, 1.00000000, 9.20000000, 0 ))
        {
            SET_CHAR_COORDINATES( l_U2250, 1165.89800000, -435.99320000, 34.45870000 );
            SET_CHAR_HEADING( l_U2250, 205.15150000 );
        }
    }
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1168.01200000, -446.48750000, 22.03780000, 10.00000000, 1.00000000, 9.50000000, 0 ))
        {
            SET_CHAR_COORDINATES( l_U2250, 1171.26300000, -461.38450000, 31.96240000 );
            SET_CHAR_HEADING( l_U2250, 157.00000000 );
        }
    }
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1168.13300000, -470.88960000, 20.80740000, 10.00000000, 6.20000000, 10.20000000, 0 ))
        {
            SET_CHAR_COORDINATES( l_U2250, 1163.48800000, -476.92280000, 31.96180000 );
            SET_CHAR_HEADING( l_U2250, 224.04350000 );
        }
    }
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1165.15700000, -400.36430000, 45.56460000, 10.50000000, 10.50000000, 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1164.14000000, -411.05220000, 40.53130000, 8.50000000, 8.50000000, 1.50000000, 0 )))
    {
        if ((l_U2091[0] == 0) AND (l_U2091[1] == 1))
        {
            sub_21901( "V4_CHASE2", ref l_U2170, 8, 1 );
    ...
    if (((l_U2091[0] == 1) AND (l_U2091[7] == 0)) AND (TIMERA() > 7500))
    {
        CLEAR_HELP();
        l_U2091[7] = 1;
    }
    if ((((NOT (sub_69718( l_U2250, 29 ))) AND (l_U2091[0] == 1)) AND (l_U2091[3] == 0)) AND ((sub_8216( l_U2156, l_U2250, 1 )) < 20.00000000))
    {
        l_U2091[3] = 1;
    }
    if (((NOT (sub_69718( l_U2250, 29 ))) AND (l_U2091[0] == 1)) AND (l_U2091[2] == 0))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
            TASK_PLAY_ANIM( l_U2250, "EXHAUSTED_INTRO", "missVlad4", 8.00000000, 0, 0, 0, 1, -1 );
        }
        l_U2091[2] = 1;
    }
    if ((l_U2091[5] == 1) || (l_U2208))
    {
        if (NOT (IS_CHAR_INJURED( l_U2250 )))
        {
            if (IS_CHAR_PLAYING_ANIM( l_U2250, "missVlad4", "RUN_FALL_OFF_ROOF" ))
            {
                if (l_U2202 == 0)
                {
                    SAY_AMBIENT_SPEECH_WITH_VOICE( l_U2250, "PANIC", "PAIN_VOICE", 1, 1, 2 );
                    l_U2202 = 1;
                }
                FREEZE_CHAR_POSITION( l_U2250, 1 );
                SET_CHAR_COORDINATES_NO_OFFSET( l_U2250, 1175.03800000, -486.60300000, 34.20300000 );
                SET_CHAR_HEADING( l_U2250, 180.00000000 );
    ...
    sub_49155();
    if (((((DOES_CHAR_EXIST( l_U2250 )) AND (l_U2091[5] == 0)) AND (l_U2230 == 0)) AND (l_U2231 == 0)) AND (l_U2232 == 0))
    {
        if (IS_CHAR_DEAD( l_U2250 ))
        {
            if (DOES_BLIP_EXIST( l_U2485 ))
    ...
    if (IS_CHAR_PLAYING_ANIM( l_U2250, "missVlad4", "RUN_FALL_OFF_ROOF" ))
    {
        GET_CHAR_ANIM_CURRENT_TIME( l_U2250, "missVlad4", "RUN_FALL_OFF_ROOF", ref l_U2203 );
        l_U2201 = 1;
    }
    if (((l_U2203 >= 1.00000000) AND ((l_U2091[5] == 1) || (l_U2208))) AND (l_U2209))
    {
        if ((NOT (IS_CHAR_DEAD( l_U2250 ))) AND (l_U2091[6] == 0))
        {
            PRINT_NOW( "VLA4D_05", 7500, 1 );
            SET_CHAR_NEVER_TARGETTED( l_U2250, 0 );
            SET_CHAR_PROOFS( l_U2250, 0, 0, 0, 0, 0 );
            SET_CHAR_SUFFERS_CRITICAL_HITS( l_U2250, 0 );
            TASK_PLAY_ANIM_NON_INTERRUPTABLE( l_U2250, "HANG_ON_LEDGE", "missVlad4", 1000.00000000, 1, 0, 0, 0, -1 );
            SET_CHAR_COORDINATES( l_U2250, 1175.03800000, -492.90300000, 33.20000000 );
            SET_CHAR_HEADING( l_U2250, 0.00000000 );
            FREEZE_CHAR_POSITION( l_U2250, 1 );
            CHANGE_BLIP_DISPLAY( l_U2485, 4 );
            SAY_AMBIENT_SPEECH( l_U2250, "PANIC", 0, 0, 0 );
            l_U2176++;
            l_U2091[6] = 1;
        }
    }
...
void sub_66520(boolean bParam0)
{
    ...
    SET_PLAYER_CONTROL( l_U2157, NOT bParam0 );
...
void sub_70752()
{
    ...
    if (l_U2180[l_U2176] == 0)
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U2250 )))
        {
            GET_CHAR_HEALTH( l_U2250, ref l_U2228 );
            SET_CHAR_NEVER_TARGETTED( l_U2250, 1 );
        }
        sub_17418();
        l_U2180[l_U2176] = 1;
    }
    if (NOT (IS_CHAR_DEAD( l_U2250 )))
    {
        GET_CHAR_HEALTH( l_U2250, ref l_U2506 );
    }
    ...
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U2156, 1175.21300000, -491.69920000, 34.20850000, 1.00000000, 1.50000000, 1.50000000, 0 ))
    {
        if ((l_U2091[0] == 0) AND (TIMERA() > 9500))
        {
            sub_21901( "V4_HOLD", ref l_U2170, 8, 1 );
            PRINT_HELP_FOREVER( "VLA4H_03" );
            l_U2091[0] = 1;
        }
        if (((IS_CONTROL_JUST_PRESSED( 0, 23 )) AND (l_U2091[1] == 0)) AND (NOT (IS_CHAR_IN_AIR( l_U2156 ))))
        {
            CLEAR_HELP();
            if (NOT (IS_CHAR_DEAD( l_U2250 )))
            {
                ...
                SET_CAM_POS( l_U2154, 1178.00000000, -489.72750000, 34.86095000 );
                ...
                sub_66463( ref l_U2154, 1 );
                sub_66520( 1 );
                SET_CHAR_COORDINATES( l_U2156, 1175.03800000, -492.15000000, 33.25000000 );
                SET_CHAR_HEADING( l_U2156, 180.00000000 );
                CLEAR_CHAR_TASKS( l_U2156 );
                FREEZE_CHAR_POSITION( l_U2156, 1 );
            }
            sub_21901( "V4_HELP", ref l_U2170, 8, 1 );
            TASK_PLAY_ANIM_NON_INTERRUPTABLE( l_U2156, "LEDGE_HELP_UP", "missVlad4", 8.00000000, 0, 0, 0, 0, -1 );
            if (NOT (IS_CHAR_DEAD( l_U2250 )))
            {
                SET_CHAR_COORDINATES( l_U2250, 1175.03800000, -492.80300000, 33.25000000 );
                TASK_PLAY_ANIM_NON_INTERRUPTABLE( l_U2250, "LEDGE_HELPED_UP", "missVlad4", 8.00000000, 0, 0, 0, 1, -1 );
            }
            else
            {
                DELETE_CHAR( ref l_U2250 );
                CREATE_CHAR( 26, 1166762483, 1175.03800000, -492.80300000, 33.25000000, ref l_U2250, 1 );
                SET_CHAR_AS_ENEMY( l_U2250, 1 );
                SET_CHAR_GET_OUT_UPSIDE_DOWN_CAR( l_U2250, 0 );
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U2250, 1 );
            }
            ...
            {
                if (IS_CHAR_PLAYING_ANIM( l_U2156, "missVlad4", "LEDGE_HELP_UP" ))
                {
                    GET_CHAR_ANIM_CURRENT_TIME( l_U2156, "missVlad4", "LEDGE_HELP_UP", ref l_U2248 );
                }
                WAIT( 0 );
            }
            l_U2176++;
        ...
        if (((IS_CONTROL_PRESSED( 0, 62 )) AND (l_U2091[2] == 0)) AND (NOT (IS_CHAR_IN_AIR( l_U2156 ))))
        {
            CLEAR_HELP();
            l_U2215 = 1;
            ...
            if (NOT (IS_CHAR_DEAD( l_U2250 )))
            {
                ...
                SET_CAM_POS( l_U2154, 1177.41600000, -494.35790000, 32.09663000 );
                SET_CAM_ROT( l_U2154, 23.81830000, -15.32264000, 54.93951000 );
                SET_CAM_FOV( l_U2154, 45.00000000 );
                SET_CAM_POS( l_U2154, 1176.12200000, -494.08730000, 29.60839000 );
                SET_CAM_ROT( l_U2154, 55.07161000, -13.60788000, 26.47294000 );
                SET_CAM_FOV( l_U2154, 39.90001000 );
                sub_66463( ref l_U2154, 1 );
                sub_66520( 1 );
                SET_CHAR_COORDINATES( l_U2156, 1175.03800000, -492.25000000, 33.25000000 );
                SET_CHAR_HEADING( l_U2156, 180.00000000 );
                CLEAR_CHAR_TASKS( l_U2156 );
                FREEZE_CHAR_POSITION( l_U2156, 1 );
                TASK_LOOK_AT_CHAR( l_U2156, l_U2250, 10000, 0 );
                TASK_PLAY_ANIM( l_U2156, "look_down_loop", "missVlad4", 8.00000000, 1, 0, 0, 0, -1 );
            }
            ...
            SET_CAM_POS( l_U2154, 1175.03800000, -495.90340000, 37.90384000 );
            ...
            SET_CAM_FOV( l_U2154, 45.00000000 );
            TASK_PLAY_ANIM_NON_INTERRUPTABLE( l_U2156, "LEDGE_STAMP", "missVlad4", 8.00000000, 0, 0, 0, 0, -1 );
            while (l_U2248 < 0.48000000)
            {
                if (IS_CHAR_PLAYING_ANIM( l_U2156, "missVlad4", "LEDGE_STAMP" ))
                {
                    GET_CHAR_ANIM_CURRENT_TIME( l_U2156, "missVlad4", "LEDGE_STAMP", ref l_U2248 );
                }
                WAIT( 0 );
            }
            ...
            if (NOT (IS_CHAR_DEAD( l_U2250 )))
            {
                FREEZE_CHAR_POSITION( l_U2250, 0 );
                CLEAR_CHAR_TASKS_IMMEDIATELY( l_U2250 );
                STOP_PED_SPEAKING( l_U2250, 1 );
            }
            WAIT( 0 );
            ...
            {
                UNLOCK_RAGDOLL( l_U2250, 1 );
                SWITCH_PED_TO_RAGDOLL( l_U2250, 0, 60000, 1, 1, 1, 0 );
                if (IS_PED_RAGDOLL( l_U2250 ))
                {
                    CREATE_NM_MESSAGE( 1, 246 );
                    SEND_NM_MESSAGE( l_U2250 );
                }
            }
            sub_50156( 45 );
            ...
            l_U2176 = 8;
            SETTIMERA( 0 );
            while (((sub_47981( l_U2250 )) > 18.00000000) AND (TIMERA() < 10000))
            {
                if (NOT (IS_CHAR_DEAD( l_U2250 )))
                {
                    if (LOCATE_CHAR_ANY_MEANS_3D( l_U2250, 1177.86500000, -493.22930000, 30.90230000, 2.00000000, 1.00000000, 2.50000000, 1 ))
                    {
                        APPLY_FORCE_TO_PED( l_U2250, 0, 0.10000000, 0.10000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 8, 1, 1, 1 );
                    }
                }
                WAIT( 0 );
            }
            if (NOT (IS_CHAR_DEAD( l_U2250 )))
            {
                SET_PED_GENERATES_DEAD_BODY_EVENTS( l_U2250, 1 );
                REMOVE_CHAR_ELEGANTLY( ref l_U2250 );
            }
            uVar2 = {sub_73234( l_U2250 )};
            SET_CAM_POS( l_U2154, 1180.21900000, -495.97100000, 13.08902000 );
            SET_CAM_ROT( l_U2154, 12.45547000, -0.00000000, 81.64666000 );
            SET_CAM_FOV( l_U2154, 55.00000000 );
            while ((ABSF( uVar2._fU8 )) > 0.50000000)
            {
                uVar2 = {sub_73234( l_U2250 )};
                WAIT( 0 );
            }
            ...
            SET_CHAR_COORDINATES( l_U2156, 1175.13200000, -491.08990000, 33.20360000 );
            SET_CHAR_HEADING( l_U2156, 72.00740000 );
            SET_GAME_CAM_HEADING( 0.00000000 );
            WAIT( 3500 );
            FREEZE_CHAR_POSITION( l_U2156, 0 );
            sub_66463( ref l_U2154, 0 );
            sub_66463( ref l_U2152, 0 );
            sub_66520( 0 );
            l_U2091[2] = 1;
    ...
    if (DOES_CHAR_EXIST( l_U2250 ))
    {
        if ((l_U2506 < l_U2228) || (IS_CHAR_ON_FIRE( l_U2250 )))
        {
            ...
            if (NOT (IS_CHAR_INJURED( l_U2250 )))
            {
                SWITCH_PED_TO_RAGDOLL( l_U2250, 10000, 60000, 1, 1, 1, 0 );
            }
            if (NOT (IS_CHAR_INJURED( l_U2250 )))
            {
                if (IS_PED_RAGDOLL( l_U2250 ))
            ...
            uVar5 = {sub_73234( l_U2250 )};
            SET_CAM_POS( l_U2154, 1180.21900000, -495.97100000, 13.08902000 );
            SET_CAM_ROT( l_U2154, 12.45547000, -0.00000000, 81.64666000 );
            SET_CAM_FOV( l_U2154, 55.00000000 );
            while ((ABSF( uVar5._fU8 )) > 0.50000000)
            {
                uVar5 = {sub_73234( l_U2250 )};
                WAIT( 0 );
            }
...
void sub_74819()
{
    if (l_U2180[l_U2176] == 0)
    {
        ...
        SET_CHAR_COORDINATES( l_U2156, 1175.18600000, -489.19990000, 33.20350000 );
        SET_CHAR_HEADING( l_U2156, 349.33930000 );
        if (NOT (IS_CHAR_DEAD( l_U2250 )))
        {
            SET_CHAR_COORDINATES( l_U2250, 1175.24600000, -487.56990000, 33.20350000 );
            SET_CHAR_HEADING( l_U2250, 189.33930000 );
            FREEZE_CHAR_POSITION( l_U2250, 0 );
        }
        sub_66170();
    ...
    if (l_U2091[0] == 0)
    {
        if (NOT (IS_CHAR_DEAD( l_U2250 )))
        {
            TASK_LOOK_AT_CHAR( l_U2156, l_U2250, 35000, 0 );
            TASK_LOOK_AT_CHAR( l_U2250, l_U2156, 35000, 0 );
        }
        sub_21901( "V4_LIVE", ref l_U2170, 8, 1 );
        INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
        l_U2091[0] = 1;
    }
    if (((sub_75539( l_U2170 )) > 1) AND (l_U2091[2] == 0))
    {
    ...
    if (((sub_75539( l_U2170 )) > 2) AND (l_U2091[3] == 0))
    {
    ...
    if (((sub_75539( l_U2170 )) > 3) AND (l_U2091[4] == 0))
    {
    ...
    if (((l_U2091[4] == 1) AND (NOT (sub_22883( l_U2170 )))) AND (l_U2091[5] == 0))
    {
        if (NOT (IS_CHAR_DEAD( l_U2250 )))
        {
            TASK_FOLLOW_NAV_MESH_TO_COORD( l_U2250, 1165.12000000, -461.01090000, 31.96240000, 4, 5000, 0.50000000 );
        }
        SETTIMERA( 0 );
        l_U2091[5] = 1;
    }
    if ((((l_U2091[1] == 0) AND (l_U2091[5] == 1)) AND (TIMERA() > 2000)) || ((sub_66744()) AND (IS_SCREEN_FADED_IN())))
    {
        DO_SCREEN_FADE_OUT( 500 );
        while (IS_SCREEN_FADING_OUT())
        {
