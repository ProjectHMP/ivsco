...
int sub_6935(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_547() ))
    {
        if (IS_SCREEN_FADED_IN())
        {
            ...
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_547() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9200)))
                {
                    if (NOT sub_3819())
                    {
...
int sub_12719(unknown uParam0, unknown uParam1, unknown uParam2)
{
    unknown uVar5;
    unknown uVar6;
    unknown uVar7;
...
void sub_14008()
{
    ...
    sub_14470();
    SET_CHAR_HEALTH( sub_695(), sub_14587() );
    return;
}

void sub_14054(unknown uParam0, unknown uParam1)
{
    sub_14075( uParam0, uParam1, 0.00000000, "" );
    return;
}

void sub_14075(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    unknown uVar6;
    unknown uVar7;
    unknown uVar8;
