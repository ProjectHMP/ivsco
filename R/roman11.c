                    ...
                    if (NOT (sub_28597( l_U593 )))
                    {
                        if (NOT IS_MESSAGE_BEING_DISPLAYED())
                        {
                            if (g_U64687 == 0)
                            {
                                ...
                                {
                                    GET_SCRIPT_TASK_STATUS( l_U491, 53, ref l_U588 );
                                    if ((l_U588 == 7) || (l_U588 == 2))
                                    {
                                        sub_1663( ref l_U593, 0 );
                                    }
                                    else if (NOT (IS_CHAR_INJURED( l_U491 )))
                                    {
                                        if ((IS_PLAYER_FREE_AIMING_AT_CHAR( sub_3911(), l_U491 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U491, sub_1448(), 0 )))
                                        {
                                            sub_1663( ref l_U593, 0 );
                                        }
                                    }
                ...
                if (sub_28070( l_U491 ))
                {
                    ...
                    if (LOCATE_CHAR_ANY_MEANS_3D( sub_1448(), l_U511._fU0, l_U511._fU4, l_U511._fU8, l_U581, l_U581, l_U581, 1 ))
                    {
                        if (sub_22368( 1, 1 ))
                        {
                            if (IS_CHAR_SITTING_IN_ANY_CAR( sub_1448() ))
                            {
                                if (sub_22194())
                                {
                                    ...
                                    if (NOT (DOES_CAM_EXIST( l_U607 )))
                                    {
                                        ...
                                        SET_CAM_ROT( l_U609, 32.76917000, -0.00000100, -110.83620000 );
                                    ...
                                    CLEAR_AREA( 595.70280000, 1401.08700000, 9.95820000, 25.00000000, 1 );
                                    l_U481 = 5;
                                }
                            }
                            ...
                            CLEAR_AREA( 595.70280000, 1401.08700000, 9.95820000, 3.00000000, 1 );
                            l_U481 = 5;;
                        }
                    }
                }
...
void sub_2974()
{
    ...
    {
        if (((sub_3012( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_4164()
{
    ...
    if (NOT (IS_CHAR_INJURED( sub_1448() )))
    {
        if (g_U64691)
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_1448(), 822.56290000, -270.34200000, 15.61570000, 150.00000000, 150.00000000, 150.00000000, 1 )) || (IS_SCREEN_FADED_IN()))
            {
        ...
        if (g_U64690)
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( sub_1448(), 896.52000000, -502.84000000, 19.48000000, 150.00000000, 150.00000000, 150.00000000, 1 )) || (IS_SCREEN_FADED_IN()))
            {
                GET_GAME_VIEWPORT_ID( ref uVar2 );
...
void sub_21013()
{
    if (((((l_U481 == 1) || (l_U481 == 2)) || (l_U481 == 3)) || (l_U481 == 4)) || (l_U481 == 5))
    {
        if (NOT (IS_CHAR_INJURED( l_U491 )))
        {
            if (sub_21089( l_U491 ))
...
void sub_21740()
{
    if (NOT (IS_CAR_DEAD( l_U497 )))
    {
        ...
        {
            if (((IS_CHAR_SHOOTING( sub_1448() )) || (IS_CHAR_IN_ANY_CAR( sub_1448() ))) || (IS_CAR_ON_FIRE( l_U497 )))
            {
...
void sub_26141()
{
    ...
    while (((NOT (HAS_MODEL_LOADED( l_U616 ))) || (NOT (HAS_MODEL_LOADED( l_U617 )))) || (NOT (HAVE_ANIMS_LOADED( "MISSROMAN11" ))))
    {
...
int sub_31104()
{
    ...
    switch (l_U484)
    {
        ...
        switch (l_U486)
        {
            ...
            break;
            case 2:
            if ((NOT (IS_CHAR_DEAD( sub_1448() ))) AND (NOT (IS_CHAR_DEAD( l_U491 ))))
            {
                if (IS_CHAR_IN_ANY_CAR( sub_1448() ))
                {
                    STORE_CAR_CHAR_IS_IN_NO_SAVE( sub_1448(), ref l_U613 );
...
void sub_35390()
{
    ...
    vVar3 = {811.26560000, -254.48830000, 14.54200000};
    fVar6 = 104.39370000;
    ...
    switch (l_U485)
    {
        ...
        switch (l_U486)
        {
            ...
            if (IS_CHAR_IN_ANY_CAR( sub_1448() ))
            {
                ...
                if (l_U588 == 7)
                {
                    if ((NOT (IS_CHAR_INJURED( l_U491 ))) AND (NOT (IS_CHAR_INJURED( sub_1448() ))))
                    {
                        sub_22740();
                        if (NOT (DOES_CAM_EXIST( l_U605 )))
                        {
    ...
    else
    {
        switch (l_U483)
        {
            ...
            if (NOT (IS_CHAR_INJURED( l_U491 )))
            {
                ...
                if ((LOCATE_CHAR_ON_FOOT_3D( sub_1448(), 595.70280000, 1401.08700000, 9.95820000, 1.50000000, 1.50000000, 1.50000000, 0 )) || (LOCATE_CHAR_ON_FOOT_3D( l_U491, 595.70280000, 1401.08700000, 9.95820000, 1.50000000, 1.50000000, 1.50000000, 0 )))
                {
                    l_U483 = 1;
                }
                if (TIMERA() > 3000)
            ...
            if (l_U576)
            {
                if (NOT (sub_27489( l_U593 )))
                {
                    if (NOT (IS_CHAR_INJURED( l_U491 )))
                    {
                        ...
                        TASK_FOLLOW_NAV_MESH_TO_COORD( l_U491, 595.70280000, 1401.08700000, 9.95820000, 2, -2, 1.00000000 );
                    }
                    if (NOT (IS_CHAR_INJURED( sub_1448() )))
                    {
                        TASK_FOLLOW_NAV_MESH_TO_COORD( sub_1448(), 595.70280000, 1401.08700000, 9.95820000, 2, -2, 1.00000000 );
                    }
                    CLEAR_PRINTS();
                    ...
                    if (IS_CHAR_IN_ANY_CAR( sub_1448() ))
                    {
                        ...
                        WARP_CHAR_FROM_CAR_TO_COORD( sub_1448(), 594.63680000, 1401.48600000, 9.95970000 );
                    }
                    else
                    {
                        SET_CHAR_COORDINATES( sub_1448(), 594.63680000, 1401.48600000, 9.95970000 );
                    }
                    if (NOT (IS_CHAR_DEAD( l_U491 )))
                    {
            ...
            if (l_U576)
            {
                if (NOT (sub_27489( l_U593 )))
                {
                    ...
                    if (IS_CHAR_IN_ANY_CAR( sub_1448() ))
                    {
                        ...
                        WARP_CHAR_FROM_CAR_TO_COORD( sub_1448(), 592.83650000, 1401.05300000, 9.95820000 );
                    }
                    else
                    {
                        SET_CHAR_COORDINATES( sub_1448(), 592.83650000, 1401.05300000, 9.95820000 );
                    }
