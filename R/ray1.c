...
void sub_1729()
{
    ...
    {
        if (((sub_1767( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3416()
{
    ...
    l_U885[2]._fU16 = {-543.38120000, 1251.32300000, 93.53980000};
    ...
    l_U1046[3]._fU40 = 7;
    l_U1046[3]._fU76 = 10;
    l_U1046[4]._fU4 = {-544.70050000, 1245.47900000, 96.53470000};
    ...
    l_U1046[6]._fU16 = {-542.53300000, 1251.46200000, 97.53960000};
...
void sub_7752()
{
    ...
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U147, l_U1638._fU0, l_U1638._fU4, 150.00000000, 150.00000000, 0 )) AND (l_U82[1] == 0))
    {
        sub_9894( -1345134469 );
        sub_9894( -196312163 );
        sub_9894( -268530289 );
        ...
        SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( 106751028, -548.00000000, 1249.80000000, 97.80000000, 1, 0.00000000 );
        ...
        SET_OBJECT_HEADING( l_U1571, 80.45000000 );
        ...
        CREATE_OBJECT_NO_OFFSET( -16333017, -543.12300000, 1260.33400000, 89.73550000, ref l_U1575, 1 );
        ...
        CREATE_OBJECT_NO_OFFSET( 1667998832, -543.11900000, 1260.29900000, 89.73550000, ref l_U1576, 1 );
    ...
    if (l_U82[0] == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U147, l_U1638._fU0, l_U1638._fU4, l_U1638._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (sub_12844( 1, 1 )))
        {
            sub_13135();
    ...
    if (DOES_CHAR_EXIST( l_U1569 ))
    {
        ...
        if (((sub_13506( l_U1569 )) < 225) || (l_U670 == 1))
        {
            if (NOT (IS_CHAR_DEAD( l_U1569 )))
            {
    ...
    if ((LOCATE_CHAR_ON_FOOT_3D( l_U147, l_U1644._fU0, l_U1644._fU4, l_U1644._fU8, 6.50000000, 6.50000000, 2.50000000, 0 )) AND (sub_12844( 1, 1 )))
    {
...
void sub_7903()
{
    ...
    if (((DOES_VEHICLE_EXIST( l_U153 )) AND (NOT (IS_CAR_DEAD( l_U153 )))) AND (l_U153 != nil))
    {
        ...
        {
            if ((l_U154 != l_U153) AND (l_U154 != nil))
            {
...
int sub_9125()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_1767( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_2053( I );
            return 1;
        }
...
void sub_13135()
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3610() )) || (IS_CHAR_ON_ANY_BIKE( sub_3610() )))
    {
...
void sub_14623()
{
    ...
    if (l_U651[l_U647] == 0)
    {
        ...
        SET_CAM_POS( l_U140, -489.01550000, 1272.55400000, 27.14602000 );
        SET_CAM_ROT( l_U140, -48.91621000, 0.00000000, 147.32670000 );
        SET_CAM_FOV( l_U140, 45.00000000 );
        SET_CAM_POS( l_U142, -489.01550000, 1272.55400000, 27.14602000 );
    ...
    if ((((iVar2 == 7) AND (l_U82[11] == 0)) AND (TIMERA() > 750)) AND (l_U82[13] == 0))
    {
        SET_USE_HIGHDOF( 1 );
        ...
        SET_CAM_FOV( l_U145, 34.20004000 );
    ...
    if (((TIMERA() > 3000) AND (l_U668 == 0)) AND (l_U82[13] == 0))
    {
        sub_15487( "RB1_WHERE", 1, 1, ref l_U641, 8, 1 );
        SET_CAM_POS( l_U140, -494.10820000, 1265.39900000, 18.11092000 );
        ...
        SET_CAM_POS( l_U142, -494.10820000, 1265.39900000, 18.11092000 );
    ...
    if (l_U82[13] == 0)
    {
        if (((l_U82[12] == 0) AND (l_U668 == 1)) AND (NOT (sub_17079( l_U641 ))))
        {
            sub_15487( "RB1_WHERE", 2, 1, ref l_U641, 8, 1 );
            SET_CAM_POS( l_U145, -494.62810000, 1267.74800000, 18.08209000 );
            SET_CAM_ROT( l_U145, -2.11254500, -0.00000000, 164.11680000 );
            SET_CAM_FOV( l_U145, 38.20004000 );
            if (NOT GET_IS_WIDESCREEN())
            {
    ...
    if (l_U82[13] == 0)
    {
        if (((l_U82[12] == 1) AND (NOT (sub_17079( l_U641 )))) AND (l_U703 == 0))
        {
    ...
    if (l_U82[13] == 0)
    {
        if (((sub_17505()) AND (IS_SCREEN_FADED_IN())) AND (TIMERA() > 1000))
        {
            l_U681 = 1;
        }
    }
    if ((((l_U703 == 1) AND (NOT (sub_17079( l_U641 )))) AND (l_U82[13] == 0)) || (l_U681 == 1))
    {
        if (l_U681)
        {
    ...
    if (((l_U82[13] == 1) AND (NOT (sub_17079( l_U641 )))) AND (l_U704 == 0))
    {
    ...
    if (NOT (IS_CHAR_DEAD( l_U1569 )))
    {
        if ((((((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1569, l_U147, 0 )) || (IS_CHAR_TOUCHING_CHAR( l_U1569, l_U147 ))) || ((sub_18147( l_U1569, l_U147, 1 )) < 1.25000000)) AND (l_U82[13] == 1)) AND (l_U82[14] == 0)) AND (l_U82[1] == 0))
        {
            if (NOT (IS_CHAR_DEAD( l_U1569 )))
            {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U1569 ))) AND (l_U82[13] == 1))
    {
        if (((sub_13506( l_U1569 )) < 160) || ((((IS_PLAYER_TARGETTING_CHAR( l_U148, l_U1569 )) || (IS_PLAYER_FREE_AIMING_AT_CHAR( l_U148, l_U1569 ))) AND (IS_CHAR_ARMED( l_U147, 7 ))) AND ((sub_18147( l_U147, l_U1569, 1 )) < 7.50000000)))
        {
            if (l_U82[1] == 0)
            {
                sub_17792( ref l_U641, 0 );
        ...
        if (l_U82[1] == 0)
        {
            if ((NOT (sub_17079( l_U641 ))) AND (IS_CHAR_FATALLY_INJURED( l_U1569 )))
            {
        ...
        if (NOT (IS_CHAR_DEAD( l_U1569 )))
        {
            if (((((sub_18147( l_U147, l_U1569, 1 )) > 35.00000000) AND ((IS_CHAR_ON_SCREEN( l_U1569 )) == 0)) AND (l_U82[7] == 0)) AND (l_U675 == 0))
            {
                sub_17792( ref l_U641, 1 );
    ...
    if ((NOT (IS_CHAR_DEAD( l_U1569 ))) AND (l_U82[7] == 0))
    {
        if (l_U82[1] == 1)
        {
            if ((((NOT (IS_PED_RAGDOLL( l_U1569 ))) AND (NOT (sub_19127( l_U1569, 34 )))) AND (NOT (sub_17079( l_U641 )))) || (NOT (IS_CHAR_FACING_CHAR( l_U1569, l_U147, 45.00000000 ))))
            {
    ...
    if ((DOES_CHAR_EXIST( l_U1569 )) AND ((l_U675 == 0) AND (l_U82[7] == 0)))
    {
    ...
    if ((l_U82[1] == 1) AND (NOT (sub_17079( l_U641 ))))
    {
        if (l_U82[4] == 0)
        {
        ...
        if ((NOT (sub_17079( l_U641 ))) AND (TIMERA() > 8000))
        {
            if (((l_U82[7] == 0) AND (l_U82[4] == 1)) AND (l_U675 == 1))
            {
                sub_17792( ref l_U641, 0 );
        ...
        sub_19944( 1 );
        if (((LOCATE_CHAR_ANY_MEANS_3D( l_U147, l_U1641._fU0, l_U1641._fU4, l_U1641._fU8, 2.50000000, 2.50000000, 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -551.11180000, 1261.25400000, 15.76990000, 2.00000000, 2.00000000, 2.00000000, 0 ))) || ((sub_20111( l_U147, -542.77000000, 1258.52000000, 17.79000000 )) < 4.00000000))
        {
            if (IS_CHAR_INJURED( l_U1569 ))
            {
                l_U723 = 1;
...
void sub_20248()
{
    ...
    sub_19944( 1 );
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U147, -540.57380000, 1259.33500000, 17.54000000, 3.50000000, 3.50000000, 1.00000000, 0 )) AND (l_U82[0] == 0))
    {
    ...
    if (((LOCATE_CHAR_ON_FOOT_3D( l_U147, -542.77000000, 1258.52000000, 17.79000000, 1.00000000, 1.00000000, 1.50000000, 0 )) AND (NOT (IS_AREA_OCCUPIED( -543.07000000, 1258.22000000, 17.49000000, -542.47000000, 1258.82000000, 18.09000000, 0, 1, 0, 0, 0 )))) AND (l_U82[1] == 0))
    {
        if (sub_20812( 4, 0 ))
        {
    ...
    if (l_U82[2] == 0)
    {
        if (((((sub_22004( l_U147, "missRay1", "Press_Button" )) > 0.50000000) || (TIMERA() > 8000)) AND (l_U82[1] == 1)) AND (l_U680 == 0))
        {
            CLEAR_CHAR_TASKS( l_U147 );
    ...
    if ((((l_U82[1] == 1) AND (l_U82[2] == 0)) AND (l_U680 == 1)) AND (TIMERA() > 6000))
    {
    ...
    if (l_U82[2] == 1)
    {
        if ((((l_U82[0] == 1) AND (NOT (IS_PLAYER_TARGETTING_ANYTHING( sub_2947() )))) AND ((((sub_20111( l_U147, -544.45900000, 1260.58300000, 18.04000000 )) < 1.00000000) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -544.45900000, 1260.58300000, 18.04000000, 1.60000000, 1.60000000, 1.60000000, 1 ))) || (LOCATE_CHAR_IN_CAR_3D( l_U147, -544.16390000, 1260.34900000, 16.33430000, 1.40000000, 1.40000000, 2.60000000, 0 )))) AND (NOT (IS_PED_IN_COVER( l_U147 ))))
        {
            REMOVE_BLIP( l_U1625 );
    ...
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -535.08720000, 1257.08300000, 87.55230000, 1.00000000, 1.00000000, 1.50000000, 0 ))
    {
        ...
        while ((((((NOT (HAS_MODEL_LOADED( 492147228 ))) || (NOT (HAS_MODEL_LOADED( -1926041127 )))) || (NOT (HAS_MODEL_LOADED( 1168388225 )))) || (NOT (HAS_MODEL_LOADED( -1746774780 )))) || (NOT (HAS_MODEL_LOADED( -256051882 )))) || (NOT (HAS_MODEL_LOADED( -862378730 ))))
        {
            WAIT( 0 );
        }
...
int sub_20812(int iParam0, unknown uParam1)
{
    if (IS_PLAYER_PLAYING( sub_2947() ))
    {
        ...
        {
            if ((IS_PLAYER_CONTROL_ON( sub_2947() )) || (iParam0 == 5))
            {
                if ((((IS_PLAYER_FREE_FOR_AMBIENT_TASK( sub_2947() )) || (iParam0 == 5)) || (iParam0 == 4)) || ((uParam1) AND (g_U9202)))
                {
                    if (NOT sub_20908())
                    {
...
void sub_25286()
{
    ...
    if (l_U651[l_U647] == 0)
    {
        ...
        sub_15171( 1 );
        sub_25369( -537.69810000, 1255.81400000, 17.72528000, -5.44527800, -0.00000000, 65.26086000, l_U148 );
        if (IS_CHAR_ON_ANY_BIKE( l_U147 ))
        {
            SET_PLAYER_CONTROL( l_U148, 0 );
        ...
        REQUEST_MODEL( 1168388225 );
        REQUEST_MODEL( -1746774780 );
        while ((((NOT (HAS_MODEL_LOADED( 492147228 ))) || (NOT (HAS_MODEL_LOADED( -1926041127 )))) || (NOT (HAS_MODEL_LOADED( 1168388225 )))) || (NOT (HAS_MODEL_LOADED( -1746774780 ))))
        {
            WAIT( 0 );
        }
    ...
    if (l_U723 == 0)
    {
        if (((l_U82[1] == 1) AND (l_U82[2] == 0)) AND (TIMERA() > 500))
        {
            ...
            SET_CAM_POS( l_U140, -501.01750000, 1264.77900000, 16.91545000 );
            SET_CAM_ROT( l_U140, 32.42542000, 0.00000100, 119.45540000 );
            SET_CAM_FOV( l_U140, 54.00000000 );
            SET_CAM_POS( l_U142, -501.01750000, 1264.77900000, 16.91545000 );
    ...
    else if ((l_U82[1] == 1) AND (l_U82[2] == 0))
    {
    ...
    if ((l_U82[3] == 0) AND (l_U82[2] == 1))
    {
        ...
        if (l_U723 == 0)
        {
            ...
            SET_CAM_POS( l_U145, -536.77480000, 1266.08700000, 89.39059000 );
    ...
    if (((l_U82[3] == 1) AND (l_U82[4] == 0)) AND (TIMERA() > 1000))
    {
        ...
        STOP_SOUND( l_U1653 );
        PLAY_SOUND_FROM_POSITION( -1, "RB1_PROJECT_TAKEDOWN_LIFT_BELL", -542.92300000, 1261.23400000, 89.73550000 );
        PLAY_SOUND_FROM_POSITION( l_U1654, "RB1_PROJECT_TAKEDOWN_LIFT_DOOR_OPEN", -542.92300000, 1261.23400000, 89.73550000 );
        while (NOT (sub_22647( ref l_U1575, ref l_U1576, 20, -542.92300000, 1261.23400000, 89.73550000, -543.26900000, 1259.26900000, 89.73550000 )))
        {
            WAIT( 0 );
        }
        l_U716 = 0;
    ...
    if (((l_U82[4] == 1) AND (l_U82[5] == 0)) AND (TIMERA() > 1250))
    {
        if (NOT (IS_CHAR_DEAD( l_U724[0]._fU0 )))
        {
...
void sub_29730()
{
    ...
    if (l_U723 == 1)
    {
        if (((NOT (IS_CHAR_INJURED( l_U724[0]._fU0 ))) AND ((sub_18497( l_U641 )) > 2)) AND (l_U82[2] == 0))
        {
    ...
    sub_19944( 1 );
    if (((l_U723 == 1) AND (NOT (sub_17079( l_U641 )))) AND (l_U82[4] == 0))
    {
        l_U723 = 0;
        l_U82[4] = 1;
    }
    if ((((l_U723 == 0) || (IS_CHAR_SHOOTING( l_U147 ))) || (TIMERA() > 9000)) || (NOT (sub_17079( l_U641 ))))
    {
        SET_PED_IS_BLIND_RAGING( l_U147, 1 );
        if ((l_U82[1] == 1) || (l_U82[0] == 1))
        {
            l_U723 = 0;
        }
        if (l_U82[3] == 0)
    ...
    if ((IS_CHAR_INJURED( l_U724[0]._fU0 )) || (IS_CHAR_INJURED( l_U724[1]._fU0 )))
    {
        sub_17792( ref l_U641, 0 );
    }
    if (((IS_CHAR_INJURED( l_U724[0]._fU0 )) AND (IS_CHAR_INJURED( l_U724[1]._fU0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -540.05600000, 1263.79800000, 89.54080000, 2.00000000, 1.45000000, 1.00000000, 0 )))
    {
        if (l_U677 == 0)
        {
    ...
    if (((l_U677 == 1) AND (l_U678 == 0)) AND (TIMERA() > 10000))
    {
        CLEAR_HELP();
        l_U678 = 1;
    }
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -537.11870000, 1257.53400000, 90.54050000, 1.00000000, 1.00000000, 1.00000000, 0 ))
    {
...
void sub_30712(unknown uParam0, int iParam1, int iParam2)
{
    ...
    for ( I = 0; I <= (iParam1 - 1); I++ )
    {
        if ((((uParam0^)[I]._fU44 == 0) AND (DOES_CHAR_EXIST( (uParam0^)[I]._fU0 ))) AND (NOT (IS_CHAR_DEAD( (uParam0^)[I]._fU0 ))))
        {
            if ((((((LOCATE_CHAR_ANY_MEANS_3D( l_U147, (uParam0^)[I]._fU16._fU0, (uParam0^)[I]._fU16._fU4, (uParam0^)[I]._fU16._fU8, 2.50000000, 2.50000000, 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U147, (uParam0^)[I]._fU28._fU0, (uParam0^)[I]._fU28._fU4, (uParam0^)[I]._fU28._fU8, 2.50000000, 2.50000000, 1.50000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -527.22350000, 1260.76300000, 89.53560000, 2.00000000, 1.00000000, 1.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -529.00400000, 1251.05500000, 93.53950000, 2.00000000, 1.00000000, 1.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -535.08720000, 1257.08300000, 87.55230000, 3.00000000, 3.00000000, 1.50000000, 0 ))) || (((IS_CHAR_SHOOTING( l_U147 )) AND ((sub_18147( l_U147, (uParam0^)[I]._fU0, 1 )) < 3.00000000)) AND ((uParam0^)[I]._fU60 != 3)))
            {
                ...
                if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 )))
                {
                    ...
                    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U147, -527.22350000, 1260.76300000, (uParam0^)[I]._fU16._fU8, 2.00000000, 1.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -529.00400000, 1251.05500000, 93.53950000, 2.00000000, 1.00000000, 1.00000000, 0 )))
                    {
                        if ((uParam0^)[I]._fU48 == 0)
                        {
        ...
        {
            if (((((uParam0^)[I]._fU44 == 1) AND ((uParam0^)[I]._fU60 == 3)) AND (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( (uParam0^)[I]._fU0, l_U147, 0 ))) AND ((uParam0^)[I]._fU72 == 0))
            {
                if (NOT (IS_CHAR_INJURED( (uParam0^)[I]._fU0 )))
                {
...
void sub_33683()
{
    ...
    sub_30712( ref l_U724, 8, 35 );
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -538.63030000, 1258.18800000, 93.54450000, 6.00000000, 1.00000000, 1.00000000, 0 ))
    {
...
void sub_33936()
{
    ...
    if (l_U82[0] == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U147, -546.91700000, 1250.26000000, 97.53500000, 1.00000000, 1.00000000, 1.25000000, 1 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -546.91700000, 1250.26000000, 97.53500000, 2.50000000, 2.50000000, 1.25000000, 0 )))
        {
            SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( 106751028, -548.00000000, 1249.80000000, 97.80000000, 0, 0.00000000 );
            ...
            SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( -1412882709, -546.00000000, 1233.80000000, 97.80000000, 1, 0.00000000 );
    ...
    if ((l_U699 == 1) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
    ...
    sub_19944( 1 );
    if (((sub_30712( ref l_U1046, 8, 35 )) > 4) AND (l_U82[0] == 1))
    {
        l_U647++;
    }
    return;
...
void sub_34777()
{
    ...
    if ((l_U82[0] == 0) AND (sub_34897( l_U147, 346.00000000 )))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -544.86790000, 1231.62200000, 97.53960000, 1.00000000, 1.00000000, 1.00000000, 0 ))
        {
            DO_SCREEN_FADE_OUT( 500 );
            while (IS_SCREEN_FADING_OUT())
            {
            ...
            CLEAR_AREA( -546.00000000, 1233.80000000, 97.80000000, 4.00000000, 1 );
            START_CUTSCENE();
            while (NOT HAS_CUTSCENE_LOADED())
            {
                WAIT( 0 );
            ...
            SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( -1412882709, -546.00000000, 1233.80000000, 97.80000000, 0, 0.00000000 );
            SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( 106751028, -548.00000000, 1249.80000000, 97.80000000, 1, 1.00000000 );
            CLEAR_NAMED_CUTSCENE( "IMRAY1" );
            REQUEST_INTERIOR_MODELS( 2035661027, "RM1b_MloRoom" );
            GET_INTERIOR_AT_COORDS( -544.86790000, 1231.62200000, 97.53960000, ref uVar2 );
...
int sub_34897(unknown uParam0, unknown uParam1)
{
    ...
    if (NOT (IS_CHAR_DEAD( uParam0 )))
    {
        ...
        {
            if (((fVar4 < fVar8) AND (fVar4 >= 0)) || ((fVar4 <= 360) AND (fVar4 > fVar5)))
            {
                l_U639 = 1;
            }
            else
        ...
        {
            if (((fVar4 > fVar7) AND (fVar4 <= 360)) || ((fVar4 >= 0) AND (fVar4 < fVar6)))
            {
                l_U639 = 1;
            }
            else
...
void sub_37423()
{
    ...
    if (l_U651[l_U647] == 0)
    {
        ...
        sub_14548();
        if ((NOT (DOES_CHAR_EXIST( l_U1570 ))) || (IS_CHAR_INJURED( l_U1570 )))
        {
    ...
    if (l_U707 == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U147, -538.14420000, 1265.66400000, 108.75670000, 2.00000000, 2.00000000, 2.00000000, 0 )) AND (l_U82[2] == 0))
        {
            OPEN_SEQUENCE_TASK( ref uVar3 );
    ...
    if (l_U706 == 0)
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U147, -534.54180000, 1281.57200000, 105.58900000, 1.00000000, 1.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U147, -534.30360000, 1281.71600000, 106.59460000, 10.00000000, 1.50000000, 3.00000000, 0 )))
        {
            sub_3713( 1, l_U1570, "TEDDY", 0 );
            sub_17792( ref l_U641, 0 );
    ...
    if (NOT (IS_CHAR_DEAD( l_U1570 )))
    {
        if (((l_U82[2] == 1) AND (IS_CHAR_PLAYING_ANIM( l_U1570, "missray1", "scared_02" ))) AND (l_U82[3] == 0))
        {
    ...
    if ((l_U707 == 1) AND (l_U82[1] == 0))
    {
        ...
        if ((((l_U665 - l_U666) > 10000) AND (l_U706 == 1)) AND (NOT (sub_17079( l_U641 ))))
        {
        ...
        if (((((((sub_13506( l_U1570 )) < 600) || (IS_CHAR_ON_FIRE( l_U1570 ))) || ((sub_18147( l_U147, l_U1570, 1 )) < 0.85000000)) || (((sub_18147( l_U147, l_U1570, 1 )) < 4.85000000) AND (IS_CHAR_IN_ANY_CAR( l_U147 )))) || (IS_EXPLOSION_IN_AREA( 0, -539.00000000, 1283.86000000, 104.00000000, -531.27000000, 1289.18000000, 109.07000000 ))) || (IS_EXPLOSION_IN_AREA( 2, -539.00000000, 1283.86000000, 104.00000000, -531.27000000, 1289.18000000, 109.07000000 )))
        {
            ...
            {
                SET_CHAR_HEALTH( l_U1570, 200 );
                if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U1570, -533.20000000, 1288.12000000, 104.64000000, 1.00000000, 1.00000000, 1.00000000, 0 ))) AND (NOT (IS_CHAR_PLAYING_ANIM( l_U1570, "missRay1", "Trans_to_scared02" ))))
                {
                    CLEAR_CHAR_TASKS_IMMEDIATELY( l_U1570 );
                    SET_CHAR_HEADING( l_U1570, 270.00000000 );
                ...
                while (l_U721 < 0.93000000)
                {
                    ...
                    if ((l_U721 > 0.50000000) AND (l_U698 == 0))
                    {
...
void sub_54270()
{
    ...
    if (((sub_20111( l_U1570, -533.63530000, 1288.52500000, 104.56440000 )) < 1.80000000) AND (l_U82[4] == 0))
    {
        l_U82[4] = 1;
    }
    if (NOT (IS_CHAR_DEAD( l_U1570 )))
    ...
    if ((uVar2._fU8 < 102.00000000) AND (l_U82[0] == 0))
    {
    ...
    if (((sub_55206( l_U1570 )) < 60.00000000) AND (l_U82[1] == 0))
    {
    ...
    if (((l_U1603._fU8 > 0.25000000) AND (l_U82[2] == 0)) AND (l_U82[1] == 1))
    {
        sub_17792( ref l_U641, 0 );
    ...
    if (((TIMERA() > 2000) AND (l_U82[3] == 0)) AND (l_U82[2] == 1))
    {
        SET_CAM_POS( l_U140, -536.69440000, 1305.87700000, 53.48011000 );
        ...
        SET_CAM_POS( l_U142, -536.69440000, 1305.87700000, 53.48011000 );
    ...
    if ((((l_U82[2] == 1) AND (l_U82[3] == 1)) AND (l_U82[5] == 0)) AND (TIMERA() > 4000))
    {
    ...
    if (((l_U82[5] == 1) AND (TIMERA() > 3500)) || (sub_17505()))
    {
        if (l_U82[5] == 0)
        {
            DO_SCREEN_FADE_OUT( 1000 );
