void main()
{
    ...
    switch (l_U627)
    {
        ...
        l_U606 = 1;
        l_U591 = {848.39760000, 757.39150000, 7.90063100};
        ...
        l_U491 = {1235.90700000, 744.48880000, 40.93580000};
        l_U606 = 1;
        ...
        l_U606 = 1;
        l_U591 = {1090.94300000, 1589.21300000, 18.97629000};
    ...
    while (true)
    {
        ...
        switch (l_U652)
        {
            ...
            switch (l_U653)
            {
                ...
                if (NOT l_U613)
                {
                    if (((IS_VEH_DRIVEABLE( g_U64761 )) AND (NOT (sub_13911( ref g_U64761 )))) AND (NOT (IS_CAR_IN_WATER( g_U64761 ))))
                    {
                        l_U583 = g_U64761;
                    ...
                    else if (IS_CHAR_IN_ANY_CAR( sub_3372() ))
                    {
                        ...
                        if ((IS_VEH_DRIVEABLE( l_U582 )) AND (NOT (IS_CAR_IN_WATER( g_U64761 ))))
                        {
                ...
                else if (IS_VEH_DRIVEABLE( l_U583 ))
                {
                    ...
                    if (IS_CHAR_IN_CAR( sub_3372(), l_U583 ))
                    {
                        ...
                        if ((LOCATE_CHAR_IN_CAR_3D( sub_3372(), g_U64764._fU0, g_U64764._fU4, g_U64764._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )) || ((l_U618) AND (IS_PLAYER_PRESSING_HORN( sub_349() ))))
                        {
                            if ((sub_14937( 1, 1 )) AND (HAS_MODEL_LOADED( l_U629 )))
                            {
                                if (HAVE_ANIMS_LOADED( "MISSroman8" ))
                                {
                                    ...
                                    if (IS_VEHICLE_ON_ALL_WHEELS( l_U582 ))
                                    {
                                        if (IS_CAR_MODEL( l_U582, -1932515764 ))
                                        {
                                            ...
                                            CLEAR_HELP();
                                            if ((NOT (IS_CHAR_INJURED( l_U590 ))) AND (IS_VEH_DRIVEABLE( l_U583 )))
                                            {
                ...
                else if (NOT l_U617)
                {
                    if (NOT (IS_CHAR_INJURED( l_U590 )))
                    {
                        if ((NOT (IS_CHAR_WAITING_FOR_WORLD_COLLISION( l_U590 ))) AND (HAS_MODEL_LOADED( l_U630 )))
                        {
                            PRINTNL();
                            PRINTNL();
                ...
                if ((IS_CHAR_SHOOTING_IN_AREA( sub_3372(), g_U64764._fU0 - 50, g_U64764._fU4 - 50, g_U64764._fU0 + 50, g_U64764._fU0 + 50, 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U590, sub_3372(), 0 )))
                {
            ...
            switch (l_U655)
            {
                ...
                if ((g_U64758 - l_U624) > 0)
                {
                    ...
                    if (IS_VEH_DRIVEABLE( l_U583 ))
                    {
                        if (NOT (IS_CHAR_INJURED( l_U590 )))
                        {
                            if (((NOT (IS_CHAR_IN_CAR( l_U590, l_U583 ))) || (sub_13911( ref l_U583 ))) || (NOT (IS_VEH_DRIVEABLE( l_U583 ))))
                            {
                                STOP_PED_SPEAKING( l_U590, 0 );
                        ...
                        else if (NOT (IS_CHAR_INJURED( l_U590 )))
                        {
                            ...
                            if ((TIMERB() >= 30000) || (IS_CHAR_SHOOTING( sub_3372() )))
                            {
                                STOP_PED_SPEAKING( l_U590, 0 );
                                SAY_AMBIENT_SPEECH( l_U590, "GENERIC_FUCK_OFF", 1, 1, 2 );
                                STOP_PED_SPEAKING( l_U590, 1 );
                ...
                else if (((g_U64758 - l_U624) < 5000) AND ((g_U64758 - l_U624) > 0))
                {
                    sub_457( l_U598 );
                    STOP_PED_SPEAKING( l_U590, 0 );
...
void sub_2177()
{
    ...
    {
        if (((sub_2215( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
int sub_9221(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3372() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3372() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_9748()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_15265()
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3372() )) || (IS_CHAR_ON_ANY_BIKE( sub_3372() )))
    {
    ...
    if (TIMERB() >= 8000)
    {
        if (IS_CHAR_IN_ANY_CAR( sub_3372() ))
        {
            ...
            if (NOT (IS_CHAR_INJURED( l_U590 )))
            {
                ...
                {
                    if (((GET_TIME_SINCE_PLAYER_HIT_PED( sub_349() )) < 500) AND ((GET_TIME_SINCE_PLAYER_HIT_PED( sub_349() )) > 0))
                    {
                        STOP_PED_SPEAKING( l_U590, 0 );
        ...
        if (IS_CHAR_IN_ANY_CAR( sub_3372() ))
        {
            ...
            if (IS_VEH_DRIVEABLE( l_U583 ))
            {
                if (NOT (IS_CHAR_INJURED( l_U590 )))
                {
                    if (IS_CHAR_IN_CAR( l_U590, l_U583 ))
                    {
                        if (((((GET_TIME_SINCE_PLAYER_HIT_CAR( sub_349() )) < 500) AND ((GET_TIME_SINCE_PLAYER_HIT_CAR( sub_349() )) > 0)) || (((GET_TIME_SINCE_PLAYER_HIT_BUILDING( sub_349() )) < 500) AND ((GET_TIME_SINCE_PLAYER_HIT_BUILDING( sub_349() )) > 0))) || (((GET_TIME_SINCE_PLAYER_HIT_OBJECT( sub_349() )) < 500) AND ((GET_TIME_SINCE_PLAYER_HIT_OBJECT( sub_349() )) > 0)))
                        {
                            STOP_PED_SPEAKING( l_U590, 0 );
        ...
        if (IS_CHAR_IN_ANY_CAR( sub_3372() ))
        {
            ...
            if (IS_VEH_DRIVEABLE( l_U583 ))
            {
                if (NOT (IS_CHAR_INJURED( l_U590 )))
                {
                    if (IS_CHAR_IN_CAR( l_U590, l_U583 ))
                    {
                        if (((((GET_TIME_SINCE_PLAYER_DROVE_ON_PAVEMENT( sub_349() )) < 500) AND ((GET_TIME_SINCE_PLAYER_DROVE_ON_PAVEMENT( sub_349() )) > 0)) || (((GET_TIME_SINCE_PLAYER_DROVE_AGAINST_TRAFFIC( sub_349() )) < 500) AND ((GET_TIME_SINCE_PLAYER_DROVE_AGAINST_TRAFFIC( sub_349() )) > 0))) || (((GET_TIME_SINCE_PLAYER_RAN_LIGHT( sub_349() )) < 500) AND ((GET_TIME_SINCE_PLAYER_RAN_LIGHT( sub_349() )) > 0)))
                        {
                            STOP_PED_SPEAKING( l_U590, 0 );
                            SAY_AMBIENT_SPEECH( l_U590, "SHIT", 1, 1, 2 );
                            STOP_PED_SPEAKING( l_U590, 1 );
