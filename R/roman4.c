...
void sub_2407()
{
    ...
    {
        if (((sub_2445( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_7848()
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( l_U628 )) AND (l_U563[0] == 0))
    {
        SETTIMERA( 0 );
        l_U563[0] = 1;
    }
    if (((TIMERA() > 5000) AND (l_U563[1] == 0)) AND (l_U563[0] == 1))
    {
        PRINT_HELP_FOREVER( "ROM4GPS" );
        SETTIMERA( 0 );
        l_U563[1] = 1;
    }
    if (((l_U563[1] == 1) AND (TIMERA() > 7500)) AND (l_U563[2] == 0))
    {
        CLEAR_HELP();
        l_U563[2] = 1;
    }
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U628, 1235.63900000, -505.04780000, 150.00000000, 150.00000000, 0 )) AND (l_U1400 == 0))
    {
        sub_8432( -503930010 );
        sub_8432( 1731510984 );
        sub_8432( -1932515764 );
    ...
    if (l_U1400 == 1)
    {
        if ((((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1473[0], l_U628, 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1473[1], l_U628, 0 ))) || ((IS_CHAR_SHOOTING( l_U628 )) AND ((sub_18173( l_U628, l_U1473[0], 1 )) < 40.00000000))) || (((IS_CHAR_IN_ANY_HELI( l_U628 )) AND ((sub_18173( l_U628, l_U1473[0], 1 )) < 40.00000000)) AND (l_U1400 == 1)))
        {
    ...
    if (l_U1331 == 1)
    {
        if ((((sub_18173( l_U1477, l_U628, 1 )) > 90.00000000) AND (l_U1432 == 0)) AND (l_U1483 == 0))
        {
            REMOVE_BLIP( l_U1441 );
    ...
    if (((l_U1331 == 1) AND (l_U1400 == 1)) AND ((l_U1427 - l_U1333) > (sub_18873( 4200, 5200 ))))
    {
        uVar3 = sub_18873( 0, 3 );
        switch (uVar3)
        {
    ...
    sub_6083( 1 );
    if ((IS_CHAR_IN_ANGLED_AREA_3D( l_U628, 1216.88900000, -505.93550000, 13.02010000, 1226.95700000, -520.09200000, 18.85685000, 18.50000000, 0 )) AND (l_U1400 == 1))
    {
        SET_ROUTE( l_U1441, 0 );
    ...
    if ((l_U1401 == 1) AND (l_U1489 == 0))
    {
        if (DOES_CHAR_EXIST( l_U1477 ))
        {
            if (IS_CHAR_IN_ANY_CAR( l_U628 ))
            {
                ...
                {
                    if ((IS_CHAR_TOUCHING_VEHICLE( l_U1477, uVar2 )) AND (l_U1388 < 3))
                    {
                        iVar3 = 1;
                    }
                }
            ...
            if (NOT (IS_CHAR_DEAD( l_U1477 )))
            {
                if ((IS_CHAR_ON_FIRE( l_U1477 )) AND (IS_CHAR_IN_ANY_CAR( l_U1477 )))
                {
                    iVar4 = 1;
                }
            }
            if (((iVar3) || (IS_CHAR_INJURED( l_U1477 ))) || ((IS_CHAR_ON_FIRE( l_U1477 )) AND (iVar4 == 0)))
            {
                if (NOT (IS_CHAR_DEAD( l_U1477 )))
                {
        ...
        if (((NOT (IS_VEH_DRIVEABLE( l_U1455 ))) || (((sub_13536( l_U1455 )) AND (l_U1388 > 2)) AND (l_U1359 == 0))) || ((sub_13649( l_U1455 )) AND (l_U1388 > 2)))
        {
            sub_13850();
            CLEAR_HELP();
            CLEAR_PRINTS();
            ...
            while ((sub_15076( l_U1373 )) AND (NOT (IS_CAR_IN_WATER( l_U1455 ))))
            {
                WAIT( 0 );
            }
            if (NOT (sub_13649( l_U1455 )))
...
void sub_15716()
{
    ...
    sub_16234();
    SET_CAM_POS( l_U626, 833.73320000, -281.40850000, 15.79863000 );
    ...
    {
        WAIT( 0 );
        if ((TIMERA() > 2000) AND (l_U563[0] == 0))
        {
            UNPOINT_CAM( l_U621 );
            SET_CAM_POS( l_U621, 833.73320000, -281.40850000, 15.79863000 );
            ...
            UNPOINT_CAM( l_U623 );
            SET_CAM_POS( l_U623, 833.73320000, -281.40850000, 15.79863000 );
        ...
        if (((TIMERA() > 3000) AND (l_U563[1] == 0)) AND (l_U563[0] == 1))
        {
            sub_14103( "R4_DROPTR", ref l_U1373, 8, 1 );
            SETTIMERA( 0 );
            l_U563[1] = 1;
        }
        if (((TIMERA() > 6000) AND (l_U563[2] == 0)) AND (l_U563[1] == 1))
        {
            sub_16467( ref l_U626, 1 );
            sub_16467( ref l_U624, 0 );
            SET_CAM_POS( l_U621, 842.27580000, -290.29130000, 15.26637000 );
            SET_CAM_ROT( l_U621, 15.30651000, -0.00000000, 39.80610000 );
            SET_CAM_NEAR_DOF( l_U621, 2.00000000 );
            SET_CAM_FAR_DOF( l_U621, 8.00000000 );
            SET_CAM_FOV( l_U621, 47.00000000 );
            SET_CAM_POS( l_U623, 842.27580000, -290.29130000, 15.26637000 );
        ...
        if ((((TIMERA() > 7000) AND (l_U563[2] == 1)) AND (NOT (sub_15076( l_U1373 )))) || (((sub_17607()) AND (IS_SCREEN_FADED_IN())) AND (TIMERA() > 1000)))
        {
            l_U1338 = 0;
        }
    }
...
void sub_19193()
{
    ...
    if (l_U1392[l_U1388] == 0)
    {
        ...
        if ((IS_CHAR_IN_ANY_CAR( l_U628 )) || (IS_CHAR_ON_ANY_BIKE( l_U628 )))
        {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U1473[0] ))) AND (NOT (IS_CHAR_INJURED( l_U1473[1] ))))
        {
        ...
        while ((NOT (HAS_MODEL_LOADED( 1159759556 ))) || (NOT (HAS_MODEL_LOADED( 800869680 ))))
        {
            WAIT( 0 );
        }
...
void sub_19268()
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_4260() )) || (IS_CHAR_ON_ANY_BIKE( sub_4260() )))
    {
...
void sub_21055()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U1473[0] )))
    {
        if (((IS_CHAR_PLAYING_ANIM( l_U1473[0], "missRoman4", "scared_02" )) AND (l_U1405 == 0)) AND (l_U1406 == 0))
        {
            sub_20193( l_U1473[0], l_U628 );
        }
    }
    ...
    if ((((sub_18173( l_U1477, l_U628, 1 )) > 60.00000000) AND (l_U1331 == 1)) AND (l_U1483 == 0))
    {
        REMOVE_BLIP( l_U1441 );
        REMOVE_BLIP( l_U1442[2] );
        PRINT_NOW( "R4FAIL_05", 7500, 1 );
    ...
    if (((sub_18173( l_U1477, l_U628, 1 )) > 150.00000000) AND (l_U1483 == 0))
    {
        REMOVE_BLIP( l_U1441 );
        REMOVE_BLIP( l_U1442[2] );
        PRINT_NOW( "R4FAIL_05", 7500, 1 );
    ...
    if (NOT (IS_CHAR_INJURED( l_U1473[0] )))
    {
        ...
        if (l_U1405 == 0)
        {
            if (((iVar2 == 7) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1473[0], l_U628, 0 ))) || ((sub_18173( l_U628, l_U1473[0], 1 )) < 2.00000000))
            {
                CLEAR_CHAR_TASKS( l_U1473[0] );
    ...
    if (((l_U1406 == 0) AND (l_U563[1] == 0)) AND (IS_CHAR_ON_FOOT( l_U628 )))
    {
        CLEAR_HELP();
    ...
    if (((IS_CONTROL_PRESSED( 0, 6 )) || (IS_CONTROL_PRESSED( 0, 87 ))) || (((l_U1417[0] == 1) AND (l_U563[1] == 0)) AND (IS_CHAR_ON_FOOT( l_U628 ))))
    {
        l_U1417[0] = 1;
        if (((l_U1407[0] == 0) AND (l_U1406 == 1)) AND (TIMERA() > 7500))
        {
            CLEAR_HELP();
    ...
    if (((((IS_CHAR_ON_FOOT( l_U628 )) AND (l_U1407[0] == 1)) AND (l_U1353 == 0)) AND (l_U1406 == 1)) AND (TIMERA() > 7500))
    {
        CLEAR_HELP();
    ...
    if ((((((l_U1407[2] == 0) AND (l_U1407[0] == 1)) AND (TIMERA() > 7500)) AND (l_U563[1] == 0)) AND (IS_CHAR_IN_MELEE_COMBAT( l_U628 ))) AND (l_U1353))
    {
        if (IS_HUD_RETICULE_COMPLEX())
        {
            CLEAR_HELP();
    ...
    if ((((IS_CONTROL_PRESSED( 2, 59 )) || (IS_CONTROL_PRESSED( 2, 60 ))) || (IS_CONTROL_PRESSED( 2, 62 ))) || (((l_U1417[3] == 1) AND (l_U563[1] == 0)) AND (IS_CHAR_IN_MELEE_COMBAT( l_U628 ))))
    {
        l_U1417[3] = 1;
        if ((((l_U1407[4] == 0) AND (l_U1407[2] == 1)) AND (TIMERA() > 7500)) AND (IS_CHAR_IN_MELEE_COMBAT( l_U628 )))
        {
            CLEAR_HELP();
    ...
    if (((TIMERA() > 7500) AND (l_U1407[4] == 1)) || (NOT (IS_CHAR_ON_FOOT( l_U628 ))))
    {
        CLEAR_HELP();
    }
    if ((IS_CHAR_DEAD( l_U1473[1] )) || (IS_CHAR_INJURED( l_U1473[1] )))
    {
        if (NOT (IS_CHAR_DEAD( l_U1473[1] )))
        {
    ...
    if (l_U563[0] == 0)
    {
        if (((((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U1473[1], l_U628, 0 )) || ((sub_18173( l_U628, l_U1473[1], 1 )) < 2.00000000)) || (((sub_18173( l_U628, l_U1473[1], 1 )) < 6.00000000) AND (IS_CHAR_IN_ANY_CAR( l_U628 )))) || (IS_CHAR_DEAD( l_U1473[0] ))) || (IS_CHAR_INJURED( l_U1473[0] )))
        {
            if (NOT (IS_CHAR_INJURED( l_U1477 )))
            {
    ...
    GET_GAME_TIMER( ref l_U1427 );
    if (((((l_U563[0] == 0) AND (l_U563[1] == 0)) AND ((l_U1427 - l_U1428) > 10000)) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (TIMERB() > 7500))
    {
    ...
    if (((((l_U563[0] == 0) AND (l_U563[1] == 0)) AND ((l_U1427 - l_U1428) > 5000)) AND (TIMERB() > 7500)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
        SAY_AMBIENT_SPEECH( l_U1477, "WHIMPER", 1, 1, 0 );
    ...
    if (((l_U563[0] == 0) AND (sub_21349( l_U1473[0], ref l_U1330 ))) AND ((l_U1427 - l_U1428) < 500))
    {
        sub_13121( ref l_U1373, 0 );
    }
    GET_GAME_TIMER( ref l_U1427 );
    if (((((l_U563[0] == 1) AND (l_U563[1] == 0)) AND ((l_U1427 - l_U1428) > 7000)) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (TIMERB() > 7500))
    {
        if ((sub_18873( 0, 10 )) > 5)
        {
    ...
    if (((((l_U563[0] == 1) AND (l_U1407[7] == 0)) AND (TIMERA() > 5000)) AND (l_U563[1] == 0)) AND (IS_CHAR_IN_MELEE_COMBAT( l_U628 )))
    {
        CLEAR_HELP();
    ...
    if (((l_U1402[0]) AND (l_U1402[1])) AND (l_U563[1] == 0))
    {
        ...
        while (((NOT (HAVE_ANIMS_LOADED( "missroman4" ))) || (NOT (HAVE_ANIMS_LOADED( "move_m@roman_inj" )))) || (NOT (HAS_MODEL_LOADED( 1468450703 ))))
        {
            WAIT( 0 );
        }
        WAIT( 2000 );
    ...
    sub_12417();
    if (((((sub_18173( l_U628, l_U1477, 1 )) < 5.00000000) AND (l_U563[1] == 1)) AND (NOT (IS_CHAR_IN_ANY_CAR( l_U628 )))) AND (HAS_MODEL_LOADED( 1468450703 )))
    {
        CLEAR_WANTED_LEVEL( l_U629 );
        CLEAR_PRINTS();
        DO_SCREEN_FADE_OUT( 500 );
        ...
        SET_CAM_ROT( l_U621, -8.75230100, 0.00000000, -44.47956000 );
        ...
        SETTIMERA( 0 );
        while ((fVar7 < 0.95000000) AND (NOT l_U1350))
        {
            SET_PED_ENABLE_LEG_IK( l_U628, 0 );
            SET_USE_LEG_IK( l_U629, 0 );
            l_U1350 = ((sub_17607()) AND (TIMERA() > 1000)) AND (IS_SCREEN_FADED_IN());
            ...
            if ((NOT (sub_15076( l_U1373 ))) AND (l_U1386 == 0))
            {
...
void sub_26023()
{
    ...
    if (l_U1392[l_U1388] == 0)
    {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U1477 ))) AND (NOT (IS_CHAR_INJURED( l_U628 ))))
        {
            CLEAR_AREA( 1233.18600000, -506.07640000, 14.04480000, 7.00000000, 1 );
            CLEAR_CHAR_TASKS_IMMEDIATELY( l_U1477 );
        ...
        SET_CAM_ROT( l_U623, -9.52463200, -0.00000000, -140.32700000 );
    ...
    if (l_U563[8] == 0)
    {
        if ((l_U563[0] == 0) AND (TIMERA() > 500))
        {
            if (((NOT (IS_CHAR_DEAD( l_U1477 ))) AND (NOT (IS_CHAR_DEAD( l_U1473[2] )))) AND (l_U1350 == 0))
            {
                sub_20193( l_U628, l_U1477 );
        ...
        if (((l_U563[0] == 1) AND (l_U563[17] == 0)) AND (TIMERA() > 1000))
        {
            if ((NOT (IS_CHAR_DEAD( l_U1477 ))) AND (NOT (IS_CHAR_DEAD( l_U1473[2] ))))
            {
        ...
        if (((l_U563[0] == 1) AND (l_U563[18] == 0)) AND ((sub_27612( l_U1373 )) == 2))
        {
            if ((NOT (IS_CHAR_DEAD( l_U1477 ))) AND (NOT (IS_CHAR_DEAD( l_U1473[2] ))))
            {
        ...
        if (((((NOT (sub_15076( l_U1373 ))) AND (l_U563[0] == 1)) AND (l_U563[3] == 0)) AND (l_U1350 == 0)) AND (TIMERA() > 2000))
        {
            ...
            SET_CAM_NEAR_DOF( l_U621, 3.00000000 );
            SET_CAM_FAR_DOF( l_U621, 25.00000000 );
            SET_CAM_POS( l_U623, 1234.32500000, -510.30470000, 14.67841000 );
        ...
        if (((l_U563[3] == 1) AND (TIMERA() > 400)) AND (l_U563[4] == 0))
        {
            if (NOT (IS_CHAR_DEAD( l_U1473[2] )))
            {
        ...
        if (((NOT (sub_15076( l_U1373 ))) AND (l_U563[3] == 1)) AND (l_U563[1] == 0))
        {
            SETTIMERA( 0 );
        ...
        if (l_U563[5] == 0)
        {
            if ((((l_U563[4] == 1) AND (l_U563[6] == 1)) || (((sub_17607()) AND (TIMERA() > 1000)) AND (IS_SCREEN_FADED_IN()))) || (l_U1350))
            {
                if (l_U563[6] == 0)
                {
                    l_U1350 = 1;
                ...
                if ((NOT (IS_CHAR_INJURED( l_U1477 ))) AND (NOT (IS_CAR_DEAD( l_U1455 ))))
                {
                    CLEAR_CHAR_TASKS_IMMEDIATELY( l_U1477 );
                    UNLOCK_RAGDOLL( l_U1477, 1 );
...
void sub_29750()
{
    ...
    l_U1063[3] = -825837129;
    l_U1108[4] = {1107.90100000, -565.60600000, 13.12680000};
    l_U699[4] = -0.01840000;
    l_U740[4] = 0.01530000;
    l_U781[4] = 0.70440000;
    l_U822[4] = 0.70940000;
    ...
    l_U1108[15] = {859.89230000, -469.88350000, 13.93490000};
    ...
    l_U1108[22] = {858.14170000, -135.29910000, 5.58860000};
    ...
    l_U1108[35] = {863.23110000, 277.87210000, 5.55500000};
...
void sub_35533()
{
    ...
    if ((l_U563[19] == 1) AND (l_U563[12] == 0))
    {
        if (NOT (IS_CHAR_DEAD( l_U1477 )))
        {
    ...
    if (NOT (IS_CAR_DEAD( l_U1457 )))
    {
        ...
        {
            if (LOCATE_CAR_3D( l_U1457, 1198.72400000, -514.96660000, 14.13180000, 2.50000000, 2.50000000, 2.00000000, 0 ))
            {
    ...
    if (l_U1432 == 1)
    {
        if (((NOT (IS_CHAR_DEAD( l_U1473[2] ))) AND (NOT (IS_CAR_DEAD( l_U1457 )))) AND (l_U563[12] == 0))
        {
            if ((((NOT IS_HELP_MESSAGE_BEING_DISPLAYED()) AND (IS_CAR_ON_SCREEN( l_U1457 ))) AND (l_U1349 == 0)) AND (sub_36979()))
            {
            ...
            else
            {
                ...
                {
                    if (((l_U1363 - l_U1364) > 10000) || (NOT sub_36979()))
                    {
                        l_U1349 = 1;
                        if ((l_U563[14] == 0) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "HELP5" ))))
                        {
                            CLEAR_HELP();
                        }
                    }
        ...
        if (l_U1344 == 0)
        {
            if (NOT (IS_CAR_DEAD( l_U1455 )))
            {
                if (IS_CHAR_IN_CAR( l_U628, l_U1455 ))
                {
                    if (((TIMERB() > 4000) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (l_U1345 == 1))
                    {
        ...
        else if ((NOT (IS_CAR_DEAD( l_U1455 ))) AND (NOT (IS_CHAR_DEAD( l_U1477 ))))
        {
            if ((IS_CHAR_SITTING_IN_CAR( l_U628, l_U1455 )) AND (IS_CHAR_SITTING_IN_CAR( l_U1477, l_U1455 )))
            {
                GET_GAME_TIMER( ref l_U1427 );
                if ((((l_U1427 - l_U1332) > 4000) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (l_U1355 == 0))
                {
                    switch (g_U64960)
                    {
                        case 1:
            ...
            else if ((l_U1355 == 0) AND (l_U563[9] == 0))
            {
    ...
    if ((((sub_18173( l_U1477, l_U628, 1 )) > 60.00000000) AND (l_U1432 == 0)) AND (l_U1483 == 0))
    {
        REMOVE_BLIP( l_U1441 );
        REMOVE_BLIP( l_U1442[2] );
        PRINT_NOW( "R4FAIL_05", 7500, 1 );
    ...
    if ((LOCATE_CHAR_IN_CAR_2D( l_U628, 805.14740000, -457.82390000, 19.00000000, 16.00000000, 1 )) AND (l_U1370 == 0))
    {
        PRINT_HELP( "HELP5" );
    ...
    if ((l_U563[5] == 1) AND (l_U563[9] == 0))
    {
        if ((NOT (IS_CAR_DEAD( l_U1455 ))) AND (NOT (IS_CHAR_DEAD( l_U1477 ))))
        {
            if (IS_CHAR_SITTING_IN_CAR( l_U628, l_U1455 ))
            {
                ...
                {
                    if (((sub_18173( l_U1477, l_U628, 1 )) > 10.00000000) AND (l_U1433 != l_U1432))
                    {
                ...
                else if ((l_U1433 != l_U1432) || (l_U1438 == 1))
                {
                    CHANGE_BLIP_DISPLAY( l_U1441, 0 );
            ...
            else if ((l_U1429 == 0) AND (l_U1433 != l_U1432))
            {
                CHANGE_BLIP_DISPLAY( l_U1446, 4 );
                CHANGE_BLIP_DISPLAY( l_U1442[2], 1 );
                CHANGE_BLIP_DISPLAY( l_U1441, 0 );
    ...
    if (((((l_U1432 == 1) AND (l_U563[5] == 1)) AND (l_U563[9] == 0)) AND (NOT (sub_15076( l_U1373 )))) AND (l_U1345 == 1))
    {
        if ((NOT (IS_CAR_DEAD( l_U1455 ))) AND (NOT (IS_CHAR_DEAD( l_U1477 ))))
        {
            if (((IS_CHAR_IN_CAR( l_U628, l_U1455 )) AND (IS_CHAR_IN_CAR( l_U1477, l_U1455 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
            {
                GET_GAME_TIMER( ref l_U1427 );
                if (((sub_18173( l_U628, l_U1473[2], 1 )) > 100) AND ((l_U1427 - l_U1332) > 4000))
                {
    ...
    if ((((l_U563[12] == 1) AND (l_U563[8] == 1)) AND (l_U563[9] == 0)) AND (NOT (IS_CAR_DEAD( l_U1457 ))))
    {
    ...
    if ((l_U563[9] == 1) AND (l_U1352 == 0))
    {
        if (NOT (IS_CAR_DEAD( l_U1457 )))
        {
            if ((IS_CAR_ON_SCREEN( l_U1457 )) AND ((sub_18173( l_U628, l_U1473[2], 1 )) < 38.00000000))
            {
    ...
    if ((((((l_U563[9] == 1) AND ((sub_40613( l_U628, 789.20130000, 423.40260000, 11.49480000 )) < 15.00000000)) AND (l_U1438 == 0)) AND (NOT (IS_CAR_DEAD( l_U1455 )))) AND (NOT (IS_CHAR_DEAD( l_U1477 )))) || (((l_U1352 == 1) AND (NOT (sub_15076( l_U1373 )))) AND (l_U1438 == 0)))
    {
    ...
    if (((((l_U1438 == 1) AND ((sub_40898( l_U1473[2] )) > (sub_40898( l_U628 )))) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_15076( l_U1373 )))) AND (l_U1367 == 0))
    {
        PRINT_HELP( "ROM4ARR" );
        l_U1367 = 1;
    }
    GET_GAME_TIMER( ref l_U1365 );
    if ((((l_U563[9] == 1) AND ((sub_18173( l_U628, l_U1473[2], 1 )) < 15.00000000)) AND ((l_U1365 - l_U1366) > 10000)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
    ...
    if ((l_U563[7] == 0) AND (l_U563[9] == 1))
    {
        if (NOT (IS_CHAR_DEAD( l_U1477 )))
        {
            if ((IS_CHAR_IN_ANY_CAR( l_U1477 )) AND (IS_CHAR_IN_ANY_CAR( l_U628 )))
            {
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( l_U1477, 1 );
                l_U563[7] = 1;
            }
    ...
    if (((((sub_18173( l_U628, l_U1473[2], 1 )) < 6.00000000) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 777.98220000, 470.00510000, 23.36090000, 1.00000000, 8.00000000, 1.50000000, 0 ))) AND (l_U563[16] == 0)) AND (l_U563[11] == 1))
    {
        if (NOT (IS_CHAR_DEAD( l_U1473[2] )))
        {
            SET_CHAR_HEALTH( l_U1473[2], 280 );
    ...
    if (((l_U563[8] == 1) AND (l_U563[5] == 1)) AND (l_U563[16] == 0))
    {
        if ((NOT (IS_CHAR_DEAD( l_U1473[2] ))) AND (NOT (IS_CAR_DEAD( l_U1457 ))))
        {
            if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1457 ))
            {
                if ((FIND_TIME_POSITION_IN_RECORDING( l_U1457 )) < 90621.52000000)
                {
                    ...
                    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 759.85230000, -362.56770000, 7.31750000, 30.00000000, 36.00000000, 2.00000000, 0 )) AND (g_U9170 == 0))
                    {
                        if (NOT (IS_CAR_ON_SCREEN( l_U1457 )))
                        {
                            g_U9170 = 0;
                ...
                if (NOT (IS_CHAR_DEAD( l_U1477 )))
                {
                    if ((IS_CHAR_ON_FOOT( l_U628 )) || (IS_CHAR_ON_FOOT( l_U1477 )))
                    {
    ...
    if (((sub_18173( l_U628, l_U1473[2], 1 )) < l_U630) || ((sub_40613( l_U1473[2], 779.00000000, 468.00000000, 23.35000000 )) > (sub_40613( l_U628, 779.00000000, 468.00000000, 23.35000000 ))))
    {
    ...
    if ((((TIMERA() > 2000) AND (l_U563[14] == 0)) AND (l_U563[11] == 1)) AND (l_U563[15] == 0))
    {
        PRINT_HELP_FOREVER( "R4KNIFE" );
        SETTIMERA( 0 );
        l_U563[14] = 1;
    }
    if (((TIMERA() > 15000) AND (l_U563[15] == 0)) AND (l_U563[14] == 1))
    {
        CLEAR_HELP();
        l_U563[15] = 1;
    }
    if ((l_U563[9] == 1) AND (l_U563[11] == 1))
    {
        if (NOT (IS_CHAR_DEAD( l_U1473[2] )))
        {
            GET_CHAR_HEALTH( l_U1473[2], ref l_U1437 );
        }
        if (((l_U1437 < 175) AND (NOT (IS_CHAR_IN_WATER( l_U1473[2] )))) AND (l_U1358 == 1))
        {
            if (l_U1341 == 0)
            {
            ...
            {
                if (((LOCATE_CHAR_ANY_MEANS_3D( l_U1473[2], 779.75250000, 472.47600000, 23.35980000, 2.00000000, 2.00000000, 1.00000000, 0 )) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 779.75250000, 472.47600000, 23.35980000, 9.00000000, 9.00000000, 1.00000000, 0 ))) AND (uVar5._fU8 > 23.35000000))
                {
                    CLEAR_HELP();
                    CHANGE_BLIP_DISPLAY( l_U1446, 0 );
                    REMOVE_BLIP( l_U1442[2] );
    ...
    if ((IS_CHAR_INJURED( l_U1473[2] )) || (l_U1351 == 1))
    {
        sub_13121( ref l_U1373, 1 );
...
void sub_36214(unknown uParam0)
{
    ...
    if ((l_U1326) AND (IS_HINT_RUNNING()))
    {
        iVar4 = 0;
        GET_GAME_TIMER( ref iVar4 );
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_4260() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_36382())) AND (iVar3 != 4))
    {
    ...
    {
        if ((NOT l_U1325) AND (NOT l_U1326))
        {
            if (l_U1328)
            {
                PRINTNL();
...
int sub_36979()
{
    ...
    if (((iVar2 != 4) AND (iVar2 != 5)) AND (IS_CHAR_SITTING_IN_ANY_CAR( sub_4260() )))
    {
        return 1;
    }
    return 0;
...
void sub_46823(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U650)
    {
        ...
        if ((l_U938 == 0) || (IS_SCREEN_FADED_OUT()))
        {
            iVar10 = 1;
        }
        if ((iVar10) AND (NOT l_U672))
        {
            if (NOT l_U638)
            {
...
void sub_48705(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 40; I++ )
        {
            ...
            if (l_U999[I] == 0)
            {
                if (((l_U958[I] > 0) AND (l_U958[I] < 3000)) AND (NOT (l_U1063[I] == 0)))
                {
                    if (NOT l_U638)
                    {
            ...
            if (l_U999[I] == 2)
            {
                if (HAS_MODEL_LOADED( l_U1063[I] ))
                {
                    if (NOT (DOES_VEHICLE_EXIST( l_U1255[I] )))
                    {
                        ...
                        {
                            bVar17 = false;
                            if ((NOT (sub_48232( l_U1108[I], 5.00000000, 1120403456 ))) AND (NOT (sub_50021( l_U1108[I] ))))
                            {
                                bVar17 = true;
                            }
                            if (l_U664)
                        ...
                        if (8 > l_U1046)
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U958[I] ))
                            {
                                if (fVar14 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U958[I] )))
                                {
                                    ...
                                    if ((NOT (sub_48232( uVar8, 5.00000000, 1120403456 ))) AND (sub_48232( uVar11, 5.00000000, 1120403456 )))
                                    {
                                        sub_49105( I, 1090519040 );
                                    }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1255[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_3832() ))
                                {
                                    if ((((IS_CHAR_TOUCHING_VEHICLE( sub_4260(), l_U1255[I] )) AND (NOT l_U644)) AND (NOT l_U641)) AND (NOT l_U653))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_4260() ))
                                        {
                                            bVar16 = false;
                                    ...
                                    else if ((sub_52878( uParam0, l_U1255[I] )) AND (NOT l_U653))
                                    {
                                        sub_52751( l_U1255[I] );
                                        l_U999[I]++;
                                    }
        ...
        if (IS_PLAYER_PLAYING( sub_3832() ))
        {
            ...
            for ( I = 0; I < 40; I++ )
            {
                ...
                if (DOES_VEHICLE_EXIST( l_U1255[I] ))
                {
                    if (IS_VEH_DRIVEABLE( l_U1255[I] ))
                    {
                        if ((sub_54333( l_U1255[I], (uParam0^) )) || (sub_54333( l_U1255[I], uVar6 )))
                        {
            ...
            if (l_U1044[I] == 1)
            {
                if (6 > l_U1049)
                {
                    if (HAS_MODEL_LOADED( l_U1104[I] ))
                    {
                        ...
                        {
                            if (((NOT (sub_48232( l_U1229[I], 5.00000000, 1120403456 ))) || (l_U638)) || (l_U664))
                            {
                                if (l_U657)
                                {
...
void sub_56187(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 1; I++ )
        {
            if (((l_U1040[I] > 0) AND (l_U1040[I] < 3000)) AND (NOT (l_U1106[I] == 0)))
            {
                if (l_U1042[I] == 0)
                {
                    if (NOT l_U638)
                ...
                if (l_U1042[I] == 2)
                {
                    if (HAS_MODEL_LOADED( l_U1106[I] ))
                    {
                        if (NOT (DOES_VEHICLE_EXIST( l_U1307[I] )))
                        {
                            ...
                            if (bVar15)
                            {
                                if ((NOT (sub_48232( l_U1233[I], 5.00000000, 1120403456 ))) || (l_U664))
                                {
                            ...
                            if (4 > l_U1048)
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1040[I] ))
                                {
                                    if (fVar13 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1040[I] )))
                                    {
                                        ...
                                        if (((NOT (sub_48232( uVar7, 5.00000000, 1120403456 ))) AND (sub_48232( uVar10, 5.00000000, 1120403456 ))) AND (NOT l_U664))
                                        {
                                            l_U1048++;
                                            l_U1042[I]++;
                                        }
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U1307[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_3832() ))
                                    {
                                        if (((IS_CHAR_TOUCHING_VEHICLE( sub_4260(), l_U1307[I] )) AND (NOT l_U644)) AND (NOT l_U641))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_4260() ))
                                            {
                                                bVar15 = false;
...
int sub_59911(unknown uParam0, unknown uParam1)
{
    ...
    if (((l_U1060 == 0) AND (l_U1061 == 0)) AND (l_U1062 == 0))
    {
        l_U641 = 0;
        l_U638 = 0;
        l_U667 = 0;
...
void sub_60514()
{
    ...
    if (NOT (IS_CAR_DEAD( l_U1455 )))
    {
        ...
        SET_VEHICLE_QUATERNION( l_U1455, -0.01510000, 0.00280000, 0.72000000, -0.69380000 );
    ...
    SET_CAM_ROT( l_U626, 2.73772700, 0.00000000, 120.21170000 );
    ...
    while (l_U1338)
    {
        ...
        if (((NOT (sub_15076( l_U1373 ))) AND (l_U563[1] == 0)) AND (l_U563[0] == 1))
        {
            OPEN_SEQUENCE_TASK( ref l_U1458 );
        ...
        if (((TIMERA() > 6000) AND (l_U563[2] == 1)) AND (NOT (sub_15076( l_U1373 ))))
        {
            sub_13121( ref l_U1373, 0 );
            l_U1338 = 0;
        }
...
void sub_63868()
{
    ...
    if (((l_U563[0] == 1) AND (l_U563[8] == 0)) AND (TIMERA() > 360))
    {
    ...
    if (((TIMERA() > 700) AND (l_U563[1] == 0)) AND (l_U563[0] == 1))
    {
        if (NOT (IS_CHAR_DEAD( l_U1473[2] )))
        {
    ...
    if (((TIMERA() > 1000) AND (l_U563[2] == 0)) AND (l_U563[1] == 1))
    {
        SET_TIME_SCALE( 1.00000000 );
        SET_CAM_POS( l_U626, 789.55210000, 478.20850000, 12.50268000 );
    ...
    if (((TIMERA() > 1000) AND (l_U563[3] == 0)) AND (l_U563[2] == 1))
    {
        if (NOT (IS_CHAR_DEAD( l_U1473[2] )))
        {
    ...
    if (((TIMERA() > 1000) AND (l_U563[4] == 0)) AND (l_U563[3] == 1))
    {
        SETTIMERA( 0 );
        l_U563[4] = 1;
    }
    ...
    if ((((l_U563[4] == 1) AND (TIMERA() > 2000)) AND (uVar6._fU8 > 13.00000000)) AND (l_U563[7] == 0))
    {
    ...
    if ((l_U563[4] == 1) AND ((l_U563[5] == 0) || (l_U563[6] == 0)))
    {
        APPLY_FORCE_TO_PED( l_U1473[2], 0, 0.00000000, 0.50000000, 0.00000000, 0.00000000, 0.00000000, 0.00000000, 7, 0, 1, 1 );
    }
    if ((((uVar6._fU8 < 13.00000000) || (TIMERA() > 5500)) AND (l_U563[4] == 1)) AND (l_U563[5] == 0))
    {
        UNPOINT_CAM( l_U626 );
        ...
        SET_CAM_ROT( l_U621, 15.17653000, -0.00000000, -143.93710000 );
    ...
    if (((TIMERA() > 3000) AND (l_U563[5] == 1)) AND (l_U563[6] == 0))
    {
        SET_CAM_POS( l_U621, 757.77930000, 510.22270000, 1.23270600 );
        SET_CAM_ROT( l_U621, 15.17653000, -0.00000000, -143.93710000 );
        SET_CAM_FOV( l_U621, 50.69999000 );
        ...
        SET_CAM_ROT( l_U623, 15.17653000, -0.00000000, -143.93710000 );
    ...
    if (((sub_40898( l_U1473[2] )) < 0.50000000) AND (l_U1356 == 0))
    {
        sub_13121( ref l_U1373, 0 );
        if (NOT (IS_CHAR_DEAD( l_U1473[2] )))
        {
    ...
    if (((TIMERA() > 3000) AND (l_U563[6] == 1)) || (((TIMERA() > 1000) AND (sub_17607())) AND (IS_SCREEN_FADED_IN())))
    {
        if (DOES_CHAR_EXIST( l_U1473[2] ))
        {
            DELETE_CHAR( ref l_U1473[2] );
...
void sub_67026()
{
    ...
    if (((NOT (IS_CHAR_DEAD( l_U1477 ))) AND (NOT (IS_CAR_DEAD( l_U1455 )))) AND (NOT l_U563[3]))
    {
        if ((NOT (IS_CHAR_IN_CAR( l_U1477, l_U1455 ))) AND (NOT (sub_67131( l_U1477, 29 ))))
        {
    ...
    if ((NOT (IS_CHAR_DEAD( l_U1477 ))) AND (NOT (IS_CAR_DEAD( l_U1455 ))))
    {
        ...
        else if ((NOT (DOES_BLIP_EXIST( l_U1446 ))) AND (NOT l_U563[2]))
        {
            ADD_BLIP_FOR_CAR( l_U1455, ref l_U1446 );
            CHANGE_BLIP_DISPLAY( l_U1446, 4 );
            SET_BLIP_AS_FRIENDLY( l_U1446, 1 );
    ...
    if (((IS_CHAR_GETTING_IN_TO_A_CAR( l_U628 )) AND (l_U1455 == iVar2)) AND (l_U563[4] == 0))
    {
    ...
    if (((l_U1392[l_U1388] == 1) AND (l_U563[1] == 0)) AND (NOT (sub_15076( l_U1373 ))))
    {
    ...
    if (NOT (IS_CAR_DEAD( l_U1455 )))
    {
        if ((((((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_15076( l_U1373 )))) AND ((l_U1427 - l_U1340) > 7500)) AND (IS_CHAR_IN_CAR( l_U628, l_U1455 ))) AND (l_U563[0] == 0)) AND (l_U563[1] == 1))
        {
            switch (g_U64961)
            {
                case 0:
    ...
    if (l_U563[0] == 1)
    {
        if ((NOT (IS_CAR_DEAD( l_U1455 ))) AND (NOT (IS_CHAR_DEAD( l_U1477 ))))
        {
            if (((IS_CHAR_SITTING_IN_CAR( l_U628, l_U1455 )) AND (IS_CHAR_SITTING_IN_CAR( l_U1477, l_U1455 ))) AND (TIMERB() > 3000))
            {
                switch (g_U64961)
                {
                    case 0:
    ...
    sub_12417();
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U628, 810.47810000, -261.82920000, 50.00000000, 50.00000000, 0 )) AND (l_U563[5] == 0))
    {
        if ((g_U15654[0]) AND (NOT g_U15654[4]))
        {
    ...
    if ((NOT (IS_CHAR_DEAD( l_U1477 ))) AND (NOT (IS_CAR_DEAD( l_U1455 ))))
    {
        if ((IS_CHAR_IN_CAR( l_U1477, l_U1455 )) AND (IS_CHAR_IN_CAR( l_U628, l_U1455 )))
        {
            if ((((LOCATE_CHAR_IN_CAR_3D( l_U628, 829.01370000, -267.98060000, 16.78300000, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (LOCATE_CHAR_IN_CAR_3D( l_U628, 829.01370000, -267.98060000, 15.01080000, 2.00000000, 2.00000000, 2.00000000, 0 ))) AND (sub_15349( 1, 1 ))) AND (l_U1392[l_U1388] == 1))
            {
                ...
                while (sub_15076( l_U1373 ))
                {
                    if ((sub_17607()) AND (IS_SCREEN_FADED_IN()))
                    {
                        l_U1348 = 1;
                        DO_SCREEN_FADE_OUT( 500 );
                        while (IS_SCREEN_FADING_OUT())
                ...
                if (NOT (IS_CHAR_DEAD( l_U1477 )))
                {
                    ...
                    TASK_LEAVE_ANY_CAR( 0 );
                    TASK_TURN_CHAR_TO_FACE_CHAR( 0, l_U628 );
                    TASK_FOLLOW_NAV_MESH_TO_COORD_NO_STOP( 0, 817.59610000, -268.36100000, 15.34270000, 3, 8000, 0.50000000 );
                    CLOSE_SEQUENCE_TASK( l_U1458 );
                    TASK_PERFORM_SEQUENCE( l_U1477, l_U1458 );
                }
                bVar10 = true;
                ...
                SETTIMERA( 0 );
                while ((TIMERA() < 4500) AND (l_U1348 == 0))
                {
                    if (sub_17607())
                    {
                        l_U1348 = 1;
...
int sub_69533()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_2445( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_2731( I );
            return 1;
        }
