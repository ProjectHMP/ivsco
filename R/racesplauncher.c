void main()
{
    ...
    l_U477 = {816.48000000, 321.37000000, 7.38000000};
    l_U480 = 0;
    while (true)
    {
        WAIT( 0 );
        if (((NOT (IS_CHAR_DEAD( sub_220() ))) AND (sub_269())) AND (g_U15811[29] == 1))
        {
            if (((LOCATE_CHAR_ANY_MEANS_3D( sub_220(), l_U477._fU0, l_U477._fU4, l_U477._fU8, 100.00000000, 100.00000000, 100.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_220(), l_U471._fU0, l_U471._fU4, l_U471._fU8, 100.00000000, 100.00000000, 100.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( sub_220(), l_U474._fU0, l_U474._fU4, l_U474._fU8, 100.00000000, 100.00000000, 100.00000000, 0 )))
            {
                if ((NOT g_U12379) AND (NOT (IS_BIT_SET( g_U10938._fU0, 4 ))))
                {
                    if (((LOCATE_CHAR_ON_FOOT_3D( sub_220(), l_U477._fU0, l_U477._fU4, l_U477._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )) || (LOCATE_CHAR_ON_FOOT_3D( sub_220(), l_U471._fU0, l_U471._fU4, l_U471._fU8, 2.50000000, 2.50000000, 2.50000000, 1 ))) || (LOCATE_CHAR_ON_FOOT_3D( sub_220(), l_U474._fU0, l_U474._fU4, l_U474._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )))
                    {
                        sub_2389();
                        g_U12379 = 1;
