void main()
{
    ...
    l_U680 = 187.35630000;
    l_U681 = {786.04690000, 125.42390000, 6.02500000};
        ...
        if (IS_PLAYER_PLAYING( sub_6868() ))
        {
            switch (l_U656)
            {
                ...
                if (NOT (IS_CHAR_DEAD( l_U918 )))
                {
                    ...
                    if ((IS_CHAR_INJURED( l_U918 )) || (l_U698 == 0))
                    {
                        if (sub_25512( l_U827 ))
                        {
                            sub_25684( ref l_U827, 0 );
...
void sub_2180()
{
    ...
    {
        if (((sub_2218( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
int sub_18318(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3227() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3227() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_18845()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
        ...
        if (NOT (IS_CHAR_DEAD( l_U917 )))
        {
            if (IS_GROUP_MEMBER( l_U917, sub_27199() ))
            {
                if (LOCATE_CHAR_ANY_MEANS_3D( sub_3227(), l_U670._fU0, l_U670._fU4, l_U670._fU8 + 2.50000000, 2.50000000, 2.50000000, 2.50000000, 1 ))
                {
                    ...
                    {
                        if ((sub_32643( 1, 1 )) AND (sub_32933( l_U917 )))
                        {
...
void sub_28892(unknown uParam0, unknown uParam1)
{
    ...
    if ((sub_29079( l_U917 )) AND (sub_28977( l_U917 )))
    {
        iVar8 = 1;
        if (l_U942 != 6)
        {
    ...
    if ((((l_U941 == 11) || (l_U941 == 9)) || (l_U941 == 10)) || (l_U778 == 1))
    {
        l_U779 = 1;
    }
    else
...
void sub_30861()
{
    ...
    if (NOT (IS_CHAR_INJURED( l_U917 )))
    {
        if ((((IS_CHAR_IN_MELEE_COMBAT( l_U917 )) || (IS_CHAR_IN_MELEE_COMBAT( sub_3227() ))) || (iVar2 > 1)) || (sub_30963( uVar3 )))
        {
            if (sub_25512( l_U862 ))
            {
...
void sub_33527()
{
    ...
    switch (l_U662)
    {
        ...
        {
            SET_PLAYER_CONTROL( sub_6868(), 0 );
            if (((HAS_MODEL_LOADED( l_U911 )) AND (HAS_MODEL_LOADED( l_U912 ))) AND (HAS_MODEL_LOADED( l_U913 )))
            {
                if (HAS_CAR_RECORDING_BEEN_LOADED( 75 ))
                {
                    ...
                    if (IS_CHAR_IN_ANY_CAR( sub_3227() ))
                    {
                        ...
                        if (NOT (IS_CAR_ON_FIRE( l_U926 )))
                        {
                            ...
                            {
                                SET_CAM_POS( l_U936, 2288.96100000, 177.07710000, 6.88489000 );
                                if (IS_VEH_DRIVEABLE( l_U926 ))
                                {
                    ...
                    else
                    {
                        ...
                        SET_EVERYONE_IGNORE_PLAYER( sub_6868(), 1 );
                        SET_PLAYER_CONTROL( sub_6868(), 0 );
                        sub_34425( 2288.96100000, 177.07710000, 6.88489000, -7.88449100, -0.00000000, 105.48800000, 20, 1, 20, ref l_U936 );
                        sub_25809( 1 );
                        GET_GAME_TIMER( ref l_U755 );
                        CLEAR_PRINTS();
                        if (NOT (IS_CHAR_INJURED( l_U917 )))
        ...
        if (IS_VEH_DRIVEABLE( l_U927 ))
        {
            if ((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U927 ))) || (l_U757 > 5000))
            {
                GET_GAME_TIMER( ref l_U755 );
                l_U662 = 9;
            }
...
int sub_38121(unknown uParam0)
{
    ...
    if (DOES_CHAR_EXIST( uParam0 ))
    {
        if (NOT (IS_CHAR_INJURED( sub_3227() )))
        {
            if (NOT (IS_CHAR_INJURED( uParam0 )))
            {
                if ((GET_CHAR_MELEE_ACTION_FLAG0( uParam0 )) || (((NOT IS_USING_CONTROLLER()) AND (IS_PLAYER_FREE_AIMING_AT_CHAR( sub_6868(), uParam0 ))) AND (IS_CONTROL_JUST_PRESSED( 0, 4 ))))
                {
                    if ((NOT (IS_CHAR_INJURED( sub_3227() ))) AND (NOT (IS_CHAR_INJURED( uParam0 ))))
                    {
            ...
            if (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3227(), l_U917, 12.00000000, 12.00000000, 12.00000000, 0 ))
            {
                ...
                switch (l_U664)
                {
                    ...
                    else
                    {
                        ...
                        CLEAR_PRINTS();
                        sub_48616();
                        if ((l_U757 > 17500) || ((IS_CHAR_IN_ANY_CAR( sub_3227() )) AND (IS_CHAR_IN_ANY_CAR( l_U917 ))))
                        {
