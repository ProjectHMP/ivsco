void main()
{
    ...
    l_U725 = {-91.67880000, -250.79660000, 13.45870000};
    ...
    while (l_U590)
    {
        ...
        g_U9077 = 0;
        sub_10387();
        if (((sub_10473()) AND (l_U588 == 0)) AND (l_U578 <= 10))
        {
            sub_10625( 2 );
        }
        else if (((((sub_12102( l_U678 )) AND (l_U588 == 0)) AND (l_U578 < 10)) AND (l_U578 > 1)) AND (l_U605))
        {
            sub_10625( 5 );
        }
        else if ((((NOT sub_12341()) AND (l_U588 == 0)) AND (l_U578 <= 10)) AND (NOT (l_U578 == 1)))
        {
            if (NOT (l_U578 == 0))
            {
                sub_10625( 3 );
        ...
        if ((l_U578 < 8) AND (IS_PLAYER_SCRIPT_CONTROL_ON( sub_7251() )))
        {
            sub_12536();
        }
        switch (l_U578)
        ...
        if ((((l_U578 < 10) AND (NOT (l_U578 == 8))) AND (NOT (l_U578 == 1))) AND (NOT (l_U578 == 0)))
        {
            if (NOT (l_U578 == 12))
            {
                sub_55639();
                sub_56252();
                if ((l_U616) AND (l_U664 == 2))
                {
                    sub_63783();
                }
            }
            if ((l_U595) AND (DOES_OBJECT_EXIST( l_U692 )))
            {
                sub_64137( ref l_U692, 1 );
            }
            if ((l_U596) AND (DOES_OBJECT_EXIST( l_U693 )))
            {
                sub_64137( ref l_U693, 2 );
            }
            if ((l_U597) AND (DOES_OBJECT_EXIST( l_U694 )))
            {
                sub_64137( ref l_U694, 3 );
            }
            if ((l_U598) AND (DOES_OBJECT_EXIST( l_U695 )))
            {
...
void sub_2784()
{
    ...
    {
        if (((sub_2822( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_5340(boolean bParam0)
{
    ...
    LOAD_ALL_OBJECTS_NOW();
    while (((NOT (HAS_MODEL_LOADED( l_U683 ))) || (NOT (HAS_MODEL_LOADED( l_U684 )))) || (NOT (HAS_MODEL_LOADED( l_U685 ))))
    {
        WAIT( 0 );
    }
    if (bParam0)
...
int sub_10473()
{
    ...
    if ((((CHECK_STUCK_TIMER( l_U678, 3, 60000 )) || (CHECK_STUCK_TIMER( l_U678, 2, 30000 ))) || (CHECK_STUCK_TIMER( l_U678, 1, 40000 ))) || (CHECK_STUCK_TIMER( l_U678, 0, 5000 )))
    {
        return 1;
        break;
    }
...
void sub_10625(unknown uParam0)
{
    ...
    {
        case 2:
        if (((NOT (IS_CHAR_DEAD( l_U672 ))) AND (NOT (IS_CAR_DEAD( l_U678 )))) AND (l_U648))
        {
...
int sub_12341()
{
    if (((NOT (IS_CHAR_INJURED( l_U672 ))) AND (NOT (IS_CHAR_INJURED( l_U673 )))) AND (NOT (IS_CHAR_INJURED( l_U674 ))))
    {
        return 1;
        break;
    }
...
void sub_12536()
{
    if (NOT l_U647)
    {
        if ((IS_WANTED_LEVEL_GREATER( sub_7251(), 0 )) AND (NOT (l_U578 == 0)))
        {
            if (sub_12589( l_U825 ))
            {
                sub_4418( ref l_U825, 1 );
    ...
    if ((((NOT l_U645) AND (NOT (l_U578 == 3))) AND (NOT (sub_12589( l_U831 )))) AND (l_U646))
    {
...
void sub_13433()
{
    ...
    if (((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U672, sub_4155(), 0 )) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U673, sub_4155(), 0 ))) || (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U674, sub_4155(), 0 )))
    {
        REMOVE_BLIP( l_U698 );
        sub_10625( 4 );
    }
    if ((LOCATE_CHAR_ON_FOOT_3D( sub_4155(), l_U725._fU0, l_U725._fU4, l_U725._fU8, 17.00000000, 17.00000000, 17.00000000, 0 )) AND (sub_13907( 1, 1 )))
    {
        SET_ROUTE( l_U698, 0 );
        REMOVE_BLIP( l_U698 );
        if (NOT (IS_CHAR_INJURED( l_U672 )))
...
void sub_14355()
{
    ...
    switch (l_U584)
    {
        ...
        if (IS_VEH_DRIVEABLE( uVar2 ))
        {
            ...
            if ((NOT (iVar3 == 1917016601)) AND (iVar4 == nil))
            {
        ...
        sub_5340( 0 );
        WAIT( 1000 );
        if ((NOT sub_10473()) AND (sub_12341()))
        {
        ...
        if ((IS_VEH_DRIVEABLE( l_U678 )) AND (NOT (IS_CHAR_DEAD( sub_4155() ))))
        {
            SET_CAR_ENGINE_ON( l_U678, 1, 1 );
            SET_CAR_CAN_BE_VISIBLY_DAMAGED( l_U678, 0 );
            SET_CHAR_COORDINATES_NO_OFFSET( sub_4155(), -93.83720000, -247.41730000, 12.66880000 );
...
void sub_16095()
{
    ...
    if (NOT sub_10473())
    {
        if (IS_CHAR_SITTING_IN_CAR( sub_4155(), l_U678 ))
        {
            ...
            if ((((l_U620) AND (NOT l_U626)) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT l_U647))
            {
                switch (g_U64955)
                {
                    case 0:
            ...
            if ((((NOT (sub_12589( l_U831 ))) AND (NOT l_U620)) AND (NOT l_U641)) AND (NOT l_U647))
            {
                PRINT_NOW( "RAY2_02", 7500, 1 );
                l_U620 = 1;
            }
            if (((l_U626) AND (sub_16574( l_U825 ))) AND (l_U853 >= 3000))
            {
                switch (l_U669)
                {
                    case 0:
...
void sub_17464()
{
    ...
    if (IS_VEH_DRIVEABLE( l_U678 ))
    {
        if (IS_CHAR_SITTING_IN_CAR( sub_4155(), l_U678 ))
        {
            ...
            CLEAR_PRINTS();
            REMOVE_BLIP( l_U698 );
            if (NOT ((l_U580 == 1) || (l_U580 == 11)))
            {
                iVar2++;
                sub_17602( ref l_U673, 2, ref l_U580 );
            }
            if (NOT ((l_U581 == 1) || (l_U581 == 11)))
            {
                iVar2 += 2;
            ...
            else if (l_U664 == 0)
            {
                ...
                if (NOT l_U647)
                {
                    if ((l_U620) AND (l_U625))
                    {
                        PRINT_NOW( "RAY2_02", 7500, 1 );
                    }
                    if ((NOT (DOES_BLIP_EXIST( l_U699 ))) AND (l_U625))
                    {
                        ADD_BLIP_FOR_COORD( l_U707._fU0, l_U707._fU4, l_U707._fU8, ref l_U699 );
                        SET_ROUTE( l_U699, 1 );
                    }
...
void sub_18711()
{
    ...
    if (((l_U632) AND (NOT l_U633)) AND (NOT (sub_12589( l_U831 ))))
    {
        l_U633 = 1;
        PRINT_NOW( "RAY2_04", 7500, 1 );
    }
...
void sub_20040(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3)
{
    ...
    if (((l_U618) AND (NOT (sub_12589( l_U831 )))) AND (NOT l_U619))
    {
        if (((NOT (l_U589 == 1)) AND (NOT (l_U589 == 2))) AND (IS_CHAR_IN_CAR( sub_4155(), l_U678 )))
        {
    ...
    if (iParam0 == 1)
    {
        if ((((l_U640) AND (NOT (sub_12589( l_U831 )))) AND (NOT (sub_12589( l_U825 )))) AND (NOT l_U623))
        {
            if (IS_CHAR_IN_CAR( sub_4155(), l_U678 ))
            {
        ...
        if (((NOT l_U640) AND (NOT (sub_12589( l_U825 )))) AND (NOT (sub_12589( l_U831 ))))
        {
            if (IS_CHAR_IN_CAR( sub_4155(), l_U678 ))
            {
        ...
        if ((l_U599) AND (IS_CHAR_IN_CAR( sub_4155(), l_U678 )))
        {
            if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT (sub_12589( l_U831 ))))
            {
                if (NOT l_U631)
                {
                ...
                if (((l_U631) AND (l_U600)) AND (NOT l_U627))
                {
    ...
    {
        if (((NOT l_U642) AND (NOT (sub_12589( l_U825 )))) AND (NOT (sub_12589( l_U831 ))))
        {
            if (IS_CHAR_IN_CAR( sub_4155(), l_U678 ))
            {
    ...
    if (((l_U580 == 11) AND (l_U581 == 11)) AND (IS_CHAR_IN_CAR( sub_4155(), l_U678 )))
    {
        if (iParam0 == 1)
        {
            sub_20684();
...
void sub_23148()
{
    if ((NOT l_U634) AND ((DOES_OBJECT_EXIST( l_U692 )) || (DOES_OBJECT_EXIST( l_U693 ))))
    {
        if (TIMERB() >= 8000)
        {
            l_U634 = 1;
    ...
    if (IS_VEH_DRIVEABLE( l_U678 ))
    {
        if (IS_CHAR_SITTING_IN_CAR( sub_4155(), l_U678 ))
        {
            if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT l_U627)) AND (NOT (sub_12589( l_U831 ))))
            {
                sub_11032( "RB2_B2AV1", ref l_U831, 7, 1 );
                l_U627 = 1;
            }
            if ((((((l_U621) AND (NOT l_U628)) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_12589( l_U831 )))) AND (NOT l_U647)) AND (TIMERA() >= 12500))
            {
                switch (g_U64956)
                {
                    case 0:
            ...
            if (((((NOT (sub_12589( l_U831 ))) AND (NOT l_U621)) AND (NOT l_U643)) AND (l_U627)) AND (NOT l_U647))
            {
                PRINT_NOW( "RAY2_03", 7500, 1 );
                SETTIMERA( 0 );
                l_U621 = 1;
            }
            if (((l_U628) AND (sub_16574( l_U825 ))) AND (l_U853 >= 3000))
            {
                switch (l_U670)
                {
                    case 0:
...
void sub_24548()
{
    ...
    if (((((sub_24573()) AND (NOT (l_U585 == 0))) AND (NOT (l_U585 == 4))) AND (IS_SCREEN_FADED_IN())) AND (TIMERB() >= 1000))
    {
        CLEAR_PRINTS();
        CLEAR_HELP();
        sub_4418( ref l_U831, 1 );
        ...
        if ((IS_VEH_DRIVEABLE( l_U679 )) AND (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U679 )))
        {
    ...
    if (NOT l_U637)
    {
        if (l_U636)
        {
            ...
            if ((l_U872 == 7) AND (NOT (IS_CHAR_INJURED( l_U673 ))))
            {
    ...
    switch (l_U585)
    {
        ...
        else if (IS_SCREEN_FADED_OUT())
        {
            ...
            LOAD_ALL_OBJECTS_NOW();
            while (((NOT (HAS_MODEL_LOADED( l_U682 ))) || (NOT (HAS_MODEL_LOADED( l_U686 )))) || (NOT (HAS_MODEL_LOADED( -196312163 ))))
            {
                WAIT( 0 );
            }
            ...
            if ((((IS_VEH_DRIVEABLE( l_U679 )) AND (NOT sub_10473())) AND (sub_12341())) AND (sub_26317()))
            {
        ...
        {
            BEGIN_CAM_COMMANDS( ref l_U665 );
            if ((NOT (IS_CAR_DEAD( l_U678 ))) AND (NOT (IS_CHAR_DEAD( l_U673 ))))
            {
                ATTACH_CAM_TO_VEHICLE( l_U842, l_U678 );
                SET_CAM_ATTACH_OFFSET( l_U842, 1.70000000, -6.31000000, 0.92300000 );
        ...
        break;
        case 2:
        if ((NOT l_U636) AND (NOT (IS_CHAR_DEAD( l_U673 ))))
        {
        ...
        if ((NOT (IS_CHAR_DEAD( l_U675[1] ))) AND (NOT (IS_CHAR_DEAD( l_U672 ))))
        {
...
int sub_26317()
{
    if ((NOT (IS_CHAR_INJURED( l_U675[0] ))) AND (NOT (IS_CHAR_INJURED( l_U675[1] ))))
    {
        return 1;
        break;
    }
...
void sub_27591()
{
    if ((IS_VEH_DRIVEABLE( l_U679 )) AND (NOT (IS_CHAR_INJURED( l_U675[0] ))))
    {
    ...
    if (IS_VEH_DRIVEABLE( l_U678 ))
    {
        if (l_U616)
        {
            if (NOT sub_28304())
            {
                if (TIMERB() <= 50000)
                {
                    if (NOT ((IS_CHAR_IN_CAR( sub_4155(), l_U678 )) AND (LOCATE_CHAR_IN_CAR_3D( sub_4155(), l_U713._fU0, l_U713._fU4, l_U713._fU8, 150, 150, 150, 0 ))))
                    {
                        sub_28505();
                    }
                    else
                ...
                else if ((IS_CHAR_IN_CAR( sub_4155(), l_U678 )) AND (LOCATE_CHAR_IN_CAR_3D( sub_4155(), l_U713._fU0, l_U713._fU4, l_U713._fU8, 150, 150, 150, 0 )))
                {
                    sub_30140();
                    l_U616 = 0;
                }
        ...
        if (NOT l_U652)
        {
            if ((IS_CHAR_INJURED( l_U675[0] )) AND (IS_CHAR_INJURED( l_U675[1] )))
            {
        ...
        if (IS_CHAR_SITTING_IN_CAR( sub_4155(), l_U678 ))
        {
            ...
            if (((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT l_U629)) AND (NOT (sub_12589( l_U831 ))))
            {
                sub_11032( "RB2_B3AV1", ref l_U831, 7, 1 );
                l_U629 = 1;
            }
            if ((((((l_U622) AND (NOT l_U630)) AND (NOT l_U653)) AND (NOT l_U654)) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_12589( l_U831 ))))
            {
                switch (g_U64957)
                {
                    case 0:
            ...
            if (((NOT (sub_12589( l_U831 ))) AND (NOT l_U622)) AND (l_U629))
            {
                PRINT_NOW( "RAY2_05", 7500, 1 );
                l_U622 = 1;
            }
            if ((NOT (sub_12589( l_U831 ))) AND (NOT (sub_12589( l_U825 ))))
            {
                if (((NOT l_U654) AND (NOT l_U653)) AND (l_U853 >= 3000))
                {
                    if (((l_U649) || (IS_CHAR_DEAD( l_U675[0] ))) AND (DOES_VEHICLE_EXIST( l_U679 )))
                    {
            ...
            if (((l_U630) AND (sub_16574( l_U825 ))) AND (l_U853 >= 3000))
            {
                if (NOT ((l_U649) || (IS_CHAR_DEAD( l_U675[0] ))))
                {
                    switch (l_U671)
                    {
                        case 0:
            ...
            if (((IS_CHAR_IN_CAR( sub_4155(), l_U678 )) AND (NOT (IS_CHAR_INJURED( l_U672 )))) AND (l_U616))
            {
                if ((((NOT (sub_12589( l_U825 ))) AND (NOT (sub_12589( l_U831 )))) AND (l_U630)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
                {
                    bVar2 = false;
                    if ((NOT (IS_CAR_DEAD( l_U679 ))) AND (NOT (IS_CHAR_INJURED( l_U675[1] ))))
                    {
            ...
            if ((LOCATE_CHAR_IN_CAR_3D( sub_4155(), l_U713._fU0, l_U713._fU4, l_U713._fU8, 3.20000000, 3.20000000, 3.20000000, 1 )) AND (sub_13907( 1, 1 )))
            {
                SET_PLAYER_CONTROL( sub_7251(), 0 );
                SETTIMERB( 0 );
                SET_WANTED_MULTIPLIER( 0.00000000 );
            ...
            else if ((LOCATE_CHAR_IN_CAR_3D( sub_4155(), l_U713._fU0, l_U713._fU4, l_U713._fU8, 18.00000000, 18.00000000, 5.00000000, 0 )) AND (NOT l_U644))
            {
                CLEAR_PRINTS();
                sub_4418( ref l_U825, 0 );
...
int sub_28304()
{
    ...
    if ((IS_CHAR_IN_CAR( sub_4155(), l_U678 )) AND (NOT (LOCATE_CHAR_ANY_MEANS_CAR_3D( sub_4155(), l_U679, 115, 115, 115, 0 ))))
    {
        return 1;
        break;
    }
...
void sub_32348()
{
    if (((((sub_24573()) AND (NOT (l_U586 == 0))) AND (NOT (l_U586 == 2))) AND (IS_SCREEN_FADED_IN())) AND (TIMERB() >= 1000))
    {
        CLEAR_PRINTS();
        sub_4418( ref l_U831, 0 );
        DO_SCREEN_FADE_OUT( 500 );
    ...
    switch (l_U586)
    {
        ...
        else if (IS_SCREEN_FADED_OUT())
        {
            ...
            if ((NOT (IS_CHAR_INJURED( sub_4155() ))) AND (IS_VEH_DRIVEABLE( l_U678 )))
            {
                if (IS_CHAR_IN_CAR( sub_4155(), l_U678 ))
                {
        ...
        if (((sub_34297( l_U831 )) == 2) AND (l_U848 == 1))
        {
        ...
        if (((sub_34297( l_U831 )) == 5) AND (l_U848 == 2))
        {
            if ((NOT (IS_CHAR_DEAD( l_U673 ))) AND (NOT (IS_CHAR_DEAD( l_U672 ))))
            {
        ...
        if (((sub_34297( l_U831 )) == 7) AND (l_U848 == 3))
        {
        ...
        if ((TIMERA() >= 31000) AND (NOT l_U655))
        {
...
void sub_49577()
{
    if (((((sub_24573()) AND (NOT (l_U587 == 0))) AND (NOT (l_U587 == 2))) AND (IS_SCREEN_FADED_IN())) AND (TIMERB() >= 1000))
    {
        SETTIMERA( 0 );
        DO_SCREEN_FADE_OUT( 500 );
        while (NOT IS_SCREEN_FADED_OUT())
    ...
    switch (l_U587)
    {
        ...
        sub_4418( ref l_U831, 0 );
        sub_4418( ref l_U825, 0 );
        while ((sub_12589( l_U825 )) || (sub_12589( l_U831 )))
        {
            WAIT( 0 );
        }
        if (DOES_VEHICLE_EXIST( l_U678 ))
        ...
        if ((TIMERB() >= 200) AND (NOT l_U658))
        {
            if ((l_U588 == 2) || (l_U588 == 5))
            {
                if (NOT (IS_CHAR_INJURED( l_U672 )))
                {
        ...
        if ((NOT l_U659) AND ((TIMERB() >= 11000) || ((l_U662) AND (TIMERB() >= 9000))))
        {
            if (NOT (IS_CHAR_INJURED( l_U672 )))
            {
                OPEN_SEQUENCE_TASK( ref l_U688 );
        ...
        if ((NOT l_U660) AND ((TIMERB() >= 12500) || ((l_U662) AND (TIMERB() >= 10500))))
        {
            if (NOT (IS_CHAR_INJURED( l_U673 )))
            {
                OPEN_SEQUENCE_TASK( ref l_U688 );
        ...
        if (NOT l_U661)
        {
            if (((TIMERB() >= 13000) || (((IS_CHAR_INJURED( l_U672 )) AND (IS_CHAR_INJURED( l_U673 ))) AND (TIMERB() >= 3000))) || ((l_U662) AND (TIMERB() >= 11000)))
            {
                if (NOT (IS_CHAR_INJURED( l_U674 )))
                {
                    OPEN_SEQUENCE_TASK( ref l_U688 );
        ...
        if (((TIMERB() >= 15500) || (((IS_CHAR_INJURED( l_U672 )) AND (IS_CHAR_INJURED( l_U673 ))) AND (TIMERB() >= 5600))) || ((l_U662) AND (TIMERB() >= 13500)))
        {
            l_U587 = 2;
        }
        break;
...
void sub_50170(int iParam0)
{
    ...
    if (iParam0 == 3)
    {
        sub_50170( -1 );
        sub_50195( -1 );
        if (((GET_CHAR_DRAWABLE_VARIATION( sub_4155(), 8 )) != 1) || ((GET_CHAR_TEXTURE_VARIATION( sub_4155(), 8 )) != 0))
        {
    ...
    else
    {
        ...
        if (((GET_CHAR_DRAWABLE_VARIATION( sub_4155(), 8 )) != 0) || ((GET_CHAR_TEXTURE_VARIATION( sub_4155(), 8 )) != 0))
        {
...
void sub_53432()
{
    ...
    if ((NOT l_U624) AND (NOT (sub_12589( l_U831 ))))
    {
        switch (l_U588)
        {
            case 2:
    ...
    if (((l_U624) AND (TIMERB() >= 8500)) AND (sub_13907( 0, 1 )))
    {
        if (l_U648)
        {
            if (IS_CHAR_INJURED( l_U672 ))
...
void sub_53441()
{
    if (NOT (IS_CHAR_INJURED( l_U673 )))
    {
        ...
        if ((IS_CAR_DEAD( l_U678 )) || (l_U859 < 300))
        {
            if ((NOT (l_U580 == 12)) AND ((l_U580 == 11) || (l_U580 == 1)))
            {
                DETACH_PED( l_U673, 1 );
                CLEAR_CHAR_TASKS( l_U673 );
                if (NOT (IS_CHAR_INJURED( l_U673 )))
    ...
    if (NOT (IS_CHAR_INJURED( l_U674 )))
    {
        ...
        if ((IS_CAR_DEAD( l_U678 )) || (l_U859 < 300))
        {
            if ((NOT (l_U581 == 12)) AND ((l_U581 == 11) || (l_U581 == 1)))
            {
                DETACH_PED( l_U674, 1 );
                CLEAR_CHAR_TASKS( l_U674 );
                if (NOT (IS_CHAR_INJURED( l_U674 )))
...
void sub_54724()
{
    if (IS_VEH_DRIVEABLE( l_U678 ))
    {
        if (((((NOT (IS_CHAR_DEAD( sub_4155() ))) AND (IS_CHAR_IN_CAR( sub_4155(), l_U678 ))) AND (NOT l_U635)) AND (NOT (l_U578 == 8))) AND (l_U578 < 10))
        {
            if ((sub_54810()) AND (sub_54865() == 1000))
            {
                switch (l_U589)
                {
                    case 0:
...
void sub_56531(unknown uParam0, int iParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    switch ((uParam2^))
    {
        ...
        break;
        case 4:
        if ((((iParam1 == 2) AND (LOCATE_CHAR_ON_FOOT_3D( (uParam0^), l_U788._fU0, l_U788._fU4, l_U788._fU8, 0.60000000, 0.60000000, 2.00000000, 0 ))) AND (l_U667 == 2)) || (((iParam1 == 3) AND (LOCATE_CHAR_ON_FOOT_3D( (uParam0^), l_U791._fU0, l_U791._fU4, l_U791._fU8, 0.60000000, 0.60000000, 2.00000000, 0 ))) AND (l_U667 == 3)))
        {
            if (l_U589 == 2)
            {
                if (iParam1 == 2)
            ...
            else if ((NOT l_U618) AND (NOT (l_U589 == 1)))
            {
                if (IS_CHAR_IN_CAR( sub_4155(), l_U678 ))
                {
        ...
        else if ((((iParam1 == 2) AND (LOCATE_CHAR_ON_FOOT_3D( (uParam0^), l_U788._fU0, l_U788._fU4, l_U788._fU8, 5.00000000, 5.00000000, 2.00000000, 0 ))) AND (NOT (l_U667 == 2))) || (((iParam1 == 3) AND (LOCATE_CHAR_ON_FOOT_3D( (uParam0^), l_U791._fU0, l_U791._fU4, l_U791._fU8, 5.00000000, 5.00000000, 2.00000000, 0 ))) AND (NOT (l_U667 == 3))))
        {
        ...
        if ((((l_U872 == 7) AND (l_U821 <= 0.05000000)) AND (fVar7 < 10.00000000)) AND (LOCATE_CHAR_ANY_MEANS_3D( (uParam0^), l_U861, l_U862, l_U863, 1.40000000, 1.40000000, 1.40000000, 0 )))
        {
            if (NOT (IS_CHAR_INJURED( (uParam0^) )))
            {
                CLEAR_CHAR_TASKS( (uParam0^) );
        ...
        else if ((((((l_U821 >= 0.05000000) || (IS_CHAR_IN_AREA_2D( sub_4155(), 1054.81000000, -304.68000000, 1061.75000000, -287.17000000, 0 ))) || (IS_CHAR_IN_AREA_2D( sub_4155(), -517.95000000, 359.26000000, -509.95000000, 375.57000000, 0 ))) || (IS_CHAR_IN_AREA_2D( sub_4155(), -312.81000000, 1532.53000000, -301.33000000, 1546.49000000, 0 ))) || (IS_CHAR_IN_AREA_2D( sub_4155(), -1152.88000000, 1178.61000000, -1142.67000000, 1197.26000000, 0 ))) || (IS_CHAR_IN_AREA_2D( sub_4155(), -1303.29000000, 277.25000000, -1296.34000000, 289.04000000, 0 )))
        {
            GET_SCRIPT_TASK_STATUS( (uParam0^), 45, ref l_U872 );
            if (NOT (l_U872 == 1))
            {
...
void sub_61075(unknown uParam0, unknown uParam1, int iParam2, int iParam3, unknown uParam4)
{
    ...
    {
        case 0:
        if ((((IS_CHAR_PLAYING_ANIM( (uParam0^), l_U871, "GBGE_HANGL" )) || (IS_CHAR_PLAYING_ANIM( (uParam0^), l_U871, "GBGE_HANGR" ))) || (IS_CHAR_PLAYING_ANIM( (uParam0^), l_U871, "GBGE_SHOOT" ))) AND ((iParam2 == 1) || (iParam2 == 11)))
        {
            (uParam1^) = 1;
            if (iParam3 == 3)
            {
        ...
        if (((((uParam4^) >= 0.20000000) || (l_U870 >= 0.28200000)) AND (IS_CHAR_ON_SCREEN( (uParam0^) ))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_4155(), (uParam0^), 10.00000000, 10.00000000, 10.00000000, 0 )))
        {
        ...
        else if (NOT ((l_U617) AND (iParam3 == 3)))
        {
            if (iParam3 == 2)
            {
...
{
    if (((NOT (IS_CAR_DEAD( l_U678 ))) AND (NOT (IS_CAR_DEAD( l_U679 )))) AND (NOT (IS_CHAR_DEAD( l_U675[0] ))))
    {
        ...
        if ((((l_U865 <= -5) AND (l_U865 >= 65516)) AND (l_U870 < 20.00000000)) AND (HAS_CHAR_SPOTTED_CHAR( (uParam0^), l_U675[0] )))
        {
            l_U639 = 1;
        }
        else
        ...
        else
        {
            ...
            SET_NM_MESSAGE_VEC3( 243, l_U861, l_U862, l_U863 );
            SEND_NM_MESSAGE( (uParam0^) );
            if (((uParam2^) >= 0.40000000) AND (l_U639))
            {
...
void sub_63783()
{
    if ((IS_VEH_DRIVEABLE( l_U679 )) AND (NOT (IS_CHAR_DEAD( l_U675[0] ))))
    {
