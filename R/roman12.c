...
void sub_1664()
{
    ...
    {
        if (((sub_1702( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_3179()
{
    ...
    if ((g_U9893._fU24 == 0) AND (NOT (IS_CHAR_DEAD( l_U628 ))))
    {
        LOAD_SCENE( 1252.69800000, 1488.80800000, 15.72340000 );
        SET_CHAR_COORDINATES( l_U628, 1252.69800000, 1488.80800000, 15.72340000 );
...
void sub_5181()
{
    ...
    if ((l_U563[0] == 0) AND (TIMERA() > 25000))
    {
    ...
    if (((TIMERB() > 3000) AND (l_U688 == 0)) AND (l_U563[1] == 1))
    {
    ...
    if ((((sub_7956( 25, 1 )) AND (NOT (sub_8259( 25 )))) AND (l_U688 == 1)) AND (l_U563[2] == 0))
    {
...
int sub_5983()
{
    ...
    for ( I = 0; I <= (g_U569 - 1); I++ )
    {
        if (((sub_1702( 1, g_U569[I] )) != 0) AND (g_U569[I]._fU20))
        {
            sub_1988( I );
            return 1;
        }
...
int sub_8497(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3508() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3508() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_9012()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U91._fU60 = uParam0;
...
void sub_12437()
{
    ...
    if (l_U660[l_U656] == 0)
    {
        ...
        sub_12733( 0 );
        while (((NOT sub_13436()) || (NOT sub_13522())) || (NOT (sub_13626( 0 ))))
        {
            WAIT( 0 );
        }
        ...
        CREATE_CHAR( 26, -2088164056, 1211.66800000, 1447.70800000, 16.73050000, ref l_U806[4], 1 );
    ...
    if (((TIMERB() > 3000) AND (l_U688 == 0)) AND (l_U701 == 1))
    {
        sub_6945( "R12_TEXT", ref l_U638, 8, 1 );
    ...
    if (((IS_CHAR_SHOOTING( l_U628 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1191.47500000, 1458.68400000, 16.71670000, 1.00000000, 1.00000000, 4.00000000, 0 ))) || (IS_SNIPER_BULLET_IN_AREA( 1182.02900000, 1432.30800000, 12.76710000, 1234.86000000, 1474.00000000, 52.00000000 )))
    {
        PRINTSTRING( "Should skip to shootout" );
        PRINTNL();
        l_U795 = 1;
    }
    if ((DOES_CHAR_EXIST( l_U900 )) AND (DOES_CHAR_EXIST( l_U901 )))
    {
        if (((sub_20778( l_U900, l_U628, 1 )) < 80.00000000) AND (l_U563[1] == 0))
        {
        ...
        if (((sub_20778( l_U901, l_U628, 1 )) < 80.00000000) AND (l_U563[2] == 0))
        {
            if (NOT (IS_CHAR_INJURED( l_U901 )))
            {
                TASK_SHOOT_AT_CHAR( l_U901, l_U628, 500000, 3 );
            }
            if ((NOT (IS_CHAR_DEAD( l_U902 ))) AND (NOT (IS_CHAR_DEAD( l_U903 ))))
            {
    ...
    if (LOCATE_CHAR_ANY_MEANS_2D( l_U628, 1219.35000000, 1441.59800000, 40.50000000, 40.50000000, 0 ))
    {
        ...
        if ((IS_CHAR_SHOOTING( l_U628 )) || (l_U795 == 1))
        {
    ...
    if (l_U656 < 6)
    {
        if ((LOCATE_CHAR_ON_FOOT_3D( l_U628, 1220.35000000, 1441.59800000, 16.71700000, 1.50000000, 1.50000000, 1.00000000, 1 )) || (LOCATE_CHAR_IN_CAR_3D( l_U628, 1219.35000000, 1441.59800000, 16.71700000, 3.50000000, 3.50000000, 1.00000000, 0 )))
        {
...
void sub_19205()
{
    ...
    if ((((l_U679 - l_U680) > l_U681) AND (iVar2 == 0)) AND (iVar3 == 0))
    {
...
{
    if ((((NOT (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( 1190.59000000, 1451.44000000, 30.62000000, 5.00000000, -9766626 ))) || (NOT (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( 1190.59000000, 1451.44000000, 30.62000000, 5.00000000, -1624818688 )))) || (NOT (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( 1190.59000000, 1451.44000000, 30.62000000, 5.00000000, -1926297576 )))) || (NOT (DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS( 1190.59000000, 1451.44000000, 30.62000000, 5.00000000, -1953528903 ))))
    {
        return 0;
        break;
    }
...
void sub_22041()
{
    ...
    if (l_U660[l_U656] == 0)
    {
        if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1220.35000000, 1441.59800000, 16.71700000, 1.50000000, 1.50000000, 1.00000000, 1 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1212.19800000, 1441.61400000, 16.71660000, 6.00000000, 1.50000000, 1.00000000, 0 ))) || ((LOCATE_CHAR_IN_CAR_3D( l_U628, 1219.35000000, 1441.59800000, 16.71700000, 4.50000000, 4.50000000, 1.00000000, 0 )) AND ((IS_CHAR_ON_ANY_BIKE( l_U628 )) || (IS_CHAR_IN_ANY_CAR( l_U628 )))))
        {
            if (l_U660[l_U656] == 0)
            {
                ...
                while ((IS_CHAR_IN_ANY_CAR( l_U628 )) || (IS_CHAR_ON_ANY_BIKE( l_U628 )))
                {
                ...
                SET_CAM_ROT( l_U621, -3.07324100, -0.00000000, -70.75600000 );
                ...
                SET_CAM_ROT( l_U623, -3.68878000, -0.00000000, 27.38025000 );
    ...
    if (((TIMERA() > 2000) AND (l_U563[4] == 0)) AND (l_U660[l_U656] == 1))
    {
    ...
    if (((TIMERA() > 5000) AND (l_U563[0] == 0)) AND (l_U660[l_U656] == 1))
    {
    ...
    if (((TIMERA() > 9500) AND (l_U563[2] == 0)) AND (l_U660[l_U656] == 1))
    {
        ...
        SET_CAM_ROT( l_U621, 15.37226000, 0.00000000, 148.71850000 );
        SET_CAM_FOV( l_U621, 50.99998000 );
        SET_CAM_NEAR_DOF( l_U621, 3.00000000 );
        SET_CAM_FAR_DOF( l_U621, 25.00000000 );
        SET_CAM_POS( l_U623, 1205.68900000, 1452.37500000, 31.34040000 );
    ...
    if (((TIMERA() > 15500) AND (l_U563[3] == 0)) AND (l_U660[l_U656] == 1))
    {
    ...
    if (((sub_24732( l_U638 )) > 0) AND (l_U563[3] == 1))
    {
    ...
    if (((sub_24732( l_U638 )) > 1) AND (l_U563[3] == 1))
    {
    ...
    if ((NOT (sub_24748( l_U638 ))) AND (l_U563[3] == 1))
    {
        l_U563[5] = 1;
    }
    if (((sub_25284()) AND (IS_SCREEN_FADED_IN())) AND (TIMERA() > 1000))
    {
        l_U700 = 1;
        DO_SCREEN_FADE_OUT( 500 );
        while (IS_SCREEN_FADING_OUT())
    ...
    if (((l_U700) AND (l_U563[4] == 1)) || (((TIMERA() > 25000) AND (l_U660[l_U656] == 1)) AND (l_U563[5] == 1)))
    {
        if (l_U700)
        {
            sub_24557( ref l_U638, 0 );
...
void sub_25940()
{
    ...
    sub_26775();
    if ((IS_CHAR_SHOOTING( l_U628 )) || (l_U772 == 1))
    {
        if (l_U660[l_U656] == 0)
        {
            l_U660[l_U656] = 1;
    ...
    if ((((((l_U1028 - l_U704) > 30000) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U628 )))) AND (NOT (sub_24748( l_U638 )))) AND (l_U660[l_U656] == 1))
    {
        sub_6945( "R12_GOON", ref l_U638, 8, 1 );
        GET_GAME_TIMER( ref l_U704 );
    }
    if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1215.98900000, 1455.97800000, 18.21660000, 2.00000000, 2.00000000, 1.00000000, 0 )) || ((sub_27433( l_U628 )) > 19.00000000)) || (l_U798 > 4))
    {
        CLEAR_PRINTS();
        l_U656++;
    }
...
void sub_27562()
{
    ...
    if (l_U660[l_U656] == 0)
    {
        ...
        CREATE_CHAR( 26, -2088164056, 1225.98100000, 1458.46400000, 20.68320000, ref l_U821[1], 1 );
        ...
        SET_CHAR_SPHERE_DEFENSIVE_AREA( l_U821[1], 1225.98100000, 1458.46400000, 21.68320000, 2.00000000 );
    ...
    GET_GAME_TIMER( ref l_U1028 );
    if (((((l_U1028 - l_U704) > 15000) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_24748( l_U638 )))) AND (l_U660[l_U656] == 1))
    {
        sub_6945( "R12_GOON", ref l_U638, 8, 1 );
        GET_GAME_TIMER( ref l_U704 );
    }
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1215.98900000, 1455.97800000, 18.21660000, 2.00000000, 2.00000000, 1.00000000, 0 )) AND (l_U691 == 0))
    {
    ...
    sub_26775();
    if ((l_U563[0] == 0) AND (l_U660[l_U656] == 1))
    {
        for ( I = 0; I <= 13; I++ )
        {
    ...
    if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1198.12000000, 1442.79200000, 24.18320000, 2.00000000, 2.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1193.92300000, 1442.72400000, 21.68820000, 3.00000000, 2.00000000, 1.00000000, 0 ))) || ((sub_27433( l_U628 )) > 24.50000000))
    {
        sub_30774();
        sub_5359();
        CLEAR_PRINTS();
...
void sub_30861()
{
    ...
    if (l_U660[l_U656] == 0)
    {
        ...
        for ( I = 0; I <= 2; I++ )
        {
            SET_CHAR_HEADING( l_U908[I], 9.36320000 );
        ...
        for ( l_U799 = 0; l_U799 <= 1; l_U799++ )
        {
            if (NOT (IS_CHAR_INJURED( l_U836[l_U799] )))
            {
                SET_CHAR_ANGLED_DEFENSIVE_AREA( l_U836[l_U799], 1225.16700000, 1464.21500000, 26.10200000, 1227.77300000, 1447.92200000, 24.10200000, 8.50000000 );
                TASK_PERFORM_SEQUENCE( l_U836[l_U799], l_U1006 );
            }
        }
        ...
        CREATE_CHAR( 26, 1976502708, 1208.25000000, 1465.39800000, 25.98010000, ref l_U881, 1 );
    ...
    sub_26775();
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1226.33700000, 1456.17700000, 25.98010000, 8.00000000, 1.00000000, 1.00000000, 0 )) AND (l_U563[0] == 0))
    {
    ...
    if (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1220.06200000, 1437.12500000, 25.98010000, 2.50000000, 2.50000000, 2.50000000, 0 ))
    {
        if (l_U563[1] == 0)
        {
            l_U563[1] = 1;
    ...
    if (l_U563[2] == 0)
    {
        if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1228.34800000, 1453.87800000, 25.98010000, 8.00000000, 3.00000000, 1.50000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1223.80300000, 1447.68500000, 26.41670000, 4.00000000, 1.00000000, 1.50000000, 0 ))) || ((sub_27433( l_U628 )) > 29.78010000))
        {
    ...
    GET_GAME_TIMER( ref l_U1028 );
    if ((((((l_U1028 - l_U704) > 15000) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_24748( l_U638 )))) AND (l_U660[l_U656] == 1)) AND (l_U655 == 0))
    {
        sub_6945( "R12_GOON", ref l_U638, 8, 1 );
        GET_GAME_TIMER( ref l_U704 );
    }
    if (((l_U563[2] == 1) AND (HAS_MODEL_LOADED( -1992728631 ))) AND (l_U655 == 0))
    {
    ...
    if ((l_U655 == 1) AND (NOT (sub_24748( l_U638 ))))
    {
        if (DOES_CHAR_EXIST( l_U883 ))
        {
            DELETE_CHAR( ref l_U883 );
    ...
    if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1219.77000000, 1470.96400000, 28.73310000, 2.40000000, 2.80000000, 4.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1220.69500000, 1467.52600000, 25.98550000, 2.00000000, 2.00000000, 2.00000000, 0 ))) || ((sub_27433( l_U628 )) > 29.50000000))
    {
        CLEAR_PRINTS();
        l_U656++;
    }
...
void sub_33741()
{
    ...
    {
        if ((NOT (sub_24748( l_U638 ))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U628 ))))
        {
            iVar2 = sub_22574( 0, 16 );
            if ((iVar2 > 0) AND (iVar2 < 3))
            {
                if (DOES_CHAR_EXIST( l_U883 ))
                {
                    sub_6945( "R12_HELP", ref l_U638, 8, 0 );
...
void sub_34194(unknown uParam0)
{
    ...
    {
        if ((l_U913[uParam0][3] == 0) AND (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U908[uParam0], l_U628, 1 )))
        {
...
void sub_34676()
{
    ...
    sub_34194( 2 );
    sub_34194( 3 );
    if ((IS_CHAR_INJURED( l_U908[2] )) AND (l_U563[2] == 0))
    {
    ...
    if ((IS_CHAR_INJURED( l_U908[3] )) AND (l_U563[3] == 0))
    {
    ...
    if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1209.85400000, 1469.25900000, 30.28010000, 6.00000000, 6.00000000, 3.00000000, 0 )) || ((sub_27433( l_U628 )) > 29.00000000)) || (l_U707 == 1))
    {
        sub_5359();
        l_U656++;
    }
...
void sub_36109()
{
    if (l_U660[l_U656] == 0)
    {
        ...
        while (((NOT (HAVE_ANIMS_LOADED( "reaction@male_flee" ))) || (NOT (HAS_MODEL_LOADED( -1992728631 )))) || (NOT (HAS_MODEL_LOADED( 1543404628 ))))
        {
            WAIT( 0 );
        }
        sub_13927( 0, ref l_U883, 1203.70600000, 1435.35900000, 29.24520000, 275.16160000 );
    ...
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1194.87100000, 1469.95600000, 30.28010000, 2.00000000, 3.00000000, 1.00000000, 0 )) || ((IS_CHAR_DEAD( l_U851[2] )) AND (IS_CHAR_DEAD( l_U851[1] ))))
        {
            l_U656++;
        }
    }
...
void sub_37174(unknown uParam0)
{
    ...
    GET_GAME_TIMER( ref l_U1028 );
    if ((l_U714[uParam0][1] == 0) AND (HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U908[uParam0], l_U628, 0 )))
    {
        ...
        if (NOT (IS_CHAR_DEAD( l_U908[uParam0] )))
        {
            ...
            if ((((l_U1028 - l_U759[uParam0]) > 0) AND (l_U714[uParam0][3] == 0)) AND (l_U714[uParam0][2] == 1))
            {
            ...
            if ((((l_U1028 - l_U759[uParam0]) > 100) AND (l_U714[uParam0][4] == 0)) AND (l_U714[uParam0][3] == 1))
            {
                GET_GAME_TIMER( ref l_U759[uParam0] );
                l_U714[uParam0][4] = 1;
            }
            if ((((l_U1028 - l_U759[uParam0]) > 500) AND (l_U714[uParam0][5] == 0)) AND (l_U714[uParam0][4] == 1))
            {
                if ((IS_PED_RAGDOLL( l_U908[uParam0] )) AND (NOT (IS_CHAR_INJURED( l_U908[uParam0] ))))
                {
                    ...
                    SET_NM_MESSAGE_FLOAT( 287, 0.71000000 );
                    SEND_NM_MESSAGE( l_U908[uParam0] );
            ...
            if ((l_U714[uParam0][6] == 0) AND (l_U714[uParam0][5] == 1))
            {
                if (NOT (IS_CHAR_INJURED( l_U908[uParam0] )))
                {
            ...
            if ((((l_U1028 - l_U759[uParam0]) > 1000) AND (l_U714[uParam0][7] == 0)) AND (l_U714[uParam0][6] == 1))
            {
                if ((NOT (IS_CHAR_INJURED( l_U908[uParam0] ))) AND (IS_PED_RAGDOLL( l_U908[uParam0] )))
                {
            ...
            if (IS_PED_RAGDOLL( l_U908[uParam0] ))
            {
                if ((CHECK_NM_FEEDBACK( l_U908[uParam0], 188, 0 )) || (CHECK_NM_FEEDBACK( l_U908[uParam0], 162, 0 )))
                {
...
void sub_39176()
{
    ...
    sub_33741();
    sub_26775();
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1190.26100000, 1464.05700000, 30.28010000, 2.50000000, 1.50000000, 1.00000000, 0 )) AND (l_U563[0] == 0))
    {
        SETTIMERA( 0 );
        l_U563[0] = 1;
    }
    if (l_U563[0] == 1)
    {
        if ((((GET_PED_CLIMB_STATE( l_U628 )) == 2) || ((GET_PED_CLIMB_STATE( l_U628 )) == 3)) || ((GET_PED_CLIMB_STATE( l_U628 )) == 4))
        {
            if (l_U563[1] == 0)
            {
                CLEAR_HELP();
    ...
    if ((LOCATE_CHAR_ANY_MEANS_2D( l_U628, 1191.40100000, 1451.54100000, 2.50000000, 1.50000000, 0 )) AND (l_U563[2] == 0))
    {
        CLEAR_HELP();
        if ((((GET_PED_CLIMB_STATE( l_U628 )) == 2) || ((GET_PED_CLIMB_STATE( l_U628 )) == 3)) || ((GET_PED_CLIMB_STATE( l_U628 )) == 4))
        {
...
void sub_40265()
{
    ...
    if ((TIMERA() > 1000) AND (l_U563[2] == 0))
    {
        SET_CAM_FOV( l_U626, 21.00000000 );
        sub_6945( "R12_BEGLIF", ref l_U638, 8, 1 );
        l_U563[2] = 1;
    }
    if ((TIMERA() > 1500) AND (l_U563[3] == 0))
    {
        SET_CAM_FOV( l_U626, 11.71000000 );
        l_U563[3] = 1;
    }
    if ((TIMERA() > 2000) AND (l_U563[4] == 0))
    {
        INCREMENT_INT_STAT_NO_MESSAGE( 373, 1 );
        l_U563[4] = 1;
    }
    if ((TIMERA() > 3500) AND (l_U660[l_U656] == 1))
    {
        sub_23294( ref l_U626, 0 );
        sub_23351( 0 );
        sub_5359();
...
void sub_41650()
{
    ...
    if ((IS_BULLET_IN_AREA( 1205.46600000, 1438.48000000, 29.28010000, 3.00000000, 1 )) || (IS_SNIPER_BULLET_IN_AREA( 1199.74100000, 1434.84800000, 29.28510000, 1206.71000000, 1445.95000000, 33.28510000 )))
    {
        if (l_U677 == 0)
        {
            l_U712++;
    ...
    if (NOT (IS_CHAR_DEAD( l_U882 )))
    {
        if (IS_CHAR_PLAYING_ANIM( l_U882, "missRoman12", "Hostage_taker_fire" ))
        {
            ...
            if ((fVar6 >= 0.41000000) AND (fVar6 < 0.43000000))
            {
                sub_44062( l_U882 );
            }
            if ((fVar6 >= 0.55000000) AND (fVar6 < 0.57000000))
            {
                sub_44062( l_U882 );
            }
            if ((fVar6 >= 0.68000000) AND (fVar6 < 0.70000000))
            {
                sub_44062( l_U882 );
            }
            if ((l_U698 == 0) AND (NOT (sub_24748( l_U638 ))))
            {
                if (l_U697 == 0)
                {
    ...
    if ((NOT (sub_24748( l_U638 ))) AND ((l_U769 - l_U770) > 5000))
    {
        sub_6945( "R12_BEGLIF", ref l_U638, 6, 1 );
        GET_GAME_TIMER( ref l_U770 );
    }
    if (((((sub_38813( l_U883 )) < 250) || (IS_CHAR_ON_FIRE( l_U883 ))) AND (l_U793 == 0)) AND (l_U805 == 0))
    {
        if (l_U706 == 0)
        {
            ...
            PRINTNL();
            if ((((sub_44978( l_U628 )) == 10) || ((sub_44978( l_U628 )) == 11)) || ((sub_44978( l_U628 )) == 18))
            {
    ...
    if (((fVar2 < 10.00000000) AND (l_U793 == 0)) AND (l_U805 == 0))
    {
    ...
    GET_GAME_TIMER( ref l_U1028 );
    if ((((l_U1028 - l_U800) > 30000) AND (l_U793 == 0)) AND (l_U805 == 0))
    {
        PRINTSTRING( "TooLong!" );
        PRINTNL();
        if (l_U563[1] == 0)
    ...
    if (l_U805 == 0)
    {
        ...
        if (((l_U794 == 1) AND (TIMERB() > 6000)) AND (l_U796 == 0))
        {
            PRINT_HELP_FOREVER( "ZOOM1" );
            SETTIMERB( 0 );
            l_U796 = 1;
        }
        if (((TIMERB() > 6000) AND (l_U796 == 1)) AND (l_U687 == 0))
        {
        ...
        if (((l_U687 == 0) AND (TIMERB() > 6000)) AND (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ACCUR" )))
        {
            CLEAR_HELP();
        }
        if (((NOT (IS_CHAR_DEAD( l_U882 ))) AND (NOT (IS_CHAR_DEAD( l_U883 )))) AND ((sub_38813( l_U882 )) >= 250))
        {
            GET_OFFSET_FROM_CHAR_IN_WORLD_COORDS( l_U882, l_U1035._fU0, l_U1035._fU4, l_U1035._fU8, ref l_U801._fU0, ref l_U801._fU4, ref l_U801._fU8 );
            SET_CHAR_COORDINATES_NO_OFFSET( l_U883, l_U801._fU0, l_U801._fU4, l_U801._fU8 );
        }
        if ((((((sub_38813( l_U882 )) < 250) AND (l_U793 == 0)) AND ((sub_44978( l_U628 )) != 10)) AND ((sub_44978( l_U628 )) != 11)) AND ((sub_44978( l_U628 )) != 18))
        {
            if ((NOT (IS_CHAR_DEAD( l_U882 ))) AND (NOT (IS_CHAR_DEAD( l_U883 ))))
            {
                sub_24557( ref l_U638, 0 );
                ...
                while ((l_U686 < 0.12000000) AND (l_U683 == 0))
                {
                    if (NOT (IS_CHAR_DEAD( l_U883 )))
                    {
                ...
                while ((l_U686 < 0.82000000) AND (l_U683 == 0))
                {
                    ...
                    if ((l_U686 > 0.55000000) AND (l_U699 == 0))
                    {
                ...
                SETTIMERA( 0 );
                while ((TIMERA() < 1500) AND (l_U683 == 0))
                {
                    if (l_U684 == 0)
                    {
                        if (NOT (IS_CHAR_DEAD( l_U883 )))
                ...
                while ((l_U685 < 0.98000000) AND (l_U683 == 0))
                {
                    if (sub_48351())
                    {
                        if ((NOT IS_SCREEN_FADING_OUT()) || (NOT IS_SCREEN_FADED_OUT()))
                    ...
                    if ((l_U685 > 0.32000000) AND (l_U692 == 0))
                    {
        ...
        if ((((l_U712 != l_U713) AND (l_U793 == 0)) AND (l_U805 == 0)) AND ((sub_38813( l_U883 )) == 250))
        {
            l_U713 = l_U712;
    ...
    if (((l_U793 == 1) AND (TIMERB() > 1750)) AND (l_U563[2] == 0))
    {
        SET_TIME_SCALE( 1.00000000 );
    ...
    if (DOES_CHAR_EXIST( l_U883 ))
    {
        if (((NOT (IS_GROUP_MEMBER( l_U883, l_U627 ))) AND (l_U793 == 1)) AND (TIMERB() > 2000))
        {
            if (NOT (IS_CHAR_DEAD( l_U882 )))
            {
            ...
            if ((NOT (IS_CHAR_DEAD( l_U883 ))) AND (l_U774 == 0))
            {
                SET_CHAR_COLLISION( l_U883, 1 );
                sub_3617( 1, l_U883, "ROMAN", 0 );
...
void sub_45207()
{
    ...
    if ((NOT (IS_CHAR_INJURED( l_U883 ))) AND (NOT (IS_CHAR_INJURED( l_U882 ))))
    {
...
void sub_47067()
{
    if (DOES_CHAR_EXIST( l_U883 ))
    {
        if ((IS_CHAR_DEAD( l_U883 )) || (IS_CHAR_DEAD( l_U628 )))
        {
            l_U658 = 1;
            l_U656 = -1;
        }
...
void sub_52066()
{
    ...
    if (((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 1191.75800000, 1451.47200000, 30.22480000, 2.00000000, 2.00000000, 2.00000000, 0 )) AND (l_U689 == 0)) AND (l_U563[3] == 0))
    {
    ...
    if (NOT (IS_CHAR_DEAD( l_U883 )))
    {
        if (((IS_CHAR_IN_ANY_CAR( l_U628 )) AND (NOT (IS_GROUP_MEMBER( l_U883, l_U627 )))) AND (l_U563[3] == 0))
        {
    ...
    {
        if (((IS_CHAR_IN_CAR( l_U628, l_U973 )) AND (IS_CHAR_IN_CAR( l_U883, l_U973 ))) || (sub_53516( l_U883, l_U628 )))
        {
            if (DOES_BLIP_EXIST( l_U1014 ))
            {
                REMOVE_BLIP( l_U1014 );
...
void sub_53714()
{
    ...
    if (((TIMERA() > 7500) AND (l_U563[0] == 0)) AND (l_U563[2] == 1))
    {
    ...
    if (NOT (IS_CHAR_DEAD( l_U883 )))
    {
        if ((NOT (IS_CHAR_SITTING_IN_ANY_CAR( l_U883 ))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( l_U628 ))))
        {
            if ((sub_20778( l_U883, l_U628, 1 )) > 30.00000000)
            {
                PRINT_NOW( "FS_36", 1, 0 );
    ...
    if (NOT (IS_CHAR_DEAD( l_U883 )))
    {
        if ((IS_CHAR_IN_ANY_CAR( l_U628 )) AND (NOT (IS_GROUP_MEMBER( l_U883, l_U627 ))))
        {
            CLEAR_CHAR_TASKS( l_U883 );
            GET_PLAYER_GROUP( l_U629, ref l_U627 );
            SET_GROUP_MEMBER( l_U627, l_U883 );
    ...
    if (l_U773 == 0)
    {
        if (NOT (IS_CHAR_DEAD( l_U883 )))
        {
            if ((LOCATE_CHAR_ANY_MEANS_3D( l_U628, 589.73650000, 1385.77400000, 11.65320000, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (IS_GROUP_MEMBER( l_U883, l_U627 )))
            {
                SET_PLAYER_CONTROL( l_U629, 0 );
                REMOVE_BLIP( l_U1016 );
                ...
                CLEAR_AREA_OF_CARS( 594.61820000, 1392.93000000, 9.97300000, 2.60000000 );
                CLEAR_AREA_OF_CARS( 594.58640000, 1399.28800000, 9.95410000, 2.60000000 );
    ...
    if (DOES_CHAR_EXIST( l_U883 ))
    {
        if ((IS_CHAR_DEAD( l_U883 )) || ((IS_CHAR_IN_WATER( l_U883 )) AND (IS_CHAR_INJURED( l_U883 ))))
        {
            PRINT_NOW( "FS_ROMD", 7500, 1 );
            WAIT( 7500 );
            sub_52940( 0, l_U883, 0 );
