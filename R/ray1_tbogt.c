void main()
{
    ...
    while (true)
    {
        ...
        switch (l_U3172)
        {
            ...
            LOAD_SCENE( 781.23660000, -223.71060000, 4.95870000 );
            SET_PLAYER_CONTROL( sub_3898(), 1 );
            sub_44477( 500 );
            ...
            {
                WAIT( 0 );
                if ((IS_CHAR_IN_ANY_CAR( sub_3952() )) AND (NOT l_U3243))
                {
            ...
            if ((IS_CHAR_INJURED( l_U3257[0]._fU4[0] )) AND (IS_CHAR_INJURED( l_U3257[0]._fU4[1] )))
            {
                ...
                else if ((NOT l_U3230) AND (NOT l_U3231))
                {
            ...
            {
                if ((NOT l_U3230) AND (NOT l_U3231))
                {
                    ADD_BLIP_FOR_OBJECT( l_U3531[0]._fU16, ref l_U3531[0]._fU20 );
                    ADD_BLIP_FOR_OBJECT( l_U3531[2]._fU16, ref l_U3531[2]._fU20 );
                    if (l_U3241 == 1)
...
void sub_2463()
{
    ...
    {
        if (((sub_2501( 5, g_U572[I] )) == 1) AND (g_U572[I]._fU20))
        {
...
void sub_5367()
{
    ...
    if (DOES_VEHICLE_EXIST( l_U3187 ))
    {
        ...
        else if ((((VDIST( sub_9097( l_U3187, 1 ), sub_4026( sub_3952(), 1 ) )) > 100.00000000) AND (NOT (IS_CAR_ON_SCREEN( l_U3187 )))) || ((VDIST( sub_9097( l_U3187, 1 ), sub_4026( sub_3952(), 1 ) )) > 300.00000000))
        {
...
int sub_11709(int iParam0)
{
    ...
    if ((NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))) || (IS_CHAR_SITTING_IN_ANY_CAR( sub_3952() )))
    {
        return 0;
    }
    ...
    if (iVar4 == iVar3)
    {
        if (NOT (((sub_11843( iParam0 + 0 )) == 3) AND ((sub_12800( iVar3 )) == sub_12829())))
        {
            if ((((sub_11843( iParam0 + 0 )) != 1) || ((sub_12875( iParam0->_fU0 )) == (sub_12358( 0 )))) || ((sub_12917( sub_3952() )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_3952() )))))
            {
                return 0;
            }
            else
...
void sub_11883(unknown uParam0)
{
    ...
    if (Result == 0)
    {
        if (((((((uParam0^) == (sub_12358( 0 ))) || ((uParam0^) == (sub_12358( 1 )))) || ((uParam0^) == (sub_12358( 6 )))) || ((uParam0^) == (sub_12358( 7 )))) || ((uParam0^) == (sub_12358( 13 )))) || ((uParam0^) == (sub_12358( 16 ))))
        {
            Result = 1;
        }
        else if (((uParam0^) == (sub_12358( 15 ))) || ((uParam0^) == (sub_12358( 17 ))))
        {
            Result = 3;
        }
    }
    ...
    if (Result)
    {
        ...
        if (DOES_CHAR_EXIST( iParam2 ))
        {
            ...
            if (iParam0 != sub_3952())
            {
                ...
                if ((iVar8 == 1) AND (iParam2 != sub_3952()))
                {
        ...
        if (iParam3 != 39)
        {
            if ((iParam3 == 38) AND (IS_CHAR_MODEL( iParam0, sub_12358( 0 ) )))
            {
                if (l_U180)
                {
...
int sub_15231(int iParam0, unknown uParam1, boolean bParam2)
{
    ...
    else if ((sub_12917( iParam0->_fU0 )) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU0 ))))
    {
        return 2;
    }
    else if ((uParam1) || (sub_15309( iParam0, 1 )))
    {
        uVar5 = nil;
        if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
        {
...
void sub_15724(int iParam0)
{
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        {
            if (((sub_15790( (iParam0^) )) AND (NOT l_U162)) AND (NOT l_U163))
            {
                if ((NOT IS_MESSAGE_BEING_DISPLAYED()) AND (NOT sub_15842()))
                {
                    if ((IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )) AND (IS_CHAR_ON_ANY_BIKE( sub_3952() )))
                    {
        ...
        {
            if ((((((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3952(), iParam0->_fU0, l_U153, l_U153, l_U153, 0 ))) || (NOT (IS_CHAR_ON_ANY_BIKE( sub_3952() )))) || (NOT (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU0 )))) || (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3952() )))) || (NOT (sub_17823( l_U155 ))))
            {
                sub_18314( iParam0 );
            }
        }
...
void sub_18596(int iParam0)
{
    ...
    if ((sub_15755( (iParam0^) )) AND (sub_15842()))
    {
        if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
        {
            if (((IS_CHAR_SITTING_IN_CAR( iParam0->_fU0, iParam0->_fU4 )) AND (IS_CHAR_ON_ANY_BIKE( iParam0->_fU0 ))) AND (IS_CHAR_ON_ANY_BIKE( sub_3952() )))
            {
                ...
                {
                    if ((l_U175 != iParam0->_fU0) || (l_U176 != sub_3952()))
                    {
    ...
    if (((sub_15842()) || (sub_15755( (iParam0^) ))) || ((iVar4 - l_U173) < 33))
    {
        return;
    }
    if (l_U173 <= 0)
    ...
    if ((NOT (IS_CHAR_INJURED( iParam0->_fU0 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar12 )))
        {
            if (sub_19523( uVar12 ))
            {
                ...
                if (((NOT (sub_15755( (iParam0^) ))) AND (((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) AND (fVar21 < 19)) || (fVar21 < 15))) AND (iParam0->_fU0 != l_U175))
                {
                    GET_CAR_PITCH( uVar12, ref uVar22 );
                    if ((l_U14) AND ((iParam0->_fU36 != 1) || ((sub_8441( 0, 10 )) == 0)))
                    {
                        l_U14 = 0;
                        iVar15 = 17;
                        iVar11 = sub_3952();
                    }
                    else if ((((sub_19756( iParam0 )) AND (iParam0->_fU36 == 2)) AND ((sub_11843( iParam0 + 0 )) == 1)) AND (NOT (IS_BIT_SET( l_U178, 6 ))))
                    {
                        iVar15 = 38;
                        uVar13 = sub_19870( bVar16 );
                        iVar11 = sub_3952();
                    }
                    else if (((IS_CAR_IN_AIR_PROPER( uVar12 )) AND ((ABSF( uVar22 )) < 20.00000000)) AND (sub_19958( 8 )))
                    {
                        uVar13 = sub_20212( bVar16 );
                        iVar15 = 8;
                    }
                    else if ((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, sub_3952() )) AND (sub_19958( 12 )))
                    {
                        uVar13 = sub_19870( bVar16 );
                        iVar11 = sub_3952();
                        iVar15 = 12;
                    ...
                    else if (((HAS_CAR_BEEN_DAMAGED_BY_CHAR( uVar12, 0 )) || (IS_PED_RAGDOLL( iParam0->_fU0 ))) AND (sub_19958( 13 )))
                    {
                        uVar13 = sub_19870( bVar16 );
                        iVar11 = nil;
                        iVar15 = 13;
                    ...
                    else if (((((sub_11843( iParam0 + 0 )) == 1) AND (NOT (IS_PLAYER_PRESSING_HORN( sub_3898() )))) AND (IS_BIT_SET( l_U178, 7 ))) AND (sub_19958( 20 )))
                    {
                        if (bVar16)
                        {
                            bVar18 = true;
                    ...
                    else if ((((IS_WANTED_LEVEL_GREATER( sub_3898(), 0 )) AND (NOT (IS_BIT_SET( l_U178, 0 )))) AND (sub_19958( 24 ))) AND ((sub_11843( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 24;
                        iVar11 = sub_3952();
                    }
                    else if ((((NOT (IS_WANTED_LEVEL_GREATER( sub_3898(), 0 ))) AND (IS_BIT_SET( l_U178, 0 ))) AND (sub_19958( 30 ))) AND ((sub_11843( iParam0 + 0 )) == 1))
                    {
                        iVar15 = 30;
                    }
                    else
                    {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if (((sub_19958( 33 )) AND (NOT (IS_BIT_SET( l_U178, 4 )))) AND ((sub_11843( iParam0 + 0 )) == 1))
                                {
                            ...
                            else if (IS_CHAR_SITTING_IN_ANY_CAR( sub_3952() ))
                            {
                                ...
                                if (DOES_VEHICLE_EXIST( uVar23 ))
                                {
                                    if (((sub_19958( 31 )) AND (NOT (IS_BIT_SET( l_U178, 4 )))) AND ((sub_11843( iParam0 + 0 )) == 1))
                                    {
                            ...
                            else if ((IS_CHAR_ON_FOOT( sub_3952() )) AND (NOT (IS_PED_RAGDOLL( sub_3952() ))))
                            {
                                CLEAR_BIT( ref l_U178, 3 );
                                CLEAR_BIT( ref l_U178, 4 );
                            };;;
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (GET_CLOSEST_CHAR( uVar5._fU0, uVar5._fU4, uVar5._fU8, 25.00000000, 1, 1, ref iVar11 ))
                            {
                                ...
                                else if ((sub_19958( 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_3898(), 0 ))))
                                {
                                ...
                                else if (((sub_19958( 36 )) AND (IS_WANTED_LEVEL_GREATER( sub_3898(), 0 ))) AND (NOT (IS_BIT_SET( l_U178, 1 ))))
                                {
                                    if (IS_CHAR_ON_SCREEN( iVar11 ))
                                    {
                                        uVar13 = nil;
                                ...
                                else if ((IS_WANTED_LEVEL_GREATER( sub_3898(), 2 )) AND (sub_19958( 23 )))
                                {
                                    uVar13 = nil;
                                    iVar15 = 23;
                                };;;;
                        ...
                        if (iVar15 == 39)
                        {
                            if ((IS_WANTED_LEVEL_GREATER( sub_3898(), 0 )) AND (NOT (IS_BIT_SET( l_U178, 2 ))))
                            {
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            if (IS_VEH_DRIVEABLE( uVar23 ))
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        case 2:
                                        if ((sub_19958( 28 )) AND ((sub_11843( iParam0 + 0 )) == 1))
                                        {
                                            iVar15 = 28;
                                        }
                                        break;
                                        ...
                                        {
                                            if ((sub_19958( 3 )) AND (sub_19958( 4 )))
                                            {
                                                if (g_U15728[13])
                                                {
                                                    iVar15 = 4;
                        ...
                        if (iVar15 == 39)
                        {
                            if (((sub_11843( iParam0 + 0 )) == 1) AND (fVar26 < 5))
                            {
                                if ((sub_19958( 23 )) AND (IS_WANTED_LEVEL_GREATER( sub_3898(), 0 )))
                                {
                                    iVar15 = 23;
                                }
                        ...
                        if (iVar15 == 39)
                        {
                            ...
                            {
                                if ((sub_19958( 30 )) AND ((sub_11843( iParam0 + 0 )) == 1))
                                {
                                    iVar15 = 30;
                                }
    ...
    if ((IS_PLAYER_PRESSING_HORN( sub_3898() )) AND (NOT (IS_BIT_SET( l_U178, 7 ))))
    {
...
int sub_24694(int iParam0)
{
    ...
    if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
    {
        ...
        if (NOT (IS_CAR_DEAD( uVar3 )))
        {
            ...
            if (NOT (IS_CHAR_INJURED( iVar4 )))
            {
                if (((sub_11843( ref iVar4 )) == (sub_11843( iParam0 + 0 ))) || ((iVar4 == sub_3952()) AND ((sub_11843( iParam0 + 0 )) == 1)))
                {
...
void sub_24919(int iParam0, int iParam1)
{
    ...
    if ((iParam0->_fU8 == sub_3952()) AND (iParam1 != sub_3952()))
    {
        if (iParam0->_fU0 == g_U11198)
        {
            g_U11198 = nil;
...
{
    return (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 )) AND (NOT (sub_3861( uParam0, uParam1 )));
}
...
int sub_25906(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((iVar3 == sub_3952()) || ((iVar3 == iParam0->_fU8) AND (NOT (IS_CHAR_INJURED( iVar3 )))))
        {
        ...
        if ((((IS_CHAR_IN_CAR( sub_3952(), iParam0->_fU4 )) || (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((sub_19586( iParam0->_fU0, sub_3952(), 1 )) < 90.00000000))
        {
...
int sub_26642(unknown uParam0)
{
    ...
    if (IS_PED_IN_GROUP( uParam0 ))
    {
        ...
        if (DOES_GROUP_EXIST( iVar3 ))
        {
            ...
            {
                if (((iVar4 < 1) || (iVar5 < 2)) AND (iVar3 != sub_26728()))
                {
                    REMOVE_GROUP( iVar3 );
                }
                else
            ...
            else if ((iVar5 < 1) AND (iVar3 != sub_26728()))
            {
                REMOVE_GROUP( iVar3 );
            }
        }
...
int sub_27074(int iParam0)
{
    ...
    if ((NOT (sub_15309( iParam0, 2 ))) AND (IS_VEH_DRIVEABLE( iParam0->_fU4 )))
    {
        return 0;
    }
...
int sub_27609(int iParam0)
{
    ...
    else if ((((sub_23806( iParam0 )) > 90.00000000) AND (NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 )))) AND ((sub_19586( iParam0->_fU0, sub_3952(), 1 )) > 90.00000000))
    {
        ...
        {
            if (((CAM_IS_SPHERE_VISIBLE( uVar3, uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000 )) || (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar4._fU0, uVar4._fU4, uVar4._fU8, 2.00000000, 2.00000000, 2.00000000 ))) || ((VDIST( sub_4026( sub_3952(), 1 ), uVar4 )) < 30.00000000))
            {
                ;
            }
            else if (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 ))
...
int sub_28224(int iParam0)
{
    ...
    if (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
    {
        if (NOT (IS_PED_IN_COMBAT( iParam0->_fU0 )))
        {
            ...
            if ((iVar3 == 7) AND (NOT (IS_CHAR_FACING_CHAR( iParam0->_fU0, sub_3952(), 45.00000000 ))))
            {
...
int sub_28381(int iParam0)
{
    ...
    if (DOES_VEHICLE_EXIST( iVar4 ))
    {
        if (sub_25015( iParam0->_fU0, iVar4 ))
        {
            ...
            bVar6 = false;
            if ((NOT (IS_CHAR_IN_CAR( sub_3952(), iVar4 ))) AND (NOT (IS_CHAR_GETTING_IN_TO_A_CAR( sub_3952() ))))
            {
    ...
    if ((sub_15309( iParam0, 1 )) AND ((sub_23806( iParam0 )) < 30.00000000))
    {
    ...
    if (iParam0->_fU8 == sub_3952())
    {
        if ((IS_CHAR_ON_FOOT( iParam0->_fU0 )) AND (IS_CHAR_ON_FOOT( sub_3952() )))
        {
    ...
    if ((NOT (IS_CHAR_IN_WATER( iParam0->_fU8 ))) AND ((((IS_CHAR_SITTING_IN_ANY_CAR( iParam0->_fU8 )) || (IS_CHAR_GETTING_IN_TO_A_CAR( iParam0->_fU8 ))) || (DOES_VEHICLE_EXIST( iVar4 ))) || ((sub_19586( iParam0->_fU0, iParam0->_fU8, 1 )) > fVar8)))
    {
        if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
        {
            if ((sub_3861( iParam0->_fU8, iParam0->_fU4 )) || (iParam0->_fU4 == iVar4))
            {
            ...
            else if ((sub_3861( sub_3952(), iParam0->_fU4 )) AND ((sub_11843( iParam0 + 0 )) == 1))
            {
    ...
    else if (((sub_25944( sub_3952(), iParam0->_fU0, 1 )) AND (iParam0->_fU8 != sub_3952())) AND ((sub_11843( iParam0 + 0 )) == 1))
    {
    ...
    if (IS_CHAR_IN_WATER( iParam0->_fU8 ))
    {
        ...
        else if ((NOT (sub_15309( iParam0, 1 ))) || (IS_CHAR_IN_ANY_CAR( iParam0->_fU0 )))
        {
            if ((sub_15417( iParam0 )) != 0)
            {
                ;
    ...
    else if ((sub_15309( iParam0, 1 )) AND (NOT (IS_CHAR_IN_ANY_CAR( iParam0->_fU8 ))))
    {
...
int sub_30134(int iParam0)
{
    ...
    else if ((NOT (IS_CHAR_ON_SCREEN( iParam0->_fU0 ))) AND ((sub_19566( iParam0 )) > 30.00000000))
    {
...
int sub_31990(int iParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( iParam0->_fU4 ))
    {
        ...
        if ((((IS_CHAR_ON_SCREEN( iParam0->_fU0 )) || (IS_CAR_ON_SCREEN( iParam0->_fU4 ))) || ((VDIST( uVar4, uVar10 )) < 30.00000000)) || ((VDIST( uVar4, uVar7 )) < 30.00000000))
        {
            ...
            else if ((iVar3 == sub_3952()) || ((sub_11843( ref iVar3 )) == (sub_11843( iParam0 + 0 ))))
            {
...
int sub_32816(int iParam0)
{
    ...
    if ((((IS_PED_IN_COMBAT( iParam0->_fU0 )) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 110 ))) || (IS_CHAR_RESPONDING_TO_EVENT( iParam0->_fU0, 115 ))) AND ((sub_23806( iParam0 )) < 30.00000000))
    {
        return 2;
    }
    return 0;
...
int sub_32965(int iParam0)
{
    ...
    else if ((iParam0->_fU8 == sub_3952()) AND (IS_CHAR_GETTING_IN_TO_A_CAR( sub_3952() )))
    {
    ...
    if (IS_VEH_DRIVEABLE( uVar10 ))
    {
        ...
        else if (((sub_24334( iParam0->_fU4 )) || (sub_15309( iParam0, 4 ))) AND ((sub_19566( iParam0 )) >= l_U133))
        {
        ...
        if (NOT (IS_CAR_ON_SCREEN( iParam0->_fU4 )))
        {
            ...
            if (GET_CLOSEST_CAR_NODE_WITH_HEADING( vVar9.x, vVar9.y, vVar9.z, ref uVar15._fU0, ref uVar15._fU4, ref uVar15._fU8, ref uVar18 ))
            {
                if (NOT (IS_POINT_OBSCURED_BY_A_MISSION_ENTITY( uVar15._fU0, uVar15._fU4, uVar15._fU8, 4.00000000, 4.00000000, 4.00000000 )))
                {
                    ...
                    if (((NOT (CAM_IS_SPHERE_VISIBLE( uVar19, uVar15._fU0, uVar15._fU4, uVar15._fU8, 6.00000000 ))) AND ((VDIST( uVar15, sub_4026( sub_3952(), 1 ) )) > fParam2)) AND ((VDIST2( uVar15, vVar6 )) > 9.00000000))
                    {
...
void sub_38056()
{
    ...
    if (sub_38065())
    {
        if ((DOES_CHAR_EXIST( l_U3283[0]._fU0 )) AND (DOES_CHAR_EXIST( l_U3283[1]._fU0 )))
        {
            l_U3248 = 1;
        }
        for ( I = 0; I < 2; I++ )
        {
            ...
            if (((NOT (DOES_CHAR_EXIST( l_U3283[I]._fU0 ))) AND (DOES_CHAR_EXIST( g_U11081[I] ))) AND (NOT l_U3248))
            {
                if (I == 0)
                {
                    iVar3 = 1;
            ...
            else if ((DOES_CHAR_EXIST( l_U3283[I]._fU0 )) AND (IS_CHAR_INJURED( l_U3283[I]._fU0 )))
            {
                sub_11490( I + 1 );
                l_U3247++;
...
void sub_40559(int iParam0)
{
    ...
    if (iVar3 == 1)
    {
        ...
        else if ((NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_12358( 6 ) ))) AND (NOT (IS_CHAR_MODEL( iParam0->_fU0, sub_12358( 7 ) ))))
        {
            sub_41003( iParam0 );
        }
    }
...
void sub_42991()
{
    ...
    ADD_SCENARIO_BLOCKING_AREA( 654.53000000, -372.51000000, 0.24000000, 813.45000000, -99.21000000, 6.67000000 );
    if (g_U39149[16] == 0)
    {
        if (g_U15728[29])
        {
...
int sub_44665(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3952() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3952() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_45180()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
...
void sub_47489()
{
    ...
    while ((((((NOT (sub_38298( 1 ))) || (NOT (sub_38298( 2 )))) || (NOT (sub_38298( 3 )))) || (NOT (sub_38298( 4 )))) || (NOT (sub_38298( 5 )))) || (NOT (HAS_MODEL_LOADED( l_U3280 ))))
    {
        WAIT( 0 );
    }
...
void sub_48465(int iParam0, unknown uParam1, int iParam2)
{
    ...
    else
    {
        ...
        if (iVar5 >= 0)
        {
            ...
            sub_48602( vVar6 + (vector( 2.00000000, 0.00000000, 0.00000000)), 0.00000000, uParam1, iParam2 );
...
void sub_49379()
{
    ...
    else if ((TIMERA() > 4000) AND (NOT l_U3246))
    {
        sub_49774();
        l_U3246 = 1;
    }
    ...
    else if ((NOT (IS_VEH_DRIVEABLE( l_U3272 ))) || (sub_51433( l_U3272 )))
    {
        REMOVE_BLIP( l_U3273 );
        REMOVE_BLIP( l_U3174 );
        if (NOT (sub_49405( 0 )))
    ...
    else
    {
        ...
        switch (sub_53341( ref l_U3272, ref l_U3273, "", "" ))
        {
            ...
            if (NOT l_U3239)
            {
                if (((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3952(), l_U3336[0]._fU0, 245.00000000, 45.00000000, 1.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3952(), l_U3336[0]._fU0, 80.00000000, 80.00000000, 1.00000000, 0 ))) AND (IS_CHAR_ON_SCREEN( l_U3336[0]._fU0 )))
                {
                    REMOVE_BLIP( l_U3174 );
                    sub_53829( 6 );
                    l_U3239 = 1;
                    ...
                    for ( I = 0; I < l_U3336; I++ )
                    {
                        if ((NOT (IS_CHAR_INJURED( l_U3336[I]._fU0 ))) AND (IS_VEH_DRIVEABLE( l_U3336[I]._fU4 )))
                        {
            ...
            {
                if ((sub_49405( 1 )) || ((NOT (sub_49405( 1 ))) AND (sub_54486() == 4)))
                {
                    if (l_U3239)
                    {
            ...
            if (((VDIST( uVar17, sub_4026( sub_3952(), 1 ) )) < 8.00000000) || (IS_KEYBOARD_KEY_JUST_PRESSED( 36 )))
            {
            ...
            else if (l_U3239)
            {
                ...
                for ( I = 0; I < l_U3336; I++ )
                {
                    ...
                    {
                        if ((((sub_19566( ref l_U3336[I] )) < 3.00000000) AND (IS_CHAR_SITTING_IN_ANY_CAR( l_U3336[I]._fU0 ))) AND (NOT l_U3519[I]))
                        {
...
int sub_50404()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if (((sub_2501( 1, g_U572[I] )) != 0) AND (g_U572[I]._fU20))
        {
            sub_2787( I );
            return 1;
        }
...
void sub_53883(int iParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4)
{
    ...
    if (NOT (IS_CHAR_INJURED( iParam0->_fU0 )))
    {
        ...
        else if ((iParam0->_fU36 == 4) AND ((VDIST( iParam0->_fU16, sub_4026( iParam0->_fU0, 1 ) )) < 12.00000000))
        {
            return;
        }
...
void sub_55658(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3952() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_55818())) AND (iVar3 != 4))
    {
...
void sub_56320(unknown uParam0, int iParam1, boolean bParam2)
{
    ...
    {
        iVar31[I] = -1;
        uVar52[I] = sub_56919( uParam0, ref uVar21[I], ref iVar6, (bVar17) || (NOT bParam2) );
        if (uVar52[I] >= 0)
        {
    ...
    if (uVar52[0] == uVar52[1])
    {
        ...
        J = (J + 1) mod 2;
        uVar52[J] = sub_56919( uParam0, ref uVar21[J], ref iVar6, (bVar17) || (NOT bParam2) );
        if (uVar52[J] >= 0)
        {
...
void sub_59372()
{
    ...
    if ((((NOT (IS_VEH_DRIVEABLE( l_U3272 ))) || (sub_52917( l_U3272 ))) || (sub_51433( l_U3272 ))) || (sub_62465( l_U3272 )))
    {
        REMOVE_BLIP( l_U3273 );
        REMOVE_BLIP( l_U3174 );
        if (NOT (sub_49405( 0 )))
    ...
    switch (sub_53341( ref l_U3272, ref l_U3273, "", "" ))
    {
        ...
        if (((LOCATE_CHAR_IN_CAR_3D( sub_3952(), l_U3527._fU0, l_U3527._fU4, l_U3527._fU8 + 2.50000000, 2.50000000, 2.50000000, 5.00000000, 1 )) || (sub_63312())) AND (sub_42393( 1, 1 )))
        {
        ...
        {
            if ((sub_17823( l_U3221 )) AND (sub_63492( l_U3221 )))
            {
        ...
        else if ((((TIMERA() > 10000) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (NOT (sub_17823( l_U3221 )))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U3336[0]._fU0, sub_3952(), 25, 25, 25, 0 )))
        {
            if (g_U39239 == 0)
            {
        ...
        if (((l_U3245) AND (NOT (sub_63492( l_U3221 )))) AND (sub_17823( l_U3221 )))
        {
...
void sub_59385(unknown uParam0)
{
    ...
    if ((((((((IS_CONTROL_PRESSED( 0, 51 )) AND (NOT (IS_CONTROL_PRESSED( 0, 38 )))) AND (NOT (IS_CONTROL_PRESSED( 0, 39 )))) AND (IS_CHAR_ON_ANY_BIKE( sub_3952() ))) AND (NOT sub_55818())) AND (NOT (iVar14 == 4))) AND (iVar8 >= 0)) AND (NOT bVar4))
    {
...
void sub_59612(unknown uParam0)
{
    ...
    {
        if (((sub_59646( uParam0, I )) AND (I != l_U20)) AND (Result < 0))
        {
            Result = I;
        }
    }
...
int sub_59646(unknown uParam0, int iParam1)
{
    ...
    if (((NOT (IS_CHAR_INJURED( (uParam0^)[iParam1]._fU0 ))) AND (IS_VEH_DRIVEABLE( (uParam0^)[iParam1]._fU4 ))) AND (NOT (IS_CHAR_IN_ANY_POLICE_VEHICLE( sub_3952() ))))
    {
        if (((NOT (IS_CHAR_IN_CAR( sub_3952(), (uParam0^)[iParam1]._fU4 ))) AND (IS_CHAR_IN_CAR( (uParam0^)[iParam1]._fU0, (uParam0^)[iParam1]._fU4 ))) AND (IS_CHAR_ON_ANY_BIKE( (uParam0^)[iParam1]._fU0 )))
        {
...
boolean sub_63312()
{
    return (IS_CHAR_IN_AREA_3D( sub_3952(), 654.53000000, -372.51000000, 0.24000000, 801.62000000, -184.86000000, 6.12000000, 0 )) || (LOCATE_CHAR_IN_CAR_3D( sub_3952(), l_U3527._fU0, l_U3527._fU4, l_U3527._fU8 + 2.00000000, 2.50000000, 2.50000000, 5.00000000, 0 ));
}
...
void sub_64576()
{
    ...
    sub_38265( 2 );
    LOAD_ALL_OBJECTS_NOW();
    while ((((NOT (HAS_MODEL_LOADED( l_U3177 ))) || (NOT (HAS_MODEL_LOADED( l_U3179 )))) || (NOT (HAS_MODEL_LOADED( l_U3256 )))) || (NOT (HAS_MODEL_LOADED( l_U3180 ))))
    {
        WAIT( 0 );
    }
    if (sub_65887())
    ...
    if (((IS_VEH_DRIVEABLE( l_U3187 )) AND (NOT (IS_CHAR_INJURED( l_U3188 )))) AND (NOT (IS_CHAR_INJURED( l_U3189 ))))
    {
    ...
    SET_CHAR_COORDINATES( sub_3952(), 781.23660000, -225.71060000, 4.95870000 );
    ...
    CLEAR_AREA_OF_COPS( 878.34000000, 65185, 17, 20.00000000 );
    SET_ZONE_NO_COPS( GET_NAME_OF_ZONE( 878.34000000, 65185, 17 ), 1 );
    MARK_MODEL_AS_NO_LONGER_NEEDED( l_U3279 );
    MARK_MODEL_AS_NO_LONGER_NEEDED( l_U3281 );
    REMOVE_CAR_RECORDING( 2300 );
    REMOVE_CAR_RECORDING( 2297 );
...
void sub_64954(int iParam0, boolean bParam1)
{
    ...
    if ((DOES_CHAR_EXIST( iParam0->_fU0 )) AND (iParam0->_fU0 != sub_3952()))
    {
...
void sub_70250()
{
    ...
    l_U1995[0] = 83136452;
    l_U2223[1] = {773.50150000, -397.02800000, 5.72100000};
    l_U424[1] = 0.01560000;
    l_U575[1] = -0.00130000;
    l_U726[1] = -0.11690000;
    l_U877[1] = 0.99300000;
    ...
    l_U1995[4] = 83136452;
    l_U2223[5] = {931.18260000, -301.43190000, 17.74690000};
    l_U424[5] = -0.01720000;
    l_U575[5] = -0.01690000;
    l_U726[5] = 0.71530000;
    l_U877[5] = 0.69840000;
    ...
    l_U1995[60] = 0;
    l_U2223[61] = {91.28390000, -405.37750000, 14.40990000};
...
void sub_81526()
{
    if (NOT (IS_CAR_DEAD( l_U3187 )))
    {
        ...
        {
            if ((NOT (IS_CAR_DEAD( l_U3274 ))) AND (NOT (IS_CHAR_INJURED( l_U3275[0] ))))
            {
...
void sub_84967()
{
    ...
    if (IS_CHAR_INJURED( l_U3188 ))
    {
        ...
        if (NOT l_U3227)
        {
            if ((NOT (IS_CHAR_INJURED( l_U3275[0] ))) AND (IS_VEH_DRIVEABLE( l_U3274 )))
            {
    ...
    else if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3952(), l_U3188, 190.00000000, 170.00000000, 170.00000000, 0 ))) || ((((IS_CONTROL_PRESSED( 0, 6 )) || (IS_CONTROL_PRESSED( 0, 87 ))) AND (IS_CHAR_ON_SCREEN( l_U3188 ))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3952(), l_U3188, 250.00000000, 250.00000000, 250.00000000, 0 )))))
    {
        sub_5367();
        l_U3172 = 12;
    }
    else if (IS_CHAR_IN_ANY_CAR( l_U3188 ))
    {
        ...
        if ((sub_99793( l_U3187 )) || (IS_CHAR_INJURED( l_U3189 )))
        {
        ...
        else if ((LOCATE_CHAR_IN_CAR_CHAR_3D( sub_3952(), l_U3188, 25.00000000, 25.00000000, 12.00000000, 0 )) AND (NOT (sub_17823( l_U3221 ))))
        {
            if (TIMERA() > 12000)
            {
            ...
            else if (((TIMERB() > 5000) AND (IS_CAR_DEAD( l_U3274 ))) AND (NOT (IS_CHAR_INJURED( l_U3190 ))))
            {
                if ((IS_CHAR_IN_CAR( l_U3190, l_U3187 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U3190, sub_3952(), 25, 25, 12, 0 )))
                {
                    if ((IS_CONTROL_PRESSED( 0, 38 )) || (IS_CONTROL_PRESSED( 0, 39 )))
                    {
                        switch (sub_8441( 0, 2 ))
                        {
                            case 0:
    ...
    else
    {
        ...
        if (NOT l_U3244)
        {
            if (((NOT sub_15842()) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U3188 )))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( sub_3952() ))))
            {
        ...
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3952(), l_U3188, 25.00000000, 25.00000000, 25.00000000, 0 )) AND (NOT l_U3251))
        {
            switch (sub_8441( 0, 3 ))
            {
                case 0:
...
void sub_84976()
{
    ...
    for ( I = 0; I < 2; I++ )
    {
        if ((DOES_VEHICLE_EXIST( l_U3195[I] )) || (DOES_CHAR_EXIST( l_U3198[I] )))
        {
            ...
            if ((NOT (IS_VEH_DRIVEABLE( l_U3195[I] ))) || (IS_CHAR_INJURED( l_U3198[I] )))
            {
                if (DOES_VEHICLE_EXIST( l_U3195[I] ))
                {
                    MARK_CAR_AS_NO_LONGER_NEEDED( ref l_U3195[I] );
            ...
            else if (((VDIST( sub_4026( l_U3198[I], 1 ), sub_4026( sub_3952(), 1 ) )) > 90.00000000) AND (NOT (IS_CHAR_ON_SCREEN( l_U3198[I] ))))
            {
                if (DOES_CHAR_EXIST( l_U3198[I] ))
                {
                ...
                if (DOES_VEHICLE_EXIST( l_U3195[I] ))
                {
                    if (((VDIST( sub_9097( l_U3195[I], 1 ), sub_4026( sub_3952(), 1 ) )) > 85.00000000) AND (NOT (IS_CAR_ON_SCREEN( l_U3195[I] ))))
                    {
...
void sub_86042(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U375)
    {
        ...
        if ((l_U1553 == 0) || (IS_SCREEN_FADED_OUT()))
        {
            iVar10 = 1;
        }
        if ((iVar10) AND (NOT l_U397))
        {
            if (NOT l_U363)
            {
...
void sub_87924(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 150; I++ )
        {
            ...
            if (l_U1724[I] == 0)
            {
                if (((l_U1573[I] > 0) AND (l_U1573[I] < 3000)) AND (NOT (l_U1995[I] == 0)))
                {
                    if (NOT l_U363)
                    {
            ...
            if (l_U1724[I] == 2)
            {
                if (HAS_MODEL_LOADED( l_U1995[I] ))
                {
                    if (NOT (DOES_VEHICLE_EXIST( l_U2919[I] )))
                    {
                        ...
                        {
                            bVar17 = false;
                            if ((NOT (sub_87451( l_U2223[I], 5.00000000, 1120403456 ))) AND (NOT (sub_89240( l_U2223[I] ))))
                            {
                                bVar17 = true;
                            }
                            if (l_U389)
                        ...
                        if (8 > l_U1978)
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1573[I] ))
                            {
                                if (fVar14 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1573[I] )))
                                {
                                    ...
                                    if ((NOT (sub_87451( uVar8, 5.00000000, 1120403456 ))) AND (sub_87451( uVar11, 5.00000000, 1120403456 )))
                                    {
                                        sub_88324( I, 1090519040 );
                                    }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U2919[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_3898() ))
                                {
                                    if ((((IS_CHAR_TOUCHING_VEHICLE( sub_3952(), l_U2919[I] )) AND (NOT l_U369)) AND (NOT l_U366)) AND (NOT l_U378))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_3952() ))
                                        {
                                            bVar16 = false;
                                    ...
                                    else if ((sub_92097( uParam0, l_U2919[I] )) AND (NOT l_U378))
                                    {
                                        sub_91970( l_U2919[I] );
                                        l_U1724[I]++;
                                    }
        ...
        if (IS_PLAYER_PLAYING( sub_3898() ))
        {
            ...
            for ( I = 0; I < 150; I++ )
            {
                ...
                if (DOES_VEHICLE_EXIST( l_U2919[I] ))
                {
                    if (IS_VEH_DRIVEABLE( l_U2919[I] ))
                    {
                        if ((sub_93552( l_U2919[I], (uParam0^) )) || (sub_93552( l_U2919[I], uVar6 )))
                        {
            ...
            if (l_U1927[I] == 1)
            {
                if (6 > l_U1981)
                {
                    if (HAS_MODEL_LOADED( l_U2146[I] ))
                    {
                        ...
                        {
                            if (((NOT (sub_87451( l_U2674[I], 5.00000000, 1120403456 ))) || (l_U363)) || (l_U389))
                            {
                                if (l_U382)
                                {
...
void sub_95414(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 25; I++ )
        {
            if (((l_U1875[I] > 0) AND (l_U1875[I] < 3000)) AND (NOT (l_U2197[I] == 0)))
            {
                if (l_U1901[I] == 0)
                {
                    if (NOT l_U363)
                ...
                if (l_U1901[I] == 2)
                {
                    if (HAS_MODEL_LOADED( l_U2197[I] ))
                    {
                        if (NOT (DOES_VEHICLE_EXIST( l_U3130[I] )))
                        {
                            ...
                            if (bVar15)
                            {
                                if ((NOT (sub_87451( l_U2825[I], 5.00000000, 1120403456 ))) || (l_U389))
                                {
                            ...
                            if (4 > l_U1980)
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U1875[I] ))
                                {
                                    if (fVar13 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U1875[I] )))
                                    {
                                        ...
                                        if (((NOT (sub_87451( uVar7, 5.00000000, 1120403456 ))) AND (sub_87451( uVar10, 5.00000000, 1120403456 ))) AND (NOT l_U389))
                                        {
                                            l_U1980++;
                                            l_U1901[I]++;
                                        }
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U3130[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_3898() ))
                                    {
                                        if (((IS_CHAR_TOUCHING_VEHICLE( sub_3952(), l_U3130[I] )) AND (NOT l_U369)) AND (NOT l_U366))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_3952() ))
                                            {
                                                bVar15 = false;
...
int sub_99138(unknown uParam0, unknown uParam1)
{
    ...
    if (((l_U1992 == 0) AND (l_U1993 == 0)) AND (l_U1994 == 0))
    {
        l_U366 = 0;
        l_U363 = 0;
        l_U392 = 0;
...
void sub_99683()
{
    ...
    if (IS_VEH_DRIVEABLE( l_U3187 ))
    {
        ...
        else if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U3187 ))
        {
            if (NOT l_U3229)
            {
                if ((sub_99793( l_U3187 )) || (LOCATE_CAR_3D( l_U3187, -50.42000000, -312.59000000, 14.24000000, 10.00000000, 10.00000000, 10.00000000, 0 )))
                {
...
int sub_99793(unknown uParam0)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        ...
        if ((iVar3 > 2) AND (NOT (IS_CAR_HEALTH_GREATER( uParam0, 500 ))))
        {
            return 1;
        }
    }
...
void sub_100432()
{
    if ((IS_VEH_DRIVEABLE( l_U3187 )) AND (NOT l_U3565))
    {
...
void sub_100617()
{
    ...
    if (DOES_VEHICLE_EXIST( l_U3274 ))
    {
        ...
        else if ((l_U3227 == 1) AND (NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U3275[0], sub_3952(), 140.00000000, 140.00000000, 140.00000000, 0 ))))
        {
            sub_9324();
        }
        else if ((IS_CHAR_INJURED( l_U3275[1] )) AND (NOT (IS_CHAR_INJURED( l_U3275[2] ))))
        {
        ...
        for ( I = 0; I < l_U3275; I++ )
        {
            if ((TIMERB() > 4500) AND (NOT (sub_17823( l_U3221 ))))
            {
                if (NOT (IS_CHAR_INJURED( l_U3275[I] )))
                {
                    if ((IS_CHAR_IN_CAR( l_U3275[I], l_U3274 )) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U3275[I], sub_3952(), 25, 25, 12, 0 )))
                    {
                        if ((IS_CONTROL_PRESSED( 0, 38 )) || (IS_CONTROL_PRESSED( 0, 39 )))
                        {
                            switch (sub_8441( 0, 2 ))
...
void sub_103705()
{
    ...
    {
        if ((IS_ANY_CHAR_SHOOTING_IN_AREA( vVar2 - (vector( 30.00000000, 30.00000000, 30.00000000)), vVar2 + (vector( 30.00000000, 30.00000000, 30.00000000)), 0 )) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_3898(), 0 ))))
        {
    ...
    else
    {
        switch (sub_104075())
        {
            ...
            FLASH_BLIP( l_U3531[2]._fU20, 0 );
            WAIT( 2000 );
            if ((l_U3241 == 1) AND (NOT (IS_WANTED_LEVEL_GREATER( sub_3898(), 0 ))))
            {
                PRINT_NOW( "R1_STASH1", 7500, 0 );
                l_U3241 = 0;
            }
...
void sub_104652()
{
    ...
    if ((sub_103718( ref l_U3215 )) AND (l_U3227))
    {
        if ((NOT (HAS_MODEL_LOADED( l_U3256 ))) || (NOT (HAS_MODEL_LOADED( l_U3180 ))))
        {
            REQUEST_MODEL( l_U3256 );
            REQUEST_MODEL( l_U3180 );
            sub_102006( ref l_U3215, 100 );
        }
        else if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3952(), l_U3531[0]._fU0._fU0, l_U3531[0]._fU0._fU4, l_U3531[0]._fU0._fU8, 120.00000000, 120.00000000, 30.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3952(), l_U3531[2]._fU0._fU0, l_U3531[2]._fU0._fU4, l_U3531[2]._fU0._fU8, 120.00000000, 120.00000000, 30.00000000, 0 )))
        {
            sub_102006( ref l_U3215, 100 );
        }
...
void sub_104675(unknown uParam0)
{
    ...
    for ( I = 0; I < (uParam0^); I++ )
    {
        if ((DOES_CHAR_EXIST( (uParam0^)[I]._fU4[0] )) || (DOES_CHAR_EXIST( (uParam0^)[I]._fU4[1] )))
        {
            ...
            if ((IS_CHAR_INJURED( (uParam0^)[I]._fU4[0] )) AND (IS_CHAR_INJURED( (uParam0^)[I]._fU4[1] )))
            {
...
void sub_105251(int iParam0)
{
    ...
    if (DOES_VEHICLE_EXIST( uVar11 ))
    {
        ...
        if ((uVar12._fU0 < 0.00000000) || (NOT (sub_19523( uVar11 ))))
        {
...
void sub_105664()
{
    ...
    if (NOT (IS_CAR_DEAD( uVar5 )))
    {
        if (((sub_10766( uVar5 )) == 0) AND (IS_CHAR_SITTING_IN_CAR( sub_3952(), uVar5 )))
        {
    ...
    while (bVar7)
    {
        ...
        else if ((TIMERA() > 500) AND (sub_106629()))
        {
            bVar7 = false;
        }
    }
...
void sub_107144()
{
    ...
    {
        WAIT( 0 );
        if (((TIMERA() > 6000) AND (NOT (IS_CHAR_PLAYING_ANIM( sub_3952(), "MISSRAYB_1", "stash" )))) AND (NOT (IS_CHAR_PLAYING_ANIM( sub_3952(), "MISSRAYB_1", "bike_stash" ))))
        {
            bVar7 = false;
        }
        else if ((TIMERA() > 500) AND (sub_106629()))
...
void sub_119202(boolean bParam0)
{
    ...
    for ( I = 0; I < 5; I++ )
    {
        if (((bParam0) AND (I > 1)) || (NOT bParam0))
        {
            iVar6 = sub_119251( I + 1 );
            if ((iVar6 >= 0) AND (iVar6 < iVar5))
            {
                Result = I + 1;
                iVar5 = iVar6;
            }
