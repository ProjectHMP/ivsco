...
void sub_184()
{
    ...
    if (((IS_CHAR_IN_MODEL( sub_1782(), -960289747 )) || (IS_CHAR_IN_ANY_TRAIN( sub_1782() ))) || (IS_CHAR_IN_ANY_HELI( sub_1782() )))
    {
        g_U43132 = 0;
    ...
    while ((IS_THREAD_ACTIVE( uVar11 )) AND (NOT IS_SCREEN_FADED_IN()))
    {
        WAIT( 0 );
    }
