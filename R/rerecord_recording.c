void main()
{
    ...
    while (true)
    {
        switch (l_U188)
        {
            ...
            if ((l_U198) AND (l_U199))
            {
                if (l_U196)
                {
                    if (IS_PLAYER_PLAYING( sub_611() ))
                    {
                        if ((DOES_VEHICLE_EXIST( l_U212 )) AND (DOES_VEHICLE_EXIST( l_U213 )))
                        {
                            if ((NOT (IS_CAR_DEAD( l_U212 ))) AND (NOT (IS_CAR_DEAD( l_U213 ))))
                            {
                                if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U212 ))
                                {
            ...
            if ((NOT (l_U190 > 0)) AND (NOT (l_U190 <= 3000)))
            {
            ...
            if ((NOT (l_U189 > 0)) AND (NOT (l_U189 < 3000)))
            {
            ...
            while (((NOT (HAS_CAR_RECORDING_BEEN_LOADED( l_U189 ))) || (NOT (HAS_MODEL_LOADED( l_U210 )))) || (NOT (HAS_MODEL_LOADED( sub_4594() ))))
            {
                WAIT( 0 );
            }
            ...
            while ((NOT (sub_4912( l_U212, l_U189 ))) || (NOT (sub_4912( l_U213, l_U189 ))))
            {
                WAIT( 0 );
            }
            l_U200 = 0;
