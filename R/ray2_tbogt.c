...
void sub_2501()
{
    ...
    {
        if (((sub_2539( 5, g_U572[I] )) == 1) AND (g_U572[I]._fU20))
        {
...
void sub_3974()
{
    ...
    {
        if ((NOT (IS_CHAR_ON_SCREEN( l_U813 ))) || (IS_SCREEN_FADED_OUT()))
        {
    ...
    for ( I = 0; I <= 0; I++ )
    {
        ...
        {
            if ((NOT (IS_CHAR_ON_SCREEN( l_U814[I] ))) || (IS_SCREEN_FADED_OUT()))
            {
    ...
    for ( I = 0; I <= 1; I++ )
    {
        ...
        {
            if ((NOT (IS_CAR_ON_SCREEN( l_U870[I] ))) || (IS_SCREEN_FADED_OUT()))
            {
...
void sub_5484()
{
    ...
    CREATE_PICKUP_ROTATE( 1069950328, 22, 200, -98.84000000, 854.75000000, 26.10000000, 0, 0, 0, ref l_U391 );
...
void sub_9436()
{
    ...
    CREATE_CAR( l_U878, -61.28390000, 803.44560000, 13.52400000, ref l_U861[3], 1 );
...
void sub_11052()
{
    ...
    if ((IS_WANTED_LEVEL_GREATER( l_U1063, 0 )) AND (l_U434 == 1))
    {
    ...
    if ((NOT (IS_WANTED_LEVEL_GREATER( l_U1063, 0 ))) AND (l_U434 == 0))
    {
        if (NOT (DOES_BLIP_EXIST( l_U540 )))
        {
            ADD_BLIP_FOR_COORD( l_U527._fU0, l_U527._fU4, l_U527._fU8, ref l_U540 );
    ...
    {
        SET_STATE_OF_CLOSEST_DOOR_OF_TYPE( 419786306, 65439, 878, 15, 0, 0.00000000 );
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, l_U527._fU0, l_U527._fU4, l_U527._fU8 + 2.00000000, 2.50000000, 2.50000000, 2.50000000, 1 )) || (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -97.33060000, 879.78090000, 13.81980000 + 2.00000000, 2.50000000, 2.50000000, 2.50000000, 0 )))
        {
            if (DOES_BLIP_EXIST( l_U540 ))
            {
                REMOVE_BLIP( l_U540 );
    ...
    sub_12490();
    sub_13421();
    if ((sub_13783()) || ((NOT (IS_CHAR_INJURED( g_U11081[0] ))) AND (NOT (IS_CHAR_INJURED( g_U11081[1] )))))
    {
        l_U1042 = 1;
    }
    return;
...
void sub_11981()
{
    ...
    if (l_U435[0] == 0)
    {
        if (NOT (IS_CAR_DEAD( l_U861[0] )))
        {
            ...
            if ((((l_U366 < 750) AND (NOT (IS_CHAR_IN_CAR( l_U1062, l_U861[0] )))) AND (NOT (IS_CHAR_TOUCHING_VEHICLE( l_U1062, l_U861[0] )))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U1062, l_U861[0], 7.50000000, 7.50000000, 7.50000000, 0 ))))
            {
    ...
    for ( I = 1; I <= 4; I++ )
    {
        if (l_U435[0] == 0)
        {
            if (NOT (IS_CAR_DEAD( l_U861[I] )))
            {
                ...
                if ((((l_U366 < (300 - ((I) XOR (4)))) AND (NOT (IS_CHAR_IN_CAR( l_U1062, l_U861[I] )))) AND (NOT (IS_CHAR_TOUCHING_VEHICLE( l_U1062, l_U861[I] )))) AND (NOT (LOCATE_CHAR_ANY_MEANS_CAR_3D( l_U1062, l_U861[I], 8.00000000, 8.00000000, 8.00000000, 0 ))))
                {
...
void sub_12490()
{
    if ((DOES_CHAR_EXIST( l_U690 )) AND (l_U401 == 0))
    {
        ...
        else if ((DOES_CHAR_EXIST( l_U690 )) AND (IS_CHAR_INJURED( l_U690 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U690 )))
            {
                SET_CHAR_RELATIONSHIP( l_U690, 5, 0 );
        ...
        if (IS_CHAR_ON_ANY_BIKE( l_U1062 ))
        {
            ...
            if (NOT (IS_CAR_DEAD( uVar2 )))
            {
                if (sub_13489( uVar2 ))
                {
                    ...
                    if (((((NOT (IS_CAR_ON_FIRE( uVar2 ))) AND (iVar3 > 300)) AND (NOT (IS_CAR_TYRE_BURST( uVar2, 6 )))) AND (NOT (IS_CAR_TYRE_BURST( uVar2, 7 )))) AND (NOT (IS_CAR_A_MISSION_CAR( uVar2 ))))
                    {
                        l_U867 = uVar2;
...
int sub_13489(unknown uParam0)
{
    ...
    if (NOT (IS_CAR_DEAD( uParam0 )))
    {
        ...
        if (((((((iVar3 == -159126838) || (iVar3 == 301427732)) || (iVar3 == -570033273)) || (iVar3 == -408052231)) || (iVar3 == 584879743)) || (iVar3 == 802082487)) || (iVar3 == -359167535))
        {
            return 1;
        }
    }
...
void sub_13926()
{
    ...
    sub_17041();
    if ((l_U985 == 0) AND (l_U451 == 1))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -108.37790000, 845.44200000, 17.62490000, 16.20735000, 0.34835000, 10, 0 ))
        {
            sub_20311( "E1R2_ARRV", ref l_U1064, 1, 0 );
            l_U985 = 1;
        }
    }
    if ((l_U453[0] == 0) AND (NOT (IS_CHAR_INJURED( l_U797[0] ))))
    {
    ...
    if (((l_U453[0] == 1) AND (l_U453[1] == 0)) AND (NOT (IS_CHAR_INJURED( l_U797[0] ))))
    {
    ...
    if ((l_U453[2] == 0) AND (NOT (IS_CHAR_INJURED( l_U797[2] ))))
    {
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U1062, l_U797[2], 1.50000000, 1.50000000, 1.50000000, 0 )) AND (NOT (sub_21801( l_U1064 ))))
        {
    ...
    if ((l_U453[3] == 0) AND (NOT (IS_CHAR_INJURED( l_U797[4] ))))
    {
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U1062, l_U797[4], 2.50000000, 2.50000000, 2.50000000, 0 )) AND (NOT (sub_21801( l_U1064 ))))
        {
    ...
    if ((l_U453[4] == 0) AND (NOT (IS_CHAR_INJURED( l_U797[8] ))))
    {
    ...
    if ((l_U453[5] == 0) AND (NOT (IS_CHAR_INJURED( l_U797[5] ))))
    {
    ...
    if ((l_U453[6] == 0) AND (NOT (IS_CHAR_INJURED( l_U797[9] ))))
    {
    ...
    if ((l_U453[7] == 0) AND (NOT (IS_CHAR_INJURED( l_U797[10] ))))
    {
    ...
    if ((l_U453[8] == 0) AND (NOT (IS_CHAR_INJURED( l_U797[14] ))))
    {
    ...
    if ((l_U453[9] == 0) AND (NOT (IS_CHAR_INJURED( l_U797[6] ))))
    {
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U1062, l_U797[6], 4.00000000, 4.00000000, 3.00000000, 0 )) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U797[5] ))))
        {
            SAY_AMBIENT_SPEECH( l_U797[6], "GANG_WATCH_THIS_GUY", 1, 0, 0 );
            l_U453[9] = 1;
        }
    }
    if (((l_U453[10] == 0) AND (l_U453[9] == 1)) AND (NOT (IS_CHAR_INJURED( l_U797[7] ))))
    {
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U1062, l_U797[7], 6.00000000, 6.00000000, 3.00000000, 0 )) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( l_U797[6] ))))
        {
    ...
    sub_23259();
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -107.45770000, 764.30180000, 14.32990000 + 1.50000000, 1.60000000, 1.60000000, 1.60000000, 1 )) AND (sub_23940( 1, 1 )))
    {
        g_U10956 = 1;
        l_U362++;
        if (DOES_BLIP_EXIST( l_U545 ))
...
void sub_13975()
{
    ...
    if ((NOT (IS_CHAR_INJURED( l_U797[0] ))) AND (NOT (IS_CHAR_INJURED( l_U797[1] ))))
    {
        TASK_CHAT_WITH_CHAR( l_U797[0], l_U797[1], 1, 1 );
        TASK_CHAT_WITH_CHAR( l_U797[1], l_U797[0], 0, 1 );
    }
    if ((NOT (IS_CHAR_INJURED( l_U797[3] ))) AND (NOT (IS_CHAR_INJURED( l_U797[4] ))))
    {
        TASK_CHAT_WITH_CHAR( l_U797[3], l_U797[4], 1, 1 );
        TASK_CHAT_WITH_CHAR( l_U797[4], l_U797[3], 0, 1 );
    }
    if ((NOT (IS_CHAR_INJURED( l_U797[6] ))) AND (NOT (IS_CHAR_INJURED( l_U797[7] ))))
    {
        TASK_CHAT_WITH_CHAR( l_U797[6], l_U797[7], 1, 1 );
        TASK_CHAT_WITH_CHAR( l_U797[7], l_U797[6], 0, 1 );
    }
    if ((NOT (IS_CHAR_INJURED( l_U797[12] ))) AND (NOT (IS_CHAR_INJURED( l_U797[13] ))))
    {
    ...
    if (l_U1036 == 0)
    {
        if (l_U1037 == 0)
        {
            if (sub_13783())
            {
                ...
                if (((l_U365 == 0) AND (l_U423 == 1)) || (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -99.50985000, 875.25110000 - 2, 13.68480000, 6.58310000, 4.26400000, 10, 0 )))
                {
                    if (NOT (IS_CHAR_INJURED( g_U11081[0] )))
                    {
                        if ((l_U1038 == 0) AND (l_U1040 == 1))
                        {
        ...
        switch (l_U1043)
        {
            ...
            if ((NOT (IS_CHAR_INJURED( g_U11081[0] ))) AND (NOT (IS_CHAR_INJURED( g_U11081[1] ))))
            {
                if ((LOCATE_CHAR_ANY_MEANS_3D( g_U11081[0], -78.45590000, 877.37820000, 13.68360000, 10, 10, 10, 0 )) AND (LOCATE_CHAR_ANY_MEANS_3D( g_U11081[1], -78.45590000 - 1, 877.37820000 - 3, 13.68360000, 10, 10, 10, 0 )))
                {
                    l_U1043++;
                }
            }
            if ((l_U1058[1] == 0) AND (NOT IS_HELP_MESSAGE_BEING_DISPLAYED()))
            {
...
void sub_17847(int iParam0, int iParam1)
{
    ...
    if ((iParam0->_fU8 == sub_3862()) AND (iParam1 != sub_3862()))
    {
        if (iParam0->_fU0 == g_U11198)
        {
            g_U11198 = nil;
...
{
    return (IS_CHAR_SITTING_IN_CAR( uParam0, uParam1 )) AND (NOT (sub_17967( uParam0, uParam1 )));
}
...
void sub_23259()
{
    ...
    for ( I = 0; I <= 14; I++ )
    {
        ...
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U797[I], l_U1062, 0 )) || (IS_CHAR_INJURED( l_U797[I] )))
            {
                l_U452 = 1;
            }
        }
    ...
    {
        if ((((l_U365 == 2004012895) || (l_U365 == -1975100134)) || (l_U365 == -1611808994)) || (l_U365 == 193674066))
        {
            l_U368++;
            if (l_U368 > 3)
            {
...
void sub_24325()
{
    ...
    if (NOT (IS_CAR_DEAD( l_U867 )))
    {
        ...
        if (((LOCATE_CAR_3D( l_U867, -106.76030000, 762.18690000, 14.29030000, 25.00000000, 25.00000000, 10.00000000, 0 )) || (LOCATE_CAR_3D( l_U867, l_U527._fU0, l_U527._fU4, l_U527._fU8, 10.00000000, 10.00000000, 10.00000000, 0 ))) || (l_U896 != nil))
        {
            PRINTSTRING( "\n\n -----> CAR WITHIN 25m <----- \n\n\n" );
            ...
            if (LOCATE_CAR_3D( l_U867, -120.57320000, 792.11740000 + 2.00000000, 24.93190000, 10.00000000, 10.00000000, 3.00000000, 0 ))
            {
                ...
                SET_CAR_COORDINATES( l_U867, -118.66150000, 798.90170000, 24.93230000 );
    ...
    if ((sub_13783()) || ((NOT (IS_CHAR_INJURED( g_U11081[0] ))) AND (NOT (IS_CHAR_INJURED( g_U11081[1] )))))
    {
        if (l_U1036 == 1)
        {
            if (NOT (IS_CHAR_INJURED( g_U11081[0] )))
            {
                ...
                SET_CHAR_COORDINATES( g_U11081[0], -118.28280000, 795.59330000, 24.93230000 );
                SET_BLOCKING_OF_NON_TEMPORARY_EVENTS( g_U11081[0], 0 );
            }
            if (NOT (IS_CHAR_INJURED( g_U11081[1] )))
            {
...
void sub_25927()
{
    ...
    if (l_U423 == 0)
    {
        ...
        if (NOT (IS_CHAR_INJURED( l_U690 )))
        {
            if ((NOT (IS_CHAR_DEAD( l_U818 ))) AND (NOT (IS_CHAR_DEAD( l_U819 ))))
            {
                OPEN_SEQUENCE_TASK( ref l_U650 );
                ...
                {
                    TASK_GO_TO_COORD_WHILE_SHOOTING( 0, -101.45840000, 815.04610000, 17.62490000, 3, 2.00000000, 2.00000000, l_U701[7], 0 );
                }
        ...
        if ((NOT (IS_CHAR_INJURED( l_U701[4] ))) AND (NOT (IS_CHAR_DEAD( l_U690 ))))
        {
    ...
    if (l_U989 == 0)
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -110.10270000, 852.32540000, 24.93230000, 6.00010000, 3.15655000, 5, 0 ))
        {
            sub_36028();
            l_U989 = 1;
        }
    ...
    {
        if (((l_U411[0] == 0) AND (TIMERA() > l_U369)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
        {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U710[4] ))) AND (l_U403[0] == 0))
    {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U710[2] ))) AND (l_U403[1] == 0))
    {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U717[1] ))) AND (l_U403[2] == 0))
    {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -94.27770000, 855.74480000, 24.93230000, 2.75000000, 2.50000000, 3.00000000, 0 )) AND (l_U475 == 0))
    {
        sub_43189();
        SETTIMERB( 0 );
        l_U475 = 1;
    }
    if ((l_U476 == 0) AND (l_U475 == 1))
    {
    ...
    if (((TIMERB() > 8000) AND (l_U477 == 0)) AND (l_U475 == 1))
    {
        for ( I = 0; I <= 2; I++ )
        {
    ...
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -100.87830000, 873.18660000, 25.93190000, 3.00000000, 3.00000000, 3.00000000, 0 )) || (l_U382._fU8 < 23.00000000))
    {
        l_U362++;
    }
    return;
...
void sub_26915()
{
    ...
    CREATE_PICKUP_ROTATE( 993473937, 22, 5, -98.72000000, 870.23000000, 24.95500000, 94.62000000, 40.28000000, 0, ref l_U399 );
...
void sub_28430()
{
    CREATE_CHAR( 7, l_U845, -107.50590000, 794.66160000, 25.93190000 - 1.00000000, ref l_U697[2], 1 );
    SET_CHAR_HEADING( l_U697[2], 0.60400000 );
    sub_14067( l_U697[2], 2, 1, 1, "Museum2_Hall" );
    sub_14434( l_U697[2], 0 );
    SET_CHAR_AS_ENEMY( l_U697[2], 1 );
    SET_CHAR_SPHERE_DEFENSIVE_AREA( l_U697[2], -107.50590000, 794.66160000, 25.93190000 - 1.00000000, 1.00000000 );
...
void sub_28976()
{
    ...
    sub_26365( l_U701[4] );
    CREATE_CHAR( 8, l_U843, -92.37910000, 817.59140000, 25.93200000 - 1.00000000, ref l_U701[5], 1 );
    SET_CHAR_HEADING( l_U701[5], 177.31980000 );
    sub_14067( l_U701[5], 2, 1, 1, "Museum2_Hall" );
    sub_14434( l_U701[5], 0 );
    SET_CHAR_SPHERE_DEFENSIVE_AREA( l_U701[5], -92.37910000, 817.59140000, 25.93200000 - 1.00000000, 10.00000000 );
...
void sub_30308()
{
    ...
    CREATE_CHAR( 8, l_U846, -122.47550000, 809.90390000, 24.93230000, ref l_U710[5], 1 );
...
void sub_31183()
{
    CREATE_CHAR( 8, l_U846, -91.88680000, 871.38590000, 24.93230000, ref l_U717[0], 1 );
    SET_CHAR_HEADING( l_U717[0], 186.02380000 );
    sub_14067( l_U717[0], 2, 1, 1, "Museum2_jugs" );
    sub_14434( l_U717[0], 0 );
    SET_CHAR_SPHERE_DEFENSIVE_AREA( l_U717[0], -91.88680000, 871.38590000, 24.93230000, 3.00000000 );
...
void sub_35345(unknown uParam0, unknown uParam1)
{
    ...
    if ((iVar10 - l_U371) > l_U372)
    {
        ...
        if ((NOT (IS_CHAR_DEAD( uParam0 ))) AND (NOT (IS_CHAR_INJURED( uParam1 ))))
        {
...
void sub_36028()
{
    CREATE_CHAR( 8, l_U845, -118.80100000, 789.50420000, 19.35157000, ref l_U820[0], 1 );
    ...
    CREATE_CHAR( 8, l_U843, -118.80100000 + 1, 789.50420000, 19.35157000, ref l_U820[1], 1 );
    ...
    sub_26365( l_U820[1] );
    SET_DEAD_CHAR_COORDINATES( l_U820[1], -95.66290000, 869.07290000, 24.93230000 );
    return;
}

void sub_36487()
{
    if ((g_U10991 == 1) || (g_U10991 == 4))
    {
        sub_36516();
    }
    return;
...
int sub_37146()
{
    ...
    for ( I = 0; I <= (g_U572 - 1); I++ )
    {
        if (((sub_2539( 1, g_U572[I] )) != 0) AND (g_U572[I]._fU20))
        {
            sub_2825( I );
            return 1;
        }
...
void sub_39828()
{
    if ((NOT (IS_CHAR_INJURED( l_U697[2] ))) AND (l_U444 == 0))
    {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U717[2] ))) AND (l_U445 == 0))
    {
...
void sub_40069()
{
    ...
    if (NOT (IS_CHAR_DEAD( l_U697[2] )))
    {
        ...
        if ((((IS_PED_RAGDOLL( l_U697[2] )) AND (uVar2._fU8 < 24.75000000)) AND (uVar2._fU8 > 20)) AND (l_U487 == 0))
        {
            GET_GAME_TIMER( ref l_U378 );
            PLAY_SOUND_FROM_PED( l_U375, "E1_RB2_SCREAM", l_U697[2] );
            l_U487 = 1;
        }
        if ((uVar2._fU8 < 18.50000000) AND (l_U487 == 1))
        {
            STOP_SOUND( l_U375 );
    ...
    for ( I = 0; I < l_U710; I++ )
    {
        if (NOT (IS_CHAR_DEAD( l_U710[I] )))
        {
            ...
            if ((((IS_PED_RAGDOLL( l_U710[I] )) AND (uVar2._fU8 < 24.75000000)) AND (uVar2._fU8 > 20)) AND (l_U487 == 0))
            {
                GET_GAME_TIMER( ref l_U378 );
    ...
    for ( I = 0; I < l_U701; I++ )
    {
        if (NOT (IS_CHAR_DEAD( l_U701[I] )))
        {
            ...
            if ((((IS_PED_RAGDOLL( l_U701[I] )) AND (uVar2._fU8 < 24.75000000)) AND (uVar2._fU8 > 20)) AND (l_U487 == 0))
            {
                GET_GAME_TIMER( ref l_U378 );
    ...
    for ( I = 0; I < l_U725; I++ )
    {
        if ((I == 7) || (I == 8))
        {
            if (NOT (IS_CHAR_DEAD( l_U725[I] )))
            {
                ...
                if ((((IS_PED_RAGDOLL( l_U725[I] )) AND (uVar2._fU8 < 24.75000000)) AND (uVar2._fU8 > 20)) AND (l_U487 == 0))
                {
                    GET_GAME_TIMER( ref l_U378 );
...
void sub_41197()
{
    if (NOT (IS_CHAR_INJURED( l_U691 )))
    {
        if ((((TIMERB() > l_U364) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( l_U1062, l_U691, 6.00000000, 6.00000000, 2.00000000, 0 ))) AND (NOT (sub_21801( l_U1064 )))) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
        {
...
void sub_41356()
{
    if ((l_U443 == 1) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, 65429, 821, 20, 25.00000000, 75.00000000, 35.00000000, 0 ))))
    {
        STOP_SOUND( l_U367 );
        RELEASE_SOUND_ID( l_U367 );
        l_U443 = 0;
    }
    else if ((l_U443 == 0) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, 65429, 821, 20, 25.00000000, 75.00000000, 35.00000000, 0 )))
    {
        l_U367 = GET_SOUND_ID();
        PLAY_SOUND_FROM_POSITION( l_U367, "RB2_COLLECTORS_ITEM_ALARM", 65429, 821, 20 );
        l_U443 = 1;
    ...
    if (l_U443 == 1)
    {
        ...
        {
            GET_KEY_FOR_CHAR_IN_ROOM( l_U1062, ref l_U365 );
            if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -101.34560000, 857.80050000, 16.31420000, 1.50000000, 1.50000000, 2.00000000, 0 )) AND (l_U442 == 0))
            {
                SET_VARIABLE_ON_SOUND( l_U367, "Control", 0.30000000 );
                l_U442 = 1;
            }
            else if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -101.51580000, 854.89260000, 17.62630000, 1.50000000, 1.50000000, 2.00000000, 0 )) AND (l_U442 == 1))
            {
                SET_VARIABLE_ON_SOUND( l_U367, "Control", 1.00000000 );
                l_U442 = 1;
            }
            else if ((l_U365 == 2004012895) AND (l_U442 == 0))
            {
                SET_VARIABLE_ON_SOUND( l_U367, "Control", 1.00000000 );
            }
...
void sub_42054()
{
    if (((IS_CHAR_DEAD( l_U690 )) || (IS_CHAR_FATALLY_INJURED( l_U690 ))) AND (l_U428 == 0))
    {
        PRINT_NOW( "RB2_FAIL_06", 7500, 1 );
        sub_12655( 5, "E1R2_FAIL4", "E1R2AUD", 0 );
        l_U362 = -1;
    ...
    if ((NOT (IS_CHAR_DEAD( l_U690 ))) AND (l_U428 == 0))
    {
        if (LOCATE_CHAR_ANY_MEANS_3D( l_U690, -107.64210000, 765.37100000, 14.34170000, 2.00000000, 2.00000000, 2.00000000, 0 ))
        {
...
void sub_42367()
{
    if ((IS_CHAR_DEAD( l_U691 )) || (IS_CHAR_FATALLY_INJURED( l_U691 )))
    {
...
void sub_43189()
{
    ...
    CREATE_CHAR( 8, l_U844, -118.80100000 + 1, 789.50420000 + 1, 19.35157000, ref l_U820[2], 1 );
    ...
    CREATE_CHAR( 8, l_U843, -118.80100000 + 2, 789.50420000, 19.35157000, ref l_U820[3], 1 );
    ...
    sub_26365( l_U820[3] );
    SET_DEAD_CHAR_COORDINATES( l_U820[3], -105.14960000, 872.52530000, 24.93220000 );
    CREATE_CHAR( 8, l_U846, -118.80100000 + 1, 789.50420000 + 1, 19.35157000, ref l_U820[4], 1 );
    ...
    sub_26365( l_U820[4] );
    SET_DEAD_CHAR_COORDINATES( l_U820[4], -109.58540000, 875.48440000 - 1, 24.93220000 );
    CREATE_CHAR( 8, l_U845, -118.80100000 + 2, 789.50420000 + 1, 19.35157000, ref l_U820[5], 1 );
    ...
    CREATE_CHAR( 8, l_U846, -118.80100000 + 2, 789.50420000 + 2, 19.35157000, ref l_U820[6], 1 );
    ...
    CREATE_CHAR( 8, l_U845, -121.13440000, 783.32440000, 18.94549000, ref l_U763[5], 1 );
    ...
    CREATE_CHAR( 8, l_U846, -121.13440000, 783.32440000 - 1, 18.94549000, ref l_U763[6], 1 );
    ...
    CREATE_CHAR( 8, l_U844, -121.13440000, 783.32440000 - 2, 18.94549000, ref l_U763[7], 1 );
...
void sub_45302()
{
    ...
    if (((l_U503[1] == 0) AND (l_U1047[0] == 1)) AND (l_U475 == 1))
    {
        if (((l_U424 == 1) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -107.89990000, 851.75790000, 17.62490000, 14.06020000, 8.92730000, 3.50000000, 0 )))
        {
    ...
    GET_KEY_FOR_CHAR_IN_ROOM( l_U1062, ref l_U365 );
    if ((l_U365 == 0) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -107.64210000, 765.37100000, 14.34170000, 10.00000000, 6.00000000, 5.00000000, 0 ))))
    {
        if (DOES_BLIP_EXIST( l_U547 ))
        {
            REMOVE_BLIP( l_U547 );
...
void sub_45323()
{
    ...
    GET_CHAR_COORDINATES( l_U1062, ref l_U379._fU0, ref l_U379._fU4, ref l_U379._fU8 );
    CREATE_CHAR( 8, l_U843, -96.97180000, 805.74460000, 18.62470000 - 1.00000000, ref l_U725[5], 1 );
...
void sub_47371()
{
    if ((NOT (IS_CHAR_INJURED( l_U725[7] ))) AND (l_U446 == 0))
    {
...
void sub_47500()
{
    if (((DOES_CHAR_EXIST( l_U690 )) AND (NOT (IS_CHAR_DEAD( l_U690 )))) AND (l_U428 == 0))
    {
        if (NOT (IS_CHAR_ON_SCREEN( l_U690 )))
        {
...
void sub_47903()
{
    ...
    if (((l_U496 == 1) AND (NOT (IS_CHAR_INJURED( l_U725[15] )))) AND (l_U497 == 0))
    {
        OPEN_SEQUENCE_TASK( ref l_U650 );
...
void sub_48163()
{
    ...
    switch (l_U905)
    {
        ...
        break;
        case 1:
        if (((((HAS_CAR_RECORDING_BEEN_LOADED( 2000 )) AND (HAS_CAR_RECORDING_BEEN_LOADED( 2001 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 2002 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 2003 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 2004 )))
        {
            l_U905++;
        }
        break;
        ...
        if (IS_VEH_DRIVEABLE( l_U851[6] ))
        {
            if ((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U851[6] ))) || (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -102.05810000, 891.65560000, 14.29880000, 17.73905000, 17.20625000, 20, 0 ))))
            {
    ...
    if (l_U920 == 0)
    {
        ...
        {
            if (((((l_U490[0] == 1) AND (l_U490[1] == 1)) AND (l_U490[2] == 1)) AND (l_U490[3] == 1)) AND (l_U490[4] == 1))
            {
                l_U920 = 1;
            }
            if (l_U905 > 2)
            {
                if (IS_VEH_DRIVEABLE( l_U851[4] ))
                {
                    if (((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U851[4] ))) AND (NOT (IS_CHAR_INJURED( l_U1062 )))) AND (l_U490[0] == 0))
                    {
            ...
            if (l_U905 > 3)
            {
                if (IS_VEH_DRIVEABLE( l_U851[5] ))
                {
                    if (((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U851[5] ))) AND (NOT (IS_CHAR_INJURED( l_U1062 )))) AND (l_U490[1] == 0))
                    {
            ...
            if (l_U905 > 4)
            {
                if (IS_VEH_DRIVEABLE( l_U851[6] ))
                {
                    if (((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U851[6] ))) AND (NOT (IS_CHAR_INJURED( l_U1062 )))) AND (l_U490[2] == 0))
                    {
                ...
                if (IS_VEH_DRIVEABLE( l_U851[7] ))
                {
                    if (((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U851[7] ))) AND (NOT (IS_CHAR_INJURED( l_U1062 )))) AND (l_U490[3] == 0))
                    {
            ...
            if (l_U905 > 5)
            {
                if (IS_VEH_DRIVEABLE( l_U851[8] ))
                {
                    if (((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U851[8] ))) AND (NOT (IS_CHAR_INJURED( l_U1062 )))) AND (l_U490[4] == 0))
                    {
...
void sub_48175(unknown uParam0, unknown uParam1, unknown uParam2)
{
    ...
    if (l_U490[uParam0] == 1)
    {
        ...
        {
            if ((NOT (DOES_BLIP_EXIST( l_U621[uParam2] ))) AND (l_U365 == 0))
            {
...
void sub_57686()
{
    ...
    sub_42367();
    sub_48163();
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -111.89320000, 767.98640000, 15.99850000, 2.00000000, 2.00000000, 2.00000000, 0 )) AND (l_U420 == 0))
    {
        sub_58718();
        l_U420 = 1;
    }
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -101.38140000, 854.80690000, 17.62630000, 2.00000000, 2.00000000, 2.00000000, 0 )) AND (l_U447 == 0))
    {
        sub_59692();
        l_U447 = 1;
    }
    GET_KEY_FOR_CHAR_IN_ROOM( l_U1062, ref l_U365 );
    if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -106.36830000 - 0.20000000, 762.87490000, 14.50000000, 1.60000000 + 1.00000000, 1.60000000, 1.60000000, 0 )) || (l_U365 == 0))
    {
        if (DOES_BLIP_EXIST( l_U541 ))
        {
            REMOVE_BLIP( l_U541 );
...
void sub_58718()
{
    ...
    CREATE_CHAR( 8, l_U845, -81.43040000, 784.32690000 + 1.00000000, 14.21130000 - 1.00000000, ref l_U750[4], 1 );
...
void sub_60172()
{
    ...
    if (l_U426 == 0)
    {
        ...
        for ( I = 0; I <= 1; I++ )
        {
            if (NOT (IS_CHAR_INJURED( g_U11081[I] )))
            {
                if (((l_U1038 == 0) AND (l_U1040 == 1)) AND (I == 0))
                {
                    SAY_AMBIENT_SPEECH( g_U11081[0], "GREET_JOHNNY", 1, 0, 2 );
                    l_U1038 = 1;
                }
    ...
    if (l_U1039 == 0)
    {
        if (((NOT (IS_CHAR_INJURED( g_U11081[0] ))) AND (NOT (IS_AMBIENT_SPEECH_PLAYING( g_U11081[0] )))) AND (l_U1038 == 1))
        {
            if (NOT (IS_CHAR_INJURED( g_U11081[1] )))
            {
    ...
    if (l_U500 == 0)
    {
        if (l_U1047[1] == 1)
        {
            if ((l_U426 == 1) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
            {
    ...
    if ((l_U924 == 1) AND (l_U1000 == 0))
    {
        ...
        MARK_ROAD_NODE_AS_DONT_WANDER( 187.60420000, 1017.32100000, 13.76380000 );
        MARK_ROAD_NODE_AS_DONT_WANDER( 187.28520000, 1005.18500000, 13.76740000 );
        MARK_ROAD_NODE_AS_DONT_WANDER( 51.24980000, 999.27120000, 13.70130000 );
    ...
    if (l_U1000 == 1)
    {
        if ((((l_U1044[0] == 0) AND (l_U489 == 0)) AND (NOT IS_MESSAGE_BEING_DISPLAYED())) AND (TIMERA() > l_U370))
        {
        ...
        l_U923 = 0;
        sub_67596();
        if (((l_U499 == 0) AND (l_U480[5] == 1)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
        {
        ...
        if (l_U480[5] == 0)
        {
            if ((l_U922 > 1) || ((l_U923 < 2) AND (l_U922 > 0)))
            {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U828[0] ))) AND (l_U512[0] == 0))
        {
            if (((sub_68455( l_U828[0], 91 )) == 0) || ((sub_68529( l_U828[0], 1 )) == 1))
            {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U831[0] ))) AND (l_U512[1] == 0))
        {
            if (((sub_68455( l_U831[0], 91 )) == 0) || ((sub_68529( l_U831[0], 1 )) == 1))
            {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U828[1] ))) AND (l_U512[2] == 0))
        {
            if (((sub_68455( l_U828[1], 91 )) == 0) || ((sub_68529( l_U828[1], 1 )) == 1))
            {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U831[1] ))) AND (l_U512[3] == 0))
        {
            if (((sub_68455( l_U831[1], 91 )) == 0) || ((sub_68529( l_U831[1], 1 )) == 1))
            {
        ...
        sub_69065();
        if (((l_U1058[0] == 0) AND (IS_CHAR_IN_ANY_CAR( l_U1062 ))) AND (l_U923 != 0))
        {
            PRINT_HELP( "RB2_HELP_01" );
            l_U1058[0] = 1;
        }
        sub_69580();
        if ((l_U974[0] == 1) AND (l_U968[0] == 1))
        {
            if (l_U978[0] == 0)
            {
                if (l_U1001[0] == 0)
        ...
        {
            l_U968[0] = 1;
            if ((IS_CHAR_IN_ANY_CAR( l_U828[0] )) AND ((l_U1001[0] == 1) || (l_U1005[0] == 1)))
            {
                l_U982[0] = 1;
            }
        }
        ...
        {
            l_U968[1] = 1;
            if ((IS_CHAR_IN_ANY_CAR( l_U828[1] )) AND ((l_U1001[1] == 1) || (l_U1005[1] == 1)))
            {
                l_U982[1] = 1;
            }
        }
        ...
        if (((l_U968[0] == 0) AND (l_U968[1] == 1)) AND (l_U978[1] == 1))
        {
            if (l_U502 == 0)
            {
        ...
        if (((l_U968[0] == 0) AND (l_U968[1] == 0)) AND (l_U508 == 1))
        {
            if (l_U1017[1] == 0)
            {
                if (l_U971[0] == 1)
        ...
        if (((l_U968[0] == 0) AND (l_U968[1] == 0)) AND (l_U508 == 0))
        {
            if (l_U1017[2] == 0)
            {
                if (l_U971[1] == 1)
        ...
        if (IS_VEH_DRIVEABLE( l_U874[0] ))
        {
            if ((NOT (IS_CHAR_INJURED( l_U828[0] ))) AND (l_U519[0] == 1))
            {
            ...
            if ((NOT (IS_CHAR_INJURED( l_U831[0] ))) AND (l_U519[1] == 1))
            {
        ...
        if (IS_VEH_DRIVEABLE( l_U874[1] ))
        {
            if ((NOT (IS_CHAR_INJURED( l_U828[1] ))) AND (l_U519[2] == 1))
            {
            ...
            if ((NOT (IS_CHAR_INJURED( l_U831[1] ))) AND (l_U519[3] == 1))
            {
    ...
    if ((l_U1013[0] == 1) AND (l_U1013[1] == 1))
    {
        if (l_U1029 == 0)
        {
            if (IS_VEH_DRIVEABLE( l_U851[7] ))
            {
                if ((NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[7] ))) AND (l_U990[7] == 0))
                {
                    l_U877 = l_U851[7];
                    l_U990[7] = 1;
                }
            ...
            if (l_U1029 == 0)
            {
                if (IS_VEH_DRIVEABLE( l_U851[5] ))
                {
                    if ((NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[5] ))) AND (l_U990[5] == 0))
                    {
                        l_U877 = l_U851[5];
                        l_U990[5] = 1;
                        l_U1029 = 1;
            ...
            if (l_U1029 == 0)
            {
                if (IS_VEH_DRIVEABLE( l_U851[4] ))
                {
                    if ((NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[4] ))) AND (l_U990[4] == 0))
                    {
                        l_U877 = l_U851[4];
                        l_U990[4] = 1;
                        l_U1029 = 1;
            ...
            if (l_U1029 == 0)
            {
                if (IS_VEH_DRIVEABLE( l_U851[3] ))
                {
                    if ((NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[3] ))) AND (l_U990[3] == 0))
                    {
                        l_U877 = l_U851[3];
                        l_U990[3] = 1;
                        l_U1029 = 1;
            ...
            if (l_U1029 == 0)
            {
                if (IS_VEH_DRIVEABLE( l_U851[2] ))
                {
                    if ((NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[2] ))) AND (l_U990[2] == 0))
                    {
                        l_U877 = l_U851[2];
                        l_U990[2] = 1;
                        l_U1029 = 1;
            ...
            if (l_U1029 == 0)
            {
                if (IS_VEH_DRIVEABLE( l_U851[1] ))
                {
                    if ((NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[1] ))) AND (l_U990[1] == 0))
                    {
                        l_U877 = l_U851[1];
                        l_U990[1] = 1;
                        l_U1029 = 1;
            ...
            if ((l_U1029 == 0) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -85.10990000, 929.76700000, 13.49630000, 100, 100, 100, 0 ))))
            {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U834[0] ))) AND (l_U512[4] == 0))
        {
        ...
        if ((NOT (IS_CHAR_INJURED( l_U834[1] ))) AND (l_U512[5] == 0))
        {
        ...
        {
            if ((NOT (IS_CHAR_INJURED( l_U834[0] ))) AND (l_U519[4] == 1))
            {
            ...
            if ((NOT (IS_CHAR_INJURED( l_U834[1] ))) AND (l_U519[5] == 1))
            {
    ...
    if ((l_U489 == 0) AND (l_U1000 == 1))
    {
        ...
        if ((l_U489 == 1) AND (IS_WANTED_LEVEL_GREATER( l_U1063, 0 )))
        {
            PRINT_NOW( "RB2_COMMAND_07", 7500, 1 );
            l_U434 = 0;
        }
    }
    if (((IS_WANTED_LEVEL_GREATER( l_U1063, 0 )) AND (l_U434 == 1)) AND (l_U489 == 1))
    {
        if (DOES_BLIP_EXIST( l_U544 ))
        {
            REMOVE_BLIP( l_U544 );
    ...
    if ((((NOT (IS_WANTED_LEVEL_GREATER( l_U1063, 0 ))) AND (l_U434 == 0)) AND (l_U474 == 1)) AND (l_U489 == 1))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, l_U536._fU0, l_U536._fU4, l_U536._fU8, 30.00000000, 30.00000000, 100.00000000, 0 )) AND (l_U470 == 0))
        {
            ;
        }
    ...
    sub_11981();
    sub_41356();
    if (((l_U470 == 0) AND (NOT (IS_WANTED_LEVEL_GREATER( l_U1063, 0 )))) AND (l_U474 == 1))
    {
        if ((LOCATE_CHAR_ANY_MEANS_3D( l_U1062, l_U536._fU0, l_U536._fU4, l_U536._fU8, 150.00000000, 150.00000000, 150.00000000, 0 )) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, l_U536._fU0, l_U536._fU4, l_U536._fU8, 30.00000000, 30.00000000, 60.00000000, 0 ))))
        {
            sub_78577();
        }
    }
    sub_79854();
    if ((((l_U474 == 0) AND (NOT (IS_WANTED_LEVEL_GREATER( l_U1063, 0 )))) AND (l_U489 == 1)) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
        if (sub_80932( 1, "E1R2_CALL6", "E1R2AUD" ))
        {
            WAIT( 500 );
            while (((sub_83809( 1 )) || (sub_83903())) || (sub_83938()))
            {
                WAIT( 0 );
            }
            l_U474 = 1;
    ...
    if (((l_U434 == 1) AND (l_U466 == 1)) AND (NOT (IS_CHAR_DEAD( l_U813 ))))
    {
...
void sub_62629(unknown uParam0, unknown uParam1, int iParam2)
{
    ...
    for ( I = 0; I <= (iParam2 - 1); I++ )
    {
        ...
        {
            if (((LOCATE_CHAR_ANY_MEANS_3D( (uParam0^)[I], 18.25125000, 810.39780000, 17.62490000, 110.48070000, 42.72075000, 20, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( (uParam0^)[I], -96.88055000, 862.43540000, 25.33350000, 6.47435000, 13.22520000, 2.50000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( (uParam0^)[I], 108.00530000, 864.42830000, 21.27855000, 3.47005000, 10.96620000, 6.65365000, 0 )))
            {
        ...
        if ((NOT (IS_CHAR_INJURED( (uParam0^)[I] ))) AND (NOT (IS_CHAR_INJURED( l_U1062 ))))
        {
            GET_KEY_FOR_CHAR_IN_ROOM( (uParam0^)[I], ref iVar6 );
            if (((iVar6 == 0) AND (iVar7 == 1)) || (LOCATE_CHAR_ANY_MEANS_3D( (uParam0^)[I], -99.66875000, 870.86760000, 13.68350000, 6.27690000, 13.76810000, 2.50000000, 0 )))
            {
                if (NOT (IS_CHAR_INJURED( (uParam0^)[I] )))
                {
            ...
            {
                GET_KEY_FOR_CHAR_IN_ROOM( l_U1062, ref l_U365 );
                if ((l_U365 == 0) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( l_U1062, -97.28080000, 879.53050000, 13.80900000, 20, 20, 20, 0 ))))
                {
                    if (NOT (IS_CHAR_ON_SCREEN( (uParam0^)[I] )))
                    {
                        DELETE_CHAR( ref (uParam0^)[I] );
...
void sub_64847()
{
    ...
    if ((l_U1031[0] == 0) AND (IS_VEH_DRIVEABLE( l_U851[8] )))
    {
    ...
    if ((l_U1031[0] == 0) AND (IS_VEH_DRIVEABLE( l_U851[7] )))
    {
    ...
    if ((l_U1031[0] == 0) AND (IS_VEH_DRIVEABLE( l_U851[5] )))
    {
    ...
    if ((l_U1031[0] == 0) AND (IS_VEH_DRIVEABLE( l_U851[4] )))
    {
    ...
    if ((IS_VEH_DRIVEABLE( l_U851[6] )) AND (l_U990[6] == 0))
    {
        if (NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[6] )))
        {
    ...
    if (((l_U1031[1] == 0) AND (IS_VEH_DRIVEABLE( l_U851[8] ))) AND (l_U990[8] == 0))
    {
        if (NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[8] )))
        {
    ...
    if (((l_U1031[1] == 0) AND (IS_VEH_DRIVEABLE( l_U851[7] ))) AND (l_U990[7] == 0))
    {
        if (NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[7] )))
        {
    ...
    if (((l_U1031[1] == 0) AND (IS_VEH_DRIVEABLE( l_U851[5] ))) AND (l_U990[5] == 0))
    {
        if (NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[5] )))
        {
    ...
    if (((l_U1031[1] == 0) AND (IS_VEH_DRIVEABLE( l_U851[4] ))) AND (l_U990[4] == 0))
    {
        if (NOT (IS_CHAR_IN_CAR( l_U1062, l_U851[4] )))
        {
...
void sub_69065()
{
    if ((NOT (IS_CHAR_INJURED( l_U828[0] ))) AND (IS_VEH_DRIVEABLE( l_U874[0] )))
    {
        if (IS_CHAR_IN_CAR( l_U828[0], l_U874[0] ))
        {
            l_U519[0] = 1;
    ...
    if ((NOT (IS_CHAR_INJURED( l_U831[0] ))) AND (IS_VEH_DRIVEABLE( l_U874[0] )))
    {
        if (IS_CHAR_IN_CAR( l_U831[0], l_U874[0] ))
        {
            l_U519[1] = 1;
    ...
    if ((NOT (IS_CHAR_INJURED( l_U828[1] ))) AND (IS_VEH_DRIVEABLE( l_U874[1] )))
    {
        if (IS_CHAR_IN_CAR( l_U828[1], l_U874[1] ))
        {
            l_U519[2] = 1;
    ...
    if ((NOT (IS_CHAR_INJURED( l_U831[1] ))) AND (IS_VEH_DRIVEABLE( l_U874[1] )))
    {
        if (IS_CHAR_IN_CAR( l_U831[1], l_U874[1] ))
        {
            l_U519[3] = 1;
    ...
    if ((NOT (IS_CHAR_INJURED( l_U834[0] ))) AND (IS_VEH_DRIVEABLE( l_U877 )))
    {
    ...
    if ((NOT (IS_CHAR_INJURED( l_U834[1] ))) AND (IS_VEH_DRIVEABLE( l_U877 )))
    {
        if (IS_CHAR_IN_CAR( l_U834[1], l_U877 ))
        {
            l_U519[5] = 1;
...
void sub_69580()
{
    ...
    if ((IS_CONTROL_PRESSED( 0, 51 )) AND (l_U1057 == 0))
    {
        GET_CHAR_COORDINATES( l_U1062, ref l_U382._fU0, ref l_U382._fU4, ref l_U382._fU8 );
        if (IS_VEH_DRIVEABLE( l_U874[0] ))
        {
...
void sub_70785(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3862() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_70945())) AND (iVar3 != 4))
    {
...
void sub_72594(unknown uParam0, unknown uParam1, unknown uParam2)
{
    if (NOT (IS_CHAR_INJURED( (uParam0^) )))
    {
        if ((IS_VEH_DRIVEABLE( (uParam1^) )) AND (NOT (IS_CHAR_INJURED( (uParam2^) ))))
        {
            if (IS_CHAR_IN_ANY_CAR( (uParam0^) ))
            {
                SET_CAR_ENGINE_ON( (uParam1^), 1, 1 );
...
void sub_78577()
{
    ...
    if ((HAS_MODEL_LOADED( l_U848 )) AND (l_U466 == 0))
    {
    ...
    if ((HAS_MODEL_LOADED( l_U849 )) AND (l_U467 == 0))
    {
    ...
    if ((HAS_MODEL_LOADED( l_U884 )) AND (l_U468 == 0))
    {
    ...
    if (((l_U466 == 1) AND (l_U467 == 1)) AND (l_U468 == 1))
    {
        if ((NOT (IS_CHAR_INJURED( l_U813 ))) AND (NOT (IS_CHAR_INJURED( l_U814[0] ))))
        {
...
void sub_79854()
{
    ...
    I = 0;
    if ((DOES_CHAR_EXIST( l_U813 )) AND (l_U401 == 0))
    {
        if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U813, l_U1062, 0 )) AND (NOT IS_SCREEN_FADING_OUT()))
        {
            if (NOT (IS_CHAR_INJURED( l_U813 )))
            {
        ...
        else if ((DOES_CHAR_EXIST( l_U813 )) AND (IS_CHAR_INJURED( l_U813 )))
        {
            if (NOT (IS_CHAR_INJURED( l_U813 )))
            {
                SET_CHAR_RELATIONSHIP( l_U813, 5, 0 );
    ...
    for ( I = 0; I <= 0; I++ )
    {
        if ((DOES_CHAR_EXIST( l_U814[I] )) AND (l_U401 == 0))
        {
            if ((HAS_CHAR_BEEN_DAMAGED_BY_CHAR( l_U814[I], l_U1062, 0 )) AND (NOT IS_SCREEN_FADING_OUT()))
            {
            ...
            else if ((DOES_CHAR_EXIST( l_U814[I] )) AND (IS_CHAR_INJURED( l_U814[I] )))
            {
                if (NOT (IS_CHAR_INJURED( l_U814[I] )))
                {
                    SET_CHAR_RELATIONSHIP( l_U814[I], 5, 0 );
    ...
    for ( I = 0; I <= 1; I++ )
    {
        ...
        {
            if (((HAS_CAR_BEEN_DAMAGED_BY_CHAR( l_U870[I], l_U1062 )) AND (NOT IS_SCREEN_FADING_OUT())) AND (l_U401 == 0))
            {
                if (NOT IS_SCREEN_FADING_OUT())
                {
                    PRINT_NOW( "RB2_FAIL_10", 7500, 1 );
...
int sub_80990(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3862() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3862() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_81505()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U94._fU60 = uParam0;
