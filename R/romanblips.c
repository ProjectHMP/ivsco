...
void sub_10785()
{
    ...
    {
        if (((sub_10823( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
int sub_13467()
{
    ...
    if (l_U481 == 4)
    {
        ...
        if (TIMERA() > 500)
        {
            if ((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ROBA_1" ))) AND (l_U487))
            {
                l_U481++;
            }
        }
    ...
    if (l_U481 == 6)
    {
        if ((TIMERA() > 4000) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ROBC_1" ))))
        {
            PRINT_HELP( "ROBB_1" );
            DISPLAY_RADAR( 1 );
            SETTIMERA( 0 );
    ...
    if (l_U481 == 8)
    {
        ...
        if (TIMERA() > 500)
        {
            if ((NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "ROBB_1" ))) AND (l_U487))
            {
                l_U481++;
            }
        }
