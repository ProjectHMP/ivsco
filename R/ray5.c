...
void sub_2575()
{
    ...
    {
        if (((sub_2613( 5, g_U569[I] )) == 1) AND (g_U569[I]._fU20))
        {
...
void sub_4117()
{
    ...
    FORCE_WEATHER_NOW( 1 );
    if ((g_U9893._fU24) AND (NOT l_U923))
    {
...
void sub_5562()
{
    if ((LOCATE_CHAR_ANY_MEANS_3D( sub_3640(), l_U991._fU0, l_U991._fU4, l_U991._fU8, 2.50000000, 2.50000000, 2.50000000, 1 )) AND (sub_5622( 1, 1 )))
    {
        REMOVE_BLIP( l_U898 );
...
void sub_6174()
{
    if (((((sub_6183()) AND (NOT (l_U1065 == 0))) AND (NOT (l_U1065 == 8))) AND (TIMERA() >= 1000)) AND (IS_SCREEN_FADED_IN()))
    {
    ...
    switch (l_U1065)
    {
        ...
        if ((NOT (IS_CHAR_DEAD( sub_3640() ))) AND (NOT (IS_CHAR_DEAD( l_U872 ))))
        {
            CLEAR_CHAR_TASKS_IMMEDIATELY( sub_3640() );
        ...
        SET_CAM_POS( l_U903, -197.34500000, 1382.02300000, 19.76608000 );
        SET_CAM_ROT( l_U903, 13.41120000, -0.00000000, -113.35940000 );
        SET_CAM_FOV( l_U903, 42 );
        SET_CAM_POS( l_U904, -197.34500000, 1382.02300000, 19.86608000 );
        ...
        break;
        case 1:
        if ((TIMERB() >= 3200) AND (NOT (sub_9385( l_U911 ))))
        {
            sub_9584( "RB5_CALL1", ref l_U911, 7, 1 );
            SETTIMERA( 0 );
        }
        if (((sub_9385( l_U911 )) AND (TIMERA() >= 800)) AND (NOT l_U926))
        {
        ...
        if (((sub_9385( l_U911 )) AND (TIMERA() >= 1600)) AND (NOT l_U927))
        {
        ...
        break;
        case 3:
        if ((NOT l_U928) AND ((sub_11213( l_U911 )) == 3))
        {
            if ((NOT (IS_CHAR_INJURED( l_U872 ))) AND (NOT (IS_CHAR_INJURED( l_U873 ))))
            {
        ...
        if ((l_U928) AND (TIMERB() >= 900))
        {
            l_U1065 = 4;
            if ((((NOT (IS_CHAR_INJURED( l_U872 ))) AND (IS_VEH_DRIVEABLE( l_U876 ))) AND (NOT (IS_CHAR_INJURED( l_U873 )))) AND (IS_VEH_DRIVEABLE( l_U877 )))
            {
        ...
        if (NOT l_U935)
        {
            if ((NOT (IS_CHAR_INJURED( l_U872 ))) AND (IS_VEH_DRIVEABLE( l_U876 )))
            {
        ...
        if (NOT l_U936)
        {
            if ((NOT (IS_CHAR_INJURED( l_U873 ))) AND (IS_VEH_DRIVEABLE( l_U877 )))
            {
        ...
        break;
        case 8:
        if ((((IS_VEH_DRIVEABLE( l_U876 )) AND (IS_VEH_DRIVEABLE( l_U877 ))) AND (NOT (IS_CHAR_DEAD( l_U872 )))) AND (NOT (IS_CHAR_DEAD( l_U873 ))))
        {
...
void sub_6983()
{
    ...
    while ((((NOT (HAS_MODEL_LOADED( l_U900 ))) || (NOT (HAS_MODEL_LOADED( l_U901 )))) || (NOT (HAS_MODEL_LOADED( -570033273 )))) || (NOT (HAS_MODEL_LOADED( -1830458836 ))))
    {
        WAIT( 0 );
    }
...
void sub_7312()
{
    ...
    if (((IS_VEH_DRIVEABLE( l_U876 )) AND (IS_VEH_DRIVEABLE( l_U877 ))) AND (IS_VEH_DRIVEABLE( l_U875 )))
    {
...
void sub_8477()
{
    ...
    while ((((((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 335 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 336 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 338 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 339 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 347 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 348 ))))
    {
        WAIT( 0 );
    }
    return;
...
void sub_13523(boolean bParam0)
{
    ...
    WAIT( 0 );
    if ((IS_VEH_DRIVEABLE( l_U876 )) AND (NOT (IS_CHAR_DEAD( l_U872 ))))
    {
    ...
    if (((IS_VEH_DRIVEABLE( l_U877 )) AND (NOT (IS_CHAR_DEAD( l_U873 )))) AND (NOT l_U923))
    {
    ...
    if (NOT (IS_CHAR_DEAD( l_U872 )))
    {
        ...
        else if (NOT (IS_CAR_DEAD( l_U876 )))
        {
            if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U876 ))
            {
                ...
                if (((l_U1057 >= 26000) AND (l_U1057 <= 80000)) AND (l_U1059 == 2))
                {
...
void sub_18552()
{
    if (NOT l_U923)
    {
        if (IS_VEH_DRIVEABLE( l_U876 ))
        {
            if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U876 ))
            {
                ...
                if ((IS_VEH_DRIVEABLE( l_U877 )) AND (NOT (IS_CHAR_DEAD( l_U873 ))))
                {
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U877 ))
                    {
            ...
            else if ((IS_VEH_DRIVEABLE( l_U877 )) AND (NOT (IS_CHAR_DEAD( l_U873 ))))
            {
                if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U877 ))
                {
        ...
        if (l_U1059 == 1)
        {
            ...
            {
                if ((NOT (IS_CAR_DEAD( l_U877 ))) AND (NOT (IS_CHAR_DEAD( l_U873 ))))
                {
                    if ((NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U876 ))) AND (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U877 ))))
                    {
                        sub_38292( 0 );
                        sub_38479();
                    }
    ...
    if (IS_CHAR_DEAD( l_U873 ))
    {
        if (NOT l_U961)
        {
            ...
            if ((((NOT l_U930) AND (NOT (sub_9385( l_U911 )))) AND (NOT (sub_9385( l_U917 )))) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
            {
    ...
    else if ((NOT (IS_CHAR_IN_ANY_CAR( l_U873 ))) AND (NOT l_U961))
    {
    ...
    if (l_U1059 == 2)
    {
        if ((NOT (IS_CAR_DEAD( l_U877 ))) AND (NOT (IS_CHAR_DEAD( l_U873 ))))
        {
            if ((NOT l_U961) AND (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U877 ))))
            {
                if (NOT l_U962)
                {
                ...
                else if ((NOT (IS_CHAR_DEAD( l_U873 ))) AND (TIMERA() >= 180))
                {
        ...
        if ((l_U961) AND (NOT l_U960))
        {
            if (TIMERA() >= 1500)
            {
                if (NOT (IS_CHAR_DEAD( l_U872 )))
                {
                    if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3640(), l_U872, 75, 75, 75, 0 )) AND (IS_CHAR_ON_SCREEN( l_U872 )))
                    {
        ...
        if (IS_VEH_DRIVEABLE( l_U876 ))
        {
            if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U876 ))
            {
                if ((FIND_TIME_POSITION_IN_RECORDING( l_U876 )) >= 49500)
                {
                    ...
                    if ((NOT (IS_CHAR_DEAD( l_U872 ))) AND (NOT (DOES_BLIP_EXIST( l_U896 ))))
                    {
                        ADD_BLIP_FOR_CHAR( l_U872, ref l_U896 );
                    }
                    if ((NOT (IS_CHAR_DEAD( l_U873 ))) AND (NOT (DOES_BLIP_EXIST( l_U897 ))))
                    {
    ...
    if ((l_U931) AND (NOT l_U933))
    {
        if ((TIMERB() >= 1000) AND (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_3640(), -360.92000000, 1270.39000000, 22.32000000, 35.00000000, 35.00000000, 35.00000000, 0 ))))
        {
            sub_41033();
        }
    ...
    if (l_U1059 == 2)
    {
        if ((IS_VEH_DRIVEABLE( l_U876 )) AND (NOT l_U964))
        {
    ...
    if (NOT (IS_CHAR_DEAD( l_U872 )))
    {
        if ((LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3640(), l_U872, 25, 25, 8.00000000, 0 )) AND (IS_CHAR_IN_ANY_CAR( l_U872 )))
        {
            if (NOT l_U959)
            {
                sub_42092();
...
void sub_18606()
{
    ...
    switch (l_U1059)
    {
        ...
        else if ((l_U974) AND (l_U1049 <= 4000))
        {
...
void sub_23111(unknown uParam0, float fParam1)
{
    ...
    if (NOT l_U12)
    {
        ...
        if ((l_U175 == 0) || (IS_SCREEN_FADED_OUT()))
        {
            iVar10 = 1;
        }
        if ((iVar10) AND (NOT l_U34))
        {
            if (NOT l_U0)
            {
...
void sub_25226(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 15; I++ )
        {
            ...
            if (l_U211[I] == 0)
            {
                if (((l_U195[I] > 0) AND (l_U195[I] < 3000)) AND (NOT (l_U250[I] == 0)))
                {
                    if (NOT l_U0)
                    {
            ...
            if (l_U211[I] == 2)
            {
                if (HAS_MODEL_LOADED( l_U250[I] ))
                {
                    if (NOT (DOES_VEHICLE_EXIST( l_U342[I] )))
                    {
                        ...
                        {
                            bVar17 = false;
                            if ((NOT (sub_24759( l_U270[I], 5.00000000, 1120403456 ))) AND (NOT (sub_26728( l_U270[I] ))))
                            {
                                bVar17 = true;
                            }
                            if (l_U26)
                        ...
                        if (8 > l_U233)
                        {
                            ...
                            if (HAS_CAR_RECORDING_BEEN_LOADED( l_U195[I] ))
                            {
                                if (fVar14 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U195[I] )))
                                {
                                    ...
                                    if ((NOT (sub_24759( uVar8, 5.00000000, 1120403456 ))) AND (sub_24759( uVar11, 5.00000000, 1120403456 )))
                                    {
                                        sub_25622( I, 1090519040 );
                                    }
                    ...
                    if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U342[I] ))
                    {
                        ...
                        if (DOES_CHAR_EXIST( uVar6 ))
                        {
                            if (NOT (IS_CHAR_INJURED( uVar6 )))
                            {
                                if (IS_PLAYER_PLAYING( sub_5454() ))
                                {
                                    if ((((IS_CHAR_TOUCHING_VEHICLE( sub_3640(), l_U342[I] )) AND (NOT l_U6)) AND (NOT l_U3)) AND (NOT l_U15))
                                    {
                                        if (IS_CHAR_IN_ANY_CAR( sub_3640() ))
                                        {
                                            bVar16 = false;
                                    ...
                                    else if ((sub_29571( uParam0, l_U342[I] )) AND (NOT l_U15))
                                    {
                                        sub_29444( l_U342[I] );
                                        l_U211[I]++;
                                    }
        ...
        if (IS_PLAYER_PLAYING( sub_5454() ))
        {
            ...
            for ( I = 0; I < 15; I++ )
            {
                ...
                if (DOES_VEHICLE_EXIST( l_U342[I] ))
                {
                    if (IS_VEH_DRIVEABLE( l_U342[I] ))
                    {
                        if ((sub_31277( l_U342[I], (uParam0^) )) || (sub_31277( l_U342[I], uVar6 )))
                        {
            ...
            if (l_U231[I] == 1)
            {
                if (6 > l_U236)
                {
                    if (HAS_MODEL_LOADED( l_U266[I] ))
                    {
                        ...
                        {
                            if (((NOT (sub_24759( l_U316[I], 5.00000000, 1120403456 ))) || (l_U0)) || (l_U26))
                            {
                                if (l_U19)
                                {
...
void sub_33305(unknown uParam0, unknown uParam1)
{
    ...
    if (IS_VEH_DRIVEABLE( uParam0 ))
    {
        for ( I = 0; I < 1; I++ )
        {
            if (((l_U227[I] > 0) AND (l_U227[I] < 3000)) AND (NOT (l_U268[I] == 0)))
            {
                if (l_U229[I] == 0)
                {
                    if (NOT l_U0)
                ...
                if (l_U229[I] == 2)
                {
                    if (HAS_MODEL_LOADED( l_U268[I] ))
                    {
                        if (NOT (DOES_VEHICLE_EXIST( l_U369[I] )))
                        {
                            ...
                            if (bVar15)
                            {
                                if ((NOT (sub_24759( l_U320[I], 5.00000000, 1120403456 ))) || (l_U26))
                                {
                            ...
                            if (4 > l_U235)
                            {
                                ...
                                if (HAS_CAR_RECORDING_BEEN_LOADED( l_U227[I] ))
                                {
                                    if (fVar13 < (GET_TOTAL_DURATION_OF_CAR_RECORDING( l_U227[I] )))
                                    {
                                        ...
                                        if (((NOT (sub_24759( uVar7, 5.00000000, 1120403456 ))) AND (sub_24759( uVar10, 5.00000000, 1120403456 ))) AND (NOT l_U26))
                                        {
                                            l_U235++;
                                            l_U229[I]++;
                                        }
                        ...
                        if (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U369[I] ))
                        {
                            ...
                            if (DOES_CHAR_EXIST( uVar5 ))
                            {
                                if (NOT (IS_CHAR_INJURED( uVar5 )))
                                {
                                    if (IS_PLAYER_PLAYING( sub_5454() ))
                                    {
                                        if (((IS_CHAR_TOUCHING_VEHICLE( sub_3640(), l_U369[I] )) AND (NOT l_U6)) AND (NOT l_U3))
                                        {
                                            if (IS_CHAR_IN_ANY_CAR( sub_3640() ))
                                            {
                                                bVar15 = false;
...
int sub_37207(unknown uParam0, unknown uParam1)
{
    ...
    if (((l_U247 == 0) AND (l_U248 == 0)) AND (l_U249 == 0))
    {
        l_U3 = 0;
        l_U0 = 0;
        l_U29 = 0;
...
void sub_42092()
{
    if ((NOT (sub_9385( l_U911 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
        if (NOT (IS_CHAR_INJURED( l_U872 )))
        {
            if (l_U1050 >= l_U1051)
...
void sub_42363()
{
    if (NOT (IS_CAR_DEAD( l_U875 )))
    {
        ...
        if (NOT l_U970)
        {
            if ((NOT (l_U910 == nil)) AND (l_U1059 == 2))
            {
...
int sub_43065()
{
    if ((IS_CHAR_DEAD( l_U872 )) AND (IS_CHAR_DEAD( l_U873 )))
    {
        return 1;
        break;
    }
...
void sub_58066()
{
    if (NOT (IS_CHAR_DEAD( l_U872 )))
    {
        ...
        if (NOT l_U941)
        {
            if (IS_CHAR_IN_AREA_3D( l_U872, l_U1018._fU0, l_U1018._fU4, l_U1018._fU8, l_U1021._fU0, l_U1021._fU4, l_U1021._fU8, 0 ))
            {
                ...
                g_U64959 = l_U878[8];
                CREATE_MISSION_TRAIN( 0, 736.84000000, 274.31740000, 34.67370000, 1, ref l_U878[9] );
    ...
    for ( l_U1060 = 0; l_U1060 < l_U878; l_U1060++ )
    {
        ...
        {
            if (((((NOT ((l_U1060 == 1) AND (l_U942))) AND (NOT ((l_U1060 == 2) AND (l_U943)))) AND (NOT ((l_U1060 == 3) AND (l_U944)))) AND (NOT ((l_U1060 == 7) AND (l_U945)))) AND (NOT ((l_U1060 == 8) AND (l_U946))))
            {
                SET_TRAIN_SPEED( l_U878[l_U1060], l_U1037[l_U1060] * l_U1036 );
            }
            if (((NOT (l_U1060 == 4)) AND (NOT (l_U1060 < 3))) AND (NOT (l_U1060 >= 7)))
            {
...
void sub_60994(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3640() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_61162())) AND (iVar3 != 4))
    {
