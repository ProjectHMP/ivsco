...
void sub_2437()
{
    ...
    {
        if (((sub_2475( 5, g_U575[I] )) == 1) AND (g_U575[I]._fU20))
        {
...
void sub_3445()
{
    ...
    {
        if ((NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_3454(), -1142.77700000, -988.49450000, 1.05540000, 800.00000000, 800.00000000, 800.00000000, 0 ))) AND (NOT (sub_3576( -1142.77700000, -988.49450000, 1.05540000, 10.00000000 ))))
        {
            for ( I = 0; I < l_U746; I++ )
            {
                ;
...
void sub_5573()
{
    ...
    l_U5002[0] = {5.82850000, 6.97060000, 6.50590000};
    ...
    l_U5064[5] = {-1127.52900000, -986.14670000, 8.54710000};
    l_U5064[6] = {-1130.12800000, -985.44040000, 8.54710000};
    ...
    l_U746[3]._fU8[3] = {-1138.28600000, -991.39350000, 13.00777000};
    ...
    l_U746[4]._fU8[1] = {-1136.07800000, -987.57600000, 15.11125000};
...
void sub_14146()
{
    ...
    switch (l_U5391)
    {
        ...
        while (((((((((((((((((((NOT (HAS_MODEL_LOADED( 1033245328 ))) || (NOT (HAS_MODEL_LOADED( 861409633 )))) || (NOT (HAS_MODEL_LOADED( l_U3839 )))) || (NOT (HAS_MODEL_LOADED( l_U3840 )))) || (NOT (HAS_MODEL_LOADED( l_U3841 )))) || (NOT (HAS_MODEL_LOADED( l_U3838 )))) || (NOT (HAS_MODEL_LOADED( -1341473171 )))) || (NOT (HAS_MODEL_LOADED( 944930284 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 466 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 467 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 469 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 473 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 494 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 495 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 120 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 121 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 122 )))) || (NOT (HAVE_ANIMS_LOADED( "missyusuf01" )))) || (NOT (REQUEST_MISSION_AUDIO_BANK( "EP2_SFX\Y1_SEXY_TIME" ))))
        {
        ...
        switch (g_U43104[15])
        {
            ...
            REQUEST_MODEL( l_U3841 );
            while (((NOT (HAS_MODEL_LOADED( l_U3841 ))) || (NOT (HAS_MODEL_LOADED( l_U3844 )))) || (NOT (HAS_MODEL_LOADED( l_U3845 ))))
            {
                WAIT( 0 );
            }
            ...
            while (((((((((((NOT (HAS_MODEL_LOADED( -2075782048 ))) || (NOT (HAS_MODEL_LOADED( 1239854102 )))) || (NOT (HAS_MODEL_LOADED( 1930762713 )))) || (NOT (HAS_MODEL_LOADED( 1233545547 )))) || (NOT (HAS_MODEL_LOADED( 1005833766 )))) || (NOT (HAS_MODEL_LOADED( 67157199 )))) || (NOT (HAS_MODEL_LOADED( 518033353 )))) || (NOT (HAS_MODEL_LOADED( -1366166054 )))) || (NOT (HAS_MODEL_LOADED( 1595218282 )))) || (NOT (HAS_MODEL_LOADED( 2120126803 )))) || (NOT (HAS_MODEL_LOADED( 1789985121 ))))
            {
                WAIT( 0 );
            }
            if (NOT (IS_CAR_DEAD( l_U4972 )))
...
void sub_14667(unknown uParam0)
{
    ...
    switch (uParam0)
    {
        ...
        break;
        case 5:
        CREATE_CAR( l_U3839, -1110.85300000, -983.73520000, 7.72440000, ref l_U4972, 1 );
        ...
        l_U3642[0]._fU52[2] = {-989.28360000, -913.03450000, 0.00000000};
        ...
        l_U3874[2]._fU28 = 1;
        l_U3874[3]._fU0 = sub_18122( l_U3841, 24, -1150.99600000, -992.98330000, 9.21610000, 99.40000000, 7, 1, 0 );
        ...
        l_U3874[2]._fU80 = l_U4871;
        l_U3874[2]._fU28 = 1;
        l_U3874[3]._fU0 = sub_18122( l_U3841, 24, -1150.99600000, -992.98330000, 9.21610000, 99.40000000, 14, 1, 0 );
        l_U3874[3]._fU40 = {-1126.17700000, -987.88590000, 9.21610000};
        l_U3874[3]._fU52 = 0;
        l_U3874[3]._fU80 = l_U4871;
        l_U3874[3]._fU8 = 1;
        l_U3874[4]._fU0 = sub_18122( l_U3841, 24, -1125.57200000, -985.29300000, 6.54710000, 275.00000000, 14, 1, 0 );
        ...
        l_U3874[6]._fU0 = sub_18122( l_U3841, 24, -1148.68800000, -995.55850000, 7.55550000, 217.76650000, 18, 0, 0 );
        ...
        break;
        case 17:
        sub_26786( 32, ref l_U4779, 260.67900000, -363.12370000, 161.01430000, 0.00000000 );
...
void sub_31348()
{
            ...
            if (NOT l_U5357)
            {
                if (NOT (IS_WANTED_LEVEL_GREATER( sub_14417(), 0 )))
                {
                    ...
                    if (NOT l_U5350)
                    {
                        ...
                        if (((LOCATE_CHAR_ANY_MEANS_3D( sub_3454(), -396.15550000, -480.42750000, 3.34680000, 24.00000000, 22.00000000, 10.00000000, 0 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3454(), -380.91380000, -531.38390000, -0.53980000, 48.00000000, 47.00000000, 10.00000000, 0 ))) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3454(), l_U5095._fU0, l_U5095._fU4, 6.17000000, 2.50000000, 2.50000000, 2.50000000, 1 )))
                        {
        ...
        if (NOT (IS_CAR_DEAD( l_U4972 )))
        {
                ...
                if (NOT l_U4774)
                {
                    if (sub_33251( 1 ))
                    {
                        ...
                        if (NOT (IS_CAR_DEAD( uVar11 )))
                        {
                            ...
                            if ((((uVar5._fU0 >= -7.40000000) AND (uVar5._fU0 < 7.40000000)) AND (uVar5._fU4 > -29.70000000)) AND (uVar5._fU4 < 36.70000000))
                            {
                        ...
                        while (((((((((((((((NOT (HAS_MODEL_LOADED( -2075782048 ))) || (NOT (HAS_MODEL_LOADED( 1239854102 )))) || (NOT (HAS_MODEL_LOADED( 1930762713 )))) || (NOT (HAS_MODEL_LOADED( 1233545547 )))) || (NOT (HAS_MODEL_LOADED( 1005833766 )))) || (NOT (HAS_MODEL_LOADED( 67157199 )))) || (NOT (HAS_MODEL_LOADED( 518033353 )))) || (NOT (HAS_MODEL_LOADED( -1366166054 )))) || (NOT (HAS_MODEL_LOADED( 1595218282 )))) || (NOT (HAS_MODEL_LOADED( 2120126803 )))) || (NOT (HAS_MODEL_LOADED( 1789985121 )))) || (NOT (HAS_MODEL_LOADED( -1085774992 )))) || (NOT (HAS_MODEL_LOADED( l_U3841 )))) || (NOT (HAS_MODEL_LOADED( l_U3844 )))) || (NOT (HAS_MODEL_LOADED( l_U3845 ))))
                        {
                            WAIT( 0 );
                        }
                        sub_14667( 14 );
                        ...
                        if ((l_U5360) || (NOT (DOES_BLIP_EXIST( l_U4982 ))))
                        {
                            if (NOT (IS_CAR_DEAD( l_U4972 )))
                            {
            ...
            else if (NOT (IS_CHAR_SITTING_IN_CAR( sub_3454(), l_U4972 )))
            {
                ...
                if (sub_36569())
                {
                    if (NOT l_U5347)
                    {
                        if ((l_U5325 == 0) || ((l_U5325 != 0) AND (sub_36871( l_U5325, 1500 ))))
                        {
                            if (NOT l_U5200)
                            {
                                PLAY_SOUND_FROM_POSITION( l_U4881, "Y1_STEAL_CHOPPER_SHIP_ALARM", -1149.12200000, -989.36460000, 13.71939000 );
                    ...
                    {
                        if ((l_U5354 == 0) || (sub_36871( l_U5354, 9000 )))
                        {
                ...
                if (I > -1)
                {
                    if (NOT (IS_CHAR_INJURED( l_U4280[I]._fU0 )))
                    {
                        ...
                        {
                            if ((sub_36871( l_U5355, 10000 )) || (l_U5355 == 0))
                            {
            ...
            else if ((NOT l_U3874[0]._fU4) || (l_U5347))
            {
                if (NOT l_U5347)
                {
    ...
    if (l_U5308)
    {
        if (NOT l_U5150)
        {
            if (NOT (IS_CAR_DEAD( l_U4972 )))
            {
                if (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_3454(), -1110.85300000, -983.73520000, 7.72440000, 1000.00000000, 1000.00000000, 1000.00000000, 0 )))
                {
    ...
    if (NOT l_U5361)
    {
        ...
        {
            if ((HAS_MODEL_LOADED( l_U3845 )) AND (HAS_MODEL_LOADED( l_U3844 )))
            {
                sub_14667( 13 );
                l_U5361 = 1;
            }
...
void sub_32065()
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3454() )) || (IS_CHAR_ON_ANY_BIKE( sub_3454() )))
    {
            ...
            if (NOT (IS_PED_CLIMBING( sub_3454() )))
            {
                ...
                if (uVar4._fU8 > 2.20000000)
                {
                    if (DOES_OBJECT_EXIST( l_U4715 ))
                    {
                        ...
                        if ((((uVar7._fU0 >= -7.40000000) AND (uVar7._fU0 < 7.40000000)) AND (uVar7._fU4 > -29.70000000)) AND (uVar7._fU4 < 36.70000000))
                        {
                            return 1;
                        }
                    }
...
void sub_36569()
{
    ...
    if (LOCATE_CHAR_ANY_MEANS_3D( sub_3454(), -1137.66400000, -987.62820000, 12.92580000, 41.00000000, 24.00000000, 25.00000000, 0 ))
    {
        if (IS_CHAR_SHOOTING( sub_3454() ))
        {
            if (sub_33251( 0 ))
...
void sub_38003(int iParam0, unknown uParam1)
{
    switch (uParam1)
    {
        ...
        break;
        case 5:
        SET_CHAR_ANGLED_DEFENSIVE_AREA( iParam0->_fU0, -1133.11300000, -987.17270000, 9.04600000, -1125.68800000, -986.11490000, 6.04600000, 5.50000000 );
        break;
        case 6:
...
int sub_38888()
{
    if ((NOT (sub_38903( l_U4762 ))) AND (NOT IS_MESSAGE_BEING_DISPLAYED()))
    {
        return 1;
    }
    return 0;
    ...
    for ( I = 0; I <= 14; I++ )
    {
        if ((uParam0^)[I]._fU4)
        {
            if (NOT (IS_CHAR_DEAD( (uParam0^)[I]._fU0 )))
            {
                ...
                else if ((NOT (uParam0^)[I]._fU16) || ((uParam0^)[I]._fU12))
                {
...
void sub_44745()
{
    ...
    switch (l_U5327)
    {
        ...
        REQUEST_CAR_RECORDING( 120 );
        REQUEST_CAR_RECORDING( 121 );
        while ((((NOT (HAS_MODEL_LOADED( -1043459709 ))) || (NOT (HAS_MODEL_LOADED( 1759673526 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 120 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 121 ))))
        {
            WAIT( 0 );
        }
...
void sub_45568()
{
    ...
    if (NOT (IS_CHAR_DEAD( l_U3642[0]._fU4[0] )))
    {
        ...
        else
        {
            ...
            if ((uVar5._fU4 < 70.00000000) AND (uVar5._fU4 > 1.00000000))
            {
...
void sub_46819(int iParam0)
{
    ...
    {
        if ((LOCATE_CHAR_IN_CAR_3D( iParam0->_fU4[0], uVar5._fU0, uVar5._fU4, uVar5._fU8, 10.00000000, 10.00000000, 10.00000000, 0 )) || (sub_43468( iParam0->_fU4[0], 1, 0 )))
        {
...
void sub_48916(unknown uParam0)
{
    ...
    if (((((IS_CONTROL_PRESSED( 0, 51 )) AND (IS_CHAR_IN_ANY_CAR( sub_3454() ))) AND (NOT (IS_CHAR_DEAD( (uParam0^) )))) AND (NOT sub_49084())) AND (iVar3 != 4))
    {
...
void sub_49731()
{
    ...
    switch (l_U5176)
    {
        ...
        break;
        case 1:
        if ((sub_36871( l_U5177, 1700 )) || (l_U5177 == 0))
        {
            l_U5178 = 1;
    ...
    if (l_U5178)
    {
        ...
        for ( I = 0; I < l_U4280; I++ )
        {
            ...
            {
                OPEN_SEQUENCE_TASK( ref uVar4 );
                TASK_FOLLOW_NAV_MESH_TO_COORD( 0, -1125.75000000, -983.69070000, 6.54090000, 3, -2, 0.50000000 );
                TASK_COWER( 0 );
                CLOSE_SEQUENCE_TASK( uVar4 );
                if (NOT (IS_CHAR_INJURED( l_U4280[I]._fU0 )))
                {
            ...
            if (NOT l_U5181)
            {
                if (NOT (IS_CAR_DEAD( l_U4972 )))
                {
                    if (IS_CHAR_IN_CAR( sub_3454(), l_U4972 ))
                    {
                        if (l_U5180 == 0)
                        {
                            if (LOCATE_CHAR_IN_CAR_3D( sub_3454(), -1110.26500000, -983.66270000, 8.32060000, 4.00000000, 5.00000000, 2.50000000, 0 ))
                            {
...
int sub_49817()
{
    if (NOT (IS_CAR_DEAD( l_U4972 )))
    {
        if ((IS_CHAR_IN_CAR( sub_3454(), l_U4972 )) || (LOCATE_CHAR_ANY_MEANS_3D( sub_3454(), -1112.23200000, -985.10900000, 8.32060000, 7.00000000, 9.00000000, 2.00000000, 0 )))
        {
            return 1;
        }
    }
    ...
    if (NOT (IS_CAR_DEAD( l_U4972 )))
    {
        if (IS_CHAR_IN_CAR( sub_3454(), l_U4972 ))
        {
            if (DOES_OBJECT_EXIST( l_U4715 ))
            {
                GET_CHAR_COORDINATES( sub_3454(), ref uVar2._fU0, ref uVar2._fU4, ref uVar2._fU8 );
                sub_33408( l_U4715, uVar2, ref uVar5 );
                if ((((uVar5._fU0 < -6.50000000) || (uVar5._fU0 > 6.50000000)) || (uVar5._fU4 < -23.00000000)) || (uVar5._fU4 > 10.00000000))
                {
                    return 0;
                }
            }
...
void sub_55372()
{
    ...
    if (l_U5146 == 0)
    {
        ...
        if (l_U5150)
        {
            if (NOT (IS_CHAR_DEAD( sub_3454() )))
            {
                if (((IS_CHAR_IN_ANY_CAR( sub_3454() )) || (IS_CHAR_IN_WATER( sub_3454() ))) || (sub_33251( 0 )))
                {
                    while ((IS_MESSAGE_BEING_DISPLAYED()) || (NOT (sub_36871( l_U5151, 7000 ))))
                    {
                        WAIT( 0 );
                    }
                    if (IS_CHAR_IN_ANY_CAR( sub_3454() ))
        ...
        if (IS_CHAR_IN_CAR( sub_3454(), l_U4972 ))
        {
            if (NOT l_U4965)
            {
                if (DOES_BLIP_EXIST( l_U4982 ))
                {
                    ...
                    if ((NOT l_U5323) AND (NOT sub_58572()))
                    {
                        l_U5323 = 1;
                    }
                }
...
void sub_59042()
{
    ...
    switch (l_U5316)
    {
        ...
        if (l_U5317)
        {
            ...
            if (l_U5295)
            {
                if ((sub_36871( l_U5296, 5000 )) || (l_U5296 == 0))
                {
                    if (sub_38888())
                    {
                        if (NOT g_U3)
            ...
            if (l_U4768)
            {
                if ((sub_36871( l_U4775, 10000 )) || (NOT l_U4769))
                {
                    if (sub_38888())
                    {
...
int sub_59200(unknown uParam0, unknown uParam1, unknown uParam2, unknown uParam3, unknown uParam4, unknown uParam5, unknown uParam6, unknown uParam7, boolean bParam8, unknown uParam9, unknown uParam10, boolean bParam11, unknown uParam12, unknown uParam13)
{
    ...
    if ((IS_CHAR_IN_ANY_CAR( sub_3454() )) AND (NOT (IS_CHAR_SITTING_IN_ANY_CAR( sub_3454() ))))
    {
    ...
    {
        case 0:
        if ((NOT sub_59715()) AND (NOT bParam11))
        {
            return 0;
        }
        g_U95._fU60 = uParam0;
            ...
            for ( I = 0; I < l_U3874; I++ )
            {
                if (NOT (IS_CHAR_INJURED( l_U3874[I]._fU0 )))
                {
                    if (sub_36871( l_U5265, 5000 ))
                    {
                        ...
                        {
                            if ((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3454(), l_U3874[I]._fU0, 40.00000000, 40.00000000, 40.00000000, 0 ))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3454(), l_U3874[I]._fU0, 180.00000000, 180.00000000, 180.00000000, 0 )))
                            {
                                if ((sub_43468( l_U3874[I]._fU0, 1, 0 )) || (l_U3874[I]._fU72))
                                {
                                    GET_CHAR_COORDINATES( sub_3454(), ref uVar5._fU0, ref uVar5._fU4, ref uVar5._fU8 );
                                    uVar14 = {sub_63544()};
...
void sub_63746(unknown uParam0)
{
    ...
    if (NOT (IS_CHAR_INJURED( uParam0 )))
    {
        ...
        if ((sub_63818( uVar6, ref l_U1765[2] )) AND (sub_63818( uVar6, ref l_U1765[1] )))
        {
            Result = 5;
        }
        else if ((sub_63818( uVar6, ref l_U1765[3] )) AND (sub_63818( uVar6, ref l_U1765[1] )))
        {
            Result = 6;
        }
        else if ((sub_63818( uVar6, ref l_U1765[3] )) AND (sub_63818( uVar6, ref l_U1765[4] )))
        {
            Result = 8;
        }
        else if ((sub_63818( uVar6, ref l_U1765[2] )) AND (sub_63818( uVar6, ref l_U1765[4] )))
        {
            Result = 7;
        }
...
{
    if ((((((uParam0._fU0 >= (ref iParam3->_fU0->_fU0)) AND (uParam0._fU4 >= (ref iParam3->_fU0->_fU4))) AND (uParam0._fU8 >= (ref iParam3->_fU0->_fU8))) AND (uParam0._fU0 <= (ref iParam3->_fU12->_fU0))) AND (uParam0._fU4 <= (ref iParam3->_fU12->_fU4))) AND (uParam0._fU8 <= (ref iParam3->_fU12->_fU8)))
    {
        return 1;
    }
    return 0;
                    ...
                    if (NOT l_U1765[J]._fU80[I]._fU124)
                    {
                        if (l_U1765[J]._fU80[I]._fU12._fU0 == l_U4686._fU0)
                        {
                            ...
                            if (NOT (sub_66292( uVar14, 0.00000000, 0.00000000, 0.00000000 )))
                            {
                                ...
                                if ((NOT bParam0) || ((bParam0) AND (NOT (sub_67107( ref l_U1765[J] )))))
                                {
                                    if (fVar7 < fVar6)
                                    {
                                        fVar6 = fVar7;
...
void sub_70612()
{
    ...
    if (NOT l_U5287)
    {
        ...
        {
            if (((sub_36871( l_U5284, 5000 )) AND ((l_U5285 - fVar6) > 10000)) || (sub_36871( l_U5284, 30000 )))
            {
    ...
    for ( J = 0; J < l_U746; J++ )
    {
        if (DOES_OBJECT_EXIST( l_U746[J]._fU4 ))
        {
            ...
            if (iVar6 <= 4)
            {
                for ( I = 0; I < iVar4; I++ )
                {
                    if ((sub_36871( l_U746[J]._fU388._fU4, 5000 )) || (l_U746[J]._fU388._fU4 == 0))
                    {
                    ...
                    switch (l_U746[J]._fU388._fU256[I])
                    {
                        ...
                        if (DOES_CHAR_EXIST( l_U746[J]._fU388._fU8[I] ))
                        {
                            ...
                            else
                            {
                                ...
                                if ((NOT (sub_3576( uVar14, 1.50000000 ))) || (NOT (LOCATE_CHAR_ANY_MEANS_3D( sub_3454(), uVar14._fU0, uVar14._fU4, uVar14._fU8, 75.00000000, 75.00000000, 75.00000000, 0 ))))
                                {
...
int sub_72759(int iParam0)
{
    ...
    sub_33408( l_U4715, uVar3, ref uVar6 );
    if (((((((uVar6._fU0 >= uVar9[0]._fU0) AND (uVar6._fU4 >= uVar9[0]._fU4)) AND (uVar6._fU8 >= uVar9[0]._fU8)) AND (uVar6._fU0 <= uVar16[0]._fU0)) AND (uVar6._fU4 <= uVar16[0]._fU4)) AND (uVar6._fU8 <= uVar16[0]._fU8)) || ((((((uVar6._fU0 >= uVar9[1]._fU0) AND (uVar6._fU4 >= uVar9[1]._fU4)) AND (uVar6._fU8 >= uVar9[1]._fU8)) AND (uVar6._fU0 <= uVar16[1]._fU0)) AND (uVar6._fU4 <= uVar16[1]._fU4)) AND (uVar6._fU8 <= uVar16[1]._fU8)))
    {
        return 1;
    }
    return 0;
    ...
    if (NOT l_U5258)
    {
        ...
        else if (iVar4 > 4)
        {
            ...
            else
            {
                ...
                if (((l_U5261 - uVar2) >= 200.00000000) || (sub_36871( l_U5256, 60000 )))
                {
                    l_U5263 = 1000;
                    l_U5258 = 1;
        ...
        else if (((sub_36871( l_U5256, 7000 )) AND (sub_36871( l_U5262, 40000 ))) || (sub_36871( l_U5255, 300000 )))
        {
            g_U43571 = 0;
            if (NOT l_U5259)
            {
            ...
            else
            {
                ...
                if (((l_U5261 - uVar2) >= 2000.00000000) || (sub_36871( l_U5255, 300000 )))
                {
                    l_U5263 = 1000;
                    l_U5258 = 1;
                    GET_GAME_TIMER( ref l_U5257 );
...
int sub_77045()
{
    ...
    switch (l_U5226)
    {
                ...
                if (sub_77132( 1, 1 ))
                {
                    ...
                    if (IS_VEH_DRIVEABLE( l_U4972 ))
                    {
                        ...
                        if (l_U5231)
                        {
                            ...
                            REQUEST_MODEL( 1033245328 );
                            while (((((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 496 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 497 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 498 )))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 499 )))) || (NOT (HAS_MODEL_LOADED( 1033245328 ))))
                            {
                                WAIT( 0 );
                            }
                            sub_14667( 9 );
        ...
        if (HAS_CUTSCENE_LOADED())
        {
            ...
            while (((((((NOT (HAS_CAR_RECORDING_BEEN_LOADED( 466 ))) || (NOT (HAS_CAR_RECORDING_BEEN_LOADED( 467 )))) || (NOT (HAS_MODEL_LOADED( -1570089923 )))) || (NOT (HAS_MODEL_LOADED( -1863929546 )))) || (NOT (HAS_MODEL_LOADED( 1073680232 )))) || (NOT (HAS_MODEL_LOADED( 767847151 )))) || (NOT (HAS_MODEL_LOADED( l_U3842 ))))
            {
                WAIT( 0 );
            }
            if (NOT (IS_CAR_DEAD( l_U4972 )))
...
void sub_79342()
{
    ...
    if (NOT (HAS_MODEL_LOADED( -1570089923 )))
    {
        ...
        while ((((((((NOT (HAS_MODEL_LOADED( -1570089923 ))) || (NOT (HAS_MODEL_LOADED( -1863929546 )))) || (NOT (HAS_MODEL_LOADED( 1073680232 )))) || (NOT (HAS_MODEL_LOADED( 767847151 )))) || (NOT (HAS_MODEL_LOADED( 1484046419 )))) || (NOT (HAS_MODEL_LOADED( 1238049536 )))) || (NOT (HAS_MODEL_LOADED( -1496523498 )))) || (NOT (HAS_MODEL_LOADED( -1752023391 ))))
        {
            WAIT( 0 );
        }
    }
    ...
    CREATE_OBJECT_NO_OFFSET( -1570089923, -1126.03100000, -999.96220000, 1.00000000, ref l_U4716[3], 1 );
    ...
    CREATE_OBJECT_NO_OFFSET( -1752023391, -1265.07800000, -910.81460000, 1.00000000, ref l_U4716[41], 1 );
    ...
    l_U5210[0] = sub_81389( -1132.14400000, -995.61170000, -0.68620000, 0 );
    l_U5210[1] = sub_81389( -1144.92100000, -999.81120000, -0.68620000, 0 );
    ...
    switch (l_U5247)
    {
            ...
            if (NOT (IS_CAR_DEAD( l_U3642[J]._fU0 )))
            {
                        ...
                        if (NOT (IS_CAR_DEAD( l_U4972 )))
                        {
                            if (IS_CHAR_IN_CAR( sub_3454(), l_U4972 ))
                            {
                                if (sub_36871( l_U5246, 5000 ))
                                {
                                    ...
                                    {
                                        if (((NOT (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3454(), l_U3642[J]._fU4[2], 40.00000000, 40.00000000, 40.00000000, 0 ))) AND (LOCATE_CHAR_ANY_MEANS_CHAR_3D( sub_3454(), l_U3642[J]._fU4[2], 90.00000000, 90.00000000, 90.00000000, 0 ))) AND (NOT (sub_83366( J ))))
                                        {
                                            uVar7[0] = {sub_63544()};
                ...
                if (NOT (IS_CAR_DEAD( l_U4972 )))
                {
                    if (NOT (IS_CHAR_DEAD( l_U3642[J]._fU4[0] )))
                    {
                        if (l_U3642[J]._fU152)
                        {
                            if ((NOT (IS_CHAR_IN_CAR( sub_3454(), l_U4972 ))) || (NOT (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U3642[J]._fU0 ))))
                            {
                                SET_CHAR_PROOFS( l_U3642[J]._fU4[0], 0, 0, 0, 0, 0 );
                                l_U3642[J]._fU152 = 0;
                            }
                        }
                        else if ((IS_CHAR_IN_CAR( sub_3454(), l_U4972 )) || (IS_PLAYBACK_GOING_ON_FOR_CAR( l_U3642[J]._fU0 )))
                        {
                ...
                if (NOT (IS_CHAR_ON_SCREEN( uVar26 )))
                {
                    if (IS_CHAR_IN_ANY_CAR( uVar26 ))
                    {
                        ...
                        if (iVar6 > -1)
                        {
                            ...
                            if ((IS_PLAYBACK_GOING_ON_FOR_CAR( l_U3642[iVar6]._fU0 )) AND (uVar20._fU4 < 0.00000000))
                            {
                                if (l_U5254 == 0)
                                {
        ...
        if (l_U5248)
        {
            if (fVar24 < 200.00000000)
            {
                if (l_U4773)
                {
                    if ((sub_36871( l_U4776, 25000 )) || (NOT l_U4771))
                    {
            ...
            if (l_U4772)
            {
                if (l_U4768)
                {
                    if (fVar24 < 200.00000000)
                    {
                        if (((sub_36871( l_U4775, 15000 )) AND (sub_36871( l_U4776, 10000 ))) || (NOT l_U4769))
                        {
                            if (sub_38888())
                            {
                                if (HAS_SOUND_FINISHED( l_U4879 ))
...
int sub_82084()
{
    ...
    array(ref iVar2, 3);
    if (((HAS_CAR_RECORDING_BEEN_LOADED( 466 )) AND (HAS_CAR_RECORDING_BEEN_LOADED( 467 ))) AND (HAS_CAR_RECORDING_BEEN_LOADED( 495 )))
    {
        if (NOT (IS_CAR_DEAD( l_U3642[0]._fU0 )))
        {
    ...
    if (((iVar2[0]) AND (iVar2[1])) AND (iVar2[2]))
    {
        return 1;
    }
    return 0;
            ...
            if (IS_CHAR_SITTING_IN_CAR( sub_3454(), l_U4972 ))
            {
                if (l_U5194)
                {
                    if (NOT l_U5185)
                    {
                        ...
                        {
                            if ((NOT l_U5186) AND (NOT (IS_THIS_HELP_MESSAGE_BEING_DISPLAYED( "YS1_WHEL" ))))
                            {
                                if (l_U5179)
                                {
                                    if (NOT (sub_38903( l_U4762 )))
    ...
    if (NOT (IS_CAR_DEAD( l_U4972 )))
    {
        if (IS_CHAR_SITTING_IN_CAR( sub_3454(), l_U4972 ))
        {
            ...
            if (fVar5 < 0.10000000)
            {
                ...
                {
                    if ((NOT (IS_CONTROL_PRESSED( 0, 40 ))) AND (NOT (IS_CONTROL_PRESSED( 0, 55 ))))
                    {
                        if (l_U5168 == 0)
                        {
...
int sub_90843()
{
    ...
    else if (((l_U5163 > 0) AND (NOT l_U5167)) AND (IS_SCREEN_FADED_IN()))
    {
        if (sub_90863())
        {
            CLEAR_PRINTS();
    ...
    switch (l_U5163)
    {
        ...
        if (NOT (IS_CAR_DEAD( l_U4972 )))
        {
            if (sub_77132( 1, 1 ))
            {
                ...
                SET_CAM_POS( l_U4904[16], 267.98460000, -359.48720000, 161.59820000 );
                SET_CAM_ROT( l_U4904[16], 5.87184900, 0.00000000, 56.26260000 );
                SET_CAM_FOV( l_U4904[16], 31.20004000 );
                ...
                SET_CAM_FOV( l_U4904[17], 31.20004000 );
                ...
                SET_CAM_FOV( l_U4904[19], 31.20004000 );
                ...
                SET_CAM_FOV( l_U4904[20], 31.20004000 );
                ...
                SET_CAM_POS( l_U4904[24], 251.13050000, -361.13430000, 179.03960000 );
                ...
                SET_CAM_ROT( l_U4904[22], 18.14836000, 0.00000000, 150.59540000 );
        ...
        if (NOT l_U5169)
        {
            if (NOT (IS_CAR_DEAD( l_U4972 )))
            {
                ...
                if ((fVar5 > 0.90000000) || (sub_36871( l_U5162, 15000 )))
                {
        ...
        if ((sub_36871( l_U5162, 5500 )) || (iVar3 > 0))
        {
        ...
        if (NOT (IS_CAR_DEAD( l_U4972 )))
        {
            if (NOT (IS_CHAR_DEAD( l_U4778 )))
            {
                if ((sub_94019( l_U4778, "missYusuf01", "Ahmed_helipad", 0.92000000 )) || (sub_36871( l_U5162, 15000 )))
                {
        ...
        break;
        case 11:
        if (((IS_KEYBOARD_KEY_JUST_PRESSED( 2 )) || (sub_36871( l_U5162, 6000 ))) || (l_U5167))
        {
            if (NOT IS_SCREEN_FADED_OUT())
            {
                DO_SCREEN_FADE_OUT( 500 );
...
void sub_107127()
{
    if (NOT (sub_38903( l_U4762 )))
    {
        if ((l_U5244 == 0) || (sub_36871( l_U5244, 10000 )))
        {
            if (sub_107179())
            {
...
int sub_107179()
{
    if (NOT (IS_CAR_DEAD( l_U4972 )))
    {
        if (IS_CHAR_SITTING_IN_CAR( sub_3454(), l_U4972 ))
        {
            if (NOT l_U5243)
            {
                if ((IS_CONTROL_PRESSED( 0, 39 )) || (IS_CONTROL_PRESSED( 0, 45 )))
                {
                    l_U5243 = 1;
                }
            }
            else if ((NOT (IS_CONTROL_PRESSED( 0, 39 ))) AND (NOT (IS_CONTROL_PRESSED( 0, 45 ))))
            {
                l_U5243 = 0;
                return 1;
            }
